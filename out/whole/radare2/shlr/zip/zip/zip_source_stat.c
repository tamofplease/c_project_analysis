# 0 "project/radare2/shlr/zip/zip/zip_source_stat.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_stat.c" 2
...
zip_source_stat(struct zip_source *src, struct zip_stat *st)
{
    ...
    if (st == 
# 45 "project/radare2/shlr/zip/zip/zip_source_stat.c" 3 4
             ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_source_stat.c"
                 ) {
 ...
 return -1;
    ...
    if (src->src == 
# 50 "project/radare2/shlr/zip/zip/zip_source_stat.c" 3 4
                   ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_source_stat.c"
                       ) {
 ...
 return -1;
    ...
    if (ret < 0) {
 if (ret == 
# 64 "project/radare2/shlr/zip/zip/zip_source_stat.c" 3 4
           -2
# 64 "project/radare2/shlr/zip/zip/zip_source_stat.c"
                               )
     src->error_source = ZIP_LES_LOWER;
 else
