# 0 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 2
    ...
    zip_uint16_t em, int flags, const char *password)
{
    ...
    if (password == 
# 70 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                   ((void *)0) 
# 70 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                        || src == 
# 70 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                                  ((void *)0) 
# 70 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
...
# 71 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                           18
# 71 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                       , 0);
 return 
# 72 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
       ((void *)0)
# 72 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
           ;
    }
    if (flags & 
# 74 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
               1
# 74 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                               ) {
 _zip_error_set(&za->error, 
# 75 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                           24
# 75 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                             , 0);
 return 
# 76 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
       ((void *)0)
# 76 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
           ;
    }

    if ((ctx=(struct trad_pkware *)malloc(sizeof(*ctx))) == 
# 79 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                                                           ((void *)0)
# 79 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                                               ) {
 _zip_error_set(&za->error, 
# 80 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                           14
# 80 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                        , 0);
 return 
# 81 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
       ((void *)0)
# 81 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
           ;
    }
    ...
    ctx->key[2] = 878082192;
    decrypt(ctx, 
# 89 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                ((void *)0)
# 89 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                    , (const zip_uint8_t *)password, strlen(password), 1);

    if ((s2=zip_source_layered(za, src, pkware_decrypt, ctx)) == 
# 91 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                                                                ((void *)0)
# 91 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                                                    ) {
 pkware_free(ctx);
 return 
# 93 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
       ((void *)0)
# 93 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
           ;
    }
...
decrypt_header(struct zip_source *src, struct trad_pkware *ctx)
{
    ...
    if ((n=zip_source_read(src, header, 12)) < 0) {
 ...
 return -1;
    ...
    if (n != 12) {
 ctx->e[0] = 
# 147 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
            17
# 147 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                      ;
 ctx->e[1] = 0;
 return -1;
    }

    decrypt(ctx, header, header, 12, 0);
 ...
 return 0;
    ...
    if (header[12 -1] != st.crc>>24
 && header[12 -1] != dostime>>8) {
 ctx->e[0] = 
# 163 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
            27
# 163 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                              ;
 ctx->e[1] = 0;
 return -1;
    }
        ...
        zip_uint64_t len, enum zip_source_cmd cmd)
{
 ...
 if ((n=zip_source_read(src, data, len)) < 0)
     return 
# 190 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
           -2
# 190 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                               ;
...
# 205 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                            0
# 205 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                       ;
     st->valid |= 
# 206 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                 0x0080u
# 206 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                           ;

     if (st->valid & 
# 208 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
                    0x0008u
# 208 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                                      )
  st->comp_size -= 12;
 }
 return 0;
...
# 214 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
__builtin___memcpy_chk (
# 214 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
data
# 214 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
, 
# 214 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
...
# 214 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
 ...
 return 0;
    ...
    default:
 ctx->e[0] = 
# 222 "project/radare2/shlr/zip/zip/zip_source_pkware.c" 3 4
            18
# 222 "project/radare2/shlr/zip/zip/zip_source_pkware.c"
                        ;
 ctx->e[1] = 0;
 return -1;
    }
