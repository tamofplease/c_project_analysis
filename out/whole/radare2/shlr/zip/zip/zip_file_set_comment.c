# 0 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
          int
...
# 50 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                                   ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                       ) == 
# 50 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                                            ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
 ...
 return -1;
    ...
    if (((za)->ch_flags & 
# 53 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
       2u
# 53 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
       )) {
 _zip_error_set(&za->error, 
# 54 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                           25
# 54 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                        , 0);
 return -1;
    }

    if (len > 0 && comment == 
# 58 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                             ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                 ) {
 _zip_error_set(&za->error, 
# 59 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                           18
# 59 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                       , 0);
 return -1;
    }
...
# 64 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                                                                                    ((void *)0)
# 64 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                                                                        )
     return -1;
 if ((flags & (
# 66 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
             0u
# 66 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
             |
# 66 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
             4096u
# 66 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
...
# 66 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
 ...
 cstr = 
# 70 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
       ((void *)0)
# 70 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
           ;
 ...
 e->changes->comment = 
# 76 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                      ((void *)0)
# 76 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                          ;
 e->changes->changed &= ~0x0004u;
    }
 ...
 changed = (cstr != 
# 83 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                   ((void *)0)
# 83 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                       );

    if (changed) {
        if (e->changes == 
# 86 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                         ((void *)0)
# 86 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 87 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                                                          ((void *)0)
# 87 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                                              ) {
                _zip_error_set(&za->error, 
# 88 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                                          14
# 88 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                                                       , 0);
 ...
 if (e->changes && e->changes->changed == 0) {
     ...
     e->changes = 
# 100 "project/radare2/shlr/zip/zip/zip_file_set_comment.c" 3 4
                 ((void *)0)
# 100 "project/radare2/shlr/zip/zip/zip_file_set_comment.c"
                     ;
 }
    }
