# 0 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 2
      ...
      zip_uint64_t start, zip_uint64_t len, const char *password)
{
    ...
    if (za == 
# 52 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
             ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                 )
 return 
# 53 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 53 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;

    if (srcza == 
# 55 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                ((void *)0) 
# 55 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                     || srcidx >= srcza->nentry) {
 _zip_error_set(&za->error, 
# 56 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                           18
# 56 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                       , 0);
 return 
# 57 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 57 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;
    }

    if ((flags & 
# 60 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                8u
# 60 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                ) == 0
 && (((srcza->entry+srcidx)->source != 
# 61 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
    ((void *)0)
# 61 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
    ) || srcza->entry[srcidx].deleted)) {
 _zip_error_set(&za->error, 
# 62 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                           15
# 62 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                         , 0);
 return 
# 63 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 63 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;
    }

    if (zip_stat_index(srcza, srcidx, flags|
# 66 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                           8u
# 66 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                           , &st) < 0) {
 _zip_error_set(&za->error, 
# 67 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                           20
# 67 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                          , 0);
 return 
# 68 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 68 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;
    }

    if (flags & 
# 71 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
               32u
# 71 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                               )
 flags |= 
# 72 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
         4u
# 72 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                          ;

    if ((start > 0 || len > 0) && (flags & 
# 74 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                          4u
# 74 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                           )) {
 _zip_error_set(&za->error, 
# 75 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                           18
# 75 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                       , 0);
 return 
# 76 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 76 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;
    }
 ...
 _zip_error_set(&za->error, 
# 81 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                           18
# 81 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                       , 0);
 return 
# 82 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 82 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;
    }

    enc_impl = 
# 85 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
              ((void *)0)
# 85 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                  ;
    if (((flags & 
# 86 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                 32u
# 86 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                 ) == 0) && (st.encryption_method != 
# 86 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                     0
# 86 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                                )) {
 if (password == 
# 87 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                ((void *)0)
# 87 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                    ) {
     _zip_error_set(&za->error, 
# 88 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                               26
# 88 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                              , 0);
     return 
# 89 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
           ((void *)0)
# 89 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
               ;
 }
 if ((enc_impl=_zip_get_encryption_implementation(st.encryption_method)) == 
# 91 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                           ((void *)0)
# 91 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                               ) {
     _zip_error_set(&za->error, 
# 92 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                               24
# 92 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                 , 0);
     return 
# 93 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
           ((void *)0)
# 93 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
               ;
 }
    }

    comp_impl = 
# 97 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
               ((void *)0)
# 97 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                   ;
    if ((flags & 
# 98 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                4u
# 98 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                 ) == 0) {
 if (st.comp_method != 
# 99 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                      0
# 99 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                  ) {
     if ((comp_impl=_zip_get_compression_implementation(st.comp_method)) == 
# 100 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                           ((void *)0)
# 100 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                               ) {
  _zip_error_set(&za->error, 
# 101 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                            16
# 101 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                              , 0);
  return 
# 102 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 102 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
     }
 }
    }
 ...
 return 
# 108 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
       ((void *)0)
# 108 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
           ;

    if (st.comp_size == 0) {
 if ((src=zip_source_buffer(za, 
# 111 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                               ((void *)0)
# 111 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                   , 0, 0)) == 
# 111 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                               ((void *)0)
# 111 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
     ...
     return 
# 112 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
           ((void *)0)
# 112 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
               ;
    }
    else {
 if (start+len > 0 && enc_impl == 
# 115 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                 ((void *)0) 
# 115 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                      && comp_impl == 
# 115 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                      ((void *)0)
# 115 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
     ...
     st2.comp_method = 
# 120 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                      0
# 120 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                  ;
     st2.mtime = st.mtime;
     st2.valid = 
# 122 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                0x0004u
# 122 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                             |
# 122 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                              0x0008u
# 122 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
...
# 122 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
     ...
     if ((src=_zip_source_file_or_p(za, 
# 125 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                       ((void *)0)
# 125 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                           , srcza->zp, offset+start, (zip_int64_t)st2.size, 0, &st2)) == 
# 125 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                                                          ((void *)0)
# 125 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                                                              )
  return 
# 126 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 126 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
 }
 else {

     if ((src=_zip_source_file_or_p(za, 
# 130 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                       ((void *)0)
# 130 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                           , srcza->zp, offset, (zip_int64_t)st.comp_size, 0, &st)) == 
# 130 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                                                       ((void *)0)
# 130 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                                                           )
  return 
# 131 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 131 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
 }

 if (enc_impl) {
     if ((s2=enc_impl(za, src, st.encryption_method, 0, password)) == 
# 135 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                     ((void *)0)
# 135 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                         ) {
  zip_source_free(src);

  return 
# 138 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 138 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
     }
     src = s2;
 }
...
# 143 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                      ((void *)0)
# 143 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                          ) {
  zip_source_free(src);

  return 
# 146 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 146 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
     }
     src = s2;
 }
 if (((flags & 
# 150 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
              4u
# 150 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                               ) == 0 || st.comp_method == 
# 150 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                           0
# 150 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
...
# 153 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                           ((void *)0)
# 153 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                               ) {
  zip_source_free(src);

  return 
# 156 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 156 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
     }
     src = s2;
 }
...
# 162 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
                                                                             ((void *)0)
# 162 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
                                                                                 ) {
  zip_source_free(src);

  return 
# 165 "project/radare2/shlr/zip/zip/zip_source_zip_new.c" 3 4
        ((void *)0)
# 165 "project/radare2/shlr/zip/zip/zip_source_zip_new.c"
            ;
     }
     src = s2;
 }
