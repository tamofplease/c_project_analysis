# 0 "project/radare2/shlr/zip/zip/zip_get_encryption_implementation.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_get_encryption_implementation.c" 2
...
{
    if (em == 
# 43 "project/radare2/shlr/zip/zip/zip_get_encryption_implementation.c" 3 4
             1
# 43 "project/radare2/shlr/zip/zip/zip_get_encryption_implementation.c"
                               )
 return zip_source_pkware;
    return 
# 45 "project/radare2/shlr/zip/zip/zip_get_encryption_implementation.c" 3 4
          ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_get_encryption_implementation.c"
              ;
}
