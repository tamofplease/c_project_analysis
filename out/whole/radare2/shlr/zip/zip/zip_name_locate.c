# 0 "project/radare2/shlr/zip/zip/zip_name_locate.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_name_locate.c" 2
...
# 41 "project/radare2/shlr/zip/zip/zip_name_locate.c" 2
...
# 43 "project/radare2/shlr/zip/zip/zip_name_locate.c" 2




# 46 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
extern 
# 46 "project/radare2/shlr/zip/zip/zip_name_locate.c"
          zip_int64_t
...
_zip_name_locate(struct zip *za, const char *fname, zip_flags_t flags, struct zip_error *error)
{
    ...
    if (za == 
# 61 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
             ((void *)0)
# 61 "project/radare2/shlr/zip/zip/zip_name_locate.c"
                 )
 return -1;

    if (fname == 
# 64 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
                ((void *)0)
# 64 "project/radare2/shlr/zip/zip/zip_name_locate.c"
                    ) {
 _zip_error_set(error, 
# 65 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
                      18
# 65 "project/radare2/shlr/zip/zip/zip_name_locate.c"
                                  , 0);
 return -1;
    }

    cmp = (flags & 
# 69 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
                  1u
# 69 "project/radare2/shlr/zip/zip/zip_name_locate.c"
                               ) ? __strcasecmp : strcmp;
 ...
 if (fn == 
# 75 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
          ((void *)0)
# 75 "project/radare2/shlr/zip/zip/zip_name_locate.c"
              )
     continue;

 if (flags & 
# 78 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
            2u
# 78 "project/radare2/shlr/zip/zip/zip_name_locate.c"
                        ) {
     p = strrchr(fn, '/');
     if (p)
  fn = p+1;
 ...
 if (cmp(fname, fn) == 0) {
    ...
    _zip_error_set(error, 
# 90 "project/radare2/shlr/zip/zip/zip_name_locate.c" 3 4
                         9
# 90 "project/radare2/shlr/zip/zip/zip_name_locate.c"
                                     , 0);
    return -1;
}
