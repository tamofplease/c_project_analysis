# 0 "project/radare2/shlr/zip/zip/zip_fopen_encrypted.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_fopen_encrypted.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_fopen_encrypted.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_fopen_encrypted.c"
          struct zip_file *
zip_fopen_encrypted(struct zip *za, const char *fname, zip_flags_t flags, const char *password)
{
 ...
 return 
# 46 "project/radare2/shlr/zip/zip/zip_fopen_encrypted.c" 3 4
       ((void *)0)
# 46 "project/radare2/shlr/zip/zip/zip_fopen_encrypted.c"
           ;
