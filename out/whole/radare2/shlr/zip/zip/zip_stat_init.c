# 0 "project/radare2/shlr/zip/zip/zip_stat_init.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_stat_init.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_stat_init.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_stat_init.c"
          void
zip_stat_init(struct zip_stat *st)
{
    st->valid = 0;
    st->name = 
# 44 "project/radare2/shlr/zip/zip/zip_stat_init.c" 3 4
              ((void *)0)
# 44 "project/radare2/shlr/zip/zip/zip_stat_init.c"
                  ;
    st->index = 
# 45 "project/radare2/shlr/zip/zip/zip_stat_init.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 45 "project/radare2/shlr/zip/zip/zip_stat_init.c"
                             ;
    st->crc = 0;
    st->mtime = (time_t)-1;
    st->size = 0;
    st->comp_size = 0;
    st->comp_method = 
# 50 "project/radare2/shlr/zip/zip/zip_stat_init.c" 3 4
                     0
# 50 "project/radare2/shlr/zip/zip/zip_stat_init.c"
                                 ;
    st->encryption_method = 
# 51 "project/radare2/shlr/zip/zip/zip_stat_init.c" 3 4
                           0
# 51 "project/radare2/shlr/zip/zip/zip_stat_init.c"
                                      ;
}
