# 0 "project/radare2/shlr/zip/zip/zip_source_open.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_open.c" 2
...
zip_source_open(struct zip_source *src)
{
 ...
 return -1;
    ...
    if (src->src == 
# 50 "project/radare2/shlr/zip/zip/zip_source_open.c" 3 4
                   ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_source_open.c"
                       ) {
 if (src->cb.f(src->ud, 
# 51 "project/radare2/shlr/zip/zip/zip_source_open.c" 3 4
                       ((void *)0)
# 51 "project/radare2/shlr/zip/zip/zip_source_open.c"
                           , 0, ZIP_SOURCE_OPEN) < 0)
     return -1;
    }
    else {
 ...
 ret = src->cb.l(src->src, src->ud, 
# 60 "project/radare2/shlr/zip/zip/zip_source_open.c" 3 4
                                   ((void *)0)
# 60 "project/radare2/shlr/zip/zip/zip_source_open.c"
                                       , 0, ZIP_SOURCE_OPEN);
 ...
 if (ret < 0) {
     ...
     if (ret == 
# 65 "project/radare2/shlr/zip/zip/zip_source_open.c" 3 4
               -2
# 65 "project/radare2/shlr/zip/zip/zip_source_open.c"
                                   )
  src->error_source = ZIP_LES_LOWER;
     else
