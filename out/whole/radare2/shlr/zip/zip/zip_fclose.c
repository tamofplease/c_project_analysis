# 0 "project/radare2/shlr/zip/zip/zip_fclose.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_fclose.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_fclose.c" 2




# 41 "project/radare2/shlr/zip/zip/zip_fclose.c" 3 4
extern 
# 41 "project/radare2/shlr/zip/zip/zip_fclose.c"
 ...
 if (!zf)
  return 
# 46 "project/radare2/shlr/zip/zip/zip_fclose.c" 3 4
        20
# 46 "project/radare2/shlr/zip/zip/zip_fclose.c"
                       ;
 if (zf->src)
