# 0 "project/radare2/shlr/zip/zip/zip_error_clear.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_error_clear.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_error_clear.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_error_clear.c"
          void
zip_error_clear(struct zip *za)
{
    if (za == 
# 43 "project/radare2/shlr/zip/zip/zip_error_clear.c" 3 4
             ((void *)0)
# 43 "project/radare2/shlr/zip/zip/zip_error_clear.c"
                 )
 return;
