# 0 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
          int
zip_set_archive_flag(struct zip *za, unsigned int flag, int value)
{
 ...
 return 0;
    ...
    if (((za)->ch_flags & 
# 53 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
       2u
# 53 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
       )) {
 _zip_error_set(&za->error, 
# 54 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
                           25
# 54 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
                                        , 0);
 return -1;
    }

    if ((flag & 
# 58 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
               2u
# 58 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
                             ) && value
 && (za->ch_flags & 
# 59 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
                   2u
# 59 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
                                 ) == 0) {
 if (_zip_changed(za, 
# 60 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
                     ((void *)0)
# 60 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
                         )) {
     _zip_error_set(&za->error, 
# 61 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c" 3 4
                               15
# 61 "project/radare2/shlr/zip/zip/zip_set_archive_flag.c"
                                             , 0);
     return -1;
 }
    }
