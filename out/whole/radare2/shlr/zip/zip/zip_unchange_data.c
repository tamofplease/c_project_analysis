# 0 "project/radare2/shlr/zip/zip/zip_unchange_data.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_unchange_data.c" 2
...
_zip_unchange_data(struct zip_entry *ze)
{
 ...
 ze->source = 
# 43 "project/radare2/shlr/zip/zip/zip_unchange_data.c" 3 4
             ((void *)0)
# 43 "project/radare2/shlr/zip/zip/zip_unchange_data.c"
                 ;
    }

    if (ze->changes != 
# 46 "project/radare2/shlr/zip/zip/zip_unchange_data.c" 3 4
                      ((void *)0) 
# 46 "project/radare2/shlr/zip/zip/zip_unchange_data.c"
                           && (ze->changes->changed & 0x0001u) && ze->changes->comp_method == (-2)) {
 ze->changes->changed &= ~0x0001u;
 if (ze->changes->changed == 0) {
     _zip_dirent_free(ze->changes);
     ze->changes = 
# 50 "project/radare2/shlr/zip/zip/zip_unchange_data.c" 3 4
                  ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_unchange_data.c"
                      ;
 }
    }
