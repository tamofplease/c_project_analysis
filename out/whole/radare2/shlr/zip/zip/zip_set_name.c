# 0 "project/radare2/shlr/zip/zip/zip_set_name.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_set_name.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_set_name.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_set_name.c" 2
...
# 52 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                           18
# 52 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                       , 0);
 return -1;
    }

    if (((za)->ch_flags & 
# 56 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
       2u
# 56 "project/radare2/shlr/zip/zip/zip_set_name.c"
       )) {
 _zip_error_set(&za->error, 
# 57 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                           25
# 57 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                        , 0);
 return -1;
    }
...
# 63 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                                                                                                       ((void *)0)
# 63 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                                                                                           )
     return -1;
 if ((flags & (
# 65 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
             0u
# 65 "project/radare2/shlr/zip/zip/zip_set_name.c"
             |
# 65 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
             4096u
# 65 "project/radare2/shlr/zip/zip/zip_set_name.c"
...
# 65 "project/radare2/shlr/zip/zip/zip_set_name.c"
 ...
 str = 
# 69 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
      ((void *)0)
# 69 "project/radare2/shlr/zip/zip/zip_set_name.c"
          ;


    if ((i=_zip_name_locate(za, name, 0, 
# 72 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                                        ((void *)0)
# 72 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                            )) >= 0 && (zip_uint64_t)i != idx) {
 _zip_string_free(str);
 _zip_error_set(&za->error, 
# 74 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                           10
# 74 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                        , 0);
 return -1;
    }
 ...
 e->changes->filename = 
# 88 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                       ((void *)0)
# 88 "project/radare2/shlr/zip/zip/zip_set_name.c"
                           ;
 e->changes->changed &= ~0x0002u;
    }
 ...
 changed = 1;
    ...
    if (changed) {
        if (e->changes == 
# 98 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                         ((void *)0)
# 98 "project/radare2/shlr/zip/zip/zip_set_name.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 99 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                                                          ((void *)0)
# 99 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                                              ) {
                _zip_error_set(&za->error, 
# 100 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                                          14
# 100 "project/radare2/shlr/zip/zip/zip_set_name.c"
                                                       , 0);
  _zip_string_free(str);
                return -1;
            }
 ...
 if (e->changes && e->changes->changed == 0) {
     ...
     e->changes = 
# 112 "project/radare2/shlr/zip/zip/zip_set_name.c" 3 4
                 ((void *)0)
# 112 "project/radare2/shlr/zip/zip/zip_set_name.c"
                     ;
 }
    }
