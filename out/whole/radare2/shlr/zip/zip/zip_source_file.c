# 0 "project/radare2/shlr/zip/zip/zip_source_file.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_file.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_file.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_file.c" 2




# 43 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
extern 
# 43 "project/radare2/shlr/zip/zip/zip_source_file.c"
          struct zip_source *
zip_source_file(struct zip *za, const char *fname, zip_uint64_t start,
  zip_int64_t len)
{
    if (za == 
# 47 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
             ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_source_file.c"
                 )
 return 
# 48 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
       ((void *)0)
# 48 "project/radare2/shlr/zip/zip/zip_source_file.c"
           ;

    if (fname == 
# 50 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
                ((void *)0) 
# 50 "project/radare2/shlr/zip/zip/zip_source_file.c"
                     || len < -1) {
 _zip_error_set(&za->error, 
# 51 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
                           18
# 51 "project/radare2/shlr/zip/zip/zip_source_file.c"
                                       , 0);
 return 
# 52 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
       ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_source_file.c"
           ;
    }

    return _zip_source_file_or_p(za, fname, 
# 55 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
                                           ((void *)0)
# 55 "project/radare2/shlr/zip/zip/zip_source_file.c"
                                               , start, len, 1, 
# 55 "project/radare2/shlr/zip/zip/zip_source_file.c" 3 4
                                                                ((void *)0)
# 55 "project/radare2/shlr/zip/zip/zip_source_file.c"
