# 0 "project/radare2/shlr/zip/zip/zip_close.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_close.c" 2
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/strings.h" 1 3 4
# 43 "project/radare2/shlr/zip/zip/zip_close.c" 2
...
# 45 "project/radare2/shlr/zip/zip/zip_close.c" 2
# 57 "project/radare2/shlr/zip/zip/zip_close.c"
#define MAX_DEFLATE_SIZE_32 4293656963u


# 59 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 68 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
extern 
# 68 "project/radare2/shlr/zip/zip/zip_close.c"
          int
zip_close(struct zip *za)
{
    ...
    if (za == 
# 85 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
             ((void *)0)
# 85 "project/radare2/shlr/zip/zip/zip_close.c"
                 )
 return -1;
    ...
    if (survivors == 0) {
 if (za->zn && ((za->open_flags & 
# 92 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                 8
# 92 "project/radare2/shlr/zip/zip/zip_close.c"
                                             ) || (changed && za->zp))) {
     if (remove(za->zn) != 0) {
  _zip_error_set(&za->error, 
# 94 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                            22
# 94 "project/radare2/shlr/zip/zip/zip_close.c"
                                         , 
# 94 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                           (*__error())
# 94 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 return 0;
    ...
    if (survivors > za->nentry) {
        _zip_error_set(&za->error, 
# 108 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                  20
# 108 "project/radare2/shlr/zip/zip/zip_close.c"
                                                 , 0);
        return -1;
    }

    if ((filelist=(struct zip_filelist *)malloc(sizeof(filelist[0])*survivors)) == 
# 112 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                                                  ((void *)0)
# 112 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                                      )
 return -1;


    if (zip_get_archive_flag(za, 
# 116 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                1u
# 116 "project/radare2/shlr/zip/zip/zip_close.c"
                                               , 0)) {

 if (zip_set_archive_comment(za, "TORRENTZIPPED-" "XXXXXXXX", 14 + 8) < 0) {
     free(filelist);
     return -1;
 }
    }
 ...
 if (za->entry[i].deleted)
     continue;
        ...
        if (j >= survivors) {
            free(filelist);
            _zip_error_set(&za->error, 
# 133 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                      20
# 133 "project/radare2/shlr/zip/zip/zip_close.c"
                                                     , 0);
            return -1;
        }
 filelist[j].idx = i;
 ...
 j++;
    ...
    if (j < survivors) {
        free(filelist);
        _zip_error_set(&za->error, 
# 142 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                  20
# 142 "project/radare2/shlr/zip/zip/zip_close.c"
                                                 , 0);
        return -1;
    }
...
# 147 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                   ((void *)0)
# 147 "project/radare2/shlr/zip/zip/zip_close.c"
                                                       ) {
 free(filelist);
 return -1;
    }
    ...
    if (zip_get_archive_flag(za, 
# 152 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                1u
# 152 "project/radare2/shlr/zip/zip/zip_close.c"
                                               , 0))
 qsort(filelist, survivors, sizeof(filelist[0]),
       _zip_torrentzip_cmp);

    new_torrentzip = (zip_get_archive_flag(za, 
# 156 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                              1u
# 156 "project/radare2/shlr/zip/zip/zip_close.c"
                                                             , 0) == 1
        && zip_get_archive_flag(za, 
# 157 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                   1u
# 157 "project/radare2/shlr/zip/zip/zip_close.c"
                                                  ,
           
# 158 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
          8u
# 158 "project/radare2/shlr/zip/zip/zip_close.c"
                          ) == 0);
    error = 0;
...
# 168 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
            ((void *)0)
# 168 "project/radare2/shlr/zip/zip/zip_close.c"
            ) || new_torrentzip || ((entry)->changes && ((entry)->changes->changed & (0x0001u))));


 if (entry->changes == 
# 171 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                      ((void *)0)
# 171 "project/radare2/shlr/zip/zip/zip_close.c"
                          ) {
     if ((entry->changes=_zip_dirent_clone(entry->orig)) == 
# 172 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                           ((void *)0)
# 172 "project/radare2/shlr/zip/zip/zip_close.c"
                                                               ) {
                _zip_error_set(&za->error, 
# 173 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                          14
# 173 "project/radare2/shlr/zip/zip/zip_close.c"
                                                       , 0);
                error = 1;
                break;
     }
 ...
 if (zip_get_archive_flag(za, 
# 185 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                             1u
# 185 "project/radare2/shlr/zip/zip/zip_close.c"
                                            , 0))
     _zip_dirent_torrent_normalize(entry->changes);


 de->offset = (zip_uint64_t)ftell(out);

 if (new_data) {
     struct zip_source *zs;

     zs = 
# 194 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
         ((void *)0)
# 194 "project/radare2/shlr/zip/zip/zip_close.c"
             ;
     if (!((entry)->source != 
# 195 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
         ((void *)0)
# 195 "project/radare2/shlr/zip/zip/zip_close.c"
         )) {
  if ((zs=_zip_source_zip_new(za, za, i, 
# 196 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                        8u
# 196 "project/radare2/shlr/zip/zip/zip_close.c"
                                                        , 0, 0, 
# 196 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                                ((void *)0)
# 196 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 196 "project/radare2/shlr/zip/zip/zip_close.c"
  ...
  zip_source_free(zs);
     ...
     de->bitflags &= ~0x0008;
     if (_zip_dirent_write(de, out, 
# 217 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                   256u
# 217 "project/radare2/shlr/zip/zip/zip_close.c"
                                               , &za->error) < 0) {
  error = 1;
  break;
     }
...
# 225 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                      0
# 225 "project/radare2/shlr/zip/zip/zip_close.c"
                                              ) < 0)) {
  _zip_error_set(&za->error, 
# 226 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                            4
# 226 "project/radare2/shlr/zip/zip/zip_close.c"
                                       , 
# 226 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                         (*__error())
# 226 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 return -1;
    ...
    if (fclose(out) != 0) {
 _zip_error_set(&za->error, 
# 252 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           3
# 252 "project/radare2/shlr/zip/zip/zip_close.c"
                                       , 
# 252 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                         (*__error())
# 252 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 fclose(za->zp);
 za->zp = 
# 259 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
         ((void *)0)
# 259 "project/radare2/shlr/zip/zip/zip_close.c"
             ;
 reopen_on_error = 1;
    }
    if (rename(temp, za->zn) != 0) {
 _zip_error_set(&za->error, 
# 263 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           2
# 263 "project/radare2/shlr/zip/zip/zip_close.c"
                                        , 
# 263 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                          (*__error())
# 263 "project/radare2/shlr/zip/zip/zip_close.c"
...
add_data(struct zip *za, struct zip_source *src, struct zip_dirent *de, FILE *ft)
{
 ...
 return -1;
    ...
    if ((st.valid & 
# 300 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                   0x0040u
# 300 "project/radare2/shlr/zip/zip/zip_close.c"
                                       ) == 0) {
 st.valid |= 
# 301 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
            0x0040u
# 301 "project/radare2/shlr/zip/zip/zip_close.c"
                                ;
 st.comp_method = 
# 302 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                 0
# 302 "project/radare2/shlr/zip/zip/zip_close.c"
                             ;
    }

    if (((de->comp_method) == 
# 305 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       -1 
# 305 "project/radare2/shlr/zip/zip/zip_close.c"
       || (de->comp_method) == (-2)) && st.comp_method != 
# 305 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                               0
# 305 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                           )
 de->comp_method = st.comp_method;
    else if (de->comp_method == 
# 307 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                               0 
# 307 "project/radare2/shlr/zip/zip/zip_close.c"
                                            && (st.valid & 
# 307 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                           0x0004u
# 307 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 st.valid |= 
# 308 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
            0x0008u
# 308 "project/radare2/shlr/zip/zip/zip_close.c"
                              ;
 ...
 st.valid &= ~
# 313 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
             0x0008u
# 313 "project/radare2/shlr/zip/zip/zip_close.c"
                               ;
    }


    flags = 
# 317 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
           256u
# 317 "project/radare2/shlr/zip/zip/zip_close.c"
                       ;

    if ((st.valid & 
# 319 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                   0x0004u
# 319 "project/radare2/shlr/zip/zip/zip_close.c"
                                ) == 0)
 flags |= 1024;
    else {
 ...
 if ((st.valid & 
# 324 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                0x0008u
# 324 "project/radare2/shlr/zip/zip/zip_close.c"
                                  ) == 0) {
     if (( ((de->comp_method == 
# 325 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                               8 
# 325 "project/radare2/shlr/zip/zip/zip_close.c"
                                              || ((de->comp_method) == 
# 325 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                 -1 
# 325 "project/radare2/shlr/zip/zip/zip_close.c"
                                                 || (de->comp_method) == (-2))) && st.size > 4293656963u)
   || (de->comp_method != 
# 326 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                         0 
# 326 "project/radare2/shlr/zip/zip/zip_close.c"
                                      && de->comp_method != 
# 326 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                            8 
# 326 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 326 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 return -1;
    ...
    if (st.comp_method == 
# 342 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                         0 
# 342 "project/radare2/shlr/zip/zip/zip_close.c"
                                      || (((de->comp_method) == 
# 342 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                          -1 
# 342 "project/radare2/shlr/zip/zip/zip_close.c"
                                          || (de->comp_method) == (-2)) && st.comp_method != de->comp_method)) {
 struct zip_source *s_store, *s_crc;
 zip_compression_implementation comp_impl;

 if (st.comp_method != 
# 346 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                      0
# 346 "project/radare2/shlr/zip/zip/zip_close.c"
                                  ) {
     if ((comp_impl=_zip_get_compression_implementation(st.comp_method)) == 
# 347 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                                           ((void *)0)
# 347 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                               ) {
  _zip_error_set(&za->error, 
# 348 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                            16
# 348 "project/radare2/shlr/zip/zip/zip_close.c"
                                              , 0);
  return -1;
     }
     if ((s_store=comp_impl(za, src, st.comp_method, 
# 351 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                    0
# 351 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                    )) == 
# 351 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                                          ((void *)0)
# 351 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 359 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                              ((void *)0)
# 359 "project/radare2/shlr/zip/zip/zip_close.c"
                                                  ) {
     if (s_store != src)
 ...
 if (de->comp_method != 
# 366 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                       0 
# 366 "project/radare2/shlr/zip/zip/zip_close.c"
                                    && ((st.valid & 
# 366 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                    0x0004u
# 366 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 367 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                                            ((void *)0)
# 367 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                                ) {
  _zip_error_set(&za->error, 
# 368 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                            16
# 368 "project/radare2/shlr/zip/zip/zip_close.c"
                                              , 0);
  ...
  return -1;
     ...
     if ((s2=comp_impl(za, s_crc, de->comp_method, 
# 374 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                  1
# 374 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                  )) == 
# 374 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                                        ((void *)0)
# 374 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 395 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                               ((void *)0)
# 395 "project/radare2/shlr/zip/zip/zip_close.c"
                                   ) {
 ...
 if (offend < 0)
  return -1;
    ...
    if (fseek(ft, offstart, 
# 409 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                            0
# 409 "project/radare2/shlr/zip/zip/zip_close.c"
                                    ) < 0) {
 _zip_error_set(&za->error, 
# 410 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           4
# 410 "project/radare2/shlr/zip/zip/zip_close.c"
                                      , 
# 410 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                        (*__error())
# 410 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 return -1;
    ...
    if ((st.valid & (
# 414 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                    0x0040u
# 414 "project/radare2/shlr/zip/zip/zip_close.c"
                                        |
# 414 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                         0x0020u
# 414 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 414 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 _zip_error_set(&za->error, 
# 415 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           20
# 415 "project/radare2/shlr/zip/zip/zip_close.c"
                                          , 0);
 return -1;
    }

    if (st.valid & 
# 419 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                  0x0010u
# 419 "project/radare2/shlr/zip/zip/zip_close.c"
                                )
 ...
 time(&de->last_mod);
    ...
    if (zip_get_archive_flag(za, 
# 428 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                1u
# 428 "project/radare2/shlr/zip/zip/zip_close.c"
                                               , 0))
 ...
 _zip_error_set(&za->error, 
# 436 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           20
# 436 "project/radare2/shlr/zip/zip/zip_close.c"
                                          , 0);
 return -1;
    }
    ...
    if (fseek(ft, offend, 
# 441 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                          0
# 441 "project/radare2/shlr/zip/zip/zip_close.c"
                                  ) < 0) {
 _zip_error_set(&za->error, 
# 442 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           4
# 442 "project/radare2/shlr/zip/zip/zip_close.c"
                                      , 
# 442 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                        (*__error())
# 442 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 464 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                     5
# 464 "project/radare2/shlr/zip/zip/zip_close.c"
                                                , 
# 464 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                  (*__error())
# 464 "project/radare2/shlr/zip/zip/zip_close.c"
                ...
                _zip_error_set(error, 
# 468 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                     17
# 468 "project/radare2/shlr/zip/zip/zip_close.c"
                                               , 0);
                return -1;
            }
        }
 ...
 if (fwrite(buf, 1, n, ft) != (size_t)n) {
     _zip_error_set(error, 
# 474 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                          6
# 474 "project/radare2/shlr/zip/zip/zip_close.c"
                                      , 
# 474 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                        (*__error())
# 474 "project/radare2/shlr/zip/zip/zip_close.c"
...
copy_source(struct zip *za, struct zip_source *src, FILE *ft)
{
 ...
 if (fwrite(buf, 1, (size_t)n, ft) != (size_t)n) {
     _zip_error_set(&za->error, 
# 501 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                               6
# 501 "project/radare2/shlr/zip/zip/zip_close.c"
                                           , 
# 501 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                             (*__error())
# 501 "project/radare2/shlr/zip/zip/zip_close.c"
...
write_cdir(struct zip *za, const struct zip_filelist *filelist, zip_uint64_t survivors, FILE *out)
{
 ...
 return -1;
    ...
    if (zip_get_archive_flag(za, 
# 537 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                1u
# 537 "project/radare2/shlr/zip/zip/zip_close.c"
                                               , 0) == 0)
 return 0;
...
# 546 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
   __builtin___snprintf_chk (
# 546 "project/radare2/shlr/zip/zip/zip_close.c"
   buf
# 546 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
   , 
# 546 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 546 "project/radare2/shlr/zip/zip/zip_close.c"
    ...
    if (fseek(out, end-8, 
# 548 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                        0
# 548 "project/radare2/shlr/zip/zip/zip_close.c"
                                                ) < 0) {
 _zip_error_set(&za->error, 
# 549 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           4
# 549 "project/radare2/shlr/zip/zip/zip_close.c"
                                      , 
# 549 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                        (*__error())
# 549 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 _zip_error_set(&za->error, 
# 554 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           6
# 554 "project/radare2/shlr/zip/zip/zip_close.c"
                                       , 
# 554 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                         (*__error())
# 554 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 598 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                            ((void *)0)
# 598 "project/radare2/shlr/zip/zip/zip_close.c"
                                                                ) {
            _zip_error_set(&za->error, 
# 599 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                      14
# 599 "project/radare2/shlr/zip/zip/zip_close.c"
                                                   , 0);
            return 
# 600 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                  ((void *)0)
# 600 "project/radare2/shlr/zip/zip/zip_close.c"
                      ;
        }
        
# 602 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       __builtin___sprintf_chk (
# 602 "project/radare2/shlr/zip/zip/zip_close.c"
       temp
# 602 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       , 0, __builtin_object_size (
# 602 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 605 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                                      ((void *)0)
# 605 "project/radare2/shlr/zip/zip/zip_close.c"
                                                          ) {
            _zip_error_set(&za->error, 
# 606 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                      14
# 606 "project/radare2/shlr/zip/zip/zip_close.c"
                                                   , 0);
            return 
# 607 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                  ((void *)0)
# 607 "project/radare2/shlr/zip/zip/zip_close.c"
                      ;
        }
        
# 609 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       __builtin___sprintf_chk (
# 609 "project/radare2/shlr/zip/zip/zip_close.c"
       temp
# 609 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       , 0, __builtin_object_size (
# 609 "project/radare2/shlr/zip/zip/zip_close.c"
...
# 609 "project/radare2/shlr/zip/zip/zip_close.c"
    ...
    if ((tfd=open(temp, 
# 612 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                       0x0002
# 612 "project/radare2/shlr/zip/zip/zip_close.c"
                             |
# 612 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                              0x00000200
# 612 "project/radare2/shlr/zip/zip/zip_close.c"
                                     , 0644)) == -1) {
 _zip_error_set(&za->error, 
# 613 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           12
# 613 "project/radare2/shlr/zip/zip/zip_close.c"
                                         , 
# 613 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                           (*__error())
# 613 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 free(temp);
 return 
# 615 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       ((void *)0)
# 615 "project/radare2/shlr/zip/zip/zip_close.c"
           ;
    }
# 626 "project/radare2/shlr/zip/zip/zip_close.c"
    if ((tfp=fdopen(tfd, "r+b")) == 
# 626 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                   ((void *)0)
# 626 "project/radare2/shlr/zip/zip/zip_close.c"
                                       ) {
 _zip_error_set(&za->error, 
# 627 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                           12
# 627 "project/radare2/shlr/zip/zip/zip_close.c"
                                         , 
# 627 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                                           (*__error())
# 627 "project/radare2/shlr/zip/zip/zip_close.c"
 ...
 free(temp);
 return 
# 631 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
       ((void *)0)
# 631 "project/radare2/shlr/zip/zip/zip_close.c"
           ;
    }
# 652 "project/radare2/shlr/zip/zip/zip_close.c"
    *outp = tfp;
    return temp;
}
...
_zip_torrentzip_cmp(const void *a, const void *b)
{
    ...
    if (aname == 
# 664 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                ((void *)0)
# 664 "project/radare2/shlr/zip/zip/zip_close.c"
                    )
 return (bname != 
# 665 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                 ((void *)0)
# 665 "project/radare2/shlr/zip/zip/zip_close.c"
                     ) * -1;
    else if (bname == 
# 666 "project/radare2/shlr/zip/zip/zip_close.c" 3 4
                     ((void *)0)
# 666 "project/radare2/shlr/zip/zip/zip_close.c"
                         )
 return 1;
