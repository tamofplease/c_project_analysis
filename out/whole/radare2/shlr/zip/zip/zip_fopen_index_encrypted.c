# 0 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 2
...
# 41 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 2
...
# 46 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
extern 
# 46 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
          struct zip_file *
...
# 53 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
                                                                          ((void *)0)
# 53 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                                                                              )
 return 
# 54 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 54 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
           ;
 ...
 zip_source_free(src);
 return 
# 59 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 59 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
           ;
    }

    if ((zf=_zip_file_new(za)) == 
# 62 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
                                 ((void *)0)
# 62 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                                     ) {
 zip_source_free(src);
 return 
# 64 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 64 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
           ;
    }
...
# 79 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
                                                                  ((void *)0)
# 79 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                                                                      ) {
 _zip_error_set(&za->error, 
# 80 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
                           14
# 80 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                                        , 0);
 return 
# 81 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 81 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
           ;
    }
 ...
 if (file == 
# 89 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
            ((void *)0)
# 89 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                ) {
     _zip_error_set(&za->error, 
# 90 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
                               14
# 90 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                                            , 0);
     free(zf);
     return 
# 92 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
           ((void *)0)
# 92 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
               ;
 }
 za->nfile_alloc = n;
 za->file = file;
    ...
    zf->eof = 0;
    zf->src = 
# 103 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c" 3 4
             ((void *)0)
# 103 "project/radare2/shlr/zip/zip/zip_fopen_index_encrypted.c"
                 ;
