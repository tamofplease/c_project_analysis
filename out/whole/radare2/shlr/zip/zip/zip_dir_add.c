# 0 "project/radare2/shlr/zip/zip/zip_dir_add.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_dir_add.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_dir_add.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_dir_add.c" 2
...
# 45 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
extern 
# 45 "project/radare2/shlr/zip/zip/zip_dir_add.c"
          zip_int64_t
zip_dir_add(struct zip *za, const char *name, zip_flags_t flags)
{
    ...
    if (((za)->ch_flags & 
# 53 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
       2u
# 53 "project/radare2/shlr/zip/zip/zip_dir_add.c"
       )) {
 _zip_error_set(&za->error, 
# 54 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                           25
# 54 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                                        , 0);
 return -1;
    }

    if (name == 
# 58 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
               ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                   ) {
 _zip_error_set(&za->error, 
# 59 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                           18
# 59 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                                       , 0);
 return -1;
    }

    s = 
# 63 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
       ((void *)0)
# 63 "project/radare2/shlr/zip/zip/zip_dir_add.c"
           ;
    len = strlen(name);

    if (name[len-1] != '/') {
 if ((s=(char *)malloc(len+2)) == 
# 67 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                                 ((void *)0)
# 67 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                                     ) {
     _zip_error_set(&za->error, 
# 68 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                               14
# 68 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                                            , 0);
     return -1;
 }
 
# 71 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
__builtin___strcpy_chk (
# 71 "project/radare2/shlr/zip/zip/zip_dir_add.c"
s
# 71 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
, 
# 71 "project/radare2/shlr/zip/zip/zip_dir_add.c"
...
# 71 "project/radare2/shlr/zip/zip/zip_dir_add.c"
 ...
 s[len+1] = '\0';
    ...
    if ((source=zip_source_buffer(za, 
# 76 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                                     ((void *)0)
# 76 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                                         , 0, 0)) == 
# 76 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                                                     ((void *)0)
# 76 "project/radare2/shlr/zip/zip/zip_dir_add.c"
 ...
 return -1;
    ...
    ret = _zip_file_replace(za, 
# 81 "project/radare2/shlr/zip/zip/zip_dir_add.c" 3 4
                               0xFFFFFFFFFFFFFFFFULL
# 81 "project/radare2/shlr/zip/zip/zip_dir_add.c"
                                             , s ? s : name, source, flags);
