# 0 "project/radare2/shlr/zip/zip/zip_source_error.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_error.c" 2
...
zip_source_error(struct zip_source *src, int *ze, int *se)
{
    ...
    if (src->src == 
# 45 "project/radare2/shlr/zip/zip/zip_source_error.c" 3 4
                   ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_source_error.c"
                       ) {
        if (src->cb.f(src->ud, e, sizeof(e), ZIP_SOURCE_ERROR) < 0) {
            e[0] = 
# 47 "project/radare2/shlr/zip/zip/zip_source_error.c" 3 4
                  20
# 47 "project/radare2/shlr/zip/zip/zip_source_error.c"
                                 ;
            e[1] = 0;
        }
    }
 ...
 case ZIP_LES_INVAL:
     e[0] = 
# 58 "project/radare2/shlr/zip/zip/zip_source_error.c" 3 4
           18
# 58 "project/radare2/shlr/zip/zip/zip_source_error.c"
                       ;
     e[1] = 0;
     break;
 ...
 case ZIP_LES_UPPER:
  ...
  e[0] = 
# 68 "project/radare2/shlr/zip/zip/zip_source_error.c" 3 4
        20
# 68 "project/radare2/shlr/zip/zip/zip_source_error.c"
                       ;
  e[1] = 0;
     }
     break;
 ...
 default:
     e[0] = 
# 74 "project/radare2/shlr/zip/zip/zip_source_error.c" 3 4
           20
# 74 "project/radare2/shlr/zip/zip/zip_source_error.c"
                          ;
     e[1] = 0;
     break;
 }
