# 0 "project/radare2/shlr/zip/zip/zip_file_rename.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_file_rename.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_file_rename.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_file_rename.c"
          int
zip_file_rename(struct zip *za, zip_uint64_t idx, const char *name, zip_flags_t flags)
{
    ...
    if (idx >= za->nentry || (name != 
# 48 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                                     ((void *)0) 
# 48 "project/radare2/shlr/zip/zip/zip_file_rename.c"
                                          && strlen(name) > 
# 48 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                                                            0xFFFFU
# 48 "project/radare2/shlr/zip/zip/zip_file_rename.c"
...
# 49 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                           18
# 49 "project/radare2/shlr/zip/zip/zip_file_rename.c"
                                       , 0);
 return -1;
    }

    if (((za)->ch_flags & 
# 53 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
       2u
# 53 "project/radare2/shlr/zip/zip/zip_file_rename.c"
       )) {
 _zip_error_set(&za->error, 
# 54 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                           25
# 54 "project/radare2/shlr/zip/zip/zip_file_rename.c"
                                        , 0);
 return -1;
    }

    if ((old_name=zip_get_name(za, idx, 0)) == 
# 58 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                                              ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_file_rename.c"
                                                  )
 return -1;

    new_is_dir = (name != 
# 61 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                         ((void *)0) 
# 61 "project/radare2/shlr/zip/zip/zip_file_rename.c"
                              && name[strlen(name)-1] == '/');
    old_is_dir = (old_name[strlen(old_name)-1] == '/');

    if (new_is_dir != old_is_dir) {
 _zip_error_set(&za->error, 
# 65 "project/radare2/shlr/zip/zip/zip_file_rename.c" 3 4
                           18
# 65 "project/radare2/shlr/zip/zip/zip_file_rename.c"
                                       , 0);
 return -1;
    }
