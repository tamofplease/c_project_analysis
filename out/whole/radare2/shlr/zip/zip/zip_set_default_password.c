# 0 "project/radare2/shlr/zip/zip/zip_set_default_password.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 2




# 43 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 3 4
extern 
# 43 "project/radare2/shlr/zip/zip/zip_set_default_password.c"
          int
zip_set_default_password(struct zip *za, const char *passwd)
{
    if (za == 
# 46 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 3 4
             ((void *)0)
# 46 "project/radare2/shlr/zip/zip/zip_set_default_password.c"
                 )
 return -1;
 ...
 free(za->default_password);
    ...
    if (passwd) {
 if ((za->default_password=strdup(passwd)) == 
# 53 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 3 4
                                             ((void *)0)
# 53 "project/radare2/shlr/zip/zip/zip_set_default_password.c"
                                                 ) {
     _zip_error_set(&za->error, 
# 54 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 3 4
                               14
# 54 "project/radare2/shlr/zip/zip/zip_set_default_password.c"
                                            , 0);
     return -1;
 }
    }
 ...
 za->default_password = 
# 59 "project/radare2/shlr/zip/zip/zip_set_default_password.c" 3 4
                       ((void *)0)
# 59 "project/radare2/shlr/zip/zip/zip_set_default_password.c"
                           ;
