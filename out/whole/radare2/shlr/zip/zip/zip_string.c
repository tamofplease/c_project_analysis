# 0 "project/radare2/shlr/zip/zip/zip_string.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_string.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_string.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_string.c" 2
...
_zip_string_crc32(const struct zip_string *s)
{
    ...
    crc = (zip_uint32_t)crc32(0L, 
# 48 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                                 0
# 48 "project/radare2/shlr/zip/zip/zip_string.c"
                                       , 0);

    if (s != 
# 50 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
            ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_string.c"
                )
...
{
    if (a == 
# 61 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
            ((void *)0) 
# 61 "project/radare2/shlr/zip/zip/zip_string.c"
                 || b == 
# 61 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                         ((void *)0)
# 61 "project/radare2/shlr/zip/zip/zip_string.c"
...
{
    if (s == 
# 77 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
            ((void *)0)
# 77 "project/radare2/shlr/zip/zip/zip_string.c"
                )
 return;
...
_zip_string_get(struct zip_string *string, zip_uint32_t *lenp, zip_flags_t flags, struct zip_error *error)
{
    ...
    if (string == 
# 92 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                 ((void *)0)
# 92 "project/radare2/shlr/zip/zip/zip_string.c"
                     ) {
 if (lenp)
     *lenp = 0;
 return empty;
    ...
    if ((flags & 
# 98 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                64u
# 98 "project/radare2/shlr/zip/zip/zip_string.c"
                              ) == 0) {
 ...
 if (((flags & 
# 103 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
              128u
# 103 "project/radare2/shlr/zip/zip/zip_string.c"
                               )
      && string->encoding != ZIP_ENCODING_ASCII && string->encoding != ZIP_ENCODING_UTF8_KNOWN)
     || (string->encoding == ZIP_ENCODING_CP437)) {
     if (string->converted == 
# 106 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                             ((void *)0)
# 106 "project/radare2/shlr/zip/zip/zip_string.c"
                                 ) {
  if ((string->converted=_zip_cp437_to_utf8(string->raw, string->length,
         &string->converted_length, error)) == 
# 108 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                                              ((void *)0)
# 108 "project/radare2/shlr/zip/zip/zip_string.c"
                                                  )
      return 
# 109 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
            ((void *)0)
# 109 "project/radare2/shlr/zip/zip/zip_string.c"
                ;
     }
     if (lenp)
...
{
    if (s == 
# 127 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
            ((void *)0)
# 127 "project/radare2/shlr/zip/zip/zip_string.c"
                )
 return 0;
...
_zip_string_new(const zip_uint8_t *raw, zip_uint16_t length, zip_flags_t flags, struct zip_error *error)
{
    ...
    if (length == 0)
 return 
# 142 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
       ((void *)0)
# 142 "project/radare2/shlr/zip/zip/zip_string.c"
           ;

    switch (flags & (
# 144 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                   0u
# 144 "project/radare2/shlr/zip/zip/zip_string.c"
                   |
# 144 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                   4096u
# 144 "project/radare2/shlr/zip/zip/zip_string.c"
...
# 144 "project/radare2/shlr/zip/zip/zip_string.c"
    ...
    case 
# 145 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
        0u
# 145 "project/radare2/shlr/zip/zip/zip_string.c"
                        :
 expected_encoding = ZIP_ENCODING_UNKNOWN;
 break;
    case 
# 148 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
        2048u
# 148 "project/radare2/shlr/zip/zip/zip_string.c"
                        :
 expected_encoding = ZIP_ENCODING_UTF8_KNOWN;
 break;
    case 
# 151 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
        4096u
# 151 "project/radare2/shlr/zip/zip/zip_string.c"
                        :
 expected_encoding = ZIP_ENCODING_CP437;
 break;
    default:
 _zip_error_set(error, 
# 155 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                      18
# 155 "project/radare2/shlr/zip/zip/zip_string.c"
                                  , 0);
 return 
# 156 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
       ((void *)0)
# 156 "project/radare2/shlr/zip/zip/zip_string.c"
           ;
    }

    if ((s=(struct zip_string *)malloc(sizeof(*s))) == 
# 159 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                                                      ((void *)0)
# 159 "project/radare2/shlr/zip/zip/zip_string.c"
                                                          ) {
 _zip_error_set(error, 
# 160 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                      14
# 160 "project/radare2/shlr/zip/zip/zip_string.c"
                                   , 0);
 return 
# 161 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
       ((void *)0)
# 161 "project/radare2/shlr/zip/zip/zip_string.c"
           ;
    }

    if ((s->raw=(zip_uint8_t *)malloc(length+1)) == 
# 164 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                                                   ((void *)0)
# 164 "project/radare2/shlr/zip/zip/zip_string.c"
                                                       ) {
 free(s);
 return 
# 166 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
       ((void *)0)
# 166 "project/radare2/shlr/zip/zip/zip_string.c"
           ;
    }

    
# 169 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
   __builtin___memcpy_chk (
# 169 "project/radare2/shlr/zip/zip/zip_string.c"
   s->raw
# 169 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
   , 
# 169 "project/radare2/shlr/zip/zip/zip_string.c"
...
# 169 "project/radare2/shlr/zip/zip/zip_string.c"
    ...
    s->converted = 
# 173 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                  ((void *)0)
# 173 "project/radare2/shlr/zip/zip/zip_string.c"
                      ;
 ...
 if (_zip_guess_encoding(s, expected_encoding) == ZIP_ENCODING_ERROR) {
     _zip_string_free(s);
     _zip_error_set(error, 
# 179 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
                          18
# 179 "project/radare2/shlr/zip/zip/zip_string.c"
                                      , 0);
     return 
# 180 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
           ((void *)0)
# 180 "project/radare2/shlr/zip/zip/zip_string.c"
               ;
 }
    }
...
{
    if (s == 
# 192 "project/radare2/shlr/zip/zip/zip_string.c" 3 4
            ((void *)0)
# 192 "project/radare2/shlr/zip/zip/zip_string.c"
                )
 return;
