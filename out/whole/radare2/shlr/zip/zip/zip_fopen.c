# 0 "project/radare2/shlr/zip/zip/zip_fopen.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_fopen.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_fopen.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_fopen.c"
          struct zip_file *
zip_fopen(struct zip *za, const char *fname, zip_flags_t flags)
{
 ...
 return 
# 46 "project/radare2/shlr/zip/zip/zip_fopen.c" 3 4
       ((void *)0)
# 46 "project/radare2/shlr/zip/zip/zip_fopen.c"
           ;
