# 0 "project/radare2/shlr/zip/zip/zip_discard.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_discard.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_discard.c" 2
...
zip_discard(struct zip *za)
{
    ...
    if (za == 
# 51 "project/radare2/shlr/zip/zip/zip_discard.c" 3 4
             ((void *)0)
# 51 "project/radare2/shlr/zip/zip/zip_discard.c"
                 )
 return;
 ...
 if (za->file[i]->error.zip_err == 
# 71 "project/radare2/shlr/zip/zip/zip_discard.c" 3 4
                                  0
# 71 "project/radare2/shlr/zip/zip/zip_discard.c"
                                           ) {
     _zip_error_set(&za->file[i]->error, 
# 72 "project/radare2/shlr/zip/zip/zip_discard.c" 3 4
                                        8
# 72 "project/radare2/shlr/zip/zip/zip_discard.c"
                                                        , 0);
     za->file[i]->za = 
# 73 "project/radare2/shlr/zip/zip/zip_discard.c" 3 4
                      ((void *)0)
# 73 "project/radare2/shlr/zip/zip/zip_discard.c"
                          ;
 }
    }
