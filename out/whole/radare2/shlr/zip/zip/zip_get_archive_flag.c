# 0 "project/radare2/shlr/zip/zip/zip_get_archive_flag.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_get_archive_flag.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_get_archive_flag.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_get_archive_flag.c"
          int
zip_get_archive_flag(struct zip *za, unsigned int flag, zip_flags_t flags)
{
    ...
    fl = (flags & 
# 45 "project/radare2/shlr/zip/zip/zip_get_archive_flag.c" 3 4
                 8u
# 45 "project/radare2/shlr/zip/zip/zip_get_archive_flag.c"
                                 ) ? za->flags : za->ch_flags;
