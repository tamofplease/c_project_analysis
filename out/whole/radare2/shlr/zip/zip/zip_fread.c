# 0 "project/radare2/shlr/zip/zip/zip_fread.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_fread.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_fread.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_fread.c"
          zip_int64_t
zip_fread(struct zip_file *zf, void *outbuf, zip_uint64_t toread)
{
 ...
 return -1;
    ...
    if (toread > 
# 51 "project/radare2/shlr/zip/zip/zip_fread.c" 3 4
                ((long long)0x7FFFFFFFFFFFFFFFULL)
# 51 "project/radare2/shlr/zip/zip/zip_fread.c"
                             ) {
 _zip_error_set(&zf->error, 
# 52 "project/radare2/shlr/zip/zip/zip_fread.c" 3 4
                           18
# 52 "project/radare2/shlr/zip/zip/zip_fread.c"
                                       , 0);
 return -1;
    }
