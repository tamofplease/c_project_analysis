# 0 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c"
          const char *
zip_get_archive_comment(struct zip *za, int *lenp, zip_flags_t flags)
{
    ...
    if ((flags & 
# 49 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 3 4
                8u
# 49 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c"
                                ) || (za->comment_changes == 
# 49 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 3 4
                                                             ((void *)0)
# 49 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c"
...
# 54 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 3 4
                                                                  ((void *)0)
# 54 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c"
                                                                      )
 return 
# 55 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c" 3 4
       ((void *)0)
# 55 "project/radare2/shlr/zip/zip/zip_get_archive_comment.c"
           ;
