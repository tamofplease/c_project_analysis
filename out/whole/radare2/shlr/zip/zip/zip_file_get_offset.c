# 0 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
# 41 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
# 42 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
# 477 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/zip/include/zconf.h" 3 4
#define z_off_t long
...
# 44 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 2
...
_zip_file_get_offset(const struct zip *za, zip_uint64_t idx, struct zip_error *error)
{
    ...
    if (fseek(za->zp, (off_t)offset, 
# 61 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                                     0
# 61 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
                                             ) != 0) {
 _zip_error_set(error, 
# 62 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                      4
# 62 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
                                 , 
# 62 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                                   (*__error())
# 62 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
 ...
 return 0;
    ...
    if ((size=_zip_dirent_size(za->zp, 
# 67 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                                      256u
# 67 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
                                                  , error)) < 0)
 return 0;

    if (offset+(zip_uint32_t)size > 
# 70 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                                   ((long long)0x7FFFFFFFFFFFFFFFULL)
# 70 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
                                              ) {
        _zip_error_set(error, 
# 71 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                             4
# 71 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
                                        , 
# 71 "project/radare2/shlr/zip/zip/zip_file_get_offset.c" 3 4
                                          27
# 71 "project/radare2/shlr/zip/zip/zip_file_get_offset.c"
