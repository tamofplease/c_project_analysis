# 0 "project/radare2/shlr/zip/zip/zip_stat_index.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_stat_index.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_stat_index.c"
          int
        ...
        struct zip_stat *st)
{
    ...
    if ((de=_zip_get_dirent(za, index, flags, 
# 47 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                                             ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                                 )) == 
# 47 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                                                       ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_stat_index.c"
...
# 50 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                                                ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                                    )
 return -1;


    if ((flags & 
# 54 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                8u
# 54 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                ) == 0
 && ((za->entry+index)->source != 
# 55 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
   ((void *)0)
# 55 "project/radare2/shlr/zip/zip/zip_stat_index.c"
   )) {
 if (zip_source_stat(za->entry[index].source, st) < 0) {
     _zip_error_set(&za->error, 
# 57 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                               15
# 57 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                             , 0);
     return -1;
 }
    }
 ...
 if (de->bitflags & 0x0001) {
     if (de->bitflags & 0x0040) {

  st->encryption_method = 
# 72 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                         0xffff
# 72 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                       ;
     }
     else
  st->encryption_method = 
# 75 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                         1
# 75 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                           ;
 }
 else
     st->encryption_method = 
# 78 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                            0
# 78 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                                       ;
 st->valid = 
# 79 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
            0x0020u
# 79 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                        |
# 79 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                         0x0004u
# 79 "project/radare2/shlr/zip/zip/zip_stat_index.c"
...
# 80 "project/radare2/shlr/zip/zip/zip_stat_index.c"
    |
# 80 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
     0x0008u
# 80 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                       |
# 80 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
...
# 80 "project/radare2/shlr/zip/zip/zip_stat_index.c"
    ...
    st->name = name;
    st->valid |= 
# 85 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                0x0002u
# 85 "project/radare2/shlr/zip/zip/zip_stat_index.c"
                              |
# 85 "project/radare2/shlr/zip/zip/zip_stat_index.c" 3 4
                               0x0001u
# 85 "project/radare2/shlr/zip/zip/zip_stat_index.c"
