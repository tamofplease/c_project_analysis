# 0 "project/radare2/shlr/zip/zip/zip_error_get_sys_type.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_error_get_sys_type.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_error_get_sys_type.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_error_get_sys_type.c"
          int
