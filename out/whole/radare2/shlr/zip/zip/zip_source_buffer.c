# 0 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 2
...
# 51 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
extern 
# 51 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
          struct zip_source *
zip_source_buffer(struct zip *za, const void *data, zip_uint64_t len, int freep)
{
    ...
    if (za == 
# 57 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
             ((void *)0)
# 57 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                 )
 return 
# 58 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
       ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
           ;

    if (data == 
# 60 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
               ((void *)0) 
# 60 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                    && len > 0) {
 _zip_error_set(&za->error, 
# 61 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                           18
# 61 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                                       , 0);
 return 
# 62 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
       ((void *)0)
# 62 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
           ;
    }

    if ((f=(struct read_data *)malloc(sizeof(*f))) == 
# 65 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                                                     ((void *)0)
# 65 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                                                         ) {
 _zip_error_set(&za->error, 
# 66 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                           14
# 66 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                                        , 0);
 return 
# 67 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
       ((void *)0)
# 67 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
           ;
    }
    ...
    f->freep = freep;
    f->mtime = time(
# 73 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                   ((void *)0)
# 73 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                       );

    if ((zs=zip_source_function(za, read_data, f)) == 
# 75 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                                                     ((void *)0)
# 75 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                                                         ) {
 free(f);
 return 
# 77 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
       ((void *)0)
# 77 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
           ;
    }
...
# 106 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
    __builtin___memcpy_chk (
# 106 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
    buf
# 106 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
    , 
# 106 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
...
# 106 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
 ...
 return 0;
  ...
  return -1;
     ...
     st->comp_method = 
# 128 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                      0
# 128 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                                  ;
     st->encryption_method = 
# 129 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                            0
# 129 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                                       ;
     st->valid = 
# 130 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                0x0010u
# 130 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                              |
# 130 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
                               0x0004u
# 130 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
...
# 131 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
 |
# 131 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
  0x0040u
# 131 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                      |
# 131 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
...
# 131 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
 ...
 if (z->freep) {
     free((void *)z->data);
     z->data = 
# 151 "project/radare2/shlr/zip/zip/zip_source_buffer.c" 3 4
              ((void *)0)
# 151 "project/radare2/shlr/zip/zip/zip_source_buffer.c"
                  ;
 }
 free(z);
 return 0;
