# 0 "project/radare2/shlr/zip/zip/zip_file_replace.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_file_replace.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_file_replace.c"
          int
zip_file_replace(struct zip *za, zip_uint64_t idx, struct zip_source *source, zip_flags_t flags)
{
    if (idx >= za->nentry || source == 
# 43 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                      ((void *)0)
# 43 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                          ) {
 _zip_error_set(&za->error, 
# 44 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                           18
# 44 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                       , 0);
 return -1;
    }

    if (_zip_file_replace(za, idx, 
# 48 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                  ((void *)0)
# 48 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                      , source, flags) == -1)
 return -1;
...
_zip_file_replace(struct zip *za, zip_uint64_t idx, const char *name, struct zip_source *source, zip_flags_t flags)
{
    ...
    if (((za)->ch_flags & 
# 64 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
       2u
# 64 "project/radare2/shlr/zip/zip/zip_file_replace.c"
       )) {
 _zip_error_set(&za->error, 
# 65 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                           25
# 65 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                        , 0);
 return -1;
    }
    ...
    if (idx == 
# 70 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 70 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                            ) {
 zip_int64_t i = -1;

 if (flags & 
# 73 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
            8192u
# 73 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                            )
     i = _zip_name_locate(za, name, flags, 
# 74 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                          ((void *)0)
# 74 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                              );
...
# 96 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                              ((void *)0) 
# 96 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                   && (za->entry[idx].changes == 
# 96 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                                                 ((void *)0) 
# 96 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                                                      || (za->entry[idx].changes->changed & 0x0001u) == 0)) {
        if (za->entry[idx].changes == 
# 97 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                     ((void *)0)
# 97 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                         ) {
            if ((za->entry[idx].changes=_zip_dirent_clone(za->entry[idx].orig)) == 
# 98 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                                                                  ((void *)0)
# 98 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                                                                      ) {
                _zip_error_set(&za->error, 
# 99 "project/radare2/shlr/zip/zip/zip_file_replace.c" 3 4
                                          14
# 99 "project/radare2/shlr/zip/zip/zip_file_replace.c"
                                                       , 0);
                return -1;
            }
        }

        za->entry[idx].changes->comp_method = (-2);
        za->entry[idx].changes->changed |= 0x0001u;
    }
