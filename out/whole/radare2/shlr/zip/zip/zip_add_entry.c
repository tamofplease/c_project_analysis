# 0 "project/radare2/shlr/zip/zip/zip_add_entry.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_add_entry.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_add_entry.c" 2
...
# 54 "project/radare2/shlr/zip/zip/zip_add_entry.c" 3 4
                               14
# 54 "project/radare2/shlr/zip/zip/zip_add_entry.c"
                                            , 0);
     return -1;
 }
 za->entry = rentries;
