# 0 "project/radare2/shlr/zip/zip/zip_extra_field.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zip/zip_extra_field.c"
# 36 "project/radare2/shlr/zip/zip/zip_extra_field.c"
...
# 37 "project/radare2/shlr/zip/zip/zip_extra_field.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_extra_field.c" 2
...
# 44 "project/radare2/shlr/zip/zip/zip_extra_field.c"
struct zip_extra_field *
_zip_ef_clone(const struct zip_extra_field *ef, struct zip_error *error)
{
    ...
    head = prev = 
# 49 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                 ((void *)0)
# 49 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                     ;

    while (ef) {
        if ((def=_zip_ef_new(ef->id, ef->size, ef->data, ef->flags)) == 
# 52 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                                                       ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                                                           ) {
            _zip_error_set(error, 
# 53 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                 14
# 53 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                              , 0);
            _zip_ef_free(head);
            return 
# 55 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                  ((void *)0)
# 55 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                      ;
        }

        if (head == 
# 58 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                   ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                       )
            head = def;
        if (prev)
            prev->next = def;
...
_zip_ef_delete_by_id(struct zip_extra_field *ef, zip_uint16_t id, zip_uint16_t id_idx, zip_flags_t flags)
{
    ...
    head = ef;
    prev = 
# 79 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
          ((void *)0)
# 79 "project/radare2/shlr/zip/zip/zip_extra_field.c"
              ;
    for (; ef; ef=(prev ? prev->next : head)) {
 if ((ef->flags & flags & (
# 81 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                         256u
# 81 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                         |
# 81 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                         512u
# 81 "project/radare2/shlr/zip/zip/zip_extra_field.c"
     ...
     if (id_idx == 
# 82 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                  0xFFFFU 
# 82 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                      || i == id_idx) {
  ef->flags &= ~(flags & (
# 83 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        256u
# 83 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                        |
# 83 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        512u
# 83 "project/radare2/shlr/zip/zip/zip_extra_field.c"
  ...
  if ((ef->flags & (
# 84 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                  256u
# 84 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                  |
# 84 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                  512u
# 84 "project/radare2/shlr/zip/zip/zip_extra_field.c"
   ...
   head = ef->next;
      ef->next = 
# 89 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                ((void *)0)
# 89 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                    ;
      _zip_ef_free(ef);

      if (id_idx == 
# 92 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                   0xFFFFU
# 92 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                      )
   continue;
  }
     }
...
_zip_ef_get_by_id(const struct zip_extra_field *ef, zip_uint16_t *lenp, zip_uint16_t id, zip_uint16_t id_idx, zip_flags_t flags, struct zip_error *error)
{
    ...
    i = 0;
    for (; ef; ef=ef->next) {
 if (ef->id == id && (ef->flags & flags & (
# 134 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                         256u
# 134 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                         |
# 134 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                         512u
# 134 "project/radare2/shlr/zip/zip/zip_extra_field.c"
  ...
  *lenp = ef->size;
  ...
  return empty;
    ...
    _zip_error_set(error, 
# 149 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                         9
# 149 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                     , 0);
    return 
# 150 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
          ((void *)0)
# 150 "project/radare2/shlr/zip/zip/zip_extra_field.c"
              ;
}
...
_zip_ef_merge(struct zip_extra_field *to, struct zip_extra_field *from)
{
    ...
    if (to == 
# 161 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
             ((void *)0)
# 161 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                 )
 return from;
 ...
 for (tt=to; tt; tt=tt->next) {
  ...
  if (tt->data && from->data && !memcmp(tt->data, from->data, tt->size)) {
   tt->flags |= (from->flags & (
# 174 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                              256u
# 174 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                              |
# 174 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                              512u
# 174 "project/radare2/shlr/zip/zip/zip_extra_field.c"
 ...
 from->next = 
# 181 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
             ((void *)0)
# 181 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                 ;
 if (duplicate)
     _zip_ef_free(from);
 else
...
# 198 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                                             ((void *)0)
# 198 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                                                 )
 return 
# 199 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
       ((void *)0)
# 199 "project/radare2/shlr/zip/zip/zip_extra_field.c"
           ;

    ef->next = 
# 201 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
              ((void *)0)
# 201 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                  ;
    ef->flags = flags;
 ef->data = 
# 203 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
           ((void *)0)
# 203 "project/radare2/shlr/zip/zip/zip_extra_field.c"
               ;
    ef->id = id;
    ef->size = size;
    if (size > 0) {
...
# 210 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
 __builtin___memcpy_chk (
# 210 "project/radare2/shlr/zip/zip/zip_extra_field.c"
 p
# 210 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
 , 
# 210 "project/radare2/shlr/zip/zip/zip_extra_field.c"
...
# 210 "project/radare2/shlr/zip/zip/zip_extra_field.c"
     ...
     free(ef);
     return 
# 213 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
           ((void *)0)
# 213 "project/radare2/shlr/zip/zip/zip_extra_field.c"
               ;
 }
    }
...
_zip_ef_parse(const zip_uint8_t *data, zip_uint16_t len, zip_flags_t flags, struct zip_error *error)
{
    ...
    ef_head = 
# 229 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
             ((void *)0)
# 229 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                 ;
    for (p=data; p<data+len; p+=flen) {
 if (p+4 > data+len) {
     _zip_error_set(error, 
# 232 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                          21
# 232 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                       , 0);
     _zip_ef_free(ef_head);
     return 
# 234 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
           ((void *)0)
# 234 "project/radare2/shlr/zip/zip/zip_extra_field.c"
               ;
 }
 ...
 if (p+flen > data+len) {
     _zip_error_set(error, 
# 241 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                          21
# 241 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                       , 0);
     _zip_ef_free(ef_head);
     return 
# 243 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
           ((void *)0)
# 243 "project/radare2/shlr/zip/zip/zip_extra_field.c"
               ;
 }

 if ((ef2=_zip_ef_new(fid, flen, p, flags)) == 
# 246 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                              ((void *)0)
# 246 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                                  ) {
     _zip_error_set(error, 
# 247 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                          14
# 247 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                       , 0);
     _zip_ef_free(ef_head);
     return 
# 249 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
           ((void *)0)
# 249 "project/radare2/shlr/zip/zip/zip_extra_field.c"
               ;
 }
...
_zip_ef_remove_internal(struct zip_extra_field *ef)
{
    ...
    ef_head = ef;
    prev = 
# 272 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
          ((void *)0)
# 272 "project/radare2/shlr/zip/zip/zip_extra_field.c"
              ;

    while (ef) {
        if (((ef->id) == 0x6375 || (ef->id) == 0x7075 || (ef->id) == 0x0001)) {
            next = ef->next;
            if (ef_head == ef)
                ef_head = next;
            ef->next = 
# 279 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                      ((void *)0)
# 279 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                          ;
            _zip_ef_free(ef);
            if (prev)
                prev->next = next;
...
_zip_ef_size(const struct zip_extra_field *ef, zip_flags_t flags)
{
    ...
    for (; ef; ef=ef->next) {
 if (ef->flags & flags & (
# 302 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        256u
# 302 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                        |
# 302 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        512u
# 302 "project/radare2/shlr/zip/zip/zip_extra_field.c"
...
_zip_ef_write(const struct zip_extra_field *ef, zip_flags_t flags, FILE *f)
{
    for (; ef; ef=ef->next) {
 if (ef->flags & flags & (
# 315 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        256u
# 315 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                        |
# 315 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        512u
# 315 "project/radare2/shlr/zip/zip/zip_extra_field.c"
...
# 335 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                           18
# 335 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                       , 0);
 return -1;
    }
    ...
    if (e->orig == 
# 341 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                  ((void *)0) 
# 341 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                       || e->orig->local_extra_fields_read)
 return 0;


    if (fseek(za->zp, (off_t)(e->orig->offset + 26), 
# 345 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                                     0
# 345 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                                             ) < 0) {
 _zip_error_set(&za->error, 
# 346 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                           4
# 346 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                      , 
# 346 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                        (*__error())
# 346 "project/radare2/shlr/zip/zip/zip_extra_field.c"
 ...
 _zip_error_set(&za->error, 
# 351 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                           5
# 351 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                      , 
# 351 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                        (*__error())
# 351 "project/radare2/shlr/zip/zip/zip_extra_field.c"
 ...
 if (fseek(za->zp, fname_len, 
# 363 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                             1
# 363 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                     ) < 0) {
     _zip_error_set(&za->error, 
# 364 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                               4
# 364 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                          , 
# 364 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                            (*__error())
# 364 "project/radare2/shlr/zip/zip/zip_extra_field.c"
 ...
 ef_raw = _zip_read_data(
# 368 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                        ((void *)0)
# 368 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                            , za->zp, ef_len, 0, &za->error);

 if (ef_raw == 
# 370 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
              ((void *)0)
# 370 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                  )
     return -1;

 if ((ef=_zip_ef_parse(ef_raw, ef_len, 
# 373 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                      256u
# 373 "project/radare2/shlr/zip/zip/zip_extra_field.c"
                                                  , &za->error)) == 
# 373 "project/radare2/shlr/zip/zip/zip_extra_field.c" 3 4
                                                                    ((void *)0)
# 373 "project/radare2/shlr/zip/zip/zip_extra_field.c"
