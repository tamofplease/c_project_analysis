# 0 "project/radare2/shlr/zip/zip/zip_source_pop.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_pop.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_source_pop.c" 2
...
zip_source_pop(struct zip_source *src)
{
    ...
    if (src == 
# 47 "project/radare2/shlr/zip/zip/zip_source_pop.c" 3 4
              ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_source_pop.c"
                  )
 return 
# 48 "project/radare2/shlr/zip/zip/zip_source_pop.c" 3 4
       ((void *)0)
# 48 "project/radare2/shlr/zip/zip/zip_source_pop.c"
           ;

    lower = src->src;

    if (lower == 
# 52 "project/radare2/shlr/zip/zip/zip_source_pop.c" 3 4
                ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_source_pop.c"
                    )
 zip_source_free(src);
    else {
 if (src->is_open)
     (void)src->cb.l(src, src->ud, 
# 56 "project/radare2/shlr/zip/zip/zip_source_pop.c" 3 4
                                  ((void *)0)
# 56 "project/radare2/shlr/zip/zip/zip_source_pop.c"
                                      , 0, ZIP_SOURCE_CLOSE);
 (void)src->cb.l(src, src->ud, 
# 57 "project/radare2/shlr/zip/zip/zip_source_pop.c" 3 4
                              ((void *)0)
# 57 "project/radare2/shlr/zip/zip/zip_source_pop.c"
                                  , 0, ZIP_SOURCE_FREE);
