# 0 "project/radare2/shlr/zip/zip/zip_get_num_entries.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_get_num_entries.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_get_num_entries.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_get_num_entries.c"
          zip_int64_t
zip_get_num_entries(struct zip *za, zip_flags_t flags)
{
    ...
    if (za == 
# 45 "project/radare2/shlr/zip/zip/zip_get_num_entries.c" 3 4
             ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_get_num_entries.c"
                 )
 return -1;

    if (flags & 
# 48 "project/radare2/shlr/zip/zip/zip_get_num_entries.c" 3 4
               8u
# 48 "project/radare2/shlr/zip/zip/zip_get_num_entries.c"
                               ) {
 n = za->nentry;
 while (n>0 && za->entry[n-1].orig == 
# 50 "project/radare2/shlr/zip/zip/zip_get_num_entries.c" 3 4
                                     ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_get_num_entries.c"
                                         )
     --n;
