# 0 "project/radare2/shlr/zip/zip/zip_fdopen.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 37 "project/radare2/shlr/zip/zip/zip_fdopen.c" 2
# 46 "project/radare2/shlr/zip/zip/zip_fdopen.c"

# 46 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
extern 
# 46 "project/radare2/shlr/zip/zip/zip_fdopen.c"
          struct zip *
zip_fdopen(int fd_orig, int _flags, int *zep)
{
    ...
    if (_flags < 0) {
        if (zep)
            *zep = 
# 55 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
                  18
# 55 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                              ;
        return 
# 56 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
               ((void *)0)
# 56 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                   ;
    }
    flags = (unsigned int)_flags;

    if (flags & 
# 60 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
               8
# 60 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                           ) {
 *zep = 
# 61 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
       18
# 61 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                   ;
 return 
# 62 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
       ((void *)0)
# 62 "project/radare2/shlr/zip/zip/zip_fdopen.c"
           ;
    }
    ...
    if ((fd=dup(fd_orig)) < 0) {
 *zep = 
# 69 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
       11
# 69 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                  ;
 return 
# 70 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
       ((void *)0)
# 70 "project/radare2/shlr/zip/zip/zip_fdopen.c"
           ;
    }

    if ((fp=fdopen(fd, "rb")) == 
# 73 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
                                ((void *)0)
# 73 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                                    ) {
 close(fd);
 *zep = 
# 75 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
       11
# 75 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                  ;
 return 
# 76 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
       ((void *)0)
# 76 "project/radare2/shlr/zip/zip/zip_fdopen.c"
           ;
    }

    close(fd_orig);
    return _zip_open(
# 80 "project/radare2/shlr/zip/zip/zip_fdopen.c" 3 4
                    ((void *)0)
# 80 "project/radare2/shlr/zip/zip/zip_fdopen.c"
                        , fp, flags, zep);
}
