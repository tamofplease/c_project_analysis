# 0 "project/radare2/shlr/sdb/src/fmt.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/fmt.c"
...
# 4 "project/radare2/shlr/sdb/src/fmt.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
...
#define __va_list__ 
# 5 "project/radare2/shlr/sdb/src/fmt.c" 2





#define concat(x) if (x) { int size = 2+strlen(x?x:"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { strcat (o, ","); strcat (o, x); out = o; } } else { out = strdup (x); } }
# 23 "project/radare2/shlr/sdb/src/fmt.c"

# 23 "project/radare2/shlr/sdb/src/fmt.c"
__attribute__ ((visibility ("default"))) char *sdb_fmt(const char *fmt, ...) {
#define KL 256
#define KN 16
...
# 29 "project/radare2/shlr/sdb/src/fmt.c" 3 4
__builtin_va_start(
# 29 "project/radare2/shlr/sdb/src/fmt.c"
ap
# 29 "project/radare2/shlr/sdb/src/fmt.c" 3 4
,
# 29 "project/radare2/shlr/sdb/src/fmt.c"
...
# 33 "project/radare2/shlr/sdb/src/fmt.c" 3 4
 __builtin___vsnprintf_chk (
# 33 "project/radare2/shlr/sdb/src/fmt.c"
 Key[n]
# 33 "project/radare2/shlr/sdb/src/fmt.c" 3 4
 , 
# 33 "project/radare2/shlr/sdb/src/fmt.c"
...
# 36 "project/radare2/shlr/sdb/src/fmt.c" 3 4
__builtin_va_end(
# 36 "project/radare2/shlr/sdb/src/fmt.c"
ap
# 36 "project/radare2/shlr/sdb/src/fmt.c" 3 4
)
# 36 "project/radare2/shlr/sdb/src/fmt.c"
...
__attribute__ ((visibility ("default"))) char *sdb_fmt_tostr(void *p, const char *fmt) {
 char buf[128], *e_str, *out = 
# 41 "project/radare2/shlr/sdb/src/fmt.c" 3 4
                              ((void *)0)
# 41 "project/radare2/shlr/sdb/src/fmt.c"
                                  ;
 int n, len = 0;
 if (!p || !fmt) {
  return 
# 44 "project/radare2/shlr/sdb/src/fmt.c" 3 4
        ((void *)0)
# 44 "project/radare2/shlr/sdb/src/fmt.c"
            ;
 }
 for (; *fmt; fmt++) {
  n = 4;
  switch (*fmt) {
  case 'b':
   if (sdb_itoa ((unsigned long long)*((unsigned char*)p + len), buf, 10)) { int size = 2+strlen(sdb_itoa ((unsigned long long)*((unsigned char*)p + len), buf, 10)?sdb_itoa ((unsigned long long)*((unsigned char*)p + len), buf, 10):"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 50 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 50 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 50 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 50 "project/radare2/shlr/sdb/src/fmt.c"
...
# 50 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 50 "project/radare2/shlr/sdb/src/fmt.c"
  sdb_itoa ((unsigned long long)*((unsigned char*)p + len), buf, 10)
# 50 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , __builtin_object_size (
# 50 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 50 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 2 > 1 ? 1 : 0))
# 50 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup (sdb_itoa ((unsigned long long)*((unsigned char*)p + len), buf, 10)); } };
   break;
  case 'h':
   if (sdb_itoa ((unsigned long long)*((short*)((unsigned char*)p + len)), buf, 10)) { int size = 2+strlen(sdb_itoa ((unsigned long long)*((short*)((unsigned char*)p + len)), buf, 10)?sdb_itoa ((unsigned long long)*((short*)((unsigned char*)p + len)), buf, 10):"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 53 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 53 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 53 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 53 "project/radare2/shlr/sdb/src/fmt.c"
...
# 53 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 53 "project/radare2/shlr/sdb/src/fmt.c"
  sdb_itoa ((unsigned long long)*((short*)((unsigned char*)p + len)), buf, 10)
# 53 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , __builtin_object_size (
# 53 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 53 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 2 > 1 ? 1 : 0))
# 53 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup (sdb_itoa ((unsigned long long)*((short*)((unsigned char*)p + len)), buf, 10)); } };
   break;
  case 'd':
   if (sdb_itoa ((unsigned long long)*((int*)((unsigned char*)p + len)), buf, 10)) { int size = 2+strlen(sdb_itoa ((unsigned long long)*((int*)((unsigned char*)p + len)), buf, 10)?sdb_itoa ((unsigned long long)*((int*)((unsigned char*)p + len)), buf, 10):"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 56 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 56 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 56 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 56 "project/radare2/shlr/sdb/src/fmt.c"
...
# 56 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 56 "project/radare2/shlr/sdb/src/fmt.c"
  sdb_itoa ((unsigned long long)*((int*)((unsigned char*)p + len)), buf, 10)
# 56 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , __builtin_object_size (
# 56 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 56 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 2 > 1 ? 1 : 0))
# 56 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup (sdb_itoa ((unsigned long long)*((int*)((unsigned char*)p + len)), buf, 10)); } };
   break;
  case 'q':
   if (sdb_itoa (*((unsigned long long*)((unsigned char*)p + len)), buf, 10)) { int size = 2+strlen(sdb_itoa (*((unsigned long long*)((unsigned char*)p + len)), buf, 10)?sdb_itoa (*((unsigned long long*)((unsigned char*)p + len)), buf, 10):"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 59 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 59 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 59 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 59 "project/radare2/shlr/sdb/src/fmt.c"
...
# 59 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup (sdb_itoa (*((unsigned long long*)((unsigned char*)p + len)), buf, 10)); } };
   ...
   break;
  case 'z':
   if ((char*)p + len) { int size = 2+strlen((char*)p + len?(char*)p + len:"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 63 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 63 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 63 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 63 "project/radare2/shlr/sdb/src/fmt.c"
...
# 63 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 2 > 1 ? 1 : 0))
# 63 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup ((char*)p + len); } };
   break;
  case 's':
   e_str = sdb_encode ((const unsigned char*)*((char**)((unsigned char*)p + len)), -1);
   if (e_str) { int size = 2+strlen(e_str?e_str:"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 67 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 67 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 67 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 67 "project/radare2/shlr/sdb/src/fmt.c"
...
# 67 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 2 > 1 ? 1 : 0))
# 67 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup (e_str); } };
   free (e_str);
   break;
  case 'p':
   if (sdb_itoa ((unsigned long long)*((size_t*)((unsigned char*)p + len)), buf, 16)) { int size = 2+strlen(sdb_itoa ((unsigned long long)*((size_t*)((unsigned char*)p + len)), buf, 16)?sdb_itoa ((unsigned long long)*((size_t*)((unsigned char*)p + len)), buf, 16):"")+(out?strlen(out)+4:0); if (out) { char *o = realloc (out, size); if (o) { 
# 71 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___strcat_chk (
# 71 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 71 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 71 "project/radare2/shlr/sdb/src/fmt.c"
...
# 71 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 71 "project/radare2/shlr/sdb/src/fmt.c"
  sdb_itoa ((unsigned long long)*((size_t*)((unsigned char*)p + len)), buf, 16)
# 71 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , __builtin_object_size (
# 71 "project/radare2/shlr/sdb/src/fmt.c"
  o
# 71 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 2 > 1 ? 1 : 0))
# 71 "project/radare2/shlr/sdb/src/fmt.c"
  ; out = o; } } else { out = strdup (sdb_itoa ((unsigned long long)*((size_t*)((unsigned char*)p + len)), buf, 16)); } };
   n = sizeof (size_t);
   break;
  }
  len += ((((long)sizeof (void*))>(n))?((long)sizeof (void*)):(n));
 }
 return out;
}
...
__attribute__ ((visibility ("default"))) int sdb_fmt_tobin(const char *_str, const char *fmt, void *stru) {
 ...
 for (; *fmt; fmt++) {
  ...
  n = 4;
  switch (*fmt) {
  case 'b': *((unsigned char*)(stru8 + idx)) = (unsigned char)sdb_atoi (word); break;
  case 'd': *((int*)(stru8 + idx)) = (int)sdb_atoi (word); break;
  case 'q': *((unsigned long long*)(stru8 + idx)) = sdb_atoi (word); n = 8; break;
  ...
  idx += ((((long)sizeof (void*))>(n))?((long)sizeof (void*)):(n));
  if (!next) {
   break;
  }
  ptr = next;
...
__attribute__ ((visibility ("default"))) void sdb_fmt_free (void *stru, const char *fmt) {
 int n, len = 0;
 for (; *fmt; fmt++) {
  n = 4;
  switch (*fmt) {
  ...
  case 'z':
  case 's':
   free ((void*)*((char**)((unsigned char*)stru + len)));
   break;
  }
  len += ((((long)sizeof (void*))>(n))?((long)sizeof (void*)):(n));
 }
...
__attribute__ ((visibility ("default"))) int sdb_fmt_init (void *p, const char *fmt) {
 ...
 for (; *fmt; fmt++) {
  switch (*fmt) {
  case 'b': len += sizeof (unsigned char); break;
  case 'h': len += sizeof (short); break;
  case 'd': len += sizeof (unsigned int); break;
  case 'q': len += sizeof (unsigned long long); break;
  case 'z': len += sizeof (char*); break;
  case 's': len += sizeof (char*); break;
  case 'p': len += sizeof (char*); break;
  }
 }
 if (p) {
  
# 159 "project/radare2/shlr/sdb/src/fmt.c" 3 4
 __builtin___memset_chk (
# 159 "project/radare2/shlr/sdb/src/fmt.c"
 p
# 159 "project/radare2/shlr/sdb/src/fmt.c" 3 4
 , 
# 159 "project/radare2/shlr/sdb/src/fmt.c"
...
static const char *sdb_anext2(const char *str, const char **next) {
 char *nxt, *p = strchr (str, ',');
 if (p) {
  nxt = p + 1;
 } else {
  nxt = 
# 169 "project/radare2/shlr/sdb/src/fmt.c" 3 4
       ((void *)0)
# 169 "project/radare2/shlr/sdb/src/fmt.c"
           ;
 }
 if (next) {
  *next = nxt;
...
__attribute__ ((visibility ("default"))) unsigned long long* sdb_fmt_array_num(const char *list) {
 unsigned long long *retp, *ret = 
# 179 "project/radare2/shlr/sdb/src/fmt.c" 3 4
                   ((void *)0)
# 179 "project/radare2/shlr/sdb/src/fmt.c"
                       ;
 unsigned int size;
 const char *next, *ptr = list;
 if (list && *list) {
  unsigned int len = (unsigned int) sdb_alen (list);
  size = sizeof (unsigned long long) * (len + 1);
  if (size < len) {
   return 
# 186 "project/radare2/shlr/sdb/src/fmt.c" 3 4
         ((void *)0)
# 186 "project/radare2/shlr/sdb/src/fmt.c"
             ;
  }
  retp = ret = (unsigned long long*) malloc (size);
  if (!ret) {
   return 
# 190 "project/radare2/shlr/sdb/src/fmt.c" 3 4
         ((void *)0)
# 190 "project/radare2/shlr/sdb/src/fmt.c"
             ;
  }
  *retp++ = len;
  do {
   const char *str = sdb_anext2 (ptr, &next);
   unsigned long long n = sdb_atoi (str);
   *retp++ = n;
   ptr = next;
  } while (next);
 }
...
__attribute__ ((visibility ("default"))) char** sdb_fmt_array(const char *list) {
 char *_s, **retp, **ret = 
# 204 "project/radare2/shlr/sdb/src/fmt.c" 3 4
                          ((void *)0)
# 204 "project/radare2/shlr/sdb/src/fmt.c"
                              ;
 const char *next, *ptr = list;
 if (list && *list) {
  ...
  if (!ret) {
   return 
# 212 "project/radare2/shlr/sdb/src/fmt.c" 3 4
         ((void *)0)
# 212 "project/radare2/shlr/sdb/src/fmt.c"
             ;
  }
  do {
   const char *str = sdb_anext2 (ptr, &next);
...
# 218 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  __builtin___memcpy_chk (
# 218 "project/radare2/shlr/sdb/src/fmt.c"
  _s
# 218 "project/radare2/shlr/sdb/src/fmt.c" 3 4
  , 
# 218 "project/radare2/shlr/sdb/src/fmt.c"
...
# 218 "project/radare2/shlr/sdb/src/fmt.c"
  ...
  *retp = 
# 224 "project/radare2/shlr/sdb/src/fmt.c" 3 4
         ((void *)0)
# 224 "project/radare2/shlr/sdb/src/fmt.c"
             ;
 }
 return ret;
}
