# 0 "project/radare2/shlr/sdb/src/ns.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/shlr/sdb/src/ns.c" 2
...
static int in_list(SdbList *list, void *item) {
 ...
 SdbListIter *it;
 if (list && item)
 if ((list)) for (it = (list)->head; it && (ns = it->data); it = it->n) {
  if (item == ns) {
   return 1;
  }
 }
...
static void ns_free(Sdb *s, SdbList *list) {
 ...
 if ((s->ns)) for (it = (s->ns)->head; it && (ns = it->data); it = it->n) {
  ...
  if (!in_list (list, ns)) {
   ...
   free (ns->name);
   ns->name = 
# 47 "project/radare2/shlr/sdb/src/ns.c" 3 4
             ((void *)0)
# 47 "project/radare2/shlr/sdb/src/ns.c"
                 ;
   deleted = 1;
   if (ns->sdb) {
    if (sdb_free (ns->sdb)) {
     ns->sdb = 
# 51 "project/radare2/shlr/sdb/src/ns.c" 3 4
              ((void *)0)
# 51 "project/radare2/shlr/sdb/src/ns.c"
                  ;
     free (ns->name);
     ns->name = 
# 53 "project/radare2/shlr/sdb/src/ns.c" 3 4
               ((void *)0)
# 53 "project/radare2/shlr/sdb/src/ns.c"
                   ;
    }
   }
   ls_append (list, ns);
  ...
  if (!deleted) {
   sdb_free (ns->sdb);
   s->ns->free = 
# 63 "project/radare2/shlr/sdb/src/ns.c" 3 4
                ((void *)0)
# 63 "project/radare2/shlr/sdb/src/ns.c"
                    ;
   ls_delete (s->ns, it);
  }
  free (ns);
 ...
 ls_free (s->ns);
 s->ns = 
# 70 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 70 "project/radare2/shlr/sdb/src/ns.c"
            ;
}
...
__attribute__ ((visibility ("default"))) void sdb_ns_free(Sdb *s) {
 ...
 list = ls_new ();
 list->free = 
# 79 "project/radare2/shlr/sdb/src/ns.c" 3 4
             ((void *)0)
# 79 "project/radare2/shlr/sdb/src/ns.c"
                 ;
 ns_free (s, list);
 ls_free (list);
 ls_free (s->ns);
 s->ns = 
# 83 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 83 "project/radare2/shlr/sdb/src/ns.c"
            ;
}

static SdbNs *sdb_ns_new (Sdb *s, const char *name, unsigned int hash) {
 char dir[256];
 SdbNs *ns;
 if (s->dir && *s->dir && name && *name) {
  int dir_len = strlen (s->dir);
  int name_len = strlen (name);
  if ((dir_len+name_len+3)>256) {
   return 
# 93 "project/radare2/shlr/sdb/src/ns.c" 3 4
         ((void *)0)
# 93 "project/radare2/shlr/sdb/src/ns.c"
             ;
  }
  
# 95 "project/radare2/shlr/sdb/src/ns.c" 3 4
 __builtin___memcpy_chk (
# 95 "project/radare2/shlr/sdb/src/ns.c"
 dir
# 95 "project/radare2/shlr/sdb/src/ns.c" 3 4
 , 
# 95 "project/radare2/shlr/sdb/src/ns.c"
...
# 96 "project/radare2/shlr/sdb/src/ns.c" 3 4
 __builtin___memcpy_chk (
# 96 "project/radare2/shlr/sdb/src/ns.c"
 dir + dir_len
# 96 "project/radare2/shlr/sdb/src/ns.c" 3 4
 , 
# 96 "project/radare2/shlr/sdb/src/ns.c"
...
# 97 "project/radare2/shlr/sdb/src/ns.c" 3 4
 __builtin___memcpy_chk (
# 97 "project/radare2/shlr/sdb/src/ns.c"
 dir + dir_len + 1
# 97 "project/radare2/shlr/sdb/src/ns.c" 3 4
 , 
# 97 "project/radare2/shlr/sdb/src/ns.c"
...
# 97 "project/radare2/shlr/sdb/src/ns.c"
 ...
 if (!ns) {
  return 
# 103 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 103 "project/radare2/shlr/sdb/src/ns.c"
            ;
 }
 ns->hash = hash;
 ns->name = name? strdup (name): 
# 106 "project/radare2/shlr/sdb/src/ns.c" 3 4
                                ((void *)0)
# 106 "project/radare2/shlr/sdb/src/ns.c"
                                    ;
 ...
 if (ns->sdb) {
  free (ns->sdb->path);
  ns->sdb->path = 
# 113 "project/radare2/shlr/sdb/src/ns.c" 3 4
                 ((void *)0)
# 113 "project/radare2/shlr/sdb/src/ns.c"
                     ;
  if (*dir) {
  ...
  free (ns);
  ns = 
# 124 "project/radare2/shlr/sdb/src/ns.c" 3 4
      ((void *)0)
# 124 "project/radare2/shlr/sdb/src/ns.c"
          ;
 }
 return ns;
}
...
__attribute__ ((visibility ("default"))) 
# 129 "project/radare2/shlr/sdb/src/ns.c" 3 4
       _Bool 
# 129 "project/radare2/shlr/sdb/src/ns.c"
            sdb_ns_unset (Sdb *s, const char *name, Sdb *r) {
 SdbNs *ns;
 SdbListIter *it;
 if (s && (name || r)) {
  if ((s->ns)) for (it = (s->ns)->head; it && (ns = it->data); it = it->n) {
   if (name && (!strcmp (name, ns->name))) {
    ls_delete (s->ns, it);
    return 
# 136 "project/radare2/shlr/sdb/src/ns.c" 3 4
          1
# 136 "project/radare2/shlr/sdb/src/ns.c"
              ;
   }
   if (r && ns->sdb == r) {
    ls_delete (s->ns, it);
    return 
# 140 "project/radare2/shlr/sdb/src/ns.c" 3 4
          1
# 140 "project/radare2/shlr/sdb/src/ns.c"
              ;
   }
  }
 }
 return 
# 144 "project/radare2/shlr/sdb/src/ns.c" 3 4
       0
# 144 "project/radare2/shlr/sdb/src/ns.c"
            ;
}
...
__attribute__ ((visibility ("default"))) int sdb_ns_set(Sdb *s, const char *name, Sdb *r) {
 SdbNs *ns;
 SdbListIter *it;
 unsigned int hash = sdb_hash (name);
 if (!s || !r || !name) {
  return 0;
 }
 if ((s->ns)) for (it = (s->ns)->head; it && (ns = it->data); it = it->n) {
...
__attribute__ ((visibility ("default"))) Sdb *sdb_ns(Sdb *s, const char *name, int create) {
 ...
 if (!s || !name || !*name) {
  return 
# 182 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 182 "project/radare2/shlr/sdb/src/ns.c"
            ;
 }
 hash = sdb_hash (name);
 if ((s->ns)) for (it = (s->ns)->head; it && (ns = it->data); it = it->n) {
 ...
 if (!create) {
  return 
# 191 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 191 "project/radare2/shlr/sdb/src/ns.c"
            ;
 }
 if (s->ns_lock) {
  return 
# 194 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 194 "project/radare2/shlr/sdb/src/ns.c"
            ;
 }
 ns = sdb_ns_new (s, name, hash);
 if (!ns) {
  return 
# 198 "project/radare2/shlr/sdb/src/ns.c" 3 4
        ((void *)0)
# 198 "project/radare2/shlr/sdb/src/ns.c"
            ;
 }
 ls_append (s->ns, ns);
 return ns->sdb;
...
__attribute__ ((visibility ("default"))) void sdb_ns_sync (Sdb *s) {
 ...
 ns_sync (s, list);
 list->free = 
# 241 "project/radare2/shlr/sdb/src/ns.c" 3 4
             ((void *)0)
# 241 "project/radare2/shlr/sdb/src/ns.c"
                 ;
 ls_free (list);
}
