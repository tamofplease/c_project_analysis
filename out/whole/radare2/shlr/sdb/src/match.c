# 0 "project/radare2/shlr/sdb/src/match.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/match.c"
...
# 4 "project/radare2/shlr/sdb/src/match.c" 2
...
# 5 "project/radare2/shlr/sdb/src/match.c" 2


# 6 "project/radare2/shlr/sdb/src/match.c"
...
static inline 
# 51 "project/radare2/shlr/sdb/src/match.c" 3 4
             _Bool 
# 51 "project/radare2/shlr/sdb/src/match.c"
                  compareString(const char *a, const char *b, int blen, int flags) {
 const int start = flags & SDB_LIKE_START;
 const int end = flags & SDB_LIKE_END;
 char *aa = 
# 54 "project/radare2/shlr/sdb/src/match.c" 3 4
           ((void *)0)
# 54 "project/radare2/shlr/sdb/src/match.c"
               ;
 int alen;
 
# 56 "project/radare2/shlr/sdb/src/match.c" 3 4
_Bool 
# 56 "project/radare2/shlr/sdb/src/match.c"
     ret = 
# 56 "project/radare2/shlr/sdb/src/match.c" 3 4
           0
# 56 "project/radare2/shlr/sdb/src/match.c"
...
__attribute__ ((visibility ("default"))) 
# 86 "project/radare2/shlr/sdb/src/match.c" 3 4
       _Bool 
# 86 "project/radare2/shlr/sdb/src/match.c"
            sdb_match (const char *str, const char *glob) {
 int glob_len, flags = SDB_LIKE_NONE;
 if (!str || !glob) {
  return 
# 89 "project/radare2/shlr/sdb/src/match.c" 3 4
        0
# 89 "project/radare2/shlr/sdb/src/match.c"
             ;
 }
