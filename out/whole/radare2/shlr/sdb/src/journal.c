# 0 "project/radare2/shlr/sdb/src/journal.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/journal.c"
...
# 4 "project/radare2/shlr/sdb/src/journal.c" 2
...
# 5 "project/radare2/shlr/sdb/src/journal.c" 2





# 9 "project/radare2/shlr/sdb/src/journal.c"
static const char *sdb_journal_filename(Sdb *s) {
 return (s && s->name)
  ? sdb_fmt ("%s.journal", s->name)
  : 
# 12 "project/radare2/shlr/sdb/src/journal.c" 3 4
   ((void *)0)
# 12 "project/radare2/shlr/sdb/src/journal.c"
       ;
}

__attribute__ ((visibility ("default"))) 
# 15 "project/radare2/shlr/sdb/src/journal.c" 3 4
       _Bool 
# 15 "project/radare2/shlr/sdb/src/journal.c"
            sdb_journal_close(Sdb *s) {
 if (s->journal == -1) {
  return 
# 17 "project/radare2/shlr/sdb/src/journal.c" 3 4
        0
# 17 "project/radare2/shlr/sdb/src/journal.c"
             ;
 }
 close (s->journal);
 s->journal = -1;
 ...
 return 
# 22 "project/radare2/shlr/sdb/src/journal.c" 3 4
       1
# 22 "project/radare2/shlr/sdb/src/journal.c"
           ;
}

__attribute__ ((visibility ("default"))) 
# 25 "project/radare2/shlr/sdb/src/journal.c" 3 4
       _Bool 
# 25 "project/radare2/shlr/sdb/src/journal.c"
            sdb_journal_open(Sdb *s) {
 const char *filename;
 if (!s || !s->name) {
  return 
# 28 "project/radare2/shlr/sdb/src/journal.c" 3 4
        0
# 28 "project/radare2/shlr/sdb/src/journal.c"
             ;
 }
 filename = sdb_journal_filename (s);
 if (!filename) {
  return 
# 32 "project/radare2/shlr/sdb/src/journal.c" 3 4
        0
# 32 "project/radare2/shlr/sdb/src/journal.c"
             ;
 }
 close (s->journal);
 s->journal = open (filename, 
# 35 "project/radare2/shlr/sdb/src/journal.c" 3 4
                             0x00000200 
# 35 "project/radare2/shlr/sdb/src/journal.c"
                                     | 
# 35 "project/radare2/shlr/sdb/src/journal.c" 3 4
                                       0x0002 
# 35 "project/radare2/shlr/sdb/src/journal.c"
...
__attribute__ ((visibility ("default"))) int sdb_journal_load(Sdb *s) {
 ...
 char *eq, *str, *cur, *ptr = 
# 42 "project/radare2/shlr/sdb/src/journal.c" 3 4
                             ((void *)0)
# 42 "project/radare2/shlr/sdb/src/journal.c"
                                 ;
 if (!s) {
  return 0;
 }
 ...
 sz = lseek (fd, 0, 
# 50 "project/radare2/shlr/sdb/src/journal.c" 3 4
                   2
# 50 "project/radare2/shlr/sdb/src/journal.c"
                           );
 if (sz < 1) {
  return 0;
 }
 lseek (fd, 0, 
# 54 "project/radare2/shlr/sdb/src/journal.c" 3 4
              0
# 54 "project/radare2/shlr/sdb/src/journal.c"
                      );
 str = malloc (sz + 1);
 if (!str) {
  return 0;
...
__attribute__ ((visibility ("default"))) 
# 83 "project/radare2/shlr/sdb/src/journal.c" 3 4
       _Bool 
# 83 "project/radare2/shlr/sdb/src/journal.c"
            sdb_journal_log(Sdb *s, const char *key, const char *val) {
 if (s->journal == -1) {
  return 
# 85 "project/radare2/shlr/sdb/src/journal.c" 3 4
        0
# 85 "project/radare2/shlr/sdb/src/journal.c"
             ;
 }
 ...
 if (write (s->journal, str, len) != len) {
  return 
# 90 "project/radare2/shlr/sdb/src/journal.c" 3 4
        0
# 90 "project/radare2/shlr/sdb/src/journal.c"
             ;
 }
 ...
 return 
# 95 "project/radare2/shlr/sdb/src/journal.c" 3 4
       1
# 95 "project/radare2/shlr/sdb/src/journal.c"
           ;
}

__attribute__ ((visibility ("default"))) 
# 98 "project/radare2/shlr/sdb/src/journal.c" 3 4
       _Bool 
# 98 "project/radare2/shlr/sdb/src/journal.c"
            sdb_journal_clear(Sdb *s) {
 if (s->journal != -1) {
  return !ftruncate (s->journal, 0);
 }
 return 
# 102 "project/radare2/shlr/sdb/src/journal.c" 3 4
       0
# 102 "project/radare2/shlr/sdb/src/journal.c"
            ;
}

__attribute__ ((visibility ("default"))) 
# 105 "project/radare2/shlr/sdb/src/journal.c" 3 4
       _Bool 
# 105 "project/radare2/shlr/sdb/src/journal.c"
            sdb_journal_unlink(Sdb *s) {
 ...
 return 
# 111 "project/radare2/shlr/sdb/src/journal.c" 3 4
       0
# 111 "project/radare2/shlr/sdb/src/journal.c"
            ;
}
