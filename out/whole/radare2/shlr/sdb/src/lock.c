# 0 "project/radare2/shlr/sdb/src/lock.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/lock.c"
...
# 4 "project/radare2/shlr/sdb/src/lock.c" 2
...
# 5 "project/radare2/shlr/sdb/src/lock.c" 2
...
# 6 "project/radare2/shlr/sdb/src/lock.c" 2
...
# 7 "project/radare2/shlr/sdb/src/lock.c" 2
...
__attribute__ ((visibility ("default"))) const char *sdb_lock_file(const char *f) {
 ...
 if (!f || !*f) {
  return 
# 15 "project/radare2/shlr/sdb/src/lock.c" 3 4
        ((void *)0)
# 15 "project/radare2/shlr/sdb/src/lock.c"
            ;
 }
 len = strlen (f);
 if (len + 10 > sizeof buf) {
  return 
# 19 "project/radare2/shlr/sdb/src/lock.c" 3 4
        ((void *)0)
# 19 "project/radare2/shlr/sdb/src/lock.c"
            ;
 }
 
# 21 "project/radare2/shlr/sdb/src/lock.c" 3 4
__builtin___memcpy_chk (
# 21 "project/radare2/shlr/sdb/src/lock.c"
buf
# 21 "project/radare2/shlr/sdb/src/lock.c" 3 4
, 
# 21 "project/radare2/shlr/sdb/src/lock.c"
...
# 22 "project/radare2/shlr/sdb/src/lock.c" 3 4
__builtin___strcpy_chk (
# 22 "project/radare2/shlr/sdb/src/lock.c"
buf + len
# 22 "project/radare2/shlr/sdb/src/lock.c" 3 4
, 
# 22 "project/radare2/shlr/sdb/src/lock.c"
...
__attribute__ ((visibility ("default"))) 
# 26 "project/radare2/shlr/sdb/src/lock.c" 3 4
       _Bool 
# 26 "project/radare2/shlr/sdb/src/lock.c"
            sdb_lock(const char *s) {
 int fd;
 char *pid, pidstr[64];
 if (!s) {
  return 
# 30 "project/radare2/shlr/sdb/src/lock.c" 3 4
        0
# 30 "project/radare2/shlr/sdb/src/lock.c"
             ;
 }
 fd = open (s, 
# 32 "project/radare2/shlr/sdb/src/lock.c" 3 4
              0x00000200 
# 32 "project/radare2/shlr/sdb/src/lock.c"
                      | 
# 32 "project/radare2/shlr/sdb/src/lock.c" 3 4
                        0x00000400 
# 32 "project/radare2/shlr/sdb/src/lock.c"
...
# 32 "project/radare2/shlr/sdb/src/lock.c"
 ...
 if (fd == -1) {
  return 
# 34 "project/radare2/shlr/sdb/src/lock.c" 3 4
        0
# 34 "project/radare2/shlr/sdb/src/lock.c"
             ;
 }
 ...
 if (pid) {
  if ((write (fd, pid, strlen (pid)) < 0)
   ...
   close (fd);
   return 
# 41 "project/radare2/shlr/sdb/src/lock.c" 3 4
         0
# 41 "project/radare2/shlr/sdb/src/lock.c"
              ;
  }
 }
 close (fd);
 return 
# 45 "project/radare2/shlr/sdb/src/lock.c" 3 4
       1
# 45 "project/radare2/shlr/sdb/src/lock.c"
           ;
}

__attribute__ ((visibility ("default"))) int sdb_lock_wait(const char *s) {
