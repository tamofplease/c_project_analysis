# 0 "project/radare2/shlr/sdb/src/disk.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/disk.c"
...
# 4 "project/radare2/shlr/sdb/src/disk.c" 2
...
# 5 "project/radare2/shlr/sdb/src/disk.c" 2
...
# 6 "project/radare2/shlr/sdb/src/disk.c" 2
...
# 7 "project/radare2/shlr/sdb/src/disk.c" 2
...
# 8 "project/radare2/shlr/sdb/src/disk.c" 2
...
# 9 "project/radare2/shlr/sdb/src/disk.c" 2
...
# 10 "project/radare2/shlr/sdb/src/disk.c" 2
# 52 "project/radare2/shlr/sdb/src/disk.c"
...
# 72 "project/radare2/shlr/sdb/src/disk.c" 3 4
                            (*__error()) 
# 72 "project/radare2/shlr/sdb/src/disk.c"
                            != 
# 72 "project/radare2/shlr/sdb/src/disk.c" 3 4
                            17
# 72 "project/radare2/shlr/sdb/src/disk.c"
   ...
   fprintf(
# 73 "project/radare2/shlr/sdb/src/disk.c" 3 4
  __stderrp
# 73 "project/radare2/shlr/sdb/src/disk.c"
...
__attribute__ ((visibility ("default"))) 
# 83 "project/radare2/shlr/sdb/src/disk.c" 3 4
       _Bool 
# 83 "project/radare2/shlr/sdb/src/disk.c"
            sdb_disk_create(Sdb* s) {
 int nlen;
 char *str;
 const char *dir;
 if (!s || s->fdump >= 0) {
  return 
# 88 "project/radare2/shlr/sdb/src/disk.c" 3 4
        0
# 88 "project/radare2/shlr/sdb/src/disk.c"
             ;
 }
 if (!s->dir && s->name) {
  s->dir = strdup (s->name);
 ...
 dir = s->dir ? s->dir : "./";
 { free (s->ndump); s->ndump = 
# 94 "project/radare2/shlr/sdb/src/disk.c" 3 4
((void *)0)
# 94 "project/radare2/shlr/sdb/src/disk.c"
; };
 nlen = strlen (dir);
 str = malloc (nlen + 5);
 if (!str) {
  return 
# 98 "project/radare2/shlr/sdb/src/disk.c" 3 4
        0
# 98 "project/radare2/shlr/sdb/src/disk.c"
             ;
 }
 
# 100 "project/radare2/shlr/sdb/src/disk.c" 3 4
__builtin___memcpy_chk (
# 100 "project/radare2/shlr/sdb/src/disk.c"
str
# 100 "project/radare2/shlr/sdb/src/disk.c" 3 4
, 
# 100 "project/radare2/shlr/sdb/src/disk.c"
...
# 102 "project/radare2/shlr/sdb/src/disk.c" 3 4
__builtin___memcpy_chk (
# 102 "project/radare2/shlr/sdb/src/disk.c"
str + nlen
# 102 "project/radare2/shlr/sdb/src/disk.c" 3 4
, 
# 102 "project/radare2/shlr/sdb/src/disk.c"
...
# 115 "project/radare2/shlr/sdb/src/disk.c"
 s->fdump = open (str, 0 | 
# 115 "project/radare2/shlr/sdb/src/disk.c" 3 4
                                 0x0002 
# 115 "project/radare2/shlr/sdb/src/disk.c"
                                        | 
# 115 "project/radare2/shlr/sdb/src/disk.c" 3 4
...
# 115 "project/radare2/shlr/sdb/src/disk.c"
 ...
 if (s->fdump == -1) {
  fprintf(
# 118 "project/radare2/shlr/sdb/src/disk.c" 3 4
 __stderrp
# 118 "project/radare2/shlr/sdb/src/disk.c"
 ,"sdb: Cannot open '%s' for writing.\n", str);
  free (str);
  return 
# 120 "project/radare2/shlr/sdb/src/disk.c" 3 4
        0
# 120 "project/radare2/shlr/sdb/src/disk.c"
             ;
 }
 cdb_make_start (&s->m, s->fdump);
 s->ndump = str;
 return 
# 124 "project/radare2/shlr/sdb/src/disk.c" 3 4
       1
# 124 "project/radare2/shlr/sdb/src/disk.c"
           ;
}

__attribute__ ((visibility ("default"))) 
# 127 "project/radare2/shlr/sdb/src/disk.c" 3 4
       _Bool 
# 127 "project/radare2/shlr/sdb/src/disk.c"
            sdb_disk_insert(Sdb* s, const char *key, const char *val) {
 struct cdb_make *c = &s->m;
 if (!key || !val) {
  return 
# 130 "project/radare2/shlr/sdb/src/disk.c" 3 4
        0
# 130 "project/radare2/shlr/sdb/src/disk.c"
             ;
 }
...
__attribute__ ((visibility ("default"))) 
# 137 "project/radare2/shlr/sdb/src/disk.c" 3 4
       _Bool 
# 137 "project/radare2/shlr/sdb/src/disk.c"
            sdb_disk_finish (Sdb* s) {
 
# 138 "project/radare2/shlr/sdb/src/disk.c" 3 4
_Bool 
# 138 "project/radare2/shlr/sdb/src/disk.c"
     reopen = 
# 138 "project/radare2/shlr/sdb/src/disk.c" 3 4
              0
# 138 "project/radare2/shlr/sdb/src/disk.c"
...
# 138 "project/radare2/shlr/sdb/src/disk.c"
                               ;
 if (!cdb_make_finish (&s->m)) ret = 0;

 if (fsync (s->fdump)) ret = 0;

 if (close (s->fdump)) ret = 0;
 s->fdump = -1;
 ...
 if (s->fd != -1) {
  ...
  s->fd = -1;
  reopen = 
# 149 "project/radare2/shlr/sdb/src/disk.c" 3 4
          1
# 149 "project/radare2/shlr/sdb/src/disk.c"
              ;
 }
# 161 "project/radare2/shlr/sdb/src/disk.c"
 if (s->ndump && s->dir) {
  if (rename (s->ndump, s->dir)) ret = 0;
 }

 free (s->ndump);
 s->ndump = 
# 166 "project/radare2/shlr/sdb/src/disk.c" 3 4
           ((void *)0)
# 166 "project/radare2/shlr/sdb/src/disk.c"
               ;

 reopen = 
# 168 "project/radare2/shlr/sdb/src/disk.c" 3 4
         1
# 168 "project/radare2/shlr/sdb/src/disk.c"
             ;
 if (reopen) {
  int rr = sdb_open (s, s->dir);
  if (ret && rr < 0) {
   ret = 
# 172 "project/radare2/shlr/sdb/src/disk.c" 3 4
        0
# 172 "project/radare2/shlr/sdb/src/disk.c"
             ;
  }
  cdb_init (&s->db, s->fd);
 }
...
__attribute__ ((visibility ("default"))) 
# 179 "project/radare2/shlr/sdb/src/disk.c" 3 4
       _Bool 
# 179 "project/radare2/shlr/sdb/src/disk.c"
            sdb_disk_unlink (Sdb *s) {
