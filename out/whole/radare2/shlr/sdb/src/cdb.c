# 0 "project/radare2/shlr/sdb/src/cdb.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/cdb.c"
...
# 4 "project/radare2/shlr/sdb/src/cdb.c" 2
...
# 5 "project/radare2/shlr/sdb/src/cdb.c" 2
...
# 6 "project/radare2/shlr/sdb/src/cdb.c" 2
...
# 7 "project/radare2/shlr/sdb/src/cdb.h" 2
...
# 8 "project/radare2/shlr/sdb/src/cdb.h" 2
...
# 7 "project/radare2/shlr/sdb/src/cdb.c" 2
...
# 9 "project/radare2/shlr/sdb/src/cdb.c" 2



_Bool 
# 12 "project/radare2/shlr/sdb/src/cdb.c"
    cdb_getkvlen(struct cdb *c, unsigned int *klen, unsigned int *vlen, unsigned int pos) {
 unsigned char buf[4] = { 0 };
 *klen = *vlen = 0;
 if (!cdb_read (c, (char *)buf, sizeof (buf), pos)) {
  return 
# 16 "project/radare2/shlr/sdb/src/cdb.c" 3 4
        0
# 16 "project/radare2/shlr/sdb/src/cdb.c"
             ;
 }
 *klen = (unsigned int)buf[0];
 *vlen = (unsigned int)(buf[1] | ((unsigned int)buf[2] << 8) | ((unsigned int)buf[3] << 16));
 if (*vlen > 0xffffff) {
  *vlen = 0xffffff;
  return 
# 22 "project/radare2/shlr/sdb/src/cdb.c" 3 4
        0
# 22 "project/radare2/shlr/sdb/src/cdb.c"
             ;
 }
 return 
# 24 "project/radare2/shlr/sdb/src/cdb.c" 3 4
       1
# 24 "project/radare2/shlr/sdb/src/cdb.c"
           ;
}
...
void cdb_free(struct cdb *c) {
 ...
 c->map = 
# 36 "project/radare2/shlr/sdb/src/cdb.c" 3 4
         ((void *)0)
# 36 "project/radare2/shlr/sdb/src/cdb.c"
             ;
}
...
# 48 "project/radare2/shlr/sdb/src/cdb.c" 3 4
_Bool 
# 48 "project/radare2/shlr/sdb/src/cdb.c"
 ...
 c->fd = fd;
 cdb_findstart (c);
 if (fd != -1 && !fstat (fd, &st) && st.st_size > 4 && st.st_size != (off_t)((unsigned long long)(0xffffffffffffffffLL))) {

  char *x = mmap (0, st.st_size, 
# 57 "project/radare2/shlr/sdb/src/cdb.c" 3 4
                                0x01
# 57 "project/radare2/shlr/sdb/src/cdb.c"
                                         , 
# 57 "project/radare2/shlr/sdb/src/cdb.c" 3 4
                                           0x0001
# 57 "project/radare2/shlr/sdb/src/cdb.c"
                                                     , fd, 0);
  if (x == 
# 58 "project/radare2/shlr/sdb/src/cdb.c" 3 4
          ((void *)-1)
# 58 "project/radare2/shlr/sdb/src/cdb.c"
                    ) {
   fprintf(
# 59 "project/radare2/shlr/sdb/src/cdb.c" 3 4
  __stderrp
# 59 "project/radare2/shlr/sdb/src/cdb.c"
  ,"Cannot mmap %d\n", (int)st.st_size);
   return 
# 60 "project/radare2/shlr/sdb/src/cdb.c" 3 4
         0
# 60 "project/radare2/shlr/sdb/src/cdb.c"
              ;
  }
  if (c->map) {
   munmap (c->map, c->size);
  }
# 77 "project/radare2/shlr/sdb/src/cdb.c"
  c->map = x;
  c->size = st.st_size;
  return 
# 79 "project/radare2/shlr/sdb/src/cdb.c" 3 4
        1
# 79 "project/radare2/shlr/sdb/src/cdb.c"
            ;
 }
 c->map = 
# 81 "project/radare2/shlr/sdb/src/cdb.c" 3 4
         ((void *)0)
# 81 "project/radare2/shlr/sdb/src/cdb.c"
             ;
 c->size = 0;
 return 
# 83 "project/radare2/shlr/sdb/src/cdb.c" 3 4
       0
# 83 "project/radare2/shlr/sdb/src/cdb.c"
            ;
}


# 86 "project/radare2/shlr/sdb/src/cdb.c" 3 4
_Bool 
# 86 "project/radare2/shlr/sdb/src/cdb.c"
    cdb_read(struct cdb *c, char *buf, unsigned int len, unsigned int pos) {
 if (c->map) {
  if ((pos > c->size) || (c->size - pos < len)) {
   return 
# 89 "project/radare2/shlr/sdb/src/cdb.c" 3 4
         0
# 89 "project/radare2/shlr/sdb/src/cdb.c"
              ;
  }
  if (!buf) {
   return 
# 92 "project/radare2/shlr/sdb/src/cdb.c" 3 4
         0
# 92 "project/radare2/shlr/sdb/src/cdb.c"
              ;
  }
  
# 94 "project/radare2/shlr/sdb/src/cdb.c" 3 4
 __builtin___memcpy_chk (
# 94 "project/radare2/shlr/sdb/src/cdb.c"
 buf
# 94 "project/radare2/shlr/sdb/src/cdb.c" 3 4
 , 
# 94 "project/radare2/shlr/sdb/src/cdb.c"
...
# 94 "project/radare2/shlr/sdb/src/cdb.c"
                                ;
  return 
# 95 "project/radare2/shlr/sdb/src/cdb.c" 3 4
        1
# 95 "project/radare2/shlr/sdb/src/cdb.c"
            ;
 }
 if (c->fd == -1 || !seek_set (c->fd, pos)) {
  return 
# 98 "project/radare2/shlr/sdb/src/cdb.c" 3 4
        0
# 98 "project/radare2/shlr/sdb/src/cdb.c"
             ;
 }
 while (len > 0) {
  int r = (int)read (c->fd, buf, len);
  if (r < 1 || (unsigned int)r != len) {
   return 
# 103 "project/radare2/shlr/sdb/src/cdb.c" 3 4
         0
# 103 "project/radare2/shlr/sdb/src/cdb.c"
              ;
  }
  buf += r;
  len -= r;
 ...
 return 
# 108 "project/radare2/shlr/sdb/src/cdb.c" 3 4
       1
# 108 "project/radare2/shlr/sdb/src/cdb.c"
           ;
}

static int match(struct cdb *c, const char *key, unsigned int len, unsigned int pos) {
 char buf[32];
...
int cdb_findnext(struct cdb *c, unsigned int u, const char *key, unsigned int len) {
 char buf[8];
 unsigned int pos;
 int m;
 len++;
 ...
 if (!c->loop) {
  ...
  c->hslots = (pos - c->hpos) / (2 * sizeof (unsigned int));
  if (!c->hslots) {
   return 0;
  }
  c->khash = u;
