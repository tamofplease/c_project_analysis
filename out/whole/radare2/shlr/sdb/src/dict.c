# 0 "project/radare2/shlr/sdb/src/dict.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/dict.c"
...
# 4 "project/radare2/shlr/sdb/src/dict.c" 2
...
# 5 "project/radare2/shlr/sdb/src/dict.c" 2
...
# 6 "project/radare2/shlr/sdb/src/dict.c" 2
...
# 7 "project/radare2/shlr/sdb/src/dict.c" 2

__attribute__ ((visibility ("default"))) dict *dict_new (unsigned int size, dict_freecb f) {
 dict *m = calloc (1, sizeof (dict));
 if (!dict_init (m, (((size)>(1))?(size):(1)), f)) {
  free (m);
  m = 
# 12 "project/radare2/shlr/sdb/src/dict.c" 3 4
     ((void *)0)
# 12 "project/radare2/shlr/sdb/src/dict.c"
         ;
 }
 return m;
}
...
static unsigned int dict_bucket(dict *m, dicti k) {
 if (m->size > 0) {
  return k % m->size;
 }
 return 0;
...
__attribute__ ((visibility ("default"))) 
# 25 "project/radare2/shlr/sdb/src/dict.c" 3 4
       _Bool 
# 25 "project/radare2/shlr/sdb/src/dict.c"
            dict_init (dict *m, unsigned int size, dict_freecb f) {
 if (m) {
  
# 27 "project/radare2/shlr/sdb/src/dict.c" 3 4
 __builtin___memset_chk (
# 27 "project/radare2/shlr/sdb/src/dict.c"
 m
# 27 "project/radare2/shlr/sdb/src/dict.c" 3 4
 , 
# 27 "project/radare2/shlr/sdb/src/dict.c"
...
# 27 "project/radare2/shlr/sdb/src/dict.c"
  ...
  if (size > 0) {
   ...
   if (!m->table) {
    return 
# 31 "project/radare2/shlr/sdb/src/dict.c" 3 4
          0
# 31 "project/radare2/shlr/sdb/src/dict.c"
               ;
   }
   m->size = size;
  }
 ...
 return 
# 37 "project/radare2/shlr/sdb/src/dict.c" 3 4
       1
# 37 "project/radare2/shlr/sdb/src/dict.c"
           ;
}
...
__attribute__ ((visibility ("default"))) void dict_fini (dict *m) {
 ...
 if (m) {
  ...
  free (m->table);
  dict_init (m, 0, 
# 60 "project/radare2/shlr/sdb/src/dict.c" 3 4
                  ((void *)0)
# 60 "project/radare2/shlr/sdb/src/dict.c"
                      );
 }
}

__attribute__ ((visibility ("default"))) void dict_free (dict *m) {
 dict_fini (m);
 free (m);
}
...
__attribute__ ((visibility ("default"))) 
# 74 "project/radare2/shlr/sdb/src/dict.c" 3 4
       _Bool 
# 74 "project/radare2/shlr/sdb/src/dict.c"
            dict_set (dict *m, dicti k, dicti v, void *u) {
 if (!m || !m->size || k == 0) {
  return 
# 76 "project/radare2/shlr/sdb/src/dict.c" 3 4
        0
# 76 "project/radare2/shlr/sdb/src/dict.c"
             ;
 }
 ...
 if (!kv) {
  ...
  if (kv) {
   ...
   kv->v = 0;
   kv->u = 
# 86 "project/radare2/shlr/sdb/src/dict.c" 3 4
          ((void *)0)
# 86 "project/radare2/shlr/sdb/src/dict.c"
              ;
   return dict_set (m, k, v, u);
  }
  return 
# 89 "project/radare2/shlr/sdb/src/dict.c" 3 4
        0
# 89 "project/radare2/shlr/sdb/src/dict.c"
             ;
 }
 dictkv *tmp = kv;
 while (kv->k != 0) {
  if (kv->k == k) {
   ...
   kv->u = u;
   return 
# 96 "project/radare2/shlr/sdb/src/dict.c" 3 4
         1
# 96 "project/radare2/shlr/sdb/src/dict.c"
             ;
  }
  kv++;
 }
 ...
 if (newkv) {
  ...
  kv->v = 0;
  kv->u = 
# 111 "project/radare2/shlr/sdb/src/dict.c" 3 4
         ((void *)0)
# 111 "project/radare2/shlr/sdb/src/dict.c"
             ;
  return 
# 112 "project/radare2/shlr/sdb/src/dict.c" 3 4
        1
# 112 "project/radare2/shlr/sdb/src/dict.c"
            ;
 }
 return 
# 114 "project/radare2/shlr/sdb/src/dict.c" 3 4
       0
# 114 "project/radare2/shlr/sdb/src/dict.c"
            ;
}
...
__attribute__ ((visibility ("default"))) dictkv *dict_getr (dict *m, dicti k) {
 if (!m->size) {
  return 
# 135 "project/radare2/shlr/sdb/src/dict.c" 3 4
        ((void *)0)
# 135 "project/radare2/shlr/sdb/src/dict.c"
            ;
 }
 ...
 return 
# 147 "project/radare2/shlr/sdb/src/dict.c" 3 4
       ((void *)0)
# 147 "project/radare2/shlr/sdb/src/dict.c"
           ;
}
...
__attribute__ ((visibility ("default"))) void *dict_getu (dict *m, dicti k) {
 dictkv *kv = dict_getr (m, k);
 return kv ? kv->u : 
# 157 "project/radare2/shlr/sdb/src/dict.c" 3 4
                    ((void *)0)
# 157 "project/radare2/shlr/sdb/src/dict.c"
                        ;
}

__attribute__ ((visibility ("default"))) 
# 160 "project/radare2/shlr/sdb/src/dict.c" 3 4
       _Bool 
# 160 "project/radare2/shlr/sdb/src/dict.c"
            dict_add (dict *m, dicti k, dicti v, void *u) {
 return dict_getr (m, k)
  ? dict_set (m, k, v, u)
  : 
# 163 "project/radare2/shlr/sdb/src/dict.c" 3 4
   0
# 163 "project/radare2/shlr/sdb/src/dict.c"
        ;
}

__attribute__ ((visibility ("default"))) 
# 166 "project/radare2/shlr/sdb/src/dict.c" 3 4
       _Bool 
# 166 "project/radare2/shlr/sdb/src/dict.c"
            dict_del (dict *m, dicti k) {
 int bucket = dict_bucket (m, k);
 if (k == 0) {
  return 
# 169 "project/radare2/shlr/sdb/src/dict.c" 3 4
        0
# 169 "project/radare2/shlr/sdb/src/dict.c"
             ;
 }
 dictkv *kv = m->table[bucket];
 if (kv) {
  while (kv->k != 0) {
   if (kv->k == k) {
    ...
    kv->k = 0;
    return 
# 183 "project/radare2/shlr/sdb/src/dict.c" 3 4
          1
# 183 "project/radare2/shlr/sdb/src/dict.c"
              ;
   }
   kv++;
  }
 ...
 return 
# 188 "project/radare2/shlr/sdb/src/dict.c" 3 4
       0
# 188 "project/radare2/shlr/sdb/src/dict.c"
            ;
}
...
# 197 "project/radare2/shlr/sdb/src/dict.c" 3 4
_Bool 
# 197 "project/radare2/shlr/sdb/src/dict.c"
     iterate = 
# 197 "project/radare2/shlr/sdb/src/dict.c" 3 4
               1
# 197 "project/radare2/shlr/sdb/src/dict.c"
 ...
 for (i = 0; i < m->size && iterate; i++) {
  ...
  if (kv) {
   while (kv->k != 0) {
    ...
    if (res != 0) {
     iterate = 
# 206 "project/radare2/shlr/sdb/src/dict.c" 3 4
              0
# 206 "project/radare2/shlr/sdb/src/dict.c"
                   ;
     break;
    }
    kv++;
