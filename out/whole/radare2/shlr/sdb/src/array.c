# 0 "project/radare2/shlr/sdb/src/array.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/array.c"
...
# 4 "project/radare2/shlr/sdb/src/array.c" 2
...
# 5 "project/radare2/shlr/sdb/src/array.c" 2
...
static const char *Aindexof(const char *str, int idx) {
 ...
 return 
# 23 "project/radare2/shlr/sdb/src/array.c" 3 4
       ((void *)0)
# 23 "project/radare2/shlr/sdb/src/array.c"
           ;
}
...
__attribute__ ((visibility ("default"))) char *sdb_array_get(Sdb *s, const char *key, int idx, unsigned int *cas) {
 ...
 if (!str || !*str) {
  return 
# 89 "project/radare2/shlr/sdb/src/array.c" 3 4
        ((void *)0)
# 89 "project/radare2/shlr/sdb/src/array.c"
            ;
 }
 if (idx < 0) {
  ...
  if (idx > len) {
   return 
# 95 "project/radare2/shlr/sdb/src/array.c" 3 4
         ((void *)0)
# 95 "project/radare2/shlr/sdb/src/array.c"
             ;
  }
  idx = len - idx;
 }
 if (!idx) {
  ...
  if (!o) {
   return 
# 107 "project/radare2/shlr/sdb/src/array.c" 3 4
         ((void *)0)
# 107 "project/radare2/shlr/sdb/src/array.c"
             ;
  }
  
# 109 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 109 "project/radare2/shlr/sdb/src/array.c"
 o
# 109 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 109 "project/radare2/shlr/sdb/src/array.c"
...
# 109 "project/radare2/shlr/sdb/src/array.c"
 ...
 for (i = 0; i < idx; i++) {
  n = strchr (p, ',');
  if (!n) return 
# 115 "project/radare2/shlr/sdb/src/array.c" 3 4
                ((void *)0)
# 115 "project/radare2/shlr/sdb/src/array.c"
                    ;
  p = n + 1;
 }
 n = strchr (p, ',');
...
# 125 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 125 "project/radare2/shlr/sdb/src/array.c"
 o
# 125 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 125 "project/radare2/shlr/sdb/src/array.c"
...
# 125 "project/radare2/shlr/sdb/src/array.c"
 ...
 return 
# 129 "project/radare2/shlr/sdb/src/array.c" 3 4
       ((void *)0)
# 129 "project/radare2/shlr/sdb/src/array.c"
           ;
}

__attribute__ ((visibility ("default"))) int sdb_array_insert_num(Sdb *s, const char *key, int idx, unsigned long long val,
      unsigned int cas) {
 char valstr[64];
 return sdb_array_insert (s, key, idx,
     sdb_itoa (val, valstr, 16), cas);
}


__attribute__ ((visibility ("default"))) int sdb_array_insert(Sdb *s, const char *key, int idx, const char *val,
         unsigned int cas) {
 int lnstr, lstr;
 size_t lval;
 char *x, *ptr;
 ...
 if (((
# 158 "project/radare2/shlr/sdb/src/array.c" 3 4
    18446744073709551615UL 
# 158 "project/radare2/shlr/sdb/src/array.c"
    - (lval)) <= (lstr_tmp)) || ((
# 158 "project/radare2/shlr/sdb/src/array.c" 3 4
                                       18446744073709551615UL 
# 158 "project/radare2/shlr/sdb/src/array.c"
                                       - (lval + lstr_tmp)) <= (2))) {
  return 
# 159 "project/radare2/shlr/sdb/src/array.c" 3 4
        0
# 159 "project/radare2/shlr/sdb/src/array.c"
             ;
 }
 x = malloc (lval + lstr_tmp + 2);
 if (!x) {
  return 
# 163 "project/radare2/shlr/sdb/src/array.c" 3 4
        0
# 163 "project/radare2/shlr/sdb/src/array.c"
             ;
 }

 if (idx == -1) {
  
# 167 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 167 "project/radare2/shlr/sdb/src/array.c"
 x
# 167 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 167 "project/radare2/shlr/sdb/src/array.c"
...
# 169 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 169 "project/radare2/shlr/sdb/src/array.c"
 x + lstr + 1
# 169 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 169 "project/radare2/shlr/sdb/src/array.c"
...
# 171 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 171 "project/radare2/shlr/sdb/src/array.c"
 x
# 171 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 171 "project/radare2/shlr/sdb/src/array.c"
...
# 173 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 173 "project/radare2/shlr/sdb/src/array.c"
 x + lval + 1
# 173 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 173 "project/radare2/shlr/sdb/src/array.c"
...
# 173 "project/radare2/shlr/sdb/src/array.c"
  ...
  if (!nstr) {
   free (x);
   return 
# 178 "project/radare2/shlr/sdb/src/array.c" 3 4
         0
# 178 "project/radare2/shlr/sdb/src/array.c"
              ;
  }
  
# 180 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 180 "project/radare2/shlr/sdb/src/array.c"
 nstr
# 180 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 180 "project/radare2/shlr/sdb/src/array.c"
...
# 187 "project/radare2/shlr/sdb/src/array.c" 3 4
  __builtin___memcpy_chk (
# 187 "project/radare2/shlr/sdb/src/array.c"
  x
# 187 "project/radare2/shlr/sdb/src/array.c" 3 4
  , 
# 187 "project/radare2/shlr/sdb/src/array.c"
...
# 189 "project/radare2/shlr/sdb/src/array.c" 3 4
  __builtin___memcpy_chk (
# 189 "project/radare2/shlr/sdb/src/array.c"
  x + lnstr + 1
# 189 "project/radare2/shlr/sdb/src/array.c" 3 4
  , 
# 189 "project/radare2/shlr/sdb/src/array.c"
...
# 192 "project/radare2/shlr/sdb/src/array.c" 3 4
  __builtin___memcpy_chk (
# 192 "project/radare2/shlr/sdb/src/array.c"
  x + lval + 2 + lnstr
# 192 "project/radare2/shlr/sdb/src/array.c" 3 4
  , 
# 192 "project/radare2/shlr/sdb/src/array.c"
...
__attribute__ ((visibility ("default"))) int sdb_array_set_num(Sdb *s, const char *key, int idx, unsigned long long val,
          unsigned int cas) {
 char valstr[64];
 return sdb_array_set (s, key, idx, sdb_itoa (val, valstr, 16),
         cas);
}

__attribute__ ((visibility ("default"))) int sdb_array_add_num(Sdb *s, const char *key, unsigned long long val, unsigned int cas) {
 char buf[64];
 char *v = sdb_itoa (val, buf, 16);
 if (!sdb_array_contains (s, key, v, 
# 215 "project/radare2/shlr/sdb/src/array.c" 3 4
                                    ((void *)0)
# 215 "project/radare2/shlr/sdb/src/array.c"
                                        )) {
  if (val < 256) {
...
# 226 "project/radare2/shlr/sdb/src/array.c" 3 4
                                     ((void *)0)
# 226 "project/radare2/shlr/sdb/src/array.c"
                                         )) {
  return 0;
 }
...
__attribute__ ((visibility ("default"))) int sdb_array_add_sorted(Sdb *s, const char *key, const char *val, unsigned int cas) {
 ...
 if (i > 1) {
  qsort (vals, i, sizeof (unsigned long long*), cstring_cmp);
 }
...
# 268 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 268 "project/radare2/shlr/sdb/src/array.c"
 nstr_p
# 268 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 268 "project/radare2/shlr/sdb/src/array.c"
...
# 275 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 275 "project/radare2/shlr/sdb/src/array.c"
 nstr_p
# 275 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 275 "project/radare2/shlr/sdb/src/array.c"
...
# 280 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 280 "project/radare2/shlr/sdb/src/array.c"
 nstr_p
# 280 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 280 "project/radare2/shlr/sdb/src/array.c"
...
__attribute__ ((visibility ("default"))) int sdb_array_add_sorted_num(Sdb *s, const char *key, unsigned long long val,
          unsigned int cas) {
 int i;
 char valstr[64];
 ...
 const char *n = str;
 if (!str || !*str) {
  return sdb_set (s, key, sdb_itoa (val, valstr, 16), cas);
 }
 for (i = 0; n; i++) {
  if (val <= sdb_atoi (n)) {
   break;
...
__attribute__ ((visibility ("default"))) int sdb_array_unset(Sdb *s, const char *key, int idx, unsigned int cas) {
 return sdb_array_set (s, key, idx, "", cas);
}

__attribute__ ((visibility ("default"))) 
# 313 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 313 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_append(Sdb *s, const char *key, const char *val,
          unsigned int cas) {



 int str_len = 0;
 unsigned int kas = cas;
 const char *str = sdb_const_get_len (s, key, &str_len, &kas);
 if (!val || (cas && cas != kas)) {
  return 
# 322 "project/radare2/shlr/sdb/src/array.c" 3 4
        0
# 322 "project/radare2/shlr/sdb/src/array.c"
             ;
 }
 cas = kas;
 if (str && *str && str_len > 0) {
  ...
  if (!newval) {
   return 
# 329 "project/radare2/shlr/sdb/src/array.c" 3 4
         0
# 329 "project/radare2/shlr/sdb/src/array.c"
              ;
  }
  
# 331 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 331 "project/radare2/shlr/sdb/src/array.c"
 newval
# 331 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 331 "project/radare2/shlr/sdb/src/array.c"
...
# 333 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 333 "project/radare2/shlr/sdb/src/array.c"
 newval+str_len+1
# 333 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 333 "project/radare2/shlr/sdb/src/array.c"
...
# 333 "project/radare2/shlr/sdb/src/array.c"
 ...
 return 
# 339 "project/radare2/shlr/sdb/src/array.c" 3 4
       1
# 339 "project/radare2/shlr/sdb/src/array.c"
           ;

}

__attribute__ ((visibility ("default"))) 
# 343 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 343 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_append_num(Sdb *s, const char *key, unsigned long long val, unsigned int cas) {
 return sdb_array_set_num (s, key, -1, val, cas);
}

__attribute__ ((visibility ("default"))) int sdb_array_set(Sdb *s, const char *key, int idx, const char *val,
      unsigned int cas) {
 int lstr, lval, len;
...
# 372 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 372 "project/radare2/shlr/sdb/src/array.c"
 newkey + i
# 372 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 372 "project/radare2/shlr/sdb/src/array.c"
...
# 372 "project/radare2/shlr/sdb/src/array.c"
 ...
 if (ptr) {
  ...
  if (!nstr) {
   return 
# 383 "project/radare2/shlr/sdb/src/array.c" 3 4
         0
# 383 "project/radare2/shlr/sdb/src/array.c"
              ;
  }
  ptr = nstr + diff;

  
# 387 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 387 "project/radare2/shlr/sdb/src/array.c"
 nstr
# 387 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 387 "project/radare2/shlr/sdb/src/array.c"
...
# 388 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 388 "project/radare2/shlr/sdb/src/array.c"
 ptr
# 388 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 388 "project/radare2/shlr/sdb/src/array.c"
...
# 392 "project/radare2/shlr/sdb/src/array.c" 3 4
  __builtin___strcpy_chk (
# 392 "project/radare2/shlr/sdb/src/array.c"
  ptr + lval + 1
# 392 "project/radare2/shlr/sdb/src/array.c" 3 4
  , 
# 392 "project/radare2/shlr/sdb/src/array.c"
...
__attribute__ ((visibility ("default"))) int sdb_array_indexof(Sdb *s, const char *key, const char *val,
          unsigned int cas) {
 const char *str = sdb_const_get (s, key, 0);
 const char *n, *p = str;
 int i;
...
__attribute__ ((visibility ("default"))) int sdb_array_remove (Sdb *s, const char *key, const char *val,
         unsigned int cas) {
 const char *str = sdb_const_get (s, key, 0);
 const char *n, *p = str;
 int idx;
...
__attribute__ ((visibility ("default"))) int sdb_array_delete(Sdb *s, const char *key, int idx, unsigned int cas) {
 int i;
...
# 482 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memmove_chk (
# 482 "project/radare2/shlr/sdb/src/array.c"
 p
# 482 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 482 "project/radare2/shlr/sdb/src/array.c"
...
__attribute__ ((visibility ("default"))) 
# 494 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 494 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_contains_num(Sdb *s, const char *key, unsigned long long num, unsigned int *cas) {
 char val[64];
 char *nval = sdb_itoa (num, val, 16);
 return sdb_array_contains (s, key, nval, cas);
}

__attribute__ ((visibility ("default"))) 
# 500 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 500 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_contains(Sdb *s, const char *key, const char *val, unsigned int *cas) {
 if (!s || !key || !val) {
  return 
# 502 "project/radare2/shlr/sdb/src/array.c" 3 4
        0
# 502 "project/radare2/shlr/sdb/src/array.c"
             ;
 }
 ...
 if (ptr && *ptr) {
  ...
  while (1) {
   ...
   if (len == vlen && !memcmp (ptr, val, len)) {
    return 
# 511 "project/radare2/shlr/sdb/src/array.c" 3 4
          1
# 511 "project/radare2/shlr/sdb/src/array.c"
              ;
   }
   if (!next) {
    break;
 ...
 return 
# 519 "project/radare2/shlr/sdb/src/array.c" 3 4
       0
# 519 "project/radare2/shlr/sdb/src/array.c"
            ;
}
...
__attribute__ ((visibility ("default"))) int sdb_array_push_num(Sdb *s, const char *key, unsigned long long num, unsigned int cas) {
 char buf[64], *n = sdb_itoa (num, buf, 16);
 return sdb_array_push (s, key, n, cas);
}

__attribute__ ((visibility ("default"))) 
# 536 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 536 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_push(Sdb *s, const char *key, const char *val, unsigned int cas) {
...
__attribute__ ((visibility ("default"))) 
# 544 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 544 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_prepend_num(Sdb *s, const char *key, unsigned long long num, unsigned int cas) {
 char buf[64];
 char *n = sdb_itoa (num, buf, 16);
 return sdb_array_push (s, key, n, cas);
}

__attribute__ ((visibility ("default"))) 
# 550 "project/radare2/shlr/sdb/src/array.c" 3 4
       _Bool 
# 550 "project/radare2/shlr/sdb/src/array.c"
            sdb_array_prepend (Sdb *s, const char *key, const char *val, unsigned int cas) {
 if (!s || !key || !val) {
  return 
# 552 "project/radare2/shlr/sdb/src/array.c" 3 4
        0
# 552 "project/radare2/shlr/sdb/src/array.c"
             ;
 }
 int str_len = 0;
 unsigned int kas = cas;
 ...
 if (!val || (cas && cas != kas)) {
  return 
# 558 "project/radare2/shlr/sdb/src/array.c" 3 4
        0
# 558 "project/radare2/shlr/sdb/src/array.c"
             ;
 }
 cas = kas;
 if (str && *str) {
  ...
  if (!newval) {
   return 
# 565 "project/radare2/shlr/sdb/src/array.c" 3 4
         0
# 565 "project/radare2/shlr/sdb/src/array.c"
              ;
  }
  
# 567 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 567 "project/radare2/shlr/sdb/src/array.c"
 newval
# 567 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 567 "project/radare2/shlr/sdb/src/array.c"
...
# 569 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 569 "project/radare2/shlr/sdb/src/array.c"
 newval + val_len + 1
# 569 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 569 "project/radare2/shlr/sdb/src/array.c"
...
# 569 "project/radare2/shlr/sdb/src/array.c"
 ...
 return 
# 576 "project/radare2/shlr/sdb/src/array.c" 3 4
       1
# 576 "project/radare2/shlr/sdb/src/array.c"
           ;
}
...
__attribute__ ((visibility ("default"))) unsigned long long sdb_array_pop_num(Sdb *s, const char *key, unsigned int *cas) {
 ...
 if (!a) {
  if (cas) {
   *cas = ((unsigned int)0xffffffff);
  }
  return ((unsigned long long)(0xffffffffffffffffLL));
 }
 if (cas) {
  *cas = 0;
 }
...
__attribute__ ((visibility ("default"))) char *sdb_array_pop_head(Sdb *s, const char *key, unsigned int *cas) {
 ...
 if (!str || !*str) {
  free (str);
  return 
# 610 "project/radare2/shlr/sdb/src/array.c" 3 4
        ((void *)0)
# 610 "project/radare2/shlr/sdb/src/array.c"
            ;
 }
 if (cas && *cas != kas) {
  *cas = kas;
...
__attribute__ ((visibility ("default"))) char *sdb_array_pop_tail(Sdb *s, const char *key, unsigned int *cas) {
 ...
 if (!str || !*str) {
  free (str);
  return 
# 630 "project/radare2/shlr/sdb/src/array.c" 3 4
        ((void *)0)
# 630 "project/radare2/shlr/sdb/src/array.c"
            ;
 }
 if (cas && *cas != kas) {
  *cas = kas;
...
# 665 "project/radare2/shlr/sdb/src/array.c" 3 4
 __builtin___memcpy_chk (
# 665 "project/radare2/shlr/sdb/src/array.c"
 nstr
# 665 "project/radare2/shlr/sdb/src/array.c" 3 4
 , 
# 665 "project/radare2/shlr/sdb/src/array.c"
...
__attribute__ ((visibility ("default"))) void sdb_array_sort_num(Sdb *s, const char *key, unsigned int cas) {
 ...
 unsigned long long *nums = sdb_fmt_array_num (str);
 free (str);
 if (!nums) {
  return;
 }

 qsort (nums + 1, (int)*nums, sizeof (unsigned long long), int_cmp);
...
# 702 "project/radare2/shlr/sdb/src/array.c" 3 4
__builtin___memset_chk (
# 702 "project/radare2/shlr/sdb/src/array.c"
nstr
# 702 "project/radare2/shlr/sdb/src/array.c" 3 4
, 
# 702 "project/radare2/shlr/sdb/src/array.c"
