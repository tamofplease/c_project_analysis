# 0 "project/radare2/shlr/sdb/src/util.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/util.c"
...
# 4 "project/radare2/shlr/sdb/src/util.c" 2

#define FORCE_COLLISION 0
# 61 "project/radare2/shlr/sdb/src/util.c"
...
# 62 "project/radare2/shlr/sdb/src/util.c" 2




# 65 "project/radare2/shlr/sdb/src/util.c"
__attribute__ ((visibility ("default"))) unsigned int sdb_hash_len(const char *s, unsigned int *len) {
 unsigned int h = 5381;
...
__attribute__ ((visibility ("default"))) unsigned int sdb_hash(const char *s) {
 return sdb_hash_len (s, 
# 89 "project/radare2/shlr/sdb/src/util.c" 3 4
                        ((void *)0)
# 89 "project/radare2/shlr/sdb/src/util.c"
                            );
}

__attribute__ ((visibility ("default"))) unsigned char sdb_hash_byte(const char *s) {
 const unsigned int hash = sdb_hash_len (s, 
# 93 "project/radare2/shlr/sdb/src/util.c" 3 4
                                   ((void *)0)
# 93 "project/radare2/shlr/sdb/src/util.c"
                                       );
 const unsigned char *h = (const unsigned char*)&hash;
 return h[0] ^ h[1] ^ h[2] ^ h[3];
}

__attribute__ ((visibility ("default"))) const char *sdb_itoca(unsigned long long n) {
 return sdb_itoa (n, sdb_fmt (
# 99 "project/radare2/shlr/sdb/src/util.c" 3 4
                             ((void *)0)
# 99 "project/radare2/shlr/sdb/src/util.c"
                                 ), 16);
}



__attribute__ ((visibility ("default"))) char *sdb_itoa(unsigned long long n, char *os, int base) {
 static const char* lookup = "0123456789abcdef";
 char tmpbuf[64], *s = 
# 106 "project/radare2/shlr/sdb/src/util.c" 3 4
                      ((void *)0)
# 106 "project/radare2/shlr/sdb/src/util.c"
                          ;
 const int imax = 62;
 ...
 if ((base > 16) || (base < 1)) {
  return 
# 120 "project/radare2/shlr/sdb/src/util.c" 3 4
        ((void *)0)
# 120 "project/radare2/shlr/sdb/src/util.c"
            ;
 }
 if (!n) {
  if (!os) {
...
# 126 "project/radare2/shlr/sdb/src/util.c" 3 4
 __builtin___strcpy_chk (
# 126 "project/radare2/shlr/sdb/src/util.c"
 os
# 126 "project/radare2/shlr/sdb/src/util.c" 3 4
 , 
# 126 "project/radare2/shlr/sdb/src/util.c"
...
# 149 "project/radare2/shlr/sdb/src/util.c" 3 4
 __builtin___memmove_chk (
# 149 "project/radare2/shlr/sdb/src/util.c"
 os
# 149 "project/radare2/shlr/sdb/src/util.c" 3 4
 , 
# 149 "project/radare2/shlr/sdb/src/util.c"
 s + i + 1, strlen (s + i + 1) + 1
# 149 "project/radare2/shlr/sdb/src/util.c" 3 4
 , __builtin_object_size (
# 149 "project/radare2/shlr/sdb/src/util.c"
 os
...
# 173 "project/radare2/shlr/sdb/src/util.c" 3 4
  __builtin___memmove_chk (
# 173 "project/radare2/shlr/sdb/src/util.c"
  p
# 173 "project/radare2/shlr/sdb/src/util.c" 3 4
  , 
# 173 "project/radare2/shlr/sdb/src/util.c"
...
__attribute__ ((visibility ("default"))) char *sdb_aslice(char *out, int from, int to) {
 int len, idx = 0;
 char *str = 
# 184 "project/radare2/shlr/sdb/src/util.c" 3 4
            ((void *)0)
# 184 "project/radare2/shlr/sdb/src/util.c"
                ;
 char *end = 
# 185 "project/radare2/shlr/sdb/src/util.c" 3 4
            ((void *)0)
# 185 "project/radare2/shlr/sdb/src/util.c"
                ;
 char *p = out;
 if (from >= to) {
  return 
# 188 "project/radare2/shlr/sdb/src/util.c" 3 4
        ((void *)0)
# 188 "project/radare2/shlr/sdb/src/util.c"
            ;
 }
 while (*p) {
  if (!str && idx == from) {
...
# 208 "project/radare2/shlr/sdb/src/util.c" 3 4
 __builtin___memmove_chk (
# 208 "project/radare2/shlr/sdb/src/util.c"
 out
# 208 "project/radare2/shlr/sdb/src/util.c" 3 4
 , 
# 208 "project/radare2/shlr/sdb/src/util.c"
...
# 208 "project/radare2/shlr/sdb/src/util.c"
 ...
 return 
# 212 "project/radare2/shlr/sdb/src/util.c" 3 4
       ((void *)0)
# 212 "project/radare2/shlr/sdb/src/util.c"
           ;
}
...
__attribute__ ((visibility ("default"))) char *sdb_anext(char *str, char **next) {
  ...
  *p = 0;
  ...
  nxt = 
# 263 "project/radare2/shlr/sdb/src/util.c" 3 4
       ((void *)0)
# 263 "project/radare2/shlr/sdb/src/util.c"
           ;
 }
 if (next) {
  *next = nxt;
...
__attribute__ ((visibility ("default"))) const char *sdb_const_anext(const char *str) {
 ...
 return p ? p + 1 : 
# 273 "project/radare2/shlr/sdb/src/util.c" 3 4
                   ((void *)0)
# 273 "project/radare2/shlr/sdb/src/util.c"
                       ;
}
...
__attribute__ ((visibility ("default"))) unsigned long long sdb_now (void) {
 ...
 struct timeval now;
 if (!gettimeofday (&now, 
# 284 "project/radare2/shlr/sdb/src/util.c" 3 4
                         ((void *)0)
# 284 "project/radare2/shlr/sdb/src/util.c"
                             )) {
  return now.tv_sec;
 }
...
# 301 "project/radare2/shlr/sdb/src/util.c"
        struct timeval now;
        if (!gettimeofday (&now, 
# 302 "project/radare2/shlr/sdb/src/util.c" 3 4
                                ((void *)0)
# 302 "project/radare2/shlr/sdb/src/util.c"
                                    )) {
  x = now.tv_sec;
  x <<= 32;
  x += now.tv_usec;
...
__attribute__ ((visibility ("default"))) 
# 346 "project/radare2/shlr/sdb/src/util.c" 3 4
       _Bool 
# 346 "project/radare2/shlr/sdb/src/util.c"
            sdb_isjson (const char *k) {
 int level = 0;
 
# 348 "project/radare2/shlr/sdb/src/util.c" 3 4
_Bool 
# 348 "project/radare2/shlr/sdb/src/util.c"
     quotes = 
# 348 "project/radare2/shlr/sdb/src/util.c" 3 4
              0
# 348 "project/radare2/shlr/sdb/src/util.c"
 ...
 if (!k || (*k != '{' && *k != '[')) {
  return 
# 350 "project/radare2/shlr/sdb/src/util.c" 3 4
        0
# 350 "project/radare2/shlr/sdb/src/util.c"
             ;
 }
 for (; *k; k++) {
  if (quotes) {
   if (*k == '"') {
    quotes = 
# 355 "project/radare2/shlr/sdb/src/util.c" 3 4
            0
# 355 "project/radare2/shlr/sdb/src/util.c"
                 ;
   }
   continue;
  }
  ...
  case '"':
   quotes = 
# 361 "project/radare2/shlr/sdb/src/util.c" 3 4
           1
# 361 "project/radare2/shlr/sdb/src/util.c"
               ;
   break;
  case '[':
  case '{':
  ...
  case '}':
   ...
   if (level < 0) {
    ...
    return 
# 372 "project/radare2/shlr/sdb/src/util.c" 3 4
          0
# 372 "project/radare2/shlr/sdb/src/util.c"
               ;
   }
   break;
  }
