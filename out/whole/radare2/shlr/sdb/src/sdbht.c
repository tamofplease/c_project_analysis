# 0 "project/radare2/shlr/sdb/src/sdbht.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/sdbht.c"
...
# 5 "project/radare2/shlr/sdb/src/ls.h" 2
...
# 6 "project/radare2/shlr/sdb/src/ls.h" 2
...
# 50 "project/radare2/shlr/sdb/src/sdbht.h"
                                                             * found);
# 4 "project/radare2/shlr/sdb/src/sdbht.c" 2
...
static 
# 18 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
      _Bool 
# 18 "project/radare2/shlr/sdb/src/sdbht.c"
           sdb_ht_internal_insert(HtPP* ht, const char* key, const char* value, 
# 18 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
                                                                                _Bool 
# 18 "project/radare2/shlr/sdb/src/sdbht.c"
                                                                                     update) {
 if (!ht || !key || !value) {
  return 
# 20 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
        0
# 20 "project/radare2/shlr/sdb/src/sdbht.c"
             ;
 }
 SdbKv kvp = {{ 0 }};
 ...
 free (kvp.base.value);
 return 
# 39 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
       0
# 39 "project/radare2/shlr/sdb/src/sdbht.c"
            ;
}

__attribute__ ((visibility ("default"))) 
# 42 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
       _Bool 
# 42 "project/radare2/shlr/sdb/src/sdbht.c"
            sdb_ht_insert(HtPP* ht, const char* key, const char* value) {
 return sdb_ht_internal_insert (ht, key, value, 
# 43 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
                                               0
# 43 "project/radare2/shlr/sdb/src/sdbht.c"
                                                    );
}

__attribute__ ((visibility ("default"))) 
# 46 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
       _Bool 
# 46 "project/radare2/shlr/sdb/src/sdbht.c"
            sdb_ht_insert_kvp(HtPP* ht, SdbKv *kvp, 
# 46 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
                                                    _Bool 
# 46 "project/radare2/shlr/sdb/src/sdbht.c"
...
__attribute__ ((visibility ("default"))) 
# 50 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
       _Bool 
# 50 "project/radare2/shlr/sdb/src/sdbht.c"
            sdb_ht_update(HtPP *ht, const char *key, const char* value) {
 return sdb_ht_internal_insert (ht, key, value, 
# 51 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
                                               1
# 51 "project/radare2/shlr/sdb/src/sdbht.c"
                                                   );
}

__attribute__ ((visibility ("default"))) SdbKv* sdb_ht_find_kvp(HtPP* ht, const char* key, 
# 54 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
                                                         _Bool
# 54 "project/radare2/shlr/sdb/src/sdbht.c"
                                                             * found) {
 return (SdbKv *)ht_pp_find_kv (ht, key, found);
}

__attribute__ ((visibility ("default"))) char* sdb_ht_find(HtPP* ht, const char* key, 
# 58 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
                                                    _Bool
# 58 "project/radare2/shlr/sdb/src/sdbht.c"
                                                        * found) {
...
__attribute__ ((visibility ("default"))) 
# 66 "project/radare2/shlr/sdb/src/sdbht.c" 3 4
       _Bool 
# 66 "project/radare2/shlr/sdb/src/sdbht.c"
            sdb_ht_delete(HtPP* ht, const char *key) {
