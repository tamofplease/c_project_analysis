# 0 "project/radare2/shlr/sdb/src/set.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/set.c"


# 1 "project/radare2/shlr/sdb/src/set.h" 1
...
# 5 "project/radare2/shlr/sdb/src/set.h" 2
...
#undef KEY_TO_HASH
#undef HT_NULL_VALUE
# 24 "project/radare2/shlr/sdb/src/ht_inc.h"
...
# 50 "project/radare2/shlr/sdb/src/sdbht.h"
                                                             * found);
# 12 "project/radare2/shlr/sdb/src/ht_up.h" 2
...
#undef HT_TYPE
# 6 "project/radare2/shlr/sdb/src/set.h" 2

typedef HtPP SetP;
typedef 
# 8 "project/radare2/shlr/sdb/src/set.h" 3 4
       _Bool 
# 8 "project/radare2/shlr/sdb/src/set.h"
            (*set_p_foreach_cb)(void *userdata, const void *p);
typedef 
# 9 "project/radare2/shlr/sdb/src/set.h" 3 4
       _Bool 
# 9 "project/radare2/shlr/sdb/src/set.h"
            (*set_u_foreach_cb)(void *userdata, const unsigned long long u);

__attribute__ ((visibility ("default"))) SetP *set_p_new(void);
__attribute__ ((visibility ("default"))) void set_p_add(SetP *p, void *u);
__attribute__ ((visibility ("default"))) 
# 13 "project/radare2/shlr/sdb/src/set.h" 3 4
       _Bool 
# 13 "project/radare2/shlr/sdb/src/set.h"
            set_p_contains(SetP *s, void *u);
...
__attribute__ ((visibility ("default"))) 
# 22 "project/radare2/shlr/sdb/src/set.h" 3 4
       _Bool 
# 22 "project/radare2/shlr/sdb/src/set.h"
            set_u_contains(SetU *s, unsigned long long u);
...
# 4 "project/radare2/shlr/sdb/src/set.c" 2
...
static 
# 11 "project/radare2/shlr/sdb/src/set.c" 3 4
      _Bool 
# 11 "project/radare2/shlr/sdb/src/set.c"
           u_foreach_cb(void *user, const unsigned long long k, const void *nada) {
 SetData *sd = (SetData*)user;
 set_u_foreach_cb cb = (set_u_foreach_cb)sd->cbptr;
 return cb (sd->userdata, k);
}

__attribute__ ((visibility ("default"))) void set_u_foreach(SetU *s, set_u_foreach_cb cb, void *userdata) {
 SetData sd = {cb, userdata};
 ht_up_foreach (s, u_foreach_cb, &sd);
}

static 
# 22 "project/radare2/shlr/sdb/src/set.c" 3 4
      _Bool 
# 22 "project/radare2/shlr/sdb/src/set.c"
           p_foreach_cb(void *user, const void *k, const void *nada) {
 SetData *sd = (SetData*)user;
 set_p_foreach_cb cb = (set_p_foreach_cb)sd->cbptr;
 return cb (sd->userdata, k);
}

__attribute__ ((visibility ("default"))) void set_p_foreach(SetP *s, set_p_foreach_cb cb, void *userdata) {
 SetData sd = {cb, userdata};
...
__attribute__ ((visibility ("default"))) void set_p_add(SetP *s, void *u) {
 ht_pp_insert (s, u, (void*)1);
}

__attribute__ ((visibility ("default"))) 
# 42 "project/radare2/shlr/sdb/src/set.c" 3 4
       _Bool 
# 42 "project/radare2/shlr/sdb/src/set.c"
            set_p_contains(SetP *s, void *u) {
 return ht_pp_find (s, u, 
# 43 "project/radare2/shlr/sdb/src/set.c" 3 4
                         ((void *)0)
# 43 "project/radare2/shlr/sdb/src/set.c"
                             ) != 
# 43 "project/radare2/shlr/sdb/src/set.c" 3 4
                                  ((void *)0)
# 43 "project/radare2/shlr/sdb/src/set.c"
...
__attribute__ ((visibility ("default"))) void set_u_add(SetU *s, unsigned long long u) {
 ht_up_insert (s, u, (void*)1);
}

__attribute__ ((visibility ("default"))) 
# 64 "project/radare2/shlr/sdb/src/set.c" 3 4
       _Bool 
# 64 "project/radare2/shlr/sdb/src/set.c"
            set_u_contains(SetU *s, unsigned long long u) {
 return ht_up_find (s, u, 
# 65 "project/radare2/shlr/sdb/src/set.c" 3 4
                         ((void *)0)
# 65 "project/radare2/shlr/sdb/src/set.c"
                             ) != 
# 65 "project/radare2/shlr/sdb/src/set.c" 3 4
                                  ((void *)0)
# 65 "project/radare2/shlr/sdb/src/set.c"
...
__attribute__ ((visibility ("default"))) void set_u_free(SetU *s) {
 ht_up_free (s);
}
