# 0 "project/radare2/shlr/sdb/src/base64.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/base64.c"
...
# 4 "project/radare2/shlr/sdb/src/base64.c" 2
...
# 5 "project/radare2/shlr/sdb/src/base64.c" 2
...
# 6 "project/radare2/shlr/sdb/src/base64.c" 2
...
# 7 "project/radare2/shlr/sdb/src/base64.c" 2

#define SZ 1024
static const char cb64[]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
static const char cd64[]="|$$$}rstuvwxyz{$$$$$$$>?@ABCDEFGHIJKLMNOPQRSTUVW$$$$$$XYZ[\\]^_`abcdefghijklmnopq";

static void sdb_b64_encode(const unsigned char in[3], char out[4], int len) {
 if (len < 1) {
  return;
 }
 out[0] = cb64[ in[0] >> 2 ];
...
static int sdb_b64_decode(const char in[4], unsigned char out[3]) {
 int len = 3;
 unsigned char i, v[4] = {0};
 for (i = 0; i < 4; i++) {
  if (in[i] < '+' || in[i] > 'z') {
   return -1;
  }
...
__attribute__ ((visibility ("default"))) char *sdb_encode(const unsigned char *bin, int len) {
 ...
 if (!bin) {
  return 
# 66 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 66 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
 if (len < 0) {
 ...
 if (!out) {
  return 
# 76 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 76 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
...
__attribute__ ((visibility ("default"))) unsigned char *sdb_decode (const char *in, int *len) {
 ...
 if (!in) {
  return 
# 90 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 90 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
 ilen = strlen (in);
 if (!ilen) {
  return 
# 94 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 94 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
 size = (ilen * 3) + 16;
 if (size < (unsigned int)ilen) {
  return 
# 98 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 98 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
 out = calloc (1, size);
 if (!out) {
  return 
# 102 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 102 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
 ...
 if (!olen) {
  free (out);
  return 
# 107 "project/radare2/shlr/sdb/src/base64.c" 3 4
        ((void *)0)
# 107 "project/radare2/shlr/sdb/src/base64.c"
            ;
 }
 out[olen] = 0;
 if (len) {
