# 0 "project/radare2/shlr/sdb/src/ht_uu.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/ht_uu.c"
...
#define HAVE_MMAN 1
#define ULLFMT "ll"
# 72 "project/radare2/shlr/sdb/src/types.h"
...
# 62 "project/radare2/shlr/sdb/src/sdb.h"
...
# 2 "project/radare2/shlr/sdb/src/ht_uu.c" 2
# 1 "project/radare2/shlr/sdb/src/ht_uu.h" 1
...
#undef KEY_TO_HASH
#undef HT_NULL_VALUE
# 32 "project/radare2/shlr/sdb/src/ht_inc.h"
...
# 53 "project/radare2/shlr/sdb/src/ht_inc.h"
...
# 67 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 67 "project/radare2/shlr/sdb/src/ht_inc.h"
            (*HtUUForeachCallback)(void *user, const unsigned long long, const unsigned long long);
...
# 100 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 100 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_uu_insert(HtUU* ht, const unsigned long long key, unsigned long long value);

__attribute__ ((visibility ("default"))) 
# 102 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 102 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_uu_update(HtUU* ht, const unsigned long long key, unsigned long long value);

__attribute__ ((visibility ("default"))) 
# 104 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 104 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_uu_update_key(HtUU* ht, const unsigned long long old_key, const unsigned long long new_key);

__attribute__ ((visibility ("default"))) 
# 106 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 106 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_uu_delete(HtUU* ht, const unsigned long long key);

__attribute__ ((visibility ("default"))) unsigned long long ht_uu_find(HtUU* ht, const unsigned long long key, 
# 108 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                                 _Bool
# 108 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                                     * found);
...
__attribute__ ((visibility ("default"))) HtUUKv* ht_uu_find_kv(HtUU* ht, const unsigned long long key, 
# 115 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                                  _Bool
# 115 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                                      * found);
...
# 116 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_uu_insert_kv(HtUU *ht, HtUUKv *kv, 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                         _Bool 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                              update);
...
#undef HT_TYPE
# 11 "project/radare2/shlr/sdb/src/ht_uu.h" 2


__attribute__ ((visibility ("default"))) HtUU* ht_uu_new0(void);
# 3 "project/radare2/shlr/sdb/src/ht_uu.c" 2
# 1 "project/radare2/shlr/sdb/src/ht_inc.c" 1
...
static const unsigned int ht_primes_sizes[] = {
...
static inline unsigned int hashfn(HtUU *ht, const unsigned long long k) {
 return ht->opt.hashfn ? ht->opt.hashfn (k) : ((unsigned int)(k));
}

static inline unsigned int bucketfn(HtUU *ht, const unsigned long long k) {
 return hashfn (ht, k) % ht->size;
}

static inline unsigned long long dupkey(HtUU *ht, const unsigned long long k) {
 return ht->opt.dupkey ? ht->opt.dupkey (k) : (unsigned long long)k;
}

static inline unsigned long long dupval(HtUU *ht, const unsigned long long v) {
 return ht->opt.dupvalue ? ht->opt.dupvalue (v) : (unsigned long long)v;
}

static inline unsigned int calcsize_key(HtUU *ht, const unsigned long long k) {
 return ht->opt.calcsizeK ? ht->opt.calcsizeK (k) : 0;
}

static inline unsigned int calcsize_val(HtUU *ht, const unsigned long long v) {
 return ht->opt.calcsizeV ? ht->opt.calcsizeV (v) : 0;
}

static inline void freefn(HtUU *ht, HtUUKv *kv) {
 if (ht->opt.freefn) {
  ht->opt.freefn (kv);
 }
}
...
static inline unsigned int next_idx(unsigned int idx) {
 if (idx != ((unsigned int)0xffffffff) && idx < (sizeof (ht_primes_sizes) / sizeof (ht_primes_sizes[0])) - 1) {
  return idx + 1;
 }
 return ((unsigned int)0xffffffff);
}

static inline unsigned int compute_size(unsigned int idx, unsigned int sz) {


 return idx != ((unsigned int)0xffffffff) && idx < (sizeof (ht_primes_sizes) / sizeof (ht_primes_sizes[0])) ? ht_primes_sizes[idx] : (sz | 1);
}

static inline 
# 62 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
             _Bool 
# 62 "project/radare2/shlr/sdb/src/ht_inc.c"
                  is_kv_equal(HtUU *ht, const unsigned long long key, const unsigned int key_len, const HtUUKv *kv) {
 if (key_len != kv->key_len) {
  return 
# 64 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        0
# 64 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
 }

 
# 67 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
_Bool 
# 67 "project/radare2/shlr/sdb/src/ht_inc.c"
     res = key == kv->key;
 if (!res && ht->opt.cmp) {
...
static inline HtUUKv *kv_at(HtUU *ht, HtUUBucket *bt, unsigned int i) {
 return (HtUUKv *)((char *)bt->arr + i * ht->opt.elem_size);
}

static inline HtUUKv *next_kv(HtUU *ht, HtUUKv *kv) {
 return (HtUUKv *)((char *)kv + ht->opt.elem_size);
}

#define BUCKET_FOREACH(ht,bt,j,kv) if ((bt)->arr) for ((j) = 0, (kv) = (bt)->arr; (j) < (bt)->count; (j)++, (kv) = next_kv (ht, kv))



#define BUCKET_FOREACH_SAFE(ht,bt,j,count,kv) if ((bt)->arr) for ((j) = 0, (kv) = (bt)->arr, (count) = (ht)->count; (j) < (bt)->count; (j) = (count) == (ht)->count? j + 1: j, (kv) = (count) == (ht)->count? next_kv (ht, kv): kv, (count) = (ht)->count)
# 101 "project/radare2/shlr/sdb/src/ht_inc.c"
static HtUU* internal_ht_new(unsigned int size, unsigned int prime_idx, HtUUOptions *opt) {
 HtUU* ht = calloc (1, sizeof (*ht));
 if (!ht) {
  return 
# 104 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        ((void *)0)
# 104 "project/radare2/shlr/sdb/src/ht_inc.c"
            ;
 }
 ht->size = size;
 ht->count = 0;
 ...
 if (!ht->table) {
  free (ht);
  return 
# 112 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        ((void *)0)
# 112 "project/radare2/shlr/sdb/src/ht_inc.c"
            ;
 }
 ht->opt = *opt;
 ...
 if (ht->opt.elem_size == 0) {
  ht->opt.elem_size = sizeof (HtUUKv);
 }
 return ht;
}
...
__attribute__ ((visibility ("default"))) void ht_uu_free(HtUU* ht) {
 ...
 unsigned int i;
 for (i = 0; i < ht->size; i++) {
  HtUUBucket *bt = &ht->table[i];
  HtUUKv *kv;
  unsigned int j;

  if (ht->opt.freefn) {
   if ((bt)->arr) for ((j) = 0, (kv) = (bt)->arr; (j) < (bt)->count; (j)++, (kv) = next_kv (ht, kv)) {
    ht->opt.freefn (kv);
   }
  }
...
static void internal_ht_grow(HtUU* ht) {
 HtUU* ht2;
 HtUU swap;
 unsigned int idx = next_idx (ht->prime_idx);
 unsigned int sz = compute_size (idx, ht->size * 2);
 unsigned int i;
 ...
 for (i = 0; i < ht->size; i++) {
  ...
  if ((bt)->arr) for ((j) = 0, (kv) = (bt)->arr; (j) < (bt)->count; (j)++, (kv) = next_kv (ht, kv)) {
   ht_uu_insert_kv (ht2, kv, 
# 171 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                           0
# 171 "project/radare2/shlr/sdb/src/ht_inc.c"
                                );
  }
 }
 ...
 *ht2 = swap;
 ...
 ht2->opt.freefn = 
# 179 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                  ((void *)0)
# 179 "project/radare2/shlr/sdb/src/ht_inc.c"
                      ;
 ht_uu_free (ht2);
}

static void check_growing(HtUU *ht) {
 if (ht->count >= 1 * ht->size) {
  internal_ht_grow (ht);
 }
}

static HtUUKv *reserve_kv(HtUU *ht, const unsigned long long key, const int key_len, 
# 189 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                                  _Bool 
# 189 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                                       update) {
 HtUUBucket *bt = &ht->table[bucketfn (ht, key)];
 HtUUKv *kvtmp;
 unsigned int j;

 if ((bt)->arr) for ((j) = 0, (kvtmp) = (bt)->arr; (j) < (bt)->count; (j)++, (kvtmp) = next_kv (ht, kvtmp)) {
  if (is_kv_equal (ht, key, key_len, kvtmp)) {
   ...
   return 
# 200 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
         ((void *)0)
# 200 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
  }
 }

 HtUUKv *newkvarr = realloc (bt->arr, (bt->count + 1) * ht->opt.elem_size);
 if (!newkvarr) {
  return 
# 206 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        ((void *)0)
# 206 "project/radare2/shlr/sdb/src/ht_inc.c"
            ;
 }
...
__attribute__ ((visibility ("default"))) 
# 215 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       _Bool 
# 215 "project/radare2/shlr/sdb/src/ht_inc.c"
            ht_uu_insert_kv(HtUU *ht, HtUUKv *kv, 
# 215 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                         _Bool 
# 215 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                              update) {
 HtUUKv *kv_dst = reserve_kv (ht, kv->key, kv->key_len, update);
 if (!kv_dst) {
  return 
# 218 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        0
# 218 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
 }

 
# 221 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
__builtin___memcpy_chk (
# 221 "project/radare2/shlr/sdb/src/ht_inc.c"
kv_dst
# 221 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
, 
# 221 "project/radare2/shlr/sdb/src/ht_inc.c"
...
# 221 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 check_growing (ht);
 return 
# 223 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       1
# 223 "project/radare2/shlr/sdb/src/ht_inc.c"
           ;
}

static 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
      _Bool 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c"
           insert_update(HtUU *ht, const unsigned long long key, unsigned long long value, 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                                _Bool 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                                     update) {
 unsigned int key_len = calcsize_key (ht, key);
 HtUUKv* kv_dst = reserve_kv (ht, key, key_len, update);
 if (!kv_dst) {
  return 
# 230 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        0
# 230 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
 }
 ...
 check_growing (ht);
 return 
# 238 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       1
# 238 "project/radare2/shlr/sdb/src/ht_inc.c"
           ;
}
...
__attribute__ ((visibility ("default"))) 
# 243 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       _Bool 
# 243 "project/radare2/shlr/sdb/src/ht_inc.c"
            ht_uu_insert(HtUU* ht, const unsigned long long key, unsigned long long value) {
 return insert_update (ht, key, value, 
# 244 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                      0
# 244 "project/radare2/shlr/sdb/src/ht_inc.c"
                                           );
}
...
__attribute__ ((visibility ("default"))) 
# 249 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       _Bool 
# 249 "project/radare2/shlr/sdb/src/ht_inc.c"
            ht_uu_update(HtUU* ht, const unsigned long long key, unsigned long long value) {
 return insert_update (ht, key, value, 
# 250 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                      1
# 250 "project/radare2/shlr/sdb/src/ht_inc.c"
                                          );
}


__attribute__ ((visibility ("default"))) 
# 254 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       _Bool 
# 254 "project/radare2/shlr/sdb/src/ht_inc.c"
            ht_uu_update_key(HtUU* ht, const unsigned long long old_key, const unsigned long long new_key) {

 
# 256 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
_Bool 
# 256 "project/radare2/shlr/sdb/src/ht_inc.c"
     found;
 unsigned long long value = ht_uu_find (ht, old_key, &found);
 if (!found) {
  return 
# 259 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        0
# 259 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
 }


 
# 263 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
_Bool 
# 263 "project/radare2/shlr/sdb/src/ht_inc.c"
     inserted = insert_update (ht, new_key, value, 
# 263 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                   0
# 263 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                        );
 if (!inserted) {
  return 
# 265 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        0
# 265 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
 }


 HtUUBucket *bt = &ht->table[bucketfn (ht, old_key)];
...
# 287 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
  __builtin___memmove_chk (
# 287 "project/radare2/shlr/sdb/src/ht_inc.c"
  kv
# 287 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
  , 
# 287 "project/radare2/shlr/sdb/src/ht_inc.c"
...
# 287 "project/radare2/shlr/sdb/src/ht_inc.c"
   ...
   ht->count--;
   return 
# 290 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
         1
# 290 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
  }
 }

 return 
# 294 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       0
# 294 "project/radare2/shlr/sdb/src/ht_inc.c"
            ;
}
...
__attribute__ ((visibility ("default"))) HtUUKv* ht_uu_find_kv(HtUU* ht, const unsigned long long key, 
# 300 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                  _Bool
# 300 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                      * found) {
 if (found) {
  *found = 
# 302 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
          0
# 302 "project/radare2/shlr/sdb/src/ht_inc.c"
               ;
 }
 if (!ht) {
  if (found) {
   *found = 
# 306 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
           0
# 306 "project/radare2/shlr/sdb/src/ht_inc.c"
                ;
  }
  return 
# 308 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
        ((void *)0)
# 308 "project/radare2/shlr/sdb/src/ht_inc.c"
            ;
 }
 ...
 if ((bt)->arr) for ((j) = 0, (kv) = (bt)->arr; (j) < (bt)->count; (j)++, (kv) = next_kv (ht, kv)) {
  if (is_kv_equal (ht, key, key_len, kv)) {
   if (found) {
    *found = 
# 319 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
            1
# 319 "project/radare2/shlr/sdb/src/ht_inc.c"
                ;
   }
   return kv;
  }
 ...
 return 
# 324 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       ((void *)0)
# 324 "project/radare2/shlr/sdb/src/ht_inc.c"
           ;
}
...
__attribute__ ((visibility ("default"))) unsigned long long ht_uu_find(HtUU* ht, const unsigned long long key, 
# 330 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                 _Bool
# 330 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                     * found) {
 HtUUKv *res = ht_uu_find_kv (ht, key, found);
 return res ? res->value : 0;
}


__attribute__ ((visibility ("default"))) 
# 336 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       _Bool 
# 336 "project/radare2/shlr/sdb/src/ht_inc.c"
            ht_uu_delete(HtUU* ht, const unsigned long long key) {
 HtUUBucket *bt = &ht->table[bucketfn (ht, key)];
 unsigned int key_len = calcsize_key (ht, key);
 HtUUKv *kv;
...
# 346 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
  __builtin___memmove_chk (
# 346 "project/radare2/shlr/sdb/src/ht_inc.c"
  kv
# 346 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
  , 
# 346 "project/radare2/shlr/sdb/src/ht_inc.c"
...
# 346 "project/radare2/shlr/sdb/src/ht_inc.c"
   ...
   ht->count--;
   return 
# 349 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
         1
# 349 "project/radare2/shlr/sdb/src/ht_inc.c"
             ;
  }
 }
 return 
# 352 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
       0
# 352 "project/radare2/shlr/sdb/src/ht_inc.c"
            ;
}
...
__attribute__ ((visibility ("default"))) void ht_uu_foreach(HtUU *ht, HtUUForeachCallback cb, void *user) {
 ...
 for (i = 0; i < ht->size; ++i) {
  ...
  if ((bt)->arr) for ((j) = 0, (kv) = (bt)->arr, (count) = (ht)->count; (j) < (bt)->count; (j) = (count) == (ht)->count? j + 1: j, (kv) = (count) == (ht)->count? next_kv (ht, kv): kv, (count) = (ht)->count) {
...
# 4 "project/radare2/shlr/sdb/src/ht_uu.c" 2


__attribute__ ((visibility ("default"))) HtUU* ht_uu_new0(void) {
 HtUUOptions opt = {
  .cmp = 
# 8 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
        ((void *)0)
# 8 "project/radare2/shlr/sdb/src/ht_uu.c"
            ,
  .hashfn = 
# 9 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
           ((void *)0)
# 9 "project/radare2/shlr/sdb/src/ht_uu.c"
               ,
  .dupkey = 
# 10 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
           ((void *)0)
# 10 "project/radare2/shlr/sdb/src/ht_uu.c"
               ,
  .dupvalue = 
# 11 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
             ((void *)0)
# 11 "project/radare2/shlr/sdb/src/ht_uu.c"
                 ,
  .calcsizeK = 
# 12 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
              ((void *)0)
# 12 "project/radare2/shlr/sdb/src/ht_uu.c"
                  ,
  .calcsizeV = 
# 13 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
              ((void *)0)
# 13 "project/radare2/shlr/sdb/src/ht_uu.c"
                  ,
  .freefn = 
# 14 "project/radare2/shlr/sdb/src/ht_uu.c" 3 4
           ((void *)0)
 
# 15 "project/radare2/shlr/sdb/src/ht_uu.c"
};
 return ht_uu_new_opt (&opt);
}
