# 0 "project/radare2/shlr/sdb/src/text.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/text.c"
...
# 4 "project/radare2/shlr/sdb/src/text.c" 2
...
# 6 "project/radare2/shlr/sdb/src/text.c" 2
...
# 7 "project/radare2/shlr/sdb/src/text.c" 2
...
# 8 "project/radare2/shlr/sdb/src/text.c" 2
...
# 10 "project/radare2/shlr/sdb/src/text.c" 2
# 62 "project/radare2/shlr/sdb/src/text.c"
...
#define ESCAPE_LOOP(fd,str,escapes) do { const char *p = str; const char *n = p; while (*n) { switch (*n) { escapes } n++; } FLUSH; } while (0)
# 82 "project/radare2/shlr/sdb/src/text.c"
#define ESCAPE(c,repl,replsz) case c: FLUSH; p++; if (write (fd, "\\"repl, replsz + 1) != replsz + 1) { return false; }; break;
...
static 
# 89 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 89 "project/radare2/shlr/sdb/src/text.c"
           write_path(int fd, SdbList *path) {
 if (write (fd, "/", 1) != 1) {
  return 
# 91 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 91 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 SdbListIter *it;
 const char *path_token;
 
# 95 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 95 "project/radare2/shlr/sdb/src/text.c"
     first = 
# 95 "project/radare2/shlr/sdb/src/text.c" 3 4
             1
# 95 "project/radare2/shlr/sdb/src/text.c"
                 ;
 if ((path)) for (it = (path)->head; it && (path_token = it->data); it = it->n) {
  if (first) {
   first = 
# 98 "project/radare2/shlr/sdb/src/text.c" 3 4
          0
# 98 "project/radare2/shlr/sdb/src/text.c"
               ;
  } else {
   if (write (fd, "/", 1) != 1) {
    return 
# 101 "project/radare2/shlr/sdb/src/text.c" 3 4
          0
# 101 "project/radare2/shlr/sdb/src/text.c"
               ;
   }
  }
  do { const char *p = path_token; const char *n = p; while (*n) { switch (*n) { case '\\': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""\\", 1 + 1) != 1 + 1) { return 
# 104 "project/radare2/shlr/sdb/src/text.c" 3 4
 0
# 104 "project/radare2/shlr/sdb/src/text.c"
 ; }; break;; case '/': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""/", 1 + 1) != 1 + 1) { return 
# 104 "project/radare2/shlr/sdb/src/text.c" 3 4
 0
# 104 "project/radare2/shlr/sdb/src/text.c"
 ; }; break;; case '\n': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""n", 1 + 1) != 1 + 1) { return 
# 104 "project/radare2/shlr/sdb/src/text.c" 3 4
 0
# 104 "project/radare2/shlr/sdb/src/text.c"
 ; }; break;; case '\r': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""r", 1 + 1) != 1 + 1) { return 
# 104 "project/radare2/shlr/sdb/src/text.c" 3 4
 0
# 104 "project/radare2/shlr/sdb/src/text.c"
 ; }; break;; } n++; } do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); } while (0)
 ...
 return 
# 111 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 111 "project/radare2/shlr/sdb/src/text.c"
           ;
}

static 
# 114 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 114 "project/radare2/shlr/sdb/src/text.c"
           write_key(int fd, const char *k) {

 if (*k == '/') {
  if (write (fd, "\\", 1) != 1) {
   return 
# 118 "project/radare2/shlr/sdb/src/text.c" 3 4
         0
# 118 "project/radare2/shlr/sdb/src/text.c"
              ;
  }
 }
 do { const char *p = k; const char *n = p; while (*n) { switch (*n) { case '\\': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""\\", 1 + 1) != 1 + 1) { return 
# 121 "project/radare2/shlr/sdb/src/text.c" 3 4
0
# 121 "project/radare2/shlr/sdb/src/text.c"
; }; break;; case '=': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""=", 1 + 1) != 1 + 1) { return 
# 121 "project/radare2/shlr/sdb/src/text.c" 3 4
0
# 121 "project/radare2/shlr/sdb/src/text.c"
...
; }; break;; } n++; } do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); } while (0)
  ...
  ;
 return 
# 127 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 127 "project/radare2/shlr/sdb/src/text.c"
           ;
}

static 
# 130 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 130 "project/radare2/shlr/sdb/src/text.c"
           write_value(int fd, const char *v) {
 do { const char *p = v; const char *n = p; while (*n) { switch (*n) { case '\\': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""\\", 1 + 1) != 1 + 1) { return 
# 131 "project/radare2/shlr/sdb/src/text.c" 3 4
0
# 131 "project/radare2/shlr/sdb/src/text.c"
; }; break;; case '\n': do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); p++; if (write (fd, "\\""n", 1 + 1) != 1 + 1) { return 
# 131 "project/radare2/shlr/sdb/src/text.c" 3 4
0
# 131 "project/radare2/shlr/sdb/src/text.c"
...
; }; break;; } n++; } do { if (p != n) { (void)write (fd, p, n - p); p = n; } } while (0); } while (0)
  ...
  ;
 return 
# 136 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 136 "project/radare2/shlr/sdb/src/text.c"
           ;
}
#undef FLUSH
#undef ESCAPE_LOOP
...
static 
# 142 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 142 "project/radare2/shlr/sdb/src/text.c"
           save_kv_cb(void *user, const char *k, const char *v) {
 int fd = *(int *)user;
 if (!write_key (fd, k) || write (fd, "=", 1) != 1) {
  return 
# 145 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 145 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 if (!write_value (fd, v) || write (fd, "\n", 1) != 1) {
  return 
# 148 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 148 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 return 
# 150 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 150 "project/radare2/shlr/sdb/src/text.c"
           ;
}

static 
# 153 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 153 "project/radare2/shlr/sdb/src/text.c"
           text_save(Sdb *s, int fd, 
# 153 "project/radare2/shlr/sdb/src/text.c" 3 4
                                     _Bool 
# 153 "project/radare2/shlr/sdb/src/text.c"
                                          sort, SdbList *path) {
 ...
 if (!write_path (fd, path) || write (fd, "\n", 1) != 1) {
  return 
# 156 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 156 "project/radare2/shlr/sdb/src/text.c"
             ;
 }


 if (sort) {
  SdbList *l = sdb_foreach_list (s, 
# 161 "project/radare2/shlr/sdb/src/text.c" 3 4
                                   1
# 161 "project/radare2/shlr/sdb/src/text.c"
                                       );
  SdbKv *kv;
  SdbListIter *it;
 ...
 SdbNs *ns;
 SdbListIter *it;
 if ((l)) for (it = (l)->head; it && (ns = it->data); it = it->n) {
  if (write (fd, "\n", 1) != 1) {
   ls_free (l);
   return 
# 184 "project/radare2/shlr/sdb/src/text.c" 3 4
         0
# 184 "project/radare2/shlr/sdb/src/text.c"
              ;
  }
  ls_append(path,ns->name);
 ...
 return 
# 194 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 194 "project/radare2/shlr/sdb/src/text.c"
           ;
}

__attribute__ ((visibility ("default"))) 
# 197 "project/radare2/shlr/sdb/src/text.c" 3 4
       _Bool 
# 197 "project/radare2/shlr/sdb/src/text.c"
            sdb_text_save_fd(Sdb *s, int fd, 
# 197 "project/radare2/shlr/sdb/src/text.c" 3 4
                                             _Bool 
# 197 "project/radare2/shlr/sdb/src/text.c"
 ...
 if (!path) {
  return 
# 200 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 200 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 
# 202 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 202 "project/radare2/shlr/sdb/src/text.c"
     r = text_save (s, fd, sort, path);
 ls_free (path);
 return r;
}

__attribute__ ((visibility ("default"))) 
# 207 "project/radare2/shlr/sdb/src/text.c" 3 4
       _Bool 
# 207 "project/radare2/shlr/sdb/src/text.c"
            sdb_text_save(Sdb *s, const char *file, 
# 207 "project/radare2/shlr/sdb/src/text.c" 3 4
                                                    _Bool 
# 207 "project/radare2/shlr/sdb/src/text.c"
                                                         sort) {
 int fd = open (file, 
# 208 "project/radare2/shlr/sdb/src/text.c" 3 4
                     0x0001 
# 208 "project/radare2/shlr/sdb/src/text.c"
                              | 
# 208 "project/radare2/shlr/sdb/src/text.c" 3 4
                                0x00000200 
# 208 "project/radare2/shlr/sdb/src/text.c"
...
# 208 "project/radare2/shlr/sdb/src/text.c"
 ...
 if (fd < 0) {
  return 
# 210 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 210 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 
# 212 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 212 "project/radare2/shlr/sdb/src/text.c"
     r = sdb_text_save_fd (s, fd, sort);
 close (fd);
 return r;
}
...
# 225 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 225 "project/radare2/shlr/sdb/src/text.c"
     eof;
 char *buf;
 size_t bufsz;
 Sdb *root_db;
...
# 236 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 236 "project/radare2/shlr/sdb/src/text.c"
     unescape;
} LoadCtx;
...
static void load_process_line(LoadCtx *ctx) {
 ctx->unescape = 
# 243 "project/radare2/shlr/sdb/src/text.c" 3 4
                0
# 243 "project/radare2/shlr/sdb/src/text.c"
                     ;

 ctx->buf[ctx->pos - ctx->shift] = '\0';
 switch (ctx->state) {
 case STATE_PATH: {
  ls_append(ctx->path,(void *)ctx->token_begin);
  SdbListIter *it;
  void *token_off_tmp;
  ctx->cur_db = ctx->root_db;
  if ((ctx->path)) for (it = (ctx->path)->head; it && (token_off_tmp = it->data); it = it->n) {
...
static void load_process_single_char(LoadCtx *ctx) {
 ...
 if (ctx->unescape) {
  ...
  ctx->unescape = 
# 320 "project/radare2/shlr/sdb/src/text.c" 3 4
                 0
# 320 "project/radare2/shlr/sdb/src/text.c"
                      ;
 } else if (c == '\\') {

  ctx->shift++;
  ctx->unescape = 
# 324 "project/radare2/shlr/sdb/src/text.c" 3 4
                 1
# 324 "project/radare2/shlr/sdb/src/text.c"
                     ;
...
static 
# 344 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 344 "project/radare2/shlr/sdb/src/text.c"
           load_process_final_line(LoadCtx *ctx) {
 ...
 if (!linebuf) {
  return 
# 350 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 350 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 
# 352 "project/radare2/shlr/sdb/src/text.c" 3 4
__builtin___memcpy_chk (
# 352 "project/radare2/shlr/sdb/src/text.c"
linebuf
# 352 "project/radare2/shlr/sdb/src/text.c" 3 4
, 
# 352 "project/radare2/shlr/sdb/src/text.c"
ctx->buf + ctx->line_begin, linesz
# 352 "project/radare2/shlr/sdb/src/text.c" 3 4
...
# 352 "project/radare2/shlr/sdb/src/text.c"
 ...
 free (linebuf);
 ctx->buf = 
# 366 "project/radare2/shlr/sdb/src/text.c" 3 4
           ((void *)0)
# 366 "project/radare2/shlr/sdb/src/text.c"
               ;
 return 
# 367 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 367 "project/radare2/shlr/sdb/src/text.c"
           ;
}
...
static 
# 374 "project/radare2/shlr/sdb/src/text.c" 3 4
      _Bool 
# 374 "project/radare2/shlr/sdb/src/text.c"
           load_ctx_init(LoadCtx *ctx, Sdb *s, char *buf, size_t sz) {
 ctx->eof = 
# 375 "project/radare2/shlr/sdb/src/text.c" 3 4
           0
# 375 "project/radare2/shlr/sdb/src/text.c"
                ;
 ctx->buf = buf;
 ctx->bufsz = sz;
 ctx->root_db = s;
 ...
 ctx->state = STATE_NEWLINE;
 ctx->unescape = 
# 386 "project/radare2/shlr/sdb/src/text.c" 3 4
                0
# 386 "project/radare2/shlr/sdb/src/text.c"
                     ;
 if (!ctx->buf || !ctx->path) {
  load_ctx_fini (ctx);
  return 
# 389 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 389 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 return 
# 391 "project/radare2/shlr/sdb/src/text.c" 3 4
       1
# 391 "project/radare2/shlr/sdb/src/text.c"
           ;
}

__attribute__ ((visibility ("default"))) 
# 394 "project/radare2/shlr/sdb/src/text.c" 3 4
       _Bool 
# 394 "project/radare2/shlr/sdb/src/text.c"
            sdb_text_load_buf(Sdb *s, char *buf, size_t sz) {
 if (!sz) {
  return 
# 396 "project/radare2/shlr/sdb/src/text.c" 3 4
        1
# 396 "project/radare2/shlr/sdb/src/text.c"
            ;
 }
 LoadCtx ctx;
 if (!load_ctx_init (&ctx, s, buf, sz)) {
  return 
# 400 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 400 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 
# 402 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 402 "project/radare2/shlr/sdb/src/text.c"
     ret = 
# 402 "project/radare2/shlr/sdb/src/text.c" 3 4
           1
# 402 "project/radare2/shlr/sdb/src/text.c"
...
__attribute__ ((visibility ("default"))) 
# 413 "project/radare2/shlr/sdb/src/text.c" 3 4
       _Bool 
# 413 "project/radare2/shlr/sdb/src/text.c"
            sdb_text_load(Sdb *s, const char *file) {
 int fd = open (file, 
# 414 "project/radare2/shlr/sdb/src/text.c" 3 4
                     0x0000 
# 414 "project/radare2/shlr/sdb/src/text.c"
                              | 0);
 if (fd < 0) {
  return 
# 416 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 416 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 
# 418 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 418 "project/radare2/shlr/sdb/src/text.c"
     r = 
# 418 "project/radare2/shlr/sdb/src/text.c" 3 4
         0
# 418 "project/radare2/shlr/sdb/src/text.c"
 ...
 char *x = mmap (0, st.st_size, 
# 424 "project/radare2/shlr/sdb/src/text.c" 3 4
                               0x01 
# 424 "project/radare2/shlr/sdb/src/text.c"
                                         | 
# 424 "project/radare2/shlr/sdb/src/text.c" 3 4
                                           0x02
# 424 "project/radare2/shlr/sdb/src/text.c"
...
# 424 "project/radare2/shlr/sdb/src/text.c"
                                                                  , fd, 0);
 if (x == 
# 425 "project/radare2/shlr/sdb/src/text.c" 3 4
         ((void *)-1)
# 425 "project/radare2/shlr/sdb/src/text.c"
                   ) {
  goto beach;
 }
# 438 "project/radare2/shlr/sdb/src/text.c"
...
__attribute__ ((visibility ("default"))) 
# 449 "project/radare2/shlr/sdb/src/text.c" 3 4
       _Bool 
# 449 "project/radare2/shlr/sdb/src/text.c"
            sdb_text_check(Sdb *s, const char *file) {
 char buf[64];
 int fd = open (file, 
# 451 "project/radare2/shlr/sdb/src/text.c" 3 4
                     0x0000 
# 451 "project/radare2/shlr/sdb/src/text.c"
                              | 0);
 if (fd < 0) {
  return 
# 453 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 453 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 struct stat st;
 if (fstat (fd, &st) || !st.st_size) {
  close (fd);
  return 
# 458 "project/radare2/shlr/sdb/src/text.c" 3 4
        0
# 458 "project/radare2/shlr/sdb/src/text.c"
             ;
 }
 int count = read (fd, buf, (((st.st_size)>((off_t)sizeof (buf)))?((off_t)sizeof (buf)):(st.st_size)));
 close (fd);
 
# 462 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 462 "project/radare2/shlr/sdb/src/text.c"
     is_ascii = 
# 462 "project/radare2/shlr/sdb/src/text.c" 3 4
                1
# 462 "project/radare2/shlr/sdb/src/text.c"
...
# 463 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 463 "project/radare2/shlr/sdb/src/text.c"
     has_eq = 
# 463 "project/radare2/shlr/sdb/src/text.c" 3 4
              0
# 463 "project/radare2/shlr/sdb/src/text.c"
...
# 464 "project/radare2/shlr/sdb/src/text.c" 3 4
_Bool 
# 464 "project/radare2/shlr/sdb/src/text.c"
     has_nl = 
# 464 "project/radare2/shlr/sdb/src/text.c" 3 4
              0
# 464 "project/radare2/shlr/sdb/src/text.c"
 ...
 while (*p) {
  if (*p == '=') {
   has_eq = 
# 469 "project/radare2/shlr/sdb/src/text.c" 3 4
           1
# 469 "project/radare2/shlr/sdb/src/text.c"
               ;
  } else if (*p == '\n') {
   if (!has_eq) {
    break;
   ...
   has_nl = 
# 474 "project/radare2/shlr/sdb/src/text.c" 3 4
           1
# 474 "project/radare2/shlr/sdb/src/text.c"
               ;
  } else if (!has_eq) {
   if (*p < 10 || *p > '~') {
    is_ascii = 
# 477 "project/radare2/shlr/sdb/src/text.c" 3 4
              0
# 477 "project/radare2/shlr/sdb/src/text.c"
                   ;
   }
  }
  p++;
