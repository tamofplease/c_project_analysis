# 0 "project/radare2/shlr/sdb/src/json/api.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/sdb/src/json/api.c"
...
# 5 "project/radare2/shlr/sdb/src/json/api.c" 2
...
# 6 "project/radare2/shlr/sdb/src/json/api.c" 2
...
# 7 "project/radare2/shlr/sdb/src/json/api.c" 2
# 1 "project/radare2/shlr/sdb/src/json/rangstr.h" 1
...
# 5 "project/radare2/shlr/sdb/src/json/rangstr.h" 2
# 1 "project/radare2/shlr/sdb/src/json/../types.h" 1
...
# 6 "project/radare2/shlr/sdb/src/json/../types.h" 2
...
# 10 "project/radare2/shlr/sdb/src/json/../types.h" 2
...
# 61 "project/radare2/shlr/sdb/src/json/../types.h" 2
#undef HAVE_MMAN
#define HAVE_MMAN 1
#define ULLFMT "ll"
# 72 "project/radare2/shlr/sdb/src/json/../types.h"
...
# 1 "project/radare2/shlr/sdb/src/json/../config.h" 1
...
#define SDB_KT ut32
# 116 "project/radare2/shlr/sdb/src/json/../types.h" 2


# 117 "project/radare2/shlr/sdb/src/json/../types.h"
static inline int seek_set(int fd, off_t pos) {
 return ((fd == -1) || (lseek (fd, (off_t) pos, 
# 118 "project/radare2/shlr/sdb/src/json/../types.h" 3 4
                                               0
# 118 "project/radare2/shlr/sdb/src/json/../types.h"
                                                       ) == -1))? 0:1;
}
...
# 6 "project/radare2/shlr/sdb/src/json/rangstr.h" 2
...
# 8 "project/radare2/shlr/sdb/src/json/api.c" 2
...
char *api_json_set (const char *s, const char *k, const char *v) {
 ...
 int idx, len[3];
 char *str = 
# 19 "project/radare2/shlr/sdb/src/json/api.c" 3 4
            ((void *)0)
# 19 "project/radare2/shlr/sdb/src/json/api.c"
                ;
 Rangstr rs = json_get (s, k);
 if (!rs.p) {
  return 
# 22 "project/radare2/shlr/sdb/src/json/api.c" 3 4
        ((void *)0)
# 22 "project/radare2/shlr/sdb/src/json/api.c"
            ;
 }
#define WLEN(x) (int)(size_t)(end[x]-beg[x])
 ...
 if (!str) {
  return 
# 40 "project/radare2/shlr/sdb/src/json/api.c" 3 4
        ((void *)0)
# 40 "project/radare2/shlr/sdb/src/json/api.c"
            ;
 }
 idx = len[0];
 
# 43 "project/radare2/shlr/sdb/src/json/api.c" 3 4
__builtin___memcpy_chk (
# 43 "project/radare2/shlr/sdb/src/json/api.c"
str
# 43 "project/radare2/shlr/sdb/src/json/api.c" 3 4
, 
# 43 "project/radare2/shlr/sdb/src/json/api.c"
...
# 44 "project/radare2/shlr/sdb/src/json/api.c" 3 4
__builtin___memcpy_chk (
# 44 "project/radare2/shlr/sdb/src/json/api.c"
str+idx
# 44 "project/radare2/shlr/sdb/src/json/api.c" 3 4
, 
# 44 "project/radare2/shlr/sdb/src/json/api.c"
...
# 46 "project/radare2/shlr/sdb/src/json/api.c" 3 4
__builtin___memcpy_chk (
# 46 "project/radare2/shlr/sdb/src/json/api.c"
str+idx
# 46 "project/radare2/shlr/sdb/src/json/api.c" 3 4
, 
# 46 "project/radare2/shlr/sdb/src/json/api.c"
...
# 53 "project/radare2/shlr/sdb/src/json/api.c" 3 4
__builtin___sprintf_chk (
# 53 "project/radare2/shlr/sdb/src/json/api.c"
str
# 53 "project/radare2/shlr/sdb/src/json/api.c" 3 4
