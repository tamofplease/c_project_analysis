# 0 "project/radare2/shlr/qnx/src/utils.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/shlr/qnx/src/utils.c" 2
...
# 5 "project/radare2/shlr/qnx/src/utils.c" 2
...
# 6 "project/radare2/shlr/qnx/src/utils.c" 2
...
# 29 "project/radare2/shlr/qnx/src/utils.c"
enum {
 NTO_REG_GENERAL,
 NTO_REG_FLOAT,
 NTO_REG_SYSTEM,
...
# 117 "project/radare2/shlr/qnx/src/utils.c"
  {0}
...
# 134 "project/radare2/shlr/qnx/src/utils.c" 3 4
long long

# 135 "project/radare2/shlr/qnx/src/utils.c"
extract_signed_integer (const 
# 135 "project/radare2/shlr/qnx/src/utils.c" 3 4
                             unsigned char 
# 135 "project/radare2/shlr/qnx/src/utils.c"
                                 *addr, int len, int be) {
 
# 136 "project/radare2/shlr/qnx/src/utils.c" 3 4
long long 
# 136 "project/radare2/shlr/qnx/src/utils.c"
        retval;
 const 
# 137 "project/radare2/shlr/qnx/src/utils.c" 3 4
      unsigned char 
# 137 "project/radare2/shlr/qnx/src/utils.c"
          *p;
 const 
# 138 "project/radare2/shlr/qnx/src/utils.c" 3 4
      unsigned char 
# 138 "project/radare2/shlr/qnx/src/utils.c"
          *startaddr = addr;
 const 
# 139 "project/radare2/shlr/qnx/src/utils.c" 3 4
      unsigned char 
# 139 "project/radare2/shlr/qnx/src/utils.c"
          *endaddr = startaddr + len;

 if (len > (int)sizeof(
# 141 "project/radare2/shlr/qnx/src/utils.c" 3 4
                      long long
# 141 "project/radare2/shlr/qnx/src/utils.c"
                             ))
  
# 142 "project/radare2/shlr/qnx/src/utils.c" 3 4
 fprintf(__stderrp,
# 142 "project/radare2/shlr/qnx/src/utils.c"
...
# 144 "project/radare2/shlr/qnx/src/utils.c"
                       ;
 ...
 if (be) {
  ...
  retval = ((
# 151 "project/radare2/shlr/qnx/src/utils.c" 3 4
            long long
# 151 "project/radare2/shlr/qnx/src/utils.c"
                   )*p ^ 0x80) - 0x80;
  for (++p; p < endaddr; p++)
   retval = (retval << 8) | *p;
 } else {
  ...
  retval = ((
# 157 "project/radare2/shlr/qnx/src/utils.c" 3 4
            long long
# 157 "project/radare2/shlr/qnx/src/utils.c"
                   )*p ^ 0x80) - 0x80;
  for (--p; p >= startaddr; --p)
   retval = (retval << 8) | *p;
 }
...
# 164 "project/radare2/shlr/qnx/src/utils.c" 3 4
unsigned long long

# 165 "project/radare2/shlr/qnx/src/utils.c"
extract_unsigned_integer (const 
# 165 "project/radare2/shlr/qnx/src/utils.c" 3 4
                               unsigned char 
# 165 "project/radare2/shlr/qnx/src/utils.c"
                                   *addr, int len, int be) {
 
# 166 "project/radare2/shlr/qnx/src/utils.c" 3 4
unsigned long long 
# 166 "project/radare2/shlr/qnx/src/utils.c"
         retval;
 const 
# 167 "project/radare2/shlr/qnx/src/utils.c" 3 4
      unsigned char 
# 167 "project/radare2/shlr/qnx/src/utils.c"
          *p;
 const 
# 168 "project/radare2/shlr/qnx/src/utils.c" 3 4
      unsigned char 
# 168 "project/radare2/shlr/qnx/src/utils.c"
          *startaddr = addr;
 const 
# 169 "project/radare2/shlr/qnx/src/utils.c" 3 4
      unsigned char 
# 169 "project/radare2/shlr/qnx/src/utils.c"
          *endaddr = startaddr + len;

 if (len > (int)sizeof(
# 171 "project/radare2/shlr/qnx/src/utils.c" 3 4
                      long long
# 171 "project/radare2/shlr/qnx/src/utils.c"
                             ))
  
# 172 "project/radare2/shlr/qnx/src/utils.c" 3 4
 fprintf(__stderrp,
# 172 "project/radare2/shlr/qnx/src/utils.c"
 "This operation is not available on integers of more than %d byte(s)\n", (int)sizeof(
# 172 "project/radare2/shlr/qnx/src/utils.c" 3 4
 long long
# 172 "project/radare2/shlr/qnx/src/utils.c"
...
# 174 "project/radare2/shlr/qnx/src/utils.c"
                       ;
...
int i386nto_reg_offset (int regnum) {
 if (regnum >= 0 && regnum < 
# 203 "project/radare2/shlr/qnx/src/utils.c" 3 4
                            (sizeof(
# 203 "project/radare2/shlr/qnx/src/utils.c"
...
int i386nto_register_area (int regno, int regset, 
# 209 "project/radare2/shlr/qnx/src/utils.c" 3 4
                                                 unsigned int 
# 209 "project/radare2/shlr/qnx/src/utils.c"
                                                      *off) {
 *off = 0;
...
# 220 "project/radare2/shlr/qnx/src/utils.c" 3 4
 unsigned int 
# 220 "project/radare2/shlr/qnx/src/utils.c"
      off_adjust, regsize, regset_size, regno_base;

  int first_four = (regno >= (I386_ST0_REGNUM + 8) && regno <= ((I386_ST0_REGNUM + 8) + 3));
  int second_four = (regno > ((I386_ST0_REGNUM + 8) + 3) && regno <= ((I386_ST0_REGNUM + 8) + 7));
  int st_reg = (regno >= I386_ST0_REGNUM && regno < I386_ST0_REGNUM + 8);
  int xmm_reg = (regno >= (I386_ST0_REGNUM + 16) && regno < ((I386_ST0_REGNUM + 16) + 8));
  ...
  if (first_four) {
   ...
   regsize = 2;
   off_adjust = 0;
   regno_base = (I386_ST0_REGNUM + 8);
  } else if (second_four) {

   regsize = 4;
   off_adjust = 8;
   regno_base = ((I386_ST0_REGNUM + 8) + 3) + 1;
  } else if (st_reg) {

   regsize = 16;
   off_adjust = 32;
   regno_base = I386_ST0_REGNUM;
  } else if (xmm_reg) {

   regsize = 16;
   off_adjust = 160;
   regno_base = (I386_ST0_REGNUM + 16);
  } else if (regno == ((I386_ST0_REGNUM + 16) + 8)) {
   regsize = 4;
   off_adjust = 24;
   regno_base = ((I386_ST0_REGNUM + 16) + 8);
  } else {
...
# 293 "project/radare2/shlr/qnx/src/utils.c"
...
ptid_t ptid_build (
# 299 "project/radare2/shlr/qnx/src/utils.c" 3 4
                  int 
# 299 "project/radare2/shlr/qnx/src/utils.c"
                       pid, 
# 299 "project/radare2/shlr/qnx/src/utils.c" 3 4
                            long long 
# 299 "project/radare2/shlr/qnx/src/utils.c"
