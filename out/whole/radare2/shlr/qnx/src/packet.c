# 0 "project/radare2/shlr/qnx/src/packet.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/qnx/src/packet.c"
...
# 4 "project/radare2/shlr/qnx/src/packet.c" 2
...
# 5 "project/radare2/shlr/qnx/src/packet.c" 2
...
# 6 "project/radare2/shlr/qnx/src/packet.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/qnx/include/dsmsgs.h" 1 3 4
# 7 "project/radare2/shlr/qnx/src/packet.c" 2
...
# 17 "project/radare2/shlr/qnx/src/packet.c"
static 
# 17 "project/radare2/shlr/qnx/src/packet.c" 3 4
      unsigned char 
# 17 "project/radare2/shlr/qnx/src/packet.c"
          nak_packet[] =
 {0x7e, 0xff, 0, 0x7e};
static 
# 19 "project/radare2/shlr/qnx/src/packet.c" 3 4
      unsigned char 
# 19 "project/radare2/shlr/qnx/src/packet.c"
          ch_reset_packet[] =
 {0x7e, 0, 0xff, 0x7e};
static 
# 21 "project/radare2/shlr/qnx/src/packet.c" 3 4
      unsigned char 
# 21 "project/radare2/shlr/qnx/src/packet.c"
          ch_debug_packet[] =
 {0x7e, 1, 0xfe, 0x7e};
static 
# 23 "project/radare2/shlr/qnx/src/packet.c" 3 4
      unsigned char 
# 23 "project/radare2/shlr/qnx/src/packet.c"
          ch_text_packet[] =
 {0x7e, 2, 0xfd, 0x7e};

static int append (libqnxr_t *g, char ch) {
 if (g->data_len == 
# 27 "project/radare2/shlr/qnx/src/packet.c" 3 4
                   1024 
# 27 "project/radare2/shlr/qnx/src/packet.c"
                                    + 16) {
  
# 28 "project/radare2/shlr/qnx/src/packet.c" 3 4
 fprintf(__stderrp,
# 28 "project/radare2/shlr/qnx/src/packet.c"
 "%s: data too long\n", __func__
# 28 "project/radare2/shlr/qnx/src/packet.c" 3 4
 )
# 28 "project/radare2/shlr/qnx/src/packet.c"
...
# 37 "project/radare2/shlr/qnx/src/packet.c" 3 4
unsigned char 
# 37 "project/radare2/shlr/qnx/src/packet.c"
    modifier = 0;
 
# 38 "project/radare2/shlr/qnx/src/packet.c" 3 4
unsigned char 
# 38 "project/radare2/shlr/qnx/src/packet.c"
    sum = 0xff;
...
# 51 "project/radare2/shlr/qnx/src/packet.c" 3 4
   fprintf(__stderrp,
# 51 "project/radare2/shlr/qnx/src/packet.c"
   "%s: Checksum error\n", __func__
# 51 "project/radare2/shlr/qnx/src/packet.c" 3 4
   )
# 51 "project/radare2/shlr/qnx/src/packet.c"
...
# 71 "project/radare2/shlr/qnx/src/packet.c" 3 4
 fprintf(__stderrp,
# 71 "project/radare2/shlr/qnx/src/packet.c"
...
# 71 "project/radare2/shlr/qnx/src/packet.c"
 ...
 if (g->read_len == 0 || g->read_ptr == g->read_len) {
  while (
# 79 "project/radare2/shlr/qnx/src/packet.c" 3 4
        1
# 79 "project/radare2/shlr/qnx/src/packet.c"
            ) {
   int ret = r_socket_ready (g->sock, 0, (300 * 1000 * 1000));
   if (ret < 0) {
    if (
# 82 "project/radare2/shlr/qnx/src/packet.c" 3 4
       (*__error()) 
# 82 "project/radare2/shlr/qnx/src/packet.c"
             == 
# 82 "project/radare2/shlr/qnx/src/packet.c" 3 4
                4
# 82 "project/radare2/shlr/qnx/src/packet.c"
...
# 91 "project/radare2/shlr/qnx/src/packet.c" 3 4
          1024 
# 91 "project/radare2/shlr/qnx/src/packet.c"
                           * 2);
   if (g->read_len <= 0) {
    g->read_len = 0;
    
# 94 "project/radare2/shlr/qnx/src/packet.c" 3 4
   fprintf(__stderrp,
# 94 "project/radare2/shlr/qnx/src/packet.c"
   "%s: read failed\n", __func__
# 94 "project/radare2/shlr/qnx/src/packet.c" 3 4
   )
# 94 "project/radare2/shlr/qnx/src/packet.c"
...
# 104 "project/radare2/shlr/qnx/src/packet.c" 3 4
 fprintf(__stderrp,
# 104 "project/radare2/shlr/qnx/src/packet.c"
 "%s: unpack failed\n", __func__
# 104 "project/radare2/shlr/qnx/src/packet.c" 3 4
 )
# 104 "project/radare2/shlr/qnx/src/packet.c"
 ...
 if (g->data_len >= sizeof (struct DShdr)) {
  ...
  if (g->recv.data[0] == 0xff) {
   
# 113 "project/radare2/shlr/qnx/src/packet.c" 3 4
  fprintf(__stderrp,
# 113 "project/radare2/shlr/qnx/src/packet.c"
  "%s: NAK received\n", __func__
# 113 "project/radare2/shlr/qnx/src/packet.c" 3 4
  )
# 113 "project/radare2/shlr/qnx/src/packet.c"
...
# 147 "project/radare2/shlr/qnx/src/packet.c" 3 4
 fprintf(__stderrp,
# 147 "project/radare2/shlr/qnx/src/packet.c"
 "Initialize libqnxr_t first\n"
# 147 "project/radare2/shlr/qnx/src/packet.c" 3 4
 )
# 147 "project/radare2/shlr/qnx/src/packet.c"
...
# 152 "project/radare2/shlr/qnx/src/packet.c" 3 4
unsigned char 
# 152 "project/radare2/shlr/qnx/src/packet.c"
    csum = 0;
 char *p;
...
# 159 "project/radare2/shlr/qnx/src/packet.c" 3 4
 unsigned char 
# 159 "project/radare2/shlr/qnx/src/packet.c"
     c = g->tran.data[i];
  csum += c;
