# 0 "project/radare2/test/unit/test_dwarf_integration.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 2 "project/radare2/test/unit/test_dwarf_integration.c" 2
...
# 4 "project/radare2/test/unit/test_dwarf_integration.c" 2

#define MODE 2

#define check_kv(k,v) do { value = sdb_get (sdb, k, NULL); mu_assert_nullable_streq (value, v, "Wrong key - value pair"); } while (0)
...
static 
# 13 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
      _Bool 
# 13 "project/radare2/test/unit/test_dwarf_integration.c"
           test_parse_dwarf_types(void) {
 RBin *bin = r_bin_new ();
 do { char _meqstr[5120]; const void *act__ = (bin); 
# 15 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 15 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 15 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 15 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 15 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("Couldn't create new RBin")
# 15 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 15 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
((void *)0)
# 15 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 15, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 15, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RIO *io = r_io_new ();
 do { char _meqstr[5120]; const void *act__ = (io); 
# 17 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 17 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 17 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 17 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 17 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("Couldn't create new RIO")
# 17 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 17 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
# 17 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (anal); 
# 19 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 19 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 19 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 19 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 19 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("Couldn't create new RAnal")
# 19 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 19 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
# 23 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
_Bool 
# 23 "project/radare2/test/unit/test_dwarf_integration.c"
     res = r_bin_open (bin, "bins/pe/vista-glass.exe", &opt);

 anal->cpu = strdup ("x86");
 anal->bits = 32;
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 27, "pe/vista-glass.exe binary could not be opened"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 27, "pe/vista-glass.exe binary could not be opened"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const void *act__ = (anal->sdb_types); 
# 28 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 28 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 28 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 28 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 28 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("Couldn't create new RAnal.sdb_types")
# 28 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 28 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
# 28 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 RBinDwarfDebugAbbrev *abbrevs = r_bin_dwarf_parse_abbrev (bin, 2);
 do { char _meqstr[5120]; const void *act__ = (abbrevs); 
# 30 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 30 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 30 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 30 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 30 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("Couldn't parse Abbreviations")
# 30 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 30 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
((void *)0)
# 30 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RBinDwarfDebugInfo *info = r_bin_dwarf_parse_info (abbrevs, bin, 2);
 do { char _meqstr[5120]; const void *act__ = (info); 
# 32 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 32 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 32 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 32 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 32 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("Couldn't parse debug_info section")
# 32 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 32 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
# 32 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 HtUP *loc_table = r_bin_dwarf_parse_loc (bin, 4);
 ...
 char * value = 
# 41 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
               ((void *)0)
# 41 "project/radare2/test/unit/test_dwarf_integration.c"
                   ;
 Sdb *sdb = anal->sdb_types;
 do { value = sdb_get (sdb, "_cairo_status", 
# 43 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 43 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("enum"); 
# 43 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 43 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 43 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected %s, got %s.", ("Wrong key - value pair"), (exp__ ? exp__ : "NULL"), (act__ ? act__ : "NULL")
# 43 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 43 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!(((act__) == 
...
((void *)0) 
# 43 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 43, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 43, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.0x0", 
# 44 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 44 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("CAIRO_STATUS_SUCCESS"); 
# 44 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 44 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 44 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 44, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 44, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.CAIRO_STATUS_SUCCESS", 
# 45 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 45 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x0"); 
# 45 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 45 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 45 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 45, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 45, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.0x9", 
# 46 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 46 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("CAIRO_STATUS_INVALID_PATH_DATA"); 
# 46 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 46 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 46 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 46, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 46, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.CAIRO_STATUS_INVALID_PATH_DATA", 
# 47 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 47 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x9"); 
# 47 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 47 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 47 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 47, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 47, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.0x1f", 
# 48 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 48 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("CAIRO_STATUS_INVALID_WEIGHT"); 
# 48 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 48 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 48 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 48, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 48, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.CAIRO_STATUS_INVALID_WEIGHT", 
# 49 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 49 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x1f"); 
# 49 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 49 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 49 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 49, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 49, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status.0x20", 
# 50 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 50 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = (
# 50 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 50 "project/radare2/test/unit/test_dwarf_integration.c"
); 
...
((void *)0) 
# 50 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 50, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 50, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "enum._cairo_status", 
# 51 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 51 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("CAIRO_STATUS_SUCCESS,CAIRO_STATUS_NO_MEMORY" ",CAIRO_STATUS_INVALID_RESTORE,CAIRO_STATUS_INVALID_POP_GROUP,CAIRO_STATUS_NO_CURRENT_POINT" ",CAIRO_STATUS_INVALID_MATRIX,CAIRO_STATUS_INVALID_STATUS,CAIRO_STATUS_NULL_POINTER," "CAIRO_STATUS_INVALID_STRING,CAIRO_STATUS_INVALID_PATH_DATA,CAIRO_STATUS_READ_ERROR," "CAIRO_STATUS_WRITE_ERROR,CAIRO_STATUS_SURFACE_FINISHED,CAIRO_STATUS_SURFACE_TYPE_MISMATCH," "CAIRO_STATUS_PATTERN_TYPE_MISMATCH,CAIRO_STATUS_INVALID_CONTENT,CAIRO_STATUS_INVALID_FORMAT," "CAIRO_STATUS_INVALID_VISUAL,CAIRO_STATUS_FILE_NOT_FOUND,CAIRO_STATUS_INVALID_DASH," "CAIRO_STATUS_INVALID_DSC_COMMENT,CAIRO_STATUS_INVALID_INDEX,CAIRO_STATUS_CLIP_NOT_REPRESENTABLE," "CAIRO_STATUS_TEMP_FILE_ERROR,CAIRO_STATUS_INVALID_STRIDE," "CAIRO_STATUS_FONT_TYPE_MISMATCH,CAIRO_STATUS_USER_FONT_IMMUTABLE,CAIRO_STATUS_USER_FONT_ERROR," "CAIRO_STATUS_NEGATIVE_COUNT,CAIRO_STATUS_INVALID_CLUSTERS," "CAIRO_STATUS_INVALID_SLANT,CAIRO_STATUS_INVALID_WEIGHT"); 
# 51 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 51 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 51 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 51, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 51, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0)
# 62 "project/radare2/test/unit/test_dwarf_integration.c"
                                                          ;

 do { value = sdb_get (sdb, "_MARGINS", 
# 64 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 64 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("struct"); 
# 64 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 64 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 64 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 64, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 64, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);

 do { value = sdb_get (sdb, "struct._MARGINS", 
# 66 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 66 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("cxLeftWidth,cxRightWidth,cyTopHeight,cyBottomHeight"); 
# 66 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 66 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 66 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 66, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 66, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);

 do { value = sdb_get (sdb, "unaligned", 
# 68 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 68 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("union"); 
# 68 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 68 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 68 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "union.unaligned", 
# 69 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 69 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("ptr,u2,u4,u8,s2,s4,s8"); 
# 69 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 69 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 69 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 69, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 69, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "union.unaligned.u2", 
# 70 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 70 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("short unsigned int,0,0"); 
# 70 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 70 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 70 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 70, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 70, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "union.unaligned.s8", 
# 71 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 71 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("long long int,0,0"); 
# 71 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 71 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 71, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 71, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
...
static 
# 80 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
      _Bool 
# 80 "project/radare2/test/unit/test_dwarf_integration.c"
           test_dwarf_function_parsing_cpp(void) {
 RBin *bin = r_bin_new ();
 do { char _meqstr[5120]; const void *act__ = (bin); 
# 82 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 82 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 82 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 82 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 82 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 82, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 82, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RIO *io = r_io_new ();
 do { char _meqstr[5120]; const void *act__ = (io); 
# 84 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 84 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 84 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 84 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 84 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 84, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 84, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RAnal *anal = r_anal_new ();
 do { char _meqstr[5120]; const void *act__ = (anal); 
# 86 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 86 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 86 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 86 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 86 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 86, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 86, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_bind (io, &bin->iob);
 anal->binb.demangle = r_bin_demangle;

 RBinFileOptions opt = { 0 };
 
# 91 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
_Bool 
# 91 "project/radare2/test/unit/test_dwarf_integration.c"
     res = r_bin_open (bin, "bins/elf/dwarf4_many_comp_units.elf", &opt);

 anal->cpu = strdup ("x86");
 anal->bits = 64;
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 95, "elf/dwarf4_many_comp_units.elf binary could not be opened"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 95, "elf/dwarf4_many_comp_units.elf binary could not be opened"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const void *act__ = (anal->sdb_types); 
# 96 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 96 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 96 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 96 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 96 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 RBinDwarfDebugAbbrev *abbrevs = r_bin_dwarf_parse_abbrev (bin, 2);
 do { char _meqstr[5120]; const void *act__ = (abbrevs); 
# 98 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 98 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 98 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 98 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 98 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 98, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 98, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RBinDwarfDebugInfo *info = r_bin_dwarf_parse_info (abbrevs, bin, 2);
 do { char _meqstr[5120]; const void *act__ = (info); 
# 100 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 100 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 100 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 100 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 100 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 100, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 100, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 HtUP *loc_table = r_bin_dwarf_parse_loc (bin, 8);
 ...
 do { char _meqstr[5120]; const void *act__ = (sdb); 
# 110 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 110 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 110 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 110 "project/radare2/test/unit/test_dwarf_integration.c"
...
, 2 > 1 ? 1 : 0), 
# 110 "project/radare2/test/unit/test_dwarf_integration.c"
"%s: expected to not be NULL but it was.", ("No dwarf function information in db")
# 110 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
)
# 110 "project/radare2/test/unit/test_dwarf_integration.c"
; do { if (!((act__) != 
...
((void *)0)
# 110 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 110, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 110, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 char *value = 
# 111 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
              ((void *)0)
# 111 "project/radare2/test/unit/test_dwarf_integration.c"
                  ;
 do { value = sdb_get (sdb, "Mammal", 
# 112 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 112 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("fcn"); 
# 112 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 112 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 112 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 112, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 112, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Mammal.addr", 
# 113 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 113 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x401300"); 
# 113 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 113 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 113 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 113, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 113, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Mammal.sig", 
# 114 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 114 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("void Mammal(Mammal * this);"); 
# 114 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 114 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 114 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 114, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 114, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Dog::walk__.addr", 
# 115 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 115 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x401380"); 
# 115 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 115 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 115 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Dog::walk__.sig", 
# 116 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 116 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("int Dog::walk()(Dog * this);"); 
# 116 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 116 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 116 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 116, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 116, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Dog::walk__.name", 
# 117 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 117 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("Dog::walk()"); 
# 117 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 117 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 117 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 117, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 117, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Mammal::walk__.vars", 
# 118 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 118 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("this"); 
# 118 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 118 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 118 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 118, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 118, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.Mammal::walk__.var.this", 
# 119 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 119 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("b,-8,Mammal *"); 
# 119 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 119 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 119 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 119, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 119, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);

 do { value = sdb_get (sdb, "main", 
# 121 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 121 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("fcn"); 
# 121 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 121 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0) 
# 121 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 121, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 121, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.addr", 
# 122 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 122 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x401160"); 
# 122 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 122 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 122 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 122, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 122, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.sig", 
# 123 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 123 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("int main();"); 
# 123 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 123 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 123 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 123, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 123, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.vars", 
# 124 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 124 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("b,m,output"); 
# 124 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 124 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 124 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 124, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 124, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.var.output", 
# 125 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 125 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("b,-40,int"); 
# 125 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 125 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 125 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 125, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 125, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
...
static 
# 136 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
      _Bool 
# 136 "project/radare2/test/unit/test_dwarf_integration.c"
           test_dwarf_function_parsing_go(void) {
 RBin *bin = r_bin_new ();
 do { char _meqstr[5120]; const void *act__ = (bin); 
# 138 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 138 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 138 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 138 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 138 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 RIO *io = r_io_new ();
 do { char _meqstr[5120]; const void *act__ = (io); 
# 140 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 140 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 140 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 140 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 140 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 140, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 140, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RAnal *anal = r_anal_new ();
 do { char _meqstr[5120]; const void *act__ = (anal); 
# 142 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 142 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 142 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 142 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 142 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 142, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 142, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_bind (io, &bin->iob);
 anal->binb.demangle = r_bin_demangle;

 RBinFileOptions opt = { 0 };
 
# 147 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
_Bool 
# 147 "project/radare2/test/unit/test_dwarf_integration.c"
     res = r_bin_open (bin, "bins/elf/dwarf_go_tree", &opt);

 anal->cpu = strdup ("x86");
 anal->bits = 64;
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 151, "bins/elf/dwarf_go_tree"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 151, "bins/elf/dwarf_go_tree"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const void *act__ = (anal->sdb_types); 
# 152 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 152 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 152 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 152 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 152 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 RBinDwarfDebugAbbrev *abbrevs = r_bin_dwarf_parse_abbrev (bin, 2);
 do { char _meqstr[5120]; const void *act__ = (abbrevs); 
# 154 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 154 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 154 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 154 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 154 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 RBinDwarfDebugInfo *info = r_bin_dwarf_parse_info (abbrevs, bin, 2);
 do { char _meqstr[5120]; const void *act__ = (info); 
# 156 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 156 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 156 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 156 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 156 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 Sdb *sdb = sdb_ns (anal->sdb, "dwarf", 0);
 do { char _meqstr[5120]; const void *act__ = (sdb); 
# 166 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 166 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 166 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 166 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 166 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 166, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 166, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 char *value = 
# 167 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
              ((void *)0)
# 167 "project/radare2/test/unit/test_dwarf_integration.c"
                  ;

 do { value = sdb_get (sdb, "main_main", 
# 169 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 169 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("fcn"); 
# 169 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 169 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0) 
# 169 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 169, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 169, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main_main.name", 
# 170 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 170 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("main.main"); 
# 170 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 170 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 170 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 170, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 170, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main_main.addr", 
# 171 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 171 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x491980"); 
# 171 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 171 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 171 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 171, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 171, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);

 do { value = sdb_get (sdb, "main_tree_iterInorder", 
# 173 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 173 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("fcn"); 
# 173 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 173 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0) 
# 173 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 173, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 173, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main_tree_iterInorder.name", 
# 174 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 174 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("main.tree.iterInorder"); 
# 174 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 174 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 174 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 174, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 174, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main_tree_iterInorder.addr", 
# 175 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 175 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x491d90"); 
# 175 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 175 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 175 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 175, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 175, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main_tree_iterInorder.sig", 
# 176 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 176 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("void main.tree.iterInorder(main.tree t,func(int) visit);"); 
# 176 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 176 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 176 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 176, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 176, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
...
static 
# 190 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
      _Bool 
# 190 "project/radare2/test/unit/test_dwarf_integration.c"
           test_dwarf_function_parsing_rust(void) {
 RBin *bin = r_bin_new ();
 do { char _meqstr[5120]; const void *act__ = (bin); 
# 192 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 192 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 192 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 192 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 192 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 192, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 192, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RIO *io = r_io_new ();
 do { char _meqstr[5120]; const void *act__ = (io); 
# 194 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 194 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 194 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 194 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 194 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 194, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 194, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RAnal *anal = r_anal_new ();
 do { char _meqstr[5120]; const void *act__ = (anal); 
# 196 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 196 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 196 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 196 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 196 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 196, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 196, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_bind (io, &bin->iob);
 anal->binb.demangle = r_bin_demangle;

 RBinFileOptions opt = { 0 };
 
# 201 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
_Bool 
# 201 "project/radare2/test/unit/test_dwarf_integration.c"
     res = r_bin_open (bin, "bins/elf/dwarf_rust_bubble", &opt);

 anal->cpu = strdup ("x86");
 anal->bits = 64;
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 205, "bins/elf/dwarf_rust_bubble"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 205, "bins/elf/dwarf_rust_bubble"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const void *act__ = (anal->sdb_types); 
# 206 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 206 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 206 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 206 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 206 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 206, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 206, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 RBinDwarfDebugAbbrev *abbrevs = r_bin_dwarf_parse_abbrev (bin, 2);
 do { char _meqstr[5120]; const void *act__ = (abbrevs); 
# 208 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 208 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 208 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 208 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 208 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 RBinDwarfDebugInfo *info = r_bin_dwarf_parse_info (abbrevs, bin, 2);
 do { char _meqstr[5120]; const void *act__ = (info); 
# 210 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 210 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 210 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 210 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0)
# 210 "project/radare2/test/unit/test_dwarf_integration.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 210, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 210, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 HtUP *loc_table = r_bin_dwarf_parse_loc (bin, 8);
 ...
 Sdb *sdb = sdb_ns (anal->sdb, "dwarf", 0);
 do { char _meqstr[5120]; const void *act__ = (sdb); 
# 220 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 220 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
# 220 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
, 
# 220 "project/radare2/test/unit/test_dwarf_integration.c"
...
# 220 "project/radare2/test/unit/test_dwarf_integration.c"
 ...
 char *value = 
# 221 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
              ((void *)0)
# 221 "project/radare2/test/unit/test_dwarf_integration.c"
                  ;

 do { value = sdb_get (sdb, "fcn.main.addr", 
# 223 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 223 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x5750"); 
# 223 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 223 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 223 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 223, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 223, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.name", 
# 224 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 224 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("main"); 
# 224 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 224 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 224 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 224, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 224, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.var.numbers", 
# 225 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 225 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("s,128,i32[11]"); 
# 225 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 225 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 225 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 225, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 225, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.main.var.strings", 
# 226 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 226 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("s,312,&str[6]"); 
# 226 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 226 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 226 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 226, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 226, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);

 do { value = sdb_get (sdb, "fcn.lang_start_internal.sig", 
# 228 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 228 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("isize lang_start_internal(&Fn<()> main,isize argc,u8 ** argv);"); 
# 228 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 228 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 228 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 228, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 228, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);

 do { value = sdb_get (sdb, "bubble_sort__str_", 
# 230 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 230 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("fcn"); 
# 230 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 230 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0) 
# 230 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 230, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 230, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "bubble_sort_i32_", 
# 231 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 231 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("fcn"); 
# 231 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 231 "project/radare2/test/unit/test_dwarf_integration.c"
...
((void *)0) 
# 231 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 231, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 231, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.bubble_sort_i32_.vars", 
# 232 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 232 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("values,n,swapped,iter,__next,val,i"); 
# 232 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 232 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 232 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 232, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 232, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.bubble_sort_i32_.var.iter", 
# 233 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 233 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("s,112,Range<usize>"); 
# 233 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 233 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 233 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 233, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 233, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.bubble_sort_i32_.var.i", 
# 234 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 234 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("s,176,usize"); 
# 234 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 234 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 234 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 234, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 234, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.bubble_sort_i32_.name", 
# 235 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 235 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("bubble_sort<i32>"); 
# 235 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 235 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 235 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 235, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 235, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
 do { value = sdb_get (sdb, "fcn.bubble_sort_i32_.addr", 
# 236 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
((void *)0)
# 236 "project/radare2/test/unit/test_dwarf_integration.c"
); do { char _meqstr[5120]; const char *act__ = (value); const char *exp__ = ("0x5270"); 
# 236 "project/radare2/test/unit/test_dwarf_integration.c" 3 4
__builtin___snprintf_chk (
# 236 "project/radare2/test/unit/test_dwarf_integration.c"
_meqstr
...
((void *)0) 
# 236 "project/radare2/test/unit/test_dwarf_integration.c"
&& strcmp((exp__), (act__)) == 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 236, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 236, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); } while (0);
...
int all_tests(void) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parse_dwarf_types"); result = test_parse_dwarf_types(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_dwarf_function_parsing_cpp"); result = test_dwarf_function_parsing_cpp(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_dwarf_function_parsing_go"); result = test_dwarf_function_parsing_go(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_dwarf_function_parsing_rust"); result = test_dwarf_function_parsing_rust(); tests_run++; tests_passed += result; } while (0);
