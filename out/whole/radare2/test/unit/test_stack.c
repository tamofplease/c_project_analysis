# 0 "project/radare2/test/unit/test_stack.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_stack.c"
...
# 2 "project/radare2/test/unit/test_stack.c" 2
...
# 3 "project/radare2/test/unit/test_stack.c" 2



# 5 "project/radare2/test/unit/test_stack.c" 3 4
_Bool 
# 5 "project/radare2/test/unit/test_stack.c"
    test_r_stack_pop_empty(void) {
 RStack *stack = r_stack_new (10);
 void *elem = r_stack_pop (stack);
 do { 
# 8 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long 
# 8 "project/radare2/test/unit/test_stack.c"
act__ = (
# 8 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long
# 8 "project/radare2/test/unit/test_stack.c"
...
# 14 "project/radare2/test/unit/test_stack.c" 3 4
_Bool 
# 14 "project/radare2/test/unit/test_stack.c"
    test_r_stack_push_pop(void) {
 RStack *stack = r_stack_new (10);
 r_stack_push (stack, (void*)(intptr_t)0x1337);
 void *elem = r_stack_pop (stack);
 do { 
# 18 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long 
# 18 "project/radare2/test/unit/test_stack.c"
act__ = (
# 18 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long
# 18 "project/radare2/test/unit/test_stack.c"
...
# 24 "project/radare2/test/unit/test_stack.c" 3 4
_Bool 
# 24 "project/radare2/test/unit/test_stack.c"
    test_r_stack_push_pop_multi(void) {
 RStack *stack = r_stack_new (10);
 r_stack_push (stack, (void*)(intptr_t)0x1337);
 r_stack_push (stack, (void*)(intptr_t)0x8888);
 void *elem = r_stack_pop (stack);
 do { 
# 29 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long 
# 29 "project/radare2/test/unit/test_stack.c"
act__ = (
# 29 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long
# 29 "project/radare2/test/unit/test_stack.c"
...
unsigned long long
# 29 "project/radare2/test/unit/test_stack.c"
)(0x8888); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 29 "project/radare2/test/unit/test_stack.c" 3 4
__builtin___snprintf_chk (
# 29 "project/radare2/test/unit/test_stack.c"
_meqstr
...
# 29 "project/radare2/test/unit/test_stack.c"
 ...
 do { 
# 31 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long 
# 31 "project/radare2/test/unit/test_stack.c"
act__ = (
# 31 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long
# 31 "project/radare2/test/unit/test_stack.c"
...
# 37 "project/radare2/test/unit/test_stack.c" 3 4
_Bool 
# 37 "project/radare2/test/unit/test_stack.c"
    test_r_stack_grow(void) {
 RStack *stack = r_stack_new (2);
 do { 
# 39 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long 
# 39 "project/radare2/test/unit/test_stack.c"
act__ = (
# 39 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long
# 39 "project/radare2/test/unit/test_stack.c"
...
# 39 "project/radare2/test/unit/test_stack.c"
 ...
 do { 
# 43 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long 
# 43 "project/radare2/test/unit/test_stack.c"
act__ = (
# 43 "project/radare2/test/unit/test_stack.c" 3 4
unsigned long long
# 43 "project/radare2/test/unit/test_stack.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_stack_pop_empty"); result = test_r_stack_pop_empty(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_stack_push_pop"); result = test_r_stack_push_pop(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_stack_push_pop_multi"); result = test_r_stack_push_pop_multi(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_stack_grow"); result = test_r_stack_grow(); tests_run++; tests_passed += result; } while (0);
