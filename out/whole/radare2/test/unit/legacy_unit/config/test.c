# 0 "project/radare2/test/unit/legacy_unit/config/test.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/legacy_unit/config/test.c"
...
# 2 "project/radare2/test/unit/legacy_unit/config/test.c" 2


# 3 "project/radare2/test/unit/legacy_unit/config/test.c"
int main () {
 struct r_config_t *cfg;


 cfg = r_config_new (
# 7 "project/radare2/test/unit/legacy_unit/config/test.c" 3 4
                    ((void *)0)
# 7 "project/radare2/test/unit/legacy_unit/config/test.c"
                        );
