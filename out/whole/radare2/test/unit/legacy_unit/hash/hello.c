# 0 "project/radare2/test/unit/legacy_unit/hash/hello.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/legacy_unit/hash/hello.c"
...
# 2 "project/radare2/test/unit/legacy_unit/hash/hello.c" 2
...
# 3 "project/radare2/test/unit/legacy_unit/hash/hello.c" 2
...
# 4 "project/radare2/test/unit/legacy_unit/hash/hello.c" 2
...
# 5 "project/radare2/test/unit/legacy_unit/hash/hello.c" 2


# 6 "project/radare2/test/unit/legacy_unit/hash/hello.c"
int main(int argc, char **argv) {
 RIODesc *fd;
 
# 8 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
unsigned char 
# 8 "project/radare2/test/unit/legacy_unit/hash/hello.c"
    *buf;
 
# 9 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
unsigned long long 
# 9 "project/radare2/test/unit/legacy_unit/hash/hello.c"
     size;
 struct r_io_t *io;
 ...
 if (fd == 
# 20 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
          ((void *)0)
# 20 "project/radare2/test/unit/legacy_unit/hash/hello.c"
              ) {
  
# 21 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
 fprintf(__stderrp,
# 21 "project/radare2/test/unit/legacy_unit/hash/hello.c"
 "Cannot open file\n"
# 21 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
 )
# 21 "project/radare2/test/unit/legacy_unit/hash/hello.c"
 ...
 buf = (
# 29 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
       unsigned char
# 29 "project/radare2/test/unit/legacy_unit/hash/hello.c"
          *) malloc (size);
 if (buf == 
# 30 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
           ((void *)0)
# 30 "project/radare2/test/unit/legacy_unit/hash/hello.c"
               ) {
  printf ("Big too file\n");
  r_io_close (io, fd);
  r_io_free (io);
...
# 37 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
__builtin___memset_chk (
# 37 "project/radare2/test/unit/legacy_unit/hash/hello.c"
buf
# 37 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
, 
# 37 "project/radare2/test/unit/legacy_unit/hash/hello.c"
...
# 37 "project/radare2/test/unit/legacy_unit/hash/hello.c"
 ...
 printf ("file size = %"
# 41 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
                       "lld"
# 41 "project/radare2/test/unit/legacy_unit/hash/hello.c"
                              "\n", size);
...

 {
  struct r_hash_t *ctx;
  const 
# 46 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
       unsigned char 
# 46 "project/radare2/test/unit/legacy_unit/hash/hello.c"
           *c;
  int i;

  ctx = r_hash_new (
# 49 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
                   1
# 49 "project/radare2/test/unit/legacy_unit/hash/hello.c"
                       , 
# 49 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
                         ((1ULL << (((63)>(R_HASH_NUM_INDICES))?(R_HASH_NUM_INDICES):(63)))-1)
# 49 "project/radare2/test/unit/legacy_unit/hash/hello.c"
                                   );
  c = r_hash_do_md5 (ctx, buf, size);
  printf ("MD5: ");
  for (i=0;i<
# 52 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
            16
# 52 "project/radare2/test/unit/legacy_unit/hash/hello.c"
                           ;i++) { printf("%02x", c[i]); }
  printf ("\n");
  ...
  printf ("SHA1: ");
  for (i=0;i<
# 57 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
            20
# 57 "project/radare2/test/unit/legacy_unit/hash/hello.c"
                            ;i++) { printf("%02x", c[i]); }
  printf ("\n");
  ...
  printf ("SHA256: ");
  for (i=0;i<
# 62 "project/radare2/test/unit/legacy_unit/hash/hello.c" 3 4
            32
# 62 "project/radare2/test/unit/legacy_unit/hash/hello.c"
                              ;i++) { printf("%02x", c[i]); }
  printf ("\n");
  r_hash_free (ctx);
 }
