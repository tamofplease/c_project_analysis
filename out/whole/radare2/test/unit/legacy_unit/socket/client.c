# 0 "project/radare2/test/unit/legacy_unit/socket/client.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/legacy_unit/socket/client.c"
...
# 2 "project/radare2/test/unit/legacy_unit/socket/client.c" 2


# 3 "project/radare2/test/unit/legacy_unit/socket/client.c"
int main() {
 int ret;
 char buf[1024];
 RSocket *s = r_socket_new (
# 6 "project/radare2/test/unit/legacy_unit/socket/client.c" 3 4
                           0
# 6 "project/radare2/test/unit/legacy_unit/socket/client.c"
                                );
 if (r_socket_connect (s, "localhost", "9090", 0, 10)) {
  do {
   ret = r_socket_gets (s, buf, sizeof (buf));
   
# 10 "project/radare2/test/unit/legacy_unit/socket/client.c" 3 4
  fprintf(__stderrp,
# 10 "project/radare2/test/unit/legacy_unit/socket/client.c"
  "((%s))\n", buf
# 10 "project/radare2/test/unit/legacy_unit/socket/client.c" 3 4
  )
# 10 "project/radare2/test/unit/legacy_unit/socket/client.c"
