# 0 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
...
# 2 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 2
#define MAX_LINE 2048
#define PORT "4433"


# 5 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
...
# 10 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
 fprintf(__stderrp,
# 10 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
 "Use %s <cert>\n", argv[0]
# 10 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
 )
# 10 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
 ...
 s = r_socket_new (
# 13 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
                  1
# 13 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
                      );
 if (!r_socket_listen (s, "4433", argv[1])) {
  
# 15 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
 fprintf(__stderrp,
# 15 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
 "Error, cant listen at port: %s\n", "4433"
# 15 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
 )
# 15 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
                                                   ;
...
# 22 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
 __builtin___strcpy_chk (
# 22 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
 buf
# 22 "project/radare2/test/unit/legacy_unit/socket/serverssl.c" 3 4
 , 
# 22 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
...
# 24 "project/radare2/test/unit/legacy_unit/socket/serverssl.c"
                          ;
