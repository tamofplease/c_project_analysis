# 0 "project/radare2/test/unit/legacy_unit/socket/test.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/legacy_unit/socket/test.c"
...
# 2 "project/radare2/test/unit/legacy_unit/socket/test.c" 2


# 3 "project/radare2/test/unit/legacy_unit/socket/test.c"
int main() {
 int ret;
