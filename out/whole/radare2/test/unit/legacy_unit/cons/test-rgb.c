# 0 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c" 2


# 3 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c"
int main() {
 int i,j ,k;
...
# 17 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c" 3 4
   r_cons_strcat (
# 17 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c"
   "__"
# 17 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c" 3 4
   )
# 17 "project/radare2/test/unit/legacy_unit/cons/test-rgb.c"
