# 0 "project/radare2/test/unit/legacy_unit/util/plugin.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/test/unit/legacy_unit/util/plugin.c" 2


# 3 "project/radare2/test/unit/legacy_unit/util/plugin.c"
int mystuff = 31337;
...
struct r_lib_struct_t radare_plugin = {
 ...
 .data = &mystuff,
 .version = 
# 8 "project/radare2/test/unit/legacy_unit/util/plugin.c" 3 4
           "5.5.4"

# 9 "project/radare2/test/unit/legacy_unit/util/plugin.c"
};
