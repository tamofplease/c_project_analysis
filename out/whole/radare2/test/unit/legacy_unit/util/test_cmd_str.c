# 0 "project/radare2/test/unit/legacy_unit/util/test_cmd_str.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/test/unit/legacy_unit/util/test_cmd_str.c" 2


# 3 "project/radare2/test/unit/legacy_unit/util/test_cmd_str.c"
int main() {
 int out;
