# 0 "project/radare2/test/unit/legacy_unit/search/test.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/test/unit/legacy_unit/search/test.c" 2



# 4 "project/radare2/test/unit/legacy_unit/search/test.c"
char *buffer = "helloworldlibisnlizbiceandcoolib2loblubljb";

static int hit(RSearchKeyword *kw, void *user, 
# 6 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                                              unsigned long long 
# 6 "project/radare2/test/unit/legacy_unit/search/test.c"
                                                   addr) {

 printf ("HIT %d AT %"
# 8 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                     "lld"
# 8 "project/radare2/test/unit/legacy_unit/search/test.c"
...
int main(int argc, char **argv) {
 ...
 r_search_kw_add (rs,
  r_search_keyword_new_str ("lib", "", 
# 15 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                                      ((void *)0)
# 15 "project/radare2/test/unit/legacy_unit/search/test.c"
                                          , 0));
 ...
 r_search_update (rs, 0LL, (
# 21 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                           unsigned char 
# 21 "project/radare2/test/unit/legacy_unit/search/test.c"
 ...
 printf ("Searching for '%s' in '%s'\n", "lib", buffer);
 r_search_update (rs, 0LL, (
# 29 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                           unsigned char 
# 29 "project/radare2/test/unit/legacy_unit/search/test.c"
                               *)buffer, strlen (buffer));
 rs = r_search_free (rs);
 ...
 {
  RSearchKeyword *kw = r_search_keyword_new_str ("lib", "ff00ff", 
# 37 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                                                                 ((void *)0)
# 37 "project/radare2/test/unit/legacy_unit/search/test.c"
                                                                     , 0);
 ...
 r_search_update (rs, 0LL, (
# 45 "project/radare2/test/unit/legacy_unit/search/test.c" 3 4
                           unsigned char 
# 45 "project/radare2/test/unit/legacy_unit/search/test.c"
                               *)buffer, strlen (buffer));
 rs = r_search_free (rs);
 return 0;
}
