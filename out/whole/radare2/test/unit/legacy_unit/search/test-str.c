# 0 "project/radare2/test/unit/legacy_unit/search/test-str.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/legacy_unit/search/test-str.c"
...
# 2 "project/radare2/test/unit/legacy_unit/search/test-str.c" 2


# 3 "project/radare2/test/unit/legacy_unit/search/test-str.c"
const 
# 3 "project/radare2/test/unit/legacy_unit/search/test-str.c" 3 4
     unsigned char 
# 3 "project/radare2/test/unit/legacy_unit/search/test-str.c"
         *buffer = (const 
# 3 "project/radare2/test/unit/legacy_unit/search/test-str.c" 3 4
                          unsigned char
# 3 "project/radare2/test/unit/legacy_unit/search/test-str.c"
                             *) "hellowor\x01\x02ldlibis\x01\x02niceandcoolib2loblubljb";

int hit(RSearchKeyword *kw, void *user, 
# 5 "project/radare2/test/unit/legacy_unit/search/test-str.c" 3 4
                                       unsigned long long 
# 5 "project/radare2/test/unit/legacy_unit/search/test-str.c"
                                            addr) {
 const 
# 6 "project/radare2/test/unit/legacy_unit/search/test-str.c" 3 4
      unsigned char 
# 6 "project/radare2/test/unit/legacy_unit/search/test-str.c"
          *buf = (const 
# 6 "project/radare2/test/unit/legacy_unit/search/test-str.c" 3 4
                        unsigned char
# 6 "project/radare2/test/unit/legacy_unit/search/test-str.c"
                           *)user;
 printf("HIT %d AT %"
# 7 "project/radare2/test/unit/legacy_unit/search/test-str.c" 3 4
                    "lld"
# 7 "project/radare2/test/unit/legacy_unit/search/test-str.c"
