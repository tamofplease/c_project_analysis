# 0 "project/radare2/test/unit/test_addr_interval.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_addr_interval.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_itv.h" 2 3 4
...
# 2 "project/radare2/test/unit/test_addr_interval.c" 2
...
# 3 "project/radare2/test/unit/test_addr_interval.c" 2

#define I(begin,end) ((RInterval){(begin), (end)-(begin)})

int test_r_itv_contain(void) {
 do { if (!(r_itv_contain (((RInterval){(0), (3)-(0)}), 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 7, "contain"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 7, "contain"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_itv_contain (((RInterval){(0), (3)-(0)}), 2))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 8, "contain"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 8, "contain"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_contain (((RInterval){(0), (3)-(0)}), 3))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 9, "contain"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 9, "contain"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_itv_contain (((RInterval){(-4), (0)-(-4)}), 
# 10 "project/radare2/test/unit/test_addr_interval.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 10 "project/radare2/test/unit/test_addr_interval.c"
))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 10, "contain"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 10, "contain"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_contain (((RInterval){(-4), (0)-(-4)}), 0))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 11, "contain"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 11, "contain"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_contain (((RInterval){(-4), (-1)-(-4)}), 
# 12 "project/radare2/test/unit/test_addr_interval.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 12 "project/radare2/test/unit/test_addr_interval.c"
))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 12, "contain"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 12, "contain"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

int test_r_itv_include(void) {
 do { if (!(r_itv_include (((RInterval){(3), (8)-(3)}), ((RInterval){(3), (5)-(3)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 17, "include"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 17, "include"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_include (((RInterval){(3), (5)-(3)}), ((RInterval){(2), (4)-(2)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 18, "include"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 18, "include"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_itv_include (((RInterval){(-4), (0)-(-4)}), ((RInterval){(-4), (-2)-(-4)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 19, "include"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 19, "include"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_itv_include (((RInterval){(-4), (0)-(-4)}), ((RInterval){(-2), (0)-(-2)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 20, "include"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 20, "include"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_itv_include (((RInterval){(-4), (0)-(-4)}), ((RInterval){(-1), (0)-(-1)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 21, "include"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 21, "include"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_include (((RInterval){(-4), (0)-(-4)}), ((RInterval){(0), (0)-(0)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 22, "include"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 22, "include"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

int test_r_itv_overlap(void) {
 do { if (!(r_itv_overlap (((RInterval){(3), (5)-(3)}), ((RInterval){(4), (5)-(4)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 27, "overlap"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 27, "overlap"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_overlap (((RInterval){(4), (5)-(4)}), ((RInterval){(3), (4)-(3)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 28, "overlap"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 28, "overlap"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_itv_overlap (((RInterval){(4), (0)-(4)}), ((RInterval){(-1), (0)-(-1)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 29, "overlap"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 29, "overlap"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!r_itv_overlap (((RInterval){(4), (-1)-(4)}), ((RInterval){(-1), (0)-(-1)})))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 30, "overlap"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 30, "overlap"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

int all_tests(void) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_itv_contain"); result = test_r_itv_contain(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_itv_include"); result = test_r_itv_include(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_itv_overlap"); result = test_r_itv_overlap(); tests_run++; tests_passed += result; } while (0);
