# 0 "project/radare2/test/unit/test_anal_xrefs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_anal_xrefs.c"
...
# 2 "project/radare2/test/unit/test_anal_xrefs.c" 2
...
# 3 "project/radare2/test/unit/test_anal_xrefs.c" 2


# 4 "project/radare2/test/unit/test_anal_xrefs.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_anal_xrefs.c"
    test_r_anal_xrefs_count() {
 RAnal *anal = r_anal_new ();

 do { 
# 7 "project/radare2/test/unit/test_anal_xrefs.c" 3 4
unsigned long long 
# 7 "project/radare2/test/unit/test_anal_xrefs.c"
act__ = (
# 7 "project/radare2/test/unit/test_anal_xrefs.c" 3 4
unsigned long long
# 7 "project/radare2/test/unit/test_anal_xrefs.c"
)(r_anal_xrefs_count (anal)); 
# 7 "project/radare2/test/unit/test_anal_xrefs.c" 3 4
unsigned long long 
# 7 "project/radare2/test/unit/test_anal_xrefs.c"
exp__ = (
...
# 7 "project/radare2/test/unit/test_anal_xrefs.c"
 ...
 do { 
# 15 "project/radare2/test/unit/test_anal_xrefs.c" 3 4
unsigned long long 
# 15 "project/radare2/test/unit/test_anal_xrefs.c"
act__ = (
# 15 "project/radare2/test/unit/test_anal_xrefs.c" 3 4
unsigned long long
# 15 "project/radare2/test/unit/test_anal_xrefs.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_xrefs_count"); result = test_r_anal_xrefs_count(); tests_run++; tests_passed += result; } while (0);
