# 0 "project/radare2/test/unit/test_anal_function.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_anal_function.c"
...
# 2 "project/radare2/test/unit/test_anal_function.c" 2
...
# 3 "project/radare2/test/unit/test_anal_function.c" 2

# 1 "project/radare2/test/unit/test_anal_block_invars.inl" 1

static 
# 2 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
      _Bool 
# 2 "project/radare2/test/unit/test_anal_block_invars.inl"
           block_check_invariants(RAnal *anal) {
 RBIter iter;
 RAnalBlock *block;
 
# 5 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
unsigned long long 
# 5 "project/radare2/test/unit/test_anal_block_invars.inl"
     last_start = 
# 5 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
...
# 6 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
for ((
# 6 "project/radare2/test/unit/test_anal_block_invars.inl"
iter
# 6 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
) = r_rbtree_first (
# 6 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 6 "project/radare2/test/unit/test_anal_block_invars.inl"
                                                               {
  if (last_start != 
# 7 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 7 "project/radare2/test/unit/test_anal_block_invars.inl"
                           ) {
   do { if (!(block->addr >= last_start)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 8, "corrupted binary tree"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 8, "corrupted binary tree"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
   do { char _meqstr[5120]; 
# 9 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long 
# 9 "project/radare2/test/unit/test_anal_block_invars.inl"
  act__ = (
# 9 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long
# 9 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 9 "project/radare2/test/unit/test_anal_block_invars.inl"
  ...
  do { if (!(block->ref >= 1)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 13, "block->ref < 1, but it is still in the tree"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 13, "block->ref < 1, but it is still in the tree"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  do { if (!(block->ref >= r_list_length (block->fcns))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 14, "block->ref < r_list_length (block->fcns)"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 14, "block->ref < r_list_length (block->fcns)"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

  RListIter *fcniter;
  RAnalFunction *fcn;
  
# 18 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 if (
# 18 "project/radare2/test/unit/test_anal_block_invars.inl"
 block->fcns
# 18 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 ) for (
# 18 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 18 "project/radare2/test/unit/test_anal_block_invars.inl"
   ...
   for (fcniter2 = fcniter->n; fcniter2 && (fcn2 = fcniter2->data, 1); fcniter2 = fcniter2->n) {
    do { char _meqstr[5120]; const void *act__ = (fcn); const void *exp__ = (fcn2); 
# 22 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   __builtin___snprintf_chk (
# 22 "project/radare2/test/unit/test_anal_block_invars.inl"
   _meqstr
# 22 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   , 
# 22 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 22 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   , 2 > 1 ? 1 : 0), 
# 22 "project/radare2/test/unit/test_anal_block_invars.inl"
   "%s: expected not %p, got %p.", ("duplicate function in basic block"), (exp__), (act__)
# 22 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   )
# 22 "project/radare2/test/unit/test_anal_block_invars.inl"
   ...
   do { if (!(r_list_contains (fcn->bbs, block))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 24, "block references function, but function does not reference block"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 24, "block references function, but function does not reference block"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  }
 }
...
# 30 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
if (
# 30 "project/radare2/test/unit/test_anal_block_invars.inl"
anal->fcns
# 30 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
) for (
# 30 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 32 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 unsigned long long 
# 32 "project/radare2/test/unit/test_anal_block_invars.inl"
      min = 
# 32 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 32 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 33 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 unsigned long long 
# 33 "project/radare2/test/unit/test_anal_block_invars.inl"
      max = 
# 33 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
            0ULL
# 33 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 34 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 unsigned long long 
# 34 "project/radare2/test/unit/test_anal_block_invars.inl"
      realsz = 0;
  
# 35 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 if (
# 35 "project/radare2/test/unit/test_anal_block_invars.inl"
 fcn->bbs
# 35 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 ) for (
# 35 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 35 "project/radare2/test/unit/test_anal_block_invars.inl"
   ...
   for (blockiter2 = blockiter->n; blockiter2 && (block2 = blockiter2->data, 1); blockiter2 = blockiter2->n) {
    do { char _meqstr[5120]; const void *act__ = (block); const void *exp__ = (block2); 
# 46 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   __builtin___snprintf_chk (
# 46 "project/radare2/test/unit/test_anal_block_invars.inl"
   _meqstr
# 46 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   , 
# 46 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 46 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   , 2 > 1 ? 1 : 0), 
# 46 "project/radare2/test/unit/test_anal_block_invars.inl"
   "%s: expected not %p, got %p.", ("duplicate basic block in function"), (exp__), (act__)
# 46 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
   )
# 46 "project/radare2/test/unit/test_anal_block_invars.inl"
   ...
   do { if (!(r_list_contains (block->fcns, fcn))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 48, "function references block, but block does not reference function"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 48, "function references block, but block does not reference function"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  }

  if (fcn->meta._min != 
# 51 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
                       0xFFFFFFFFFFFFFFFFULL
# 51 "project/radare2/test/unit/test_anal_block_invars.inl"
                               ) {
   do { 
# 52 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long 
# 52 "project/radare2/test/unit/test_anal_block_invars.inl"
  act__ = (
# 52 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long
# 52 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 52 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long
# 52 "project/radare2/test/unit/test_anal_block_invars.inl"
  )(min); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 52 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  __builtin___snprintf_chk (
# 52 "project/radare2/test/unit/test_anal_block_invars.inl"
  _meqstr
...
# 52 "project/radare2/test/unit/test_anal_block_invars.inl"
   ...
   do { 
# 53 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long 
# 53 "project/radare2/test/unit/test_anal_block_invars.inl"
  act__ = (
# 53 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long
# 53 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 53 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  unsigned long long
# 53 "project/radare2/test/unit/test_anal_block_invars.inl"
  )(max); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 53 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  __builtin___snprintf_chk (
# 53 "project/radare2/test/unit/test_anal_block_invars.inl"
  _meqstr
...
# 53 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  0
# 53 "project/radare2/test/unit/test_anal_block_invars.inl"
  )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 53, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 53, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
  }

  do { 
# 56 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 unsigned long long 
# 56 "project/radare2/test/unit/test_anal_block_invars.inl"
 act__ = (
# 56 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 unsigned long long
# 56 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 56 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 unsigned long long
# 56 "project/radare2/test/unit/test_anal_block_invars.inl"
 )(realsz); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 56 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
 __builtin___snprintf_chk (
# 56 "project/radare2/test/unit/test_anal_block_invars.inl"
 _meqstr
...
# 56 "project/radare2/test/unit/test_anal_block_invars.inl"
 ...
 return 
# 58 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
       1
# 58 "project/radare2/test/unit/test_anal_block_invars.inl"
           ;
}

static 
# 61 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
      _Bool 
# 61 "project/radare2/test/unit/test_anal_block_invars.inl"
           block_check_leaks(RAnal *anal) {
 RBIter iter;
 RAnalBlock *block;
 
# 64 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
for ((
# 64 "project/radare2/test/unit/test_anal_block_invars.inl"
iter
# 64 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
) = r_rbtree_first (
# 64 "project/radare2/test/unit/test_anal_block_invars.inl"
...
# 64 "project/radare2/test/unit/test_anal_block_invars.inl"
  ...
  if (block->ref != r_list_length (block->fcns)) {
   do { if (!(
# 66 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
  0
# 66 "project/radare2/test/unit/test_anal_block_invars.inl"
  )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 66, "leaked basic block"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 66, "leaked basic block"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  }
 }
 return 
# 69 "project/radare2/test/unit/test_anal_block_invars.inl" 3 4
       1
# 69 "project/radare2/test/unit/test_anal_block_invars.inl"
           ;
}
# 5 "project/radare2/test/unit/test_anal_function.c" 2


# 6 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 6 "project/radare2/test/unit/test_anal_function.c"
    ht_up_count(void *user, const 
# 6 "project/radare2/test/unit/test_anal_function.c" 3 4
                                  unsigned long long 
# 6 "project/radare2/test/unit/test_anal_function.c"
                                       k, const void *v) {
 ...
 (*count)++;
 return 
# 9 "project/radare2/test/unit/test_anal_function.c" 3 4
       1
# 9 "project/radare2/test/unit/test_anal_function.c"
           ;
}


# 12 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 12 "project/radare2/test/unit/test_anal_function.c"
    ht_pp_count(void *user, const void *k, const void *v) {
 size_t *count = user;
 (*count)++;
 return 
# 15 "project/radare2/test/unit/test_anal_function.c" 3 4
       1
# 15 "project/radare2/test/unit/test_anal_function.c"
           ;
}

static 
# 18 "project/radare2/test/unit/test_anal_function.c" 3 4
      _Bool 
# 18 "project/radare2/test/unit/test_anal_function.c"
           function_check_invariants(RAnal *anal) {
 if (!block_check_invariants (anal)) {
  return 
# 20 "project/radare2/test/unit/test_anal_function.c" 3 4
        0
# 20 "project/radare2/test/unit/test_anal_function.c"
             ;
 }
...
# 25 "project/radare2/test/unit/test_anal_function.c" 3 4
if (
# 25 "project/radare2/test/unit/test_anal_function.c"
anal->fcns
# 25 "project/radare2/test/unit/test_anal_function.c" 3 4
) for (
# 25 "project/radare2/test/unit/test_anal_function.c"
...
# 25 "project/radare2/test/unit/test_anal_function.c"
                                     {
  do { char _meqstr[5120]; const void *act__ = (ht_up_find (anal->ht_addr_fun, fcn->addr, 
# 26 "project/radare2/test/unit/test_anal_function.c" 3 4
 ((void *)0)
# 26 "project/radare2/test/unit/test_anal_function.c"
 )); const void *exp__ = (fcn); 
# 26 "project/radare2/test/unit/test_anal_function.c" 3 4
 __builtin___snprintf_chk (
# 26 "project/radare2/test/unit/test_anal_function.c"
 _meqstr
...
# 26 "project/radare2/test/unit/test_anal_function.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 26 "project/radare2/test/unit/test_anal_function.c"
 "%s: expected %p, got %p.", ("function in addr ht"), (exp__), (act__)
# 26 "project/radare2/test/unit/test_anal_function.c" 3 4
 )
# 26 "project/radare2/test/unit/test_anal_function.c"
 ; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 26, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 26, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
  do { char _meqstr[5120]; const void *act__ = (ht_pp_find (anal->ht_name_fun, fcn->name, 
# 27 "project/radare2/test/unit/test_anal_function.c" 3 4
 ((void *)0)
# 27 "project/radare2/test/unit/test_anal_function.c"
 )); const void *exp__ = (fcn); 
# 27 "project/radare2/test/unit/test_anal_function.c" 3 4
 __builtin___snprintf_chk (
# 27 "project/radare2/test/unit/test_anal_function.c"
...
# 27 "project/radare2/test/unit/test_anal_function.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 27 "project/radare2/test/unit/test_anal_function.c"
 "%s: expected %p, got %p.", ("function in name ht"), (exp__), (act__)
# 27 "project/radare2/test/unit/test_anal_function.c" 3 4
 )
# 27 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 32 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 32 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 32 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 32 "project/radare2/test/unit/test_anal_function.c"
...
unsigned long long
# 32 "project/radare2/test/unit/test_anal_function.c"
)(r_list_length (anal->fcns)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 32 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 32 "project/radare2/test/unit/test_anal_function.c"
_meqstr
...
# 32 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 36 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 36 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 36 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 36 "project/radare2/test/unit/test_anal_function.c"
...
# 36 "project/radare2/test/unit/test_anal_function.c"
 ...
 return 
# 38 "project/radare2/test/unit/test_anal_function.c" 3 4
       1
# 38 "project/radare2/test/unit/test_anal_function.c"
           ;
}
...
# 47 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 47 "project/radare2/test/unit/test_anal_function.c"
    test_r_anal_function_relocate() {
 RAnal *anal = r_anal_new ();
 do { if (!function_check_invariants (anal)) { return 
# 49 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 49 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);

 RAnalFunction *fa = r_anal_create_function (anal, "do_something", 0x1337, 0, 
# 51 "project/radare2/test/unit/test_anal_function.c" 3 4
                                                                             ((void *)0)
# 51 "project/radare2/test/unit/test_anal_function.c"
                                                                                 );
 do { if (!function_check_invariants (anal)) { return 
# 52 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 52 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);
 RAnalFunction *fb = r_anal_create_function (anal, "do_something_else", 0xdeadbeef, 0, 
# 53 "project/radare2/test/unit/test_anal_function.c" 3 4
                                                                                      ((void *)0)
# 53 "project/radare2/test/unit/test_anal_function.c"
                                                                                          );
 do { if (!function_check_invariants (anal)) { return 
# 54 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 54 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);
 r_anal_create_function (anal, "do_something_different", 0xc0ffee, 0, 
# 55 "project/radare2/test/unit/test_anal_function.c" 3 4
                                                                     ((void *)0)
# 55 "project/radare2/test/unit/test_anal_function.c"
                                                                         );
 do { if (!function_check_invariants (anal)) { return 
# 56 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 56 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);

 
# 58 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 58 "project/radare2/test/unit/test_anal_function.c"
     success = r_anal_function_relocate (fa, fb->addr);
 do { if (!function_check_invariants (anal)) { return 
# 59 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 59 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);
 do { 
# 60 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 60 "project/radare2/test/unit/test_anal_function.c"
act__ = (success); if ((act__)) { char _meqstr[5120]; 
# 60 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 60 "project/radare2/test/unit/test_anal_function.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 60 "project/radare2/test/unit/test_anal_function.c"
"%s: expected false, got true", ("failed relocate")
# 60 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 60 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(
...
# 60 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 61 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 61 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 61 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 61 "project/radare2/test/unit/test_anal_function.c"
...
# 61 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { if (!function_check_invariants (anal)) { return 
# 64 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 64 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);
 do { 
# 65 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 65 "project/radare2/test/unit/test_anal_function.c"
act__ = (success); if (!(act__)) { char _meqstr[5120]; 
# 65 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 65 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 65 "project/radare2/test/unit/test_anal_function.c"
"%s: expected true, got false", ("successful relocate")
# 65 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 65 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(
...
# 65 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 66 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 66 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 66 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 66 "project/radare2/test/unit/test_anal_function.c"
...
unsigned long long
# 66 "project/radare2/test/unit/test_anal_function.c"
)(0x1234); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 66 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 66 "project/radare2/test/unit/test_anal_function.c"
_meqstr
...
# 66 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { if (!block_check_leaks (anal)) { return 
# 68 "project/radare2/test/unit/test_anal_function.c" 3 4
0
# 68 "project/radare2/test/unit/test_anal_function.c"
; } } while (0);
 r_anal_free (anal);
...
# 73 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 73 "project/radare2/test/unit/test_anal_function.c"
    test_r_anal_function_labels() {
 RAnal *anal = r_anal_new ();

 RAnalFunction *f = r_anal_create_function (anal, "do_something", 0x1337, 0, 
# 76 "project/radare2/test/unit/test_anal_function.c" 3 4
                                                                            ((void *)0)
# 76 "project/radare2/test/unit/test_anal_function.c"
                                                                                );

 
# 78 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 78 "project/radare2/test/unit/test_anal_function.c"
     s = r_anal_function_set_label (f, "smartfriend", 0x1339);
 do { 
# 79 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 79 "project/radare2/test/unit/test_anal_function.c"
act__ = (s); if (!(act__)) { char _meqstr[5120]; 
# 79 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 79 "project/radare2/test/unit/test_anal_function.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 79 "project/radare2/test/unit/test_anal_function.c"
"%s: expected true, got false", ("set label")
# 79 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 79 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(
...
# 79 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 81 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 81 "project/radare2/test/unit/test_anal_function.c"
act__ = (s); if (!(act__)) { char _meqstr[5120]; 
# 81 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 81 "project/radare2/test/unit/test_anal_function.c"
...
# 81 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 83 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 83 "project/radare2/test/unit/test_anal_function.c"
act__ = (s); if (!(act__)) { char _meqstr[5120]; 
# 83 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 83 "project/radare2/test/unit/test_anal_function.c"
...
# 83 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 85 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 85 "project/radare2/test/unit/test_anal_function.c"
act__ = (s); if ((act__)) { char _meqstr[5120]; 
# 85 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 85 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 85 "project/radare2/test/unit/test_anal_function.c"
"%s: expected false, got true", ("set label (existing name)")
# 85 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 85 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(
...
# 85 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 87 "project/radare2/test/unit/test_anal_function.c" 3 4
_Bool 
# 87 "project/radare2/test/unit/test_anal_function.c"
act__ = (s); if ((act__)) { char _meqstr[5120]; 
# 87 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 87 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 87 "project/radare2/test/unit/test_anal_function.c"
"%s: expected false, got true", ("set label (existing addr)")
# 87 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 87 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(
...
# 89 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 89 "project/radare2/test/unit/test_anal_function.c"
     addr = r_anal_function_get_label (f, "smartfriend");
 do { 
# 90 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 90 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 90 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 90 "project/radare2/test/unit/test_anal_function.c"
...
unsigned long long
# 90 "project/radare2/test/unit/test_anal_function.c"
)(0x1339); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 90 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 90 "project/radare2/test/unit/test_anal_function.c"
_meqstr
...
# 90 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 92 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 92 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 92 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 92 "project/radare2/test/unit/test_anal_function.c"
...
unsigned long long
# 92 "project/radare2/test/unit/test_anal_function.c"
)(0x133c); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 92 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 92 "project/radare2/test/unit/test_anal_function.c"
_meqstr
...
# 92 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { 
# 94 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 94 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 94 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 94 "project/radare2/test/unit/test_anal_function.c"
...
# 94 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (name); const char *exp__ = ("smartfriend"); 
# 97 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 97 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 97 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 97 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 97 "project/radare2/test/unit/test_anal_function.c"
"%s: expected %s, got %s.", ("get label at"), (exp__), (act__)
# 97 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 97 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 97, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 97, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (name); const char *exp__ = ("stray"); 
# 99 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 99 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 99 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 99 "project/radare2/test/unit/test_anal_function.c"
...
# 99 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 99, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 99, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 name = r_anal_function_get_label_at (f, 0x1234);
 do { char _meqstr[5120]; const void *act__ = (name); 
# 101 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 101 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 101 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 101 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 101 "project/radare2/test/unit/test_anal_function.c"
"%s: expected to be NULL but it wasn't.", ("get label at (unknown)")
# 101 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 101 "project/radare2/test/unit/test_anal_function.c"
; do { if (!((act__) == 
...
((void *)0)
# 101 "project/radare2/test/unit/test_anal_function.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 101, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 101, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_anal_function_delete_label (f, "stray");
 addr = r_anal_function_get_label (f, "stray");
 do { 
# 105 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 105 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 105 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 105 "project/radare2/test/unit/test_anal_function.c"
...
# 105 "project/radare2/test/unit/test_anal_function.c"
 ...
 name = r_anal_function_get_label_at (f, 0x133c);
 do { char _meqstr[5120]; const void *act__ = (name); 
# 107 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 107 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 107 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 107 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 107 "project/radare2/test/unit/test_anal_function.c"
"%s: expected to be NULL but it wasn't.", ("get label at (deleted)")
# 107 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 107 "project/radare2/test/unit/test_anal_function.c"
; do { if (!((act__) == 
...
# 107 "project/radare2/test/unit/test_anal_function.c"
 ...
 addr = r_anal_function_get_label (f, "smartfriend");
 do { 
# 109 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 109 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 109 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 109 "project/radare2/test/unit/test_anal_function.c"
...
"lld" 
# 109 "project/radare2/test/unit/test_anal_function.c"
".", ("get label (unaffected by delete)"), (
# 109 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 109 "project/radare2/test/unit/test_anal_function.c"
)(exp__), (
...
# 109 "project/radare2/test/unit/test_anal_function.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (name); const char *exp__ = ("smartfriend"); 
# 111 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 111 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 111 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 111 "project/radare2/test/unit/test_anal_function.c"
...
, 2 > 1 ? 1 : 0), 
# 111 "project/radare2/test/unit/test_anal_function.c"
"%s: expected %s, got %s.", ("get label at (unaffected by delete)"), (exp__), (act__)
# 111 "project/radare2/test/unit/test_anal_function.c" 3 4
)
# 111 "project/radare2/test/unit/test_anal_function.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { 
# 115 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 115 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 115 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 115 "project/radare2/test/unit/test_anal_function.c"
...
0
# 115 "project/radare2/test/unit/test_anal_function.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 name = r_anal_function_get_label_at (f, 0x340);
 do { char _meqstr[5120]; const void *act__ = (name); 
# 117 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 117 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 117 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 117 "project/radare2/test/unit/test_anal_function.c"
...
# 117 "project/radare2/test/unit/test_anal_function.c"
 ...
 addr = r_anal_function_get_label (f, "smartfriend");
 do { 
# 119 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long 
# 119 "project/radare2/test/unit/test_anal_function.c"
act__ = (
# 119 "project/radare2/test/unit/test_anal_function.c" 3 4
unsigned long long
# 119 "project/radare2/test/unit/test_anal_function.c"
...
# 119 "project/radare2/test/unit/test_anal_function.c"
 ...
 name = r_anal_function_get_label_at (f, 0x1339);
 do { char _meqstr[5120]; const char *act__ = (name); const char *exp__ = ("smartfriend"); 
# 121 "project/radare2/test/unit/test_anal_function.c" 3 4
__builtin___snprintf_chk (
# 121 "project/radare2/test/unit/test_anal_function.c"
_meqstr
# 121 "project/radare2/test/unit/test_anal_function.c" 3 4
, 
# 121 "project/radare2/test/unit/test_anal_function.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_function_relocate"); result = test_r_anal_function_relocate(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_function_labels"); result = test_r_anal_function_labels(); tests_run++; tests_passed += result; } while (0);
