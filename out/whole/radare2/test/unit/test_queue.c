# 0 "project/radare2/test/unit/test_queue.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_queue.c"
...
# 2 "project/radare2/test/unit/test_queue.c" 2
...
# 3 "project/radare2/test/unit/test_queue.c" 2


# 4 "project/radare2/test/unit/test_queue.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_queue.c"
    test_r_queue_add_remove(void) {
 int i, j;

 RQueue* queue = r_queue_new (5);
 for (i = 0; i < 5; i++) {
  do { if (!(r_queue_enqueue (queue, (void*)(intptr_t)((i + 1) * 10)))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 9, "enqueue to available slot"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 9, "enqueue to available slot"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0)
                                                             ;
 }
 do { 
# 12 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long 
# 12 "project/radare2/test/unit/test_queue.c"
act__ = (
# 12 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long
# 12 "project/radare2/test/unit/test_queue.c"
...
# 12 "project/radare2/test/unit/test_queue.c"
 ...
 do { if (!(r_queue_enqueue (queue, (void*)(intptr_t)60))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 13, "enqueue but it's full! Increase Capacity!"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 13, "enqueue but it's full! Increase Capacity!"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0)
                                                 ;
 do { 
# 15 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long 
# 15 "project/radare2/test/unit/test_queue.c"
act__ = (
# 15 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long
# 15 "project/radare2/test/unit/test_queue.c"
...
"lld" 
# 15 "project/radare2/test/unit/test_queue.c"
".", ("new capacity should be double old"), (
# 15 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long
# 15 "project/radare2/test/unit/test_queue.c"
)(exp__), (
...
# 15 "project/radare2/test/unit/test_queue.c"
 ...
 for (i = 0; i < 6; i++) {
  ...
  do { 
# 18 "project/radare2/test/unit/test_queue.c" 3 4
 unsigned long long 
# 18 "project/radare2/test/unit/test_queue.c"
 act__ = (
# 18 "project/radare2/test/unit/test_queue.c" 3 4
 unsigned long long
# 18 "project/radare2/test/unit/test_queue.c"
...
# 18 "project/radare2/test/unit/test_queue.c" 3 4
 unsigned long long
# 18 "project/radare2/test/unit/test_queue.c"
 )((i + 1) * 10); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 18 "project/radare2/test/unit/test_queue.c" 3 4
 __builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_queue.c"
 _meqstr
...
# 18 "project/radare2/test/unit/test_queue.c"
 ...
 j = (int)(intptr_t)r_queue_dequeue (queue);
 do { 
# 21 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long 
# 21 "project/radare2/test/unit/test_queue.c"
act__ = (
# 21 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long
# 21 "project/radare2/test/unit/test_queue.c"
...
# 26 "project/radare2/test/unit/test_queue.c" 3 4
_Bool 
# 26 "project/radare2/test/unit/test_queue.c"
    test_r_queue_zero_size(void) {

 RQueue* queue = r_queue_new (0);
 do { 
# 29 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long 
# 29 "project/radare2/test/unit/test_queue.c"
act__ = (
# 29 "project/radare2/test/unit/test_queue.c" 3 4
unsigned long long
# 29 "project/radare2/test/unit/test_queue.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_queue_add_remove"); result = test_r_queue_add_remove(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_queue_zero_size"); result = test_r_queue_zero_size(); tests_run++; tests_passed += result; } while (0);
