# 0 "project/radare2/test/unit/test_debug_session.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_debug_session.c"
...
# 2 "project/radare2/test/unit/test_debug_session.c" 2
...
# 5 "project/radare2/test/unit/test_debug_session.c" 2
...
Sdb *ref_db() {
 ...
 Sdb *registers_db = sdb_ns (db, "registers", 
# 11 "project/radare2/test/unit/test_debug_session.c" 3 4
                                             1
# 11 "project/radare2/test/unit/test_debug_session.c"
                                                 );
 sdb_set (registers_db, "0x100", "[{\"cnum\":0,\"data\":1094861636},{\"cnum\":1,\"data\":3735928559}]", 0);

 Sdb *memory_sdb = sdb_ns (db, "memory", 
# 14 "project/radare2/test/unit/test_debug_session.c" 3 4
                                        1
# 14 "project/radare2/test/unit/test_debug_session.c"
                                            );
 ...
 Sdb *checkpoints_sdb = sdb_ns (db, "checkpoints", 
# 18 "project/radare2/test/unit/test_debug_session.c" 3 4
                                                  1
# 18 "project/radare2/test/unit/test_debug_session.c"
                                                      );
...
# 57 "project/radare2/test/unit/test_debug_session.c" 3 4
 __builtin___memset_chk (
# 57 "project/radare2/test/unit/test_debug_session.c"
 a->bytes
# 57 "project/radare2/test/unit/test_debug_session.c" 3 4
 , 
# 57 "project/radare2/test/unit/test_debug_session.c"
...
# 57 "project/radare2/test/unit/test_debug_session.c"
 ...
 RDebugSnap *snap = 
# 61 "project/radare2/test/unit/test_debug_session.c" 3 4
                   (
# 61 "project/radare2/test/unit/test_debug_session.c"
                   RDebugSnap
# 61 "project/radare2/test/unit/test_debug_session.c" 3 4
                   *)calloc(1,sizeof(
# 61 "project/radare2/test/unit/test_debug_session.c"
...
# 61 "project/radare2/test/unit/test_debug_session.c"
 ...
 snap->user = 0;
 snap->shared = 
# 68 "project/radare2/test/unit/test_debug_session.c" 3 4
               1
# 68 "project/radare2/test/unit/test_debug_session.c"
                   ;
 snap->data = malloc (snap->size);
 
# 70 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___memset_chk (
# 70 "project/radare2/test/unit/test_debug_session.c"
snap->data
# 70 "project/radare2/test/unit/test_debug_session.c" 3 4
, 
# 70 "project/radare2/test/unit/test_debug_session.c"
...
static 
# 85 "project/radare2/test/unit/test_debug_session.c" 3 4
      _Bool 
# 85 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { if (!(sdb_diff (expected, actual, diff_cb, 
# 91 "project/radare2/test/unit/test_debug_session.c" 3 4
((void *)0)
# 91 "project/radare2/test/unit/test_debug_session.c"
))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 91, "save"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 91, "save"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
...
static 
# 99 "project/radare2/test/unit/test_debug_session.c" 3 4
      _Bool 
# 99 "project/radare2/test/unit/test_debug_session.c"
           compare_registers_cb(void *user, const 
# 99 "project/radare2/test/unit/test_debug_session.c" 3 4
                                                  unsigned long long 
# 99 "project/radare2/test/unit/test_debug_session.c"
 ...
 RVector *expected_vreg = ht_up_find (ref, key, 
# 104 "project/radare2/test/unit/test_debug_session.c" 3 4
                                               ((void *)0)
# 104 "project/radare2/test/unit/test_debug_session.c"
                                                   );
 do { if (!(expected_vreg)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 105, "vreg not found"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 105, "vreg not found"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { 
# 106 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 106 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 106 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 106 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 106 "project/radare2/test/unit/test_debug_session.c"
)(expected_vreg->len); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 106 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 106 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
# 109 "project/radare2/test/unit/test_debug_session.c" 3 4
if (!r_vector_empty (
# 109 "project/radare2/test/unit/test_debug_session.c"
actual_vreg
# 109 "project/radare2/test/unit/test_debug_session.c" 3 4
)) for (
# 109 "project/radare2/test/unit/test_debug_session.c"
...
# 109 "project/radare2/test/unit/test_debug_session.c"
  ...
  do { 
# 111 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long 
# 111 "project/radare2/test/unit/test_debug_session.c"
 act__ = (
# 111 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 111 "project/radare2/test/unit/test_debug_session.c"
...
# 111 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 111 "project/radare2/test/unit/test_debug_session.c"
 )(expected_reg->cnum); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 111 "project/radare2/test/unit/test_debug_session.c" 3 4
 __builtin___snprintf_chk (
# 111 "project/radare2/test/unit/test_debug_session.c"
 _meqstr
...
# 111 "project/radare2/test/unit/test_debug_session.c" 3 4
 0
# 111 "project/radare2/test/unit/test_debug_session.c"
 )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
  do { 
# 112 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long 
# 112 "project/radare2/test/unit/test_debug_session.c"
 act__ = (
# 112 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 112 "project/radare2/test/unit/test_debug_session.c"
...
# 112 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 112 "project/radare2/test/unit/test_debug_session.c"
 )(expected_reg->data); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 112 "project/radare2/test/unit/test_debug_session.c" 3 4
 __builtin___snprintf_chk (
# 112 "project/radare2/test/unit/test_debug_session.c"
 _meqstr
...
# 112 "project/radare2/test/unit/test_debug_session.c" 3 4
 0
# 112 "project/radare2/test/unit/test_debug_session.c"
 )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 112, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 112, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 }
 return 
# 114 "project/radare2/test/unit/test_debug_session.c" 3 4
       1
# 114 "project/radare2/test/unit/test_debug_session.c"
           ;
}

static 
# 117 "project/radare2/test/unit/test_debug_session.c" 3 4
      _Bool 
# 117 "project/radare2/test/unit/test_debug_session.c"
           compare_memory_cb(void *user, const 
# 117 "project/radare2/test/unit/test_debug_session.c" 3 4
                                               unsigned long long 
# 117 "project/radare2/test/unit/test_debug_session.c"
                                                    key, const void *value) {
 ...
 RVector *expected_vmem = ht_up_find (ref, key, 
# 122 "project/radare2/test/unit/test_debug_session.c" 3 4
                                               ((void *)0)
# 122 "project/radare2/test/unit/test_debug_session.c"
                                                   );
 do { if (!(expected_vmem)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 123, "vmem not found"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 123, "vmem not found"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { 
# 124 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 124 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 124 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 124 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 124 "project/radare2/test/unit/test_debug_session.c"
)(expected_vmem->len); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 124 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 124 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
0
# 124 "project/radare2/test/unit/test_debug_session.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 124, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 124, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 size_t i;
 
# 127 "project/radare2/test/unit/test_debug_session.c" 3 4
if (!r_vector_empty (
# 127 "project/radare2/test/unit/test_debug_session.c"
actual_vmem
# 127 "project/radare2/test/unit/test_debug_session.c" 3 4
)) for (
# 127 "project/radare2/test/unit/test_debug_session.c"
...
# 127 "project/radare2/test/unit/test_debug_session.c"
  ...
  do { 
# 129 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long 
# 129 "project/radare2/test/unit/test_debug_session.c"
 act__ = (
# 129 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 129 "project/radare2/test/unit/test_debug_session.c"
...
# 129 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 129 "project/radare2/test/unit/test_debug_session.c"
 )(expected_mem->cnum); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 129 "project/radare2/test/unit/test_debug_session.c" 3 4
 __builtin___snprintf_chk (
# 129 "project/radare2/test/unit/test_debug_session.c"
 _meqstr
...
# 129 "project/radare2/test/unit/test_debug_session.c" 3 4
 0
# 129 "project/radare2/test/unit/test_debug_session.c"
 )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 129, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 129, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
  do { 
# 130 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long 
# 130 "project/radare2/test/unit/test_debug_session.c"
 act__ = (
# 130 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 130 "project/radare2/test/unit/test_debug_session.c"
...
# 130 "project/radare2/test/unit/test_debug_session.c" 3 4
 unsigned long long
# 130 "project/radare2/test/unit/test_debug_session.c"
 )(expected_mem->data); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 130 "project/radare2/test/unit/test_debug_session.c" 3 4
 __builtin___snprintf_chk (
# 130 "project/radare2/test/unit/test_debug_session.c"
 _meqstr
...
# 130 "project/radare2/test/unit/test_debug_session.c" 3 4
 0
# 130 "project/radare2/test/unit/test_debug_session.c"
 )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 130, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 130, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 }
 return 
# 132 "project/radare2/test/unit/test_debug_session.c" 3 4
       1
# 132 "project/radare2/test/unit/test_debug_session.c"
           ;
}

static 
# 135 "project/radare2/test/unit/test_debug_session.c" 3 4
      _Bool 
# 135 "project/radare2/test/unit/test_debug_session.c"
           arena_eq(RRegArena *actual, RRegArena *expected) {
 do { if (!(actual && expected)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 136, "arena null"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 136, "arena null"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { 
# 137 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 137 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 137 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 137 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 137 "project/radare2/test/unit/test_debug_session.c"
)(expected->size); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 137 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 137 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
0
# 137 "project/radare2/test/unit/test_debug_session.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 137, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 137, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 138 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned char 
# 138 "project/radare2/test/unit/test_debug_session.c"
*act__ = (actual->bytes); const 
# 138 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned char 
# 138 "project/radare2/test/unit/test_debug_session.c"
*exp__ = (expected->bytes); 
# 138 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 138 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 138 "project/radare2/test/unit/test_debug_session.c"
"%s: expected ", "arena bytes"
# 138 "project/radare2/test/unit/test_debug_session.c" 3 4
)
# 138 "project/radare2/test/unit/test_debug_session.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (expected->size)); _meqstr_len = strlen (_meqstr); 
# 138 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 138 "project/radare2/test/unit/test_debug_session.c"
_meqstr + _meqstr_len
...
# 138 "project/radare2/test/unit/test_debug_session.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (expected->size)); do { if (!(memcmp((exp__), (act__), (expected->size)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 138, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 138, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 return 
# 139 "project/radare2/test/unit/test_debug_session.c" 3 4
       1
# 139 "project/radare2/test/unit/test_debug_session.c"
           ;
}

static 
# 142 "project/radare2/test/unit/test_debug_session.c" 3 4
      _Bool 
# 142 "project/radare2/test/unit/test_debug_session.c"
           snap_eq(RDebugSnap *actual, RDebugSnap *expected) {
 do { if (!(actual && expected)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 143, "snap null"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 143, "snap null"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const char *act__ = (actual->name); const char *exp__ = (expected->name); 
# 144 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 144 "project/radare2/test/unit/test_debug_session.c"
_meqstr
# 144 "project/radare2/test/unit/test_debug_session.c" 3 4
, 
# 144 "project/radare2/test/unit/test_debug_session.c"
...
, 2 > 1 ? 1 : 0), 
# 144 "project/radare2/test/unit/test_debug_session.c"
"%s: expected %s, got %s.", ("snap name"), (exp__), (act__)
# 144 "project/radare2/test/unit/test_debug_session.c" 3 4
)
# 144 "project/radare2/test/unit/test_debug_session.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 144, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 144, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 145 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 145 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 145 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 145 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 145 "project/radare2/test/unit/test_debug_session.c"
)(expected->addr); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 145 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 145 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
# 145 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { 
# 146 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 146 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 146 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 146 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 146 "project/radare2/test/unit/test_debug_session.c"
)(expected->addr_end); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 146 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 146 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
# 146 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { 
# 147 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 147 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 147 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 147 "project/radare2/test/unit/test_debug_session.c"
...
# 147 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { 
# 148 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 148 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 148 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 148 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 148 "project/radare2/test/unit/test_debug_session.c"
)(expected->perm); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 148 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 148 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
# 148 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { 
# 149 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 149 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 149 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 149 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 149 "project/radare2/test/unit/test_debug_session.c"
)(expected->user); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 149 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 149 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
# 149 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { 
# 150 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 150 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 150 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 150 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 150 "project/radare2/test/unit/test_debug_session.c"
)(expected->shared); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 150 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 150 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
# 150 "project/radare2/test/unit/test_debug_session.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 151 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned char 
# 151 "project/radare2/test/unit/test_debug_session.c"
*act__ = (actual->data); const 
# 151 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned char 
# 151 "project/radare2/test/unit/test_debug_session.c"
*exp__ = (expected->data); 
...
# 151 "project/radare2/test/unit/test_debug_session.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (expected->size)); do { if (!(memcmp((exp__), (act__), (expected->size)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 151, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 151, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 return 
# 152 "project/radare2/test/unit/test_debug_session.c" 3 4
       1
# 152 "project/radare2/test/unit/test_debug_session.c"
           ;
}

static 
# 155 "project/radare2/test/unit/test_debug_session.c" 3 4
      _Bool 
# 155 "project/radare2/test/unit/test_debug_session.c"
           test_session_load(void) {
 ...
 do { 
# 161 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 161 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 161 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 161 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 161 "project/radare2/test/unit/test_debug_session.c"
)(ref->maxcnum); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 161 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 161 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
0
# 161 "project/radare2/test/unit/test_debug_session.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 161, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 161, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 ...
 do { 
# 169 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long 
# 169 "project/radare2/test/unit/test_debug_session.c"
act__ = (
# 169 "project/radare2/test/unit/test_debug_session.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_debug_session.c"
...
unsigned long long
# 169 "project/radare2/test/unit/test_debug_session.c"
)(ref->checkpoints->len); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 169 "project/radare2/test/unit/test_debug_session.c" 3 4
__builtin___snprintf_chk (
# 169 "project/radare2/test/unit/test_debug_session.c"
_meqstr
...
0
# 169 "project/radare2/test/unit/test_debug_session.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 169, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 169, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 
# 170 "project/radare2/test/unit/test_debug_session.c" 3 4
if (!r_vector_empty (
# 170 "project/radare2/test/unit/test_debug_session.c"
s->checkpoints
# 170 "project/radare2/test/unit/test_debug_session.c" 3 4
)) for (
# 170 "project/radare2/test/unit/test_debug_session.c"
...
# 170 "project/radare2/test/unit/test_debug_session.c"
  ...
  RListIter *actual_snaps_iter = 
# 177 "project/radare2/test/unit/test_debug_session.c" 3 4
                                (
# 177 "project/radare2/test/unit/test_debug_session.c"
                                chkpt->snaps
# 177 "project/radare2/test/unit/test_debug_session.c" 3 4
                                )? (
# 177 "project/radare2/test/unit/test_debug_session.c"
...
# 177 "project/radare2/test/unit/test_debug_session.c"
                                                              ;
  RListIter *expected_snaps_iter = 
# 178 "project/radare2/test/unit/test_debug_session.c" 3 4
                                  (
# 178 "project/radare2/test/unit/test_debug_session.c"
                                  ref_chkpt->snaps
# 178 "project/radare2/test/unit/test_debug_session.c" 3 4
                                  )? (
# 178 "project/radare2/test/unit/test_debug_session.c"
...
# 178 "project/radare2/test/unit/test_debug_session.c"
  ...
  while (actual_snaps_iter && expected_snaps_iter) {
   RDebugSnap *actual_snap = 
# 180 "project/radare2/test/unit/test_debug_session.c" 3 4
                            (
# 180 "project/radare2/test/unit/test_debug_session.c"
                            actual_snaps_iter
# 180 "project/radare2/test/unit/test_debug_session.c" 3 4
                            )->data; (
# 180 "project/radare2/test/unit/test_debug_session.c"
...
# 180 "project/radare2/test/unit/test_debug_session.c"
                                                               ;
   RDebugSnap *expected_snap = 
# 181 "project/radare2/test/unit/test_debug_session.c" 3 4
                              (
# 181 "project/radare2/test/unit/test_debug_session.c"
                              expected_snaps_iter
# 181 "project/radare2/test/unit/test_debug_session.c" 3 4
                              )->data; (
# 181 "project/radare2/test/unit/test_debug_session.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_session_save"); result = test_session_save(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_session_load"); result = test_session_load(); tests_run++; tests_passed += result; } while (0);
