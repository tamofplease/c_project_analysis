# 0 "project/radare2/test/unit/test_pj.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_pj.c"
...
# 2 "project/radare2/test/unit/test_pj.c" 2
...
# 3 "project/radare2/test/unit/test_pj.c" 2
...
# 4 "project/radare2/test/unit/test_pj.c" 2


# 5 "project/radare2/test/unit/test_pj.c" 3 4
_Bool 
# 5 "project/radare2/test/unit/test_pj.c"
    test_pj_reset() {
 PJ *j = pj_new ();
 pj_o (j);
 pj_ks (j, "test", "object");
 pj_end (j);
 do { char _meqstr[5120]; const char *act__ = (pj_string (j)); const char *exp__ = ("{\"test\":\"object\"}"); 
# 10 "project/radare2/test/unit/test_pj.c" 3 4
__builtin___snprintf_chk (
# 10 "project/radare2/test/unit/test_pj.c"
_meqstr
# 10 "project/radare2/test/unit/test_pj.c" 3 4
, 
# 10 "project/radare2/test/unit/test_pj.c"
...
, 2 > 1 ? 1 : 0), 
# 10 "project/radare2/test/unit/test_pj.c"
"%s: expected %s, got %s.", ("before reset"), (exp__), (act__)
# 10 "project/radare2/test/unit/test_pj.c" 3 4
)
# 10 "project/radare2/test/unit/test_pj.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 10, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 10, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 pj_reset (j);
 do { char _meqstr[5120]; const char *act__ = (pj_string (j)); const char *exp__ = (""); 
# 12 "project/radare2/test/unit/test_pj.c" 3 4
__builtin___snprintf_chk (
# 12 "project/radare2/test/unit/test_pj.c"
_meqstr
# 12 "project/radare2/test/unit/test_pj.c" 3 4
, 
# 12 "project/radare2/test/unit/test_pj.c"
...
, 2 > 1 ? 1 : 0), 
# 12 "project/radare2/test/unit/test_pj.c"
"%s: expected %s, got %s.", ("empty after reset"), (exp__), (act__)
# 12 "project/radare2/test/unit/test_pj.c" 3 4
)
# 12 "project/radare2/test/unit/test_pj.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 12, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 12, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 pj_s (j, "array");
 pj_end (j);
 do { char _meqstr[5120]; const char *act__ = (pj_string (j)); const char *exp__ = ("[\"test\",\"array\"]"); 
# 17 "project/radare2/test/unit/test_pj.c" 3 4
__builtin___snprintf_chk (
# 17 "project/radare2/test/unit/test_pj.c"
_meqstr
# 17 "project/radare2/test/unit/test_pj.c" 3 4
, 
# 17 "project/radare2/test/unit/test_pj.c"
...
, 2 > 1 ? 1 : 0), 
# 17 "project/radare2/test/unit/test_pj.c"
"%s: expected %s, got %s.", ("reuse after reset"), (exp__), (act__)
# 17 "project/radare2/test/unit/test_pj.c" 3 4
)
# 17 "project/radare2/test/unit/test_pj.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_pj_reset"); result = test_pj_reset(); tests_run++; tests_passed += result; } while (0);
