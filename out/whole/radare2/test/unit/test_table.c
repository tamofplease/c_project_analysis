# 0 "project/radare2/test/unit/test_table.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_table.c"
...
# 2 "project/radare2/test/unit/test_table.c" 2
...
# 3 "project/radare2/test/unit/test_table.c" 2
#define BUF_LENGTH 100




# 7 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 7 "project/radare2/test/unit/test_table.c"
    test_r_table(void) {
 ...
 r_table_add_row (t, "hello", "100", 
# 17 "project/radare2/test/unit/test_table.c" 3 4
                                    ((void *)0)
# 17 "project/radare2/test/unit/test_table.c"
                                        );
 r_table_add_row (t, "namings", "20000", 
# 18 "project/radare2/test/unit/test_table.c" 3 4
                                        ((void *)0)
# 18 "project/radare2/test/unit/test_table.c"
                                            );
 ...
 r_table_sort (t, 1, 
# 23 "project/radare2/test/unit/test_table.c" 3 4
                    1
# 23 "project/radare2/test/unit/test_table.c"
                        );
 {
  char *j = r_table_tojson (t);
  const char *jOK = "[{\"name\":\"namings\",\"address\":20000},{\"name\":\"hello\",\"address\":100}]";
  do { char _meqstr[5120]; const char *act__ = (j); const char *exp__ = (jOK); 
# 27 "project/radare2/test/unit/test_table.c" 3 4
 __builtin___snprintf_chk (
# 27 "project/radare2/test/unit/test_table.c"
 _meqstr
# 27 "project/radare2/test/unit/test_table.c" 3 4
 , 
# 27 "project/radare2/test/unit/test_table.c"
...
# 27 "project/radare2/test/unit/test_table.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 27 "project/radare2/test/unit/test_table.c"
 "%s: expected %s, got %s.", ("r_table_get_sections"), (exp__), (act__)
# 27 "project/radare2/test/unit/test_table.c" 3 4
 )
# 27 "project/radare2/test/unit/test_table.c"
...
RTable *__table_test_data1() {
 ...
 r_table_add_row (t, "a", "97", 
# 40 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 40 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "b", "98", 
# 41 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 41 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 42 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 42 "project/radare2/test/unit/test_table.c"
                                   );
...
# 47 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 47 "project/radare2/test/unit/test_table.c"
    test_r_table_column_type(void) {
 RTable *t = __table_test_data1 ();
 RTableColumn *c = r_list_get_n (t->cols, 1);
 c->type = r_table_type ("NUMBER");
 r_table_sort (t, 1, 
# 51 "project/radare2/test/unit/test_table.c" 3 4
                    1
# 51 "project/radare2/test/unit/test_table.c"
                        );
 char *s = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n"); 
# 53 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 53 "project/radare2/test/unit/test_table.c"
_meqstr
# 53 "project/radare2/test/unit/test_table.c" 3 4
, 
# 53 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 53 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("not sorted by second column due to undefined type"), (exp__), (act__)
# 53 "project/radare2/test/unit/test_table.c" 3 4
)
# 53 "project/radare2/test/unit/test_table.c"
...
# 64 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 64 "project/radare2/test/unit/test_table.c"
    test_r_table_tostring(void) {
 RTable *t = __table_test_data1 ();
 char buf[100];
...
# 71 "project/radare2/test/unit/test_table.c" 3 4
 __builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_table.c"
 buf
# 71 "project/radare2/test/unit/test_table.c" 3 4
 , 
# 71 "project/radare2/test/unit/test_table.c"
...
# 71 "project/radare2/test/unit/test_table.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 71 "project/radare2/test/unit/test_table.c"
 "%d-th call to r_table_tostring", i
# 71 "project/radare2/test/unit/test_table.c" 3 4
 )
# 71 "project/radare2/test/unit/test_table.c"
                                                                ;
  do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n"); 
# 72 "project/radare2/test/unit/test_table.c" 3 4
 __builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_table.c"
 _meqstr
# 72 "project/radare2/test/unit/test_table.c" 3 4
 , 
# 72 "project/radare2/test/unit/test_table.c"
...
# 84 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 84 "project/radare2/test/unit/test_table.c"
    test_r_table_sort1(void) {
 RTable *t = __table_test_data1 ();

 r_table_sort (t, 1, 
# 87 "project/radare2/test/unit/test_table.c" 3 4
                    1
# 87 "project/radare2/test/unit/test_table.c"
                        );
 char *strd = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (strd); const char *exp__ = ("ascii code\n" "----------\n" "c     99\n" "b     98\n" "a     97\n"); 
# 89 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 89 "project/radare2/test/unit/test_table.c"
_meqstr
# 89 "project/radare2/test/unit/test_table.c" 3 4
, 
# 89 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 89 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("sort decreasing second column using number type"), (exp__), (act__)
# 89 "project/radare2/test/unit/test_table.c" 3 4
)
# 89 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_sort (t, 1, 
# 97 "project/radare2/test/unit/test_table.c" 3 4
                    0
# 97 "project/radare2/test/unit/test_table.c"
                         );
 char *stri = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (stri); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n"); 
# 99 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 99 "project/radare2/test/unit/test_table.c"
_meqstr
# 99 "project/radare2/test/unit/test_table.c" 3 4
, 
# 99 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 99 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("sort increasing second column using number type"), (exp__), (act__)
# 99 "project/radare2/test/unit/test_table.c" 3 4
)
# 99 "project/radare2/test/unit/test_table.c"
...
# 110 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 110 "project/radare2/test/unit/test_table.c"
    test_r_table_uniq(void) {
 RTable *t = __table_test_data1 ();

 r_table_uniq (t);
 char *strd = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (strd); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n"); 
# 115 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 115 "project/radare2/test/unit/test_table.c"
_meqstr
# 115 "project/radare2/test/unit/test_table.c" 3 4
, 
# 115 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 115 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("uniq delete nothing"), (exp__), (act__)
# 115 "project/radare2/test/unit/test_table.c" 3 4
)
# 115 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_add_row (t, "a", "97", 
# 124 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 124 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "a", "97", 
# 125 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 125 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "a", "97", 
# 126 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 126 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "b", "98", 
# 127 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 127 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 128 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 128 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "b", "98", 
# 129 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 129 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 130 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 130 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "d", "99", 
# 131 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 131 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "b", "98", 
# 132 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 132 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "d", "99", 
# 133 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 133 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 134 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 134 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "100", 
# 135 "project/radare2/test/unit/test_table.c" 3 4
                                ((void *)0)
# 135 "project/radare2/test/unit/test_table.c"
                                    );

 r_table_uniq (t);
 char *stri = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (stri); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n" "d     99\n" "c     100\n"); 
# 139 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 139 "project/radare2/test/unit/test_table.c"
_meqstr
# 139 "project/radare2/test/unit/test_table.c" 3 4
, 
# 139 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 139 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("uniq delete some rows"), (exp__), (act__)
# 139 "project/radare2/test/unit/test_table.c" 3 4
)
# 139 "project/radare2/test/unit/test_table.c"
...
# 189 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 189 "project/radare2/test/unit/test_table.c"
    test_r_table_group (void) {
 RTable *t = __table_test_data1 ();

 r_table_group (t, -1, 
# 192 "project/radare2/test/unit/test_table.c" 3 4
                      ((void *)0)
# 192 "project/radare2/test/unit/test_table.c"
                          );
 char *str = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n"); 
# 194 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 194 "project/radare2/test/unit/test_table.c"
_meqstr
# 194 "project/radare2/test/unit/test_table.c" 3 4
, 
# 194 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 194 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("group delete nothing"), (exp__), (act__)
# 194 "project/radare2/test/unit/test_table.c" 3 4
)
# 194 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 194, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 194, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_add_row (t, "a", "97", 
# 203 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 203 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "a", "97", 
# 204 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 204 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "a", "97", 
# 205 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 205 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "b", "98", 
# 206 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 206 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 207 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 207 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "b", "98", 
# 208 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 208 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 209 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 209 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "d", "1", 
# 210 "project/radare2/test/unit/test_table.c" 3 4
                              ((void *)0)
# 210 "project/radare2/test/unit/test_table.c"
                                  );
 r_table_add_row (t, "b", "98", 
# 211 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 211 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "d", "99", 
# 212 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 212 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "99", 
# 213 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 213 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "c", "100", 
# 214 "project/radare2/test/unit/test_table.c" 3 4
                                ((void *)0)
# 214 "project/radare2/test/unit/test_table.c"
                                    );

 r_table_group (t, 0, 
# 216 "project/radare2/test/unit/test_table.c" 3 4
                     ((void *)0)
# 216 "project/radare2/test/unit/test_table.c"
                         );
 str = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("ascii code\n" "----------\n" "a     97\n" "b     98\n" "c     99\n" "d     1\n"); 
# 218 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 218 "project/radare2/test/unit/test_table.c"
_meqstr
# 218 "project/radare2/test/unit/test_table.c" 3 4
, 
# 218 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 218 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("group delete some rows"), (exp__), (act__)
# 218 "project/radare2/test/unit/test_table.c" 3 4
)
# 218 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 218, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 218, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_add_row (t, "e", "97", 
# 228 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 228 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "f", "98", 
# 229 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 229 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "g", "99", 
# 230 "project/radare2/test/unit/test_table.c" 3 4
                               ((void *)0)
# 230 "project/radare2/test/unit/test_table.c"
                                   );
 r_table_add_row (t, "h", "1", 
# 231 "project/radare2/test/unit/test_table.c" 3 4
                              ((void *)0)
# 231 "project/radare2/test/unit/test_table.c"
                                  );

 r_table_group (t, 1, simple_merge);
 str = r_table_tostring (t);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("ascii code\n" "----------\n" "a | e 97\n" "b | f 98\n" "c | h 99\n" "d | g 1\n"); 
# 235 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 235 "project/radare2/test/unit/test_table.c"
_meqstr
# 235 "project/radare2/test/unit/test_table.c" 3 4
, 
# 235 "project/radare2/test/unit/test_table.c"
...
# 235 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 235, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 235, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
...
# 249 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 249 "project/radare2/test/unit/test_table.c"
    test_r_table_columns () {
 RTable *t = 
# 250 "project/radare2/test/unit/test_table.c" 3 4
            ((void *)0)
# 250 "project/radare2/test/unit/test_table.c"
                ;
#define CREATE_TABLE r_table_free (t); t = r_table_new ("test"); r_table_add_column (t, r_table_type ("number"), "name", 0); r_table_add_column (t, r_table_type ("number"), "address", 0); r_table_add_row (t, "hello", "100", NULL); r_table_add_row (t, "namings", "20000", NULL);
 ...
 r_table_free (t); t = r_table_new ("test"); r_table_add_column (t, r_table_type ("number"), "name", 0); r_table_add_column (t, r_table_type ("number"), "address", 0); r_table_add_row (t, "hello", "100", 
# 259 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 259 "project/radare2/test/unit/test_table.c"
); r_table_add_row (t, "namings", "20000", 
# 259 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 259 "project/radare2/test/unit/test_table.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("name,address\n" "hello,100\n" "namings,20000\n"); 
# 261 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 261 "project/radare2/test/unit/test_table.c"
_meqstr
# 261 "project/radare2/test/unit/test_table.c" 3 4
, 
# 261 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 261 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("original"), (exp__), (act__)
# 261 "project/radare2/test/unit/test_table.c" 3 4
)
# 261 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 261, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 261, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 s = r_table_tocsv (t);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("\n" "\n" "\n"); 
# 270 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 270 "project/radare2/test/unit/test_table.c"
_meqstr
# 270 "project/radare2/test/unit/test_table.c" 3 4
, 
# 270 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 270 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("no cols"), (exp__), (act__)
# 270 "project/radare2/test/unit/test_table.c" 3 4
)
# 270 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 270, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 270, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_free (t); t = r_table_new ("test"); r_table_add_column (t, r_table_type ("number"), "name", 0); r_table_add_column (t, r_table_type ("number"), "address", 0); r_table_add_row (t, "hello", "100", 
# 276 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 276 "project/radare2/test/unit/test_table.c"
); r_table_add_row (t, "namings", "20000", 
# 276 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 276 "project/radare2/test/unit/test_table.c"
...
# 277 "project/radare2/test/unit/test_table.c" 3 4
r_list_append ((
# 277 "project/radare2/test/unit/test_table.c"
newcols
# 277 "project/radare2/test/unit/test_table.c" 3 4
), (
# 277 "project/radare2/test/unit/test_table.c"
...
# 277 "project/radare2/test/unit/test_table.c"
 ...
 r_table_columns (t, newcols);
 s = r_table_tocsv (t);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("address\n" "100\n" "20000\n"); 
# 280 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 280 "project/radare2/test/unit/test_table.c"
_meqstr
# 280 "project/radare2/test/unit/test_table.c" 3 4
, 
# 280 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 280 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("select"), (exp__), (act__)
# 280 "project/radare2/test/unit/test_table.c" 3 4
)
# 280 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 280, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 280, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_free (t); t = r_table_new ("test"); r_table_add_column (t, r_table_type ("number"), "name", 0); r_table_add_column (t, r_table_type ("number"), "address", 0); r_table_add_row (t, "hello", "100", 
# 286 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 286 "project/radare2/test/unit/test_table.c"
); r_table_add_row (t, "namings", "20000", 
# 286 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 286 "project/radare2/test/unit/test_table.c"
...
# 287 "project/radare2/test/unit/test_table.c" 3 4
r_list_append ((
# 287 "project/radare2/test/unit/test_table.c"
newcols
# 287 "project/radare2/test/unit/test_table.c" 3 4
), (
# 287 "project/radare2/test/unit/test_table.c"
...
# 287 "project/radare2/test/unit/test_table.c"
 ...
 r_table_columns (t, newcols);
 s = r_table_tocsv (t);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("address,name\n" "100,hello\n" "20000,namings\n"); 
# 290 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 290 "project/radare2/test/unit/test_table.c"
_meqstr
# 290 "project/radare2/test/unit/test_table.c" 3 4
, 
# 290 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 290 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("reorder"), (exp__), (act__)
# 290 "project/radare2/test/unit/test_table.c" 3 4
)
# 290 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 290, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 290, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
 ...
 r_table_free (t); t = r_table_new ("test"); r_table_add_column (t, r_table_type ("number"), "name", 0); r_table_add_column (t, r_table_type ("number"), "address", 0); r_table_add_row (t, "hello", "100", 
# 296 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 296 "project/radare2/test/unit/test_table.c"
); r_table_add_row (t, "namings", "20000", 
# 296 "project/radare2/test/unit/test_table.c" 3 4
((void *)0)
# 296 "project/radare2/test/unit/test_table.c"
...
# 297 "project/radare2/test/unit/test_table.c" 3 4
r_list_append ((
# 297 "project/radare2/test/unit/test_table.c"
newcols
# 297 "project/radare2/test/unit/test_table.c" 3 4
), (
# 297 "project/radare2/test/unit/test_table.c"
...
# 298 "project/radare2/test/unit/test_table.c" 3 4
r_list_append ((
# 298 "project/radare2/test/unit/test_table.c"
newcols
# 298 "project/radare2/test/unit/test_table.c" 3 4
), (
# 298 "project/radare2/test/unit/test_table.c"
...
# 298 "project/radare2/test/unit/test_table.c"
 ...
 r_table_columns (t, newcols);
 s = r_table_tocsv (t);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("address,name,name,address\n" "100,hello,hello,100\n" "20000,namings,namings,20000\n"); 
# 301 "project/radare2/test/unit/test_table.c" 3 4
__builtin___snprintf_chk (
# 301 "project/radare2/test/unit/test_table.c"
_meqstr
# 301 "project/radare2/test/unit/test_table.c" 3 4
, 
# 301 "project/radare2/test/unit/test_table.c"
...
, 2 > 1 ? 1 : 0), 
# 301 "project/radare2/test/unit/test_table.c"
"%s: expected %s, got %s.", ("replicate"), (exp__), (act__)
# 301 "project/radare2/test/unit/test_table.c" 3 4
)
# 301 "project/radare2/test/unit/test_table.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 301, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 301, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0)
...
# 313 "project/radare2/test/unit/test_table.c" 3 4
_Bool 
# 313 "project/radare2/test/unit/test_table.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table"); result = test_r_table(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table_column_type"); result = test_r_table_column_type(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table_tostring"); result = test_r_table_tostring(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table_sort1"); result = test_r_table_sort1(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table_uniq"); result = test_r_table_uniq(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table_group"); result = test_r_table_group(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_table_columns"); result = test_r_table_columns(); tests_run++; tests_passed += result; } while (0);
