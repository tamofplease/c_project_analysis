# 0 "project/radare2/test/unit/test_bin.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_bin.c"
...
# 2 "project/radare2/test/unit/test_bin.c" 2
...
# 3 "project/radare2/test/unit/test_bin.c" 2
...
# 4 "project/radare2/test/unit/test_bin.c" 2



_Bool 
# 7 "project/radare2/test/unit/test_bin.c"
    test_r_bin(void) {
 RBin *bin = r_bin_new ();
 RIO *io = r_io_new ();
...
# 13 "project/radare2/test/unit/test_bin.c" 3 4
_Bool 
# 13 "project/radare2/test/unit/test_bin.c"
     res = r_bin_open (bin, "bins/elf/ioli/crackme0x00", &opt);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 14, "crackme0x00 binary could not be opened"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 14, "crackme0x00 binary could not be opened"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 RList *sections = r_bin_get_sections (bin);

 do { 
# 18 "project/radare2/test/unit/test_bin.c" 3 4
unsigned long long 
# 18 "project/radare2/test/unit/test_bin.c"
act__ = (
# 18 "project/radare2/test/unit/test_bin.c" 3 4
unsigned long long
# 18 "project/radare2/test/unit/test_bin.c"
)(r_list_length (sections)); 
# 18 "project/radare2/test/unit/test_bin.c" 3 4
unsigned long long 
# 18 "project/radare2/test/unit/test_bin.c"
exp__ = (
...
unsigned long long
# 18 "project/radare2/test/unit/test_bin.c"
)(39); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 18 "project/radare2/test/unit/test_bin.c" 3 4
__builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_bin.c"
_meqstr
...
# 26 "project/radare2/test/unit/test_bin.c" 3 4
_Bool 
# 26 "project/radare2/test/unit/test_bin.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_bin"); result = test_r_bin(); tests_run++; tests_passed += result; } while (0);
