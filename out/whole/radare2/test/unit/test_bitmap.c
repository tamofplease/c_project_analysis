# 0 "project/radare2/test/unit/test_bitmap.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_bitmap.c"
...
# 2 "project/radare2/test/unit/test_bitmap.c" 2
...
# 3 "project/radare2/test/unit/test_bitmap.c" 2


# 4 "project/radare2/test/unit/test_bitmap.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_bitmap.c"
    test_r_bitmap_set(void) {
 int i;
 static const int max_value = (2343 + 1);
 static const 
# 7 "project/radare2/test/unit/test_bitmap.c" 3 4
             unsigned int 
# 7 "project/radare2/test/unit/test_bitmap.c"
                  values [] = { 1,2,3,4,8,34,543,2343 };
 static const int len = (sizeof(values)/sizeof(
# 8 "project/radare2/test/unit/test_bitmap.c" 3 4
                                              unsigned int
# 8 "project/radare2/test/unit/test_bitmap.c"
                                                  ));
 ...
 for(i=0; i < len; i++) {
  do { 
# 14 "project/radare2/test/unit/test_bitmap.c" 3 4
 unsigned long long 
# 14 "project/radare2/test/unit/test_bitmap.c"
 act__ = (
# 14 "project/radare2/test/unit/test_bitmap.c" 3 4
 unsigned long long
# 14 "project/radare2/test/unit/test_bitmap.c"
 )(r_bitmap_test(bitmap, values[i])); 
# 14 "project/radare2/test/unit/test_bitmap.c" 3 4
 unsigned long long 
# 14 "project/radare2/test/unit/test_bitmap.c"
 exp__ = (
...
# 14 "project/radare2/test/unit/test_bitmap.c"
 ...
 for(i=0; i < len; i++) {
  do { 
# 21 "project/radare2/test/unit/test_bitmap.c" 3 4
 unsigned long long 
# 21 "project/radare2/test/unit/test_bitmap.c"
 act__ = (
# 21 "project/radare2/test/unit/test_bitmap.c" 3 4
 unsigned long long
# 21 "project/radare2/test/unit/test_bitmap.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_bitmap_set"); result = test_r_bitmap_set(); tests_run++; tests_passed += result; } while (0);
