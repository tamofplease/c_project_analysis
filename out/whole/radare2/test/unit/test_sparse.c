# 0 "project/radare2/test/unit/test_sparse.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_sparse.c"
...
# 2 "project/radare2/test/unit/test_sparse.c" 2
...
# 3 "project/radare2/test/unit/test_sparse.c" 2


# 4 "project/radare2/test/unit/test_sparse.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_sparse.c"
    test_r_buf_new_sparse(void) {
 
# 5 "project/radare2/test/unit/test_sparse.c" 3 4
unsigned char 
# 5 "project/radare2/test/unit/test_sparse.c"
    data[128];
 ...
 r_buf_free (b);
 do { char _meqstr[5120]; const char *act__ = ((const char *)data); const char *exp__ = ("eXXo World"); 
# 12 "project/radare2/test/unit/test_sparse.c" 3 4
__builtin___snprintf_chk (
# 12 "project/radare2/test/unit/test_sparse.c"
_meqstr
# 12 "project/radare2/test/unit/test_sparse.c" 3 4
, 
# 12 "project/radare2/test/unit/test_sparse.c"
...
, 2 > 1 ? 1 : 0), 
# 12 "project/radare2/test/unit/test_sparse.c"
"%s: expected %s, got %s.", ("test_r_buf_new_sparse"), (exp__), (act__)
# 12 "project/radare2/test/unit/test_sparse.c" 3 4
)
# 12 "project/radare2/test/unit/test_sparse.c"
...
# 16 "project/radare2/test/unit/test_sparse.c" 3 4
_Bool 
# 16 "project/radare2/test/unit/test_sparse.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_new_sparse"); result = test_r_buf_new_sparse(); tests_run++; tests_passed += result; } while (0);
