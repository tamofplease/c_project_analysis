# 0 "project/radare2/test/unit/test_sign.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_sign.c"
...
# 2 "project/radare2/test/unit/test_sign.c" 2
...
# 3 "project/radare2/test/unit/test_sign.c" 2
...
# 5 "project/radare2/test/unit/test_sign.c" 2

static 
# 6 "project/radare2/test/unit/test_sign.c" 3 4
      _Bool 
# 6 "project/radare2/test/unit/test_sign.c"
           check_var_n(RList *vars, int n, RAnalVarProt *ans) {
 RAnalVarProt *test = r_list_get_n (vars, n);
 if (strcmp (test->name, ans->name)) {
  return 
# 9 "project/radare2/test/unit/test_sign.c" 3 4
        0
# 9 "project/radare2/test/unit/test_sign.c"
             ;
 }
 if (strcmp (test->type, ans->type)) {
  return 
# 12 "project/radare2/test/unit/test_sign.c" 3 4
        0
# 12 "project/radare2/test/unit/test_sign.c"
             ;
 }
 if (test->isarg != ans->isarg) {
  return 
# 15 "project/radare2/test/unit/test_sign.c" 3 4
        0
# 15 "project/radare2/test/unit/test_sign.c"
             ;
 }
 if (test->kind != ans->kind) {
  return 
# 18 "project/radare2/test/unit/test_sign.c" 3 4
        0
# 18 "project/radare2/test/unit/test_sign.c"
             ;
 }
 return 
# 20 "project/radare2/test/unit/test_sign.c" 3 4
       1
# 20 "project/radare2/test/unit/test_sign.c"
           ;
}

static 
# 23 "project/radare2/test/unit/test_sign.c" 3 4
      _Bool 
# 23 "project/radare2/test/unit/test_sign.c"
           test_anal_sign_get_set(void) {
 ...
 item->bytes = 
# 31 "project/radare2/test/unit/test_sign.c" 3 4
              (
# 31 "project/radare2/test/unit/test_sign.c"
              RSignBytes
# 31 "project/radare2/test/unit/test_sign.c" 3 4
              *)calloc(1,sizeof(
# 31 "project/radare2/test/unit/test_sign.c"
...
# 31 "project/radare2/test/unit/test_sign.c"
 ...
 item->bytes->size = 4;
 item->bytes->bytes = (
# 33 "project/radare2/test/unit/test_sign.c" 3 4
                      unsigned char 
# 33 "project/radare2/test/unit/test_sign.c"
                          *)strdup ("\xde\xad\xbe\xef");
 item->bytes->mask = (
# 34 "project/radare2/test/unit/test_sign.c" 3 4
                     unsigned char 
# 34 "project/radare2/test/unit/test_sign.c"
                         *)strdup ("\xc0\xff\xee\x42");

 item->graph = 
# 36 "project/radare2/test/unit/test_sign.c" 3 4
              (
# 36 "project/radare2/test/unit/test_sign.c"
              RSignGraph
# 36 "project/radare2/test/unit/test_sign.c" 3 4
              *)calloc(1,sizeof(
# 36 "project/radare2/test/unit/test_sign.c"
...
# 36 "project/radare2/test/unit/test_sign.c"
 ...
 item->hash = 
# 57 "project/radare2/test/unit/test_sign.c" 3 4
             (
# 57 "project/radare2/test/unit/test_sign.c"
             RSignHash
# 57 "project/radare2/test/unit/test_sign.c" 3 4
             *)calloc(1,sizeof(
# 57 "project/radare2/test/unit/test_sign.c"
...
# 57 "project/radare2/test/unit/test_sign.c"
 ...
 r_spaces_set (&anal->zign_spaces, 
# 68 "project/radare2/test/unit/test_sign.c" 3 4
                                  ((void *)0)
# 68 "project/radare2/test/unit/test_sign.c"
                                      );
 item = r_sign_get_item (anal, "sym.mahboi");
 do { char _meqstr[5120]; const void *act__ = (item); 
# 70 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 70 "project/radare2/test/unit/test_sign.c"
_meqstr
# 70 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 70 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 70 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("get item")
# 70 "project/radare2/test/unit/test_sign.c" 3 4
)
# 70 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
# 70 "project/radare2/test/unit/test_sign.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (item->name); const char *exp__ = ("sym.mahboi"); 
# 72 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_sign.c"
_meqstr
# 72 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 72 "project/radare2/test/unit/test_sign.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (item->realname); const char *exp__ = ("sym.Mah.Boi"); 
# 73 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 73 "project/radare2/test/unit/test_sign.c"
_meqstr
# 73 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 73 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 73 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("realname"), (exp__), (act__)
# 73 "project/radare2/test/unit/test_sign.c" 3 4
)
# 73 "project/radare2/test/unit/test_sign.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 73, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 73, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (item->comment); const char *exp__ = ("This peace is what all true warriors strive for"); 
# 74 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 74 "project/radare2/test/unit/test_sign.c"
_meqstr
# 74 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 74 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 74 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("comment"), (exp__), (act__)
# 74 "project/radare2/test/unit/test_sign.c" 3 4
)
# 74 "project/radare2/test/unit/test_sign.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 74, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 74, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (item->bytes); 
# 75 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 75 "project/radare2/test/unit/test_sign.c"
_meqstr
# 75 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 75 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 75 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("bytes")
# 75 "project/radare2/test/unit/test_sign.c" 3 4
)
# 75 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
# 75 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 76 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 76 "project/radare2/test/unit/test_sign.c"
act__ = (
# 76 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 76 "project/radare2/test/unit/test_sign.c"
...
# 77 "project/radare2/test/unit/test_sign.c" 3 4
unsigned char 
# 77 "project/radare2/test/unit/test_sign.c"
*act__ = (item->bytes->bytes); const 
# 77 "project/radare2/test/unit/test_sign.c" 3 4
unsigned char 
# 77 "project/radare2/test/unit/test_sign.c"
*exp__ = ((
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (4)); do { if (!(memcmp((exp__), (act__), (4)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 77, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 77, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 78 "project/radare2/test/unit/test_sign.c" 3 4
unsigned char 
# 78 "project/radare2/test/unit/test_sign.c"
*act__ = (item->bytes->mask); const 
# 78 "project/radare2/test/unit/test_sign.c" 3 4
unsigned char 
# 78 "project/radare2/test/unit/test_sign.c"
*exp__ = ((
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (4)); do { if (!(memcmp((exp__), (act__), (4)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 78, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 78, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (item->graph); 
# 79 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 79 "project/radare2/test/unit/test_sign.c"
_meqstr
# 79 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 79 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 79 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("graph")
# 79 "project/radare2/test/unit/test_sign.c" 3 4
)
# 79 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
# 79 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 80 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 80 "project/radare2/test/unit/test_sign.c"
act__ = (
# 80 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 80 "project/radare2/test/unit/test_sign.c"
...
# 80 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 81 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 81 "project/radare2/test/unit/test_sign.c"
act__ = (
# 81 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 81 "project/radare2/test/unit/test_sign.c"
...
# 81 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 82 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 82 "project/radare2/test/unit/test_sign.c"
act__ = (
# 82 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 82 "project/radare2/test/unit/test_sign.c"
...
# 82 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 83 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 83 "project/radare2/test/unit/test_sign.c"
act__ = (
# 83 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 83 "project/radare2/test/unit/test_sign.c"
...
unsigned long long
# 83 "project/radare2/test/unit/test_sign.c"
)(12); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 83 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 83 "project/radare2/test/unit/test_sign.c"
_meqstr
...
# 83 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 84 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 84 "project/radare2/test/unit/test_sign.c"
act__ = (
# 84 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 84 "project/radare2/test/unit/test_sign.c"
...
unsigned long long
# 84 "project/radare2/test/unit/test_sign.c"
)(11); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 84 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 84 "project/radare2/test/unit/test_sign.c"
_meqstr
...
# 84 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 85 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 85 "project/radare2/test/unit/test_sign.c"
act__ = (
# 85 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 85 "project/radare2/test/unit/test_sign.c"
...
# 85 "project/radare2/test/unit/test_sign.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (item->refs); 
# 86 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 86 "project/radare2/test/unit/test_sign.c"
_meqstr
# 86 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 86 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 86 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("refs")
# 86 "project/radare2/test/unit/test_sign.c" 3 4
)
# 86 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
# 86 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 87 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 87 "project/radare2/test/unit/test_sign.c"
act__ = (
# 87 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 87 "project/radare2/test/unit/test_sign.c"
)(r_list_length (item->refs)); 
# 87 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 87 "project/radare2/test/unit/test_sign.c"
exp__ = (
...
# 87 "project/radare2/test/unit/test_sign.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (r_list_get_n (item->refs, 0)); const char *exp__ = ("gwonam"); 
# 88 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 88 "project/radare2/test/unit/test_sign.c"
_meqstr
# 88 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 88 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 88 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("ref"), (exp__), (act__)
# 88 "project/radare2/test/unit/test_sign.c" 3 4
)
# 88 "project/radare2/test/unit/test_sign.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 88, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 88, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (r_list_get_n (item->refs, 1)); const char *exp__ = ("link"); 
# 89 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 89 "project/radare2/test/unit/test_sign.c"
_meqstr
# 89 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 89 "project/radare2/test/unit/test_sign.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (item->xrefs); 
# 90 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 90 "project/radare2/test/unit/test_sign.c"
_meqstr
# 90 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 90 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 90 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("xrefs")
# 90 "project/radare2/test/unit/test_sign.c" 3 4
)
# 90 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
# 90 "project/radare2/test/unit/test_sign.c"
 ...
 do { 
# 91 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 91 "project/radare2/test/unit/test_sign.c"
act__ = (
# 91 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 91 "project/radare2/test/unit/test_sign.c"
)(r_list_length (item->xrefs)); 
# 91 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 91 "project/radare2/test/unit/test_sign.c"
exp__ = (
...
# 91 "project/radare2/test/unit/test_sign.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (r_list_get_n (item->xrefs, 0)); const char *exp__ = ("king"); 
# 92 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 92 "project/radare2/test/unit/test_sign.c"
_meqstr
# 92 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 92 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 92 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("xref"), (exp__), (act__)
# 92 "project/radare2/test/unit/test_sign.c" 3 4
)
# 92 "project/radare2/test/unit/test_sign.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 92, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 92, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (r_list_get_n (item->xrefs, 1)); const char *exp__ = ("ganon"); 
# 93 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 93 "project/radare2/test/unit/test_sign.c"
_meqstr
# 93 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 93 "project/radare2/test/unit/test_sign.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 93, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 93, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 RAnalVarProt v;
 do { char _meqstr[5120]; const void *act__ = (item->vars); 
# 97 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 97 "project/radare2/test/unit/test_sign.c"
_meqstr
# 97 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 97 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 97 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("vars")
# 97 "project/radare2/test/unit/test_sign.c" 3 4
)
# 97 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
((void *)0)
# 97 "project/radare2/test/unit/test_sign.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 97, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 97, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 98 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 98 "project/radare2/test/unit/test_sign.c"
act__ = (
# 98 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long
# 98 "project/radare2/test/unit/test_sign.c"
)(r_list_length (item->vars)); 
# 98 "project/radare2/test/unit/test_sign.c" 3 4
unsigned long long 
# 98 "project/radare2/test/unit/test_sign.c"
exp__ = (
...
# 98 "project/radare2/test/unit/test_sign.c"
 ...
 v = (RAnalVarProt){ .isarg = 
# 99 "project/radare2/test/unit/test_sign.c" 3 4
                             1
# 99 "project/radare2/test/unit/test_sign.c"
                                 , .kind = 'r', .name = "arg16", .type = "int *" };
 do { if (!(check_var_n (item->vars, 0, &v))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 100, "var[0]"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 100, "var[0]"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 v = (RAnalVarProt){ .isarg = 
# 101 "project/radare2/test/unit/test_sign.c" 3 4
                             1
# 101 "project/radare2/test/unit/test_sign.c"
                                 , .kind = 's', .name = "arg42", .type = "int64_t" };
 do { if (!(check_var_n (item->vars, 1, &v))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 102, "var[1]"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 102, "var[1]"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 v = (RAnalVarProt){ .isarg = 
# 103 "project/radare2/test/unit/test_sign.c" 3 4
                             0
# 103 "project/radare2/test/unit/test_sign.c"
                                  , .kind = 'b', .name = "var_13", .type = "char **" };
 do { if (!(check_var_n (item->vars, 2, &v))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 104, "var[2]"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 104, "var[2]"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 do { char _meqstr[5120]; const char *act__ = (item->types); const char *exp__ = ("char * sym.mahboi (int arg0, uint32_t die)"); 
# 106 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 106 "project/radare2/test/unit/test_sign.c"
_meqstr
# 106 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 106 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 106 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("types"), (exp__), (act__)
# 106 "project/radare2/test/unit/test_sign.c" 3 4
)
# 106 "project/radare2/test/unit/test_sign.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 106, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 106, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (item->hash); 
# 107 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 107 "project/radare2/test/unit/test_sign.c"
_meqstr
# 107 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 107 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 107 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("hash")
# 107 "project/radare2/test/unit/test_sign.c" 3 4
)
# 107 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
((void *)0)
# 107 "project/radare2/test/unit/test_sign.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 107, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 107, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (item->hash->bbhash); const char *exp__ = ("7bfa1358c427e26bc03c2384f41de7be6ebc01958a57e9a6deda5bdba9768851"); 
# 108 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 108 "project/radare2/test/unit/test_sign.c"
_meqstr
# 108 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 108 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 108 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("hash val"), (exp__), (act__)
# 108 "project/radare2/test/unit/test_sign.c" 3 4
)
# 108 "project/radare2/test/unit/test_sign.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 108, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 108, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_sign_item_free (item);

 r_spaces_set (&anal->zign_spaces, "koridai");
 item = r_sign_get_item (anal, "sym.boring");
 do { char _meqstr[5120]; const void *act__ = (item); 
# 113 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 113 "project/radare2/test/unit/test_sign.c"
_meqstr
# 113 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 113 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 113 "project/radare2/test/unit/test_sign.c"
"%s: expected to not be NULL but it was.", ("get item in space")
# 113 "project/radare2/test/unit/test_sign.c" 3 4
)
# 113 "project/radare2/test/unit/test_sign.c"
; do { if (!((act__) != 
...
# 113 "project/radare2/test/unit/test_sign.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (item->comment); const char *exp__ = ("gee it sure is boring around here"); 
# 114 "project/radare2/test/unit/test_sign.c" 3 4
__builtin___snprintf_chk (
# 114 "project/radare2/test/unit/test_sign.c"
_meqstr
# 114 "project/radare2/test/unit/test_sign.c" 3 4
, 
# 114 "project/radare2/test/unit/test_sign.c"
...
, 2 > 1 ? 1 : 0), 
# 114 "project/radare2/test/unit/test_sign.c"
"%s: expected %s, got %s.", ("item in space comment"), (exp__), (act__)
# 114 "project/radare2/test/unit/test_sign.c" 3 4
)
# 114 "project/radare2/test/unit/test_sign.c"
...
int all_tests(void) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_anal_sign_get_set"); result = test_anal_sign_get_set(); tests_run++; tests_passed += result; } while (0);
