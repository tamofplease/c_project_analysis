# 0 "project/radare2/test/unit/test_reg.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_reg.c"
...
# 2 "project/radare2/test/unit/test_reg.c" 2
...
# 3 "project/radare2/test/unit/test_reg.c" 2


# 4 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_reg.c"
    test_r_reg_set_name(void) {
 RReg *reg;

 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 8 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 8 "project/radare2/test/unit/test_reg.c"
_meqstr
# 8 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 8 "project/radare2/test/unit/test_reg.c"
...
, 2 > 1 ? 1 : 0), 
# 8 "project/radare2/test/unit/test_reg.c"
"%s: expected to not be NULL but it was.", ("r_reg_new () failed")
# 8 "project/radare2/test/unit/test_reg.c" 3 4
)
# 8 "project/radare2/test/unit/test_reg.c"
; do { if (!((act__) != 
...
# 8 "project/radare2/test/unit/test_reg.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (name); const char *exp__ = ("eip"); 
# 12 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 12 "project/radare2/test/unit/test_reg.c"
_meqstr
# 12 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 12 "project/radare2/test/unit/test_reg.c"
...
, 2 > 1 ? 1 : 0), 
# 12 "project/radare2/test/unit/test_reg.c"
"%s: expected %s, got %s.", ("PC register alias is eip"), (exp__), (act__)
# 12 "project/radare2/test/unit/test_reg.c" 3 4
)
# 12 "project/radare2/test/unit/test_reg.c"
...
# 18 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 18 "project/radare2/test/unit/test_reg.c"
    test_r_reg_set_profile_string(void) {
 RReg *reg;

 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 22 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 22 "project/radare2/test/unit/test_reg.c"
_meqstr
# 22 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 22 "project/radare2/test/unit/test_reg.c"
...
# 22 "project/radare2/test/unit/test_reg.c"
 ...
 const char *name = r_reg_get_name (reg, R_REG_NAME_PC);
 do { char _meqstr[5120]; const char *act__ = (name); const char *exp__ = ("eip"); 
# 26 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 26 "project/radare2/test/unit/test_reg.c"
_meqstr
# 26 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 26 "project/radare2/test/unit/test_reg.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 26, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 26, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { 
# 28 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 28 "project/radare2/test/unit/test_reg.c"
act__ = (
# 28 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 28 "project/radare2/test/unit/test_reg.c"
)(r_reg_set_profile_string (reg, "gpr eax .32 24 0")); 
# 28 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 28 "project/radare2/test/unit/test_reg.c"
exp__ = (
...
# 28 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 31 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 31 "project/radare2/test/unit/test_reg.c"
act__ = (
# 31 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 31 "project/radare2/test/unit/test_reg.c"
)(r_reg_setv (reg, "eax", 1234)); 
# 31 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 31 "project/radare2/test/unit/test_reg.c"
exp__ = (
...
"lld" 
# 31 "project/radare2/test/unit/test_reg.c"
".", ("set eax register value to 1234"), (
# 31 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 31 "project/radare2/test/unit/test_reg.c"
)(exp__), (
...
# 34 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 34 "project/radare2/test/unit/test_reg.c"
     value = r_reg_getv (reg, "eax");
 do { 
# 35 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 35 "project/radare2/test/unit/test_reg.c"
act__ = (
# 35 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 35 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 35 "project/radare2/test/unit/test_reg.c"
)(1234); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 35 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 35 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 41 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 41 "project/radare2/test/unit/test_reg.c"
    test_r_reg_get_value_gpr(void) {
 RReg *reg;
 
# 43 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 43 "project/radare2/test/unit/test_reg.c"
     value;

 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 46 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 46 "project/radare2/test/unit/test_reg.c"
_meqstr
# 46 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 46 "project/radare2/test/unit/test_reg.c"
...
# 58 "project/radare2/test/unit/test_reg.c"
 do { 
# 58 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 58 "project/radare2/test/unit/test_reg.c"
act__ = (
# 58 "project/radare2/test/unit/test_reg.c" 3 4
...
"lld" 
# 58 "project/radare2/test/unit/test_reg.c"
".", ("set eax register value to 0x01234567"), (
# 58 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 58 "project/radare2/test/unit/test_reg.c"
)(exp__), (
...
# 58 "project/radare2/test/unit/test_reg.c"
 ...
 value = r_reg_getv (reg, "eax");
 do { 
# 62 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 62 "project/radare2/test/unit/test_reg.c"
act__ = (
# 62 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 62 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 62 "project/radare2/test/unit/test_reg.c"
)(0x01234567); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 62 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 62 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 62 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 65 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 65 "project/radare2/test/unit/test_reg.c"
act__ = (
# 65 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 65 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 65 "project/radare2/test/unit/test_reg.c"
)(0x4567); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 65 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 65 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 65 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 68 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 68 "project/radare2/test/unit/test_reg.c"
act__ = (
# 68 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 68 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 68 "project/radare2/test/unit/test_reg.c"
)(0x45); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 68 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 68 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 68 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 71 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 71 "project/radare2/test/unit/test_reg.c"
act__ = (
# 71 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 71 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 71 "project/radare2/test/unit/test_reg.c"
)(0x67); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 71 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 71 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 73 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 73 "project/radare2/test/unit/test_reg.c"
act__ = (
# 73 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 73 "project/radare2/test/unit/test_reg.c"
)(r_reg_setv (reg, "ebx", 0x89ab0000)); 
# 73 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 73 "project/radare2/test/unit/test_reg.c"
exp__ = (
...
"lld" 
# 73 "project/radare2/test/unit/test_reg.c"
".", ("set ebx register value to 0x89ab0000"), (
# 73 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 73 "project/radare2/test/unit/test_reg.c"
)(exp__), (
...
# 73 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 77 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 77 "project/radare2/test/unit/test_reg.c"
act__ = (
# 77 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 77 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 77 "project/radare2/test/unit/test_reg.c"
)(0x89ab0000); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 77 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 77 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 77 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 79 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 79 "project/radare2/test/unit/test_reg.c"
act__ = (
# 79 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 79 "project/radare2/test/unit/test_reg.c"
)(r_reg_setv (reg, "bh", 0xcd)); 
# 79 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 79 "project/radare2/test/unit/test_reg.c"
exp__ = (
...
# 79 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 82 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 82 "project/radare2/test/unit/test_reg.c"
act__ = (
# 82 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 82 "project/radare2/test/unit/test_reg.c"
)(r_reg_setv (reg, "bl", 0xef)); 
# 82 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 82 "project/radare2/test/unit/test_reg.c"
exp__ = (
...
# 82 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 86 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 86 "project/radare2/test/unit/test_reg.c"
act__ = (
# 86 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 86 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 86 "project/radare2/test/unit/test_reg.c"
)(0xcdef); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 86 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 86 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 92 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 92 "project/radare2/test/unit/test_reg.c"
    test_r_reg_get_value_flag(void) {
 RReg *reg;
 RRegItem *r;
 
# 95 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 95 "project/radare2/test/unit/test_reg.c"
     value;

 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 98 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 98 "project/radare2/test/unit/test_reg.c"
_meqstr
# 98 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 98 "project/radare2/test/unit/test_reg.c"
...
# 113 "project/radare2/test/unit/test_reg.c"
 r = r_reg_get (reg, "eflags", R_REG_TYPE_FLG);
 r_reg_set_value (reg, r, 0x00000346);

 value = r_reg_getv (reg, "cf");
 do { 
# 117 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 117 "project/radare2/test/unit/test_reg.c"
act__ = (
# 117 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 117 "project/radare2/test/unit/test_reg.c"
...
# 117 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 120 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 120 "project/radare2/test/unit/test_reg.c"
act__ = (
# 120 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 120 "project/radare2/test/unit/test_reg.c"
...
# 120 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 123 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 123 "project/radare2/test/unit/test_reg.c"
act__ = (
# 123 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 123 "project/radare2/test/unit/test_reg.c"
...
# 123 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 126 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 126 "project/radare2/test/unit/test_reg.c"
act__ = (
# 126 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 126 "project/radare2/test/unit/test_reg.c"
...
0
# 126 "project/radare2/test/unit/test_reg.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 126, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 126, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 value = r_reg_getv (reg, "sf");
 do { 
# 129 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 129 "project/radare2/test/unit/test_reg.c"
act__ = (
# 129 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 129 "project/radare2/test/unit/test_reg.c"
...
# 129 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 132 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 132 "project/radare2/test/unit/test_reg.c"
act__ = (
# 132 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 132 "project/radare2/test/unit/test_reg.c"
...
# 132 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 135 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 135 "project/radare2/test/unit/test_reg.c"
act__ = (
# 135 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 135 "project/radare2/test/unit/test_reg.c"
...
# 141 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 141 "project/radare2/test/unit/test_reg.c"
    test_r_reg_get(void) {
 RReg *reg;
 RRegItem *r;
 ...
 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 146 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 146 "project/radare2/test/unit/test_reg.c"
_meqstr
# 146 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 146 "project/radare2/test/unit/test_reg.c"
...
# 148 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 148 "project/radare2/test/unit/test_reg.c"
     success = r_reg_set_profile_string (reg,
  "gpr	eax		.32	24	0\n		fpu		sf0		.32	304	0\n		xmm		xmm0	.64	160	4");


 do { 
# 152 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 152 "project/radare2/test/unit/test_reg.c"
act__ = (
# 152 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 152 "project/radare2/test/unit/test_reg.c"
...
# 152 "project/radare2/test/unit/test_reg.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (r->name); const char *exp__ = ("sf0"); 
# 155 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 155 "project/radare2/test/unit/test_reg.c"
_meqstr
# 155 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 155 "project/radare2/test/unit/test_reg.c"
...
, 2 > 1 ? 1 : 0), 
# 155 "project/radare2/test/unit/test_reg.c"
"%s: expected %s, got %s.", ("found sf0 as R_REG_TYPE_FPU"), (exp__), (act__)
# 155 "project/radare2/test/unit/test_reg.c" 3 4
)
# 155 "project/radare2/test/unit/test_reg.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 155, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 155, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 156 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 156 "project/radare2/test/unit/test_reg.c"
act__ = (
# 156 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 156 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 156 "project/radare2/test/unit/test_reg.c"
)(R_REG_TYPE_FPU); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 156 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 156 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 156 "project/radare2/test/unit/test_reg.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (r->name); const char *exp__ = ("xmm0"); 
# 159 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 159 "project/radare2/test/unit/test_reg.c"
_meqstr
# 159 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 159 "project/radare2/test/unit/test_reg.c"
...
, 2 > 1 ? 1 : 0), 
# 159 "project/radare2/test/unit/test_reg.c"
"%s: expected %s, got %s.", ("found xmm0 as R_REG_TYPE_XMM"), (exp__), (act__)
# 159 "project/radare2/test/unit/test_reg.c" 3 4
)
# 159 "project/radare2/test/unit/test_reg.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 159, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 159, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 160 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 160 "project/radare2/test/unit/test_reg.c"
act__ = (
# 160 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 160 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 160 "project/radare2/test/unit/test_reg.c"
)(R_REG_TYPE_XMM); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 160 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 160 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 160 "project/radare2/test/unit/test_reg.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (r->name); const char *exp__ = ("xmm0"); 
# 163 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 163 "project/radare2/test/unit/test_reg.c"
_meqstr
# 163 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 163 "project/radare2/test/unit/test_reg.c"
...
, 2 > 1 ? 1 : 0), 
# 163 "project/radare2/test/unit/test_reg.c"
"%s: expected %s, got %s.", ("found xmm0"), (exp__), (act__)
# 163 "project/radare2/test/unit/test_reg.c" 3 4
)
# 163 "project/radare2/test/unit/test_reg.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 163, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 163, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 164 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 164 "project/radare2/test/unit/test_reg.c"
act__ = (
# 164 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 164 "project/radare2/test/unit/test_reg.c"
...
# 170 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 170 "project/radare2/test/unit/test_reg.c"
    test_r_reg_get_list(void) {
 RReg *reg;
 RList *l;
 int mask;
 ...
 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 176 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 176 "project/radare2/test/unit/test_reg.c"
_meqstr
# 176 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 176 "project/radare2/test/unit/test_reg.c"
...
# 178 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 178 "project/radare2/test/unit/test_reg.c"
     success = r_reg_set_profile_string (reg,
  "gpr		eax		.32	24	0\n		fpu			sf0		.32	304	0\n		xmm@fpu		xmm0	.64	160	4");


 do { 
# 182 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 182 "project/radare2/test/unit/test_reg.c"
act__ = (
# 182 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 182 "project/radare2/test/unit/test_reg.c"
...
# 182 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 185 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 185 "project/radare2/test/unit/test_reg.c"
act__ = (
# 185 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 185 "project/radare2/test/unit/test_reg.c"
)((reg->regset[R_REG_TYPE_FPU].maskregstype & mask)); 
# 185 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 185 "project/radare2/test/unit/test_reg.c"
exp__ = (
...
unsigned long long
# 185 "project/radare2/test/unit/test_reg.c"
)(mask); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 185 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 185 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 185 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 189 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 189 "project/radare2/test/unit/test_reg.c"
act__ = (
# 189 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 189 "project/radare2/test/unit/test_reg.c"
...
"lld" 
# 189 "project/radare2/test/unit/test_reg.c"
".", ("sf0 and xmm0 stored as R_REG_TYPE_FPU"), (
# 189 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 189 "project/radare2/test/unit/test_reg.c"
)(exp__), (
...
# 195 "project/radare2/test/unit/test_reg.c" 3 4
_Bool 
# 195 "project/radare2/test/unit/test_reg.c"
    test_r_reg_get_pack(void) {
 RReg *reg;
 RRegItem *r;
 
# 198 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 198 "project/radare2/test/unit/test_reg.c"
     value;

 reg = r_reg_new ();
 do { char _meqstr[5120]; const void *act__ = (reg); 
# 201 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 201 "project/radare2/test/unit/test_reg.c"
_meqstr
# 201 "project/radare2/test/unit/test_reg.c" 3 4
, 
# 201 "project/radare2/test/unit/test_reg.c"
...
# 201 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 214 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 214 "project/radare2/test/unit/test_reg.c"
act__ = (
# 214 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 214 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 214 "project/radare2/test/unit/test_reg.c"
)(0x0011223344556677); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 214 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 214 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 214 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 218 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 218 "project/radare2/test/unit/test_reg.c"
act__ = (
# 218 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 218 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 218 "project/radare2/test/unit/test_reg.c"
)(0x44556677); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 218 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 218 "project/radare2/test/unit/test_reg.c"
_meqstr
...
# 218 "project/radare2/test/unit/test_reg.c"
 ...
 do { 
# 223 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 223 "project/radare2/test/unit/test_reg.c"
act__ = (
# 223 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 223 "project/radare2/test/unit/test_reg.c"
...
# 223 "project/radare2/test/unit/test_reg.c"
 ...
 value = r_reg_get_pack (reg, r, 0, 32);
 do { 
# 230 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long 
# 230 "project/radare2/test/unit/test_reg.c"
act__ = (
# 230 "project/radare2/test/unit/test_reg.c" 3 4
unsigned long long
# 230 "project/radare2/test/unit/test_reg.c"
...
unsigned long long
# 230 "project/radare2/test/unit/test_reg.c"
)(0xccddeeff); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 230 "project/radare2/test/unit/test_reg.c" 3 4
__builtin___snprintf_chk (
# 230 "project/radare2/test/unit/test_reg.c"
_meqstr
...
0
# 230 "project/radare2/test/unit/test_reg.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 230, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 230, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0)
                                              ;
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_set_name"); result = test_r_reg_set_name(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_set_profile_string"); result = test_r_reg_set_profile_string(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_get_value_gpr"); result = test_r_reg_get_value_gpr(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_get_value_flag"); result = test_r_reg_get_value_flag(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_get"); result = test_r_reg_get(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_get_list"); result = test_r_reg_get_list(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_reg_get_pack"); result = test_r_reg_get_pack(); tests_run++; tests_passed += result; } while (0);
