# 0 "project/radare2/test/unit/test_r2pipe.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_r2pipe.c"
...
# 2 "project/radare2/test/unit/test_r2pipe.c" 2
...
# 3 "project/radare2/test/unit/test_r2pipe.c" 2
...
# 4 "project/radare2/test/unit/test_r2pipe.c" 2

static 
# 5 "project/radare2/test/unit/test_r2pipe.c" 3 4
      _Bool 
# 5 "project/radare2/test/unit/test_r2pipe.c"
           test_r2pipe(void) {
 R2Pipe *r = r2pipe_open ("radare2 -q0 -");
 do { if (!(r)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 7, "r2pipe can spawn"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 7, "r2pipe can spawn"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 char *hello = r2pipe_cmd (r, "?e hello world");
 do { char _meqstr[5120]; const char *act__ = (hello); const char *exp__ = ("hello world\n"); 
# 9 "project/radare2/test/unit/test_r2pipe.c" 3 4
__builtin___snprintf_chk (
# 9 "project/radare2/test/unit/test_r2pipe.c"
_meqstr
# 9 "project/radare2/test/unit/test_r2pipe.c" 3 4
, 
# 9 "project/radare2/test/unit/test_r2pipe.c"
...
, 2 > 1 ? 1 : 0), 
# 9 "project/radare2/test/unit/test_r2pipe.c"
"%s: expected %s, got %s.", ("r2pipe hello world"), (exp__), (act__)
# 9 "project/radare2/test/unit/test_r2pipe.c" 3 4
)
# 9 "project/radare2/test/unit/test_r2pipe.c"
...
static 
# 15 "project/radare2/test/unit/test_r2pipe.c" 3 4
      _Bool 
# 15 "project/radare2/test/unit/test_r2pipe.c"
           test_r2pipe_404(void) {
 R2Pipe *r = r2pipe_open ("rodoro2 -q0 -");
 do { if (!(!r)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 17, "r2pipe can spawn"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 17, "r2pipe can spawn"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

static int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r2pipe"); result = test_r2pipe(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r2pipe_404"); result = test_r2pipe_404(); tests_run++; tests_passed += result; } while (0);
