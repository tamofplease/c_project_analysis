# 0 "project/radare2/test/unit/test_tree.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_tree.c"
...
# 2 "project/radare2/test/unit/test_tree.c" 2
...
# 3 "project/radare2/test/unit/test_tree.c" 2
...
# 25 "project/radare2/test/unit/test_tree.c"
 ...
 r_tree_add_node (t, 
# 33 "project/radare2/test/unit/test_tree.c" 3 4
                    ((void *)0)
# 33 "project/radare2/test/unit/test_tree.c"
                        , (void *)1);
 r_tree_bfs(t, &calc);
 do { 
# 35 "project/radare2/test/unit/test_tree.c" 3 4
unsigned long long 
# 35 "project/radare2/test/unit/test_tree.c"
act__ = (
# 35 "project/radare2/test/unit/test_tree.c" 3 4
unsigned long long
# 35 "project/radare2/test/unit/test_tree.c"
...
unsigned long long
# 35 "project/radare2/test/unit/test_tree.c"
)((int)(intptr_t)calc.data); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 35 "project/radare2/test/unit/test_tree.c" 3 4
__builtin___snprintf_chk (
# 35 "project/radare2/test/unit/test_tree.c"
_meqstr
...
# 35 "project/radare2/test/unit/test_tree.c"
 ...
 r_tree_bfs(t, &calc);
 do { 
# 42 "project/radare2/test/unit/test_tree.c" 3 4
unsigned long long 
# 42 "project/radare2/test/unit/test_tree.c"
act__ = (
# 42 "project/radare2/test/unit/test_tree.c" 3 4
unsigned long long
# 42 "project/radare2/test/unit/test_tree.c"
...
# 42 "project/radare2/test/unit/test_tree.c"
 ...
 r_tree_bfs(t, &lister);
 do { RListIter *ita = 
# 59 "project/radare2/test/unit/test_tree.c" 3 4
(
# 59 "project/radare2/test/unit/test_tree.c"
(RList *)lister.data
# 59 "project/radare2/test/unit/test_tree.c" 3 4
)? (
# 59 "project/radare2/test/unit/test_tree.c"
...
unsigned long long
# 59 "project/radare2/test/unit/test_tree.c"
)(e); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 59 "project/radare2/test/unit/test_tree.c" 3 4
__builtin___snprintf_chk (
# 59 "project/radare2/test/unit/test_tree.c"
_meqstr
...
0
# 59 "project/radare2/test/unit/test_tree.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 59, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 59, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } do { if (!((!ita && !ite))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 59, "lists must have same elements"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 59, "lists must have same elements"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 r_list_free(exp1);
 ...
 r_tree_dfs(t, &lister);
 do { RListIter *ita = 
# 73 "project/radare2/test/unit/test_tree.c" 3 4
(
# 73 "project/radare2/test/unit/test_tree.c"
(RList *)lister.data
# 73 "project/radare2/test/unit/test_tree.c" 3 4
)? (
# 73 "project/radare2/test/unit/test_tree.c"
...
0
# 73 "project/radare2/test/unit/test_tree.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 73, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 73, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } do { if (!((!ita && !ite))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 73, "lists must have same elements"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 73, "lists must have same elements"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 r_list_free(exp2);
 r_list_free((RList *)lister.data);


 r_tree_reset(t);
 RTreeNode *root = r_tree_add_node(t, 
# 79 "project/radare2/test/unit/test_tree.c" 3 4
                                     ((void *)0)
# 79 "project/radare2/test/unit/test_tree.c"
                                         , "root");
 ...
 r_tree_dfs(t, &lister);
 do { RListIter *ita = 
# 95 "project/radare2/test/unit/test_tree.c" 3 4
(
# 95 "project/radare2/test/unit/test_tree.c"
(RList *)lister.data
# 95 "project/radare2/test/unit/test_tree.c" 3 4
)? (
# 95 "project/radare2/test/unit/test_tree.c"
...
0
# 95 "project/radare2/test/unit/test_tree.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 95, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 95, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } do { if (!((!ita && !ite))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 95, "lists must have same elements"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 95, "lists must have same elements"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 r_list_free(exp3);
 r_list_free((RList *)lister.data);
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_tree"); result = test_r_tree(); tests_run++; tests_passed += result; } while (0);
