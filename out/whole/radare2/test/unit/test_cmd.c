# 0 "project/radare2/test/unit/test_cmd.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_cmd.c"
...
# 2 "project/radare2/test/unit/test_cmd.c" 2
...
# 5 "project/radare2/test/unit/test_cmd.c" 2


# 6 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 6 "project/radare2/test/unit/test_cmd.c"
    test_parsed_args_noargs(void) {
 RCmdParsedArgs *a = r_cmd_parsed_args_new ("pd", 0, 
# 7 "project/radare2/test/unit/test_cmd.c" 3 4
                                                    ((void *)0)
# 7 "project/radare2/test/unit/test_cmd.c"
                                                        );
 do { char _meqstr[5120]; const char *act__ = (a->argv[0]); const char *exp__ = ("pd"); 
# 8 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 8 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 8 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 8 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 8 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("pd is the command"), (exp__), (act__)
# 8 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 8 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 8, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 8, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("")); 
# 9 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 9 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 9 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 9 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 9 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("empty arguments")), (exp__), (act__)
# 9 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 9 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 9, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 9, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("pd")); 
# 10 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 10 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 10 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 10 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 10 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("only command")), (exp__), (act__)
# 10 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 10 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 10, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 10, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 r_cmd_parsed_args_free (a);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 15 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 15 "project/radare2/test/unit/test_cmd.c"
    test_parsed_args_onearg(void) {
 char *args[] = {"10"};
 RCmdParsedArgs *a = r_cmd_parsed_args_new ("pd", 1, args);
 do { char _meqstr[5120]; const char *act__ = (a->argv[0]); const char *exp__ = ("pd"); 
# 18 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 18 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 18 "project/radare2/test/unit/test_cmd.c"
...
# 18 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 18, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 18, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("10")); 
# 19 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 19 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 19 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 19 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 19 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("one argument")), (exp__), (act__)
# 19 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 19 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 19, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 19, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("pd 10")); 
# 20 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 20 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 20 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 20 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 20 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("cmd + arg")), (exp__), (act__)
# 20 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 20 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 20, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 20, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 r_cmd_parsed_args_free (a);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 25 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 25 "project/radare2/test/unit/test_cmd.c"
    test_parsed_args_args(void) {
 char *args[] = { "d", "0" };
 RCmdParsedArgs *a = r_cmd_parsed_args_new ("wA", 2, args);
 do { char _meqstr[5120]; const char *act__ = (a->argv[0]); const char *exp__ = ("wA"); 
# 28 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 28 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 28 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 28 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 28 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("wA is the command"), (exp__), (act__)
# 28 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 28 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 28, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 28, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("d 0")); 
# 29 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 29 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 29 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 29 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 29 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("two args")), (exp__), (act__)
# 29 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 29 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 29, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 29, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("wA d 0")); 
# 30 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 30 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 30 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 30 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 30 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("cmd + args")), (exp__), (act__)
# 30 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 30 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 r_cmd_parsed_args_free (a);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 35 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 35 "project/radare2/test/unit/test_cmd.c"
    test_parsed_args_nospace(void) {
 char *args[] = { "dr*" };
 RCmdParsedArgs *a = r_cmd_parsed_args_new (".", 1, args);
 a->has_space_after_cmd = 
# 38 "project/radare2/test/unit/test_cmd.c" 3 4
                         0
# 38 "project/radare2/test/unit/test_cmd.c"
                              ;
 do { char _meqstr[5120]; const char *act__ = (a->argv[0]); const char *exp__ = ("."); 
# 39 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 39 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 39 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 39 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 39 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (". is the command"), (exp__), (act__)
# 39 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 39 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 39, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 39, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("dr*")); 
# 40 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 40 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 40 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 40 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 40 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("arg")), (exp__), (act__)
# 40 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 40 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 40, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 40, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = ((".dr*")); 
# 41 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 41 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 41 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 41 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 41 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("cmd + args without space")), (exp__), (act__)
# 41 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 41 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 41, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 41, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 r_cmd_parsed_args_free (a);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 46 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 46 "project/radare2/test/unit/test_cmd.c"
    test_parsed_args_newcmd(void) {
 RCmdParsedArgs *a = r_cmd_parsed_args_newcmd ("pd");
 do { char _meqstr[5120]; const char *act__ = (a->argv[0]); const char *exp__ = ("pd"); 
# 48 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 48 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 48 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 48 "project/radare2/test/unit/test_cmd.c"
...
# 50 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 50 "project/radare2/test/unit/test_cmd.c"
     res = r_cmd_parsed_args_setargs (a, 1, args);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 51, "args should be added"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 51, "args should be added"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { 
# 52 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 52 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 52 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 52 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 52 "project/radare2/test/unit/test_cmd.c"
)(2); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 52 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 52 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 52 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 52, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 52, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("10")); 
# 53 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 53 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 53 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 53 "project/radare2/test/unit/test_cmd.c"
...
# 53 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 53, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 53, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("pd 10")); 
# 54 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 54 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 54 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 54 "project/radare2/test/unit/test_cmd.c"
...
# 54 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 54, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 54, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);

 char *args2[] = { "2", "3" };
 res = r_cmd_parsed_args_setargs (a, 2, args2);
 do { 
# 58 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 58 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 58 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 58 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 58 "project/radare2/test/unit/test_cmd.c"
)(3); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 58 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 58 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 58 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 58, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 58, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("2 3")); 
# 59 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 59 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 59 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 59 "project/radare2/test/unit/test_cmd.c"
...
# 59 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 59, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 59, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("pd 2 3")); 
# 60 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 60 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 60 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 60 "project/radare2/test/unit/test_cmd.c"
...
# 60 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 60, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 60, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
...
# 66 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 66 "project/radare2/test/unit/test_cmd.c"
    test_parsed_args_newargs(void) {
 char *args[] = { "0", "1", "2" };
 RCmdParsedArgs *a = r_cmd_parsed_args_newargs (3, args);
 do { 
# 69 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 69 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 69 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 69 "project/radare2/test/unit/test_cmd.c"
...
0
# 69 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 69, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 69, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char *act2__ = (r_cmd_parsed_args_argstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("0 1 2")); 
# 70 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 70 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 70 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 70 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 70 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", (("args")), (exp__), (act__)
# 70 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 70 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 70, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 70, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 do { char _meqstr[5120]; const char *act__ = (a->argv[1]); const char *exp__ = ("0"); 
# 71 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 71 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 71 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 71 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("first arg"), (exp__), (act__)
# 71 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 71 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 71, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 71, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (a->argv[2]); const char *exp__ = ("1"); 
# 72 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 72 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 72 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 72 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("second arg"), (exp__), (act__)
# 72 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 72 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 
# 74 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 74 "project/radare2/test/unit/test_cmd.c"
     res = r_cmd_parsed_args_setcmd (a, "pd");
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 75, "cmd should be added"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 75, "cmd should be added"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char *act2__ = (r_cmd_parsed_args_execstr (a)); do { char _meqstr[5120]; const char *act__ = (act2__); const char *exp__ = (("pd 0 1 2")); 
# 76 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 76 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 76 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 76 "project/radare2/test/unit/test_cmd.c"
...
# 76 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 76, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 76, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0); free (act2__); } while (0);
 r_cmd_parsed_args_free (a);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}
...
# 85 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 85 "project/radare2/test/unit/test_cmd.c"
    test_cmd_descriptor_argv(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *cd = r_cmd_desc_argv_new (cmd, root, "afl", afl_argv_handler, 
# 88 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                        ((void *)0)
# 88 "project/radare2/test/unit/test_cmd.c"
                                                                            );
 do { char _meqstr[5120]; const void *act__ = (cd); 
# 89 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 89 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 89 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 89 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 89 "project/radare2/test/unit/test_cmd.c"
"%s: expected to not be NULL but it was.", ("cmddesc created")
# 89 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 89 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) != 
...
((void *)0)
# 89 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (cd->name); const char *exp__ = ("afl"); 
# 90 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 90 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 90 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 90 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 90 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("command descriptor name is afl"), (exp__), (act__)
# 90 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 90 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 90, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 90, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 91 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 91 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 91 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 91 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 91 "project/radare2/test/unit/test_cmd.c"
)(R_CMD_DESC_TYPE_ARGV); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 91 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 91 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
"lld" 
# 91 "project/radare2/test/unit/test_cmd.c"
".", ("type of command descriptor is argv"), (
# 91 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 91 "project/radare2/test/unit/test_cmd.c"
)(exp__), (
...
0
# 91 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 91, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 91, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_desc_parent (cd)); const void *exp__ = (root); 
# 92 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 92 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 92 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 92 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 92 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("root parent descriptor"), (exp__), (act__)
# 92 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 92 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 92, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 92, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 93 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 93 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 93 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 93 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 93 "project/radare2/test/unit/test_cmd.c"
)(1); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 93 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 93 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 93 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 93, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 93, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 94 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 94 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 94 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 94 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 94 "project/radare2/test/unit/test_cmd.c"
)(0); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 94 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 94 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 94 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 94, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 94, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_cmd_free (cmd);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 99 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 99 "project/radare2/test/unit/test_cmd.c"
    test_cmd_descriptor_argv_nested(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *af_cd = r_cmd_desc_argv_new (cmd, root, "af", 
# 102 "project/radare2/test/unit/test_cmd.c" 3 4
                                                        ((void *)0)
# 102 "project/radare2/test/unit/test_cmd.c"
                                                            , 
# 102 "project/radare2/test/unit/test_cmd.c" 3 4
                                                              ((void *)0)
# 102 "project/radare2/test/unit/test_cmd.c"
                                                                  );
 r_cmd_desc_argv_new (cmd, root, "af2", 
# 103 "project/radare2/test/unit/test_cmd.c" 3 4
                                       ((void *)0)
# 103 "project/radare2/test/unit/test_cmd.c"
                                           , 
# 103 "project/radare2/test/unit/test_cmd.c" 3 4
                                             ((void *)0)
# 103 "project/radare2/test/unit/test_cmd.c"
...
# 104 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                         ((void *)0)
# 104 "project/radare2/test/unit/test_cmd.c"
                                                                             );
 do { char _meqstr[5120]; const void *act__ = (r_cmd_desc_parent (cd)); const void *exp__ = (af_cd); 
# 105 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 105 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 105 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 105 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 105 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("parent of afl is af"), (exp__), (act__)
# 105 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 105 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 105, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 105, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 106 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 106 "project/radare2/test/unit/test_cmd.c"
act__ = (r_pvector_contains (&af_cd->children, cd)); if (!(act__)) { char _meqstr[5120]; 
# 106 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 106 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 106 "project/radare2/test/unit/test_cmd.c"
"%s: expected true, got false", ("afl is child of af")
# 106 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 106 "project/radare2/test/unit/test_cmd.c"
; do { if (!(
...
0
# 106 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 106, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 106, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 r_cmd_free (cmd);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}
...
# 115 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 115 "project/radare2/test/unit/test_cmd.c"
    test_cmd_descriptor_oldinput(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *cd = r_cmd_desc_oldinput_new (cmd, root, "a", a_oldinput_cb, 
# 118 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                       ((void *)0)
# 118 "project/radare2/test/unit/test_cmd.c"
                                                                           );
 do { char _meqstr[5120]; const void *act__ = (cd); 
# 119 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 119 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 119 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 119 "project/radare2/test/unit/test_cmd.c"
...
((void *)0)
# 119 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 119, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 119, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (cd->name); const char *exp__ = ("a"); 
# 120 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 120 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 120 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 120 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 120 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("command descriptor name is a"), (exp__), (act__)
# 120 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 120 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 120, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 120, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 121 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 121 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 121 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 121 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 121 "project/radare2/test/unit/test_cmd.c"
)(R_CMD_DESC_TYPE_OLDINPUT); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 121 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 121 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
"lld" 
# 121 "project/radare2/test/unit/test_cmd.c"
".", ("type of command descriptor is oldinput"), (
# 121 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 121 "project/radare2/test/unit/test_cmd.c"
)(exp__), (
...
0
# 121 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 121, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 121, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_desc_parent (cd)); const void *exp__ = (root); 
# 122 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 122 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 122 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 122 "project/radare2/test/unit/test_cmd.c"
...
# 122 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 122, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 122, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 123 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 123 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 123 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 123 "project/radare2/test/unit/test_cmd.c"
...
# 136 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 136 "project/radare2/test/unit/test_cmd.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (cd); 
# 145 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 145 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 145 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 145 "project/radare2/test/unit/test_cmd.c"
...
((void *)0)
# 145 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 145, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 145, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (cd->name); const char *exp__ = ("a"); 
# 146 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 146 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 146 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 146 "project/radare2/test/unit/test_cmd.c"
...
# 146 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 146, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 146, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 147 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 147 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 147 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 147 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 147 "project/radare2/test/unit/test_cmd.c"
)(R_CMD_DESC_TYPE_GROUP); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 147 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 147 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
"lld" 
# 147 "project/radare2/test/unit/test_cmd.c"
".", ("type of command descriptor is group"), (
# 147 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 147 "project/radare2/test/unit/test_cmd.c"
)(exp__), (
...
0
# 147 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 147, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 147, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_desc_parent (cd)); const void *exp__ = (root); 
# 148 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 148 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 148 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 148 "project/radare2/test/unit/test_cmd.c"
...
# 148 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 148, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 148, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 149 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 149 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 149 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 149 "project/radare2/test/unit/test_cmd.c"
...
0
# 149 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 149, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 149, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 150 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 150 "project/radare2/test/unit/test_cmd.c"
act__ = (r_cmd_desc_has_handler (cd)); if (!(act__)) { char _meqstr[5120]; 
# 150 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 150 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 150 "project/radare2/test/unit/test_cmd.c"
"%s: expected true, got false", ("a_exec_cb is the handler for this")
# 150 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 150 "project/radare2/test/unit/test_cmd.c"
; do { if (!(
...
0
# 150 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 150, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 150, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);

 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "a")); const void *exp__ = (cd); 
# 152 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 152 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 152 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 152 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 152 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("cd is the desc for `a`"), (exp__), (act__)
# 152 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 152 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 152, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 152, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);

 RCmdParsedArgs *pa = r_cmd_parsed_args_newcmd("a??");
 char *h = r_cmd_get_help (cmd, pa, 
# 155 "project/radare2/test/unit/test_cmd.c" 3 4
                                   0
# 155 "project/radare2/test/unit/test_cmd.c"
                                        );
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = ("Usage: a   # a exec help\n"); 
# 156 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 156 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 156 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 156 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 156 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("detailed help for a is a_exec_help"), (exp__), (act__)
# 156 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 156 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 156, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 156, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_cmd_parsed_args_free (pa);
 free (h);

 pa = r_cmd_parsed_args_newcmd ("a?");
 h = r_cmd_get_help (cmd, pa, 
# 161 "project/radare2/test/unit/test_cmd.c" 3 4
                             0
# 161 "project/radare2/test/unit/test_cmd.c"
                                  );
 const char *exp_h = "Usage: a[b]   # a group help\n"
  "| a  # a exec help\n"
  "| ab # ab help\n";
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = (exp_h); 
# 165 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 165 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 165 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 165 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 165 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("regular help for a is a_group_help"), (exp__), (act__)
# 165 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 165 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 165, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 165, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (h);
...
# 189 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 189 "project/radare2/test/unit/test_cmd.c"
    test_cmd_descriptor_tree(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *a_cd = r_cmd_desc_argv_new (cmd, root, "a", 
# 192 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 192 "project/radare2/test/unit/test_cmd.c"
                                                          , 
# 192 "project/radare2/test/unit/test_cmd.c" 3 4
                                                            ((void *)0)
# 192 "project/radare2/test/unit/test_cmd.c"
...
# 193 "project/radare2/test/unit/test_cmd.c" 3 4
                                                  ((void *)0)
# 193 "project/radare2/test/unit/test_cmd.c"
                                                      );
 r_cmd_desc_oldinput_new (cmd, root, "w", w_handler, 
# 194 "project/radare2/test/unit/test_cmd.c" 3 4
                                                    ((void *)0)
# 194 "project/radare2/test/unit/test_cmd.c"
                                                        );

 void **it_cd;
 
# 197 "project/radare2/test/unit/test_cmd.c" 3 4
for (
# 197 "project/radare2/test/unit/test_cmd.c"
it_cd 
# 197 "project/radare2/test/unit/test_cmd.c" 3 4
= (void **)(&
# 197 "project/radare2/test/unit/test_cmd.c"
...
# 197 "project/radare2/test/unit/test_cmd.c"
  ...
  RCmdDesc *cd = *it_cd;
  do { char _meqstr[5120]; const void *act__ = (r_cmd_desc_parent (cd)); const void *exp__ = (root); 
# 199 "project/radare2/test/unit/test_cmd.c" 3 4
 __builtin___snprintf_chk (
# 199 "project/radare2/test/unit/test_cmd.c"
 _meqstr
# 199 "project/radare2/test/unit/test_cmd.c" 3 4
 , 
# 199 "project/radare2/test/unit/test_cmd.c"
...
# 199 "project/radare2/test/unit/test_cmd.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 199 "project/radare2/test/unit/test_cmd.c"
 "%s: expected %p, got %p.", ("root is the parent"), (exp__), (act__)
# 199 "project/radare2/test/unit/test_cmd.c" 3 4
 )
# 199 "project/radare2/test/unit/test_cmd.c"
 ; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 199, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 199, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 }
...
# 206 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 206 "project/radare2/test/unit/test_cmd.c"
    test_cmd_get_desc(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *a_cd = r_cmd_desc_argv_new (cmd, root, "a", 
# 209 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 209 "project/radare2/test/unit/test_cmd.c"
                                                          , 
# 209 "project/radare2/test/unit/test_cmd.c" 3 4
                                                            ((void *)0)
# 209 "project/radare2/test/unit/test_cmd.c"
...
# 210 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                    ((void *)0)
# 210 "project/radare2/test/unit/test_cmd.c"
                                                                        );
 RCmdDesc *apd_cd = r_cmd_desc_argv_new (cmd, ap_cd, "apd", ap_handler, 
# 211 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                       ((void *)0)
# 211 "project/radare2/test/unit/test_cmd.c"
                                                                           );
 RCmdDesc *ae_cd = r_cmd_desc_oldinput_new (cmd, a_cd, "ae", ae_handler, 
# 212 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                        ((void *)0)
# 212 "project/radare2/test/unit/test_cmd.c"
                                                                            );
 RCmdDesc *aeir_cd = r_cmd_desc_argv_new (cmd, ae_cd, "aeir", aeir_handler, 
# 213 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                           ((void *)0)
# 213 "project/radare2/test/unit/test_cmd.c"
                                                                               );
 RCmdDesc *w_cd = r_cmd_desc_oldinput_new (cmd, root, "w", w_handler, 
# 214 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                     ((void *)0)
# 214 "project/radare2/test/unit/test_cmd.c"
                                                                         );

 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "afl")); 
# 216 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 216 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 216 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 216 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 216 "project/radare2/test/unit/test_cmd.c"
"%s: expected to be NULL but it wasn't.", ("afl does not have any handler")
# 216 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 216 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) == 
...
((void *)0)
# 216 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 216, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 216, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "ap")); const void *exp__ = (ap_cd); 
# 217 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 217 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 217 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 217 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 217 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("ap will be handled by ap"), (exp__), (act__)
# 217 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 217 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 217, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 217, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "wx")); const void *exp__ = (w_cd); 
# 218 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 218 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 218 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 218 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 218 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("wx will be handled by w"), (exp__), (act__)
# 218 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 218 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 218, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 218, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "wao")); const void *exp__ = (w_cd); 
# 219 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 219 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 219 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 219 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 219 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("wao will be handled by w"), (exp__), (act__)
# 219 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 219 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 219, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 219, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "apx")); 
# 220 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 220 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 220 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 220 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 220 "project/radare2/test/unit/test_cmd.c"
"%s: expected to be NULL but it wasn't.", ("apx does not have any handler")
# 220 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 220 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) == 
...
((void *)0)
# 220 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 220, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 220, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "apd")); const void *exp__ = (apd_cd); 
# 221 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 221 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 221 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 221 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 221 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("apd will be handled by apd"), (exp__), (act__)
# 221 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 221 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 221, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 221, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "ae")); const void *exp__ = (ae_cd); 
# 222 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 222 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 222 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 222 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 222 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("ae will be handled by ae"), (exp__), (act__)
# 222 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 222 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 222, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 222, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "aeim")); const void *exp__ = (ae_cd); 
# 223 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 223 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 223 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 223 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 223 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("aeim will be handled by ae"), (exp__), (act__)
# 223 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 223 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 223, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 223, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "aeir")); const void *exp__ = (aeir_cd); 
# 224 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 224 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 224 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 224 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 224 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("aeir will be handled by aeir"), (exp__), (act__)
# 224 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 224 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 224, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 224, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "aei")); const void *exp__ = (ae_cd); 
# 225 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 225 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 225 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 225 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 225 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("aei will be handled by ae"), (exp__), (act__)
# 225 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 225 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 225, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 225, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
...
static RCmdStatus pd_handler(RCore *core, int argc, const char **argv) {
 do { 
# 232 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 232 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 232 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 232 "project/radare2/test/unit/test_cmd.c"
...
"lld" 
# 232 "project/radare2/test/unit/test_cmd.c"
".", ("pd_handler called with 2 arguments (name and arg)"), (
# 232 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 232 "project/radare2/test/unit/test_cmd.c"
)(exp__), (
...
0
# 232 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 232, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 232, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const char *act__ = (argv[0]); const char *exp__ = ("pd"); 
# 233 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 233 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 233 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 233 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 233 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("pd is argv[0]"), (exp__), (act__)
# 233 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 233 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 233, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 233, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (argv[1]); const char *exp__ = ("10"); 
# 234 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 234 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 234 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 234 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 234 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("10 is argv[1]"), (exp__), (act__)
# 234 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 234 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 234, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 234, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 return R_CMD_STATUS_OK;
}
...
static int p_handler(void *user, const char *input) {
 do { char _meqstr[5120]; const char *act__ = (input); const char *exp__ = ("x 10"); 
# 243 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 243 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 243 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 243 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 243 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("input is +1"), (exp__), (act__)
# 243 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 243 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 243, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 243, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 return -1;
}
...
static int wv_handler(void *user, const char *input) {
 do { char _meqstr[5120]; const char *act__ = (input); const char *exp__ = ("8 0xdeadbeef"); 
# 255 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 255 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 255 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 255 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 255 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("input is +2"), (exp__), (act__)
# 255 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 255 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 255, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 255, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 return 1;
}
...
# 263 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 263 "project/radare2/test/unit/test_cmd.c"
    test_cmd_call_desc(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *p_cd = r_cmd_desc_argv_new (cmd, root, "p", 
# 266 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 266 "project/radare2/test/unit/test_cmd.c"
                                                          , 
# 266 "project/radare2/test/unit/test_cmd.c" 3 4
                                                            ((void *)0)
# 266 "project/radare2/test/unit/test_cmd.c"
...
# 267 "project/radare2/test/unit/test_cmd.c" 3 4
                                                  ((void *)0)
# 267 "project/radare2/test/unit/test_cmd.c"
                                                      );
 r_cmd_desc_oldinput_new (cmd, p_cd, "p", p_handler, 
# 268 "project/radare2/test/unit/test_cmd.c" 3 4
                                                    ((void *)0)
# 268 "project/radare2/test/unit/test_cmd.c"
                                                        );
 r_cmd_desc_oldinput_new (cmd, root, "wv", wv_handler, 
# 269 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 269 "project/radare2/test/unit/test_cmd.c"
                                                          );
 r_cmd_desc_oldinput_new (cmd, root, "q", q_handler, 
# 270 "project/radare2/test/unit/test_cmd.c" 3 4
                                                    ((void *)0)
# 270 "project/radare2/test/unit/test_cmd.c"
                                                        );
 ...
 do { 
# 277 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 277 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 277 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 277 "project/radare2/test/unit/test_cmd.c"
)(r_cmd_call_parsed_args (cmd, a)); 
# 277 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 277 "project/radare2/test/unit/test_cmd.c"
exp__ = (
...
unsigned long long
# 277 "project/radare2/test/unit/test_cmd.c"
)(R_CMD_STATUS_OK); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 277 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 277 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 277 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 277, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 277, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_cmd_parsed_args_free (a);

 a = r_cmd_parsed_args_new ("px", 1, px_args);
 do { 
# 281 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 281 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 281 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 281 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 281 "project/radare2/test/unit/test_cmd.c"
)(R_CMD_STATUS_INVALID); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 281 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 281 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 281 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 281, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 281, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_cmd_parsed_args_free (a);

 a = r_cmd_parsed_args_new ("wv8", 1, wv8_args);
 do { 
# 285 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 285 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 285 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 285 "project/radare2/test/unit/test_cmd.c"
...
0
# 285 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 285, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 285, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_cmd_parsed_args_free (a);

 a = r_cmd_parsed_args_new ("quit", 0, 
# 288 "project/radare2/test/unit/test_cmd.c" 3 4
                                      ((void *)0)
# 288 "project/radare2/test/unit/test_cmd.c"
                                          );
 do { 
# 289 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 289 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 289 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 289 "project/radare2/test/unit/test_cmd.c"
...
unsigned long long
# 289 "project/radare2/test/unit/test_cmd.c"
)(R_CMD_STATUS_EXIT); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 289 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 289 "project/radare2/test/unit/test_cmd.c"
_meqstr
...
0
# 289 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 289, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 289, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_cmd_parsed_args_free (a);
...
# 296 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 296 "project/radare2/test/unit/test_cmd.c"
    test_cmd_help(void) {
 const RCmdDescHelp p_help = {
  ...
  .args_str = "",
  .description = 
# 301 "project/radare2/test/unit/test_cmd.c" 3 4
                ((void *)0)
# 301 "project/radare2/test/unit/test_cmd.c"
                    ,
  .examples = 
# 302 "project/radare2/test/unit/test_cmd.c" 3 4
             ((void *)0)
# 302 "project/radare2/test/unit/test_cmd.c"
                 ,
 };
 ...
 const RCmdDescHelp pd_help = {
  .summary = "pd summary",
  .usage = 
# 312 "project/radare2/test/unit/test_cmd.c" 3 4
          ((void *)0)
# 312 "project/radare2/test/unit/test_cmd.c"
              ,
  .args_str = " <num>",
 ...
 const RCmdDescHelp px_help = {
  ...
  .examples = 
# 323 "project/radare2/test/unit/test_cmd.c" 3 4
             ((void *)0)
# 323 "project/radare2/test/unit/test_cmd.c"
                 ,
 };
 ...
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *p_cd = r_cmd_desc_argv_new (cmd, root, "p", 
# 328 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 328 "project/radare2/test/unit/test_cmd.c"
                                                          , &p_help);
...
# 336 "project/radare2/test/unit/test_cmd.c" 3 4
                                  0
# 336 "project/radare2/test/unit/test_cmd.c"
                                       );
 do { char _meqstr[5120]; const void *act__ = (h); 
# 337 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 337 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 337 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 337 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 337 "project/radare2/test/unit/test_cmd.c"
"%s: expected to not be NULL but it was.", ("help is not null")
# 337 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 337 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) != 
...
((void *)0)
# 337 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 337, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 337, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = (p_help_exp); 
# 338 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 338 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 338 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 338 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 338 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("wrong help for p?"), (exp__), (act__)
# 338 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 338 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 338, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 338, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (h);
 r_cmd_parsed_args_free (a);
...
# 344 "project/radare2/test/unit/test_cmd.c" 3 4
                            0
# 344 "project/radare2/test/unit/test_cmd.c"
                                 );
 do { char _meqstr[5120]; const void *act__ = (h); 
# 345 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 345 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 345 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 345 "project/radare2/test/unit/test_cmd.c"
...
((void *)0)
# 345 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 345, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 345, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = (pd_help_exp); 
# 346 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 346 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 346 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 346 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 346 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("wrong help for pd?"), (exp__), (act__)
# 346 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 346 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 346, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 346, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (h);
 r_cmd_parsed_args_free (a);
 ...
 a = r_cmd_parsed_args_newcmd ("pd??");
 h = r_cmd_get_help (cmd, a, 
# 357 "project/radare2/test/unit/test_cmd.c" 3 4
                            0
# 357 "project/radare2/test/unit/test_cmd.c"
                                 );
 do { char _meqstr[5120]; const void *act__ = (h); 
# 358 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 358 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 358 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 358 "project/radare2/test/unit/test_cmd.c"
...
((void *)0)
# 358 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 358, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 358, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = (pd_long_help_exp); 
# 359 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 359 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 359 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 359 "project/radare2/test/unit/test_cmd.c"
...
# 359 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 359, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 359, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (h);
 r_cmd_parsed_args_free (a);
...
# 367 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 367 "project/radare2/test/unit/test_cmd.c"
    test_cmd_group_help(void) {
 const RCmdDescHelp p_help = {
  .summary = "p summary",
  .usage = "p-usage",
  .args_str = "",
  .description = 
# 372 "project/radare2/test/unit/test_cmd.c" 3 4
                ((void *)0)
# 372 "project/radare2/test/unit/test_cmd.c"
                    ,
  .examples = 
# 373 "project/radare2/test/unit/test_cmd.c" 3 4
             ((void *)0)
# 373 "project/radare2/test/unit/test_cmd.c"
                 ,
 };
 ...
 const RCmdDescHelp p_group_help = {
  ...
  .args_str = 
# 379 "project/radare2/test/unit/test_cmd.c" 3 4
             ((void *)0)
# 379 "project/radare2/test/unit/test_cmd.c"
                 ,
  .description = 
# 380 "project/radare2/test/unit/test_cmd.c" 3 4
                ((void *)0)
# 380 "project/radare2/test/unit/test_cmd.c"
                    ,
  .examples = 
# 381 "project/radare2/test/unit/test_cmd.c" 3 4
             ((void *)0)
# 381 "project/radare2/test/unit/test_cmd.c"
                 ,
 };
 ...
 const RCmdDescHelp pd_help = {
  .summary = "pd summary",
  .usage = 
# 386 "project/radare2/test/unit/test_cmd.c" 3 4
          ((void *)0)
# 386 "project/radare2/test/unit/test_cmd.c"
              ,
  .args_str = " <num>",
  .description = "pd long description",
  .examples = 
# 389 "project/radare2/test/unit/test_cmd.c" 3 4
             ((void *)0)
# 389 "project/radare2/test/unit/test_cmd.c"
                 ,
 };
 ...
 RCmdParsedArgs *a = r_cmd_parsed_args_newcmd ("p?");
 char *h = r_cmd_get_help (cmd, a, 
# 401 "project/radare2/test/unit/test_cmd.c" 3 4
                                  0
# 401 "project/radare2/test/unit/test_cmd.c"
                                       );
 do { char _meqstr[5120]; const void *act__ = (h); 
# 402 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 402 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 402 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 402 "project/radare2/test/unit/test_cmd.c"
...
((void *)0)
# 402 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 402, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 402, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = (p_help_exp); 
# 403 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 403 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 403 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 403 "project/radare2/test/unit/test_cmd.c"
...
# 403 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 403, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 403, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (h);
 r_cmd_parsed_args_free (a);
...
# 411 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 411 "project/radare2/test/unit/test_cmd.c"
    test_cmd_oldinput_help(void) {
 r_cons_new ();

 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *p_cd = r_cmd_desc_argv_new (cmd, root, "p", 
# 416 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 416 "project/radare2/test/unit/test_cmd.c"
                                                          , 
# 416 "project/radare2/test/unit/test_cmd.c" 3 4
                                                            ((void *)0)
# 416 "project/radare2/test/unit/test_cmd.c"
 ...
 r_cmd_desc_argv_new (cmd, p_cd, "pd", pd_handler, 
# 417 "project/radare2/test/unit/test_cmd.c" 3 4
                                                  ((void *)0)
# 417 "project/radare2/test/unit/test_cmd.c"
                                                      );
 r_cmd_desc_oldinput_new (cmd, p_cd, "px", px_handler, 
# 418 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 418 "project/radare2/test/unit/test_cmd.c"
                                                          );

 RCmdParsedArgs *a = r_cmd_parsed_args_newcmd ("px?");
 const char *px_help_exp = "Free format px help\n";
 char *h = r_cmd_get_help (cmd, a, 
# 422 "project/radare2/test/unit/test_cmd.c" 3 4
                                  0
# 422 "project/radare2/test/unit/test_cmd.c"
                                       );
 do { char _meqstr[5120]; const void *act__ = (h); 
# 423 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 423 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 423 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 423 "project/radare2/test/unit/test_cmd.c"
...
((void *)0)
# 423 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 423, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 423, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h); const char *exp__ = (px_help_exp); 
# 424 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 424 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 424 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 424 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 424 "project/radare2/test/unit/test_cmd.c"
"%s: expected %s, got %s.", ("wrong help for px?"), (exp__), (act__)
# 424 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 424 "project/radare2/test/unit/test_cmd.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 424, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 424, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (h);
 r_cmd_parsed_args_free (a);
...
# 433 "project/radare2/test/unit/test_cmd.c" 3 4
_Bool 
# 433 "project/radare2/test/unit/test_cmd.c"
    test_remove_cmd(void) {
 RCmd *cmd = r_cmd_new ();
 RCmdDesc *root = r_cmd_get_root (cmd);
 RCmdDesc *x_cd = r_cmd_desc_argv_new (cmd, root, "x", 
# 436 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 436 "project/radare2/test/unit/test_cmd.c"
                                                          , 
# 436 "project/radare2/test/unit/test_cmd.c" 3 4
                                                            ((void *)0)
# 436 "project/radare2/test/unit/test_cmd.c"
 ...
 RCmdDesc *p_cd = r_cmd_desc_argv_new (cmd, root, "p", 
# 437 "project/radare2/test/unit/test_cmd.c" 3 4
                                                      ((void *)0)
# 437 "project/radare2/test/unit/test_cmd.c"
                                                          , 
# 437 "project/radare2/test/unit/test_cmd.c" 3 4
                                                            ((void *)0)
# 437 "project/radare2/test/unit/test_cmd.c"
...
# 438 "project/radare2/test/unit/test_cmd.c" 3 4
                                                                    ((void *)0)
# 438 "project/radare2/test/unit/test_cmd.c"
                                                                        );
 r_cmd_desc_argv_new (cmd, p_cd, "px", pd_handler, 
# 439 "project/radare2/test/unit/test_cmd.c" 3 4
                                                  ((void *)0)
# 439 "project/radare2/test/unit/test_cmd.c"
                                                      );

 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "x")); const void *exp__ = (x_cd); 
# 441 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 441 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 441 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 441 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 441 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("x is found"), (exp__), (act__)
# 441 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 441 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 441, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 441, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "pd")); const void *exp__ = (pd_cd); 
# 442 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 442 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 442 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 442 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 442 "project/radare2/test/unit/test_cmd.c"
"%s: expected %p, got %p.", ("pd is found"), (exp__), (act__)
# 442 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 442 "project/radare2/test/unit/test_cmd.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 442, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 442, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 443 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 443 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 443 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 443 "project/radare2/test/unit/test_cmd.c"
...
"lld" 
# 443 "project/radare2/test/unit/test_cmd.c"
".", ("root has 2 commands as children"), (
# 443 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 443 "project/radare2/test/unit/test_cmd.c"
)(exp__), (
...
0
# 443 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 443, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 443, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_cmd_desc_remove (cmd, p_cd);
 do { 
# 445 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long 
# 445 "project/radare2/test/unit/test_cmd.c"
act__ = (
# 445 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 445 "project/radare2/test/unit/test_cmd.c"
...
"lld" 
# 445 "project/radare2/test/unit/test_cmd.c"
".", ("p was removed, now root has 1 command as children"), (
# 445 "project/radare2/test/unit/test_cmd.c" 3 4
unsigned long long
# 445 "project/radare2/test/unit/test_cmd.c"
)(exp__), (
...
0
# 445 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 445, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 445, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "p")); 
# 446 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 446 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 446 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 446 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 446 "project/radare2/test/unit/test_cmd.c"
"%s: expected to be NULL but it wasn't.", ("p should not be found anymore")
# 446 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 446 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) == 
...
((void *)0)
# 446 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 446, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 446, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "pd")); 
# 447 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 447 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 447 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 447 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 447 "project/radare2/test/unit/test_cmd.c"
"%s: expected to be NULL but it wasn't.", ("pd should not be found anymore")
# 447 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 447 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) == 
...
((void *)0)
# 447 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 447, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 447, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_cmd_get_desc (cmd, "px")); 
# 448 "project/radare2/test/unit/test_cmd.c" 3 4
__builtin___snprintf_chk (
# 448 "project/radare2/test/unit/test_cmd.c"
_meqstr
# 448 "project/radare2/test/unit/test_cmd.c" 3 4
, 
# 448 "project/radare2/test/unit/test_cmd.c"
...
, 2 > 1 ? 1 : 0), 
# 448 "project/radare2/test/unit/test_cmd.c"
"%s: expected to be NULL but it wasn't.", ("px should not be found anymore")
# 448 "project/radare2/test/unit/test_cmd.c" 3 4
)
# 448 "project/radare2/test/unit/test_cmd.c"
; do { if (!((act__) == 
...
((void *)0)
# 448 "project/radare2/test/unit/test_cmd.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 448, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 448, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 void **it_cd;
 
# 451 "project/radare2/test/unit/test_cmd.c" 3 4
for (
# 451 "project/radare2/test/unit/test_cmd.c"
it_cd 
# 451 "project/radare2/test/unit/test_cmd.c" 3 4
= (void **)(&
# 451 "project/radare2/test/unit/test_cmd.c"
...
# 451 "project/radare2/test/unit/test_cmd.c"
                                          {
  RCmdDesc *cd = *it_cd;
  do { char _meqstr[5120]; const void *act__ = (cd); const void *exp__ = (p_cd); 
# 453 "project/radare2/test/unit/test_cmd.c" 3 4
 __builtin___snprintf_chk (
# 453 "project/radare2/test/unit/test_cmd.c"
 _meqstr
# 453 "project/radare2/test/unit/test_cmd.c" 3 4
 , 
# 453 "project/radare2/test/unit/test_cmd.c"
...
# 453 "project/radare2/test/unit/test_cmd.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 453 "project/radare2/test/unit/test_cmd.c"
 "%s: expected not %p, got %p.", ("p should not be found anymore"), (exp__), (act__)
# 453 "project/radare2/test/unit/test_cmd.c" 3 4
 )
# 453 "project/radare2/test/unit/test_cmd.c"
 ; do { if (!((exp__) != (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 453, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 453, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 }
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parsed_args_noargs"); result = test_parsed_args_noargs(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parsed_args_onearg"); result = test_parsed_args_onearg(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parsed_args_args"); result = test_parsed_args_args(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parsed_args_nospace"); result = test_parsed_args_nospace(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parsed_args_newcmd"); result = test_parsed_args_newcmd(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_parsed_args_newargs"); result = test_parsed_args_newargs(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_descriptor_argv"); result = test_cmd_descriptor_argv(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_descriptor_argv_nested"); result = test_cmd_descriptor_argv_nested(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_descriptor_oldinput"); result = test_cmd_descriptor_oldinput(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_descriptor_tree"); result = test_cmd_descriptor_tree(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_descriptor_group"); result = test_cmd_descriptor_group(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_get_desc"); result = test_cmd_get_desc(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_call_desc"); result = test_cmd_call_desc(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_help"); result = test_cmd_help(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_group_help"); result = test_cmd_group_help(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_oldinput_help"); result = test_cmd_oldinput_help(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_remove_cmd"); result = test_remove_cmd(); tests_run++; tests_passed += result; } while (0);
