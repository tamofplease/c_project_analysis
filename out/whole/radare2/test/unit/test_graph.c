# 0 "project/radare2/test/unit/test_graph.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_graph.c"
...
# 2 "project/radare2/test/unit/test_graph.c" 2
...
# 3 "project/radare2/test/unit/test_graph.c" 2
...
#define check_list(act,exp,descr) do { RListIter *ita = r_list_iterator (act); RListIter *ite = r_list_iterator (exp); int diff = 0; while (r_list_iter_next (ita) && r_list_iter_next (ite)) { int a = (int)(size_t)r_list_iter_get (ita); int e = (int)(size_t)r_list_iter_get (ite); if (a != e) { eprintf ("[-][%s] test failed (actual: %d; expected: %d)\n", descr, a, e); diff = 1; } } mu_assert_false (ita || ite || diff, "(one list shorter or different)"); } while (0)
# 24 "project/radare2/test/unit/test_graph.c"
static 
# 24 "project/radare2/test/unit/test_graph.c" 3 4
      _Bool 
# 24 "project/radare2/test/unit/test_graph.c"
           test_legacy_graph(void) {
 RGraph *g = r_graph_new ();

 do { 
# 27 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 27 "project/radare2/test/unit/test_graph.c"
act__ = (
# 27 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 27 "project/radare2/test/unit/test_graph.c"
...
# 27 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 29 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 29 "project/radare2/test/unit/test_graph.c"
act__ = (
# 29 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 29 "project/radare2/test/unit/test_graph.c"
...
# 29 "project/radare2/test/unit/test_graph.c"
 ...
 r_graph_reset (g);
 do { 
# 31 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 31 "project/radare2/test/unit/test_graph.c"
act__ = (
# 31 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 31 "project/radare2/test/unit/test_graph.c"
...
# 31 "project/radare2/test/unit/test_graph.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_graph_get_node (g, gn->idx)); const void *exp__ = (gn); 
# 34 "project/radare2/test/unit/test_graph.c" 3 4
__builtin___snprintf_chk (
# 34 "project/radare2/test/unit/test_graph.c"
_meqstr
# 34 "project/radare2/test/unit/test_graph.c" 3 4
, 
# 34 "project/radare2/test/unit/test_graph.c"
...
, 2 > 1 ? 1 : 0), 
# 34 "project/radare2/test/unit/test_graph.c"
"%s: expected %p, got %p.", ("get_node.1"), (exp__), (act__)
# 34 "project/radare2/test/unit/test_graph.c" 3 4
)
# 34 "project/radare2/test/unit/test_graph.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 34, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 34, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 do { char _meqstr[5120]; const void *act__ = (r_graph_get_node (g, gn2->idx)); const void *exp__ = (gn2); 
# 36 "project/radare2/test/unit/test_graph.c" 3 4
__builtin___snprintf_chk (
# 36 "project/radare2/test/unit/test_graph.c"
_meqstr
# 36 "project/radare2/test/unit/test_graph.c" 3 4
, 
# 36 "project/radare2/test/unit/test_graph.c"
...
, 2 > 1 ? 1 : 0), 
# 36 "project/radare2/test/unit/test_graph.c"
"%s: expected %p, got %p.", ("get_node.2"), (exp__), (act__)
# 36 "project/radare2/test/unit/test_graph.c" 3 4
)
# 36 "project/radare2/test/unit/test_graph.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 36, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 36, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 do { 
# 38 "project/radare2/test/unit/test_graph.c" 3 4
_Bool 
# 38 "project/radare2/test/unit/test_graph.c"
act__ = (r_graph_adjacent (g, gn, gn2)); if (!(act__)) { char _meqstr[5120]; 
# 38 "project/radare2/test/unit/test_graph.c" 3 4
__builtin___snprintf_chk (
# 38 "project/radare2/test/unit/test_graph.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 38 "project/radare2/test/unit/test_graph.c"
"%s: expected true, got false", ("is_adjacent.1")
# 38 "project/radare2/test/unit/test_graph.c" 3 4
)
# 38 "project/radare2/test/unit/test_graph.c"
; do { if (!(
...
# 38 "project/radare2/test/unit/test_graph.c"
 ...
 do { RListIter *ita = 
# 41 "project/radare2/test/unit/test_graph.c" 3 4
(
# 41 "project/radare2/test/unit/test_graph.c"
r_graph_get_neighbours (g, gn)
# 41 "project/radare2/test/unit/test_graph.c" 3 4
)? (
# 41 "project/radare2/test/unit/test_graph.c"
r_graph_get_neighbours (g, gn)
...
fprintf(__stderrp,
# 41 "project/radare2/test/unit/test_graph.c"
"[-][%s] test failed (actual: %d; expected: %d)\n", "get_neighbours.1", a, e
# 41 "project/radare2/test/unit/test_graph.c" 3 4
)
# 41 "project/radare2/test/unit/test_graph.c"
; diff = 1; } } do { 
...
_Bool 
# 41 "project/radare2/test/unit/test_graph.c"
act__ = (ita || ite || diff); if ((act__)) { char _meqstr[5120]; 
# 41 "project/radare2/test/unit/test_graph.c" 3 4
__builtin___snprintf_chk (
# 41 "project/radare2/test/unit/test_graph.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 41 "project/radare2/test/unit/test_graph.c"
"%s: expected false, got true", ("(one list shorter or different)")
# 41 "project/radare2/test/unit/test_graph.c" 3 4
)
# 41 "project/radare2/test/unit/test_graph.c"
; do { if (!(
...
0
# 41 "project/radare2/test/unit/test_graph.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 41, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 41, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0); } while (0);

 RGraphNode *gn3 = r_graph_add_node (g, (void *)3);
 r_graph_add_edge (g, gn, gn3);
 r_list_append (exp_gn_neigh, gn3);
 do { RListIter *ita = 
# 46 "project/radare2/test/unit/test_graph.c" 3 4
(
# 46 "project/radare2/test/unit/test_graph.c"
r_graph_get_neighbours (g, gn)
# 46 "project/radare2/test/unit/test_graph.c" 3 4
)? (
# 46 "project/radare2/test/unit/test_graph.c"
...
# 46 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 68 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 68 "project/radare2/test/unit/test_graph.c"
act__ = (
# 68 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 68 "project/radare2/test/unit/test_graph.c"
...
# 68 "project/radare2/test/unit/test_graph.c"
 ...
 do { RListIter *ita = 
# 69 "project/radare2/test/unit/test_graph.c" 3 4
(
# 69 "project/radare2/test/unit/test_graph.c"
nodes
# 69 "project/radare2/test/unit/test_graph.c" 3 4
)? (
# 69 "project/radare2/test/unit/test_graph.c"
...
# 69 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 88 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 88 "project/radare2/test/unit/test_graph.c"
act__ = (
# 88 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 88 "project/radare2/test/unit/test_graph.c"
...
# 88 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 90 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 90 "project/radare2/test/unit/test_graph.c"
act__ = (
# 90 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 90 "project/radare2/test/unit/test_graph.c"
)(r_graph_adjacent (g, gn8, gn9)); 
# 90 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 90 "project/radare2/test/unit/test_graph.c"
exp__ = (
...
# 90 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 91 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 91 "project/radare2/test/unit/test_graph.c"
act__ = (
# 91 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 91 "project/radare2/test/unit/test_graph.c"
...
# 91 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 93 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 93 "project/radare2/test/unit/test_graph.c"
act__ = (
# 93 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 93 "project/radare2/test/unit/test_graph.c"
...
# 93 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 94 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 94 "project/radare2/test/unit/test_graph.c"
act__ = (
# 94 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 94 "project/radare2/test/unit/test_graph.c"
)(r_graph_adjacent (g, gn9, gn8)); 
# 94 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 94 "project/radare2/test/unit/test_graph.c"
exp__ = (
...
# 94 "project/radare2/test/unit/test_graph.c"
 ...
 r_graph_add_edge (g, gn8, gn9);
 do { 
# 97 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 97 "project/radare2/test/unit/test_graph.c"
act__ = (
# 97 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 97 "project/radare2/test/unit/test_graph.c"
...
# 97 "project/radare2/test/unit/test_graph.c"
 ...
 do { 
# 98 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 98 "project/radare2/test/unit/test_graph.c"
act__ = (
# 98 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 98 "project/radare2/test/unit/test_graph.c"
...
# 98 "project/radare2/test/unit/test_graph.c"
 ...
 do { RListIter *ita = 
# 115 "project/radare2/test/unit/test_graph.c" 3 4
(
# 115 "project/radare2/test/unit/test_graph.c"
(RList *)vis.data
# 115 "project/radare2/test/unit/test_graph.c" 3 4
)? (
# 115 "project/radare2/test/unit/test_graph.c"
...
# 115 "project/radare2/test/unit/test_graph.c"
 ...
 do { RListIter *ita = 
# 122 "project/radare2/test/unit/test_graph.c" 3 4
(
# 122 "project/radare2/test/unit/test_graph.c"
r_graph_innodes (g, gn3)
# 122 "project/radare2/test/unit/test_graph.c" 3 4
)? (
# 122 "project/radare2/test/unit/test_graph.c"
r_graph_innodes (g, gn3)
...
# 122 "project/radare2/test/unit/test_graph.c"
 ...
 do { RListIter *ita = 
# 128 "project/radare2/test/unit/test_graph.c" 3 4
(
# 128 "project/radare2/test/unit/test_graph.c"
r_graph_all_neighbours (g, gn3)
# 128 "project/radare2/test/unit/test_graph.c" 3 4
)? (
# 128 "project/radare2/test/unit/test_graph.c"
r_graph_all_neighbours (g, gn3)
...
0
# 128 "project/radare2/test/unit/test_graph.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 128, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 128, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0); } while (0);
 r_list_free (exp_allnodes);

 r_graph_del_node (g, gn);
 r_graph_del_node (g, gn2);
 do { 
# 133 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 133 "project/radare2/test/unit/test_graph.c"
act__ = (
# 133 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 133 "project/radare2/test/unit/test_graph.c"
...
0
# 133 "project/radare2/test/unit/test_graph.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 133, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 133, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 134 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long 
# 134 "project/radare2/test/unit/test_graph.c"
act__ = (
# 134 "project/radare2/test/unit/test_graph.c" 3 4
unsigned long long
# 134 "project/radare2/test/unit/test_graph.c"
...
static int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_legacy_graph"); result = test_legacy_graph(); tests_run++; tests_passed += result; } while (0);
