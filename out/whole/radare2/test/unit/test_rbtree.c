# 0 "project/radare2/test/unit/test_rbtree.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_rbtree.c"
...
# 2 "project/radare2/test/unit/test_rbtree.c" 2
...
# 3 "project/radare2/test/unit/test_rbtree.c" 2
...
# 4 "project/radare2/test/unit/test_rbtree.c" 2
...
# 5 "project/radare2/test/unit/test_rbtree.c" 2
...
# 6 "project/radare2/test/unit/test_rbtree.c" 2
...
static void freefn(RBNode *a, void *user) {
 free (
# 26 "project/radare2/test/unit/test_rbtree.c" 3 4
      ((
# 26 "project/radare2/test/unit/test_rbtree.c"
      struct Node 
# 26 "project/radare2/test/unit/test_rbtree.c" 3 4
      *)((char *)(__typeof__(((
# 26 "project/radare2/test/unit/test_rbtree.c"
...
static void size(RBNode *a_) {
 int i;
 struct Node *a = 
# 31 "project/radare2/test/unit/test_rbtree.c" 3 4
                 ((
# 31 "project/radare2/test/unit/test_rbtree.c"
                 struct Node 
# 31 "project/radare2/test/unit/test_rbtree.c" 3 4
                 *)((char *)(__typeof__(((
# 31 "project/radare2/test/unit/test_rbtree.c"
...
# 31 "project/radare2/test/unit/test_rbtree.c"
 ...
 for (i = 0; i < 2; i++) {
  if (a_->child[i]) {
   a->size += 
# 35 "project/radare2/test/unit/test_rbtree.c" 3 4
             ((
# 35 "project/radare2/test/unit/test_rbtree.c"
             struct Node 
# 35 "project/radare2/test/unit/test_rbtree.c" 3 4
             *)((char *)(__typeof__(((
# 35 "project/radare2/test/unit/test_rbtree.c"
...
static int cmp(const void *a, const RBNode *b, void *user) {
 return ((const struct Node *)a)->key - 
# 41 "project/radare2/test/unit/test_rbtree.c" 3 4
                                       ((
# 41 "project/radare2/test/unit/test_rbtree.c"
                                       const struct Node 
# 41 "project/radare2/test/unit/test_rbtree.c" 3 4
                                       *)((char *)(__typeof__(((
# 41 "project/radare2/test/unit/test_rbtree.c"
...
static struct Node *make(int key) {
 struct Node *x = 
# 45 "project/radare2/test/unit/test_rbtree.c" 3 4
                 (
# 45 "project/radare2/test/unit/test_rbtree.c"
                 struct Node
# 45 "project/radare2/test/unit/test_rbtree.c" 3 4
                 *)malloc(sizeof(
# 45 "project/radare2/test/unit/test_rbtree.c"
...
static 
# 50 "project/radare2/test/unit/test_rbtree.c" 3 4
      _Bool 
# 50 "project/radare2/test/unit/test_rbtree.c"
           check1(RBNode *x, int dep, int black, 
# 50 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                 _Bool 
# 50 "project/radare2/test/unit/test_rbtree.c"
                                                      leftmost) {
 ...
 if (x) {
  ...
  if (x->red && ((x->child[0] && x->child[0]->red) || (x->child[1] && x->child[1]->red))) {
   ...
   return 
# 56 "project/radare2/test/unit/test_rbtree.c" 3 4
         0
# 56 "project/radare2/test/unit/test_rbtree.c"
              ;
  }
  if ((x->child[0] ? 
# 58 "project/radare2/test/unit/test_rbtree.c" 3 4
                    ((
# 58 "project/radare2/test/unit/test_rbtree.c"
                    struct Node 
# 58 "project/radare2/test/unit/test_rbtree.c" 3 4
                    *)((char *)(__typeof__(((
# 58 "project/radare2/test/unit/test_rbtree.c"
...
# 58 "project/radare2/test/unit/test_rbtree.c"
                                                               ->size : 0) +
    (x->child[1] ? 
# 59 "project/radare2/test/unit/test_rbtree.c" 3 4
                  ((
# 59 "project/radare2/test/unit/test_rbtree.c"
                  struct Node 
# 59 "project/radare2/test/unit/test_rbtree.c" 3 4
                  *)((char *)(__typeof__(((
# 59 "project/radare2/test/unit/test_rbtree.c"
...
# 60 "project/radare2/test/unit/test_rbtree.c" 3 4
   ((
# 60 "project/radare2/test/unit/test_rbtree.c"
   struct Node 
# 60 "project/radare2/test/unit/test_rbtree.c" 3 4
   *)((char *)(__typeof__(((
# 60 "project/radare2/test/unit/test_rbtree.c"
...
# 60 "project/radare2/test/unit/test_rbtree.c"
   ...
   return 
# 62 "project/radare2/test/unit/test_rbtree.c" 3 4
         0
# 62 "project/radare2/test/unit/test_rbtree.c"
              ;
  }
  if (!check1 (x->child[0], dep + 1, black, leftmost)) {
   return 
# 65 "project/radare2/test/unit/test_rbtree.c" 3 4
         0
# 65 "project/radare2/test/unit/test_rbtree.c"
              ;
  }
  if (!check1 (x->child[1], dep + 1, black, 
# 67 "project/radare2/test/unit/test_rbtree.c" 3 4
                                           0
# 67 "project/radare2/test/unit/test_rbtree.c"
                                                )) {
   return 
# 68 "project/radare2/test/unit/test_rbtree.c" 3 4
         0
# 68 "project/radare2/test/unit/test_rbtree.c"
              ;
  }
 } else if (leftmost) {
  black_ = black;
  ...
  return 
# 74 "project/radare2/test/unit/test_rbtree.c" 3 4
        0
# 74 "project/radare2/test/unit/test_rbtree.c"
             ;
 }
 return 
# 76 "project/radare2/test/unit/test_rbtree.c" 3 4
       1
# 76 "project/radare2/test/unit/test_rbtree.c"
           ;
}


# 79 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 79 "project/radare2/test/unit/test_rbtree.c"
    check(RBNode *tree) {
 return check1 (tree, 0, 0, 
# 80 "project/radare2/test/unit/test_rbtree.c" 3 4
                           1
# 80 "project/radare2/test/unit/test_rbtree.c"
                               );
}


# 83 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 83 "project/radare2/test/unit/test_rbtree.c"
    test_r_rbtree_bound_iterate() {
 struct Node key = { 0 };
 RBIter it;
 RBNode *tree = 
# 86 "project/radare2/test/unit/test_rbtree.c" 3 4
               ((void *)0)
# 86 "project/radare2/test/unit/test_rbtree.c"
                   ;
 struct Node *x;
 int i;
 ...
 do { 
# 91 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 91 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 91 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 91 "project/radare2/test/unit/test_rbtree.c"
...
# 95 "project/radare2/test/unit/test_rbtree.c" 3 4
                                         ((void *)0)
# 95 "project/radare2/test/unit/test_rbtree.c"
                                             );
 }
...
# 100 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                    ((void *)0)
# 100 "project/radare2/test/unit/test_rbtree.c"
                                                        );
 i = 0x24;
 
# 102 "project/radare2/test/unit/test_rbtree.c" 3 4
for (; ((&
# 102 "project/radare2/test/unit/test_rbtree.c"
it
# 102 "project/radare2/test/unit/test_rbtree.c" 3 4
)->len) && (
# 102 "project/radare2/test/unit/test_rbtree.c"
...
# 102 "project/radare2/test/unit/test_rbtree.c"
                                             {
  do { 
# 103 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 103 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 103 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 103 "project/radare2/test/unit/test_rbtree.c"
...
# 103 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 103 "project/radare2/test/unit/test_rbtree.c"
 )(i); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 103 "project/radare2/test/unit/test_rbtree.c" 3 4
 __builtin___snprintf_chk (
# 103 "project/radare2/test/unit/test_rbtree.c"
 _meqstr
...
# 103 "project/radare2/test/unit/test_rbtree.c"
 ...
 do { 
# 106 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 106 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 106 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 106 "project/radare2/test/unit/test_rbtree.c"
...
unsigned long long
# 106 "project/radare2/test/unit/test_rbtree.c"
)(98 * 2); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 106 "project/radare2/test/unit/test_rbtree.c" 3 4
__builtin___snprintf_chk (
# 106 "project/radare2/test/unit/test_rbtree.c"
_meqstr
...
# 106 "project/radare2/test/unit/test_rbtree.c"
 ...
 key.key = 0x25;
 it = r_rbtree_lower_bound_forward (tree, &key, cmp, 
# 109 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                    ((void *)0)
# 109 "project/radare2/test/unit/test_rbtree.c"
                                                        );
 i = 0x26;
 
# 111 "project/radare2/test/unit/test_rbtree.c" 3 4
for (; ((&
# 111 "project/radare2/test/unit/test_rbtree.c"
it
# 111 "project/radare2/test/unit/test_rbtree.c" 3 4
)->len) && (
# 111 "project/radare2/test/unit/test_rbtree.c"
...
# 111 "project/radare2/test/unit/test_rbtree.c"
                                             {
  do { 
# 112 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 112 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 112 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 112 "project/radare2/test/unit/test_rbtree.c"
...
# 112 "project/radare2/test/unit/test_rbtree.c"
 ...
 do { 
# 115 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 115 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 115 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 115 "project/radare2/test/unit/test_rbtree.c"
...
# 119 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                     ((void *)0)
# 119 "project/radare2/test/unit/test_rbtree.c"
                                                         );
 i = 0x24;
 
# 121 "project/radare2/test/unit/test_rbtree.c" 3 4
for (; ((&
# 121 "project/radare2/test/unit/test_rbtree.c"
it
# 121 "project/radare2/test/unit/test_rbtree.c" 3 4
)->len) && (
# 121 "project/radare2/test/unit/test_rbtree.c"
...
# 121 "project/radare2/test/unit/test_rbtree.c"
                                                  {
  do { 
# 122 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 122 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 122 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 122 "project/radare2/test/unit/test_rbtree.c"
...
# 122 "project/radare2/test/unit/test_rbtree.c"
 ...
 do { 
# 125 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 125 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 125 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 125 "project/radare2/test/unit/test_rbtree.c"
...
# 125 "project/radare2/test/unit/test_rbtree.c"
 ...
 key.key = 0x25;
 it = r_rbtree_upper_bound_backward (tree, &key, cmp, 
# 128 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                     ((void *)0)
# 128 "project/radare2/test/unit/test_rbtree.c"
                                                         );
 i = 0x24;
 
# 130 "project/radare2/test/unit/test_rbtree.c" 3 4
for (; ((&
# 130 "project/radare2/test/unit/test_rbtree.c"
it
# 130 "project/radare2/test/unit/test_rbtree.c" 3 4
)->len) && (
# 130 "project/radare2/test/unit/test_rbtree.c"
...
# 130 "project/radare2/test/unit/test_rbtree.c"
                                                  {
  do { 
# 131 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 131 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 131 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 131 "project/radare2/test/unit/test_rbtree.c"
...
# 131 "project/radare2/test/unit/test_rbtree.c"
 ...
 do { 
# 134 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 134 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 134 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 134 "project/radare2/test/unit/test_rbtree.c"
...
# 136 "project/radare2/test/unit/test_rbtree.c" 3 4
                             ((void *)0)
# 136 "project/radare2/test/unit/test_rbtree.c"
                                 );
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 140 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 140 "project/radare2/test/unit/test_rbtree.c"
    test_r_rbtree_bound() {
 struct Node key = { 0 };
 RBNode *tree = 
# 142 "project/radare2/test/unit/test_rbtree.c" 3 4
               ((void *)0)
# 142 "project/radare2/test/unit/test_rbtree.c"
                   ;
 struct Node *x;
 int i;
 ...
 for (i = 0; i < 99; i++) {
  x = make (i*2);
  r_rbtree_insert (&tree, x, &x->rb, cmp, 
# 148 "project/radare2/test/unit/test_rbtree.c" 3 4
                                         ((void *)0)
# 148 "project/radare2/test/unit/test_rbtree.c"
                                             );
 }

 key.key = 0x24;
 x = 
# 152 "project/radare2/test/unit/test_rbtree.c" 3 4
    ((
# 152 "project/radare2/test/unit/test_rbtree.c"
    struct Node 
# 152 "project/radare2/test/unit/test_rbtree.c" 3 4
    *)((char *)(__typeof__(((
# 152 "project/radare2/test/unit/test_rbtree.c"
...
# 152 "project/radare2/test/unit/test_rbtree.c"
    r_rbtree_lower_bound (tree, &key, cmp, 
# 152 "project/radare2/test/unit/test_rbtree.c" 3 4
    ((void *)0)
# 152 "project/radare2/test/unit/test_rbtree.c"
    )
...
# 152 "project/radare2/test/unit/test_rbtree.c"
                                                                                ;
 do { 
# 153 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 153 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 153 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 153 "project/radare2/test/unit/test_rbtree.c"
...
unsigned long long
# 153 "project/radare2/test/unit/test_rbtree.c"
)(0x24); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 153 "project/radare2/test/unit/test_rbtree.c" 3 4
__builtin___snprintf_chk (
# 153 "project/radare2/test/unit/test_rbtree.c"
_meqstr
...
0
# 153 "project/radare2/test/unit/test_rbtree.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 153, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 153, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 key.key = 0x25;
 x = 
# 156 "project/radare2/test/unit/test_rbtree.c" 3 4
    ((
# 156 "project/radare2/test/unit/test_rbtree.c"
    struct Node 
# 156 "project/radare2/test/unit/test_rbtree.c" 3 4
    *)((char *)(__typeof__(((
# 156 "project/radare2/test/unit/test_rbtree.c"
...
# 156 "project/radare2/test/unit/test_rbtree.c"
                                                                                ;
 do { 
# 157 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 157 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 157 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 157 "project/radare2/test/unit/test_rbtree.c"
...
unsigned long long
# 157 "project/radare2/test/unit/test_rbtree.c"
)(0x26); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 157 "project/radare2/test/unit/test_rbtree.c" 3 4
__builtin___snprintf_chk (
# 157 "project/radare2/test/unit/test_rbtree.c"
_meqstr
...
# 157 "project/radare2/test/unit/test_rbtree.c"
 ...
 key.key = 0x24;
 x = 
# 160 "project/radare2/test/unit/test_rbtree.c" 3 4
    ((
# 160 "project/radare2/test/unit/test_rbtree.c"
    struct Node 
# 160 "project/radare2/test/unit/test_rbtree.c" 3 4
    *)((char *)(__typeof__(((
# 160 "project/radare2/test/unit/test_rbtree.c"
...
# 160 "project/radare2/test/unit/test_rbtree.c"
    r_rbtree_upper_bound (tree, &key, cmp, 
# 160 "project/radare2/test/unit/test_rbtree.c" 3 4
    ((void *)0)
# 160 "project/radare2/test/unit/test_rbtree.c"
    )
...
# 160 "project/radare2/test/unit/test_rbtree.c"
                                                                                ;
 do { 
# 161 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 161 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 161 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 161 "project/radare2/test/unit/test_rbtree.c"
...
# 161 "project/radare2/test/unit/test_rbtree.c"
 ...
 key.key = 0x25;
 x = 
# 164 "project/radare2/test/unit/test_rbtree.c" 3 4
    ((
# 164 "project/radare2/test/unit/test_rbtree.c"
    struct Node 
# 164 "project/radare2/test/unit/test_rbtree.c" 3 4
    *)((char *)(__typeof__(((
# 164 "project/radare2/test/unit/test_rbtree.c"
...
# 164 "project/radare2/test/unit/test_rbtree.c"
                                                                                ;
 do { 
# 165 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long 
# 165 "project/radare2/test/unit/test_rbtree.c"
act__ = (
# 165 "project/radare2/test/unit/test_rbtree.c" 3 4
unsigned long long
# 165 "project/radare2/test/unit/test_rbtree.c"
...
# 165 "project/radare2/test/unit/test_rbtree.c"
 ...
 r_rbtree_free (tree, freefn, 
# 166 "project/radare2/test/unit/test_rbtree.c" 3 4
                             ((void *)0)
# 166 "project/radare2/test/unit/test_rbtree.c"
                                 );
...
static 
# 171 "project/radare2/test/unit/test_rbtree.c" 3 4
      _Bool 
# 171 "project/radare2/test/unit/test_rbtree.c"
           insert_delete(int *a, int n, RBNodeSum sum) {
 RBNode *tree = 
# 172 "project/radare2/test/unit/test_rbtree.c" 3 4
               ((void *)0)
# 172 "project/radare2/test/unit/test_rbtree.c"
                   ;
 struct Node *x;
 int i, t;
 ...
 for (i = 0; i < n; i++) {
  x = make (a[i]);
  r_rbtree_aug_insert (&tree, x, &x->rb, cmp, 
# 178 "project/radare2/test/unit/test_rbtree.c" 3 4
                                             ((void *)0)
# 178 "project/radare2/test/unit/test_rbtree.c"
                                                 , sum);
  if (sum) {
   do { 
# 180 "project/radare2/test/unit/test_rbtree.c" 3 4
  unsigned long long 
# 180 "project/radare2/test/unit/test_rbtree.c"
  act__ = (
# 180 "project/radare2/test/unit/test_rbtree.c" 3 4
  unsigned long long
# 180 "project/radare2/test/unit/test_rbtree.c"
...
# 180 "project/radare2/test/unit/test_rbtree.c"
  ->size); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 180 "project/radare2/test/unit/test_rbtree.c" 3 4
  __builtin___snprintf_chk (
# 180 "project/radare2/test/unit/test_rbtree.c"
  _meqstr
...
# 180 "project/radare2/test/unit/test_rbtree.c"
   ...
   do { if (!(check (tree))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 181, "shape"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 181, "shape"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  }
 }
 ...
 for (i = 0; i < n; i++) {
  ...
  t = r_rbtree_aug_delete (&tree, &x, cmp, 
# 188 "project/radare2/test/unit/test_rbtree.c" 3 4
                                          ((void *)0)
# 188 "project/radare2/test/unit/test_rbtree.c"
                                              , freefn, 
# 188 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                        ((void *)0)
# 188 "project/radare2/test/unit/test_rbtree.c"
                                                            , sum);
  do { if (!(t)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 189, "delete"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 189, "delete"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  t = r_rbtree_aug_delete (&tree, &x, cmp, 
# 190 "project/radare2/test/unit/test_rbtree.c" 3 4
                                          ((void *)0)
# 190 "project/radare2/test/unit/test_rbtree.c"
                                              , freefn, 
# 190 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                        ((void *)0)
# 190 "project/radare2/test/unit/test_rbtree.c"
                                                            , sum);
  do { if (!(!t)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 191, "delete non-existent"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 191, "delete non-existent"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  if (sum) {
   if (i == n-1)
    do { if (!(tree == 
# 194 "project/radare2/test/unit/test_rbtree.c" 3 4
   ((void *)0)
# 194 "project/radare2/test/unit/test_rbtree.c"
   )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 194, "size"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 194, "size"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
   else
    do { 
# 196 "project/radare2/test/unit/test_rbtree.c" 3 4
   unsigned long long 
# 196 "project/radare2/test/unit/test_rbtree.c"
   act__ = (
# 196 "project/radare2/test/unit/test_rbtree.c" 3 4
   unsigned long long
# 196 "project/radare2/test/unit/test_rbtree.c"
...
# 196 "project/radare2/test/unit/test_rbtree.c"
   ...
   do { if (!(check (tree))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 197, "shape"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 197, "shape"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  }
 }

 r_rbtree_free (tree, freefn, 
# 201 "project/radare2/test/unit/test_rbtree.c" 3 4
                             ((void *)0)
# 201 "project/radare2/test/unit/test_rbtree.c"
                                 );
 return 1;
}


# 205 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 205 "project/radare2/test/unit/test_rbtree.c"
    test_r_rbtree_insert_delete(void) {
#define N 1000
 int a[1000], i;


 random_iota (a, 1000);
 insert_delete (a, 1000, 
# 211 "project/radare2/test/unit/test_rbtree.c" 3 4
                     ((void *)0)
# 211 "project/radare2/test/unit/test_rbtree.c"
                         );
 ...
 for (i = 0; i < 1000; i++)
  a[i] = i;
 insert_delete (a, 1000, 
# 216 "project/radare2/test/unit/test_rbtree.c" 3 4
                     ((void *)0)
# 216 "project/radare2/test/unit/test_rbtree.c"
                         );
 ...
 for (i = 0; i < 1000; i++)
  a[i] = 1000 - 1 - i;
 insert_delete (a, 1000, 
# 221 "project/radare2/test/unit/test_rbtree.c" 3 4
                     ((void *)0)
# 221 "project/radare2/test/unit/test_rbtree.c"
                         );
...
# 227 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 227 "project/radare2/test/unit/test_rbtree.c"
    test_r_rbtree_augmented_insert_delete(void) {
#define N 1000
 int a[1000], i;


 random_iota (a, 1000);
 insert_delete (a, 1000, size);
...
# 249 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 249 "project/radare2/test/unit/test_rbtree.c"
    test_r_rbtree_augmented_insert_delete2(void) {
#define N 1000
 RBNode *tree = 
# 251 "project/radare2/test/unit/test_rbtree.c" 3 4
               ((void *)0)
# 251 "project/radare2/test/unit/test_rbtree.c"
                   ;
 struct Node *x;
 int a[1000], i, t;
 ...
 for (i = 0; i < 1000; i++) {
  x = make (a[i] * 2);
  r_rbtree_aug_insert (&tree, x, &x->rb, cmp, 
# 259 "project/radare2/test/unit/test_rbtree.c" 3 4
                                             ((void *)0)
# 259 "project/radare2/test/unit/test_rbtree.c"
                                                 , size);
 }
 for (i = 0; i < 1000; i++) {
  struct Node x = {.key = a[i] * 2 + 1};
  t = r_rbtree_aug_delete (&tree, &x, cmp, 
# 263 "project/radare2/test/unit/test_rbtree.c" 3 4
                                          ((void *)0)
# 263 "project/radare2/test/unit/test_rbtree.c"
                                              , freefn, 
# 263 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                        ((void *)0)
# 263 "project/radare2/test/unit/test_rbtree.c"
                                                            , size);
  do { if (!(!t)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 264, "delete non-existent"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 264, "delete non-existent"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  do { 
# 265 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 265 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 265 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 265 "project/radare2/test/unit/test_rbtree.c"
...
# 265 "project/radare2/test/unit/test_rbtree.c" 3 4
 0
# 265 "project/radare2/test/unit/test_rbtree.c"
 )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 265, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 265, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
  do { if (!(check (tree))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 266, "shape"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 266, "shape"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

  x.key = a[i] * 2;
  t = r_rbtree_aug_delete (&tree, &x, cmp, 
# 269 "project/radare2/test/unit/test_rbtree.c" 3 4
                                          ((void *)0)
# 269 "project/radare2/test/unit/test_rbtree.c"
                                              , freefn, 
# 269 "project/radare2/test/unit/test_rbtree.c" 3 4
                                                        ((void *)0)
# 269 "project/radare2/test/unit/test_rbtree.c"
                                                            , size);
  do { if (!(t)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 270, "delete"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 270, "delete"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  do { if (!(check (tree))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 271, "shape"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 271, "shape"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 }
...
# 278 "project/radare2/test/unit/test_rbtree.c" 3 4
_Bool 
# 278 "project/radare2/test/unit/test_rbtree.c"
    test_r_rbtree_traverse(void) {
 RBIter it;
 RBNode *tree = 
# 280 "project/radare2/test/unit/test_rbtree.c" 3 4
               ((void *)0)
# 280 "project/radare2/test/unit/test_rbtree.c"
                   ;
 struct Node *x;
 int i;
 ...
 for (i = 0; i < 99; i++) {
  x = make (i);
  r_rbtree_insert (&tree, x, &x->rb, cmp, 
# 286 "project/radare2/test/unit/test_rbtree.c" 3 4
                                         ((void *)0)
# 286 "project/radare2/test/unit/test_rbtree.c"
                                             );
 }
 i = 0;
 
# 289 "project/radare2/test/unit/test_rbtree.c" 3 4
for ((
# 289 "project/radare2/test/unit/test_rbtree.c"
it
# 289 "project/radare2/test/unit/test_rbtree.c" 3 4
) = r_rbtree_first (
# 289 "project/radare2/test/unit/test_rbtree.c"
...
# 289 "project/radare2/test/unit/test_rbtree.c"
                                                {
  do { 
# 290 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 290 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 290 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 290 "project/radare2/test/unit/test_rbtree.c"
...
# 290 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 290 "project/radare2/test/unit/test_rbtree.c"
 )(x->key); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 290 "project/radare2/test/unit/test_rbtree.c" 3 4
 __builtin___snprintf_chk (
# 290 "project/radare2/test/unit/test_rbtree.c"
 _meqstr
...
# 290 "project/radare2/test/unit/test_rbtree.c" 3 4
 0
# 290 "project/radare2/test/unit/test_rbtree.c"
 )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 290, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 290, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
  i++;
 }
 
# 293 "project/radare2/test/unit/test_rbtree.c" 3 4
for ((
# 293 "project/radare2/test/unit/test_rbtree.c"
it
# 293 "project/radare2/test/unit/test_rbtree.c" 3 4
) = r_rbtree_last (
# 293 "project/radare2/test/unit/test_rbtree.c"
...
# 293 "project/radare2/test/unit/test_rbtree.c"
  ...
  i--;
  do { 
# 295 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long 
# 295 "project/radare2/test/unit/test_rbtree.c"
 act__ = (
# 295 "project/radare2/test/unit/test_rbtree.c" 3 4
 unsigned long long
# 295 "project/radare2/test/unit/test_rbtree.c"
...
# 295 "project/radare2/test/unit/test_rbtree.c"
 ...
 r_rbtree_free (tree, freefn, 
# 298 "project/radare2/test/unit/test_rbtree.c" 3 4
                             ((void *)0)
# 298 "project/radare2/test/unit/test_rbtree.c"
                                 );
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_rbtree_bound"); result = test_r_rbtree_bound(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_rbtree_bound_iterate"); result = test_r_rbtree_bound_iterate(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_rbtree_insert_delete"); result = test_r_rbtree_insert_delete(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_rbtree_traverse"); result = test_r_rbtree_traverse(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_rbtree_augmented_insert_delete"); result = test_r_rbtree_augmented_insert_delete(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_rbtree_augmented_insert_delete2"); result = test_r_rbtree_augmented_insert_delete2(); tests_run++; tests_passed += result; } while (0);
