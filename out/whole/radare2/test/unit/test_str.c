# 0 "project/radare2/test/unit/test_str.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/test/unit/test_str.c" 2
...
# 3 "project/radare2/test/unit/test_str.c" 2




# 6 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 6 "project/radare2/test/unit/test_str.c"
    test_r_str_wrap(void) {
 char *s = r_str_wrap ("hello world\nhow are you\n", 5);
 char *res = strdup ("hello \nworld\nhow ar\ne you\n");
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = (res); 
# 9 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 9 "project/radare2/test/unit/test_str.c"
_meqstr
# 9 "project/radare2/test/unit/test_str.c" 3 4
, 
# 9 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 9 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("error, invalid string wrapping"), (exp__), (act__)
# 9 "project/radare2/test/unit/test_str.c" 3 4
)
# 9 "project/radare2/test/unit/test_str.c"
...
# 15 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 15 "project/radare2/test/unit/test_str.c"
    test_r_str_replace_char_once(void) {
 char* str = strdup ("hello world");
 (void) r_str_replace_char_once (str, 'l', 'x');
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("hexlo world"); 
# 18 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_str.c"
_meqstr
# 18 "project/radare2/test/unit/test_str.c" 3 4
, 
# 18 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 18 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("error, replace char once failed"), (exp__), (act__)
# 18 "project/radare2/test/unit/test_str.c" 3 4
)
# 18 "project/radare2/test/unit/test_str.c"
...
# 23 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 23 "project/radare2/test/unit/test_str.c"
    test_r_str_replace(void) {

 char *str = r_str_replace (strdup ("hello world"), "hell", "ihell", 0);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("ihello world"); 
# 26 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 26 "project/radare2/test/unit/test_str.c"
_meqstr
# 26 "project/radare2/test/unit/test_str.c" 3 4
, 
# 26 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 26 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("error, replace char multi failed"), (exp__), (act__)
# 26 "project/radare2/test/unit/test_str.c" 3 4
)
# 26 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 26, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 26, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("ihello world"); 
# 30 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 30 "project/radare2/test/unit/test_str.c"
_meqstr
# 30 "project/radare2/test/unit/test_str.c" 3 4
, 
# 30 "project/radare2/test/unit/test_str.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = (" world"); 
# 34 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 34 "project/radare2/test/unit/test_str.c"
_meqstr
# 34 "project/radare2/test/unit/test_str.c" 3 4
, 
# 34 "project/radare2/test/unit/test_str.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 34, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 34, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("helloello world"); 
# 38 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 38 "project/radare2/test/unit/test_str.c"
_meqstr
# 38 "project/radare2/test/unit/test_str.c" 3 4
, 
# 38 "project/radare2/test/unit/test_str.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 38, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 38, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("helloello helloorld"); 
# 42 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 42 "project/radare2/test/unit/test_str.c"
_meqstr
# 42 "project/radare2/test/unit/test_str.c" 3 4
, 
# 42 "project/radare2/test/unit/test_str.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 42, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 42, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("helloello horld"); 
# 45 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 45 "project/radare2/test/unit/test_str.c"
_meqstr
# 45 "project/radare2/test/unit/test_str.c" 3 4
, 
# 45 "project/radare2/test/unit/test_str.c"
...
# 50 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 50 "project/radare2/test/unit/test_str.c"
    test_r_str_replace_char(void) {
 char* str = strdup ("hello world");
 (void) r_str_replace_char (str, 'l', 'x');
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("hexxo worxd"); 
# 53 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 53 "project/radare2/test/unit/test_str.c"
_meqstr
# 53 "project/radare2/test/unit/test_str.c" 3 4
, 
# 53 "project/radare2/test/unit/test_str.c"
...
# 60 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 60 "project/radare2/test/unit/test_str.c"
    test_r_str_bits64(void) {
 char buf[65];
 (void)r_str_bits64 (buf, 0);
 do { char _meqstr[5120]; const char *act__ = (buf); const char *exp__ = ("00000000"); 
# 63 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 63 "project/radare2/test/unit/test_str.c"
_meqstr
# 63 "project/radare2/test/unit/test_str.c" 3 4
, 
# 63 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 63 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("binary of 0"), (exp__), (act__)
# 63 "project/radare2/test/unit/test_str.c" 3 4
)
# 63 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 63, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 63, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (buf); const char *exp__ = ("00000001"); 
# 65 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 65 "project/radare2/test/unit/test_str.c"
_meqstr
# 65 "project/radare2/test/unit/test_str.c" 3 4
, 
# 65 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 65 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("binary of 1"), (exp__), (act__)
# 65 "project/radare2/test/unit/test_str.c" 3 4
)
# 65 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 65, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 65, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (buf); const char *exp__ = ("00000010"); 
# 67 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 67 "project/radare2/test/unit/test_str.c"
_meqstr
# 67 "project/radare2/test/unit/test_str.c" 3 4
, 
# 67 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 67 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("binary of 2"), (exp__), (act__)
# 67 "project/radare2/test/unit/test_str.c" 3 4
)
# 67 "project/radare2/test/unit/test_str.c"
...
# 73 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 73 "project/radare2/test/unit/test_str.c"
    test_r_str_rwx(void) {
 ...
 do { 
# 81 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 81 "project/radare2/test/unit/test_str.c"
act__ = (
# 81 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 81 "project/radare2/test/unit/test_str.c"
...
# 81 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 82 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 82 "project/radare2/test/unit/test_str.c"
act__ = (
# 82 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 82 "project/radare2/test/unit/test_str.c"
...
# 82 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 83 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 83 "project/radare2/test/unit/test_str.c"
act__ = (
# 83 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 83 "project/radare2/test/unit/test_str.c"
...
# 83 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 84 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 84 "project/radare2/test/unit/test_str.c"
act__ = (
# 84 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 84 "project/radare2/test/unit/test_str.c"
...
# 84 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 85 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 85 "project/radare2/test/unit/test_str.c"
act__ = (
# 85 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 85 "project/radare2/test/unit/test_str.c"
...
# 85 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 86 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 86 "project/radare2/test/unit/test_str.c"
act__ = (
# 86 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 86 "project/radare2/test/unit/test_str.c"
...
# 86 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 87 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 87 "project/radare2/test/unit/test_str.c"
act__ = (
# 87 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 87 "project/radare2/test/unit/test_str.c"
...
# 93 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 93 "project/radare2/test/unit/test_str.c"
    test_r_str_rwx_i(void) {
 ...
 do { char _meqstr[5120]; const char *act__ = (rwx); const char *exp__ = ("rwx"); 
# 99 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 99 "project/radare2/test/unit/test_str.c"
_meqstr
# 99 "project/radare2/test/unit/test_str.c" 3 4
, 
# 99 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 99 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("rwx = 7 mode"), (exp__), (act__)
# 99 "project/radare2/test/unit/test_str.c" 3 4
)
# 99 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 99, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 99, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (rw); const char *exp__ = ("rw-"); 
# 100 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 100 "project/radare2/test/unit/test_str.c"
_meqstr
# 100 "project/radare2/test/unit/test_str.c" 3 4
, 
# 100 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 100 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("rw = 6 mode"), (exp__), (act__)
# 100 "project/radare2/test/unit/test_str.c" 3 4
)
# 100 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 100, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 100, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (rx); const char *exp__ = ("r-x"); 
# 101 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 101 "project/radare2/test/unit/test_str.c"
_meqstr
# 101 "project/radare2/test/unit/test_str.c" 3 4
, 
# 101 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 101 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("rx = 5 mode"), (exp__), (act__)
# 101 "project/radare2/test/unit/test_str.c" 3 4
)
# 101 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 101, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 101, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (invalid_mode); const char *exp__ = ("---"); 
# 102 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 102 "project/radare2/test/unit/test_str.c"
_meqstr
# 102 "project/radare2/test/unit/test_str.c" 3 4
, 
# 102 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 102 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("invalid permissions mode"), (exp__), (act__)
# 102 "project/radare2/test/unit/test_str.c" 3 4
)
# 102 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 102, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 102, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (invalid_mode_neg); const char *exp__ = ("---"); 
# 103 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 103 "project/radare2/test/unit/test_str.c"
_meqstr
# 103 "project/radare2/test/unit/test_str.c" 3 4
, 
# 103 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 103 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("invalid permissions mode (negative value)"), (exp__), (act__)
# 103 "project/radare2/test/unit/test_str.c" 3 4
)
# 103 "project/radare2/test/unit/test_str.c"
...
# 107 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 107 "project/radare2/test/unit/test_str.c"
    test_r_str_trim(void) {

 const char* one = r_str_trim_head_ro ("  hello  ");
 do { char _meqstr[5120]; const char *act__ = (one); const char *exp__ = ("hello  "); 
# 110 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 110 "project/radare2/test/unit/test_str.c"
_meqstr
# 110 "project/radare2/test/unit/test_str.c" 3 4
, 
# 110 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 110 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("one"), (exp__), (act__)
# 110 "project/radare2/test/unit/test_str.c" 3 4
)
# 110 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 110, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 110, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r_str_trim_head (two);
 do { char _meqstr[5120]; const char *act__ = (two); const char *exp__ = ("hello  "); 
# 114 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 114 "project/radare2/test/unit/test_str.c"
_meqstr
# 114 "project/radare2/test/unit/test_str.c" 3 4
, 
# 114 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 114 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("two"), (exp__), (act__)
# 114 "project/radare2/test/unit/test_str.c" 3 4
)
# 114 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 114, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 114, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (two); const char *exp__ = ("hello"); 
# 117 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 117 "project/radare2/test/unit/test_str.c"
_meqstr
# 117 "project/radare2/test/unit/test_str.c" 3 4
, 
# 117 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 117 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("three"), (exp__), (act__)
# 117 "project/radare2/test/unit/test_str.c" 3 4
)
# 117 "project/radare2/test/unit/test_str.c"
...
# 123 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 123 "project/radare2/test/unit/test_str.c"
    test_r_str_bool(void) {
 const char* one = r_str_bool(1);
 const char* zero = r_str_bool(0);
 const char* fifty = r_str_bool(50);
 const char* negative = r_str_bool(-1);
 do { char _meqstr[5120]; const char *act__ = (one); const char *exp__ = ("true"); 
# 128 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 128 "project/radare2/test/unit/test_str.c"
_meqstr
# 128 "project/radare2/test/unit/test_str.c" 3 4
, 
# 128 "project/radare2/test/unit/test_str.c"
...
# 128 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 128, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 128, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (zero); const char *exp__ = ("false"); 
# 129 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 129 "project/radare2/test/unit/test_str.c"
_meqstr
# 129 "project/radare2/test/unit/test_str.c" 3 4
, 
# 129 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 129 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("zero"), (exp__), (act__)
# 129 "project/radare2/test/unit/test_str.c" 3 4
)
# 129 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 129, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 129, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (fifty); const char *exp__ = ("true"); 
# 130 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 130 "project/radare2/test/unit/test_str.c"
_meqstr
# 130 "project/radare2/test/unit/test_str.c" 3 4
, 
# 130 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 130 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("large positive value"), (exp__), (act__)
# 130 "project/radare2/test/unit/test_str.c" 3 4
)
# 130 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 130, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 130, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (negative); const char *exp__ = ("true"); 
# 131 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 131 "project/radare2/test/unit/test_str.c"
_meqstr
# 131 "project/radare2/test/unit/test_str.c" 3 4
, 
# 131 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 131 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("negative number"), (exp__), (act__)
# 131 "project/radare2/test/unit/test_str.c" 3 4
)
# 131 "project/radare2/test/unit/test_str.c"
...
# 135 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 135 "project/radare2/test/unit/test_str.c"
    test_r_str_case(void) {
 char* str1_mixedcase = strdup ("mIxEdCaSe");
 char* str2_mixedcase = strdup ("mIxEdCaSe");
 r_str_case (str1_mixedcase, 
# 138 "project/radare2/test/unit/test_str.c" 3 4
                            1 
# 138 "project/radare2/test/unit/test_str.c"
                                           );
 r_str_case (str2_mixedcase, 
# 139 "project/radare2/test/unit/test_str.c" 3 4
                            0 
# 139 "project/radare2/test/unit/test_str.c"
                                              );
 do { char _meqstr[5120]; const char *act__ = (str1_mixedcase); const char *exp__ = ("MIXEDCASE"); 
# 140 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 140 "project/radare2/test/unit/test_str.c"
_meqstr
# 140 "project/radare2/test/unit/test_str.c" 3 4
, 
# 140 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 140 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("upcase"), (exp__), (act__)
# 140 "project/radare2/test/unit/test_str.c" 3 4
)
# 140 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 140, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 140, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (str2_mixedcase); const char *exp__ = ("mixedcase"); 
# 141 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 141 "project/radare2/test/unit/test_str.c"
_meqstr
# 141 "project/radare2/test/unit/test_str.c" 3 4
, 
# 141 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 141 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("downcase"), (exp__), (act__)
# 141 "project/radare2/test/unit/test_str.c" 3 4
)
# 141 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 141, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 141, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r_str_case (non_alphanum_1, 
# 144 "project/radare2/test/unit/test_str.c" 3 4
                            1 
# 144 "project/radare2/test/unit/test_str.c"
                                           );
 r_str_case (non_alphanum_2, 
# 145 "project/radare2/test/unit/test_str.c" 3 4
                            0 
# 145 "project/radare2/test/unit/test_str.c"
                                              );
 do { char _meqstr[5120]; const char *act__ = (non_alphanum_1); const char *exp__ = ("C00LSTRING!"); 
# 146 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 146 "project/radare2/test/unit/test_str.c"
_meqstr
# 146 "project/radare2/test/unit/test_str.c" 3 4
, 
# 146 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 146 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("upcase, nonalpanum"), (exp__), (act__)
# 146 "project/radare2/test/unit/test_str.c" 3 4
)
# 146 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 146, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 146, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (non_alphanum_2); const char *exp__ = ("c00lstring!"); 
# 147 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 147 "project/radare2/test/unit/test_str.c"
_meqstr
# 147 "project/radare2/test/unit/test_str.c" 3 4
, 
# 147 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 147 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("downcase, nonalpanum"), (exp__), (act__)
# 147 "project/radare2/test/unit/test_str.c" 3 4
)
# 147 "project/radare2/test/unit/test_str.c"
...
# 158 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 158 "project/radare2/test/unit/test_str.c"
    test_r_str_split(void) {
 char* hi = strdup ("hello world");
 int r = r_str_split (hi, ' ');
 do { 
# 161 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 161 "project/radare2/test/unit/test_str.c"
act__ = (
# 161 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 161 "project/radare2/test/unit/test_str.c"
...
# 164 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 164 "project/radare2/test/unit/test_str.c"
_meqstr
# 164 "project/radare2/test/unit/test_str.c" 3 4
, 
# 164 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 164 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("first string in split"), (exp__), (act__)
# 164 "project/radare2/test/unit/test_str.c" 3 4
)
# 164 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 164, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 164, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (world); const char *exp__ = ("world"); 
# 165 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 165 "project/radare2/test/unit/test_str.c"
_meqstr
# 165 "project/radare2/test/unit/test_str.c" 3 4
, 
# 165 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 165 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("second string in split"), (exp__), (act__)
# 165 "project/radare2/test/unit/test_str.c" 3 4
)
# 165 "project/radare2/test/unit/test_str.c"
...
# 170 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 170 "project/radare2/test/unit/test_str.c"
    test_r_str_tokenize(void) {


 char* hi = strdup ("hello world");
 int r = r_str_word_set0 (hi);
 do { 
# 175 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 175 "project/radare2/test/unit/test_str.c"
act__ = (
# 175 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 175 "project/radare2/test/unit/test_str.c"
...
# 175 "project/radare2/test/unit/test_str.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (hello); const char *exp__ = ("hello"); 
# 178 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 178 "project/radare2/test/unit/test_str.c"
_meqstr
# 178 "project/radare2/test/unit/test_str.c" 3 4
, 
# 178 "project/radare2/test/unit/test_str.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 178, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 178, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (world); const char *exp__ = ("world"); 
# 179 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 179 "project/radare2/test/unit/test_str.c"
_meqstr
# 179 "project/radare2/test/unit/test_str.c" 3 4
, 
# 179 "project/radare2/test/unit/test_str.c"
...
# 184 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 184 "project/radare2/test/unit/test_str.c"
    test_r_str_char_count(void) {
 do { 
# 185 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 185 "project/radare2/test/unit/test_str.c"
act__ = (
# 185 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 185 "project/radare2/test/unit/test_str.c"
)(r_str_char_count ("poop", 'p')); 
# 185 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 185 "project/radare2/test/unit/test_str.c"
exp__ = (
...
# 189 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 189 "project/radare2/test/unit/test_str.c"
    test_r_str_word_count(void) {
 do { 
# 190 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 190 "project/radare2/test/unit/test_str.c"
act__ = (
# 190 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 190 "project/radare2/test/unit/test_str.c"
)(r_str_word_count ("let's test\nradare2 \t libraries!")); 
# 190 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 190 "project/radare2/test/unit/test_str.c"
exp__ = (
...
# 195 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 195 "project/radare2/test/unit/test_str.c"
    test_r_str_ichr(void) {
 char* test = "rrrrrradare2";
 char* out = r_str_ichr (test, 'r');
 do { char _meqstr[5120]; const char *act__ = (out); const char *exp__ = ("adare2"); 
# 198 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 198 "project/radare2/test/unit/test_str.c"
_meqstr
# 198 "project/radare2/test/unit/test_str.c" 3 4
, 
# 198 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 198 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("string after the first non-r character in rrrrrradare2"), (exp__), (act__)
# 198 "project/radare2/test/unit/test_str.c" 3 4
)
# 198 "project/radare2/test/unit/test_str.c"
...
# 203 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 203 "project/radare2/test/unit/test_str.c"
    test_r_str_lchr(void) {
 const char* test = "radare2";
 const char* out = r_str_lchr (test, 'r');
 do { char _meqstr[5120]; const char *act__ = (out); const char *exp__ = ("re2"); 
# 206 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 206 "project/radare2/test/unit/test_str.c"
_meqstr
# 206 "project/radare2/test/unit/test_str.c" 3 4
, 
# 206 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 206 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pointer to last r in radare2"), (exp__), (act__)
# 206 "project/radare2/test/unit/test_str.c" 3 4
)
# 206 "project/radare2/test/unit/test_str.c"
...
# 210 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 210 "project/radare2/test/unit/test_str.c"
    test_r_sub_str_lchr(void) {
 const char* test = "raddddare2d";
 const char* out = r_sub_str_lchr (test, 1, 8, 'd');
 do { char _meqstr[5120]; const char *act__ = (out); const char *exp__ = ("dare2d"); 
# 213 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 213 "project/radare2/test/unit/test_str.c"
_meqstr
# 213 "project/radare2/test/unit/test_str.c" 3 4
, 
# 213 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 213 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pointer to last d in range in radddddare2d"), (exp__), (act__)
# 213 "project/radare2/test/unit/test_str.c" 3 4
)
# 213 "project/radare2/test/unit/test_str.c"
...
# 217 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 217 "project/radare2/test/unit/test_str.c"
    test_r_sub_str_rchr(void) {
 const char* test = "raddddare2d";
 const char* out = r_sub_str_rchr (test, 1, 8, 'd');
 do { char _meqstr[5120]; const char *act__ = (out); const char *exp__ = ("ddddare2d"); 
# 220 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 220 "project/radare2/test/unit/test_str.c"
_meqstr
# 220 "project/radare2/test/unit/test_str.c" 3 4
, 
# 220 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 220 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pointer to first d in range in radddddare2d"), (exp__), (act__)
# 220 "project/radare2/test/unit/test_str.c" 3 4
)
# 220 "project/radare2/test/unit/test_str.c"
...
# 224 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 224 "project/radare2/test/unit/test_str.c"
    test_r_str_rchr(void) {
 const char* test = "raddddare2d";
 const char* out = r_str_rchr (test, 
# 226 "project/radare2/test/unit/test_str.c" 3 4
                                    ((void *)0)
# 226 "project/radare2/test/unit/test_str.c"
                                        , '2');
 do { char _meqstr[5120]; const char *act__ = (out); const char *exp__ = ("2d"); 
# 227 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 227 "project/radare2/test/unit/test_str.c"
_meqstr
# 227 "project/radare2/test/unit/test_str.c" 3 4
, 
# 227 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 227 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pointer to last p in range in raddddare2d"), (exp__), (act__)
# 227 "project/radare2/test/unit/test_str.c" 3 4
)
# 227 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 227, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 227, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 out = r_str_rchr (test, 
# 228 "project/radare2/test/unit/test_str.c" 3 4
                        ((void *)0)
# 228 "project/radare2/test/unit/test_str.c"
                            , 'p');
 if (out) {
  do { if (!(0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 230, "non NULL value returned"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 230, "non NULL value returned"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 }
 out = test + 9;
 out = r_str_rchr (test, out, 'd');
 do { char _meqstr[5120]; const char *act__ = (out); const char *exp__ = ("dare2d"); 
# 234 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 234 "project/radare2/test/unit/test_str.c"
_meqstr
# 234 "project/radare2/test/unit/test_str.c" 3 4
, 
# 234 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 234 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pointer to last d in range in raddddare2d"), (exp__), (act__)
# 234 "project/radare2/test/unit/test_str.c" 3 4
)
# 234 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 234, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 234, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 if (out) {
  do { if (!(0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 238, "non NULL value of out"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 238, "non NULL value of out"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 }
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 243 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 243 "project/radare2/test/unit/test_str.c"
    test_r_str_ansi_len(void) {
 int len;

 len = r_str_ansi_len ("\x1b[0m");
 do { 
# 247 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 247 "project/radare2/test/unit/test_str.c"
act__ = (
# 247 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 247 "project/radare2/test/unit/test_str.c"
...
# 247 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 250 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 250 "project/radare2/test/unit/test_str.c"
act__ = (
# 250 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 250 "project/radare2/test/unit/test_str.c"
...
# 250 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 253 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 253 "project/radare2/test/unit/test_str.c"
act__ = (
# 253 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 253 "project/radare2/test/unit/test_str.c"
...
# 253 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 256 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 256 "project/radare2/test/unit/test_str.c"
act__ = (
# 256 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 256 "project/radare2/test/unit/test_str.c"
...
# 256 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 259 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 259 "project/radare2/test/unit/test_str.c"
act__ = (
# 259 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 259 "project/radare2/test/unit/test_str.c"
...
# 259 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 262 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 262 "project/radare2/test/unit/test_str.c"
act__ = (
# 262 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 262 "project/radare2/test/unit/test_str.c"
...
"lld" 
# 262 "project/radare2/test/unit/test_str.c"
".", ("len(ascii + 2 byte utf-8 counted as 2 chars)"), (
# 262 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 262 "project/radare2/test/unit/test_str.c"
)(exp__), (
...
# 262 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 265 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 265 "project/radare2/test/unit/test_str.c"
act__ = (
# 265 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 265 "project/radare2/test/unit/test_str.c"
...
"lld" 
# 265 "project/radare2/test/unit/test_str.c"
".", ("len(ascii + 3 byte utf-8 counted as 3 chars)"), (
# 265 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 265 "project/radare2/test/unit/test_str.c"
)(exp__), (
...
# 265 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 268 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 268 "project/radare2/test/unit/test_str.c"
act__ = (
# 268 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 268 "project/radare2/test/unit/test_str.c"
...
"lld" 
# 268 "project/radare2/test/unit/test_str.c"
".", ("len(ascii + 4 byte utf-8 counted as 4 chars)"), (
# 268 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 268 "project/radare2/test/unit/test_str.c"
)(exp__), (
...
# 273 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 273 "project/radare2/test/unit/test_str.c"
    test_r_str_len_utf8_ansi(void) {
 int len;

 len = r_str_len_utf8_ansi ("radare2");
 do { 
# 277 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 277 "project/radare2/test/unit/test_str.c"
act__ = (
# 277 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 277 "project/radare2/test/unit/test_str.c"
...
# 277 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 280 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 280 "project/radare2/test/unit/test_str.c"
act__ = (
# 280 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 280 "project/radare2/test/unit/test_str.c"
...
# 280 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 283 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 283 "project/radare2/test/unit/test_str.c"
act__ = (
# 283 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 283 "project/radare2/test/unit/test_str.c"
...
# 283 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 286 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 286 "project/radare2/test/unit/test_str.c"
act__ = (
# 286 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 286 "project/radare2/test/unit/test_str.c"
...
0
# 286 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 286, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 286, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 len = r_str_len_utf8_ansi ("r\xc3\xa4""dare2");
 do { 
# 289 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 289 "project/radare2/test/unit/test_str.c"
act__ = (
# 289 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 289 "project/radare2/test/unit/test_str.c"
...
"lld" 
# 289 "project/radare2/test/unit/test_str.c"
".", ("len(ascii + 2 byte utf-8 counted as 1 char)"), (
# 289 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 289 "project/radare2/test/unit/test_str.c"
)(exp__), (
...
# 289 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 292 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 292 "project/radare2/test/unit/test_str.c"
act__ = (
# 292 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 292 "project/radare2/test/unit/test_str.c"
...
"lld" 
# 292 "project/radare2/test/unit/test_str.c"
".", ("len(ascii + 3 byte utf-8 counted as 1 char)"), (
# 292 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 292 "project/radare2/test/unit/test_str.c"
)(exp__), (
...
0
# 292 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 292, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 292, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 len = r_str_len_utf8_ansi ("radar\xf0\x9d\x84\x9e""2");
 do { 
# 295 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 295 "project/radare2/test/unit/test_str.c"
act__ = (
# 295 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 295 "project/radare2/test/unit/test_str.c"
...
"lld" 
# 295 "project/radare2/test/unit/test_str.c"
".", ("len(ascii + 4 byte utf-8 counted as 1 char)"), (
# 295 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 295 "project/radare2/test/unit/test_str.c"
)(exp__), (
...
# 300 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 300 "project/radare2/test/unit/test_str.c"
    test_r_str_utf8_charsize(void) {
 char s[16] = "\x61\xc3\xa1\xe6\x97\xa5\xf0\x9f\x91\x8c\xf0\x9f\x91\x8c\x8c";
 int sz;

 sz = r_str_utf8_charsize (s);
 do { 
# 305 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 305 "project/radare2/test/unit/test_str.c"
act__ = (
# 305 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 305 "project/radare2/test/unit/test_str.c"
...
# 305 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 308 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 308 "project/radare2/test/unit/test_str.c"
act__ = (
# 308 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 308 "project/radare2/test/unit/test_str.c"
...
# 308 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 311 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 311 "project/radare2/test/unit/test_str.c"
act__ = (
# 311 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 311 "project/radare2/test/unit/test_str.c"
...
# 311 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 314 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 314 "project/radare2/test/unit/test_str.c"
act__ = (
# 314 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 314 "project/radare2/test/unit/test_str.c"
...
# 314 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 317 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 317 "project/radare2/test/unit/test_str.c"
act__ = (
# 317 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 317 "project/radare2/test/unit/test_str.c"
...
0
# 317 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 317, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 317, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 322 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 322 "project/radare2/test/unit/test_str.c"
    test_r_str_utf8_charsize_prev(void) {
 char s[16] = "\x61\xc3\xa1\xe6\x97\xa5\xf0\x9f\x91\x8c\xf0\x9f\x91\x8c\x8c";
 int sz;

 sz = r_str_utf8_charsize_last (s);
 do { 
# 327 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 327 "project/radare2/test/unit/test_str.c"
act__ = (
# 327 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 327 "project/radare2/test/unit/test_str.c"
...
0
# 327 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 327, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 327, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 sz = r_str_utf8_charsize_prev (s + 10, 10);
 do { 
# 330 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 330 "project/radare2/test/unit/test_str.c"
act__ = (
# 330 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 330 "project/radare2/test/unit/test_str.c"
...
0
# 330 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 330, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 330, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 sz = r_str_utf8_charsize_prev (s + 6, 6);
 do { 
# 333 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 333 "project/radare2/test/unit/test_str.c"
act__ = (
# 333 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 333 "project/radare2/test/unit/test_str.c"
...
0
# 333 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 333, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 333, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 sz = r_str_utf8_charsize_prev (s + 3, 3);
 do { 
# 336 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 336 "project/radare2/test/unit/test_str.c"
act__ = (
# 336 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 336 "project/radare2/test/unit/test_str.c"
...
0
# 336 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 336, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 336, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 sz = r_str_utf8_charsize_prev (s + 1, 1);
 do { 
# 339 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 339 "project/radare2/test/unit/test_str.c"
act__ = (
# 339 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 339 "project/radare2/test/unit/test_str.c"
...
# 344 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 344 "project/radare2/test/unit/test_str.c"
    test_r_str_sanitize_sdb_key(void) {
 char *s = r_str_sanitize_sdb_key("rada.re2<is>::Cool");
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("rada_re2_is_::Cool"); 
# 346 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 346 "project/radare2/test/unit/test_str.c"
_meqstr
# 346 "project/radare2/test/unit/test_str.c" 3 4
, 
# 346 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 346 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("sanitize"), (exp__), (act__)
# 346 "project/radare2/test/unit/test_str.c" 3 4
)
# 346 "project/radare2/test/unit/test_str.c"
...
# 351 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 351 "project/radare2/test/unit/test_str.c"
    test_r_str_escape_sh(void) {
 char *escaped = r_str_escape_sh ("Hello, \"World\"");
 do { char _meqstr[5120]; const char *act__ = (escaped); const char *exp__ = ("Hello, \\\"World\\\""); 
# 353 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 353 "project/radare2/test/unit/test_str.c"
_meqstr
# 353 "project/radare2/test/unit/test_str.c" 3 4
, 
# 353 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 353 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("escaped \"double quotes\""), (exp__), (act__)
# 353 "project/radare2/test/unit/test_str.c" 3 4
)
# 353 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 353, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 353, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (escaped); const char *exp__ = ("Hello, \\\\World\\\\"); 
# 356 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 356 "project/radare2/test/unit/test_str.c"
_meqstr
# 356 "project/radare2/test/unit/test_str.c" 3 4
, 
# 356 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 356 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("escaped backspace"), (exp__), (act__)
# 356 "project/radare2/test/unit/test_str.c" 3 4
)
# 356 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 356, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 356, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 escaped = r_str_escape_sh ("Hello, $(World)");
 do { char _meqstr[5120]; const char *act__ = (escaped); const char *exp__ = ("Hello, \\$(World)"); 
# 360 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 360 "project/radare2/test/unit/test_str.c"
_meqstr
# 360 "project/radare2/test/unit/test_str.c" 3 4
, 
# 360 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 360 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("escaped $(command)"), (exp__), (act__)
# 360 "project/radare2/test/unit/test_str.c" 3 4
)
# 360 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 360, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 360, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 escaped = r_str_escape_sh ("Hello, `World`");
 do { char _meqstr[5120]; const char *act__ = (escaped); const char *exp__ = ("Hello, \\`World\\`"); 
# 363 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 363 "project/radare2/test/unit/test_str.c"
_meqstr
# 363 "project/radare2/test/unit/test_str.c" 3 4
, 
# 363 "project/radare2/test/unit/test_str.c"
...
# 363 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 363, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 363, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (escaped);
...
# 369 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 369 "project/radare2/test/unit/test_str.c"
    test_r_str_unescape(void) {
 char buf[] = "Hello\\x31World\\n";
 r_str_unescape (buf);
 do { char _meqstr[5120]; const char *act__ = (buf); const char *exp__ = ("Hello1World\n"); 
# 372 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 372 "project/radare2/test/unit/test_str.c"
_meqstr
# 372 "project/radare2/test/unit/test_str.c" 3 4
, 
# 372 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 372 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("unescaped"), (exp__), (act__)
# 372 "project/radare2/test/unit/test_str.c" 3 4
)
# 372 "project/radare2/test/unit/test_str.c"
...
# 376 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 376 "project/radare2/test/unit/test_str.c"
    test_r_str_newf(void) {
 char *a = r_str_newf ("hello");
 do { char _meqstr[5120]; const char *act__ = (a); const char *exp__ = ("hello"); 
# 378 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 378 "project/radare2/test/unit/test_str.c"
_meqstr
# 378 "project/radare2/test/unit/test_str.c" 3 4
, 
# 378 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 378 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("oops"), (exp__), (act__)
# 378 "project/radare2/test/unit/test_str.c" 3 4
)
# 378 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 378, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 378, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (a); const char *exp__ = ("hello/world"); 
# 382 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 382 "project/radare2/test/unit/test_str.c"
_meqstr
# 382 "project/radare2/test/unit/test_str.c" 3 4
, 
# 382 "project/radare2/test/unit/test_str.c"
...
# 382 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 382, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 382, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (a);

 a = r_str_newf ("%s/%s", "hello", "world");
 a = r_str_appendf (a, "..%s/%s", "cow", "low");
 a = r_str_appendf (a, "PWN");
 do { char _meqstr[5120]; const char *act__ = (a); const char *exp__ = ("hello/world..cow/lowPWN"); 
# 388 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 388 "project/radare2/test/unit/test_str.c"
_meqstr
# 388 "project/radare2/test/unit/test_str.c" 3 4
, 
# 388 "project/radare2/test/unit/test_str.c"
...
# 393 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 393 "project/radare2/test/unit/test_str.c"
    test_r_str_constpool(void) {
 RStrConstPool pool;
 
# 395 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 395 "project/radare2/test/unit/test_str.c"
     s = r_str_constpool_init (&pool);
 do { if (!(s)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 396, "pool init success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 396, "pool init success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 const char *a_ref = "deliverance";
 const char *a_pooled = r_str_constpool_get (&pool, a_ref);
 do { char _meqstr[5120]; const void *act__ = (a_pooled); const void *exp__ = (a_ref); 
# 400 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 400 "project/radare2/test/unit/test_str.c"
_meqstr
# 400 "project/radare2/test/unit/test_str.c" 3 4
, 
# 400 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 400 "project/radare2/test/unit/test_str.c"
"%s: expected not %p, got %p.", ("pooled != ref"), (exp__), (act__)
# 400 "project/radare2/test/unit/test_str.c" 3 4
)
# 400 "project/radare2/test/unit/test_str.c"
; do { if (!((exp__) != (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 400, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 400, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const char *act__ = (a_pooled); const char *exp__ = (a_ref); 
# 401 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 401 "project/radare2/test/unit/test_str.c"
_meqstr
# 401 "project/radare2/test/unit/test_str.c" 3 4
, 
# 401 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 401 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pooled == ref (strcmp)"), (exp__), (act__)
# 401 "project/radare2/test/unit/test_str.c" 3 4
)
# 401 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 401, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 401, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const void *act__ = (a_pooled2); const void *exp__ = (a_pooled); 
# 403 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 403 "project/radare2/test/unit/test_str.c"
_meqstr
# 403 "project/radare2/test/unit/test_str.c" 3 4
, 
# 403 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 403 "project/radare2/test/unit/test_str.c"
"%s: expected %p, got %p.", ("same on re-get"), (exp__), (act__)
# 403 "project/radare2/test/unit/test_str.c" 3 4
)
# 403 "project/radare2/test/unit/test_str.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 403, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 403, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 free (a_ref_cpy);
 do { char _meqstr[5120]; const void *act__ = (a_pooled2); const void *exp__ = (a_pooled); 
# 407 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 407 "project/radare2/test/unit/test_str.c"
_meqstr
# 407 "project/radare2/test/unit/test_str.c" 3 4
, 
# 407 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 407 "project/radare2/test/unit/test_str.c"
"%s: expected %p, got %p.", ("same on re-get with different ptr"), (exp__), (act__)
# 407 "project/radare2/test/unit/test_str.c" 3 4
)
# 407 "project/radare2/test/unit/test_str.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 407, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 407, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 do { char _meqstr[5120]; const void *act__ = (b_pooled); const void *exp__ = (b_ref); 
# 411 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 411 "project/radare2/test/unit/test_str.c"
_meqstr
# 411 "project/radare2/test/unit/test_str.c" 3 4
, 
# 411 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 411 "project/radare2/test/unit/test_str.c"
"%s: expected not %p, got %p.", ("pooled != ref (second)"), (exp__), (act__)
# 411 "project/radare2/test/unit/test_str.c" 3 4
)
# 411 "project/radare2/test/unit/test_str.c"
; do { if (!((exp__) != (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 411, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 411, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const char *act__ = (b_pooled); const char *exp__ = (b_ref); 
# 412 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 412 "project/radare2/test/unit/test_str.c"
_meqstr
# 412 "project/radare2/test/unit/test_str.c" 3 4
, 
# 412 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 412 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("pooled == ref (strcmp, second)"), (exp__), (act__)
# 412 "project/radare2/test/unit/test_str.c" 3 4
)
# 412 "project/radare2/test/unit/test_str.c"
...
# 418 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 418 "project/radare2/test/unit/test_str.c"
    test_r_str_format_msvc_argv() {

 const char *a = "CallMePancake";
 char *str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("CallMePancake"); 
# 422 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 422 "project/radare2/test/unit/test_str.c"
_meqstr
# 422 "project/radare2/test/unit/test_str.c" 3 4
, 
# 422 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 422 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("no escaping"), (exp__), (act__)
# 422 "project/radare2/test/unit/test_str.c" 3 4
)
# 422 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 422, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 422, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (str);

 a = "Call Me Pancake";
 str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("\"Call Me Pancake\""); 
# 427 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 427 "project/radare2/test/unit/test_str.c"
_meqstr
# 427 "project/radare2/test/unit/test_str.c" 3 4
, 
# 427 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 427 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("just quoting"), (exp__), (act__)
# 427 "project/radare2/test/unit/test_str.c" 3 4
)
# 427 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 427, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 427, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (str);

 a = "CallMe\"Pancake";
 str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("CallMe\\\"Pancake"); 
# 432 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 432 "project/radare2/test/unit/test_str.c"
_meqstr
# 432 "project/radare2/test/unit/test_str.c" 3 4
, 
# 432 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 432 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("just escaping"), (exp__), (act__)
# 432 "project/radare2/test/unit/test_str.c" 3 4
)
# 432 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 432, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 432, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (str);

 a = "CallMePancake\\";
 str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("CallMePancake\\"); 
# 437 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 437 "project/radare2/test/unit/test_str.c"
_meqstr
# 437 "project/radare2/test/unit/test_str.c" 3 4
, 
# 437 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 437 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("no escaping of backslashes"), (exp__), (act__)
# 437 "project/radare2/test/unit/test_str.c" 3 4
)
# 437 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 437, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 437, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (str);

 a = "Call Me Pancake\\";
 str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("\"Call Me Pancake\\\\\""); 
# 442 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 442 "project/radare2/test/unit/test_str.c"
_meqstr
# 442 "project/radare2/test/unit/test_str.c" 3 4
, 
# 442 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 442 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("escaping of backslashes before closing quote"), (exp__), (act__)
# 442 "project/radare2/test/unit/test_str.c" 3 4
)
# 442 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 442, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 442, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("CallMe\\\\\\\"Pancake"); 
# 447 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 447 "project/radare2/test/unit/test_str.c"
_meqstr
# 447 "project/radare2/test/unit/test_str.c" 3 4
, 
# 447 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 447 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("escaping of backslashes before literal quote"), (exp__), (act__)
# 447 "project/radare2/test/unit/test_str.c" 3 4
)
# 447 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 447, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 447, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 str = r_str_format_msvc_argv (1, &a);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("\"Call Me\\\\\\\"Pancake\""); 
# 452 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 452 "project/radare2/test/unit/test_str.c"
_meqstr
# 452 "project/radare2/test/unit/test_str.c" 3 4
, 
# 452 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 452 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("escaping of backslashes before literal quote in quote"), (exp__), (act__)
# 452 "project/radare2/test/unit/test_str.c" 3 4
)
# 452 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 452, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 452, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (str);

 const char *args[] = { "rm", "-rf", "\\"};
 str = r_str_format_msvc_argv (3, args);
 do { char _meqstr[5120]; const char *act__ = (str); const char *exp__ = ("rm -rf \\"); 
# 457 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 457 "project/radare2/test/unit/test_str.c"
_meqstr
# 457 "project/radare2/test/unit/test_str.c" 3 4
, 
# 457 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 457 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("multiple args"), (exp__), (act__)
# 457 "project/radare2/test/unit/test_str.c" 3 4
)
# 457 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 457, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 457, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (str);
...
# 463 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 463 "project/radare2/test/unit/test_str.c"
    test_r_str_str_xy(void) {
 char *canvas = "Hello World\n"
  "This World is World\n"
  "World is Hello\n";
 int x = 0, y = 0;
 const char *next = r_str_str_xy (canvas, "World", 
# 468 "project/radare2/test/unit/test_str.c" 3 4
                                                  ((void *)0)
# 468 "project/radare2/test/unit/test_str.c"
                                                      , &x, &y);
 do { 
# 469 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 469 "project/radare2/test/unit/test_str.c"
act__ = (
# 469 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 469 "project/radare2/test/unit/test_str.c"
...
# 469 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 470 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 470 "project/radare2/test/unit/test_str.c"
act__ = (
# 470 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 470 "project/radare2/test/unit/test_str.c"
...
# 470 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 472 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 472 "project/radare2/test/unit/test_str.c"
act__ = (
# 472 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 472 "project/radare2/test/unit/test_str.c"
...
0
# 472 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 472, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 472, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 473 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 473 "project/radare2/test/unit/test_str.c"
act__ = (
# 473 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 473 "project/radare2/test/unit/test_str.c"
...
0
# 473 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 473, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 473, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 next = r_str_str_xy (canvas, "World", next, &x, &y);
 do { 
# 475 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 475 "project/radare2/test/unit/test_str.c"
act__ = (
# 475 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 475 "project/radare2/test/unit/test_str.c"
...
# 475 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 476 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 476 "project/radare2/test/unit/test_str.c"
act__ = (
# 476 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 476 "project/radare2/test/unit/test_str.c"
...
# 476 "project/radare2/test/unit/test_str.c"
 ...
 next = r_str_str_xy (canvas, "World", next, &x, &y);
 do { 
# 478 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 478 "project/radare2/test/unit/test_str.c"
act__ = (
# 478 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 478 "project/radare2/test/unit/test_str.c"
...
# 478 "project/radare2/test/unit/test_str.c"
 ...
 do { 
# 479 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long 
# 479 "project/radare2/test/unit/test_str.c"
act__ = (
# 479 "project/radare2/test/unit/test_str.c" 3 4
unsigned long long
# 479 "project/radare2/test/unit/test_str.c"
...
0
# 479 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 479, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 479, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 next = r_str_str_xy (canvas, "World", next, &x, &y);
 do { char _meqstr[5120]; const void *act__ = (next); 
# 481 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 481 "project/radare2/test/unit/test_str.c"
_meqstr
# 481 "project/radare2/test/unit/test_str.c" 3 4
, 
# 481 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 481 "project/radare2/test/unit/test_str.c"
"%s: expected to be NULL but it wasn't.", ("no more occurences")
# 481 "project/radare2/test/unit/test_str.c" 3 4
)
# 481 "project/radare2/test/unit/test_str.c"
; do { if (!((act__) == 
...
((void *)0)
# 481 "project/radare2/test/unit/test_str.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 481, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 481, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 485 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 485 "project/radare2/test/unit/test_str.c"
    test_r_str_encoded_json(void) {
 ...
 do { char _meqstr[5120]; const char *act__ = (array); const char *exp__ = ("084,104,105,115,032,105,115,032,109,121,032,226,032,115,097,109,112,108,101,032,194,169,032,115,116,114,105,110,103,010"); 
# 490 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 490 "project/radare2/test/unit/test_str.c"
_meqstr
# 490 "project/radare2/test/unit/test_str.c" 3 4
, 
# 490 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 490 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("string as array of uchar"), (exp__), (act__)
# 490 "project/radare2/test/unit/test_str.c" 3 4
)
# 490 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 490, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 490, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (hex); const char *exp__ = ("54686973206973206D7920E22073616D706C6520C2A920737472696E670A"); 
# 494 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 494 "project/radare2/test/unit/test_str.c"
_meqstr
# 494 "project/radare2/test/unit/test_str.c" 3 4
, 
# 494 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 494 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("string as hexpairs"), (exp__), (act__)
# 494 "project/radare2/test/unit/test_str.c" 3 4
)
# 494 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 494, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 494, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const char *act__ = (b64); const char *exp__ = ("VGhpcyBpcyBteSDiIHNhbXBsZSDCqSBzdHJpbmcK"); 
# 498 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 498 "project/radare2/test/unit/test_str.c"
_meqstr
# 498 "project/radare2/test/unit/test_str.c" 3 4
, 
# 498 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 498 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("string as base64 encoded"), (exp__), (act__)
# 498 "project/radare2/test/unit/test_str.c" 3 4
)
# 498 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 498, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 498, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free ((void *)b64);

 const char *stripped = r_str_encoded_json (invalidJsonString, len, PJ_ENCODING_STR_STRIP);
 do { char _meqstr[5120]; const char *act__ = (stripped); const char *exp__ = ("This is my  sample © string\\n"); 
# 502 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 502 "project/radare2/test/unit/test_str.c"
_meqstr
# 502 "project/radare2/test/unit/test_str.c" 3 4
, 
# 502 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 502 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("string with bad chars stripped"), (exp__), (act__)
# 502 "project/radare2/test/unit/test_str.c" 3 4
)
# 502 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 502, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 502, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free ((void *)stripped);

 const char *none = r_str_encoded_json (invalidJsonString, len, PJ_ENCODING_STR_DEFAULT);
 do { char _meqstr[5120]; const char *act__ = (none); const char *exp__ = ("This is my \\xe2 sample © string\\n"); 
# 506 "project/radare2/test/unit/test_str.c" 3 4
__builtin___snprintf_chk (
# 506 "project/radare2/test/unit/test_str.c"
_meqstr
# 506 "project/radare2/test/unit/test_str.c" 3 4
, 
# 506 "project/radare2/test/unit/test_str.c"
...
, 2 > 1 ? 1 : 0), 
# 506 "project/radare2/test/unit/test_str.c"
"%s: expected %s, got %s.", ("default encoding"), (exp__), (act__)
# 506 "project/radare2/test/unit/test_str.c" 3 4
)
# 506 "project/radare2/test/unit/test_str.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 506, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 506, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free ((void *)none);
...
# 512 "project/radare2/test/unit/test_str.c" 3 4
_Bool 
# 512 "project/radare2/test/unit/test_str.c"
    all_tests () {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_wrap"); result = test_r_str_wrap(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_newf"); result = test_r_str_newf(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_replace_char_once"); result = test_r_str_replace_char_once(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_replace_char"); result = test_r_str_replace_char(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_replace"); result = test_r_str_replace(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_bits64"); result = test_r_str_bits64(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_rwx"); result = test_r_str_rwx(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_rwx_i"); result = test_r_str_rwx_i(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_bool"); result = test_r_str_bool(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_trim"); result = test_r_str_trim(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_case"); result = test_r_str_case(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_split"); result = test_r_str_split(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_tokenize"); result = test_r_str_tokenize(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_char_count"); result = test_r_str_char_count(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_word_count"); result = test_r_str_word_count(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_ichr"); result = test_r_str_ichr(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_lchr"); result = test_r_str_lchr(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_sub_str_lchr"); result = test_r_sub_str_lchr(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_sub_str_rchr"); result = test_r_sub_str_rchr(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_rchr"); result = test_r_str_rchr(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_ansi_len"); result = test_r_str_ansi_len(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_len_utf8_ansi"); result = test_r_str_len_utf8_ansi(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_utf8_charsize"); result = test_r_str_utf8_charsize(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_utf8_charsize_prev"); result = test_r_str_utf8_charsize_prev(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_sanitize_sdb_key"); result = test_r_str_sanitize_sdb_key(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_escape_sh"); result = test_r_str_escape_sh(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_unescape"); result = test_r_str_unescape(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_constpool"); result = test_r_str_constpool(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_format_msvc_argv"); result = test_r_str_format_msvc_argv(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_str_xy"); result = test_r_str_str_xy(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_str_encoded_json"); result = test_r_str_encoded_json(); tests_run++; tests_passed += result; } while (0);
