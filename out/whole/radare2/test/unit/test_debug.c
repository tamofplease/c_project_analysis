# 0 "project/radare2/test/unit/test_debug.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_debug.c"
...
# 2 "project/radare2/test/unit/test_debug.c" 2
...
# 3 "project/radare2/test/unit/test_debug.c" 2
# 12 "project/radare2/test/unit/test_debug.c"

# 12 "project/radare2/test/unit/test_debug.c" 3 4
_Bool 
# 12 "project/radare2/test/unit/test_debug.c"
    test_r_debug_use(void) {
 RDebug *dbg;
 
# 14 "project/radare2/test/unit/test_debug.c" 3 4
_Bool 
# 14 "project/radare2/test/unit/test_debug.c"
     res;

 dbg = r_debug_new (
# 16 "project/radare2/test/unit/test_debug.c" 3 4
                   1
# 16 "project/radare2/test/unit/test_debug.c"
                       );
 do { char _meqstr[5120]; const void *act__ = (dbg); 
# 17 "project/radare2/test/unit/test_debug.c" 3 4
__builtin___snprintf_chk (
# 17 "project/radare2/test/unit/test_debug.c"
_meqstr
# 17 "project/radare2/test/unit/test_debug.c" 3 4
, 
# 17 "project/radare2/test/unit/test_debug.c"
...
, 2 > 1 ? 1 : 0), 
# 17 "project/radare2/test/unit/test_debug.c"
"%s: expected to not be NULL but it was.", ("r_debug_new () failed")
# 17 "project/radare2/test/unit/test_debug.c" 3 4
)
# 17 "project/radare2/test/unit/test_debug.c"
; do { if (!((act__) != 
...
# 17 "project/radare2/test/unit/test_debug.c"
 ...
 do { 
# 20 "project/radare2/test/unit/test_debug.c" 3 4
unsigned long long 
# 20 "project/radare2/test/unit/test_debug.c"
act__ = (
# 20 "project/radare2/test/unit/test_debug.c" 3 4
unsigned long long
# 20 "project/radare2/test/unit/test_debug.c"
...
0
# 20 "project/radare2/test/unit/test_debug.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 20, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 20, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
...
# 26 "project/radare2/test/unit/test_debug.c" 3 4
_Bool 
# 26 "project/radare2/test/unit/test_debug.c"
    test_r_debug_reg_offset(void) {
# 52 "project/radare2/test/unit/test_debug.c"
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_debug_use"); result = test_r_debug_use(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_debug_reg_offset"); result = test_r_debug_reg_offset(); tests_run++; tests_passed += result; } while (0);
