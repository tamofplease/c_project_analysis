# 0 "project/radare2/test/unit/test_debruijn.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/test/unit/test_debruijn.c" 2
...
# 3 "project/radare2/test/unit/test_debruijn.c" 2


# 4 "project/radare2/test/unit/test_debruijn.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_debruijn.c"
    test_r_debruijn_pattern(void) {
 char* pattern = r_debruijn_pattern (256, 0, 
# 5 "project/radare2/test/unit/test_debruijn.c" 3 4
                                            ((void *)0) 
# 5 "project/radare2/test/unit/test_debruijn.c"
                                                                    );
 do { 
# 6 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long 
# 6 "project/radare2/test/unit/test_debruijn.c"
act__ = (
# 6 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long
# 6 "project/radare2/test/unit/test_debruijn.c"
...
unsigned long long
# 6 "project/radare2/test/unit/test_debruijn.c"
)(256); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 6 "project/radare2/test/unit/test_debruijn.c" 3 4
__builtin___snprintf_chk (
# 6 "project/radare2/test/unit/test_debruijn.c"
_meqstr
...
# 6 "project/radare2/test/unit/test_debruijn.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (pattern); const char *exp__ = (""); 
# 7 "project/radare2/test/unit/test_debruijn.c" 3 4
__builtin___snprintf_chk (
# 7 "project/radare2/test/unit/test_debruijn.c"
_meqstr
# 7 "project/radare2/test/unit/test_debruijn.c" 3 4
, 
# 7 "project/radare2/test/unit/test_debruijn.c"
...
, 2 > 1 ? 1 : 0), 
# 7 "project/radare2/test/unit/test_debruijn.c"
"%s: expected %s, got %s.", ("pattern of 256 length"), (exp__), (act__)
# 7 "project/radare2/test/unit/test_debruijn.c" 3 4
)
# 7 "project/radare2/test/unit/test_debruijn.c"
...
# 12 "project/radare2/test/unit/test_debruijn.c" 3 4
_Bool 
# 12 "project/radare2/test/unit/test_debruijn.c"
    test_r_debruijn_offset(void) {

 
# 14 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long 
# 14 "project/radare2/test/unit/test_debruijn.c"
     offset = 0x41417641;
 do { 
# 15 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long 
# 15 "project/radare2/test/unit/test_debruijn.c"
act__ = (
# 15 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long
# 15 "project/radare2/test/unit/test_debruijn.c"
)(r_debruijn_offset (offset, 
# 15 "project/radare2/test/unit/test_debruijn.c" 3 4
0 
# 15 "project/radare2/test/unit/test_debruijn.c"
)); 
...
unsigned long long
# 15 "project/radare2/test/unit/test_debruijn.c"
)(140); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 15 "project/radare2/test/unit/test_debruijn.c" 3 4
__builtin___snprintf_chk (
# 15 "project/radare2/test/unit/test_debruijn.c"
_meqstr
...
# 15 "project/radare2/test/unit/test_debruijn.c"
 ...
 offset = 0x41764141;
 do { 
# 17 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long 
# 17 "project/radare2/test/unit/test_debruijn.c"
act__ = (
# 17 "project/radare2/test/unit/test_debruijn.c" 3 4
unsigned long long
# 17 "project/radare2/test/unit/test_debruijn.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_debruijn_pattern"); result = test_r_debruijn_pattern(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_debruijn_offset"); result = test_r_debruijn_offset(); tests_run++; tests_passed += result; } while (0);
