# 0 "project/radare2/test/unit/test_hex.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_hex.c"
...
# 2 "project/radare2/test/unit/test_hex.c" 2
...
# 3 "project/radare2/test/unit/test_hex.c" 2


# 4 "project/radare2/test/unit/test_hex.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_hex.c"
    test_r_hex_from_code() {
 const char *s;
 char *r;
 s = "char *s = \"ABCD\";";
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 9 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 9 "project/radare2/test/unit/test_hex.c"
_meqstr
# 9 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 9 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 9 "project/radare2/test/unit/test_hex.c"
"%s: expected %s, got %s.", (s), (exp__), (act__)
# 9 "project/radare2/test/unit/test_hex.c" 3 4
)
# 9 "project/radare2/test/unit/test_hex.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 9, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 9, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 13 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 13 "project/radare2/test/unit/test_hex.c"
_meqstr
# 13 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 13 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 13, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 13, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 17 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 17 "project/radare2/test/unit/test_hex.c"
_meqstr
# 17 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 17 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 17, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 17, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 21 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 21 "project/radare2/test/unit/test_hex.c"
_meqstr
# 21 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 21 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 21, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 21, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 s = "char *s = \"\n\r\033\"";
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("0a0d1b"); 
# 25 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 25 "project/radare2/test/unit/test_hex.c"
_meqstr
# 25 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 25 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 25, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 25, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 29 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 29 "project/radare2/test/unit/test_hex.c"
_meqstr
# 29 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 29 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 29, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 29, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 33 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 33 "project/radare2/test/unit/test_hex.c"
_meqstr
# 33 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 33 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 33, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 33, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 37 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 37 "project/radare2/test/unit/test_hex.c"
_meqstr
# 37 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 37 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 37, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 37, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 41 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 41 "project/radare2/test/unit/test_hex.c"
_meqstr
# 41 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 41 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 41, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 41, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 45 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 45 "project/radare2/test/unit/test_hex.c"
_meqstr
# 45 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 45 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 45, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 45, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 49 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 49 "project/radare2/test/unit/test_hex.c"
_meqstr
# 49 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 49 "project/radare2/test/unit/test_hex.c"
...
# 55 "project/radare2/test/unit/test_hex.c" 3 4
_Bool 
# 55 "project/radare2/test/unit/test_hex.c"
    test_r_hex_from_c() {
 const char *s;
 char *r;
 s = "char *s = \"ABCD\";";
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 60 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 60 "project/radare2/test/unit/test_hex.c"
_meqstr
# 60 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 60 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 60, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 60, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 64 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 64 "project/radare2/test/unit/test_hex.c"
_meqstr
# 64 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 64 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 64, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 64, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 68 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 68 "project/radare2/test/unit/test_hex.c"
_meqstr
# 68 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 68 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 72 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_hex.c"
_meqstr
# 72 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 72 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("0a0d1b"); 
# 76 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 76 "project/radare2/test/unit/test_hex.c"
_meqstr
# 76 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 76 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 76, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 76, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 80 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 80 "project/radare2/test/unit/test_hex.c"
_meqstr
# 80 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 80 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 80, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 80, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 84 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 84 "project/radare2/test/unit/test_hex.c"
_meqstr
# 84 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 84 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 84, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 84, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 88 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 88 "project/radare2/test/unit/test_hex.c"
_meqstr
# 88 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 88 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 88, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 88, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_c (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 92 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 92 "project/radare2/test/unit/test_hex.c"
_meqstr
# 92 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 92 "project/radare2/test/unit/test_hex.c"
...
# 98 "project/radare2/test/unit/test_hex.c" 3 4
_Bool 
# 98 "project/radare2/test/unit/test_hex.c"
    test_r_hex_from_py() {
 const char *s;
 char *r;
 s = "s = \"ABCD\";";
 r = r_hex_from_py (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 103 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 103 "project/radare2/test/unit/test_hex.c"
_meqstr
# 103 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 103 "project/radare2/test/unit/test_hex.c"
...
# 103 "project/radare2/test/unit/test_hex.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 103, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 103, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (r);
 s = "s = \"\x41\x42\x43\x44\"";
 r = r_hex_from_py (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 107 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 107 "project/radare2/test/unit/test_hex.c"
_meqstr
# 107 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 107 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 107, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 107, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 s = "s = \"\n\r\"";
 r = r_hex_from_py (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("0a0d"); 
# 111 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 111 "project/radare2/test/unit/test_hex.c"
_meqstr
# 111 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 111 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_py (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 115 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 115 "project/radare2/test/unit/test_hex.c"
_meqstr
# 115 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 115 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 115, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_py (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 119 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 119 "project/radare2/test/unit/test_hex.c"
_meqstr
# 119 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 119 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 119, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 119, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_from_py (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 123 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 123 "project/radare2/test/unit/test_hex.c"
_meqstr
# 123 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 123 "project/radare2/test/unit/test_hex.c"
...
# 129 "project/radare2/test/unit/test_hex.c" 3 4
_Bool 
# 129 "project/radare2/test/unit/test_hex.c"
    test_r_hex_no_code() {
 const char *s;
 char *r;
 s = "\"ABCD\"";
 r = r_hex_no_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 134 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 134 "project/radare2/test/unit/test_hex.c"
_meqstr
# 134 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 134 "project/radare2/test/unit/test_hex.c"
...
# 134 "project/radare2/test/unit/test_hex.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 134, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 134, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (r);
 s = "\"AB\" \"CD\"";
 r = r_hex_no_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 138 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 138 "project/radare2/test/unit/test_hex.c"
_meqstr
# 138 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 138 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 138, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 138, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_no_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 142 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 142 "project/radare2/test/unit/test_hex.c"
_meqstr
# 142 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 142 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 142, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 142, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_no_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 146 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 146 "project/radare2/test/unit/test_hex.c"
_meqstr
# 146 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 146 "project/radare2/test/unit/test_hex.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 146, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 146, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_hex_no_code (s);
 do { char _meqstr[5120]; const char *act__ = (r); const char *exp__ = ("41424344"); 
# 150 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 150 "project/radare2/test/unit/test_hex.c"
_meqstr
# 150 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 150 "project/radare2/test/unit/test_hex.c"
...
# 156 "project/radare2/test/unit/test_hex.c" 3 4
_Bool 
# 156 "project/radare2/test/unit/test_hex.c"
    test_str2bin_alloc () {
 
# 157 "project/radare2/test/unit/test_hex.c" 3 4
unsigned char 
# 157 "project/radare2/test/unit/test_hex.c"
    *buf = 
# 157 "project/radare2/test/unit/test_hex.c" 3 4
           ((void *)0)
# 157 "project/radare2/test/unit/test_hex.c"
 ...
 do { 
# 161 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 161 "project/radare2/test/unit/test_hex.c"
act__ = (
# 161 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 161 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 161 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new invalid str 1"), (
# 161 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 161 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
# 161 "project/radare2/test/unit/test_hex.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (buf); 
# 162 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 162 "project/radare2/test/unit/test_hex.c"
_meqstr
# 162 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 162 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 162 "project/radare2/test/unit/test_hex.c"
"%s: expected to be NULL but it wasn't.", ("r_hex_str2bin_until_new invalid str 1")
# 162 "project/radare2/test/unit/test_hex.c" 3 4
)
# 162 "project/radare2/test/unit/test_hex.c"
; do { if (!((act__) == 
...
# 162 "project/radare2/test/unit/test_hex.c"
 ...
 do { 
# 165 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 165 "project/radare2/test/unit/test_hex.c"
act__ = (
# 165 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 165 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 165 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new invalid str 2"), (
# 165 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 165 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
# 165 "project/radare2/test/unit/test_hex.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (buf); 
# 166 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 166 "project/radare2/test/unit/test_hex.c"
_meqstr
# 166 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 166 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 166 "project/radare2/test/unit/test_hex.c"
"%s: expected to be NULL but it wasn't.", ("r_hex_str2bin_until_new invalid str 2")
# 166 "project/radare2/test/unit/test_hex.c" 3 4
)
# 166 "project/radare2/test/unit/test_hex.c"
; do { if (!((act__) == 
...
# 166 "project/radare2/test/unit/test_hex.c"
 ...
 do { 
# 169 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 169 "project/radare2/test/unit/test_hex.c"
act__ = (
# 169 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 169 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new invalid str 3"), (
# 169 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
# 169 "project/radare2/test/unit/test_hex.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (buf); 
# 170 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 170 "project/radare2/test/unit/test_hex.c"
_meqstr
# 170 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 170 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 170 "project/radare2/test/unit/test_hex.c"
"%s: expected to be NULL but it wasn't.", ("r_hex_str2bin_until_new invalid str 3")
# 170 "project/radare2/test/unit/test_hex.c" 3 4
)
# 170 "project/radare2/test/unit/test_hex.c"
; do { if (!((act__) == 
...
# 170 "project/radare2/test/unit/test_hex.c"
 ...
 do { 
# 173 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 173 "project/radare2/test/unit/test_hex.c"
act__ = (
# 173 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 173 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 173 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new invalid str 4"), (
# 173 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 173 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
0
# 173 "project/radare2/test/unit/test_hex.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 173, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 173, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const void *act__ = (buf); 
# 174 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 174 "project/radare2/test/unit/test_hex.c"
_meqstr
# 174 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 174 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 174 "project/radare2/test/unit/test_hex.c"
"%s: expected to be NULL but it wasn't.", ("r_hex_str2bin_until_new invalid str 4")
# 174 "project/radare2/test/unit/test_hex.c" 3 4
)
# 174 "project/radare2/test/unit/test_hex.c"
; do { if (!((act__) == 
...
# 177 "project/radare2/test/unit/test_hex.c" 3 4
unsigned char 
# 177 "project/radare2/test/unit/test_hex.c"
    buf2[3];
 len = r_hex_str2bin_until_new ("44", (
# 178 "project/radare2/test/unit/test_hex.c" 3 4
                                      unsigned char 
# 178 "project/radare2/test/unit/test_hex.c"
                                          **)&buf2);
 do { 
# 179 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 179 "project/radare2/test/unit/test_hex.c"
act__ = (
# 179 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 179 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 179 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new accepted non-null **"), (
# 179 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 179 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
# 179 "project/radare2/test/unit/test_hex.c"
 ...
 len = r_hex_str2bin_until_new ("4142", 
# 181 "project/radare2/test/unit/test_hex.c" 3 4
                                       ((void *)0)
# 181 "project/radare2/test/unit/test_hex.c"
                                           );
 do { 
# 182 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 182 "project/radare2/test/unit/test_hex.c"
act__ = (
# 182 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 182 "project/radare2/test/unit/test_hex.c"
...
0
# 182 "project/radare2/test/unit/test_hex.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 182, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 182, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);


 buf = 
# 185 "project/radare2/test/unit/test_hex.c" 3 4
      ((void *)0)
# 185 "project/radare2/test/unit/test_hex.c"
          ;
 len = r_hex_str2bin_until_new ("4142", &buf);
 do { 
# 187 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 187 "project/radare2/test/unit/test_hex.c"
act__ = (
# 187 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 187 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 187 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new simple example"), (
# 187 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 187 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
# 187 "project/radare2/test/unit/test_hex.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (buf); 
# 188 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 188 "project/radare2/test/unit/test_hex.c"
_meqstr
# 188 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 188 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 188 "project/radare2/test/unit/test_hex.c"
"%s: expected to not be NULL but it was.", ("r_hex_str2bin_until_new simple example")
# 188 "project/radare2/test/unit/test_hex.c" 3 4
)
# 188 "project/radare2/test/unit/test_hex.c"
; do { if (!((act__) != 
...
((void *)0)
# 188 "project/radare2/test/unit/test_hex.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 188, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 188, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 189 "project/radare2/test/unit/test_hex.c" 3 4
unsigned char 
# 189 "project/radare2/test/unit/test_hex.c"
*act__ = (buf); const 
# 189 "project/radare2/test/unit/test_hex.c" 3 4
unsigned char 
# 189 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 189 "project/radare2/test/unit/test_hex.c"
"%s: expected ", "r_hex_str2bin_until_new simple example"
# 189 "project/radare2/test/unit/test_hex.c" 3 4
)
# 189 "project/radare2/test/unit/test_hex.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (len)); _meqstr_len = strlen (_meqstr); 
# 189 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 189 "project/radare2/test/unit/test_hex.c"
_meqstr + _meqstr_len
...
# 189 "project/radare2/test/unit/test_hex.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (len)); do { if (!(memcmp((exp__), (act__), (len)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 189, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 189, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (buf);

 buf = 
# 192 "project/radare2/test/unit/test_hex.c" 3 4
      ((void *)0)
# 192 "project/radare2/test/unit/test_hex.c"
          ;
 len = r_hex_str2bin_until_new ("414243:NOT_HEX", &buf);
 do { 
# 194 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long 
# 194 "project/radare2/test/unit/test_hex.c"
act__ = (
# 194 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 194 "project/radare2/test/unit/test_hex.c"
...
"lld" 
# 194 "project/radare2/test/unit/test_hex.c"
".", ("r_hex_str2bin_until_new \"414243:NOT_HEX\" returns 3 bytes"), (
# 194 "project/radare2/test/unit/test_hex.c" 3 4
unsigned long long
# 194 "project/radare2/test/unit/test_hex.c"
)(exp__), (
...
# 194 "project/radare2/test/unit/test_hex.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (buf); 
# 195 "project/radare2/test/unit/test_hex.c" 3 4
__builtin___snprintf_chk (
# 195 "project/radare2/test/unit/test_hex.c"
_meqstr
# 195 "project/radare2/test/unit/test_hex.c" 3 4
, 
# 195 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 195 "project/radare2/test/unit/test_hex.c"
"%s: expected to not be NULL but it was.", ("r_hex_str2bin_until_new \"414243:NOT_HEX\" returns 3 bytes")
# 195 "project/radare2/test/unit/test_hex.c" 3 4
)
# 195 "project/radare2/test/unit/test_hex.c"
; do { if (!((act__) != 
...
((void *)0)
# 195 "project/radare2/test/unit/test_hex.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 195, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 195, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 196 "project/radare2/test/unit/test_hex.c" 3 4
unsigned char 
# 196 "project/radare2/test/unit/test_hex.c"
*act__ = (buf); const 
# 196 "project/radare2/test/unit/test_hex.c" 3 4
unsigned char 
# 196 "project/radare2/test/unit/test_hex.c"
...
, 2 > 1 ? 1 : 0), 
# 196 "project/radare2/test/unit/test_hex.c"
"%s: expected ", "r_hex_str2bin_until_new \"414243:NOT_HEX\" returns 3 bytes"
# 196 "project/radare2/test/unit/test_hex.c" 3 4
)
# 196 "project/radare2/test/unit/test_hex.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (len)); _meqstr_len = strlen (_meqstr); 
...
# 202 "project/radare2/test/unit/test_hex.c" 3 4
_Bool 
# 202 "project/radare2/test/unit/test_hex.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_hex_from_c"); result = test_r_hex_from_c(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_hex_from_py"); result = test_r_hex_from_py(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_hex_from_code"); result = test_r_hex_from_code(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_hex_no_code"); result = test_r_hex_no_code(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_str2bin_alloc"); result = test_str2bin_alloc(); tests_run++; tests_passed += result; } while (0);
