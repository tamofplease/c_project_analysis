# 0 "project/radare2/test/unit/test_strbuf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_strbuf.c"
...
# 2 "project/radare2/test/unit/test_strbuf.c" 2
...
# 3 "project/radare2/test/unit/test_strbuf.c" 2


# 4 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_slice(void) {
 RStrBuf *sa = r_strbuf_new ("foo,bar,cow");
 r_strbuf_slice (sa, 2, 4);
 char *a = r_strbuf_drain (sa);
 do { char _meqstr[5120]; const char *act__ = (a); const char *exp__ = ("o,ba"); 
# 8 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 8 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 8 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 8 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 8 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("slicing fails"), (exp__), (act__)
# 8 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 8 "project/radare2/test/unit/test_strbuf.c"
...
# 14 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 14 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_append(void) {
 RStrBuf *sa = r_strbuf_new ("foo");
 r_strbuf_append (sa, "bar");
 r_strbuf_prepend (sa, "pre");
 char *a = r_strbuf_drain (sa);
 do { char _meqstr[5120]; const char *act__ = (a); const char *exp__ = ("prefoobar"); 
# 19 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 19 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 19 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 19 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 19 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("append+prepend"), (exp__), (act__)
# 19 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 19 "project/radare2/test/unit/test_strbuf.c"
...
# 25 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 25 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_strong_string(void) {

 RStrBuf *sa = r_strbuf_new ("");
 r_strbuf_set (sa, "food");
 do { 
# 29 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 29 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 29 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 29 "project/radare2/test/unit/test_strbuf.c"
...
# 29 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 30 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 30 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 30 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 30 "project/radare2/test/unit/test_strbuf.c"
...
# 30 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (drained); const char *exp__ = ("food"); 
# 37 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 37 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 37 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 37 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 37 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("drained string"), (exp__), (act__)
# 37 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 37 "project/radare2/test/unit/test_strbuf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 37, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 37, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { 
# 43 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 43 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 43 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 43 "project/radare2/test/unit/test_strbuf.c"
...
unsigned long long
# 43 "project/radare2/test/unit/test_strbuf.c"
)(46); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 43 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 43 "project/radare2/test/unit/test_strbuf.c"
_meqstr
...
# 43 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 44 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 44 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 44 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 44 "project/radare2/test/unit/test_strbuf.c"
...
0
# 44 "project/radare2/test/unit/test_strbuf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 44, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 44, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 45 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 45 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 45 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 45 "project/radare2/test/unit/test_strbuf.c"
...
unsigned long long
# 45 "project/radare2/test/unit/test_strbuf.c"
)(47); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 45 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 45 "project/radare2/test/unit/test_strbuf.c"
_meqstr
...
# 45 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (drained); const char *exp__ = ("VERYLONGTEXTTHATDOESNTFITINSIDETHESTRUCTBUFFER"); 
# 51 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 51 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 51 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 51 "project/radare2/test/unit/test_strbuf.c"
...
# 57 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 57 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_strong_binary(void) {
 RStrBuf *sa = r_strbuf_new ("");
 
# 59 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 59 "project/radare2/test/unit/test_strbuf.c"
     res = r_strbuf_setbin (sa, (const 
# 59 "project/radare2/test/unit/test_strbuf.c" 3 4
                                       unsigned char 
# 59 "project/radare2/test/unit/test_strbuf.c"
                                           *)"food", 4);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 60, "setbin success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 60, "setbin success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 61 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 61 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 61 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 61 "project/radare2/test/unit/test_strbuf.c"
*)r_strbuf_get (sa)); const 
# 61 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 61 "project/radare2/test/unit/test_strbuf.c"
*exp__ = ((const 
...
, 2 > 1 ? 1 : 0), 
# 61 "project/radare2/test/unit/test_strbuf.c"
"%s: expected ", "small binary data"
# 61 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 61 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (4)); _meqstr_len = strlen (_meqstr); 
# 61 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 61 "project/radare2/test/unit/test_strbuf.c"
_meqstr + _meqstr_len
...
# 61 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (4)); do { if (!(memcmp((exp__), (act__), (4)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 61, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 61, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 62 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 62 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 62 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 62 "project/radare2/test/unit/test_strbuf.c"
...
# 62 "project/radare2/test/unit/test_strbuf.c"
 ...
 sa = r_strbuf_new ("");
 r_strbuf_setbin (sa, (const 
# 66 "project/radare2/test/unit/test_strbuf.c" 3 4
                            unsigned char 
# 66 "project/radare2/test/unit/test_strbuf.c"
                                *)"food", 4);
 char *drained = r_strbuf_drain (sa);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 68 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 68 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 68 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 68 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 68 "project/radare2/test/unit/test_strbuf.c"
"%s: expected ", "drained binary data"
# 68 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 68 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (4)); _meqstr_len = strlen (_meqstr); 
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (4)); do { if (!(memcmp((exp__), (act__), (4)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 sa = r_strbuf_new ("");
 res = r_strbuf_setbin (sa, (const 
# 72 "project/radare2/test/unit/test_strbuf.c" 3 4
                                  unsigned char 
# 72 "project/radare2/test/unit/test_strbuf.c"
                                      *)"VERYLONGTEXTTHATDOESNTFITINSIDETHESTRUCTBUFFER", 46);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 73, "setbin success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 73, "setbin success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 74 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 74 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 74 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 74 "project/radare2/test/unit/test_strbuf.c"
...
unsigned char 
# 74 "project/radare2/test/unit/test_strbuf.c"
*)"VERYLONGTEXTTHATDOESNTFITINSIDETHESTRUCTBUFFER"); 
# 74 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 74 "project/radare2/test/unit/test_strbuf.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 74 "project/radare2/test/unit/test_strbuf.c"
"%s: expected ", "big binary data"
# 74 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 74 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (46)); _meqstr_len = strlen (_meqstr); 
# 74 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 74 "project/radare2/test/unit/test_strbuf.c"
_meqstr + _meqstr_len
...
# 74 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (46)); do { if (!(memcmp((exp__), (act__), (46)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 74, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 74, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 75 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 75 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 75 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 75 "project/radare2/test/unit/test_strbuf.c"
...
# 75 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 76 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 76 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 76 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 76 "project/radare2/test/unit/test_strbuf.c"
...
# 76 "project/radare2/test/unit/test_strbuf.c"
 ...
 sa = r_strbuf_new ("");
 r_strbuf_setbin (sa, (const 
# 80 "project/radare2/test/unit/test_strbuf.c" 3 4
                            unsigned char 
# 80 "project/radare2/test/unit/test_strbuf.c"
                                *)"VERYLONGTEXTTHATDOESNTFITINSIDETHESTRUCTBUFFER", 46);
 drained = r_strbuf_drain (sa);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 82 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 82 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 82 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 82 "project/radare2/test/unit/test_strbuf.c"
...
# 88 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 88 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_weak_string(void) {

 char *myptr = "food";
 RStrBuf *sa = r_strbuf_new ("");
 r_strbuf_setptr (sa, myptr, -1);
 do { 
# 93 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 93 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 93 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 93 "project/radare2/test/unit/test_strbuf.c"
...
# 93 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 94 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 94 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 94 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 94 "project/radare2/test/unit/test_strbuf.c"
...
# 94 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 95 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 95 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 95 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 95 "project/radare2/test/unit/test_strbuf.c"
...
0
# 95 "project/radare2/test/unit/test_strbuf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 95, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 95, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_strbuf_get (sa)); const void *exp__ = (myptr); 
# 96 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 96 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 96 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 96 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 96 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %p, got %p.", ("weak ptr"), (exp__), (act__)
# 96 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 96 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 96, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 96, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 char *drained = r_strbuf_drain (sa);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 102 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 102 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 102 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 102 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 102 "project/radare2/test/unit/test_strbuf.c"
"%s: expected ", "drained weak string"
# 102 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 102 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (4)); _meqstr_len = strlen (_meqstr); 
...
# 102 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (4)); do { if (!(memcmp((exp__), (act__), (4)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 102, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 102, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (drained);
 ...
 r_strbuf_setptr (sa, myptr, -1);
 do { 
# 109 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 109 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 109 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 109 "project/radare2/test/unit/test_strbuf.c"
...
# 109 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 110 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 110 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 110 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 110 "project/radare2/test/unit/test_strbuf.c"
...
# 110 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 111 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 111 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 111 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 111 "project/radare2/test/unit/test_strbuf.c"
...
# 111 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_strbuf_get (sa)); const void *exp__ = (myptr); 
# 112 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 112 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 112 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 112 "project/radare2/test/unit/test_strbuf.c"
...
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 112, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 112, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 drained = r_strbuf_drain (sa);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 118 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 118 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 118 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 118 "project/radare2/test/unit/test_strbuf.c"
...
# 118 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (46)); do { if (!(memcmp((exp__), (act__), (46)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 118, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 118, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (drained);
...
# 124 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 124 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_weak_binary(void) {
 char *myptr = "food";
 RStrBuf *sa = r_strbuf_new ("");
 
# 127 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 127 "project/radare2/test/unit/test_strbuf.c"
     res = r_strbuf_setptr (sa, myptr, 4);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 128, "setbin success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 128, "setbin success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_strbuf_get (sa)); const void *exp__ = (myptr); 
# 129 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 129 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 129 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 129 "project/radare2/test/unit/test_strbuf.c"
...
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 129, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 129, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 130 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 130 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 130 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 130 "project/radare2/test/unit/test_strbuf.c"
...
# 130 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 131 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 131 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 131 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 131 "project/radare2/test/unit/test_strbuf.c"
...
0
# 131 "project/radare2/test/unit/test_strbuf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 131, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 131, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_strbuf_free (sa);
 ...
 char *drained = r_strbuf_drain (sa);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 137 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 137 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 137 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 137 "project/radare2/test/unit/test_strbuf.c"
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (4)); do { if (!(memcmp((exp__), (act__), (4)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 137, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 137, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 143, "setbin success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 143, "setbin success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_strbuf_get (sa)); const void *exp__ = (myptr); 
# 144 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 144 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 144 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 144 "project/radare2/test/unit/test_strbuf.c"
...
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 144, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 144, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { 
# 145 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 145 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 145 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 145 "project/radare2/test/unit/test_strbuf.c"
...
# 145 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 146 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 146 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 146 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 146 "project/radare2/test/unit/test_strbuf.c"
...
# 146 "project/radare2/test/unit/test_strbuf.c"
 ...
 drained = r_strbuf_drain (sa);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 152 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 152 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 152 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 152 "project/radare2/test/unit/test_strbuf.c"
...
# 158 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 158 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_setbin(void) {
 RStrBuf *sa = r_strbuf_new ("");
 r_strbuf_setbin (sa, (const 
# 160 "project/radare2/test/unit/test_strbuf.c" 3 4
                            unsigned char 
# 160 "project/radare2/test/unit/test_strbuf.c"
                                *)"inbuffffffff", 5);
 do { char _meqstr[5120]; const char *act__ = (r_strbuf_get (sa)); const char *exp__ = ("inbuf"); 
# 161 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 161 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 161 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 161 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 161 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("setbin str with size"), (exp__), (act__)
# 161 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 161 "project/radare2/test/unit/test_strbuf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 161, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 161, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 162 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 162 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 162 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 162 "project/radare2/test/unit/test_strbuf.c"
...
# 164 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 164 "project/radare2/test/unit/test_strbuf.c"
    *buf = malloc(46);
 
# 165 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___memcpy_chk (
# 165 "project/radare2/test/unit/test_strbuf.c"
buf
# 165 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 165 "project/radare2/test/unit/test_strbuf.c"
...
# 165 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 167 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 167 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 167 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 167 "project/radare2/test/unit/test_strbuf.c"
...
# 167 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (46)); do { if (!(memcmp((exp__), (act__), (46)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 167, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 167, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (buf);
 do { 
# 169 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 169 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 169 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_strbuf.c"
...
# 169 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 170 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 170 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 170 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 170 "project/radare2/test/unit/test_strbuf.c"
...
# 170 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 171 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 171 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 171 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 171 "project/radare2/test/unit/test_strbuf.c"
...
unsigned long long
# 171 "project/radare2/test/unit/test_strbuf.c"
)(46 + 1); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 171 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 171 "project/radare2/test/unit/test_strbuf.c"
_meqstr
...
0
# 171 "project/radare2/test/unit/test_strbuf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 171, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 171, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);


 buf = malloc (46 * 2);
 
# 175 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___memcpy_chk (
# 175 "project/radare2/test/unit/test_strbuf.c"
buf
# 175 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 175 "project/radare2/test/unit/test_strbuf.c"
"VERYLONGTEXTTHATDOESNTFITINSIDETHESTRUCTBUFFERVERYLONGTEXTTHATDOESNTFITINSIDETHESTRUCTBUFFER", 46 * 2
# 175 "project/radare2/test/unit/test_strbuf.c" 3 4
, __builtin_object_size (
# 175 "project/radare2/test/unit/test_strbuf.c"
buf
...
# 175 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 177 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 177 "project/radare2/test/unit/test_strbuf.c"
*act__ = ((const 
# 177 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned char 
# 177 "project/radare2/test/unit/test_strbuf.c"
...
# 177 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (46 * 2)); _meqstr_len = strlen (_meqstr); 
# 177 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 177 "project/radare2/test/unit/test_strbuf.c"
_meqstr + _meqstr_len
...
# 177 "project/radare2/test/unit/test_strbuf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (46 * 2)); do { if (!(memcmp((exp__), (act__), (46 * 2)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 177, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 177, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (buf);
 do { 
# 179 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 179 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 179 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 179 "project/radare2/test/unit/test_strbuf.c"
)(r_strbuf_get (sa)[46 * 2]); 
# 179 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 179 "project/radare2/test/unit/test_strbuf.c"
exp__ = (
...
# 179 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 180 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 180 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 180 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 180 "project/radare2/test/unit/test_strbuf.c"
...
unsigned long long
# 180 "project/radare2/test/unit/test_strbuf.c"
)(46 * 2); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 180 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 180 "project/radare2/test/unit/test_strbuf.c"
_meqstr
...
# 180 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { 
# 181 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long 
# 181 "project/radare2/test/unit/test_strbuf.c"
act__ = (
# 181 "project/radare2/test/unit/test_strbuf.c" 3 4
unsigned long long
# 181 "project/radare2/test/unit/test_strbuf.c"
...
unsigned long long
# 181 "project/radare2/test/unit/test_strbuf.c"
)(46 * 2 + 1); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 181 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 181 "project/radare2/test/unit/test_strbuf.c"
_meqstr
...
# 187 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 187 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_set(void) {
 RStrBuf sb;
 r_strbuf_init (&sb);
 const char *s = r_strbuf_set (&sb, "I have packed only the essentials");
 do { char _meqstr[5120]; const void *act__ = (s); 
# 191 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 191 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 191 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 191 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 191 "project/radare2/test/unit/test_strbuf.c"
"%s: expected to not be NULL but it was.", ("set return notnull")
# 191 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 191 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((act__) != 
...
((void *)0)
# 191 "project/radare2/test/unit/test_strbuf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 191, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 191, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (s); const void *exp__ = (r_strbuf_get (&sb)); 
# 192 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 192 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 192 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 192 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 192 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %p, got %p.", ("set return"), (exp__), (act__)
# 192 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 192 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 192, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 192, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const char *act__ = (r_strbuf_get (&sb)); const char *exp__ = ("I have packed only the essentials"); 
# 193 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 193 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 193 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 193 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 193 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("set"), (exp__), (act__)
# 193 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 193 "project/radare2/test/unit/test_strbuf.c"
...
# 198 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 198 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_setf(void) {
 RStrBuf sb;
 r_strbuf_init (&sb);
 const char *s = r_strbuf_setf (&sb, "One %s for hydration", "water");
 do { char _meqstr[5120]; const void *act__ = (s); 
# 202 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 202 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 202 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 202 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 202 "project/radare2/test/unit/test_strbuf.c"
"%s: expected to not be NULL but it was.", ("setf return notnull")
# 202 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 202 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((act__) != 
...
# 202 "project/radare2/test/unit/test_strbuf.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (s); const void *exp__ = (r_strbuf_get (&sb)); 
# 203 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 203 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 203 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 203 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 203 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %p, got %p.", ("setf return"), (exp__), (act__)
# 203 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 203 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 203, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 203, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const char *act__ = (r_strbuf_get (&sb)); const char *exp__ = ("One water for hydration"); 
# 204 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 204 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 204 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 204 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 204 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("setf"), (exp__), (act__)
# 204 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 204 "project/radare2/test/unit/test_strbuf.c"
...
# 209 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 209 "project/radare2/test/unit/test_strbuf.c"
    test_r_strbuf_initf(void) {
 RStrBuf sb;
 const char *s = r_strbuf_initf (&sb, "hmmst, %s was that audial occurence? %d", "wat", 42);
 do { char _meqstr[5120]; const void *act__ = (s); 
# 212 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 212 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 212 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 212 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 212 "project/radare2/test/unit/test_strbuf.c"
"%s: expected to not be NULL but it was.", ("initf return notnull")
# 212 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 212 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((act__) != 
...
((void *)0)
# 212 "project/radare2/test/unit/test_strbuf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 212, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 212, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (s); const void *exp__ = (r_strbuf_get (&sb)); 
# 213 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 213 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 213 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 213 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 213 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %p, got %p.", ("initf return"), (exp__), (act__)
# 213 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 213 "project/radare2/test/unit/test_strbuf.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 213, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 213, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 do { char _meqstr[5120]; const char *act__ = (r_strbuf_get (&sb)); const char *exp__ = ("hmmst, wat was that audial occurence? 42"); 
# 214 "project/radare2/test/unit/test_strbuf.c" 3 4
__builtin___snprintf_chk (
# 214 "project/radare2/test/unit/test_strbuf.c"
_meqstr
# 214 "project/radare2/test/unit/test_strbuf.c" 3 4
, 
# 214 "project/radare2/test/unit/test_strbuf.c"
...
, 2 > 1 ? 1 : 0), 
# 214 "project/radare2/test/unit/test_strbuf.c"
"%s: expected %s, got %s.", ("initf"), (exp__), (act__)
# 214 "project/radare2/test/unit/test_strbuf.c" 3 4
)
# 214 "project/radare2/test/unit/test_strbuf.c"
...
# 219 "project/radare2/test/unit/test_strbuf.c" 3 4
_Bool 
# 219 "project/radare2/test/unit/test_strbuf.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_append"); result = test_r_strbuf_append(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_strong_string"); result = test_r_strbuf_strong_string(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_strong_binary"); result = test_r_strbuf_strong_binary(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_weak_string"); result = test_r_strbuf_weak_string(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_weak_binary"); result = test_r_strbuf_weak_binary(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_slice"); result = test_r_strbuf_slice(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_setbin"); result = test_r_strbuf_setbin(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_set"); result = test_r_strbuf_set(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_setf"); result = test_r_strbuf_setf(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_strbuf_initf"); result = test_r_strbuf_initf(); tests_run++; tests_passed += result; } while (0);
