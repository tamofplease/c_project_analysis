# 0 "project/radare2/test/unit/test_buf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_buf.c"
...
# 2 "project/radare2/test/unit/test_buf.c" 2
...
# 3 "project/radare2/test/unit/test_buf.c" 2
...
# 5 "project/radare2/test/unit/test_buf.c" 2


# 6 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 6 "project/radare2/test/unit/test_buf.c"
    test_buf(RBuffer *b) {
 
# 7 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 7 "project/radare2/test/unit/test_buf.c"
    buffer[1024] = { 0 };
...
# 12 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 12 "project/radare2/test/unit/test_buf.c"
     buf_sz = r_buf_size (b);
 do { 
# 13 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 13 "project/radare2/test/unit/test_buf.c"
act__ = (
# 13 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 13 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 13 "project/radare2/test/unit/test_buf.c"
)(length); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 13 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 13 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 13 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 13, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 13, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 r = r_buf_read (b, buffer, length);
 do { 
# 16 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 16 "project/radare2/test/unit/test_buf.c"
act__ = (
# 16 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 16 "project/radare2/test/unit/test_buf.c"
...
# 17 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 17 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 17 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 17 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 17 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "r_buf_read_at has corrupted content"
# 17 "project/radare2/test/unit/test_buf.c" 3 4
)
# 17 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (length)); _meqstr_len = strlen (_meqstr); 
# 17 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 17 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 17 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (length)); do { if (!(memcmp((exp__), (act__), (length)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 17, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 17, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 const char *s = "This is a new content";
 const size_t sl = strlen (s);
 
# 21 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 21 "project/radare2/test/unit/test_buf.c"
     res = r_buf_set_bytes (b, (
# 21 "project/radare2/test/unit/test_buf.c" 3 4
                                unsigned char 
# 21 "project/radare2/test/unit/test_buf.c"
                                    *)s, sl);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 22, "New content should be written"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 22, "New content should be written"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 r_buf_seek (b, 0, 
# 24 "project/radare2/test/unit/test_buf.c" 3 4
                  0
# 24 "project/radare2/test/unit/test_buf.c"
                           );
 r = r_buf_read (b, buffer, sl);
 do { 
# 26 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 26 "project/radare2/test/unit/test_buf.c"
act__ = (
# 26 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 26 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 26 "project/radare2/test/unit/test_buf.c"
)(sl); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 26 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 26 "project/radare2/test/unit/test_buf.c"
_meqstr
...
# 26 "project/radare2/test/unit/test_buf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 27 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 27 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 27 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 27 "project/radare2/test/unit/test_buf.c"
...
# 27 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (sl)); _meqstr_len = strlen (_meqstr); 
# 27 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 27 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 27 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (sl)); do { if (!(memcmp((exp__), (act__), (sl)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 27, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 27, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_buf_seek (b, 0, 
# 29 "project/radare2/test/unit/test_buf.c" 3 4
                  0
# 29 "project/radare2/test/unit/test_buf.c"
                           );
 r = r_buf_read (b, buffer, 3);
 do { 
# 31 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 31 "project/radare2/test/unit/test_buf.c"
act__ = (
# 31 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 31 "project/radare2/test/unit/test_buf.c"
...
# 31 "project/radare2/test/unit/test_buf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 32 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 32 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 32 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 32 "project/radare2/test/unit/test_buf.c"
...
# 32 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (3)); _meqstr_len = strlen (_meqstr); 
# 32 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 32 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 32 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (3)); do { if (!(memcmp((exp__), (act__), (3)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 32, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 32, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r = r_buf_read (b, buffer, 5);
 do { 
# 34 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 34 "project/radare2/test/unit/test_buf.c"
act__ = (
# 34 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 34 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 34 "project/radare2/test/unit/test_buf.c"
)(5); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 34 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 34 "project/radare2/test/unit/test_buf.c"
_meqstr
...
# 34 "project/radare2/test/unit/test_buf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 35 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 35 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 35 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 35 "project/radare2/test/unit/test_buf.c"
...
# 35 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (5)); _meqstr_len = strlen (_meqstr); 
# 35 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 35 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 35 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (5)); do { if (!(memcmp((exp__), (act__), (5)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 35, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 35, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 const char *s2 = ", hello world";
 const size_t s2l = strlen (s2);
 res = r_buf_append_string (b, s2);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 40, "string should be appended"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 40, "string should be appended"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 buf_sz = r_buf_size (b);
 do { 
# 43 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 43 "project/radare2/test/unit/test_buf.c"
act__ = (
# 43 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 43 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 43 "project/radare2/test/unit/test_buf.c"
)(sl + s2l); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 43 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 43 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 43 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 43, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 43, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 res = r_buf_resize (b, 10);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 46, "file should be resized"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 46, "file should be resized"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 buf_sz = r_buf_size (b);
 do { 
# 48 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 48 "project/radare2/test/unit/test_buf.c"
act__ = (
# 48 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 48 "project/radare2/test/unit/test_buf.c"
...
# 48 "project/radare2/test/unit/test_buf.c"
 ...
 do { 
# 51 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 51 "project/radare2/test/unit/test_buf.c"
act__ = (
# 51 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 51 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 51 "project/radare2/test/unit/test_buf.c"
)(9); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 51 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 51 "project/radare2/test/unit/test_buf.c"
_meqstr
...
"lld" 
# 51 "project/radare2/test/unit/test_buf.c"
".", ("only 9 bytes can be read from offset 1"), (
# 51 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 51 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 51 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 51, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 51, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 52 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 52 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 52 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 52 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 52 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "read right bytes from offset 1"
# 52 "project/radare2/test/unit/test_buf.c" 3 4
)
# 52 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (9)); _meqstr_len = strlen (_meqstr); 
# 52 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 52 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 52 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (9)); do { if (!(memcmp((exp__), (act__), (9)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 52, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 52, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_buf_set_bytes (b, (
# 54 "project/radare2/test/unit/test_buf.c" 3 4
                     unsigned char 
# 54 "project/radare2/test/unit/test_buf.c"
                         *)"World", strlen ("World"));
 char *base = r_buf_to_string (b);
 do { char _meqstr[5120]; const void *act__ = (base); 
# 56 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 56 "project/radare2/test/unit/test_buf.c"
_meqstr
# 56 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 56 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 56 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("string should be there")
# 56 "project/radare2/test/unit/test_buf.c" 3 4
)
# 56 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 56 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 56, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 56, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (base); const char *exp__ = ("World"); 
# 57 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 57 "project/radare2/test/unit/test_buf.c"
_meqstr
# 57 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 57 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 57 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("World there"), (exp__), (act__)
# 57 "project/radare2/test/unit/test_buf.c" 3 4
)
# 57 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 57, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 57, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (base);

 const char *s3 = "Hello ";
 res = r_buf_prepend_bytes (b, (const 
# 61 "project/radare2/test/unit/test_buf.c" 3 4
                                     unsigned char 
# 61 "project/radare2/test/unit/test_buf.c"
                                         *)s3, strlen (s3));
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 62, "bytes should be prepended"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 62, "bytes should be prepended"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 char *st = r_buf_to_string (b);
 do { char _meqstr[5120]; const void *act__ = (st); 
# 64 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 64 "project/radare2/test/unit/test_buf.c"
_meqstr
# 64 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 64 "project/radare2/test/unit/test_buf.c"
...
((void *)0)
# 64 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 64, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 64, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (st); const char *exp__ = ("Hello World"); 
# 65 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 65 "project/radare2/test/unit/test_buf.c"
_meqstr
# 65 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 65 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 65 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("hello world there"), (exp__), (act__)
# 65 "project/radare2/test/unit/test_buf.c" 3 4
)
# 65 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 65, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 65, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (st);

 r_buf_insert_bytes (b, 5, (
# 68 "project/radare2/test/unit/test_buf.c" 3 4
                           unsigned char 
# 68 "project/radare2/test/unit/test_buf.c"
                               *)",", 1);
 char *st2 = r_buf_to_string (b);
 do { char _meqstr[5120]; const void *act__ = (st2); 
# 70 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 70 "project/radare2/test/unit/test_buf.c"
_meqstr
# 70 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 70 "project/radare2/test/unit/test_buf.c"
...
((void *)0)
# 70 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 70, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 70, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (st2); const char *exp__ = ("Hello, World"); 
# 71 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_buf.c"
_meqstr
# 71 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 71 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 71 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("comma inserted"), (exp__), (act__)
# 71 "project/radare2/test/unit/test_buf.c" 3 4
)
# 71 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 71, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 71, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r = r_buf_seek (b, 0x100, 
# 74 "project/radare2/test/unit/test_buf.c" 3 4
                          0
# 74 "project/radare2/test/unit/test_buf.c"
                                   );
 do { 
# 75 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 75 "project/radare2/test/unit/test_buf.c"
act__ = (
# 75 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 75 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 75 "project/radare2/test/unit/test_buf.c"
)(0x100); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 75 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 75 "project/radare2/test/unit/test_buf.c"
_meqstr
...
"lld" 
# 75 "project/radare2/test/unit/test_buf.c"
".", ("moving seek out of current length"), (
# 75 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 75 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 75 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 75, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 75, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r = r_buf_write (b, (
# 76 "project/radare2/test/unit/test_buf.c" 3 4
                     unsigned char 
# 76 "project/radare2/test/unit/test_buf.c"
                         *)"mydata", 6);
 do { 
# 77 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 77 "project/radare2/test/unit/test_buf.c"
act__ = (
# 77 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 77 "project/radare2/test/unit/test_buf.c"
...
0
# 77 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 77, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 77, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r = r_buf_read_at (b, 0xf0, buffer, sizeof (buffer));
 do { 
# 79 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 79 "project/radare2/test/unit/test_buf.c"
act__ = (
# 79 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 79 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 79 "project/radare2/test/unit/test_buf.c"
)(0x16); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 79 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 79 "project/radare2/test/unit/test_buf.c"
_meqstr
...
"lld" 
# 79 "project/radare2/test/unit/test_buf.c"
".", ("read 16 bytes at the end of gap and new data"), (
# 79 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 79 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 79 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 79, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 79, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 80 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 80 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 80 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 80 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 80 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "first bytes should be 0"
# 80 "project/radare2/test/unit/test_buf.c" 3 4
)
# 80 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (16)); _meqstr_len = strlen (_meqstr); 
# 80 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 80 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 80 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (16)); do { if (!(memcmp((exp__), (act__), (16)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 80, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 80, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 81 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 81 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer + 0x10); const 
# 81 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 81 "project/radare2/test/unit/test_buf.c"
*exp__ = ((
...
, 2 > 1 ? 1 : 0), 
# 81 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "then there is mydata"
# 81 "project/radare2/test/unit/test_buf.c" 3 4
)
# 81 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (6)); _meqstr_len = strlen (_meqstr); 
# 81 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 81 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 81 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (6)); do { if (!(memcmp((exp__), (act__), (6)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 81, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 81, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_buf_set_bytes (b, (
# 83 "project/radare2/test/unit/test_buf.c" 3 4
                     unsigned char 
# 83 "project/radare2/test/unit/test_buf.c"
                         *)"Hello", 5);
 RBuffer *sec_buf = r_buf_new_with_bytes ((
# 84 "project/radare2/test/unit/test_buf.c" 3 4
                                          unsigned char 
# 84 "project/radare2/test/unit/test_buf.c"
                                              *)" second", 7);
 res = r_buf_append_buf (b, sec_buf);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 86, "append buf should succeed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 86, "append buf should succeed"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 char *st3 = r_buf_to_string (b);
 do { char _meqstr[5120]; const char *act__ = (st3); const char *exp__ = ("Hello second"); 
# 88 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 88 "project/radare2/test/unit/test_buf.c"
_meqstr
# 88 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 88 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 88 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("append buf correctly"), (exp__), (act__)
# 88 "project/radare2/test/unit/test_buf.c" 3 4
)
# 88 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 88, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 88, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (st3);
 r_buf_free (sec_buf);

 sec_buf = r_buf_new_with_bytes ((
# 92 "project/radare2/test/unit/test_buf.c" 3 4
                                 unsigned char 
# 92 "project/radare2/test/unit/test_buf.c"
                                     *)"123456789", 9);
 res = r_buf_append_buf_slice (b, sec_buf, 5, 3);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 94, "append buf slice should succeed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 94, "append buf slice should succeed"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 char *st4 = r_buf_to_string (b);
 do { char _meqstr[5120]; const char *act__ = (st4); const char *exp__ = ("Hello second678"); 
# 96 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 96 "project/radare2/test/unit/test_buf.c"
_meqstr
# 96 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 96 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 96 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("append buf slice correctly"), (exp__), (act__)
# 96 "project/radare2/test/unit/test_buf.c" 3 4
)
# 96 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 96, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 96, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (st4);
 r_buf_free (sec_buf);
...
# 103 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 103 "project/radare2/test/unit/test_buf.c"
    test_r_buf_file(void) {
 RBuffer *b;
 ...
 do { char _meqstr[5120]; 
# 111 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 111 "project/radare2/test/unit/test_buf.c"
act__ = (
# 111 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 111 "project/radare2/test/unit/test_buf.c"
...
; do { if (!((exp__) != (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 111, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 b = r_buf_new_file (filename, 
# 115 "project/radare2/test/unit/test_buf.c" 3 4
                              0x0002
# 115 "project/radare2/test/unit/test_buf.c"
                                    , 0);
 do { char _meqstr[5120]; const void *act__ = (b); 
# 116 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 116 "project/radare2/test/unit/test_buf.c"
_meqstr
# 116 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 116 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 116 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("r_buf_new_file failed")
# 116 "project/radare2/test/unit/test_buf.c" 3 4
)
# 116 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 116 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 116, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 116, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 if (test_buf (b) != 1) {
  do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 119, "test failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 119, "test failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0);
 }
...
# 129 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 129 "project/radare2/test/unit/test_buf.c"
    test_r_buf_bytes(void) {
 RBuffer *b;
 const char *content = "Something To\nSay Here..";
 const int length = 23;

 b = r_buf_new_with_bytes ((const 
# 134 "project/radare2/test/unit/test_buf.c" 3 4
                                 unsigned char 
# 134 "project/radare2/test/unit/test_buf.c"
                                     *)content, length);
 do { char _meqstr[5120]; const void *act__ = (b); 
# 135 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 135 "project/radare2/test/unit/test_buf.c"
_meqstr
# 135 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 135 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 135 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("r_buf_new_with_bytes failed")
# 135 "project/radare2/test/unit/test_buf.c" 3 4
)
# 135 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 135 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 135, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 135, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 if (test_buf (b) != 1) {
  do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 138, "test failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 138, "test failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0);
 }
...
# 146 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 146 "project/radare2/test/unit/test_buf.c"
    test_r_buf_mmap(void) {
 RBuffer *b;
 char *filename = "r2-XXXXXX";
 const char *content = "Something To\nSay Here..";
 const int length = 23;
 ...
 int fd = r_file_mkstemp ("", &filename);
 do { char _meqstr[5120]; 
# 154 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 154 "project/radare2/test/unit/test_buf.c"
act__ = (
# 154 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 154 "project/radare2/test/unit/test_buf.c"
...
# 154 "project/radare2/test/unit/test_buf.c"
; do { if (!((exp__) != (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 154, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 154, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 write (fd, content, length);
 close (fd);

 b = r_buf_new_mmap (filename, 
# 158 "project/radare2/test/unit/test_buf.c" 3 4
                              (4|2)
# 158 "project/radare2/test/unit/test_buf.c"
                                       );
 do { char _meqstr[5120]; const void *act__ = (b); 
# 159 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 159 "project/radare2/test/unit/test_buf.c"
_meqstr
# 159 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 159 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 159 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("r_buf_new_mmap failed")
# 159 "project/radare2/test/unit/test_buf.c" 3 4
)
# 159 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 159 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 159, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 159, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 if (test_buf (b) != 1) {
  unlink(filename);
  do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 163, "test failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 163, "test failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0);
 }
...
# 173 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 173 "project/radare2/test/unit/test_buf.c"
    test_r_buf_io(void) {
 RBuffer *b;
 const char *content = "Something To\nSay Here..";
 const int length = 23;
 ...
 RIO *io = r_io_new ();
 RIODesc *desc = r_io_open_at (io, "file:///tmp/r-buf-io.test", 
# 179 "project/radare2/test/unit/test_buf.c" 3 4
                                                               (4|2) 
# 179 "project/radare2/test/unit/test_buf.c"
                                                                         | 
# 179 "project/radare2/test/unit/test_buf.c" 3 4
                                                                           64
# 179 "project/radare2/test/unit/test_buf.c"
                                                                                       , 0644, 0);
 do { char _meqstr[5120]; const void *act__ = (desc); 
# 180 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 180 "project/radare2/test/unit/test_buf.c"
_meqstr
# 180 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 180 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 180 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("file should be opened for writing")
# 180 "project/radare2/test/unit/test_buf.c" 3 4
)
# 180 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 180 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 180, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 180, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 
# 182 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 182 "project/radare2/test/unit/test_buf.c"
     res = r_io_write_at (io, 0, (
# 182 "project/radare2/test/unit/test_buf.c" 3 4
                                  unsigned char 
# 182 "project/radare2/test/unit/test_buf.c"
                                      *)content, length);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 183, "initial content should be written"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 183, "initial content should be written"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 ...
 do { char _meqstr[5120]; const void *act__ = (b); 
# 189 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 189 "project/radare2/test/unit/test_buf.c"
_meqstr
# 189 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 189 "project/radare2/test/unit/test_buf.c"
...
((void *)0)
# 189 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 189, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 189, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 if (test_buf (b) != 1) {
  do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 192, "test failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 192, "test failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0);
 }
...
# 202 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 202 "project/radare2/test/unit/test_buf.c"
    test_r_buf_sparse(void) {
 RBuffer *b;
 const char *content = "Something To\nSay Here..";
 const int length = 23;
 ...
 do { char _meqstr[5120]; const void *act__ = (b); 
# 208 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 208 "project/radare2/test/unit/test_buf.c"
_meqstr
# 208 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 208 "project/radare2/test/unit/test_buf.c"
...
((void *)0)
# 208 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 208, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 208, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_buf_write (b, (
# 210 "project/radare2/test/unit/test_buf.c" 3 4
                 unsigned char 
# 210 "project/radare2/test/unit/test_buf.c"
                     *)content, length);
 r_buf_seek (b, 0, 
# 211 "project/radare2/test/unit/test_buf.c" 3 4
                  0
# 211 "project/radare2/test/unit/test_buf.c"
                           );

 if (test_buf (b) != 1) {
  do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 214, "test failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 214, "test failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0);
 }
...
# 222 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 222 "project/radare2/test/unit/test_buf.c"
    test_r_buf_sparse2(void) {
 RBuffer *b = r_buf_new_sparse (0xff);
 r_buf_write (b, (
# 224 "project/radare2/test/unit/test_buf.c" 3 4
                 unsigned char 
# 224 "project/radare2/test/unit/test_buf.c"
                     *)"aaaa", 4);
 r_buf_write (b, (
# 225 "project/radare2/test/unit/test_buf.c" 3 4
                 unsigned char 
# 225 "project/radare2/test/unit/test_buf.c"
                     *)"bbbbb", 5);
 r_buf_write (b, (
# 226 "project/radare2/test/unit/test_buf.c" 3 4
                 unsigned char 
# 226 "project/radare2/test/unit/test_buf.c"
                     *)"cccccc", 6);
 r_buf_write_at (b, 2, (
# 227 "project/radare2/test/unit/test_buf.c" 3 4
                       unsigned char 
# 227 "project/radare2/test/unit/test_buf.c"
                           *)"D", 1);
 r_buf_write_at (b, 7, (
# 228 "project/radare2/test/unit/test_buf.c" 3 4
                       unsigned char 
# 228 "project/radare2/test/unit/test_buf.c"
                           *)"EEE", 3);

 
# 230 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 230 "project/radare2/test/unit/test_buf.c"
    tmp[20];
 int r = r_buf_read_at (b, 0, tmp, sizeof (tmp));
 do { 
# 232 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 232 "project/radare2/test/unit/test_buf.c"
act__ = (
# 232 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 232 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 232 "project/radare2/test/unit/test_buf.c"
)(15); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 232 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 232 "project/radare2/test/unit/test_buf.c"
_meqstr
...
# 232 "project/radare2/test/unit/test_buf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 233 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 233 "project/radare2/test/unit/test_buf.c"
*act__ = (tmp); const 
# 233 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 233 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 233 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "read the right bytes"
# 233 "project/radare2/test/unit/test_buf.c" 3 4
)
# 233 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (15)); _meqstr_len = strlen (_meqstr); 
# 233 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 233 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 233 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (15)); do { if (!(memcmp((exp__), (act__), (15)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 233, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 233, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 
# 235 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 235 "project/radare2/test/unit/test_buf.c"
     res = r_buf_resize (b, 0);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 236, "resized to 0"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 236, "resized to 0"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 r = r_buf_read_at (b, 0, tmp, sizeof (tmp));
 do { 
# 239 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 239 "project/radare2/test/unit/test_buf.c"
act__ = (
# 239 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 239 "project/radare2/test/unit/test_buf.c"
...
0
# 239 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 239, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 239, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 r_buf_write_at (b, 3, (
# 241 "project/radare2/test/unit/test_buf.c" 3 4
                       unsigned char 
# 241 "project/radare2/test/unit/test_buf.c"
                           *)"aaaa", 4);
 r = r_buf_read_at (b, 0, tmp, sizeof (tmp));
 do { 
# 243 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 243 "project/radare2/test/unit/test_buf.c"
act__ = (
# 243 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 243 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 243 "project/radare2/test/unit/test_buf.c"
)(7); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 243 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 243 "project/radare2/test/unit/test_buf.c"
_meqstr
...
# 243 "project/radare2/test/unit/test_buf.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 244 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 244 "project/radare2/test/unit/test_buf.c"
*act__ = (tmp); const 
# 244 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 244 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 244 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "right 7 bytes"
# 244 "project/radare2/test/unit/test_buf.c" 3 4
)
# 244 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (7)); _meqstr_len = strlen (_meqstr); 
# 244 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 244 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 244 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (7)); do { if (!(memcmp((exp__), (act__), (7)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 244, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 244, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 res = r_buf_resize (b, 10);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 247, "resized to 10"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 247, "resized to 10"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 
# 249 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 249 "project/radare2/test/unit/test_buf.c"
     sz = r_buf_size (b);
 do { 
# 250 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 250 "project/radare2/test/unit/test_buf.c"
act__ = (
# 250 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 250 "project/radare2/test/unit/test_buf.c"
...
0
# 250 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 250, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 250, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r = r_buf_read_at (b, 0, tmp, sizeof (tmp));
 do { 
# 252 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 252 "project/radare2/test/unit/test_buf.c"
act__ = (
# 252 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 252 "project/radare2/test/unit/test_buf.c"
...
"lld" 
# 252 "project/radare2/test/unit/test_buf.c"
".", ("read the initial/final 0xff bytes"), (
# 252 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 252 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 252 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 252, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 252, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 253 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 253 "project/radare2/test/unit/test_buf.c"
*act__ = (tmp); const 
# 253 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 253 "project/radare2/test/unit/test_buf.c"
...
unsigned char 
# 253 "project/radare2/test/unit/test_buf.c"
*)"\xff\xff\xff\x61\x61\x61\x61\xff\xff\xff"); 
# 253 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 253 "project/radare2/test/unit/test_buf.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 253 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "right 10 bytes"
# 253 "project/radare2/test/unit/test_buf.c" 3 4
)
# 253 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (10)); _meqstr_len = strlen (_meqstr); 
# 253 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 253 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 253 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (10)); do { if (!(memcmp((exp__), (act__), (10)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 253, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 253, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r = r_buf_write_at (b, 0x100, (
# 255 "project/radare2/test/unit/test_buf.c" 3 4
                               unsigned char 
# 255 "project/radare2/test/unit/test_buf.c"
                                   *)"ABCDEF", 6);
 do { 
# 256 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 256 "project/radare2/test/unit/test_buf.c"
act__ = (
# 256 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 256 "project/radare2/test/unit/test_buf.c"
...
0
# 256 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 256, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 256, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r = r_buf_read_at (b, 0xfe, tmp, sizeof (tmp));
 do { 
# 258 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 258 "project/radare2/test/unit/test_buf.c"
act__ = (
# 258 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 258 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 258 "project/radare2/test/unit/test_buf.c"
)(8); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 258 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 258 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 258 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 258, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 258, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 259 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 259 "project/radare2/test/unit/test_buf.c"
*act__ = (tmp); const 
# 259 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 259 "project/radare2/test/unit/test_buf.c"
...
unsigned char 
# 259 "project/radare2/test/unit/test_buf.c"
*)"\xff\xff\x41\x42\x43\x44\x45\x46"); 
# 259 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 259 "project/radare2/test/unit/test_buf.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 259 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "right bytes"
# 259 "project/radare2/test/unit/test_buf.c" 3 4
)
# 259 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
# 259 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 259 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 259 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 259, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 259, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 sz = r_buf_size (b);
 do { 
# 262 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 262 "project/radare2/test/unit/test_buf.c"
act__ = (
# 262 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 262 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 262 "project/radare2/test/unit/test_buf.c"
)(0x106); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 262 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 262 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 262 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 262, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 262, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
...
# 268 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 268 "project/radare2/test/unit/test_buf.c"
    test_r_buf_bytes_steal(void) {
 RBuffer *b;
 const char *content = "Something To\nSay Here..";
 const int length = 23;

 b = r_buf_new_with_bytes ((const 
# 273 "project/radare2/test/unit/test_buf.c" 3 4
                                 unsigned char 
# 273 "project/radare2/test/unit/test_buf.c"
                                     *)content, length);
 do { char _meqstr[5120]; const void *act__ = (b); 
# 274 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 274 "project/radare2/test/unit/test_buf.c"
_meqstr
# 274 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 274 "project/radare2/test/unit/test_buf.c"
...
((void *)0)
# 274 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 274, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 274, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 char *s = r_buf_to_string (b);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = (content); 
# 276 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 276 "project/radare2/test/unit/test_buf.c"
_meqstr
# 276 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 276 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 276 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("content is right"), (exp__), (act__)
# 276 "project/radare2/test/unit/test_buf.c" 3 4
)
# 276 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 276, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 276, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (s);
...
# 284 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 284 "project/radare2/test/unit/test_buf.c"
    test_r_buf_format(void) {
 RBuffer *b = r_buf_new ();
 uint16_t a[] = {0xdead, 0xbeef, 0xcafe, 0xbabe};
 
# 287 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 287 "project/radare2/test/unit/test_buf.c"
    buf[4 * sizeof (uint16_t)];

 r_buf_fwrite (b, (
# 289 "project/radare2/test/unit/test_buf.c" 3 4
                  unsigned char 
# 289 "project/radare2/test/unit/test_buf.c"
                      *)a, "4s", 1);
 r_buf_read_at (b, 0, buf, sizeof (buf));
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 291 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 291 "project/radare2/test/unit/test_buf.c"
*act__ = (buf); const 
# 291 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 291 "project/radare2/test/unit/test_buf.c"
...
unsigned char 
# 291 "project/radare2/test/unit/test_buf.c"
*)"\xad\xde\xef\xbe\xfe\xca\xbe\xba"); 
# 291 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 291 "project/radare2/test/unit/test_buf.c"
_meqstr
...
# 291 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (sizeof(buf))); _meqstr_len = strlen (_meqstr); 
# 291 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 291 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 291 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (sizeof(buf))); do { if (!(memcmp((exp__), (act__), (sizeof(buf))) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 291, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 291, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_buf_fread_at (b, 0, (
# 293 "project/radare2/test/unit/test_buf.c" 3 4
                       unsigned char 
# 293 "project/radare2/test/unit/test_buf.c"
                           *)a, "S", 4);
 do { 
# 294 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 294 "project/radare2/test/unit/test_buf.c"
act__ = (
# 294 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 294 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 294 "project/radare2/test/unit/test_buf.c"
)(0xadde); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 294 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 294 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 294 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 294, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 294, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 295 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 295 "project/radare2/test/unit/test_buf.c"
act__ = (
# 295 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 295 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 295 "project/radare2/test/unit/test_buf.c"
)(0xefbe); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 295 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 295 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 295 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 295, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 295, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 296 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 296 "project/radare2/test/unit/test_buf.c"
act__ = (
# 296 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 296 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 296 "project/radare2/test/unit/test_buf.c"
)(0xfeca); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 296 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 296 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 296 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 296, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 296, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 297 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 297 "project/radare2/test/unit/test_buf.c"
act__ = (
# 297 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 297 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 297 "project/radare2/test/unit/test_buf.c"
)(0xbeba); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 297 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 297 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 297 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 297, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 297, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
...
# 303 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 303 "project/radare2/test/unit/test_buf.c"
    test_r_buf_with_buf(void) {
 const char *content = "Something To\nSay Here..";
 const int length = 23;
 RBuffer *buf = r_buf_new_with_bytes ((
# 306 "project/radare2/test/unit/test_buf.c" 3 4
                                      unsigned char 
# 306 "project/radare2/test/unit/test_buf.c"
                                          *)content, length);

 RBuffer *b = r_buf_new_with_buf (buf);
 do { char _meqstr[5120]; const void *act__ = (b); 
# 309 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 309 "project/radare2/test/unit/test_buf.c"
_meqstr
# 309 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 309 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 309 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("r_buf_new_with_buf failed")
# 309 "project/radare2/test/unit/test_buf.c" 3 4
)
# 309 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 309 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 309, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 309, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_buf_free (buf);

 if (test_buf (b) != 1) {
  do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 313, "r_buf_with_buf failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 313, "r_buf_with_buf failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0);
 }
...
# 321 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 321 "project/radare2/test/unit/test_buf.c"
    test_r_buf_slice(void) {
 const char *content = "AAAAAAAAAASomething To\nSay Here..BBBBBBBBBB";
 const int length = strlen (content);
 RBuffer *buf = r_buf_new_with_bytes ((
# 324 "project/radare2/test/unit/test_buf.c" 3 4
                                      unsigned char 
# 324 "project/radare2/test/unit/test_buf.c"
                                          *)content, length);
 
# 325 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 325 "project/radare2/test/unit/test_buf.c"
    buffer[1024];

 RBuffer *b = r_buf_new_slice (buf, 10, 23);
 do { char _meqstr[5120]; const void *act__ = (b); 
# 328 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 328 "project/radare2/test/unit/test_buf.c"
_meqstr
# 328 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 328 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 328 "project/radare2/test/unit/test_buf.c"
"%s: expected to not be NULL but it was.", ("r_buf_new_slice failed")
# 328 "project/radare2/test/unit/test_buf.c" 3 4
)
# 328 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) != 
...
((void *)0)
# 328 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 328, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 328, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 
# 330 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 330 "project/radare2/test/unit/test_buf.c"
     buf_sz = r_buf_size (b);
 do { 
# 331 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 331 "project/radare2/test/unit/test_buf.c"
act__ = (
# 331 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 331 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 331 "project/radare2/test/unit/test_buf.c"
)(23); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 331 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 331 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 331 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 331, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 331, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 int r = r_buf_read_at (b, 0, buffer, 23);
 do { 
# 334 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 334 "project/radare2/test/unit/test_buf.c"
act__ = (
# 334 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 334 "project/radare2/test/unit/test_buf.c"
...
0
# 334 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 334, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 334, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 335 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 335 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 335 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 335 "project/radare2/test/unit/test_buf.c"
...
# 335 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (23)); _meqstr_len = strlen (_meqstr); 
# 335 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 335 "project/radare2/test/unit/test_buf.c"
_meqstr + _meqstr_len
...
# 335 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (23)); do { if (!(memcmp((exp__), (act__), (23)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 335, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 335, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_buf_seek (b, 3, 
# 337 "project/radare2/test/unit/test_buf.c" 3 4
                  0
# 337 "project/radare2/test/unit/test_buf.c"
                           );
 r = r_buf_read (b, buffer, 3);
 do { 
# 339 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 339 "project/radare2/test/unit/test_buf.c"
act__ = (
# 339 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 339 "project/radare2/test/unit/test_buf.c"
...
0
# 339 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 339, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 339, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 340 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 340 "project/radare2/test/unit/test_buf.c"
*act__ = (buffer); const 
# 340 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 340 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 340 "project/radare2/test/unit/test_buf.c"
"%s: expected ", "base should be considered"
# 340 "project/radare2/test/unit/test_buf.c" 3 4
)
# 340 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (3)); _meqstr_len = strlen (_meqstr); 
...
# 340 "project/radare2/test/unit/test_buf.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (3)); do { if (!(memcmp((exp__), (act__), (3)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 340, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 340, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r = r_buf_read (b, buffer, 40);
 do { 
# 343 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 343 "project/radare2/test/unit/test_buf.c"
act__ = (
# 343 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 343 "project/radare2/test/unit/test_buf.c"
...
unsigned long long
# 343 "project/radare2/test/unit/test_buf.c"
)(23 - 6); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 343 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 343 "project/radare2/test/unit/test_buf.c"
_meqstr
...
0
# 343 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 343, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 343, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 
# 345 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 345 "project/radare2/test/unit/test_buf.c"
     res = r_buf_resize (b, 30);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 346, "file should be resized"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 346, "file should be resized"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 buf_sz = r_buf_size (b);
 do { 
# 348 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 348 "project/radare2/test/unit/test_buf.c"
act__ = (
# 348 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 348 "project/radare2/test/unit/test_buf.c"
...
0
# 348 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 348, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 348, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
...
# 356 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 356 "project/radare2/test/unit/test_buf.c"
    test_r_buf_get_string(void) {
 
# 357 "project/radare2/test/unit/test_buf.c" 3 4
unsigned char 
# 357 "project/radare2/test/unit/test_buf.c"
    *ch = malloc (128);
 
# 358 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___memset_chk (
# 358 "project/radare2/test/unit/test_buf.c"
ch
# 358 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 358 "project/radare2/test/unit/test_buf.c"
...
# 358 "project/radare2/test/unit/test_buf.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ((char *)ch + 100); 
# 362 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 362 "project/radare2/test/unit/test_buf.c"
_meqstr
# 362 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 362 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 362 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("the string is the same"), (exp__), (act__)
# 362 "project/radare2/test/unit/test_buf.c" 3 4
)
# 362 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 362, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 362, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (s);
 s = r_buf_get_string (b, 0);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ((char *)ch); 
# 365 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 365 "project/radare2/test/unit/test_buf.c"
_meqstr
# 365 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 365 "project/radare2/test/unit/test_buf.c"
...
# 365 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 365, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 365, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (s);
 s = r_buf_get_string (b, 127);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("\x00"); 
# 368 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 368 "project/radare2/test/unit/test_buf.c"
_meqstr
# 368 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 368 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 368 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("the string is empty"), (exp__), (act__)
# 368 "project/radare2/test/unit/test_buf.c" 3 4
)
# 368 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 368, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 368, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (s);
 r_buf_free (b);
 free (ch);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
...
# 375 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 375 "project/radare2/test/unit/test_buf.c"
    test_r_buf_get_string_nothing(void) {
 RBuffer *b = r_buf_new_with_bytes ((
# 376 "project/radare2/test/unit/test_buf.c" 3 4
                                    unsigned char 
# 376 "project/radare2/test/unit/test_buf.c"
                                        *)"\x33\x22", 2);
 char *s = r_buf_get_string (b, 0);
 do { char _meqstr[5120]; const void *act__ = (s); 
# 378 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 378 "project/radare2/test/unit/test_buf.c"
_meqstr
# 378 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 378 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 378 "project/radare2/test/unit/test_buf.c"
"%s: expected to be NULL but it wasn't.", ("there is no string in the buffer (no null terminator)")
# 378 "project/radare2/test/unit/test_buf.c" 3 4
)
# 378 "project/radare2/test/unit/test_buf.c"
; do { if (!((act__) == 
...
((void *)0)
# 378 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 378, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 378, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_buf_append_bytes (b, (
# 379 "project/radare2/test/unit/test_buf.c" 3 4
                        unsigned char 
# 379 "project/radare2/test/unit/test_buf.c"
                            *)"\x00", 1);
 s = r_buf_get_string (b, 0);
 do { char _meqstr[5120]; const char *act__ = (s); const char *exp__ = ("\x33\x22"); 
# 381 "project/radare2/test/unit/test_buf.c" 3 4
__builtin___snprintf_chk (
# 381 "project/radare2/test/unit/test_buf.c"
_meqstr
# 381 "project/radare2/test/unit/test_buf.c" 3 4
, 
# 381 "project/radare2/test/unit/test_buf.c"
...
, 2 > 1 ? 1 : 0), 
# 381 "project/radare2/test/unit/test_buf.c"
"%s: expected %s, got %s.", ("now there is a string because of the null terminator"), (exp__), (act__)
# 381 "project/radare2/test/unit/test_buf.c" 3 4
)
# 381 "project/radare2/test/unit/test_buf.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 381, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 381, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (s);
 r_buf_free (b);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}
...
# 387 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 387 "project/radare2/test/unit/test_buf.c"
    test_r_buf_slice_too_big(void) {
 RBuffer *buf = r_buf_new_with_bytes ((
# 388 "project/radare2/test/unit/test_buf.c" 3 4
                                      unsigned char 
# 388 "project/radare2/test/unit/test_buf.c"
                                          *)"AAAA", 4);
 RBuffer *sl = r_buf_new_slice (buf, 1, 5);
 
# 390 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 390 "project/radare2/test/unit/test_buf.c"
     sz = r_buf_size (sl);
 do { 
# 391 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 391 "project/radare2/test/unit/test_buf.c"
act__ = (
# 391 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 391 "project/radare2/test/unit/test_buf.c"
...
"lld" 
# 391 "project/radare2/test/unit/test_buf.c"
".", ("the size cannot be more than the original buffer"), (
# 391 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 391 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 391 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 391, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 391, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_buf_resize (sl, 1);
 sz = r_buf_size (sl);
 do { 
# 394 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 394 "project/radare2/test/unit/test_buf.c"
act__ = (
# 394 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 394 "project/radare2/test/unit/test_buf.c"
...
"lld" 
# 394 "project/radare2/test/unit/test_buf.c"
".", ("it should be shrinked to 1 byte"), (
# 394 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 394 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 394 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 394, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 394, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 
# 395 "project/radare2/test/unit/test_buf.c" 3 4
_Bool 
# 395 "project/radare2/test/unit/test_buf.c"
     res = r_buf_resize (sl, 7);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 396, "the resize should be successful"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 396, "the resize should be successful"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 sz = r_buf_size (sl);
 do { 
# 398 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long 
# 398 "project/radare2/test/unit/test_buf.c"
act__ = (
# 398 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 398 "project/radare2/test/unit/test_buf.c"
...
"lld" 
# 398 "project/radare2/test/unit/test_buf.c"
".", ("but it should just use the biggest value"), (
# 398 "project/radare2/test/unit/test_buf.c" 3 4
unsigned long long
# 398 "project/radare2/test/unit/test_buf.c"
)(exp__), (
...
0
# 398 "project/radare2/test/unit/test_buf.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 398, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 398, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 r_buf_free (sl);
 r_buf_free (buf);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_file"); result = test_r_buf_file(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_bytes"); result = test_r_buf_bytes(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_mmap"); result = test_r_buf_mmap(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_with_buf"); result = test_r_buf_with_buf(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_slice"); result = test_r_buf_slice(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_io"); result = test_r_buf_io(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_sparse"); result = test_r_buf_sparse(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_sparse2"); result = test_r_buf_sparse2(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_bytes_steal"); result = test_r_buf_bytes_steal(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_format"); result = test_r_buf_format(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_get_string"); result = test_r_buf_get_string(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_get_string_nothing"); result = test_r_buf_get_string_nothing(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_buf_slice_too_big"); result = test_r_buf_slice_too_big(); tests_run++; tests_passed += result; } while (0);
