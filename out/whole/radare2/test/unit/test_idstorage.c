# 0 "project/radare2/test/unit/test_idstorage.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/test/unit/test_idstorage.c"
...
# 2 "project/radare2/test/unit/test_idstorage.c" 2
...
# 3 "project/radare2/test/unit/test_idstorage.c" 2


# 4 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_idstorage.c"
    test_r_id_storage_add0(void) {
 char *str = "lol";
 RIDStorage *ids = r_id_storage_new (5, 23);
 
# 7 "project/radare2/test/unit/test_idstorage.c" 3 4
unsigned int 
# 7 "project/radare2/test/unit/test_idstorage.c"
     id;
 
# 8 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 8 "project/radare2/test/unit/test_idstorage.c"
     success = r_id_storage_add (ids, str, &id);
 void *ptr = r_id_storage_get (ids, id);
 r_id_storage_free (ids);
 do { if (!(success && (ptr == str))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 11, "id_storage_add 0"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 11, "id_storage_add 0"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 15 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 15 "project/radare2/test/unit/test_idstorage.c"
    test_r_id_storage_add1(void) {
 char *str = "lol";
 RIDStorage *ids = r_id_storage_new (0, 4);
 
# 18 "project/radare2/test/unit/test_idstorage.c" 3 4
unsigned int 
# 18 "project/radare2/test/unit/test_idstorage.c"
     id;
...
# 23 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 23 "project/radare2/test/unit/test_idstorage.c"
     success = r_id_storage_add (ids, str, &id);
 r_id_storage_free (ids);
 do { if (!(!success)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 25, "id_storage_add 1"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 25, "id_storage_add 1"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 29 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 29 "project/radare2/test/unit/test_idstorage.c"
    test_r_id_storage_set(void) {
 char *str = "lol";
 RIDStorage *ids = r_id_storage_new (5, 23);
 r_id_storage_set (ids, str, 1);
 void *ptr = r_id_storage_get (ids, 1);
 r_id_storage_free (ids);
 do { char _meqstr[5120]; const void *act__ = (ptr); const void *exp__ = (str); 
# 35 "project/radare2/test/unit/test_idstorage.c" 3 4
__builtin___snprintf_chk (
# 35 "project/radare2/test/unit/test_idstorage.c"
_meqstr
# 35 "project/radare2/test/unit/test_idstorage.c" 3 4
, 
# 35 "project/radare2/test/unit/test_idstorage.c"
...
, 2 > 1 ? 1 : 0), 
# 35 "project/radare2/test/unit/test_idstorage.c"
"%s: expected %p, got %p.", ("id_storage_set"), (exp__), (act__)
# 35 "project/radare2/test/unit/test_idstorage.c" 3 4
)
# 35 "project/radare2/test/unit/test_idstorage.c"
...
# 39 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 39 "project/radare2/test/unit/test_idstorage.c"
    test_r_id_storage_delete(void) {
 RIDStorage *ids = r_id_storage_new (5, 23);
 
# 41 "project/radare2/test/unit/test_idstorage.c" 3 4
unsigned int 
# 41 "project/radare2/test/unit/test_idstorage.c"
     id;
 r_id_storage_add (ids, "lol", &id);
 r_id_storage_delete (ids, id);
 void *ptr = r_id_storage_get (ids, id);
 r_id_storage_free (ids);
 do { char _meqstr[5120]; const void *act__ = (ptr); const void *exp__ = (
# 46 "project/radare2/test/unit/test_idstorage.c" 3 4
((void *)0)
# 46 "project/radare2/test/unit/test_idstorage.c"
); 
# 46 "project/radare2/test/unit/test_idstorage.c" 3 4
__builtin___snprintf_chk (
# 46 "project/radare2/test/unit/test_idstorage.c"
...
, 2 > 1 ? 1 : 0), 
# 46 "project/radare2/test/unit/test_idstorage.c"
"%s: expected %p, got %p.", ("id_storage_delete"), (exp__), (act__)
# 46 "project/radare2/test/unit/test_idstorage.c" 3 4
)
# 46 "project/radare2/test/unit/test_idstorage.c"
...
# 50 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 50 "project/radare2/test/unit/test_idstorage.c"
    test_r_id_storage_take0(void) {
 char *str = "lol";
 RIDStorage *ids = r_id_storage_new (5, 23);
 
# 53 "project/radare2/test/unit/test_idstorage.c" 3 4
unsigned int 
# 53 "project/radare2/test/unit/test_idstorage.c"
     id;
 r_id_storage_add (ids, str, &id);
 void *ptr = r_id_storage_take (ids, id);
 r_id_storage_free (ids);
 do { char _meqstr[5120]; const void *act__ = (ptr); const void *exp__ = (str); 
# 57 "project/radare2/test/unit/test_idstorage.c" 3 4
__builtin___snprintf_chk (
# 57 "project/radare2/test/unit/test_idstorage.c"
_meqstr
# 57 "project/radare2/test/unit/test_idstorage.c" 3 4
, 
# 57 "project/radare2/test/unit/test_idstorage.c"
...
, 2 > 1 ? 1 : 0), 
# 57 "project/radare2/test/unit/test_idstorage.c"
"%s: expected %p, got %p.", ("id_storage_take 0"), (exp__), (act__)
# 57 "project/radare2/test/unit/test_idstorage.c" 3 4
)
# 57 "project/radare2/test/unit/test_idstorage.c"
...
# 61 "project/radare2/test/unit/test_idstorage.c" 3 4
_Bool 
# 61 "project/radare2/test/unit/test_idstorage.c"
    test_r_id_storage_take1(void) {
 char *str = "lol";
 RIDStorage *ids = r_id_storage_new (5, 23);
 
# 64 "project/radare2/test/unit/test_idstorage.c" 3 4
unsigned int 
# 64 "project/radare2/test/unit/test_idstorage.c"
     id;
 r_id_storage_add (ids, str, &id);
 ...
 r_id_storage_free (ids);
 do { char _meqstr[5120]; const void *act__ = (ptr); const void *exp__ = (
# 69 "project/radare2/test/unit/test_idstorage.c" 3 4
((void *)0)
# 69 "project/radare2/test/unit/test_idstorage.c"
); 
# 69 "project/radare2/test/unit/test_idstorage.c" 3 4
__builtin___snprintf_chk (
# 69 "project/radare2/test/unit/test_idstorage.c"
...
, 2 > 1 ? 1 : 0), 
# 69 "project/radare2/test/unit/test_idstorage.c"
"%s: expected %p, got %p.", ("id_storage_take 1"), (exp__), (act__)
# 69 "project/radare2/test/unit/test_idstorage.c" 3 4
)
# 69 "project/radare2/test/unit/test_idstorage.c"
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_storage_add0"); result = test_r_id_storage_add0(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_storage_add1"); result = test_r_id_storage_add1(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_storage_set"); result = test_r_id_storage_set(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_storage_delete"); result = test_r_id_storage_delete(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_storage_take0"); result = test_r_id_storage_take0(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_storage_take1"); result = test_r_id_storage_take1(); tests_run++; tests_passed += result; } while (0);
