# 0 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 2

# 1 "/usr/local/include/GeoIP.h" 1 3 4
# 22 "/usr/local/include/GeoIP.h" 3 4
#define GEOIP_H 
# 46 "/usr/local/include/GeoIP.h" 3 4
...
# 166 "/usr/local/include/GeoIP.h" 3 4
#define GEOIP_API 
#define GEOIP_DATA 


extern char **GeoIPDBFileName;
extern const char *GeoIPDBDescription[(38 + 1)];
...
# 202 "/usr/local/include/GeoIP.h" 3 4
...
# 13 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 2
# 1 "/usr/local/include/GeoIPCity.h" 1 3 4
# 22 "/usr/local/include/GeoIPCity.h" 3 4
#define GEOIPCITY_H 

# 1 "/usr/local/include/GeoIP.h" 1 3 4
# 25 "/usr/local/include/GeoIPCity.h" 2 3 4
...
# 14 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 2
...
# 21 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
typedef struct {
    GeoIP *country;
    GeoIP *org;
    GeoIP *city;
...
# 67 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
static ngx_command_t ngx_http_geoip_commands[] = {
    ...
    { 
# 99 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 99 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_country"
# 99 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 99 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 100 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     0x02000000
# 100 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       |
# 100 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
...
# 102 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 102 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                              ,
      0,
      
# 104 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ((void *)0) 
# 104 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
          },

    { 
# 106 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 106 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_org"
# 106 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 106 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 107 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     0x02000000
# 107 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       |
# 107 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                        (0x00000002|0x00000004)
# 107 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 109 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 109 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                              ,
      0,
      
# 111 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ((void *)0) 
# 111 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
          },

    { 
# 113 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 113 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_city"
# 113 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 113 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 114 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     0x02000000
# 114 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       |
# 114 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                        (0x00000002|0x00000004)
# 114 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 116 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 116 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                              ,
      0,
      
# 118 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ((void *)0) 
# 118 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
          },

    { 
# 120 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 120 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_proxy"
# 120 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 120 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 121 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     0x02000000
# 121 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       |
# 121 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                        0x00000002
# 121 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 123 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 123 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                              ,
      0,
      
# 125 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ((void *)0) 
# 125 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
          },

    { 
# 127 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 127 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 128 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     0x02000000
# 128 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       |
# 128 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                        0x00000200
# 128 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 130 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 130 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                              ,
      
# 131 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 131 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     ngx_http_geoip_conf_t
# 131 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 131 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 132 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ((void *)0) 
# 132 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
          },

      
# 134 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 135 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
};
...
# 140 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 140 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
...
# 145 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 145 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 146 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 146 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,

    
# 148 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 148 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 149 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)

# 150 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
};


ngx_module_t ngx_http_geoip_module = {
    
# 154 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 154 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
   "8" 
# 154 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   "," 
# 154 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 157 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   0x50545448
# 157 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ,
    
# 158 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 158 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 159 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 159 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 160 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 160 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 161 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 161 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 162 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 162 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 163 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 163 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 164 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   ((void *)0)
# 164 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       ,
    
# 165 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 166 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
};
...
static ngx_http_variable_t ngx_http_geoip_vars[] = {
    ...
    { 
# 171 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 171 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_country_code"
# 171 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 171 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 171 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 175 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 175 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_country_code3"
# 175 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 175 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 175 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 179 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 179 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_country_name"
# 179 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 179 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 179 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 183 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 183 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_org"
# 183 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 183 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 183 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 187 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 187 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 189 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 189 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 189 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 189 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 189 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 191 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 191 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 193 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 193 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 193 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 193 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 193 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 195 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 195 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 197 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 197 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 197 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 197 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 197 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 199 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 199 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 201 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 201 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 201 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 201 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 201 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 203 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 203 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_region"
# 203 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 203 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 205 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 205 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 205 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 205 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 205 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 207 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 207 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_region_name"
# 207 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 207 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 207 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 211 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 211 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_city"
# 211 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 211 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 213 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 213 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 213 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 213 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 213 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 215 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 215 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_postal_code"
# 215 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 215 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 217 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 217 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 217 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 217 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 217 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 219 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 219 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_latitude"
# 219 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 219 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 221 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 221 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 221 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 221 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 221 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 223 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 223 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_longitude"
# 223 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 223 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 225 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 225 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 225 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 225 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 225 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 227 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 227 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_dma_code"
# 227 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 227 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 229 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 229 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 229 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 229 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 229 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    { 
# 231 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { sizeof(
# 231 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     "geoip_area_code"
# 231 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 231 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 233 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     __builtin_offsetof (
# 233 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
     GeoIPRecord
# 233 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     , 
# 233 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 235 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 236 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
};
...
ngx_http_geoip_addr(ngx_http_request_t *r, ngx_http_geoip_conf_t *gcf)
{
    ...
    if (xfwd->nelts > 0 && gcf->proxies != 
# 252 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                          ((void *)0)
# 252 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                              ) {
        (void) ngx_http_get_forwarded_addr(r, &addr, xfwd, 
# 253 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                                          ((void *)0)
# 253 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                                              ,
    ...
    if (addr.sockaddr->sa_family == 
# 259 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                   30
# 259 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                           ) {
        u_char *p;
        in_addr_t inaddr;
        ...
        if (
# 266 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           ((*(const __uint32_t *)(const void *)(&(
# 266 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
           inaddr6
# 266 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
...
# 266 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
            ...
            p = inaddr6->
# 267 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                        __u6_addr.__u6_addr8
# 267 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                               ;
    ...
    if (addr.sockaddr->sa_family != 
# 280 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                   2
# 280 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                          ) {
        return 
# 281 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              0xffffffff
# 281 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                         ;
    }

    sin = (struct sockaddr_in *) addr.sockaddr;
    return 
# 285 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          (__builtin_constant_p(
# 285 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
          sin->sin_addr.s_addr
# 285 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
...
# 340 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
static ngx_int_t
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    gcf = 
# 354 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         (
# 354 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
         r
# 354 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         )->main_conf[
# 354 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 354 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    if (gcf->country == 
# 356 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                       ((void *)0)
# 356 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                           ) {
        goto not_found;
    }
    ...
    if (val == 
# 368 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 368 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ) {
        goto not_found;
    }

    v->len = 
# 372 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
            strlen((const char *) 
# 372 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
            val
# 372 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
            )
# 372 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    return 
# 378 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 378 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 384 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 384 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    gcf = 
# 396 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         (
# 396 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
         r
# 396 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         )->main_conf[
# 396 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 396 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    if (gcf->org == 
# 398 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                   ((void *)0)
# 398 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ) {
        goto not_found;
    }
# 409 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    val = GeoIP_name_by_ipnum(gcf->org, ngx_http_geoip_addr(r, gcf));


    if (val == 
# 412 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 412 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ) {
        goto not_found;
    }

    len = 
# 416 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         strlen((const char *) 
# 416 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
         val
# 416 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         )
# 416 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    if (v->data == 
# 418 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  ((void *)0)
# 418 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
        
# 419 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
       free
# 419 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
               (val);
        return 
# 420 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              -1
# 420 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ;
    }

    
# 423 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 423 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
   v->data
# 423 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   , 
# 423 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 430 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   free
# 430 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
           (val);

    return 
# 432 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 432 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 438 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 438 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (gr == 
# 451 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
             ((void *)0)
# 451 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                 ) {
        goto not_found;
    }
    ...
    if (val == 
# 456 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 456 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ) {
        goto no_value;
    }

    len = 
# 460 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         strlen((const char *) 
# 460 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
         val
# 460 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         )
# 460 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    v->data = ngx_pnalloc(r->pool, len);
    if (v->data == 
# 462 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  ((void *)0)
# 462 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
        GeoIPRecord_delete(gr);
        return 
# 464 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              -1
# 464 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ;
    }

    
# 467 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 467 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
   v->data
# 467 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   , 
# 467 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 467 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    return 
# 476 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 476 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 486 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 486 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    gr = ngx_http_geoip_get_city_record(r);
    if (gr == 
# 499 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
             ((void *)0)
# 499 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                 ) {
        goto not_found;
    }
    ...
    if (val == 
# 507 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 507 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ) {
        goto not_found;
    }

    len = 
# 511 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         strlen((const char *) 
# 511 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
         val
# 511 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         )
# 511 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    v->data = ngx_pnalloc(r->pool, len);
    if (v->data == 
# 513 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  ((void *)0)
# 513 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
        return 
# 514 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              -1
# 514 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ;
    }

    
# 517 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 517 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
   v->data
# 517 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   , 
# 517 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 517 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    return 
# 524 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 524 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 530 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 530 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    gr = ngx_http_geoip_get_city_record(r);
    if (gr == 
# 542 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
             ((void *)0)
# 542 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                 ) {
        v->not_found = 1;
        return 
# 544 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              0
# 544 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                    ;
    }

    v->data = ngx_pnalloc(r->pool, 
# 547 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                  (sizeof("-9223372036854775808") - 1) 
# 547 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                                + 5);
    if (v->data == 
# 548 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  ((void *)0)
# 548 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
        GeoIPRecord_delete(gr);
        return 
# 550 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              -1
# 550 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ;
    }
    ...
    return 
# 562 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 562 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    gr = ngx_http_geoip_get_city_record(r);
    if (gr == 
# 574 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
             ((void *)0)
# 574 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                 ) {
        v->not_found = 1;
        return 
# 576 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              0
# 576 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                    ;
    }

    v->data = ngx_pnalloc(r->pool, 
# 579 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                  (sizeof("-9223372036854775808") - 1)
# 579 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                               );
    if (v->data == 
# 580 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  ((void *)0)
# 580 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
        GeoIPRecord_delete(gr);
        return 
# 582 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              -1
# 582 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ;
    }
    ...
    return 
# 594 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 594 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
...
ngx_http_geoip_get_city_record(ngx_http_request_t *r)
{
    ...
    gcf = 
# 603 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         (
# 603 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
         r
# 603 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
         )->main_conf[
# 603 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 603 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    return 
# 617 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          ((void *)0)
# 617 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
              ;
}
...
ngx_http_geoip_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_http_geoip_vars; v->name.len; v++) {
        ...
        if (var == 
# 628 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  ((void *)0)
# 628 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
            return 
# 629 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  -1
# 629 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                           ;
        }
    ...
    return 
# 636 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 636 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
...
ngx_http_geoip_create_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 647 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
               ((void *)0)
# 647 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                   ) {
        return 
# 648 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 648 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ;
    }

    conf->proxy_recursive = 
# 651 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                           -1
# 651 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                         ;

    cln = ngx_pool_cleanup_add(cf->pool, 0);
    if (cln == 
# 654 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 654 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ) {
        return 
# 655 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 655 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                  ;
    }
...
# 670 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   if (
# 670 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
   gcf->proxy_recursive 
# 670 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
   == -1) { 
# 670 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 670 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    ...
    return 
# 672 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          ((void *)0)
# 672 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                     ;
}
...
ngx_http_geoip_country(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (gcf->country == 
# 691 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                       ((void *)0)
# 691 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                           ) {
        ngx_conf_log_error(
# 692 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 692 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0,
                           "GeoIP_open(\"%V\") failed", &value[1]);

        return 
# 695 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 695 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }

    if (cf->args->nelts == 3) {
        if (
# 699 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           strcmp((const char *) 
# 699 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
           value[2].data
# 699 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           , (const char *) 
# 699 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 699 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
            ...
            ngx_conf_log_error(
# 703 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                              1
# 703 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 705 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  (void *) -1
# 705 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                ;
        }
    }
    ...
    case GEOIP_COUNTRY_EDITION:
        ...
        return 
# 713 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 713 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                         ;
# 722 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    default:
        ngx_conf_log_error(
# 723 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 723 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0,
                           "invalid GeoIP database \"%V\" type:%d",
                           &value[1], gcf->country->databaseType);
        return 
# 726 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 726 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }
}
...
ngx_http_geoip_org(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (gcf->org == 
# 746 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                   ((void *)0)
# 746 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ) {
        ngx_conf_log_error(
# 747 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 747 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0,
                           "GeoIP_open(\"%V\") failed", &value[1]);

        return 
# 750 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 750 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }

    if (cf->args->nelts == 3) {
        if (
# 754 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           strcmp((const char *) 
# 754 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
           value[2].data
# 754 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           , (const char *) 
# 754 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 754 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
            ...
            ngx_conf_log_error(
# 758 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                              1
# 758 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 760 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  (void *) -1
# 760 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                ;
        }
    }
    ...
    case GEOIP_ASNUM_EDITION:
        ...
        return 
# 771 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 771 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                         ;
# 783 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    default:
        ngx_conf_log_error(
# 784 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 784 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0,
                           "invalid GeoIP database \"%V\" type:%d",
                           &value[1], gcf->org->databaseType);
        return 
# 787 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 787 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }
}
...
ngx_http_geoip_city(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (gcf->city == 
# 807 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                    ((void *)0)
# 807 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                        ) {
        ngx_conf_log_error(
# 808 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 808 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0,
                           "GeoIP_open(\"%V\") failed", &value[1]);

        return 
# 811 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 811 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }

    if (cf->args->nelts == 3) {
        if (
# 815 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           strcmp((const char *) 
# 815 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
           value[2].data
# 815 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
           , (const char *) 
# 815 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 815 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
            ...
            ngx_conf_log_error(
# 819 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                              1
# 819 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 821 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  (void *) -1
# 821 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                ;
        }
    }
    ...
    case GEOIP_CITY_EDITION_REV1:
        ...
        return 
# 830 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              ((void *)0)
# 830 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                         ;
# 840 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
    default:
        ngx_conf_log_error(
# 841 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 841 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0,
                           "invalid GeoIP City database \"%V\" type:%d",
                           &value[1], gcf->city->databaseType);
        return 
# 844 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 844 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }
}
...
ngx_http_geoip_proxy(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_http_geoip_cidr_value(cf, &value[1], &cidr) != 
# 859 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                                                          0
# 859 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                                                ) {
        return 
# 860 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 860 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }

    if (gcf->proxies == 
# 863 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                       ((void *)0)
# 863 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                           ) {
        gcf->proxies = ngx_array_create(cf->pool, 4, sizeof(ngx_cidr_t));
        if (gcf->proxies == 
# 865 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                           ((void *)0)
# 865 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                               ) {
            return 
# 866 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                  (void *) -1
# 866 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                ;
        }
    }
    ...
    if (c == 
# 871 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
            ((void *)0)
# 871 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ) {
        return 
# 872 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              (void *) -1
# 872 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                            ;
    }
    ...
    *c = cidr;
    ...
    return 
# 877 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          ((void *)0)
# 877 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                     ;
}
...
ngx_http_geoip_cidr_value(ngx_conf_t *cf, ngx_str_t *net, ngx_cidr_t *cidr)
{
    ...
    if (
# 885 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
       strcmp((const char *) 
# 885 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
       net->data
# 885 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
       , (const char *) 
# 885 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
...
# 885 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                                == 0) {
        cidr->family = 
# 886 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                      2
# 886 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                             ;
        cidr->u.in.addr = 0xffffffff;
        cidr->u.in.mask = 0xffffffff;

        return 
# 890 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              0
# 890 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                    ;
    }
    ...
    if (rc == 
# 895 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
             -1
# 895 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                      ) {
        ngx_conf_log_error(
# 896 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          1
# 896 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                       , cf, 0, "invalid network \"%V\"", net);
        return 
# 897 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
              -1
# 897 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                       ;
    }

    if (rc == 
# 900 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
             -4
# 900 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                     ) {
        ngx_conf_log_error(
# 901 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
                          5
# 901 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                                      , cf, 0,
                           "low address bits of %V are meaningless", net);
    }

    return 
# 905 "project/nginx/src/http/modules/ngx_http_geoip_module.c" 3 4
          0
# 905 "project/nginx/src/http/modules/ngx_http_geoip_module.c"
                ;
}
