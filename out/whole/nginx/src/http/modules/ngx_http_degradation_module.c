# 0 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
typedef struct {
    size_t sbrk_size;
...
static ngx_conf_enum_t ngx_http_degrade[] = {
    { 
# 24 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     { sizeof(
# 24 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
     "204"
# 24 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     ) - 1, (u_char *) 
# 24 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 24 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                      , 204 },
    { 
# 25 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     { sizeof(
# 25 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
     "444"
# 25 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     ) - 1, (u_char *) 
# 25 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 25 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                      , 444 },
    { 
# 26 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     { 0, ((void *)0) }
# 26 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                    , 0 }
};
...
static ngx_command_t ngx_http_degradation_commands[] = {
    ...
    { 
# 41 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     { sizeof(
# 41 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
     "degradation"
# 41 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     ) - 1, (u_char *) 
# 41 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 42 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     0x02000000
# 42 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                       |
# 42 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                        0x00000002
# 42 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 44 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 44 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                              ,
      0,
      
# 46 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     ((void *)0) 
# 46 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
          },

    { 
# 48 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     { sizeof(
# 48 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
     "degrade"
# 48 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     ) - 1, (u_char *) 
# 48 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 49 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     0x02000000
# 49 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                       |
# 49 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                        0x04000000
# 49 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 51 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 51 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                             ,
      
# 52 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     __builtin_offsetof (
# 52 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
     ngx_http_degradation_loc_conf_t
# 52 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     , 
# 52 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 55 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 56 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
};


static ngx_http_module_t ngx_http_degradation_module_ctx = {
    
# 60 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    ngx_http_degradation_init,

    ngx_http_degradation_create_main_conf,
    
# 64 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 64 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,

    
# 66 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 66 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 67 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 67 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
...
# 75 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 75 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
   "8" 
# 75 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   "," 
# 75 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 78 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   0x50545448
# 78 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                  ,
    
# 79 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 79 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 80 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 80 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 81 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 81 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 82 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 82 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 83 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 83 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 84 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 84 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 85 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   ((void *)0)
# 85 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       ,
    
# 86 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 87 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
};
...
ngx_http_degradation_handler(ngx_http_request_t *r)
{
    ...
    dlcf = 
# 95 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          (
# 95 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
          r
# 95 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          )->loc_conf[
# 95 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 95 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
    ...
    return 
# 101 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          -5
# 101 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                      ;
}
...
ngx_http_degraded(ngx_http_request_t *r)
{
    ...
    dmcf = 
# 114 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          (
# 114 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
          r
# 114 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          )->main_conf[
# 114 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 114 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
    ...
    if (dmcf->sbrk_size) {
        ...
        log = 0;
        now = 
# 119 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
             ngx_cached_time->sec
# 119 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                       ;
...
# 141 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
               if ((
# 141 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
               r->connection->log
# 141 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
...
# 141 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
               , 
# 141 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
               0, "degradation sbrk:%uzM", sbrk_size / (1024 * 1024)
# 141 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
               )

                                                        
# 143 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                                                       ;
            }
...
ngx_http_degradation_create_main_conf(ngx_conf_t *cf)
{
    ...
    if (dmcf == 
# 160 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
               ((void *)0)
# 160 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                   ) {
        return 
# 161 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
              ((void *)0)
# 161 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                  ;
    }
...
ngx_http_degradation_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 174 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
               ((void *)0)
# 174 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                   ) {
        return 
# 175 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
              ((void *)0)
# 175 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                  ;
    }

    conf->degrade = 
# 178 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                   (ngx_uint_t) -1
# 178 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                                      ;
...
# 190 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   if (
# 190 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
   conf->degrade 
# 190 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 190 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 190 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
    ...
    return 
# 192 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          ((void *)0)
# 192 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                     ;
}
...
ngx_http_degradation(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (
# 205 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
       strncmp((const char *) 
# 205 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
       value[1].data
# 205 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
       , (const char *) 
# 205 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 205 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
        ...
        if (dmcf->sbrk_size == (size_t) 
# 211 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                                       -1
# 211 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                                                ) {
            ngx_conf_log_error(
# 212 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                              1
# 212 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                                           , cf, 0,
                               "invalid sbrk size \"%V\"", &value[1]);
            return 
# 214 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                  (void *) -1
# 214 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                                ;
        }

        return 
# 217 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
              ((void *)0)
# 217 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                         ;
    }

    ngx_conf_log_error(
# 220 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
                      1
# 220 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                                   , cf, 0,
                       "invalid parameter \"%V\"", &value[1]);

    return 
# 223 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          (void *) -1
# 223 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                        ;
}
...
ngx_http_degradation_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 233 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 233 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
          cf
# 233 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          ->ctx)->main_conf[
# 233 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
# 233 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
    ...
    if (h == 
# 236 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
            ((void *)0)
# 236 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                ) {
        return 
# 237 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
              -1
# 237 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                       ;
    }
    ...
    *h = ngx_http_degradation_handler;
    ...
    return 
# 242 "project/nginx/src/http/modules/ngx_http_degradation_module.c" 3 4
          0
# 242 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
                ;
}
