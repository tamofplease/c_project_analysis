# 0 "project/nginx/src/http/modules/ngx_http_ssl_module.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_ssl_module.h"
# 9 "project/nginx/src/http/modules/ngx_http_ssl_module.h"
...
# 13 "project/nginx/src/http/modules/ngx_http_ssl_module.h" 2
...
# 14 "project/nginx/src/http/modules/ngx_http_ssl_module.h" 2
...
# 15 "project/nginx/src/http/modules/ngx_http_ssl_module.h" 2



# 17 "project/nginx/src/http/modules/ngx_http_ssl_module.h"
typedef struct {
    ngx_flag_t enable;
