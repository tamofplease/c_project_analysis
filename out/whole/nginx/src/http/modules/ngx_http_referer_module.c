# 0 "project/nginx/src/http/modules/ngx_http_referer_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_referer_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_referer_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_referer_module.c" 2
...
# 16 "project/nginx/src/http/modules/ngx_http_referer_module.c"
typedef struct {
    ngx_hash_combined_t hash;
...
static int ngx_http_cmp_referer_wildcards(const void *one,
    const void *two);
...
static ngx_command_t ngx_http_referer_commands[] = {
    ...
    { 
# 55 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     { sizeof(
# 55 "project/nginx/src/http/modules/ngx_http_referer_module.c"
     "valid_referers"
# 55 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     ) - 1, (u_char *) 
# 55 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 56 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     0x04000000
# 56 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                      |
# 56 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                       0x08000000
# 56 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 58 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 58 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                             ,
      0,
      
# 60 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     ((void *)0) 
# 60 "project/nginx/src/http/modules/ngx_http_referer_module.c"
          },

    { 
# 62 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     { sizeof(
# 62 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 63 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     0x04000000
# 63 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                      |
# 63 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                       0x08000000
# 63 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 65 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 65 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                             ,
      
# 66 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     __builtin_offsetof (
# 66 "project/nginx/src/http/modules/ngx_http_referer_module.c"
     ngx_http_referer_conf_t
# 66 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     , 
# 66 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 67 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     ((void *)0) 
# 67 "project/nginx/src/http/modules/ngx_http_referer_module.c"
          },

    { 
# 69 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     { sizeof(
# 69 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 70 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     0x04000000
# 70 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                      |
# 70 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                       0x08000000
# 70 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 72 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 72 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                             ,
      
# 73 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     __builtin_offsetof (
# 73 "project/nginx/src/http/modules/ngx_http_referer_module.c"
     ngx_http_referer_conf_t
# 73 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     , 
# 73 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 74 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     ((void *)0) 
# 74 "project/nginx/src/http/modules/ngx_http_referer_module.c"
          },

      
# 76 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 77 "project/nginx/src/http/modules/ngx_http_referer_module.c"
};
...
# 82 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 82 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,

    
# 84 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 84 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 85 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 85 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,

    
# 87 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 87 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 88 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 88 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
...
# 96 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 96 "project/nginx/src/http/modules/ngx_http_referer_module.c"
   "8" 
# 96 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   "," 
# 96 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 96 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                ,
    &ngx_http_referer_module_ctx,
    ngx_http_referer_commands,
    
# 99 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   0x50545448
# 99 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                  ,
    
# 100 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 100 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 101 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 101 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 102 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 102 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 103 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 103 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 104 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 104 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 105 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 105 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 106 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   ((void *)0)
# 106 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       ,
    
# 107 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 108 "project/nginx/src/http/modules/ngx_http_referer_module.c"
};


static ngx_str_t ngx_http_invalid_referer_name = 
# 111 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                 { sizeof(
# 111 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                 "invalid_referer"
# 111 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                 ) - 1, (u_char *) 
# 111 "project/nginx/src/http/modules/ngx_http_referer_module.c"
    ...
    uintptr_t data)
{
    ...
    rlcf = 
# 129 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          (
# 129 "project/nginx/src/http/modules/ngx_http_referer_module.c"
          r
# 129 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          )->loc_conf[
# 129 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 129 "project/nginx/src/http/modules/ngx_http_referer_module.c"
    ...
    if (rlcf->hash.hash.buckets == 
# 131 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                  ((void *)0)
        
# 132 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       && rlcf->hash.wc_head == 
# 132 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                ((void *)0)
        
# 133 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       && rlcf->hash.wc_tail == 
# 133 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                ((void *)0)

        
# 135 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       && rlcf->regex == 
# 135 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                         ((void *)0)
        
# 136 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       && rlcf->server_name_regex == 
# 136 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                     ((void *)0)

       
# 138 "project/nginx/src/http/modules/ngx_http_referer_module.c"
      )
    {
        goto valid;
    }
...
# 143 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                ((void *)0)
# 143 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                    ) {
        if (rlcf->no_referer) {
            goto valid;
        }
...
valid_scheme:
    ...
    for (p = ref; p < last; p++) {
        ...
        buf[i] = 
# 189 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                (u_char) ((
# 189 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                *p 
# 189 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                >= 'A' && 
# 189 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 189 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                               ;
        key = 
# 190 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             ((ngx_uint_t) 
# 190 "project/nginx/src/http/modules/ngx_http_referer_module.c"
             key 
# 190 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             * 31 + 
# 190 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 190 "project/nginx/src/http/modules/ngx_http_referer_module.c"
    ...
    if (rlcf->server_name_regex) {
        ...
        if (rc == 
# 208 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                 0
# 208 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ) {
            goto valid;
        }

        if (rc == 
# 212 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                 -1
# 212 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                          ) {
            return rc;
        }
    ...
    if (rlcf->regex) {
        ...
        if (rc == 
# 225 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                 0
# 225 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ) {
            goto valid;
        }

        if (rc == 
# 229 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                 -1
# 229 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                          ) {
            return rc;
        }
...
invalid:
    ...
    *v = ngx_http_variable_true_value;
    ...
    return 
# 242 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          0
# 242 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                ;
...
uri:
    ...
    if (len < uri->len || 
# 258 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                         strncmp((const char *) 
# 258 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                         uri->data
# 258 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                         , (const char *) 
# 258 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
valid:
    ...
    *v = ngx_http_variable_null_value;
    ...
    return 
# 266 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          0
# 266 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                ;
}
...
# 276 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                               1
# 276 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                      );
    if (var == 
# 277 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              ((void *)0)
# 277 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                  ) {
        return 
# 278 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              -1
# 278 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
    }
    ...
    return 
# 283 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          0
# 283 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                ;
}
...
ngx_http_referer_create_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 293 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
               ((void *)0)
# 293 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                   ) {
        return 
# 294 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              ((void *)0)
# 294 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                  ;
    }
# 306 "project/nginx/src/http/modules/ngx_http_referer_module.c"
    conf->regex = 
# 306 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                 (void *) -1
# 306 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                   ;
    conf->server_name_regex = 
# 307 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                             (void *) -1
# 307 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                               ;


    conf->no_referer = 
# 310 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      -1
# 310 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                    ;
    conf->blocked_referer = 
# 311 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                           -1
# 311 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                         ;
    conf->referer_hash_max_size = 
# 312 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                 (ngx_uint_t) -1
# 312 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                    ;
    conf->referer_hash_bucket_size = 
# 313 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                    (ngx_uint_t) -1
# 313 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                       ;
...
ngx_http_referer_merge_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->keys == 
# 330 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                     ((void *)0)
# 330 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                         ) {
        conf->hash = prev->hash;


        
# 334 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if (
# 334 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       conf->regex 
# 334 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       == (void *) -1) { 
# 334 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 335 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if (
# 335 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       conf->server_name_regex 
# 335 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       == (void *) -1) { 
# 335 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 336 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                              ;

        
# 338 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if (
# 338 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       conf->no_referer 
# 338 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       == -1) { 
# 338 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 339 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if (
# 339 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       conf->blocked_referer 
# 339 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       == -1) { 
# 339 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 340 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if (
# 340 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       conf->referer_hash_max_size 
# 340 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       == (ngx_uint_t) -1) { 
# 340 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 341 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                   ;
        
# 342 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if (
# 342 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       conf->referer_hash_bucket_size 
# 342 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       == (ngx_uint_t) -1) { 
# 342 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 343 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                    ;

        return 
# 345 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              ((void *)0)
# 345 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                         ;
    }

    if (conf->server_names == 1) {
        cscf = 
# 349 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              ((ngx_http_conf_ctx_t *) 
# 349 "project/nginx/src/http/modules/ngx_http_referer_module.c"
              cf
# 349 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              ->ctx)->srv_conf[
# 349 "project/nginx/src/http/modules/ngx_http_referer_module.c"
        ...
        for (n = 0; n < cscf->server_names.nelts; n++) {
            ...
            if (sn[n].regex) {
                ...
                if (ngx_http_add_regex_server_name(cf, conf, sn[n].regex)
                    != 
# 358 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      0
# 358 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                            )
                {
                    return 
# 360 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                          (void *) -1
# 360 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                        ;
                }
            ...
            if (ngx_http_add_referer(cf, conf->keys, &sn[n].name, 
# 367 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                                 ((void *)0)
# 367 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                     )
                != 
# 368 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  0
# 368 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                        )
            {
                return 
# 370 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      (void *) -1
# 370 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                    ;
            }
        }
    }
...
# 380 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       if ((
# 380 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       cf->log
# 380 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
...
# 380 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       , 
# 380 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       0, "the \"none\" or \"blocked\" referers are specified " "in the \"valid_referers\" directive " "without any valid referer"
# 380 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       )


                                                  
# 383 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                 ;
        return 
# 384 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              (void *) -1
# 384 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                            ;
    }

    
# 387 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   if (
# 387 "project/nginx/src/http/modules/ngx_http_referer_module.c"
   conf->referer_hash_max_size 
# 387 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 387 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 388 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                               ;
    
# 389 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   if (
# 389 "project/nginx/src/http/modules/ngx_http_referer_module.c"
   conf->referer_hash_bucket_size 
# 389 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 389 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 390 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                ;
    conf->referer_hash_bucket_size = 
# 391 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                    (((
# 391 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                    conf->referer_hash_bucket_size
# 391 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                    ) + (
# 391 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 392 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                 ;
    ...
    if (conf->keys->keys.nelts) {
        ...
        hash.temp_pool = 
# 402 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                        ((void *)0)
# 402 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                            ;

        if (ngx_hash_init(&hash, conf->keys->keys.elts, conf->keys->keys.nelts)
            != 
# 405 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              0
# 405 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                    )
        {
            return 
# 407 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 407 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }
    }
...
# 413 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       qsort
# 413 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                (conf->keys->dns_wc_head.elts,
                  (size_t) conf->keys->dns_wc_head.nelts,
                  sizeof(ngx_hash_key_t),
                  ngx_http_cmp_referer_wildcards);

        hash.hash = 
# 418 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                   ((void *)0)
# 418 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
        ...
        if (ngx_hash_wildcard_init(&hash, conf->keys->dns_wc_head.elts,
            ...
            != 
# 423 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              0
# 423 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                    )
        {
            return 
# 425 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 425 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }
...
# 433 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       qsort
# 433 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                (conf->keys->dns_wc_tail.elts,
                  (size_t) conf->keys->dns_wc_tail.nelts,
                  sizeof(ngx_hash_key_t),
                  ngx_http_cmp_referer_wildcards);

        hash.hash = 
# 438 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                   ((void *)0)
# 438 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
        hash.temp_pool = cf->temp_pool;
        ...
        if (ngx_hash_wildcard_init(&hash, conf->keys->dns_wc_tail.elts,
            ...
            != 
# 443 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              0
# 443 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                    )
        {
            return 
# 445 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 445 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }
...
# 452 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   if (
# 452 "project/nginx/src/http/modules/ngx_http_referer_module.c"
   conf->regex 
# 452 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   == (void *) -1) { 
# 452 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 453 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   if (
# 453 "project/nginx/src/http/modules/ngx_http_referer_module.c"
   conf->server_name_regex 
# 453 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   == (void *) -1) { 
# 453 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 454 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                 ;


    if (conf->no_referer == 
# 457 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                           -1
# 457 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                         ) {
        conf->no_referer = 0;
    }

    if (conf->blocked_referer == 
# 461 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                -1
# 461 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                              ) {
        conf->blocked_referer = 0;
    }

    conf->keys = 
# 465 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                ((void *)0)
# 465 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                    ;

    return 
# 467 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          ((void *)0)
# 467 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                     ;
}
...
ngx_http_valid_referers(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (rlcf->keys == 
# 480 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                     ((void *)0)
# 480 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                         ) {
        rlcf->keys = ngx_pcalloc(cf->temp_pool, sizeof(ngx_hash_keys_arrays_t));
        if (rlcf->keys == 
# 482 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                         ((void *)0)
# 482 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                             ) {
            return 
# 483 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 483 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }
        ...
        if (ngx_hash_keys_array_init(rlcf->keys, 
# 489 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                1
# 489 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                              ) != 
# 489 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                                   0
# 489 "project/nginx/src/http/modules/ngx_http_referer_module.c"
            ...
            return 
# 490 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 490 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }
    }
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        if (value[i].len == 0) {
            ngx_conf_log_error(
# 498 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                              1
# 498 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                           , cf, 0,
                               "invalid referer \"%V\"", &value[i]);
            return 
# 500 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 500 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }

        if (
# 503 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
           strcmp((const char *) 
# 503 "project/nginx/src/http/modules/ngx_http_referer_module.c"
           value[i].data
# 503 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
           , (const char *) 
# 503 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 503 "project/nginx/src/http/modules/ngx_http_referer_module.c"
        ...
        if (
# 508 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
           strcmp((const char *) 
# 508 "project/nginx/src/http/modules/ngx_http_referer_module.c"
           value[i].data
# 508 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
           , (const char *) 
# 508 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 508 "project/nginx/src/http/modules/ngx_http_referer_module.c"
        ...
        if (
# 513 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
           strcmp((const char *) 
# 513 "project/nginx/src/http/modules/ngx_http_referer_module.c"
           value[i].data
# 513 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
           , (const char *) 
# 513 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 513 "project/nginx/src/http/modules/ngx_http_referer_module.c"
        ...
        if (value[i].data[0] == '~') {
            if (ngx_http_add_regex_referer(cf, rlcf, &value[i]) != 
# 519 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                                  0
# 519 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                        ) {
                return 
# 520 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      (void *) -1
# 520 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                    ;
            }
...
# 526 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       (
# 526 "project/nginx/src/http/modules/ngx_http_referer_module.c"
       &uri
# 526 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
       )->len = 0; (
# 526 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 526 "project/nginx/src/http/modules/ngx_http_referer_module.c"
        ...
        p = (u_char *) 
# 528 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      strchr((const char *) 
# 528 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                      value[i].data
# 528 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      , (int) 
# 528 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 528 "project/nginx/src/http/modules/ngx_http_referer_module.c"
        ...
        if (ngx_http_add_referer(cf, rlcf->keys, &value[i], &uri) != 
# 536 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                                                    0
# 536 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                                          ) {
            return 
# 537 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  (void *) -1
# 537 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                ;
        }
    }

    return 
# 541 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          ((void *)0)
# 541 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                     ;
}
    ...
    ngx_str_t *value, ngx_str_t *uri)
{
    ...
    if (uri == 
# 552 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              ((void *)0) 
# 552 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                   || uri->len == 0) {
        u = ((void *) 4);
        ...
        if (u == 
# 557 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                ((void *)0)
# 557 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                    ) {
            return 
# 558 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  -1
# 558 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                           ;
        }
    ...
    rc = ngx_hash_add_key(keys, value, u, 
# 564 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                         1
# 564 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                              );

    if (rc == 
# 566 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             0
# 566 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                   ) {
        return 
# 567 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              0
# 567 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                    ;
    }

    if (rc == 
# 570 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             -5
# 570 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                         ) {
        ngx_conf_log_error(
# 571 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                          1
# 571 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                       , cf, 0,
                           "invalid hostname or wildcard \"%V\"", value);
    }

    if (rc == 
# 575 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             -3
# 575 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                     ) {
        ngx_conf_log_error(
# 576 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                          1
# 576 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                       , cf, 0,
                           "conflicting parameter \"%V\"", value);
    }

    return 
# 580 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          -1
# 580 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                   ;
}
    ...
    ngx_str_t *name)
{
    ...
    ngx_regex_compile_t rc;
    u_char errstr[
# 591 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                1024
# 591 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                   ];

    if (name->len == 1) {
        ngx_conf_log_error(
# 594 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                          1
# 594 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                       , cf, 0, "empty regex in \"%V\"", name);
        return 
# 595 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              -1
# 595 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
    }

    if (rlcf->regex == 
# 598 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                      (void *) -1
# 598 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                        ) {
        rlcf->regex = ngx_array_create(cf->pool, 2, sizeof(ngx_regex_elt_t));
        if (rlcf->regex == 
# 600 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                          ((void *)0)
# 600 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                              ) {
            return 
# 601 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  -1
# 601 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                           ;
        }
    }
    ...
    if (re == 
# 606 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             ((void *)0)
# 606 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                 ) {
        return 
# 607 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              -1
# 607 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
    }
...
# 613 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   (void) __builtin___memset_chk (
# 613 "project/nginx/src/http/modules/ngx_http_referer_module.c"
   &rc
# 613 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
   , 0, 
# 613 "project/nginx/src/http/modules/ngx_http_referer_module.c"
...
# 613 "project/nginx/src/http/modules/ngx_http_referer_module.c"
    ...
    rc.pool = cf->pool;
    rc.options = 
# 617 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                0x00000001
# 617 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                  ;
    rc.err.len = 
# 618 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                1024
# 618 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                   ;
    rc.err.data = errstr;

    if (ngx_regex_compile(&rc) != 
# 621 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                 0
# 621 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                       ) {
        ngx_conf_log_error(
# 622 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                          1
# 622 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                       , cf, 0, "%V", &rc.err);
        return 
# 623 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              -1
# 623 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
    }
    ...
    return 
# 629 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          0
# 629 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                ;
# 640 "project/nginx/src/http/modules/ngx_http_referer_module.c"
}
    ...
    ngx_http_regex_t *regex)
{
    ...
    if (rlcf->server_name_regex == 
# 651 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                  (void *) -1
# 651 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                                    ) {
        rlcf->server_name_regex = ngx_array_create(cf->pool, 2,
                                                   sizeof(ngx_regex_elt_t));
        if (rlcf->server_name_regex == 
# 654 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                                      ((void *)0)
# 654 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                                          ) {
            return 
# 655 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
                  -1
# 655 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                           ;
        }
    }
    ...
    if (re == 
# 660 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
             ((void *)0)
# 660 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                 ) {
        return 
# 661 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
              -1
# 661 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                       ;
    }
    ...
    return 
# 667 "project/nginx/src/http/modules/ngx_http_referer_module.c" 3 4
          0
# 667 "project/nginx/src/http/modules/ngx_http_referer_module.c"
                ;
}
