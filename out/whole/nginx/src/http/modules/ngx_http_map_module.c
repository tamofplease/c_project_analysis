# 0 "project/nginx/src/http/modules/ngx_http_map_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_map_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_map_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_map_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_map_module.c"
typedef struct {
...
static int ngx_http_map_cmp_dns_wildcards(const void *one,
    const void *two);
...
static ngx_command_t ngx_http_map_commands[] = {
    ...
    { 
# 51 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     { sizeof(
# 51 "project/nginx/src/http/modules/ngx_http_map_module.c"
     "map"
# 51 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     ) - 1, (u_char *) 
# 51 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 52 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     0x02000000
# 52 "project/nginx/src/http/modules/ngx_http_map_module.c"
                       |
# 52 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                        0x00000100
# 52 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 54 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 54 "project/nginx/src/http/modules/ngx_http_map_module.c"
                              ,
      0,
      
# 56 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     ((void *)0) 
# 56 "project/nginx/src/http/modules/ngx_http_map_module.c"
          },

    { 
# 58 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     { sizeof(
# 58 "project/nginx/src/http/modules/ngx_http_map_module.c"
     "map_hash_max_size"
# 58 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     ) - 1, (u_char *) 
# 58 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 59 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     0x02000000
# 59 "project/nginx/src/http/modules/ngx_http_map_module.c"
                       |
# 59 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                        0x00000002
# 59 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 61 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 61 "project/nginx/src/http/modules/ngx_http_map_module.c"
                              ,
      
# 62 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     __builtin_offsetof (
# 62 "project/nginx/src/http/modules/ngx_http_map_module.c"
     ngx_http_map_conf_t
# 62 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     , 
# 62 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 63 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     ((void *)0) 
# 63 "project/nginx/src/http/modules/ngx_http_map_module.c"
          },

    { 
# 65 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     { sizeof(
# 65 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 66 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     0x02000000
# 66 "project/nginx/src/http/modules/ngx_http_map_module.c"
                       |
# 66 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                        0x00000002
# 66 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 68 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 68 "project/nginx/src/http/modules/ngx_http_map_module.c"
                              ,
      
# 69 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     __builtin_offsetof (
# 69 "project/nginx/src/http/modules/ngx_http_map_module.c"
     ngx_http_map_conf_t
# 69 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     , 
# 69 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 70 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     ((void *)0) 
# 70 "project/nginx/src/http/modules/ngx_http_map_module.c"
          },

      
# 72 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 73 "project/nginx/src/http/modules/ngx_http_map_module.c"
};


static ngx_http_module_t ngx_http_map_module_ctx = {
    
# 77 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 77 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 78 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 78 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,

    ngx_http_map_create_conf,
    
# 81 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 81 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,

    
# 83 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 83 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 84 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 84 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,

    
# 86 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 86 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 87 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)

# 88 "project/nginx/src/http/modules/ngx_http_map_module.c"
};


ngx_module_t ngx_http_map_module = {
    
# 92 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 92 "project/nginx/src/http/modules/ngx_http_map_module.c"
   "8" 
# 92 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   "," 
# 92 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 92 "project/nginx/src/http/modules/ngx_http_map_module.c"
                ,
    &ngx_http_map_module_ctx,
    ngx_http_map_commands,
    
# 95 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   0x50545448
# 95 "project/nginx/src/http/modules/ngx_http_map_module.c"
                  ,
    
# 96 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 96 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 97 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 97 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 98 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 98 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 99 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 99 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 100 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 100 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 101 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 101 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 102 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   ((void *)0)
# 102 "project/nginx/src/http/modules/ngx_http_map_module.c"
       ,
    
# 103 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 104 "project/nginx/src/http/modules/ngx_http_map_module.c"
};
    ...
    uintptr_t data)
{
    ...
    if (ngx_http_complex_value(r, &map->value, &val) != 
# 120 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                                       0
# 120 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                             ) {
        return 
# 121 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              -1
# 121 "project/nginx/src/http/modules/ngx_http_map_module.c"
                       ;
    }
    ...
    if (value == 
# 130 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                ((void *)0)
# 130 "project/nginx/src/http/modules/ngx_http_map_module.c"
                    ) {
    ...
    if (!value->valid) {
        ...
        if (ngx_http_complex_value(r, cv, &str) != 
# 137 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                                  0
# 137 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                        ) {
            return 
# 138 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  -1
# 138 "project/nginx/src/http/modules/ngx_http_map_module.c"
                           ;
        }
    ...
    return 
# 154 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          0
# 154 "project/nginx/src/http/modules/ngx_http_map_module.c"
                ;
}
...
ngx_http_map_create_conf(ngx_conf_t *cf)
{
    ...
    if (mcf == 
# 164 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 164 "project/nginx/src/http/modules/ngx_http_map_module.c"
                  ) {
        return 
# 165 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 165 "project/nginx/src/http/modules/ngx_http_map_module.c"
                  ;
    }

    mcf->hash_max_size = 
# 168 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                        (ngx_uint_t) -1
# 168 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                           ;
    mcf->hash_bucket_size = 
# 169 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                           (ngx_uint_t) -1
# 169 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                              ;
...
# 190 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                             (ngx_uint_t) -1
# 190 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                ) {
        mcf->hash_max_size = 2048;
    }

    if (mcf->hash_bucket_size == 
# 194 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                (ngx_uint_t) -1
# 194 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                   ) {
        mcf->hash_bucket_size = ngx_cacheline_size;

    } else {
        mcf->hash_bucket_size = 
# 198 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                               (((
# 198 "project/nginx/src/http/modules/ngx_http_map_module.c"
                               mcf->hash_bucket_size
# 198 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                               ) + (
# 198 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 199 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                            ;
    }

    map = ngx_pcalloc(cf->pool, sizeof(ngx_http_map_ctx_t));
    if (map == 
# 203 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 203 "project/nginx/src/http/modules/ngx_http_map_module.c"
                  ) {
        return 
# 204 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 204 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
...
# 209 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   (void) __builtin___memset_chk (
# 209 "project/nginx/src/http/modules/ngx_http_map_module.c"
   &ccv
# 209 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   , 0, 
# 209 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 215 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                               0
# 215 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                     ) {
        return 
# 216 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 216 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
    ...
    if (name.data[0] != '$') {
        ngx_conf_log_error(
# 222 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                          1
# 222 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                       , cf, 0,
                           "invalid variable name \"%V\"", &name);
        return 
# 224 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 224 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
...
# 230 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                          1
# 230 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                                 );
    if (var == 
# 231 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 231 "project/nginx/src/http/modules/ngx_http_map_module.c"
                  ) {
        return 
# 232 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 232 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
...
# 238 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                          (16 * 1024)
# 238 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                               , cf->log);
    if (pool == 
# 239 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
               ((void *)0)
# 239 "project/nginx/src/http/modules/ngx_http_map_module.c"
                   ) {
        return 
# 240 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 240 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
...
# 246 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                           2
# 246 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                         ) != 
# 246 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                                              0
# 246 "project/nginx/src/http/modules/ngx_http_map_module.c"
        ...
        return 
# 248 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 248 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }

    ctx.values_hash = ngx_pcalloc(pool, sizeof(ngx_array_t) * ctx.keys.hsize);
    if (ctx.values_hash == 
# 252 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                          ((void *)0)
# 252 "project/nginx/src/http/modules/ngx_http_map_module.c"
                              ) {
        ngx_destroy_pool(pool);
        return 
# 254 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 254 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
    ...
    if (ngx_array_init(&ctx.regexes, cf->pool, 2, sizeof(ngx_http_map_regex_t))
        != 
# 259 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          0
# 259 "project/nginx/src/http/modules/ngx_http_map_module.c"
                )
    {
        ngx_destroy_pool(pool);
        return 
# 262 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 262 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }


    ctx.default_value = 
# 266 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                       ((void *)0)
# 266 "project/nginx/src/http/modules/ngx_http_map_module.c"
                           ;
    ctx.cf = &save;
    ctx.hostnames = 0;
    ctx.no_cacheable = 0;
...
# 277 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                           ((void *)0)
# 277 "project/nginx/src/http/modules/ngx_http_map_module.c"
                               );

    *cf = save;

    if (rv != 
# 281 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             ((void *)0)
# 281 "project/nginx/src/http/modules/ngx_http_map_module.c"
                        ) {
        ngx_destroy_pool(pool);
        return rv;
    }
    ...
    if (ctx.no_cacheable) {
        var->flags |= 
# 287 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                     2
# 287 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                             ;
    }
    ...
    if (ctx.keys.keys.nelts) {
        ...
        hash.temp_pool = 
# 303 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                        ((void *)0)
# 303 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;

        if (ngx_hash_init(&hash, ctx.keys.keys.elts, ctx.keys.keys.nelts)
            != 
# 306 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              0
# 306 "project/nginx/src/http/modules/ngx_http_map_module.c"
                    )
        {
            ngx_destroy_pool(pool);
            return 
# 309 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 309 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
    }
...
# 315 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       qsort
# 315 "project/nginx/src/http/modules/ngx_http_map_module.c"
                (ctx.keys.dns_wc_head.elts,
                  (size_t) ctx.keys.dns_wc_head.nelts,
                  sizeof(ngx_hash_key_t), ngx_http_map_cmp_dns_wildcards);

        hash.hash = 
# 319 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                   ((void *)0)
# 319 "project/nginx/src/http/modules/ngx_http_map_module.c"
                       ;
        hash.temp_pool = pool;
        ...
        if (ngx_hash_wildcard_init(&hash, ctx.keys.dns_wc_head.elts,
            ...
            != 
# 324 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              0
# 324 "project/nginx/src/http/modules/ngx_http_map_module.c"
                    )
        {
            ngx_destroy_pool(pool);
            return 
# 327 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 327 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
...
# 335 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       qsort
# 335 "project/nginx/src/http/modules/ngx_http_map_module.c"
                (ctx.keys.dns_wc_tail.elts,
                  (size_t) ctx.keys.dns_wc_tail.nelts,
                  sizeof(ngx_hash_key_t), ngx_http_map_cmp_dns_wildcards);

        hash.hash = 
# 339 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                   ((void *)0)
# 339 "project/nginx/src/http/modules/ngx_http_map_module.c"
                       ;
        hash.temp_pool = pool;
        ...
        if (ngx_hash_wildcard_init(&hash, ctx.keys.dns_wc_tail.elts,
            ...
            != 
# 344 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              0
# 344 "project/nginx/src/http/modules/ngx_http_map_module.c"
                    )
        {
            ngx_destroy_pool(pool);
            return 
# 347 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 347 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
...
ngx_http_map(ngx_conf_t *cf, ngx_command_t *dummy, void *conf)
{
    ...
    if (cf->args->nelts == 1
        && 
# 398 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          strcmp((const char *) 
# 398 "project/nginx/src/http/modules/ngx_http_map_module.c"
          value[0].data
# 398 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          , (const char *) 
# 398 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 398 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                 == 0)
    {
        ctx->hostnames = 1;
        return 
# 401 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 401 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ;
    }

    if (cf->args->nelts == 1
        && 
# 405 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          strcmp((const char *) 
# 405 "project/nginx/src/http/modules/ngx_http_map_module.c"
          value[0].data
# 405 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          , (const char *) 
# 405 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 405 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                == 0)
    {
        ctx->no_cacheable = 1;
        return 
# 408 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 408 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ;
    }

    if (cf->args->nelts != 2) {
        ngx_conf_log_error(
# 412 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                          1
# 412 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                       , cf, 0,
                           "invalid number of the map parameters");
        return 
# 414 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 414 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }

    if (
# 417 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       strcmp((const char *) 
# 417 "project/nginx/src/http/modules/ngx_http_map_module.c"
       value[0].data
# 417 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       , (const char *) 
# 417 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 417 "project/nginx/src/http/modules/ngx_http_map_module.c"
    ...
    for (i = 0; i < value[1].len; i++) {
        key = 
# 424 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             ((ngx_uint_t) 
# 424 "project/nginx/src/http/modules/ngx_http_map_module.c"
             key 
# 424 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             * 31 + 
# 424 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 424 "project/nginx/src/http/modules/ngx_http_map_module.c"
    ...
    if (vp) {
        for (i = 0; i < ctx->values_hash[key].nelts; i++) {
            ...
            if (
# 448 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
               strncmp((const char *) 
# 448 "project/nginx/src/http/modules/ngx_http_map_module.c"
               value[1].data
# 448 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
               , (const char *) 
# 448 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 448 "project/nginx/src/http/modules/ngx_http_map_module.c"
        ...
        if (ngx_array_init(&ctx->values_hash[key], cf->pool, 4,
            ...
            != 
# 457 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              0
# 457 "project/nginx/src/http/modules/ngx_http_map_module.c"
                    )
        {
            return 
# 459 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 459 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
    }
    ...
    if (var == 
# 464 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 464 "project/nginx/src/http/modules/ngx_http_map_module.c"
                  ) {
        return 
# 465 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 465 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
    ...
    if (v.data == 
# 470 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                 ((void *)0)
# 470 "project/nginx/src/http/modules/ngx_http_map_module.c"
                     ) {
        return 
# 471 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 471 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }

    
# 474 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   (void) __builtin___memset_chk (
# 474 "project/nginx/src/http/modules/ngx_http_map_module.c"
   &ccv
# 474 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
   , 0, 
# 474 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 474 "project/nginx/src/http/modules/ngx_http_map_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 480 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                               0
# 480 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                     ) {
        return 
# 481 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 481 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }

    if (cv.lengths != 
# 484 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                     ((void *)0)
# 484 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ) {
        cvp = ngx_palloc(ctx->keys.pool, sizeof(ngx_http_complex_value_t));
        if (cvp == 
# 486 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  ((void *)0)
# 486 "project/nginx/src/http/modules/ngx_http_map_module.c"
                      ) {
            return 
# 487 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 487 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
    ...
    if (vp == 
# 506 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             ((void *)0)
# 506 "project/nginx/src/http/modules/ngx_http_map_module.c"
                 ) {
        return 
# 507 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              (void *) -1
# 507 "project/nginx/src/http/modules/ngx_http_map_module.c"
                            ;
    }
...
found:
    ...
    if (
# 514 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       strcmp((const char *) 
# 514 "project/nginx/src/http/modules/ngx_http_map_module.c"
       value[0].data
# 514 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       , (const char *) 
# 514 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 514 "project/nginx/src/http/modules/ngx_http_map_module.c"
        ...
        if (ctx->default_value) {
            ngx_conf_log_error(
# 517 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                              1
# 517 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                           , cf, 0,
                               "duplicate default map parameter");
            return 
# 519 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 519 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
        ...
        return 
# 524 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 524 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ;
    }
    ...
    if (value[0].len && value[0].data[0] == '~') {
        ...
        ngx_http_map_regex_t *regex;
        u_char errstr[
# 532 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                     1024
# 532 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                        ];

        regex = ngx_array_push(&ctx->regexes);
        if (regex == 
# 535 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                    ((void *)0)
# 535 "project/nginx/src/http/modules/ngx_http_map_module.c"
                        ) {
            return 
# 536 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 536 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
...
# 542 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       (void) __builtin___memset_chk (
# 542 "project/nginx/src/http/modules/ngx_http_map_module.c"
       &rc
# 542 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
       , 0, 
# 542 "project/nginx/src/http/modules/ngx_http_map_module.c"
...
# 542 "project/nginx/src/http/modules/ngx_http_map_module.c"
        ...
        if (value[0].data[0] == '*') {
            ...
            value[0].data++;
            rc.options = 
# 547 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                        0x00000001
# 547 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                          ;
        }

        rc.pattern = value[0];
        rc.err.len = 
# 551 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                    1024
# 551 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                       ;
        rc.err.data = errstr;

        regex->regex = ngx_http_regex_compile(ctx->cf, &rc);
        if (regex->regex == 
# 555 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                           ((void *)0)
# 555 "project/nginx/src/http/modules/ngx_http_map_module.c"
                               ) {
            return 
# 556 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                  (void *) -1
# 556 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                ;
        }
        ...
        return 
# 561 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 561 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ;
    }
    ...
    rv = ngx_hash_add_key(&ctx->keys, &value[0], var,
                          (ctx->hostnames) ? 
# 572 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                                            1 
# 572 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                                                  : 0);

    if (rv == 
# 574 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             0
# 574 "project/nginx/src/http/modules/ngx_http_map_module.c"
                   ) {
        return 
# 575 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
              ((void *)0)
# 575 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ;
    }

    if (rv == 
# 578 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             -5
# 578 "project/nginx/src/http/modules/ngx_http_map_module.c"
                         ) {
        ngx_conf_log_error(
# 579 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                          1
# 579 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                       , cf, 0,
                           "invalid hostname or wildcard \"%V\"", &value[0]);
    }

    if (rv == 
# 583 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
             -3
# 583 "project/nginx/src/http/modules/ngx_http_map_module.c"
                     ) {
        ngx_conf_log_error(
# 584 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
                          1
# 584 "project/nginx/src/http/modules/ngx_http_map_module.c"
                                       , cf, 0,
                           "conflicting parameter \"%V\"", &value[0]);
    }

    return 
# 588 "project/nginx/src/http/modules/ngx_http_map_module.c" 3 4
          (void *) -1
# 588 "project/nginx/src/http/modules/ngx_http_map_module.c"
                        ;
}
