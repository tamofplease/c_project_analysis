# 0 "project/nginx/src/http/modules/ngx_http_browser_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/http/modules/ngx_http_browser_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_browser_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_browser_module.c" 2
...
# 24 "project/nginx/src/http/modules/ngx_http_browser_module.c"
typedef struct {
    u_char browser[12];
    size_t skip;
    size_t add;
...
static ngx_command_t ngx_http_browser_commands[] = {
    ...
    { 
# 77 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 77 "project/nginx/src/http/modules/ngx_http_browser_module.c"
     "modern_browser"
# 77 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ) - 1, (u_char *) 
# 77 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 78 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     0x02000000
# 78 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                       |
# 78 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                        0x04000000
# 78 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 80 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 80 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      
# 82 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ((void *)0) 
# 82 "project/nginx/src/http/modules/ngx_http_browser_module.c"
          },

    { 
# 84 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 84 "project/nginx/src/http/modules/ngx_http_browser_module.c"
     "ancient_browser"
# 84 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ) - 1, (u_char *) 
# 84 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 85 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     0x02000000
# 85 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                       |
# 85 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                        0x04000000
# 85 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 87 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 87 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      
# 89 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ((void *)0) 
# 89 "project/nginx/src/http/modules/ngx_http_browser_module.c"
          },

    { 
# 91 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 91 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 92 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     0x02000000
# 92 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                       |
# 92 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                        0x04000000
# 92 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 94 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 94 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      
# 96 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ((void *)0) 
# 96 "project/nginx/src/http/modules/ngx_http_browser_module.c"
          },

    { 
# 98 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 98 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 99 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     0x02000000
# 99 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                       |
# 99 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                        0x04000000
# 99 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 101 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 101 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      
# 103 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ((void *)0) 
# 103 "project/nginx/src/http/modules/ngx_http_browser_module.c"
          },

      
# 105 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 106 "project/nginx/src/http/modules/ngx_http_browser_module.c"
};
...
# 111 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,

    
# 113 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 113 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 114 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 114 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,

    
# 116 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 116 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 117 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 117 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
...
# 125 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 125 "project/nginx/src/http/modules/ngx_http_browser_module.c"
   "8" 
# 125 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   "," 
# 125 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 128 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   0x50545448
# 128 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                  ,
    
# 129 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 129 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 130 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 130 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 131 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 131 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 132 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 132 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 133 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 133 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 134 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 134 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 135 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   ((void *)0)
# 135 "project/nginx/src/http/modules/ngx_http_browser_module.c"
       ,
    
# 136 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 137 "project/nginx/src/http/modules/ngx_http_browser_module.c"
};
...
static ngx_http_variable_t ngx_http_browser_vars[] = {
    ...
    { 
# 216 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 216 "project/nginx/src/http/modules/ngx_http_browser_module.c"
     "msie"
# 216 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ) - 1, (u_char *) 
# 216 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 216 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                         ((void *)0)
# 216 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             , ngx_http_msie_variable,
      0, 
# 217 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
        1
# 217 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                               , 0 },

    { 
# 219 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 219 "project/nginx/src/http/modules/ngx_http_browser_module.c"
     "modern_browser"
# 219 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ) - 1, (u_char *) 
# 219 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 219 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                   ((void *)0)
# 219 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                       , ngx_http_browser_variable,
      0, 
# 220 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                              1
# 220 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                                     , 0 },

    { 
# 222 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { sizeof(
# 222 "project/nginx/src/http/modules/ngx_http_browser_module.c"
     "ancient_browser"
# 222 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     ) - 1, (u_char *) 
# 222 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 222 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                        , ngx_http_browser_variable,
      1, 
# 223 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                               1
# 223 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                                      , 0 },

      
# 225 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 226 "project/nginx/src/http/modules/ngx_http_browser_module.c"
};
    ...
    uintptr_t data)
{
    ...
    cf = 
# 236 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
        (
# 236 "project/nginx/src/http/modules/ngx_http_browser_module.c"
        r
# 236 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
        )->loc_conf[
# 236 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 236 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    ...
    if (data == 0 && rc == 0) {
        *v = *cf->modern_browser_value;
        return 
# 242 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              0
# 242 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                    ;
    }
    ...
    if (data == 1 && rc == 1) {
        *v = *cf->ancient_browser_value;
        return 
# 247 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              0
# 247 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                    ;
    }

    *v = ngx_http_variable_null_value;
    return 
# 251 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          0
# 251 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                ;
}
...
# 264 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                   ((void *)0)
# 264 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                       ) {
    ...
    if (cf->modern_browsers) {
        ...
        for (i = 0; i < cf->modern_browsers->nelts; i++) {
            ...
            name = (u_char *) 
# 286 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                             strstr((const char *) 
# 286 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             name
# 286 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                             , (const char *) 
# 286 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 286 "project/nginx/src/http/modules/ngx_http_browser_module.c"
            ...
            if (name == 
# 288 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                       ((void *)0)
# 288 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                           ) {
                continue;
            }
    ...
    if (cf->netscape4) {
        if (len > sizeof("Mozilla/4.72 ") - 1
            && 
# 356 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              strncmp((const char *) 
# 356 "project/nginx/src/http/modules/ngx_http_browser_module.c"
              ua
# 356 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              , (const char *) 
# 356 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    ...
    if (cf->ancient_browsers) {
        ...
        for (i = 0; i < cf->ancient_browsers->nelts; i++) {
            if (len >= ancient[i].len
                && 
# 368 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  strstr((const char *) 
# 368 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                  ua
# 368 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  , (const char *) 
# 368 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    ...
    uintptr_t data)
{
    if (r->headers_in.msie) {
        *v = ngx_http_variable_true_value;
        return 
# 389 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              0
# 389 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                    ;
    }

    *v = ngx_http_variable_null_value;
    return 
# 393 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          0
# 393 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                ;
}
...
ngx_http_browser_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_http_browser_vars; v->name.len; v++) {
        ...
        if (var == 
# 405 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  ((void *)0)
# 405 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                      ) {
            return 
# 406 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  -1
# 406 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                           ;
        }
    ...
    return 
# 413 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          0
# 413 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                ;
}
...
ngx_http_browser_create_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 423 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
               ((void *)0)
# 423 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                   ) {
        return 
# 424 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              ((void *)0)
# 424 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                  ;
    }
...
ngx_http_browser_merge_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->modern_browsers == 
# 458 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                ((void *)0) 
# 458 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    ...
    } else if (conf->modern_browsers != 
# 462 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                       ((void *)0)
# 462 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                           ) {
        ...
        if (opera == 
# 477 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                    ((void *)0)
# 477 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                        ) {
            return 
# 478 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  (void *) -1
# 478 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                ;
        }
...
# 488 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
       qsort
# 488 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                (browsers, (size_t) conf->modern_browsers->nelts,
    ...
    if (conf->ancient_browsers == 
# 502 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                 ((void *)0) 
# 502 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                      && conf->netscape4 == 0) {
        conf->ancient_browsers = prev->ancient_browsers;
        conf->netscape4 = prev->netscape4;
    }

    if (conf->modern_browser_value == 
# 507 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                     ((void *)0)
# 507 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                         ) {
        conf->modern_browser_value = prev->modern_browser_value;
    }

    if (conf->modern_browser_value == 
# 511 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                     ((void *)0)
# 511 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                         ) {
        conf->modern_browser_value = &ngx_http_variable_true_value;
    }

    if (conf->ancient_browser_value == 
# 515 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                      ((void *)0)
# 515 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                          ) {
        conf->ancient_browser_value = prev->ancient_browser_value;
    }

    if (conf->ancient_browser_value == 
# 519 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                      ((void *)0)
# 519 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                          ) {
        conf->ancient_browser_value = &ngx_http_variable_true_value;
    }

    return 
# 523 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          ((void *)0)
# 523 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                     ;
}
...
ngx_http_modern_browser(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        if (
# 551 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
           strcmp((const char *) 
# 551 "project/nginx/src/http/modules/ngx_http_browser_module.c"
           value[1].data
# 551 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
           , (const char *) 
# 551 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 551 "project/nginx/src/http/modules/ngx_http_browser_module.c"
            ...
            return 
# 553 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  ((void *)0)
# 553 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                             ;
        }

        return 
# 556 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              (void *) -1
# 556 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                            ;
    }

    if (bcf->modern_browsers == 
# 559 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                               ((void *)0)
# 559 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                   ) {
        bcf->modern_browsers = ngx_array_create(cf->pool, 5,
                                            sizeof(ngx_http_modern_browser_t));
        if (bcf->modern_browsers == 
# 562 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                   ((void *)0)
# 562 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                       ) {
            return 
# 563 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  (void *) -1
# 563 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                ;
        }
    }
    ...
    if (browser == 
# 568 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  ((void *)0)
# 568 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                      ) {
        return 
# 569 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              (void *) -1
# 569 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                            ;
    }
    ...
    ngx_conf_log_error(
# 580 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                      1
# 580 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                   , cf, 0,
                       "unknown browser name \"%V\"", &value[1]);

    return 
# 583 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          (void *) -1
# 583 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                        ;
...
found:
    ...
    for (i = 0; i < value[2].len; i++) {
        ...
        ngx_conf_log_error(
# 615 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                          1
# 615 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                       , cf, 0,
                           "invalid browser version \"%V\"", &value[2]);

        return 
# 618 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              (void *) -1
# 618 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                            ;
    }
    ...
    return 
# 625 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          ((void *)0)
# 625 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                     ;
}
...
ngx_http_ancient_browser(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        if (
# 640 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
           strcmp((const char *) 
# 640 "project/nginx/src/http/modules/ngx_http_browser_module.c"
           value[i].data
# 640 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
           , (const char *) 
# 640 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
# 640 "project/nginx/src/http/modules/ngx_http_browser_module.c"
        ...
        if (bcf->ancient_browsers == 
# 645 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                    ((void *)0)
# 645 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                        ) {
            bcf->ancient_browsers = ngx_array_create(cf->pool, 4,
                                                     sizeof(ngx_str_t));
            if (bcf->ancient_browsers == 
# 648 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                        ((void *)0)
# 648 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                            ) {
                return 
# 649 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                      (void *) -1
# 649 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                    ;
            }
        }
        ...
        if (browser == 
# 654 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                      ((void *)0)
# 654 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                          ) {
            return 
# 655 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                  (void *) -1
# 655 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                ;
        }
    ...
    return 
# 661 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          ((void *)0)
# 661 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                     ;
}
...
ngx_http_modern_browser_value(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (bcf->modern_browser_value == 
# 674 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                    ((void *)0)
# 674 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                        ) {
        return 
# 675 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              (void *) -1
# 675 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                            ;
    }
    ...
    return 
# 686 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          ((void *)0)
# 686 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                     ;
}
...
ngx_http_ancient_browser_value(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    bcf->ancient_browser_value = ngx_palloc(cf->pool,
                                            sizeof(ngx_http_variable_value_t));
    if (bcf->ancient_browser_value == 
# 699 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
                                     ((void *)0)
# 699 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                                         ) {
        return 
# 700 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
              (void *) -1
# 700 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                            ;
    }
    ...
    return 
# 711 "project/nginx/src/http/modules/ngx_http_browser_module.c" 3 4
          ((void *)0)
# 711 "project/nginx/src/http/modules/ngx_http_browser_module.c"
                     ;
}
