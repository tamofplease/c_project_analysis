# 0 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
typedef struct {
    ngx_chain_t *free;
    ngx_chain_t *busy;
...
# 25 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 25 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    ngx_http_chunked_filter_init,

    
# 28 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 28 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 29 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 29 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,

    
# 31 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 31 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 32 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 32 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,

    
# 34 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 34 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 35 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)

# 36 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
};


ngx_module_t ngx_http_chunked_filter_module = {
    
# 40 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 40 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
   "8" 
# 40 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   "," 
# 40 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 42 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 42 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 43 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   0x50545448
# 43 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  ,
    
# 44 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 44 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 45 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 45 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 46 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 46 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 47 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 47 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 48 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 48 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 49 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 49 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 50 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   ((void *)0)
# 50 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       ,
    
# 51 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 52 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
};
...
# 65 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                304
        
# 66 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       || r->headers_out.status == 
# 66 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                   204
        
# 67 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       || r->headers_out.status < 
# 67 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                  200
        
# 68 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
       || r != r->main
        || r->method == 
# 69 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                       0x00000004
# 69 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                    )
    {
    ...
    {
        clcf = 
# 77 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
              (
# 77 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
              r
# 77 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
              )->loc_conf[
# 77 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 77 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
        ...
        if (r->http_version >= 
# 79 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                              1001
            
# 80 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
           && clcf->chunked_transfer_encoding)
        {
            if (r->expect_trailers) {
                r
# 83 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
               ->headers_out.content_length_n = -1; if (
# 83 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
               r
# 83 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
...
# 83 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
            ...
            if (ctx == 
# 89 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                      ((void *)0)
# 89 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                          ) {
                return 
# 90 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                      -1
# 90 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                               ;
            }

            r
# 93 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
           ->ctx[
# 93 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
ngx_http_chunked_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (in == 
# 114 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
             ((void *)0) 
# 114 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  || !r->chunked || r->header_only) {
        return ngx_http_next_body_filter(r, in);
    }

    ctx = 
# 118 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
         (
# 118 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
         r
# 118 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
         )->ctx[
# 118 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 118 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
    ...
    out = 
# 120 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
         ((void *)0)
# 120 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
             ;
    ll = &out;
    ...
    for ( ;; ) {
        ...
        size += 
# 130 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
               (((
# 130 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
               cl->buf
# 130 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
               )->temporary || (
# 130 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 130 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
        ...
        if (cl->buf->flush
            || cl->buf->sync
            || 
# 134 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
              ((
# 134 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
              cl->buf
# 134 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
              )->temporary || (
# 134 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 135 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
           || cl->buf->in_file)
        {
            tl = ngx_alloc_chain_link(r->pool);
            if (tl == 
# 138 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                     ((void *)0)
# 138 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                         ) {
                return 
# 139 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                      -1
# 139 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                               ;
            }
        ...
        if (cl->next == 
# 147 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                       ((void *)0)
# 147 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                           ) {
            break;
        }
    ...
    if (size) {
        ...
        if (tl == 
# 156 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 ((void *)0)
# 156 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                     ) {
            return 
# 157 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                  -1
# 157 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                           ;
        }
        ...
        if (chunk == 
# 163 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                    ((void *)0)
# 163 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                        ) {


            chunk = ngx_palloc(r->pool, sizeof("0000000000000000" 
# 166 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                                                 "\r\n"
# 166 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                                                     ) - 1);
            if (chunk == 
# 167 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                        ((void *)0)
# 167 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                            ) {
                return 
# 168 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                      -1
# 168 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                               ;
            }

            b->start = chunk;
            b->end = chunk + sizeof("0000000000000000" 
# 172 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                                      "\r\n"
# 172 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                                          ) - 1;
        }
...
# 179 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                          "\r\n"
# 179 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                              , size);
    ...
    if (cl->buf->last_buf) {
        ...
        if (tl == 
# 187 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 ((void *)0)
# 187 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                     ) {
            return 
# 188 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                  -1
# 188 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                           ;
        }
        ...
        *ll = tl;
        ...
        tl = ngx_chain_get_free_buf(r->pool, &ctx->free);
        if (tl == 
# 201 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 ((void *)0)
# 201 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                     ) {
            return 
# 202 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                  -1
# 202 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                           ;
        }
        ...
        b->memory = 1;
        b->pos = (u_char *) 
# 210 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                           "\r\n"
# 210 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                               ;
        b->last = b->pos + 2;
        ...
        *ll = 
# 216 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
             ((void *)0)
# 216 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                 ;
    }
    ...
    ngx_http_chunked_filter_ctx_t *ctx)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 247 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                             ((void *)0)
# 247 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                 ) {
                break;
            }
...
# 261 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                             "\r\n"
# 261 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                                 ) - 1;
    }

    cl = ngx_chain_get_free_buf(r->pool, &ctx->free);
    if (cl == 
# 265 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
             ((void *)0)
# 265 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                 ) {
        return 
# 266 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
              ((void *)0)
# 266 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  ;
    }
    ...
    if (len == 0) {
        b->pos = (u_char *) 
# 277 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                           "\r\n" 
# 277 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                "0" 
# 277 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                    "\r\n" "\r\n"
# 277 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                             ;
        b->last = b->pos + sizeof(
# 278 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                 "\r\n" 
# 278 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                      "0" 
# 278 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                          "\r\n" "\r\n"
# 278 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
    ...
    len += sizeof(
# 282 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 "\r\n" 
# 282 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                      "0" 
# 282 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                          "\r\n" "\r\n"
# 282 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
    ...
    if (b->pos == 
# 285 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 ((void *)0)
# 285 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                     ) {
        return 
# 286 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
              ((void *)0)
# 286 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  ;
    }
    ...
    *b->last++ = 
# 291 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                (u_char) '\r'
# 291 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  ; *b->last++ = 
# 291 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                 (u_char) '\n'
# 291 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
    ...
    *b->last++ = '0';
    *b->last++ = 
# 293 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                (u_char) '\r'
# 293 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  ; *b->last++ = 
# 293 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                 (u_char) '\n'
# 293 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 301 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                             ((void *)0)
# 301 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                 ) {
                break;
            }
        ...
        b->last = 
# 318 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 (((u_char *) __builtin___memcpy_chk (
# 318 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                 b->last
# 318 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 , 
# 318 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 318 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
        ...
        *b->last++ = ':'; *b->last++ = ' ';
        ...
        b->last = 
# 321 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 (((u_char *) __builtin___memcpy_chk (
# 321 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                 b->last
# 321 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                 , 
# 321 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
# 321 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                                                                             ;
        *b->last++ = 
# 322 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                    (u_char) '\r'
# 322 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                      ; *b->last++ = 
# 322 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                     (u_char) '\n'
# 322 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
    ...
    *b->last++ = 
# 325 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                (u_char) '\r'
# 325 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                  ; *b->last++ = 
# 325 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
                                 (u_char) '\n'
# 325 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
...
ngx_http_chunked_filter_init(ngx_conf_t *cf)
{
    ...
    return 
# 340 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c" 3 4
          0
# 340 "project/nginx/src/http/modules/ngx_http_chunked_filter_module.c"
                ;
}
