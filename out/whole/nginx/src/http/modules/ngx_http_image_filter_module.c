# 0 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 2

# 1 "/usr/local/include/gd.h" 1 3 4

#define GD_H 1
# 14 "/usr/local/include/gd.h" 3 4
...
# 96 "/usr/local/include/gd.h" 3 4
#undef ARG_NOT_USED
#define ARG_NOT_USED(arg) (void) arg
# 113 "/usr/local/include/gd.h" 3 4
# 1 "/usr/local/include/gd_io.h" 1 3 4

#define GD_IO_H 1
# 55 "/usr/local/include/gd_io.h" 3 4
...
# 114 "/usr/local/include/gd.h" 2 3 4
...
# 142 "/usr/local/include/gd.h" 3 4
...
# 164 "/usr/local/include/gd.h" 3 4
#define gdTrueColorGetAlpha(c) (((c) & 0x7F000000) >> 24)
# 177 "/usr/local/include/gd.h" 3 4
#define gdTrueColorGetRed(c) (((c) & 0xFF0000) >> 16)
# 190 "/usr/local/include/gd.h" 3 4
#define gdTrueColorGetGreen(c) (((c) & 0x00FF00) >> 8)
# 203 "/usr/local/include/gd.h" 3 4
#define gdTrueColorGetBlue(c) ((c) & 0x0000FF)
# 227 "/usr/local/include/gd.h" 3 4
...
__attribute__ ((__visibility__ ("default"))) int gdAlphaBlend (int dest, int src);
__attribute__ ((__visibility__ ("default"))) int gdLayerOverlay (int dest, int src);
__attribute__ ((__visibility__ ("default"))) int gdLayerMultiply (int dest, int src);
# 271 "/usr/local/include/gd.h" 3 4
...
# 310 "/usr/local/include/gd.h" 3 4
typedef enum {
 GD_DEFAULT = 0,
 GD_BELL,
 GD_BESSEL,
...
# 359 "/usr/local/include/gd.h" 3 4
typedef enum {
 GD_HEIF_CODEC_UNKNOWN = 0,
 GD_HEIF_CODEC_HEVC,
 GD_HEIF_CODEC_AV1 = 4,
} gdHeifCodec;
# 379 "/usr/local/include/gd.h" 3 4
...
# 414 "/usr/local/include/gd.h" 3 4
typedef struct gdImageStruct {
 ...
 int blue[256];
 int open[256];
# 437 "/usr/local/include/gd.h" 3 4
 int transparent;
 int *polyInts;
 int polyAllocated;
 ...
 int thick;
# 458 "/usr/local/include/gd.h" 3 4
 int alpha[256];
...
# 532 "/usr/local/include/gd.h" 3 4
typedef struct
{
 double x, y;
}
gdPointF, *gdPointFPtr;
# 579 "/usr/local/include/gd.h" 3 4
typedef struct {
...
__attribute__ ((__visibility__ ("default"))) void gdSetErrorMethod(gdErrorMethod);
__attribute__ ((__visibility__ ("default"))) void gdClearErrorMethod(void);




#define gdDashSize 4
# 635 "/usr/local/include/gd.h" 3 4
#define gdStyled (-2)
#define gdBrushed (-3)
...
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreate (int sx, int sy);


#define gdImageCreatePalette gdImageCreate


__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateTrueColor (int sx, int sy);
...
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromPng (FILE * fd);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromPngCtx(gdIOCtxPtr in);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromPngPtr (int size, void *data);


__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGif (FILE * fd);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGifCtx(gdIOCtxPtr in);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGifPtr (int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromWBMP (FILE * inFile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromWBMPCtx(gdIOCtxPtr infile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromWBMPPtr (int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromJpeg (FILE * infile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromJpegEx (FILE * infile, int ignore_warning);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromJpegCtx(gdIOCtxPtr infile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromJpegCtxEx(gdIOCtxPtr infile, int ignore_warning);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromJpegPtr (int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromJpegPtrEx (int size, void *data, int ignore_warning);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromWebp (FILE * inFile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromWebpPtr (int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromWebpCtx(gdIOCtxPtr infile);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromHeif(FILE *inFile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromHeifPtr(int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromHeifCtx(gdIOCtxPtr infile);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromAvif(FILE *inFile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromAvifPtr(int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromAvifCtx(gdIOCtxPtr infile);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromTiff(FILE *inFile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromTiffCtx(gdIOCtxPtr infile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromTiffPtr(int size, void *data);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromTga( FILE * fp );
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromTgaCtx(gdIOCtxPtr ctx);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromTgaPtr(int size, void *data);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromBmp (FILE * inFile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromBmpPtr (int size, void *data);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromBmpCtx(gdIOCtxPtr infile);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromFile(const char *filename);
# 728 "/usr/local/include/gd.h" 3 4
typedef struct {
...
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromPngSource (gdSourcePtr in);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd (FILE * in);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGdCtx(gdIOCtxPtr in);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGdPtr (int size, void *data);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd2 (FILE * in);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd2Ctx(gdIOCtxPtr in);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd2Ptr (int size, void *data);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd2Part (FILE * in, int srcx, int srcy, int w,
        int h);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd2PartCtx(gdIOCtxPtr in, int srcx, int srcy,
           int w, int h);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromGd2PartPtr (int size, void *data, int srcx, int srcy,
           int w, int h);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromXbm (FILE * in);
__attribute__ ((__visibility__ ("default"))) void gdImageXbmCtx(gdImagePtr image, char* file_name, int fg, gdIOCtxPtr out);


__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreateFromXpm (char *filename);

__attribute__ ((__visibility__ ("default"))) void gdImageDestroy (gdImagePtr im);
# 769 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) void gdImageSetPixel (gdImagePtr im, int x, int y, int color);


__attribute__ ((__visibility__ ("default"))) int gdImageGetPixel (gdImagePtr im, int x, int y);
__attribute__ ((__visibility__ ("default"))) int gdImageGetTrueColorPixel (gdImagePtr im, int x, int y);

__attribute__ ((__visibility__ ("default"))) void gdImageAABlend (gdImagePtr im);

__attribute__ ((__visibility__ ("default"))) void gdImageLine (gdImagePtr im, int x1, int y1, int x2, int y2, int color);



__attribute__ ((__visibility__ ("default"))) void gdImageDashedLine (gdImagePtr im, int x1, int y1, int x2, int y2,
                                     int color);


__attribute__ ((__visibility__ ("default"))) void gdImageRectangle (gdImagePtr im, int x1, int y1, int x2, int y2,
                                    int color);

__attribute__ ((__visibility__ ("default"))) void gdImageFilledRectangle (gdImagePtr im, int x1, int y1, int x2, int y2,
       int color);
__attribute__ ((__visibility__ ("default"))) void gdImageSetClip(gdImagePtr im, int x1, int y1, int x2, int y2);
__attribute__ ((__visibility__ ("default"))) void gdImageGetClip(gdImagePtr im, int *x1P, int *y1P, int *x2P, int *y2P);
__attribute__ ((__visibility__ ("default"))) void gdImageSetResolution(gdImagePtr im, const unsigned int res_x, const unsigned int res_y);
__attribute__ ((__visibility__ ("default"))) int gdImageBoundsSafe (gdImagePtr im, int x, int y);
__attribute__ ((__visibility__ ("default"))) void gdImageChar (gdImagePtr im, gdFontPtr f, int x, int y, int c,
                               int color);
__attribute__ ((__visibility__ ("default"))) void gdImageCharUp (gdImagePtr im, gdFontPtr f, int x, int y, int c,
                                 int color);
__attribute__ ((__visibility__ ("default"))) void gdImageString (gdImagePtr im, gdFontPtr f, int x, int y,
                                 unsigned char *s, int color);
__attribute__ ((__visibility__ ("default"))) void gdImageStringUp (gdImagePtr im, gdFontPtr f, int x, int y,
                                   unsigned char *s, int color);
__attribute__ ((__visibility__ ("default"))) void gdImageString16 (gdImagePtr im, gdFontPtr f, int x, int y,
                                   unsigned short *s, int color);
__attribute__ ((__visibility__ ("default"))) void gdImageStringUp16 (gdImagePtr im, gdFontPtr f, int x, int y,
                                     unsigned short *s, int color);
...
__attribute__ ((__visibility__ ("default"))) int gdFontCacheSetup (void);



__attribute__ ((__visibility__ ("default"))) void gdFontCacheShutdown (void);



__attribute__ ((__visibility__ ("default"))) void gdFreeFontCache (void);


__attribute__ ((__visibility__ ("default"))) char * gdImageStringTTF (gdImagePtr im, int *brect, int fg, const char *fontlist,
                                      double ptsize, double angle, int x, int y,
                                      const char *string);


__attribute__ ((__visibility__ ("default"))) char * gdImageStringFT (gdImagePtr im, int *brect, int fg, const char *fontlist,
                                     double ptsize, double angle, int x, int y,
                                     const char *string);
# 849 "/usr/local/include/gd.h" 3 4
typedef struct {
 int flags;
 double linespacing;
 int charmap;
 ...
 char *fontpath;
# 877 "/usr/local/include/gd.h" 3 4
}
...
__attribute__ ((__visibility__ ("default"))) int gdFTUseFontConfig(int flag);
...
__attribute__ ((__visibility__ ("default"))) char * gdImageStringFTEx (gdImagePtr im, int *brect, int fg, const char *fontlist,
                                       double ptsize, double angle, int x, int y,
                                       const char *string, gdFTStringExtraPtr strex);
# 933 "/usr/local/include/gd.h" 3 4
typedef struct {
 int x, y;
}
gdPoint, *gdPointPtr;
# 953 "/usr/local/include/gd.h" 3 4
typedef struct {
 int x, y;
 int width, height;
}
...
__attribute__ ((__visibility__ ("default"))) void gdImagePolygon (gdImagePtr im, gdPointPtr p, int n, int c);
__attribute__ ((__visibility__ ("default"))) void gdImageOpenPolygon (gdImagePtr im, gdPointPtr p, int n, int c);
__attribute__ ((__visibility__ ("default"))) void gdImageFilledPolygon (gdImagePtr im, gdPointPtr p, int n, int c);



__attribute__ ((__visibility__ ("default"))) int gdImageColorAllocate (gdImagePtr im, int r, int g, int b);

__attribute__ ((__visibility__ ("default"))) int gdImageColorAllocateAlpha (gdImagePtr im, int r, int g, int b, int a);

__attribute__ ((__visibility__ ("default"))) int gdImageColorClosest (gdImagePtr im, int r, int g, int b);




__attribute__ ((__visibility__ ("default"))) int gdImageColorClosestAlpha (gdImagePtr im, int r, int g, int b, int a);

__attribute__ ((__visibility__ ("default"))) int gdImageColorClosestHWB (gdImagePtr im, int r, int g, int b);

__attribute__ ((__visibility__ ("default"))) int gdImageColorExact (gdImagePtr im, int r, int g, int b);

__attribute__ ((__visibility__ ("default"))) int gdImageColorExactAlpha (gdImagePtr im, int r, int g, int b, int a);

__attribute__ ((__visibility__ ("default"))) int gdImageColorResolve (gdImagePtr im, int r, int g, int b);

__attribute__ ((__visibility__ ("default"))) int gdImageColorResolveAlpha (gdImagePtr im, int r, int g, int b, int a);




#define gdTrueColor(r,g,b) (((r) << 16) + ((g) << 8) + (b))
# 1015 "/usr/local/include/gd.h" 3 4
#define gdTrueColorAlpha(r,g,b,a) (((a) << 24) + ((r) << 16) + ((g) << 8) + (b))




__attribute__ ((__visibility__ ("default"))) void gdImageColorDeallocate (gdImagePtr im, int color);
# 1045 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCreatePaletteFromTrueColor (gdImagePtr im, int ditherFlag,
          int colorsWanted);

__attribute__ ((__visibility__ ("default"))) int gdImageTrueColorToPalette (gdImagePtr im, int ditherFlag,
         int colorsWanted);

__attribute__ ((__visibility__ ("default"))) int gdImagePaletteToTrueColor(gdImagePtr src);





__attribute__ ((__visibility__ ("default"))) int gdImageColorMatch(gdImagePtr im1, gdImagePtr im2);
# 1066 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) int gdImageTrueColorToPaletteSetMethod (gdImagePtr im, int method, int speed);
# 1075 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) void gdImageTrueColorToPaletteSetQuality (gdImagePtr im, int min_quality, int max_quality);
# 1086 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) void gdImageColorTransparent (gdImagePtr im, int color);

__attribute__ ((__visibility__ ("default"))) void gdImagePaletteCopy (gdImagePtr dst, gdImagePtr src);

typedef int (*gdCallbackImageColor)(gdImagePtr im, int src);

__attribute__ ((__visibility__ ("default"))) int gdImageColorReplace(gdImagePtr im, int src, int dst);
__attribute__ ((__visibility__ ("default"))) int gdImageColorReplaceThreshold(gdImagePtr im, int src, int dst, float threshold);
__attribute__ ((__visibility__ ("default"))) int gdImageColorReplaceArray(gdImagePtr im, int len, int *src, int *dst);
__attribute__ ((__visibility__ ("default"))) int gdImageColorReplaceCallback(gdImagePtr im, gdCallbackImageColor callback);

__attribute__ ((__visibility__ ("default"))) void gdImageGif (gdImagePtr im, FILE * out);
__attribute__ ((__visibility__ ("default"))) void gdImagePng (gdImagePtr im, FILE * out);
__attribute__ ((__visibility__ ("default"))) void gdImagePngCtx(gdImagePtr im, gdIOCtxPtr out);
__attribute__ ((__visibility__ ("default"))) void gdImageGifCtx(gdImagePtr im, gdIOCtxPtr out);
__attribute__ ((__visibility__ ("default"))) void gdImageTiff(gdImagePtr im, FILE *outFile);
__attribute__ ((__visibility__ ("default"))) void * gdImageTiffPtr(gdImagePtr im, int *size);
__attribute__ ((__visibility__ ("default"))) void gdImageTiffCtx(gdImagePtr image, gdIOCtxPtr out);

__attribute__ ((__visibility__ ("default"))) void * gdImageBmpPtr(gdImagePtr im, int *size, int compression);
__attribute__ ((__visibility__ ("default"))) void gdImageBmp(gdImagePtr im, FILE *outFile, int compression);
__attribute__ ((__visibility__ ("default"))) void gdImageBmpCtx(gdImagePtr im, gdIOCtxPtr out, int compression);





__attribute__ ((__visibility__ ("default"))) void gdImagePngEx (gdImagePtr im, FILE * out, int level);
__attribute__ ((__visibility__ ("default"))) void gdImagePngCtxEx(gdImagePtr im, gdIOCtxPtr out, int level);

__attribute__ ((__visibility__ ("default"))) void gdImageWBMP (gdImagePtr image, int fg, FILE * out);
__attribute__ ((__visibility__ ("default"))) void gdImageWBMPCtx(gdImagePtr image, int fg, gdIOCtxPtr out);

__attribute__ ((__visibility__ ("default"))) int gdImageFile(gdImagePtr im, const char *filename);
__attribute__ ((__visibility__ ("default"))) int gdSupportsFileType(const char *filename, int writing);




__attribute__ ((__visibility__ ("default"))) void gdFree (void *m);


__attribute__ ((__visibility__ ("default"))) void * gdImageWBMPPtr (gdImagePtr im, int *size, int fg);



__attribute__ ((__visibility__ ("default"))) void gdImageJpeg (gdImagePtr im, FILE * out, int quality);
__attribute__ ((__visibility__ ("default"))) void gdImageJpegCtx(gdImagePtr im, gdIOCtxPtr out, int quality);


__attribute__ ((__visibility__ ("default"))) void * gdImageJpegPtr (gdImagePtr im, int *size, int quality);
# 1149 "/usr/local/include/gd.h" 3 4
#define gdWebpLossless 101

__attribute__ ((__visibility__ ("default"))) void gdImageWebpEx (gdImagePtr im, FILE * outFile, int quantization);
__attribute__ ((__visibility__ ("default"))) void gdImageWebp (gdImagePtr im, FILE * outFile);
__attribute__ ((__visibility__ ("default"))) void * gdImageWebpPtr (gdImagePtr im, int *size);
__attribute__ ((__visibility__ ("default"))) void * gdImageWebpPtrEx (gdImagePtr im, int *size, int quantization);
__attribute__ ((__visibility__ ("default"))) void gdImageWebpCtx(gdImagePtr im, gdIOCtxPtr outfile, int quantization);

__attribute__ ((__visibility__ ("default"))) void gdImageHeifEx(gdImagePtr im, FILE *outFile, int quality, gdHeifCodec codec, gdHeifChroma chroma);
__attribute__ ((__visibility__ ("default"))) void gdImageHeif(gdImagePtr im, FILE *outFile);
__attribute__ ((__visibility__ ("default"))) void * gdImageHeifPtr(gdImagePtr im, int *size);
__attribute__ ((__visibility__ ("default"))) void * gdImageHeifPtrEx(gdImagePtr im, int *size, int quality, gdHeifCodec codec, gdHeifChroma chroma);
__attribute__ ((__visibility__ ("default"))) void gdImageHeifCtx(gdImagePtr im, gdIOCtxPtr outfile, int quality, gdHeifCodec codec, gdHeifChroma chroma);

__attribute__ ((__visibility__ ("default"))) void gdImageAvif(gdImagePtr im, FILE *outFile);
__attribute__ ((__visibility__ ("default"))) void gdImageAvifEx(gdImagePtr im, FILE *outFile, int quality, int speed);
__attribute__ ((__visibility__ ("default"))) void * gdImageAvifPtr(gdImagePtr im, int *size);
__attribute__ ((__visibility__ ("default"))) void * gdImageAvifPtrEx(gdImagePtr im, int *size, int quality, int speed);
__attribute__ ((__visibility__ ("default"))) void gdImageAvifCtx(gdImagePtr im, gdIOCtxPtr outfile, int quality, int speed);
# 1185 "/usr/local/include/gd.h" 3 4
enum {
 gdDisposalUnknown,
 gdDisposalNone,
...
__attribute__ ((__visibility__ ("default"))) void gdImageGifAnimBegin(gdImagePtr im, FILE *outFile, int GlobalCM, int Loops);
__attribute__ ((__visibility__ ("default"))) void gdImageGifAnimAdd(gdImagePtr im, FILE *outFile, int LocalCM, int LeftOfs, int TopOfs, int Delay, int Disposal, gdImagePtr previm);
__attribute__ ((__visibility__ ("default"))) void gdImageGifAnimEnd(FILE *outFile);
__attribute__ ((__visibility__ ("default"))) void gdImageGifAnimBeginCtx(gdImagePtr im, gdIOCtxPtr out, int GlobalCM, int Loops);
__attribute__ ((__visibility__ ("default"))) void gdImageGifAnimAddCtx(gdImagePtr im, gdIOCtxPtr out, int LocalCM, int LeftOfs, int TopOfs, int Delay, int Disposal, gdImagePtr previm);
__attribute__ ((__visibility__ ("default"))) void gdImageGifAnimEndCtx(gdIOCtxPtr out);
__attribute__ ((__visibility__ ("default"))) void * gdImageGifAnimBeginPtr(gdImagePtr im, int *size, int GlobalCM, int Loops);
__attribute__ ((__visibility__ ("default"))) void * gdImageGifAnimAddPtr(gdImagePtr im, int *size, int LocalCM, int LeftOfs, int TopOfs, int Delay, int Disposal, gdImagePtr previm);
__attribute__ ((__visibility__ ("default"))) void * gdImageGifAnimEndPtr(int *size);
# 1232 "/usr/local/include/gd.h" 3 4
typedef struct {
...
__attribute__ ((__visibility__ ("default"))) void gdImagePngToSink (gdImagePtr im, gdSinkPtr out);

__attribute__ ((__visibility__ ("default"))) void gdImageGd (gdImagePtr im, FILE * out);
__attribute__ ((__visibility__ ("default"))) void gdImageGd2 (gdImagePtr im, FILE * out, int cs, int fmt);


__attribute__ ((__visibility__ ("default"))) void * gdImageGifPtr (gdImagePtr im, int *size);


__attribute__ ((__visibility__ ("default"))) void * gdImagePngPtr (gdImagePtr im, int *size);
__attribute__ ((__visibility__ ("default"))) void * gdImagePngPtrEx (gdImagePtr im, int *size, int level);


__attribute__ ((__visibility__ ("default"))) void * gdImageGdPtr (gdImagePtr im, int *size);


__attribute__ ((__visibility__ ("default"))) void * gdImageGd2Ptr (gdImagePtr im, int cs, int fmt, int *size);
# 1267 "/usr/local/include/gd.h" 3 4
#define gdArc 0
#define gdPie gdArc
#define gdChord 1
#define gdNoFill 2
...
__attribute__ ((__visibility__ ("default"))) void gdImageFilledArc (gdImagePtr im, int cx, int cy, int w, int h, int s,
                                    int e, int color, int style);
__attribute__ ((__visibility__ ("default"))) void gdImageArc (gdImagePtr im, int cx, int cy, int w, int h, int s, int e,
                              int color);
__attribute__ ((__visibility__ ("default"))) void gdImageEllipse(gdImagePtr im, int cx, int cy, int w, int h, int color);
__attribute__ ((__visibility__ ("default"))) void gdImageFilledEllipse (gdImagePtr im, int cx, int cy, int w, int h,
                                        int color);
__attribute__ ((__visibility__ ("default"))) void gdImageFillToBorder (gdImagePtr im, int x, int y, int border,
                                       int color);
__attribute__ ((__visibility__ ("default"))) void gdImageFill (gdImagePtr im, int x, int y, int color);
__attribute__ ((__visibility__ ("default"))) void gdImageCopy (gdImagePtr dst, gdImagePtr src, int dstX, int dstY,
                               int srcX, int srcY, int w, int h);
__attribute__ ((__visibility__ ("default"))) void gdImageCopyMerge (gdImagePtr dst, gdImagePtr src, int dstX, int dstY,
                                    int srcX, int srcY, int w, int h, int pct);
__attribute__ ((__visibility__ ("default"))) void gdImageCopyMergeGray (gdImagePtr dst, gdImagePtr src, int dstX,
...
__attribute__ ((__visibility__ ("default"))) void gdImageCopyResized (gdImagePtr dst, gdImagePtr src, int dstX, int dstY,
                                      int srcX, int srcY, int dstW, int dstH, int srcW,
                                      int srcH);
# 1307 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) void gdImageCopyResampled (gdImagePtr dst, gdImagePtr src, int dstX,
                                        int dstY, int srcX, int srcY, int dstW, int dstH,
                                        int srcW, int srcH);
# 1318 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) void gdImageCopyRotated (gdImagePtr dst,
                                      gdImagePtr src,
                                      double dstX, double dstY,
                                      int srcX, int srcY,
                                      int srcWidth, int srcHeight, int angle);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageClone (gdImagePtr src);

__attribute__ ((__visibility__ ("default"))) void gdImageSetBrush (gdImagePtr im, gdImagePtr brush);
__attribute__ ((__visibility__ ("default"))) void gdImageSetTile (gdImagePtr im, gdImagePtr tile);
__attribute__ ((__visibility__ ("default"))) void gdImageSetAntiAliased (gdImagePtr im, int c);
__attribute__ ((__visibility__ ("default"))) void gdImageSetAntiAliasedDontBlend (gdImagePtr im, int c, int dont_blend);
__attribute__ ((__visibility__ ("default"))) void gdImageSetStyle (gdImagePtr im, int *style, int noOfPixels);


__attribute__ ((__visibility__ ("default"))) void gdImageSetThickness (gdImagePtr im, int thickness);

__attribute__ ((__visibility__ ("default"))) void gdImageInterlace (gdImagePtr im, int interlaceArg);
__attribute__ ((__visibility__ ("default"))) void gdImageAlphaBlending (gdImagePtr im, int alphaBlendingArg);
__attribute__ ((__visibility__ ("default"))) void gdImageSaveAlpha (gdImagePtr im, int saveAlphaArg);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageNeuQuant(gdImagePtr im, const int max_color, int sample_factor);
...
__attribute__ ((__visibility__ ("default"))) int gdImagePixelate(gdImagePtr im, int block_size, const unsigned int mode);
...
__attribute__ ((__visibility__ ("default"))) int gdImageScatter(gdImagePtr im, int sub, int plus);
__attribute__ ((__visibility__ ("default"))) int gdImageScatterColor(gdImagePtr im, int sub, int plus, int colors[], unsigned int num_colors);
__attribute__ ((__visibility__ ("default"))) int gdImageScatterEx(gdImagePtr im, gdScatterPtr s);
__attribute__ ((__visibility__ ("default"))) int gdImageSmooth(gdImagePtr im, float weight);
__attribute__ ((__visibility__ ("default"))) int gdImageMeanRemoval(gdImagePtr im);
__attribute__ ((__visibility__ ("default"))) int gdImageEmboss(gdImagePtr im);
__attribute__ ((__visibility__ ("default"))) int gdImageGaussianBlur(gdImagePtr im);
__attribute__ ((__visibility__ ("default"))) int gdImageEdgeDetectQuick(gdImagePtr src);
__attribute__ ((__visibility__ ("default"))) int gdImageSelectiveBlur( gdImagePtr src);
__attribute__ ((__visibility__ ("default"))) int gdImageConvolution(gdImagePtr src, float filter[3][3], float filter_div, float offset);
__attribute__ ((__visibility__ ("default"))) int gdImageColor(gdImagePtr src, const int red, const int green, const int blue, const int alpha);
__attribute__ ((__visibility__ ("default"))) int gdImageContrast(gdImagePtr src, double contrast);
__attribute__ ((__visibility__ ("default"))) int gdImageBrightness(gdImagePtr src, int brightness);
__attribute__ ((__visibility__ ("default"))) int gdImageGrayScale(gdImagePtr src);
__attribute__ ((__visibility__ ("default"))) int gdImageNegate(gdImagePtr src);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCopyGaussianBlurred(gdImagePtr src, int radius,
                                                   double sigma);
# 1391 "/usr/local/include/gd.h" 3 4
#define gdImageTrueColor(im) ((im)->trueColor)
# 1401 "/usr/local/include/gd.h" 3 4
#define gdImageSX(im) ((im)->sx)
# 1411 "/usr/local/include/gd.h" 3 4
#define gdImageSY(im) ((im)->sy)
# 1423 "/usr/local/include/gd.h" 3 4
#define gdImageColorsTotal(im) ((im)->colorsTotal)
# 1434 "/usr/local/include/gd.h" 3 4
#define gdImageRed(im,c) ((im)->trueColor ? gdTrueColorGetRed(c) : (im)->red[(c)])
# 1446 "/usr/local/include/gd.h" 3 4
#define gdImageGreen(im,c) ((im)->trueColor ? gdTrueColorGetGreen(c) : (im)->green[(c)])
# 1458 "/usr/local/include/gd.h" 3 4
#define gdImageBlue(im,c) ((im)->trueColor ? gdTrueColorGetBlue(c) : (im)->blue[(c)])
# 1470 "/usr/local/include/gd.h" 3 4
#define gdImageAlpha(im,c) ((im)->trueColor ? gdTrueColorGetAlpha(c) : (im)->alpha[(c)])
# 1484 "/usr/local/include/gd.h" 3 4
#define gdImageGetTransparent(im) ((im)->transparent)
# 1500 "/usr/local/include/gd.h" 3 4
#define gdImageGetInterlaced(im) ((im)->interlace)
# 1519 "/usr/local/include/gd.h" 3 4
#define gdImagePalettePixel(im,x,y) (im)->pixels[(y)][(x)]
# 1538 "/usr/local/include/gd.h" 3 4
#define gdImageTrueColorPixel(im,x,y) (im)->tpixels[(y)][(x)]
# 1552 "/usr/local/include/gd.h" 3 4
#define gdImageResolutionX(im) (im)->res_x
# 1566 "/usr/local/include/gd.h" 3 4
#define gdImageResolutionY(im) (im)->res_y



__attribute__ ((__visibility__ ("default"))) gdIOCtxPtr gdNewFileCtx(FILE *);
...
__attribute__ ((__visibility__ ("default"))) gdIOCtxPtr gdNewDynamicCtx(int size, void *data);
# 1586 "/usr/local/include/gd.h" 3 4
__attribute__ ((__visibility__ ("default"))) gdIOCtxPtr gdNewDynamicCtxEx(int size, void *data, int freeFlag);
__attribute__ ((__visibility__ ("default"))) gdIOCtxPtr gdNewSSCtx(gdSourcePtr in, gdSinkPtr out);
__attribute__ ((__visibility__ ("default"))) void * gdDPExtractData(gdIOCtxPtr ctx, int *size);
...
__attribute__ ((__visibility__ ("default"))) int gdImageCompare (gdImagePtr im1, gdImagePtr im2);

__attribute__ ((__visibility__ ("default"))) void gdImageFlipHorizontal(gdImagePtr im);
__attribute__ ((__visibility__ ("default"))) void gdImageFlipVertical(gdImagePtr im);
__attribute__ ((__visibility__ ("default"))) void gdImageFlipBoth(gdImagePtr im);

#define GD_FLIP_HORINZONTAL 1
#define GD_FLIP_HORIZONTAL 1
#define GD_FLIP_VERTICAL 2
#define GD_FLIP_BOTH 3
# 1625 "/usr/local/include/gd.h" 3 4
enum gdCropMode {
 GD_CROP_DEFAULT = 0,
 GD_CROP_TRANSPARENT,
 GD_CROP_BLACK,
...
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCrop(gdImagePtr src, const gdRect *crop);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCropAuto(gdImagePtr im, const unsigned int mode);
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageCropThreshold(gdImagePtr im, const unsigned int color, const float threshold);

__attribute__ ((__visibility__ ("default"))) int gdImageSetInterpolationMethod(gdImagePtr im, gdInterpolationMethod id);
__attribute__ ((__visibility__ ("default"))) gdInterpolationMethod gdImageGetInterpolationMethod(gdImagePtr im);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageScale(const gdImagePtr src, const unsigned int new_width, const unsigned int new_height);

__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageRotateInterpolated(const gdImagePtr src, const float angle, int bgcolor);
...
__attribute__ ((__visibility__ ("default"))) int gdAffineApplyToPointF (gdPointFPtr dst, const gdPointFPtr src, const double affine[6]);
__attribute__ ((__visibility__ ("default"))) int gdAffineInvert (double dst[6], const double src[6]);
__attribute__ ((__visibility__ ("default"))) int gdAffineFlip (double dst_affine[6], const double src_affine[6], const int flip_h, const int flip_v);
__attribute__ ((__visibility__ ("default"))) int gdAffineConcat (double dst[6], const double m1[6], const double m2[6]);

__attribute__ ((__visibility__ ("default"))) int gdAffineIdentity (double dst[6]);
__attribute__ ((__visibility__ ("default"))) int gdAffineScale (double dst[6], const double scale_x, const double scale_y);
__attribute__ ((__visibility__ ("default"))) int gdAffineRotate (double dst[6], const double angle);
__attribute__ ((__visibility__ ("default"))) int gdAffineShearHorizontal (double dst[6], const double angle);
__attribute__ ((__visibility__ ("default"))) int gdAffineShearVertical(double dst[6], const double angle);
__attribute__ ((__visibility__ ("default"))) int gdAffineTranslate (double dst[6], const double offset_x, const double offset_y);
__attribute__ ((__visibility__ ("default"))) double gdAffineExpansion (const double src[6]);
__attribute__ ((__visibility__ ("default"))) int gdAffineRectilinear (const double src[6]);
__attribute__ ((__visibility__ ("default"))) int gdAffineEqual (const double matrix1[6], const double matrix2[6]);
__attribute__ ((__visibility__ ("default"))) int gdTransformAffineGetImage(gdImagePtr *dst, const gdImagePtr src, gdRectPtr src_area, const double affine[6]);
__attribute__ ((__visibility__ ("default"))) int gdTransformAffineCopy(gdImagePtr dst, int dst_x, int dst_y, const gdImagePtr src, gdRectPtr src_region, const double affine[6]);





__attribute__ ((__visibility__ ("default"))) int gdTransformAffineBoundingBox(gdRectPtr src, const double affine[6], gdRectPtr bbox);
# 1693 "/usr/local/include/gd.h" 3 4
...
__attribute__ ((__visibility__ ("default"))) int gdMajorVersion(void);
__attribute__ ((__visibility__ ("default"))) int gdMinorVersion(void);
__attribute__ ((__visibility__ ("default"))) int gdReleaseVersion(void);
__attribute__ ((__visibility__ ("default"))) const char * gdExtraVersion(void);
__attribute__ ((__visibility__ ("default"))) const char * gdVersionString(void);


# 1 "/usr/local/include/gdfx.h" 1 3 4
...
__attribute__ ((__visibility__ ("default"))) gdImagePtr gdImageSquareToCircle(gdImagePtr im, int radius);

__attribute__ ((__visibility__ ("default"))) char * gdImageStringFTCircle(
    gdImagePtr im,
    int cx,
    int cy,
    double radius,
...
__attribute__ ((__visibility__ ("default"))) void gdImageSharpen (gdImagePtr im, int pct);
# 1716 "/usr/local/include/gd.h" 2 3 4
# 13 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 2
...
# 40 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
typedef struct {
    ngx_uint_t filter;
    ngx_uint_t width;
    ngx_uint_t height;
...
static ngx_command_t ngx_http_image_filter_commands[] = {
    ...
    { 
# 124 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 124 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
     "image_filter"
# 124 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ) - 1, (u_char *) 
# 124 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 125 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x08000000
# 125 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      |
# 125 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
...
# 127 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 127 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      0,
      
# 129 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 129 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

    { 
# 131 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 131 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 132 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x02000000
# 132 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       |
# 132 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        0x04000000
# 132 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 134 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 134 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      0,
      
# 136 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 136 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

    { 
# 138 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 138 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 139 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x02000000
# 139 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       |
# 139 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        0x04000000
# 139 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 141 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 141 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      0,
      
# 143 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 143 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

    { 
# 145 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 145 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 146 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x02000000
# 146 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       |
# 146 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        0x04000000
# 146 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 148 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 148 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      0,
      
# 150 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 150 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

    { 
# 152 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 152 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 153 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x02000000
# 153 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       |
# 153 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        0x04000000
# 153 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 155 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 155 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      
# 156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (
# 156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
     ngx_http_image_filter_conf_t
# 156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     , 
# 156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 157 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 157 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

    { 
# 159 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 159 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 160 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x02000000
# 160 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       |
# 160 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        0x04000000
# 160 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 162 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 162 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      
# 163 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (
# 163 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
     ngx_http_image_filter_conf_t
# 163 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     , 
# 163 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 164 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 164 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

    { 
# 166 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { sizeof(
# 166 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
     "image_filter_buffer"
# 166 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ) - 1, (u_char *) 
# 166 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 167 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     0x02000000
# 167 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       |
# 167 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        0x04000000
# 167 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 169 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 169 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ,
      
# 170 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     __builtin_offsetof (
# 170 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
     ngx_http_image_filter_conf_t
# 170 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     , 
# 170 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 171 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     ((void *)0) 
# 171 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          },

      
# 173 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 174 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
};


static ngx_http_module_t ngx_http_image_filter_module_ctx = {
    
# 178 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 178 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    ngx_http_image_filter_init,

    
# 181 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 181 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 182 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 182 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,

    
# 184 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 184 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 185 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 185 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
...
# 193 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 193 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   "8" 
# 193 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   "," 
# 193 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 196 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   0x50545448
# 196 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ,
    
# 197 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 197 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 198 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 198 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 199 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 199 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 200 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 200 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 201 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 201 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 202 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 202 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 203 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ((void *)0)
# 203 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ,
    
# 204 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 205 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
};
...
# 213 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   { sizeof(
# 213 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   "image/jpeg"
# 213 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ) - 1, (u_char *) 
# 213 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 214 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   { sizeof(
# 214 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   "image/gif"
# 214 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ) - 1, (u_char *) 
# 214 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 215 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   { sizeof(
# 215 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   "image/png"
# 215 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ) - 1, (u_char *) 
# 215 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 216 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   { sizeof(
# 216 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   "image/webp"
# 216 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ) - 1, (u_char *) 
# 216 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 217 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
};
...
# 227 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                304
# 227 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                     ) {
        return ngx_http_next_header_filter(r);
    }

    ctx = 
# 231 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         (
# 231 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
         r
# 231 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         )->ctx[
# 231 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 231 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ctx) {
        r
# 234 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       ->ctx[
# 234 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       ngx_http_image_filter_module
# 234 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       .ctx_index] = ((void *)0);
# 234 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    conf = 
# 238 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          (
# 238 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          r
# 238 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          )->loc_conf[
# 238 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 251 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if ((
# 251 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->connection->log
# 251 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
...
# 251 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       , 
# 251 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       0, "image filter: multipart/x-mixed-replace response"
# 251 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       )
                                                                         
# 252 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                                        ;

        return 
# 254 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              -1
# 254 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       ;
    }

    ctx = ngx_pcalloc(r->pool, sizeof(ngx_http_image_filter_ctx_t));
    if (ctx == 
# 258 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 258 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        return 
# 259 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              -1
# 259 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       ;
    }

    r
# 262 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   ->ctx[
# 262 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   ngx_http_image_filter_module
# 262 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   .ctx_index] = 
# 262 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if ((
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->connection->log
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       , 
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       0, "image filter: too big response: %O", len
# 267 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       )
                                                                
# 268 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                               ;

        return 
# 270 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              415
# 270 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                             ;
    }
    ...
    return 
# 287 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          0
# 287 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                ;
}
...
ngx_http_image_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (in == 
# 302 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
             ((void *)0)
# 302 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                 ) {
        return ngx_http_next_body_filter(r, in);
    }

    ctx = 
# 306 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         (
# 306 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
         r
# 306 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         )->ctx[
# 306 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 306 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ctx == 
# 308 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 308 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        return ngx_http_next_body_filter(r, in);
    }
    ...
    case 0:
        ...
        conf = 
# 318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (
# 318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
              r
# 318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              )->loc_conf[
# 318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (ctx->type == 0) {
            ...
            if (conf->filter == 2) {
                out.buf = ngx_http_image_json(r, 
# 323 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                                ((void *)0)
# 323 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                    );

                if (out.buf) {
                    out.next = 
# 326 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                              ((void *)0)
# 326 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                  ;
                    ctx->phase = 4;
...
# 335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                             415
# 335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                                            );
        }
...
# 343 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                             ((void *)0)
# 343 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                 ;
    ...
    case 1:
        ...
        if (rc == 
# 359 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                 -2
# 359 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ) {
            return 
# 360 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  0
# 360 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                        ;
        }

        if (rc == 
# 363 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                 -1
# 363 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ) {
            return ngx_http_filter_finalize_request(r,
                                              &ngx_http_image_filter_module,
                                              
# 366 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                             415
# 366 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                                            );
        }
    ...
    case 2:
        ...
        if (out.buf == 
# 375 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 375 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ) {
            return ngx_http_filter_finalize_request(r,
                                              &ngx_http_image_filter_module,
                                              
# 378 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                             415
# 378 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                                            );
        }

        out.next = 
# 381 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 381 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
        ctx->phase = 3;
...
# 392 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                         ((void *)0)
# 392 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                             );


        return (rc == 
# 395 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     0
# 395 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                           ) ? 
# 395 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                               -1 
# 395 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    ngx_chain_t *in)
{
    ...
    if (rc == 
# 408 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
             -1 
# 408 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       || rc > 
# 408 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                               0 
# 408 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                      || r->header_only) {
        return 
# 409 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              -1
# 409 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                       ;
    }
    ...
    if (ctx->phase == 4) {
        ...
        return (rc == 
# 416 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     0
# 416 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                           ) ? 
# 416 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                               -1 
# 416 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
ngx_http_image_read(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ctx = 
# 479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         (
# 479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
         r
# 479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         )->ctx[
# 479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ctx->image == 
# 481 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((void *)0)
# 481 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ) {
        ctx->image = ngx_palloc(r->pool, ctx->length);
        if (ctx->image == 
# 483 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 483 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            return 
# 484 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -1
# 484 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                           ;
        }
...
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           if ((
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           r->connection->log
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , 
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           0, "image filter: too big response"
# 503 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           )
                                                           
# 504 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                          ;
            return 
# 505 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -1
# 505 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                           ;
        }

        p = 
# 508 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 508 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           p
# 508 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , 
# 508 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 508 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (b->last_buf) {
            ctx->last = p;
            return 
# 513 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  0
# 513 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                        ;
        }
    }
    ...
    return 
# 520 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          -2
# 520 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                   ;
}
...
ngx_http_image_process(ngx_http_request_t *r)
{
    ...
    ctx = 
# 533 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         (
# 533 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
         r
# 533 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         )->ctx[
# 533 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 533 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    conf = 
# 537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          (
# 537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          r
# 537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          )->loc_conf[
# 537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (conf->filter == 2) {
        return ngx_http_image_json(r, rc == 
# 540 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                           0 
# 540 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                  ? ctx : 
# 540 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                                          ((void *)0)
# 540 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (conf->filter == 5) {
        ...
        if (ctx->angle != 90 && ctx->angle != 180 && ctx->angle != 270) {
            return 
# 548 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 548 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
        }
    ...
    if (ctx->max_width == 0) {
        return 
# 556 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 556 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }
    ...
    if (ctx->max_height == 0) {
        return 
# 562 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 562 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }

    if (rc == 
# 565 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
             0
        
# 566 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
ngx_http_image_json(ngx_http_request_t *r, ngx_http_image_filter_ctx_t *ctx)
{
    ...
    b = 
# 584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       ngx_pcalloc(
# 584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->pool
# 584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       , sizeof(ngx_buf_t))
# 584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
    if (b == 
# 585 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
            ((void *)0)
# 585 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                ) {
        return 
# 586 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 586 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }
...
# 594 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                           200
# 594 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                      ;
    r->headers_out.content_type_len = sizeof("application/json") - 1;
    
# 596 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (
# 596 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 596 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   "application/json";
    r->headers_out.content_type_lowcase = 
# 597 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                         ((void *)0)
# 597 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                             ;

    if (ctx == 
# 599 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 599 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        b->pos = (u_char *) "{}" 
# 600 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                "\r\n"
# 600 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                    ;
        b->last = b->pos + sizeof("{}" 
# 601 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                      "\r\n"
# 601 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                          ) - 1;
    ...
    len = sizeof("{ \"img\" : "
                 "{ \"width\": , \"height\": , \"type\": \"jpeg\" } }" 
# 609 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                                                      "\r\n"
# 609 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                                          ) - 1
          + 2 * 
# 610 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
               (sizeof("-9223372036854775808") - 1)
# 610 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ;

    b->pos = ngx_pnalloc(r->pool, len);
    if (b->pos == 
# 613 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                 ((void *)0)
# 613 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     ) {
        return 
# 614 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 614 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }
    ...
    b->last = ngx_sprintf(b->pos,
                          "{ \"img\" : "
                                       "{ \"width\": %uz,"
                                        " \"height\": %uz,"
                                        " \"type\": \"%s\" } }" 
# 621 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                                               "\r\n"
# 621 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                                   ,
...
ngx_http_image_asis(ngx_http_request_t *r, ngx_http_image_filter_ctx_t *ctx)
{
    ...
    b = 
# 636 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       ngx_pcalloc(
# 636 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->pool
# 636 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       , sizeof(ngx_buf_t))
# 636 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
    if (b == 
# 637 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
            ((void *)0)
# 637 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                ) {
        return 
# 638 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 638 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }
...
# 661 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                   ((void *)0)
# 661 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                       ;
}
...
ngx_http_image_size(ngx_http_request_t *r, ngx_http_image_filter_ctx_t *ctx)
{
    ...
    case 1:
        ...
        if (width == 0 || height == 0) {
            return 
# 720 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -5
# 720 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
        }
    ...
    case 2:
        ...
        if (ctx->length < 10) {
            return 
# 735 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -5
# 735 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
        }
    ...
    case 3:
        ...
        if (ctx->length < 24) {
            return 
# 746 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -5
# 746 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
        }
    ...
    case 4:
        ...
        if (ctx->length < 30) {
            return 
# 757 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -5
# 757 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
        }

        if (p[12] != 'V' || p[13] != 'P' || p[14] != '8') {
            return 
# 761 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -5
# 761 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
        }
        ...
        case ' ':
            if (p[20] & 1) {
                ...
                return 
# 769 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      -5
# 769 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                  ;
            }
            ...
            if (p[23] != 0x9d || p[24] != 0x01 || p[25] != 0x2a) {
                ...
                return 
# 774 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      -5
# 774 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                  ;
            }
        ...
        case 'L':
            if (p[20] != 0x2f) {
                ...
                return 
# 785 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      -5
# 785 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                  ;
            }
        ...
        default:
            return 
# 799 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  -5
# 799 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
        }
    ...
    default:
        ...
        return 
# 806 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              -5
# 806 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ;
    }
    ...
    return 
# 815 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          0
# 815 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                ;
}
...
ngx_http_image_resize(ngx_http_request_t *r, ngx_http_image_filter_ctx_t *ctx)
{
    ...
    if (src == 
# 834 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 834 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        return 
# 835 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 835 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }

    sx = 
# 838 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
        ((
# 838 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        src
# 838 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
        )->sx)
# 838 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
    sy = 
# 839 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
        ((
# 839 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        src
# 839 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
        )->sy)
# 839 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    conf = 
# 841 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          (
# 841 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
          r
# 841 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          )->loc_conf[
# 841 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 841 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    colors = 
# 852 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
            ((
# 852 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
            src
# 852 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
            )->colorsTotal)
# 852 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (colors && conf->transparency) {
        transparent = 
# 855 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((
# 855 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     src
# 855 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     )->transparent)
# 855 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (transparent != -1) {
            palette = colors;
            red = 
# 859 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                 ((
# 859 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                 src
# 859 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                 )->trueColor ? (((
# 859 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 859 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                             ;
            green = 
# 860 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                   ((
# 860 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                   src
# 860 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                   )->trueColor ? (((
# 860 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 860 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                 ;
            blue = 
# 861 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((
# 861 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  src
# 861 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  )->trueColor ? ((
# 861 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
transparent:
    ...
    if (resize) {
        ...
        if (dst == 
# 924 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 924 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ) {
            gdImageDestroy(src);
            return 
# 926 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 926 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
        }
    ...
    if (ctx->angle) {
        ...
        case 270:
            ...
            if (dst == 
# 957 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 957 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ) {
                gdImageDestroy(src);
                return 
# 959 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 959 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ;
            }
            if (ctx->angle == 90) {
                ox = dy / 2 + ay;
        ...
        case 180:
            dst = ngx_http_image_new(r, dx, dy, palette);
            if (dst == 
# 981 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 981 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ) {
                gdImageDestroy(src);
                return 
# 983 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 983 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ;
            }
    ...
    if (conf->filter == 4) {
        ...
        if (ox || oy) {
            ...
            if (dst == 
# 1014 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 1014 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ) {
                gdImageDestroy(src);
                return 
# 1016 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      ((void *)0)
# 1016 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                          ;
            }
    ...
    if (out == 
# 1060 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1060 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        return 
# 1061 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1061 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }

    cln = ngx_pool_cleanup_add(r->pool, 0);
    if (cln == 
# 1065 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1065 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        gdFree(out);
        return 
# 1067 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1067 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }

    b = 
# 1070 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       ngx_pcalloc(
# 1070 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->pool
# 1070 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       , sizeof(ngx_buf_t))
# 1070 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                              ;
    if (b == 
# 1071 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
            ((void *)0)
# 1071 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                ) {
        gdFree(out);
        return 
# 1073 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1073 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }
...
ngx_http_image_source(ngx_http_request_t *r, ngx_http_image_filter_ctx_t *ctx)
{
    ...
    img = 
# 1097 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         ((void *)0)
# 1097 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
             ;
    ...
    if (img == 
# 1130 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1130 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        
# 1131 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if ((
# 1131 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->connection->log
# 1131 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 1131 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
ngx_http_image_new(ngx_http_request_t *r, int w, int h, int colors)
{
    ...
    if (colors == 0) {
        ...
        if (img == 
# 1146 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 1146 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ) {
            
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           if ((
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           r->connection->log
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , 
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           0, "gdImageCreateTrueColor() failed"
# 1147 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           )
                                                            
# 1148 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                           ;
            return 
# 1149 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 1149 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
        }
        ...
        if (img == 
# 1155 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 1155 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ) {
            
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           if ((
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           r->connection->log
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , 
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           0, "gdImageCreate() failed"
# 1156 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           )
                                                   
# 1157 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                  ;
            return 
# 1158 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 1158 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
        }
    }
    ...
    int *size)
{
    ...
    out = 
# 1175 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
         ((void *)0)
# 1175 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
             ;
    ...
    case 1:
        conf = 
# 1180 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (
# 1180 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
              r
# 1180 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              )->loc_conf[
# 1180 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1180 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (q <= 0) {
            return 
# 1184 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 1184 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                      ;
        }
    ...
    case 4:
# 1213 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        failed = "nginx was built without GD WebP support";
    ...
    if (out == 
# 1222 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1222 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ) {
        
# 1223 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if ((
# 1223 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       r->connection->log
# 1223 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 1223 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    ngx_http_complex_value_t *cv, ngx_uint_t v)
{
    ...
    if (cv == 
# 1243 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
             ((void *)0)
# 1243 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                 ) {
        return v;
    }

    if (ngx_http_complex_value(r, cv, &val) != 
# 1247 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                              0
# 1247 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                    ) {
        return 0;
    }
...
ngx_http_image_filter_create_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 1280 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
               ((void *)0)
# 1280 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                   ) {
        return 
# 1281 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1281 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  ;
    }
# 1298 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    conf->filter = 
# 1298 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (ngx_uint_t) -1
# 1298 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                     ;
    conf->jpeg_quality = 
# 1299 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        (ngx_uint_t) -1
# 1299 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                           ;
    conf->webp_quality = 
# 1300 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        (ngx_uint_t) -1
# 1300 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                           ;
    conf->sharpen = 
# 1301 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                   (ngx_uint_t) -1
# 1301 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                      ;
    conf->transparency = 
# 1302 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        -1
# 1302 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                      ;
    conf->interlace = 
# 1303 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     -1
# 1303 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                   ;
    conf->buffer_size = 
# 1304 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                       (size_t) -1
# 1304 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                          ;
...
ngx_http_image_filter_merge_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->filter == 
# 1316 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                       (ngx_uint_t) -1
# 1316 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                          ) {

        if (prev->filter == 
# 1318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                           (ngx_uint_t) -1
# 1318 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                              ) {
            conf->filter = 0;
    ...
    if (conf->jpeg_quality == 
# 1332 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                             (ngx_uint_t) -1
# 1332 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                ) {


        
# 1335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if (
# 1335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       conf->jpeg_quality 
# 1335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       == (ngx_uint_t) -1) { 
# 1335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1335 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (conf->jqcv == 
# 1337 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 1337 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            conf->jqcv = prev->jqcv;
        }
    }

    if (conf->webp_quality == 
# 1342 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                             (ngx_uint_t) -1
# 1342 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                ) {


        
# 1345 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if (
# 1345 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       conf->webp_quality 
# 1345 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       == (ngx_uint_t) -1) { 
# 1345 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1345 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (conf->wqcv == 
# 1347 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 1347 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            conf->wqcv = prev->wqcv;
        }
    }
    ...
    if (conf->sharpen == 
# 1352 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        (ngx_uint_t) -1
# 1352 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                           ) {
        
# 1353 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       if (
# 1353 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       conf->sharpen 
# 1353 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       == (ngx_uint_t) -1) { 
# 1353 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1353 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        if (conf->shcv == 
# 1355 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 1355 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            conf->shcv = prev->shcv;
        }
    }
...
# 1360 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   if (
# 1360 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   conf->transparency 
# 1360 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   == -1) { 
# 1360 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1362 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   if (
# 1362 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   conf->interlace 
# 1362 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   == -1) { 
# 1362 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1364 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   if (
# 1364 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   conf->buffer_size 
# 1364 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   == (size_t) -1) { 
# 1364 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1365 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                             ;

    return 
# 1367 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          ((void *)0)
# 1367 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     ;
}
...
ngx_http_image_filter(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        if (
# 1387 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           strcmp((const char *) 
# 1387 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           value[i].data
# 1387 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , (const char *) 
# 1387 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1390 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  strcmp((const char *) 
# 1390 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  value[i].data
# 1390 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  , (const char *) 
# 1390 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1393 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  strcmp((const char *) 
# 1393 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                  value[i].data
# 1393 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  , (const char *) 
# 1393 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1393 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
        ...
        return 
# 1400 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              ((void *)0)
# 1400 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ;

    } else if (cf->args->nelts == 3) {

        if (
# 1404 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           strcmp((const char *) 
# 1404 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           value[i].data
# 1404 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , (const char *) 
# 1404 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1411 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           (void) __builtin___memset_chk (
# 1411 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
           &ccv
# 1411 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
           , 0, 
# 1411 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1417 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                                       0
# 1417 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                             ) {
                return 
# 1418 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      (void *) -1
# 1418 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                    ;
            }

            if (cv.lengths == 
# 1421 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                             ((void *)0)
# 1421 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                 ) {
                ...
                if (imcf->acv == 
# 1433 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                ((void *)0)
# 1433 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                    ) {
                    return 
# 1434 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                          (void *) -1
# 1434 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                        ;
                }
            ...
            return 
# 1440 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  ((void *)0)
# 1440 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ;
    ...
    if (
# 1447 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       strcmp((const char *) 
# 1447 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
       value[i].data
# 1447 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
       , (const char *) 
# 1447 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1450 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              strcmp((const char *) 
# 1450 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
              value[i].data
# 1450 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              , (const char *) 
# 1450 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1457 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (void) __builtin___memset_chk (
# 1457 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   &ccv
# 1457 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   , 0, 
# 1457 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1457 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 1463 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                               0
# 1463 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                     ) {
        return 
# 1464 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (void *) -1
# 1464 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ;
    }

    if (cv.lengths == 
# 1467 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((void *)0)
# 1467 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ) {
        n = ngx_http_image_filter_value(&value[i]);
        ...
        if (imcf->wcv == 
# 1478 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        ((void *)0)
# 1478 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ) {
            return 
# 1479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1479 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
...
# 1485 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (void) __builtin___memset_chk (
# 1485 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   &ccv
# 1485 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   , 0, 
# 1485 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1485 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 1491 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                               0
# 1491 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                     ) {
        return 
# 1492 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (void *) -1
# 1492 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ;
    }

    if (cv.lengths == 
# 1495 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((void *)0)
# 1495 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ) {
        n = ngx_http_image_filter_value(&value[i]);
        ...
        if (imcf->hcv == 
# 1506 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                        ((void *)0)
# 1506 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ) {
            return 
# 1507 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1507 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
    ...
    return 
# 1513 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          ((void *)0)
# 1513 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     ;

failed:

    ngx_conf_log_error(
# 1517 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                      1
# 1517 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                   , cf, 0, "invalid parameter \"%V\"",
                       &value[i]);

    return 
# 1520 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          (void *) -1
# 1520 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                        ;
}
...
# 1537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (void) __builtin___memset_chk (
# 1537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   &ccv
# 1537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   , 0, 
# 1537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1537 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 1543 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                               0
# 1543 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                     ) {
        return 
# 1544 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (void *) -1
# 1544 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ;
    }

    if (cv.lengths == 
# 1547 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((void *)0)
# 1547 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ) {
        n = ngx_http_image_filter_value(&value[1]);

        if (n <= 0) {
            ngx_conf_log_error(
# 1551 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                              1
# 1551 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                           , cf, 0,
                               "invalid value \"%V\"", &value[1]);
            return 
# 1553 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1553 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
        ...
        if (imcf->jqcv == 
# 1560 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 1560 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            return 
# 1561 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1561 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
    ...
    return 
# 1567 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          ((void *)0)
# 1567 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     ;
}
...
# 1584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (void) __builtin___memset_chk (
# 1584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   &ccv
# 1584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   , 0, 
# 1584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1584 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 1590 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                               0
# 1590 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                     ) {
        return 
# 1591 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (void *) -1
# 1591 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ;
    }

    if (cv.lengths == 
# 1594 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((void *)0)
# 1594 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ) {
        n = ngx_http_image_filter_value(&value[1]);

        if (n <= 0) {
            ngx_conf_log_error(
# 1598 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                              1
# 1598 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                           , cf, 0,
                               "invalid value \"%V\"", &value[1]);
            return 
# 1600 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1600 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
        ...
        if (imcf->wqcv == 
# 1607 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 1607 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            return 
# 1608 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1608 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
    ...
    return 
# 1614 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          ((void *)0)
# 1614 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     ;
}
...
# 1631 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   (void) __builtin___memset_chk (
# 1631 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
   &ccv
# 1631 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
   , 0, 
# 1631 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
...
# 1631 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 1637 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                                               0
# 1637 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                                     ) {
        return 
# 1638 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
              (void *) -1
# 1638 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                            ;
    }

    if (cv.lengths == 
# 1641 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                     ((void *)0)
# 1641 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                         ) {
        n = ngx_http_image_filter_value(&value[1]);

        if (n < 0) {
            ngx_conf_log_error(
# 1645 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                              1
# 1645 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                           , cf, 0,
                               "invalid value \"%V\"", &value[1]);
            return 
# 1647 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1647 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
        ...
        if (imcf->shcv == 
# 1654 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                         ((void *)0)
# 1654 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                             ) {
            return 
# 1655 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
                  (void *) -1
# 1655 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                                ;
        }
    ...
    return 
# 1661 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          ((void *)0)
# 1661 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                     ;
}
...
ngx_http_image_filter_init(ngx_conf_t *cf)
{
    ...
    return 
# 1674 "project/nginx/src/http/modules/ngx_http_image_filter_module.c" 3 4
          0
# 1674 "project/nginx/src/http/modules/ngx_http_image_filter_module.c"
                ;
}
