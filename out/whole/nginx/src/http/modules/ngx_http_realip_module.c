# 0 "project/nginx/src/http/modules/ngx_http_realip_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/http/modules/ngx_http_realip_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_realip_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_realip_module.c" 2
...
# 19 "project/nginx/src/http/modules/ngx_http_realip_module.c"
typedef struct {
    ngx_array_t *from;
    ngx_uint_t type;
    ngx_uint_t hash;
...
static ngx_command_t ngx_http_realip_commands[] = {
    ...
    { 
# 60 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { sizeof(
# 60 "project/nginx/src/http/modules/ngx_http_realip_module.c"
     "set_real_ip_from"
# 60 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 60 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 61 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     0x02000000
# 61 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       |
# 61 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                        0x04000000
# 61 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 63 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 63 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                             ,
      0,
      
# 65 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ((void *)0) 
# 65 "project/nginx/src/http/modules/ngx_http_realip_module.c"
          },

    { 
# 67 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { sizeof(
# 67 "project/nginx/src/http/modules/ngx_http_realip_module.c"
     "real_ip_header"
# 67 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 67 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 68 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     0x02000000
# 68 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       |
# 68 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                        0x04000000
# 68 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 70 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 70 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                             ,
      0,
      
# 72 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ((void *)0) 
# 72 "project/nginx/src/http/modules/ngx_http_realip_module.c"
          },

    { 
# 74 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { sizeof(
# 74 "project/nginx/src/http/modules/ngx_http_realip_module.c"
     "real_ip_recursive"
# 74 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 74 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 75 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     0x02000000
# 75 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       |
# 75 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                        0x04000000
# 75 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 77 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 77 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                             ,
      
# 78 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     __builtin_offsetof (
# 78 "project/nginx/src/http/modules/ngx_http_realip_module.c"
     ngx_http_realip_loc_conf_t
# 78 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     , 
# 78 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 79 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ((void *)0) 
# 79 "project/nginx/src/http/modules/ngx_http_realip_module.c"
          },

      
# 81 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 82 "project/nginx/src/http/modules/ngx_http_realip_module.c"
};
...
# 90 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 90 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 91 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 91 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,

    
# 93 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 93 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 94 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 94 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
...
# 102 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 102 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   "8" 
# 102 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   "," 
# 102 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 105 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   0x50545448
# 105 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                  ,
    
# 106 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 106 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 107 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 107 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 108 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 108 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 109 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 109 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 110 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 110 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 111 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 112 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ((void *)0)
# 112 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       ,
    
# 113 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 114 "project/nginx/src/http/modules/ngx_http_realip_module.c"
};
...
static ngx_http_variable_t ngx_http_realip_vars[] = {
    ...
    { 
# 119 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { sizeof(
# 119 "project/nginx/src/http/modules/ngx_http_realip_module.c"
     "realip_remote_addr"
# 119 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 119 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 119 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    { 
# 122 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { sizeof(
# 122 "project/nginx/src/http/modules/ngx_http_realip_module.c"
     "realip_remote_port"
# 122 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 122 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 125 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 126 "project/nginx/src/http/modules/ngx_http_realip_module.c"
};
...
ngx_http_realip_handler(ngx_http_request_t *r)
{
    ...
    rlcf = 
# 144 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          (
# 144 "project/nginx/src/http/modules/ngx_http_realip_module.c"
          r
# 144 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          )->loc_conf[
# 144 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 144 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    if (rlcf->from == 
# 146 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                     ((void *)0)
# 146 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ) {
        return 
# 147 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              -5
# 147 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                          ;
    }
    ...
    if (ctx) {
        return 
# 153 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              -5
# 153 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                          ;
    }
...
# 160 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                                      ((void *)0)
# 160 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                          ) {
            return 
# 161 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  -5
# 161 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                              ;
        }

        value = &r->headers_in.x_real_ip->value;
        xfwd = 
# 165 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 165 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                  ;
    ...
    case 1:
        ...
        if (xfwd->elts == 
# 173 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                         ((void *)0)
# 173 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                             ) {
            return 
# 174 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  -5
# 174 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                              ;
        }

        value = 
# 177 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
               ((void *)0)
# 177 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                   ;
...
# 183 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                                            ((void *)0)
# 183 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                                ) {
            return 
# 184 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  -5
# 184 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                              ;
        }

        value = &r->connection->proxy_protocol->src_addr;
        xfwd = 
# 188 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 188 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                  ;
    ...
    default:
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 204 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                                 ((void *)0)
# 204 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                     ) {
                    break;
                }
            ...
            if (hash == header[i].hash
                ...
                && 
# 215 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  strncmp((const char *) 
# 215 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                  p
# 215 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  , (const char *) 
# 215 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 215 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                                             == 0)
            {
                ...
                xfwd = 
# 218 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                      ((void *)0)
# 218 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                          ;
        ...
        return 
# 224 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              -5
# 224 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                          ;
    }
...
found:
    ...
    if (ngx_http_get_forwarded_addr(r, &addr, xfwd, value, rlcf->from,
                                    rlcf->recursive)
        != 
# 237 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          -5
# 237 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                      )
    {
        if (rlcf->type == 3) {
    ...
    return 
# 246 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          -5
# 246 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                      ;
}
...
ngx_http_realip_set_addr(ngx_http_request_t *r, ngx_addr_t *addr)
{
    ...
    u_char *p;
    u_char text[
# 255 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                                (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 255 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                                   ];
    ngx_connection_t *c;
    ...
    if (cln == 
# 261 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 261 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                  ) {
        return 
# 262 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              500
# 262 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                            ;
    }
...
# 270 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                       (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 270 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                          , 0);
    if (len == 0) {
        return 
# 272 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              500
# 272 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                            ;
    }

    p = ngx_pnalloc(c->pool, len);
    if (p == 
# 276 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
            ((void *)0)
# 276 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ) {
        return 
# 277 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              500
# 277 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                            ;
    }

    
# 280 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 280 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   p
# 280 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   , 
# 280 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 280 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    r
# 283 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   ->ctx[
# 283 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   ngx_http_realip_module
# 283 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   .ctx_index] = 
# 283 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 283 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    return 
# 295 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          -5
# 295 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                      ;
}
...
ngx_http_realip_from(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (rlcf->from == 
# 331 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                     ((void *)0)
# 331 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ) {
        rlcf->from = ngx_array_create(cf->pool, 2,
                                      sizeof(ngx_cidr_t));
        if (rlcf->from == 
# 334 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                         ((void *)0)
# 334 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                             ) {
            return 
# 335 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  (void *) -1
# 335 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                ;
        }
    }
    ...
    if (
# 341 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       strcmp((const char *) 
# 341 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       value[1].data
# 341 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       , (const char *) 
# 341 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 341 "project/nginx/src/http/modules/ngx_http_realip_module.c"
        ...
        if (cidr == 
# 343 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                   ((void *)0)
# 343 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       ) {
            return 
# 344 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  (void *) -1
# 344 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                ;
        }

        cidr->family = 
# 347 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                      1
# 347 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                             ;
        return 
# 348 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 348 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ;
    }
    ...
    if (rc != 
# 355 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
             -1
# 355 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                      ) {
        if (rc == 
# 356 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                 -4
# 356 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ) {
            ngx_conf_log_error(
# 357 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                              5
# 357 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                          , cf, 0,
        ...
        cidr = ngx_array_push(rlcf->from);
        if (cidr == 
# 363 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                   ((void *)0)
# 363 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       ) {
            return 
# 364 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  (void *) -1
# 364 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                ;
        }
        ...
        *cidr = c;
        ...
        return 
# 369 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 369 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ;
    }

    
# 372 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   (void) __builtin___memset_chk (
# 372 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   &u
# 372 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   , 0, 
# 372 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 375 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                                              0
# 375 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                                    ) {
        if (u.err) {
            ngx_conf_log_error(
# 377 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                              1
# 377 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                           , cf, 0,
        ...
        return 
# 382 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              (void *) -1
# 382 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                            ;
    }

    cidr = ngx_array_push_n(rlcf->from, u.naddrs);
    if (cidr == 
# 386 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
               ((void *)0)
# 386 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                   ) {
        return 
# 387 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              (void *) -1
# 387 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                            ;
    }

    
# 390 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   (void) __builtin___memset_chk (
# 390 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   cidr
# 390 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   , 0, 
# 390 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 390 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    for (i = 0; i < u.naddrs; i++) {
        ...
        case 
# 398 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
            30
# 398 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                    :
            sin6 = (struct sockaddr_in6 *) u.addrs[i].sockaddr;
            cidr[i].u.in6.addr = sin6->sin6_addr;
            
# 401 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
           (void) __builtin___memset_chk (
# 401 "project/nginx/src/http/modules/ngx_http_realip_module.c"
           cidr[i].u.in6.mask.
# 401 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
...
# 401 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    return 
# 413 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          ((void *)0)
# 413 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                     ;
}
...
ngx_http_realip(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (rlcf->type != 
# 424 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                     (ngx_uint_t) -1
# 424 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                        ) {
        return "is duplicate";
    }
    ...
    if (
# 430 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       strcmp((const char *) 
# 430 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       value[1].data
# 430 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       , (const char *) 
# 430 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 430 "project/nginx/src/http/modules/ngx_http_realip_module.c"
        ...
        rlcf->type = 0;
        return 
# 432 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 432 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ;
    }

    if (
# 435 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       strcmp((const char *) 
# 435 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       value[1].data
# 435 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       , (const char *) 
# 435 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 435 "project/nginx/src/http/modules/ngx_http_realip_module.c"
        ...
        rlcf->type = 1;
        return 
# 437 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 437 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ;
    }

    if (
# 440 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       strcmp((const char *) 
# 440 "project/nginx/src/http/modules/ngx_http_realip_module.c"
       value[1].data
# 440 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
       , (const char *) 
# 440 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 440 "project/nginx/src/http/modules/ngx_http_realip_module.c"
        ...
        rlcf->type = 3;
        return 
# 442 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 442 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ;
    }
    ...
    return 
# 449 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          ((void *)0)
# 449 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                     ;
}
...
ngx_http_realip_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 459 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
               ((void *)0)
# 459 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                   ) {
        return 
# 460 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0)
# 460 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                  ;
    }
# 471 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    conf->type = 
# 471 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                (ngx_uint_t) -1
# 471 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                   ;
    conf->recursive = 
# 472 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                     -1
# 472 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                                   ;
...
ngx_http_realip_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->from == 
# 484 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                     ((void *)0)
# 484 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                         ) {
        conf->from = prev->from;
    }

    
# 488 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   if (
# 488 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   conf->type 
# 488 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 488 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 489 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   if (
# 489 "project/nginx/src/http/modules/ngx_http_realip_module.c"
   conf->recursive 
# 489 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
   == -1) { 
# 489 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 489 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    return 
# 496 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          ((void *)0)
# 496 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                     ;
}
...
ngx_http_realip_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_http_realip_vars; v->name.len; v++) {
        ...
        if (var == 
# 507 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  ((void *)0)
# 507 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                      ) {
            return 
# 508 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  -1
# 508 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                           ;
        }
    ...
    return 
# 515 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          0
# 515 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ;
}
...
ngx_http_realip_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 525 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 525 "project/nginx/src/http/modules/ngx_http_realip_module.c"
          cf
# 525 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          ->ctx)->main_conf[
# 525 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 525 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    if (h == 
# 528 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
            ((void *)0)
# 528 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ) {
        return 
# 529 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              -1
# 529 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       ;
    }
    ...
    *h = ngx_http_realip_handler;
    ...
    if (h == 
# 535 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
            ((void *)0)
# 535 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ) {
        return 
# 536 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              -1
# 536 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       ;
    }
    ...
    *h = ngx_http_realip_handler;
    ...
    return 
# 541 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          0
# 541 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ;
}
...
ngx_http_realip_get_module_ctx(ngx_http_request_t *r)
{
    ...
    ctx = 
# 551 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
         (
# 551 "project/nginx/src/http/modules/ngx_http_realip_module.c"
         r
# 551 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
         )->ctx[
# 551 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
# 551 "project/nginx/src/http/modules/ngx_http_realip_module.c"
    ...
    if (ctx == 
# 553 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              ((void *)0) 
# 553 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                   && (r->internal || r->filter_finalize)) {
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    return 
# 589 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          0
# 589 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (v->data == 
# 611 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
                  ((void *)0)
# 611 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                      ) {
        return 
# 612 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
              -1
# 612 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                       ;
    }
    ...
    return 
# 621 "project/nginx/src/http/modules/ngx_http_realip_module.c" 3 4
          0
# 621 "project/nginx/src/http/modules/ngx_http_realip_module.c"
                ;
}
