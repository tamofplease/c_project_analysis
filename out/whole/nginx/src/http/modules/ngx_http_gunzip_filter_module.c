# 0 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 10 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 2
...
# 12 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                  ...
                                                  ;
# 14 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 2



# 16 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
typedef struct {
    ngx_flag_t enable;
    ngx_bufs_t bufs;
...
static ngx_command_t ngx_http_gunzip_filter_commands[] = {
    ...
    { 
# 67 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     { sizeof(
# 67 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
     "gunzip"
# 67 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     ) - 1, (u_char *) 
# 67 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 68 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     0x02000000
# 68 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       |
# 68 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                        0x04000000
# 68 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 70 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 70 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                             ,
      
# 71 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     __builtin_offsetof (
# 71 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
     ngx_http_gunzip_conf_t
# 71 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     , 
# 71 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 72 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     ((void *)0) 
# 72 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
          },

    { 
# 74 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     { sizeof(
# 74 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
     "gunzip_buffers"
# 74 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     ) - 1, (u_char *) 
# 74 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 75 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     0x02000000
# 75 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       |
# 75 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                        0x04000000
# 75 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 77 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 77 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                             ,
      
# 78 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     __builtin_offsetof (
# 78 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
     ngx_http_gunzip_conf_t
# 78 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     , 
# 78 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 79 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     ((void *)0) 
# 79 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
          },

      
# 81 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 82 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
};


static ngx_http_module_t ngx_http_gunzip_filter_module_ctx = {
    
# 86 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 86 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    ngx_http_gunzip_filter_init,

    
# 89 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 89 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 90 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 90 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,

    
# 92 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 92 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 93 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 93 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
...
# 101 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 101 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
   "8" 
# 101 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   "," 
# 101 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 104 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   0x50545448
# 104 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                  ,
    
# 105 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 105 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 106 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 106 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 107 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 107 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 108 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 108 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 109 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 109 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 110 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 110 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 111 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       ,
    
# 112 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 113 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
};
...
ngx_http_gunzip_header_filter(ngx_http_request_t *r)
{
    ...
    conf = 
# 126 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          (
# 126 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
          r
# 126 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          )->loc_conf[
# 126 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 133 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                             ((void *)0)
        
# 134 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 144 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                  0
# 144 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                        ) {
            return ngx_http_next_header_filter(r);
        }
    ...
    if (ctx == 
# 153 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              ((void *)0)
# 153 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                  ) {
        return 
# 154 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -1
# 154 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }

    r
# 157 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ->ctx[
# 157 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
   ngx_http_gunzip_filter_module
# 157 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   .ctx_index] = 
# 157 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 157 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
    ...
    r->headers_out.content_encoding = 
# 164 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                     ((void *)0)
# 164 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                         ;

    r
# 166 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ->headers_out.content_length_n = -1; if (
# 166 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
   r
# 166 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
...
# 166 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                   ;
    r
# 167 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   ->allow_ranges = 0; if (
# 167 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
   r
# 167 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
...
ngx_http_gunzip_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ctx = 
# 182 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
         (
# 182 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
         r
# 182 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
         )->ctx[
# 182 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 182 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
    ...
    if (ctx == 
# 184 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              ((void *)0) 
# 184 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                   || ctx->done) {
    ...
    if (!ctx->started) {
        if (ngx_http_gunzip_filter_inflate_start(r, ctx) != 
# 192 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                                           0
# 192 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                                 ) {
            goto failed;
        }
    }
...
# 198 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                                        0
# 198 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                              ) {
            goto failed;
        }
    }
...
# 207 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                        ((void *)0)
# 207 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                            ) == 
# 207 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                                 -1
# 207 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
        ...
        cl = 
# 211 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
            ((void *)0)
# 211 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                ;
    ...
    for ( ;; ) {
        ...
        for ( ;; ) {
            ...
            if (rc == 
# 232 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     -5
# 232 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                 ) {
                break;
            }

            if (rc == 
# 236 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     -2
# 236 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                              ) {
                continue;
            }
            ...
            if (rc == 
# 245 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     -5
# 245 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                 ) {
                break;
            }

            if (rc == 
# 249 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     -1
# 249 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                              ) {
                goto failed;
            }
            ...
            if (rc == 
# 255 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     0
# 255 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ) {
                break;
            }

            if (rc == 
# 259 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     -1
# 259 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                              ) {
                goto failed;
            }
        ...
        if (ctx->out == 
# 266 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                       ((void *)0) 
# 266 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                            && !flush) {
            return ctx->busy ? 
# 267 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                              -2 
# 267 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                        : 
# 267 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                          0
# 267 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
        ...
        if (rc == 
# 272 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                 -1
# 272 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                          ) {
            goto failed;
        }
...
failed:
    ...
    return 
# 297 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          -1
# 297 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                   ;
}
    ...
    ngx_http_gunzip_ctx_t *ctx)
{
    ...
    ctx->zstream.next_in = 
# 307 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                          0
# 307 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                ;
    ...
    rc = 
# 315 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
        inflateInit2_((
# 315 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
        &ctx->zstream
# 315 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
        ), (15 
# 315 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 315 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
    ...
    if (rc != 
# 317 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
             0
# 317 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                 ) {
        
# 318 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       if ((
# 318 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       r->connection->log
# 318 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
...
# 318 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       , 
# 318 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       0, "inflateInit2() failed: %d", rc
# 318 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       )
                                                      
# 319 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                     ;
        return 
# 320 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -1
# 320 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }
    ...
    ctx->last_out = &ctx->out;
    ctx->flush = 
# 326 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                0
# 326 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                          ;

    return 
# 328 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          0
# 328 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                ;
}
...
# 336 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                              0 
# 336 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                         || ctx->redo) {
        return 
# 337 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              0
# 337 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                    ;
    }
    ...
    if (ctx->in == 
# 343 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  ((void *)0)
# 343 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                      ) {
        return 
# 344 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -5
# 344 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                          ;
    }
    ...
    if (ctx->in_buf->last_buf || ctx->in_buf->last_in_chain) {
        ctx->flush = 
# 359 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                    4
# 359 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                            ;

    } else if (ctx->in_buf->flush) {
        ctx->flush = 
# 362 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                    2
# 362 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                ;

    } else if (ctx->zstream.avail_in == 0) {

        return 
# 366 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -2
# 366 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }

    return 
# 369 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          0
# 369 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                ;
}
    ...
    ngx_http_gunzip_ctx_t *ctx)
{
    ...
    if (ctx->zstream.avail_out) {
        return 
# 380 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              0
# 380 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                    ;
    }

    conf = 
# 383 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          (
# 383 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
          r
# 383 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          )->loc_conf[
# 383 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 383 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
    ...
    if (ctx->free) {
        ...
        if (ctx->out_buf == 
# 394 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                           ((void *)0)
# 394 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                               ) {
            return 
# 395 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 395 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }
        ...
        ctx->nomem = 1;
        return 
# 404 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -5
# 404 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                          ;
    }
    ...
    return 
# 410 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          0
# 410 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                ;
}
    ...
    ngx_http_gunzip_ctx_t *ctx)
{
    ...
    if (rc != 
# 430 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
             0 
# 430 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                  && rc != 
# 430 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                           1 
# 430 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 431 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       if ((
# 431 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       r->connection->log
# 431 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
...
# 431 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       , 
# 431 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       0, "inflate() failed: %d, %d", ctx->flush, rc
# 431 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       )
                                                                 
# 432 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                                ;
        return 
# 433 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -1
# 433 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }
    ...
    if (ctx->zstream.next_in) {
        ...
        if (ctx->zstream.avail_in == 0) {
            ctx->zstream.next_in = 
# 450 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                  ((void *)0)
# 450 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                      ;
        }
    }
    ...
    if (ctx->zstream.avail_out == 0) {
        ...
        if (cl == 
# 461 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                 ((void *)0)
# 461 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                     ) {
            return 
# 462 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 462 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }

        cl->buf = ctx->out_buf;
        cl->next = 
# 466 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  ((void *)0)
# 466 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                      ;
        *ctx->last_out = cl;
        ...
        return 
# 472 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -2
# 472 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }
    ...
    if (ctx->flush == 
# 477 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     2
# 477 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                 ) {

        ctx->flush = 
# 479 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                    0
# 479 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                              ;

        cl = ngx_alloc_chain_link(r->pool);
        if (cl == 
# 482 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                 ((void *)0)
# 482 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                     ) {
            return 
# 483 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 483 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }
        ...
        if (
# 488 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           (((
# 488 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           b
# 488 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           )->temporary || (
# 488 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 488 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
            ...
            b = 
# 490 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
               ngx_pcalloc(
# 490 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
               ctx->request->pool
# 490 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
               , sizeof(ngx_buf_t))
# 490 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                 ;
            if (b == 
# 491 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                    ((void *)0)
# 491 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                        ) {
                return 
# 492 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                      -1
# 492 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                               ;
            }
        ...
        cl->buf = b;
        cl->next = 
# 502 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  ((void *)0)
# 502 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                      ;
        *ctx->last_out = cl;
        ctx->last_out = &cl->next;

        return 
# 506 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              0
# 506 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                    ;
    }

    if (ctx->flush == 
# 509 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                     4 
# 509 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                              && ctx->zstream.avail_in == 0) {

        if (rc != 
# 511 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                 1
# 511 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                             ) {
            
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           if ((
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           r->connection->log
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           , 
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           0, "inflate() returned %d on response end", rc
# 512 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           )
                                                                      
# 513 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                                     ;
            return 
# 514 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 514 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }

        if (ngx_http_gunzip_filter_inflate_end(r, ctx) != 
# 517 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                                                         0
# 517 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                               ) {
            return 
# 518 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 518 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }

        return 
# 521 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              0
# 521 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                    ;
    }

    if (rc == 
# 524 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
             1 
# 524 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                          && ctx->zstream.avail_in > 0) {

        rc = inflateReset(&ctx->zstream);

        if (rc != 
# 528 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                 0
# 528 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                     ) {
            
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           if ((
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           r->connection->log
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           , 
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           0, "inflateReset() failed: %d", rc
# 529 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           )
                                                          
# 530 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                         ;
            return 
# 531 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 531 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }
        ...
        return 
# 536 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -2
# 536 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }

    if (ctx->in == 
# 539 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  ((void *)0)
# 539 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                      ) {

        b = ctx->out_buf;

        if (
# 543 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           (((
# 543 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           b
# 543 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           )->temporary || (
# 543 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 543 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           == 0) {
            return 
# 544 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  0
# 544 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                        ;
        }

        cl = ngx_alloc_chain_link(r->pool);
        if (cl == 
# 548 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                 ((void *)0)
# 548 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                     ) {
            return 
# 549 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 549 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }
        ...
        cl->buf = b;
        cl->next = 
# 555 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  ((void *)0)
# 555 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                      ;
        *ctx->last_out = cl;
        ctx->last_out = &cl->next;

        return 
# 559 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              0
# 559 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                    ;
    }

    return 
# 562 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          -2
# 562 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                   ;
}
    ...
    ngx_http_gunzip_ctx_t *ctx)
{
    ...
    if (rc != 
# 579 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
             0
# 579 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                 ) {
        
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       if ((
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       r->connection->log
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       , 
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       0, "inflateEnd() failed: %d", rc
# 580 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       )
                                                    
# 581 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                   ;
        return 
# 582 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -1
# 582 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }
    ...
    if (
# 587 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       (((
# 587 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
       b
# 587 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
       )->temporary || (
# 587 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 587 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
        ...
        b = 
# 589 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           ngx_pcalloc(
# 589 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
           ctx->request->pool
# 589 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
           , sizeof(ngx_buf_t))
# 589 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                             ;
        if (b == 
# 590 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                ((void *)0)
# 590 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                    ) {
            return 
# 591 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 591 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                           ;
        }
    }
    ...
    cl = ngx_alloc_chain_link(r->pool);
    if (cl == 
# 596 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
             ((void *)0)
# 596 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                 ) {
        return 
# 597 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              -1
# 597 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                       ;
    }

    cl->buf = b;
    cl->next = 
# 601 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              ((void *)0)
# 601 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                  ;
    *ctx->last_out = cl;
    ctx->last_out = &cl->next;
    ...
    return 
# 611 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          0
# 611 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                ;
}
...
ngx_http_gunzip_create_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 646 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
               ((void *)0)
# 646 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                   ) {
        return 
# 647 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
              ((void *)0)
# 647 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                  ;
    }
    ...
    conf->enable = 
# 656 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
                  -1
# 656 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                ;
...
# 668 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   if (
# 668 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
   conf->enable 
# 668 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   == -1) { 
# 668 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 670 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   if (
# 670 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
   conf->bufs
# 670 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
   .num == 0) { if (
# 670 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
# 671 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                                                                       ;

    return 
# 673 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          ((void *)0)
# 673 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                     ;
}
...
ngx_http_gunzip_filter_init(ngx_conf_t *cf)
{
    ...
    return 
# 686 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c" 3 4
          0
# 686 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
                ;
}
