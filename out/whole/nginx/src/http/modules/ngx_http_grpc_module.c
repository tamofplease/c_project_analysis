# 0 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
typedef struct {
    ngx_array_t *flushes;
    ngx_array_t *lengths;
    ngx_array_t *values;
...
# 42 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
static char *ngx_http_grpc_pass(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf);
# 217 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
static ngx_conf_bitmask_t ngx_http_grpc_next_upstream_masks[] = {
    { 
# 218 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 218 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "error"
# 218 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 218 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 218 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 219 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 219 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "timeout"
# 219 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 219 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 219 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 220 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 220 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "invalid_header"
# 220 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 220 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 220 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 221 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 221 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "non_idempotent"
# 221 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 221 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 221 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 222 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 222 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_500"
# 222 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 222 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 222 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 223 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 223 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_502"
# 223 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 223 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 223 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 224 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 224 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_503"
# 224 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 224 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 224 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 225 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 225 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_504"
# 225 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 225 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 225 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 226 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 226 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_403"
# 226 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 226 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 226 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 227 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 227 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_404"
# 227 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 227 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 227 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 228 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 228 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "http_429"
# 228 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 228 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 228 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 229 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 229 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "off"
# 229 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 229 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 229 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 230 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { 0, ((void *)0) }
# 230 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    , 0 }
};
# 252 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
static ngx_command_t ngx_http_grpc_commands[] = {

    { 
# 254 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 254 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_pass"
# 254 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 254 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 255 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x08000000
# 255 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      |
# 255 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       0x40000000
# 255 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 257 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 257 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      0,
      
# 259 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 259 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 261 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 261 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_bind"
# 261 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 261 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 262 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 262 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 262 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 262 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 264 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 264 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 265 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 265 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 265 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 265 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 266 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 266 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 268 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 268 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 269 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 269 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 269 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 269 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 271 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 271 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 272 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 272 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 272 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 272 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 273 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 273 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 275 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 275 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 276 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 276 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 276 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 276 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 278 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 278 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 279 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 279 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 279 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 279 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 280 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 280 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 282 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 282 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_send_timeout"
# 282 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 282 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 283 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 283 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 283 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 283 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 285 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 285 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 286 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 286 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 286 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 286 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 287 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 287 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 289 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 289 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 290 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 290 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 290 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 290 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 292 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 292 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 293 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 293 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 293 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 293 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 294 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 294 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 296 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 296 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_buffer_size"
# 296 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 296 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 297 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 297 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 297 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 297 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 299 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 299 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 300 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 300 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 300 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 300 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 301 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 301 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 303 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 303 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_read_timeout"
# 303 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 303 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 304 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 304 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 304 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 304 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 306 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 306 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 307 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 307 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 307 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 307 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 308 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 308 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 310 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 310 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_next_upstream"
# 310 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 310 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 311 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 311 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 311 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 311 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 313 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 313 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 314 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 314 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 314 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 314 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 314 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 317 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 317 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 318 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 318 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 318 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 318 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 320 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 320 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 321 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 321 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 321 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 321 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 322 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 322 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 324 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 324 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 325 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 325 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 325 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 325 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 327 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 327 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 328 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 328 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 328 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 328 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 329 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 329 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 331 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 331 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_set_header"
# 331 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 331 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 332 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 332 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 332 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 332 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 334 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 334 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 335 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 335 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 335 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 335 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 336 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 336 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 338 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 338 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_pass_header"
# 338 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 338 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 339 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 339 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 339 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 339 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 341 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 341 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 342 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 342 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 343 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 343 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 345 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 345 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_hide_header"
# 345 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 345 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 346 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 346 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 346 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 346 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 348 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 348 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 349 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 349 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 349 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 349 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 350 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ((void *)0) 
# 350 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          },

    { 
# 352 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 352 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_ignore_headers"
# 352 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 352 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 353 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     0x02000000
# 353 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       |
# 353 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        0x04000000
# 353 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 355 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 355 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             ,
      
# 356 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     __builtin_offsetof (
# 356 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     ngx_http_grpc_loc_conf_t
# 356 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     , 
# 356 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 454 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
      
# 454 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 455 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
};
...
# 460 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 460 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,

    
# 462 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 462 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 463 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 463 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,

    
# 465 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 465 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 466 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 466 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
...
# 474 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 474 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "8" 
# 474 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   "," 
# 474 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 474 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ,
    &ngx_http_grpc_module_ctx,
    ngx_http_grpc_commands,
    
# 477 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   0x50545448
# 477 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ,
    
# 478 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 478 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 479 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 479 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 480 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 480 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 481 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 481 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 482 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 482 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 483 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 483 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 484 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ((void *)0)
# 484 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       ,
    
# 485 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 486 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
};
...
static ngx_keyval_t ngx_http_grpc_headers[] = {
    { 
# 502 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 502 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Content-Length"
# 502 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 502 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 502 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 503 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 503 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "TE"
# 503 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 503 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 503 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 504 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 504 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Host"
# 504 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 504 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 504 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 505 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 505 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Connection"
# 505 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 505 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 505 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 506 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 506 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Transfer-Encoding"
# 506 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 506 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 506 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 507 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 507 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Keep-Alive"
# 507 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 507 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 507 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 508 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 508 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Expect"
# 508 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 508 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 508 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 509 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 509 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "Upgrade"
# 509 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 509 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 509 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    { 
# 510 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { 0, ((void *)0) }
# 510 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    , 
# 510 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      { 0, ((void *)0) } 
# 510 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 515 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 515 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "Date"
# 515 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 515 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 516 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 516 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "Server"
# 516 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 516 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 517 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 517 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "X-Accel-Expires"
# 517 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 517 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 518 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 518 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "X-Accel-Redirect"
# 518 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 518 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 519 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 519 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "X-Accel-Limit-Rate"
# 519 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 519 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 520 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 520 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "X-Accel-Buffering"
# 520 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 520 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 521 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { sizeof(
# 521 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   "X-Accel-Charset"
# 521 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ) - 1, (u_char *) 
# 521 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 522 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   { 0, ((void *)0) }

# 523 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
};
...
static ngx_http_variable_t ngx_http_grpc_vars[] = {
    ...
    { 
# 528 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { sizeof(
# 528 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
     "grpc_internal_trailers"
# 528 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     ) - 1, (u_char *) 
# 528 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 530 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     2
# 530 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             |
# 530 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              8
# 530 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 533 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
};
...
# 544 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                      0
# 544 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ) {
        return 
# 545 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              500
# 545 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
    }

    ctx = ngx_pcalloc(r->pool, sizeof(ngx_http_grpc_ctx_t));
    if (ctx == 
# 549 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 549 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ) {
        return 
# 550 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              500
# 550 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
    }
    ...
    r
# 555 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   ->ctx[
# 555 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 555 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    glcf = 
# 557 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          (
# 557 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          r
# 557 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          )->loc_conf[
# 557 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 557 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (glcf->grpc_lengths == 
# 561 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                             ((void *)0)
# 561 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                 ) {
        ctx->host = glcf->host;
# 574 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        
# 574 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (
# 574 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       &u->schema
# 574 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
...
# 574 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       "grpc://";
        ...
        if (ngx_http_grpc_eval(r, ctx, glcf) != 
# 578 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                               0
# 578 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                     ) {
            return 
# 579 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  500
# 579 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                ;
        }
    }
    ...
    if (rc >= 
# 601 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             300
# 601 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                      ) {
        return rc;
    }

    return 
# 605 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          -4
# 605 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ;
}
...
# 617 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (void) __builtin___memset_chk (
# 617 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   &url
# 617 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   , 0, 
# 617 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 617 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (ngx_http_script_run(r, &url.url, glcf->grpc_lengths->elts, 0,
        ...
        == 
# 621 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ((void *)0)
# 621 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
              )
    {
        return 
# 623 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 623 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
...
# 639 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       if ((
# 639 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       r->connection->log
# 639 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
...
# 639 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       , 
# 639 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       0, "grpcs protocol requires SSL support"
# 639 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       )
                                                            
# 640 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                           ;
        return 
# 641 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 641 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
...
# 658 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (
# 658 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       &u->schema
# 658 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       )->len = sizeof(
# 658 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 658 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (ngx_parse_url(r->pool, &url) != 
# 663 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                       0
# 663 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                             ) {
        if (url.err) {
            
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "%s in upstream \"%V\"", url.err, &url.url
# 665 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                                     
# 666 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                    ;
        }

        return 
# 669 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 669 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    u->resolved = ngx_pcalloc(r->pool, sizeof(ngx_http_upstream_resolved_t));
    if (u->resolved == 
# 673 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      ((void *)0)
# 673 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                          ) {
        return 
# 674 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 674 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    if (url.family != 
# 688 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     1
# 688 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ) {
...
# 699 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (
# 699 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       &ctx->host
# 699 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       )->len = sizeof(
# 699 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 699 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    return 
# 702 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 702 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_create_request(ngx_http_request_t *r)
{
    ...
    glcf = 
# 727 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          (
# 727 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          r
# 727 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          )->loc_conf[
# 727 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 727 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    ctx = 
# 729 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         (
# 729 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
         r
# 729 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         )->ctx[
# 729 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 729 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    len = sizeof(ngx_http_grpc_connection_start) - 1
          + sizeof(ngx_http_grpc_frame_t);



    if (r->method == 
# 736 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                    0x00000002 
# 736 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                 || r->method == 
# 736 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                 0x00000008
# 736 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 756 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                   ((void *)0)
# 756 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       , r->uri.data, r->uri.len,
                                    
# 757 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                   0
# 757 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 );
...
# 780 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (void) __builtin___memset_chk (
# 780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   &le
# 780 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   , 0, 
# 780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (glcf->upstream.pass_request_headers) {
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 819 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 ((void *)0)
# 819 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                     ) {
                    break;
                }
    ...
    if (b == 
# 854 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
            ((void *)0)
# 854 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ) {
        return 
# 855 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 855 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    cl = ngx_alloc_chain_link(r->pool);
    if (cl == 
# 859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             ((void *)0)
# 859 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                 ) {
        return 
# 860 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 860 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    cl->buf = b;
    cl->next = 
# 864 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 864 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ;

    tmp = ngx_palloc(r->pool, tmp_len * 3);
    if (tmp == 
# 867 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 867 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ) {
        return 
# 868 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 868 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    b->last = 
# 876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             (((u_char *) __builtin___memcpy_chk (
# 876 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
             b->last
# 876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             , 
# 876 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
             ngx_http_grpc_connection_start
# 876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             , 
# 876 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 877 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                 ;
    ...
    if (r->method == 
# 896 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                    0x00000002
# 896 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                ) {
...
# 902 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                           0x00000008
# 902 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ) {
...
# 925 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    {
...
# 951 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                         0
# 951 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                       );

        } else {
            p = 
# 954 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 954 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               p
# 954 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 954 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 954 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (r->args.len > 0) {
            *p++ = '?';
            p = 
# 959 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 959 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               p
# 959 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 959 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 986 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (void) __builtin___memset_chk (
# 986 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   &e
# 986 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   , 0, 
# 986 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1046 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    }
    ...
    if (glcf->upstream.pass_request_headers) {
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 1055 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 ((void *)0)
# 1055 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                     ) {
                    break;
                }
...
# 1087 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        }
    }
...
# 1116 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (void) __builtin___memmove_chk (
# 1116 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1116 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (r->request_body_no_buffering) {
        ...
        if (body == 
# 1157 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   ((void *)0)
# 1157 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ) {
            f = (ngx_http_grpc_frame_t *) headers_frame;
        ...
        while (body) {
            b = 
# 1163 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               ngx_palloc(
# 1163 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->pool
# 1163 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , sizeof(ngx_buf_t))
# 1163 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                     ;
            if (b == 
# 1164 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                    ((void *)0)
# 1164 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ) {
                return 
# 1165 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 1165 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            
# 1168 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 1168 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           b
# 1168 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 1168 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1168 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            ...
            if (cl->next == 
# 1171 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                           ((void *)0)
# 1171 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ) {
                return 
# 1172 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 1172 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
    ...
    b->flush = 1;
    cl->next = 
# 1188 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 1188 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ;

    return 
# 1190 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 1190 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_reinit_request(ngx_http_request_t *r)
{
    ...
    ctx = 
# 1199 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         (
# 1199 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
         r
# 1199 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         )->ctx[
# 1199 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1199 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (ctx == 
# 1201 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 1201 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ) {
        return 
# 1202 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              0
# 1202 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ;
    }
    ...
    ctx->goaway = 0;
    ctx->connection = 
# 1215 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     ((void *)0)
# 1215 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                         ;

    return 
# 1217 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 1217 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_body_output_filter(void *data, ngx_chain_t *in)
{
    ...
    if (ctx == 
# 1242 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 1242 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ) {
        return 
# 1243 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 1243 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    if (in) {
        if (ngx_chain_add_copy(r->pool, &ctx->in, in) != 
# 1247 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                        0
# 1247 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ) {
            return 
# 1248 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 1248 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }

    out = 
# 1252 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         ((void *)0)
# 1252 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
             ;
    ll = &out;
    ...
    if (ctx->out) {
        ...
        *ll = ctx->out;
        ...
        ctx->out = 
# 1306 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ((void *)0)
# 1306 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      ;
    }

    f = 
# 1309 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       ((void *)0)
# 1309 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           ;
    last = 0;

    limit = 
# 1312 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           ((
# 1312 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0 
# 1312 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           < 
# 1312 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1312 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    file_pos = 0;
    pos = 
# 1324 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         ((void *)0)
# 1324 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
             ;
    cl = 
# 1325 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
        ((void *)0)
# 1325 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            ;
    ...
    while (in && limit > 0) {
        ...
        if (
# 1342 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           (((
# 1342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           in->buf
# 1342 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->flush || (
# 1342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        do {
            ...
            if (cl == 
# 1358 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     ((void *)0)
# 1358 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                         ) {
                return 
# 1359 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 1359 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
            ...
            *ll = cl;
            ...
            if (cl == 
# 1371 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     ((void *)0)
# 1371 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                         ) {
                return 
# 1372 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 1372 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 1378 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 1378 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           b
# 1378 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 1378 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1378 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            ...
            if (in->buf->in_file) {
                b->file_pos = file_pos;
                file_pos += 
# 1389 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                           ((
# 1389 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1389 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ...
                b->pos = pos;
                pos += 
# 1401 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      ((
# 1401 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      NGX_HTTP_V2_DEFAULT_FRAME_SIZE 
# 1401 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      > 
# 1401 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1401 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (last) {
        ...
        if (f) {
            ...
            cl = ngx_http_grpc_get_buf(r, ctx);
            if (cl == 
# 1477 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     ((void *)0)
# 1477 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                         ) {
                return 
# 1478 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 1478 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
    ...
    *ll = 
# 1503 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         ((void *)0)
# 1503 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
             ;
# 1525 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    for (cl = ctx->free; cl; cl = cl->next) {
        ...
        if (cl->buf->shadow) {
            ...
            cl->buf->shadow = 
# 1540 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                             ((void *)0)
# 1540 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                 ;
        }
    }

    if (rc == 
# 1544 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             0 
# 1544 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    && ctx->in) {
        rc = 
# 1545 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
            -2
# 1545 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                     ;
    }

    if (rc == 
# 1548 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             -2
# 1548 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      ) {
    ...
    if (ctx->done) {
        ...
        if (ctx->in == 
# 1566 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      ((void *)0)
            
# 1567 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           && ctx->out == 
# 1567 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          ((void *)0)
            
# 1568 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           && ctx->output_closed
            && !ctx->output_blocked
            && !ctx->goaway
...
# 1576 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       if (!(
# 1576 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
ngx_http_grpc_process_header(ngx_http_request_t *r)
{
    ...
    if (ctx == 
# 1606 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 1606 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ) {
        return 
# 1607 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 1607 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    umcf = 
# 1610 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          (
# 1610 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          r
# 1610 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          )->main_conf[
# 1610 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1610 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    for ( ;; ) {
        ...
        if (ctx->state < ngx_http_grpc_st_payload) {
            ...
            if (rc == 
# 1618 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1618 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                ...
                return 
# 1631 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1631 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 1634 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 1634 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1635 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1635 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }
# 1647 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent unexpected http2 frame: %d", ctx->type
# 1653 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                        
# 1655 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                return 
# 1656 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1656 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }

            if (ctx->stream_id && ctx->stream_id != ctx->id) {
                
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent frame for unknown stream %ui", ctx->stream_id
# 1660 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                             
# 1662 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
                return 
# 1663 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1663 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }
        }
        ...
        if (ctx->type == NGX_HTTP_V2_RST_STREAM_FRAME) {
            ...
            if (rc == 
# 1673 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1673 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1674 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1674 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 1677 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 1677 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1678 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1678 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }

            
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream rejected request with error %ui", ctx->error
# 1681 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )

                                     
# 1683 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                    ;

            return 
# 1685 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  40
# 1685 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                  ;
        }
        ...
        if (ctx->type == NGX_HTTP_V2_GOAWAY_FRAME) {
            ...
            if (rc == 
# 1692 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1692 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1693 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1693 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 1696 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 1696 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1697 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1697 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }
# 1709 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            if (ctx->stream_id < ctx->id) {



                
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent goaway with error %ui", ctx->error
# 1713 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                         
# 1715 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ;

                return 
# 1717 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1717 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }
        ...
        if (ctx->type == NGX_HTTP_V2_WINDOW_UPDATE_FRAME) {
            ...
            if (rc == 
# 1729 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1729 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1730 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1730 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 1733 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 1733 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1734 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1734 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }

            if (ctx->in) {
                
# 1738 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if (!(
# 1738 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               u->peer.connection->write
# 1738 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->posted) { (
# 1738 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               u->peer.connection->write
...
# 1738 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (ctx->type == NGX_HTTP_V2_SETTINGS_FRAME) {
            ...
            if (rc == 
# 1748 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1748 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1749 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1749 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 1752 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 1752 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1753 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1753 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }

            if (ctx->in) {
                
# 1757 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if (!(
# 1757 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               u->peer.connection->write
# 1757 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->posted) { (
# 1757 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1757 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (ctx->type == NGX_HTTP_V2_PING_FRAME) {
            ...
            if (rc == 
# 1767 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1767 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1768 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1768 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 1771 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 1771 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 1772 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      40
# 1772 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            }

            
# 1775 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if (!(
# 1775 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           u->peer.connection->write
# 1775 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->posted) { (
# 1775 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent unexpected push promise frame"
# 1780 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                                        
# 1781 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                       ;
            return 
# 1782 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  40
# 1782 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                  ;
        }
            ...
            && ctx->type != NGX_HTTP_V2_CONTINUATION_FRAME)
        {
            ...
            if (b->last - b->pos < (ssize_t) ctx->rest) {
                ...
                b->pos = b->last;
                return 
# 1793 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 1793 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        for ( ;; ) {
            ...
            if (rc == 
# 1809 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 1809 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                break;
            }

            if (rc == 
# 1813 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     0
# 1813 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ) {
                ...
                if (ctx->name.len && ctx->name.data[0] == ':') {
                    ...
                    if (ctx->name.len != sizeof(":status") - 1
                        || 
# 1824 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          strncmp((const char *) 
# 1824 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                          ctx->name.data
# 1824 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          , (const char *) 
# 1824 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1826 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                          != 0)
                    {
                        
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       , 
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       0, "upstream sent invalid header \"%V: %V\"", &ctx->name, &ctx->value
# 1828 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )

                                                              
# 1830 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;
                        return 
# 1831 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              40
# 1831 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
                    }

                    if (ctx->status) {
                        
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       , 
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       0, "upstream sent duplicate :status header"
# 1835 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )
                                                                               
# 1836 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                              ;
                        return 
# 1837 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              40
# 1837 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
                    }
...
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       , 
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       0, "upstream sent invalid :status \"%V\"", status_line
# 1843 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )

                                                  
# 1845 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 ;
                        return 
# 1846 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              40
# 1846 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
                    }
                    ...
                    if (status == 
# 1851 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 -1
# 1851 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                          ) {
                        
# 1852 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 1852 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 1852 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 1852 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1854 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 ;
                        return 
# 1855 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              40
# 1855 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
                    }

                    if (status < 
# 1858 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                200
# 1858 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                           ) {
                        
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       , 
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       0, "upstream sent unexpected :status \"%V\"", status_line
# 1859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )

                                                  
# 1861 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 ;
                        return 
# 1862 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              40
# 1862 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
                    }
...
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent no :status header"
# 1876 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )
                                                                    
# 1877 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                   ;
                    return 
# 1878 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          40
# 1878 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                          ;
                }

                h = ngx_list_push(&u->headers_in.headers);
                if (h == 
# 1882 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        ((void *)0)
# 1882 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ) {
                    return 
# 1883 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 1883 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
                ...
                if (hh && hh->handler(r, h, hh->offset) != 
# 1894 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                          0
# 1894 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                ) {
                    return 
# 1895 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 1895 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
            ...
            if (rc == 
# 1901 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     1
# 1901 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                               ) {
                ...
                if (ctx->end_stream) {
                    ...
                    if (ctx->in == 
# 1911 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                  ((void *)0)
                        
# 1912 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       && ctx->out == 
# 1912 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                      ((void *)0)
                        
# 1913 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       && ctx->output_closed
                        && !ctx->output_blocked
                        && !ctx->goaway
                        && b->last == b->pos)
                ...
                return 
# 1922 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      0
# 1922 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ;
            }
...
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent invalid header"
# 1927 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                         
# 1928 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                        ;

            return 
# 1930 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  40
# 1930 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                  ;
        }
        ...
        return 
# 1940 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 1940 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
}
...
# 1956 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 204
        
# 1957 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       || u->headers_in.status_n == 
# 1957 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                    304
        
# 1958 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       || r->method == 
# 1958 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       0x00000004
# 1958 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                    )
    {
...
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream prematurely closed stream"
# 1969 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                               
# 1970 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
            return 
# 1971 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 1971 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    ...
    return 
# 1981 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 1981 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_filter(void *data, ssize_t bytes)
{
    ...
    for ( ;; ) {
        ...
        if (ctx->state < ngx_http_grpc_st_payload) {
            ...
            if (rc == 
# 2017 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 2017 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
...
# 2022 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 2022 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 2022 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 2022 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2023 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                          ;
                        return 
# 2024 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              -1
# 2024 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                    }
...
# 2034 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if (!(
# 2034 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       u->peer.connection->write
# 2034 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->posted) { (
# 2034 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2035 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                         ;
                        return 
# 2036 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              -2
# 2036 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                    }
                    ...
                    if (ctx->in == 
# 2041 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                  ((void *)0)
                        
# 2042 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       && ctx->output_closed
                        && !ctx->output_blocked
                        && !ctx->goaway
                        && ctx->state == ngx_http_grpc_st_start)
                ...
                return 
# 2053 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2053 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2056 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 2056 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2057 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2057 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 2065 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2065 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2065 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2065 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2067 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                return 
# 2068 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2068 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent data frame " "for unknown stream %ui", ctx->stream_id
# 2074 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )


                                                 
# 2077 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                ;
                    return 
# 2078 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2078 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }

                if (ctx->rest > ctx->recv_window) {
                    
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream violated stream flow control, " "received %uz data frame with window %uz", ctx->rest, ctx->recv_window
# 2082 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )


                                                              
# 2085 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;
                    return 
# 2086 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2086 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }

                if (ctx->rest > ctx->connection->recv_window) {
                    
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream violated connection flow control, " "received %uz data frame with window %uz", ctx->rest, ctx->connection->recv_window
# 2090 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )


                                                                          
# 2093 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                         ;
                    return 
# 2094 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2094 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
                ...
                {
                    if (ngx_http_grpc_send_window_update(r, ctx) != 
# 2103 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                                   0
# 2103 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                         ) {
                        return 
# 2104 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              -1
# 2104 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                    }

                    
# 2107 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if (!(
# 2107 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   u->peer.connection->write
# 2107 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->posted) { (
# 2107 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2108 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                     ;
                }
            }
...
# 2113 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2113 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2113 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2113 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2115 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
                return 
# 2116 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2116 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent frame for closed stream %ui", ctx->stream_id
# 2123 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                             
# 2125 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
                return 
# 2126 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2126 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        if (ctx->state == ngx_http_grpc_st_padding) {
            ...
            if (b->last - b->pos < (ssize_t) ctx->rest) {
                ...
                b->pos = b->last;
                return 
# 2137 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2137 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        if (ctx->type == NGX_HTTP_V2_RST_STREAM_FRAME) {
            ...
            if (rc == 
# 2157 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 2157 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2158 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2158 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2161 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 2161 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2162 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2162 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (ctx->error || !ctx->done) {
                
# 2166 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2166 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2166 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2166 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2168 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ;
                return 
# 2169 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2169 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (ctx->rst) {
                
# 2173 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2173 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2173 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2173 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2175 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
                return 
# 2176 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2176 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        if (ctx->type == NGX_HTTP_V2_GOAWAY_FRAME) {
            ...
            if (rc == 
# 2188 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 2188 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2189 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2189 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2192 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 2192 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2193 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2193 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
# 2205 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            if (ctx->stream_id < ctx->id) {



                
# 2209 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2209 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2209 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2209 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2211 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ;

                return 
# 2213 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2213 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        if (ctx->type == NGX_HTTP_V2_WINDOW_UPDATE_FRAME) {
            ...
            if (rc == 
# 2225 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 2225 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2226 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2226 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2229 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 2229 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2230 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2230 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (ctx->in) {
                
# 2234 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if (!(
# 2234 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               u->peer.connection->write
# 2234 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->posted) { (
# 2234 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2234 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (ctx->type == NGX_HTTP_V2_SETTINGS_FRAME) {
            ...
            if (rc == 
# 2244 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 2244 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2245 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2245 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2248 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 2248 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2249 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2249 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (ctx->in) {
                
# 2253 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if (!(
# 2253 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               u->peer.connection->write
# 2253 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->posted) { (
# 2253 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2253 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (ctx->type == NGX_HTTP_V2_PING_FRAME) {
            ...
            if (rc == 
# 2263 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -2
# 2263 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2264 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2264 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2267 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     -1
# 2267 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
                return 
# 2268 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2268 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            
# 2271 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if (!(
# 2271 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           u->peer.connection->write
# 2271 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->posted) { (
# 2271 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2276 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 2276 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 2276 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 2276 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2277 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                       ;
            return 
# 2278 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 2278 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
            ...
            || ctx->type == NGX_HTTP_V2_CONTINUATION_FRAME)
        {
            for ( ;; ) {
                ...
                if (rc == 
# 2288 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                         -2
# 2288 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                  ) {
                    break;
                }

                if (rc == 
# 2292 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                         0
# 2292 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ) {
...
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       if ((
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       r->connection->log
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )->log_level >= 4) ngx_log_error_core(4, 
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       , 
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       0, "upstream sent invalid " "trailer \"%V: %V\"", &ctx->name, &ctx->value
# 2301 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       )


                                                              
# 2304 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;
                        return 
# 2305 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              -1
# 2305 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                    }

                    h = ngx_list_push(&u->headers_in.trailers);
                    if (h == 
# 2309 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                            ((void *)0)
# 2309 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                ) {
                        return 
# 2310 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              -1
# 2310 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                    }
                ...
                if (rc == 
# 2321 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                         1
# 2321 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ) {
...
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent trailer without " "end stream flag"
# 2333 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )

                                                    
# 2335 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;
                    return 
# 2336 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2336 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
...
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent invalid trailer"
# 2341 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )
                                                              
# 2342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;

                return 
# 2344 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2344 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (rc == 
# 2347 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                     1
# 2347 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                               ) {
                continue;
            }
            ...
            return 
# 2358 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -2
# 2358 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
        ...
        if (ctx->type != NGX_HTTP_V2_DATA_FRAME) {
            ...
            if (b->last - b->pos < (ssize_t) ctx->rest) {
                ...
                b->pos = b->last;
                return 
# 2368 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2368 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 2390 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        if (ctx->flags & NGX_HTTP_V2_PADDED_FLAG) {

            if (ctx->rest == 0) {
                
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent too short http2 frame"
# 2393 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )
                                                                    
# 2394 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                   ;
                return 
# 2395 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2395 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (b->pos == b->last) {
                return 
# 2399 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -2
# 2399 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent http2 frame with too long " "padding: %d in frame %uz", ctx->padding, ctx->rest
# 2407 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )


                                                      
# 2410 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                     ;
                return 
# 2411 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2411 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        if (b->pos == b->last) {
            return 
# 2422 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -2
# 2422 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        cl = ngx_chain_get_free_buf(r->pool, &u->free_bufs);
        if (cl == 
# 2426 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                 ((void *)0)
# 2426 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                     ) {
            return 
# 2427 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 2427 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
...
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent response body larger " "than indicated content length"
# 2453 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )

                                                                  
# 2455 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                 ;
                    return 
# 2456 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2456 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
            ...
            return 
# 2462 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -2
# 2462 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
...
# 2472 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2472 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2472 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2472 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2474 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;
                return 
# 2475 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2475 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
    ...
    return 
# 2495 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 2495 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent too large http2 frame: %uz", ctx->rest
# 2532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                        
# 2534 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                return 
# 2535 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2535 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        case ngx_http_grpc_st_stream_id_4:
            ...
            return 
# 2578 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  0
# 2578 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ;
    ...
    return 
# 2590 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          -2
# 2590 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   ;
}
...
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent headers frame " "with invalid length: %uz", ctx->rest
# 2628 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )


                                        
# 2631 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                return 
# 2632 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2632 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
    ...
    if (state < sw_fragment) {
        ...
        for (p = b->pos; p < last; p++) {
            ch = *p;
# 2690 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            switch (state) {
        ...
        ctx->frame_state = state;
        return 
# 2734 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 2734 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
...
# 2743 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 2743 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 2743 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 2743 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2746 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 ;
            return 
# 2747 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 2747 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    ...
    if (state == sw_fragment) {
        ...
        if (rc == 
# 2758 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                 -2
# 2758 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                          ) {
            return 
# 2759 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -2
# 2759 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (rc == 
# 2762 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                 -1
# 2762 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                          ) {
            return 
# 2763 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 2763 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (rc == 
# 2766 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                 0
# 2766 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ) {
            return 
# 2767 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  0
# 2767 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ;
        }
    ...
    if (state == sw_padding) {
        ...
        if (b->last - b->pos < (ssize_t) ctx->rest) {
            ...
            return 
# 2783 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -2
# 2783 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
...
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent truncated http2 header"
# 2794 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )
                                                                     
# 2795 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                    ;
                return 
# 2796 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 2796 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
            ...
            return 
# 2801 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  1
# 2801 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
        }

        return 
# 2804 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 2804 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    return 
# 2809 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          -1
# 2809 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   ;
}
...
# 2845 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    if (b->last - b->pos < (ssize_t) ctx->rest - ctx->padding) {
        last = b->last;
    ...
    for (p = b->pos; p < last; p++) {
        ...
        case sw_start:
            ...
            if ((ch & 0x80) == 0x80) {
# 2877 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                index = ch & ~0x80;

                if (index == 0 || index > 61) {
                    
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent invalid http2 " "table index: %ui", index
# 2880 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )

                                                            
# 2882 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                           ;
                    return 
# 2883 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2883 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
...
# 2921 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                index = ch & ~0xc0;

                if (index > 61) {
                    
# 2924 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2924 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2924 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2924 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2926 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                           ;
                    return 
# 2927 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2927 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
...
# 2954 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                size_update = ch & ~0xe0;

                if (size_update > 0) {
                    
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent invalid http2 " "dynamic table size update: %ui", size_update
# 2957 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )


                                              
# 2960 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                             ;
                    return 
# 2961 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 2961 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
...
# 2996 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                index = ch & ~0xf0;
...
# 3047 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                index = ch & ~0xf0;
            ...
            return 
# 3074 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3074 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
...
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent http2 table index " "with continuation flag"
# 3080 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                                       
# 3082 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
                return 
# 3083 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3083 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }

            if (ctx->index > 61) {
                
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent invalid http2 " "table index: %ui", ctx->index
# 3087 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                                             
# 3089 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                            ;
                return 
# 3090 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3090 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent zero http2 " "header name length"
# 3109 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                                   
# 3111 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                  ;
                return 
# 3112 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3112 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
...
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent too large http2 " "header name length"
# 3144 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                                   
# 3146 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                  ;
                return 
# 3147 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3147 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        case sw_name:
            ...
            if (ctx->name.data == 
# 3158 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 ((void *)0)
# 3158 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                     ) {
                return 
# 3159 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3159 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        case sw_name_bytes:
            ...
            size = 
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ((
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  last - p 
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  > 
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  (ssize_t) ctx->field_rest
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ) ? (
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  (ssize_t) ctx->field_rest
...
# 3179 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            ...
            if (ctx->field_huffman) {
                if (ngx_http_huff_decode(&ctx->field_state, p, size,
                                         ...
                                         r->connection->log)
                    != 
# 3187 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      0
# 3187 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            )
                {
                    
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent invalid encoded header"
# 3189 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )
                                                                         
# 3190 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                        ;
                    return 
# 3191 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 3191 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
                ...
                ctx->field_end = 
# 3198 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                (((u_char *) __builtin___memcpy_chk (
# 3198 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                ctx->field_end
# 3198 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                , 
# 3198 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3220 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               (
# 3220 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               &ctx->value
# 3220 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->len = sizeof(
# 3220 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent too large http2 " "header value length"
# 3253 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )

                                                    
# 3255 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;
                return 
# 3256 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3256 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        case sw_value:
            ...
            if (ctx->value.data == 
# 3267 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                  ((void *)0)
# 3267 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                      ) {
                return 
# 3268 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3268 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        ...
        case sw_value_bytes:
            ...
            size = 
# 3288 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ((
# 3288 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  last - p 
# 3288 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  > 
# 3288 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3288 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            ...
            if (ctx->field_huffman) {
                if (ngx_http_huff_decode(&ctx->field_state, p, size,
                                         ...
                                         r->connection->log)
                    != 
# 3296 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      0
# 3296 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            )
                {
                    
# 3298 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 3298 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 3298 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 3298 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3299 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                        ;
                    return 
# 3300 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 3300 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
                ...
                ctx->field_end = 
# 3307 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                (((u_char *) __builtin___memcpy_chk (
# 3307 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                ctx->field_end
# 3307 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                , 
# 3307 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3307 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (!ctx->index) {
            if (ngx_http_grpc_validate_header_name(r, &ctx->name) != 
# 3338 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                                    0
# 3338 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                          ) {
                
# 3339 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3339 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3339 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3339 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3341 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                     ;
                return 
# 3342 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3342 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        }

        if (!ctx->index || ctx->literal) {
            if (ngx_http_grpc_validate_header_value(r, &ctx->value) != 
# 3347 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                                      0
# 3347 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                            ) {
                
# 3348 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3348 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3348 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3348 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3350 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                     ;
                return 
# 3351 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3351 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
        }

        return 
# 3355 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              0
# 3355 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ;
    }
    ...
    if (ctx->rest > ctx->padding) {
        return 
# 3363 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 3363 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    return 
# 3366 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          -4
# 3366 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ;
}
...
ngx_http_grpc_validate_header_name(ngx_http_request_t *r, ngx_str_t *s)
{
    ...
    for (i = 0; i < s->len; i++) {
        ...
        if (ch == ':' && i > 0) {
            return 
# 3380 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3380 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ch >= 'A' && ch <= 'Z') {
            return 
# 3384 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3384 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ch <= 0x20 || ch == 0x7f) {
            return 
# 3388 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3388 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }

    return 
# 3392 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 3392 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_validate_header_value(ngx_http_request_t *r, ngx_str_t *s)
{
    ...
    for (i = 0; i < s->len; i++) {
        ...
        if (ch == '\0' || ch == 
# 3405 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                               (u_char) '\r' 
# 3405 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                  || ch == 
# 3405 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                           (u_char) '\n'
# 3405 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            ...
            return 
# 3406 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3406 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }

    return 
# 3410 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 3410 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent rst stream frame " "with invalid length: %uz", ctx->rest
# 3437 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                    
# 3440 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
            return 
# 3441 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3441 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }
    ...
    if (ctx->rest > 0) {
        return 
# 3486 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 3486 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    return 
# 3491 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 3491 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent goaway frame " "with non-zero stream id: %ui", ctx->stream_id
# 3524 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                         
# 3527 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ;
            return 
# 3528 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3528 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ctx->rest < 8) {
            
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent goaway frame " "with invalid length: %uz", ctx->rest
# 3532 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                    
# 3535 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
            return 
# 3536 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3536 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }
    ...
    if (ctx->rest > 0) {
        return 
# 3600 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 3600 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    return 
# 3609 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 3609 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent window update frame " "with invalid length: %uz", ctx->rest
# 3636 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                    
# 3639 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
            return 
# 3640 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3640 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }
    ...
    if (ctx->rest > 0) {
        return 
# 3681 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 3681 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
...
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent too large window update"
# 3694 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                                  
# 3695 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                 ;
            return 
# 3696 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3696 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
...
# 3706 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3706 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3706 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3706 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3707 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                 ;
            return 
# 3708 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3708 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    ...
    return 
# 3714 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 3714 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent settings frame " "with non-zero stream id: %ui", ctx->stream_id
# 3746 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                         
# 3749 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ;
            return 
# 3750 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3750 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
...
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               if ((
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               r->connection->log
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               , 
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
               0, "upstream sent settings frame " "with ack flag and non-zero length: %uz", ctx->rest
# 3758 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               )


                                        
# 3761 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       ;
                return 
# 3762 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 3762 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
            ...
            return 
# 3767 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  0
# 3767 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ;
        }

        if (ctx->rest % 6 != 0) {
            
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent settings frame " "with invalid length: %uz", ctx->rest
# 3771 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                    
# 3774 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
            return 
# 3775 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3775 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ctx->free == 
# 3778 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        ((void *)0) 
# 3778 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             && ctx->settings++ > 1000) {
            
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent too many settings frames"
# 3779 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                                   
# 3780 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                  ;
            return 
# 3781 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3781 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }
    ...
    for (p = b->pos; p < last; p++) {
        ...
        case sw_value_4:
            ...
            state = sw_id;
                                                               ...
                                                               ;
# 3840 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
            if (ctx->setting_id == 0x04) {


                if (ctx->setting_value > NGX_HTTP_V2_MAX_WINDOW) {
                    
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   0, "upstream sent settings frame " "with too large initial window size: %ui", ctx->setting_value
# 3844 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )


                                                     
# 3847 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                    ;
                    return 
# 3848 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 3848 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
...
# 3859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   if ((
# 3859 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   r->connection->log
# 3859 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 3859 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3862 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                    ;
                    return 
# 3863 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          -1
# 3863 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
                }
    ...
    if (ctx->rest > 0) {
        return 
# 3878 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 3878 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
...
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent ping frame " "with non-zero stream id: %ui", ctx->stream_id
# 3915 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                         
# 3918 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                        ;
            return 
# 3919 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3919 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ctx->rest != 8) {
            
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent ping frame " "with invalid length: %uz", ctx->rest
# 3923 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )


                                    
# 3926 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                   ;
            return 
# 3927 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3927 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ctx->flags & NGX_HTTP_V2_ACK_FLAG) {
            
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent ping frame with ack flag"
# 3931 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                                   
# 3932 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                  ;
            return 
# 3933 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3933 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        if (ctx->free == 
# 3936 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                        ((void *)0) 
# 3936 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                             && ctx->pings++ > 1000) {
            
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           r->connection->log
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "upstream sent too many ping frames"
# 3937 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )
                                                               
# 3938 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ;
            return 
# 3939 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 3939 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    }
    ...
    if (ctx->rest > 0) {
        return 
# 3969 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -2
# 3969 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
...
ngx_http_grpc_send_settings_ack(ngx_http_request_t *r, ngx_http_grpc_ctx_t *ctx)
{
    ...
    cl = ngx_http_grpc_get_buf(r, ctx);
    if (cl == 
# 3992 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             ((void *)0)
# 3992 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                 ) {
        return 
# 3993 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 3993 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    *ll = cl;
    ...
    return 
# 4011 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4011 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_send_ping_ack(ngx_http_request_t *r, ngx_http_grpc_ctx_t *ctx)
{
    ...
    cl = ngx_http_grpc_get_buf(r, ctx);
    if (cl == 
# 4029 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             ((void *)0)
# 4029 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                 ) {
        return 
# 4030 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4030 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    cl->buf->last = 
# 4046 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   (((u_char *) __builtin___memcpy_chk (
# 4046 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   cl->buf->last
# 4046 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   , 
# 4046 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4046 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    *ll = cl;
    ...
    return 
# 4050 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4050 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
    ...
    ngx_http_grpc_ctx_t *ctx)
{
    ...
    cl = ngx_http_grpc_get_buf(r, ctx);
    if (cl == 
# 4071 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             ((void *)0)
# 4071 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                 ) {
        return 
# 4072 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4072 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    *ll = cl;
    ...
    return 
# 4119 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4119 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_get_buf(ngx_http_request_t *r, ngx_http_grpc_ctx_t *ctx)
{
    ...
    cl = ngx_chain_get_free_buf(r->pool, &ctx->free);
    if (cl == 
# 4131 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             ((void *)0)
# 4131 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                 ) {
        return 
# 4132 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 4132 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ;
    }
    ...
    if (start == 
# 4138 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                ((void *)0)
# 4138 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ) {
        ...
        if (start == 
# 4146 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                    ((void *)0)
# 4146 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ) {
            return 
# 4147 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ((void *)0)
# 4147 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      ;
        }
...
# 4152 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (void) __builtin___memset_chk (
# 4152 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   b
# 4152 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   , 0, 
# 4152 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
ngx_http_grpc_get_ctx(ngx_http_request_t *r)
{
    ...
    ctx = 
# 4173 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         (
# 4173 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
         r
# 4173 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
         )->ctx[
# 4173 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4173 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (ctx->connection == 
# 4175 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          ((void *)0)
# 4175 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
        u = r->upstream;

        if (ngx_http_grpc_get_connection_data(r, ctx, &u->peer) != 
# 4178 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                                  0
# 4178 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                        ) {
            return 
# 4179 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ((void *)0)
# 4179 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      ;
        }
    }
    ...
    ngx_http_grpc_ctx_t *ctx, ngx_peer_connection_t *pc)
{
    ...
    if (pc->cached) {
        ...
        if (ctx->connection == 
# 4210 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                              ((void *)0)
# 4210 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                  ) {
            
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           if ((
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           c->log
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           , 
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
           0, "no connection data found for " "keepalive http2 connection"
# 4211 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
           )

                                                       
# 4213 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                      ;
            return 
# 4214 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4214 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
        ...
        return 
# 4223 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              0
# 4223 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ;
    }

    cln = ngx_pool_cleanup_add(c->pool, sizeof(ngx_http_grpc_conn_t));
    if (cln == 
# 4227 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 4227 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ) {
        return 
# 4228 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4228 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    return 
# 4244 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4244 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (te == 
# 4285 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             ((void *)0)
# 4285 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                 ) {
        v->not_found = 1;
        return 
# 4287 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              0
# 4287 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ;
    }
    ...
    if (ngx_strlcasestrn(te->value.data, te->value.data + te->value.len,
                         (u_char *) "trailers", 8 - 1)
        == 
# 4292 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ((void *)0)
# 4292 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
              )
    {
        v->not_found = 1;
        return 
# 4295 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              0
# 4295 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ;
    }
    ...
    return 
# 4305 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4305 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_http_grpc_vars; v->name.len; v++) {
        ...
        if (var == 
# 4316 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  ((void *)0)
# 4316 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      ) {
            return 
# 4317 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4317 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    ...
    return 
# 4324 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4324 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                ;
}
...
ngx_http_grpc_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 4334 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               ((void *)0)
# 4334 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   ) {
        return 
# 4335 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 4335 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                  ;
    }
# 4357 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    conf->upstream.local = 
# 4357 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          (void *) -1
# 4357 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;
    conf->upstream.socket_keepalive = 
# 4358 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                     -1
# 4358 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;
    conf->upstream.next_upstream_tries = 
# 4359 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                        (ngx_uint_t) -1
# 4359 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                           ;
    conf->upstream.connect_timeout = 
# 4360 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                    (ngx_msec_t) -1
# 4360 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                       ;
    conf->upstream.send_timeout = 
# 4361 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 (ngx_msec_t) -1
# 4361 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                    ;
    conf->upstream.read_timeout = 
# 4362 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 (ngx_msec_t) -1
# 4362 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                    ;
    conf->upstream.next_upstream_timeout = 
# 4363 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                          (ngx_msec_t) -1
# 4363 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;

    conf->upstream.buffer_size = 
# 4365 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                (size_t) -1
# 4365 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;

    conf->upstream.hide_headers = 
# 4367 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 (void *) -1
# 4367 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;
    conf->upstream.pass_headers = 
# 4368 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                 (void *) -1
# 4368 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;

    conf->upstream.intercept_errors = 
# 4370 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                     -1
# 4370 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;
# 4385 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    conf->headers_source = 
# 4399 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          (void *) -1
# 4399 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                            ;

    
# 4401 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (
# 4401 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4417 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4417 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.local 
# 4417 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (void *) -1) { 
# 4417 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4418 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                        ;

    
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.socket_keepalive 
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == -1) { 
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   = (
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   prev->upstream.socket_keepalive 
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == -1) ? 
# 4420 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   0 
...
# 4421 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                ;

    
# 4423 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4423 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.next_upstream_tries 
# 4423 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 4423 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4424 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                   ;

    
# 4426 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4426 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.connect_timeout 
# 4426 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 4426 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4427 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                   ;

    
# 4429 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4429 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.send_timeout 
# 4429 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 4429 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4430 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                ;

    
# 4432 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4432 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.read_timeout 
# 4432 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 4432 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4433 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                ;

    
# 4435 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4435 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.next_upstream_timeout 
# 4435 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 4435 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4436 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                     ;

    
# 4438 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4438 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.buffer_size 
# 4438 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (size_t) -1) { 
# 4438 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4440 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                   ;

    
# 4442 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4442 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.ignore_headers 
# 4442 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == 0) { 
# 4442 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.ignore_headers 
...
# 4444 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                  ;

    
# 4446 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4446 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4450 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                             ;

    if (conf->upstream.next_upstream & 
# 4452 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                      0x80000000
# 4452 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                              ) {
        conf->upstream.next_upstream = 
# 4453 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                      1
                                       
# 4454 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                      |
# 4454 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                       0x80000000
# 4454 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                               ;
    }
...
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->upstream.intercept_errors 
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == -1) { 
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   = (
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   prev->upstream.intercept_errors 
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == -1) ? 
# 4457 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   0 
...
# 4458 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                                ;
# 4500 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    hash.max_size = 512;
    hash.bucket_size = 
# 4501 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      (((
# 4501 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                      64
# 4501 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      ) + (
# 4501 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4501 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (ngx_http_upstream_hide_headers_hash(cf, &conf->upstream,
        ...
        != 
# 4506 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4506 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                )
    {
        return 
# 4508 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              (void *) -1
# 4508 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ;
    }

    clcf = 
# 4511 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 4511 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          cf
# 4511 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ->ctx)->loc_conf[
# 4511 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4514 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                     ((void *)0) 
# 4514 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                          && conf->grpc_lengths == 
# 4514 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                                                   ((void *)0)
# 4514 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4527 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                           ((void *)0)
        
# 4528 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4533 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   if (
# 4533 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   conf->headers_source 
# 4533 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   == (void *) -1) { 
# 4533 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4533 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    if (rc != 
# 4542 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
             0
# 4542 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   ) {
        return 
# 4543 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              (void *) -1
# 4543 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ;
    }
...
# 4551 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                     ((void *)0)
        
# 4552 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    return 
# 4558 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ((void *)0)
# 4558 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                     ;
}
    ...
    ngx_http_grpc_headers_t *headers, ngx_keyval_t *default_headers)
{
    ...
    if (headers->hash.buckets) {
        return 
# 4578 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              0
# 4578 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ;
    }

    if (ngx_array_init(&headers_names, cf->temp_pool, 4, sizeof(ngx_hash_key_t))
        != 
# 4582 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4582 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                )
    {
        return 
# 4584 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4584 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    if (ngx_array_init(&headers_merged, cf->temp_pool, 4, sizeof(ngx_keyval_t))
        != 
# 4588 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          0
# 4588 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                )
    {
        return 
# 4590 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4590 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    headers->lengths = ngx_array_create(cf->pool, 64, 1);
    if (headers->lengths == 
# 4594 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                           ((void *)0)
# 4594 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ) {
        return 
# 4595 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4595 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    headers->values = ngx_array_create(cf->pool, 512, 1);
    if (headers->values == 
# 4599 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          ((void *)0)
# 4599 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                              ) {
        return 
# 4600 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4600 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }
    ...
    if (conf->headers_source) {
        ...
        for (i = 0; i < conf->headers_source->nelts; i++) {
            ...
            if (s == 
# 4615 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                    ((void *)0)
# 4615 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ) {
                return 
# 4616 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                      -1
# 4616 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
            }
    ...
    while (h->key.len) {
        ...
        s = ngx_array_push(&headers_merged);
        if (s == 
# 4635 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                ((void *)0)
# 4635 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                    ) {
            return 
# 4636 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4636 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
    ...
    for (i = 0; i < headers_merged.nelts; i++) {
        ...
        if (hk == 
# 4651 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                 ((void *)0)
# 4651 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                     ) {
            return 
# 4652 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4652 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
        ...
        if (copy == 
# 4665 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   ((void *)0)
# 4665 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ) {
            return 
# 4666 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4666 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
        ...
        if (copy == 
# 4678 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   ((void *)0)
# 4678 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ) {
            return 
# 4679 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4679 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }
...
# 4686 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (void) __builtin___memcpy_chk (
# 4686 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       p
# 4686 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       , 
# 4686 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4688 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (void) __builtin___memset_chk (
# 4688 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       &sc
# 4688 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       , 0, 
# 4688 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4696 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                           0
# 4696 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 ) {
            return 
# 4697 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4697 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        code = ngx_array_push_n(headers->lengths, sizeof(uintptr_t));
        if (code == 
# 4701 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   ((void *)0)
# 4701 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ) {
            return 
# 4702 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4702 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        *code = (uintptr_t) 
# 4705 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                           ((void *)0)
# 4705 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;

        code = ngx_array_push_n(headers->values, sizeof(uintptr_t));
        if (code == 
# 4708 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   ((void *)0)
# 4708 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ) {
            return 
# 4709 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  -1
# 4709 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
        }

        *code = (uintptr_t) 
# 4712 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                           ((void *)0)
# 4712 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                               ;
    }

    code = ngx_array_push_n(headers->lengths, sizeof(uintptr_t));
    if (code == 
# 4716 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
               ((void *)0)
# 4716 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                   ) {
        return 
# 4717 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              -1
# 4717 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                       ;
    }

    *code = (uintptr_t) 
# 4720 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                       ((void *)0)
# 4720 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                           ;
    ...
    hash.pool = cf->pool;
    hash.temp_pool = 
# 4729 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                    ((void *)0)
# 4729 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                        ;
...
ngx_http_grpc_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    clcf = 
# 4751 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 4751 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
          cf
# 4751 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ->ctx)->loc_conf[
# 4751 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4767 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (void) __builtin___memset_chk (
# 4767 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       &sc
# 4767 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       , 0, 
# 4767 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4767 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
        ...
        if (ngx_http_script_compile(&sc) != 
# 4777 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                           0
# 4777 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                                 ) {
            return 
# 4778 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                  (void *) -1
# 4778 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                ;
        }
        ...
        return 
# 4785 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              ((void *)0)
# 4785 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                         ;
    }
    ...
    if (ngx_strncasecmp(url->data, (u_char *) "grpc://", 7) == 0) {
        ...
        ngx_conf_log_error(
# 4798 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                          1
# 4798 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                       , cf, 0,
                           "grpcs protocol requires SSL support");
        return 
# 4800 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              (void *) -1
# 4800 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ;
...
# 4807 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   (void) __builtin___memset_chk (
# 4807 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
   &u
# 4807 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
   , 0, 
# 4807 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4814 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                                  ((void *)0)
# 4814 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                                      ) {
        return 
# 4815 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
              (void *) -1
# 4815 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                            ;
    }

    if (u.family != 
# 4818 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
                   1
# 4818 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                          ) {
...
# 4829 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       (
# 4829 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
       &glcf->host
# 4829 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
       )->len = sizeof(
# 4829 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
...
# 4829 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
    ...
    return 
# 4832 "project/nginx/src/http/modules/ngx_http_grpc_module.c" 3 4
          ((void *)0)
# 4832 "project/nginx/src/http/modules/ngx_http_grpc_module.c"
                     ;
}
