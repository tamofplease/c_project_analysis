# 0 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
typedef struct {
    ngx_array_t *mirror;
...
static ngx_command_t ngx_http_mirror_commands[] = {
    ...
    { 
# 36 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     { sizeof(
# 36 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
     "mirror"
# 36 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     ) - 1, (u_char *) 
# 36 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 37 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     0x02000000
# 37 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                       |
# 37 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                        0x04000000
# 37 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 39 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 39 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                             ,
      0,
      
# 41 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     ((void *)0) 
# 41 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
          },

    { 
# 43 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     { sizeof(
# 43 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
     "mirror_request_body"
# 43 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     ) - 1, (u_char *) 
# 43 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 44 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     0x02000000
# 44 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                       |
# 44 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                        0x04000000
# 44 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 46 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 46 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                             ,
      
# 47 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     __builtin_offsetof (
# 47 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
     ngx_http_mirror_loc_conf_t
# 47 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     , 
# 47 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 48 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     ((void *)0) 
# 48 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
          },

      
# 50 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 51 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
};


static ngx_http_module_t ngx_http_mirror_module_ctx = {
    
# 55 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 55 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    ngx_http_mirror_init,

    
# 58 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 58 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 59 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,

    
# 61 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 61 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 62 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 62 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
...
# 70 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 70 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
   "8" 
# 70 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   "," 
# 70 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 70 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                ,
    &ngx_http_mirror_module_ctx,
    ngx_http_mirror_commands,
    
# 73 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   0x50545448
# 73 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                  ,
    
# 74 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 74 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 75 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 75 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 76 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 76 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 77 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 77 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 78 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 78 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 79 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 79 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 80 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   ((void *)0)
# 80 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ,
    
# 81 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 82 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
};
...
ngx_http_mirror_handler(ngx_http_request_t *r)
{
    ...
    if (r != r->main) {
        return 
# 93 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              -5
# 93 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                          ;
    }

    mlcf = 
# 96 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          (
# 96 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
          r
# 96 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          )->loc_conf[
# 96 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 96 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
    ...
    if (mlcf->mirror == 
# 98 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                       ((void *)0)
# 98 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                           ) {
        return 
# 99 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              -5
# 99 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                          ;
    }
    ...
    if (mlcf->request_body) {
        ctx = 
# 105 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
             (
# 105 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
             r
# 105 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
             )->ctx[
# 105 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 105 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
        ...
        if (ctx == 
# 112 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                  ((void *)0)
# 112 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                      ) {
            return 
# 113 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                  -1
# 113 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                           ;
        }

        ctx->status = 
# 116 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                     -4
# 116 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                             ;

        r
# 118 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
       ->ctx[
# 118 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       ngx_http_mirror_module
# 118 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
       .ctx_index] = 
# 118 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 118 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
        ...
        if (rc >= 
# 121 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                 300
# 121 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                          ) {
            return rc;
        }

        ngx_http_finalize_request(r, 
# 125 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                                    -4
# 125 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                            );
        return 
# 126 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              -4
# 126 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                      ;
    }
...
ngx_http_mirror_body_handler(ngx_http_request_t *r)
{
    ...
    ctx = 
# 138 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
         (
# 138 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
         r
# 138 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
         )->ctx[
# 138 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
ngx_http_mirror_handler_internal(ngx_http_request_t *r)
{
    ...
    mlcf = 
# 157 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          (
# 157 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
          r
# 157 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          )->loc_conf[
# 157 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 157 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
    ...
    for (i = 0; i < mlcf->mirror->nelts; i++) {
        if (ngx_http_subrequest(r, &name[i], &r->args, &sr, 
# 162 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                                                           ((void *)0)
# 162 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                                               ,
                                
# 163 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                               16
# 163 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                                             )
            != 
# 164 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              0
# 164 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                    )
        {
            return 
# 166 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                  500
# 166 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                                ;
        }
    ...
    return 
# 174 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          -5
# 174 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                      ;
}
...
ngx_http_mirror_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (mlcf == 
# 184 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
               ((void *)0)
# 184 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                   ) {
        return 
# 185 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              ((void *)0)
# 185 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                  ;
    }

    mlcf->mirror = 
# 188 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                  (void *) -1
# 188 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                    ;
    mlcf->request_body = 
# 189 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                        -1
# 189 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                      ;
...
# 201 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   if (
# 201 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
   conf->mirror 
# 201 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   == (void *) -1) { 
# 201 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 202 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   if (
# 202 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
   conf->request_body 
# 202 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
   == -1) { 
# 202 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 202 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
    ...
    return 
# 204 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          ((void *)0)
# 204 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                     ;
}
...
ngx_http_mirror(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (
# 217 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
       strcmp((const char *) 
# 217 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
       value[1].data
# 217 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
       , (const char *) 
# 217 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 217 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                        == 0) {
        if (mlcf->mirror != 
# 218 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                           (void *) -1
# 218 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                             ) {
            return "is duplicate";
        }

        mlcf->mirror = 
# 222 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                      ((void *)0)
# 222 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                          ;
        return 
# 223 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              ((void *)0)
# 223 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                         ;
    }

    if (mlcf->mirror == 
# 226 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                       ((void *)0)
# 226 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                           ) {
        return "is duplicate";
    }

    if (mlcf->mirror == 
# 230 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                       (void *) -1
# 230 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                         ) {
        mlcf->mirror = ngx_array_create(cf->pool, 4, sizeof(ngx_str_t));
        if (mlcf->mirror == 
# 232 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                           ((void *)0)
# 232 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                               ) {
            return 
# 233 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
                  (void *) -1
# 233 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                                ;
        }
    }
    ...
    if (s == 
# 238 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
            ((void *)0)
# 238 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                ) {
        return 
# 239 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              (void *) -1
# 239 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                            ;
    }
    ...
    *s = value[1];
    ...
    return 
# 244 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          ((void *)0)
# 244 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                     ;
}
...
ngx_http_mirror_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 254 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 254 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
          cf
# 254 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          ->ctx)->main_conf[
# 254 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
...
# 254 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
    ...
    if (h == 
# 257 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
            ((void *)0)
# 257 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                ) {
        return 
# 258 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
              -1
# 258 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                       ;
    }
    ...
    *h = ngx_http_mirror_handler;
    ...
    return 
# 263 "project/nginx/src/http/modules/ngx_http_mirror_module.c" 3 4
          0
# 263 "project/nginx/src/http/modules/ngx_http_mirror_module.c"
                ;
}
