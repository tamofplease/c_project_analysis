# 0 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_crypt.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_crypt.h" 3 4
...
ngx_int_t ngx_crypt(ngx_pool_t *pool, u_char *key, u_char *salt,
    u_char **encrypted);
# 12 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 2
...
# 17 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
typedef struct {
...
static ngx_command_t ngx_http_auth_basic_commands[] = {
    ...
    { 
# 38 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     { sizeof(
# 38 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
     "auth_basic"
# 38 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     ) - 1, (u_char *) 
# 38 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 39 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     0x02000000
# 39 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       |
# 39 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                        0x04000000
# 39 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 40 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       |
# 40 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                        0x00000002
# 40 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                      ,
      ngx_http_set_complex_value_slot,
      
# 42 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 42 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                             ,
      
# 43 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     __builtin_offsetof (
# 43 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
     ngx_http_auth_basic_loc_conf_t
# 43 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     , 
# 43 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 44 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     ((void *)0) 
# 44 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
          },

    { 
# 46 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     { sizeof(
# 46 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 47 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     0x02000000
# 47 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       |
# 47 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                        0x04000000
# 47 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 48 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       |
# 48 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                        0x00000002
# 48 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                      ,
      ngx_http_auth_basic_user_file,
      
# 50 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 50 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                             ,
      
# 51 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     __builtin_offsetof (
# 51 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
     ngx_http_auth_basic_loc_conf_t
# 51 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     , 
# 51 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 52 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     ((void *)0) 
# 52 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
          },

      
# 54 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 55 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
};


static ngx_http_module_t ngx_http_auth_basic_module_ctx = {
    
# 59 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    ngx_http_auth_basic_init,

    
# 62 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 62 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 63 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 63 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,

    
# 65 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 65 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 66 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 66 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
...
# 74 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 74 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   "8" 
# 74 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   "," 
# 74 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 77 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   0x50545448
# 77 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                  ,
    
# 78 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 78 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 79 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 79 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 80 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 80 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 81 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 81 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 82 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 82 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 83 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 83 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 84 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   ((void *)0)
# 84 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       ,
    
# 85 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 86 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
};
...
ngx_http_auth_basic_handler(ngx_http_request_t *r)
{
    ...
    alcf = 
# 108 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          (
# 108 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
          r
# 108 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          )->loc_conf[
# 108 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 108 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
    ...
    if (alcf->realm == 
# 110 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                      ((void *)0) 
# 110 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                           || alcf->user_file == 
# 110 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                                 ((void *)0)
# 110 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
        ...
        return 
# 111 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              -5
# 111 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                          ;
    }

    if (ngx_http_complex_value(r, alcf->realm, &realm) != 
# 114 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                                         0
# 114 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                               ) {
        return 
# 115 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              -1
# 115 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       ;
    }

    if (realm.len == 3 && 
# 118 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                         strncmp((const char *) 
# 118 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                         realm.data
# 118 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                         , (const char *) 
# 118 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 118 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                           == 0) {
        return 
# 119 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              -5
# 119 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                          ;
    }
    ...
    if (rc == 
# 124 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
             -5
# 124 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                         ) {

        
# 126 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       if ((
# 126 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       r->connection->log
# 126 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
...
# 126 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       , 
# 126 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       0, "no user/password was provided for basic authentication"
# 126 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       )
                                                                               
# 127 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                                              ;
    ...
    if (rc == 
# 132 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
             -1
# 132 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                      ) {
        return 
# 133 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              500
# 133 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                            ;
    }

    if (ngx_http_complex_value(r, alcf->user_file, &user_file) != 
# 136 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                                                 0
# 136 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                                       ) {
        return 
# 137 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              -1
# 137 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       ;
    }

    fd = 
# 140 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
        open((const char *) 
# 140 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
        user_file.data
# 140 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
        , 0x0000|0, 
# 140 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 140 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
    ...
    if (fd == 
# 142 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
             -1
# 142 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                             ) {
        err = 
# 143 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
             (*__error())
# 143 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                      ;

        if (err == 
# 145 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                  2
# 145 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                            ) {
            level = 
# 146 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                   4
# 146 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                              ;
            rc = 
# 147 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                403
# 147 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                  ;

        } else {
            level = 
# 150 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                   3
# 150 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                               ;
            rc = 
# 151 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                500
# 151 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                              ;
        }

        
# 154 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       if ((
# 154 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       r->connection->log
# 154 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       )->log_level >= 
# 154 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 155 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                                      ;
...
# 160 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   (void) __builtin___memset_chk (
# 160 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   &file
# 160 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   , 0, 
# 160 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 160 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
    ...
    for ( ;; ) {
        ...
        n = ngx_read_file(&file, buf + left, 2048 - left,
                          offset);

        if (n == 
# 178 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                -1
# 178 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                         ) {
            rc = 
# 179 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                500
# 179 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                              ;
            goto cleanup;
        }
        ...
        for (i = left; i < left + n; i++) {
            ...
            case sw_login:
                if (login == 0) {
                    ...
                    if (buf[i] == '#' || buf[i] == 
# 193 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                                  (u_char) '\r'
# 193 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                    ) {
                        state = sw_skip;
                        break;
                    }
                    ...
                    if (buf[i] == 
# 198 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                 (u_char) '\n'
# 198 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                   ) {
                        break;
                    }
                }
            ...
            case sw_passwd:
                if (buf[i] == 
# 218 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                             (u_char) '\n' 
# 218 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                || buf[i] == 
# 218 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                             (u_char) '\r' 
# 218 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
            ...
            case sw_skip:
                if (buf[i] == 
# 231 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                             (u_char) '\n'
# 231 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                               ) {
                    state = sw_login;
                    login = 0;
                }
...
# 242 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
           (void) __builtin___memmove_chk (
# 242 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
           buf
# 242 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
           , 
# 242 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 242 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
    ...
    if (state == sw_passwd) {
        ...
        if (pwd.data == 
# 255 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                       ((void *)0)
# 255 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                           ) {
            return 
# 256 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                  500
# 256 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                ;
        }
...
# 265 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   if ((
# 265 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   r->connection->log
# 265 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
...
# 265 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   , 
# 265 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   0, "user \"%V\" was not found in \"%s\"", &r->headers_in.user, user_file.data
# 265 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   )

                                                      
# 267 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                     ;
...
cleanup:
    ...
    if (
# 273 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       close
# 273 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                     (file.fd) == 
# 273 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                  -1
# 273 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 274 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       if ((
# 274 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       r->connection->log
# 274 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
...
# 275 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                                       ;
    }

    ngx_explicit_memzero(buf, 2048);
    ...
    ngx_str_t *realm)
{
    ...
    if (rc != 
# 298 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
             0
# 298 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                   ) {
        return 
# 299 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              500
# 299 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                            ;
    }

    if (
# 302 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       strcmp((const char *) 
# 302 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       encrypted
# 302 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       , (const char *) 
# 302 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 302 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                           == 0) {
        return 
# 303 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              0
# 303 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                    ;
    }
...
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   if ((
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   r->connection->log
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   )->log_level >= 4) ngx_log_error_core(4, 
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   , 
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   0, "user \"%V\": password mismatch", &r->headers_in.user
# 309 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   )

                                      
# 311 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                     ;
...
# 324 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                          ((void *)0)
# 324 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                              ) {
        return 
# 325 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              500
# 325 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                            ;
    }
    ...
    if (basic == 
# 331 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                ((void *)0)
# 331 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                    ) {
        r->headers_out.www_authenticate->hash = 0;
        r->headers_out.www_authenticate = 
# 333 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                         ((void *)0)
# 333 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                             ;
        return 
# 334 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              500
# 334 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                            ;
    }

    p = 
# 337 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 337 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       basic
# 337 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       , 
# 337 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 337 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                                        ;
    p = 
# 338 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 338 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
       p
# 338 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
       , 
# 338 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 342 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   (
# 342 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   &r->headers_out.www_authenticate->key
# 342 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   )->len = sizeof(
# 342 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   "WWW-Authenticate"
...
# 342 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   "WWW-Authenticate";
    ...
    return 
# 346 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          401
# 346 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                               ;
}
...
ngx_http_auth_basic_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 356 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
               ((void *)0)
# 356 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                   ) {
        return 
# 357 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              ((void *)0)
# 357 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                  ;
    }

    conf->realm = 
# 360 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                 (void *) -1
# 360 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                   ;
    conf->user_file = 
# 361 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                     (void *) -1
# 361 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                       ;
...
# 373 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   if (
# 373 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   conf->realm 
# 373 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   == (void *) -1) { 
# 373 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 374 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   if (
# 374 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   conf->user_file 
# 374 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   == (void *) -1) { 
# 374 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 374 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
    ...
    return 
# 376 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          ((void *)0)
# 376 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                     ;
}
...
ngx_http_auth_basic_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 386 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 386 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
          cf
# 386 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          ->ctx)->main_conf[
# 386 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 386 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
    ...
    if (h == 
# 389 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
            ((void *)0)
# 389 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                ) {
        return 
# 390 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              -1
# 390 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                       ;
    }
    ...
    *h = ngx_http_auth_basic_handler;
    ...
    return 
# 395 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          0
# 395 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                ;
}
...
ngx_http_auth_basic_user_file(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (alcf->user_file != 
# 407 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                          (void *) -1
# 407 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                            ) {
        return "is duplicate";
    }
    ...
    if (alcf->user_file == 
# 412 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                          ((void *)0)
# 412 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                              ) {
        return 
# 413 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              (void *) -1
# 413 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                            ;
    }
...
# 418 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   (void) __builtin___memset_chk (
# 418 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
   &ccv
# 418 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
   , 0, 
# 418 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
...
# 426 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
                                               0
# 426 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                                                     ) {
        return 
# 427 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
              (void *) -1
# 427 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                            ;
    }

    return 
# 430 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c" 3 4
          ((void *)0)
# 430 "project/nginx/src/http/modules/ngx_http_auth_basic_module.c"
                     ;
}
