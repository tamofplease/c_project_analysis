# 0 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
typedef struct {
    ngx_array_t *lengths;
    ngx_array_t *values;
    ngx_str_t name;
...
static ngx_command_t ngx_http_try_files_commands[] = {
    ...
    { 
# 36 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
     { sizeof(
# 36 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
     "try_files"
# 36 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
     ) - 1, (u_char *) 
# 36 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 37 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
     0x04000000
# 37 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                      |
# 37 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                       0x08000000
# 37 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 39 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 39 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                             ,
      0,
      
# 41 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
     ((void *)0) 
# 41 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
          },

      
# 43 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 44 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
};


static ngx_http_module_t ngx_http_try_files_module_ctx = {
    
# 48 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 48 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    ngx_http_try_files_init,

    
# 51 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 51 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 52 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 52 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,

    
# 54 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 54 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 55 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 55 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,

    ngx_http_try_files_create_loc_conf,
    
# 58 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)

# 59 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
};


ngx_module_t ngx_http_try_files_module = {
    
# 63 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 63 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
   "8" 
# 63 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   "," 
# 63 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 66 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   0x50545448
# 66 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                  ,
    
# 67 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 67 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 68 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 68 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 69 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 69 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 70 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 70 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 71 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 71 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 72 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 72 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 73 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   ((void *)0)
# 73 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       ,
    
# 74 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 75 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
};
...
ngx_http_try_files_handler(ngx_http_request_t *r)
{
    ...
    tlcf = 
# 93 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          (
# 93 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
          r
# 93 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          )->loc_conf[
# 93 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 93 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
    ...
    if (tlcf->try_files == 
# 95 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                          ((void *)0)
# 95 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                              ) {
        return 
# 96 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
              -5
# 96 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                          ;
    }
    ...
    root = 0;
    name = 
# 104 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          ((void *)0)
# 104 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
              ;

    path.data = 
# 106 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               ((void *)0)
# 106 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                   ;

    tf = tlcf->try_files;

    clcf = 
# 110 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          (
# 110 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
          r
# 110 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          )->loc_conf[
# 110 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 117 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           (void) __builtin___memset_chk (
# 117 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
           &e
# 117 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           , 0, 
# 117 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 137 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                           9223372036854775807LL
# 137 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                               ) {
            reserve = len;
        ...
        if (reserve > allocated || !allocated) {
            ...
            if (ngx_http_map_uri_to_path(r, &path, &root, allocated) == 
# 149 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                                                                       ((void *)0)
# 149 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                                           ) {
                return 
# 150 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                      500
# 150 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                    ;
            }
        ...
        if (tf->values == 
# 156 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                         ((void *)0)
# 156 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                             ) {



            
# 160 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 160 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
           name
# 160 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           , 
# 160 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 160 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
            ...
            *e.pos = '\0';
            ...
            if (alias && alias != 
# 178 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                                 9223372036854775807LL
                
# 179 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
               && 
# 179 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                  strncmp((const char *) 
# 179 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                  name
# 179 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
...
# 181 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               (void) __builtin___memmove_chk (
# 181 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
               name
# 181 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               , 
# 181 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 181 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
        ...
        if (tf->lengths == 
# 194 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                          ((void *)0) 
# 194 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                               && tf->name.len == 0) {
...
# 212 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                                        -4
# 212 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                );
            return 
# 213 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                  -4
# 213 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                          ;
        }

        
# 216 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
       (void) __builtin___memset_chk (
# 216 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
       &of
# 216 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
       , 0, 
# 216 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 226 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                                                                 0
# 226 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                                       ) {
            return 
# 227 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                  500
# 227 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                ;
        }

        if (ngx_open_cached_file(clcf->open_file_cache, &path, &of, r->pool)
            != 
# 231 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
              0
# 231 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                    )
        {
            if (of.err == 0) {
                return 
# 234 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                      500
# 234 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                    ;
            }

            if (of.err != 
# 237 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                         2
                
# 238 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
               && of.err != 
# 238 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                            20
                
# 239 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
               && of.err != 
# 239 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                            63
# 239 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                            )
            {
                
# 241 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               if ((
# 241 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
               r->connection->log
# 241 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
...
# 242 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                                      ;
            }
...
# 258 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                           9223372036854775807LL
# 258 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                               ) {
            if (!test_dir) {
                r->uri = path;
            ...
            if (r->uri.data == 
# 269 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                              ((void *)0)
# 269 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                  ) {
                r->uri.len = 0;
                return 
# 271 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                      500
# 271 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                    ;
            }

            p = 
# 274 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 274 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
               r->uri.data
# 274 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               , 
# 274 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 275 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 275 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
           p
# 275 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           , 
# 275 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 275 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
        ...
        return 
# 283 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
              -5
# 283 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                          ;
    }
...
ngx_http_try_files(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (tf == 
# 306 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
             ((void *)0)
# 306 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                 ) {
        return 
# 307 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
              (void *) -1
# 307 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                            ;
    }
...
# 330 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           (void) __builtin___memset_chk (
# 330 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
           &sc
# 330 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
           , 0, 
# 330 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 340 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                                               0
# 340 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                                     ) {
                return 
# 341 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                      (void *) -1
# 341 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                    ;
            }
    ...
    if (tf[i - 1].name.data[0] == '=') {
        ...
        if (code == 
# 354 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                   -1 
# 354 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                             || code > 999) {
            ngx_conf_log_error(
# 355 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                              1
# 355 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                           , cf, 0,
                               "invalid code \"%*s\"",
                               tf[i - 1].name.len - 1, tf[i - 1].name.data);
            return 
# 358 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
                  (void *) -1
# 358 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                                ;
        }
    ...
    return 
# 364 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          ((void *)0)
# 364 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                     ;
}
...
ngx_http_try_files_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (tlcf == 
# 374 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
               ((void *)0)
# 374 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                   ) {
        return 
# 375 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
              ((void *)0)
# 375 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                  ;
    }
...
ngx_http_try_files_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 394 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 394 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
          cf
# 394 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          ->ctx)->main_conf[
# 394 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
...
# 394 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
    ...
    if (h == 
# 397 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
            ((void *)0)
# 397 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                ) {
        return 
# 398 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
              -1
# 398 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                       ;
    }
    ...
    *h = ngx_http_try_files_handler;
    ...
    return 
# 403 "project/nginx/src/http/modules/ngx_http_try_files_module.c" 3 4
          0
# 403 "project/nginx/src/http/modules/ngx_http_try_files_module.c"
                ;
}
