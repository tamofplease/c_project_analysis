# 0 "project/nginx/src/http/ngx_http.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/ngx_http.c"
...
# 9 "project/nginx/src/http/ngx_http.c" 2
...
# 10 "project/nginx/src/http/ngx_http.c" 2
...
# 11 "project/nginx/src/http/ngx_http.c" 2



# 13 "project/nginx/src/http/ngx_http.c"
...
static int ngx_http_cmp_dns_wildcards(const void *one,
    const void *two);
...
# 80 "project/nginx/src/http/ngx_http.c" 3 4
   { sizeof(
# 80 "project/nginx/src/http/ngx_http.c"
   "text/html"
# 80 "project/nginx/src/http/ngx_http.c" 3 4
   ) - 1, (u_char *) 
# 80 "project/nginx/src/http/ngx_http.c"
...
# 81 "project/nginx/src/http/ngx_http.c" 3 4
   { 0, ((void *)0) }

# 82 "project/nginx/src/http/ngx_http.c"
};
...
static ngx_command_t ngx_http_commands[] = {
    ...
    { 
# 87 "project/nginx/src/http/ngx_http.c" 3 4
     { sizeof(
# 87 "project/nginx/src/http/ngx_http.c"
     "http"
# 87 "project/nginx/src/http/ngx_http.c" 3 4
     ) - 1, (u_char *) 
# 87 "project/nginx/src/http/ngx_http.c"
...
# 88 "project/nginx/src/http/ngx_http.c" 3 4
     0x01000000
# 88 "project/nginx/src/http/ngx_http.c"
                  |
# 88 "project/nginx/src/http/ngx_http.c" 3 4
                   0x00000100
# 88 "project/nginx/src/http/ngx_http.c"
...
# 92 "project/nginx/src/http/ngx_http.c" 3 4
     ((void *)0) 
# 92 "project/nginx/src/http/ngx_http.c"
          },

      
# 94 "project/nginx/src/http/ngx_http.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 95 "project/nginx/src/http/ngx_http.c"
};


static ngx_core_module_t ngx_http_module_ctx = {
    
# 99 "project/nginx/src/http/ngx_http.c" 3 4
   { sizeof(
# 99 "project/nginx/src/http/ngx_http.c"
   "http"
# 99 "project/nginx/src/http/ngx_http.c" 3 4
   ) - 1, (u_char *) 
# 99 "project/nginx/src/http/ngx_http.c"
...
# 100 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 100 "project/nginx/src/http/ngx_http.c"
       ,
    
# 101 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)

# 102 "project/nginx/src/http/ngx_http.c"
};


ngx_module_t ngx_http_module = {
    
# 106 "project/nginx/src/http/ngx_http.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 106 "project/nginx/src/http/ngx_http.c"
   "8" 
# 106 "project/nginx/src/http/ngx_http.c" 3 4
   "," 
# 106 "project/nginx/src/http/ngx_http.c"
...
# 109 "project/nginx/src/http/ngx_http.c" 3 4
   0x45524F43
# 109 "project/nginx/src/http/ngx_http.c"
                  ,
    
# 110 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 110 "project/nginx/src/http/ngx_http.c"
       ,
    
# 111 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/http/ngx_http.c"
       ,
    
# 112 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 112 "project/nginx/src/http/ngx_http.c"
       ,
    
# 113 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 113 "project/nginx/src/http/ngx_http.c"
       ,
    
# 114 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 114 "project/nginx/src/http/ngx_http.c"
       ,
    
# 115 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 115 "project/nginx/src/http/ngx_http.c"
       ,
    
# 116 "project/nginx/src/http/ngx_http.c" 3 4
   ((void *)0)
# 116 "project/nginx/src/http/ngx_http.c"
       ,
    
# 117 "project/nginx/src/http/ngx_http.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 118 "project/nginx/src/http/ngx_http.c"
};
...
ngx_http_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ctx == 
# 140 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 140 "project/nginx/src/http/ngx_http.c"
                  ) {
        return 
# 141 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 141 "project/nginx/src/http/ngx_http.c"
                            ;
    }
    ...
    *(ngx_http_conf_ctx_t **) conf = ctx;
    ...
    ngx_http_max_module = ngx_count_modules(cf->cycle, 
# 149 "project/nginx/src/http/ngx_http.c" 3 4
                                                      0x50545448
# 149 "project/nginx/src/http/ngx_http.c"
                                                                     );
    ...
    if (ctx->main_conf == 
# 156 "project/nginx/src/http/ngx_http.c" 3 4
                         ((void *)0)
# 156 "project/nginx/src/http/ngx_http.c"
                             ) {
        return 
# 157 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 157 "project/nginx/src/http/ngx_http.c"
                            ;
    }
    ...
    if (ctx->srv_conf == 
# 167 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 167 "project/nginx/src/http/ngx_http.c"
                            ) {
        return 
# 168 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 168 "project/nginx/src/http/ngx_http.c"
                            ;
    }
    ...
    if (ctx->loc_conf == 
# 178 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 178 "project/nginx/src/http/ngx_http.c"
                            ) {
        return 
# 179 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 179 "project/nginx/src/http/ngx_http.c"
                            ;
    }
...
# 189 "project/nginx/src/http/ngx_http.c" 3 4
                                          0x50545448
# 189 "project/nginx/src/http/ngx_http.c"
                                                         ) {
            continue;
        }
        ...
        if (module->create_main_conf) {
            ...
            if (ctx->main_conf[mi] == 
# 198 "project/nginx/src/http/ngx_http.c" 3 4
                                     ((void *)0)
# 198 "project/nginx/src/http/ngx_http.c"
                                         ) {
                return 
# 199 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 199 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
        }
        ...
        if (module->create_srv_conf) {
            ...
            if (ctx->srv_conf[mi] == 
# 205 "project/nginx/src/http/ngx_http.c" 3 4
                                    ((void *)0)
# 205 "project/nginx/src/http/ngx_http.c"
                                        ) {
                return 
# 206 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 206 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
        }
        ...
        if (module->create_loc_conf) {
            ...
            if (ctx->loc_conf[mi] == 
# 212 "project/nginx/src/http/ngx_http.c" 3 4
                                    ((void *)0)
# 212 "project/nginx/src/http/ngx_http.c"
                                        ) {
                return 
# 213 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 213 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
        }
    }
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 222 "project/nginx/src/http/ngx_http.c" 3 4
                                          0x50545448
# 222 "project/nginx/src/http/ngx_http.c"
                                                         ) {
            continue;
        }
        ...
        if (module->preconfiguration) {
            if (module->preconfiguration(cf) != 
# 229 "project/nginx/src/http/ngx_http.c" 3 4
                                               0
# 229 "project/nginx/src/http/ngx_http.c"
                                                     ) {
                return 
# 230 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 230 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
        }
    }
    ...
    cf->module_type = 
# 237 "project/nginx/src/http/ngx_http.c" 3 4
                     0x50545448
# 237 "project/nginx/src/http/ngx_http.c"
                                    ;
    cf->cmd_type = 
# 238 "project/nginx/src/http/ngx_http.c" 3 4
                  0x02000000
# 238 "project/nginx/src/http/ngx_http.c"
                                    ;
    rv = ngx_conf_parse(cf, 
# 239 "project/nginx/src/http/ngx_http.c" 3 4
                           ((void *)0)
# 239 "project/nginx/src/http/ngx_http.c"
                               );

    if (rv != 
# 241 "project/nginx/src/http/ngx_http.c" 3 4
             ((void *)0)
# 241 "project/nginx/src/http/ngx_http.c"
                        ) {
        goto failed;
    }
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 254 "project/nginx/src/http/ngx_http.c" 3 4
                                          0x50545448
# 254 "project/nginx/src/http/ngx_http.c"
                                                         ) {
            continue;
        }
        ...
        if (module->init_main_conf) {
            ...
            if (rv != 
# 265 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 265 "project/nginx/src/http/ngx_http.c"
                                ) {
                goto failed;
            }
        }
        ...
        if (rv != 
# 271 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 271 "project/nginx/src/http/ngx_http.c"
                            ) {
            goto failed;
        }
    }
    ...
    for (s = 0; s < cmcf->servers.nelts; s++) {
        ...
        if (ngx_http_init_locations(cf, cscfp[s], clcf) != 
# 283 "project/nginx/src/http/ngx_http.c" 3 4
                                                          0
# 283 "project/nginx/src/http/ngx_http.c"
                                                                ) {
            return 
# 284 "project/nginx/src/http/ngx_http.c" 3 4
                  (void *) -1
# 284 "project/nginx/src/http/ngx_http.c"
                                ;
        }

        if (ngx_http_init_static_location_trees(cf, clcf) != 
# 287 "project/nginx/src/http/ngx_http.c" 3 4
                                                            0
# 287 "project/nginx/src/http/ngx_http.c"
                                                                  ) {
            return 
# 288 "project/nginx/src/http/ngx_http.c" 3 4
                  (void *) -1
# 288 "project/nginx/src/http/ngx_http.c"
                                ;
        }
    }


    if (ngx_http_init_phases(cf, cmcf) != 
# 293 "project/nginx/src/http/ngx_http.c" 3 4
                                         0
# 293 "project/nginx/src/http/ngx_http.c"
                                               ) {
        return 
# 294 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 294 "project/nginx/src/http/ngx_http.c"
                            ;
    }

    if (ngx_http_init_headers_in_hash(cf, cmcf) != 
# 297 "project/nginx/src/http/ngx_http.c" 3 4
                                                  0
# 297 "project/nginx/src/http/ngx_http.c"
                                                        ) {
        return 
# 298 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 298 "project/nginx/src/http/ngx_http.c"
                            ;
    }
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 303 "project/nginx/src/http/ngx_http.c" 3 4
                                          0x50545448
# 303 "project/nginx/src/http/ngx_http.c"
                                                         ) {
            continue;
        }
        ...
        if (module->postconfiguration) {
            if (module->postconfiguration(cf) != 
# 310 "project/nginx/src/http/ngx_http.c" 3 4
                                                0
# 310 "project/nginx/src/http/ngx_http.c"
                                                      ) {
                return 
# 311 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 311 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
        }
    }

    if (ngx_http_variables_init_vars(cf) != 
# 316 "project/nginx/src/http/ngx_http.c" 3 4
                                           0
# 316 "project/nginx/src/http/ngx_http.c"
                                                 ) {
        return 
# 317 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 317 "project/nginx/src/http/ngx_http.c"
                            ;
    }
...
# 328 "project/nginx/src/http/ngx_http.c" 3 4
                                                 0
# 328 "project/nginx/src/http/ngx_http.c"
                                                       ) {
        return 
# 329 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 329 "project/nginx/src/http/ngx_http.c"
                            ;
    }
    ...
    if (ngx_http_optimize_servers(cf, cmcf, cmcf->ports) != 
# 335 "project/nginx/src/http/ngx_http.c" 3 4
                                                           0
# 335 "project/nginx/src/http/ngx_http.c"
                                                                 ) {
        return 
# 336 "project/nginx/src/http/ngx_http.c" 3 4
              (void *) -1
# 336 "project/nginx/src/http/ngx_http.c"
                            ;
    }

    return 
# 339 "project/nginx/src/http/ngx_http.c" 3 4
          ((void *)0)
# 339 "project/nginx/src/http/ngx_http.c"
                     ;
...
ngx_http_init_phases(ngx_conf_t *cf, ngx_http_core_main_conf_t *cmcf)
{
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_POST_READ_PHASE].handlers,
        ...
        != 
# 354 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 354 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 356 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 356 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_SERVER_REWRITE_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_http_handler_pt))
        != 
# 361 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 361 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 363 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 363 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_REWRITE_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_http_handler_pt))
        != 
# 368 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 368 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 370 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 370 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_PREACCESS_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_http_handler_pt))
        != 
# 375 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 375 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 377 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 377 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_ACCESS_PHASE].handlers,
        ...
        != 
# 382 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 382 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 384 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 384 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_PRECONTENT_PHASE].handlers,
                       cf->pool, 2, sizeof(ngx_http_handler_pt))
        != 
# 389 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 389 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 391 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 391 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_CONTENT_PHASE].handlers,
        ...
        != 
# 396 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 396 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 398 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 398 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_HTTP_LOG_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_http_handler_pt))
        != 
# 403 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 403 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 405 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 405 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    return 
# 408 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 408 "project/nginx/src/http/ngx_http.c"
                ;
}
...
ngx_http_init_headers_in_hash(ngx_conf_t *cf, ngx_http_core_main_conf_t *cmcf)
{
    ...
    if (ngx_array_init(&headers_in, cf->temp_pool, 32, sizeof(ngx_hash_key_t))
        != 
# 421 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 421 "project/nginx/src/http/ngx_http.c"
                )
    {
        return 
# 423 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 423 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    for (header = ngx_http_headers_in; header->name.len; header++) {
        ...
        if (hk == 
# 428 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 428 "project/nginx/src/http/ngx_http.c"
                     ) {
            return 
# 429 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 429 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    ...
    hash.max_size = 512;
    hash.bucket_size = 
# 440 "project/nginx/src/http/ngx_http.c" 3 4
                      (((
# 440 "project/nginx/src/http/ngx_http.c"
                      64
# 440 "project/nginx/src/http/ngx_http.c" 3 4
                      ) + (
# 440 "project/nginx/src/http/ngx_http.c"
...
# 440 "project/nginx/src/http/ngx_http.c"
    ...
    hash.pool = cf->pool;
    hash.temp_pool = 
# 443 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 443 "project/nginx/src/http/ngx_http.c"
                        ;

    if (ngx_hash_init(&hash, headers_in.elts, headers_in.nelts) != 
# 445 "project/nginx/src/http/ngx_http.c" 3 4
                                                                  0
# 445 "project/nginx/src/http/ngx_http.c"
                                                                        ) {
        return 
# 446 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 446 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    return 
# 449 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 449 "project/nginx/src/http/ngx_http.c"
                ;
}
...
ngx_http_init_phase_handlers(ngx_conf_t *cf, ngx_http_core_main_conf_t *cmcf)
{
    ...
    if (ph == 
# 479 "project/nginx/src/http/ngx_http.c" 3 4
             ((void *)0)
# 479 "project/nginx/src/http/ngx_http.c"
                 ) {
        return 
# 480 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 480 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    return 
# 558 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 558 "project/nginx/src/http/ngx_http.c"
                ;
}
    ...
    ngx_http_module_t *module, ngx_uint_t ctx_index)
{
    ...
    saved = *ctx;
    rv = 
# 575 "project/nginx/src/http/ngx_http.c" 3 4
        ((void *)0)
# 575 "project/nginx/src/http/ngx_http.c"
                   ;
    ...
    for (s = 0; s < cmcf->servers.nelts; s++) {
        ...
        if (module->merge_srv_conf) {
            ...
            if (rv != 
# 586 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 586 "project/nginx/src/http/ngx_http.c"
                                ) {
                goto failed;
            }
        }
        ...
        if (module->merge_loc_conf) {
            ...
            if (rv != 
# 599 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 599 "project/nginx/src/http/ngx_http.c"
                                ) {
                goto failed;
            }
            ...
            rv = ngx_http_merge_locations(cf, clcf->locations,
                                          ...
                                          module, ctx_index);
            if (rv != 
# 610 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 610 "project/nginx/src/http/ngx_http.c"
                                ) {
                goto failed;
            }
        }
    ...
    void **loc_conf, ngx_http_module_t *module, ngx_uint_t ctx_index)
{
    ...
    if (locations == 
# 634 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 634 "project/nginx/src/http/ngx_http.c"
                        ) {
        return 
# 635 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 635 "project/nginx/src/http/ngx_http.c"
                         ;
    }
    ...
    for (q = 
# 641 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 641 "project/nginx/src/http/ngx_http.c"
            locations
# 641 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 641 "project/nginx/src/http/ngx_http.c"
                                     ;
         q != 
# 642 "project/nginx/src/http/ngx_http.c" 3 4
             (
# 642 "project/nginx/src/http/ngx_http.c"
             locations
# 642 "project/nginx/src/http/ngx_http.c" 3 4
             )
# 642 "project/nginx/src/http/ngx_http.c"
                                          ;
         q = 
# 643 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 643 "project/nginx/src/http/ngx_http.c"
            q
# 643 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 643 "project/nginx/src/http/ngx_http.c"
                             )
    {
        ...
        if (rv != 
# 652 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 652 "project/nginx/src/http/ngx_http.c"
                            ) {
            return rv;
        }
        ...
        rv = ngx_http_merge_locations(cf, clcf->locations, clcf->loc_conf,
                                      module, ctx_index);
        if (rv != 
# 658 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 658 "project/nginx/src/http/ngx_http.c"
                            ) {
            return rv;
        }
    }
    ...
    *ctx = saved;
    ...
    return 
# 665 "project/nginx/src/http/ngx_http.c" 3 4
          ((void *)0)
# 665 "project/nginx/src/http/ngx_http.c"
                     ;
}
    ...
    ngx_http_core_loc_conf_t *pclcf)
{
    ...
    if (locations == 
# 685 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 685 "project/nginx/src/http/ngx_http.c"
                        ) {
        return 
# 686 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 686 "project/nginx/src/http/ngx_http.c"
                    ;
    }
    ...
    named = 
# 691 "project/nginx/src/http/ngx_http.c" 3 4
           ((void *)0)
# 691 "project/nginx/src/http/ngx_http.c"
               ;
    n = 0;

    regex = 
# 694 "project/nginx/src/http/ngx_http.c" 3 4
           ((void *)0)
# 694 "project/nginx/src/http/ngx_http.c"
               ;
    r = 0;


    for (q = 
# 698 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 698 "project/nginx/src/http/ngx_http.c"
            locations
# 698 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 698 "project/nginx/src/http/ngx_http.c"
                                     ;
         q != 
# 699 "project/nginx/src/http/ngx_http.c" 3 4
             (
# 699 "project/nginx/src/http/ngx_http.c"
             locations
# 699 "project/nginx/src/http/ngx_http.c" 3 4
             )
# 699 "project/nginx/src/http/ngx_http.c"
                                          ;
         q = 
# 700 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 700 "project/nginx/src/http/ngx_http.c"
            q
# 700 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 700 "project/nginx/src/http/ngx_http.c"
                             )
    {
        ...
        if (ngx_http_init_locations(cf, 
# 706 "project/nginx/src/http/ngx_http.c" 3 4
                                       ((void *)0)
# 706 "project/nginx/src/http/ngx_http.c"
                                           , clcf) != 
# 706 "project/nginx/src/http/ngx_http.c" 3 4
                                                      0
# 706 "project/nginx/src/http/ngx_http.c"
            ...
            return 
# 707 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 707 "project/nginx/src/http/ngx_http.c"
                           ;
        }
        ...
        if (clcf->regex) {
            ...
            if (regex == 
# 715 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 715 "project/nginx/src/http/ngx_http.c"
                            ) {
                regex = q;
            }
        ...
        if (clcf->named) {
            ...
            if (named == 
# 727 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 727 "project/nginx/src/http/ngx_http.c"
                            ) {
                named = q;
            }
    ...
    if (q != 
# 739 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 739 "project/nginx/src/http/ngx_http.c"
            locations
# 739 "project/nginx/src/http/ngx_http.c" 3 4
            )
# 739 "project/nginx/src/http/ngx_http.c"
...
# 740 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 740 "project/nginx/src/http/ngx_http.c"
       &tail
# 740 "project/nginx/src/http/ngx_http.c" 3 4
       )->prev = (
# 740 "project/nginx/src/http/ngx_http.c"
...
# 740 "project/nginx/src/http/ngx_http.c"
    ...
    if (named) {
        ...
        if (clcfp == 
# 746 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 746 "project/nginx/src/http/ngx_http.c"
                        ) {
            return 
# 747 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 747 "project/nginx/src/http/ngx_http.c"
                           ;
        }
        ...
        for (q = named;
             q != 
# 753 "project/nginx/src/http/ngx_http.c" 3 4
                 (
# 753 "project/nginx/src/http/ngx_http.c"
                 locations
# 753 "project/nginx/src/http/ngx_http.c" 3 4
                 )
# 753 "project/nginx/src/http/ngx_http.c"
                                              ;
             q = 
# 754 "project/nginx/src/http/ngx_http.c" 3 4
                (
# 754 "project/nginx/src/http/ngx_http.c"
                q
# 754 "project/nginx/src/http/ngx_http.c" 3 4
                )->next
# 754 "project/nginx/src/http/ngx_http.c"
        ...
        *clcfp = 
# 761 "project/nginx/src/http/ngx_http.c" 3 4
                ((void *)0)
# 761 "project/nginx/src/http/ngx_http.c"
                    ;

        
# 763 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 763 "project/nginx/src/http/ngx_http.c"
       &tail
# 763 "project/nginx/src/http/ngx_http.c" 3 4
       )->prev = (
# 763 "project/nginx/src/http/ngx_http.c"
...
# 763 "project/nginx/src/http/ngx_http.c"
    ...
    if (regex) {
        ...
        if (clcfp == 
# 772 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 772 "project/nginx/src/http/ngx_http.c"
                        ) {
            return 
# 773 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 773 "project/nginx/src/http/ngx_http.c"
                           ;
        }
        ...
        for (q = regex;
             q != 
# 779 "project/nginx/src/http/ngx_http.c" 3 4
                 (
# 779 "project/nginx/src/http/ngx_http.c"
                 locations
# 779 "project/nginx/src/http/ngx_http.c" 3 4
                 )
# 779 "project/nginx/src/http/ngx_http.c"
                                              ;
             q = 
# 780 "project/nginx/src/http/ngx_http.c" 3 4
                (
# 780 "project/nginx/src/http/ngx_http.c"
                q
# 780 "project/nginx/src/http/ngx_http.c" 3 4
                )->next
# 780 "project/nginx/src/http/ngx_http.c"
        ...
        *clcfp = 
# 787 "project/nginx/src/http/ngx_http.c" 3 4
                ((void *)0)
# 787 "project/nginx/src/http/ngx_http.c"
                    ;

        
# 789 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 789 "project/nginx/src/http/ngx_http.c"
       &tail
# 789 "project/nginx/src/http/ngx_http.c" 3 4
       )->prev = (
# 789 "project/nginx/src/http/ngx_http.c"
...
# 789 "project/nginx/src/http/ngx_http.c"
    ...
    return 
# 794 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 794 "project/nginx/src/http/ngx_http.c"
                ;
}
    ...
    ngx_http_core_loc_conf_t *pclcf)
{
    ...
    if (locations == 
# 808 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 808 "project/nginx/src/http/ngx_http.c"
                        ) {
        return 
# 809 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 809 "project/nginx/src/http/ngx_http.c"
                    ;
    }

    if (
# 812 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 812 "project/nginx/src/http/ngx_http.c"
       locations 
# 812 "project/nginx/src/http/ngx_http.c" 3 4
       == (
# 812 "project/nginx/src/http/ngx_http.c"
...
# 812 "project/nginx/src/http/ngx_http.c"
        ...
        return 
# 813 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 813 "project/nginx/src/http/ngx_http.c"
                    ;
    }

    for (q = 
# 816 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 816 "project/nginx/src/http/ngx_http.c"
            locations
# 816 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 816 "project/nginx/src/http/ngx_http.c"
                                     ;
         q != 
# 817 "project/nginx/src/http/ngx_http.c" 3 4
             (
# 817 "project/nginx/src/http/ngx_http.c"
             locations
# 817 "project/nginx/src/http/ngx_http.c" 3 4
             )
# 817 "project/nginx/src/http/ngx_http.c"
                                          ;
         q = 
# 818 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 818 "project/nginx/src/http/ngx_http.c"
            q
# 818 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 818 "project/nginx/src/http/ngx_http.c"
                             )
    {
        ...
        if (ngx_http_init_static_location_trees(cf, clcf) != 
# 824 "project/nginx/src/http/ngx_http.c" 3 4
                                                            0
# 824 "project/nginx/src/http/ngx_http.c"
                                                                  ) {
            return 
# 825 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 825 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    }

    if (ngx_http_join_exact_locations(cf, locations) != 
# 829 "project/nginx/src/http/ngx_http.c" 3 4
                                                       0
# 829 "project/nginx/src/http/ngx_http.c"
                                                             ) {
        return 
# 830 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 830 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    ngx_http_create_locations_list(locations, 
# 833 "project/nginx/src/http/ngx_http.c" 3 4
                                             (
# 833 "project/nginx/src/http/ngx_http.c"
                                             locations
# 833 "project/nginx/src/http/ngx_http.c" 3 4
                                             )->next
# 833 "project/nginx/src/http/ngx_http.c"
    ...
    if (pclcf->static_locations == 
# 836 "project/nginx/src/http/ngx_http.c" 3 4
                                  ((void *)0)
# 836 "project/nginx/src/http/ngx_http.c"
                                      ) {
        return 
# 837 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 837 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    return 
# 840 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 840 "project/nginx/src/http/ngx_http.c"
                ;
}
    ...
    ngx_http_core_loc_conf_t *clcf)
{
    ...
    if (*locations == 
# 850 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 850 "project/nginx/src/http/ngx_http.c"
                         ) {
        *locations = ngx_palloc(cf->temp_pool,
                                sizeof(ngx_http_location_queue_t));
        if (*locations == 
# 853 "project/nginx/src/http/ngx_http.c" 3 4
                         ((void *)0)
# 853 "project/nginx/src/http/ngx_http.c"
                             ) {
            return 
# 854 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 854 "project/nginx/src/http/ngx_http.c"
                           ;
        }

        
# 857 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 857 "project/nginx/src/http/ngx_http.c"
       *locations
# 857 "project/nginx/src/http/ngx_http.c" 3 4
       )->prev = 
# 857 "project/nginx/src/http/ngx_http.c"
...
# 857 "project/nginx/src/http/ngx_http.c"
    ...
    if (lq == 
# 861 "project/nginx/src/http/ngx_http.c" 3 4
             ((void *)0)
# 861 "project/nginx/src/http/ngx_http.c"
                 ) {
        return 
# 862 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 862 "project/nginx/src/http/ngx_http.c"
                       ;
    }
        ...
        || clcf->named || clcf->noname)
    {
        lq->exact = clcf;
        lq->inclusive = 
# 872 "project/nginx/src/http/ngx_http.c" 3 4
                       ((void *)0)
# 872 "project/nginx/src/http/ngx_http.c"
                           ;

    } else {
        lq->exact = 
# 875 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 875 "project/nginx/src/http/ngx_http.c"
                       ;
        lq->inclusive = clcf;
    }
...
# 883 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 883 "project/nginx/src/http/ngx_http.c"
   &lq->list
# 883 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev = 
# 883 "project/nginx/src/http/ngx_http.c"
...
# 885 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 885 "project/nginx/src/http/ngx_http.c"
   &lq->queue
# 885 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev = (
# 885 "project/nginx/src/http/ngx_http.c"
...
# 885 "project/nginx/src/http/ngx_http.c"
   &lq->queue;
    ...
    if (ngx_http_escape_location_name(cf, clcf) != 
# 887 "project/nginx/src/http/ngx_http.c" 3 4
                                                  0
# 887 "project/nginx/src/http/ngx_http.c"
                                                        ) {
        return 
# 888 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 888 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    return 
# 891 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 891 "project/nginx/src/http/ngx_http.c"
                ;
}
...
# 902 "project/nginx/src/http/ngx_http.c" 3 4
                               ((void *)0)
# 902 "project/nginx/src/http/ngx_http.c"
                                   , clcf->name.data, clcf->name.len,
                                
# 903 "project/nginx/src/http/ngx_http.c" 3 4
                               0
# 903 "project/nginx/src/http/ngx_http.c"
                                             );
    ...
    if (escape) {
        ...
        if (p == 
# 909 "project/nginx/src/http/ngx_http.c" 3 4
                ((void *)0)
# 909 "project/nginx/src/http/ngx_http.c"
                    ) {
            return 
# 910 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 910 "project/nginx/src/http/ngx_http.c"
                           ;
        }
        ...
        ngx_escape_uri(p, clcf->name.data, clcf->name.len, 
# 916 "project/nginx/src/http/ngx_http.c" 3 4
                                                          0
# 916 "project/nginx/src/http/ngx_http.c"
                                                                        );
    ...
    return 
# 922 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 922 "project/nginx/src/http/ngx_http.c"
                ;
}
...
ngx_http_cmp_locations(const ngx_queue_t *one, const ngx_queue_t *two)
{
    ...
    if (first->named && second->named) {
        return 
# 965 "project/nginx/src/http/ngx_http.c" 3 4
              strcmp((const char *) 
# 965 "project/nginx/src/http/ngx_http.c"
              first->name.data
# 965 "project/nginx/src/http/ngx_http.c" 3 4
              , (const char *) 
# 965 "project/nginx/src/http/ngx_http.c"
...
# 988 "project/nginx/src/http/ngx_http.c" 3 4
                         ((
# 988 "project/nginx/src/http/ngx_http.c"
                         first->name.len 
# 988 "project/nginx/src/http/ngx_http.c" 3 4
                         > 
# 988 "project/nginx/src/http/ngx_http.c"
...
ngx_http_join_exact_locations(ngx_conf_t *cf, ngx_queue_t *locations)
{
    ...
    q = 
# 1005 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 1005 "project/nginx/src/http/ngx_http.c"
       locations
# 1005 "project/nginx/src/http/ngx_http.c" 3 4
       )->next
# 1005 "project/nginx/src/http/ngx_http.c"
    ...
    while (q != 
# 1007 "project/nginx/src/http/ngx_http.c" 3 4
               (
# 1007 "project/nginx/src/http/ngx_http.c"
               locations
# 1007 "project/nginx/src/http/ngx_http.c" 3 4
               )->prev
# 1007 "project/nginx/src/http/ngx_http.c"
        ...
        x = 
# 1009 "project/nginx/src/http/ngx_http.c" 3 4
           (
# 1009 "project/nginx/src/http/ngx_http.c"
           q
# 1009 "project/nginx/src/http/ngx_http.c" 3 4
           )->next
# 1009 "project/nginx/src/http/ngx_http.c"
...
# 1019 "project/nginx/src/http/ngx_http.c" 3 4
               if ((
# 1019 "project/nginx/src/http/ngx_http.c"
               cf->log
# 1019 "project/nginx/src/http/ngx_http.c" 3 4
...
# 1019 "project/nginx/src/http/ngx_http.c" 3 4
               , 
# 1019 "project/nginx/src/http/ngx_http.c"
               0, "duplicate location \"%V\" in %s:%ui", lx->name, lx->file_name, lx->line
# 1019 "project/nginx/src/http/ngx_http.c" 3 4
               )

                                                                
# 1021 "project/nginx/src/http/ngx_http.c"
                                                               ;

                return 
# 1023 "project/nginx/src/http/ngx_http.c" 3 4
                      -1
# 1023 "project/nginx/src/http/ngx_http.c"
                               ;
            }
...
# 1028 "project/nginx/src/http/ngx_http.c" 3 4
           (
# 1028 "project/nginx/src/http/ngx_http.c"
           x
# 1028 "project/nginx/src/http/ngx_http.c" 3 4
           )->next->prev = (
# 1028 "project/nginx/src/http/ngx_http.c"
...
# 1028 "project/nginx/src/http/ngx_http.c"
        ...
        q = 
# 1033 "project/nginx/src/http/ngx_http.c" 3 4
           (
# 1033 "project/nginx/src/http/ngx_http.c"
           q
# 1033 "project/nginx/src/http/ngx_http.c" 3 4
           )->next
# 1033 "project/nginx/src/http/ngx_http.c"
    ...
    return 
# 1036 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1036 "project/nginx/src/http/ngx_http.c"
                ;
}
...
ngx_http_create_locations_list(ngx_queue_t *locations, ngx_queue_t *q)
{
    ...
    if (q == 
# 1048 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 1048 "project/nginx/src/http/ngx_http.c"
            locations
# 1048 "project/nginx/src/http/ngx_http.c" 3 4
            )->prev
# 1048 "project/nginx/src/http/ngx_http.c"
    ...
    if (lq->inclusive == 
# 1054 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 1054 "project/nginx/src/http/ngx_http.c"
                            ) {
        ngx_http_create_locations_list(locations, 
# 1055 "project/nginx/src/http/ngx_http.c" 3 4
                                                 (
# 1055 "project/nginx/src/http/ngx_http.c"
                                                 q
# 1055 "project/nginx/src/http/ngx_http.c" 3 4
                                                 )->next
# 1055 "project/nginx/src/http/ngx_http.c"
    ...
    for (x = 
# 1062 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 1062 "project/nginx/src/http/ngx_http.c"
            q
# 1062 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 1062 "project/nginx/src/http/ngx_http.c"
                             ;
         x != 
# 1063 "project/nginx/src/http/ngx_http.c" 3 4
             (
# 1063 "project/nginx/src/http/ngx_http.c"
             locations
# 1063 "project/nginx/src/http/ngx_http.c" 3 4
             )
# 1063 "project/nginx/src/http/ngx_http.c"
                                          ;
         x = 
# 1064 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 1064 "project/nginx/src/http/ngx_http.c"
            x
# 1064 "project/nginx/src/http/ngx_http.c" 3 4
            )->next
# 1064 "project/nginx/src/http/ngx_http.c"
    ...
    q = 
# 1075 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 1075 "project/nginx/src/http/ngx_http.c"
       q
# 1075 "project/nginx/src/http/ngx_http.c" 3 4
       )->next
# 1075 "project/nginx/src/http/ngx_http.c"
...
# 1082 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 1082 "project/nginx/src/http/ngx_http.c"
   &tail
# 1082 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev = (
# 1082 "project/nginx/src/http/ngx_http.c"
...
# 1083 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 1083 "project/nginx/src/http/ngx_http.c"
   &lq->list
# 1083 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev->next = (
# 1083 "project/nginx/src/http/ngx_http.c"
...
# 1083 "project/nginx/src/http/ngx_http.c"
    ...
    if (x == 
# 1085 "project/nginx/src/http/ngx_http.c" 3 4
            (
# 1085 "project/nginx/src/http/ngx_http.c"
            locations
# 1085 "project/nginx/src/http/ngx_http.c" 3 4
            )
# 1085 "project/nginx/src/http/ngx_http.c"
                                         ) {
        ngx_http_create_locations_list(&lq->list, 
# 1086 "project/nginx/src/http/ngx_http.c" 3 4
                                                 (
# 1086 "project/nginx/src/http/ngx_http.c"
                                                 &lq->list
# 1086 "project/nginx/src/http/ngx_http.c" 3 4
                                                 )->next
# 1086 "project/nginx/src/http/ngx_http.c"
...
# 1090 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 1090 "project/nginx/src/http/ngx_http.c"
   &tail
# 1090 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev = (
# 1090 "project/nginx/src/http/ngx_http.c"
...
# 1091 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 1091 "project/nginx/src/http/ngx_http.c"
   locations
# 1091 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev->next = (
# 1091 "project/nginx/src/http/ngx_http.c"
...
# 1091 "project/nginx/src/http/ngx_http.c"
    ...
    ngx_http_create_locations_list(&lq->list, 
# 1093 "project/nginx/src/http/ngx_http.c" 3 4
                                             (
# 1093 "project/nginx/src/http/ngx_http.c"
                                             &lq->list
# 1093 "project/nginx/src/http/ngx_http.c" 3 4
                                             )->next
# 1093 "project/nginx/src/http/ngx_http.c"
...
# 1119 "project/nginx/src/http/ngx_http.c" 3 4
                     __builtin_offsetof (
# 1119 "project/nginx/src/http/ngx_http.c"
...
# 1119 "project/nginx/src/http/ngx_http.c"
                                                                   + len);
    if (node == 
# 1120 "project/nginx/src/http/ngx_http.c" 3 4
               ((void *)0)
# 1120 "project/nginx/src/http/ngx_http.c"
                   ) {
        return 
# 1121 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 1121 "project/nginx/src/http/ngx_http.c"
                  ;
    }

    node->left = 
# 1124 "project/nginx/src/http/ngx_http.c" 3 4
                ((void *)0)
# 1124 "project/nginx/src/http/ngx_http.c"
                    ;
    node->right = 
# 1125 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1125 "project/nginx/src/http/ngx_http.c"
                     ;
    node->tree = 
# 1126 "project/nginx/src/http/ngx_http.c" 3 4
                ((void *)0)
# 1126 "project/nginx/src/http/ngx_http.c"
                    ;
    node->exact = lq->exact;
...
# 1134 "project/nginx/src/http/ngx_http.c" 3 4
   (void) __builtin___memcpy_chk (
# 1134 "project/nginx/src/http/ngx_http.c"
   node->name
# 1134 "project/nginx/src/http/ngx_http.c" 3 4
   , 
# 1134 "project/nginx/src/http/ngx_http.c"
...
# 1136 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 1136 "project/nginx/src/http/ngx_http.c"
   &tail
# 1136 "project/nginx/src/http/ngx_http.c" 3 4
   )->prev = (
# 1136 "project/nginx/src/http/ngx_http.c"
...
# 1136 "project/nginx/src/http/ngx_http.c"
    ...
    if (
# 1138 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 1138 "project/nginx/src/http/ngx_http.c"
       locations 
# 1138 "project/nginx/src/http/ngx_http.c" 3 4
       == (
# 1138 "project/nginx/src/http/ngx_http.c"
...
# 1138 "project/nginx/src/http/ngx_http.c"
    ...
    if (node->left == 
# 1147 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 1147 "project/nginx/src/http/ngx_http.c"
                         ) {
        return 
# 1148 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 1148 "project/nginx/src/http/ngx_http.c"
                  ;
    }

    
# 1151 "project/nginx/src/http/ngx_http.c" 3 4
   (
# 1151 "project/nginx/src/http/ngx_http.c"
   q
# 1151 "project/nginx/src/http/ngx_http.c" 3 4
   )->next->prev = (
# 1151 "project/nginx/src/http/ngx_http.c"
...
# 1151 "project/nginx/src/http/ngx_http.c"
    ...
    if (
# 1153 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 1153 "project/nginx/src/http/ngx_http.c"
       &tail 
# 1153 "project/nginx/src/http/ngx_http.c" 3 4
       == (
# 1153 "project/nginx/src/http/ngx_http.c"
...
# 1153 "project/nginx/src/http/ngx_http.c"
    ...
    if (node->right == 
# 1158 "project/nginx/src/http/ngx_http.c" 3 4
                      ((void *)0)
# 1158 "project/nginx/src/http/ngx_http.c"
                          ) {
        return 
# 1159 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 1159 "project/nginx/src/http/ngx_http.c"
                  ;
    }
...
inclusive:
    ...
    if (
# 1164 "project/nginx/src/http/ngx_http.c" 3 4
       (
# 1164 "project/nginx/src/http/ngx_http.c"
       &lq->list 
# 1164 "project/nginx/src/http/ngx_http.c" 3 4
       == (
# 1164 "project/nginx/src/http/ngx_http.c"
...
# 1164 "project/nginx/src/http/ngx_http.c"
    ...
    if (node->tree == 
# 1169 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 1169 "project/nginx/src/http/ngx_http.c"
                         ) {
        return 
# 1170 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 1170 "project/nginx/src/http/ngx_http.c"
                  ;
    }
    ...
    ngx_http_listen_opt_t *lsopt)
{
    ...
    cmcf = 
# 1187 "project/nginx/src/http/ngx_http.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 1187 "project/nginx/src/http/ngx_http.c"
          cf
# 1187 "project/nginx/src/http/ngx_http.c" 3 4
          ->ctx)->main_conf[
# 1187 "project/nginx/src/http/ngx_http.c"
...
# 1187 "project/nginx/src/http/ngx_http.c"
    ...
    if (cmcf->ports == 
# 1189 "project/nginx/src/http/ngx_http.c" 3 4
                      ((void *)0)
# 1189 "project/nginx/src/http/ngx_http.c"
                          ) {
        cmcf->ports = ngx_array_create(cf->temp_pool, 2,
                                       sizeof(ngx_http_conf_port_t));
        if (cmcf->ports == 
# 1192 "project/nginx/src/http/ngx_http.c" 3 4
                          ((void *)0)
# 1192 "project/nginx/src/http/ngx_http.c"
                              ) {
            return 
# 1193 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1193 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    }
    ...
    if (port == 
# 1215 "project/nginx/src/http/ngx_http.c" 3 4
               ((void *)0)
# 1215 "project/nginx/src/http/ngx_http.c"
                   ) {
        return 
# 1216 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1216 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    port->port = p;
    port->addrs.elts = 
# 1221 "project/nginx/src/http/ngx_http.c" 3 4
                      ((void *)0)
# 1221 "project/nginx/src/http/ngx_http.c"
                          ;
    ...
    ngx_http_conf_port_t *port, ngx_http_listen_opt_t *lsopt)
{
    ...
    ngx_http_conf_addr_t *addr;
# 1245 "project/nginx/src/http/ngx_http.c"
    ...
    for (i = 0; i < port->addrs.nelts; i++) {
        ...
        if (ngx_cmp_sockaddr(lsopt->sockaddr, lsopt->socklen,
            ...
            != 
# 1252 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1252 "project/nginx/src/http/ngx_http.c"
                    )
        {
            continue;
        }
        ...
        if (ngx_http_add_server(cf, cscf, &addr[i]) != 
# 1259 "project/nginx/src/http/ngx_http.c" 3 4
                                                      0
# 1259 "project/nginx/src/http/ngx_http.c"
                                                            ) {
            return 
# 1260 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1260 "project/nginx/src/http/ngx_http.c"
                           ;
        }
...
# 1275 "project/nginx/src/http/ngx_http.c"
        if (lsopt->set) {

            if (addr[i].opt.set) {
                ngx_conf_log_error(
# 1278 "project/nginx/src/http/ngx_http.c" 3 4
                                  1
# 1278 "project/nginx/src/http/ngx_http.c"
                                               , cf, 0,
                                   "duplicate listen options for %V",
                                   &addr[i].opt.addr_text);
                return 
# 1281 "project/nginx/src/http/ngx_http.c" 3 4
                      -1
# 1281 "project/nginx/src/http/ngx_http.c"
                               ;
            }
        ...
        if (lsopt->default_server) {
            ...
            if (default_server) {
                ngx_conf_log_error(
# 1292 "project/nginx/src/http/ngx_http.c" 3 4
                                  1
# 1292 "project/nginx/src/http/ngx_http.c"
                                               , cf, 0,
                                   "a duplicate default server for %V",
                                   &addr[i].opt.addr_text);
                return 
# 1295 "project/nginx/src/http/ngx_http.c" 3 4
                      -1
# 1295 "project/nginx/src/http/ngx_http.c"
                               ;
            }
        ...
        return 
# 1311 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1311 "project/nginx/src/http/ngx_http.c"
                    ;
    }
    ...
    ngx_http_conf_port_t *port, ngx_http_listen_opt_t *lsopt)
{
    ...
    if (port->addrs.elts == 
# 1331 "project/nginx/src/http/ngx_http.c" 3 4
                           ((void *)0)
# 1331 "project/nginx/src/http/ngx_http.c"
                               ) {
        if (ngx_array_init(&port->addrs, cf->temp_pool, 4,
                           sizeof(ngx_http_conf_addr_t))
            != 
# 1334 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1334 "project/nginx/src/http/ngx_http.c"
                    )
        {
            return 
# 1336 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1336 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    }
# 1352 "project/nginx/src/http/ngx_http.c"
    addr = ngx_array_push(&port->addrs);
    if (addr == 
# 1353 "project/nginx/src/http/ngx_http.c" 3 4
               ((void *)0)
# 1353 "project/nginx/src/http/ngx_http.c"
                   ) {
        return 
# 1354 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1354 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    addr->opt = *lsopt;
    addr->hash.buckets = 
# 1358 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 1358 "project/nginx/src/http/ngx_http.c"
                            ;
    addr->hash.size = 0;
    addr->wc_head = 
# 1360 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 1360 "project/nginx/src/http/ngx_http.c"
                       ;
    addr->wc_tail = 
# 1361 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 1361 "project/nginx/src/http/ngx_http.c"
                       ;

    addr->nregex = 0;
    addr->regex = 
# 1364 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1364 "project/nginx/src/http/ngx_http.c"
                     ;

    addr->default_server = cscf;
    addr->servers.elts = 
# 1367 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 1367 "project/nginx/src/http/ngx_http.c"
                            ;
    ...
    ngx_http_conf_addr_t *addr)
{
    ...
    if (addr->servers.elts == 
# 1382 "project/nginx/src/http/ngx_http.c" 3 4
                             ((void *)0)
# 1382 "project/nginx/src/http/ngx_http.c"
                                 ) {
        if (ngx_array_init(&addr->servers, cf->temp_pool, 4,
                           sizeof(ngx_http_core_srv_conf_t *))
            != 
# 1385 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1385 "project/nginx/src/http/ngx_http.c"
                    )
        {
            return 
# 1387 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1387 "project/nginx/src/http/ngx_http.c"
                           ;
        }
        ...
        for (i = 0; i < addr->servers.nelts; i++) {
            if (server[i] == cscf) {
                ngx_conf_log_error(
# 1394 "project/nginx/src/http/ngx_http.c" 3 4
                                  1
# 1394 "project/nginx/src/http/ngx_http.c"
                                               , cf, 0,
                                   "a duplicate listen %V",
                                   &addr->opt.addr_text);
                return 
# 1397 "project/nginx/src/http/ngx_http.c" 3 4
                      -1
# 1397 "project/nginx/src/http/ngx_http.c"
                               ;
            }
        }
    }
    ...
    if (server == 
# 1403 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1403 "project/nginx/src/http/ngx_http.c"
                     ) {
        return 
# 1404 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1404 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    *server = cscf;
    ...
    return 
# 1409 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1409 "project/nginx/src/http/ngx_http.c"
                ;
}
    ...
    ngx_array_t *ports)
{
    ...
    if (ports == 
# 1421 "project/nginx/src/http/ngx_http.c" 3 4
                ((void *)0)
# 1421 "project/nginx/src/http/ngx_http.c"
                    ) {
        return 
# 1422 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1422 "project/nginx/src/http/ngx_http.c"
                    ;
    }
    ...
    for (p = 0; p < ports->nelts; p++) {
        ...
        for (a = 0; a < port[p].addrs.nelts; a++) {
            ...
            {
                if (ngx_http_server_names(cf, cmcf, &addr[a]) != 
# 1445 "project/nginx/src/http/ngx_http.c" 3 4
                                                                0
# 1445 "project/nginx/src/http/ngx_http.c"
                                                                      ) {
                    return 
# 1446 "project/nginx/src/http/ngx_http.c" 3 4
                          -1
# 1446 "project/nginx/src/http/ngx_http.c"
                                   ;
                }
            }
        }

        if (ngx_http_init_listening(cf, &port[p]) != 
# 1451 "project/nginx/src/http/ngx_http.c" 3 4
                                                    0
# 1451 "project/nginx/src/http/ngx_http.c"
                                                          ) {
            return 
# 1452 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1452 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    }

    return 
# 1456 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1456 "project/nginx/src/http/ngx_http.c"
                ;
}
...
# 1476 "project/nginx/src/http/ngx_http.c" 3 4
   (void) __builtin___memset_chk (
# 1476 "project/nginx/src/http/ngx_http.c"
   &ha
# 1476 "project/nginx/src/http/ngx_http.c" 3 4
   , 0, 
# 1476 "project/nginx/src/http/ngx_http.c"
...
# 1476 "project/nginx/src/http/ngx_http.c"
    ...
    ha.temp_pool = ngx_create_pool(
# 1478 "project/nginx/src/http/ngx_http.c" 3 4
                                  (16 * 1024)
# 1478 "project/nginx/src/http/ngx_http.c"
                                                       , cf->log);
    if (ha.temp_pool == 
# 1479 "project/nginx/src/http/ngx_http.c" 3 4
                       ((void *)0)
# 1479 "project/nginx/src/http/ngx_http.c"
                           ) {
        return 
# 1480 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1480 "project/nginx/src/http/ngx_http.c"
                       ;
    }

    ha.pool = cf->pool;

    if (ngx_hash_keys_array_init(&ha, 
# 1485 "project/nginx/src/http/ngx_http.c" 3 4
                                     2
# 1485 "project/nginx/src/http/ngx_http.c"
                                                   ) != 
# 1485 "project/nginx/src/http/ngx_http.c" 3 4
                                                        0
# 1485 "project/nginx/src/http/ngx_http.c"
...
# 1505 "project/nginx/src/http/ngx_http.c" 3 4
                                 1
# 1505 "project/nginx/src/http/ngx_http.c"
                                                      );

            if (rc == 
# 1507 "project/nginx/src/http/ngx_http.c" 3 4
                     -1
# 1507 "project/nginx/src/http/ngx_http.c"
                              ) {
                goto failed;
            }

            if (rc == 
# 1511 "project/nginx/src/http/ngx_http.c" 3 4
                     -5
# 1511 "project/nginx/src/http/ngx_http.c"
                                 ) {
                
# 1512 "project/nginx/src/http/ngx_http.c" 3 4
               if ((
# 1512 "project/nginx/src/http/ngx_http.c"
               cf->log
# 1512 "project/nginx/src/http/ngx_http.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 1512 "project/nginx/src/http/ngx_http.c"
...
# 1512 "project/nginx/src/http/ngx_http.c" 3 4
               , 
# 1512 "project/nginx/src/http/ngx_http.c"
               0, "invalid server name or wildcard \"%V\" on %V", &name[n].name, &addr->opt.addr_text
# 1512 "project/nginx/src/http/ngx_http.c" 3 4
               )

                                                                  
# 1514 "project/nginx/src/http/ngx_http.c"
                                                                 ;
                goto failed;
            }

            if (rc == 
# 1518 "project/nginx/src/http/ngx_http.c" 3 4
                     -3
# 1518 "project/nginx/src/http/ngx_http.c"
                             ) {
                
# 1519 "project/nginx/src/http/ngx_http.c" 3 4
               if ((
# 1519 "project/nginx/src/http/ngx_http.c"
               cf->log
# 1519 "project/nginx/src/http/ngx_http.c" 3 4
...
# 1519 "project/nginx/src/http/ngx_http.c" 3 4
               , 
# 1519 "project/nginx/src/http/ngx_http.c"
               0, "conflicting server name \"%V\" on %V, ignored", &name[n].name, &addr->opt.addr_text
# 1519 "project/nginx/src/http/ngx_http.c" 3 4
               )

                                                                  
# 1521 "project/nginx/src/http/ngx_http.c"
                                                                 ;
            }
        }
    }
    ...
    if (ha.keys.nelts) {
        hash.hash = &addr->hash;
        hash.temp_pool = 
# 1534 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 1534 "project/nginx/src/http/ngx_http.c"
                            ;

        if (ngx_hash_init(&hash, ha.keys.elts, ha.keys.nelts) != 
# 1536 "project/nginx/src/http/ngx_http.c" 3 4
                                                                0
# 1536 "project/nginx/src/http/ngx_http.c"
                                                                      ) {
            goto failed;
        }
    }
...
# 1543 "project/nginx/src/http/ngx_http.c" 3 4
       qsort
# 1543 "project/nginx/src/http/ngx_http.c"
                (ha.dns_wc_head.elts, (size_t) ha.dns_wc_head.nelts,
                  sizeof(ngx_hash_key_t), ngx_http_cmp_dns_wildcards);

        hash.hash = 
# 1546 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 1546 "project/nginx/src/http/ngx_http.c"
                       ;
        ...
        if (ngx_hash_wildcard_init(&hash, ha.dns_wc_head.elts,
            ...
            != 
# 1551 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1551 "project/nginx/src/http/ngx_http.c"
                    )
        {
            goto failed;
        }
...
# 1561 "project/nginx/src/http/ngx_http.c" 3 4
       qsort
# 1561 "project/nginx/src/http/ngx_http.c"
                (ha.dns_wc_tail.elts, (size_t) ha.dns_wc_tail.nelts,
                  sizeof(ngx_hash_key_t), ngx_http_cmp_dns_wildcards);

        hash.hash = 
# 1564 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 1564 "project/nginx/src/http/ngx_http.c"
                       ;
        hash.temp_pool = ha.temp_pool;
        ...
        if (ngx_hash_wildcard_init(&hash, ha.dns_wc_tail.elts,
            ...
            != 
# 1569 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1569 "project/nginx/src/http/ngx_http.c"
                    )
        {
            goto failed;
        }
    ...
    if (regex == 0) {
        return 
# 1582 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 1582 "project/nginx/src/http/ngx_http.c"
                    ;
    }
    ...
    if (addr->regex == 
# 1587 "project/nginx/src/http/ngx_http.c" 3 4
                      ((void *)0)
# 1587 "project/nginx/src/http/ngx_http.c"
                          ) {
        return 
# 1588 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1588 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    return 
# 1606 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1606 "project/nginx/src/http/ngx_http.c"
                ;
...
failed:
    ...
    return 
# 1612 "project/nginx/src/http/ngx_http.c" 3 4
          -1
# 1612 "project/nginx/src/http/ngx_http.c"
                   ;
}
...
# 1680 "project/nginx/src/http/ngx_http.c"
    ...
    while (i < last) {
        ...
        if (ls == 
# 1698 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1698 "project/nginx/src/http/ngx_http.c"
                     ) {
            return 
# 1699 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1699 "project/nginx/src/http/ngx_http.c"
                           ;
        }

        hport = ngx_pcalloc(cf->pool, sizeof(ngx_http_port_t));
        if (hport == 
# 1703 "project/nginx/src/http/ngx_http.c" 3 4
                    ((void *)0)
# 1703 "project/nginx/src/http/ngx_http.c"
                        ) {
            return 
# 1704 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1704 "project/nginx/src/http/ngx_http.c"
                           ;
        }
        ...
        case 
# 1714 "project/nginx/src/http/ngx_http.c" 3 4
            30
# 1714 "project/nginx/src/http/ngx_http.c"
                    :
            if (ngx_http_add_addrs6(cf, hport, addr) != 
# 1715 "project/nginx/src/http/ngx_http.c" 3 4
                                                       0
# 1715 "project/nginx/src/http/ngx_http.c"
                                                             ) {
                return 
# 1716 "project/nginx/src/http/ngx_http.c" 3 4
                      -1
# 1716 "project/nginx/src/http/ngx_http.c"
                               ;
            }
            break;

        default:
            if (ngx_http_add_addrs(cf, hport, addr) != 
# 1721 "project/nginx/src/http/ngx_http.c" 3 4
                                                      0
# 1721 "project/nginx/src/http/ngx_http.c"
                                                            ) {
                return 
# 1722 "project/nginx/src/http/ngx_http.c" 3 4
                      -1
# 1722 "project/nginx/src/http/ngx_http.c"
                               ;
            }
            break;
        }
    ...
    return 
# 1731 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1731 "project/nginx/src/http/ngx_http.c"
                ;
}
...
ngx_http_add_listening(ngx_conf_t *cf, ngx_http_conf_addr_t *addr)
{
    ...
    if (ls == 
# 1743 "project/nginx/src/http/ngx_http.c" 3 4
             ((void *)0)
# 1743 "project/nginx/src/http/ngx_http.c"
                 ) {
        return 
# 1744 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 1744 "project/nginx/src/http/ngx_http.c"
                  ;
    }
...
# 1773 "project/nginx/src/http/ngx_http.c"
    ls->backlog = addr->opt.backlog;
    ls->rcvbuf = addr->opt.rcvbuf;
    ls->sndbuf = addr->opt.sndbuf;

    ls->keepalive = addr->opt.so_keepalive;
# 1793 "project/nginx/src/http/ngx_http.c"
    ...
    ngx_http_conf_addr_t *addr)
{
    ...
    if (hport->addrs == 
# 1823 "project/nginx/src/http/ngx_http.c" 3 4
                       ((void *)0)
# 1823 "project/nginx/src/http/ngx_http.c"
                           ) {
        return 
# 1824 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1824 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    for (i = 0; i < hport->naddrs; i++) {
        ...
        if (addr[i].hash.buckets == 
# 1842 "project/nginx/src/http/ngx_http.c" 3 4
                                   ((void *)0)
            
# 1843 "project/nginx/src/http/ngx_http.c"
           && (addr[i].wc_head == 
# 1843 "project/nginx/src/http/ngx_http.c" 3 4
                                  ((void *)0)
                
# 1844 "project/nginx/src/http/ngx_http.c"
               || addr[i].wc_head->hash.buckets == 
# 1844 "project/nginx/src/http/ngx_http.c" 3 4
                                                   ((void *)0)
# 1844 "project/nginx/src/http/ngx_http.c"
                                                       )
            && (addr[i].wc_tail == 
# 1845 "project/nginx/src/http/ngx_http.c" 3 4
                                  ((void *)0)
                
# 1846 "project/nginx/src/http/ngx_http.c"
               || addr[i].wc_tail->hash.buckets == 
# 1846 "project/nginx/src/http/ngx_http.c" 3 4
                                                   ((void *)0)
# 1846 "project/nginx/src/http/ngx_http.c"
                                                       )
        ...
        if (vn == 
# 1856 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1856 "project/nginx/src/http/ngx_http.c"
                     ) {
            return 
# 1857 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1857 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    ...
    return 
# 1871 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1871 "project/nginx/src/http/ngx_http.c"
                ;
}
    ...
    ngx_http_conf_addr_t *addr)
{
    ...
    if (hport->addrs == 
# 1888 "project/nginx/src/http/ngx_http.c" 3 4
                       ((void *)0)
# 1888 "project/nginx/src/http/ngx_http.c"
                           ) {
        return 
# 1889 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 1889 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    for (i = 0; i < hport->naddrs; i++) {
        ...
        if (addr[i].hash.buckets == 
# 1907 "project/nginx/src/http/ngx_http.c" 3 4
                                   ((void *)0)
            
# 1908 "project/nginx/src/http/ngx_http.c"
           && (addr[i].wc_head == 
# 1908 "project/nginx/src/http/ngx_http.c" 3 4
                                  ((void *)0)
                
# 1909 "project/nginx/src/http/ngx_http.c"
               || addr[i].wc_head->hash.buckets == 
# 1909 "project/nginx/src/http/ngx_http.c" 3 4
                                                   ((void *)0)
# 1909 "project/nginx/src/http/ngx_http.c"
                                                       )
            && (addr[i].wc_tail == 
# 1910 "project/nginx/src/http/ngx_http.c" 3 4
                                  ((void *)0)
                
# 1911 "project/nginx/src/http/ngx_http.c"
               || addr[i].wc_tail->hash.buckets == 
# 1911 "project/nginx/src/http/ngx_http.c" 3 4
                                                   ((void *)0)
# 1911 "project/nginx/src/http/ngx_http.c"
                                                       )
        ...
        vn = ngx_palloc(cf->pool, sizeof(ngx_http_virtual_names_t));
        if (vn == 
# 1921 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1921 "project/nginx/src/http/ngx_http.c"
                     ) {
            return 
# 1922 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 1922 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    ...
    return 
# 1936 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 1936 "project/nginx/src/http/ngx_http.c"
                ;
}
...
ngx_http_types_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*types == (void *) -1) {
        return 
# 1955 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 1955 "project/nginx/src/http/ngx_http.c"
                         ;
    }
    ...
    if (*types == 
# 1960 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 1960 "project/nginx/src/http/ngx_http.c"
                     ) {
        *types = ngx_array_create(cf->temp_pool, 1, sizeof(ngx_hash_key_t));
        if (*types == 
# 1962 "project/nginx/src/http/ngx_http.c" 3 4
                     ((void *)0)
# 1962 "project/nginx/src/http/ngx_http.c"
                         ) {
            return 
# 1963 "project/nginx/src/http/ngx_http.c" 3 4
                  (void *) -1
# 1963 "project/nginx/src/http/ngx_http.c"
                                ;
        }
        ...
        if (default_type) {
            ...
            if (type == 
# 1968 "project/nginx/src/http/ngx_http.c" 3 4
                       ((void *)0)
# 1968 "project/nginx/src/http/ngx_http.c"
                           ) {
                return 
# 1969 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 1969 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (value[i].len == 1 && value[i].data[0] == '*') {
            *types = (void *) -1;
            return 
# 1985 "project/nginx/src/http/ngx_http.c" 3 4
                  ((void *)0)
# 1985 "project/nginx/src/http/ngx_http.c"
                             ;
        }
        ...
        for (n = 0; n < (*types)->nelts; n++) {
            ...
            if (
# 1994 "project/nginx/src/http/ngx_http.c" 3 4
               strcmp((const char *) 
# 1994 "project/nginx/src/http/ngx_http.c"
               value[i].data
# 1994 "project/nginx/src/http/ngx_http.c" 3 4
               , (const char *) 
# 1994 "project/nginx/src/http/ngx_http.c"
...
# 1994 "project/nginx/src/http/ngx_http.c"
                                                           == 0) {
                ngx_conf_log_error(
# 1995 "project/nginx/src/http/ngx_http.c" 3 4
                                  5
# 1995 "project/nginx/src/http/ngx_http.c"
                                              , cf, 0,
        ...
        type = ngx_array_push(*types);
        if (type == 
# 2002 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 2002 "project/nginx/src/http/ngx_http.c"
                       ) {
            return 
# 2003 "project/nginx/src/http/ngx_http.c" 3 4
                  (void *) -1
# 2003 "project/nginx/src/http/ngx_http.c"
                                ;
        }
    ...
    return 
# 2015 "project/nginx/src/http/ngx_http.c" 3 4
          ((void *)0)
# 2015 "project/nginx/src/http/ngx_http.c"
                     ;
}
    ...
    ngx_str_t *default_types)
{
    ...
    if (*keys) {
        ...
        if (*keys == (void *) -1) {
            return 
# 2029 "project/nginx/src/http/ngx_http.c" 3 4
                  ((void *)0)
# 2029 "project/nginx/src/http/ngx_http.c"
                             ;
        }

        hash.hash = types_hash;
        hash.key = 
# 2033 "project/nginx/src/http/ngx_http.c" 3 4
                  ((void *)0)
# 2033 "project/nginx/src/http/ngx_http.c"
                      ;
        hash.max_size = 2048;
        hash.bucket_size = 64;
        ...
        hash.pool = cf->pool;
        hash.temp_pool = 
# 2038 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 2038 "project/nginx/src/http/ngx_http.c"
                            ;

        if (ngx_hash_init(&hash, (*keys)->elts, (*keys)->nelts) != 
# 2040 "project/nginx/src/http/ngx_http.c" 3 4
                                                                  0
# 2040 "project/nginx/src/http/ngx_http.c"
                                                                        ) {
            return 
# 2041 "project/nginx/src/http/ngx_http.c" 3 4
                  (void *) -1
# 2041 "project/nginx/src/http/ngx_http.c"
                                ;
        }

        return 
# 2044 "project/nginx/src/http/ngx_http.c" 3 4
              ((void *)0)
# 2044 "project/nginx/src/http/ngx_http.c"
                         ;
    }

    if (prev_types_hash->buckets == 
# 2047 "project/nginx/src/http/ngx_http.c" 3 4
                                   ((void *)0)
# 2047 "project/nginx/src/http/ngx_http.c"
                                       ) {

        if (*prev_keys == 
# 2049 "project/nginx/src/http/ngx_http.c" 3 4
                         ((void *)0)
# 2049 "project/nginx/src/http/ngx_http.c"
                             ) {

            if (ngx_http_set_default_types(cf, prev_keys, default_types)
                != 
# 2052 "project/nginx/src/http/ngx_http.c" 3 4
                  0
# 2052 "project/nginx/src/http/ngx_http.c"
                        )
            {
                return 
# 2054 "project/nginx/src/http/ngx_http.c" 3 4
                      (void *) -1
# 2054 "project/nginx/src/http/ngx_http.c"
                                    ;
            }
            ...
            *keys = *prev_keys;
            return 
# 2059 "project/nginx/src/http/ngx_http.c" 3 4
                  ((void *)0)
# 2059 "project/nginx/src/http/ngx_http.c"
                             ;
        }

        hash.hash = prev_types_hash;
        hash.key = 
# 2063 "project/nginx/src/http/ngx_http.c" 3 4
                  ((void *)0)
# 2063 "project/nginx/src/http/ngx_http.c"
                      ;
        hash.max_size = 2048;
        hash.bucket_size = 64;
        hash.name = "test_types_hash";
        hash.pool = cf->pool;
        hash.temp_pool = 
# 2068 "project/nginx/src/http/ngx_http.c" 3 4
                        ((void *)0)
# 2068 "project/nginx/src/http/ngx_http.c"
                            ;

        if (ngx_hash_init(&hash, (*prev_keys)->elts, (*prev_keys)->nelts)
            != 
# 2071 "project/nginx/src/http/ngx_http.c" 3 4
              0
# 2071 "project/nginx/src/http/ngx_http.c"
                    )
        {
            return 
# 2073 "project/nginx/src/http/ngx_http.c" 3 4
                  (void *) -1
# 2073 "project/nginx/src/http/ngx_http.c"
                                ;
        }
    }
    ...
    *types_hash = *prev_types_hash;
    ...
    return 
# 2079 "project/nginx/src/http/ngx_http.c" 3 4
          ((void *)0)
# 2079 "project/nginx/src/http/ngx_http.c"
                     ;
    ...
    ngx_str_t *default_type)
{
    ...
    *types = ngx_array_create(cf->temp_pool, 1, sizeof(ngx_hash_key_t));
    if (*types == 
# 2091 "project/nginx/src/http/ngx_http.c" 3 4
                 ((void *)0)
# 2091 "project/nginx/src/http/ngx_http.c"
                     ) {
        return 
# 2092 "project/nginx/src/http/ngx_http.c" 3 4
              -1
# 2092 "project/nginx/src/http/ngx_http.c"
                       ;
    }
    ...
    while (default_type->len) {
        ...
        type = ngx_array_push(*types);
        if (type == 
# 2098 "project/nginx/src/http/ngx_http.c" 3 4
                   ((void *)0)
# 2098 "project/nginx/src/http/ngx_http.c"
                       ) {
            return 
# 2099 "project/nginx/src/http/ngx_http.c" 3 4
                  -1
# 2099 "project/nginx/src/http/ngx_http.c"
                           ;
        }
    ...
    return 
# 2110 "project/nginx/src/http/ngx_http.c" 3 4
          0
# 2110 "project/nginx/src/http/ngx_http.c"
                ;
}
