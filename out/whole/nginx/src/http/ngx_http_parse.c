# 0 "project/nginx/src/http/ngx_http_parse.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/ngx_http_parse.c"
...
# 9 "project/nginx/src/http/ngx_http_parse.c" 2
...
# 10 "project/nginx/src/http/ngx_http_parse.c" 2
...
# 11 "project/nginx/src/http/ngx_http_parse.c" 2



# 13 "project/nginx/src/http/ngx_http_parse.c"
...
# 103 "project/nginx/src/http/ngx_http_parse.c"
ngx_int_t
ngx_http_parse_request_line(ngx_http_request_t *r, ngx_buf_t *b)
{
    ...
    for (p = b->pos; p < b->last; p++) {
        ...
        case sw_start:
            ...
            if (ch == 
# 146 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\r' 
# 146 "project/nginx/src/http/ngx_http_parse.c"
                        || ch == 
# 146 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                 (u_char) '\n'
# 146 "project/nginx/src/http/ngx_http_parse.c"
            ...
            if ((ch < 'A' || ch > 'Z') && ch != '_' && ch != '-') {
                return 
# 151 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      10
# 151 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            }
        ...
        case sw_method:
            if (ch == ' ') {
                ...
                case 3:
                    if (*(uint32_t *) m == ((' ' << 24) | ('T' << 16) | ('E' << 8) | 'G')) {
                        r->method = 
# 166 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000002
# 166 "project/nginx/src/http/ngx_http_parse.c"
                                               ;
                        break;
                    }

                    if (*(uint32_t *) m == ((' ' << 24) | ('T' << 16) | ('U' << 8) | 'P')) {
                        r->method = 
# 171 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000010
# 171 "project/nginx/src/http/ngx_http_parse.c"
                                               ;
                        break;
                    }
                ...
                case 4:
                    if (m[1] == 'O') {
                        ...
                        if (*(uint32_t *) m == (('T' << 24) | ('S' << 16) | ('O' << 8) | 'P')) {
                            r->method = 
# 181 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                       0x00000008
# 181 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
                            break;
                        }

                        if (*(uint32_t *) m == (('Y' << 24) | ('P' << 16) | ('O' << 8) | 'C')) {
                            r->method = 
# 186 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                       0x00000080
# 186 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
                            break;
                        }

                        if (*(uint32_t *) m == (('E' << 24) | ('V' << 16) | ('O' << 8) | 'M')) {
                            r->method = 
# 191 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                       0x00000100
# 191 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
                            break;
                        }

                        if (*(uint32_t *) m == (('K' << 24) | ('C' << 16) | ('O' << 8) | 'L')) {
                            r->method = 
# 196 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                       0x00001000
# 196 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
                            break;
                        }
                        ...
                        if (*(uint32_t *) m == (('D' << 24) | ('A' << 16) | ('E' << 8) | 'H')) {
                            r->method = 
# 203 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                       0x00000004
# 203 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
                            break;
                        }
                    }
                ...
                case 5:
                    if (*(uint32_t *) m == (('O' << 24) | ('C' << 16) | ('K' << 8) | 'M') && m[4] == 'L') {
                        r->method = 
# 212 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000040
# 212 "project/nginx/src/http/ngx_http_parse.c"
                                                 ;
                        break;
                    }

                    if (*(uint32_t *) m == (('C' << 24) | ('T' << 16) | ('A' << 8) | 'P') && m[4] == 'H') {
                        r->method = 
# 217 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00004000
# 217 "project/nginx/src/http/ngx_http_parse.c"
                                                 ;
                        break;
                    }

                    if (*(uint32_t *) m == (('C' << 24) | ('A' << 16) | ('R' << 8) | 'T') && m[4] == 'E') {
                        r->method = 
# 222 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00008000
# 222 "project/nginx/src/http/ngx_http_parse.c"
                                                 ;
                        break;
                    }
                ...
                case 6:
                    if (*(uint32_t *) m == (('E' << 24) | ('L' << 16) | ('E' << 8) | 'D') && (((uint32_t *) m)[1] & 0xffff) == (('E' << 8) | 'T')) {
                        r->method = 
# 230 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000020
# 230 "project/nginx/src/http/ngx_http_parse.c"
                                                  ;
                        break;
                    }

                    if (*(uint32_t *) m == (('O' << 24) | ('L' << 16) | ('N' << 8) | 'U') && (((uint32_t *) m)[1] & 0xffff) == (('K' << 8) | 'C')) {
                        r->method = 
# 235 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00002000
# 235 "project/nginx/src/http/ngx_http_parse.c"
                                                  ;
                        break;
                    }
                ...
                case 7:
                    if (*(uint32_t *) m == (('I' << 24) | ('T' << 16) | ('P' << 8) | 'O') && ((uint32_t *) m)[1] == ((' ' << 24) | ('S' << 16) | ('N' << 8) | 'O'))
                    {
                        r->method = 
# 244 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000200
# 244 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
                    }

                    if (*(uint32_t *) m == (('N' << 24) | ('N' << 16) | ('O' << 8) | 'C') && ((uint32_t *) m)[1] == ((' ' << 24) | ('T' << 16) | ('C' << 8) | 'E'))
                    {
                        r->method = 
# 249 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00010000
# 249 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
                    }
                ...
                case 8:
                    if (*(uint32_t *) m == (('P' << 24) | ('O' << 16) | ('R' << 8) | 'P') && ((uint32_t *) m)[1] == (('D' << 24) | ('N' << 16) | ('I' << 8) | 'F'))
                    {
                        r->method = 
# 257 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000400
# 257 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
                    }
                ...
                case 9:
                    if (*(uint32_t *) m == (('P' << 24) | ('O' << 16) | ('R' << 8) | 'P') && ((uint32_t *) m)[1] == (('C' << 24) | ('T' << 16) | ('A' << 8) | 'P') && m[8] == 'H'
                                                                        )
                    {
                        r->method = 
# 266 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   0x00000800
# 266 "project/nginx/src/http/ngx_http_parse.c"
                                                     ;
                    }
            ...
            if ((ch < 'A' || ch > 'Z') && ch != '_' && ch != '-') {
                return 
# 277 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      10
# 277 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            }
        ...
        case sw_spaces_before_uri:
            ...
            default:
                return 
# 302 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 302 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_schema:
            ...
            default:
                return 
# 324 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 324 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_schema_slash:
            ...
            default:
                return 
# 334 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 334 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_schema_slash_slash:
            ...
            default:
                return 
# 344 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 344 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_host_end:
            ...
            default:
                return 
# 402 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 402 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_host_ip_literal:
            ...
            default:
                return 
# 443 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 443 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_port:
            ...
            default:
                return 
# 476 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 476 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_after_slash_in_uri:
            ...
            case ' ':
                ...
                break;
            case 
# 493 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 493 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->uri_end = p;
                r->http_minor = 9;
                ...
                break;
            case 
# 498 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 498 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->uri_end = p;
                r->http_minor = 9;
                goto done;
            ...
            default:
                if (ch < 0x20 || ch == 0x7f) {
                    return 
# 533 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          11
# 533 "project/nginx/src/http/ngx_http_parse.c"
                                                        ;
                }
                state = sw_check_uri;
                break;
        ...
        case sw_check_uri:
            ...
            case '/':
                ...
                r->uri_ext = 
# 556 "project/nginx/src/http/ngx_http_parse.c" 3 4
                            ((void *)0)
# 556 "project/nginx/src/http/ngx_http_parse.c"
                                ;
                state = sw_after_slash_in_uri;
                break;
            case '.':
            ...
            case ' ':
                ...
                break;
            case 
# 566 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 566 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->uri_end = p;
                r->http_minor = 9;
                state = sw_almost_done;
                break;
            case 
# 571 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 571 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->uri_end = p;
                r->http_minor = 9;
                goto done;
            ...
            default:
                if (ch < 0x20 || ch == 0x7f) {
                    return 
# 598 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          11
# 598 "project/nginx/src/http/ngx_http_parse.c"
                                                        ;
                }
                break;
            }
        ...
        case sw_uri:
            ...
            case ' ':
                ...
                break;
            case 
# 616 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 616 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->uri_end = p;
                r->http_minor = 9;
                state = sw_almost_done;
                break;
            case 
# 621 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 621 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->uri_end = p;
                r->http_minor = 9;
                goto done;
            ...
            default:
                if (ch < 0x20 || ch == 0x7f) {
                    return 
# 630 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          11
# 630 "project/nginx/src/http/ngx_http_parse.c"
                                                        ;
                }
                break;
            }
        ...
        case sw_http_09:
            ...
            case ' ':
                break;
            case 
# 641 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 641 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->http_minor = 9;
                state = sw_almost_done;
                break;
            case 
# 645 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 645 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->http_minor = 9;
                goto done;
            case 'H':
            ...
            default:
                return 
# 653 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 653 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_http_H:
            ...
            default:
                return 
# 663 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 663 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_http_HT:
            ...
            default:
                return 
# 673 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 673 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_http_HTT:
            ...
            default:
                return 
# 683 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 683 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_http_HTTP:
            ...
            default:
                return 
# 693 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 693 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_first_major_digit:
            if (ch < '1' || ch > '9') {
                return 
# 700 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 700 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            ...
            if (r->http_major > 1) {
                return 
# 706 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      12
# 706 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
        ...
        case sw_major_digit:
            ...
            if (ch < '0' || ch > '9') {
                return 
# 720 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 720 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            ...
            if (r->http_major > 1) {
                return 
# 726 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      12
# 726 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
        ...
        case sw_first_minor_digit:
            if (ch < '0' || ch > '9') {
                return 
# 734 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 734 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
        ...
        case sw_minor_digit:
            if (ch == 
# 743 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\r'
# 743 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                state = sw_almost_done;
                break;
            }
            ...
            if (ch == 
# 748 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 748 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                goto done;
            }
            ...
            if (ch < '0' || ch > '9') {
                return 
# 758 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 758 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }

            if (r->http_minor > 99) {
                return 
# 762 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 762 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
        ...
        case sw_spaces_after_digit:
            ...
            case ' ':
                break;
            case 
# 772 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 772 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 775 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 775 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            default:
                return 
# 778 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 778 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
            break;
        ...
        case sw_almost_done:
            ...
            switch (ch) {
            case 
# 786 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 786 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            default:
                return 
# 789 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 789 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
        }
    }
    ...
    return 
# 797 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -2
# 797 "project/nginx/src/http/ngx_http_parse.c"
                   ;
    ...
    if (r->request_end == 
# 803 "project/nginx/src/http/ngx_http_parse.c" 3 4
                         ((void *)0)
# 803 "project/nginx/src/http/ngx_http_parse.c"
                             ) {
        r->request_end = p;
    }
    ...
    if (r->http_version == 9 && r->method != 
# 810 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                            0x00000002
# 810 "project/nginx/src/http/ngx_http_parse.c"
                                                        ) {
        return 
# 811 "project/nginx/src/http/ngx_http_parse.c" 3 4
              13
# 811 "project/nginx/src/http/ngx_http_parse.c"
                                              ;
    }

    return 
# 814 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 814 "project/nginx/src/http/ngx_http_parse.c"
                ;
}
    ...
    ngx_uint_t allow_underscores)
{
    ...
    for (p = b->pos; p < b->last; p++) {
        ...
        case sw_start:
            ...
            switch (ch) {
            case 
# 862 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 862 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->header_end = p;
                state = sw_header_almost_done;
                break;
            case 
# 866 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 866 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->header_end = p;
                goto header_done;
            default:
                ...
                if (c) {
                    hash = 
# 875 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          ((ngx_uint_t) 
# 875 "project/nginx/src/http/ngx_http_parse.c"
                          0 
# 875 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          * 31 + 
# 875 "project/nginx/src/http/ngx_http_parse.c"
...
# 875 "project/nginx/src/http/ngx_http_parse.c"
                ...
                if (ch == '_') {
                    if (allow_underscores) {
                        hash = 
# 883 "project/nginx/src/http/ngx_http_parse.c" 3 4
                              ((ngx_uint_t) 
# 883 "project/nginx/src/http/ngx_http_parse.c"
                              0 
# 883 "project/nginx/src/http/ngx_http_parse.c" 3 4
                              * 31 + 
# 883 "project/nginx/src/http/ngx_http_parse.c"
...
# 883 "project/nginx/src/http/ngx_http_parse.c"
                ...
                if (ch <= 0x20 || ch == 0x7f || ch == ':') {
                    r->header_end = p;
                    return 
# 898 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          14
# 898 "project/nginx/src/http/ngx_http_parse.c"
                                                       ;
                }
        ...
        case sw_name:
            ...
            if (c) {
                hash = 
# 915 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      ((ngx_uint_t) 
# 915 "project/nginx/src/http/ngx_http_parse.c"
                      hash 
# 915 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      * 31 + 
# 915 "project/nginx/src/http/ngx_http_parse.c"
...
# 915 "project/nginx/src/http/ngx_http_parse.c"
                ...
                i &= (
# 917 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     32 
# 917 "project/nginx/src/http/ngx_http_parse.c"
                                            - 1);
                break;
            }
            ...
            if (ch == '_') {
                if (allow_underscores) {
                    hash = 
# 923 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          ((ngx_uint_t) 
# 923 "project/nginx/src/http/ngx_http_parse.c"
                          hash 
# 923 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          * 31 + 
# 923 "project/nginx/src/http/ngx_http_parse.c"
...
# 923 "project/nginx/src/http/ngx_http_parse.c"
                    ...
                    i &= (
# 925 "project/nginx/src/http/ngx_http_parse.c" 3 4
                         32 
# 925 "project/nginx/src/http/ngx_http_parse.c"
                                                - 1);
            ...
            if (ch == 
# 940 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\r'
# 940 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                r->header_name_end = p;
                r->header_start = p;
                r->header_end = p;
            ...
            if (ch == 
# 948 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 948 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                r->header_name_end = p;
                r->header_start = p;
                r->header_end = p;
            ...
            if (ch == '/'
                ...
                && 
# 959 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  strncmp((const char *) 
# 959 "project/nginx/src/http/ngx_http_parse.c"
                  r->header_name_start
# 959 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  , (const char *) 
# 959 "project/nginx/src/http/ngx_http_parse.c"
...
# 959 "project/nginx/src/http/ngx_http_parse.c"
            ...
            if (ch <= 0x20 || ch == 0x7f) {
                r->header_end = p;
                return 
# 967 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      14
# 967 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            }
        ...
        case sw_space_before_value:
            ...
            case ' ':
                break;
            case 
# 979 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 979 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->header_start = p;
                r->header_end = p;
                state = sw_almost_done;
                break;
            case 
# 984 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 984 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->header_start = p;
                r->header_end = p;
                goto done;
            case '\0':
                r->header_end = p;
                return 
# 990 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      14
# 990 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            default:
                r->header_start = p;
                state = sw_value;
        ...
        case sw_value:
            ...
            case ' ':
                ...
                break;
            case 
# 1005 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 1005 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->header_end = p;
                state = sw_almost_done;
                break;
            case 
# 1009 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1009 "project/nginx/src/http/ngx_http_parse.c"
                  :
                r->header_end = p;
                goto done;
            case '\0':
                r->header_end = p;
                return 
# 1014 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      14
# 1014 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            }
            break;
        ...
        case sw_space_after_value:
            ...
            case ' ':
                break;
            case 
# 1023 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 1023 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 1026 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1026 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            case '\0':
                r->header_end = p;
                return 
# 1030 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      14
# 1030 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            default:
                state = sw_value;
                break;
        ...
        case sw_ignore_line:
            switch (ch) {
            case 
# 1040 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1040 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_start;
                break;
            default:
        ...
        case sw_almost_done:
            switch (ch) {
            case 
# 1051 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1051 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            case 
# 1053 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 1053 "project/nginx/src/http/ngx_http_parse.c"
                  :
                break;
            default:
                return 
# 1056 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      14
# 1056 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            }
            break;
        ...
        case sw_header_almost_done:
            switch (ch) {
            case 
# 1063 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1063 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto header_done;
            default:
                return 
# 1066 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      14
# 1066 "project/nginx/src/http/ngx_http_parse.c"
                                                   ;
            }
        }
    }
    ...
    return 
# 1076 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -2
# 1076 "project/nginx/src/http/ngx_http_parse.c"
                   ;
    ...
    return 
# 1085 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 1085 "project/nginx/src/http/ngx_http_parse.c"
                ;
...
header_done:
    ...
    return 
# 1092 "project/nginx/src/http/ngx_http_parse.c" 3 4
          1
# 1092 "project/nginx/src/http/ngx_http_parse.c"
                                    ;
}
...
ngx_http_parse_uri(ngx_http_request_t *r)
{
    ...
    for (p = r->uri_start; p != r->uri_end; p++) {
        ...
        case sw_start:
            ...
            if (ch != '/') {
                return 
# 1118 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1118 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        ...
        case sw_after_slash_in_uri:
            ...
            default:
                if (ch <= 0x20 || ch == 0x7f) {
                    return 
# 1164 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          -1
# 1164 "project/nginx/src/http/ngx_http_parse.c"
                                   ;
                }
                state = sw_check_uri;
                break;
        ...
        case sw_check_uri:
            ...
            case '/':
                ...
                r->uri_ext = 
# 1187 "project/nginx/src/http/ngx_http_parse.c" 3 4
                            ((void *)0)
# 1187 "project/nginx/src/http/ngx_http_parse.c"
                                ;
                state = sw_after_slash_in_uri;
                break;
            case '.':
            ...
            default:
                if (ch <= 0x20 || ch == 0x7f) {
                    return 
# 1216 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          -1
# 1216 "project/nginx/src/http/ngx_http_parse.c"
                                   ;
                }
                break;
            }
        ...
        case sw_uri:
            ...
            default:
                if (ch <= 0x20 || ch == 0x7f) {
                    return 
# 1235 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          -1
# 1235 "project/nginx/src/http/ngx_http_parse.c"
                                   ;
                }
                break;
            }
    ...
    return 
# 1243 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 1243 "project/nginx/src/http/ngx_http_parse.c"
                ;
}
...
ngx_http_parse_complex_uri(ngx_http_request_t *r, ngx_uint_t merge_slashes)
{
    ...
    u = r->uri.data;
    r->uri_ext = 
# 1268 "project/nginx/src/http/ngx_http_parse.c" 3 4
                ((void *)0)
# 1268 "project/nginx/src/http/ngx_http_parse.c"
                    ;
    r->args_start = 
# 1269 "project/nginx/src/http/ngx_http_parse.c" 3 4
                   ((void *)0)
# 1269 "project/nginx/src/http/ngx_http_parse.c"
                       ;
    ...
    while (p <= r->uri_end) {
        ...
        case sw_usual:
            ...
            switch (ch) {
# 1323 "project/nginx/src/http/ngx_http_parse.c"
            case '/':
                ...
                r->uri_ext = 
# 1331 "project/nginx/src/http/ngx_http_parse.c" 3 4
                            ((void *)0)
# 1331 "project/nginx/src/http/ngx_http_parse.c"
                                ;
                state = sw_slash;
                *u++ = ch;
                break;
        ...
        case sw_dot_dot:
            ...
            case '#':
                ...
                for ( ;; ) {
                    if (u < r->uri.data) {
                        return 
# 1466 "project/nginx/src/http/ngx_http_parse.c" 3 4
                              11
# 1466 "project/nginx/src/http/ngx_http_parse.c"
                                                            ;
                    }
                    if (*u == '/') {
                        u++;
        ...
        case sw_quoted:
            ...
            return 
# 1517 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  11
# 1517 "project/nginx/src/http/ngx_http_parse.c"
                                                ;
            ...
            if (ch >= '0' && ch <= '9') {
                ...
                if (ch == '%' || ch == '#') {
                    ...
                    *u++ = ch;
                    ...
                    return 
# 1530 "project/nginx/src/http/ngx_http_parse.c" 3 4
                          11
# 1530 "project/nginx/src/http/ngx_http_parse.c"
                                                        ;
                }
            ...
            return 
# 1555 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  11
# 1555 "project/nginx/src/http/ngx_http_parse.c"
                                                ;
        }
    }
    ...
    if (state == sw_quoted || state == sw_quoted_second) {
        return 
# 1560 "project/nginx/src/http/ngx_http_parse.c" 3 4
              11
# 1560 "project/nginx/src/http/ngx_http_parse.c"
                                            ;
    }
    ...
    if (state == sw_dot) {
        ...
        for ( ;; ) {
            if (u < r->uri.data) {
                return 
# 1571 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      11
# 1571 "project/nginx/src/http/ngx_http_parse.c"
                                                    ;
            }
    ...
    r->uri_ext = 
# 1592 "project/nginx/src/http/ngx_http_parse.c" 3 4
                ((void *)0)
# 1592 "project/nginx/src/http/ngx_http_parse.c"
                    ;

    return 
# 1594 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 1594 "project/nginx/src/http/ngx_http_parse.c"
                ;
...
args:
    ...
    while (p < r->uri_end) {
        ...
        r->args_start = 
# 1605 "project/nginx/src/http/ngx_http_parse.c" 3 4
                       ((void *)0)
# 1605 "project/nginx/src/http/ngx_http_parse.c"
                           ;
    ...
    r->uri_ext = 
# 1617 "project/nginx/src/http/ngx_http_parse.c" 3 4
                ((void *)0)
# 1617 "project/nginx/src/http/ngx_http_parse.c"
                    ;

    return 
# 1619 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 1619 "project/nginx/src/http/ngx_http_parse.c"
                ;
}
    ...
    ngx_http_status_t *status)
{
    ...
    for (p = b->pos; p < b->last; p++) {
        ...
        case sw_start:
            ...
            default:
                return 
# 1659 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1659 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
            break;
        ...
        case sw_H:
            ...
            default:
                return 
# 1669 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1669 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
            break;
        ...
        case sw_HT:
            ...
            default:
                return 
# 1679 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1679 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
            break;
        ...
        case sw_HTT:
            ...
            default:
                return 
# 1689 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1689 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
            break;
        ...
        case sw_HTTP:
            ...
            default:
                return 
# 1699 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1699 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
            break;
        ...
        case sw_first_major_digit:
            if (ch < '1' || ch > '9') {
                return 
# 1706 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1706 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        ...
        case sw_major_digit:
            ...
            if (ch < '0' || ch > '9') {
                return 
# 1721 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1721 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }

            if (r->http_major > 99) {
                return 
# 1725 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1725 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        ...
        case sw_first_minor_digit:
            if (ch < '0' || ch > '9') {
                return 
# 1734 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1734 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        ...
        case sw_minor_digit:
            ...
            if (ch < '0' || ch > '9') {
                return 
# 1749 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1749 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }

            if (r->http_minor > 99) {
                return 
# 1753 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1753 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        ...
        case sw_status:
            ...
            if (ch < '0' || ch > '9') {
                return 
# 1766 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1766 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        ...
        case sw_space_after_status:
            ...
            case '.':
                ...
                break;
            case 
# 1787 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 1787 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 1790 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1790 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            default:
                return 
# 1793 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1793 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
            break;
        ...
        case sw_status_text:
            switch (ch) {
            case 
# 1800 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 1800 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_almost_done;

                break;
            case 
# 1804 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1804 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            }
            break;
        ...
        case sw_almost_done:
            ...
            switch (ch) {
            case 
# 1813 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 1813 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            default:
                return 
# 1816 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      -1
# 1816 "project/nginx/src/http/ngx_http_parse.c"
                               ;
            }
        }
    }
    ...
    return 
# 1824 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -2
# 1824 "project/nginx/src/http/ngx_http_parse.c"
                   ;
    ...
    if (status->end == 
# 1830 "project/nginx/src/http/ngx_http_parse.c" 3 4
                      ((void *)0)
# 1830 "project/nginx/src/http/ngx_http_parse.c"
                          ) {
        status->end = p;
    }
    ...
    return 
# 1837 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 1837 "project/nginx/src/http/ngx_http_parse.c"
                ;
}
    ...
    ngx_str_t *args, ngx_uint_t *flags)
{
    ...
    if (p[0] == '.' && len > 1 && p[1] == '.'
        && (len == 2 || 
# 1858 "project/nginx/src/http/ngx_http_parse.c" 3 4
                       ((
# 1858 "project/nginx/src/http/ngx_http_parse.c"
                       p[2]
# 1858 "project/nginx/src/http/ngx_http_parse.c" 3 4
                       ) == '/')
# 1858 "project/nginx/src/http/ngx_http_parse.c"
    ...
    for ( ; len; len--) {
        ...
        if (
# 1888 "project/nginx/src/http/ngx_http_parse.c" 3 4
           ((
# 1888 "project/nginx/src/http/ngx_http_parse.c"
           ch
# 1888 "project/nginx/src/http/ngx_http_parse.c" 3 4
           ) == '/') 
# 1888 "project/nginx/src/http/ngx_http_parse.c"
            ...
            if (p[0] == '.' && p[1] == '.'
                && (len == 3 || 
# 1893 "project/nginx/src/http/ngx_http_parse.c" 3 4
                               ((
# 1893 "project/nginx/src/http/ngx_http_parse.c"
                               p[2]
# 1893 "project/nginx/src/http/ngx_http_parse.c" 3 4
                               ) == '/')
# 1893 "project/nginx/src/http/ngx_http_parse.c"
    ...
    if (quoted) {
        ...
        if (dst == 
# 1907 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  ((void *)0)
# 1907 "project/nginx/src/http/ngx_http_parse.c"
                      ) {
            return 
# 1908 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  -1
# 1908 "project/nginx/src/http/ngx_http_parse.c"
                           ;
        }
        ...
        if (p[0] == '.' && len > 1 && p[1] == '.'
            && (len == 2 || 
# 1924 "project/nginx/src/http/ngx_http_parse.c" 3 4
                           ((
# 1924 "project/nginx/src/http/ngx_http_parse.c"
                           p[2]
# 1924 "project/nginx/src/http/ngx_http_parse.c" 3 4
                           ) == '/')
# 1924 "project/nginx/src/http/ngx_http_parse.c"
        ...
        for ( ; len; len--) {
            ...
            if (
# 1937 "project/nginx/src/http/ngx_http_parse.c" 3 4
               ((
# 1937 "project/nginx/src/http/ngx_http_parse.c"
               ch
# 1937 "project/nginx/src/http/ngx_http_parse.c" 3 4
               ) == '/') 
# 1937 "project/nginx/src/http/ngx_http_parse.c"
                ...
                if (p[0] == '.' && p[1] == '.'
                    && (len == 3 || 
# 1942 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   ((
# 1942 "project/nginx/src/http/ngx_http_parse.c"
                                   p[2]
# 1942 "project/nginx/src/http/ngx_http_parse.c" 3 4
                                   ) == '/')
# 1942 "project/nginx/src/http/ngx_http_parse.c"
    ...
    return 
# 1950 "project/nginx/src/http/ngx_http_parse.c" 3 4
          0
# 1950 "project/nginx/src/http/ngx_http_parse.c"
                ;

unsafe:

    if (*flags & 
# 1954 "project/nginx/src/http/ngx_http_parse.c" 3 4
                1
# 1954 "project/nginx/src/http/ngx_http_parse.c"
                                   ) {
        
# 1955 "project/nginx/src/http/ngx_http_parse.c" 3 4
       if ((
# 1955 "project/nginx/src/http/ngx_http_parse.c"
       r->connection->log
# 1955 "project/nginx/src/http/ngx_http_parse.c" 3 4
...
# 1955 "project/nginx/src/http/ngx_http_parse.c" 3 4
       , 
# 1955 "project/nginx/src/http/ngx_http_parse.c"
       0, "unsafe URI \"%V\" was detected", uri
# 1955 "project/nginx/src/http/ngx_http_parse.c" 3 4
       )
                                                            
# 1956 "project/nginx/src/http/ngx_http_parse.c"
                                                           ;
    }

    return 
# 1959 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -1
# 1959 "project/nginx/src/http/ngx_http_parse.c"
                   ;
}
    ...
    ngx_str_t *value)
{
    ...
    for (i = 0; i < headers->nelts; i++) {
        ...
        while (start < end) {
            ...
            if (value == 
# 1995 "project/nginx/src/http/ngx_http_parse.c" 3 4
                        ((void *)0)
# 1995 "project/nginx/src/http/ngx_http_parse.c"
                            ) {
                if (start == end || *start == ',') {
                    return i;
                }
    ...
    return 
# 2032 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -5
# 2032 "project/nginx/src/http/ngx_http_parse.c"
                      ;
}
    ...
    ngx_str_t *value)
{
    ...
    return 
# 2083 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -5
# 2083 "project/nginx/src/http/ngx_http_parse.c"
                      ;
}
...
ngx_http_arg(ngx_http_request_t *r, u_char *name, size_t len, ngx_str_t *value)
{
    ...
    if (r->args.len == 0) {
        return 
# 2093 "project/nginx/src/http/ngx_http_parse.c" 3 4
              -5
# 2093 "project/nginx/src/http/ngx_http_parse.c"
                          ;
    }
    ...
    for ( ; p < last; p++) {
        ...
        if (p == 
# 2105 "project/nginx/src/http/ngx_http_parse.c" 3 4
                ((void *)0)
# 2105 "project/nginx/src/http/ngx_http_parse.c"
                    ) {
            return 
# 2106 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  -5
# 2106 "project/nginx/src/http/ngx_http_parse.c"
                              ;
        }
        ...
        if ((p == r->args.data || *(p - 1) == '&') && *(p + len) == '=') {
            ...
            if (p == 
# 2115 "project/nginx/src/http/ngx_http_parse.c" 3 4
                    ((void *)0)
# 2115 "project/nginx/src/http/ngx_http_parse.c"
                        ) {
            ...
            return 
# 2121 "project/nginx/src/http/ngx_http_parse.c" 3 4
                  0
# 2121 "project/nginx/src/http/ngx_http_parse.c"
                        ;
        }
    }

    return 
# 2125 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -5
# 2125 "project/nginx/src/http/ngx_http_parse.c"
                      ;
}
    ...
    ngx_http_chunked_t *ctx)
{
    ...
    rc = 
# 2178 "project/nginx/src/http/ngx_http_parse.c" 3 4
        -2
# 2178 "project/nginx/src/http/ngx_http_parse.c"
                 ;
    ...
    for (pos = b->pos; pos < b->last; pos++) {
        ...
        case sw_chunk_size:
            if (ctx->size > 
# 2207 "project/nginx/src/http/ngx_http_parse.c" 3 4
                           9223372036854775807LL 
# 2207 "project/nginx/src/http/ngx_http_parse.c"
                                               / 16) {
                goto invalid;
            }
            ...
            if (ctx->size == 0) {
                ...
                switch (ch) {
                case 
# 2226 "project/nginx/src/http/ngx_http_parse.c" 3 4
                    (u_char) '\r'
# 2226 "project/nginx/src/http/ngx_http_parse.c"
                      :
                    state = sw_last_chunk_extension_almost_done;
                    break;
                case 
# 2229 "project/nginx/src/http/ngx_http_parse.c" 3 4
                    (u_char) '\n'
# 2229 "project/nginx/src/http/ngx_http_parse.c"
                      :
                    state = sw_trailer;
                    break;
                case ';':
            ...
            switch (ch) {
            case 
# 2245 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 2245 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_chunk_extension_almost_done;
                break;
            case 
# 2248 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 2248 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_chunk_data;
                break;
            case ';':
        ...
        case sw_chunk_extension:
            switch (ch) {
            case 
# 2264 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 2264 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_chunk_extension_almost_done;
                break;
            case 
# 2267 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 2267 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_chunk_data;
            }
            break;
        ...
        case sw_chunk_extension_almost_done:
            if (ch == 
# 2273 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 2273 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                state = sw_chunk_data;
                break;
            }
        ...
        case sw_chunk_data:
            rc = 
# 2280 "project/nginx/src/http/ngx_http_parse.c" 3 4
                0
# 2280 "project/nginx/src/http/ngx_http_parse.c"
                      ;
            goto data;
        ...
        case sw_after_data:
            switch (ch) {
            case 
# 2285 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 2285 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_after_data_almost_done;
                break;
            case 
# 2288 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 2288 "project/nginx/src/http/ngx_http_parse.c"
                  :
        ...
        case sw_after_data_almost_done:
            if (ch == 
# 2297 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 2297 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                state = sw_chunk_start;
                break;
            }
        ...
        case sw_last_chunk_extension:
            switch (ch) {
            case 
# 2305 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 2305 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_last_chunk_extension_almost_done;
                break;
            case 
# 2308 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 2308 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_trailer;
            }
            break;
        ...
        case sw_last_chunk_extension_almost_done:
            if (ch == 
# 2314 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 2314 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                state = sw_trailer;
                break;
            }
        ...
        case sw_trailer:
            switch (ch) {
            case 
# 2322 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 2322 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_trailer_almost_done;
                break;
            case 
# 2325 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 2325 "project/nginx/src/http/ngx_http_parse.c"
                  :
                goto done;
            default:
        ...
        case sw_trailer_almost_done:
            if (ch == 
# 2333 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 2333 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                goto done;
            }
            goto invalid;
        ...
        case sw_trailer_header:
            switch (ch) {
            case 
# 2340 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\r'
# 2340 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_trailer_header_almost_done;
                break;
            case 
# 2343 "project/nginx/src/http/ngx_http_parse.c" 3 4
                (u_char) '\n'
# 2343 "project/nginx/src/http/ngx_http_parse.c"
                  :
                state = sw_trailer;
            }
            break;
        ...
        case sw_trailer_header_almost_done:
            if (ch == 
# 2349 "project/nginx/src/http/ngx_http_parse.c" 3 4
                     (u_char) '\n'
# 2349 "project/nginx/src/http/ngx_http_parse.c"
                       ) {
                state = sw_trailer;
                break;
            }
...
data:
    ...
    if (ctx->size > 
# 2363 "project/nginx/src/http/ngx_http_parse.c" 3 4
                   9223372036854775807LL 
# 2363 "project/nginx/src/http/ngx_http_parse.c"
                                       - 5) {
        goto invalid;
    }
    ...
    return 
# 2410 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -4
# 2410 "project/nginx/src/http/ngx_http_parse.c"
                  ;

invalid:

    return 
# 2414 "project/nginx/src/http/ngx_http_parse.c" 3 4
          -1
# 2414 "project/nginx/src/http/ngx_http_parse.c"
                   ;
}
