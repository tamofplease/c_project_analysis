# 0 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 9 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 2
...
# 10 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 2
...
# 11 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 2



# 13 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 21 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 21 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    ngx_http_postpone_filter_init,

    
# 24 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 24 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 25 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 25 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,

    
# 27 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 27 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 28 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 28 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,

    
# 30 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 30 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 31 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)

# 32 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
};


ngx_module_t ngx_http_postpone_filter_module = {
    
# 36 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 36 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
   "8" 
# 36 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   "," 
# 36 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 38 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 38 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 39 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   0x50545448
# 39 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                  ,
    
# 40 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 40 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 41 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 41 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 42 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 42 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 43 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 43 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 44 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 44 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 45 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 45 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 46 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   ((void *)0)
# 46 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
       ,
    
# 47 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 48 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
};
...
ngx_http_postpone_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (r != c->data) {
        ...
        if (in) {
            if (ngx_http_postpone_filter_add(r, in) != 
# 72 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                                                      0
# 72 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                            ) {
                return 
# 73 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                      -1
# 73 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                               ;
            }

            return 
# 76 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                  0
# 76 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                        ;
        }
        ...
        return 
# 85 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              0
# 85 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                    ;
    }

    if (r->postponed == 
# 88 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                       ((void *)0)
# 88 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                           ) {
        ...
        return 
# 94 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              0
# 94 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                    ;
    }

    if (in) {
        if (ngx_http_postpone_filter_add(r, in) != 
# 98 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                                                  0
# 98 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                        ) {
            return 
# 99 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                  -1
# 99 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                           ;
        }
    }
...
# 116 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                                                     ((void *)0)
# 116 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                         );
        }

        if (pr->out == 
# 119 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                      ((void *)0)
# 119 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                          ) {
            
# 120 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           if ((
# 120 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
           c->log
# 120 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
...
# 120 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           , 
# 120 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
           0, "http postpone filter NULL output"
# 120 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           )
                                                             
# 121 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                            ;
            ...
            if (ngx_http_next_body_filter(r->main, pr->out) == 
# 128 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                                                              -1
# 128 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                                       ) {
                return 
# 129 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                      -1
# 129 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                               ;
            }
        }
    ...
    return 
# 137 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
          0
# 137 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                ;
}
...
ngx_http_postpone_filter_add(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (r->postponed) {
        ...
        if (pr->request == 
# 149 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                          ((void *)0)
# 149 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                              ) {
            goto found;
        }
    ...
    if (pr == 
# 160 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
             ((void *)0)
# 160 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                 ) {
        return 
# 161 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              -1
# 161 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                       ;
    }
    ...
    *ppr = pr;
    ...
    pr->request = 
# 166 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                 ((void *)0)
# 166 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                     ;
    pr->out = 
# 167 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
             ((void *)0)
# 167 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                 ;
    pr->next = 
# 168 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              ((void *)0)
# 168 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                  ;

found:

    if (ngx_chain_add_copy(r->pool, &pr->out, in) == 
# 172 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                                                    0
# 172 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                          ) {
        return 
# 173 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              0
# 173 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                    ;
    }

    return 
# 176 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
          -1
# 176 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                   ;
}
...
ngx_http_postpone_filter_in_memory(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (r->out == 
# 193 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                 ((void *)0)
# 193 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                     ) {
        clcf = 
# 194 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              (
# 194 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
              r
# 194 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
              )->loc_conf[
# 194 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 200 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
               if ((
# 200 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
               c->log
# 200 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
...
# 200 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
               , 
# 200 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
               0, "too big subrequest response: %uz", len
# 200 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
               )
                                                                      
# 201 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                                     ;
                return 
# 202 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                      -1
# 202 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                               ;
            }
        ...
        if (b == 
# 210 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                ((void *)0)
# 210 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                    ) {
            return 
# 211 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                  -1
# 211 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                           ;
        }
        ...
        if (r->out == 
# 217 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                     ((void *)0)
# 217 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                         ) {
            return 
# 218 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                  -1
# 218 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                           ;
        }

        r->out->buf = b;
        r->out->next = 
# 222 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                      ((void *)0)
# 222 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                          ;
    }
    ...
    for ( ; in; in = in->next) {
        ...
        if (
# 229 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           (((
# 229 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
           in->buf
# 229 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           )->flush || (
# 229 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           if ((
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
           c->log
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           , 
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
           0, "too big subrequest response"
# 236 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
           )
                                                        
# 237 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                                                       ;
            return 
# 238 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                  -1
# 238 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                           ;
        }
        ...
        b->last = 
# 244 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                 (((u_char *) __builtin___memcpy_chk (
# 244 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                 b->last
# 244 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
                 , 
# 244 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
...
# 244 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
    ...
    return 
# 248 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
          0
# 248 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                ;
}
...
ngx_http_postpone_filter_init(ngx_conf_t *cf)
{
    ...
    return 
# 258 "project/nginx/src/http/ngx_http_postpone_filter_module.c" 3 4
          0
# 258 "project/nginx/src/http/ngx_http_postpone_filter_module.c"
                ;
}
