# 0 "project/nginx/src/http/ngx_http_request_body.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/ngx_http_request_body.c"
...
# 9 "project/nginx/src/http/ngx_http_request_body.c" 2
...
# 10 "project/nginx/src/http/ngx_http_request_body.c" 2
...
# 11 "project/nginx/src/http/ngx_http_request_body.c" 2



# 13 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    ngx_http_client_body_handler_pt post_handler)
{
    ...
    if (r != r->main || r->request_body || r->discard_body) {
        ...
        post_handler(r);
        return 
# 48 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 48 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }

    if (ngx_http_test_expect(r) != 
# 51 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                  0
# 51 "project/nginx/src/http/ngx_http_request_body.c"
                                        ) {
        rc = 
# 52 "project/nginx/src/http/ngx_http_request_body.c" 3 4
            500
# 52 "project/nginx/src/http/ngx_http_request_body.c"
                                          ;
        goto done;
    }
    ...
    if (rb == 
# 57 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             ((void *)0)
# 57 "project/nginx/src/http/ngx_http_request_body.c"
                 ) {
        rc = 
# 58 "project/nginx/src/http/ngx_http_request_body.c" 3 4
            500
# 58 "project/nginx/src/http/ngx_http_request_body.c"
                                          ;
        goto done;
    }
# 77 "project/nginx/src/http/ngx_http_request_body.c"
    rb->rest = -1;
    ...
    if (r->headers_in.content_length_n < 0 && !r->headers_in.chunked) {
        ...
        post_handler(r);
        return 
# 85 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 85 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
# 95 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    if (preread) {
        ...
        out.buf = r->header_in;
        out.next = 
# 105 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  ((void *)0)
# 105 "project/nginx/src/http/ngx_http_request_body.c"
                      ;

        rc = ngx_http_request_body_filter(r, &out);

        if (rc != 
# 109 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 0
# 109 "project/nginx/src/http/ngx_http_request_body.c"
                       ) {
            goto done;
        }
            ...
            && rb->rest <= (off_t) (r->header_in->end - r->header_in->last))
        {
            ...
            b = 
# 121 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               ngx_pcalloc(
# 121 "project/nginx/src/http/ngx_http_request_body.c"
               r->pool
# 121 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               , sizeof(ngx_buf_t))
# 121 "project/nginx/src/http/ngx_http_request_body.c"
                                      ;
            if (b == 
# 122 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                    ((void *)0)
# 122 "project/nginx/src/http/ngx_http_request_body.c"
                        ) {
                rc = 
# 123 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                    500
# 123 "project/nginx/src/http/ngx_http_request_body.c"
                                                  ;
                goto done;
            }
        ...
        rc = ngx_http_request_body_filter(r, 
# 145 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                            ((void *)0)
# 145 "project/nginx/src/http/ngx_http_request_body.c"
                                                );

        if (rc != 
# 147 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 0
# 147 "project/nginx/src/http/ngx_http_request_body.c"
                       ) {
            goto done;
        }
    }
    ...
    if (rb->rest == 0 && rb->last_saved) {
        ...
        post_handler(r);
        return 
# 156 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 156 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }

    if (rb->rest < 0) {
        
# 160 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       if ((
# 160 "project/nginx/src/http/ngx_http_request_body.c"
       r->connection->log
# 160 "project/nginx/src/http/ngx_http_request_body.c" 3 4
...
# 160 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       , 
# 160 "project/nginx/src/http/ngx_http_request_body.c"
       0, "negative request body rest"
# 160 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       )
                                                   
# 161 "project/nginx/src/http/ngx_http_request_body.c"
                                                  ;
        rc = 
# 162 "project/nginx/src/http/ngx_http_request_body.c" 3 4
            500
# 162 "project/nginx/src/http/ngx_http_request_body.c"
                                          ;
        goto done;
    }

    clcf = 
# 166 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          (
# 166 "project/nginx/src/http/ngx_http_request_body.c"
          r
# 166 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          )->loc_conf[
# 166 "project/nginx/src/http/ngx_http_request_body.c"
...
# 166 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    if (rb->buf == 
# 189 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  ((void *)0)
# 189 "project/nginx/src/http/ngx_http_request_body.c"
                      ) {
        rc = 
# 190 "project/nginx/src/http/ngx_http_request_body.c" 3 4
            500
# 190 "project/nginx/src/http/ngx_http_request_body.c"
                                          ;
        goto done;
    }
    ...
    if (r->request_body_no_buffering
        && (rc == 
# 202 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 0 
# 202 "project/nginx/src/http/ngx_http_request_body.c"
                        || rc == 
# 202 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                 -2
# 202 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    {
        if (rc == 
# 204 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 0
# 204 "project/nginx/src/http/ngx_http_request_body.c"
                       ) {
            r->request_body_no_buffering = 0;
    ...
    if (rc >= 
# 216 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             300
# 216 "project/nginx/src/http/ngx_http_request_body.c"
                                      ) {
        r->main->count--;
    }
...
{
    ngx_int_t rc;
# 241 "project/nginx/src/http/ngx_http_request_body.c"
    if (r->connection->read->timedout) {
        r->connection->timedout = 1;
        return 
# 243 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              408
# 243 "project/nginx/src/http/ngx_http_request_body.c"
                                       ;
    }
    ...
    if (rc == 
# 248 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             0
# 248 "project/nginx/src/http/ngx_http_request_body.c"
                   ) {
        r->reading_body = 0;
    }
...
# 263 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                    408
# 263 "project/nginx/src/http/ngx_http_request_body.c"
                                                             );
        return;
    }
    ...
    if (rc >= 
# 269 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             300
# 269 "project/nginx/src/http/ngx_http_request_body.c"
                                      ) {
    ...
    for ( ;; ) {
        for ( ;; ) {
            ...
            if (rb->buf->last == rb->buf->end) {
                ...
                rc = ngx_http_request_body_filter(r, 
# 305 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                    ((void *)0)
# 305 "project/nginx/src/http/ngx_http_request_body.c"
                                                        );

                if (rc != 
# 307 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                         0
# 307 "project/nginx/src/http/ngx_http_request_body.c"
                               ) {
                    return rc;
                }

                if (rb->busy != 
# 311 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                               ((void *)0)
# 311 "project/nginx/src/http/ngx_http_request_body.c"
                                   ) {
                    if (r->request_body_no_buffering) {
                        if (c->read->timer_set) {
                            
# 314 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                           ngx_event_del_timer
# 314 "project/nginx/src/http/ngx_http_request_body.c"
                                        (c->read);
                        }

                        if (ngx_handle_read_event(c->read, 0) != 
# 317 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                                0
# 317 "project/nginx/src/http/ngx_http_request_body.c"
                                                                      ) {
                            return 
# 318 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                  500
# 318 "project/nginx/src/http/ngx_http_request_body.c"
                                                                ;
                        }

                        return 
# 321 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                              -2
# 321 "project/nginx/src/http/ngx_http_request_body.c"
                                       ;
                    }

                    if (rb->filter_need_buffering) {
                        clcf = 
# 325 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                              (
# 325 "project/nginx/src/http/ngx_http_request_body.c"
                              r
# 325 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                              )->loc_conf[
# 325 "project/nginx/src/http/ngx_http_request_body.c"
...
# 326 "project/nginx/src/http/ngx_http_request_body.c"
                                                                             ;
                        
# 327 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                       ngx_event_add_timer
# 327 "project/nginx/src/http/ngx_http_request_body.c"
                                    (c->read, clcf->client_body_timeout);

                        if (ngx_handle_read_event(c->read, 0) != 
# 329 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                                0
# 329 "project/nginx/src/http/ngx_http_request_body.c"
                                                                      ) {
                            return 
# 330 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                  500
# 330 "project/nginx/src/http/ngx_http_request_body.c"
                                                                ;
                        }

                        return 
# 333 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                              -2
# 333 "project/nginx/src/http/ngx_http_request_body.c"
                                       ;
                    }

                    
# 336 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   if ((
# 336 "project/nginx/src/http/ngx_http_request_body.c"
                   c->log
# 336 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 336 "project/nginx/src/http/ngx_http_request_body.c"
...
# 336 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   , 
# 336 "project/nginx/src/http/ngx_http_request_body.c"
                   0, "busy buffers after request body flush"
# 336 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   )
                                                                          
# 337 "project/nginx/src/http/ngx_http_request_body.c"
                                                                         ;

                    return 
# 339 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          500
# 339 "project/nginx/src/http/ngx_http_request_body.c"
                                                        ;
                }
            ...
            if (n == 
# 363 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                    -2
# 363 "project/nginx/src/http/ngx_http_request_body.c"
                             ) {
                break;
            }
...
# 368 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               if ((
# 368 "project/nginx/src/http/ngx_http_request_body.c"
               c->log
# 368 "project/nginx/src/http/ngx_http_request_body.c" 3 4
...
# 368 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               , 
# 368 "project/nginx/src/http/ngx_http_request_body.c"
               0, "client prematurely closed connection"
# 368 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               )
                                                                     
# 369 "project/nginx/src/http/ngx_http_request_body.c"
                                                                    ;
            }

            if (n == 0 || n == 
# 372 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                              -1
# 372 "project/nginx/src/http/ngx_http_request_body.c"
                                       ) {
                c->error = 1;
                return 
# 374 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      400
# 374 "project/nginx/src/http/ngx_http_request_body.c"
                                          ;
            }
            ...
            out.buf = rb->buf;
            out.next = 
# 384 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      ((void *)0)
# 384 "project/nginx/src/http/ngx_http_request_body.c"
                          ;

            rc = ngx_http_request_body_filter(r, &out);

            if (rc != 
# 388 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     0
# 388 "project/nginx/src/http/ngx_http_request_body.c"
                           ) {
                return rc;
            }
        ...
        if (flush) {
            rc = ngx_http_request_body_filter(r, 
# 405 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                ((void *)0)
# 405 "project/nginx/src/http/ngx_http_request_body.c"
                                                    );

            if (rc != 
# 407 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     0
# 407 "project/nginx/src/http/ngx_http_request_body.c"
                           ) {
                return rc;
            }
        }
        ...
        if (!c->read->ready || rb->rest == 0) {
            ...
            clcf = 
# 418 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  (
# 418 "project/nginx/src/http/ngx_http_request_body.c"
                  r
# 418 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  )->loc_conf[
# 418 "project/nginx/src/http/ngx_http_request_body.c"
...
# 419 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           ngx_event_add_timer
# 419 "project/nginx/src/http/ngx_http_request_body.c"
                        (c->read, clcf->client_body_timeout);

            if (ngx_handle_read_event(c->read, 0) != 
# 421 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                    0
# 421 "project/nginx/src/http/ngx_http_request_body.c"
                                                          ) {
                return 
# 422 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      500
# 422 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ;
            }

            return 
# 425 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  -2
# 425 "project/nginx/src/http/ngx_http_request_body.c"
                           ;
        }
    }

    if (ngx_http_copy_pipelined_header(r, rb->buf) != 
# 429 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                     0
# 429 "project/nginx/src/http/ngx_http_request_body.c"
                                                           ) {
        return 
# 430 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              500
# 430 "project/nginx/src/http/ngx_http_request_body.c"
                                            ;
    }

    if (c->read->timer_set) {
        
# 434 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       ngx_event_del_timer
# 434 "project/nginx/src/http/ngx_http_request_body.c"
                    (c->read);
    }
    ...
    return 
# 442 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 442 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
...
ngx_http_copy_pipelined_header(ngx_http_request_t *r, ngx_buf_t *buf)
{
    ...
    if (buf == b || n == 0) {
        return 
# 459 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 459 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
    ...
    if (n > (size_t) (b->end - b->last)) {
        ...
        if (hc->free) {
            ...
            cscf = 
# 486 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  (
# 486 "project/nginx/src/http/ngx_http_request_body.c"
                  r
# 486 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  )->srv_conf[
# 486 "project/nginx/src/http/ngx_http_request_body.c"
...
# 486 "project/nginx/src/http/ngx_http_request_body.c"
            ...
            if (b == 
# 490 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                    ((void *)0)
# 490 "project/nginx/src/http/ngx_http_request_body.c"
                        ) {
                return 
# 491 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      -1
# 491 "project/nginx/src/http/ngx_http_request_body.c"
                               ;
            }

            cl = ngx_alloc_chain_link(r->connection->pool);
            if (cl == 
# 495 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     ((void *)0)
# 495 "project/nginx/src/http/ngx_http_request_body.c"
                         ) {
                return 
# 496 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      -1
# 496 "project/nginx/src/http/ngx_http_request_body.c"
                               ;
            }
...
# 513 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           if ((
# 513 "project/nginx/src/http/ngx_http_request_body.c"
           r->connection->log
# 513 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 513 "project/nginx/src/http/ngx_http_request_body.c"
...
# 513 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           , 
# 513 "project/nginx/src/http/ngx_http_request_body.c"
           0, "too large pipelined header after reading body"
# 513 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           )
                                                                          
# 514 "project/nginx/src/http/ngx_http_request_body.c"
                                                                         ;
            return 
# 515 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  -1
# 515 "project/nginx/src/http/ngx_http_request_body.c"
                           ;
        }
    }

    
# 519 "project/nginx/src/http/ngx_http_request_body.c" 3 4
   (void) __builtin___memcpy_chk (
# 519 "project/nginx/src/http/ngx_http_request_body.c"
   b->last
# 519 "project/nginx/src/http/ngx_http_request_body.c" 3 4
   , 
# 519 "project/nginx/src/http/ngx_http_request_body.c"
...
# 519 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    return 
# 524 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 524 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
...
ngx_http_write_request_body(ngx_http_request_t *r)
{
    ...
    if (rb->temp_file == 
# 542 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                        ((void *)0)
# 542 "project/nginx/src/http/ngx_http_request_body.c"
                            ) {
        tf = ngx_pcalloc(r->pool, sizeof(ngx_temp_file_t));
        if (tf == 
# 544 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 ((void *)0)
# 544 "project/nginx/src/http/ngx_http_request_body.c"
                     ) {
            return 
# 545 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  -1
# 545 "project/nginx/src/http/ngx_http_request_body.c"
                           ;
        }

        clcf = 
# 548 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              (
# 548 "project/nginx/src/http/ngx_http_request_body.c"
              r
# 548 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              )->loc_conf[
# 548 "project/nginx/src/http/ngx_http_request_body.c"
...
# 548 "project/nginx/src/http/ngx_http_request_body.c"
        ...
        tf->file.fd = 
# 550 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     -1
# 550 "project/nginx/src/http/ngx_http_request_body.c"
                                     ;
        ...
        if (rb->bufs == 
# 565 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                       ((void *)0)
# 565 "project/nginx/src/http/ngx_http_request_body.c"
                           ) {
            ...
            if (ngx_create_temp_file(&tf->file, tf->path, tf->pool,
                ...
                != 
# 570 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  0
# 570 "project/nginx/src/http/ngx_http_request_body.c"
                        )
            {
                return 
# 572 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      -1
# 572 "project/nginx/src/http/ngx_http_request_body.c"
                               ;
            }

            return 
# 575 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  0
# 575 "project/nginx/src/http/ngx_http_request_body.c"
                        ;
        }
    }

    if (rb->bufs == 
# 579 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   ((void *)0)
# 579 "project/nginx/src/http/ngx_http_request_body.c"
                       ) {
        return 
# 580 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 580 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
    ...
    if (n == 
# 587 "project/nginx/src/http/ngx_http_request_body.c" 3 4
            -1
# 587 "project/nginx/src/http/ngx_http_request_body.c"
                     ) {
        return 
# 588 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              -1
# 588 "project/nginx/src/http/ngx_http_request_body.c"
                       ;
    }
...
# 601 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       (
# 601 "project/nginx/src/http/ngx_http_request_body.c"
       ln
# 601 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       )->next = (
# 601 "project/nginx/src/http/ngx_http_request_body.c"
...
# 601 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    rb->bufs = 
# 604 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              ((void *)0)
# 604 "project/nginx/src/http/ngx_http_request_body.c"
                  ;

    return 
# 606 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 606 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
...
ngx_http_discard_request_body(ngx_http_request_t *r)
{
    ...
    if (r != r->main || r->discard_body || r->request_body) {
        return 
# 618 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 618 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
# 628 "project/nginx/src/http/ngx_http_request_body.c"
    if (ngx_http_test_expect(r) != 
# 628 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                  0
# 628 "project/nginx/src/http/ngx_http_request_body.c"
                                        ) {
        return 
# 629 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              500
# 629 "project/nginx/src/http/ngx_http_request_body.c"
                                            ;
    }
...
# 637 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       ngx_event_del_timer
# 637 "project/nginx/src/http/ngx_http_request_body.c"
                    (rev);
    }

    if (r->headers_in.content_length_n <= 0 && !r->headers_in.chunked) {
        return 
# 641 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 641 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
    ...
    if (size || r->headers_in.chunked) {
        ...
        if (rc != 
# 649 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 0
# 649 "project/nginx/src/http/ngx_http_request_body.c"
                       ) {
            return rc;
        }
        ...
        if (r->headers_in.content_length_n == 0) {
            return 
# 654 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  0
# 654 "project/nginx/src/http/ngx_http_request_body.c"
                        ;
        }
    }
    ...
    if (rc == 
# 660 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             0
# 660 "project/nginx/src/http/ngx_http_request_body.c"
                   ) {
        r->lingering_close = 0;
        return 
# 662 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 662 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }

    if (rc >= 
# 665 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             300
# 665 "project/nginx/src/http/ngx_http_request_body.c"
                                      ) {
        return rc;
    }
...
# 673 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                        0
# 673 "project/nginx/src/http/ngx_http_request_body.c"
                                              ) {
        return 
# 674 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              500
# 674 "project/nginx/src/http/ngx_http_request_body.c"
                                            ;
    }
    ...
    return 
# 680 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 680 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
...
ngx_http_discarded_request_body_handler(ngx_http_request_t *r)
{
    ...
    if (rev->timedout) {
        ...
        c->error = 1;
        ngx_http_finalize_request(r, 
# 699 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                    -1
# 699 "project/nginx/src/http/ngx_http_request_body.c"
                                             );
        return;
    }

    if (r->lingering_time) {
        timer = (ngx_msec_t) r->lingering_time - (ngx_msec_t) 
# 704 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                             ngx_cached_time->sec
# 704 "project/nginx/src/http/ngx_http_request_body.c"
                                                                       ;
        ...
        if ((ngx_msec_int_t) timer <= 0) {
            ...
            r->lingering_close = 0;
            ngx_http_finalize_request(r, 
# 709 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                        -1
# 709 "project/nginx/src/http/ngx_http_request_body.c"
                                                 );
            return;
        }
    ...
    if (rc == 
# 719 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             0
# 719 "project/nginx/src/http/ngx_http_request_body.c"
                   ) {
        r->discard_body = 0;
        r->lingering_close = 0;
        r->lingering_time = 0;
        ngx_http_finalize_request(r, 
# 723 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                    -4
# 723 "project/nginx/src/http/ngx_http_request_body.c"
                                            );
        return;
    }

    if (rc >= 
# 727 "project/nginx/src/http/ngx_http_request_body.c" 3 4
             300
# 727 "project/nginx/src/http/ngx_http_request_body.c"
                                      ) {
        c->error = 1;
        ngx_http_finalize_request(r, 
# 729 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                    -1
# 729 "project/nginx/src/http/ngx_http_request_body.c"
                                             );
        return;
    }
    ...
    if (ngx_handle_read_event(rev, 0) != 
# 735 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                        0
# 735 "project/nginx/src/http/ngx_http_request_body.c"
                                              ) {
        c->error = 1;
        ngx_http_finalize_request(r, 
# 737 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                    -1
# 737 "project/nginx/src/http/ngx_http_request_body.c"
                                             );
        return;
    }
    ...
    if (timer) {
        ...
        clcf = 
# 743 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              (
# 743 "project/nginx/src/http/ngx_http_request_body.c"
              r
# 743 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              )->loc_conf[
# 743 "project/nginx/src/http/ngx_http_request_body.c"
...
# 751 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       ngx_event_add_timer
# 751 "project/nginx/src/http/ngx_http_request_body.c"
                    (rev, timer);
    }
}
...
ngx_http_read_discarded_request_body(ngx_http_request_t *r)
{
    ...
    ngx_buf_t b;
    u_char buffer[
# 763 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     4096
# 763 "project/nginx/src/http/ngx_http_request_body.c"
                                                 ];
...
# 768 "project/nginx/src/http/ngx_http_request_body.c" 3 4
   (void) __builtin___memset_chk (
# 768 "project/nginx/src/http/ngx_http_request_body.c"
   &b
# 768 "project/nginx/src/http/ngx_http_request_body.c" 3 4
   , 0, 
# 768 "project/nginx/src/http/ngx_http_request_body.c"
...
# 768 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    for ( ;; ) {
        ...
        if (!r->connection->read->ready) {
            return 
# 778 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  -2
# 778 "project/nginx/src/http/ngx_http_request_body.c"
                           ;
        }

        size = (size_t) 
# 781 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                       ((
# 781 "project/nginx/src/http/ngx_http_request_body.c"
...
# 782 "project/nginx/src/http/ngx_http_request_body.c"
                                                            ;

        n = r->connection->recv(r->connection, buffer, size);

        if (n == 
# 786 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                -1
# 786 "project/nginx/src/http/ngx_http_request_body.c"
                         ) {
            r->connection->error = 1;
            return 
# 788 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  0
# 788 "project/nginx/src/http/ngx_http_request_body.c"
                        ;
        }

        if (n == 
# 791 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                -2
# 791 "project/nginx/src/http/ngx_http_request_body.c"
                         ) {
            return 
# 792 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  -2
# 792 "project/nginx/src/http/ngx_http_request_body.c"
                           ;
        }

        if (n == 0) {
            return 
# 796 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  0
# 796 "project/nginx/src/http/ngx_http_request_body.c"
                        ;
        }
        ...
        if (rc != 
# 804 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 0
# 804 "project/nginx/src/http/ngx_http_request_body.c"
                       ) {
            return rc;
        }
    }

    if (ngx_http_copy_pipelined_header(r, &b) != 
# 809 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                0
# 809 "project/nginx/src/http/ngx_http_request_body.c"
                                                      ) {
        return 
# 810 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              500
# 810 "project/nginx/src/http/ngx_http_request_body.c"
                                            ;
    }
    ...
    return 
# 815 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 815 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
...
ngx_http_discard_request_body_filter(ngx_http_request_t *r, ngx_buf_t *b)
{
    ...
    if (r->headers_in.chunked) {
        ...
        if (rb == 
# 831 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 ((void *)0)
# 831 "project/nginx/src/http/ngx_http_request_body.c"
                     ) {

            rb = ngx_pcalloc(r->pool, sizeof(ngx_http_request_body_t));
            if (rb == 
# 834 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     ((void *)0)
# 834 "project/nginx/src/http/ngx_http_request_body.c"
                         ) {
                return 
# 835 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      500
# 835 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ;
            }

            rb->chunked = ngx_pcalloc(r->pool, sizeof(ngx_http_chunked_t));
            if (rb->chunked == 
# 839 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                              ((void *)0)
# 839 "project/nginx/src/http/ngx_http_request_body.c"
                                  ) {
                return 
# 840 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      500
# 840 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ;
            }
        ...
        for ( ;; ) {
            ...
            if (rc == 
# 850 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     0
# 850 "project/nginx/src/http/ngx_http_request_body.c"
                           ) {
            ...
            if (rc == 
# 868 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     -4
# 868 "project/nginx/src/http/ngx_http_request_body.c"
                             ) {
            ...
            if (rc == 
# 876 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     -2
# 876 "project/nginx/src/http/ngx_http_request_body.c"
                              ) {



                cscf = 
# 880 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      (
# 880 "project/nginx/src/http/ngx_http_request_body.c"
                      r
# 880 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      )->srv_conf[
# 880 "project/nginx/src/http/ngx_http_request_body.c"
...
# 880 "project/nginx/src/http/ngx_http_request_body.c"
                ...
                r->headers_in.content_length_n = 
# 882 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                ((
# 882 "project/nginx/src/http/ngx_http_request_body.c"
                                                rb->chunked->length 
# 882 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                < 
# 882 "project/nginx/src/http/ngx_http_request_body.c"
...
# 883 "project/nginx/src/http/ngx_http_request_body.c"
                                                                             ;
                break;
            }
...
# 889 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           if ((
# 889 "project/nginx/src/http/ngx_http_request_body.c"
           r->connection->log
# 889 "project/nginx/src/http/ngx_http_request_body.c" 3 4
...
# 889 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           , 
# 889 "project/nginx/src/http/ngx_http_request_body.c"
           0, "client sent invalid chunked body"
# 889 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           )
                                                             
# 890 "project/nginx/src/http/ngx_http_request_body.c"
                                                            ;

            return 
# 892 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  400
# 892 "project/nginx/src/http/ngx_http_request_body.c"
                                      ;
        }
    ...
    return 
# 908 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 908 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
...
ngx_http_test_expect(ngx_http_request_t *r)
{
    ...
    if (r->expect_tested
        || r->headers_in.expect == 
# 919 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                  ((void *)0)
        
# 920 "project/nginx/src/http/ngx_http_request_body.c"
       || r->http_version < 
# 920 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                            1001



       
# 924 "project/nginx/src/http/ngx_http_request_body.c"
      )
    {
        return 
# 926 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 926 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
    ...
    {
        return 
# 938 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 938 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
    ...
    n = r->connection->send(r->connection,
                            (u_char *) "HTTP/1.1 100 Continue" 
# 945 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                              "\r\n" "\r\n"
# 945 "project/nginx/src/http/ngx_http_request_body.c"
                                                                       ,
                            sizeof("HTTP/1.1 100 Continue" 
# 946 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                          "\r\n" "\r\n"
# 946 "project/nginx/src/http/ngx_http_request_body.c"
                                                                   ) - 1);

    if (n == sizeof("HTTP/1.1 100 Continue" 
# 948 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                           "\r\n" "\r\n"
# 948 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ) - 1) {
        return 
# 949 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 949 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
    ...
    return 
# 956 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          -1
# 956 "project/nginx/src/http/ngx_http_request_body.c"
                   ;
}
...
ngx_http_request_body_length_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    out = 
# 983 "project/nginx/src/http/ngx_http_request_body.c" 3 4
         ((void *)0)
# 983 "project/nginx/src/http/ngx_http_request_body.c"
             ;
    ll = &out;
    ...
    if (rb->rest == -1) {
        ...
        if (rb->rest == 0) {
            ...
            if (tl == 
# 995 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     ((void *)0)
# 995 "project/nginx/src/http/ngx_http_request_body.c"
                         ) {
                return 
# 996 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      500
# 996 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ;
            }
...
# 1001 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           (void) __builtin___memset_chk (
# 1001 "project/nginx/src/http/ngx_http_request_body.c"
           b
# 1001 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           , 0, 
# 1001 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1001 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    for (cl = in; cl; cl = cl->next) {
        ...
        tl = ngx_chain_get_free_buf(r->pool, &rb->free);
        if (tl == 
# 1017 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 ((void *)0)
# 1017 "project/nginx/src/http/ngx_http_request_body.c"
                     ) {
            return 
# 1018 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  500
# 1018 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
        }
...
# 1023 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       (void) __builtin___memset_chk (
# 1023 "project/nginx/src/http/ngx_http_request_body.c"
       b
# 1023 "project/nginx/src/http/ngx_http_request_body.c" 3 4
       , 0, 
# 1023 "project/nginx/src/http/ngx_http_request_body.c"
...
ngx_http_request_body_chunked_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    out = 
# 1072 "project/nginx/src/http/ngx_http_request_body.c" 3 4
         ((void *)0)
# 1072 "project/nginx/src/http/ngx_http_request_body.c"
             ;
    ll = &out;
    ...
    if (rb->rest == -1) {
        ...
        rb->chunked = ngx_pcalloc(r->pool, sizeof(ngx_http_chunked_t));
        if (rb->chunked == 
# 1081 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          ((void *)0)
# 1081 "project/nginx/src/http/ngx_http_request_body.c"
                              ) {
            return 
# 1082 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  500
# 1082 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
        }

        cscf = 
# 1085 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              (
# 1085 "project/nginx/src/http/ngx_http_request_body.c"
              r
# 1085 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              )->srv_conf[
# 1085 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1085 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    for (cl = in; cl; cl = cl->next) {
        ...
        b = 
# 1093 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           ((void *)0)
# 1093 "project/nginx/src/http/ngx_http_request_body.c"
               ;
        ...
        for ( ;; ) {
            ...
            if (rc == 
# 1108 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     0
# 1108 "project/nginx/src/http/ngx_http_request_body.c"
                           ) {



                clcf = 
# 1112 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      (
# 1112 "project/nginx/src/http/ngx_http_request_body.c"
                      r
# 1112 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      )->loc_conf[
# 1112 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1118 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   if ((
# 1118 "project/nginx/src/http/ngx_http_request_body.c"
                   r->connection->log
# 1118 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 1118 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1118 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   , 
# 1118 "project/nginx/src/http/ngx_http_request_body.c"
                   0, "client intended to send too large chunked " "body: %O+%O bytes", r->headers_in.content_length_n, rb->chunked->size
# 1118 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                   )
...
# 1122 "project/nginx/src/http/ngx_http_request_body.c"
                                                   ;

                    r->lingering_close = 1;

                    return 
# 1126 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          413
# 1126 "project/nginx/src/http/ngx_http_request_body.c"
                                                           ;
                }
...
# 1143 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                       (void) __builtin___memmove_chk (
# 1143 "project/nginx/src/http/ngx_http_request_body.c"
                       b->last
# 1143 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                       , 
# 1143 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1143 "project/nginx/src/http/ngx_http_request_body.c"
                ...
                tl = ngx_chain_get_free_buf(r->pool, &rb->free);
                if (tl == 
# 1153 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                         ((void *)0)
# 1153 "project/nginx/src/http/ngx_http_request_body.c"
                             ) {
                    return 
# 1154 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          500
# 1154 "project/nginx/src/http/ngx_http_request_body.c"
                                                        ;
                }
...
# 1159 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               (void) __builtin___memset_chk (
# 1159 "project/nginx/src/http/ngx_http_request_body.c"
               b
# 1159 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               , 0, 
# 1159 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1159 "project/nginx/src/http/ngx_http_request_body.c"
            ...
            if (rc == 
# 1190 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     -4
# 1190 "project/nginx/src/http/ngx_http_request_body.c"
                             ) {
                ...
                tl = ngx_chain_get_free_buf(r->pool, &rb->free);
                if (tl == 
# 1197 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                         ((void *)0)
# 1197 "project/nginx/src/http/ngx_http_request_body.c"
                             ) {
                    return 
# 1198 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          500
# 1198 "project/nginx/src/http/ngx_http_request_body.c"
                                                        ;
                }
...
# 1203 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               (void) __builtin___memset_chk (
# 1203 "project/nginx/src/http/ngx_http_request_body.c"
               b
# 1203 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               , 0, 
# 1203 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1203 "project/nginx/src/http/ngx_http_request_body.c"
            ...
            if (rc == 
# 1213 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     -2
# 1213 "project/nginx/src/http/ngx_http_request_body.c"
                              ) {



                cscf = 
# 1217 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      (
# 1217 "project/nginx/src/http/ngx_http_request_body.c"
                      r
# 1217 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      )->srv_conf[
# 1217 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1217 "project/nginx/src/http/ngx_http_request_body.c"
                ...
                rb->rest = 
# 1219 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          ((
# 1219 "project/nginx/src/http/ngx_http_request_body.c"
                          rb->chunked->length 
# 1219 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                          < 
# 1219 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1220 "project/nginx/src/http/ngx_http_request_body.c"
                                                                             ;
...
# 1227 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           if ((
# 1227 "project/nginx/src/http/ngx_http_request_body.c"
           r->connection->log
# 1227 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1227 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1228 "project/nginx/src/http/ngx_http_request_body.c"
                                                            ;

            return 
# 1230 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  400
# 1230 "project/nginx/src/http/ngx_http_request_body.c"
                                      ;
        }
    }
...
# 1267 "project/nginx/src/http/ngx_http_request_body.c"
        ll = &cl->next;
    }
...
# 1284 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               if ((
# 1284 "project/nginx/src/http/ngx_http_request_body.c"
               r->connection->log
# 1284 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 1284 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1284 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               , 
# 1284 "project/nginx/src/http/ngx_http_request_body.c"
               0, "duplicate last buf in save filter"
# 1284 "project/nginx/src/http/ngx_http_request_body.c" 3 4
               )
                                                                  
# 1285 "project/nginx/src/http/ngx_http_request_body.c"
                                                                 ;
                *ll = 
# 1286 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     ((void *)0)
# 1286 "project/nginx/src/http/ngx_http_request_body.c"
                         ;
                return 
# 1287 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      500
# 1287 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ;
            }
        ...
        if (tl == 
# 1294 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 ((void *)0)
# 1294 "project/nginx/src/http/ngx_http_request_body.c"
                     ) {
            *ll = 
# 1295 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                 ((void *)0)
# 1295 "project/nginx/src/http/ngx_http_request_body.c"
                     ;
            return 
# 1296 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  500
# 1296 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
        }
    ...
    *ll = 
# 1304 "project/nginx/src/http/ngx_http_request_body.c" 3 4
         ((void *)0)
# 1304 "project/nginx/src/http/ngx_http_request_body.c"
             ;

    if (r->request_body_no_buffering) {
        return 
# 1307 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 1307 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
...
# 1313 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                                0
# 1313 "project/nginx/src/http/ngx_http_request_body.c"
                                                      )
        {
            return 
# 1315 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  500
# 1315 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
        }

        return 
# 1318 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 1318 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }

    if (!rb->last_saved) {
        return 
# 1322 "project/nginx/src/http/ngx_http_request_body.c" 3 4
              0
# 1322 "project/nginx/src/http/ngx_http_request_body.c"
                    ;
    }
...
# 1328 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           if ((
# 1328 "project/nginx/src/http/ngx_http_request_body.c"
           r->connection->log
# 1328 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 1328 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1328 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           , 
# 1328 "project/nginx/src/http/ngx_http_request_body.c"
           0, "body already in file"
# 1328 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           )
                                                 
# 1329 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
            return 
# 1330 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  500
# 1330 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
        }

        if (ngx_http_write_request_body(r) != 
# 1333 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                                             0
# 1333 "project/nginx/src/http/ngx_http_request_body.c"
                                                   ) {
            return 
# 1334 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                  500
# 1334 "project/nginx/src/http/ngx_http_request_body.c"
                                                ;
        }
        ...
        if (rb->temp_file->file.offset != 0) {
            ...
            if (cl == 
# 1340 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                     ((void *)0)
# 1340 "project/nginx/src/http/ngx_http_request_body.c"
                         ) {
                return 
# 1341 "project/nginx/src/http/ngx_http_request_body.c" 3 4
                      500
# 1341 "project/nginx/src/http/ngx_http_request_body.c"
                                                    ;
            }
...
# 1346 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           (void) __builtin___memset_chk (
# 1346 "project/nginx/src/http/ngx_http_request_body.c"
           b
# 1346 "project/nginx/src/http/ngx_http_request_body.c" 3 4
           , 0, 
# 1346 "project/nginx/src/http/ngx_http_request_body.c"
...
# 1346 "project/nginx/src/http/ngx_http_request_body.c"
    ...
    return 
# 1356 "project/nginx/src/http/ngx_http_request_body.c" 3 4
          0
# 1356 "project/nginx/src/http/ngx_http_request_body.c"
                ;
}
