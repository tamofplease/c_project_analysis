# 0 "project/nginx/src/http/ngx_http_special_response.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/ngx_http_special_response.c"
...
# 9 "project/nginx/src/http/ngx_http_special_response.c" 2
...
# 10 "project/nginx/src/http/ngx_http_special_response.c" 2
...
# 11 "project/nginx/src/http/ngx_http_special_response.c" 2




# 14 "project/nginx/src/http/ngx_http_special_response.c"
...
"<hr><center>" 
# 22 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              "nginx/" "1.21.5" 
# 22 "project/nginx/src/http/ngx_http_special_response.c"
                        "</center>" 
# 22 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                    "\r\n"

# 23 "project/nginx/src/http/ngx_http_special_response.c"
"</body>" 
# 23 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         "\r\n"

# 24 "project/nginx/src/http/ngx_http_special_response.c"
"</html>" 
# 24 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         "\r\n"

# 25 "project/nginx/src/http/ngx_http_special_response.c"
;


static u_char ngx_http_error_build_tail[] =
"<hr><center>" 
# 29 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              "nginx/" "1.21.5" 
# 29 "project/nginx/src/http/ngx_http_special_response.c"
                              "</center>" 
# 29 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                          "\r\n"

# 30 "project/nginx/src/http/ngx_http_special_response.c"
"</body>" 
# 30 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         "\r\n"

# 31 "project/nginx/src/http/ngx_http_special_response.c"
"</html>" 
# 31 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         "\r\n"

# 32 "project/nginx/src/http/ngx_http_special_response.c"
;


static u_char ngx_http_error_tail[] =
"<hr><center>nginx</center>" 
# 36 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                            "\r\n"

# 37 "project/nginx/src/http/ngx_http_special_response.c"
"</body>" 
# 37 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         "\r\n"

# 38 "project/nginx/src/http/ngx_http_special_response.c"
"</html>" 
# 38 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         "\r\n"

# 39 "project/nginx/src/http/ngx_http_special_response.c"
;


static u_char ngx_http_msie_padding[] =
"<!-- a padding to disable MSIE and Chrome friendly error page -->" 
# 43 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                   "\r\n"

# 44 "project/nginx/src/http/ngx_http_special_response.c"
"<!-- a padding to disable MSIE and Chrome friendly error page -->" 
# 44 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                   "\r\n"

# 45 "project/nginx/src/http/ngx_http_special_response.c"
"<!-- a padding to disable MSIE and Chrome friendly error page -->" 
# 45 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                   "\r\n"

# 46 "project/nginx/src/http/ngx_http_special_response.c"
"<!-- a padding to disable MSIE and Chrome friendly error page -->" 
# 46 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                   "\r\n"

# 47 "project/nginx/src/http/ngx_http_special_response.c"
"<!-- a padding to disable MSIE and Chrome friendly error page -->" 
# 47 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                   "\r\n"

# 48 "project/nginx/src/http/ngx_http_special_response.c"
"<!-- a padding to disable MSIE and Chrome friendly error page -->" 
# 48 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                   "\r\n"

# 49 "project/nginx/src/http/ngx_http_special_response.c"
;
...
"\"></head><body></body></html>" 
# 57 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                "\r\n"
# 57 "project/nginx/src/http/ngx_http_special_response.c"
                                    ;


static char ngx_http_error_301_page[] =
"<html>" 
# 61 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 62 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>301 Moved Permanently</title></head>" 
# 62 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                   "\r\n"

# 63 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 63 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 64 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>301 Moved Permanently</h1></center>" 
# 64 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                 "\r\n"

# 65 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_302_page[] =
"<html>" 
# 69 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 70 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>302 Found</title></head>" 
# 70 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                       "\r\n"

# 71 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 71 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 72 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>302 Found</h1></center>" 
# 72 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                     "\r\n"

# 73 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_303_page[] =
"<html>" 
# 77 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 78 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>303 See Other</title></head>" 
# 78 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 79 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 79 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 80 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>303 See Other</h1></center>" 
# 80 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                         "\r\n"

# 81 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_307_page[] =
"<html>" 
# 85 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 86 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>307 Temporary Redirect</title></head>" 
# 86 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                    "\r\n"

# 87 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 87 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 88 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>307 Temporary Redirect</h1></center>" 
# 88 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                  "\r\n"

# 89 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_308_page[] =
"<html>" 
# 93 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 94 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>308 Permanent Redirect</title></head>" 
# 94 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                    "\r\n"

# 95 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 95 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 96 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>308 Permanent Redirect</h1></center>" 
# 96 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                  "\r\n"

# 97 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_400_page[] =
"<html>" 
# 101 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 102 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>400 Bad Request</title></head>" 
# 102 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                             "\r\n"

# 103 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 103 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 104 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>400 Bad Request</h1></center>" 
# 104 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 105 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_401_page[] =
"<html>" 
# 109 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 110 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>401 Authorization Required</title></head>" 
# 110 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                        "\r\n"

# 111 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 111 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 112 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>401 Authorization Required</h1></center>" 
# 112 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                      "\r\n"

# 113 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_402_page[] =
"<html>" 
# 117 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 118 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>402 Payment Required</title></head>" 
# 118 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                  "\r\n"

# 119 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 119 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 120 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>402 Payment Required</h1></center>" 
# 120 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                "\r\n"

# 121 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_403_page[] =
"<html>" 
# 125 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 126 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>403 Forbidden</title></head>" 
# 126 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 127 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 127 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 128 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>403 Forbidden</h1></center>" 
# 128 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                         "\r\n"

# 129 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_404_page[] =
"<html>" 
# 133 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 134 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>404 Not Found</title></head>" 
# 134 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 135 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 135 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 136 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>404 Not Found</h1></center>" 
# 136 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                         "\r\n"

# 137 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_405_page[] =
"<html>" 
# 141 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 142 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>405 Not Allowed</title></head>" 
# 142 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                             "\r\n"

# 143 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 143 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 144 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>405 Not Allowed</h1></center>" 
# 144 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 145 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_406_page[] =
"<html>" 
# 149 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 150 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>406 Not Acceptable</title></head>" 
# 150 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                "\r\n"

# 151 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 151 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 152 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>406 Not Acceptable</h1></center>" 
# 152 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                              "\r\n"

# 153 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_408_page[] =
"<html>" 
# 157 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 158 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>408 Request Time-out</title></head>" 
# 158 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                  "\r\n"

# 159 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 159 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 160 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>408 Request Time-out</h1></center>" 
# 160 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                "\r\n"

# 161 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_409_page[] =
"<html>" 
# 165 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 166 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>409 Conflict</title></head>" 
# 166 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                          "\r\n"

# 167 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 167 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 168 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>409 Conflict</h1></center>" 
# 168 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                        "\r\n"

# 169 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_410_page[] =
"<html>" 
# 173 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 174 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>410 Gone</title></head>" 
# 174 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                      "\r\n"

# 175 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 175 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 176 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>410 Gone</h1></center>" 
# 176 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                    "\r\n"

# 177 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_411_page[] =
"<html>" 
# 181 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 182 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>411 Length Required</title></head>" 
# 182 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                 "\r\n"

# 183 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 183 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 184 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>411 Length Required</h1></center>" 
# 184 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                               "\r\n"

# 185 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_412_page[] =
"<html>" 
# 189 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 190 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>412 Precondition Failed</title></head>" 
# 190 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                     "\r\n"

# 191 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 191 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 192 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>412 Precondition Failed</h1></center>" 
# 192 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                   "\r\n"

# 193 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_413_page[] =
"<html>" 
# 197 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 198 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>413 Request Entity Too Large</title></head>" 
# 198 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                          "\r\n"

# 199 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 199 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 200 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>413 Request Entity Too Large</h1></center>" 
# 200 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                        "\r\n"

# 201 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_414_page[] =
"<html>" 
# 205 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 206 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>414 Request-URI Too Large</title></head>" 
# 206 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                       "\r\n"

# 207 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 207 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 208 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>414 Request-URI Too Large</h1></center>" 
# 208 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                     "\r\n"

# 209 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_415_page[] =
"<html>" 
# 213 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 214 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>415 Unsupported Media Type</title></head>" 
# 214 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                        "\r\n"

# 215 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 215 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 216 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>415 Unsupported Media Type</h1></center>" 
# 216 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                      "\r\n"

# 217 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_416_page[] =
"<html>" 
# 221 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 222 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>416 Requested Range Not Satisfiable</title></head>" 
# 222 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                 "\r\n"

# 223 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 223 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 224 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>416 Requested Range Not Satisfiable</h1></center>" 
# 224 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                               "\r\n"

# 225 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_421_page[] =
"<html>" 
# 229 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 230 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>421 Misdirected Request</title></head>" 
# 230 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                     "\r\n"

# 231 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 231 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 232 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>421 Misdirected Request</h1></center>" 
# 232 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                   "\r\n"

# 233 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_429_page[] =
"<html>" 
# 237 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 238 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>429 Too Many Requests</title></head>" 
# 238 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                   "\r\n"

# 239 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 239 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 240 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>429 Too Many Requests</h1></center>" 
# 240 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                 "\r\n"

# 241 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_494_page[] =
"<html>" 
# 245 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 246 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>400 Request Header Or Cookie Too Large</title></head>"

# 247 "project/nginx/src/http/ngx_http_special_response.c" 3 4
"\r\n"

# 248 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 248 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 249 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>400 Bad Request</h1></center>" 
# 249 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 250 "project/nginx/src/http/ngx_http_special_response.c"
"<center>Request Header Or Cookie Too Large</center>" 
# 250 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                     "\r\n"

# 251 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_495_page[] =
"<html>" 
# 255 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 256 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>400 The SSL certificate error</title></head>"

# 257 "project/nginx/src/http/ngx_http_special_response.c" 3 4
"\r\n"

# 258 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 258 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 259 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>400 Bad Request</h1></center>" 
# 259 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 260 "project/nginx/src/http/ngx_http_special_response.c"
"<center>The SSL certificate error</center>" 
# 260 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                            "\r\n"

# 261 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_496_page[] =
"<html>" 
# 265 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 266 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>400 No required SSL certificate was sent</title></head>"

# 267 "project/nginx/src/http/ngx_http_special_response.c" 3 4
"\r\n"

# 268 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 268 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 269 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>400 Bad Request</h1></center>" 
# 269 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 270 "project/nginx/src/http/ngx_http_special_response.c"
"<center>No required SSL certificate was sent</center>" 
# 270 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                       "\r\n"

# 271 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_497_page[] =
"<html>" 
# 275 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 276 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>400 The plain HTTP request was sent to HTTPS port</title></head>"

# 277 "project/nginx/src/http/ngx_http_special_response.c" 3 4
"\r\n"

# 278 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 278 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 279 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>400 Bad Request</h1></center>" 
# 279 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 280 "project/nginx/src/http/ngx_http_special_response.c"
"<center>The plain HTTP request was sent to HTTPS port</center>" 
# 280 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                "\r\n"

# 281 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_500_page[] =
"<html>" 
# 285 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 286 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>500 Internal Server Error</title></head>" 
# 286 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                       "\r\n"

# 287 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 287 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 288 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>500 Internal Server Error</h1></center>" 
# 288 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                     "\r\n"

# 289 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_501_page[] =
"<html>" 
# 293 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 294 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>501 Not Implemented</title></head>" 
# 294 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                 "\r\n"

# 295 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 295 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 296 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>501 Not Implemented</h1></center>" 
# 296 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                               "\r\n"

# 297 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_502_page[] =
"<html>" 
# 301 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 302 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>502 Bad Gateway</title></head>" 
# 302 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                             "\r\n"

# 303 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 303 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 304 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>502 Bad Gateway</h1></center>" 
# 304 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           "\r\n"

# 305 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_503_page[] =
"<html>" 
# 309 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 310 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>503 Service Temporarily Unavailable</title></head>" 
# 310 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                                 "\r\n"

# 311 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 311 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 312 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>503 Service Temporarily Unavailable</h1></center>" 
# 312 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                               "\r\n"

# 313 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_504_page[] =
"<html>" 
# 317 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 318 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>504 Gateway Time-out</title></head>" 
# 318 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                  "\r\n"

# 319 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 319 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 320 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>504 Gateway Time-out</h1></center>" 
# 320 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                "\r\n"

# 321 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_505_page[] =
"<html>" 
# 325 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 326 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>505 HTTP Version Not Supported</title></head>" 
# 326 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                            "\r\n"

# 327 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 327 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 328 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>505 HTTP Version Not Supported</h1></center>" 
# 328 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                          "\r\n"

# 329 "project/nginx/src/http/ngx_http_special_response.c"
;


static char ngx_http_error_507_page[] =
"<html>" 
# 333 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 334 "project/nginx/src/http/ngx_http_special_response.c"
"<head><title>507 Insufficient Storage</title></head>" 
# 334 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                      "\r\n"

# 335 "project/nginx/src/http/ngx_http_special_response.c"
"<body>" 
# 335 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        "\r\n"

# 336 "project/nginx/src/http/ngx_http_special_response.c"
"<center><h1>507 Insufficient Storage</h1></center>" 
# 336 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                    "\r\n"

# 337 "project/nginx/src/http/ngx_http_special_response.c"
;
...
# 342 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 342 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
...
# 348 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 348 "project/nginx/src/http/ngx_http_special_response.c"
...
# 349 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 349 "project/nginx/src/http/ngx_http_special_response.c"
...
# 350 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 350 "project/nginx/src/http/ngx_http_special_response.c"
...
# 351 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 351 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 352 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 352 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 353 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 353 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 354 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 354 "project/nginx/src/http/ngx_http_special_response.c"
...
# 355 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 355 "project/nginx/src/http/ngx_http_special_response.c"
...
# 360 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 360 "project/nginx/src/http/ngx_http_special_response.c"
...
# 361 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 361 "project/nginx/src/http/ngx_http_special_response.c"
...
# 362 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 362 "project/nginx/src/http/ngx_http_special_response.c"
...
# 363 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 363 "project/nginx/src/http/ngx_http_special_response.c"
...
# 364 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 364 "project/nginx/src/http/ngx_http_special_response.c"
...
# 365 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 365 "project/nginx/src/http/ngx_http_special_response.c"
...
# 366 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 366 "project/nginx/src/http/ngx_http_special_response.c"
...
# 367 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 367 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 368 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 368 "project/nginx/src/http/ngx_http_special_response.c"
...
# 369 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 369 "project/nginx/src/http/ngx_http_special_response.c"
...
# 370 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 370 "project/nginx/src/http/ngx_http_special_response.c"
...
# 371 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 371 "project/nginx/src/http/ngx_http_special_response.c"
...
# 372 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 372 "project/nginx/src/http/ngx_http_special_response.c"
...
# 373 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 373 "project/nginx/src/http/ngx_http_special_response.c"
...
# 374 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 374 "project/nginx/src/http/ngx_http_special_response.c"
...
# 375 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 375 "project/nginx/src/http/ngx_http_special_response.c"
...
# 376 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 376 "project/nginx/src/http/ngx_http_special_response.c"
...
# 377 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 377 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 378 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 378 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 379 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 379 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 380 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 380 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 381 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 381 "project/nginx/src/http/ngx_http_special_response.c"
...
# 382 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 382 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 383 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 383 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 384 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 384 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 385 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 385 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 386 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 386 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 387 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 387 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 388 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 388 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 389 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 389 "project/nginx/src/http/ngx_http_special_response.c"
...
# 394 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 394 "project/nginx/src/http/ngx_http_special_response.c"
...
# 395 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 395 "project/nginx/src/http/ngx_http_special_response.c"
...
# 396 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 396 "project/nginx/src/http/ngx_http_special_response.c"
...
# 397 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 397 "project/nginx/src/http/ngx_http_special_response.c"
...
# 398 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 398 "project/nginx/src/http/ngx_http_special_response.c"
   ngx_http_error_404_page
# 398 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ) - 1, (u_char *) 
# 398 "project/nginx/src/http/ngx_http_special_response.c"
...
# 399 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 399 "project/nginx/src/http/ngx_http_special_response.c"
                  ,

    
# 401 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 401 "project/nginx/src/http/ngx_http_special_response.c"
...
# 402 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 402 "project/nginx/src/http/ngx_http_special_response.c"
...
# 403 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 403 "project/nginx/src/http/ngx_http_special_response.c"
...
# 404 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 404 "project/nginx/src/http/ngx_http_special_response.c"
...
# 405 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 405 "project/nginx/src/http/ngx_http_special_response.c"
...
# 406 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 406 "project/nginx/src/http/ngx_http_special_response.c"
...
# 407 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { 0, ((void *)0) }
# 407 "project/nginx/src/http/ngx_http_special_response.c"
                  ,
    
# 408 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   { sizeof(
# 408 "project/nginx/src/http/ngx_http_special_response.c"
...
# 412 "project/nginx/src/http/ngx_http_special_response.c"
};
...
ngx_http_special_response_handler(ngx_http_request_t *r, ngx_int_t error)
{
    ...
    if (r->keepalive) {
        switch (error) {
            case 
# 430 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                400
# 430 "project/nginx/src/http/ngx_http_special_response.c"
                                    :
            case 
# 431 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                413
# 431 "project/nginx/src/http/ngx_http_special_response.c"
                                                 :
            case 
# 432 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                414
# 432 "project/nginx/src/http/ngx_http_special_response.c"
                                              :
            case 
# 433 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                497
# 433 "project/nginx/src/http/ngx_http_special_response.c"
                                 :
            case 
# 434 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                495
# 434 "project/nginx/src/http/ngx_http_special_response.c"
                                    :
            case 
# 435 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                496
# 435 "project/nginx/src/http/ngx_http_special_response.c"
                                 :
            case 
# 436 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                500
# 436 "project/nginx/src/http/ngx_http_special_response.c"
                                              :
            case 
# 437 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                501
# 437 "project/nginx/src/http/ngx_http_special_response.c"
                                        :
                r->keepalive = 0;
        }
    }
    ...
    if (r->lingering_close) {
        switch (error) {
            case 
# 444 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                400
# 444 "project/nginx/src/http/ngx_http_special_response.c"
                                    :
            case 
# 445 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                497
# 445 "project/nginx/src/http/ngx_http_special_response.c"
                                 :
            case 
# 446 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                495
# 446 "project/nginx/src/http/ngx_http_special_response.c"
                                    :
            case 
# 447 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                496
# 447 "project/nginx/src/http/ngx_http_special_response.c"
                                 :
                r->lingering_close = 0;
        }
    }
    ...
    clcf = 
# 454 "project/nginx/src/http/ngx_http_special_response.c" 3 4
          (
# 454 "project/nginx/src/http/ngx_http_special_response.c"
          r
# 454 "project/nginx/src/http/ngx_http_special_response.c" 3 4
          )->loc_conf[
# 454 "project/nginx/src/http/ngx_http_special_response.c"
...
# 454 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    if (ngx_http_discard_request_body(r) != 
# 473 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           0
# 473 "project/nginx/src/http/ngx_http_special_response.c"
                                                 ) {
        r->keepalive = 0;
    }
    ...
    if (clcf->msie_refresh
        && r->headers_in.msie
        && (error == 
# 479 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                    301
            
# 480 "project/nginx/src/http/ngx_http_special_response.c"
           || error == 
# 480 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       302
# 480 "project/nginx/src/http/ngx_http_special_response.c"
                                                 ))
    {
    ...
    if (error == 
# 485 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                201
# 485 "project/nginx/src/http/ngx_http_special_response.c"
                                ) {

        err = 0;

    } else if (error == 
# 489 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       204
# 489 "project/nginx/src/http/ngx_http_special_response.c"
                                          ) {

        err = 0;

    } else if (error >= 
# 493 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       301
               
# 494 "project/nginx/src/http/ngx_http_special_response.c"
              && error < 309)
    {

        err = error - 
# 497 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                     301 
# 497 "project/nginx/src/http/ngx_http_special_response.c"
                                                + (202 - 201);

    } else if (error >= 
# 499 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       400
               
# 500 "project/nginx/src/http/ngx_http_special_response.c"
              && error < 430)
    {

        err = error - 
# 503 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                     400 
# 503 "project/nginx/src/http/ngx_http_special_response.c"
                                          + (309 - 301 + (202 - 201));

    } else if (error >= 
# 505 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       494
               
# 506 "project/nginx/src/http/ngx_http_special_response.c"
              && error < 508)
    {

        err = error - 
# 509 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                     494 
# 509 "project/nginx/src/http/ngx_http_special_response.c"
                                          + (430 - 400 + (309 - 301 + (202 - 201)));
        switch (error) {
            case 
# 511 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                497
# 511 "project/nginx/src/http/ngx_http_special_response.c"
                                 :
            case 
# 512 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                495
# 512 "project/nginx/src/http/ngx_http_special_response.c"
                                    :
            case 
# 513 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                496
# 513 "project/nginx/src/http/ngx_http_special_response.c"
                                 :
            case 
# 514 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                494
# 514 "project/nginx/src/http/ngx_http_special_response.c"
                                                 :
                r->err_status = 
# 515 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                               400
# 515 "project/nginx/src/http/ngx_http_special_response.c"
                                                   ;
        }
    ...
    ngx_int_t error)
{
    ...
    ctx = 
# 536 "project/nginx/src/http/ngx_http_special_response.c" 3 4
         ((void *)0)
# 536 "project/nginx/src/http/ngx_http_special_response.c"
             ;
...
# 543 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   (void) __builtin___memset_chk (
# 543 "project/nginx/src/http/ngx_http_special_response.c"
   r->ctx
# 543 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   , 0, 
# 543 "project/nginx/src/http/ngx_http_special_response.c"
...
# 543 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    case 
# 557 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        0
# 557 "project/nginx/src/http/ngx_http_special_response.c"
              :
    case 
# 558 "project/nginx/src/http/ngx_http_special_response.c" 3 4
        -4
# 558 "project/nginx/src/http/ngx_http_special_response.c"
                :
        return 
# 559 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              -1
# 559 "project/nginx/src/http/ngx_http_special_response.c"
                       ;
...
# 570 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   (void) __builtin___memset_chk (
# 570 "project/nginx/src/http/ngx_http_special_response.c"
...
# 572 "project/nginx/src/http/ngx_http_special_response.c"
                                                              ;

    r->headers_out.headers.part.nelts = 0;
    r->headers_out.headers.part.next = 
# 575 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                      ((void *)0)
# 575 "project/nginx/src/http/ngx_http_special_response.c"
                                          ;
    r->headers_out.headers.last = &r->headers_out.headers.part;

    r->headers_out.trailers.part.nelts = 0;
    r->headers_out.trailers.part.next = 
# 579 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                       ((void *)0)
# 579 "project/nginx/src/http/ngx_http_special_response.c"
                                           ;
...
# 597 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                 200
# 597 "project/nginx/src/http/ngx_http_special_response.c"
                                            ) {
        r->expect_tested = 1;
    }
    ...
    if (ngx_http_complex_value(r, &err_page->value, &uri) != 
# 605 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                            0
# 605 "project/nginx/src/http/ngx_http_special_response.c"
                                                                  ) {
        return 
# 606 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              -1
# 606 "project/nginx/src/http/ngx_http_special_response.c"
                       ;
    }
    ...
    if (uri.len && uri.data[0] == '/') {
        ...
        if (r->method != 
# 618 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                        0x00000004
# 618 "project/nginx/src/http/ngx_http_special_response.c"
                                     ) {
            r->method = 
# 619 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       0x00000002
# 619 "project/nginx/src/http/ngx_http_special_response.c"
                                   ;
    ...
    if (ngx_http_discard_request_body(r) != 
# 632 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                           0
# 632 "project/nginx/src/http/ngx_http_special_response.c"
                                                 ) {
        r->keepalive = 0;
    }
    ...
    if (location == 
# 638 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                   ((void *)0)
# 638 "project/nginx/src/http/ngx_http_special_response.c"
                       ) {
        return 
# 639 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              -1
# 639 "project/nginx/src/http/ngx_http_special_response.c"
                       ;
    }

    if (overwrite != 
# 642 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                    301
        
# 643 "project/nginx/src/http/ngx_http_special_response.c"
       && overwrite != 
# 643 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       302
        
# 644 "project/nginx/src/http/ngx_http_special_response.c"
       && overwrite != 
# 644 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       303
        
# 645 "project/nginx/src/http/ngx_http_special_response.c"
       && overwrite != 
# 645 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       307
        
# 646 "project/nginx/src/http/ngx_http_special_response.c"
       && overwrite != 
# 646 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       308
# 646 "project/nginx/src/http/ngx_http_special_response.c"
                                                  )
    {
        r->err_status = 
# 648 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                       302
# 648 "project/nginx/src/http/ngx_http_special_response.c"
                                                 ;
    }

    location->hash = 1;
    
# 652 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   (
# 652 "project/nginx/src/http/ngx_http_special_response.c"
   &location->key
# 652 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   )->len = sizeof(
# 652 "project/nginx/src/http/ngx_http_special_response.c"
...
# 655 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   if (
# 655 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 655 "project/nginx/src/http/ngx_http_special_response.c" 3 4
...
# 655 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    clcf = 
# 659 "project/nginx/src/http/ngx_http_special_response.c" 3 4
          (
# 659 "project/nginx/src/http/ngx_http_special_response.c"
          r
# 659 "project/nginx/src/http/ngx_http_special_response.c" 3 4
          )->loc_conf[
# 659 "project/nginx/src/http/ngx_http_special_response.c"
...
# 659 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    return ngx_http_send_special_response(r, clcf, r->err_status
                                                   - 
# 666 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                    301
                                                   
# 667 "project/nginx/src/http/ngx_http_special_response.c"
                                                  + (202 - 201));
}
...
# 682 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                              1
# 682 "project/nginx/src/http/ngx_http_special_response.c"
                                                       ) {
        len = sizeof(ngx_http_error_full_tail) - 1;
        tail = ngx_http_error_full_tail;

    } else if (clcf->server_tokens == 
# 686 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                     2
# 686 "project/nginx/src/http/ngx_http_special_response.c"
                                                                 ) {
    ...
    if (ngx_http_error_pages[err].len) {
        ...
        if (clcf->msie_padding
            ...
            && r->http_version >= 
# 701 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                 1000
            
# 702 "project/nginx/src/http/ngx_http_special_response.c"
           && err >= (309 - 301 + (202 - 201)))
        {
...
# 710 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       (
# 710 "project/nginx/src/http/ngx_http_special_response.c"
...
# 711 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                             ((void *)0)
# 711 "project/nginx/src/http/ngx_http_special_response.c"
                                                 ;
...
# 719 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                       ((void *)0)
# 719 "project/nginx/src/http/ngx_http_special_response.c"
                                           ;
    }

    r
# 722 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->allow_ranges = 0; if (
# 722 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 722 "project/nginx/src/http/ngx_http_special_response.c" 3 4
...
# 722 "project/nginx/src/http/ngx_http_special_response.c"
                                  ;
    r
# 723 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->headers_out.last_modified_time = -1; if (
# 723 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 723 "project/nginx/src/http/ngx_http_special_response.c" 3 4
...
# 724 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   if (
# 724 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 724 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->headers_out.etag) { 
# 724 "project/nginx/src/http/ngx_http_special_response.c"
...
# 724 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    if (rc == 
# 728 "project/nginx/src/http/ngx_http_special_response.c" 3 4
             -1 
# 728 "project/nginx/src/http/ngx_http_special_response.c"
                       || r->header_only) {
        return rc;
    }
...
# 733 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                       1
# 733 "project/nginx/src/http/ngx_http_special_response.c"
                                                    );
    }

    b = 
# 736 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       ngx_pcalloc(
# 736 "project/nginx/src/http/ngx_http_special_response.c"
       r->pool
# 736 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       , sizeof(ngx_buf_t))
# 736 "project/nginx/src/http/ngx_http_special_response.c"
                              ;
    if (b == 
# 737 "project/nginx/src/http/ngx_http_special_response.c" 3 4
            ((void *)0)
# 737 "project/nginx/src/http/ngx_http_special_response.c"
                ) {
        return 
# 738 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              -1
# 738 "project/nginx/src/http/ngx_http_special_response.c"
                       ;
    }
    ...
    b = 
# 748 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       ngx_pcalloc(
# 748 "project/nginx/src/http/ngx_http_special_response.c"
       r->pool
# 748 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       , sizeof(ngx_buf_t))
# 748 "project/nginx/src/http/ngx_http_special_response.c"
                              ;
    if (b == 
# 749 "project/nginx/src/http/ngx_http_special_response.c" 3 4
            ((void *)0)
# 749 "project/nginx/src/http/ngx_http_special_response.c"
                ) {
        return 
# 750 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              -1
# 750 "project/nginx/src/http/ngx_http_special_response.c"
                       ;
    }
    ...
    out[1].buf = b;
    out[1].next = 
# 759 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                 ((void *)0)
# 759 "project/nginx/src/http/ngx_http_special_response.c"
                     ;

    if (msie_padding) {
        b = 
# 762 "project/nginx/src/http/ngx_http_special_response.c" 3 4
           ngx_pcalloc(
# 762 "project/nginx/src/http/ngx_http_special_response.c"
           r->pool
# 762 "project/nginx/src/http/ngx_http_special_response.c" 3 4
           , sizeof(ngx_buf_t))
# 762 "project/nginx/src/http/ngx_http_special_response.c"
                                  ;
        if (b == 
# 763 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                ((void *)0)
# 763 "project/nginx/src/http/ngx_http_special_response.c"
                    ) {
            return 
# 764 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                  -1
# 764 "project/nginx/src/http/ngx_http_special_response.c"
                           ;
        }
        ...
        out[2].buf = b;
        out[2].next = 
# 773 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                     ((void *)0)
# 773 "project/nginx/src/http/ngx_http_special_response.c"
                         ;
    }
...
# 799 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                               ((void *)0)
# 799 "project/nginx/src/http/ngx_http_special_response.c"
                                   , location, len, 
# 799 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                    4
# 799 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    r->err_status = 
# 805 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                   200
# 805 "project/nginx/src/http/ngx_http_special_response.c"
                              ;

    r->headers_out.content_type_len = sizeof("text/html") - 1;
    
# 808 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   (
# 808 "project/nginx/src/http/ngx_http_special_response.c"
   &r->headers_out.content_type
# 808 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   )->len = sizeof(
# 808 "project/nginx/src/http/ngx_http_special_response.c"
...
# 808 "project/nginx/src/http/ngx_http_special_response.c"
   "text/html";
    r->headers_out.content_type_lowcase = 
# 809 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                         ((void *)0)
# 809 "project/nginx/src/http/ngx_http_special_response.c"
                                             ;

    r->headers_out.location->hash = 0;
    r->headers_out.location = 
# 812 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                             ((void *)0)
# 812 "project/nginx/src/http/ngx_http_special_response.c"
                                 ;
    ...
    if (r->headers_out.content_length) {
        r->headers_out.content_length->hash = 0;
        r->headers_out.content_length = 
# 818 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                       ((void *)0)
# 818 "project/nginx/src/http/ngx_http_special_response.c"
                                           ;
    }

    r
# 821 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->allow_ranges = 0; if (
# 821 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 821 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->headers_out.accept_ranges) { 
# 821 "project/nginx/src/http/ngx_http_special_response.c"
...
# 821 "project/nginx/src/http/ngx_http_special_response.c"
                                  ;
    r
# 822 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->headers_out.last_modified_time = -1; if (
# 822 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 822 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->headers_out.last_modified) { 
# 822 "project/nginx/src/http/ngx_http_special_response.c"
...
# 823 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   if (
# 823 "project/nginx/src/http/ngx_http_special_response.c"
   r
# 823 "project/nginx/src/http/ngx_http_special_response.c" 3 4
   ->headers_out.etag) { 
# 823 "project/nginx/src/http/ngx_http_special_response.c"
...
# 823 "project/nginx/src/http/ngx_http_special_response.c"
    ...
    if (rc == 
# 827 "project/nginx/src/http/ngx_http_special_response.c" 3 4
             -1 
# 827 "project/nginx/src/http/ngx_http_special_response.c"
                       || r->header_only) {
        return rc;
    }
    ...
    if (b == 
# 832 "project/nginx/src/http/ngx_http_special_response.c" 3 4
            ((void *)0)
# 832 "project/nginx/src/http/ngx_http_special_response.c"
                ) {
        return 
# 833 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              -1
# 833 "project/nginx/src/http/ngx_http_special_response.c"
                       ;
    }

    p = 
# 836 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 836 "project/nginx/src/http/ngx_http_special_response.c"
       b->pos
# 836 "project/nginx/src/http/ngx_http_special_response.c" 3 4
       , 
# 836 "project/nginx/src/http/ngx_http_special_response.c"
...
# 837 "project/nginx/src/http/ngx_http_special_response.c"
                                                         ;

    if (escape == 0) {
        p = 
# 840 "project/nginx/src/http/ngx_http_special_response.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 840 "project/nginx/src/http/ngx_http_special_response.c"
           p
# 840 "project/nginx/src/http/ngx_http_special_response.c" 3 4
           , 
# 840 "project/nginx/src/http/ngx_http_special_response.c"
...
# 840 "project/nginx/src/http/ngx_http_special_response.c"
        ...
        p = (u_char *) ngx_escape_uri(p, location, len, 
# 843 "project/nginx/src/http/ngx_http_special_response.c" 3 4
                                                       4
# 843 "project/nginx/src/http/ngx_http_special_response.c"
                                                                         );
    }

    b->last = 
# 846 "project/nginx/src/http/ngx_http_special_response.c" 3 4
             (((u_char *) __builtin___memcpy_chk (
# 846 "project/nginx/src/http/ngx_http_special_response.c"
             p
# 846 "project/nginx/src/http/ngx_http_special_response.c" 3 4
             , 
# 846 "project/nginx/src/http/ngx_http_special_response.c"
...
# 847 "project/nginx/src/http/ngx_http_special_response.c"
                                                               ;
    ...
    out.buf = b;
    out.next = 
# 853 "project/nginx/src/http/ngx_http_special_response.c" 3 4
              ((void *)0)
# 853 "project/nginx/src/http/ngx_http_special_response.c"
                  ;
