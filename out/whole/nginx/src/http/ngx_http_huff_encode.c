# 0 "project/nginx/src/http/ngx_http_huff_encode.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 10 "project/nginx/src/http/ngx_http_huff_encode.c" 2
...
# 11 "project/nginx/src/http/ngx_http_huff_encode.c" 2
...
# 12 "project/nginx/src/http/ngx_http_huff_encode.c" 2



# 14 "project/nginx/src/http/ngx_http_huff_encode.c"
typedef struct {
    uint32_t code;
    uint32_t len;
...
#define ngx_http_huff_encode_buf(dst,buf) (*(uint64_t *) (dst) = __builtin_bswap64(buf))
# 191 "project/nginx/src/http/ngx_http_huff_encode.c"
size_t
ngx_http_huff_encode(u_char *src, size_t len, u_char *dst, ngx_uint_t lower)
{
    ...
    while (src != end) {
        ...
        (*(uint64_t *) (&dst[hlen]) = __builtin_bswap64(buf));
    ...
    pending = 
# 240 "project/nginx/src/http/ngx_http_huff_encode.c" 3 4
             (((
# 240 "project/nginx/src/http/ngx_http_huff_encode.c"
             pending
# 240 "project/nginx/src/http/ngx_http_huff_encode.c" 3 4
             ) + (
# 240 "project/nginx/src/http/ngx_http_huff_encode.c"
