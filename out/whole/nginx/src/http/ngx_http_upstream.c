# 0 "project/nginx/src/http/ngx_http_upstream.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/http/ngx_http_upstream.c"
...
# 9 "project/nginx/src/http/ngx_http_upstream.c" 2
...
# 10 "project/nginx/src/http/ngx_http_upstream.c" 2
...
# 11 "project/nginx/src/http/ngx_http_upstream.c" 2




# 14 "project/nginx/src/http/ngx_http_upstream.c"
...
# 195 "project/nginx/src/http/ngx_http_upstream.c"
static ngx_http_upstream_header_t ngx_http_upstream_headers_in[] = {

    { 
# 197 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 197 "project/nginx/src/http/ngx_http_upstream.c"
     "Status"
# 197 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 197 "project/nginx/src/http/ngx_http_upstream.c"
...
# 199 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 199 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 199 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 199 "project/nginx/src/http/ngx_http_upstream.c"
...
# 199 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 202 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 202 "project/nginx/src/http/ngx_http_upstream.c"
     "Content-Type"
# 202 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 202 "project/nginx/src/http/ngx_http_upstream.c"
...
# 204 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 204 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 204 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 204 "project/nginx/src/http/ngx_http_upstream.c"
...
# 204 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 207 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 207 "project/nginx/src/http/ngx_http_upstream.c"
     "Content-Length"
# 207 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 207 "project/nginx/src/http/ngx_http_upstream.c"
...
# 207 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 211 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 211 "project/nginx/src/http/ngx_http_upstream.c"
     "Date"
# 211 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 211 "project/nginx/src/http/ngx_http_upstream.c"
...
# 213 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 213 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 213 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 213 "project/nginx/src/http/ngx_http_upstream.c"
...
# 215 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 215 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 215 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 215 "project/nginx/src/http/ngx_http_upstream.c"
...
# 215 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 217 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 217 "project/nginx/src/http/ngx_http_upstream.c"
     "Last-Modified"
# 217 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 217 "project/nginx/src/http/ngx_http_upstream.c"
...
# 217 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 221 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 221 "project/nginx/src/http/ngx_http_upstream.c"
     "ETag"
# 221 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 221 "project/nginx/src/http/ngx_http_upstream.c"
...
# 223 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 223 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 223 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 223 "project/nginx/src/http/ngx_http_upstream.c"
...
# 225 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 225 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 225 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 225 "project/nginx/src/http/ngx_http_upstream.c"
...
# 225 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 227 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 227 "project/nginx/src/http/ngx_http_upstream.c"
     "Server"
# 227 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 227 "project/nginx/src/http/ngx_http_upstream.c"
...
# 229 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 229 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 229 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 229 "project/nginx/src/http/ngx_http_upstream.c"
...
# 231 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 231 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 231 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 231 "project/nginx/src/http/ngx_http_upstream.c"
...
# 231 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 233 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 233 "project/nginx/src/http/ngx_http_upstream.c"
     "WWW-Authenticate"
# 233 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 233 "project/nginx/src/http/ngx_http_upstream.c"
...
# 235 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 235 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 235 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 235 "project/nginx/src/http/ngx_http_upstream.c"
...
# 235 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 238 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 238 "project/nginx/src/http/ngx_http_upstream.c"
     "Location"
# 238 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 238 "project/nginx/src/http/ngx_http_upstream.c"
...
# 240 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 240 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 240 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 240 "project/nginx/src/http/ngx_http_upstream.c"
...
# 240 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 243 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 243 "project/nginx/src/http/ngx_http_upstream.c"
     "Refresh"
# 243 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 243 "project/nginx/src/http/ngx_http_upstream.c"
...
# 243 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 247 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 247 "project/nginx/src/http/ngx_http_upstream.c"
     "Set-Cookie"
# 247 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 247 "project/nginx/src/http/ngx_http_upstream.c"
...
# 249 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 249 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 249 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 249 "project/nginx/src/http/ngx_http_upstream.c"
...
# 249 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 252 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 252 "project/nginx/src/http/ngx_http_upstream.c"
     "Content-Disposition"
# 252 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 252 "project/nginx/src/http/ngx_http_upstream.c"
...
# 252 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 256 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 256 "project/nginx/src/http/ngx_http_upstream.c"
     "Cache-Control"
# 256 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 256 "project/nginx/src/http/ngx_http_upstream.c"
...
# 259 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 259 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 259 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 259 "project/nginx/src/http/ngx_http_upstream.c"
...
# 259 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 261 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 261 "project/nginx/src/http/ngx_http_upstream.c"
     "Expires"
# 261 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 261 "project/nginx/src/http/ngx_http_upstream.c"
...
# 264 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 264 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 264 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 264 "project/nginx/src/http/ngx_http_upstream.c"
...
# 264 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 266 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 266 "project/nginx/src/http/ngx_http_upstream.c"
     "Accept-Ranges"
# 266 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 266 "project/nginx/src/http/ngx_http_upstream.c"
...
# 268 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 268 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 268 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 268 "project/nginx/src/http/ngx_http_upstream.c"
...
# 270 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 270 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 270 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 270 "project/nginx/src/http/ngx_http_upstream.c"
...
# 270 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 272 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 272 "project/nginx/src/http/ngx_http_upstream.c"
     "Content-Range"
# 272 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 272 "project/nginx/src/http/ngx_http_upstream.c"
...
# 275 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 275 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 275 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 275 "project/nginx/src/http/ngx_http_upstream.c"
...
# 275 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 277 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 277 "project/nginx/src/http/ngx_http_upstream.c"
     "Connection"
# 277 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 277 "project/nginx/src/http/ngx_http_upstream.c"
...
# 277 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 281 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 281 "project/nginx/src/http/ngx_http_upstream.c"
     "Keep-Alive"
# 281 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 281 "project/nginx/src/http/ngx_http_upstream.c"
...
# 281 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 285 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 285 "project/nginx/src/http/ngx_http_upstream.c"
     "Vary"
# 285 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 285 "project/nginx/src/http/ngx_http_upstream.c"
...
# 285 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 289 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 289 "project/nginx/src/http/ngx_http_upstream.c"
     "Link"
# 289 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 289 "project/nginx/src/http/ngx_http_upstream.c"
...
# 292 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 292 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_headers_out_t
# 292 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 292 "project/nginx/src/http/ngx_http_upstream.c"
...
# 292 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 294 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 294 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Expires"
# 294 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 294 "project/nginx/src/http/ngx_http_upstream.c"
...
# 294 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 298 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 298 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Redirect"
# 298 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 298 "project/nginx/src/http/ngx_http_upstream.c"
...
# 300 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 300 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 300 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 300 "project/nginx/src/http/ngx_http_upstream.c"
...
# 300 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 303 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 303 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Limit-Rate"
# 303 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 303 "project/nginx/src/http/ngx_http_upstream.c"
...
# 303 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 307 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 307 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Buffering"
# 307 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 307 "project/nginx/src/http/ngx_http_upstream.c"
...
# 307 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 311 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 311 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Charset"
# 311 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 311 "project/nginx/src/http/ngx_http_upstream.c"
...
# 311 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 315 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 315 "project/nginx/src/http/ngx_http_upstream.c"
     "Transfer-Encoding"
# 315 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 315 "project/nginx/src/http/ngx_http_upstream.c"
...
# 315 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 320 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 320 "project/nginx/src/http/ngx_http_upstream.c"
     "Content-Encoding"
# 320 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 320 "project/nginx/src/http/ngx_http_upstream.c"
...
# 322 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                __builtin_offsetof (
# 322 "project/nginx/src/http/ngx_http_upstream.c"
                ngx_http_upstream_headers_in_t
# 322 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                , 
# 322 "project/nginx/src/http/ngx_http_upstream.c"
...
# 322 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 326 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { 0, ((void *)0) }
# 326 "project/nginx/src/http/ngx_http_upstream.c"
                    , 
# 326 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 326 "project/nginx/src/http/ngx_http_upstream.c"
...
static ngx_command_t ngx_http_upstream_commands[] = {
    ...
    { 
# 332 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 332 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream"
# 332 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 332 "project/nginx/src/http/ngx_http_upstream.c"
...
# 333 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     0x02000000
# 333 "project/nginx/src/http/ngx_http_upstream.c"
                       |
# 333 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        0x00000100
# 333 "project/nginx/src/http/ngx_http_upstream.c"
...
# 337 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ((void *)0) 
# 337 "project/nginx/src/http/ngx_http_upstream.c"
          },

    { 
# 339 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 339 "project/nginx/src/http/ngx_http_upstream.c"
     "server"
# 339 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 339 "project/nginx/src/http/ngx_http_upstream.c"
...
# 340 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     0x10000000
# 340 "project/nginx/src/http/ngx_http_upstream.c"
                      |
# 340 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                       0x00000800
# 340 "project/nginx/src/http/ngx_http_upstream.c"
...
# 342 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, srv_conf)
# 342 "project/nginx/src/http/ngx_http_upstream.c"
                             ,
      0,
      
# 344 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ((void *)0) 
# 344 "project/nginx/src/http/ngx_http_upstream.c"
          },

      
# 346 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 347 "project/nginx/src/http/ngx_http_upstream.c"
};
...
# 352 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 352 "project/nginx/src/http/ngx_http_upstream.c"
       ,
...
# 357 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 357 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 358 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 358 "project/nginx/src/http/ngx_http_upstream.c"
       ,

    
# 360 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 360 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 361 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)

# 362 "project/nginx/src/http/ngx_http_upstream.c"
};


ngx_module_t ngx_http_upstream_module = {
    
# 366 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 366 "project/nginx/src/http/ngx_http_upstream.c"
   "8" 
# 366 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   "," 
# 366 "project/nginx/src/http/ngx_http_upstream.c"
...
# 369 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   0x50545448
# 369 "project/nginx/src/http/ngx_http_upstream.c"
                  ,
    
# 370 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 370 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 371 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 371 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 372 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 372 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 373 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 373 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 374 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 374 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 375 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 375 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 376 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((void *)0)
# 376 "project/nginx/src/http/ngx_http_upstream.c"
       ,
    
# 377 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 378 "project/nginx/src/http/ngx_http_upstream.c"
};
...
static ngx_http_variable_t ngx_http_upstream_vars[] = {
    ...
    { 
# 383 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 383 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_addr"
# 383 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 383 "project/nginx/src/http/ngx_http_upstream.c"
...
# 385 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 385 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 387 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 387 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_status"
# 387 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 387 "project/nginx/src/http/ngx_http_upstream.c"
...
# 389 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 389 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 391 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 391 "project/nginx/src/http/ngx_http_upstream.c"
...
# 393 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 393 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 395 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 395 "project/nginx/src/http/ngx_http_upstream.c"
...
# 397 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 397 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 399 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 399 "project/nginx/src/http/ngx_http_upstream.c"
...
# 401 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 401 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 403 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 403 "project/nginx/src/http/ngx_http_upstream.c"
...
# 405 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 405 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 407 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 407 "project/nginx/src/http/ngx_http_upstream.c"
...
# 409 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 409 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 411 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 411 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_bytes_sent"
# 411 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 411 "project/nginx/src/http/ngx_http_upstream.c"
...
# 413 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 413 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },



    { 
# 417 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 417 "project/nginx/src/http/ngx_http_upstream.c"
...
# 419 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 419 "project/nginx/src/http/ngx_http_upstream.c"
                             , 0 },

    { 
# 421 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 421 "project/nginx/src/http/ngx_http_upstream.c"
...
# 423 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 423 "project/nginx/src/http/ngx_http_upstream.c"
                             |
# 423 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              8
# 423 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 425 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 425 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_cache_etag"
# 425 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 425 "project/nginx/src/http/ngx_http_upstream.c"
...
# 427 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     2
# 427 "project/nginx/src/http/ngx_http_upstream.c"
                             |
# 427 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              8
# 427 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 431 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 431 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_http_"
# 431 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 431 "project/nginx/src/http/ngx_http_upstream.c"
...
# 431 "project/nginx/src/http/ngx_http_upstream.c"
      ...
      0, 
# 432 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        2
# 432 "project/nginx/src/http/ngx_http_upstream.c"
                                |
# 432 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 32
# 432 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 434 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 434 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_trailer_"
# 434 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 434 "project/nginx/src/http/ngx_http_upstream.c"
...
# 434 "project/nginx/src/http/ngx_http_upstream.c"
      ...
      0, 
# 435 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        2
# 435 "project/nginx/src/http/ngx_http_upstream.c"
                                |
# 435 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 32
# 435 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 437 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 437 "project/nginx/src/http/ngx_http_upstream.c"
     "upstream_cookie_"
# 437 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 437 "project/nginx/src/http/ngx_http_upstream.c"
...
# 437 "project/nginx/src/http/ngx_http_upstream.c"
      ...
      0, 
# 438 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        2
# 438 "project/nginx/src/http/ngx_http_upstream.c"
                                |
# 438 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 32
# 438 "project/nginx/src/http/ngx_http_upstream.c"
...
# 440 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 441 "project/nginx/src/http/ngx_http_upstream.c"
};


static ngx_http_upstream_next_t ngx_http_upstream_next_errors[] = {
    { 500, 
# 445 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000010 
# 445 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 502, 
# 446 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000020 
# 446 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 503, 
# 447 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000040 
# 447 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 504, 
# 448 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000080 
# 448 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 403, 
# 449 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000100 
# 449 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 404, 
# 450 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000200 
# 450 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 429, 
# 451 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0x00000400 
# 451 "project/nginx/src/http/ngx_http_upstream.c"
                                        },
    { 0, 0 }
};
...
ngx_conf_bitmask_t ngx_http_upstream_cache_method_mask[] = {
    { 
# 457 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 457 "project/nginx/src/http/ngx_http_upstream.c"
     "GET"
# 457 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 457 "project/nginx/src/http/ngx_http_upstream.c"
...
# 457 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 458 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 458 "project/nginx/src/http/ngx_http_upstream.c"
     "HEAD"
# 458 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 458 "project/nginx/src/http/ngx_http_upstream.c"
...
# 458 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 459 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 459 "project/nginx/src/http/ngx_http_upstream.c"
     "POST"
# 459 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 459 "project/nginx/src/http/ngx_http_upstream.c"
...
# 459 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 460 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { 0, ((void *)0) }
# 460 "project/nginx/src/http/ngx_http_upstream.c"
                    , 0 }
};
...
ngx_conf_bitmask_t ngx_http_upstream_ignore_headers_masks[] = {
    { 
# 465 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 465 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Redirect"
# 465 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 465 "project/nginx/src/http/ngx_http_upstream.c"
...
# 465 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 466 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 466 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Expires"
# 466 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 466 "project/nginx/src/http/ngx_http_upstream.c"
...
# 466 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 467 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 467 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Limit-Rate"
# 467 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 467 "project/nginx/src/http/ngx_http_upstream.c"
...
# 467 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 468 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 468 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Buffering"
# 468 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 468 "project/nginx/src/http/ngx_http_upstream.c"
...
# 468 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 469 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 469 "project/nginx/src/http/ngx_http_upstream.c"
     "X-Accel-Charset"
# 469 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 469 "project/nginx/src/http/ngx_http_upstream.c"
...
# 469 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 470 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 470 "project/nginx/src/http/ngx_http_upstream.c"
     "Expires"
# 470 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 470 "project/nginx/src/http/ngx_http_upstream.c"
...
# 470 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 471 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 471 "project/nginx/src/http/ngx_http_upstream.c"
     "Cache-Control"
# 471 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 471 "project/nginx/src/http/ngx_http_upstream.c"
...
# 471 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 472 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 472 "project/nginx/src/http/ngx_http_upstream.c"
     "Set-Cookie"
# 472 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 472 "project/nginx/src/http/ngx_http_upstream.c"
...
# 472 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 473 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { sizeof(
# 473 "project/nginx/src/http/ngx_http_upstream.c"
     "Vary"
# 473 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     ) - 1, (u_char *) 
# 473 "project/nginx/src/http/ngx_http_upstream.c"
...
# 473 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    { 
# 474 "project/nginx/src/http/ngx_http_upstream.c" 3 4
     { 0, ((void *)0) }
# 474 "project/nginx/src/http/ngx_http_upstream.c"
                    , 0 }
};
...
ngx_http_upstream_create(ngx_http_request_t *r)
{
    ...
    if (u == 
# 491 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 491 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
        return 
# 492 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 492 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    r->cache = 
# 501 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 501 "project/nginx/src/http/ngx_http_upstream.c"
                  ;
    ...
    return 
# 507 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 507 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
ngx_http_upstream_init(ngx_http_request_t *r)
{
    ...
    c = r->connection;
                                                                              ...
                                                                              ;
# 528 "project/nginx/src/http/ngx_http_upstream.c"
    if (c->read->timer_set) {
        
# 529 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 529 "project/nginx/src/http/ngx_http_upstream.c"
                    (c->read);
    }

    if (ngx_event_flags & 
# 532 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         0x00000004
# 532 "project/nginx/src/http/ngx_http_upstream.c"
                                            ) {

        if (!c->write->active) {
            if (
# 535 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ngx_event_actions.add
# 535 "project/nginx/src/http/ngx_http_upstream.c"
                            (c->write, 
# 535 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                       (-2)
# 535 "project/nginx/src/http/ngx_http_upstream.c"
...
# 535 "project/nginx/src/http/ngx_http_upstream.c"
                ...
                == 
# 536 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 536 "project/nginx/src/http/ngx_http_upstream.c"
                           )
            {
                ngx_http_finalize_request(r, 
# 538 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                            500
# 538 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          );
                return;
            }
        }
...
ngx_http_upstream_init_request(ngx_http_request_t *r)
{
    ...
    if (u->conf->cache) {
        ...
        if (rc == 
# 573 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -3
# 573 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {
        ...
        if (rc == 
# 580 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -1
# 580 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
            ngx_http_finalize_request(r, 
# 581 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        500
# 581 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      );
            return;
        }

        if (rc == 
# 585 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 0
# 585 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
            rc = ngx_http_upstream_cache_send(r, u);

            if (rc == 
# 588 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     -4
# 588 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
                return;
            }

            if (rc == 
# 592 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     40
# 592 "project/nginx/src/http/ngx_http_upstream.c"
                                                     ) {
                rc = 
# 593 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    -5
# 593 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
                r->cached = 0;
                u->buffer.start = 
# 595 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 ((void *)0)
# 595 "project/nginx/src/http/ngx_http_upstream.c"
                                     ;
                u->cache_status = 
# 596 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 1
# 596 "project/nginx/src/http/ngx_http_upstream.c"
                                                    ;
                u->request_sent = 1;
            }
        }
        ...
        if (rc != 
# 601 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -5
# 601 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
...
# 614 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if (!(
# 614 "project/nginx/src/http/ngx_http_upstream.c"
           r->connection->read
# 614 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->posted) { (
# 614 "project/nginx/src/http/ngx_http_upstream.c"
...
# 617 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                0
# 617 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      ) {
                ngx_http_finalize_request(r, 
# 618 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                            500
# 618 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          );
                return;
            }
        }
    ...
    if (u->create_request(r) != 
# 631 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0
# 631 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
        ngx_http_finalize_request(r, 
# 632 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    500
# 632 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  );
        return;
    }

    if (ngx_http_upstream_set_local(r, u, u->conf->local) != 
# 636 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                            0
# 636 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  ) {
        ngx_http_finalize_request(r, 
# 637 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    500
# 637 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  );
        return;
    }
    ...
    clcf = 
# 645 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 645 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 645 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 645 "project/nginx/src/http/ngx_http_upstream.c"
...
# 645 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (u->output.output_filter == 
# 652 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                  ((void *)0)
# 652 "project/nginx/src/http/ngx_http_upstream.c"
                                      ) {
    ...
    if (r->upstream_states == 
# 659 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 659 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {

        r->upstream_states = ngx_array_create(r->pool, 1,
                                            sizeof(ngx_http_upstream_state_t));
        if (r->upstream_states == 
# 663 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 ((void *)0)
# 663 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
            ngx_http_finalize_request(r, 
# 664 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        500
# 664 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      );
            return;
        }
        ...
        if (u->state == 
# 671 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                       ((void *)0)
# 671 "project/nginx/src/http/ngx_http_upstream.c"
                           ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 673 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 673 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }

        
# 677 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       (void) __builtin___memset_chk (
# 677 "project/nginx/src/http/ngx_http_upstream.c"
       u->state
# 677 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 0, 
# 677 "project/nginx/src/http/ngx_http_upstream.c"
...
# 677 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (cln == 
# 681 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 681 "project/nginx/src/http/ngx_http_upstream.c"
                  ) {
        ngx_http_finalize_request(r, 
# 682 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    500
# 682 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  );
        return;
    }
    ...
    if (u->resolved == 
# 690 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 690 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
        ...
        umcf = 
# 702 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (
# 702 "project/nginx/src/http/ngx_http_upstream.c"
              r
# 702 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              )->main_conf[
# 702 "project/nginx/src/http/ngx_http_upstream.c"
...
# 702 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        if (u->resolved->sockaddr) {
            ...
            if (u->resolved->port == 0
                && u->resolved->sockaddr->sa_family != 
# 722 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      1
# 722 "project/nginx/src/http/ngx_http_upstream.c"
                                                             )
            {
                
# 724 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               if ((
# 724 "project/nginx/src/http/ngx_http_upstream.c"
               r->connection->log
# 724 "project/nginx/src/http/ngx_http_upstream.c" 3 4
...
# 724 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               , 
# 724 "project/nginx/src/http/ngx_http_upstream.c"
               0, "no port in upstream \"%V\"", host
# 724 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )
                                                                 
# 725 "project/nginx/src/http/ngx_http_upstream.c"
                                                                ;
                ngx_http_upstream_finalize_request(r, u,
                                               
# 727 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 727 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                return;
            }
            ...
            if (ngx_http_upstream_create_round_robin_peer(r, u->resolved)
                != 
# 732 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 732 "project/nginx/src/http/ngx_http_upstream.c"
                        )
            {
                ngx_http_upstream_finalize_request(r, u,
                                               
# 735 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 735 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                return;
            }
...
# 745 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 745 "project/nginx/src/http/ngx_http_upstream.c"
           r->connection->log
# 745 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 745 "project/nginx/src/http/ngx_http_upstream.c"
...
# 746 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ;
            ngx_http_upstream_finalize_request(r, u,
                                               
# 748 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 748 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
        ...
        if (ctx == 
# 755 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 755 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 757 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 757 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }

        if (ctx == 
# 761 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 761 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
            
# 762 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 762 "project/nginx/src/http/ngx_http_upstream.c"
           r->connection->log
# 762 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 762 "project/nginx/src/http/ngx_http_upstream.c"
...
# 762 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , 
# 762 "project/nginx/src/http/ngx_http_upstream.c"
           0, "no resolver defined to resolve %V", host
# 762 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )
                                                                    
# 763 "project/nginx/src/http/ngx_http_upstream.c"
                                                                   ;

            ngx_http_upstream_finalize_request(r, u, 
# 765 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    502
# 765 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
            return;
        }
        ...
        if (ngx_resolve_name(ctx) != 
# 776 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0
# 776 "project/nginx/src/http/ngx_http_upstream.c"
                                          ) {
            u->resolved->ctx = 
# 777 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              ((void *)0)
# 777 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
            ngx_http_upstream_finalize_request(r, u,
                                               
# 779 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 779 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
...
found:
    ...
    if (uscf == 
# 788 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ((void *)0)
# 788 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {
        
# 789 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 789 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 789 "project/nginx/src/http/ngx_http_upstream.c" 3 4
...
# 790 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ;
        ngx_http_upstream_finalize_request(r, u,
                                           
# 792 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 792 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }
    ...
    if (uscf->peer.init(r, uscf) != 
# 802 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                   0
# 802 "project/nginx/src/http/ngx_http_upstream.c"
                                         ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 804 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 804 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }
...
ngx_http_upstream_cache(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (c == 
# 831 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 831 "project/nginx/src/http/ngx_http_upstream.c"
                ) {

        if (!(r->method & u->conf->cache_methods)) {
            return 
# 834 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -5
# 834 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
        }
        ...
        if (rc != 
# 839 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 0
# 839 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
            return rc;
        }

        if (r->method == 
# 843 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        0x00000004 
# 843 "project/nginx/src/http/ngx_http_upstream.c"
                                      && u->conf->cache_convert_head) {
            u->method = ngx_http_core_get_method;
        }

        if (ngx_http_file_cache_new(r) != 
# 847 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0
# 847 "project/nginx/src/http/ngx_http_upstream.c"
                                               ) {
            return 
# 848 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 848 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }

        if (u->create_key(r) != 
# 851 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0
# 851 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
            return 
# 852 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 852 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
...
# 860 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 860 "project/nginx/src/http/ngx_http_upstream.c"
           r->connection->log
# 860 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 860 "project/nginx/src/http/ngx_http_upstream.c"
...
# 860 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , 
# 860 "project/nginx/src/http/ngx_http_upstream.c"
           0, "%V_buffer_size %uz is not enough for cache key, " "it should be increased to at least %uz", &u->conf->module, u->conf->buffer_size, 
# 860 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           (((
# 860 "project/nginx/src/http/ngx_http_upstream.c"
           r->cache->header_start + 256
# 860 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           ) + (
# 860 "project/nginx/src/http/ngx_http_upstream.c"
           1024 
...
# 864 "project/nginx/src/http/ngx_http_upstream.c"
                                                                       ;

            r->cache = 
# 866 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 866 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
            return 
# 867 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -5
# 867 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
        }
        ...
        case 
# 880 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -1
# 880 "project/nginx/src/http/ngx_http_upstream.c"
                     :
            return 
# 881 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 881 "project/nginx/src/http/ngx_http_upstream.c"
                           ;

        case 
# 883 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -5
# 883 "project/nginx/src/http/ngx_http_upstream.c"
                        :
            u->cache_status = 
# 884 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             2
# 884 "project/nginx/src/http/ngx_http_upstream.c"
                                                  ;
            return 
# 885 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -5
# 885 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
        ...
        u->cache_status = 
# 895 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         1
# 895 "project/nginx/src/http/ngx_http_upstream.c"
                                            ;
    }
    ...
    case 
# 905 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        4
# 905 "project/nginx/src/http/ngx_http_upstream.c"
                            :

        if (((u->conf->cache_use_stale & 
# 907 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        0x00000800
# 907 "project/nginx/src/http/ngx_http_upstream.c"
                                                                     )
             || c->stale_updating) && !r->background
            && u->conf->cache_background_update)
        {
            if (ngx_http_upstream_cache_background_update(r, u) == 
# 911 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                  0
# 911 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        ) {
                r->cache->background = 1;
                u->cache_status = rc;
                rc = 
# 914 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    0
# 914 "project/nginx/src/http/ngx_http_upstream.c"
                          ;

            } else {
                rc = 
# 917 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    -1
# 917 "project/nginx/src/http/ngx_http_upstream.c"
                             ;
            }
        }
    ...
    case 
# 923 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        5
# 923 "project/nginx/src/http/ngx_http_upstream.c"
                               :

        if (((u->conf->cache_use_stale & 
# 925 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        0x00000800
# 925 "project/nginx/src/http/ngx_http_upstream.c"
                                                                     )
             || c->stale_updating) && !r->background)
        {
            u->cache_status = rc;
            rc = 
# 929 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                0
# 929 "project/nginx/src/http/ngx_http_upstream.c"
                      ;

        } else {
            rc = 
# 932 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                4
# 932 "project/nginx/src/http/ngx_http_upstream.c"
                                    ;
        }
    ...
    case 
# 937 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0
# 937 "project/nginx/src/http/ngx_http_upstream.c"
              :
        u->cache_status = 
# 938 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         7
# 938 "project/nginx/src/http/ngx_http_upstream.c"
                                           ;
    }
    ...
    case 
# 943 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0
# 943 "project/nginx/src/http/ngx_http_upstream.c"
              :

        return 
# 945 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 945 "project/nginx/src/http/ngx_http_upstream.c"
                    ;

    case 
# 947 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        4
# 947 "project/nginx/src/http/ngx_http_upstream.c"
                            :
        ...
        u->buffer.start = 
# 953 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         ((void *)0)
# 953 "project/nginx/src/http/ngx_http_upstream.c"
                             ;
        u->cache_status = 
# 954 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         3
# 954 "project/nginx/src/http/ngx_http_upstream.c"
                                               ;

        break;

    case 
# 958 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        -5
# 958 "project/nginx/src/http/ngx_http_upstream.c"
                    :

        if ((size_t) (u->buffer.end - u->buffer.start) < u->conf->buffer_size) {
            u->buffer.start = 
# 961 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 961 "project/nginx/src/http/ngx_http_upstream.c"
                                 ;
    ...
    case 
# 970 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        8
# 970 "project/nginx/src/http/ngx_http_upstream.c"
                             :
    ...
    case 
# 976 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        -2
# 976 "project/nginx/src/http/ngx_http_upstream.c"
                 :

        return 
# 978 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -3
# 978 "project/nginx/src/http/ngx_http_upstream.c"
                      ;

    case 
# 980 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        -1
# 980 "project/nginx/src/http/ngx_http_upstream.c"
                 :

        return 
# 982 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 982 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    ...
    default:
        ...
        u->cache_status = 
# 988 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         7
# 988 "project/nginx/src/http/ngx_http_upstream.c"
                                           ;

        return rc;
    }

    if (ngx_http_upstream_cache_check_range(r, u) == 
# 993 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -5
# 993 "project/nginx/src/http/ngx_http_upstream.c"
                                                                ) {
        u->cacheable = 0;
    }
    ...
    return 
# 999 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          -5
# 999 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
}
    ...
    ngx_http_file_cache_t **cache)
{
    ...
    if (u->conf->cache_zone) {
        *cache = u->conf->cache_zone->data;
        return 
# 1013 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 1013 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (ngx_http_complex_value(r, u->conf->cache_value, &val) != 
# 1016 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                0
# 1016 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      ) {
        return 
# 1017 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1017 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }

    if (val.len == 0
        || (val.len == 3 && 
# 1021 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           strncmp((const char *) 
# 1021 "project/nginx/src/http/ngx_http_upstream.c"
                           val.data
# 1021 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           , (const char *) 
# 1021 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1021 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    {
        return 
# 1023 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -5
# 1023 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
    }
    ...
    for (i = 0; i < u->caches->nelts; i++) {
        ...
        if (name->len == val.len
            && 
# 1032 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              strncmp((const char *) 
# 1032 "project/nginx/src/http/ngx_http_upstream.c"
              name->data
# 1032 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              , (const char *) 
# 1032 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1032 "project/nginx/src/http/ngx_http_upstream.c"
                                                         == 0)
        {
            *cache = caches[i];
            return 
# 1035 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 1035 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
    }

    
# 1039 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   if ((
# 1039 "project/nginx/src/http/ngx_http_upstream.c"
   r->connection->log
# 1039 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   )->log_level >= 4) ngx_log_error_core(4, 
# 1039 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1039 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 
# 1039 "project/nginx/src/http/ngx_http_upstream.c"
   0, "cache \"%V\" not found", &val
# 1039 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   )
                                                 
# 1040 "project/nginx/src/http/ngx_http_upstream.c"
                                                ;

    return 
# 1042 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          -1
# 1042 "project/nginx/src/http/ngx_http_upstream.c"
                   ;
}
...
ngx_http_upstream_cache_send(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (c->header_start == c->body_start) {
        r->http_version = 
# 1056 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         9
# 1056 "project/nginx/src/http/ngx_http_upstream.c"
                                           ;
...
# 1065 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 1065 "project/nginx/src/http/ngx_http_upstream.c"
   &u->headers_in
# 1065 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 1065 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1065 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (ngx_list_init(&u->headers_in.headers, r->pool, 8,
        ...
        != 
# 1071 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 1071 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 1073 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1073 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    if (ngx_list_init(&u->headers_in.trailers, r->pool, 2,
                      sizeof(ngx_table_elt_t))
        != 
# 1078 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 1078 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 1080 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1080 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    if (rc == 
# 1085 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             0
# 1085 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {

        if (ngx_http_upstream_process_headers(r, u) != 
# 1087 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      0
# 1087 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ) {
            return 
# 1088 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -4
# 1088 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
        }
    ...
    if (rc == 
# 1094 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -1
# 1094 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        return 
# 1095 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1095 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }

    if (rc == 
# 1098 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -2
# 1098 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        rc = 
# 1099 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            40
# 1099 "project/nginx/src/http/ngx_http_upstream.c"
                                            ;
    }
...
# 1104 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   if ((
# 1104 "project/nginx/src/http/ngx_http_upstream.c"
   r->connection->log
# 1104 "project/nginx/src/http/ngx_http_upstream.c" 3 4
...
# 1104 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 
# 1104 "project/nginx/src/http/ngx_http_upstream.c"
   0, "cache file \"%s\" contains invalid header", c->file.name.data
# 1104 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   )

                                    
# 1106 "project/nginx/src/http/ngx_http_upstream.c"
                                   ;
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (ngx_http_subrequest(r, &r->uri, &r->args, &sr, 
# 1124 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      ((void *)0)
# 1124 "project/nginx/src/http/ngx_http_upstream.c"
                                                          ,
                            
# 1125 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           8
                            
# 1126 "project/nginx/src/http/ngx_http_upstream.c"
                           |
# 1126 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            16
# 1126 "project/nginx/src/http/ngx_http_upstream.c"
                                                          )
        != 
# 1127 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 1127 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 1129 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1129 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    return 
# 1134 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 1134 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (h == 
# 1148 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
        
# 1149 "project/nginx/src/http/ngx_http_upstream.c"
       || !u->cacheable
        || u->conf->cache_max_range_offset == 
# 1150 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                             9223372036854775807LL
# 1150 "project/nginx/src/http/ngx_http_upstream.c"
                                                                )
    {
        return 
# 1152 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 1152 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (u->conf->cache_max_range_offset == 0) {
        return 
# 1156 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -5
# 1156 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
    }
    ...
    {
        return 
# 1162 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 1162 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (*p == '-') {
        return 
# 1170 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -5
# 1170 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
    }
    ...
    if (offset >= u->conf->cache_max_range_offset) {
        return 
# 1180 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -5
# 1180 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
    }

    return 
# 1183 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 1183 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
# 1206 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((ngx_http_log_ctx_t *) 
# 1206 "project/nginx/src/http/ngx_http_upstream.c"
   c->log
# 1206 "project/nginx/src/http/ngx_http_upstream.c" 3 4
...
# 1212 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 1212 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 1212 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 1212 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1212 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 
# 1212 "project/nginx/src/http/ngx_http_upstream.c"
       0, "%V could not be resolved (%i: %s)", &ctx->name, ctx->state, ngx_resolver_strerror(ctx->state)
# 1212 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )


                                                        
# 1215 "project/nginx/src/http/ngx_http_upstream.c"
                                                       ;

        ngx_http_upstream_finalize_request(r, u, 
# 1217 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                502
# 1217 "project/nginx/src/http/ngx_http_upstream.c"
                                                                    );
        goto failed;
    }
    ...
    ur->addrs = ctx->addrs;
# 1242 "project/nginx/src/http/ngx_http_upstream.c"
    if (ngx_http_upstream_create_round_robin_peer(r, ur) != 
# 1242 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                           0
# 1242 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 1244 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 1244 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        goto failed;
    }
    ...
    ur->ctx = 
# 1249 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 1249 "project/nginx/src/http/ngx_http_upstream.c"
                 ;
...
# 1282 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ((ngx_http_log_ctx_t *) 
# 1282 "project/nginx/src/http/ngx_http_upstream.c"
   c->log
# 1282 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   ->data)->current_request = 
# 1282 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    ngx_event_t *ev)
{
    ...
    if (c->error) {
        if ((ngx_event_flags & 
# 1336 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              0x00000001
# 1336 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ) && ev->active) {

            event = ev->write ? 
# 1338 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               (-2) 
# 1338 "project/nginx/src/http/ngx_http_upstream.c"
                                               : 
# 1338 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                 (-1)
# 1338 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (
# 1340 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ngx_event_actions.del
# 1340 "project/nginx/src/http/ngx_http_upstream.c"
                            (ev, event, 0) != 
# 1340 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              0
# 1340 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1342 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 1342 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                return;
            }
        }
...
# 1349 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              499
# 1349 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
        }

        return;
    }
# 1363 "project/nginx/src/http/ngx_http_upstream.c"
    if (ngx_event_flags & 
# 1363 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         0x00000008
# 1363 "project/nginx/src/http/ngx_http_upstream.c"
                                             ) {
...
# 1377 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 1377 "project/nginx/src/http/ngx_http_upstream.c"
           ev->log
# 1377 "project/nginx/src/http/ngx_http_upstream.c" 3 4
...
# 1377 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , 
# 1377 "project/nginx/src/http/ngx_http_upstream.c"
           ev->kq_errno, "kevent() reported that client prematurely closed " "connection, so upstream connection is closed too"
# 1377 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )

                                                                             
# 1379 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            ;
            ngx_http_upstream_finalize_request(r, u,
                                               
# 1381 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              499
# 1381 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }

        
# 1385 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 1385 "project/nginx/src/http/ngx_http_upstream.c"
       ev->log
# 1385 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1385 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1385 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 
# 1385 "project/nginx/src/http/ngx_http_upstream.c"
       ev->kq_errno, "kevent() reported that client prematurely closed " "connection"
# 1385 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )

                                   
# 1387 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;

        if (u->peer.connection == 
# 1389 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 ((void *)0)
# 1389 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 1391 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              499
# 1391 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
        }

        return;
    }
# 1452 "project/nginx/src/http/ngx_http_upstream.c"
    n = recv(c->fd, buf, 1, 
# 1452 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           0x2
# 1452 "project/nginx/src/http/ngx_http_upstream.c"
                                   );

    err = 
# 1454 "project/nginx/src/http/ngx_http_upstream.c" 3 4
         (*__error())
# 1454 "project/nginx/src/http/ngx_http_upstream.c"
                         ;
    ...
    if (ev->write && (n >= 0 || err == 
# 1459 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      35
# 1459 "project/nginx/src/http/ngx_http_upstream.c"
                                                )) {
        return;
    }

    if ((ngx_event_flags & 
# 1463 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          0x00000001
# 1463 "project/nginx/src/http/ngx_http_upstream.c"
                                             ) && ev->active) {

        event = ev->write ? 
# 1465 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           (-2) 
# 1465 "project/nginx/src/http/ngx_http_upstream.c"
                                           : 
# 1465 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                             (-1)
# 1465 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        if (
# 1467 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           ngx_event_actions.del
# 1467 "project/nginx/src/http/ngx_http_upstream.c"
                        (ev, event, 0) != 
# 1467 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          0
# 1467 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1469 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 1469 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
    }
    ...
    if (n == -1) {
        if (err == 
# 1479 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  35
# 1479 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
            return;
        }
...
# 1493 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 1493 "project/nginx/src/http/ngx_http_upstream.c"
       ev->log
# 1493 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1493 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1493 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 
# 1493 "project/nginx/src/http/ngx_http_upstream.c"
       err, "client prematurely closed connection, " "so upstream connection is closed too"
# 1493 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )

                                                             
# 1495 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ;
        ngx_http_upstream_finalize_request(r, u,
                                           
# 1497 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          499
# 1497 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }

    
# 1501 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   if ((
# 1501 "project/nginx/src/http/ngx_http_upstream.c"
   ev->log
# 1501 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   )->log_level >= 7) ngx_log_error_core(7, 
# 1501 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1501 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 
# 1501 "project/nginx/src/http/ngx_http_upstream.c"
   err, "client prematurely closed connection"
# 1501 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   )
                                                         
# 1502 "project/nginx/src/http/ngx_http_upstream.c"
                                                        ;

    if (u->peer.connection == 
# 1504 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 1504 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 1506 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          499
# 1506 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
    }
}
...
ngx_http_upstream_connect(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    u->state = ngx_array_push(r->upstream_states);
    if (u->state == 
# 1525 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 1525 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 1527 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 1527 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }

    
# 1531 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 1531 "project/nginx/src/http/ngx_http_upstream.c"
   u->state
# 1531 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 1531 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1531 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (rc == 
# 1544 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -1
# 1544 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 1546 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 1546 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }
    ...
    if (rc == 
# 1552 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -3
# 1552 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
        
# 1553 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 1553 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 1553 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 1553 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1554 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x40000000
# 1554 "project/nginx/src/http/ngx_http_upstream.c"
                                                               );
        return;
    }

    if (rc == 
# 1558 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -5
# 1558 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {
        ngx_http_upstream_next(r, u, 
# 1559 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000002
# 1559 "project/nginx/src/http/ngx_http_upstream.c"
                                                              );
        return;
    }
    ...
    if (c->pool == 
# 1584 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 1584 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        ...
        if (c->pool == 
# 1589 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 1589 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 1591 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 1591 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
    }
    ...
    clcf = 
# 1603 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 1603 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 1603 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 1603 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1603 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    u->writer.out = 
# 1605 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 1605 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    ...
    if (u->request_sent) {
        if (ngx_http_upstream_reinit(r, u) != 
# 1611 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                             0
# 1611 "project/nginx/src/http/ngx_http_upstream.c"
                                                   ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 1613 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 1613 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
    }
        ...
        && r == r->main)
    {
        ...
        if (u->output.free == 
# 1629 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 1629 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 1631 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 1631 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
        ...
        u->output.free->next = 
# 1636 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              ((void *)0)
# 1636 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
    ...
    if (rc == 
# 1648 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -2
# 1648 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        
# 1649 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 1649 "project/nginx/src/http/ngx_http_upstream.c"
                    (c->write, u->conf->connect_timeout);
        return;
    }
# 1662 "project/nginx/src/http/ngx_http_upstream.c"
    ngx_http_upstream_send_request(r, u, 1);
}
# 1974 "project/nginx/src/http/ngx_http_upstream.c"
static ngx_int_t
ngx_http_upstream_reinit(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (u->reinit_request(r) != 
# 1980 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0
# 1980 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
        return 
# 1981 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1981 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
...
# 1988 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 1988 "project/nginx/src/http/ngx_http_upstream.c"
   &u->headers_in
# 1988 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 1988 "project/nginx/src/http/ngx_http_upstream.c"
...
# 1988 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (ngx_list_init(&u->headers_in.headers, r->pool, 8,
                      sizeof(ngx_table_elt_t))
        != 
# 1994 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 1994 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 1996 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 1996 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    if (ngx_list_init(&u->headers_in.trailers, r->pool, 2,
                      sizeof(ngx_table_elt_t))
        != 
# 2001 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 2001 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 2003 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 2003 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
        ...
        && r != r->main && u->output.buf)
    {
        u->output.free = ngx_alloc_chain_link(r->pool);
        if (u->output.free == 
# 2027 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 2027 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
            return 
# 2028 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 2028 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }

        u->output.free->buf = u->output.buf;
        u->output.free->next = 
# 2032 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              ((void *)0)
# 2032 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
    ...
    u->output.buf = 
# 2038 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 2038 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    u->output.in = 
# 2039 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 2039 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
    u->output.busy = 
# 2040 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    ((void *)0)
# 2040 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
    ...
    return 
# 2056 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 2056 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
# 2076 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                0
# 2076 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      ) {
        ngx_http_upstream_next(r, u, 
# 2077 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000002
# 2077 "project/nginx/src/http/ngx_http_upstream.c"
                                                              );
        return;
    }
    ...
    if (rc == 
# 2085 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -1
# 2085 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        ngx_http_upstream_next(r, u, 
# 2086 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000002
# 2086 "project/nginx/src/http/ngx_http_upstream.c"
                                                              );
        return;
    }

    if (rc >= 
# 2090 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             300
# 2090 "project/nginx/src/http/ngx_http_upstream.c"
                                      ) {
    ...
    if (rc == 
# 2095 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -2
# 2095 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        if (!c->write->ready || u->request_body_blocked) {
            
# 2097 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           ngx_event_add_timer
# 2097 "project/nginx/src/http/ngx_http_upstream.c"
                        (c->write, u->conf->send_timeout);

        } else if (c->write->timer_set) {
            
# 2100 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           ngx_event_del_timer
# 2100 "project/nginx/src/http/ngx_http_upstream.c"
                        (c->write);
        }

        if (ngx_handle_write_event(c->write, u->conf->send_lowat) != 
# 2103 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                    0
# 2103 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 2105 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2105 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
...
# 2111 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               if ((
# 2111 "project/nginx/src/http/ngx_http_upstream.c"
               c->log
# 2111 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )->log_level >= 3) ngx_log_error_core(3, 
# 2111 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2112 "project/nginx/src/http/ngx_http_upstream.c"
                                                      ;
                ngx_http_upstream_finalize_request(r, u,
                                               
# 2114 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2114 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                return;
            }
...
# 2122 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if (!(
# 2122 "project/nginx/src/http/ngx_http_upstream.c"
           c->read
# 2122 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->posted) { (
# 2122 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2131 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 2131 "project/nginx/src/http/ngx_http_upstream.c"
                    (c->write);
    }
...
# 2136 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 2136 "project/nginx/src/http/ngx_http_upstream.c"
           c->log
# 2136 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 2136 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2137 "project/nginx/src/http/ngx_http_upstream.c"
                                                  ;
            ngx_http_upstream_finalize_request(r, u,
                                               
# 2139 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2139 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
    ...
    if (ngx_handle_write_event(c->write, 0) != 
# 2150 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              0
# 2150 "project/nginx/src/http/ngx_http_upstream.c"
                                                    ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 2152 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 2152 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }
...
# 2163 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 2163 "project/nginx/src/http/ngx_http_upstream.c"
                    (c->read, u->conf->read_timeout);
    ...
    ngx_http_upstream_t *u, ngx_uint_t do_write)
{
    ...
    if (!r->request_body_no_buffering) {
        ...
        if (!u->request_sent) {
            ...
            out = 
# 2194 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 2194 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
        }
        ...
        if (rc == 
# 2199 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -2
# 2199 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
    ...
    if (!u->request_sent) {
        ...
        if (r->request_body->bufs) {
            ...
            r->request_body->bufs = 
# 2216 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                   ((void *)0)
# 2216 "project/nginx/src/http/ngx_http_upstream.c"
                                       ;
        }

        c = u->peer.connection;
        clcf = 
# 2220 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (
# 2220 "project/nginx/src/http/ngx_http_upstream.c"
              r
# 2220 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              )->loc_conf[
# 2220 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2220 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        if (clcf->tcp_nodelay && ngx_tcp_nodelay(c) != 
# 2222 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      0
# 2222 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ) {
            return 
# 2223 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 2223 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
        ...
        out = 
# 2229 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 2229 "project/nginx/src/http/ngx_http_upstream.c"
                 ;
    }
    ...
    for ( ;; ) {
        ...
        if (do_write) {
            ...
            if (rc == 
# 2237 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     -1
# 2237 "project/nginx/src/http/ngx_http_upstream.c"
                              ) {
                return 
# 2238 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      -1
# 2238 "project/nginx/src/http/ngx_http_upstream.c"
                               ;
            }
...
# 2244 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               (
# 2244 "project/nginx/src/http/ngx_http_upstream.c"
               ln
# 2244 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )->next = (
# 2244 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2244 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (rc == 
# 2247 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     -2
# 2247 "project/nginx/src/http/ngx_http_upstream.c"
                              ) {
                u->request_body_blocked = 1;
            ...
            if (rc == 
# 2254 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     0 
# 2254 "project/nginx/src/http/ngx_http_upstream.c"
                            && !r->reading_body) {
                break;
            }
        }
        ...
        if (r->reading_body) {
            ...
            if (rc >= 
# 2264 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     300
# 2264 "project/nginx/src/http/ngx_http_upstream.c"
                                              ) {
                return rc;
            }
            ...
            r->request_body->bufs = 
# 2269 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                   ((void *)0)
# 2269 "project/nginx/src/http/ngx_http_upstream.c"
                                       ;
        }
        ...
        if (out == 
# 2274 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 2274 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
            rc = 
# 2275 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                -2
# 2275 "project/nginx/src/http/ngx_http_upstream.c"
                         ;
            break;
        }
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (c->write->timedout) {
        ngx_http_upstream_next(r, u, 
# 2305 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000004
# 2305 "project/nginx/src/http/ngx_http_upstream.c"
                                                                );
        return;
    }
# 2318 "project/nginx/src/http/ngx_http_upstream.c"
...
ngx_http_upstream_read_request_handler(ngx_http_request_t *r)
{
    ...
    if (c->read->timedout) {
        c->timedout = 1;
        ngx_http_upstream_finalize_request(r, u, 
# 2344 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                408
# 2344 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         );
        return;
    }
...
ngx_http_upstream_process_header(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (c->read->timedout) {
        ngx_http_upstream_next(r, u, 
# 2367 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000004
# 2367 "project/nginx/src/http/ngx_http_upstream.c"
                                                                );
        return;
    }

    if (!u->request_sent && ngx_http_upstream_test_connect(c) != 
# 2371 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                0
# 2371 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      ) {
        ngx_http_upstream_next(r, u, 
# 2372 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000002
# 2372 "project/nginx/src/http/ngx_http_upstream.c"
                                                              );
        return;
    }

    if (u->buffer.start == 
# 2376 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          ((void *)0)
# 2376 "project/nginx/src/http/ngx_http_upstream.c"
                              ) {
        u->buffer.start = ngx_palloc(r->pool, u->conf->buffer_size);
        if (u->buffer.start == 
# 2378 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              ((void *)0)
# 2378 "project/nginx/src/http/ngx_http_upstream.c"
                                  ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 2380 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2380 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
        ...
        if (ngx_list_init(&u->headers_in.headers, r->pool, 8,
                          sizeof(ngx_table_elt_t))
            != 
# 2393 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 2393 "project/nginx/src/http/ngx_http_upstream.c"
                    )
        {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 2396 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2396 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
        ...
        if (ngx_list_init(&u->headers_in.trailers, r->pool, 2,
                          sizeof(ngx_table_elt_t))
            != 
# 2402 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 2402 "project/nginx/src/http/ngx_http_upstream.c"
                    )
        {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 2405 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2405 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return;
        }
    ...
    for ( ;; ) {
        ...
        if (n == 
# 2422 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                -2
# 2422 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {




            if (ngx_handle_read_event(c->read, 0) != 
# 2427 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    0
# 2427 "project/nginx/src/http/ngx_http_upstream.c"
                                                          ) {
                ngx_http_upstream_finalize_request(r, u,
                                               
# 2429 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2429 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                return;
            }
...
# 2437 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 2437 "project/nginx/src/http/ngx_http_upstream.c"
           c->log
# 2437 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 2437 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2437 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , 
# 2437 "project/nginx/src/http/ngx_http_upstream.c"
           0, "upstream prematurely closed connection"
# 2437 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )
                                                                   
# 2438 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  ;
        }

        if (n == 
# 2441 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                -1 
# 2441 "project/nginx/src/http/ngx_http_upstream.c"
                          || n == 0) {
            ngx_http_upstream_next(r, u, 
# 2442 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        0x00000002
# 2442 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  );
            return;
        }
        ...
        if (rc == 
# 2458 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -2
# 2458 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {

            if (u->buffer.last == u->buffer.end) {
                
# 2461 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               if ((
# 2461 "project/nginx/src/http/ngx_http_upstream.c"
               c->log
# 2461 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 2461 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2461 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               , 
# 2461 "project/nginx/src/http/ngx_http_upstream.c"
               0, "upstream sent too big header"
# 2461 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )
                                                             
# 2462 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ;

                ngx_http_upstream_next(r, u,
                                       
# 2465 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      0x00000008
# 2465 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         );
                return;
            }
    ...
    if (rc == 
# 2475 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             40
# 2475 "project/nginx/src/http/ngx_http_upstream.c"
                                             ) {
        ngx_http_upstream_next(r, u, 
# 2476 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000008
# 2476 "project/nginx/src/http/ngx_http_upstream.c"
                                                                       );
        return;
    }

    if (rc == 
# 2480 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -1
# 2480 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        ngx_http_upstream_finalize_request(r, u,
                                           
# 2482 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          500
# 2482 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }
...
# 2490 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 300
# 2490 "project/nginx/src/http/ngx_http_upstream.c"
                                                          ) {

        if (ngx_http_upstream_test_next(r, u) == 
# 2492 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                0
# 2492 "project/nginx/src/http/ngx_http_upstream.c"
                                                      ) {
            return;
        }

        if (ngx_http_upstream_intercept_errors(r, u) == 
# 2496 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                       0
# 2496 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ) {
            return;
        }
    }
    ...
    if (ngx_http_upstream_process_headers(r, u) != 
# 2501 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                  0
# 2501 "project/nginx/src/http/ngx_http_upstream.c"
                                                        ) {
        return;
    }
...
ngx_http_upstream_test_next(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    for (un = ngx_http_upstream_next_errors; un->status; un++) {
        ...
        if (u->request_sent
            && (r->method & (
# 2527 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            0x00000008
# 2527 "project/nginx/src/http/ngx_http_upstream.c"
                                         |
# 2527 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          0x00001000
# 2527 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2527 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        {
            mask = un->mask | 
# 2529 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             0x00004000
# 2529 "project/nginx/src/http/ngx_http_upstream.c"
                                                                ;
            ...
            && !(timeout && ngx_current_msec - u->peer.start_time >= timeout))
        {
            ...
            return 
# 2541 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 2541 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
        ...
        if (u->cache_status == 
# 2546 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              3
            
# 2547 "project/nginx/src/http/ngx_http_upstream.c"
           && (u->conf->cache_use_stale & un->mask))
        {
            ...
            if (rc != 
# 2553 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     0
# 2553 "project/nginx/src/http/ngx_http_upstream.c"
                           ) {
                ngx_http_upstream_finalize_request(r, u, rc);
                return 
# 2555 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      0
# 2555 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
            }

            u->cache_status = 
# 2558 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             4
# 2558 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ;
            rc = ngx_http_upstream_cache_send(r, u);

            if (rc == 
# 2561 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     -4
# 2561 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
                return 
# 2562 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      0
# 2562 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
            }

            if (rc == 
# 2565 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     40
# 2565 "project/nginx/src/http/ngx_http_upstream.c"
                                                     ) {
                rc = 
# 2566 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    500
# 2566 "project/nginx/src/http/ngx_http_upstream.c"
                                                  ;
            }

            ngx_http_upstream_finalize_request(r, u, rc);
            return 
# 2570 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 2570 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
    ...
    if (status == 
# 2580 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 304
        
# 2581 "project/nginx/src/http/ngx_http_upstream.c"
       && u->cache_status == 
# 2581 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             3
        
# 2582 "project/nginx/src/http/ngx_http_upstream.c"
       && u->conf->cache_revalidate)
    {
        ...
        now = 
# 2590 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ngx_cached_time->sec
# 2590 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
        ...
        if (rc != 
# 2598 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 0
# 2598 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
            ngx_http_upstream_finalize_request(r, u, rc);
            return 
# 2600 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 2600 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

        u->cache_status = 
# 2603 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         6
# 2603 "project/nginx/src/http/ngx_http_upstream.c"
                                                   ;
        rc = ngx_http_upstream_cache_send(r, u);

        if (rc == 
# 2606 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -4
# 2606 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {
            return 
# 2607 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 2607 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

        if (rc == 
# 2610 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 40
# 2610 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ) {
            rc = 
# 2611 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                500
# 2611 "project/nginx/src/http/ngx_http_upstream.c"
                                              ;
        }
        ...
        ngx_http_upstream_finalize_request(r, u, rc);
        return 
# 2639 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 2639 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 2644 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          -5
# 2644 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
}
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (status == 
# 2660 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 404 
# 2660 "project/nginx/src/http/ngx_http_upstream.c"
                                    && u->conf->intercept_404) {
        ngx_http_upstream_finalize_request(r, u, 
# 2661 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                404
# 2661 "project/nginx/src/http/ngx_http_upstream.c"
                                                                  );
        return 
# 2662 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 2662 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (!u->conf->intercept_errors) {
        return 
# 2666 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -5
# 2666 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
    }

    clcf = 
# 2669 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 2669 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 2669 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 2669 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2669 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (clcf->error_pages == 
# 2671 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            ((void *)0)
# 2671 "project/nginx/src/http/ngx_http_upstream.c"
                                ) {
        return 
# 2672 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -5
# 2672 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
    }
    ...
    for (i = 0; i < clcf->error_pages->nelts; i++) {
        ...
        if (err_page[i].status == status) {
            ...
            if (status == 
# 2680 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         401
                
# 2681 "project/nginx/src/http/ngx_http_upstream.c"
               && u->headers_in.www_authenticate)
            {
                h = ngx_list_push(&r->headers_out.headers);

                if (h == 
# 2685 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 2685 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
                    ngx_http_upstream_finalize_request(r, u,
                                               
# 2687 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2687 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                    return 
# 2688 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          0
# 2688 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
                }
            ...
            if (r->cache) {
                ...
                if (u->cacheable) {
                    ...
                    if (valid == 0) {
                        ...
                        if (valid) {
                            r->cache->valid_sec = 
# 2709 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                 ngx_cached_time->sec 
# 2709 "project/nginx/src/http/ngx_http_upstream.c"
                                                            + valid;
                        }
                    }
            ...
            return 
# 2723 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 2723 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
    }

    return 
# 2727 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          -5
# 2727 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
}
...
ngx_http_upstream_test_connect(ngx_connection_t *c)
{
    ...
    if (ngx_event_flags & 
# 2739 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         0x00000008
# 2739 "project/nginx/src/http/ngx_http_upstream.c"
                                             ) {
        if (c->write->pending_eof || c->read->pending_eof) {
            ...
            return 
# 2751 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 2751 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
...

    {
        ...
        if (getsockopt(c->fd, 
# 2765 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             0xffff
# 2765 "project/nginx/src/http/ngx_http_upstream.c"
                                       , 
# 2765 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x1007
# 2765 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        {
            err = 
# 2768 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 (*__error())
# 2768 "project/nginx/src/http/ngx_http_upstream.c"
                                 ;
        }
        ...
        if (err) {
            ...
            return 
# 2774 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 2774 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    }

    return 
# 2778 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 2778 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
ngx_http_upstream_process_headers(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    umcf = 
# 2792 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 2792 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 2792 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->main_conf[
# 2792 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2795 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      0x00000002
# 2795 "project/nginx/src/http/ngx_http_upstream.c"
                                                                       ))
    {
        ngx_http_upstream_finalize_request(r, u, 
# 2797 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -5
# 2797 "project/nginx/src/http/ngx_http_upstream.c"
                                                            );
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 2805 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 ((void *)0)
# 2805 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
                    break;
                }
            ...
            if (hh && hh->redirect) {
                if (hh->copy_handler(r, &h[i], hh->conf) != 
# 2818 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                           0
# 2818 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 ) {
                    ngx_http_finalize_request(r,
                                              
# 2820 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                             500
# 2820 "project/nginx/src/http/ngx_http_upstream.c"
                                                                           );
                    return 
# 2821 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          -4
# 2821 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
                }
            }
        }
...
# 2832 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           (
# 2832 "project/nginx/src/http/ngx_http_upstream.c"
           &args
# 2832 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->len = 0; (
# 2832 "project/nginx/src/http/ngx_http_upstream.c"
...
# 2832 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
            flags = 
# 2833 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   1
# 2833 "project/nginx/src/http/ngx_http_upstream.c"
                                      ;

            if (ngx_http_parse_unsafe_uri(r, &uri, &args, &flags) != 
# 2835 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                    0
# 2835 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          ) {
                ngx_http_finalize_request(r, 
# 2836 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                            404
# 2836 "project/nginx/src/http/ngx_http_upstream.c"
                                                              );
                return 
# 2837 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      -4
# 2837 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
            }

            if (r->method != 
# 2840 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            0x00000004
# 2840 "project/nginx/src/http/ngx_http_upstream.c"
                                         ) {
                r->method = 
# 2841 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           0x00000002
# 2841 "project/nginx/src/http/ngx_http_upstream.c"
                                       ;
        ...
        ngx_http_finalize_request(r, 
# 2848 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    -4
# 2848 "project/nginx/src/http/ngx_http_upstream.c"
                                            );
        return 
# 2849 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -4
# 2849 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
    }
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 2858 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 2858 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
                break;
            }
        ...
        if (hh) {
            if (hh->copy_handler(r, &h[i], hh->conf) != 
# 2877 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                       0
# 2877 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ) {
                ngx_http_upstream_finalize_request(r, u,
                                               
# 2879 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2879 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
                return 
# 2880 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      -4
# 2880 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
            }
        ...
        if (ngx_http_upstream_copy_header_line(r, &h[i], 0) != 
# 2886 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                              0
# 2886 "project/nginx/src/http/ngx_http_upstream.c"
                                                                    ) {
            ngx_http_upstream_finalize_request(r, u,
                                               
# 2888 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                              500
# 2888 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            );
            return 
# 2889 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -4
# 2889 "project/nginx/src/http/ngx_http_upstream.c"
                          ;
        }
    }

    if (r->headers_out.server && r->headers_out.server->value.data == 
# 2893 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                     ((void *)0)
# 2893 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         ) {
        r->headers_out.server->hash = 0;
    }

    if (r->headers_out.date && r->headers_out.date->value.data == 
# 2897 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                 ((void *)0)
# 2897 "project/nginx/src/http/ngx_http_upstream.c"
                                                                     ) {
    ...
    return 
# 2921 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 2921 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (!u->conf->pass_trailers) {
        return 
# 2934 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 2934 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 2943 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 2943 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
                break;
            }
        ...
        if (ho == 
# 2959 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 2959 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
            return 
# 2960 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 2960 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    ...
    return 
# 2966 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 2966 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
ngx_http_upstream_send_response(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (rc == 
# 2981 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -1 
# 2981 "project/nginx/src/http/ngx_http_upstream.c"
                       || rc > 
# 2981 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0 
# 2981 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3024 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                             -1
# 3024 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ;
    }

    clcf = 
# 3027 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 3027 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 3027 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 3027 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3027 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (!u->buffering) {
        ...
        if (u->input_filter == 
# 3039 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              ((void *)0)
# 3039 "project/nginx/src/http/ngx_http_upstream.c"
                                  ) {
        ...
        if (u->input_filter_init(u->input_filter_ctx) == 
# 3052 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 3052 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 ) {
            ngx_http_upstream_finalize_request(r, u, 
# 3053 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 3053 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }

        if (clcf->tcp_nodelay && ngx_tcp_nodelay(c) != 
# 3057 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      0
# 3057 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ) {
            ngx_http_upstream_finalize_request(r, u, 
# 3058 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 3058 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }
...
# 3069 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                          -1
# 3069 "project/nginx/src/http/ngx_http_upstream.c"
                                                                   ) {
                ngx_http_upstream_finalize_request(r, u, 
# 3070 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 3070 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
                return;
            }
            ...
            if (ngx_http_send_special(r, 
# 3080 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        2
# 3080 "project/nginx/src/http/ngx_http_upstream.c"
                                                      ) == 
# 3080 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                           -1
# 3080 "project/nginx/src/http/ngx_http_upstream.c"
                ...
                ngx_http_upstream_finalize_request(r, u, 
# 3081 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 3081 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
                return;
            }
    ...
    if (r->cache && r->cache->file.fd != 
# 3095 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        -1
# 3095 "project/nginx/src/http/ngx_http_upstream.c"
                                                        ) {
        ngx_pool_run_cleanup_file(r->pool, r->cache->file.fd);
        r->cache->file.fd = 
# 3097 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           -1
# 3097 "project/nginx/src/http/ngx_http_upstream.c"
                                           ;
    }
    ...
    case 
# 3102 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        -1
# 3102 "project/nginx/src/http/ngx_http_upstream.c"
                 :
        ngx_http_upstream_finalize_request(r, u, 
# 3103 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3103 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;

    case 
# 3106 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        -5
# 3106 "project/nginx/src/http/ngx_http_upstream.c"
                    :
        u->cacheable = 0;
        break;
    ...
    default:
        ...
        if (u->cache_status == 
# 3112 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              2
# 3112 "project/nginx/src/http/ngx_http_upstream.c"
                                                   ) {



            if (ngx_http_file_cache_create(r) != 
# 3116 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                0
# 3116 "project/nginx/src/http/ngx_http_upstream.c"
                                                      ) {
                ngx_http_upstream_finalize_request(r, u, 
# 3117 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 3117 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
                return;
            }
        }
    ...
    if (u->cacheable) {
        ...
        now = 
# 3128 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ngx_cached_time->sec
# 3128 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
        ...
        if (valid) {
            ...
            if (u->headers_in.status_n == 
# 3144 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         200
                
# 3145 "project/nginx/src/http/ngx_http_upstream.c"
               || u->headers_in.status_n == 
# 3145 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                            206
# 3145 "project/nginx/src/http/ngx_http_upstream.c"
                                                                    )
            {
...
# 3153 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   (
# 3153 "project/nginx/src/http/ngx_http_upstream.c"
                   &r->cache->etag
# 3153 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   )->len = 0; (
# 3153 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3158 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               (
# 3158 "project/nginx/src/http/ngx_http_upstream.c"
               &r->cache->etag
# 3158 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )->len = 0; (
# 3158 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3158 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (ngx_http_file_cache_set_header(r, u->buffer.start) != 
# 3161 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                     0
# 3161 "project/nginx/src/http/ngx_http_upstream.c"
                                                                           ) {
                ngx_http_upstream_finalize_request(r, u, 
# 3162 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 3162 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
                return;
            }
    ...
    p->start_sec = 
# 3197 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ngx_cached_time->sec
# 3197 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    ...
    if (p->temp_file == 
# 3202 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                       ((void *)0)
# 3202 "project/nginx/src/http/ngx_http_upstream.c"
                           ) {
        ngx_http_upstream_finalize_request(r, u, 
# 3203 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3203 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }

    p->temp_file->file.fd = 
# 3207 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           -1
# 3207 "project/nginx/src/http/ngx_http_upstream.c"
                                           ;
    ...
    if (p->cacheable) {
        ...
        p->temp_file->log_level = 
# 3223 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 5
# 3223 "project/nginx/src/http/ngx_http_upstream.c"
                                             ;
...
# 3238 "project/nginx/src/http/ngx_http_upstream.c"
    p->preread_bufs = ngx_alloc_chain_link(r->pool);
    if (p->preread_bufs == 
# 3239 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          ((void *)0)
# 3239 "project/nginx/src/http/ngx_http_upstream.c"
                              ) {
        ngx_http_upstream_finalize_request(r, u, 
# 3240 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3240 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
    ...
    p->preread_bufs->next = 
# 3245 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           ((void *)0)
# 3245 "project/nginx/src/http/ngx_http_upstream.c"
                               ;
    u->buffer.recycled = 1;
    ...
    if (u->cacheable) {
        ...
        p->buf_to_file = 
# 3252 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ngx_pcalloc(
# 3252 "project/nginx/src/http/ngx_http_upstream.c"
                        r->pool
# 3252 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        , sizeof(ngx_buf_t))
# 3252 "project/nginx/src/http/ngx_http_upstream.c"
                                               ;
        if (p->buf_to_file == 
# 3253 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0)
# 3253 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
            ngx_http_upstream_finalize_request(r, u, 
# 3254 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 3254 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }
    ...
    if (ngx_event_flags & 
# 3264 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         0x00000200
# 3264 "project/nginx/src/http/ngx_http_upstream.c"
                                           ) {
    ...
    if (u->input_filter_init
        && u->input_filter_init(p->input_ctx) != 
# 3300 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                0
# 3300 "project/nginx/src/http/ngx_http_upstream.c"
                                                      )
    {
        ngx_http_upstream_finalize_request(r, u, 
# 3302 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3302 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
...
ngx_http_upstream_upgrade(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    c = r->connection;
    clcf = 
# 3320 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 3320 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 3320 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 3320 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3325 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 3325 "project/nginx/src/http/ngx_http_upstream.c"
       c->log
# 3325 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 3325 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3325 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 
# 3325 "project/nginx/src/http/ngx_http_upstream.c"
       0, "connection upgrade in subrequest"
# 3325 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )
                                                         
# 3326 "project/nginx/src/http/ngx_http_upstream.c"
                                                        ;
        ngx_http_upstream_finalize_request(r, u, 
# 3327 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3327 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
    ...
    if (clcf->tcp_nodelay) {
        ...
        if (ngx_tcp_nodelay(c) != 
# 3341 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0
# 3341 "project/nginx/src/http/ngx_http_upstream.c"
                                       ) {
            ngx_http_upstream_finalize_request(r, u, 
# 3342 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 3342 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }

        if (ngx_tcp_nodelay(u->peer.connection) != 
# 3346 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                  0
# 3346 "project/nginx/src/http/ngx_http_upstream.c"
                                                        ) {
            ngx_http_upstream_finalize_request(r, u, 
# 3347 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 3347 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }
    }
    ...
    if (ngx_http_send_special(r, 
# 3352 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                2
# 3352 "project/nginx/src/http/ngx_http_upstream.c"
                                              ) == 
# 3352 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                   -1
# 3352 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        ngx_http_upstream_finalize_request(r, u, 
# 3353 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3353 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
...
# 3360 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if (!(
# 3360 "project/nginx/src/http/ngx_http_upstream.c"
       c->read
# 3360 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->posted) { (
# 3360 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3422 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               60
# 3422 "project/nginx/src/http/ngx_http_upstream.c"
                                            , "client timed out");
        ngx_http_upstream_finalize_request(r, u, 
# 3423 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                408
# 3423 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         );
        return;
    }
    ...
    if (upstream->read->timedout || upstream->write->timedout) {
        ngx_connection_error(c, 
# 3428 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               60
# 3428 "project/nginx/src/http/ngx_http_upstream.c"
                                            , "upstream timed out");
        ngx_http_upstream_finalize_request(r, u, 
# 3429 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                504
# 3429 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         );
        return;
    }
    ...
    if (from_upstream) {
        ...
        if (b->start == 
# 3449 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                       ((void *)0)
# 3449 "project/nginx/src/http/ngx_http_upstream.c"
                           ) {
            b->start = ngx_palloc(r->pool, u->conf->buffer_size);
            if (b->start == 
# 3451 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           ((void *)0)
# 3451 "project/nginx/src/http/ngx_http_upstream.c"
                               ) {
                ngx_http_upstream_finalize_request(r, u, 
# 3452 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 3452 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
                return;
            }
    ...
    for ( ;; ) {
        ...
        if (do_write) {
            ...
            if (size && dst->write->ready) {
                ...
                if (n == 
# 3474 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        -1
# 3474 "project/nginx/src/http/ngx_http_upstream.c"
                                 ) {
                    ngx_http_upstream_finalize_request(r, u, 
# 3475 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                            -1
# 3475 "project/nginx/src/http/ngx_http_upstream.c"
                                                                     );
                    return;
                }
        ...
        if (size && src->read->ready) {
            ...
            if (n == 
# 3496 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    -2 
# 3496 "project/nginx/src/http/ngx_http_upstream.c"
                              || n == 0) {
                break;
            }
            ...
            if (n == 
# 3511 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    -1
# 3511 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
                src->read->eof = 1;
            }
        }
    ...
    clcf = 
# 3529 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 3529 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 3529 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 3529 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3529 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (ngx_handle_write_event(upstream->write, u->conf->send_lowat)
        != 
# 3532 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 3532 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        ngx_http_upstream_finalize_request(r, u, 
# 3534 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3534 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
...
# 3539 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 3539 "project/nginx/src/http/ngx_http_upstream.c"
                    (upstream->write, u->conf->send_timeout);

    } else if (upstream->write->timer_set) {
        
# 3542 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 3542 "project/nginx/src/http/ngx_http_upstream.c"
                    (upstream->write);
    }

    if (upstream->read->eof || upstream->read->error) {
        flags = 
# 3546 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               0x8000
# 3546 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
    ...
    if (ngx_handle_read_event(upstream->read, flags) != 
# 3552 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                       0
# 3552 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ) {
        ngx_http_upstream_finalize_request(r, u, 
# 3553 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3553 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
...
# 3558 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 3558 "project/nginx/src/http/ngx_http_upstream.c"
                    (upstream->read, u->conf->read_timeout);

    } else if (upstream->read->timer_set) {
        
# 3561 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 3561 "project/nginx/src/http/ngx_http_upstream.c"
                    (upstream->read);
    }

    if (ngx_handle_write_event(downstream->write, clcf->send_lowat)
        != 
# 3565 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 3565 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        ngx_http_upstream_finalize_request(r, u, 
# 3567 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3567 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
    ...
    if (downstream->read->eof || downstream->read->error) {
        flags = 
# 3572 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               0x8000
# 3572 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
    ...
    if (ngx_handle_read_event(downstream->read, flags) != 
# 3578 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                         0
# 3578 "project/nginx/src/http/ngx_http_upstream.c"
                                                               ) {
        ngx_http_upstream_finalize_request(r, u, 
# 3579 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3579 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
...
# 3584 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 3584 "project/nginx/src/http/ngx_http_upstream.c"
                    (downstream->write, clcf->send_timeout);

    } else if (downstream->write->timer_set) {
        
# 3587 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 3587 "project/nginx/src/http/ngx_http_upstream.c"
                    (downstream->write);
    }
}
...
ngx_http_upstream_process_non_buffered_downstream(ngx_http_request_t *r)
{
    ...
    if (wev->timedout) {
        c->timedout = 1;
        ngx_connection_error(c, 
# 3610 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               60
# 3610 "project/nginx/src/http/ngx_http_upstream.c"
                                            , "client timed out");
        ngx_http_upstream_finalize_request(r, u, 
# 3611 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                408
# 3611 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         );
        return;
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (c->read->timedout) {
        ngx_connection_error(c, 
# 3633 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               60
# 3633 "project/nginx/src/http/ngx_http_upstream.c"
                                            , "upstream timed out");
        ngx_http_upstream_finalize_request(r, u, 
# 3634 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                504
# 3634 "project/nginx/src/http/ngx_http_upstream.c"
                                                                         );
        return;
    }
    ...
    for ( ;; ) {
        ...
        if (do_write) {
            ...
            if (u->out_bufs || u->busy_bufs || downstream->buffered) {
                ...
                if (rc == 
# 3670 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         -1
# 3670 "project/nginx/src/http/ngx_http_upstream.c"
                                  ) {
                    ngx_http_upstream_finalize_request(r, u, 
# 3671 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                            -1
# 3671 "project/nginx/src/http/ngx_http_upstream.c"
                                                                     );
                    return;
                }
            ...
            if (u->busy_bufs == 
# 3679 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               ((void *)0)
# 3679 "project/nginx/src/http/ngx_http_upstream.c"
                                   ) {
...
# 3689 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   if ((
# 3689 "project/nginx/src/http/ngx_http_upstream.c"
                   upstream->log
# 3689 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 3689 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3690 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          ;

                    ngx_http_upstream_finalize_request(r, u,
                                                       
# 3693 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      502
# 3693 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          );
                    return;
                }
...
# 3699 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      502
# 3699 "project/nginx/src/http/ngx_http_upstream.c"
                                                                          );
                    return;
                }
        ...
        if (size && upstream->read->ready) {
            ...
            if (n == 
# 3714 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    -2
# 3714 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
                break;
            }
            ...
            if (n > 0) {
                ...
                if (u->input_filter(u->input_filter_ctx, n) == 
# 3722 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                              -1
# 3722 "project/nginx/src/http/ngx_http_upstream.c"
                                                                       ) {
                    ngx_http_upstream_finalize_request(r, u, 
# 3723 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                            -1
# 3723 "project/nginx/src/http/ngx_http_upstream.c"
                                                                     );
                    return;
                }
            }
    ...
    clcf = 
# 3736 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (
# 3736 "project/nginx/src/http/ngx_http_upstream.c"
          r
# 3736 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          )->loc_conf[
# 3736 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3736 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (downstream->data == r) {
        if (ngx_handle_write_event(downstream->write, clcf->send_lowat)
            != 
# 3740 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 3740 "project/nginx/src/http/ngx_http_upstream.c"
                    )
        {
            ngx_http_upstream_finalize_request(r, u, 
# 3742 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 3742 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }
    }
...
# 3748 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 3748 "project/nginx/src/http/ngx_http_upstream.c"
                    (downstream->write, clcf->send_timeout);

    } else if (downstream->write->timer_set) {
        
# 3751 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 3751 "project/nginx/src/http/ngx_http_upstream.c"
                    (downstream->write);
    }

    if (upstream->read->eof || upstream->read->error) {
        flags = 
# 3755 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               0x8000
# 3755 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
    ...
    if (ngx_handle_read_event(upstream->read, flags) != 
# 3761 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                       0
# 3761 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ) {
        ngx_http_upstream_finalize_request(r, u, 
# 3762 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                -1
# 3762 "project/nginx/src/http/ngx_http_upstream.c"
                                                         );
        return;
    }
...
# 3767 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_add_timer
# 3767 "project/nginx/src/http/ngx_http_upstream.c"
                    (upstream->read, u->conf->read_timeout);

    } else if (upstream->read->timer_set) {
        
# 3770 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       ngx_event_del_timer
# 3770 "project/nginx/src/http/ngx_http_upstream.c"
                    (upstream->read);
    }
}
...
{
    return 
# 3778 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 3778 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
# 3794 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 3794 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 3794 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 5) ngx_log_error_core(5, 
# 3794 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 3794 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 
# 3794 "project/nginx/src/http/ngx_http_upstream.c"
       0, "upstream sent more data than specified in " "\"Content-Length\" header"
# 3794 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )

                                                  
# 3796 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ;
        return 
# 3797 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 3797 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (cl == 
# 3805 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 3805 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 3806 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 3806 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ll = cl;
    ...
    if (u->length == -1) {
        return 
# 3822 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 3822 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
...
# 3827 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 3827 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 3827 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 5) ngx_log_error_core(5, 
# 3827 "project/nginx/src/http/ngx_http_upstream.c"
...
# 3829 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ;
        ...
        return 
# 3834 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 3834 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 3839 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 3839 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
# 3962 "project/nginx/src/http/ngx_http_upstream.c"
static ngx_int_t
...
ngx_http_upstream_process_downstream(ngx_http_request_t *r)
{
    ...
    if (wev->timedout) {
        ...
        c->timedout = 1;
        ngx_connection_error(c, 
# 4006 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               60
# 4006 "project/nginx/src/http/ngx_http_upstream.c"
                                            , "client timed out");
        ...
        if (wev->delayed) {
            ...
            if (ngx_handle_write_event(wev, p->send_lowat) != 
# 4015 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                             0
# 4015 "project/nginx/src/http/ngx_http_upstream.c"
                                                                   ) {
                ngx_http_upstream_finalize_request(r, u, 
# 4016 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 4016 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
            }
        ...
        if (ngx_event_pipe(p, 1) == 
# 4022 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                   -6
# 4022 "project/nginx/src/http/ngx_http_upstream.c"
                                            ) {
            ngx_http_upstream_finalize_request(r, u, 
# 4023 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 4023 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    if (rev->timedout) {
        ...
        p->upstream_error = 1;
        ngx_connection_error(c, 
# 4052 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               60
# 4052 "project/nginx/src/http/ngx_http_upstream.c"
                                            , "upstream timed out");
        ...
        if (rev->delayed) {
            ...
            if (ngx_handle_read_event(rev, 0) != 
# 4061 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                0
# 4061 "project/nginx/src/http/ngx_http_upstream.c"
                                                      ) {
                ngx_http_upstream_finalize_request(r, u, 
# 4062 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        -1
# 4062 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
            }
        ...
        if (ngx_event_pipe(p, 0) == 
# 4068 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                   -6
# 4068 "project/nginx/src/http/ngx_http_upstream.c"
                                            ) {
            ngx_http_upstream_finalize_request(r, u, 
# 4069 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 4069 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
            return;
        }
    }
    ...
    ngx_http_upstream_t *u)
{
    ...
    p = u->pipe;
# 4108 "project/nginx/src/http/ngx_http_upstream.c"
    if (u->peer.connection) {
        ...
        if (u->store) {
            ...
            if (p->upstream_eof || p->upstream_done) {
                ...
                if (u->headers_in.status_n == 
# 4116 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                             200
                    
# 4117 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4167 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               if ((
# 4167 "project/nginx/src/http/ngx_http_upstream.c"
               r->connection->log
# 4167 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               )->log_level >= 4) ngx_log_error_core(4, 
# 4167 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4168 "project/nginx/src/http/ngx_http_upstream.c"
                                                                      ;
            }

            ngx_http_upstream_finalize_request(r, u, 
# 4171 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    502
# 4171 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
            return;
        }
    }
    ...
    if (p->downstream_error) {
        ...
        if (!u->cacheable && !u->store && u->peer.connection) {
            ngx_http_upstream_finalize_request(r, u, 
# 4181 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                    -1
# 4181 "project/nginx/src/http/ngx_http_upstream.c"
                                                             );
        }
    }
}
...
ngx_http_upstream_store(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    if (tf->file.fd == 
# 4198 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      -1
# 4198 "project/nginx/src/http/ngx_http_upstream.c"
                                      ) {
        ...
        if (tf == 
# 4203 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 4203 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
            return;
        }

        tf->file.fd = 
# 4207 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     -1
# 4207 "project/nginx/src/http/ngx_http_upstream.c"
                                     ;
        ...
        if (ngx_create_temp_file(&tf->file, tf->path, tf->pool,
            ...
            != 
# 4215 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4215 "project/nginx/src/http/ngx_http_upstream.c"
                    )
        {
            return;
        }
    ...
    if (u->headers_in.last_modified) {
        ...
        if (lm != 
# 4235 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -1
# 4235 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
            ext.time = lm;
            ext.fd = tf->file.fd;
        }
    ...
    if (u->conf->store_lengths == 
# 4241 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 ((void *)0)
# 4241 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {

        if (ngx_http_map_uri_to_path(r, &path, &root, 0) == 
# 4243 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                           ((void *)0)
# 4243 "project/nginx/src/http/ngx_http_upstream.c"
                                                               ) {
            return;
        }
        ...
        if (ngx_http_script_run(r, &path, u->conf->store_lengths->elts, 0,
            ...
            == 
# 4250 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 4250 "project/nginx/src/http/ngx_http_upstream.c"
                  )
        {
            return;
        }
    ...
    ngx_uint_t ft_type)
{
    ...
    if (u->peer.sockaddr) {
        ...
        if (ft_type == 
# 4292 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      0x00000100
            
# 4293 "project/nginx/src/http/ngx_http_upstream.c"
           || ft_type == 
# 4293 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         0x00000200
# 4293 "project/nginx/src/http/ngx_http_upstream.c"
                                                      )
        {
            state = 
# 4295 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   2
# 4295 "project/nginx/src/http/ngx_http_upstream.c"
                                ;

        } else {
            state = 
# 4298 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   4
# 4298 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
        }

        u->peer.free(&u->peer, u->peer.data, state);
        u->peer.sockaddr = 
# 4302 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          ((void *)0)
# 4302 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
    }

    if (ft_type == 
# 4305 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0x00000004
# 4305 "project/nginx/src/http/ngx_http_upstream.c"
                                              ) {
        
# 4306 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 4306 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 4306 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 4306 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4307 "project/nginx/src/http/ngx_http_upstream.c"
                                          ;
    }

    if (u->peer.cached && ft_type == 
# 4310 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    0x00000002
# 4310 "project/nginx/src/http/ngx_http_upstream.c"
                                                              ) {
    ...
    case 
# 4317 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000004
# 4317 "project/nginx/src/http/ngx_http_upstream.c"
                                    :
    case 
# 4318 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000080
# 4318 "project/nginx/src/http/ngx_http_upstream.c"
                                     :
        status = 
# 4319 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                504
# 4319 "project/nginx/src/http/ngx_http_upstream.c"
                                         ;
        break;

    case 
# 4322 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000010
# 4322 "project/nginx/src/http/ngx_http_upstream.c"
                                     :
        status = 
# 4323 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                500
# 4323 "project/nginx/src/http/ngx_http_upstream.c"
                                              ;
        break;

    case 
# 4326 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000040
# 4326 "project/nginx/src/http/ngx_http_upstream.c"
                                     :
        status = 
# 4327 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                503
# 4327 "project/nginx/src/http/ngx_http_upstream.c"
                                            ;
        break;

    case 
# 4330 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000100
# 4330 "project/nginx/src/http/ngx_http_upstream.c"
                                     :
        status = 
# 4331 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                403
# 4331 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
        break;

    case 
# 4334 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000200
# 4334 "project/nginx/src/http/ngx_http_upstream.c"
                                     :
        status = 
# 4335 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                404
# 4335 "project/nginx/src/http/ngx_http_upstream.c"
                                  ;
        break;

    case 
# 4338 "project/nginx/src/http/ngx_http_upstream.c" 3 4
        0x00000400
# 4338 "project/nginx/src/http/ngx_http_upstream.c"
                                     :
        status = 
# 4339 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                429
# 4339 "project/nginx/src/http/ngx_http_upstream.c"
                                          ;
        break;
    ...
    default:
        status = 
# 4348 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                502
# 4348 "project/nginx/src/http/ngx_http_upstream.c"
                                    ;
    }
...
# 4353 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          499
# 4353 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        );
        return;
    }
    ...
    if (u->request_sent
        && (r->method & (
# 4362 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        0x00000008
# 4362 "project/nginx/src/http/ngx_http_upstream.c"
                                     |
# 4362 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      0x00001000
# 4362 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4362 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    {
        ft_type |= 
# 4364 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0x00004000
# 4364 "project/nginx/src/http/ngx_http_upstream.c"
                                                     ;
    }
        ...
        || (timeout && ngx_current_msec - u->peer.start_time >= timeout))
    {
        ...
        if (u->cache_status == 
# 4374 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              3
            
# 4375 "project/nginx/src/http/ngx_http_upstream.c"
           && ((u->conf->cache_use_stale & ft_type) || r->cache->stale_error))
        {
            ...
            if (rc != 
# 4381 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     0
# 4381 "project/nginx/src/http/ngx_http_upstream.c"
                           ) {
                ngx_http_upstream_finalize_request(r, u, rc);
                return;
            }
            ...
            u->cache_status = 
# 4386 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             4
# 4386 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ;
            rc = ngx_http_upstream_cache_send(r, u);

            if (rc == 
# 4389 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     -4
# 4389 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
                return;
            }

            if (rc == 
# 4393 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     40
# 4393 "project/nginx/src/http/ngx_http_upstream.c"
                                                     ) {
                rc = 
# 4394 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    500
# 4394 "project/nginx/src/http/ngx_http_upstream.c"
                                                  ;
            }
    ...
    if (u->peer.connection) {
                                              ...
                                              ;
# 4420 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        u->peer.connection = 
# 4425 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            ((void *)0)
# 4425 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
    }
...
# 4440 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                      -4
# 4440 "project/nginx/src/http/ngx_http_upstream.c"
                                                              );
}
    ...
    ngx_http_upstream_t *u, ngx_int_t rc)
{
    ...
    if (u->cleanup == 
# 4453 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     ((void *)0)
# 4453 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {

        ngx_http_finalize_request(r, 
# 4455 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    -4
# 4455 "project/nginx/src/http/ngx_http_upstream.c"
                                            );
        return;
    }

    *u->cleanup = 
# 4459 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 4459 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
    u->cleanup = 
# 4460 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                ((void *)0)
# 4460 "project/nginx/src/http/ngx_http_upstream.c"
                    ;

    if (u->resolved && u->resolved->ctx) {
        ngx_resolve_name_done(u->resolved->ctx);
        u->resolved->ctx = 
# 4464 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          ((void *)0)
# 4464 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
    }
    ...
    if (u->peer.free && u->peer.sockaddr) {
        ...
        u->peer.sockaddr = 
# 4485 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          ((void *)0)
# 4485 "project/nginx/src/http/ngx_http_upstream.c"
                              ;
    }

    if (u->peer.connection) {
# 4508 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    u->peer.connection = 
# 4519 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 4519 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
...
# 4528 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         -1
# 4528 "project/nginx/src/http/ngx_http_upstream.c"
                                                         )
    {
        if (
# 4530 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           unlink((const char *) 
# 4530 "project/nginx/src/http/ngx_http_upstream.c"
           u->pipe->temp_file->file.name.data
# 4530 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )
            
# 4531 "project/nginx/src/http/ngx_http_upstream.c"
           == 
# 4531 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 4531 "project/nginx/src/http/ngx_http_upstream.c"
                            )
        {
            
# 4533 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 4533 "project/nginx/src/http/ngx_http_upstream.c"
           r->connection->log
# 4533 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 4533 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4535 "project/nginx/src/http/ngx_http_upstream.c"
                                                            ;
        }
    }
    ...
    if (r->cache) {
        ...
        if (u->cacheable) {
            ...
            if (rc == 
# 4545 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     502 
# 4545 "project/nginx/src/http/ngx_http_upstream.c"
                                          || rc == 
# 4545 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                   504
# 4545 "project/nginx/src/http/ngx_http_upstream.c"
                ...
                if (valid) {
                    r->cache->valid_sec = 
# 4551 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         ngx_cached_time->sec 
# 4551 "project/nginx/src/http/ngx_http_upstream.c"
                                                    + valid;
                    r->cache->error = rc;
                }
            }
    ...
    if (rc == 
# 4564 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -5
# 4564 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {
        return;
    }
    ...
    if (!u->header_sent
        || rc == 
# 4571 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                408
        
# 4572 "project/nginx/src/http/ngx_http_upstream.c"
       || rc == 
# 4572 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                499
# 4572 "project/nginx/src/http/ngx_http_upstream.c"
                                              )
    {
    ...
    if (rc >= 
# 4580 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             300
# 4580 "project/nginx/src/http/ngx_http_upstream.c"
                                      ) {
        rc = 
# 4581 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -1
# 4581 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
        flush = 1;
    }
    ...
    if (rc == 0) {
        ...
        if (ngx_http_upstream_process_trailers(r, u) != 
# 4594 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                       0
# 4594 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ) {
            ngx_http_finalize_request(r, 
# 4595 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        -1
# 4595 "project/nginx/src/http/ngx_http_upstream.c"
                                                 );
            return;
        }

        rc = ngx_http_send_special(r, 
# 4599 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                     1
# 4599 "project/nginx/src/http/ngx_http_upstream.c"
                                                  );

    } else if (flush) {
        r->keepalive = 0;
        rc = ngx_http_send_special(r, 
# 4603 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                     2
# 4603 "project/nginx/src/http/ngx_http_upstream.c"
                                                   );
    }
    ...
    ngx_uint_t offset)
{
    ...
    if (*ph == 
# 4618 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 4618 "project/nginx/src/http/ngx_http_upstream.c"
                  ) {
        *ph = h;
    }

    return 
# 4622 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4622 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
{
    return 
# 4630 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4630 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    return 
# 4645 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4645 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    return 
# 4661 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4661 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (pa->elts == 
# 4676 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 4676 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        if (ngx_array_init(pa, r->pool, 1, sizeof(ngx_table_elt_t *)) != 
# 4677 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                        0
# 4677 "project/nginx/src/http/ngx_http_upstream.c"
                                                                              )
        {
            return 
# 4679 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 4679 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    }
    ...
    if (ph == 
# 4684 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 4684 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 4685 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 4685 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ph = h;
    ...
    if (!(u->conf->ignore_headers & 
# 4691 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                   0x00000020
# 4691 "project/nginx/src/http/ngx_http_upstream.c"
                                                                   )) {
        u->cacheable = 0;
    }
    ...
    return 
# 4696 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4696 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (pa->elts == 
# 4711 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 4711 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        if (ngx_array_init(pa, r->pool, 2, sizeof(ngx_table_elt_t *)) != 
# 4712 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                        0
# 4712 "project/nginx/src/http/ngx_http_upstream.c"
                                                                              )
        {
            return 
# 4714 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 4714 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    }
    ...
    ph = ngx_array_push(pa);
    if (ph == 
# 4719 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 4719 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 4720 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 4720 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ph = h;
    ...
    if (u->conf->ignore_headers & 
# 4730 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0x00000010
# 4730 "project/nginx/src/http/ngx_http_upstream.c"
                                                                    ) {
        return 
# 4731 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4731 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (r->cache == 
# 4734 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 4734 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        return 
# 4735 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4735 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (r->cache->valid_sec != 0 && u->headers_in.x_accel_expires != 
# 4738 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                    ((void *)0)
# 4738 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        ) {
        return 
# 4739 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4739 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
...
# 4745 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                      ((void *)0)
        
# 4746 "project/nginx/src/http/ngx_http_upstream.c"
       || ngx_strlcasestrn(start, last, (u_char *) "no-store", 8 - 1) != 
# 4746 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                         ((void *)0)
        
# 4747 "project/nginx/src/http/ngx_http_upstream.c"
       || ngx_strlcasestrn(start, last, (u_char *) "private", 7 - 1) != 
# 4747 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                        ((void *)0)
# 4747 "project/nginx/src/http/ngx_http_upstream.c"
                                                                            )
    {
        u->cacheable = 0;
        return 
# 4750 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4750 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (p == 
# 4756 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 4756 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
    ...
    if (p) {
        ...
        for (p += offset; p < last; p++) {
            ...
            u->cacheable = 0;
            return 
# 4775 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 4775 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
        ...
        if (n == 0) {
            u->cacheable = 0;
            return 
# 4780 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 4780 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

        r->cache->valid_sec = 
# 4783 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ngx_cached_time->sec 
# 4783 "project/nginx/src/http/ngx_http_upstream.c"
                                        + n;
    }
    ...
    if (p) {
        ...
        for (p += 23; p < last; p++) {
            ...
            u->cacheable = 0;
            return 
# 4803 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 4803 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
    ...
    if (p) {
        ...
        for (p += 15; p < last; p++) {
            ...
            u->cacheable = 0;
            return 
# 4826 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 4826 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
    ...
    return 
# 4834 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4834 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & 
# 4851 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0x00000008
# 4851 "project/nginx/src/http/ngx_http_upstream.c"
                                                              ) {
        return 
# 4852 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4852 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (r->cache == 
# 4855 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 4855 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        return 
# 4856 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4856 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (r->cache->valid_sec != 0) {
        return 
# 4860 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4860 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (expires == 
# 4865 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1 
# 4865 "project/nginx/src/http/ngx_http_upstream.c"
                            || expires < 
# 4865 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         ngx_cached_time->sec
# 4865 "project/nginx/src/http/ngx_http_upstream.c"
        ...
        u->cacheable = 0;
        return 
# 4867 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4867 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 4874 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4874 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & 
# 4893 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0x00000004
# 4893 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 ) {
        return 
# 4894 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4894 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (r->cache == 
# 4897 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 4897 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        return 
# 4898 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4898 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (p[0] != '@') {
        ...
        case 
# 4912 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -1
# 4912 "project/nginx/src/http/ngx_http_upstream.c"
                     :
            return 
# 4913 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 4913 "project/nginx/src/http/ngx_http_upstream.c"
                        ;

        default:
            r->cache->valid_sec = 
# 4916 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 ngx_cached_time->sec 
# 4916 "project/nginx/src/http/ngx_http_upstream.c"
                                            + n;
            return 
# 4917 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 4917 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
    }
    ...
    if (n != 
# 4926 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -1
# 4926 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
        r->cache->valid_sec = n;
    }
    }
    ...
    return 
# 4932 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4932 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & 
# 4946 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0x00000040
# 4946 "project/nginx/src/http/ngx_http_upstream.c"
                                                                    ) {
        return 
# 4947 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4947 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (n != 
# 4952 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -1
# 4952 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
    ...
    return 
# 4957 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4957 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & 
# 4970 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0x00000080
# 4970 "project/nginx/src/http/ngx_http_upstream.c"
                                                                   ) {
        return 
# 4971 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 4971 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (u->conf->change_buffering) {
        ...
        if (h->value.len == 2) {
            c0 = 
# 4977 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                (u_char) ((
# 4977 "project/nginx/src/http/ngx_http_upstream.c"
                h->value.data[0] 
# 4977 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                >= 'A' && 
# 4977 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4977 "project/nginx/src/http/ngx_http_upstream.c"
                                             ;
            c1 = 
# 4978 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                (u_char) ((
# 4978 "project/nginx/src/http/ngx_http_upstream.c"
                h->value.data[1] 
# 4978 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                >= 'A' && 
# 4978 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4978 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            c0 = 
# 4985 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                (u_char) ((
# 4985 "project/nginx/src/http/ngx_http_upstream.c"
                h->value.data[0] 
# 4985 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                >= 'A' && 
# 4985 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4985 "project/nginx/src/http/ngx_http_upstream.c"
                                             ;
            c1 = 
# 4986 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                (u_char) ((
# 4986 "project/nginx/src/http/ngx_http_upstream.c"
                h->value.data[1] 
# 4986 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                >= 'A' && 
# 4986 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4986 "project/nginx/src/http/ngx_http_upstream.c"
                                             ;
            c2 = 
# 4987 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                (u_char) ((
# 4987 "project/nginx/src/http/ngx_http_upstream.c"
                h->value.data[2] 
# 4987 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                >= 'A' && 
# 4987 "project/nginx/src/http/ngx_http_upstream.c"
...
# 4987 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    return 
# 4995 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 4995 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
ngx_http_upstream_process_charset(ngx_http_request_t *r, ngx_table_elt_t *h,
    ngx_uint_t offset)
{
    if (r->upstream->conf->ignore_headers & 
# 5003 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                           0x00000100
# 5003 "project/nginx/src/http/ngx_http_upstream.c"
                                                                           ) {
        return 
# 5004 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5004 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 5009 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5009 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (ngx_strlcasestrn(h->value.data, h->value.data + h->value.len,
                         (u_char *) "close", 5 - 1)
        != 
# 5021 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((void *)0)
# 5021 "project/nginx/src/http/ngx_http_upstream.c"
              )
    {
    ...
    return 
# 5026 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5026 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (ngx_strlcasestrn(h->value.data, h->value.data + h->value.len,
                         (u_char *) "chunked", 7 - 1)
        != 
# 5038 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((void *)0)
# 5038 "project/nginx/src/http/ngx_http_upstream.c"
              )
    {
    ...
    return 
# 5043 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5043 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (u->conf->ignore_headers & 
# 5058 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0x00000200
# 5058 "project/nginx/src/http/ngx_http_upstream.c"
                                                           ) {
        return 
# 5059 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5059 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (r->cache == 
# 5062 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 5062 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        return 
# 5063 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5063 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (h->value.len > 
# 5066 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      128
        
# 5067 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    return 
# 5076 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5076 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (ho == 
# 5087 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5087 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5088 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5088 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    return 
# 5098 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5098 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (pa->elts == 
# 5111 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   ((void *)0)
# 5111 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
        if (ngx_array_init(pa, r->pool, 2, sizeof(ngx_table_elt_t *)) != 
# 5112 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                        0
# 5112 "project/nginx/src/http/ngx_http_upstream.c"
                                                                              )
        {
            return 
# 5114 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 5114 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    }
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5119 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5119 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5120 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5120 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    ph = ngx_array_push(pa);
    if (ph == 
# 5126 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5126 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5127 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5127 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ph = ho;
    ...
    return 
# 5132 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5132 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
# 5144 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         ((void *)0)
# 5144 "project/nginx/src/http/ngx_http_upstream.c"
                                             ;
    ...
    for (p = h->value.data; *p; p++) {
        ...
        if (*p == '\0') {
            return 
# 5157 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 5157 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
        ...
        return 
# 5181 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5181 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    return 
# 5184 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5184 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5195 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5195 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5196 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5196 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    return 
# 5205 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5205 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5217 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5217 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5218 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5218 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    if (r->upstream->rewrite_redirect) {
        ...
        if (rc == 
# 5226 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -5
# 5226 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
            return 
# 5227 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 5227 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

        if (rc == 
# 5230 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 0
# 5230 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
    ...
    return 
# 5249 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5249 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5262 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5262 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5263 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5263 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    if (r->upstream->rewrite_redirect) {
        ...
        if (p) {
            ...
            return 
# 5276 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 5276 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

        if (rc == 
# 5279 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -5
# 5279 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
            return 
# 5280 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 5280 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

        if (rc == 
# 5283 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 0
# 5283 "project/nginx/src/http/ngx_http_upstream.c"
                       ) {
    ...
    return 
# 5295 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5295 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5307 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5307 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5308 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5308 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    if (r->upstream->rewrite_cookie) {
        ...
        if (rc == 
# 5316 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 -5
# 5316 "project/nginx/src/http/ngx_http_upstream.c"
                             ) {
            return 
# 5317 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 5317 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }
# 5327 "project/nginx/src/http/ngx_http_upstream.c"
        return rc;
    }

    return 
# 5330 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5330 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    if (r->upstream->conf->force_ranges) {
        return 
# 5341 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5341 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (r->cached) {
        r->allow_ranges = 1;
        return 
# 5348 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5348 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (r->upstream->cacheable) {
        ...
        r->single_range = 1;
        return 
# 5354 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5354 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5360 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5360 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5361 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5361 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    return 
# 5368 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5368 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_table_elt_t *h, ngx_uint_t offset)
{
    ...
    ho = ngx_list_push(&r->headers_out.headers);
    if (ho == 
# 5381 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5381 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5382 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5382 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    *ho = *h;
    ...
    return 
# 5389 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5389 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
ngx_http_upstream_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_http_upstream_vars; v->name.len; v++) {
        ...
        if (var == 
# 5402 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 5402 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
            return 
# 5403 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 5403 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    ...
    return 
# 5410 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5410 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream_states == 
# 5427 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0) 
# 5427 "project/nginx/src/http/ngx_http_upstream.c"
                                  || r->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 5429 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5429 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (p == 
# 5445 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 5445 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
        return 
# 5446 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5446 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    for ( ;; ) {
        if (state[i].peer) {
            p = 
# 5455 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 5455 "project/nginx/src/http/ngx_http_upstream.c"
               p
# 5455 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               , 
# 5455 "project/nginx/src/http/ngx_http_upstream.c"
...
# 5455 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    return 
# 5481 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5481 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream_states == 
# 5498 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0) 
# 5498 "project/nginx/src/http/ngx_http_upstream.c"
                                  || r->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 5500 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5500 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    p = ngx_pnalloc(r->pool, len);
    if (p == 
# 5506 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 5506 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
        return 
# 5507 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5507 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    return 
# 5546 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5546 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream_states == 
# 5564 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0) 
# 5564 "project/nginx/src/http/ngx_http_upstream.c"
                                  || r->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 5566 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5566 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    len = r->upstream_states->nelts * (
# 5569 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      (sizeof("-9223372036854775808") - 1) 
# 5569 "project/nginx/src/http/ngx_http_upstream.c"
                                                     + 4 + 2);

    p = ngx_pnalloc(r->pool, len);
    if (p == 
# 5572 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 5572 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
        return 
# 5573 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5573 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    for ( ;; ) {
        ...
        if (ms != -1) {
            ms = 
# 5594 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                ((
# 5594 "project/nginx/src/http/ngx_http_upstream.c"
                ms 
# 5594 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                < 
# 5594 "project/nginx/src/http/ngx_http_upstream.c"
...
# 5594 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    return 
# 5624 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5624 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream_states == 
# 5641 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             ((void *)0) 
# 5641 "project/nginx/src/http/ngx_http_upstream.c"
                                  || r->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 5643 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5643 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    len = r->upstream_states->nelts * (
# 5646 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      (sizeof("-9223372036854775808") - 1) 
# 5646 "project/nginx/src/http/ngx_http_upstream.c"
                                                    + 2);

    p = ngx_pnalloc(r->pool, len);
    if (p == 
# 5649 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 5649 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
        return 
# 5650 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5650 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    return 
# 5693 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5693 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
{
    if (r->upstream == 
# 5701 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 5701 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
        v->not_found = 1;
        return 
# 5703 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5703 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
...
{
    if (r->upstream == 
# 5716 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 5716 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
        v->not_found = 1;
        return 
# 5718 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5718 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream == 
# 5735 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
# 5735 "project/nginx/src/http/ngx_http_upstream.c"
                          ) {
        v->not_found = 1;
        return 
# 5737 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5737 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (ngx_http_parse_set_cookie_lines(&r->upstream->headers_in.cookies,
                                        &s, &cookie)
        == 
# 5745 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          -5
# 5745 "project/nginx/src/http/ngx_http_upstream.c"
                      )
    {
        v->not_found = 1;
        return 
# 5748 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5748 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 5757 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5757 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream == 
# 5769 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0) 
# 5769 "project/nginx/src/http/ngx_http_upstream.c"
                           || r->upstream->cache_status == 0) {
        v->not_found = 1;
        return 
# 5771 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5771 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 5782 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5782 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->upstream == 
# 5792 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
        
# 5793 "project/nginx/src/http/ngx_http_upstream.c"
       || !r->upstream->conf->cache_revalidate
        || r->upstream->cache_status != 
# 5794 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                       3
        
# 5795 "project/nginx/src/http/ngx_http_upstream.c"
       || r->cache->last_modified == -1)
    {
        v->not_found = 1;
        return 
# 5798 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5798 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    p = ngx_pnalloc(r->pool, sizeof("Mon, 28 Sep 1970 06:00:00 GMT") - 1);
    if (p == 
# 5802 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            ((void *)0)
# 5802 "project/nginx/src/http/ngx_http_upstream.c"
                ) {
        return 
# 5803 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 5803 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    return 
# 5812 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5812 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
{
    if (r->upstream == 
# 5820 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ((void *)0)
        
# 5821 "project/nginx/src/http/ngx_http_upstream.c"
       || !r->upstream->conf->cache_revalidate
        || r->upstream->cache_status != 
# 5822 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                       3
        
# 5823 "project/nginx/src/http/ngx_http_upstream.c"
       || r->cache->etag.len == 0)
    {
        v->not_found = 1;
        return 
# 5826 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 5826 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 5835 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 5835 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
# 5854 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 5854 "project/nginx/src/http/ngx_http_upstream.c"
   &u
# 5854 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 5854 "project/nginx/src/http/ngx_http_upstream.c"
...
# 5861 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        0x0001
                                         
# 5862 "project/nginx/src/http/ngx_http_upstream.c"
                                        |
# 5862 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x0002
                                         
# 5863 "project/nginx/src/http/ngx_http_upstream.c"
                                        |
# 5863 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x0100
                                         
# 5864 "project/nginx/src/http/ngx_http_upstream.c"
                                        |
# 5864 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x0004
                                         
# 5865 "project/nginx/src/http/ngx_http_upstream.c"
                                        |
# 5865 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x0008
                                         
# 5866 "project/nginx/src/http/ngx_http_upstream.c"
                                        |
# 5866 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x0010
                                         
# 5867 "project/nginx/src/http/ngx_http_upstream.c"
                                        |
# 5867 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0x0020
# 5867 "project/nginx/src/http/ngx_http_upstream.c"
                                                                 );
    if (uscf == 
# 5868 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ((void *)0)
# 5868 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {
        return 
# 5869 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5869 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    if (ctx == 
# 5874 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 5874 "project/nginx/src/http/ngx_http_upstream.c"
                  ) {
        return 
# 5875 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5875 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    if (ctx->srv_conf == 
# 5884 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 5884 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
        return 
# 5885 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5885 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    if (ctx->loc_conf == 
# 5896 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 5896 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
        return 
# 5897 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5897 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }

    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 5901 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          0x50545448
# 5901 "project/nginx/src/http/ngx_http_upstream.c"
                                                         ) {
            continue;
        }
        ...
        if (module->create_srv_conf) {
            ...
            if (mconf == 
# 5909 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 5909 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
                return 
# 5910 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      (void *) -1
# 5910 "project/nginx/src/http/ngx_http_upstream.c"
                                    ;
            }
        ...
        if (module->create_loc_conf) {
            ...
            if (mconf == 
# 5918 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 5918 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
                return 
# 5919 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      (void *) -1
# 5919 "project/nginx/src/http/ngx_http_upstream.c"
                                    ;
            }
    ...
    if (uscf->servers == 
# 5928 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                        ((void *)0)
# 5928 "project/nginx/src/http/ngx_http_upstream.c"
                            ) {
        return 
# 5929 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5929 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    cf->ctx = ctx;
    cf->cmd_type = 
# 5937 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0x10000000
# 5937 "project/nginx/src/http/ngx_http_upstream.c"
                                   ;

    rv = ngx_conf_parse(cf, 
# 5939 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           ((void *)0)
# 5939 "project/nginx/src/http/ngx_http_upstream.c"
                               );

    *cf = pcf;

    if (rv != 
# 5943 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5943 "project/nginx/src/http/ngx_http_upstream.c"
                        ) {
        return rv;
    }
    ...
    if (uscf->servers->nelts == 0) {
        ngx_conf_log_error(
# 5948 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          1
# 5948 "project/nginx/src/http/ngx_http_upstream.c"
                                       , cf, 0,
                           "no servers are inside upstream");
        return 
# 5950 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5950 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
...
ngx_http_upstream_server(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (us == 
# 5970 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 5970 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        return 
# 5971 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 5971 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }

    
# 5974 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 5974 "project/nginx/src/http/ngx_http_upstream.c"
   us
# 5974 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 5974 "project/nginx/src/http/ngx_http_upstream.c"
...
# 5974 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    for (i = 2; i < cf->args->nelts; i++) {
        ...
        if (
# 5985 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strncmp((const char *) 
# 5985 "project/nginx/src/http/ngx_http_upstream.c"
           value[i].data
# 5985 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 5985 "project/nginx/src/http/ngx_http_upstream.c"
...
# 5985 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (!(uscf->flags & 
# 5987 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0x0002
# 5987 "project/nginx/src/http/ngx_http_upstream.c"
                                                       )) {
                goto not_supported;
            }
            ...
            if (weight == 
# 5993 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                         -1 
# 5993 "project/nginx/src/http/ngx_http_upstream.c"
                                   || weight == 0) {
                goto invalid;
            }
        ...
        if (
# 6000 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strncmp((const char *) 
# 6000 "project/nginx/src/http/ngx_http_upstream.c"
           value[i].data
# 6000 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6000 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6000 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (!(uscf->flags & 
# 6002 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0x0100
# 6002 "project/nginx/src/http/ngx_http_upstream.c"
                                                          )) {
                goto not_supported;
            }
            ...
            if (max_conns == 
# 6008 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            -1
# 6008 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
                goto invalid;
            }
        ...
        if (
# 6015 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strncmp((const char *) 
# 6015 "project/nginx/src/http/ngx_http_upstream.c"
           value[i].data
# 6015 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6015 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6015 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (!(uscf->flags & 
# 6017 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0x0004
# 6017 "project/nginx/src/http/ngx_http_upstream.c"
                                                          )) {
                goto not_supported;
            }
            ...
            if (max_fails == 
# 6023 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            -1
# 6023 "project/nginx/src/http/ngx_http_upstream.c"
                                     ) {
                goto invalid;
            }
        ...
        if (
# 6030 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strncmp((const char *) 
# 6030 "project/nginx/src/http/ngx_http_upstream.c"
           value[i].data
# 6030 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6030 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6030 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (!(uscf->flags & 
# 6032 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0x0008
# 6032 "project/nginx/src/http/ngx_http_upstream.c"
                                                             )) {
                goto not_supported;
            }
            ...
            if (fail_timeout == (time_t) 
# 6041 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                        -1
# 6041 "project/nginx/src/http/ngx_http_upstream.c"
                                                 ) {
                goto invalid;
            }
        ...
        if (
# 6048 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strcmp((const char *) 
# 6048 "project/nginx/src/http/ngx_http_upstream.c"
           value[i].data
# 6048 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6048 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6048 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (!(uscf->flags & 
# 6050 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0x0020
# 6050 "project/nginx/src/http/ngx_http_upstream.c"
                                                       )) {
                goto not_supported;
            }
        ...
        if (
# 6059 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strcmp((const char *) 
# 6059 "project/nginx/src/http/ngx_http_upstream.c"
           value[i].data
# 6059 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6059 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6059 "project/nginx/src/http/ngx_http_upstream.c"
            ...
            if (!(uscf->flags & 
# 6061 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               0x0010
# 6061 "project/nginx/src/http/ngx_http_upstream.c"
                                                     )) {
                goto not_supported;
            }
...
# 6073 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 6073 "project/nginx/src/http/ngx_http_upstream.c"
   &u
# 6073 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 6073 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6078 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                      0
# 6078 "project/nginx/src/http/ngx_http_upstream.c"
                                            ) {
        if (u.err) {
            ngx_conf_log_error(
# 6080 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6080 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
                               "%s in upstream \"%V\"", u.err, &u.url);
        }

        return 
# 6084 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 6084 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    return 
# 6095 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((void *)0)
# 6095 "project/nginx/src/http/ngx_http_upstream.c"
                     ;

invalid:

    ngx_conf_log_error(
# 6099 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      1
# 6099 "project/nginx/src/http/ngx_http_upstream.c"
                                   , cf, 0,
                       "invalid parameter \"%V\"", &value[i]);

    return 
# 6102 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (void *) -1
# 6102 "project/nginx/src/http/ngx_http_upstream.c"
                        ;

not_supported:

    ngx_conf_log_error(
# 6106 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      1
# 6106 "project/nginx/src/http/ngx_http_upstream.c"
                                   , cf, 0,
                       "balancing method does not support parameter \"%V\"",
                       &value[i]);

    return 
# 6110 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          (void *) -1
# 6110 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
}
...
ngx_http_upstream_add(ngx_conf_t *cf, ngx_url_t *u, ngx_uint_t flags)
{
    ...
    if (!(flags & 
# 6122 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 0x0001
# 6122 "project/nginx/src/http/ngx_http_upstream.c"
                                         )) {

        if (ngx_parse_url(cf->pool, u) != 
# 6124 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                         0
# 6124 "project/nginx/src/http/ngx_http_upstream.c"
                                               ) {
            if (u->err) {
                ngx_conf_log_error(
# 6126 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                  1
# 6126 "project/nginx/src/http/ngx_http_upstream.c"
                                               , cf, 0,
                                   "%s in upstream \"%V\"", u->err, &u->url);
            }

            return 
# 6130 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 6130 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
        }
    }

    umcf = 
# 6134 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 6134 "project/nginx/src/http/ngx_http_upstream.c"
          cf
# 6134 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ->ctx)->main_conf[
# 6134 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6134 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    for (i = 0; i < umcf->upstreams.nelts; i++) {
        ...
        if ((flags & 
# 6147 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    0x0001
# 6147 "project/nginx/src/http/ngx_http_upstream.c"
                                            )
             && (uscfp[i]->flags & 
# 6148 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                  0x0001
# 6148 "project/nginx/src/http/ngx_http_upstream.c"
                                                          ))
        {
            ngx_conf_log_error(
# 6150 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6150 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
                               "duplicate upstream \"%V\"", &u->host);
            return 
# 6152 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 6152 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
        }

        if ((uscfp[i]->flags & 
# 6155 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              0x0001
# 6155 "project/nginx/src/http/ngx_http_upstream.c"
                                                      ) && !u->no_port) {
            ngx_conf_log_error(
# 6156 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6156 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
                               "upstream \"%V\" may not have port %d",
                               &u->host, u->port);
            return 
# 6159 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 6159 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
        }

        if ((flags & 
# 6162 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    0x0001
# 6162 "project/nginx/src/http/ngx_http_upstream.c"
                                            ) && !uscfp[i]->no_port) {
            
# 6163 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           if ((
# 6163 "project/nginx/src/http/ngx_http_upstream.c"
           cf->log
# 6163 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 6163 "project/nginx/src/http/ngx_http_upstream.c"
           cf->log
# 6163 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , 
# 6163 "project/nginx/src/http/ngx_http_upstream.c"
           0, "upstream \"%V\" may not have port %d in %s:%ui", &u->host, uscfp[i]->port, uscfp[i]->file_name, uscfp[i]->line
# 6163 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           )


                                                              
# 6166 "project/nginx/src/http/ngx_http_upstream.c"
                                                             ;
            return 
# 6167 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 6167 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
        }
        ...
        if (flags & 
# 6176 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                   0x0001
# 6176 "project/nginx/src/http/ngx_http_upstream.c"
                                           ) {
            uscfp[i]->flags = flags;
            uscfp[i]->port = 0;
        }
    ...
    if (uscf == 
# 6185 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ((void *)0)
# 6185 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {
        return 
# 6186 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 6186 "project/nginx/src/http/ngx_http_upstream.c"
                  ;
    }
    ...
    if (u->naddrs == 1 && (u->port || u->family == 
# 6196 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                  1
# 6196 "project/nginx/src/http/ngx_http_upstream.c"
                                                         )) {
        uscf->servers = ngx_array_create(cf->pool, 1,
                                         sizeof(ngx_http_upstream_server_t));
        if (uscf->servers == 
# 6199 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                            ((void *)0)
# 6199 "project/nginx/src/http/ngx_http_upstream.c"
                                ) {
            return 
# 6200 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 6200 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
        }

        us = ngx_array_push(uscf->servers);
        if (us == 
# 6204 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 6204 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
            return 
# 6205 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  ((void *)0)
# 6205 "project/nginx/src/http/ngx_http_upstream.c"
                      ;
        }

        
# 6208 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       (void) __builtin___memset_chk (
# 6208 "project/nginx/src/http/ngx_http_upstream.c"
       us
# 6208 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 0, 
# 6208 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6208 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    if (uscfp == 
# 6215 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                ((void *)0)
# 6215 "project/nginx/src/http/ngx_http_upstream.c"
                    ) {
        return 
# 6216 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 6216 "project/nginx/src/http/ngx_http_upstream.c"
                  ;
    }
    ...
    void *conf)
{
    ...
    if (*plocal != 
# 6239 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6239 "project/nginx/src/http/ngx_http_upstream.c"
                                    ) {
        return "is duplicate";
    }
    ...
    if (cf->args->nelts == 2 && 
# 6245 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               strcmp((const char *) 
# 6245 "project/nginx/src/http/ngx_http_upstream.c"
                               value[1].data
# 6245 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                               , (const char *) 
# 6245 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6245 "project/nginx/src/http/ngx_http_upstream.c"
                                                                == 0) {
        *plocal = 
# 6246 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 6246 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
        return 
# 6247 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 6247 "project/nginx/src/http/ngx_http_upstream.c"
                         ;
    }

    
# 6250 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 6250 "project/nginx/src/http/ngx_http_upstream.c"
   &ccv
# 6250 "project/nginx/src/http/ngx_http_upstream.c" 3 4
   , 0, 
# 6250 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6256 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                               0
# 6256 "project/nginx/src/http/ngx_http_upstream.c"
                                                     ) {
        return 
# 6257 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 6257 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }

    local = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_local_t));
    if (local == 
# 6261 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                ((void *)0)
# 6261 "project/nginx/src/http/ngx_http_upstream.c"
                    ) {
        return 
# 6262 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 6262 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    *plocal = local;
    ...
    if (cv.lengths) {
        ...
        if (local->value == 
# 6269 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                           ((void *)0)
# 6269 "project/nginx/src/http/ngx_http_upstream.c"
                               ) {
            return 
# 6270 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6270 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
        ...
        *local->value = cv;
        ...
        if (local->addr == 
# 6277 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                          ((void *)0)
# 6277 "project/nginx/src/http/ngx_http_upstream.c"
                              ) {
            return 
# 6278 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6278 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
        ...
        switch (rc) {
        case 
# 6285 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            0
# 6285 "project/nginx/src/http/ngx_http_upstream.c"
                  :
            local->addr->name = value[1];
            break;

        case 
# 6289 "project/nginx/src/http/ngx_http_upstream.c" 3 4
            -5
# 6289 "project/nginx/src/http/ngx_http_upstream.c"
                        :
            ngx_conf_log_error(
# 6290 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6290 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
        ...
        default:
            return 
# 6295 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6295 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
    }
    ...
    if (cf->args->nelts > 2) {
        if (
# 6300 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strcmp((const char *) 
# 6300 "project/nginx/src/http/ngx_http_upstream.c"
           value[2].data
# 6300 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6300 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6300 "project/nginx/src/http/ngx_http_upstream.c"
                                                    == 0) {
# 6310 "project/nginx/src/http/ngx_http_upstream.c"
            ngx_conf_log_error(
# 6310 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6310 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
            ...
            ngx_conf_log_error(
# 6315 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6315 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 6317 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6317 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
    }

    return 
# 6321 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((void *)0)
# 6321 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
}
    ...
    ngx_http_upstream_local_t *local)
{
    ...
    if (local == 
# 6333 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                ((void *)0)
# 6333 "project/nginx/src/http/ngx_http_upstream.c"
                    ) {
        u->peer.local = 
# 6334 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                       ((void *)0)
# 6334 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        return 
# 6335 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 6335 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    if (local->value == 
# 6342 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                       ((void *)0)
# 6342 "project/nginx/src/http/ngx_http_upstream.c"
                           ) {
        u->peer.local = local->addr;
        return 
# 6344 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 6344 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    if (ngx_http_complex_value(r, local->value, &val) != 
# 6347 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                        0
# 6347 "project/nginx/src/http/ngx_http_upstream.c"
                                                              ) {
        return 
# 6348 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 6348 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }

    if (val.len == 0) {
        return 
# 6352 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 6352 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }

    addr = ngx_palloc(r->pool, sizeof(ngx_addr_t));
    if (addr == 
# 6356 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ((void *)0)
# 6356 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {
        return 
# 6357 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 6357 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }

    rc = ngx_parse_addr_port(r->pool, addr, val.data, val.len);
    if (rc == 
# 6361 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             -1
# 6361 "project/nginx/src/http/ngx_http_upstream.c"
                      ) {
        return 
# 6362 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 6362 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }

    if (rc != 
# 6365 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             0
# 6365 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {
        
# 6366 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       if ((
# 6366 "project/nginx/src/http/ngx_http_upstream.c"
       r->connection->log
# 6366 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 6366 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6366 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       , 
# 6366 "project/nginx/src/http/ngx_http_upstream.c"
       0, "invalid local address \"%V\"", &val
# 6366 "project/nginx/src/http/ngx_http_upstream.c" 3 4
       )
                                                           
# 6367 "project/nginx/src/http/ngx_http_upstream.c"
                                                          ;
        return 
# 6368 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              0
# 6368 "project/nginx/src/http/ngx_http_upstream.c"
                    ;
    }
    ...
    return 
# 6374 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 6374 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
    ...
    void *conf)
{
    ...
    if (*a == 
# 6390 "project/nginx/src/http/ngx_http_upstream.c" 3 4
             ((void *)0)
# 6390 "project/nginx/src/http/ngx_http_upstream.c"
                 ) {
        *a = ngx_array_create(cf->pool, 4, sizeof(ngx_http_upstream_param_t));
        if (*a == 
# 6392 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 6392 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
            return 
# 6393 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6393 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
    }
    ...
    if (param == 
# 6398 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                ((void *)0)
# 6398 "project/nginx/src/http/ngx_http_upstream.c"
                    ) {
        return 
# 6399 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 6399 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    if (cf->args->nelts == 4) {
        if (
# 6409 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           strcmp((const char *) 
# 6409 "project/nginx/src/http/ngx_http_upstream.c"
           value[3].data
# 6409 "project/nginx/src/http/ngx_http_upstream.c" 3 4
           , (const char *) 
# 6409 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6409 "project/nginx/src/http/ngx_http_upstream.c"
                                                     != 0) {
            ngx_conf_log_error(
# 6410 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                              1
# 6410 "project/nginx/src/http/ngx_http_upstream.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[3]);
            return 
# 6412 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6412 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
    ...
    return 
# 6418 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((void *)0)
# 6418 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
}
...
# 6432 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             (void *) -1
        
# 6433 "project/nginx/src/http/ngx_http_upstream.c"
       && conf->pass_headers == 
# 6433 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                (void *) -1
# 6433 "project/nginx/src/http/ngx_http_upstream.c"
                                                  )
    {
        ...
        if (conf->hide_headers_hash.buckets) {
            return 
# 6441 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  0
# 6441 "project/nginx/src/http/ngx_http_upstream.c"
                        ;
        }

    } else {
        if (conf->hide_headers == 
# 6445 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 (void *) -1
# 6445 "project/nginx/src/http/ngx_http_upstream.c"
                                                   ) {
            conf->hide_headers = prev->hide_headers;
        }

        if (conf->pass_headers == 
# 6449 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 (void *) -1
# 6449 "project/nginx/src/http/ngx_http_upstream.c"
                                                   ) {
            conf->pass_headers = prev->pass_headers;
        }
    }
    ...
    if (ngx_array_init(&hide_headers, cf->temp_pool, 4, sizeof(ngx_hash_key_t))
        != 
# 6455 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 6455 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 6457 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 6457 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    for (h = default_hide_headers; h->len; h++) {
        ...
        if (hk == 
# 6462 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 6462 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
            return 
# 6463 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  -1
# 6463 "project/nginx/src/http/ngx_http_upstream.c"
                           ;
        }
    ...
    if (conf->hide_headers != 
# 6471 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             (void *) -1
# 6471 "project/nginx/src/http/ngx_http_upstream.c"
                                               ) {
        ...
        for (i = 0; i < conf->hide_headers->nelts; i++) {
            ...
            hk = ngx_array_push(&hide_headers);
            if (hk == 
# 6486 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     ((void *)0)
# 6486 "project/nginx/src/http/ngx_http_upstream.c"
                         ) {
                return 
# 6487 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      -1
# 6487 "project/nginx/src/http/ngx_http_upstream.c"
                               ;
            }
    ...
    if (conf->pass_headers != 
# 6500 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                             (void *) -1
# 6500 "project/nginx/src/http/ngx_http_upstream.c"
                                               ) {
        ...
        for (i = 0; i < conf->pass_headers->nelts; i++) {
            for (j = 0; j < hide_headers.nelts; j++) {
                ...
                if (hk[j].key.data == 
# 6508 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                     ((void *)0)
# 6508 "project/nginx/src/http/ngx_http_upstream.c"
                                         ) {
                    continue;
                }
                ...
                if (ngx_strcasecmp(h[i].data, hk[j].key.data) == 0) {
                    hk[j].key.data = 
# 6513 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                    ((void *)0)
# 6513 "project/nginx/src/http/ngx_http_upstream.c"
                                        ;
                    break;
                }
            }
    ...
    hash->pool = cf->pool;
    hash->temp_pool = 
# 6523 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                     ((void *)0)
# 6523 "project/nginx/src/http/ngx_http_upstream.c"
                         ;

    if (ngx_hash_init(hash, hide_headers.elts, hide_headers.nelts) != 
# 6525 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                     0
# 6525 "project/nginx/src/http/ngx_http_upstream.c"
                                                                           ) {
        return 
# 6526 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              -1
# 6526 "project/nginx/src/http/ngx_http_upstream.c"
                       ;
    }
    ...
    if (prev->hide_headers_hash.buckets == 
# 6534 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                          ((void *)0)
        
# 6535 "project/nginx/src/http/ngx_http_upstream.c"
       && conf->hide_headers == prev->hide_headers
        && conf->pass_headers == prev->pass_headers)
    {
    ...
    return 
# 6541 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 6541 "project/nginx/src/http/ngx_http_upstream.c"
                ;
}
...
ngx_http_upstream_create_main_conf(ngx_conf_t *cf)
{
    ...
    if (umcf == 
# 6551 "project/nginx/src/http/ngx_http_upstream.c" 3 4
               ((void *)0)
# 6551 "project/nginx/src/http/ngx_http_upstream.c"
                   ) {
        return 
# 6552 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 6552 "project/nginx/src/http/ngx_http_upstream.c"
                  ;
    }
    ...
    if (ngx_array_init(&umcf->upstreams, cf->pool, 4,
        ...
        != 
# 6557 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 6557 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 6559 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              ((void *)0)
# 6559 "project/nginx/src/http/ngx_http_upstream.c"
                  ;
    }
...
ngx_http_upstream_init_main_conf(ngx_conf_t *cf, void *conf)
{
    ...
    for (i = 0; i < umcf->upstreams.nelts; i++) {
        ...
        if (init(cf, uscfp[i]) != 
# 6586 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                 0
# 6586 "project/nginx/src/http/ngx_http_upstream.c"
                                       ) {
            return 
# 6587 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6587 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
    }
    ...
    if (ngx_array_init(&headers_in, cf->temp_pool, 32, sizeof(ngx_hash_key_t))
        != 
# 6595 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          0
# 6595 "project/nginx/src/http/ngx_http_upstream.c"
                )
    {
        return 
# 6597 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 6597 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }
    ...
    for (header = ngx_http_upstream_headers_in; header->name.len; header++) {
        ...
        if (hk == 
# 6602 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                 ((void *)0)
# 6602 "project/nginx/src/http/ngx_http_upstream.c"
                     ) {
            return 
# 6603 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                  (void *) -1
# 6603 "project/nginx/src/http/ngx_http_upstream.c"
                                ;
        }
    ...
    hash.max_size = 512;
    hash.bucket_size = 
# 6614 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      (((
# 6614 "project/nginx/src/http/ngx_http_upstream.c"
                      64
# 6614 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                      ) + (
# 6614 "project/nginx/src/http/ngx_http_upstream.c"
...
# 6614 "project/nginx/src/http/ngx_http_upstream.c"
    ...
    hash.pool = cf->pool;
    hash.temp_pool = 
# 6617 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                    ((void *)0)
# 6617 "project/nginx/src/http/ngx_http_upstream.c"
                        ;

    if (ngx_hash_init(&hash, headers_in.elts, headers_in.nelts) != 
# 6619 "project/nginx/src/http/ngx_http_upstream.c" 3 4
                                                                  0
# 6619 "project/nginx/src/http/ngx_http_upstream.c"
                                                                        ) {
        return 
# 6620 "project/nginx/src/http/ngx_http_upstream.c" 3 4
              (void *) -1
# 6620 "project/nginx/src/http/ngx_http_upstream.c"
                            ;
    }

    return 
# 6623 "project/nginx/src/http/ngx_http_upstream.c" 3 4
          ((void *)0)
# 6623 "project/nginx/src/http/ngx_http_upstream.c"
                     ;
}
