# 0 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
...
# 9 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 2
...
# 11 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 2
...
# 16 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
ngx_chain_t *
...
# 37 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                      (uint32_t) 0xffffffff 
# 37 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                           - ngx_pagesize)) {
        limit = 
# 38 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
               (uint32_t) 0xffffffff 
# 38 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                    - ngx_pagesize;
    }
    ...
    vec.nalloc = 
# 50 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                ((
# 50 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                64 
# 50 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                > 
# 50 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
...
# 50 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
    ...
    for ( ;; ) {
        prev = 
# 54 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
              ((void *)0)
# 54 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                  ;
        wsabuf = 
# 55 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                ((void *)0)
# 55 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                    ;
        prev_send = send;
        ...
        for (cl = in; cl && send < limit; cl = cl->next) {
            ...
            if (
# 64 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
               (((
# 64 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
               cl->buf
# 64 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
               )->flush || (
# 64 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
...
# 64 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
            ...
            if (prev == cl->buf->pos) {
                ...
                if (wsabuf == 
# 83 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                             ((void *)0)
# 83 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                 ) {
                    return 
# 84 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                          (ngx_chain_t *) -1
# 84 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                         ;
                }
        ...
        rc = WSASend(c->fd, vec.elts, vec.nelts, &sent, 0, 
# 97 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                                          ((void *)0)
# 97 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                              , 
# 97 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                                                ((void *)0)
# 97 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
        ...
        if (rc == -1) {
            err = 
# 100 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                 (*__error())
# 100 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                          ;
            ...
            if (err == WSAEWOULDBLOCK) {
                ...
                return 
# 109 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                      (ngx_chain_t *) -1
# 109 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                     ;
            }
        }
        ...
        if (send >= limit || in == 
# 125 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                  ((void *)0)
# 125 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                      ) {
            return in;
        }
    }
...
ngx_overlapped_wsasend_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    if (!wev->complete) {
        ...
        if (limit == 0 || limit > (off_t) (
# 161 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                          (uint32_t) 0xffffffff 
# 161 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                               - ngx_pagesize))
        {
            limit = 
# 163 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                   (uint32_t) 0xffffffff 
# 163 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                        - ngx_pagesize;
        }
        ...
        vec.size = sizeof(WSABUF);
        vec.nalloc = 
# 174 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                    ((
# 174 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                    64 
# 174 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                    > 
# 174 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
...
# 174 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
        ...
        send = 0;
        prev = 
# 178 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
              ((void *)0)
# 178 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                  ;
        wsabuf = 
# 179 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                ((void *)0)
# 179 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                    ;
        ...
        for (cl = in; cl && send < limit; cl = cl->next) {
            ...
            if (
# 185 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
               (((
# 185 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
               cl->buf
# 185 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
               )->flush || (
# 185 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
...
# 185 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
            ...
            if (prev == cl->buf->pos) {
                ...
                wsabuf = ngx_array_push(&vec);
                if (wsabuf == 
# 204 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                             ((void *)0)
# 204 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                 ) {
                    return 
# 205 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                          (ngx_chain_t *) -1
# 205 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                         ;
                }
...
# 217 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
       (void) __builtin___memset_chk (
# 217 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
       ovlp
# 217 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
       , 0, 
# 217 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
...
# 217 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
        ...
        rc = WSASend(c->fd, vec.elts, vec.nelts, &sent, 0, ovlp, 
# 219 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                                                ((void *)0)
# 219 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                                    );
        ...
        if (rc == -1) {
            err = 
# 224 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                 (*__error())
# 224 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                          ;
            ...
            if (err == WSA_IO_PENDING) {
                ...
                ngx_connection_error(c, err, "WSASend() failed");
                return 
# 235 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                      (ngx_chain_t *) -1
# 235 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                     ;
            }

        } else if (ngx_event_flags & 
# 238 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                    0x00000200
# 238 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                      ) {
        ...
        if (ngx_event_flags & 
# 260 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                             0x00000200
# 260 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                               ) {
            if (wev->ovlp.error) {
                ngx_connection_error(c, wev->ovlp.error, "WSASend() failed");
                return 
# 263 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                      (ngx_chain_t *) -1
# 263 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                     ;
            }
            ...
            if (WSAGetOverlappedResult(c->fd, (LPWSAOVERLAPPED) &wev->ovlp,
                                       &sent, 0, 
# 270 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                                ((void *)0)
# 270 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                    )
                == 0)
            {
                ngx_connection_error(c, 
# 273 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                                       (*__error())
# 273 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                                       ,
                               "WSASend() or WSAGetOverlappedResult() failed");

                return 
# 276 "project/nginx/src/os/win32/ngx_wsasend_chain.c" 3 4
                      (ngx_chain_t *) -1
# 276 "project/nginx/src/os/win32/ngx_wsasend_chain.c"
                                     ;
            }
        }
    }
