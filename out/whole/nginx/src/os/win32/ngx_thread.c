# 0 "project/nginx/src/os/win32/ngx_thread.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/win32/ngx_thread.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_thread.c" 2



# 12 "project/nginx/src/os/win32/ngx_thread.c"
ngx_err_t
    ...
    ngx_thread_value_t (__stdcall *func)(void *arg), void *arg, ngx_log_t *log)
{
    ...
    *tid = CreateThread(
# 19 "project/nginx/src/os/win32/ngx_thread.c" 3 4
                       ((void *)0)
# 19 "project/nginx/src/os/win32/ngx_thread.c"
                           , 0, func, arg, 0, &id);

    if (*tid != 
# 21 "project/nginx/src/os/win32/ngx_thread.c" 3 4
               ((void *)0)
# 21 "project/nginx/src/os/win32/ngx_thread.c"
                   ) {
        
# 22 "project/nginx/src/os/win32/ngx_thread.c" 3 4
       if ((
# 22 "project/nginx/src/os/win32/ngx_thread.c"
       log
# 22 "project/nginx/src/os/win32/ngx_thread.c" 3 4
...
# 23 "project/nginx/src/os/win32/ngx_thread.c"
                                                        ;
        return 0;
    }

    err = 
# 27 "project/nginx/src/os/win32/ngx_thread.c" 3 4
         (*__error())
# 27 "project/nginx/src/os/win32/ngx_thread.c"
                  ;
    
# 28 "project/nginx/src/os/win32/ngx_thread.c" 3 4
   if ((
# 28 "project/nginx/src/os/win32/ngx_thread.c"
   log
# 28 "project/nginx/src/os/win32/ngx_thread.c" 3 4
