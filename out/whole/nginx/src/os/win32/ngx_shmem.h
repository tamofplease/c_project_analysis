# 0 "project/nginx/src/os/win32/ngx_shmem.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/win32/ngx_shmem.h"
...
# 13 "project/nginx/src/os/win32/ngx_shmem.h" 2
...
# 14 "project/nginx/src/os/win32/ngx_shmem.h" 2



# 16 "project/nginx/src/os/win32/ngx_shmem.h"
typedef struct {
    u_char *addr;
    size_t size;
    ngx_str_t name;
