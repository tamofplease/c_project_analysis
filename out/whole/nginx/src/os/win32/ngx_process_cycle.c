# 0 "project/nginx/src/os/win32/ngx_process_cycle.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 9 "project/nginx/src/os/win32/ngx_process_cycle.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_process_cycle.c" 2
...
# 11 "project/nginx/src/os/win32/ngx_process_cycle.c" 2




# 14 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
ngx_master_process_cycle(ngx_cycle_t *cycle)
{
    ...
    if (ngx_process == 
# 76 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                      3
# 76 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                        ) {
    ...
    ngx_master_process_event = CreateEvent(
# 87 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                          ((void *)0)
# 87 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                              , 1, 0,
                                           ngx_master_process_event_name);
    if (ngx_master_process_event == 
# 89 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                   ((void *)0)
# 89 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                       ) {
        
# 90 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 90 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 90 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
...
# 92 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                   ;
        exit(2);
    }

    if (ngx_create_signal_events(cycle) != 
# 96 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                          0
# 96 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                ) {
        exit(2);
    }
    ...
    ngx_cache_manager_mutex = CreateMutex(
# 103 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                         ((void *)0)
# 103 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                             , 0,
                                          ngx_cache_manager_mutex_name);
    if (ngx_cache_manager_mutex == 
# 105 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 105 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                      ) {
        
# 106 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 106 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 106 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 106 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 107 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                             ;
        exit(2);
    }
    ...
    if (ngx_start_worker_processes(cycle, 
# 119 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                         -3
# 119 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                            ) == 0) {
        exit(2);
    }
    ...
    for ( ;; ) {
        ...
        err = 
# 141 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
             (*__error())
# 141 "project/nginx/src/os/win32/ngx_process_cycle.c"
                      ;
        ngx_time_update();
...
# 148 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 148 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 148 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
...
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c"
               cycle->log
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "ResetEvent(\"%s\") failed", ngx_stop_event_name
# 151 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )
                                                                               
# 152 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                              ;
            }
...
# 166 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 166 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 166 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 166 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c"
               cycle->log
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "ResetEvent(\"%s\") failed", ngx_quit_event_name
# 169 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )
                                                                               
# 170 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                              ;
            }
...
# 180 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 180 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 180 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 180 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c"
               cycle->log
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "ResetEvent(\"%s\") failed", ngx_reopen_event_name
# 183 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )

                                                    
# 185 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                   ;
            }
...
# 195 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 195 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 195 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 195 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c"
               cycle->log
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "ResetEvent(\"%s\") failed", ngx_reload_event_name
# 198 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )

                                                    
# 200 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                   ;
            }

            cycle = ngx_init_cycle(cycle);
            if (cycle == 
# 204 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                        ((void *)0)
# 204 "project/nginx/src/os/win32/ngx_process_cycle.c"
                            ) {
            ...
            if (ngx_start_worker_processes(cycle, 
# 213 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                 -4
# 213 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                         )) {
...
# 240 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 240 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 240 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 240 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 241 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                           ;
...
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       , 
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c"
       0, "WaitForMultipleObjects() returned unexpected value %ul", ev
# 246 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )
                                                                         
# 247 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                        ;
    }
}
...
# 257 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                             [
# 257 "project/nginx/src/os/win32/ngx_process_cycle.c"
                             ngx_core_module
# 257 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                             .index]
# 257 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 261 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 261 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 261 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 261 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 262 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                ;
        }
...
# 269 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 269 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 269 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 269 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 270 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                      ;
    }
}
...
# 302 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   if ((
# 302 "project/nginx/src/os/win32/ngx_process_cycle.c"
   ngx_cycle->log
# 302 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 302 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 302 "project/nginx/src/os/win32/ngx_process_cycle.c"
    ...
    if (ngx_stop_event == 
# 304 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                         ((void *)0)
# 304 "project/nginx/src/os/win32/ngx_process_cycle.c"
                             ) {
        return 1;
    }
...
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c"
       ngx_cycle->log
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       , 
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c"
       0, "SetEvent(\"%s\") failed", ngx_stop_event_name
# 309 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )
                                                                     
# 310 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                    ;
    }
...
ngx_create_signal_events(ngx_cycle_t *cycle)
{
    ...
    ngx_stop_event = CreateEvent(
# 323 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                ((void *)0)
# 323 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                    , 1, 0, ngx_stop_event_name);
    if (ngx_stop_event == 
# 324 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                         ((void *)0)
# 324 "project/nginx/src/os/win32/ngx_process_cycle.c"
                             ) {
        
# 325 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 325 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 325 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 325 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 326 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                       ;
        return 
# 327 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
              -1
# 327 "project/nginx/src/os/win32/ngx_process_cycle.c"
                       ;
    }
    ...
    ngx_quit_event = CreateEvent(
# 334 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                ((void *)0)
# 334 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                    , 1, 0, ngx_quit_event_name);
    if (ngx_quit_event == 
# 335 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                         ((void *)0)
# 335 "project/nginx/src/os/win32/ngx_process_cycle.c"
                             ) {
        
# 336 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 336 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 336 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 336 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 337 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                       ;
        return 
# 338 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
              -1
# 338 "project/nginx/src/os/win32/ngx_process_cycle.c"
                       ;
    }
    ...
    ngx_reopen_event = CreateEvent(
# 345 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 345 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                      , 1, 0, ngx_reopen_event_name);
    if (ngx_reopen_event == 
# 346 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                           ((void *)0)
# 346 "project/nginx/src/os/win32/ngx_process_cycle.c"
                               ) {
        
# 347 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 347 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 347 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 347 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 348 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                         ;
        return 
# 349 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
              -1
# 349 "project/nginx/src/os/win32/ngx_process_cycle.c"
                       ;
    }
    ...
    ngx_reload_event = CreateEvent(
# 356 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 356 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                      , 1, 0, ngx_reload_event_name);
    if (ngx_reload_event == 
# 357 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                           ((void *)0)
# 357 "project/nginx/src/os/win32/ngx_process_cycle.c"
                               ) {
        
# 358 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 358 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 358 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 358 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 359 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                         ;
        return 
# 360 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
              -1
# 360 "project/nginx/src/os/win32/ngx_process_cycle.c"
                       ;
    }

    return 
# 363 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
          0
# 363 "project/nginx/src/os/win32/ngx_process_cycle.c"
                ;
}
...
# 373 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   if ((
# 373 "project/nginx/src/os/win32/ngx_process_cycle.c"
   cycle->log
# 373 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 373 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 373 "project/nginx/src/os/win32/ngx_process_cycle.c"
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 375 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                             [
# 375 "project/nginx/src/os/win32/ngx_process_cycle.c"
                             ngx_core_module
# 375 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                             .index]
# 375 "project/nginx/src/os/win32/ngx_process_cycle.c"
    ...
    for (n = 0; n < ccf->worker_processes; n++) {
        if (ngx_spawn_process(cycle, "worker", type) == 
# 378 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                       -1
# 378 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                      ) {
            break;
        }
    }
...
ngx_reopen_worker_processes(ngx_cycle_t *cycle)
{
    ...
    for (n = 0; n < ngx_last_process; n++) {
        ...
        if (ngx_processes[n].handle == 
# 394 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                      ((void *)0)
# 394 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                          ) {
            continue;
        }
...
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           , (*__error())
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c"
           , "SetEvent(\"%s\") failed", ngx_processes[n].reopen_event
# 399 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )

                                                        
# 401 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                       ;
        }
    }
}
...
ngx_quit_worker_processes(ngx_cycle_t *cycle, ngx_uint_t old)
{
    ...
    for (n = 0; n < ngx_last_process; n++) {
        ...
        if (ngx_processes[n].handle == 
# 427 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                      ((void *)0)
# 427 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                          ) {
            continue;
        }
...
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           , (*__error())
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c"
           , "SetEvent(\"%s\") failed", ngx_processes[n].quit_event
# 432 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )

                                                      
# 434 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                     ;
        }
...
ngx_terminate_worker_processes(ngx_cycle_t *cycle)
{
    ...
    for (n = 0; n < ngx_last_process; n++) {
        ...
        if (ngx_processes[n].handle == 
# 449 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                      ((void *)0)
# 449 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                          ) {
            continue;
        }
...
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           , (*__error())
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c"
           , "TerminateProcess(\"%p\") failed", ngx_processes[n].handle
# 454 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )

                                                  
# 456 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                 ;
        }
...
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           , (*__error())
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c"
           , "GetExitCodeProcess(%P) failed", ngx_processes[n].pid
# 482 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )

                                               
# 484 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                              ;
        }

        
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 6) ngx_log_error_core(6, 
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       , 
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c"
       0, "%s process %P exited with code %Xl", ngx_processes[n].name, ngx_processes[n].pid, code
# 487 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )

                                                                        
# 489 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                       ;
...
# 496 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                 ((void *)0)
# 496 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                     ;
        ngx_processes[n].term = 
# 497 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                               ((void *)0)
# 497 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                   ;
        ngx_processes[n].quit = 
# 498 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                               ((void *)0)
# 498 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                   ;
        ngx_processes[n].reopen = 
# 499 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                 ((void *)0)
# 499 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                     ;
        ...
        if (!ngx_processes[n].exiting && !ngx_terminate && !ngx_quit) {
            ...
            if (ngx_spawn_process(cycle, ngx_processes[n].name, n)
                == 
# 504 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                  -1
# 504 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                 )
            {
                
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c"
               cycle->log
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "could not respawn %s", ngx_processes[n].name
# 506 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )
                                                                            
# 507 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                           ;
...
# 518 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   if ((
# 518 "project/nginx/src/os/win32/ngx_process_cycle.c"
   cycle->log
# 518 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   )->log_level >= 2) ngx_log_error_core(2, 
# 518 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 555 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   if ((
# 555 "project/nginx/src/os/win32/ngx_process_cycle.c"
   cycle->log
# 555 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 555 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 586 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                           ((void *)0)
# 586 "project/nginx/src/os/win32/ngx_process_cycle.c"
                               , 1, 0, wtevn);
    if (events[0] == 
# 587 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                    ((void *)0)
# 587 "project/nginx/src/os/win32/ngx_process_cycle.c"
                        ) {
        
# 588 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 588 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 588 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 588 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 589 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                         ;
        goto failed;
    }
...
# 594 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                           ((void *)0)
# 594 "project/nginx/src/os/win32/ngx_process_cycle.c"
                               , 1, 0, wqevn);
    if (events[1] == 
# 595 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                    ((void *)0)
# 595 "project/nginx/src/os/win32/ngx_process_cycle.c"
                        ) {
        
# 596 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 596 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 596 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 596 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 597 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                         ;
        goto failed;
    }
...
# 602 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                           ((void *)0)
# 602 "project/nginx/src/os/win32/ngx_process_cycle.c"
                               , 1, 0, wroevn);
    if (events[2] == 
# 603 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                    ((void *)0)
# 603 "project/nginx/src/os/win32/ngx_process_cycle.c"
                        ) {
        
# 604 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 604 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 604 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 604 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 605 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                          ;
        goto failed;
    }
    ...
    if (mev == 
# 610 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
              ((void *)0)
# 610 "project/nginx/src/os/win32/ngx_process_cycle.c"
                  ) {
        
# 611 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 611 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 611 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 611 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 612 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                      ;
        goto failed;
    }
...
# 617 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 617 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 617 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 617 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 618 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                     ;
        goto failed;
    }
    ...
    ngx_cache_manager_mutex = OpenMutex(SYNCHRONIZE, 0,
                                        ngx_cache_manager_mutex_name);
    if (ngx_cache_manager_mutex == 
# 628 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 628 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                      ) {
        
# 629 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 629 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 629 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 629 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 630 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                              ;
        goto failed;
    }

    ngx_cache_manager_event = CreateEvent(
# 634 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                         ((void *)0)
# 634 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                             , 1, 0, 
# 634 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                     ((void *)0)
# 634 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 635 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 635 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                      ) {
        
# 636 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 636 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 636 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 636 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 637 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                       ;
        goto failed;
    }


    if (ngx_create_thread(&wtid, ngx_worker_thread, 
# 642 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                   ((void *)0)
# 642 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                       , log) != 0) {
        goto failed;
    }

    if (ngx_create_thread(&cmtid, ngx_cache_manager_thread, 
# 646 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                           ((void *)0)
# 646 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                               , log) != 0) {
        goto failed;
    }

    if (ngx_create_thread(&cltid, ngx_cache_loader_thread, 
# 650 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                          ((void *)0)
# 650 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                              , log) != 0) {
        goto failed;
    }
    ...
    for ( ;; ) {
        ...
        err = 
# 657 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
             (*__error())
# 657 "project/nginx/src/os/win32/ngx_process_cycle.c"
                      ;
        ngx_time_update();
...
# 665 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 665 "project/nginx/src/os/win32/ngx_process_cycle.c"
           log
# 665 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 665 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c"
               log
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "ResetEvent(\"%s\") failed", wtevn
# 668 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )
                                                                 
# 669 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                ;
            }
...
# 677 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 677 "project/nginx/src/os/win32/ngx_process_cycle.c"
           log
# 677 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 677 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 683 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 683 "project/nginx/src/os/win32/ngx_process_cycle.c"
           log
# 683 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 683 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c"
               log
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "ResetEvent(\"%s\") failed", wroevn
# 686 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )
                                                                  
# 687 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                 ;
            }
...
# 694 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 694 "project/nginx/src/os/win32/ngx_process_cycle.c"
           log
# 694 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 694 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 695 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                           ;
...
# 704 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 704 "project/nginx/src/os/win32/ngx_process_cycle.c"
       log
# 704 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 704 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 705 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                    ;
    }
    ...
    for ( ;; ) {
        ...
        err = 
# 716 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
             (*__error())
# 716 "project/nginx/src/os/win32/ngx_process_cycle.c"
                      ;
        ngx_time_update();
...
# 742 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 742 "project/nginx/src/os/win32/ngx_process_cycle.c"
           log
# 742 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 742 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 743 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                           ;
            break;
        }
    }
...
ngx_worker_thread(void *data)
{
    ...
    tp = 
# 769 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 769 "project/nginx/src/os/win32/ngx_process_cycle.c"
                       ;
    ...
    for (n = 0; cycle->modules[n]; n++) {
        if (cycle->modules[n]->init_process) {
            if (cycle->modules[n]->init_process(cycle) == 
# 776 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                         -1
# 776 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                                  ) {
...
# 786 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                             0
# 786 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                   ) {
                break;
            }
        }
...
# 816 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   if ((
# 816 "project/nginx/src/os/win32/ngx_process_cycle.c"
   cycle->log
# 816 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 816 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 828 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   if ((
# 828 "project/nginx/src/os/win32/ngx_process_cycle.c"
   cycle->log
# 828 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 828 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               if ((
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c"
               cycle->log
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               , 
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c"
               0, "*%uA open socket #%d left in connection %ui", c[i].number, c[i].fd, i
# 845 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
               )

                                                      
# 847 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                     ;
            }
        }
    }
...
ngx_cache_manager_thread(void *data)
{
    ...
    for ( ;; ) {
        ...
        err = 
# 874 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
             (*__error())
# 874 "project/nginx/src/os/win32/ngx_process_cycle.c"
                      ;
        ngx_time_update();
...
# 881 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 881 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 881 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 881 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 882 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                           ;
        }
...
# 892 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 892 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 892 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 892 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 902 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           if ((
# 902 "project/nginx/src/os/win32/ngx_process_cycle.c"
           cycle->log
# 902 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 902 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 910 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 910 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 910 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 910 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 911 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                             ;
    }
...
# 963 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   (void) usleep(
# 963 "project/nginx/src/os/win32/ngx_process_cycle.c"
   60000 
# 963 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
   * 1000)
# 963 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
ngx_single_process_cycle(ngx_cycle_t *cycle)
{
    ...
    if (ngx_create_signal_events(cycle) != 
# 991 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                          0
# 991 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                ) {
        exit(2);
    }

    if (ngx_create_thread(&tid, ngx_worker_thread, 
# 995 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
                                                  ((void *)0)
# 995 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                      , cycle->log) != 0) {
...
ngx_os_signal_process(ngx_cycle_t *cycle, char *sig, ngx_pid_t pid)
{
    ...
    if (ev == 
# 1015 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
             ((void *)0)
# 1015 "project/nginx/src/os/win32/ngx_process_cycle.c"
                 ) {
        
# 1016 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 1016 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 1016 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
...
# 1017 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                     ;
        return 1;
    }
...
# 1022 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 1022 "project/nginx/src/os/win32/ngx_process_cycle.c"
       cycle->log
# 1022 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1022 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 1023 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                    ;
        rc = 1;
...
# 1040 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       if ((
# 1040 "project/nginx/src/os/win32/ngx_process_cycle.c"
       ngx_cycle->log
# 1040 "project/nginx/src/os/win32/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1040 "project/nginx/src/os/win32/ngx_process_cycle.c"
...
# 1041 "project/nginx/src/os/win32/ngx_process_cycle.c"
                                                 ;
    }
}
