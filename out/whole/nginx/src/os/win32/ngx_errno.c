# 0 "project/nginx/src/os/win32/ngx_errno.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/win32/ngx_errno.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_errno.c" 2



# 12 "project/nginx/src/os/win32/ngx_errno.c"
u_char *
...
# 23 "project/nginx/src/os/win32/ngx_errno.c" 3 4
                       ((void *)0)
# 23 "project/nginx/src/os/win32/ngx_errno.c"
                           , err, lang, (char *) errstr, size, 
# 23 "project/nginx/src/os/win32/ngx_errno.c" 3 4
                                                               ((void *)0)
# 23 "project/nginx/src/os/win32/ngx_errno.c"
                                                                   );
...
# 37 "project/nginx/src/os/win32/ngx_errno.c" 3 4
                           ((void *)0)
# 37 "project/nginx/src/os/win32/ngx_errno.c"
                               , err, lang, (char *) errstr, size, 
# 37 "project/nginx/src/os/win32/ngx_errno.c" 3 4
                                                                   ((void *)0)
# 37 "project/nginx/src/os/win32/ngx_errno.c"
    ...
    while (errstr[len] == '\0' || errstr[len] == 
# 46 "project/nginx/src/os/win32/ngx_errno.c" 3 4
                                                (u_char) '\r'
           
# 47 "project/nginx/src/os/win32/ngx_errno.c"
          || errstr[len] == 
# 47 "project/nginx/src/os/win32/ngx_errno.c" 3 4
                            (u_char) '\n' 
# 47 "project/nginx/src/os/win32/ngx_errno.c"
                               || errstr[len] == '.')
    {
...
{
    return 
# 59 "project/nginx/src/os/win32/ngx_errno.c" 3 4
          0
# 59 "project/nginx/src/os/win32/ngx_errno.c"
                ;
}
