# 0 "project/nginx/src/os/win32/ngx_stat.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/win32/ngx_stat.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_stat.c" 2



# 12 "project/nginx/src/os/win32/ngx_stat.c"
