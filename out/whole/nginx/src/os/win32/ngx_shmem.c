# 0 "project/nginx/src/os/win32/ngx_shmem.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/win32/ngx_shmem.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_shmem.c" 2
# 37 "project/nginx/src/os/win32/ngx_shmem.c"
#define NGX_SHMEM_BASE 0x2efe0000




# 41 "project/nginx/src/os/win32/ngx_shmem.c"
...
ngx_shm_alloc(ngx_shm_t *shm)
{
    u_char *name;
    uint64_t size;
    static u_char *base = (u_char *) 0x2efe0000;

    name = ngx_alloc(shm->name.len + 2 + 
# 51 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
                                        (sizeof("-2147483648") - 1)
# 51 "project/nginx/src/os/win32/ngx_shmem.c"
                                                     , shm->log);
    if (name == 
# 52 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
               ((void *)0)
# 52 "project/nginx/src/os/win32/ngx_shmem.c"
                   ) {
        return 
# 53 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
              -1
# 53 "project/nginx/src/os/win32/ngx_shmem.c"
                       ;
    }
...
# 58 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   (*__error()) = 
# 58 "project/nginx/src/os/win32/ngx_shmem.c"
   0;

    size = shm->size;

    shm->handle = CreateFileMapping(INVALID_HANDLE_VALUE, 
# 62 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
                                                         ((void *)0)
# 62 "project/nginx/src/os/win32/ngx_shmem.c"
                                                             , PAGE_READWRITE,
                                    (u_long) (size >> 32),
    ...
    if (shm->handle == 
# 67 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
                      ((void *)0)
# 67 "project/nginx/src/os/win32/ngx_shmem.c"
                          ) {
        
# 68 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       if ((
# 68 "project/nginx/src/os/win32/ngx_shmem.c"
       shm->log
# 68 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
...
# 68 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       , (*__error())
# 68 "project/nginx/src/os/win32/ngx_shmem.c"
       , "CreateFileMapping(%uz, %s) failed", shm->size, name
# 68 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )

                                      
# 70 "project/nginx/src/os/win32/ngx_shmem.c"
                                     ;
        
# 71 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       free
# 71 "project/nginx/src/os/win32/ngx_shmem.c"
               (name);

        return 
# 73 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
              -1
# 73 "project/nginx/src/os/win32/ngx_shmem.c"
                       ;
    }

    
# 76 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   free
# 76 "project/nginx/src/os/win32/ngx_shmem.c"
           (name);

    if (
# 78 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       (*__error()) 
# 78 "project/nginx/src/os/win32/ngx_shmem.c"
    ...
    if (shm->addr != 
# 84 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
                    ((void *)0)
# 84 "project/nginx/src/os/win32/ngx_shmem.c"
                        ) {
        base += 
# 85 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
               (((
# 85 "project/nginx/src/os/win32/ngx_shmem.c"
               size
# 85 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
               ) + (
# 85 "project/nginx/src/os/win32/ngx_shmem.c"
               ngx_allocation_granularity 
# 85 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
               - 1)) & ~(
# 85 "project/nginx/src/os/win32/ngx_shmem.c"
               ngx_allocation_granularity 
...
# 85 "project/nginx/src/os/win32/ngx_shmem.c"
                                                          ;
        return 
# 86 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
              0
# 86 "project/nginx/src/os/win32/ngx_shmem.c"
                    ;
    }
...
# 103 "project/nginx/src/os/win32/ngx_shmem.c"
    ...
    if (shm->addr != 
# 105 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
                    ((void *)0)
# 105 "project/nginx/src/os/win32/ngx_shmem.c"
                        ) {
        return 
# 106 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
              0
# 106 "project/nginx/src/os/win32/ngx_shmem.c"
                    ;
    }

    
# 109 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   if ((
# 109 "project/nginx/src/os/win32/ngx_shmem.c"
   shm->log
# 109 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   )->log_level >= 2) ngx_log_error_core(2, 
# 109 "project/nginx/src/os/win32/ngx_shmem.c"
...
# 109 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   , (*__error())
# 109 "project/nginx/src/os/win32/ngx_shmem.c"
   , "MapViewOfFile(%uz) of file mapping \"%V\" failed", shm->size, &shm->name
# 109 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   )

                                        
# 111 "project/nginx/src/os/win32/ngx_shmem.c"
                                       ;

    if (CloseHandle(shm->handle) == 0) {
        
# 114 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       if ((
# 114 "project/nginx/src/os/win32/ngx_shmem.c"
       shm->log
# 114 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 114 "project/nginx/src/os/win32/ngx_shmem.c"
...
# 114 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       , (*__error())
# 114 "project/nginx/src/os/win32/ngx_shmem.c"
       , "CloseHandle() of file mapping \"%V\" failed", &shm->name
# 114 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )

                                 
# 116 "project/nginx/src/os/win32/ngx_shmem.c"
                                ;
    }

    return 
# 119 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
          -1
# 119 "project/nginx/src/os/win32/ngx_shmem.c"
                   ;
}
...
# 127 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       if ((
# 127 "project/nginx/src/os/win32/ngx_shmem.c"
       shm->log
# 127 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 127 "project/nginx/src/os/win32/ngx_shmem.c"
...
# 127 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       , (*__error())
# 127 "project/nginx/src/os/win32/ngx_shmem.c"
       , "UnmapViewOfFile(%p) of file mapping \"%V\" failed", shm->addr, &shm->name
# 127 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )

                                            
# 129 "project/nginx/src/os/win32/ngx_shmem.c"
                                           ;
        return 
# 130 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
              -1
# 130 "project/nginx/src/os/win32/ngx_shmem.c"
                       ;
    }
    ...
    if (shm->addr != 
# 135 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
                    ((void *)0)
# 135 "project/nginx/src/os/win32/ngx_shmem.c"
                        ) {
        return 
# 136 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
              0
# 136 "project/nginx/src/os/win32/ngx_shmem.c"
                    ;
    }

    
# 139 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   if ((
# 139 "project/nginx/src/os/win32/ngx_shmem.c"
   shm->log
# 139 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   )->log_level >= 2) ngx_log_error_core(2, 
# 139 "project/nginx/src/os/win32/ngx_shmem.c"
...
# 139 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   , (*__error())
# 139 "project/nginx/src/os/win32/ngx_shmem.c"
   , "MapViewOfFileEx(%uz, %p) of file mapping \"%V\" failed", shm->size, addr, &shm->name
# 139 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
   )

                                              
# 141 "project/nginx/src/os/win32/ngx_shmem.c"
                                             ;

    return 
# 143 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
          -1
# 143 "project/nginx/src/os/win32/ngx_shmem.c"
                   ;
}
...
# 151 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       if ((
# 151 "project/nginx/src/os/win32/ngx_shmem.c"
       shm->log
# 151 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 151 "project/nginx/src/os/win32/ngx_shmem.c"
...
# 153 "project/nginx/src/os/win32/ngx_shmem.c"
                                           ;
    }

    if (CloseHandle(shm->handle) == 0) {
        
# 157 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       if ((
# 157 "project/nginx/src/os/win32/ngx_shmem.c"
       shm->log
# 157 "project/nginx/src/os/win32/ngx_shmem.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 157 "project/nginx/src/os/win32/ngx_shmem.c"
...
# 159 "project/nginx/src/os/win32/ngx_shmem.c"
                                ;
    }
}
