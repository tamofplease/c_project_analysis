# 0 "project/nginx/src/os/win32/ngx_atomic.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_atomic.h"
# 9 "project/nginx/src/os/win32/ngx_atomic.h"
...
# 13 "project/nginx/src/os/win32/ngx_atomic.h" 2
...
# 14 "project/nginx/src/os/win32/ngx_atomic.h" 2


#define NGX_HAVE_ATOMIC_OPS 1


# 18 "project/nginx/src/os/win32/ngx_atomic.h"
...
# 44 "project/nginx/src/os/win32/ngx_atomic.h"
#define ngx_atomic_fetch_add(p,add) InterlockedExchangeAdd((long *) p, add)


#define ngx_memory_barrier() 
# 57 "project/nginx/src/os/win32/ngx_atomic.h"
