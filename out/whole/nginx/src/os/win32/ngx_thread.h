# 0 "project/nginx/src/os/win32/ngx_thread.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_thread.h"
# 9 "project/nginx/src/os/win32/ngx_thread.h"
...
# 13 "project/nginx/src/os/win32/ngx_thread.h" 2
...
# 14 "project/nginx/src/os/win32/ngx_thread.h" 2



# 16 "project/nginx/src/os/win32/ngx_thread.h"
