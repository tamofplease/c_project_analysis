# 0 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
...
# 9 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 2
...
# 11 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 2



# 13 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
ssize_t
...
# 27 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                                                  ((void *)0)
# 27 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                                      , 
# 27 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                                                        ((void *)0)
# 27 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
    ...
    if (rc == -1) {
        rev->ready = 0;
        err = 
# 36 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
             (*__error())
# 36 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                             ;
        ...
        if (err == WSAEWOULDBLOCK) {
                                                 ...
                                                 ;
            return 
# 41 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                  -2
# 41 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                           ;
        }
        ...
        return 
# 47 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
              -1
# 47 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                       ;
    }
...
# 67 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
       if ((
# 67 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
       c->log
# 67 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
...
# 67 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                                                 ;
        return 
# 68 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
              -2
# 68 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                       ;
    }
    ...
    if (rev->complete) {
        ...
        if (ngx_event_flags & 
# 77 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                             0x00000200
# 77 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                               ) {
            if (rev->ovlp.error) {
                ngx_connection_error(c, rev->ovlp.error, "WSARecv() failed");
                return 
# 80 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                      -1
# 80 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                               ;
            }
        ...
        if (WSAGetOverlappedResult(c->fd, (LPWSAOVERLAPPED) &rev->ovlp,
                                   &bytes, 0, 
# 91 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                                             ((void *)0)
# 91 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                                 )
            == 0)
        {
            ngx_connection_error(c, 
# 94 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                                   (*__error())
# 94 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                                   ,
                               "WSARecv() or WSAGetOverlappedResult() failed");
            return 
# 96 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                  -1
# 96 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                           ;
        }
...
# 106 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
   (void) __builtin___memset_chk (
# 106 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
   ovlp
# 106 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
   , 0, 
# 106 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
...
# 112 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                                                        ((void *)0)
# 112 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                                            );
    ...
    if (rc == -1) {
        err = 
# 121 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
             (*__error())
# 121 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                             ;
        if (err == WSA_IO_PENDING) {
            rev->active = 1;
                                              ...
                                              ;
            return 
# 126 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                  -2
# 126 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                           ;
        }
        ...
        ngx_connection_error(c, err, "WSARecv() failed");
        return 
# 131 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
              -1
# 131 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                       ;
    }

    if (ngx_event_flags & 
# 134 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
                         0x00000200
# 134 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                                           ) {
        ...
        rev->active = 1;
        return 
# 143 "project/nginx/src/os/win32/ngx_udp_wsarecv.c" 3 4
              -2
# 143 "project/nginx/src/os/win32/ngx_udp_wsarecv.c"
                       ;
    }
