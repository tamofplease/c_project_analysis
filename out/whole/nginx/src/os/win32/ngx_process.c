# 0 "project/nginx/src/os/win32/ngx_process.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_process.c"
...
# 9 "project/nginx/src/os/win32/ngx_process.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_process.c" 2



# 12 "project/nginx/src/os/win32/ngx_process.c"
int ngx_argc;
char **ngx_argv;
char **ngx_os_argv;
...
# 17 "project/nginx/src/os/win32/ngx_process.c" 3 4
                              1024
# 17 "project/nginx/src/os/win32/ngx_process.c"
                                               ];
...
# 35 "project/nginx/src/os/win32/ngx_process.c" 3 4
                                          ((void *)0)
# 35 "project/nginx/src/os/win32/ngx_process.c"
                                              ) {
                break;
            }
        }
        ...
        if (s == 
# 40 "project/nginx/src/os/win32/ngx_process.c" 3 4
                1024
# 40 "project/nginx/src/os/win32/ngx_process.c"
                                 ) {
            
# 41 "project/nginx/src/os/win32/ngx_process.c" 3 4
           if ((
# 41 "project/nginx/src/os/win32/ngx_process.c"
           cycle->log
# 41 "project/nginx/src/os/win32/ngx_process.c" 3 4
...
# 43 "project/nginx/src/os/win32/ngx_process.c"
                                           ;
            return 
# 44 "project/nginx/src/os/win32/ngx_process.c" 3 4
                  -1
# 44 "project/nginx/src/os/win32/ngx_process.c"
                                 ;
        }
    }

    n = GetModuleFileName(
# 48 "project/nginx/src/os/win32/ngx_process.c" 3 4
                         ((void *)0)
# 48 "project/nginx/src/os/win32/ngx_process.c"
                             , file, MAX_PATH);

    if (n == 0) {
        
# 51 "project/nginx/src/os/win32/ngx_process.c" 3 4
       if ((
# 51 "project/nginx/src/os/win32/ngx_process.c"
       cycle->log
# 51 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 51 "project/nginx/src/os/win32/ngx_process.c"
...
# 52 "project/nginx/src/os/win32/ngx_process.c"
                                                  ;
        return 
# 53 "project/nginx/src/os/win32/ngx_process.c" 3 4
              -1
# 53 "project/nginx/src/os/win32/ngx_process.c"
                             ;
    }
    ...
    ctx.argv = 
# 64 "project/nginx/src/os/win32/ngx_process.c" 3 4
              ((void *)0)
# 64 "project/nginx/src/os/win32/ngx_process.c"
                  ;
    ctx.envp = 
# 65 "project/nginx/src/os/win32/ngx_process.c" 3 4
              ((void *)0)
# 65 "project/nginx/src/os/win32/ngx_process.c"
                  ;

    pid = ngx_execute(cycle, &ctx);

    if (pid == 
# 69 "project/nginx/src/os/win32/ngx_process.c" 3 4
              -1
# 69 "project/nginx/src/os/win32/ngx_process.c"
                             ) {
        return pid;
    }

    
# 73 "project/nginx/src/os/win32/ngx_process.c" 3 4
   (void) __builtin___memset_chk (
# 73 "project/nginx/src/os/win32/ngx_process.c"
   &ngx_processes[s]
# 73 "project/nginx/src/os/win32/ngx_process.c" 3 4
   , 0, 
# 73 "project/nginx/src/os/win32/ngx_process.c"
   sizeof(ngx_process_t)
# 73 "project/nginx/src/os/win32/ngx_process.c" 3 4
...
# 100 "project/nginx/src/os/win32/ngx_process.c" 3 4
                                    ((void *)0)
# 100 "project/nginx/src/os/win32/ngx_process.c"
                                        ) {
            
# 101 "project/nginx/src/os/win32/ngx_process.c" 3 4
           if ((
# 101 "project/nginx/src/os/win32/ngx_process.c"
           cycle->log
# 101 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 101 "project/nginx/src/os/win32/ngx_process.c"
...
# 101 "project/nginx/src/os/win32/ngx_process.c" 3 4
           , (*__error())
# 101 "project/nginx/src/os/win32/ngx_process.c"
           , "OpenEvent(\"%s\") failed", ngx_processes[s].term_event
# 101 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )

                                                      
# 103 "project/nginx/src/os/win32/ngx_process.c"
                                                     ;
            goto failed;
        }
...
# 109 "project/nginx/src/os/win32/ngx_process.c" 3 4
                                    ((void *)0)
# 109 "project/nginx/src/os/win32/ngx_process.c"
                                        ) {
            
# 110 "project/nginx/src/os/win32/ngx_process.c" 3 4
           if ((
# 110 "project/nginx/src/os/win32/ngx_process.c"
           cycle->log
# 110 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 110 "project/nginx/src/os/win32/ngx_process.c"
...
# 110 "project/nginx/src/os/win32/ngx_process.c" 3 4
           , (*__error())
# 110 "project/nginx/src/os/win32/ngx_process.c"
           , "OpenEvent(\"%s\") failed", ngx_processes[s].quit_event
# 110 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )

                                                      
# 112 "project/nginx/src/os/win32/ngx_process.c"
                                                     ;
            goto failed;
        }
...
# 118 "project/nginx/src/os/win32/ngx_process.c" 3 4
                                      ((void *)0)
# 118 "project/nginx/src/os/win32/ngx_process.c"
                                          ) {
            
# 119 "project/nginx/src/os/win32/ngx_process.c" 3 4
           if ((
# 119 "project/nginx/src/os/win32/ngx_process.c"
           cycle->log
# 119 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 119 "project/nginx/src/os/win32/ngx_process.c"
...
# 119 "project/nginx/src/os/win32/ngx_process.c" 3 4
           , (*__error())
# 119 "project/nginx/src/os/win32/ngx_process.c"
           , "OpenEvent(\"%s\") failed", ngx_processes[s].reopen_event
# 119 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )

                                                        
# 121 "project/nginx/src/os/win32/ngx_process.c"
                                                       ;
            goto failed;
        }
...
# 126 "project/nginx/src/os/win32/ngx_process.c" 3 4
           if ((
# 126 "project/nginx/src/os/win32/ngx_process.c"
           cycle->log
# 126 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 126 "project/nginx/src/os/win32/ngx_process.c"
...
# 126 "project/nginx/src/os/win32/ngx_process.c" 3 4
           , 
# 126 "project/nginx/src/os/win32/ngx_process.c"
           0, "ResetEvent(\"%s\") failed", ngx_master_process_event_name
# 126 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )

                                                        
# 128 "project/nginx/src/os/win32/ngx_process.c"
                                                       ;
            goto failed;
        }
...
# 136 "project/nginx/src/os/win32/ngx_process.c" 3 4
           if ((
# 136 "project/nginx/src/os/win32/ngx_process.c"
           cycle->log
# 136 "project/nginx/src/os/win32/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 136 "project/nginx/src/os/win32/ngx_process.c"
...
# 137 "project/nginx/src/os/win32/ngx_process.c"
                                                              ;
        }

        
# 140 "project/nginx/src/os/win32/ngx_process.c" 3 4
       if ((
# 140 "project/nginx/src/os/win32/ngx_process.c"
       cycle->log
# 140 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 140 "project/nginx/src/os/win32/ngx_process.c"
...
# 140 "project/nginx/src/os/win32/ngx_process.c" 3 4
       , 
# 140 "project/nginx/src/os/win32/ngx_process.c"
       0, "%s process %P exited with code %Xl", name, pid, code
# 140 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )

                                      
# 142 "project/nginx/src/os/win32/ngx_process.c"
                                     ;
...
# 147 "project/nginx/src/os/win32/ngx_process.c" 3 4
       if ((
# 147 "project/nginx/src/os/win32/ngx_process.c"
       cycle->log
# 147 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 147 "project/nginx/src/os/win32/ngx_process.c"
...
# 147 "project/nginx/src/os/win32/ngx_process.c" 3 4
       , 
# 147 "project/nginx/src/os/win32/ngx_process.c"
       0, "the event \"%s\" was not signaled for 5s", ngx_master_process_event_name
# 147 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )

                                                    
# 149 "project/nginx/src/os/win32/ngx_process.c"
                                                   ;
        goto failed;

    case WAIT_FAILED:
        
# 153 "project/nginx/src/os/win32/ngx_process.c" 3 4
       if ((
# 153 "project/nginx/src/os/win32/ngx_process.c"
       cycle->log
# 153 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 153 "project/nginx/src/os/win32/ngx_process.c"
...
# 153 "project/nginx/src/os/win32/ngx_process.c" 3 4
       , (*__error())
# 153 "project/nginx/src/os/win32/ngx_process.c"
       , "WaitForSingleObject(\"%s\") failed", ngx_master_process_event_name
# 153 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )

                                                    
# 155 "project/nginx/src/os/win32/ngx_process.c"
                                                   ;
    ...
    case 
# 166 "project/nginx/src/os/win32/ngx_process.c" 3 4
        -3
# 166 "project/nginx/src/os/win32/ngx_process.c"
                           :
        ngx_processes[s].just_spawn = 0;
        break;

    case 
# 170 "project/nginx/src/os/win32/ngx_process.c" 3 4
        -4
# 170 "project/nginx/src/os/win32/ngx_process.c"
                                :
...
failed:
    ...
    if (ngx_processes[s].handle) {
        ...
        ngx_processes[s].handle = 
# 199 "project/nginx/src/os/win32/ngx_process.c" 3 4
                                 ((void *)0)
# 199 "project/nginx/src/os/win32/ngx_process.c"
                                     ;
    }

    return 
# 202 "project/nginx/src/os/win32/ngx_process.c" 3 4
          -1
# 202 "project/nginx/src/os/win32/ngx_process.c"
                         ;
}
...
# 212 "project/nginx/src/os/win32/ngx_process.c" 3 4
   (void) __builtin___memset_chk (
# 212 "project/nginx/src/os/win32/ngx_process.c"
   &si
# 212 "project/nginx/src/os/win32/ngx_process.c" 3 4
   , 0, 
# 212 "project/nginx/src/os/win32/ngx_process.c"
...
# 215 "project/nginx/src/os/win32/ngx_process.c" 3 4
   (void) __builtin___memset_chk (
# 215 "project/nginx/src/os/win32/ngx_process.c"
   &pi
# 215 "project/nginx/src/os/win32/ngx_process.c" 3 4
   , 0, 
# 215 "project/nginx/src/os/win32/ngx_process.c"
...
# 218 "project/nginx/src/os/win32/ngx_process.c" 3 4
                     ((void *)0)
# 218 "project/nginx/src/os/win32/ngx_process.c"
                         , 
# 218 "project/nginx/src/os/win32/ngx_process.c" 3 4
                           ((void *)0)
# 218 "project/nginx/src/os/win32/ngx_process.c"
...
# 221 "project/nginx/src/os/win32/ngx_process.c" 3 4
       if ((
# 221 "project/nginx/src/os/win32/ngx_process.c"
       cycle->log
# 221 "project/nginx/src/os/win32/ngx_process.c" 3 4
...
# 222 "project/nginx/src/os/win32/ngx_process.c"
                                                                 ;
...
# 230 "project/nginx/src/os/win32/ngx_process.c" 3 4
       if ((
# 230 "project/nginx/src/os/win32/ngx_process.c"
       cycle->log
# 230 "project/nginx/src/os/win32/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 230 "project/nginx/src/os/win32/ngx_process.c"
...
# 231 "project/nginx/src/os/win32/ngx_process.c"
                                                      ;
    }

    
# 234 "project/nginx/src/os/win32/ngx_process.c" 3 4
   if ((
# 234 "project/nginx/src/os/win32/ngx_process.c"
   cycle->log
# 234 "project/nginx/src/os/win32/ngx_process.c" 3 4
...
# 234 "project/nginx/src/os/win32/ngx_process.c" 3 4
   , 
# 234 "project/nginx/src/os/win32/ngx_process.c"
   0, "start %s process %P", ctx->name, pi.dwProcessId
# 234 "project/nginx/src/os/win32/ngx_process.c" 3 4
   )
                                                                   
# 235 "project/nginx/src/os/win32/ngx_process.c"
                                                                  ;
