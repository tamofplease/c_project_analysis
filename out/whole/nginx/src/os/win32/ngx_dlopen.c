# 0 "project/nginx/src/os/win32/ngx_dlopen.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/win32/ngx_dlopen.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_dlopen.c" 2



# 12 "project/nginx/src/os/win32/ngx_dlopen.c"
char *
ngx_dlerror(void)
{
    u_char *p;
    static u_char errstr[
# 16 "project/nginx/src/os/win32/ngx_dlopen.c" 3 4
                          2048
# 16 "project/nginx/src/os/win32/ngx_dlopen.c"
                                           ];

    p = ngx_strerror(
# 18 "project/nginx/src/os/win32/ngx_dlopen.c" 3 4
                    (*__error())
# 18 "project/nginx/src/os/win32/ngx_dlopen.c"
                             , errstr, 
# 18 "project/nginx/src/os/win32/ngx_dlopen.c" 3 4
                                       2048
# 18 "project/nginx/src/os/win32/ngx_dlopen.c"
