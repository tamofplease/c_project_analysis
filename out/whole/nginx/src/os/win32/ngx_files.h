...
# 9 "project/nginx/src/os/win32/ngx_files.h"
...
#define ngx_open_tempfile(name,persistent,access) CreateFile((const char *) name, GENERIC_READ|GENERIC_WRITE, FILE_SHARE_READ|FILE_SHARE_WRITE|FILE_SHARE_DELETE, NULL, CREATE_NEW, persistent ? 0: FILE_ATTRIBUTE_TEMPORARY|FILE_FLAG_DELETE_ON_CLOSE, NULL);
# 99 "project/nginx/src/os/win32/ngx_files.h"
...
#define ngx_file_size(fi) (((off_t) (fi)->nFileSizeHigh << 32) | (fi)->nFileSizeLow)
...
#define ngx_file_mtime(fi) (time_t) (((((unsigned __int64) (fi)->ftLastWriteTime.dwHighDateTime << 32) | (fi)->ftLastWriteTime.dwLowDateTime) - 116444736000000000) / 10000000)
...
#define ngx_de_is_dir(dir) (((dir)->finddata.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) != 0)

#define ngx_de_is_file(dir) (((dir)->finddata.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) == 0)

#define ngx_de_is_link(dir) 0
#define ngx_de_access(dir) 0
#define ngx_de_size(dir) (((off_t) (dir)->finddata.nFileSizeHigh << 32) | (dir)->finddata.nFileSizeLow)

#define ngx_de_fs_size(dir) ngx_de_size(dir)



#define ngx_de_mtime(dir) (time_t) (((((unsigned __int64) (dir)->finddata.ftLastWriteTime.dwHighDateTime << 32) | (dir)->finddata.ftLastWriteTime.dwLowDateTime) - 116444736000000000) / 10000000)
