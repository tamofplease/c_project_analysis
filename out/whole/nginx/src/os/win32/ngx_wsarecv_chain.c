# 0 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
...
# 9 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 2
...
# 11 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 2
...
# 16 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
ssize_t
ngx_wsarecv_chain(ngx_connection_t *c, ngx_chain_t *chain, off_t limit)
{
    ...
    prev = 
# 29 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
          ((void *)0)
# 29 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
              ;
    wsabuf = 
# 30 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
            ((void *)0)
# 30 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                ;
    flags = 0;
    size = 0;
    bytes = 0;
    ...
    while (chain) {
        ...
        if (prev == chain->buf->last) {
            ...
            if (wsabuf == 
# 65 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                         ((void *)0)
# 65 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                             ) {
                return 
# 66 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                      -1
# 66 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                               ;
            }
    ...
    rc = WSARecv(c->fd, vec.elts, vec.nelts, &bytes, &flags, 
# 82 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                                                            ((void *)0)
# 82 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                                                                , 
# 82 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                                                                  ((void *)0)
# 82 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
    ...
    if (rc == -1) {
        rev->ready = 0;
        err = 
# 88 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
             (*__error())
# 88 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                             ;
        ...
        if (err == WSAEWOULDBLOCK) {
                                                 ...
                                                 ;
            return 
# 93 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                  -2
# 93 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                           ;
        }
        ...
        return 
# 98 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
              -1
# 98 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                       ;
    }
    ...
    if (rev->available >= 0 && bytes > 0) {
        rev->available -= bytes;
# 113 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
        if (rev->available < 0) {
            rev->available = 0;
            rev->ready = 0;
        }
        ...
        if (
# 123 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
           ioctl(
# 123 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
           c->fd
# 123 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
...
# 125 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                                   (*__error())
# 125 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                                                   ,
                                 
# 126 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                                "ioctl(FIONREAD)" 
# 126 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                                                   " failed");
            return 
# 127 "project/nginx/src/os/win32/ngx_wsarecv_chain.c" 3 4
                  -1
# 127 "project/nginx/src/os/win32/ngx_wsarecv_chain.c"
                           ;
        }
