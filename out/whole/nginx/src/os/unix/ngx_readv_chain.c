# 0 "project/nginx/src/os/unix/ngx_readv_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_readv_chain.c"
...
# 9 "project/nginx/src/os/unix/ngx_readv_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_readv_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_readv_chain.c" 2



# 13 "project/nginx/src/os/unix/ngx_readv_chain.c"
ssize_t
...
# 21 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                            64
# 21 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                ];
    ...
    if (ngx_event_flags & 
# 27 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                         0x00000008
# 27 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                             ) {
...
# 37 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
               if ((
# 37 "project/nginx/src/os/unix/ngx_readv_chain.c"
               c->log
# 37 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
...
# 37 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
               , 
# 37 "project/nginx/src/os/unix/ngx_readv_chain.c"
               rev->kq_errno, "kevent() reported about an closed connection"
# 37 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
               )
                                                                             
# 38 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                                            ;

                if (rev->kq_errno) {
                    rev->error = 1;
                    
# 42 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                   (*__error()) = 
# 42 "project/nginx/src/os/unix/ngx_readv_chain.c"
                   rev->kq_errno;
                    return 
# 43 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                          -1
# 43 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                   ;
                }
                ...
                return 
# 49 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                      -2
# 49 "project/nginx/src/os/unix/ngx_readv_chain.c"
                               ;
            }
        }
    }
# 70 "project/nginx/src/os/unix/ngx_readv_chain.c"
    prev = 
# 70 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
          ((void *)0)
# 70 "project/nginx/src/os/unix/ngx_readv_chain.c"
              ;
    iov = 
# 71 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
         ((void *)0)
# 71 "project/nginx/src/os/unix/ngx_readv_chain.c"
             ;
    size = 0;
    ...
    vec.nalloc = 
# 77 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                64
# 77 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                    ;
    vec.pool = c->pool;
    ...
    while (chain) {
        ...
        if (prev == chain->buf->last) {
            ...
            if (iov == 
# 104 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                      ((void *)0)
# 104 "project/nginx/src/os/unix/ngx_readv_chain.c"
                          ) {
                return 
# 105 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                      -1
# 105 "project/nginx/src/os/unix/ngx_readv_chain.c"
                               ;
            }
    ...
    do {
        ...
        if (n == 0) {
            rev->ready = 0;
            rev->eof = 1;
# 134 "project/nginx/src/os/unix/ngx_readv_chain.c"
            if (ngx_event_flags & 
# 134 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                                 0x00000008
# 134 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                     ) {
                rev->available = 0;
        ...
        if (n > 0) {
            ...
            if (ngx_event_flags & 
# 147 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                                 0x00000008
# 147 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                     ) {
                rev->available -= n;
            ...
            if (rev->available >= 0) {
                rev->available -= n;
# 180 "project/nginx/src/os/unix/ngx_readv_chain.c"
                if (rev->available < 0) {
                    rev->available = 0;
                    rev->ready = 0;
                }
                ...
                if (
# 190 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                   ioctl(
# 190 "project/nginx/src/os/unix/ngx_readv_chain.c"
                   c->fd
# 190 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
...
# 190 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                            == -1) {
                    n = ngx_connection_error(c, 
# 191 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                                               (*__error())
# 191 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                               ,
                                             
# 192 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                                            "ioctl(FIONREAD)" 
# 192 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                               " failed");
                    break;
                }
...
# 220 "project/nginx/src/os/unix/ngx_readv_chain.c"
            if (n < size && !(ngx_event_flags & 
# 220 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                                               0x00000020
# 220 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                                                   )) {
                rev->ready = 0;
        ...
        err = 
# 227 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
             (*__error())
# 227 "project/nginx/src/os/unix/ngx_readv_chain.c"
                             ;

        if (err == 
# 229 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                  35 
# 229 "project/nginx/src/os/unix/ngx_readv_chain.c"
                             || err == 
# 229 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                                       4
# 229 "project/nginx/src/os/unix/ngx_readv_chain.c"
                                               ...
                                               ;
            n = 
# 232 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
               -2
# 232 "project/nginx/src/os/unix/ngx_readv_chain.c"
                        ;
...
# 239 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
                   4
# 239 "project/nginx/src/os/unix/ngx_readv_chain.c"
                            );

    rev->ready = 0;

    if (n == 
# 243 "project/nginx/src/os/unix/ngx_readv_chain.c" 3 4
            -1
# 243 "project/nginx/src/os/unix/ngx_readv_chain.c"
                     ) {
        c->read->error = 1;
    }
