# 0 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 2
...
ngx_darwin_sendfile_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    struct sf_hdtr hdtr;
    struct iovec headers[
# 44 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                            64
# 44 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                                ];
    struct iovec trailers[
# 45 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                             64
# 45 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                                 ];
    ...
    if ((ngx_event_flags & 
# 55 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                          0x00000008
# 55 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                              ) && wev->pending_eof) {
        (void) ngx_connection_error(c, wev->kq_errno,
                               "kevent() reported about an closed connection");
        wev->error = 1;
        return 
# 59 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
              (ngx_chain_t *) -1
# 59 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                             ;
    }
...
# 66 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                                      9223372036854775807LL 
# 66 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                                           - ngx_pagesize)) {
        limit = 
# 67 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
               9223372036854775807LL 
# 67 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                    - ngx_pagesize;
    }
    ...
    header.iovs = headers;
    header.nalloc = 
# 73 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                   64
# 73 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                       ;

    trailer.iovs = trailers;
    trailer.nalloc = 
# 76 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                    64
# 76 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                        ;
    ...
    for ( ;; ) {
        ...
        if (cl == 
# 86 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                 (ngx_chain_t *) -1
# 86 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                ) {
            return 
# 87 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                  (ngx_chain_t *) -1
# 87 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                 ;
        }
        ...
        if (cl && cl->buf->in_file && send < limit) {
            ...
            if (header.count == 0 && send < limit) {
                ...
                cl = ngx_output_chain_to_iovec(&trailer, cl, limit - send,
                                               c->log);
                if (cl == 
# 109 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                         (ngx_chain_t *) -1
# 109 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                        ) {
                    return 
# 110 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                          (ngx_chain_t *) -1
# 110 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                         ;
                }
...
# 124 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                                                       ((void *)0)
# 124 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                                           ;
            hdtr.hdr_cnt = header.count;
            hdtr.trailers = trailer.count ? trailer.iovs : 
# 126 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                                                          ((void *)0)
# 126 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                                              ;
            ...
            if (rc == -1) {
                err = 
# 139 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                     (*__error())
# 139 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                              ;

                switch (err) {
                case 
# 142 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                    35
# 142 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                              :
                    break;

                case 
# 145 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                    4
# 145 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                             :
                    eintr = 1;
                    break;
                ...
                default:
                    ...
                    return 
# 152 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                          (ngx_chain_t *) -1
# 152 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                         ;
                }
...
# 167 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
               if ((
# 167 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
               c->log
# 167 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
...
# 167 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
               , 
# 167 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
               0, "sendfile() reported that \"%s\" was truncated", file->file->name.data
# 167 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
               )

                                                    
# 169 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                                   ;

                return 
# 171 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 171 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                     ;
            }
            ...
            if (n == 
# 181 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                    -1
# 181 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                             ) {
                return 
# 182 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 182 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                     ;
            }

            sent = (n == 
# 185 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                        -2
# 185 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                 ) ? 0 : n;
        }
        ...
        if (send >= limit || in == 
# 202 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c" 3 4
                                  ((void *)0)
# 202 "project/nginx/src/os/unix/ngx_darwin_sendfile_chain.c"
                                      ) {
            return in;
        }
    }
