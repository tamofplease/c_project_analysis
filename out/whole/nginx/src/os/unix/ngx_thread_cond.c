# 0 "project/nginx/src/os/unix/ngx_thread_cond.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/unix/ngx_thread_cond.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_thread_cond.c" 2



# 12 "project/nginx/src/os/unix/ngx_thread_cond.c"
ngx_int_t
ngx_thread_cond_create(ngx_thread_cond_t *cond, ngx_log_t *log)
{
    ngx_err_t err;

    err = pthread_cond_init(cond, 
# 17 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
                                 ((void *)0)
# 17 "project/nginx/src/os/unix/ngx_thread_cond.c"
                                     );
    if (err == 0) {
        return 
# 19 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
              0
# 19 "project/nginx/src/os/unix/ngx_thread_cond.c"
                    ;
    }

    
# 22 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   if ((
# 22 "project/nginx/src/os/unix/ngx_thread_cond.c"
   log
# 22 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
...
# 22 "project/nginx/src/os/unix/ngx_thread_cond.c"
                                                                       ;
    return 
# 23 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
          -1
# 23 "project/nginx/src/os/unix/ngx_thread_cond.c"
                   ;
}
...
ngx_thread_cond_destroy(ngx_thread_cond_t *cond, ngx_log_t *log)
{
    ...
    if (err == 0) {
        return 
# 34 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
              0
# 34 "project/nginx/src/os/unix/ngx_thread_cond.c"
                    ;
    }

    
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   if ((
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c"
   log
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   )->log_level >= 1) ngx_log_error_core(1, 
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c"
...
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   , 
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c"
   err, "pthread_cond_destroy() failed"
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   )
# 37 "project/nginx/src/os/unix/ngx_thread_cond.c"
                                                                          ;
    return 
# 38 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
          -1
# 38 "project/nginx/src/os/unix/ngx_thread_cond.c"
                   ;
}
...
ngx_thread_cond_signal(ngx_thread_cond_t *cond, ngx_log_t *log)
{
    ...
    if (err == 0) {
        return 
# 49 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
              0
# 49 "project/nginx/src/os/unix/ngx_thread_cond.c"
                    ;
    }

    
# 52 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   if ((
# 52 "project/nginx/src/os/unix/ngx_thread_cond.c"
   log
# 52 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   )->log_level >= 1) ngx_log_error_core(1, 
# 52 "project/nginx/src/os/unix/ngx_thread_cond.c"
...
# 52 "project/nginx/src/os/unix/ngx_thread_cond.c"
                                                                         ;
    return 
# 53 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
          -1
# 53 "project/nginx/src/os/unix/ngx_thread_cond.c"
                   ;
}
    ...
    ngx_log_t *log)
{
    ...
    if (err == 0) {
        return 
# 70 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
              0
# 70 "project/nginx/src/os/unix/ngx_thread_cond.c"
                    ;
    }

    
# 73 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
   if ((
# 73 "project/nginx/src/os/unix/ngx_thread_cond.c"
   log
# 73 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
...
# 73 "project/nginx/src/os/unix/ngx_thread_cond.c"
    ...
    return 
# 75 "project/nginx/src/os/unix/ngx_thread_cond.c" 3 4
          -1
# 75 "project/nginx/src/os/unix/ngx_thread_cond.c"
                   ;
}
