# 0 "project/nginx/src/os/unix/ngx_setproctitle.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/unix/ngx_setproctitle.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_setproctitle.c" 2
...
ngx_init_setproctitle(ngx_log_t *log)
{
    ...
    for (i = 0; environ[i]; i++) {
        size += 
# 44 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
               strlen((const char *) 
# 44 "project/nginx/src/os/unix/ngx_setproctitle.c"
               environ[i]
# 44 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
               ) 
# 44 "project/nginx/src/os/unix/ngx_setproctitle.c"
    ...
    if (p == 
# 48 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
            ((void *)0)
# 48 "project/nginx/src/os/unix/ngx_setproctitle.c"
                ) {
        return 
# 49 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
              -1
# 49 "project/nginx/src/os/unix/ngx_setproctitle.c"
                       ;
    }
    ...
    for (i = 0; ngx_os_argv[i]; i++) {
        if (ngx_os_argv_last == ngx_os_argv[i]) {
            ngx_os_argv_last = ngx_os_argv[i] + 
# 56 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
                                               strlen((const char *) 
# 56 "project/nginx/src/os/unix/ngx_setproctitle.c"
                                               ngx_os_argv[i]
# 56 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
                                               ) 
# 56 "project/nginx/src/os/unix/ngx_setproctitle.c"
    ...
    for (i = 0; environ[i]; i++) {
        if (ngx_os_argv_last == environ[i]) {
            ...
            size = 
# 63 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
                  strlen((const char *) 
# 63 "project/nginx/src/os/unix/ngx_setproctitle.c"
                  environ[i]
# 63 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
                  ) 
# 63 "project/nginx/src/os/unix/ngx_setproctitle.c"
    ...
    return 
# 74 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
          0
# 74 "project/nginx/src/os/unix/ngx_setproctitle.c"
                ;
}
...
{
    u_char *p;
# 90 "project/nginx/src/os/unix/ngx_setproctitle.c"
    ngx_os_argv[1] = 
# 90 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
                    ((void *)0)
# 90 "project/nginx/src/os/unix/ngx_setproctitle.c"
                        ;
...
# 127 "project/nginx/src/os/unix/ngx_setproctitle.c"
    if (ngx_os_argv_last - (char *) p) {
        
# 128 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
       (void) __builtin___memset_chk (
# 128 "project/nginx/src/os/unix/ngx_setproctitle.c"
       p
# 128 "project/nginx/src/os/unix/ngx_setproctitle.c" 3 4
       , '\0', 
# 128 "project/nginx/src/os/unix/ngx_setproctitle.c"
