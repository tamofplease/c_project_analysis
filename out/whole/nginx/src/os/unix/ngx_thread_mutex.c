# 0 "project/nginx/src/os/unix/ngx_thread_mutex.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 8 "project/nginx/src/os/unix/ngx_thread_mutex.c" 2
...
# 9 "project/nginx/src/os/unix/ngx_thread_mutex.c" 2
...
# 85 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       if ((
# 85 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       log
# 85 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
...
# 85 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       , 
# 85 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       err, "pthread_mutexattr_init() failed"
# 85 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       )
                                                        
# 86 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                                                       ;
        return 
# 87 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
              -1
# 87 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                       ;
    }
...
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       if ((
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       log
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c"
...
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       , 
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       err, "pthread_mutexattr_settype" "(PTHREAD_MUTEX_ERRORCHECK) failed"
# 92 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       )

                                                          
# 94 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                                                         ;
        return 
# 95 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
              -1
# 95 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                       ;
    }
...
# 100 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       if ((
# 100 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       log
# 100 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 100 "project/nginx/src/os/unix/ngx_thread_mutex.c"
...
# 101 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                                                   ;
        return 
# 102 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
              -1
# 102 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                       ;
    }
...
# 107 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       if ((
# 107 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       log
# 107 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
...
# 107 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       , 
# 107 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       err, "pthread_mutexattr_destroy() failed"
# 107 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       )
                                                           
# 108 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                                                          ;
    }

    return 
# 111 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
          0
# 111 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                ;
}
...
# 122 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       if ((
# 122 "project/nginx/src/os/unix/ngx_thread_mutex.c"
       log
# 122 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 122 "project/nginx/src/os/unix/ngx_thread_mutex.c"
...
# 123 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                                                      ;
        return 
# 124 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
              -1
# 124 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                       ;
    }

    return 
# 127 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
          0
# 127 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                ;
}
...
ngx_thread_mutex_lock(ngx_thread_mutex_t *mtx, ngx_log_t *log)
{
    ...
    if (err == 0) {
        return 
# 138 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
              0
# 138 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                    ;
    }

    
# 141 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
   if ((
# 141 "project/nginx/src/os/unix/ngx_thread_mutex.c"
   log
# 141 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
   )->log_level >= 2) ngx_log_error_core(2, 
# 141 "project/nginx/src/os/unix/ngx_thread_mutex.c"
...
# 141 "project/nginx/src/os/unix/ngx_thread_mutex.c"
    ...
    return 
# 143 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
          -1
# 143 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                   ;
}
...
ngx_thread_mutex_unlock(ngx_thread_mutex_t *mtx, ngx_log_t *log)
{
    ...
    if (err == 0) {
        return 
# 159 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
              0
# 159 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                    ;
    }

    
# 162 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
   if ((
# 162 "project/nginx/src/os/unix/ngx_thread_mutex.c"
   log
# 162 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
   )->log_level >= 2) ngx_log_error_core(2, 
# 162 "project/nginx/src/os/unix/ngx_thread_mutex.c"
...
# 162 "project/nginx/src/os/unix/ngx_thread_mutex.c"
    ...
    return 
# 164 "project/nginx/src/os/unix/ngx_thread_mutex.c" 3 4
          -1
# 164 "project/nginx/src/os/unix/ngx_thread_mutex.c"
                   ;
}
