# 0 "project/nginx/src/os/unix/ngx_send.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_send.c"
...
# 9 "project/nginx/src/os/unix/ngx_send.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_send.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_send.c" 2



# 13 "project/nginx/src/os/unix/ngx_send.c"
ssize_t
ngx_unix_send(ngx_connection_t *c, u_char *buf, size_t size)
{
    ...
    if ((ngx_event_flags & 
# 24 "project/nginx/src/os/unix/ngx_send.c" 3 4
                          0x00000008
# 24 "project/nginx/src/os/unix/ngx_send.c"
                                              ) && wev->pending_eof) {
        (void) ngx_connection_error(c, wev->kq_errno,
                               "kevent() reported about an closed connection");
        wev->error = 1;
        return 
# 28 "project/nginx/src/os/unix/ngx_send.c" 3 4
              -1
# 28 "project/nginx/src/os/unix/ngx_send.c"
                       ;
    }
    ...
    for ( ;; ) {
        ...
        err = 
# 49 "project/nginx/src/os/unix/ngx_send.c" 3 4
             (*__error())
# 49 "project/nginx/src/os/unix/ngx_send.c"
                             ;

        if (n == 0) {
            
# 52 "project/nginx/src/os/unix/ngx_send.c" 3 4
           if ((
# 52 "project/nginx/src/os/unix/ngx_send.c"
           c->log
# 52 "project/nginx/src/os/unix/ngx_send.c" 3 4
...
# 52 "project/nginx/src/os/unix/ngx_send.c"
        ...
        if (err == 
# 57 "project/nginx/src/os/unix/ngx_send.c" 3 4
                  35 
# 57 "project/nginx/src/os/unix/ngx_send.c"
                             || err == 
# 57 "project/nginx/src/os/unix/ngx_send.c" 3 4
                                       4
# 57 "project/nginx/src/os/unix/ngx_send.c"
            ...
            if (err == 
# 63 "project/nginx/src/os/unix/ngx_send.c" 3 4
                      35
# 63 "project/nginx/src/os/unix/ngx_send.c"
                                ) {
                return 
# 64 "project/nginx/src/os/unix/ngx_send.c" 3 4
                      -2
# 64 "project/nginx/src/os/unix/ngx_send.c"
                               ;
            }
            ...
            return 
# 70 "project/nginx/src/os/unix/ngx_send.c" 3 4
                  -1
# 70 "project/nginx/src/os/unix/ngx_send.c"
                           ;
        }
    }
}
