# 0 "project/nginx/src/os/unix/ngx_user.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_user.c"
...
# 9 "project/nginx/src/os/unix/ngx_user.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_user.c" 2
# 46 "project/nginx/src/os/unix/ngx_user.c"
...
ngx_libc_crypt(ngx_pool_t *pool, u_char *key, u_char *salt, u_char **encrypted)
{
    ...
    if (value) {
        len = 
# 56 "project/nginx/src/os/unix/ngx_user.c" 3 4
             strlen((const char *) 
# 56 "project/nginx/src/os/unix/ngx_user.c"
             value
# 56 "project/nginx/src/os/unix/ngx_user.c" 3 4
             ) 
# 56 "project/nginx/src/os/unix/ngx_user.c"
        ...
        *encrypted = ngx_pnalloc(pool, len);
        if (*encrypted == 
# 59 "project/nginx/src/os/unix/ngx_user.c" 3 4
                         ((void *)0)
# 59 "project/nginx/src/os/unix/ngx_user.c"
                             ) {
            return 
# 60 "project/nginx/src/os/unix/ngx_user.c" 3 4
                  -1
# 60 "project/nginx/src/os/unix/ngx_user.c"
                           ;
        }

        
# 63 "project/nginx/src/os/unix/ngx_user.c" 3 4
       (void) __builtin___memcpy_chk (
# 63 "project/nginx/src/os/unix/ngx_user.c"
       *encrypted
# 63 "project/nginx/src/os/unix/ngx_user.c" 3 4
       , 
# 63 "project/nginx/src/os/unix/ngx_user.c"
...
# 63 "project/nginx/src/os/unix/ngx_user.c"
                                         ;
        return 
# 64 "project/nginx/src/os/unix/ngx_user.c" 3 4
              0
# 64 "project/nginx/src/os/unix/ngx_user.c"
                    ;
    }

    err = 
# 67 "project/nginx/src/os/unix/ngx_user.c" 3 4
         (*__error())
# 67 "project/nginx/src/os/unix/ngx_user.c"
                  ;

    
# 69 "project/nginx/src/os/unix/ngx_user.c" 3 4
   if ((
# 69 "project/nginx/src/os/unix/ngx_user.c"
   pool->log
# 69 "project/nginx/src/os/unix/ngx_user.c" 3 4
...
# 69 "project/nginx/src/os/unix/ngx_user.c"
    ...
    return 
# 71 "project/nginx/src/os/unix/ngx_user.c" 3 4
          -1
# 71 "project/nginx/src/os/unix/ngx_user.c"
                   ;
}
