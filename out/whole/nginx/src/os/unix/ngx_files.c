# 0 "project/nginx/src/os/unix/ngx_files.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_files.c"
...
# 9 "project/nginx/src/os/unix/ngx_files.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_files.c" 2
# 18 "project/nginx/src/os/unix/ngx_files.c"
...
static ssize_t ngx_writev_file(ngx_file_t *file, ngx_iovec_t *vec,
    off_t offset);
# 30 "project/nginx/src/os/unix/ngx_files.c"
ssize_t
...
# 43 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 43 "project/nginx/src/os/unix/ngx_files.c"
       file->log
# 43 "project/nginx/src/os/unix/ngx_files.c" 3 4
...
# 44 "project/nginx/src/os/unix/ngx_files.c"
                                                              ;
        return 
# 45 "project/nginx/src/os/unix/ngx_files.c" 3 4
              -1
# 45 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }
# 72 "project/nginx/src/os/unix/ngx_files.c"
    file->offset += n;

    return n;
}
# 192 "project/nginx/src/os/unix/ngx_files.c"
ssize_t
ngx_write_file(ngx_file_t *file, u_char *buf, size_t size, off_t offset)
{
    ...
    for ( ;; ) {
        ...
        if (n == -1) {
            err = 
# 209 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 (*__error())
# 209 "project/nginx/src/os/unix/ngx_files.c"
                          ;

            if (err == 
# 211 "project/nginx/src/os/unix/ngx_files.c" 3 4
                      4
# 211 "project/nginx/src/os/unix/ngx_files.c"
                               ) {
...
# 217 "project/nginx/src/os/unix/ngx_files.c" 3 4
           if ((
# 217 "project/nginx/src/os/unix/ngx_files.c"
           file->log
# 217 "project/nginx/src/os/unix/ngx_files.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 217 "project/nginx/src/os/unix/ngx_files.c"
...
# 217 "project/nginx/src/os/unix/ngx_files.c" 3 4
           , 
# 217 "project/nginx/src/os/unix/ngx_files.c"
           err, "pwrite() \"%s\" failed", file->name.data
# 217 "project/nginx/src/os/unix/ngx_files.c" 3 4
           )
                                                                    
# 218 "project/nginx/src/os/unix/ngx_files.c"
                                                                   ;
            return 
# 219 "project/nginx/src/os/unix/ngx_files.c" 3 4
                  -1
# 219 "project/nginx/src/os/unix/ngx_files.c"
                           ;
        }
...
# 273 "project/nginx/src/os/unix/ngx_files.c"
}
...
# 281 "project/nginx/src/os/unix/ngx_files.c" 3 4
                                  0x00000200
# 281 "project/nginx/src/os/unix/ngx_files.c"
                                         |
# 281 "project/nginx/src/os/unix/ngx_files.c" 3 4
                                          0x00000800
# 281 "project/nginx/src/os/unix/ngx_files.c"
    ...
    ngx_pool_t *pool)
{
    ...
    ngx_iovec_t vec;
    struct iovec iovs[
# 298 "project/nginx/src/os/unix/ngx_files.c" 3 4
                       64
# 298 "project/nginx/src/os/unix/ngx_files.c"
                                           ];



    if (cl->next == 
# 302 "project/nginx/src/os/unix/ngx_files.c" 3 4
                   ((void *)0)
# 302 "project/nginx/src/os/unix/ngx_files.c"
                       ) {
    ...
    vec.iovs = iovs;
    vec.nalloc = 
# 311 "project/nginx/src/os/unix/ngx_files.c" 3 4
                64
# 311 "project/nginx/src/os/unix/ngx_files.c"
                                    ;
    ...
    do {
        ...
        if (vec.count == 1) {
            ...
            if (n == 
# 323 "project/nginx/src/os/unix/ngx_files.c" 3 4
                    -1
# 323 "project/nginx/src/os/unix/ngx_files.c"
                             ) {
                return n;
            }
        ...
        if (n == 
# 332 "project/nginx/src/os/unix/ngx_files.c" 3 4
                -1
# 332 "project/nginx/src/os/unix/ngx_files.c"
                         ) {
            return n;
        }
...
ngx_chain_to_iovec(ngx_iovec_t *vec, ngx_chain_t *cl)
{
    ...
    iov = 
# 353 "project/nginx/src/os/unix/ngx_files.c" 3 4
         ((void *)0)
# 353 "project/nginx/src/os/unix/ngx_files.c"
             ;
    prev = 
# 354 "project/nginx/src/os/unix/ngx_files.c" 3 4
          ((void *)0)
# 354 "project/nginx/src/os/unix/ngx_files.c"
              ;
    total = 0;
    n = 0;
    ...
    for ( ; cl; cl = cl->next) {
        ...
        if (
# 360 "project/nginx/src/os/unix/ngx_files.c" 3 4
           (((
# 360 "project/nginx/src/os/unix/ngx_files.c"
           cl->buf
# 360 "project/nginx/src/os/unix/ngx_files.c" 3 4
           )->flush || (
# 360 "project/nginx/src/os/unix/ngx_files.c"
...
eintr:
    ...
    if (n == -1) {
        err = 
# 407 "project/nginx/src/os/unix/ngx_files.c" 3 4
             (*__error())
# 407 "project/nginx/src/os/unix/ngx_files.c"
                      ;

        if (err == 
# 409 "project/nginx/src/os/unix/ngx_files.c" 3 4
                  4
# 409 "project/nginx/src/os/unix/ngx_files.c"
                           ) {
...
# 415 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 415 "project/nginx/src/os/unix/ngx_files.c"
       file->log
# 415 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 415 "project/nginx/src/os/unix/ngx_files.c"
...
# 415 "project/nginx/src/os/unix/ngx_files.c" 3 4
       , 
# 415 "project/nginx/src/os/unix/ngx_files.c"
       err, "pwritev() \"%s\" failed", file->name.data
# 415 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )
                                                                 
# 416 "project/nginx/src/os/unix/ngx_files.c"
                                                                ;
        return 
# 417 "project/nginx/src/os/unix/ngx_files.c" 3 4
              -1
# 417 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }

    if ((size_t) n != vec->size) {
        
# 421 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 421 "project/nginx/src/os/unix/ngx_files.c"
       file->log
# 421 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 421 "project/nginx/src/os/unix/ngx_files.c"
...
# 421 "project/nginx/src/os/unix/ngx_files.c" 3 4
       , 
# 421 "project/nginx/src/os/unix/ngx_files.c"
       0, "pwritev() \"%s\" has written only %z of %uz", file->name.data, n, vec->size
# 421 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )

                                                    
# 423 "project/nginx/src/os/unix/ngx_files.c"
                                                   ;
        return 
# 424 "project/nginx/src/os/unix/ngx_files.c" 3 4
              -1
# 424 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }
# 468 "project/nginx/src/os/unix/ngx_files.c"
    file->offset += n;

    return n;
}
# 600 "project/nginx/src/os/unix/ngx_files.c"
ngx_int_t
ngx_set_file_time(u_char *name, ngx_fd_t fd, time_t s)
{
    ...
    tv[0].tv_sec = 
# 605 "project/nginx/src/os/unix/ngx_files.c" 3 4
                  ngx_cached_time->sec
# 605 "project/nginx/src/os/unix/ngx_files.c"
                            ;
    tv[0].tv_usec = 0;
    tv[1].tv_sec = s;
    tv[1].tv_usec = 0;
    ...
    if (utimes((char *) name, tv) != -1) {
        return 
# 611 "project/nginx/src/os/unix/ngx_files.c" 3 4
              0
# 611 "project/nginx/src/os/unix/ngx_files.c"
                    ;
    }

    return 
# 614 "project/nginx/src/os/unix/ngx_files.c" 3 4
          -1
# 614 "project/nginx/src/os/unix/ngx_files.c"
                   ;
}
...
{
    fm->fd = 
# 621 "project/nginx/src/os/unix/ngx_files.c" 3 4
            open((const char *) 
# 621 "project/nginx/src/os/unix/ngx_files.c"
            fm->name
# 621 "project/nginx/src/os/unix/ngx_files.c" 3 4
            , 0x0002|(0x00000200|0x00000400), 0644)
                                                   
# 622 "project/nginx/src/os/unix/ngx_files.c"
                                                  ;

    if (fm->fd == 
# 624 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 -1
# 624 "project/nginx/src/os/unix/ngx_files.c"
                                 ) {
        
# 625 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 625 "project/nginx/src/os/unix/ngx_files.c"
       fm->log
# 625 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 625 "project/nginx/src/os/unix/ngx_files.c"
...
# 626 "project/nginx/src/os/unix/ngx_files.c"
                                                                ;
        return 
# 627 "project/nginx/src/os/unix/ngx_files.c" 3 4
              -1
# 627 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }

    if (ftruncate(fm->fd, fm->size) == -1) {
        
# 631 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 631 "project/nginx/src/os/unix/ngx_files.c"
       fm->log
# 631 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 631 "project/nginx/src/os/unix/ngx_files.c"
...
# 632 "project/nginx/src/os/unix/ngx_files.c"
                                                           ;
        goto failed;
    }

    fm->addr = mmap(
# 636 "project/nginx/src/os/unix/ngx_files.c" 3 4
                   ((void *)0)
# 636 "project/nginx/src/os/unix/ngx_files.c"
                       , fm->size, 
# 636 "project/nginx/src/os/unix/ngx_files.c" 3 4
                                   0x01
# 636 "project/nginx/src/os/unix/ngx_files.c"
...
# 636 "project/nginx/src/os/unix/ngx_files.c"
                    ...
                    fm->fd, 0);
    if (fm->addr != 
# 638 "project/nginx/src/os/unix/ngx_files.c" 3 4
                   ((void *)-1)
# 638 "project/nginx/src/os/unix/ngx_files.c"
                             ) {
        return 
# 639 "project/nginx/src/os/unix/ngx_files.c" 3 4
              0
# 639 "project/nginx/src/os/unix/ngx_files.c"
                    ;
    }

    
# 642 "project/nginx/src/os/unix/ngx_files.c" 3 4
   if ((
# 642 "project/nginx/src/os/unix/ngx_files.c"
   fm->log
# 642 "project/nginx/src/os/unix/ngx_files.c" 3 4
   )->log_level >= 3) ngx_log_error_core(3, 
# 642 "project/nginx/src/os/unix/ngx_files.c"
...
# 643 "project/nginx/src/os/unix/ngx_files.c"
                                                               ;

failed:

    if (
# 647 "project/nginx/src/os/unix/ngx_files.c" 3 4
       close
# 647 "project/nginx/src/os/unix/ngx_files.c"
                     (fm->fd) == 
# 647 "project/nginx/src/os/unix/ngx_files.c" 3 4
                                 -1
# 647 "project/nginx/src/os/unix/ngx_files.c"
...
# 648 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 648 "project/nginx/src/os/unix/ngx_files.c"
       fm->log
# 648 "project/nginx/src/os/unix/ngx_files.c" 3 4
...
# 649 "project/nginx/src/os/unix/ngx_files.c"
                                                                 ;
    }

    return 
# 652 "project/nginx/src/os/unix/ngx_files.c" 3 4
          -1
# 652 "project/nginx/src/os/unix/ngx_files.c"
                   ;
}
...
# 660 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 660 "project/nginx/src/os/unix/ngx_files.c"
       fm->log
# 660 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 660 "project/nginx/src/os/unix/ngx_files.c"
...
# 661 "project/nginx/src/os/unix/ngx_files.c"
                                                                     ;
    }

    if (
# 664 "project/nginx/src/os/unix/ngx_files.c" 3 4
       close
# 664 "project/nginx/src/os/unix/ngx_files.c"
                     (fm->fd) == 
# 664 "project/nginx/src/os/unix/ngx_files.c" 3 4
                                 -1
# 664 "project/nginx/src/os/unix/ngx_files.c"
...
# 665 "project/nginx/src/os/unix/ngx_files.c" 3 4
       if ((
# 665 "project/nginx/src/os/unix/ngx_files.c"
       fm->log
# 665 "project/nginx/src/os/unix/ngx_files.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 665 "project/nginx/src/os/unix/ngx_files.c"
...
# 666 "project/nginx/src/os/unix/ngx_files.c"
                                                                 ;
    }
}
...
ngx_open_dir(ngx_str_t *name, ngx_dir_t *dir)
{
    ...
    if (dir->dir == 
# 676 "project/nginx/src/os/unix/ngx_files.c" 3 4
                   ((void *)0)
# 676 "project/nginx/src/os/unix/ngx_files.c"
                       ) {
        return 
# 677 "project/nginx/src/os/unix/ngx_files.c" 3 4
              -1
# 677 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }
    ...
    return 
# 682 "project/nginx/src/os/unix/ngx_files.c" 3 4
          0
# 682 "project/nginx/src/os/unix/ngx_files.c"
                ;
}
...
ngx_read_dir(ngx_dir_t *dir)
{
    ...
    if (dir->de) {
        ...
        return 
# 697 "project/nginx/src/os/unix/ngx_files.c" 3 4
              0
# 697 "project/nginx/src/os/unix/ngx_files.c"
                    ;
    }

    return 
# 700 "project/nginx/src/os/unix/ngx_files.c" 3 4
          -1
# 700 "project/nginx/src/os/unix/ngx_files.c"
                   ;
}
...
ngx_open_glob(ngx_glob_t *gl)
{
    ...
    n = glob((char *) gl->pattern, 0, 
# 709 "project/nginx/src/os/unix/ngx_files.c" 3 4
                                     ((void *)0)
# 709 "project/nginx/src/os/unix/ngx_files.c"
                                         , &gl->pglob);

    if (n == 0) {
        return 
# 712 "project/nginx/src/os/unix/ngx_files.c" 3 4
              0
# 712 "project/nginx/src/os/unix/ngx_files.c"
                    ;
    }
    ...
    if (n == 
# 717 "project/nginx/src/os/unix/ngx_files.c" 3 4
            (-3) 
# 717 "project/nginx/src/os/unix/ngx_files.c"
                         && gl->test) {
        return 
# 718 "project/nginx/src/os/unix/ngx_files.c" 3 4
              0
# 718 "project/nginx/src/os/unix/ngx_files.c"
                    ;
    }
    ...
    return 
# 723 "project/nginx/src/os/unix/ngx_files.c" 3 4
          -1
# 723 "project/nginx/src/os/unix/ngx_files.c"
                   ;
}
...
ngx_read_glob(ngx_glob_t *gl, ngx_str_t *name)
{
    ...
    if (gl->n < count) {
        ...
        name->len = (size_t) 
# 740 "project/nginx/src/os/unix/ngx_files.c" 3 4
                            strlen((const char *) 
# 740 "project/nginx/src/os/unix/ngx_files.c"
...
# 740 "project/nginx/src/os/unix/ngx_files.c"
        ...
        return 
# 744 "project/nginx/src/os/unix/ngx_files.c" 3 4
              0
# 744 "project/nginx/src/os/unix/ngx_files.c"
                    ;
    }

    return 
# 747 "project/nginx/src/os/unix/ngx_files.c" 3 4
          -4
# 747 "project/nginx/src/os/unix/ngx_files.c"
                  ;
}
...
# 763 "project/nginx/src/os/unix/ngx_files.c" 3 4
   (void) __builtin___memset_chk (
# 763 "project/nginx/src/os/unix/ngx_files.c"
   &fl
# 763 "project/nginx/src/os/unix/ngx_files.c" 3 4
   , 0, 
# 763 "project/nginx/src/os/unix/ngx_files.c"
...
# 763 "project/nginx/src/os/unix/ngx_files.c"
                                         ;
    fl.l_type = 
# 764 "project/nginx/src/os/unix/ngx_files.c" 3 4
               3
# 764 "project/nginx/src/os/unix/ngx_files.c"
                      ;
    fl.l_whence = 
# 765 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 0
# 765 "project/nginx/src/os/unix/ngx_files.c"
                         ;

    if (fcntl(fd, 
# 767 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 8
# 767 "project/nginx/src/os/unix/ngx_files.c"
                        , &fl) == -1) {
        return 
# 768 "project/nginx/src/os/unix/ngx_files.c" 3 4
              (*__error())
# 768 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }
...
# 780 "project/nginx/src/os/unix/ngx_files.c" 3 4
   (void) __builtin___memset_chk (
# 780 "project/nginx/src/os/unix/ngx_files.c"
   &fl
# 780 "project/nginx/src/os/unix/ngx_files.c" 3 4
   , 0, 
# 780 "project/nginx/src/os/unix/ngx_files.c"
...
# 780 "project/nginx/src/os/unix/ngx_files.c"
                                         ;
    fl.l_type = 
# 781 "project/nginx/src/os/unix/ngx_files.c" 3 4
               3
# 781 "project/nginx/src/os/unix/ngx_files.c"
                      ;
    fl.l_whence = 
# 782 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 0
# 782 "project/nginx/src/os/unix/ngx_files.c"
                         ;

    if (fcntl(fd, 
# 784 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 9
# 784 "project/nginx/src/os/unix/ngx_files.c"
                         , &fl) == -1) {
        return 
# 785 "project/nginx/src/os/unix/ngx_files.c" 3 4
              (*__error())
# 785 "project/nginx/src/os/unix/ngx_files.c"
                       ;
    }
...
# 797 "project/nginx/src/os/unix/ngx_files.c" 3 4
   (void) __builtin___memset_chk (
# 797 "project/nginx/src/os/unix/ngx_files.c"
   &fl
# 797 "project/nginx/src/os/unix/ngx_files.c" 3 4
   , 0, 
# 797 "project/nginx/src/os/unix/ngx_files.c"
...
# 797 "project/nginx/src/os/unix/ngx_files.c"
                                         ;
    fl.l_type = 
# 798 "project/nginx/src/os/unix/ngx_files.c" 3 4
               2
# 798 "project/nginx/src/os/unix/ngx_files.c"
                      ;
    fl.l_whence = 
# 799 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 0
# 799 "project/nginx/src/os/unix/ngx_files.c"
                         ;

    if (fcntl(fd, 
# 801 "project/nginx/src/os/unix/ngx_files.c" 3 4
                 8
# 801 "project/nginx/src/os/unix/ngx_files.c"
                        , &fl) == -1) {
        return 
# 802 "project/nginx/src/os/unix/ngx_files.c" 3 4
               (*__error())
# 802 "project/nginx/src/os/unix/ngx_files.c"
                        ;
    }

    return 0;
}
# 865 "project/nginx/src/os/unix/ngx_files.c"
size_t
...
ngx_fs_available(u_char *name)
{
    ...
    if (statfs((char *) name, &fs) == -1) {
        return 
# 894 "project/nginx/src/os/unix/ngx_files.c" 3 4
              9223372036854775807LL
# 894 "project/nginx/src/os/unix/ngx_files.c"
                                 ;
    }
