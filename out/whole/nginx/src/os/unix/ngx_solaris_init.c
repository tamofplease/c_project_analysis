# 0 "project/nginx/src/os/unix/ngx_solaris_init.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_solaris_init.c"
...
# 9 "project/nginx/src/os/unix/ngx_solaris_init.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_solaris_init.c" 2



# 12 "project/nginx/src/os/unix/ngx_solaris_init.c"
...
# 26 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   1
...
# 31 "project/nginx/src/os/unix/ngx_solaris_init.c"
};
...
# 40 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
       if ((
# 40 "project/nginx/src/os/unix/ngx_solaris_init.c"
       log
# 40 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
...
# 41 "project/nginx/src/os/unix/ngx_solaris_init.c"
                                                  ;
        return 
# 42 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
              -1
# 42 "project/nginx/src/os/unix/ngx_solaris_init.c"
                       ;
    }
...
# 48 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
       if ((
# 48 "project/nginx/src/os/unix/ngx_solaris_init.c"
       log
# 48 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 48 "project/nginx/src/os/unix/ngx_solaris_init.c"
...
# 49 "project/nginx/src/os/unix/ngx_solaris_init.c"
                                                  ;
        return 
# 50 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
              -1
# 50 "project/nginx/src/os/unix/ngx_solaris_init.c"
                       ;
    }
...
# 56 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
       if ((
# 56 "project/nginx/src/os/unix/ngx_solaris_init.c"
       log
# 56 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 56 "project/nginx/src/os/unix/ngx_solaris_init.c"
...
# 57 "project/nginx/src/os/unix/ngx_solaris_init.c"
                                                  ;
        return 
# 58 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
              -1
# 58 "project/nginx/src/os/unix/ngx_solaris_init.c"
                       ;
    }
    ...
    return 
# 64 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
          0
# 64 "project/nginx/src/os/unix/ngx_solaris_init.c"
                ;
}
...
# 72 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   if ((
# 72 "project/nginx/src/os/unix/ngx_solaris_init.c"
   log
# 72 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
...
# 72 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   , 
# 72 "project/nginx/src/os/unix/ngx_solaris_init.c"
   0, "OS: %s %s", ngx_solaris_sysname, ngx_solaris_release
# 72 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   )
                                                           
# 73 "project/nginx/src/os/unix/ngx_solaris_init.c"
                                                          ;

    
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   if ((
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c"
   log
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c"
...
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   , 
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c"
   0, "version: %s", ngx_solaris_version
# 75 "project/nginx/src/os/unix/ngx_solaris_init.c" 3 4
   )
                                      
# 76 "project/nginx/src/os/unix/ngx_solaris_init.c"
                                     ;
}
