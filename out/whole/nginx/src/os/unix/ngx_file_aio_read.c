# 0 "project/nginx/src/os/unix/ngx_file_aio_read.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
# 9 "project/nginx/src/os/unix/ngx_file_aio_read.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_file_aio_read.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_file_aio_read.c" 2
# 31 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
ngx_file_aio_init(ngx_file_t *file, ngx_pool_t *pool)
{
    ...
    if (aio == 
# 45 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              ((void *)0)
# 45 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                  ) {
        return 
# 46 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -1
# 46 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }
    ...
    return 
# 57 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
          0
# 57 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                ;
}
    ...
    ngx_pool_t *pool)
{
    ...
    if (file->aio == 
# 73 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
                    ((void *)0) 
# 73 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                         && ngx_file_aio_init(file, pool) != 
# 73 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
                                                             0
# 73 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                                   ) {
        return 
# 74 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -1
# 74 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }
...
# 81 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       if ((
# 81 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       file->log
# 81 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
...
# 81 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       , 
# 81 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       0, "second aio post for \"%V\"", &file->name
# 81 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )
                                                                
# 82 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                               ;
        return 
# 83 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -2
# 83 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }
...
# 92 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       (*__error()) = 
# 92 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       aio->err;
...
# 98 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       if ((
# 98 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       file->log
# 98 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
...
# 99 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                               ;

        return 
# 101 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -1
# 101 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }

    
# 104 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
   (void) __builtin___memset_chk (
# 104 "project/nginx/src/os/unix/ngx_file_aio_read.c"
   &aio->aiocb
# 104 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
   , 0, 
# 104 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
# 104 "project/nginx/src/os/unix/ngx_file_aio_read.c"
    ...
    if (n == -1) {
        n = 
# 120 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
           (*__error())
# 120 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                    ;

        if (n == 
# 122 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
                35
# 122 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                          ) {
            return ngx_read_file(file, buf, size, offset);
        }

        
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       if ((
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       file->log
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       , 
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       n, "aio_read(\"%V\") failed", &file->name
# 126 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )
                                                             
# 127 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                            ;

        if (n == 
# 129 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
                78
# 129 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                          ) {
            ngx_file_aio = 0;
            return ngx_read_file(file, buf, size, offset);
        }
        ...
        return 
# 134 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -1
# 134 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }
...
ngx_file_aio_result(ngx_file_t *file, ngx_event_aio_t *aio, ngx_event_t *ev)
{
    ...
    if (n == -1) {
        err = 
# 160 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
             (*__error())
# 160 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                      ;
        aio->err = err;

        
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       if ((
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       file->log
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       , 
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       err, "aio_error(\"%V\") failed", &file->name
# 163 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )
                                                              
# 164 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                             ;
        return 
# 165 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -1
# 165 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }

    if (n == 
# 168 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
            36
# 168 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                           ) {
        if (ev->ready) {
            ev->ready = 0;
            
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
           if ((
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c"
           file->log
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
           , 
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c"
           n, "aio_read(\"%V\") still in progress", &file->name
# 171 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
           )

                                      
# 173 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                     ;
        }

        return 
# 176 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -2
# 176 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }
    ...
    if (n == -1) {
        err = 
# 182 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
             (*__error())
# 182 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                      ;
        aio->err = err;
        ev->ready = 1;

        
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       if ((
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       file->log
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c"
...
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       , 
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c"
       err, "aio_return(\"%V\") failed", &file->name
# 186 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
       )
                                                               
# 187 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                              ;
        return 
# 188 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
              -1
# 188 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                       ;
    }
...
ngx_file_aio_event_handler(ngx_event_t *ev)
{
    ...
    if (ngx_file_aio_result(aio->file, aio, ev) != 
# 213 "project/nginx/src/os/unix/ngx_file_aio_read.c" 3 4
                                                  -2
# 213 "project/nginx/src/os/unix/ngx_file_aio_read.c"
                                                           ) {
        aio->handler(ev);
    }
}
