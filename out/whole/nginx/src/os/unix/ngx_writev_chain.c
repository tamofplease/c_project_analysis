# 0 "project/nginx/src/os/unix/ngx_writev_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/unix/ngx_writev_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_writev_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_writev_chain.c" 2



# 13 "project/nginx/src/os/unix/ngx_writev_chain.c"
ngx_chain_t *
ngx_writev_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    ngx_iovec_t vec;
    struct iovec iovs[
# 21 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                       64
# 21 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                           ];
    ...
    if ((ngx_event_flags & 
# 31 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                          0x00000008
# 31 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                              ) && wev->pending_eof) {
        (void) ngx_connection_error(c, wev->kq_errno,
                               "kevent() reported about an closed connection");
        wev->error = 1;
        return 
# 35 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
              (ngx_chain_t *) -1
# 35 "project/nginx/src/os/unix/ngx_writev_chain.c"
                             ;
    }
...
# 42 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                                      9223372036854775807LL 
# 42 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                                           - ngx_pagesize)) {
        limit = 
# 43 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
               9223372036854775807LL 
# 43 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                    - ngx_pagesize;
    }
    ...
    vec.iovs = iovs;
    vec.nalloc = 
# 49 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                64
# 49 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                    ;
    ...
    for ( ;; ) {
        ...
        if (cl == 
# 58 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                 (ngx_chain_t *) -1
# 58 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                ) {
            return 
# 59 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                  (ngx_chain_t *) -1
# 59 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                 ;
        }

        if (cl && cl->buf->in_file) {
            
# 63 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           if ((
# 63 "project/nginx/src/os/unix/ngx_writev_chain.c"
           c->log
# 63 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
...
# 63 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           , 
# 63 "project/nginx/src/os/unix/ngx_writev_chain.c"
           0, "file buf in writev " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last
# 63 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           )
# 74 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                             ;

            
# 76 "project/nginx/src/os/unix/ngx_writev_chain.c"
           ngx_debug_point();

            return 
# 78 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                  (ngx_chain_t *) -1
# 78 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                 ;
        }
        ...
        if (n == 
# 85 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                -1
# 85 "project/nginx/src/os/unix/ngx_writev_chain.c"
                         ) {
            return 
# 86 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                  (ngx_chain_t *) -1
# 86 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                 ;
        }

        sent = (n == 
# 89 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                    -2
# 89 "project/nginx/src/os/unix/ngx_writev_chain.c"
                             ) ? 0 : n;
        ...
        if (send >= limit || in == 
# 100 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                                  ((void *)0)
# 100 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                      ) {
            return in;
        }
    }
    ...
    ngx_log_t *log)
{
    ...
    iov = 
# 116 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
         ((void *)0)
# 116 "project/nginx/src/os/unix/ngx_writev_chain.c"
             ;
    prev = 
# 117 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
          ((void *)0)
# 117 "project/nginx/src/os/unix/ngx_writev_chain.c"
              ;
    total = 0;
    n = 0;
    ...
    for ( ; in && total < limit; in = in->next) {
        ...
        if (
# 123 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           (((
# 123 "project/nginx/src/os/unix/ngx_writev_chain.c"
           in->buf
# 123 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           )->flush || (
# 123 "project/nginx/src/os/unix/ngx_writev_chain.c"
...
# 123 "project/nginx/src/os/unix/ngx_writev_chain.c"
        ...
        if (!
# 131 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
            ((
# 131 "project/nginx/src/os/unix/ngx_writev_chain.c"
            in->buf
# 131 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
            )->temporary || (
# 131 "project/nginx/src/os/unix/ngx_writev_chain.c"
...
# 132 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           if ((
# 132 "project/nginx/src/os/unix/ngx_writev_chain.c"
           log
# 132 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 132 "project/nginx/src/os/unix/ngx_writev_chain.c"
...
# 143 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                             ;

            
# 145 "project/nginx/src/os/unix/ngx_writev_chain.c"
           ngx_debug_point();

            return 
# 147 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                  (ngx_chain_t *) -1
# 147 "project/nginx/src/os/unix/ngx_writev_chain.c"
                                 ;
        }
...
eintr:
    ...
    if (n == -1) {
        err = 
# 195 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
             (*__error())
# 195 "project/nginx/src/os/unix/ngx_writev_chain.c"
                      ;

        switch (err) {
        case 
# 198 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
            35
# 198 "project/nginx/src/os/unix/ngx_writev_chain.c"
                      :
           
                                                ;
            return 
# 201 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                  -2
# 201 "project/nginx/src/os/unix/ngx_writev_chain.c"
                           ;

        case 
# 203 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
            4
# 203 "project/nginx/src/os/unix/ngx_writev_chain.c"
                     :
        ...
        default:
            ...
            return 
# 211 "project/nginx/src/os/unix/ngx_writev_chain.c" 3 4
                  -1
# 211 "project/nginx/src/os/unix/ngx_writev_chain.c"
                           ;
        }
    }
