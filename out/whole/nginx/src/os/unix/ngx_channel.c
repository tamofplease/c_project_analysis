# 0 "project/nginx/src/os/unix/ngx_channel.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_channel.c"
...
# 9 "project/nginx/src/os/unix/ngx_channel.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_channel.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/os/unix/ngx_channel.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/os/unix/ngx_channel.h" 3 4
...
# 15 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/os/unix/ngx_channel.h" 2 3 4
...
# 11 "project/nginx/src/os/unix/ngx_channel.c" 2



# 13 "project/nginx/src/os/unix/ngx_channel.c"
ngx_int_t
    ...
    ngx_log_t *log)
{
    ...
    union {
        struct cmsghdr cm;
        char space[
# 26 "project/nginx/src/os/unix/ngx_channel.c" 3 4
...
# 26 "project/nginx/src/os/unix/ngx_channel.c"
                             sizeof(int)
# 26 "project/nginx/src/os/unix/ngx_channel.c" 3 4
...
# 26 "project/nginx/src/os/unix/ngx_channel.c"
    ...
    if (ch->fd == -1) {
        msg.msg_control = 
# 30 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                         ((void *)0)
# 30 "project/nginx/src/os/unix/ngx_channel.c"
                             ;
...
# 37 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       (void) __builtin___memset_chk (
# 37 "project/nginx/src/os/unix/ngx_channel.c"
       &cmsg
# 37 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       , 0, 
# 37 "project/nginx/src/os/unix/ngx_channel.c"
...
# 39 "project/nginx/src/os/unix/ngx_channel.c"
                                               ;
        cmsg.cm.cmsg_level = 
# 40 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                            0xffff
# 40 "project/nginx/src/os/unix/ngx_channel.c"
                                      ;
        cmsg.cm.cmsg_type = 
# 41 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                           0x01
# 41 "project/nginx/src/os/unix/ngx_channel.c"
                                     ;
# 53 "project/nginx/src/os/unix/ngx_channel.c"
        
# 53 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       (void) __builtin___memcpy_chk (((unsigned char *)(
# 53 "project/nginx/src/os/unix/ngx_channel.c"
       &cmsg.cm
# 53 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1))), 
...
# 53 "project/nginx/src/os/unix/ngx_channel.c"
       sizeof(int)
# 53 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       , __builtin_object_size (((unsigned char *)(
# 53 "project/nginx/src/os/unix/ngx_channel.c"
       &cmsg.cm
# 53 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1))), 0))
# 53 "project/nginx/src/os/unix/ngx_channel.c"
                                                            ;
    }

    msg.msg_flags = 0;
# 71 "project/nginx/src/os/unix/ngx_channel.c"
    iov[0].iov_base = (char *) ch;
    iov[0].iov_len = size;

    msg.msg_name = 
# 74 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  ((void *)0)
# 74 "project/nginx/src/os/unix/ngx_channel.c"
                      ;
    msg.msg_namelen = 0;
    msg.msg_iov = iov;
    msg.msg_iovlen = 1;
    ...
    if (n == -1) {
        err = 
# 82 "project/nginx/src/os/unix/ngx_channel.c" 3 4
             (*__error())
# 82 "project/nginx/src/os/unix/ngx_channel.c"
                      ;
        if (err == 
# 83 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  35
# 83 "project/nginx/src/os/unix/ngx_channel.c"
                            ) {
            return 
# 84 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  -2
# 84 "project/nginx/src/os/unix/ngx_channel.c"
                           ;
        }

        
# 87 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       if ((
# 87 "project/nginx/src/os/unix/ngx_channel.c"
       log
# 87 "project/nginx/src/os/unix/ngx_channel.c" 3 4
...
# 87 "project/nginx/src/os/unix/ngx_channel.c"
                                                                 ;
        return 
# 88 "project/nginx/src/os/unix/ngx_channel.c" 3 4
              -1
# 88 "project/nginx/src/os/unix/ngx_channel.c"
                       ;
    }

    return 
# 91 "project/nginx/src/os/unix/ngx_channel.c" 3 4
          0
# 91 "project/nginx/src/os/unix/ngx_channel.c"
                ;
}
...
ngx_read_channel(ngx_socket_t s, ngx_channel_t *ch, size_t size, ngx_log_t *log)
{
    ...
    union {
        struct cmsghdr cm;
        char space[
# 106 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                             (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + ((__darwin_size_t)((__darwin_size_t)(
# 106 "project/nginx/src/os/unix/ngx_channel.c"
                             sizeof(int)
# 106 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                             ) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))
# 106 "project/nginx/src/os/unix/ngx_channel.c"
    ...
    msg.msg_name = 
# 115 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  ((void *)0)
# 115 "project/nginx/src/os/unix/ngx_channel.c"
                      ;
    msg.msg_namelen = 0;
    msg.msg_iov = iov;
    msg.msg_iovlen = 1;
    ...
    if (n == -1) {
        err = 
# 131 "project/nginx/src/os/unix/ngx_channel.c" 3 4
             (*__error())
# 131 "project/nginx/src/os/unix/ngx_channel.c"
                      ;
        if (err == 
# 132 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  35
# 132 "project/nginx/src/os/unix/ngx_channel.c"
                            ) {
            return 
# 133 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  -2
# 133 "project/nginx/src/os/unix/ngx_channel.c"
                           ;
        }

        
# 136 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       if ((
# 136 "project/nginx/src/os/unix/ngx_channel.c"
       log
# 136 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 136 "project/nginx/src/os/unix/ngx_channel.c"
...
# 136 "project/nginx/src/os/unix/ngx_channel.c"
                                                                 ;
        return 
# 137 "project/nginx/src/os/unix/ngx_channel.c" 3 4
              -1
# 137 "project/nginx/src/os/unix/ngx_channel.c"
                       ;
    }
    ...
    if (n == 0) {
        ;
        return 
# 142 "project/nginx/src/os/unix/ngx_channel.c" 3 4
              -1
# 142 "project/nginx/src/os/unix/ngx_channel.c"
                       ;
    }

    if ((size_t) n < sizeof(ngx_channel_t)) {
        
# 146 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       if ((
# 146 "project/nginx/src/os/unix/ngx_channel.c"
       log
# 146 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 146 "project/nginx/src/os/unix/ngx_channel.c"
...
# 146 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       , 
# 146 "project/nginx/src/os/unix/ngx_channel.c"
       0, "recvmsg() returned not enough data: %z", n
# 146 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )
                                                                  
# 147 "project/nginx/src/os/unix/ngx_channel.c"
                                                                 ;
        return 
# 148 "project/nginx/src/os/unix/ngx_channel.c" 3 4
              -1
# 148 "project/nginx/src/os/unix/ngx_channel.c"
                       ;
    }
    ...
    if (ch->command == 
# 153 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                      1
# 153 "project/nginx/src/os/unix/ngx_channel.c"
                                          ) {

        if (cmsg.cm.cmsg_len < (socklen_t) 
# 155 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                          (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + (
# 155 "project/nginx/src/os/unix/ngx_channel.c"
                                          sizeof(int)
# 155 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                          ))
# 155 "project/nginx/src/os/unix/ngx_channel.c"
...
# 156 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           if ((
# 156 "project/nginx/src/os/unix/ngx_channel.c"
           log
# 156 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 156 "project/nginx/src/os/unix/ngx_channel.c"
...
# 156 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           , 
# 156 "project/nginx/src/os/unix/ngx_channel.c"
           0, "recvmsg() returned too small ancillary data"
# 156 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           )
                                                                        
# 157 "project/nginx/src/os/unix/ngx_channel.c"
                                                                       ;
            return 
# 158 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  -1
# 158 "project/nginx/src/os/unix/ngx_channel.c"
                           ;
        }

        if (cmsg.cm.cmsg_level != 
# 161 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                 0xffff 
# 161 "project/nginx/src/os/unix/ngx_channel.c"
                                            || cmsg.cm.cmsg_type != 
# 161 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                                                    0x01
# 161 "project/nginx/src/os/unix/ngx_channel.c"
...
# 163 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           if ((
# 163 "project/nginx/src/os/unix/ngx_channel.c"
           log
# 163 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 163 "project/nginx/src/os/unix/ngx_channel.c"
...
# 163 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           , 
# 163 "project/nginx/src/os/unix/ngx_channel.c"
           0, "recvmsg() returned invalid ancillary data " "level %d or type %d", cmsg.cm.cmsg_level, cmsg.cm.cmsg_type
# 163 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           )


                                                                
# 166 "project/nginx/src/os/unix/ngx_channel.c"
                                                               ;
            return 
# 167 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  -1
# 167 "project/nginx/src/os/unix/ngx_channel.c"
                           ;
        }
...
# 172 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       (void) __builtin___memcpy_chk (
# 172 "project/nginx/src/os/unix/ngx_channel.c"
       &ch->fd
# 172 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       , ((unsigned char *)(
# 172 "project/nginx/src/os/unix/ngx_channel.c"
...
# 172 "project/nginx/src/os/unix/ngx_channel.c"
    ...
    if (msg.msg_flags & (
# 175 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                        0x10
# 175 "project/nginx/src/os/unix/ngx_channel.c"
                                 |
# 175 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                  0x20
# 175 "project/nginx/src/os/unix/ngx_channel.c"
...
# 176 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       if ((
# 176 "project/nginx/src/os/unix/ngx_channel.c"
       log
# 176 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 176 "project/nginx/src/os/unix/ngx_channel.c"
...
# 176 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       , 
# 176 "project/nginx/src/os/unix/ngx_channel.c"
       0, "recvmsg() truncated data"
# 176 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )
                                                 
# 177 "project/nginx/src/os/unix/ngx_channel.c"
                                                ;
    }
# 194 "project/nginx/src/os/unix/ngx_channel.c"
    return n;
}
    ...
    ngx_event_handler_pt handler)
{
    ...
    if (c == 
# 207 "project/nginx/src/os/unix/ngx_channel.c" 3 4
            ((void *)0)
# 207 "project/nginx/src/os/unix/ngx_channel.c"
                ) {
        return 
# 208 "project/nginx/src/os/unix/ngx_channel.c" 3 4
              -1
# 208 "project/nginx/src/os/unix/ngx_channel.c"
                       ;
    }
    ...
    ev = (event == 
# 222 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  (-1)
# 222 "project/nginx/src/os/unix/ngx_channel.c"
                                ) ? rev : wev;

    ev->handler = handler;

    if (
# 226 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       ngx_event_actions.add_conn 
# 226 "project/nginx/src/os/unix/ngx_channel.c"
                    && (ngx_event_flags & 
# 226 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                          0x00000040
# 226 "project/nginx/src/os/unix/ngx_channel.c"
        ...
        if (
# 227 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           ngx_event_actions.add_conn
# 227 "project/nginx/src/os/unix/ngx_channel.c"
                       (c) == 
# 227 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                              -1
# 227 "project/nginx/src/os/unix/ngx_channel.c"
            ...
            return 
# 229 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  -1
# 229 "project/nginx/src/os/unix/ngx_channel.c"
                           ;
        }

    } else {
        if (
# 233 "project/nginx/src/os/unix/ngx_channel.c" 3 4
           ngx_event_actions.add
# 233 "project/nginx/src/os/unix/ngx_channel.c"
                        (ev, event, 0) == 
# 233 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                                          -1
# 233 "project/nginx/src/os/unix/ngx_channel.c"
            ...
            ngx_free_connection(c);
            return 
# 235 "project/nginx/src/os/unix/ngx_channel.c" 3 4
                  -1
# 235 "project/nginx/src/os/unix/ngx_channel.c"
                           ;
        }
    }

    return 
# 239 "project/nginx/src/os/unix/ngx_channel.c" 3 4
          0
# 239 "project/nginx/src/os/unix/ngx_channel.c"
                ;
}
...
# 247 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       if ((
# 247 "project/nginx/src/os/unix/ngx_channel.c"
       log
# 247 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 247 "project/nginx/src/os/unix/ngx_channel.c"
...
# 251 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       if ((
# 251 "project/nginx/src/os/unix/ngx_channel.c"
       log
# 251 "project/nginx/src/os/unix/ngx_channel.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 251 "project/nginx/src/os/unix/ngx_channel.c"
