# 0 "project/nginx/src/os/unix/ngx_dlopen.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_dlopen.c"
...
# 9 "project/nginx/src/os/unix/ngx_dlopen.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_dlopen.c" 2





# 14 "project/nginx/src/os/unix/ngx_dlopen.c"
char *
ngx_dlerror(void)
{
    char *err;
    ...
    if (err == 
# 21 "project/nginx/src/os/unix/ngx_dlopen.c" 3 4
              ((void *)0)
# 21 "project/nginx/src/os/unix/ngx_dlopen.c"
                  ) {
        return "";
    }
