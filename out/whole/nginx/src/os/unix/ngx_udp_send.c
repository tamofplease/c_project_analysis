# 0 "project/nginx/src/os/unix/ngx_udp_send.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_udp_send.c"
...
# 9 "project/nginx/src/os/unix/ngx_udp_send.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_udp_send.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_udp_send.c" 2



# 13 "project/nginx/src/os/unix/ngx_udp_send.c"
ssize_t
    ...
    for ( ;; ) {
        ...
        if (n >= 0) {
            if ((size_t) n != size) {
                ...
                return 
# 33 "project/nginx/src/os/unix/ngx_udp_send.c" 3 4
                      -1
# 33 "project/nginx/src/os/unix/ngx_udp_send.c"
                               ;
            }
        ...
        err = 
# 41 "project/nginx/src/os/unix/ngx_udp_send.c" 3 4
             (*__error())
# 41 "project/nginx/src/os/unix/ngx_udp_send.c"
                             ;

        if (err == 
# 43 "project/nginx/src/os/unix/ngx_udp_send.c" 3 4
                  35
# 43 "project/nginx/src/os/unix/ngx_udp_send.c"
                            ) {
            wev->ready = 0;
           
                                                ;
            return 
# 47 "project/nginx/src/os/unix/ngx_udp_send.c" 3 4
                  -2
# 47 "project/nginx/src/os/unix/ngx_udp_send.c"
                           ;
        }

        if (err != 
# 50 "project/nginx/src/os/unix/ngx_udp_send.c" 3 4
                  4
# 50 "project/nginx/src/os/unix/ngx_udp_send.c"
                           ) {
            wev->error = 1;
            (void) ngx_connection_error(c, err, "sendto() failed");
            return 
# 53 "project/nginx/src/os/unix/ngx_udp_send.c" 3 4
                  -1
# 53 "project/nginx/src/os/unix/ngx_udp_send.c"
                           ;
        }
    }
}
