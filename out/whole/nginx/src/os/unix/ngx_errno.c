# 0 "project/nginx/src/os/unix/ngx_errno.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/unix/ngx_errno.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_errno.c" 2



# 12 "project/nginx/src/os/unix/ngx_errno.c"
static ngx_str_t ngx_unknown_error = 
# 12 "project/nginx/src/os/unix/ngx_errno.c" 3 4
                                      { sizeof(
# 12 "project/nginx/src/os/unix/ngx_errno.c"
                                      "Unknown error"
# 12 "project/nginx/src/os/unix/ngx_errno.c" 3 4
...
ngx_strerror(ngx_err_t err, u_char *errstr, size_t size)
{
    ...
    size = 
# 88 "project/nginx/src/os/unix/ngx_errno.c" 3 4
          ((
# 88 "project/nginx/src/os/unix/ngx_errno.c"
          size 
# 88 "project/nginx/src/os/unix/ngx_errno.c" 3 4
          > 
# 88 "project/nginx/src/os/unix/ngx_errno.c"
...
# 88 "project/nginx/src/os/unix/ngx_errno.c"
    ...
    return 
# 90 "project/nginx/src/os/unix/ngx_errno.c" 3 4
          (((u_char *) __builtin___memcpy_chk (
# 90 "project/nginx/src/os/unix/ngx_errno.c"
          errstr
# 90 "project/nginx/src/os/unix/ngx_errno.c" 3 4
          , 
# 90 "project/nginx/src/os/unix/ngx_errno.c"
...
ngx_strerror_init(void)
{
    ...
    ngx_first_error = 0;
    ngx_last_error = 
# 104 "project/nginx/src/os/unix/ngx_errno.c" 3 4
                    107
# 104 "project/nginx/src/os/unix/ngx_errno.c"
                                ;
# 173 "project/nginx/src/os/unix/ngx_errno.c"
    len = (ngx_last_error - ngx_first_error) * sizeof(ngx_str_t);

    ngx_sys_errlist = malloc(len);
    if (ngx_sys_errlist == 
# 176 "project/nginx/src/os/unix/ngx_errno.c" 3 4
                          ((void *)0)
# 176 "project/nginx/src/os/unix/ngx_errno.c"
                              ) {
        goto failed;
    }
    ...
    for (err = ngx_first_error; err < ngx_last_error; err++) {
        ...
        if (msg == 
# 183 "project/nginx/src/os/unix/ngx_errno.c" 3 4
                  ((void *)0)
# 183 "project/nginx/src/os/unix/ngx_errno.c"
                      ) {
        ...
        len = 
# 188 "project/nginx/src/os/unix/ngx_errno.c" 3 4
             strlen((const char *) 
# 188 "project/nginx/src/os/unix/ngx_errno.c"
             msg
# 188 "project/nginx/src/os/unix/ngx_errno.c" 3 4
             )
# 188 "project/nginx/src/os/unix/ngx_errno.c"
        ...
        p = malloc(len);
        if (p == 
# 191 "project/nginx/src/os/unix/ngx_errno.c" 3 4
                ((void *)0)
# 191 "project/nginx/src/os/unix/ngx_errno.c"
                    ) {
            goto failed;
        }

        
# 195 "project/nginx/src/os/unix/ngx_errno.c" 3 4
       (void) __builtin___memcpy_chk (
# 195 "project/nginx/src/os/unix/ngx_errno.c"
       p
# 195 "project/nginx/src/os/unix/ngx_errno.c" 3 4
       , 
# 195 "project/nginx/src/os/unix/ngx_errno.c"
...
# 195 "project/nginx/src/os/unix/ngx_errno.c"
    ...
    return 
# 200 "project/nginx/src/os/unix/ngx_errno.c" 3 4
          0
# 200 "project/nginx/src/os/unix/ngx_errno.c"
                ;

failed:

    err = 
# 204 "project/nginx/src/os/unix/ngx_errno.c" 3 4
         (*__error())
# 204 "project/nginx/src/os/unix/ngx_errno.c"
              ;
    ngx_log_stderr(0, "malloc(%uz) failed (%d: %s)", len, err, strerror(err));

    return 
# 207 "project/nginx/src/os/unix/ngx_errno.c" 3 4
          -1
# 207 "project/nginx/src/os/unix/ngx_errno.c"
                   ;
}
