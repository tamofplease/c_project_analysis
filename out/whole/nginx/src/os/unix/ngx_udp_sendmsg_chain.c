# 0 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 9 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 2



# 13 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
ngx_udp_unix_sendmsg_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    ngx_iovec_t vec;
    struct iovec iovs[
# 26 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                       64
# 26 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                           ];
    ...
    if ((ngx_event_flags & 
# 36 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                          0x00000008
# 36 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                              ) && wev->pending_eof) {
        (void) ngx_connection_error(c, wev->kq_errno,
                               "kevent() reported about an closed connection");
        wev->error = 1;
        return 
# 40 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
              (ngx_chain_t *) -1
# 40 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                             ;
    }
...
# 47 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                      9223372036854775807LL 
# 47 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                                           - ngx_pagesize)) {
        limit = 
# 48 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
               9223372036854775807LL 
# 48 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                    - ngx_pagesize;
    }
    ...
    vec.iovs = iovs;
    vec.nalloc = 
# 54 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                64
# 54 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                    ;
    ...
    for ( ;; ) {
        ...
        if (cl == 
# 62 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                 (ngx_chain_t *) -1
# 62 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                ) {
            return 
# 63 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  (ngx_chain_t *) -1
# 63 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                 ;
        }

        if (cl && cl->buf->in_file) {
            
# 67 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           if ((
# 67 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           c->log
# 67 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
...
# 67 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           , 
# 67 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           0, "file buf in sendmsg " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last
# 67 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           )
# 78 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                             ;

            
# 80 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           ngx_debug_point();

            return 
# 82 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  (ngx_chain_t *) -1
# 82 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                 ;
        }
        ...
        if (n == 
# 93 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                -1
# 93 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                         ) {
            return 
# 94 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  (ngx_chain_t *) -1
# 94 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                 ;
        }

        if (n == 
# 97 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                -2
# 97 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                         ) {
            wev->ready = 0;
            return in;
        }
        ...
        if (send >= limit || in == 
# 106 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                  ((void *)0)
# 106 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                      ) {
            return in;
        }
    }
...
ngx_udp_output_chain_to_iovec(ngx_iovec_t *vec, ngx_chain_t *in, ngx_log_t *log)
{
    ...
    cl = in;
    iov = 
# 123 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
         ((void *)0)
# 123 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
             ;
    prev = 
# 124 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
          ((void *)0)
# 124 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
              ;
    total = 0;
    n = 0;
    flush = 0;
    ...
    for ( ; in && !flush; in = in->next) {
        ...
        if (
# 135 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           (((
# 135 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           in->buf
# 135 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           )->flush || (
# 135 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 135 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
        ...
        if (!
# 143 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
            ((
# 143 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
            in->buf
# 143 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
            )->temporary || (
# 143 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           if ((
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           log
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           , 
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           0, "bad buf in output chain " "t:%d r:%d f:%d %p %p-%p %p %O-%O", in->buf->temporary, in->buf->recycled, in->buf->in_file, in->buf->start, in->buf->pos, in->buf->last, in->buf->file, in->buf->file_pos, in->buf->file_last
# 144 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           )
# 155 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                             ;

            
# 157 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           ngx_debug_point();

            return 
# 159 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  (ngx_chain_t *) -1
# 159 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                 ;
        }
...
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
               if ((
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
               log
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
               , 
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
               0, "too many parts in a datagram"
# 169 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
               )
                                                             
# 170 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                                            ;
                return 
# 171 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                      (ngx_chain_t *) -1
# 171 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                     ;
            }
    ...
    if (n == 0) {
        iov = &vec->iovs[n++];
        iov->iov_base = 
# 195 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                       ((void *)0)
# 195 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                           ;
        iov->iov_len = 0;
    }
...
ngx_sendmsg(ngx_connection_t *c, ngx_iovec_t *vec)
{
    ...
    u_char msg_control[
# 218 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                              (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + ((__darwin_size_t)((__darwin_size_t)(
# 218 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 218 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
    ...
    u_char msg_control6[
# 222 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                               (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + ((__darwin_size_t)((__darwin_size_t)(
# 222 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 227 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
   (void) __builtin___memset_chk (
# 227 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
   &msg
# 227 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
   , 0, 
# 227 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 264 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
        if (c->local_sockaddr->sa_family == 
# 264 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                           2
# 264 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                                  ) {
            struct cmsghdr *cmsg;
            ...
            cmsg = 
# 272 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  ((
# 272 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                  &msg
# 272 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
...
# 272 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                  &msg
# 272 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  )->msg_control : (struct cmsghdr *)0L)
# 272 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                     ;
            cmsg->cmsg_level = 
# 273 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                              0
# 273 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                        ;
            cmsg->cmsg_type = 
# 274 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                             26
# 274 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                       ;
            cmsg->cmsg_len = 
# 275 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                            (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + (
# 275 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                            sizeof(struct in_pktinfo)
# 275 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                            ))
# 275 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
            ...
            pkt = (struct in_pktinfo *) 
# 279 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                       ((unsigned char *)(
# 279 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                       cmsg
# 279 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                       ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))
# 279 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 280 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           (void) __builtin___memset_chk (
# 280 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           pkt
# 280 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           , 0, 
# 280 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 280 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
        ...
        if (c->local_sockaddr->sa_family == 
# 288 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                           30
# 288 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                                   ) {
            struct cmsghdr *cmsg;
            ...
            cmsg = 
# 296 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  ((
# 296 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                  &msg
# 296 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  )->msg_controllen >= sizeof(struct cmsghdr) ? (struct cmsghdr *)(
# 296 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 296 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                     ;
            cmsg->cmsg_level = 
# 297 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                              41
# 297 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                          ;
            cmsg->cmsg_type = 
# 298 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                             46
# 298 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                         ;
            cmsg->cmsg_len = 
# 299 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                            (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + (
# 299 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                            sizeof(struct in6_pktinfo)
# 299 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                            ))
# 299 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
            ...
            pkt6 = (struct in6_pktinfo *) 
# 303 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                         ((unsigned char *)(
# 303 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                                         cmsg
# 303 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                                         ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))
# 303 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
# 304 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           (void) __builtin___memset_chk (
# 304 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
           pkt6
# 304 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
           , 0, 
# 304 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
...
eintr:
    ...
    if (n == -1) {
        err = 
# 321 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
             (*__error())
# 321 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                      ;

        switch (err) {
        case 
# 324 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
            35
# 324 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                      :
           
                                                 ;
            return 
# 327 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  -2
# 327 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                           ;

        case 
# 329 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
            4
# 329 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                     :
        ...
        default:
            ...
            return 
# 337 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c" 3 4
                  -1
# 337 "project/nginx/src/os/unix/ngx_udp_sendmsg_chain.c"
                           ;
        }
    }
