# 0 "project/nginx/src/os/unix/ngx_recv.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_recv.c"
...
# 9 "project/nginx/src/os/unix/ngx_recv.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_recv.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_recv.c" 2



# 13 "project/nginx/src/os/unix/ngx_recv.c"
ssize_t
ngx_unix_recv(ngx_connection_t *c, u_char *buf, size_t size)
{
    ...
    if (ngx_event_flags & 
# 24 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                         0x00000008
# 24 "project/nginx/src/os/unix/ngx_recv.c"
                                             ) {
...
# 36 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                   (*__error()) = 
# 36 "project/nginx/src/os/unix/ngx_recv.c"
                   rev->kq_errno;
                ...
                rev->ready = 0;
                return 
# 46 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                      -2
# 46 "project/nginx/src/os/unix/ngx_recv.c"
                               ;
            }
        }
    }
# 68 "project/nginx/src/os/unix/ngx_recv.c"
    do {
        ...
        if (n == 0) {
            rev->ready = 0;
            rev->eof = 1;
# 85 "project/nginx/src/os/unix/ngx_recv.c"
            if (ngx_event_flags & 
# 85 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                                 0x00000008
# 85 "project/nginx/src/os/unix/ngx_recv.c"
                                                     ) {
                rev->available = 0;
        ...
        if (n > 0) {
            ...
            if (ngx_event_flags & 
# 98 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                                 0x00000008
# 98 "project/nginx/src/os/unix/ngx_recv.c"
                                                     ) {
                rev->available -= n;
            ...
            if (rev->available >= 0) {
                rev->available -= n;
# 131 "project/nginx/src/os/unix/ngx_recv.c"
                if (rev->available < 0) {
                    rev->available = 0;
                    rev->ready = 0;
                }
                ...
                if (
# 141 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                   ioctl(
# 141 "project/nginx/src/os/unix/ngx_recv.c"
                   c->fd
# 141 "project/nginx/src/os/unix/ngx_recv.c" 3 4
...
# 142 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                                               (*__error())
# 142 "project/nginx/src/os/unix/ngx_recv.c"
                                                               ,
                                             
# 143 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                                            "ioctl(FIONREAD)" 
# 143 "project/nginx/src/os/unix/ngx_recv.c"
                                                               " failed");
                    break;
                }
...
# 171 "project/nginx/src/os/unix/ngx_recv.c"
            if ((size_t) n < size
                && !(ngx_event_flags & 
# 172 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                                      0x00000020
# 172 "project/nginx/src/os/unix/ngx_recv.c"
                                                          ))
            {
                rev->ready = 0;
            }
        ...
        err = 
# 180 "project/nginx/src/os/unix/ngx_recv.c" 3 4
             (*__error())
# 180 "project/nginx/src/os/unix/ngx_recv.c"
                             ;

        if (err == 
# 182 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                  35 
# 182 "project/nginx/src/os/unix/ngx_recv.c"
                             || err == 
# 182 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                                       4
# 182 "project/nginx/src/os/unix/ngx_recv.c"
                                              ...
                                              ;
            n = 
# 185 "project/nginx/src/os/unix/ngx_recv.c" 3 4
               -2
# 185 "project/nginx/src/os/unix/ngx_recv.c"
                        ;
...
# 192 "project/nginx/src/os/unix/ngx_recv.c" 3 4
                   4
# 192 "project/nginx/src/os/unix/ngx_recv.c"
                            );

    rev->ready = 0;

    if (n == 
# 196 "project/nginx/src/os/unix/ngx_recv.c" 3 4
            -1
# 196 "project/nginx/src/os/unix/ngx_recv.c"
                     ) {
        rev->error = 1;
    }
