# 0 "project/nginx/src/os/unix/ngx_shmem.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_shmem.c"
...
# 9 "project/nginx/src/os/unix/ngx_shmem.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_shmem.c" 2





# 14 "project/nginx/src/os/unix/ngx_shmem.c"
ngx_int_t
ngx_shm_alloc(ngx_shm_t *shm)
{
    shm->addr = (u_char *) mmap(
# 17 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
                               ((void *)0)
# 17 "project/nginx/src/os/unix/ngx_shmem.c"
                                   , shm->size,
                                
# 18 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
                               0x01
# 18 "project/nginx/src/os/unix/ngx_shmem.c"
                                        |
# 18 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
                                         0x02
# 18 "project/nginx/src/os/unix/ngx_shmem.c"
...
# 19 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
                               0x1000
# 19 "project/nginx/src/os/unix/ngx_shmem.c"
                                       |
# 19 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
                                        0x0001
# 19 "project/nginx/src/os/unix/ngx_shmem.c"
    ...
    if (shm->addr == 
# 21 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
                    ((void *)-1)
# 21 "project/nginx/src/os/unix/ngx_shmem.c"
                              ) {
        
# 22 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
       if ((
# 22 "project/nginx/src/os/unix/ngx_shmem.c"
       shm->log
# 22 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
...
# 23 "project/nginx/src/os/unix/ngx_shmem.c"
                                                                        ;
        return 
# 24 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
              -1
# 24 "project/nginx/src/os/unix/ngx_shmem.c"
                       ;
    }

    return 
# 27 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
          0
# 27 "project/nginx/src/os/unix/ngx_shmem.c"
                ;
}
...
# 35 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
       if ((
# 35 "project/nginx/src/os/unix/ngx_shmem.c"
       shm->log
# 35 "project/nginx/src/os/unix/ngx_shmem.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 35 "project/nginx/src/os/unix/ngx_shmem.c"
...
# 36 "project/nginx/src/os/unix/ngx_shmem.c"
                                                                    ;
    }
}
