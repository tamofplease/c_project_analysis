# 0 "project/nginx/src/os/unix/ngx_thread_id.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/os/unix/ngx_thread_id.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_thread_id.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_thread_id.c" 2
...
ngx_thread_tid(void)
{
    ...
    (void) pthread_threadid_np(
# 51 "project/nginx/src/os/unix/ngx_thread_id.c" 3 4
                              ((void *)0)
# 51 "project/nginx/src/os/unix/ngx_thread_id.c"
                                  , &tid);
    return tid;
}
