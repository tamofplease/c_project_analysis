# 0 "project/nginx/src/os/unix/ngx_files.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/os/unix/ngx_files.h"
# 9 "project/nginx/src/os/unix/ngx_files.h"
...
# 13 "project/nginx/src/os/unix/ngx_files.h" 2
...
{
    (void) ngx_write_fd(ngx_stderr, text, strlen((const char *) text));
}
...
{
    (void) ngx_write_fd(ngx_stdout, text, strlen((const char *) text));
}
...
# 14 "project/nginx/src/os/unix/ngx_files.h" 2



# 16 "project/nginx/src/os/unix/ngx_files.h"
...
# 65 "project/nginx/src/os/unix/ngx_files.h"
...
# 100 "project/nginx/src/os/unix/ngx_files.h"
...
static 
# 144 "project/nginx/src/os/unix/ngx_files.h" 3 4
      inline 
# 144 "project/nginx/src/os/unix/ngx_files.h"
                 ssize_t
...
# 219 "project/nginx/src/os/unix/ngx_files.h"
...
static 
# 249 "project/nginx/src/os/unix/ngx_files.h" 3 4
      inline 
# 249 "project/nginx/src/os/unix/ngx_files.h"
                 ngx_int_t
...
# 267 "project/nginx/src/os/unix/ngx_files.h"
...
# 282 "project/nginx/src/os/unix/ngx_files.h"
