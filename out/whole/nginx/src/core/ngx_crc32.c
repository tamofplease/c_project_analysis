# 0 "project/nginx/src/core/ngx_crc32.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/core/ngx_crc32.c" 2
...
# 10 "project/nginx/src/core/ngx_crc32.c" 2
...
ngx_crc32_table_init(void)
{
    ...
    {
        return 
# 114 "project/nginx/src/core/ngx_crc32.c" 3 4
              0
# 114 "project/nginx/src/core/ngx_crc32.c"
                    ;
    }

    p = ngx_alloc(16 * sizeof(uint32_t) + ngx_cacheline_size, ngx_cycle->log);
    if (p == 
# 118 "project/nginx/src/core/ngx_crc32.c" 3 4
            ((void *)0)
# 118 "project/nginx/src/core/ngx_crc32.c"
                ) {
        return 
# 119 "project/nginx/src/core/ngx_crc32.c" 3 4
              -1
# 119 "project/nginx/src/core/ngx_crc32.c"
                       ;
    }

    p = 
# 122 "project/nginx/src/core/ngx_crc32.c" 3 4
       (u_char *) (((uintptr_t) (
# 122 "project/nginx/src/core/ngx_crc32.c"
       p
# 122 "project/nginx/src/core/ngx_crc32.c" 3 4
       ) + ((uintptr_t) 
# 122 "project/nginx/src/core/ngx_crc32.c"
...
# 124 "project/nginx/src/core/ngx_crc32.c" 3 4
   (void) __builtin___memcpy_chk (
# 124 "project/nginx/src/core/ngx_crc32.c"
   p
# 124 "project/nginx/src/core/ngx_crc32.c" 3 4
   , 
# 124 "project/nginx/src/core/ngx_crc32.c"
...
# 124 "project/nginx/src/core/ngx_crc32.c"
    ...
    return 
# 128 "project/nginx/src/core/ngx_crc32.c" 3 4
          0
# 128 "project/nginx/src/core/ngx_crc32.c"
                ;
}
