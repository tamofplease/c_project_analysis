# 0 "project/nginx/src/core/ngx_thread_pool.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_thread_pool.c"
# 9 "project/nginx/src/core/ngx_thread_pool.c"
...
# 10 "project/nginx/src/core/ngx_thread_pool.c" 2
...
# 11 "project/nginx/src/core/ngx_thread_pool.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_thread_pool.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_thread_pool.h" 3 4
...
# 15 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_thread_pool.h" 2 3 4
...
# 12 "project/nginx/src/core/ngx_thread_pool.c" 2



# 14 "project/nginx/src/core/ngx_thread_pool.c"
typedef struct {
    ngx_array_t pools;
...
#define ngx_thread_pool_queue_init(q) (q)->first = NULL; (q)->last = &(q)->first
...
static ngx_command_t ngx_thread_pool_commands[] = {
    ...
    { 
# 65 "project/nginx/src/core/ngx_thread_pool.c" 3 4
     { sizeof(
# 65 "project/nginx/src/core/ngx_thread_pool.c"
     "thread_pool"
# 65 "project/nginx/src/core/ngx_thread_pool.c" 3 4
     ) - 1, (u_char *) 
# 65 "project/nginx/src/core/ngx_thread_pool.c"
...
# 66 "project/nginx/src/core/ngx_thread_pool.c" 3 4
     0x01000000
# 66 "project/nginx/src/core/ngx_thread_pool.c"
                  |
# 66 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                   0x00010000
# 66 "project/nginx/src/core/ngx_thread_pool.c"
...
# 70 "project/nginx/src/core/ngx_thread_pool.c" 3 4
     ((void *)0) 
# 70 "project/nginx/src/core/ngx_thread_pool.c"
          },

      
# 72 "project/nginx/src/core/ngx_thread_pool.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 73 "project/nginx/src/core/ngx_thread_pool.c"
};


static ngx_core_module_t ngx_thread_pool_module_ctx = {
    
# 77 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   { sizeof(
# 77 "project/nginx/src/core/ngx_thread_pool.c"
   "thread_pool"
# 77 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) - 1, (u_char *) 
# 77 "project/nginx/src/core/ngx_thread_pool.c"
...
# 84 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 84 "project/nginx/src/core/ngx_thread_pool.c"
   "8" 
# 84 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   "," 
# 84 "project/nginx/src/core/ngx_thread_pool.c"
...
# 84 "project/nginx/src/core/ngx_thread_pool.c"
                ,
    &ngx_thread_pool_module_ctx,
    ngx_thread_pool_commands,
    
# 87 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   0x45524F43
# 87 "project/nginx/src/core/ngx_thread_pool.c"
                  ,
    
# 88 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 88 "project/nginx/src/core/ngx_thread_pool.c"
       ,
    
# 89 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 89 "project/nginx/src/core/ngx_thread_pool.c"
       ,
    ngx_thread_pool_init_worker,
    
# 91 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 91 "project/nginx/src/core/ngx_thread_pool.c"
       ,
    
# 92 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 92 "project/nginx/src/core/ngx_thread_pool.c"
       ,
    ngx_thread_pool_exit_worker,
    
# 94 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 94 "project/nginx/src/core/ngx_thread_pool.c"
       ,
    
# 95 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 96 "project/nginx/src/core/ngx_thread_pool.c"
};


static ngx_str_t ngx_thread_pool_default = 
# 99 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                           { sizeof(
# 99 "project/nginx/src/core/ngx_thread_pool.c"
                                           "default"
# 99 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                           ) - 1, (u_char *) 
# 99 "project/nginx/src/core/ngx_thread_pool.c"
...
ngx_thread_pool_init(ngx_thread_pool_t *tp, ngx_log_t *log, ngx_pool_t *pool)
{
    ...
    if (
# 114 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       ngx_event_actions.notify 
# 114 "project/nginx/src/core/ngx_thread_pool.c"
                  == 
# 114 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                     ((void *)0)
# 114 "project/nginx/src/core/ngx_thread_pool.c"
...
# 115 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 115 "project/nginx/src/core/ngx_thread_pool.c"
       log
# 115 "project/nginx/src/core/ngx_thread_pool.c" 3 4
...
# 115 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       , 
# 115 "project/nginx/src/core/ngx_thread_pool.c"
       0, "the configured event method cannot be used with thread pools"
# 115 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )
                                                                              
# 116 "project/nginx/src/core/ngx_thread_pool.c"
                                                                             ;
        return 
# 117 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 117 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }

    (&tp->queue)->first = 
# 120 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 120 "project/nginx/src/core/ngx_thread_pool.c"
   ; (&tp->queue)->last = &(&tp->queue)->first;

    if (ngx_thread_mutex_create(&tp->mtx, log) != 
# 122 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                 0
# 122 "project/nginx/src/core/ngx_thread_pool.c"
                                                       ) {
        return 
# 123 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 123 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }

    if (ngx_thread_cond_create(&tp->cond, log) != 
# 126 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                 0
# 126 "project/nginx/src/core/ngx_thread_pool.c"
                                                       ) {
        (void) ngx_thread_mutex_destroy(&tp->mtx, log);
        return 
# 128 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 128 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }
...
# 135 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 135 "project/nginx/src/core/ngx_thread_pool.c"
       log
# 135 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 135 "project/nginx/src/core/ngx_thread_pool.c"
...
# 136 "project/nginx/src/core/ngx_thread_pool.c"
                                                  ;
        return 
# 137 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 137 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }
...
# 142 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 142 "project/nginx/src/core/ngx_thread_pool.c"
       log
# 142 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 142 "project/nginx/src/core/ngx_thread_pool.c"
...
# 143 "project/nginx/src/core/ngx_thread_pool.c"
                                                            ;
        return 
# 144 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 144 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }
# 156 "project/nginx/src/core/ngx_thread_pool.c"
    for (n = 0; n < tp->threads; n++) {
        err = pthread_create(&tid, &attr, ngx_thread_pool_cycle, tp);
        if (err) {
            
# 159 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           if ((
# 159 "project/nginx/src/core/ngx_thread_pool.c"
           log
# 159 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 159 "project/nginx/src/core/ngx_thread_pool.c"
...
# 160 "project/nginx/src/core/ngx_thread_pool.c"
                                                   ;
            return 
# 161 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                  -1
# 161 "project/nginx/src/core/ngx_thread_pool.c"
                           ;
        }
    }
    ...
    return 
# 167 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          0
# 167 "project/nginx/src/core/ngx_thread_pool.c"
                ;
}
...
# 178 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (void) __builtin___memset_chk (
# 178 "project/nginx/src/core/ngx_thread_pool.c"
   &task
# 178 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   , 0, 
# 178 "project/nginx/src/core/ngx_thread_pool.c"
   sizeof(ngx_thread_task_t)
# 178 "project/nginx/src/core/ngx_thread_pool.c" 3 4
...
# 178 "project/nginx/src/core/ngx_thread_pool.c"
    ...
    for (n = 0; n < tp->threads; n++) {
        ...
        if (ngx_thread_task_post(tp, &task) != 
# 186 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                              0
# 186 "project/nginx/src/core/ngx_thread_pool.c"
                                                    ) {
            return;
        }
...
# 191 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           sched_yield()
# 191 "project/nginx/src/core/ngx_thread_pool.c"
                            ;
        }
...
ngx_thread_task_alloc(ngx_pool_t *pool, size_t size)
{
    ...
    if (task == 
# 220 "project/nginx/src/core/ngx_thread_pool.c" 3 4
               ((void *)0)
# 220 "project/nginx/src/core/ngx_thread_pool.c"
                   ) {
        return 
# 221 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 221 "project/nginx/src/core/ngx_thread_pool.c"
                  ;
    }
...
# 234 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 234 "project/nginx/src/core/ngx_thread_pool.c"
       tp->log
# 234 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 234 "project/nginx/src/core/ngx_thread_pool.c"
...
# 234 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       , 
# 234 "project/nginx/src/core/ngx_thread_pool.c"
       0, "task #%ui already active", task->id
# 234 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )
                                                           
# 235 "project/nginx/src/core/ngx_thread_pool.c"
                                                          ;
        return 
# 236 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 236 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }

    if (ngx_thread_mutex_lock(&tp->mtx, tp->log) != 
# 239 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                   0
# 239 "project/nginx/src/core/ngx_thread_pool.c"
                                                         ) {
        return 
# 240 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 240 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }
...
# 246 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 246 "project/nginx/src/core/ngx_thread_pool.c"
       tp->log
# 246 "project/nginx/src/core/ngx_thread_pool.c" 3 4
...
# 246 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       , 
# 246 "project/nginx/src/core/ngx_thread_pool.c"
       0, "thread pool \"%V\" queue overflow: %i tasks waiting", &tp->name, tp->waiting
# 246 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )

                                             
# 248 "project/nginx/src/core/ngx_thread_pool.c"
                                            ;
        return 
# 249 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 249 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }
    ...
    task->next = 
# 255 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                ((void *)0)
# 255 "project/nginx/src/core/ngx_thread_pool.c"
                    ;

    if (ngx_thread_cond_signal(&tp->cond, tp->log) != 
# 257 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                     0
# 257 "project/nginx/src/core/ngx_thread_pool.c"
                                                           ) {
        (void) ngx_thread_mutex_unlock(&tp->mtx, tp->log);
        return 
# 259 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              -1
# 259 "project/nginx/src/core/ngx_thread_pool.c"
                       ;
    }
    ...
    *tp->queue.last = task;
    ...
    return 
# 273 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          0
# 273 "project/nginx/src/core/ngx_thread_pool.c"
                ;
}
...
# 293 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (*(
# 293 "project/nginx/src/core/ngx_thread_pool.c"
   &set
# 293 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) = ~(sigset_t)0, 0)
# 293 "project/nginx/src/core/ngx_thread_pool.c"
...
# 295 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (*(
# 295 "project/nginx/src/core/ngx_thread_pool.c"
   &set
# 295 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) &= ~__sigbits(4), 0)
# 295 "project/nginx/src/core/ngx_thread_pool.c"
...
# 296 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (*(
# 296 "project/nginx/src/core/ngx_thread_pool.c"
   &set
# 296 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) &= ~__sigbits(8), 0)
# 296 "project/nginx/src/core/ngx_thread_pool.c"
...
# 297 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (*(
# 297 "project/nginx/src/core/ngx_thread_pool.c"
   &set
# 297 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) &= ~__sigbits(11), 0)
# 297 "project/nginx/src/core/ngx_thread_pool.c"
...
# 298 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   (*(
# 298 "project/nginx/src/core/ngx_thread_pool.c"
   &set
# 298 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) &= ~__sigbits(10), 0)
# 298 "project/nginx/src/core/ngx_thread_pool.c"
    ...
    err = pthread_sigmask(
# 300 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                         1
# 300 "project/nginx/src/core/ngx_thread_pool.c"
                                  , &set, 
# 300 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                          ((void *)0)
# 300 "project/nginx/src/core/ngx_thread_pool.c"
...
# 302 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 302 "project/nginx/src/core/ngx_thread_pool.c"
       tp->log
# 302 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 302 "project/nginx/src/core/ngx_thread_pool.c"
...
# 302 "project/nginx/src/core/ngx_thread_pool.c"
                                                                             ;
        return 
# 303 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 303 "project/nginx/src/core/ngx_thread_pool.c"
                  ;
    }

    for ( ;; ) {
        if (ngx_thread_mutex_lock(&tp->mtx, tp->log) != 
# 307 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                       0
# 307 "project/nginx/src/core/ngx_thread_pool.c"
                                                             ) {
            return 
# 308 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                  ((void *)0)
# 308 "project/nginx/src/core/ngx_thread_pool.c"
                      ;
        }
        ...
        while (tp->queue.first == 
# 314 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                 ((void *)0)
# 314 "project/nginx/src/core/ngx_thread_pool.c"
                                     ) {
            if (ngx_thread_cond_wait(&tp->cond, &tp->mtx, tp->log)
                != 
# 316 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                  0
# 316 "project/nginx/src/core/ngx_thread_pool.c"
                        )
            {
                (void) ngx_thread_mutex_unlock(&tp->mtx, tp->log);
                return 
# 319 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                      ((void *)0)
# 319 "project/nginx/src/core/ngx_thread_pool.c"
                          ;
            }
        }
        ...
        if (tp->queue.first == 
# 326 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                              ((void *)0)
# 326 "project/nginx/src/core/ngx_thread_pool.c"
                                  ) {
            tp->queue.last = &tp->queue.first;
        }

        if (ngx_thread_mutex_unlock(&tp->mtx, tp->log) != 
# 330 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                         0
# 330 "project/nginx/src/core/ngx_thread_pool.c"
                                                               ) {
            return 
# 331 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                  ((void *)0)
# 331 "project/nginx/src/core/ngx_thread_pool.c"
                      ;
        }
        ...
        task->next = 
# 348 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                    ((void *)0)
# 348 "project/nginx/src/core/ngx_thread_pool.c"
                        ;
...
# 355 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       __sync_synchronize()
# 355 "project/nginx/src/core/ngx_thread_pool.c"
                           ;

        
# 357 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       *(
# 357 "project/nginx/src/core/ngx_thread_pool.c"
...
# 357 "project/nginx/src/core/ngx_thread_pool.c"
        ...
        (void) 
# 359 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ngx_event_actions.notify
# 359 "project/nginx/src/core/ngx_thread_pool.c"
...
ngx_thread_pool_handler(ngx_event_t *ev)
{
    ...
    ngx_thread_pool_done.first = 
# 375 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                ((void *)0)
# 375 "project/nginx/src/core/ngx_thread_pool.c"
                                    ;
    ngx_thread_pool_done.last = &ngx_thread_pool_done.first;

    
# 378 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   __sync_synchronize()
# 378 "project/nginx/src/core/ngx_thread_pool.c"
                       ;

    
# 380 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   *(
# 380 "project/nginx/src/core/ngx_thread_pool.c"
   &ngx_thread_pool_done_lock
# 380 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ) = 0
# 380 "project/nginx/src/core/ngx_thread_pool.c"
...
ngx_thread_pool_create_conf(ngx_cycle_t *cycle)
{
    ...
    if (tcf == 
# 403 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 403 "project/nginx/src/core/ngx_thread_pool.c"
                  ) {
        return 
# 404 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 404 "project/nginx/src/core/ngx_thread_pool.c"
                  ;
    }
    ...
    if (ngx_array_init(&tcf->pools, cycle->pool, 4,
        ...
        != 
# 409 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          0
# 409 "project/nginx/src/core/ngx_thread_pool.c"
                )
    {
        return 
# 411 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 411 "project/nginx/src/core/ngx_thread_pool.c"
                  ;
    }
...
ngx_thread_pool_init_conf(ngx_cycle_t *cycle, void *conf)
{
    ...
    for (i = 0; i < tcf->pools.nelts; i++) {
        ...
        if (tpp[i]->name.len == ngx_thread_pool_default.len
            && 
# 435 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              strncmp((const char *) 
# 435 "project/nginx/src/core/ngx_thread_pool.c"
              tpp[i]->name.data
# 435 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              , (const char *) 
# 435 "project/nginx/src/core/ngx_thread_pool.c"
...
# 437 "project/nginx/src/core/ngx_thread_pool.c"
              == 0)
        {
            tpp[i]->threads = 32;
...
# 444 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       if ((
# 444 "project/nginx/src/core/ngx_thread_pool.c"
       cycle->log
# 444 "project/nginx/src/core/ngx_thread_pool.c" 3 4
...
# 444 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       , 
# 444 "project/nginx/src/core/ngx_thread_pool.c"
       0, "unknown thread pool \"%V\" in %s:%ui", &tpp[i]->name, tpp[i]->file, tpp[i]->line
# 444 "project/nginx/src/core/ngx_thread_pool.c" 3 4
       )

                                                                
# 446 "project/nginx/src/core/ngx_thread_pool.c"
                                                               ;

        return 
# 448 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              (void *) -1
# 448 "project/nginx/src/core/ngx_thread_pool.c"
                            ;
    }

    return 
# 451 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          ((void *)0)
# 451 "project/nginx/src/core/ngx_thread_pool.c"
                     ;
}
...
ngx_thread_pool(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (tp == 
# 466 "project/nginx/src/core/ngx_thread_pool.c" 3 4
             ((void *)0)
# 466 "project/nginx/src/core/ngx_thread_pool.c"
                 ) {
        return 
# 467 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              (void *) -1
# 467 "project/nginx/src/core/ngx_thread_pool.c"
                            ;
    }

    if (tp->threads) {
        ngx_conf_log_error(
# 471 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                          1
# 471 "project/nginx/src/core/ngx_thread_pool.c"
                                       , cf, 0,
                           "duplicate thread pool \"%V\"", &tp->name);
        return 
# 473 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              (void *) -1
# 473 "project/nginx/src/core/ngx_thread_pool.c"
                            ;
    }
    ...
    for (i = 2; i < cf->args->nelts; i++) {
        ...
        if (
# 480 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           strncmp((const char *) 
# 480 "project/nginx/src/core/ngx_thread_pool.c"
           value[i].data
# 480 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           , (const char *) 
# 480 "project/nginx/src/core/ngx_thread_pool.c"
...
# 480 "project/nginx/src/core/ngx_thread_pool.c"
            ...
            if (tp->threads == (ngx_uint_t) 
# 484 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                           -1 
# 484 "project/nginx/src/core/ngx_thread_pool.c"
                                                     || tp->threads == 0) {
                ngx_conf_log_error(
# 485 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                  1
# 485 "project/nginx/src/core/ngx_thread_pool.c"
                                               , cf, 0,
                                   "invalid threads value \"%V\"", &value[i]);
                return 
# 487 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                      (void *) -1
# 487 "project/nginx/src/core/ngx_thread_pool.c"
                                    ;
            }
        ...
        if (
# 493 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           strncmp((const char *) 
# 493 "project/nginx/src/core/ngx_thread_pool.c"
           value[i].data
# 493 "project/nginx/src/core/ngx_thread_pool.c" 3 4
           , (const char *) 
# 493 "project/nginx/src/core/ngx_thread_pool.c"
...
# 493 "project/nginx/src/core/ngx_thread_pool.c"
            ...
            if (tp->max_queue == 
# 497 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                -1
# 497 "project/nginx/src/core/ngx_thread_pool.c"
                                         ) {
                ngx_conf_log_error(
# 498 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                  1
# 498 "project/nginx/src/core/ngx_thread_pool.c"
                                               , cf, 0,
                                   "invalid max_queue value \"%V\"", &value[i]);
                return 
# 500 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                      (void *) -1
# 500 "project/nginx/src/core/ngx_thread_pool.c"
                                    ;
            }
    ...
    if (tp->threads == 0) {
        ngx_conf_log_error(
# 508 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                          1
# 508 "project/nginx/src/core/ngx_thread_pool.c"
                                       , cf, 0,
                           "\"%V\" must have \"threads\" parameter",
                           &cmd->name);
        return 
# 511 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              (void *) -1
# 511 "project/nginx/src/core/ngx_thread_pool.c"
                            ;
    }

    return 
# 514 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          ((void *)0)
# 514 "project/nginx/src/core/ngx_thread_pool.c"
                     ;
}
...
ngx_thread_pool_add(ngx_conf_t *cf, ngx_str_t *name)
{
    ...
    if (name == 
# 524 "project/nginx/src/core/ngx_thread_pool.c" 3 4
               ((void *)0)
# 524 "project/nginx/src/core/ngx_thread_pool.c"
                   ) {
    ...
    if (tp == 
# 535 "project/nginx/src/core/ngx_thread_pool.c" 3 4
             ((void *)0)
# 535 "project/nginx/src/core/ngx_thread_pool.c"
                 ) {
        return 
# 536 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 536 "project/nginx/src/core/ngx_thread_pool.c"
                  ;
    }
    ...
    tcf = (ngx_thread_pool_conf_t *) cf->cycle->conf_ctx
# 543 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    [
# 543 "project/nginx/src/core/ngx_thread_pool.c"
                                    ngx_thread_pool_module
# 543 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    .index]
                                                                         
# 544 "project/nginx/src/core/ngx_thread_pool.c"
                                                                        ;

    tpp = ngx_array_push(&tcf->pools);
    if (tpp == 
# 547 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 547 "project/nginx/src/core/ngx_thread_pool.c"
                  ) {
        return 
# 548 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 548 "project/nginx/src/core/ngx_thread_pool.c"
                  ;
    }
...
ngx_thread_pool_get(ngx_cycle_t *cycle, ngx_str_t *name)
{
    ...
    tcf = (ngx_thread_pool_conf_t *) cycle->conf_ctx
# 564 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    [
# 564 "project/nginx/src/core/ngx_thread_pool.c"
                                    ngx_thread_pool_module
# 564 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    .index]
                                                                         
# 565 "project/nginx/src/core/ngx_thread_pool.c"
                                                                        ;
    ...
    for (i = 0; i < tcf->pools.nelts; i++) {
        ...
        if (tpp[i]->name.len == name->len
            && 
# 572 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              strncmp((const char *) 
# 572 "project/nginx/src/core/ngx_thread_pool.c"
              tpp[i]->name.data
# 572 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              , (const char *) 
# 572 "project/nginx/src/core/ngx_thread_pool.c"
...
# 572 "project/nginx/src/core/ngx_thread_pool.c"
    ...
    return 
# 578 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          ((void *)0)
# 578 "project/nginx/src/core/ngx_thread_pool.c"
              ;
}
...
ngx_thread_pool_init_worker(ngx_cycle_t *cycle)
{
    ...
    if (ngx_process != 
# 589 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                      3
        
# 590 "project/nginx/src/core/ngx_thread_pool.c"
       && ngx_process != 
# 590 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                         0
# 590 "project/nginx/src/core/ngx_thread_pool.c"
                                           )
    {
        return 
# 592 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              0
# 592 "project/nginx/src/core/ngx_thread_pool.c"
                    ;
    }

    tcf = (ngx_thread_pool_conf_t *) cycle->conf_ctx
# 595 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    [
# 595 "project/nginx/src/core/ngx_thread_pool.c"
                                    ngx_thread_pool_module
# 595 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    .index]
                                                                         
# 596 "project/nginx/src/core/ngx_thread_pool.c"
                                                                        ;

    if (tcf == 
# 598 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 598 "project/nginx/src/core/ngx_thread_pool.c"
                  ) {
        return 
# 599 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              0
# 599 "project/nginx/src/core/ngx_thread_pool.c"
                    ;
    }

    (&ngx_thread_pool_done)->first = 
# 602 "project/nginx/src/core/ngx_thread_pool.c" 3 4
   ((void *)0)
# 602 "project/nginx/src/core/ngx_thread_pool.c"
   ; (&ngx_thread_pool_done)->last = &(&ngx_thread_pool_done)->first;

    tpp = tcf->pools.elts;

    for (i = 0; i < tcf->pools.nelts; i++) {
        if (ngx_thread_pool_init(tpp[i], cycle->log, cycle->pool) != 
# 607 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                                                    0
# 607 "project/nginx/src/core/ngx_thread_pool.c"
                                                                          ) {
            return 
# 608 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                  -1
# 608 "project/nginx/src/core/ngx_thread_pool.c"
                           ;
        }
    }

    return 
# 612 "project/nginx/src/core/ngx_thread_pool.c" 3 4
          0
# 612 "project/nginx/src/core/ngx_thread_pool.c"
                ;
}
...
ngx_thread_pool_exit_worker(ngx_cycle_t *cycle)
{
    ...
    if (ngx_process != 
# 623 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                      3
        
# 624 "project/nginx/src/core/ngx_thread_pool.c"
       && ngx_process != 
# 624 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                         0
# 624 "project/nginx/src/core/ngx_thread_pool.c"
                                           )
    {
    ...
    tcf = (ngx_thread_pool_conf_t *) cycle->conf_ctx
# 629 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    [
# 629 "project/nginx/src/core/ngx_thread_pool.c"
                                    ngx_thread_pool_module
# 629 "project/nginx/src/core/ngx_thread_pool.c" 3 4
                                    .index]
                                                                         
# 630 "project/nginx/src/core/ngx_thread_pool.c"
                                                                        ;

    if (tcf == 
# 632 "project/nginx/src/core/ngx_thread_pool.c" 3 4
              ((void *)0)
# 632 "project/nginx/src/core/ngx_thread_pool.c"
                  ) {
        return;
    }
