# 0 "project/nginx/src/core/ngx_conf_file.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_conf_file.c"
...
# 9 "project/nginx/src/core/ngx_conf_file.c" 2
...
# 10 "project/nginx/src/core/ngx_conf_file.c" 2

#define NGX_CONF_BUFFER 4096


# 13 "project/nginx/src/core/ngx_conf_file.c"
...
static ngx_command_t ngx_conf_commands[] = {
    ...
    { 
# 21 "project/nginx/src/core/ngx_conf_file.c" 3 4
     { sizeof(
# 21 "project/nginx/src/core/ngx_conf_file.c"
     "include"
# 21 "project/nginx/src/core/ngx_conf_file.c" 3 4
     ) - 1, (u_char *) 
# 21 "project/nginx/src/core/ngx_conf_file.c"
...
# 22 "project/nginx/src/core/ngx_conf_file.c" 3 4
     0xFF000000
# 22 "project/nginx/src/core/ngx_conf_file.c"
                 |
# 22 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  0x00000002
# 22 "project/nginx/src/core/ngx_conf_file.c"
...
# 26 "project/nginx/src/core/ngx_conf_file.c" 3 4
     ((void *)0) 
# 26 "project/nginx/src/core/ngx_conf_file.c"
          },

      
# 28 "project/nginx/src/core/ngx_conf_file.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 29 "project/nginx/src/core/ngx_conf_file.c"
};


ngx_module_t ngx_conf_module = {
    
# 33 "project/nginx/src/core/ngx_conf_file.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 33 "project/nginx/src/core/ngx_conf_file.c"
   "8" 
# 33 "project/nginx/src/core/ngx_conf_file.c" 3 4
   "," 
# 33 "project/nginx/src/core/ngx_conf_file.c"
...
# 34 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 34 "project/nginx/src/core/ngx_conf_file.c"
       ,
    ngx_conf_commands,
    
# 36 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x464E4F43
# 36 "project/nginx/src/core/ngx_conf_file.c"
                  ,
    
# 37 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 37 "project/nginx/src/core/ngx_conf_file.c"
       ,
    
# 38 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 38 "project/nginx/src/core/ngx_conf_file.c"
       ,
    
# 39 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 39 "project/nginx/src/core/ngx_conf_file.c"
       ,
    
# 40 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 40 "project/nginx/src/core/ngx_conf_file.c"
       ,
    
# 41 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 41 "project/nginx/src/core/ngx_conf_file.c"
       ,
    ngx_conf_flush_files,
    
# 43 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ((void *)0)
# 43 "project/nginx/src/core/ngx_conf_file.c"
       ,
    
# 44 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 45 "project/nginx/src/core/ngx_conf_file.c"
};
...
# 51 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000001
# 51 "project/nginx/src/core/ngx_conf_file.c"
                  ,
    
# 52 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000002
# 52 "project/nginx/src/core/ngx_conf_file.c"
                 ,
    
# 53 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000004
# 53 "project/nginx/src/core/ngx_conf_file.c"
                 ,
    
# 54 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000008
# 54 "project/nginx/src/core/ngx_conf_file.c"
                 ,
    
# 55 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000010
# 55 "project/nginx/src/core/ngx_conf_file.c"
                 ,
    
# 56 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000020
# 56 "project/nginx/src/core/ngx_conf_file.c"
                 ,
    
# 57 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000040
# 57 "project/nginx/src/core/ngx_conf_file.c"
                 ,
    
# 58 "project/nginx/src/core/ngx_conf_file.c" 3 4
   0x00000080

# 59 "project/nginx/src/core/ngx_conf_file.c"
};
...
ngx_conf_param(ngx_conf_t *cf)
{
    ...
    if (param->len == 0) {
        return 
# 73 "project/nginx/src/core/ngx_conf_file.c" 3 4
              ((void *)0)
# 73 "project/nginx/src/core/ngx_conf_file.c"
                         ;
    }

    
# 76 "project/nginx/src/core/ngx_conf_file.c" 3 4
   (void) __builtin___memset_chk (
# 76 "project/nginx/src/core/ngx_conf_file.c"
   &conf_file
# 76 "project/nginx/src/core/ngx_conf_file.c" 3 4
   , 0, 
# 76 "project/nginx/src/core/ngx_conf_file.c"
...
# 78 "project/nginx/src/core/ngx_conf_file.c" 3 4
   (void) __builtin___memset_chk (
# 78 "project/nginx/src/core/ngx_conf_file.c"
   &b
# 78 "project/nginx/src/core/ngx_conf_file.c" 3 4
   , 0, 
# 78 "project/nginx/src/core/ngx_conf_file.c"
...
# 78 "project/nginx/src/core/ngx_conf_file.c"
    ...
    conf_file.file.fd = 
# 86 "project/nginx/src/core/ngx_conf_file.c" 3 4
                       -1
# 86 "project/nginx/src/core/ngx_conf_file.c"
                                       ;
    conf_file.file.name.data = 
# 87 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              ((void *)0)
# 87 "project/nginx/src/core/ngx_conf_file.c"
                                  ;
    conf_file.line = 0;
...
# 93 "project/nginx/src/core/ngx_conf_file.c" 3 4
                           ((void *)0)
# 93 "project/nginx/src/core/ngx_conf_file.c"
                               );

    cf->conf_file = 
# 95 "project/nginx/src/core/ngx_conf_file.c" 3 4
                   ((void *)0)
# 95 "project/nginx/src/core/ngx_conf_file.c"
                       ;
...
ngx_conf_add_dump(ngx_conf_t *cf, ngx_str_t *filename)
{
    ...
    if (sn) {
        cf->conf_file->dump = 
# 116 "project/nginx/src/core/ngx_conf_file.c" 3 4
                             ((void *)0)
# 116 "project/nginx/src/core/ngx_conf_file.c"
                                 ;
        return 
# 117 "project/nginx/src/core/ngx_conf_file.c" 3 4
              0
# 117 "project/nginx/src/core/ngx_conf_file.c"
                    ;
    }

    p = ngx_pstrdup(cf->cycle->pool, filename);
    if (p == 
# 121 "project/nginx/src/core/ngx_conf_file.c" 3 4
            ((void *)0)
# 121 "project/nginx/src/core/ngx_conf_file.c"
                ) {
        return 
# 122 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 122 "project/nginx/src/core/ngx_conf_file.c"
                       ;
    }

    cd = ngx_array_push(&cf->cycle->config_dump);
    if (cd == 
# 126 "project/nginx/src/core/ngx_conf_file.c" 3 4
             ((void *)0)
# 126 "project/nginx/src/core/ngx_conf_file.c"
                 ) {
        return 
# 127 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 127 "project/nginx/src/core/ngx_conf_file.c"
                       ;
    }

    size = 
# 130 "project/nginx/src/core/ngx_conf_file.c" 3 4
          (
# 130 "project/nginx/src/core/ngx_conf_file.c"
...
# 130 "project/nginx/src/core/ngx_conf_file.c"
    ...
    if (buf == 
# 133 "project/nginx/src/core/ngx_conf_file.c" 3 4
              ((void *)0)
# 133 "project/nginx/src/core/ngx_conf_file.c"
                  ) {
        return 
# 134 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 134 "project/nginx/src/core/ngx_conf_file.c"
                       ;
    }
    ...
    if (sn == 
# 144 "project/nginx/src/core/ngx_conf_file.c" 3 4
             ((void *)0)
# 144 "project/nginx/src/core/ngx_conf_file.c"
                 ) {
        return 
# 145 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 145 "project/nginx/src/core/ngx_conf_file.c"
                       ;
    }
    ...
    return 
# 153 "project/nginx/src/core/ngx_conf_file.c" 3 4
          0
# 153 "project/nginx/src/core/ngx_conf_file.c"
                ;
}
...
ngx_conf_parse(ngx_conf_t *cf, ngx_str_t *filename)
{
    ...
    fd = 
# 172 "project/nginx/src/core/ngx_conf_file.c" 3 4
        -1
# 172 "project/nginx/src/core/ngx_conf_file.c"
                        ;
    prev = 
# 173 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 173 "project/nginx/src/core/ngx_conf_file.c"
              ;
    ...
    if (filename) {
        ...
        fd = 
# 180 "project/nginx/src/core/ngx_conf_file.c" 3 4
            open((const char *) 
# 180 "project/nginx/src/core/ngx_conf_file.c"
            filename->data
# 180 "project/nginx/src/core/ngx_conf_file.c" 3 4
            , 0x0000|0, 
# 180 "project/nginx/src/core/ngx_conf_file.c"
...
# 180 "project/nginx/src/core/ngx_conf_file.c"
        ...
        if (fd == 
# 182 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 -1
# 182 "project/nginx/src/core/ngx_conf_file.c"
                                 ) {
            ngx_conf_log_error(
# 183 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              1
# 183 "project/nginx/src/core/ngx_conf_file.c"
                                           , cf, 
# 183 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                 (*__error())
# 183 "project/nginx/src/core/ngx_conf_file.c"
...
# 184 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              "open()" 
# 184 "project/nginx/src/core/ngx_conf_file.c"
                                              " \"%s\" failed",
                               filename->data);
            return 
# 186 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  (void *) -1
# 186 "project/nginx/src/core/ngx_conf_file.c"
                                ;
        }
        ...
        if (
# 193 "project/nginx/src/core/ngx_conf_file.c" 3 4
           fstat(
# 193 "project/nginx/src/core/ngx_conf_file.c"
           fd
# 193 "project/nginx/src/core/ngx_conf_file.c" 3 4
           , 
# 193 "project/nginx/src/core/ngx_conf_file.c"
...
# 194 "project/nginx/src/core/ngx_conf_file.c" 3 4
           if ((
# 194 "project/nginx/src/core/ngx_conf_file.c"
           cf->log
# 194 "project/nginx/src/core/ngx_conf_file.c" 3 4
...
# 195 "project/nginx/src/core/ngx_conf_file.c"
                                                                        ;
        }

        cf->conf_file->buffer = &buf;

        buf.start = ngx_alloc(4096, cf->log);
        if (buf.start == 
# 201 "project/nginx/src/core/ngx_conf_file.c" 3 4
                        ((void *)0)
# 201 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
            goto failed;
        }
        ...
        {
            if (ngx_conf_add_dump(cf, filename) != 
# 225 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                  0
# 225 "project/nginx/src/core/ngx_conf_file.c"
                                                        ) {
                goto failed;
            }
            ...
            cf->conf_file->dump = 
# 230 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                 ((void *)0)
# 230 "project/nginx/src/core/ngx_conf_file.c"
                                     ;
        }

    } else if (cf->conf_file->file.fd != 
# 233 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                        -1
# 233 "project/nginx/src/core/ngx_conf_file.c"
                                                        ) {
...
# 255 "project/nginx/src/core/ngx_conf_file.c"
        if (rc == 
# 255 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 -1
# 255 "project/nginx/src/core/ngx_conf_file.c"
                          ) {
            goto done;
        ...
        if (rc == 
# 259 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 2
# 259 "project/nginx/src/core/ngx_conf_file.c"
                                    ) {

            if (type != parse_block) {
                ngx_conf_log_error(
# 262 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 262 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0, "unexpected \"}\"");
                goto failed;
            }
        ...
        if (rc == 
# 269 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 3
# 269 "project/nginx/src/core/ngx_conf_file.c"
                                   ) {

            if (type == parse_block) {
                ngx_conf_log_error(
# 272 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 272 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
        ...
        if (rc == 
# 280 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 1
# 280 "project/nginx/src/core/ngx_conf_file.c"
                                     ) {

            if (type == parse_param) {
                ngx_conf_log_error(
# 283 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 283 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
        ...
        if (cf->handler) {
            ...
            if (rc == 
# 299 "project/nginx/src/core/ngx_conf_file.c" 3 4
                     1
# 299 "project/nginx/src/core/ngx_conf_file.c"
                                         ) {
                ngx_conf_log_error(
# 300 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 300 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0, "unexpected \"{\"");
                goto failed;
            }

            rv = (*cf->handler)(cf, 
# 304 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                   ((void *)0)
# 304 "project/nginx/src/core/ngx_conf_file.c"
                                       , cf->handler_conf);
            if (rv == 
# 305 "project/nginx/src/core/ngx_conf_file.c" 3 4
                     ((void *)0)
# 305 "project/nginx/src/core/ngx_conf_file.c"
                                ) {
                continue;
            }

            if (rv == 
# 309 "project/nginx/src/core/ngx_conf_file.c" 3 4
                     (void *) -1
# 309 "project/nginx/src/core/ngx_conf_file.c"
                                   ) {
                goto failed;
            }

            ngx_conf_log_error(
# 313 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              1
# 313 "project/nginx/src/core/ngx_conf_file.c"
                                           , cf, 0, "%s", rv);
        ...
        if (rc == 
# 321 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 -1
# 321 "project/nginx/src/core/ngx_conf_file.c"
                          ) {
            goto failed;
        }
    }
...
failed:
    ...
    rc = 
# 328 "project/nginx/src/core/ngx_conf_file.c" 3 4
        -1
# 328 "project/nginx/src/core/ngx_conf_file.c"
                 ;
...
# 334 "project/nginx/src/core/ngx_conf_file.c" 3 4
           free
# 334 "project/nginx/src/core/ngx_conf_file.c"
                   (cf->conf_file->buffer->start);
        }

        if (
# 337 "project/nginx/src/core/ngx_conf_file.c" 3 4
           close
# 337 "project/nginx/src/core/ngx_conf_file.c"
                         (fd) == 
# 337 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                 -1
# 337 "project/nginx/src/core/ngx_conf_file.c"
...
# 338 "project/nginx/src/core/ngx_conf_file.c" 3 4
           if ((
# 338 "project/nginx/src/core/ngx_conf_file.c"
           cf->log
# 338 "project/nginx/src/core/ngx_conf_file.c" 3 4
...
# 340 "project/nginx/src/core/ngx_conf_file.c"
                                        ;
            rc = 
# 341 "project/nginx/src/core/ngx_conf_file.c" 3 4
                -1
# 341 "project/nginx/src/core/ngx_conf_file.c"
                         ;
        }
    ...
    if (rc == 
# 347 "project/nginx/src/core/ngx_conf_file.c" 3 4
             -1
# 347 "project/nginx/src/core/ngx_conf_file.c"
                      ) {
        return 
# 348 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 348 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }

    return 
# 351 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 351 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_handler(ngx_conf_t *cf, ngx_int_t last)
{
    ...
    for (i = 0; cf->cycle->modules[i]; i++) {
        ...
        if (cmd == 
# 371 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  ((void *)0)
# 371 "project/nginx/src/core/ngx_conf_file.c"
                      ) {
            continue;
        }
        ...
        for ( ; cmd->name.len; cmd++) {
            ...
            if (
# 381 "project/nginx/src/core/ngx_conf_file.c" 3 4
               strcmp((const char *) 
# 381 "project/nginx/src/core/ngx_conf_file.c"
               name->data
# 381 "project/nginx/src/core/ngx_conf_file.c" 3 4
               , (const char *) 
# 381 "project/nginx/src/core/ngx_conf_file.c"
...
# 387 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                              0x464E4F43
                
# 388 "project/nginx/src/core/ngx_conf_file.c"
            ...
            if (!(cmd->type & 
# 399 "project/nginx/src/core/ngx_conf_file.c" 3 4
                             0x00000100
# 399 "project/nginx/src/core/ngx_conf_file.c"
                                           ) && last != 
# 399 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                        0
# 399 "project/nginx/src/core/ngx_conf_file.c"
                ...
                ngx_conf_log_error(
# 400 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 400 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
                                  "directive \"%s\" is not terminated by \";\"",
                                  name->data);
                return 
# 403 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 403 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }

            if ((cmd->type & 
# 406 "project/nginx/src/core/ngx_conf_file.c" 3 4
                            0x00000100
# 406 "project/nginx/src/core/ngx_conf_file.c"
                                          ) && last != 
# 406 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                       1
# 406 "project/nginx/src/core/ngx_conf_file.c"
                ...
                ngx_conf_log_error(
# 407 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 407 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
                                   "directive \"%s\" has no opening \"{\"",
                                   name->data);
                return 
# 410 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 410 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }
            ...
            if (!(cmd->type & 
# 415 "project/nginx/src/core/ngx_conf_file.c" 3 4
                             0x00000400
# 415 "project/nginx/src/core/ngx_conf_file.c"
                                         )) {

                if (cmd->type & 
# 417 "project/nginx/src/core/ngx_conf_file.c" 3 4
                               0x00000200
# 417 "project/nginx/src/core/ngx_conf_file.c"
                                            ) {
...
# 423 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                      0x00000800
# 423 "project/nginx/src/core/ngx_conf_file.c"
                                                    ) {
...
# 429 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                      0x00001000
# 429 "project/nginx/src/core/ngx_conf_file.c"
                                                    ) {
                ...
                } else if (cf->args->nelts > 
# 435 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                            8
# 435 "project/nginx/src/core/ngx_conf_file.c"
                                                             ) {
            ...
            conf = 
# 447 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  ((void *)0)
# 447 "project/nginx/src/core/ngx_conf_file.c"
                      ;

            if (cmd->type & 
# 449 "project/nginx/src/core/ngx_conf_file.c" 3 4
                           0x00010000
# 449 "project/nginx/src/core/ngx_conf_file.c"
                                          ) {
                conf = ((void **) cf->ctx)[cf->cycle->modules[i]->index];

            } else if (cmd->type & 
# 452 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  0x01000000
# 452 "project/nginx/src/core/ngx_conf_file.c"
                                               ) {
                conf = &(((void **) cf->ctx)[cf->cycle->modules[i]->index]);
            ...
            if (rv == 
# 465 "project/nginx/src/core/ngx_conf_file.c" 3 4
                     ((void *)0)
# 465 "project/nginx/src/core/ngx_conf_file.c"
                                ) {
                return 
# 466 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      0
# 466 "project/nginx/src/core/ngx_conf_file.c"
                            ;
            }

            if (rv == 
# 469 "project/nginx/src/core/ngx_conf_file.c" 3 4
                     (void *) -1
# 469 "project/nginx/src/core/ngx_conf_file.c"
                                   ) {
                return 
# 470 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 470 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }

            ngx_conf_log_error(
# 473 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              1
# 473 "project/nginx/src/core/ngx_conf_file.c"
                                           , cf, 0,
                               "\"%s\" directive %s", name->data, rv);

            return 
# 476 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  -1
# 476 "project/nginx/src/core/ngx_conf_file.c"
                           ;
        }
    }
    ...
    if (found) {
        ngx_conf_log_error(
# 481 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          1
# 481 "project/nginx/src/core/ngx_conf_file.c"
                                       , cf, 0,
                           "\"%s\" directive is not allowed here", name->data);

        return 
# 484 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 484 "project/nginx/src/core/ngx_conf_file.c"
                       ;
    }

    ngx_conf_log_error(
# 487 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      1
# 487 "project/nginx/src/core/ngx_conf_file.c"
                                   , cf, 0,
                       "unknown directive \"%s\"", name->data);

    return 
# 490 "project/nginx/src/core/ngx_conf_file.c" 3 4
          -1
# 490 "project/nginx/src/core/ngx_conf_file.c"
                   ;

invalid:

    ngx_conf_log_error(
# 494 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      1
# 494 "project/nginx/src/core/ngx_conf_file.c"
                                   , cf, 0,
                       "invalid number of arguments in \"%s\" directive",
                       name->data);

    return 
# 498 "project/nginx/src/core/ngx_conf_file.c" 3 4
          -1
# 498 "project/nginx/src/core/ngx_conf_file.c"
                   ;
}
...
ngx_conf_read_token(ngx_conf_t *cf)
{
    ...
    file_size = 
# 529 "project/nginx/src/core/ngx_conf_file.c" 3 4
               (
# 529 "project/nginx/src/core/ngx_conf_file.c"
               &cf->conf_file->file.info
# 529 "project/nginx/src/core/ngx_conf_file.c" 3 4
               )->st_size
# 529 "project/nginx/src/core/ngx_conf_file.c"
        ...
        if (b->pos >= b->last) {
            ...
            if (cf->conf_file->file.offset >= file_size) {
                ...
                if (cf->args->nelts > 0 || !last_space) {
                    ...
                    if (cf->conf_file->file.fd == 
# 539 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                 -1
# 539 "project/nginx/src/core/ngx_conf_file.c"
                                                                 ) {
                        ngx_conf_log_error(
# 540 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                          1
# 540 "project/nginx/src/core/ngx_conf_file.c"
                                                       , cf, 0,
                                           "unexpected end of parameter, "
                                           "expecting \";\"");
                        return 
# 543 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              -1
# 543 "project/nginx/src/core/ngx_conf_file.c"
                                       ;
                    }

                    ngx_conf_log_error(
# 546 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                      1
# 546 "project/nginx/src/core/ngx_conf_file.c"
                                                   , cf, 0,
                                  "unexpected end of file, "
                                  "expecting \";\" or \"}\"");
                    return 
# 549 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          -1
# 549 "project/nginx/src/core/ngx_conf_file.c"
                                   ;
                }

                return 
# 552 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      3
# 552 "project/nginx/src/core/ngx_conf_file.c"
                                        ;
            }
            ...
            if (len == 4096) {
                ...
                if (d_quoted) {
                    ...
                    ngx_conf_log_error(
# 567 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                      1
# 567 "project/nginx/src/core/ngx_conf_file.c"
                                                   , cf, 0,
                                       "too long parameter \"%*s...\" started",
                                       10, start);
                    return 
# 570 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          -1
# 570 "project/nginx/src/core/ngx_conf_file.c"
                                   ;
                }

                ngx_conf_log_error(
# 573 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 573 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
                                   "too long parameter, probably "
                                   "missing terminating \"%c\" character", ch);
                return 
# 576 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 576 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }

            if (len) {
                
# 580 "project/nginx/src/core/ngx_conf_file.c" 3 4
               (void) __builtin___memmove_chk (
# 580 "project/nginx/src/core/ngx_conf_file.c"
               b->start
# 580 "project/nginx/src/core/ngx_conf_file.c" 3 4
               , 
# 580 "project/nginx/src/core/ngx_conf_file.c"
...
# 580 "project/nginx/src/core/ngx_conf_file.c"
            ...
            if (n == 
# 592 "project/nginx/src/core/ngx_conf_file.c" 3 4
                    -1
# 592 "project/nginx/src/core/ngx_conf_file.c"
                             ) {
                return 
# 593 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 593 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }

            if (n != size) {
                ngx_conf_log_error(
# 597 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 597 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
                                   
# 598 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  "pread()" 
# 598 "project/nginx/src/core/ngx_conf_file.c"
                                                  " returned "
                                   "only %z bytes instead of %z",
                                   n, size);
                return 
# 601 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 601 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }
            ...
            if (dump) {
                dump->last = 
# 609 "project/nginx/src/core/ngx_conf_file.c" 3 4
                            (((u_char *) __builtin___memcpy_chk (
# 609 "project/nginx/src/core/ngx_conf_file.c"
                            dump->last
# 609 "project/nginx/src/core/ngx_conf_file.c" 3 4
                            , 
# 609 "project/nginx/src/core/ngx_conf_file.c"
...
# 609 "project/nginx/src/core/ngx_conf_file.c"
        ...
        if (ch == 
# 615 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 (u_char) '\n'
# 615 "project/nginx/src/core/ngx_conf_file.c"
                   ) {
            cf->conf_file->line++;
        ...
        if (need_space) {
            if (ch == ' ' || ch == '\t' || ch == 
# 633 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                (u_char) '\r' 
# 633 "project/nginx/src/core/ngx_conf_file.c"
                                                   || ch == 
# 633 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                            (u_char) '\n'
# 633 "project/nginx/src/core/ngx_conf_file.c"
            ...
            if (ch == ';') {
                return 
# 640 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      0
# 640 "project/nginx/src/core/ngx_conf_file.c"
                            ;
            }

            if (ch == '{') {
                return 
# 644 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      1
# 644 "project/nginx/src/core/ngx_conf_file.c"
                                          ;
            }
            ...
            if (ch == ')') {
                ...
                ngx_conf_log_error(
# 652 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  1
# 652 "project/nginx/src/core/ngx_conf_file.c"
                                               , cf, 0,
                                   "unexpected \"%c\"", ch);
                return 
# 654 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 654 "project/nginx/src/core/ngx_conf_file.c"
                               ;
            }
        }
        ...
        if (last_space) {
            ...
            if (ch == ' ' || ch == '\t' || ch == 
# 663 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                (u_char) '\r' 
# 663 "project/nginx/src/core/ngx_conf_file.c"
                                                   || ch == 
# 663 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                            (u_char) '\n'
# 663 "project/nginx/src/core/ngx_conf_file.c"
            ...
            case '{':
                if (cf->args->nelts == 0) {
                    ngx_conf_log_error(
# 672 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                      1
# 672 "project/nginx/src/core/ngx_conf_file.c"
                                                   , cf, 0,
                                       "unexpected \"%c\"", ch);
                    return 
# 674 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          -1
# 674 "project/nginx/src/core/ngx_conf_file.c"
                                   ;
                }

                if (ch == '{') {
                    return 
# 678 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          1
# 678 "project/nginx/src/core/ngx_conf_file.c"
                                              ;
                }

                return 
# 681 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      0
# 681 "project/nginx/src/core/ngx_conf_file.c"
                            ;

            case '}':
                if (cf->args->nelts != 0) {
                    ngx_conf_log_error(
# 685 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                      1
# 685 "project/nginx/src/core/ngx_conf_file.c"
                                                   , cf, 0,
                                       "unexpected \"}\"");
                    return 
# 687 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          -1
# 687 "project/nginx/src/core/ngx_conf_file.c"
                                   ;
                }

                return 
# 690 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      2
# 690 "project/nginx/src/core/ngx_conf_file.c"
                                         ;
...
# 753 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                       (u_char) '\r' 
# 753 "project/nginx/src/core/ngx_conf_file.c"
                                                          || ch == 
# 753 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                                   (u_char) '\n'
                       
# 754 "project/nginx/src/core/ngx_conf_file.c"
                      || ch == ';' || ch == '{')
            {
                last_space = 1;
                found = 1;
            ...
            if (found) {
                ...
                if (word == 
# 762 "project/nginx/src/core/ngx_conf_file.c" 3 4
                           ((void *)0)
# 762 "project/nginx/src/core/ngx_conf_file.c"
                               ) {
                    return 
# 763 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          -1
# 763 "project/nginx/src/core/ngx_conf_file.c"
                                   ;
                }

                word->data = ngx_pnalloc(cf->pool, b->pos - 1 - start + 1);
                if (word->data == 
# 767 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                 ((void *)0)
# 767 "project/nginx/src/core/ngx_conf_file.c"
                                     ) {
                    return 
# 768 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          -1
# 768 "project/nginx/src/core/ngx_conf_file.c"
                                   ;
                }
                ...
                *dst = '\0';
                ...
                if (ch == ';') {
                    return 
# 806 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          0
# 806 "project/nginx/src/core/ngx_conf_file.c"
                                ;
                }

                if (ch == '{') {
                    return 
# 810 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          1
# 810 "project/nginx/src/core/ngx_conf_file.c"
                                              ;
                }
...
# 833 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                  0
# 833 "project/nginx/src/core/ngx_conf_file.c"
                                                        ) {
        return 
# 834 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 834 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }

    if (strpbrk((char *) file.data, "*?[") == 
# 837 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                             ((void *)0)
# 837 "project/nginx/src/core/ngx_conf_file.c"
                                                 ) {
...
# 844 "project/nginx/src/core/ngx_conf_file.c" 3 4
   (void) __builtin___memset_chk (
# 844 "project/nginx/src/core/ngx_conf_file.c"
   &gl
# 844 "project/nginx/src/core/ngx_conf_file.c" 3 4
   , 0, 
# 844 "project/nginx/src/core/ngx_conf_file.c"
...
# 844 "project/nginx/src/core/ngx_conf_file.c"
    ...
    if (ngx_open_glob(&gl) != 
# 850 "project/nginx/src/core/ngx_conf_file.c" 3 4
                             0
# 850 "project/nginx/src/core/ngx_conf_file.c"
                                   ) {
        ngx_conf_log_error(
# 851 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          1
# 851 "project/nginx/src/core/ngx_conf_file.c"
                                       , cf, 
# 851 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                             (*__error())
# 851 "project/nginx/src/core/ngx_conf_file.c"
...
# 852 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          "glob()" 
# 852 "project/nginx/src/core/ngx_conf_file.c"
                                          " \"%s\" failed", file.data);
        return 
# 853 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 853 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }

    rv = 
# 856 "project/nginx/src/core/ngx_conf_file.c" 3 4
        ((void *)0)
# 856 "project/nginx/src/core/ngx_conf_file.c"
                   ;
    ...
    for ( ;; ) {
        ...
        if (n != 
# 861 "project/nginx/src/core/ngx_conf_file.c" 3 4
                0
# 861 "project/nginx/src/core/ngx_conf_file.c"
                      ) {
            break;
        }
        ...
        if (file.data == 
# 867 "project/nginx/src/core/ngx_conf_file.c" 3 4
                        ((void *)0)
# 867 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
            return 
# 868 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  (void *) -1
# 868 "project/nginx/src/core/ngx_conf_file.c"
                                ;
        }
        ...
        if (rv != 
# 875 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 ((void *)0)
# 875 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
            break;
        }
    }
...
# 906 "project/nginx/src/core/ngx_conf_file.c" 3 4
   (
# 906 "project/nginx/src/core/ngx_conf_file.c"
   &full
# 906 "project/nginx/src/core/ngx_conf_file.c" 3 4
   )->len = 0; (
# 906 "project/nginx/src/core/ngx_conf_file.c"
...
# 906 "project/nginx/src/core/ngx_conf_file.c"
    ...
    if (name->len) {
        ...
        if (ngx_conf_full_name(cycle, &full, 0) != 
# 912 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                                  0
# 912 "project/nginx/src/core/ngx_conf_file.c"
                                                        ) {
            return 
# 913 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  ((void *)0)
# 913 "project/nginx/src/core/ngx_conf_file.c"
                      ;
        }
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 922 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                 ((void *)0)
# 922 "project/nginx/src/core/ngx_conf_file.c"
                                     ) {
                    break;
                }
                part = part->next;
            ...
            if (
# 934 "project/nginx/src/core/ngx_conf_file.c" 3 4
               strcmp((const char *) 
# 934 "project/nginx/src/core/ngx_conf_file.c"
               full.data
# 934 "project/nginx/src/core/ngx_conf_file.c" 3 4
               , (const char *) 
# 934 "project/nginx/src/core/ngx_conf_file.c"
...
# 934 "project/nginx/src/core/ngx_conf_file.c"
    ...
    if (file == 
# 941 "project/nginx/src/core/ngx_conf_file.c" 3 4
               ((void *)0)
# 941 "project/nginx/src/core/ngx_conf_file.c"
                   ) {
        return 
# 942 "project/nginx/src/core/ngx_conf_file.c" 3 4
              ((void *)0)
# 942 "project/nginx/src/core/ngx_conf_file.c"
                  ;
    }

    if (name->len) {
        file->fd = 
# 946 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  -1
# 946 "project/nginx/src/core/ngx_conf_file.c"
                                  ;
        file->name = full;

    } else {
        file->fd = 
# 950 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  2
# 950 "project/nginx/src/core/ngx_conf_file.c"
                            ;
        file->name = *name;
    }

    file->flush = 
# 954 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 ((void *)0)
# 954 "project/nginx/src/core/ngx_conf_file.c"
                     ;
    file->data = 
# 955 "project/nginx/src/core/ngx_conf_file.c" 3 4
                ((void *)0)
# 955 "project/nginx/src/core/ngx_conf_file.c"
                    ;
...
ngx_conf_flush_files(ngx_cycle_t *cycle)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 976 "project/nginx/src/core/ngx_conf_file.c" 3 4
                             ((void *)0)
# 976 "project/nginx/src/core/ngx_conf_file.c"
                                 ) {
                break;
            }
            part = part->next;
...
{
    u_char errstr[
# 995 "project/nginx/src/core/ngx_conf_file.c" 3 4
                   1024
# 995 "project/nginx/src/core/ngx_conf_file.c"
                                      ], *p, *last;
    va_list args;

    last = errstr + 
# 998 "project/nginx/src/core/ngx_conf_file.c" 3 4
                   1024
# 998 "project/nginx/src/core/ngx_conf_file.c"
                                      ;

    
# 1000 "project/nginx/src/core/ngx_conf_file.c" 3 4
   __builtin_va_start(
# 1000 "project/nginx/src/core/ngx_conf_file.c"
   args
# 1000 "project/nginx/src/core/ngx_conf_file.c" 3 4
   ,
# 1000 "project/nginx/src/core/ngx_conf_file.c"
...
# 1002 "project/nginx/src/core/ngx_conf_file.c" 3 4
   __builtin_va_end(
# 1002 "project/nginx/src/core/ngx_conf_file.c"
   args
# 1002 "project/nginx/src/core/ngx_conf_file.c" 3 4
   )
# 1002 "project/nginx/src/core/ngx_conf_file.c"
    ...
    if (cf->conf_file == 
# 1008 "project/nginx/src/core/ngx_conf_file.c" 3 4
                        ((void *)0)
# 1008 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
        
# 1009 "project/nginx/src/core/ngx_conf_file.c" 3 4
       if ((
# 1009 "project/nginx/src/core/ngx_conf_file.c"
       cf->log
# 1009 "project/nginx/src/core/ngx_conf_file.c" 3 4
       )->log_level >= 
# 1009 "project/nginx/src/core/ngx_conf_file.c"
...
# 1009 "project/nginx/src/core/ngx_conf_file.c"
    ...
    if (cf->conf_file->file.fd == 
# 1013 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                 -1
# 1013 "project/nginx/src/core/ngx_conf_file.c"
                                                 ) {
        
# 1014 "project/nginx/src/core/ngx_conf_file.c" 3 4
       if ((
# 1014 "project/nginx/src/core/ngx_conf_file.c"
       cf->log
# 1014 "project/nginx/src/core/ngx_conf_file.c" 3 4
       )->log_level >= 
# 1014 "project/nginx/src/core/ngx_conf_file.c"
...
# 1014 "project/nginx/src/core/ngx_conf_file.c" 3 4
       , 
# 1014 "project/nginx/src/core/ngx_conf_file.c"
       0, "%*s in command line", p - errstr, errstr
# 1014 "project/nginx/src/core/ngx_conf_file.c" 3 4
       )
                                         
# 1015 "project/nginx/src/core/ngx_conf_file.c"
                                        ;
        return;
    }

    
# 1019 "project/nginx/src/core/ngx_conf_file.c" 3 4
   if ((
# 1019 "project/nginx/src/core/ngx_conf_file.c"
   cf->log
# 1019 "project/nginx/src/core/ngx_conf_file.c" 3 4
   )->log_level >= 
# 1019 "project/nginx/src/core/ngx_conf_file.c"
...
# 1019 "project/nginx/src/core/ngx_conf_file.c" 3 4
   , 
# 1019 "project/nginx/src/core/ngx_conf_file.c"
   0, "%*s in %s:%ui", p - errstr, errstr, cf->conf_file->file.name.data, cf->conf_file->line
# 1019 "project/nginx/src/core/ngx_conf_file.c" 3 4
   )

                                                                     
# 1021 "project/nginx/src/core/ngx_conf_file.c"
                                                                    ;
}
...
ngx_conf_set_flag_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*fp != 
# 1036 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 1036 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
        return "is duplicate";
    }
    ...
    if (ngx_strcasecmp(value[1].data, (u_char *) "on") == 0) {
        ...
        *fp = 0;
        ...
        ngx_conf_log_error(
# 1049 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          1
# 1049 "project/nginx/src/core/ngx_conf_file.c"
                                       , cf, 0,
                     "invalid value \"%s\" in \"%s\" directive, "
                     "it must be \"on\" or \"off\"",
                     value[1].data, cmd->name.data);
        return 
# 1053 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 1053 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }
    ...
    return 
# 1061 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1061 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_str_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    *field = value[1];
    ...
    return 
# 1088 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1088 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_str_array_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*a == 
# 1103 "project/nginx/src/core/ngx_conf_file.c" 3 4
             (void *) -1
# 1103 "project/nginx/src/core/ngx_conf_file.c"
                               ) {
        *a = ngx_array_create(cf->pool, 4, sizeof(ngx_str_t));
        if (*a == 
# 1105 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 ((void *)0)
# 1105 "project/nginx/src/core/ngx_conf_file.c"
                     ) {
            return 
# 1106 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  (void *) -1
# 1106 "project/nginx/src/core/ngx_conf_file.c"
                                ;
        }
    }
    ...
    s = ngx_array_push(*a);
    if (s == 
# 1111 "project/nginx/src/core/ngx_conf_file.c" 3 4
            ((void *)0)
# 1111 "project/nginx/src/core/ngx_conf_file.c"
                ) {
        return 
# 1112 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 1112 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }
    ...
    *s = value[1];
    ...
    return 
# 1124 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1124 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_keyval_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*a == 
# 1140 "project/nginx/src/core/ngx_conf_file.c" 3 4
             (void *) -1 
# 1140 "project/nginx/src/core/ngx_conf_file.c"
                                || *a == 
# 1140 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                         ((void *)0)
# 1140 "project/nginx/src/core/ngx_conf_file.c"
        ...
        *a = ngx_array_create(cf->pool, 4, sizeof(ngx_keyval_t));
        if (*a == 
# 1142 "project/nginx/src/core/ngx_conf_file.c" 3 4
                 ((void *)0)
# 1142 "project/nginx/src/core/ngx_conf_file.c"
                     ) {
            return 
# 1143 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  (void *) -1
# 1143 "project/nginx/src/core/ngx_conf_file.c"
                                ;
        }
    }
    ...
    kv = ngx_array_push(*a);
    if (kv == 
# 1148 "project/nginx/src/core/ngx_conf_file.c" 3 4
             ((void *)0)
# 1148 "project/nginx/src/core/ngx_conf_file.c"
                 ) {
        return 
# 1149 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 1149 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }
    ...
    return 
# 1162 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1162 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_num_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*np != 
# 1178 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 1178 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
        return "is duplicate";
    }
    ...
    *np = ngx_atoi(value[1].data, value[1].len);
    if (*np == 
# 1184 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 1184 "project/nginx/src/core/ngx_conf_file.c"
                       ) {
    ...
    return 
# 1193 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1193 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_size_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*sp != 
# 1208 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (size_t) -1
# 1208 "project/nginx/src/core/ngx_conf_file.c"
                                 ) {
        return "is duplicate";
    }
    ...
    *sp = ngx_parse_size(&value[1]);
    if (*sp == (size_t) 
# 1215 "project/nginx/src/core/ngx_conf_file.c" 3 4
                       -1
# 1215 "project/nginx/src/core/ngx_conf_file.c"
                                ) {
    ...
    return 
# 1224 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1224 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_off_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*op != 
# 1239 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 1239 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
        return "is duplicate";
    }
    ...
    *op = ngx_parse_offset(&value[1]);
    if (*op == (off_t) 
# 1246 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      -1
# 1246 "project/nginx/src/core/ngx_conf_file.c"
                               ) {
        return "invalid value";
    }
    ...
    return 
# 1255 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1255 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_msec_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*msp != 
# 1270 "project/nginx/src/core/ngx_conf_file.c" 3 4
               (ngx_msec_t) -1
# 1270 "project/nginx/src/core/ngx_conf_file.c"
                                  ) {
        return "is duplicate";
    }
    ...
    *msp = ngx_parse_time(&value[1], 0);
    if (*msp == (ngx_msec_t) 
# 1277 "project/nginx/src/core/ngx_conf_file.c" 3 4
                            -1
# 1277 "project/nginx/src/core/ngx_conf_file.c"
                                     ) {
        return "invalid value";
    }
    ...
    return 
# 1286 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1286 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_sec_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*sp != 
# 1301 "project/nginx/src/core/ngx_conf_file.c" 3 4
              -1
# 1301 "project/nginx/src/core/ngx_conf_file.c"
                            ) {
        return "is duplicate";
    }
    ...
    *sp = ngx_parse_time(&value[1], 1);
    if (*sp == (time_t) 
# 1308 "project/nginx/src/core/ngx_conf_file.c" 3 4
                       -1
# 1308 "project/nginx/src/core/ngx_conf_file.c"
                                ) {
        return "invalid value";
    }
    ...
    return 
# 1317 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1317 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_bufs_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (bufs->num == 
# 1338 "project/nginx/src/core/ngx_conf_file.c" 3 4
                    -1 
# 1338 "project/nginx/src/core/ngx_conf_file.c"
                              || bufs->num == 0) {
        return "invalid value";
    }
    ...
    if (bufs->size == (size_t) 
# 1343 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              -1 
# 1343 "project/nginx/src/core/ngx_conf_file.c"
                                        || bufs->size == 0) {
        return "invalid value";
    }

    return 
# 1347 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1347 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_set_enum_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*np != 
# 1362 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (ngx_uint_t) -1
# 1362 "project/nginx/src/core/ngx_conf_file.c"
                                 ) {
        return "is duplicate";
    }
    ...
    for (i = 0; e[i].name.len != 0; i++) {
        ...
        *np = e[i].value;
        ...
        return 
# 1378 "project/nginx/src/core/ngx_conf_file.c" 3 4
              ((void *)0)
# 1378 "project/nginx/src/core/ngx_conf_file.c"
                         ;
    }

    ngx_conf_log_error(
# 1381 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      1
# 1381 "project/nginx/src/core/ngx_conf_file.c"
                                   , cf, 0,
                       "invalid value \"%s\"", value[1].data);

    return 
# 1384 "project/nginx/src/core/ngx_conf_file.c" 3 4
          (void *) -1
# 1384 "project/nginx/src/core/ngx_conf_file.c"
                        ;
}
...
ngx_conf_set_bitmask_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        for (m = 0; mask[m].name.len != 0; m++) {
            ...
            if (*np & mask[m].mask) {
                ngx_conf_log_error(
# 1412 "project/nginx/src/core/ngx_conf_file.c" 3 4
                                  5
# 1412 "project/nginx/src/core/ngx_conf_file.c"
                                              , cf, 0,
        ...
        if (mask[m].name.len == 0) {
            ngx_conf_log_error(
# 1423 "project/nginx/src/core/ngx_conf_file.c" 3 4
                              1
# 1423 "project/nginx/src/core/ngx_conf_file.c"
                                           , cf, 0,
                               "invalid value \"%s\"", value[i].data);

            return 
# 1426 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  (void *) -1
# 1426 "project/nginx/src/core/ngx_conf_file.c"
                                ;
        }
    }

    return 
# 1430 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1430 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
# 1445 "project/nginx/src/core/ngx_conf_file.c"
char *
ngx_conf_deprecated(ngx_conf_t *cf, void *post, void *data)
{
    ...
    ngx_conf_log_error(
# 1450 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      5
# 1450 "project/nginx/src/core/ngx_conf_file.c"
                                  , cf, 0,
    ...
    return 
# 1455 "project/nginx/src/core/ngx_conf_file.c" 3 4
          ((void *)0)
# 1455 "project/nginx/src/core/ngx_conf_file.c"
                     ;
}
...
ngx_conf_check_num_bounds(ngx_conf_t *cf, void *post, void *data)
{
    ...
    if (bounds->high == -1) {
        if (*np >= bounds->low) {
            return 
# 1467 "project/nginx/src/core/ngx_conf_file.c" 3 4
                  ((void *)0)
# 1467 "project/nginx/src/core/ngx_conf_file.c"
                             ;
        }

        ngx_conf_log_error(
# 1470 "project/nginx/src/core/ngx_conf_file.c" 3 4
                          1
# 1470 "project/nginx/src/core/ngx_conf_file.c"
                                       , cf, 0,
                           "value must be equal to or greater than %i",
                           bounds->low);

        return 
# 1474 "project/nginx/src/core/ngx_conf_file.c" 3 4
              (void *) -1
# 1474 "project/nginx/src/core/ngx_conf_file.c"
                            ;
    }

    if (*np >= bounds->low && *np <= bounds->high) {
        return 
# 1478 "project/nginx/src/core/ngx_conf_file.c" 3 4
              ((void *)0)
# 1478 "project/nginx/src/core/ngx_conf_file.c"
                         ;
    }

    ngx_conf_log_error(
# 1481 "project/nginx/src/core/ngx_conf_file.c" 3 4
                      1
# 1481 "project/nginx/src/core/ngx_conf_file.c"
                                   , cf, 0,
                       "value must be between %i and %i",
                       bounds->low, bounds->high);

    return 
# 1485 "project/nginx/src/core/ngx_conf_file.c" 3 4
          (void *) -1
# 1485 "project/nginx/src/core/ngx_conf_file.c"
                        ;
}
