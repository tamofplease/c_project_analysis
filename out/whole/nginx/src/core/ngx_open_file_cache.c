# 0 "project/nginx/src/core/ngx_open_file_cache.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 9 "project/nginx/src/core/ngx_open_file_cache.c" 2
...
# 10 "project/nginx/src/core/ngx_open_file_cache.c" 2
...
# 11 "project/nginx/src/core/ngx_open_file_cache.c" 2
# 21 "project/nginx/src/core/ngx_open_file_cache.c"
#define NGX_MIN_READ_AHEAD (128 * 1024)



# 24 "project/nginx/src/core/ngx_open_file_cache.c"
...
ngx_open_file_cache_init(ngx_pool_t *pool, ngx_uint_t max, time_t inactive)
{
    ...
    if (cache == 
# 63 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                ((void *)0)
# 63 "project/nginx/src/core/ngx_open_file_cache.c"
                    ) {
        return 
# 64 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              ((void *)0)
# 64 "project/nginx/src/core/ngx_open_file_cache.c"
                  ;
    }

    
# 67 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   ((
# 67 "project/nginx/src/core/ngx_open_file_cache.c"
   &cache->sentinel
# 67 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   )->color = 0); (
# 67 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 70 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   (
# 70 "project/nginx/src/core/ngx_open_file_cache.c"
   &cache->expire_queue
# 70 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   )->prev = 
# 70 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 70 "project/nginx/src/core/ngx_open_file_cache.c"
   &cache->expire_queue;
    ...
    if (cln == 
# 77 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              ((void *)0)
# 77 "project/nginx/src/core/ngx_open_file_cache.c"
                  ) {
        return 
# 78 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              ((void *)0)
# 78 "project/nginx/src/core/ngx_open_file_cache.c"
                  ;
    }
...
ngx_open_file_cache_cleanup(void *data)
{
    ...
    for ( ;; ) {
        ...
        if (
# 101 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           (
# 101 "project/nginx/src/core/ngx_open_file_cache.c"
           &cache->expire_queue 
# 101 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           == (
# 101 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 101 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        q = 
# 105 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           (
# 105 "project/nginx/src/core/ngx_open_file_cache.c"
           &cache->expire_queue
# 105 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->prev
# 105 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        file = 
# 107 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              (
# 107 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 109 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       (
# 109 "project/nginx/src/core/ngx_open_file_cache.c"
       q
# 109 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->next->prev = (
# 109 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 124 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           free
# 124 "project/nginx/src/core/ngx_open_file_cache.c"
                   (file->name);
            
# 125 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           free
# 125 "project/nginx/src/core/ngx_open_file_cache.c"
                   (file);
        }
    }
...
# 130 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       if ((
# 130 "project/nginx/src/core/ngx_open_file_cache.c"
       ngx_cycle->log
# 130 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 130 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       , 
# 130 "project/nginx/src/core/ngx_open_file_cache.c"
       0, "%ui items still left in open file cache", cache->current
# 130 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )

                                     
# 132 "project/nginx/src/core/ngx_open_file_cache.c"
                                    ;
    }

    if (cache->rbtree.root != cache->rbtree.sentinel) {
        
# 136 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       if ((
# 136 "project/nginx/src/core/ngx_open_file_cache.c"
       ngx_cycle->log
# 136 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 136 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 136 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       , 
# 136 "project/nginx/src/core/ngx_open_file_cache.c"
       0, "rbtree still is not empty in open file cache"
# 136 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )
                                                                     
# 137 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                    ;
    ...
    ngx_open_file_info_t *of, ngx_pool_t *pool)
{
    ...
    of->fd = 
# 156 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            -1
# 156 "project/nginx/src/core/ngx_open_file_cache.c"
                            ;
    of->err = 0;

    if (cache == 
# 159 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                ((void *)0)
# 159 "project/nginx/src/core/ngx_open_file_cache.c"
                    ) {
        ...
        if (of->test_only) {
            ...
            if (ngx_file_info_wrapper(name, of, &fi, pool->log)
                == 
# 164 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 164 "project/nginx/src/core/ngx_open_file_cache.c"
                                )
            {
                return 
# 166 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      -1
# 166 "project/nginx/src/core/ngx_open_file_cache.c"
                               ;
            }

            of->uniq = 
# 169 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      (
# 169 "project/nginx/src/core/ngx_open_file_cache.c"
                      &fi
# 169 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      )->st_ino
# 169 "project/nginx/src/core/ngx_open_file_cache.c"
                                        ;
            of->mtime = 
# 170 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                       (
# 170 "project/nginx/src/core/ngx_open_file_cache.c"
                       &fi
# 170 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                       )->st_mtimespec.tv_sec
# 170 "project/nginx/src/core/ngx_open_file_cache.c"
                                          ;
            of->size = 
# 171 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      (
# 171 "project/nginx/src/core/ngx_open_file_cache.c"
                      &fi
# 171 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      )->st_size
# 171 "project/nginx/src/core/ngx_open_file_cache.c"
                                        ;
            of->fs_size = 
# 172 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         (((
# 172 "project/nginx/src/core/ngx_open_file_cache.c"
                         &fi
# 172 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         )->st_blocks * 512 > (
# 172 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 172 "project/nginx/src/core/ngx_open_file_cache.c"
                                              ;
            of->is_dir = 
# 173 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        (((((
# 173 "project/nginx/src/core/ngx_open_file_cache.c"
                        &fi
# 173 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 173 "project/nginx/src/core/ngx_open_file_cache.c"
                                       ;
            of->is_file = 
# 174 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         (((((
# 174 "project/nginx/src/core/ngx_open_file_cache.c"
                         &fi
# 174 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 174 "project/nginx/src/core/ngx_open_file_cache.c"
                                         ;
            of->is_link = 
# 175 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         (((((
# 175 "project/nginx/src/core/ngx_open_file_cache.c"
                         &fi
# 175 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         )->st_mode) & 0170000) == 0120000))
# 175 "project/nginx/src/core/ngx_open_file_cache.c"
                                         ;
            of->is_exec = 
# 176 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         (((
# 176 "project/nginx/src/core/ngx_open_file_cache.c"
                         &fi
# 176 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                         )->st_mode & 0000100) == 0000100)
# 176 "project/nginx/src/core/ngx_open_file_cache.c"
                                         ;

            return 
# 178 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  0
# 178 "project/nginx/src/core/ngx_open_file_cache.c"
                        ;
        }

        cln = ngx_pool_cleanup_add(pool, sizeof(ngx_pool_cleanup_file_t));
        if (cln == 
# 182 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  ((void *)0)
# 182 "project/nginx/src/core/ngx_open_file_cache.c"
                      ) {
            return 
# 183 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 183 "project/nginx/src/core/ngx_open_file_cache.c"
                           ;
        }
        ...
        if (rc == 
# 188 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 0 
# 188 "project/nginx/src/core/ngx_open_file_cache.c"
                        && !of->is_dir) {
    ...
    if (cln == 
# 201 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              ((void *)0)
# 201 "project/nginx/src/core/ngx_open_file_cache.c"
                  ) {
        return 
# 202 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              -1
# 202 "project/nginx/src/core/ngx_open_file_cache.c"
                       ;
    }

    now = 
# 205 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
         ngx_cached_time->sec
# 205 "project/nginx/src/core/ngx_open_file_cache.c"
                   ;
...
# 215 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       (
# 215 "project/nginx/src/core/ngx_open_file_cache.c"
       &file->queue
# 215 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->next->prev = (
# 215 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 215 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        if (file->fd == 
# 217 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                       -1 
# 217 "project/nginx/src/core/ngx_open_file_cache.c"
                                        && file->err == 0 && !file->is_dir) {
            ...
            if (rc != 
# 223 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     0 
# 223 "project/nginx/src/core/ngx_open_file_cache.c"
                            && (of->err == 0 || !of->errors)) {
                goto failed;
            }
        ...
        if (file->use_event
            || (file->event == 
# 231 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                              ((void *)0)
                
# 232 "project/nginx/src/core/ngx_open_file_cache.c"
            ...
            ))
        {
            if (file->err == 0) {
                ...
                of->failed = file->disable_symlinks ? 
# 261 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                     "openat()"
                                                    
# 262 "project/nginx/src/core/ngx_open_file_cache.c"
                                                   : 
# 262 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                     "open()"
# 262 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                    ;
        ...
        if (rc != 
# 291 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 0 
# 291 "project/nginx/src/core/ngx_open_file_cache.c"
                        && (of->err == 0 || !of->errors)) {
            goto failed;
        }
        ...
        if (file->count == 0) {
            ...
            if (
# 335 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               close
# 335 "project/nginx/src/core/ngx_open_file_cache.c"
                             (file->fd) == 
# 335 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                           -1
# 335 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 336 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               if ((
# 336 "project/nginx/src/core/ngx_open_file_cache.c"
               pool->log
# 336 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 336 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 337 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                     ;
            }
    ...
    if (rc != 
# 356 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             0 
# 356 "project/nginx/src/core/ngx_open_file_cache.c"
                    && (of->err == 0 || !of->errors)) {
        goto failed;
    }
...
create:
    ...
    if (file == 
# 368 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               ((void *)0)
# 368 "project/nginx/src/core/ngx_open_file_cache.c"
                   ) {
        goto failed;
    }
    ...
    if (file->name == 
# 374 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     ((void *)0)
# 374 "project/nginx/src/core/ngx_open_file_cache.c"
                         ) {
        
# 375 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       free
# 375 "project/nginx/src/core/ngx_open_file_cache.c"
               (file);
        file = 
# 376 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              ((void *)0)
# 376 "project/nginx/src/core/ngx_open_file_cache.c"
                  ;
        goto failed;
    }
    ...
    file->use_event = 0;
    file->event = 
# 391 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 ((void *)0)
# 391 "project/nginx/src/core/ngx_open_file_cache.c"
                     ;
...
# 430 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   (
# 430 "project/nginx/src/core/ngx_open_file_cache.c"
   &file->queue
# 430 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   )->next = (
# 430 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 430 "project/nginx/src/core/ngx_open_file_cache.c"
   &file->queue;
    ...
    if (of->err == 0) {
        ...
        return 
# 448 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              0
# 448 "project/nginx/src/core/ngx_open_file_cache.c"
                    ;
    }

    return 
# 451 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          -1
# 451 "project/nginx/src/core/ngx_open_file_cache.c"
                   ;
...
failed:
    ...
    if (file) {
        ...
        if (file->count == 0) {
            ...
            if (file->fd != 
# 462 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                           -1
# 462 "project/nginx/src/core/ngx_open_file_cache.c"
                                           ) {
                if (
# 463 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                   close
# 463 "project/nginx/src/core/ngx_open_file_cache.c"
                                 (file->fd) == 
# 463 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                               -1
# 463 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 464 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                   if ((
# 464 "project/nginx/src/core/ngx_open_file_cache.c"
                   pool->log
# 464 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 464 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 466 "project/nginx/src/core/ngx_open_file_cache.c"
                                            ;
                }
            }

            
# 470 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           free
# 470 "project/nginx/src/core/ngx_open_file_cache.c"
                   (file->name);
            
# 471 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           free
# 471 "project/nginx/src/core/ngx_open_file_cache.c"
                   (file);
    ...
    if (of->fd != 
# 478 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 -1
# 478 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ) {
        if (
# 479 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           close
# 479 "project/nginx/src/core/ngx_open_file_cache.c"
                         (of->fd) == 
# 479 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                     -1
# 479 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 480 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           if ((
# 480 "project/nginx/src/core/ngx_open_file_cache.c"
           pool->log
# 480 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 480 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 481 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                 ;
        }
    }

    return 
# 485 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          -1
# 485 "project/nginx/src/core/ngx_open_file_cache.c"
                   ;
}
...
# 511 "project/nginx/src/core/ngx_open_file_cache.c"
    fd = 
# 511 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
        openat(
# 511 "project/nginx/src/core/ngx_open_file_cache.c"
        at_fd
# 511 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 511 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (fd == 
# 513 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             -1
# 513 "project/nginx/src/core/ngx_open_file_cache.c"
                             ) {
        return 
# 514 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              -1
# 514 "project/nginx/src/core/ngx_open_file_cache.c"
                              ;
    }

    if (
# 517 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       fstatat(
# 517 "project/nginx/src/core/ngx_open_file_cache.c"
       at_fd
# 517 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       , (const char *) 
# 517 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 518 "project/nginx/src/core/ngx_open_file_cache.c"
       == 
# 518 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          -1
# 518 "project/nginx/src/core/ngx_open_file_cache.c"
                        )
    {
        err = 
# 520 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             (*__error())
# 520 "project/nginx/src/core/ngx_open_file_cache.c"
                      ;
        goto failed;
    }
    ...
    if (
# 530 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       fstat(
# 530 "project/nginx/src/core/ngx_open_file_cache.c"
       fd
# 530 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       , 
# 530 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 530 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        err = 
# 531 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             (*__error())
# 531 "project/nginx/src/core/ngx_open_file_cache.c"
                      ;
        goto failed;
    }
    ...
    if (fi.st_uid != atfi.st_uid) {
        err = 
# 537 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             62
# 537 "project/nginx/src/core/ngx_open_file_cache.c"
                      ;
        goto failed;
    }
...
failed:
    ...
    if (
# 545 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       close
# 545 "project/nginx/src/core/ngx_open_file_cache.c"
                     (fd) == 
# 545 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                             -1
# 545 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 546 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       if ((
# 546 "project/nginx/src/core/ngx_open_file_cache.c"
       log
# 546 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 546 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 547 "project/nginx/src/core/ngx_open_file_cache.c"
                                                             ;
    }

    
# 550 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   (*__error()) = 
# 550 "project/nginx/src/core/ngx_open_file_cache.c"
   err;

    return 
# 552 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          -1
# 552 "project/nginx/src/core/ngx_open_file_cache.c"
                          ;
}
# 613 "project/nginx/src/core/ngx_open_file_cache.c"
static ngx_fd_t
ngx_open_file_wrapper(ngx_str_t *name, ngx_open_file_info_t *of,
    ngx_int_t mode, ngx_int_t create, ngx_int_t access, ngx_log_t *log)
{
    ngx_fd_t fd;
# 633 "project/nginx/src/core/ngx_open_file_cache.c"
    u_char *p, *cp, *end;
    ngx_fd_t at_fd;
    ngx_str_t at_name;

    if (of->disable_symlinks == 
# 637 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                               0
# 637 "project/nginx/src/core/ngx_open_file_cache.c"
                                                       ) {
        fd = 
# 638 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            open((const char *) 
# 638 "project/nginx/src/core/ngx_open_file_cache.c"
            name->data
# 638 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            , 
# 638 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 638 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        if (fd == 
# 640 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 -1
# 640 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ) {
            of->err = 
# 641 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     (*__error())
# 641 "project/nginx/src/core/ngx_open_file_cache.c"
                              ;
            of->failed = 
# 642 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        "open()"
# 642 "project/nginx/src/core/ngx_open_file_cache.c"
                                       ;
            return 
# 643 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 643 "project/nginx/src/core/ngx_open_file_cache.c"
                                  ;
        }
    ...
    if (of->disable_symlinks_from) {
        ...
        *cp = '\0';
        ...
        at_fd = 
# 660 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               open((const char *) 
# 660 "project/nginx/src/core/ngx_open_file_cache.c"
               p
# 660 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               , (0x0000|0x00100000)
# 660 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 661 "project/nginx/src/core/ngx_open_file_cache.c"
                                              ;

        *cp = '/';

        if (at_fd == 
# 665 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    -1
# 665 "project/nginx/src/core/ngx_open_file_cache.c"
                                    ) {
            of->err = 
# 666 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     (*__error())
# 666 "project/nginx/src/core/ngx_open_file_cache.c"
                              ;
            of->failed = 
# 667 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        "open()"
# 667 "project/nginx/src/core/ngx_open_file_cache.c"
                                       ;
            return 
# 668 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 668 "project/nginx/src/core/ngx_open_file_cache.c"
                                  ;
        }
        ...
        at_fd = 
# 676 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               open((const char *) 
# 676 "project/nginx/src/core/ngx_open_file_cache.c"
               "/"
# 676 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               , (0x0000|0x00100000)
# 676 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 678 "project/nginx/src/core/ngx_open_file_cache.c"
                                              ;

        if (at_fd == 
# 680 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    -1
# 680 "project/nginx/src/core/ngx_open_file_cache.c"
                                    ) {
            of->err = 
# 681 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     (*__error())
# 681 "project/nginx/src/core/ngx_open_file_cache.c"
                              ;
            of->failed = 
# 682 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        "openat()"
# 682 "project/nginx/src/core/ngx_open_file_cache.c"
                                         ;
            return 
# 683 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 683 "project/nginx/src/core/ngx_open_file_cache.c"
                                  ;
        }
        ...
        at_fd = 
# 690 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               (ngx_fd_t) -2
# 690 "project/nginx/src/core/ngx_open_file_cache.c"
                           ;
    }
    ...
    for ( ;; ) {
        ...
        if (cp == 
# 695 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 ((void *)0)
# 695 "project/nginx/src/core/ngx_open_file_cache.c"
                     ) {
            break;
        }
        ...
        *cp = '\0';
        ...
        if (of->disable_symlinks == 
# 706 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                   2
# 706 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                ) {
            fd = ngx_openat_file_owner(at_fd, p,
                                       
# 708 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                      (0x0000|0x00100000)
# 708 "project/nginx/src/core/ngx_open_file_cache.c"
                                                     |
# 708 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                      0x00000004
# 708 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 709 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                      0
# 709 "project/nginx/src/core/ngx_open_file_cache.c"
                                                   , 0, log);

        } else {
            fd = 
# 712 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                openat(
# 712 "project/nginx/src/core/ngx_open_file_cache.c"
                at_fd
# 712 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                , (const char *) 
# 712 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 714 "project/nginx/src/core/ngx_open_file_cache.c"
                                           ;
        }
        ...
        *cp = '/';
        ...
        if (fd == 
# 719 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 -1
# 719 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ) {
            of->err = 
# 720 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     (*__error())
# 720 "project/nginx/src/core/ngx_open_file_cache.c"
                              ;
            of->failed = 
# 721 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        "openat()"
# 721 "project/nginx/src/core/ngx_open_file_cache.c"
                                         ;
            goto failed;
        }

        if (at_fd != 
# 725 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    (ngx_fd_t) -2 
# 725 "project/nginx/src/core/ngx_open_file_cache.c"
                                 && 
# 725 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                    close
# 725 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 726 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           if ((
# 726 "project/nginx/src/core/ngx_open_file_cache.c"
           log
# 726 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 726 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 727 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                     ;
        }
    ...
    if (p == end) {
# 748 "project/nginx/src/core/ngx_open_file_cache.c"
        fd = 
# 748 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            openat(
# 748 "project/nginx/src/core/ngx_open_file_cache.c"
            at_fd
# 748 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 748 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (of->disable_symlinks == 
# 752 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                               2
        
# 753 "project/nginx/src/core/ngx_open_file_cache.c"
       && !(create & (
# 753 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      0x00000200
# 753 "project/nginx/src/core/ngx_open_file_cache.c"
                                             |
# 753 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 753 "project/nginx/src/core/ngx_open_file_cache.c"
                                                               )))
    {
        ...
        fd = 
# 758 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            openat(
# 758 "project/nginx/src/core/ngx_open_file_cache.c"
            at_fd
# 758 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            , (const char *) 
# 758 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 758 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (fd == 
# 763 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             -1
# 763 "project/nginx/src/core/ngx_open_file_cache.c"
                             ) {
        of->err = 
# 764 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 (*__error())
# 764 "project/nginx/src/core/ngx_open_file_cache.c"
                          ;
        of->failed = 
# 765 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    "openat()"
# 765 "project/nginx/src/core/ngx_open_file_cache.c"
                                     ;
    }
...
failed:
    ...
    if (at_fd != 
# 770 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                (ngx_fd_t) -2 
# 770 "project/nginx/src/core/ngx_open_file_cache.c"
                             && 
# 770 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                close
# 770 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 771 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       if ((
# 771 "project/nginx/src/core/ngx_open_file_cache.c"
       log
# 771 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 771 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 772 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                 ;
    }
...
{
    ngx_int_t rc;
# 800 "project/nginx/src/core/ngx_open_file_cache.c"
    ngx_fd_t fd;

    if (of->disable_symlinks == 
# 802 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                               0
# 802 "project/nginx/src/core/ngx_open_file_cache.c"
                                                       ) {

        rc = 
# 804 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            stat((const char *) 
# 804 "project/nginx/src/core/ngx_open_file_cache.c"
            name->data
# 804 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            , 
# 804 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 804 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        if (rc == 
# 806 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 -1
# 806 "project/nginx/src/core/ngx_open_file_cache.c"
                               ) {
            of->err = 
# 807 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     (*__error())
# 807 "project/nginx/src/core/ngx_open_file_cache.c"
                              ;
            of->failed = 
# 808 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        "stat()"
# 808 "project/nginx/src/core/ngx_open_file_cache.c"
                                       ;
            return 
# 809 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 809 "project/nginx/src/core/ngx_open_file_cache.c"
                                ;
        }
...
# 815 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                        0x0000
# 815 "project/nginx/src/core/ngx_open_file_cache.c"
                                                       |
# 815 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                        0x00000004
# 815 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 816 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                              0
# 816 "project/nginx/src/core/ngx_open_file_cache.c"
                                           , 0, log);

    if (fd == 
# 818 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             -1
# 818 "project/nginx/src/core/ngx_open_file_cache.c"
                             ) {
        return 
# 819 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              -1
# 819 "project/nginx/src/core/ngx_open_file_cache.c"
                            ;
    }

    rc = 
# 822 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
        fstat(
# 822 "project/nginx/src/core/ngx_open_file_cache.c"
        fd
# 822 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
        , 
# 822 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 822 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (rc == 
# 824 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             -1
# 824 "project/nginx/src/core/ngx_open_file_cache.c"
                           ) {
        of->err = 
# 825 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 (*__error())
# 825 "project/nginx/src/core/ngx_open_file_cache.c"
                          ;
        of->failed = 
# 826 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    "fstat()"
# 826 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ;
    }

    if (
# 829 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       close
# 829 "project/nginx/src/core/ngx_open_file_cache.c"
                     (fd) == 
# 829 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                             -1
# 829 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 830 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       if ((
# 830 "project/nginx/src/core/ngx_open_file_cache.c"
       log
# 830 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 830 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 831 "project/nginx/src/core/ngx_open_file_cache.c"
                                                             ;
    }
    ...
    ngx_log_t *log)
{
    ...
    if (of->fd != 
# 846 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 -1
# 846 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ) {

        if (ngx_file_info_wrapper(name, of, &fi, log) == 
# 848 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                        -1
# 848 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                      ) {
            of->fd = 
# 849 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    -1
# 849 "project/nginx/src/core/ngx_open_file_cache.c"
                                    ;
            return 
# 850 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 850 "project/nginx/src/core/ngx_open_file_cache.c"
                           ;
        }

        if (of->uniq == 
# 853 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                       (
# 853 "project/nginx/src/core/ngx_open_file_cache.c"
                       &fi
# 853 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                       )->st_ino
# 853 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        if (ngx_file_info_wrapper(name, of, &fi, log) == 
# 859 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                        -1
# 859 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                      ) {
            of->fd = 
# 860 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    -1
# 860 "project/nginx/src/core/ngx_open_file_cache.c"
                                    ;
            return 
# 861 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 861 "project/nginx/src/core/ngx_open_file_cache.c"
                           ;
        }

        if (
# 864 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           (((((
# 864 "project/nginx/src/core/ngx_open_file_cache.c"
           &fi
# 864 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->st_mode) & 0170000) == 0040000))
# 864 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (!of->log) {
        ...
        fd = ngx_open_file_wrapper(name, of, 
# 876 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                            0x0000
# 876 "project/nginx/src/core/ngx_open_file_cache.c"
                                                           |
# 876 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                            0x00000004
# 876 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 877 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                  0
# 877 "project/nginx/src/core/ngx_open_file_cache.c"
                                               , 0, log);

    } else {
        fd = ngx_open_file_wrapper(name, of, 
# 880 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                            (0x0001|0x00000008)
# 880 "project/nginx/src/core/ngx_open_file_cache.c"
                                                           ,
                                   
# 881 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                  0x00000200
# 881 "project/nginx/src/core/ngx_open_file_cache.c"
                                                         ,
                                   
# 882 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                  0644
# 882 "project/nginx/src/core/ngx_open_file_cache.c"
                                                         , log);
    }

    if (fd == 
# 885 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
             -1
# 885 "project/nginx/src/core/ngx_open_file_cache.c"
                             ) {
        of->fd = 
# 886 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                -1
# 886 "project/nginx/src/core/ngx_open_file_cache.c"
                                ;
        return 
# 887 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              -1
# 887 "project/nginx/src/core/ngx_open_file_cache.c"
                       ;
    }

    if (
# 890 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       fstat(
# 890 "project/nginx/src/core/ngx_open_file_cache.c"
       fd
# 890 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       , 
# 890 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 891 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       if ((
# 891 "project/nginx/src/core/ngx_open_file_cache.c"
       log
# 891 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
...
# 892 "project/nginx/src/core/ngx_open_file_cache.c"
                                                          ;

        if (
# 894 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           close
# 894 "project/nginx/src/core/ngx_open_file_cache.c"
                         (fd) == 
# 894 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                 -1
# 894 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 895 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           if ((
# 895 "project/nginx/src/core/ngx_open_file_cache.c"
           log
# 895 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 895 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 896 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                 ;
        }

        of->fd = 
# 899 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                -1
# 899 "project/nginx/src/core/ngx_open_file_cache.c"
                                ;

        return 
# 901 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              -1
# 901 "project/nginx/src/core/ngx_open_file_cache.c"
                       ;
    }

    if (
# 904 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       (((((
# 904 "project/nginx/src/core/ngx_open_file_cache.c"
       &fi
# 904 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->st_mode) & 0170000) == 0040000))
# 904 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        if (
# 905 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           close
# 905 "project/nginx/src/core/ngx_open_file_cache.c"
                         (fd) == 
# 905 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                 -1
# 905 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 906 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           if ((
# 906 "project/nginx/src/core/ngx_open_file_cache.c"
           log
# 906 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 906 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 907 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                 ;
        }

        of->fd = 
# 910 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                -1
# 910 "project/nginx/src/core/ngx_open_file_cache.c"
                                ;
        ...
        if (of->read_ahead && 
# 915 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                             (
# 915 "project/nginx/src/core/ngx_open_file_cache.c"
                             &fi
# 915 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                             )->st_size 
# 915 "project/nginx/src/core/ngx_open_file_cache.c"
                                                > (128 * 1024)) {
            if (
# 916 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               0 
# 916 "project/nginx/src/core/ngx_open_file_cache.c"
                                                  == 
# 916 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                     -1
# 916 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 917 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               if ((
# 917 "project/nginx/src/core/ngx_open_file_cache.c"
               log
# 917 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 917 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 918 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                     ;
            }
        }

        if (of->directio <= 
# 922 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                           (
# 922 "project/nginx/src/core/ngx_open_file_cache.c"
                           &fi
# 922 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                           )->st_size
# 922 "project/nginx/src/core/ngx_open_file_cache.c"
            ...
            if (
# 923 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               fcntl(
# 923 "project/nginx/src/core/ngx_open_file_cache.c"
               fd
# 923 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               , 48, 1) 
# 923 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 924 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               if ((
# 924 "project/nginx/src/core/ngx_open_file_cache.c"
               log
# 924 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 924 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 925 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                      ;
    ...
    of->uniq = 
# 935 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              (
# 935 "project/nginx/src/core/ngx_open_file_cache.c"
              &fi
# 935 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              )->st_ino
# 935 "project/nginx/src/core/ngx_open_file_cache.c"
                                ;
    of->mtime = 
# 936 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               (
# 936 "project/nginx/src/core/ngx_open_file_cache.c"
               &fi
# 936 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
               )->st_mtimespec.tv_sec
# 936 "project/nginx/src/core/ngx_open_file_cache.c"
                                  ;
    of->size = 
# 937 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              (
# 937 "project/nginx/src/core/ngx_open_file_cache.c"
              &fi
# 937 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              )->st_size
# 937 "project/nginx/src/core/ngx_open_file_cache.c"
                                ;
    of->fs_size = 
# 938 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 (((
# 938 "project/nginx/src/core/ngx_open_file_cache.c"
                 &fi
# 938 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 )->st_blocks * 512 > (
# 938 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 938 "project/nginx/src/core/ngx_open_file_cache.c"
                                      ;
    of->is_dir = 
# 939 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                (((((
# 939 "project/nginx/src/core/ngx_open_file_cache.c"
                &fi
# 939 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                )->st_mode) & 0170000) == 0040000))
# 939 "project/nginx/src/core/ngx_open_file_cache.c"
                               ;
    of->is_file = 
# 940 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 (((((
# 940 "project/nginx/src/core/ngx_open_file_cache.c"
                 &fi
# 940 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 )->st_mode) & 0170000) == 0100000))
# 940 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ;
    of->is_link = 
# 941 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 (((((
# 941 "project/nginx/src/core/ngx_open_file_cache.c"
                 &fi
# 941 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 )->st_mode) & 0170000) == 0120000))
# 941 "project/nginx/src/core/ngx_open_file_cache.c"
                                 ;
    of->is_exec = 
# 942 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 (((
# 942 "project/nginx/src/core/ngx_open_file_cache.c"
                 &fi
# 942 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 )->st_mode & 0000100) == 0000100)
# 942 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    return 
# 944 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          0
# 944 "project/nginx/src/core/ngx_open_file_cache.c"
                ;
}
    ...
    ngx_cached_open_file_t *file, ngx_open_file_info_t *of, ngx_log_t *log)
{
    ...
    if (!(ngx_event_flags & 
# 959 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                           0x00002000
# 959 "project/nginx/src/core/ngx_open_file_cache.c"
                                              )
        || !of->events
        || file->event
        || of->fd == 
# 962 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                    -1
        
# 963 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (file->event== 
# 971 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     ((void *)0)
# 971 "project/nginx/src/core/ngx_open_file_cache.c"
                         ) {
        return;
    }
    ...
    if (fev == 
# 976 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              ((void *)0)
# 976 "project/nginx/src/core/ngx_open_file_cache.c"
                  ) {
        
# 977 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       free
# 977 "project/nginx/src/core/ngx_open_file_cache.c"
               (file->event);
        file->event = 
# 978 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     ((void *)0)
# 978 "project/nginx/src/core/ngx_open_file_cache.c"
                         ;
        return;
    }
    ...
    if (
# 997 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       ngx_event_actions.add
# 997 "project/nginx/src/core/ngx_open_file_cache.c"
                    (file->event, 
# 997 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                  (-4)
# 997 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 997 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        != 
# 998 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          0
# 998 "project/nginx/src/core/ngx_open_file_cache.c"
                )
    {
        
# 1000 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       free
# 1000 "project/nginx/src/core/ngx_open_file_cache.c"
               (file->event->data);
        
# 1001 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       free
# 1001 "project/nginx/src/core/ngx_open_file_cache.c"
               (file->event);
        file->event = 
# 1002 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                     ((void *)0)
# 1002 "project/nginx/src/core/ngx_open_file_cache.c"
                         ;
        return;
    }
# 1013 "project/nginx/src/core/ngx_open_file_cache.c"
    return;
}
    ...
    ngx_cached_open_file_t *file, ngx_uint_t min_uses, ngx_log_t *log)
{
    ...
    if (!file->close) {
        ...
        file->accessed = 
# 1041 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                        ngx_cached_time->sec
# 1041 "project/nginx/src/core/ngx_open_file_cache.c"
                                  ;

        
# 1043 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       (
# 1043 "project/nginx/src/core/ngx_open_file_cache.c"
       &file->queue
# 1043 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->next->prev = (
# 1043 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1045 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       (
# 1045 "project/nginx/src/core/ngx_open_file_cache.c"
       &file->queue
# 1045 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->next = (
# 1045 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1045 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    if (file->fd != 
# 1058 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                   -1
# 1058 "project/nginx/src/core/ngx_open_file_cache.c"
                                   ) {

        if (
# 1060 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           close
# 1060 "project/nginx/src/core/ngx_open_file_cache.c"
                         (file->fd) == 
# 1060 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                       -1
# 1060 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1061 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           if ((
# 1061 "project/nginx/src/core/ngx_open_file_cache.c"
           log
# 1061 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 1061 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1062 "project/nginx/src/core/ngx_open_file_cache.c"
                                                                       ;
        }

        file->fd = 
# 1065 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                  -1
# 1065 "project/nginx/src/core/ngx_open_file_cache.c"
                                  ;
    }
...
# 1072 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   free
# 1072 "project/nginx/src/core/ngx_open_file_cache.c"
           (file->name);
    
# 1073 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   free
# 1073 "project/nginx/src/core/ngx_open_file_cache.c"
           (file);
}
...
{
    if (file->event == 
# 1080 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                      ((void *)0)
# 1080 "project/nginx/src/core/ngx_open_file_cache.c"
                          ) {
        return;
    }

    (void) 
# 1084 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          ngx_event_actions.del
# 1084 "project/nginx/src/core/ngx_open_file_cache.c"
                       (file->event, 
# 1084 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                     (-4)
# 1084 "project/nginx/src/core/ngx_open_file_cache.c"
                                                    ,
                         file->count ? 
# 1085 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                      0x4000 
# 1085 "project/nginx/src/core/ngx_open_file_cache.c"
                                                      : 
# 1085 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                                                        0x8000
# 1085 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1087 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   free
# 1087 "project/nginx/src/core/ngx_open_file_cache.c"
           (file->event->data);
    
# 1088 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   free
# 1088 "project/nginx/src/core/ngx_open_file_cache.c"
           (file->event);
    file->event = 
# 1089 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 ((void *)0)
# 1089 "project/nginx/src/core/ngx_open_file_cache.c"
                     ;
    file->use_event = 0;
}
    ...
    ngx_log_t *log)
{
    ...
    now = 
# 1102 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
         ngx_cached_time->sec
# 1102 "project/nginx/src/core/ngx_open_file_cache.c"
                   ;
    ...
    while (n < 3) {
        ...
        if (
# 1112 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           (
# 1112 "project/nginx/src/core/ngx_open_file_cache.c"
           &cache->expire_queue 
# 1112 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           == (
# 1112 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1112 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        q = 
# 1116 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           (
# 1116 "project/nginx/src/core/ngx_open_file_cache.c"
           &cache->expire_queue
# 1116 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           )->prev
# 1116 "project/nginx/src/core/ngx_open_file_cache.c"
        ...
        file = 
# 1118 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              (
# 1118 "project/nginx/src/core/ngx_open_file_cache.c"
              ngx_cached_open_file_t 
# 1118 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
              *) ((u_char *) 
# 1118 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1124 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       (
# 1124 "project/nginx/src/core/ngx_open_file_cache.c"
       q
# 1124 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
       )->next->prev = (
# 1124 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1138 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           free
# 1138 "project/nginx/src/core/ngx_open_file_cache.c"
                   (file->name);
            
# 1139 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
           free
# 1139 "project/nginx/src/core/ngx_open_file_cache.c"
                   (file);
        }
    }
}
    ...
    ngx_rbtree_node_t *node, ngx_rbtree_node_t *sentinel)
{
    ...
    for ( ;; ) {
        ...
        if (node->key < temp->key) {
            ...
            p = (
# 1167 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                strcmp((const char *) 
# 1167 "project/nginx/src/core/ngx_open_file_cache.c"
                file->name
# 1167 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                , (const char *) 
# 1167 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1182 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   ((
# 1182 "project/nginx/src/core/ngx_open_file_cache.c"
   node
# 1182 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   )->color = 1)
# 1182 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    uint32_t hash)
{
    ...
    while (node != sentinel) {
        ...
        rc = 
# 1213 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            strcmp((const char *) 
# 1213 "project/nginx/src/core/ngx_open_file_cache.c"
            name->data
# 1213 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
            , (const char *) 
# 1213 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1213 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    return 
# 1222 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
          ((void *)0)
# 1222 "project/nginx/src/core/ngx_open_file_cache.c"
              ;
}
...
# 1235 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   (
# 1235 "project/nginx/src/core/ngx_open_file_cache.c"
   &file->queue
# 1235 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   )->next->prev = (
# 1235 "project/nginx/src/core/ngx_open_file_cache.c"
...
# 1235 "project/nginx/src/core/ngx_open_file_cache.c"
    ...
    file->event = 
# 1242 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
                 ((void *)0)
# 1242 "project/nginx/src/core/ngx_open_file_cache.c"
                     ;
    file->use_event = 0;
...
# 1251 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   free
# 1251 "project/nginx/src/core/ngx_open_file_cache.c"
           (ev->data);
    
# 1252 "project/nginx/src/core/ngx_open_file_cache.c" 3 4
   free
# 1252 "project/nginx/src/core/ngx_open_file_cache.c"
           (ev);
}
