# 0 "project/nginx/src/core/ngx_array.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_array.c"
...
# 9 "project/nginx/src/core/ngx_array.c" 2
...
# 10 "project/nginx/src/core/ngx_array.c" 2



# 12 "project/nginx/src/core/ngx_array.c"
ngx_array_t *
ngx_array_create(ngx_pool_t *p, ngx_uint_t n, size_t size)
{
    ...
    if (a == 
# 18 "project/nginx/src/core/ngx_array.c" 3 4
            ((void *)0)
# 18 "project/nginx/src/core/ngx_array.c"
                ) {
        return 
# 19 "project/nginx/src/core/ngx_array.c" 3 4
              ((void *)0)
# 19 "project/nginx/src/core/ngx_array.c"
                  ;
    }

    if (ngx_array_init(a, p, n, size) != 
# 22 "project/nginx/src/core/ngx_array.c" 3 4
                                        0
# 22 "project/nginx/src/core/ngx_array.c"
                                              ) {
        return 
# 23 "project/nginx/src/core/ngx_array.c" 3 4
              ((void *)0)
# 23 "project/nginx/src/core/ngx_array.c"
                  ;
    }
...
ngx_array_push(ngx_array_t *a)
{
    ...
    if (a->nelts == a->nalloc) {
            ...
            && p->d.last + a->size <= p->d.end)
        {
            ...
            if (new == 
# 77 "project/nginx/src/core/ngx_array.c" 3 4
                      ((void *)0)
# 77 "project/nginx/src/core/ngx_array.c"
                          ) {
                return 
# 78 "project/nginx/src/core/ngx_array.c" 3 4
                      ((void *)0)
# 78 "project/nginx/src/core/ngx_array.c"
                          ;
            }

            
# 81 "project/nginx/src/core/ngx_array.c" 3 4
           (void) __builtin___memcpy_chk (
# 81 "project/nginx/src/core/ngx_array.c"
           new
# 81 "project/nginx/src/core/ngx_array.c" 3 4
           , 
# 81 "project/nginx/src/core/ngx_array.c"
...
ngx_array_push_n(ngx_array_t *a, ngx_uint_t n)
{
    ...
    if (a->nelts + n > a->nalloc) {
            ...
            && p->d.last + size <= p->d.end)
        {
            ...
            if (new == 
# 127 "project/nginx/src/core/ngx_array.c" 3 4
                      ((void *)0)
# 127 "project/nginx/src/core/ngx_array.c"
                          ) {
                return 
# 128 "project/nginx/src/core/ngx_array.c" 3 4
                      ((void *)0)
# 128 "project/nginx/src/core/ngx_array.c"
                          ;
            }

            
# 131 "project/nginx/src/core/ngx_array.c" 3 4
           (void) __builtin___memcpy_chk (
# 131 "project/nginx/src/core/ngx_array.c"
           new
# 131 "project/nginx/src/core/ngx_array.c" 3 4
           , 
# 131 "project/nginx/src/core/ngx_array.c"
