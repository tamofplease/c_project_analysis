# 0 "project/nginx/src/core/ngx_regex.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_regex.c"
...
# 9 "project/nginx/src/core/ngx_regex.c" 2
...
# 10 "project/nginx/src/core/ngx_regex.c" 2



# 12 "project/nginx/src/core/ngx_regex.c"
typedef struct {
    ngx_flag_t pcre_jit;
    ngx_list_t *studies;
} ngx_regex_conf_t;
...
static 
# 18 "project/nginx/src/core/ngx_regex.c" 3 4
      inline 
# 18 "project/nginx/src/core/ngx_regex.c"
                 void ngx_regex_malloc_init(ngx_pool_t *pool);
static 
# 19 "project/nginx/src/core/ngx_regex.c" 3 4
      inline 
# 19 "project/nginx/src/core/ngx_regex.c"
...
static ngx_command_t ngx_regex_commands[] = {
    ...
    { 
# 41 "project/nginx/src/core/ngx_regex.c" 3 4
     { sizeof(
# 41 "project/nginx/src/core/ngx_regex.c"
     "pcre_jit"
# 41 "project/nginx/src/core/ngx_regex.c" 3 4
     ) - 1, (u_char *) 
# 41 "project/nginx/src/core/ngx_regex.c"
...
# 42 "project/nginx/src/core/ngx_regex.c" 3 4
     0x01000000
# 42 "project/nginx/src/core/ngx_regex.c"
                  |
# 42 "project/nginx/src/core/ngx_regex.c" 3 4
                   0x00010000
# 42 "project/nginx/src/core/ngx_regex.c"
...
# 45 "project/nginx/src/core/ngx_regex.c" 3 4
     __builtin_offsetof (
# 45 "project/nginx/src/core/ngx_regex.c"
     ngx_regex_conf_t
# 45 "project/nginx/src/core/ngx_regex.c" 3 4
     , 
# 45 "project/nginx/src/core/ngx_regex.c"
...
# 48 "project/nginx/src/core/ngx_regex.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 49 "project/nginx/src/core/ngx_regex.c"
};


static ngx_core_module_t ngx_regex_module_ctx = {
    
# 53 "project/nginx/src/core/ngx_regex.c" 3 4
   { sizeof(
# 53 "project/nginx/src/core/ngx_regex.c"
   "regex"
# 53 "project/nginx/src/core/ngx_regex.c" 3 4
   ) - 1, (u_char *) 
# 53 "project/nginx/src/core/ngx_regex.c"
...
# 60 "project/nginx/src/core/ngx_regex.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 60 "project/nginx/src/core/ngx_regex.c"
   "8" 
# 60 "project/nginx/src/core/ngx_regex.c" 3 4
   "," 
# 60 "project/nginx/src/core/ngx_regex.c"
...
# 63 "project/nginx/src/core/ngx_regex.c" 3 4
   0x45524F43
# 63 "project/nginx/src/core/ngx_regex.c"
                  ,
    
# 64 "project/nginx/src/core/ngx_regex.c" 3 4
   ((void *)0)
# 64 "project/nginx/src/core/ngx_regex.c"
       ,
    ngx_regex_module_init,
    
# 66 "project/nginx/src/core/ngx_regex.c" 3 4
   ((void *)0)
# 66 "project/nginx/src/core/ngx_regex.c"
       ,
    
# 67 "project/nginx/src/core/ngx_regex.c" 3 4
   ((void *)0)
# 67 "project/nginx/src/core/ngx_regex.c"
       ,
    
# 68 "project/nginx/src/core/ngx_regex.c" 3 4
   ((void *)0)
# 68 "project/nginx/src/core/ngx_regex.c"
       ,
    
# 69 "project/nginx/src/core/ngx_regex.c" 3 4
   ((void *)0)
# 69 "project/nginx/src/core/ngx_regex.c"
       ,
    
# 70 "project/nginx/src/core/ngx_regex.c" 3 4
   ((void *)0)
# 70 "project/nginx/src/core/ngx_regex.c"
       ,
    
# 71 "project/nginx/src/core/ngx_regex.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 72 "project/nginx/src/core/ngx_regex.c"
};
...
static 
# 80 "project/nginx/src/core/ngx_regex.c" 3 4
      pcre2_compile_context_8 
# 80 "project/nginx/src/core/ngx_regex.c"
                             *ngx_regex_compile_context;
static 
# 81 "project/nginx/src/core/ngx_regex.c" 3 4
      pcre2_match_data_8 
# 81 "project/nginx/src/core/ngx_regex.c"
...
static 
# 96 "project/nginx/src/core/ngx_regex.c" 3 4
      inline 
# 96 "project/nginx/src/core/ngx_regex.c"
                 void
ngx_regex_malloc_init(ngx_pool_t *pool)
{
    ngx_regex_pool = pool;
    ngx_regex_direct_alloc = (pool == 
# 100 "project/nginx/src/core/ngx_regex.c" 3 4
                                     ((void *)0)
# 100 "project/nginx/src/core/ngx_regex.c"
                                         ) ? 1 : 0;
}


static 
# 104 "project/nginx/src/core/ngx_regex.c" 3 4
      inline 
# 104 "project/nginx/src/core/ngx_regex.c"
                 void
ngx_regex_malloc_done(void)
{
    ngx_regex_pool = 
# 107 "project/nginx/src/core/ngx_regex.c" 3 4
                    ((void *)0)
# 107 "project/nginx/src/core/ngx_regex.c"
                        ;
...
# 122 "project/nginx/src/core/ngx_regex.c" 3 4
   pcre2_code_8 
# 122 "project/nginx/src/core/ngx_regex.c"
                          *re;
    ngx_regex_elt_t *elt;
    
# 124 "project/nginx/src/core/ngx_regex.c" 3 4
   pcre2_general_context_8 
# 124 "project/nginx/src/core/ngx_regex.c"
                          *gctx;
    
# 125 "project/nginx/src/core/ngx_regex.c" 3 4
   pcre2_compile_context_8 
# 125 "project/nginx/src/core/ngx_regex.c"
                          *cctx;

    if (ngx_regex_compile_context == 
# 127 "project/nginx/src/core/ngx_regex.c" 3 4
                                    ((void *)0)
# 127 "project/nginx/src/core/ngx_regex.c"
                                        ) {
...
# 134 "project/nginx/src/core/ngx_regex.c" 3 4
                             ((void *)0)
# 134 "project/nginx/src/core/ngx_regex.c"
                                 );

        gctx = 
# 136 "project/nginx/src/core/ngx_regex.c" 3 4
              pcre2_general_context_create_8
# 136 "project/nginx/src/core/ngx_regex.c"
                                          (ngx_regex_malloc, ngx_regex_free,
                                            
# 137 "project/nginx/src/core/ngx_regex.c" 3 4
                                           ((void *)0)
# 137 "project/nginx/src/core/ngx_regex.c"
                                               );
        if (gctx == 
# 138 "project/nginx/src/core/ngx_regex.c" 3 4
                   ((void *)0)
# 138 "project/nginx/src/core/ngx_regex.c"
                       ) {
        ...
        cctx = 
# 143 "project/nginx/src/core/ngx_regex.c" 3 4
              pcre2_compile_context_create_8
# 143 "project/nginx/src/core/ngx_regex.c"
                                          (gctx);
        if (cctx == 
# 144 "project/nginx/src/core/ngx_regex.c" 3 4
                   ((void *)0)
# 144 "project/nginx/src/core/ngx_regex.c"
                       ) {
            
# 145 "project/nginx/src/core/ngx_regex.c" 3 4
           pcre2_general_context_free_8
# 145 "project/nginx/src/core/ngx_regex.c"
                                     (gctx);
            ngx_regex_malloc_done();
            goto nomem;
        }
...
# 152 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_general_context_free_8
# 152 "project/nginx/src/core/ngx_regex.c"
                                 (gctx);
        ngx_regex_malloc_done();
    }
    ...
    if (rc->options & 
# 158 "project/nginx/src/core/ngx_regex.c" 3 4
                     0x00000001
# 158 "project/nginx/src/core/ngx_regex.c"
                                       ) {
        options |= 
# 159 "project/nginx/src/core/ngx_regex.c" 3 4
                  0x00000008u
# 159 "project/nginx/src/core/ngx_regex.c"
                                ;
    }

    if (rc->options & 
# 162 "project/nginx/src/core/ngx_regex.c" 3 4
                     0x00000002
# 162 "project/nginx/src/core/ngx_regex.c"
                                        ) {
        options |= 
# 163 "project/nginx/src/core/ngx_regex.c" 3 4
                  0x00000400u
# 163 "project/nginx/src/core/ngx_regex.c"
                                 ;
    }

    if (rc->options & ~(
# 166 "project/nginx/src/core/ngx_regex.c" 3 4
                       0x00000001
# 166 "project/nginx/src/core/ngx_regex.c"
                                         |
# 166 "project/nginx/src/core/ngx_regex.c" 3 4
                                          0x00000002
# 166 "project/nginx/src/core/ngx_regex.c"
        ...
        rc->err.len = ngx_snprintf(rc->err.data, rc->err.len,
                      ...
                      - rc->err.data;
        return 
# 171 "project/nginx/src/core/ngx_regex.c" 3 4
              -1
# 171 "project/nginx/src/core/ngx_regex.c"
                       ;
    }
    ...
    re = 
# 176 "project/nginx/src/core/ngx_regex.c" 3 4
        pcre2_compile_8
# 176 "project/nginx/src/core/ngx_regex.c"
                     (rc->pattern.data, rc->pattern.len, options,
    ...
    if (re == 
# 182 "project/nginx/src/core/ngx_regex.c" 3 4
             ((void *)0)
# 182 "project/nginx/src/core/ngx_regex.c"
                 ) {
        
# 183 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_get_error_message_8
# 183 "project/nginx/src/core/ngx_regex.c"
                              (errcode, errstr, 128);
        ...
        return 
# 198 "project/nginx/src/core/ngx_regex.c" 3 4
              -1
# 198 "project/nginx/src/core/ngx_regex.c"
                       ;
    }
    ...
    if (ngx_regex_studies != 
# 205 "project/nginx/src/core/ngx_regex.c" 3 4
                            ((void *)0)
# 205 "project/nginx/src/core/ngx_regex.c"
                                ) {
        elt = ngx_list_push(ngx_regex_studies);
        if (elt == 
# 207 "project/nginx/src/core/ngx_regex.c" 3 4
                  ((void *)0)
# 207 "project/nginx/src/core/ngx_regex.c"
                      ) {
            goto nomem;
        }
    ...
    n = 
# 215 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_pattern_info_8
# 215 "project/nginx/src/core/ngx_regex.c"
                         (re, 
# 215 "project/nginx/src/core/ngx_regex.c" 3 4
                              4
# 215 "project/nginx/src/core/ngx_regex.c"
    ...
    if (rc->captures == 0) {
        return 
# 222 "project/nginx/src/core/ngx_regex.c" 3 4
              0
# 222 "project/nginx/src/core/ngx_regex.c"
                    ;
    }

    n = 
# 225 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_pattern_info_8
# 225 "project/nginx/src/core/ngx_regex.c"
                         (re, 
# 225 "project/nginx/src/core/ngx_regex.c" 3 4
                              17
# 225 "project/nginx/src/core/ngx_regex.c"
    ...
    if (rc->named_captures == 0) {
        return 
# 232 "project/nginx/src/core/ngx_regex.c" 3 4
              0
# 232 "project/nginx/src/core/ngx_regex.c"
                    ;
    }

    n = 
# 235 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_pattern_info_8
# 235 "project/nginx/src/core/ngx_regex.c"
                         (re, 
# 235 "project/nginx/src/core/ngx_regex.c" 3 4
                              18
# 235 "project/nginx/src/core/ngx_regex.c"
    ...
    n = 
# 241 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_pattern_info_8
# 241 "project/nginx/src/core/ngx_regex.c"
                         (re, 
# 241 "project/nginx/src/core/ngx_regex.c" 3 4
                              19
# 241 "project/nginx/src/core/ngx_regex.c"
    ...
    return 
# 247 "project/nginx/src/core/ngx_regex.c" 3 4
          0
# 247 "project/nginx/src/core/ngx_regex.c"
                ;
...
failed:
    ...
    rc->err.len = ngx_snprintf(rc->err.data, rc->err.len, p, &rc->pattern, n)
                  - rc->err.data;
    return 
# 253 "project/nginx/src/core/ngx_regex.c" 3 4
          -1
# 253 "project/nginx/src/core/ngx_regex.c"
                   ;
...
nomem:
    ...
    rc->err.len = ngx_snprintf(rc->err.data, rc->err.len,
                  ...
                  - rc->err.data;
    return 
# 261 "project/nginx/src/core/ngx_regex.c" 3 4
          -1
# 261 "project/nginx/src/core/ngx_regex.c"
                   ;
}
# 392 "project/nginx/src/core/ngx_regex.c"
ngx_int_t
ngx_regex_exec(ngx_regex_t *re, ngx_str_t *s, int *captures, ngx_uint_t size)
{
    ...
    ngx_regex_malloc_init(
# 405 "project/nginx/src/core/ngx_regex.c" 3 4
                         ((void *)0)
# 405 "project/nginx/src/core/ngx_regex.c"
                             );

    if (ngx_regex_match_data == 
# 407 "project/nginx/src/core/ngx_regex.c" 3 4
                               ((void *)0)
        
# 408 "project/nginx/src/core/ngx_regex.c"
...
# 416 "project/nginx/src/core/ngx_regex.c" 3 4
           pcre2_match_data_free_8
# 416 "project/nginx/src/core/ngx_regex.c"
                                (ngx_regex_match_data);
        }

        ngx_regex_match_data_size = size;
        ngx_regex_match_data = 
# 420 "project/nginx/src/core/ngx_regex.c" 3 4
                              pcre2_match_data_create_8
# 420 "project/nginx/src/core/ngx_regex.c"
                                                     (size / 3, 
# 420 "project/nginx/src/core/ngx_regex.c" 3 4
                                                                ((void *)0)
# 420 "project/nginx/src/core/ngx_regex.c"
        ...
        if (ngx_regex_match_data == 
# 422 "project/nginx/src/core/ngx_regex.c" 3 4
                                   ((void *)0)
# 422 "project/nginx/src/core/ngx_regex.c"
                                       ) {
            rc = 
# 423 "project/nginx/src/core/ngx_regex.c" 3 4
                (-48)
# 423 "project/nginx/src/core/ngx_regex.c"
                                    ;
            goto failed;
        }
    }
    ...
    rc = 
# 428 "project/nginx/src/core/ngx_regex.c" 3 4
        pcre2_match_8
# 428 "project/nginx/src/core/ngx_regex.c"
                   (re, s->data, s->len, 0, 0, ngx_regex_match_data, 
# 428 "project/nginx/src/core/ngx_regex.c" 3 4
                                                                     ((void *)0)
# 428 "project/nginx/src/core/ngx_regex.c"
                                                                         );
    ...
    n = 
# 434 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_get_ovector_count_8
# 434 "project/nginx/src/core/ngx_regex.c"
                              (ngx_regex_match_data);
    ov = 
# 435 "project/nginx/src/core/ngx_regex.c" 3 4
        pcre2_get_ovector_pointer_8
# 435 "project/nginx/src/core/ngx_regex.c"
                                 (ngx_regex_match_data);
...
# 465 "project/nginx/src/core/ngx_regex.c"
ngx_int_t
ngx_regex_exec_array(ngx_array_t *a, ngx_str_t *s, ngx_log_t *log)
{
    ...
    for (i = 0; i < a->nelts; i++) {
        ...
        n = ngx_regex_exec(re[i].regex, s, 
# 476 "project/nginx/src/core/ngx_regex.c" 3 4
                                          ((void *)0)
# 476 "project/nginx/src/core/ngx_regex.c"
                                              , 0);

        if (n == 
# 478 "project/nginx/src/core/ngx_regex.c" 3 4
                (-1)
# 478 "project/nginx/src/core/ngx_regex.c"
                                    ) {
            continue;
        }
...
# 483 "project/nginx/src/core/ngx_regex.c" 3 4
           if ((
# 483 "project/nginx/src/core/ngx_regex.c"
           log
# 483 "project/nginx/src/core/ngx_regex.c" 3 4
...
# 485 "project/nginx/src/core/ngx_regex.c"
                                          ;
            return 
# 486 "project/nginx/src/core/ngx_regex.c" 3 4
                  -1
# 486 "project/nginx/src/core/ngx_regex.c"
                           ;
        }
        ...
        return 
# 491 "project/nginx/src/core/ngx_regex.c" 3 4
              0
# 491 "project/nginx/src/core/ngx_regex.c"
                    ;
    }

    return 
# 494 "project/nginx/src/core/ngx_regex.c" 3 4
          -5
# 494 "project/nginx/src/core/ngx_regex.c"
                      ;
}
...
ngx_regex_malloc(size_t size, void *data)
{
    ...
    return 
# 511 "project/nginx/src/core/ngx_regex.c" 3 4
          ((void *)0)
# 511 "project/nginx/src/core/ngx_regex.c"
              ;
}
...
# 519 "project/nginx/src/core/ngx_regex.c" 3 4
       free
# 519 "project/nginx/src/core/ngx_regex.c"
               (p);
    }

    return;
}
# 547 "project/nginx/src/core/ngx_regex.c"
static void
ngx_regex_cleanup(void *data)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 563 "project/nginx/src/core/ngx_regex.c" 3 4
                             ((void *)0)
# 563 "project/nginx/src/core/ngx_regex.c"
                                 ) {
                break;
            }
...
# 580 "project/nginx/src/core/ngx_regex.c"
        
# 580 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_code_free_8
# 580 "project/nginx/src/core/ngx_regex.c"
                      (elts[i].regex);
    ...
    ngx_regex_studies = 
# 594 "project/nginx/src/core/ngx_regex.c" 3 4
                       ((void *)0)
# 594 "project/nginx/src/core/ngx_regex.c"
                           ;
# 603 "project/nginx/src/core/ngx_regex.c"
    if (ngx_regex_compile_context) {
        
# 604 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_compile_context_free_8
# 604 "project/nginx/src/core/ngx_regex.c"
                                 (ngx_regex_compile_context);
        ngx_regex_compile_context = 
# 605 "project/nginx/src/core/ngx_regex.c" 3 4
                                   ((void *)0)
# 605 "project/nginx/src/core/ngx_regex.c"
                                       ;
    }

    if (ngx_regex_match_data) {
        
# 609 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_match_data_free_8
# 609 "project/nginx/src/core/ngx_regex.c"
                            (ngx_regex_match_data);
        ngx_regex_match_data = 
# 610 "project/nginx/src/core/ngx_regex.c" 3 4
                              ((void *)0)
# 610 "project/nginx/src/core/ngx_regex.c"
                                  ;
...
ngx_regex_module_init(ngx_cycle_t *cycle)
{
    ...
    rcf = (ngx_regex_conf_t *) cycle->conf_ctx
# 632 "project/nginx/src/core/ngx_regex.c" 3 4
                              [
# 632 "project/nginx/src/core/ngx_regex.c"
                              ngx_regex_module
# 632 "project/nginx/src/core/ngx_regex.c" 3 4
                              .index]
# 632 "project/nginx/src/core/ngx_regex.c"
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 654 "project/nginx/src/core/ngx_regex.c" 3 4
                             ((void *)0)
# 654 "project/nginx/src/core/ngx_regex.c"
                                 ) {
                break;
            }
        ...
        if (opt) {
            ...
            n = 
# 668 "project/nginx/src/core/ngx_regex.c" 3 4
               pcre2_jit_compile_8
# 668 "project/nginx/src/core/ngx_regex.c"
                                (elts[i].regex, 
# 668 "project/nginx/src/core/ngx_regex.c" 3 4
                                                0x00000001u
# 668 "project/nginx/src/core/ngx_regex.c"
...
# 671 "project/nginx/src/core/ngx_regex.c" 3 4
               if ((
# 671 "project/nginx/src/core/ngx_regex.c"
               cycle->log
# 671 "project/nginx/src/core/ngx_regex.c" 3 4
...
# 671 "project/nginx/src/core/ngx_regex.c" 3 4
               , 
# 671 "project/nginx/src/core/ngx_regex.c"
               0, "pcre2_jit_compile() failed: %d in \"%s\", " "ignored", n, elts[i].name
# 671 "project/nginx/src/core/ngx_regex.c" 3 4
               )


                                              
# 674 "project/nginx/src/core/ngx_regex.c"
                                             ;
            }
        }
# 704 "project/nginx/src/core/ngx_regex.c"
    }

    ngx_regex_malloc_done();

    ngx_regex_studies = 
# 708 "project/nginx/src/core/ngx_regex.c" 3 4
                       ((void *)0)
# 708 "project/nginx/src/core/ngx_regex.c"
                           ;

    ngx_regex_compile_context = 
# 710 "project/nginx/src/core/ngx_regex.c" 3 4
                               ((void *)0)
# 710 "project/nginx/src/core/ngx_regex.c"
                                   ;


    return 
# 713 "project/nginx/src/core/ngx_regex.c" 3 4
          0
# 713 "project/nginx/src/core/ngx_regex.c"
                ;
}
...
ngx_regex_create_conf(ngx_cycle_t *cycle)
{
    ...
    if (rcf == 
# 724 "project/nginx/src/core/ngx_regex.c" 3 4
              ((void *)0)
# 724 "project/nginx/src/core/ngx_regex.c"
                  ) {
        return 
# 725 "project/nginx/src/core/ngx_regex.c" 3 4
              ((void *)0)
# 725 "project/nginx/src/core/ngx_regex.c"
                  ;
    }

    rcf->pcre_jit = 
# 728 "project/nginx/src/core/ngx_regex.c" 3 4
                   -1
# 728 "project/nginx/src/core/ngx_regex.c"
                                 ;

    cln = ngx_pool_cleanup_add(cycle->pool, 0);
    if (cln == 
# 731 "project/nginx/src/core/ngx_regex.c" 3 4
              ((void *)0)
# 731 "project/nginx/src/core/ngx_regex.c"
                  ) {
        return 
# 732 "project/nginx/src/core/ngx_regex.c" 3 4
              ((void *)0)
# 732 "project/nginx/src/core/ngx_regex.c"
                  ;
    }
    ...
    if (rcf->studies == 
# 739 "project/nginx/src/core/ngx_regex.c" 3 4
                       ((void *)0)
# 739 "project/nginx/src/core/ngx_regex.c"
                           ) {
        return 
# 740 "project/nginx/src/core/ngx_regex.c" 3 4
              ((void *)0)
# 740 "project/nginx/src/core/ngx_regex.c"
                  ;
    }
...
# 754 "project/nginx/src/core/ngx_regex.c" 3 4
   if (
# 754 "project/nginx/src/core/ngx_regex.c"
   rcf->pcre_jit 
# 754 "project/nginx/src/core/ngx_regex.c" 3 4
   == -1) { 
# 754 "project/nginx/src/core/ngx_regex.c"
...
# 754 "project/nginx/src/core/ngx_regex.c"
    ...
    return 
# 756 "project/nginx/src/core/ngx_regex.c" 3 4
          ((void *)0)
# 756 "project/nginx/src/core/ngx_regex.c"
                     ;
}
...
ngx_regex_pcre_jit(ngx_conf_t *cf, void *post, void *data)
{
    ...
    if (*fp == 0) {
        return 
# 766 "project/nginx/src/core/ngx_regex.c" 3 4
              ((void *)0)
# 766 "project/nginx/src/core/ngx_regex.c"
                         ;
    }
    ...
    jit = 0;
    r = 
# 775 "project/nginx/src/core/ngx_regex.c" 3 4
       pcre2_config_8
# 775 "project/nginx/src/core/ngx_regex.c"
                   (
# 775 "project/nginx/src/core/ngx_regex.c" 3 4
                    1
# 775 "project/nginx/src/core/ngx_regex.c"
    ...
    if (r != 0 || jit != 1) {
        ngx_conf_log_error(
# 778 "project/nginx/src/core/ngx_regex.c" 3 4
                          5
# 778 "project/nginx/src/core/ngx_regex.c"
                                      , cf, 0,
                           "PCRE2 library does not support JIT");
        *fp = 0;
    }
    }
# 802 "project/nginx/src/core/ngx_regex.c"
    return 
# 802 "project/nginx/src/core/ngx_regex.c" 3 4
          ((void *)0)
# 802 "project/nginx/src/core/ngx_regex.c"
                     ;
}
