# 0 "project/nginx/src/core/ngx_inet.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_inet.c"
...
# 9 "project/nginx/src/core/ngx_inet.c" 2
...
# 10 "project/nginx/src/core/ngx_inet.c" 2



# 12 "project/nginx/src/core/ngx_inet.c"
...
ngx_inet_addr(u_char *text, size_t len)
{
    ...
    for (p = text; p < text + len; p++) {
        ...
        if (c >= '0' && c <= '9') {
            ...
            if (octet > 255) {
                return 
# 37 "project/nginx/src/core/ngx_inet.c" 3 4
                      0xffffffff
# 37 "project/nginx/src/core/ngx_inet.c"
                                 ;
            }
        ...
        return 
# 50 "project/nginx/src/core/ngx_inet.c" 3 4
              0xffffffff
# 50 "project/nginx/src/core/ngx_inet.c"
                         ;
    }
    ...
    if (n == 3) {
        addr = (addr << 8) + octet;
        return 
# 55 "project/nginx/src/core/ngx_inet.c" 3 4
              (__builtin_constant_p(
# 55 "project/nginx/src/core/ngx_inet.c"
              addr
# 55 "project/nginx/src/core/ngx_inet.c" 3 4
...
# 55 "project/nginx/src/core/ngx_inet.c"
    ...
    return 
# 58 "project/nginx/src/core/ngx_inet.c" 3 4
          0xffffffff
# 58 "project/nginx/src/core/ngx_inet.c"
                     ;
}
...
ngx_inet6_addr(u_char *p, size_t len, u_char *addr)
{
    ...
    if (len == 0) {
        return 
# 72 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 72 "project/nginx/src/core/ngx_inet.c"
                       ;
    }

    zero = 
# 75 "project/nginx/src/core/ngx_inet.c" 3 4
          ((void *)0)
# 75 "project/nginx/src/core/ngx_inet.c"
              ;
    digit = 
# 76 "project/nginx/src/core/ngx_inet.c" 3 4
           ((void *)0)
# 76 "project/nginx/src/core/ngx_inet.c"
               ;
    len4 = 0;
    nibbles = 0;
    word = 0;
        ...
        if (c == ':') {
            if (nibbles) {
                ...
                *addr++ = (u_char) (word & 0xff);
                ...
                if (zero == 
# 104 "project/nginx/src/core/ngx_inet.c" 3 4
                           ((void *)0)
# 104 "project/nginx/src/core/ngx_inet.c"
                               ) {
                    digit = p;
                    len4 = len;
                    zero = addr;
            ...
            return 
# 112 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 112 "project/nginx/src/core/ngx_inet.c"
                           ;
        }

        if (c == '.' && nibbles) {
            if (n < 2 || digit == 
# 116 "project/nginx/src/core/ngx_inet.c" 3 4
                                 ((void *)0)
# 116 "project/nginx/src/core/ngx_inet.c"
                                     ) {
                return 
# 117 "project/nginx/src/core/ngx_inet.c" 3 4
                      -1
# 117 "project/nginx/src/core/ngx_inet.c"
                               ;
            }

            word = ngx_inet_addr(digit, len4 - 1);
            if (word == 
# 121 "project/nginx/src/core/ngx_inet.c" 3 4
                       0xffffffff
# 121 "project/nginx/src/core/ngx_inet.c"
                                  ) {
                return 
# 122 "project/nginx/src/core/ngx_inet.c" 3 4
                      -1
# 122 "project/nginx/src/core/ngx_inet.c"
                               ;
            }

            word = 
# 125 "project/nginx/src/core/ngx_inet.c" 3 4
                  (__builtin_constant_p(
# 125 "project/nginx/src/core/ngx_inet.c"
                  word
# 125 "project/nginx/src/core/ngx_inet.c" 3 4
                  ) ? ((__uint32_t)((((__uint32_t)(
# 125 "project/nginx/src/core/ngx_inet.c"
...
# 125 "project/nginx/src/core/ngx_inet.c"
        ...
        if (++nibbles > 4) {
            return 
# 133 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 133 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
        ...
        return 
# 148 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 148 "project/nginx/src/core/ngx_inet.c"
                       ;
    }

    if (nibbles == 0 && zero == 
# 151 "project/nginx/src/core/ngx_inet.c" 3 4
                               ((void *)0)
# 151 "project/nginx/src/core/ngx_inet.c"
                                   ) {
        return 
# 152 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 152 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
...
# 166 "project/nginx/src/core/ngx_inet.c" 3 4
           (void) __builtin___memset_chk (
# 166 "project/nginx/src/core/ngx_inet.c"
           zero
# 166 "project/nginx/src/core/ngx_inet.c" 3 4
           , 0, 
# 166 "project/nginx/src/core/ngx_inet.c"
...
# 166 "project/nginx/src/core/ngx_inet.c"
                               ;
            return 
# 167 "project/nginx/src/core/ngx_inet.c" 3 4
                  0
# 167 "project/nginx/src/core/ngx_inet.c"
                        ;
        }

    } else {
        if (zero == 
# 171 "project/nginx/src/core/ngx_inet.c" 3 4
                   ((void *)0)
# 171 "project/nginx/src/core/ngx_inet.c"
                       ) {
            return 
# 172 "project/nginx/src/core/ngx_inet.c" 3 4
                  0
# 172 "project/nginx/src/core/ngx_inet.c"
                        ;
        }
    }

    return 
# 176 "project/nginx/src/core/ngx_inet.c" 3 4
          -1
# 176 "project/nginx/src/core/ngx_inet.c"
                   ;
}
    ...
    ngx_uint_t port)
{
    ...
    case 
# 200 "project/nginx/src/core/ngx_inet.c" 3 4
        2
# 200 "project/nginx/src/core/ngx_inet.c"
               :
        ...
        if (port) {
            p = ngx_snprintf(text, len, "%ud.%ud.%ud.%ud:%d",
                             p[0], p[1], p[2], p[3], 
# 207 "project/nginx/src/core/ngx_inet.c" 3 4
                                                    ((__uint16_t)(__builtin_constant_p(
# 207 "project/nginx/src/core/ngx_inet.c"
                                                    sin->sin_port
# 207 "project/nginx/src/core/ngx_inet.c" 3 4
...
# 207 "project/nginx/src/core/ngx_inet.c"
    ...
    case 
# 217 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 217 "project/nginx/src/core/ngx_inet.c"
                :
        ...
        n = ngx_inet6_ntop(sin6->sin6_addr.
# 227 "project/nginx/src/core/ngx_inet.c" 3 4
                                          __u6_addr.__u6_addr8
# 227 "project/nginx/src/core/ngx_inet.c"
                                                 , &text[n], len);

        if (port) {
            n = ngx_sprintf(&text[1 + n], "]:%d",
                            
# 231 "project/nginx/src/core/ngx_inet.c" 3 4
                           ((__uint16_t)(__builtin_constant_p(
# 231 "project/nginx/src/core/ngx_inet.c"
                           sin6->sin6_port
# 231 "project/nginx/src/core/ngx_inet.c" 3 4
                           ) ? ((__uint16_t)((((__uint16_t)(
# 231 "project/nginx/src/core/ngx_inet.c"
...
# 231 "project/nginx/src/core/ngx_inet.c"
    ...
    case 
# 239 "project/nginx/src/core/ngx_inet.c" 3 4
        1
# 239 "project/nginx/src/core/ngx_inet.c"
               :
        saun = (struct sockaddr_un *) sa;



        if (socklen <= (socklen_t) 
# 244 "project/nginx/src/core/ngx_inet.c" 3 4
                                  __builtin_offsetof (
# 244 "project/nginx/src/core/ngx_inet.c"
                                  struct sockaddr_un
# 244 "project/nginx/src/core/ngx_inet.c" 3 4
                                  , 
# 244 "project/nginx/src/core/ngx_inet.c"
...
# 244 "project/nginx/src/core/ngx_inet.c"
            ...
            n = ngx_strnlen((u_char *) saun->sun_path,
                            socklen - 
# 249 "project/nginx/src/core/ngx_inet.c" 3 4
                                     __builtin_offsetof (
# 249 "project/nginx/src/core/ngx_inet.c"
                                     struct sockaddr_un
# 249 "project/nginx/src/core/ngx_inet.c" 3 4
                                     , 
# 249 "project/nginx/src/core/ngx_inet.c"
...
ngx_inet_ntop(int family, void *addr, u_char *text, size_t len)
{
    ...
    case 
# 272 "project/nginx/src/core/ngx_inet.c" 3 4
        2
# 272 "project/nginx/src/core/ngx_inet.c"
               :
    ...
    case 
# 282 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 282 "project/nginx/src/core/ngx_inet.c"
                :
...
ngx_inet6_ntop(u_char *p, u_char *text, size_t len)
{
    ...
    if (len < 
# 302 "project/nginx/src/core/ngx_inet.c" 3 4
             (sizeof("ffff:ffff:ffff:ffff:ffff:ffff:255.255.255.255") - 1)
# 302 "project/nginx/src/core/ngx_inet.c"
                                 ) {
        return 0;
    }
...
ngx_ptocidr(ngx_str_t *text, ngx_cidr_t *cidr)
{
    ...
    if (cidr->u.in.addr != 
# 393 "project/nginx/src/core/ngx_inet.c" 3 4
                          0xffffffff
# 393 "project/nginx/src/core/ngx_inet.c"
                                     ) {
        cidr->family = 
# 394 "project/nginx/src/core/ngx_inet.c" 3 4
                      2
# 394 "project/nginx/src/core/ngx_inet.c"
                             ;

        if (mask == 
# 396 "project/nginx/src/core/ngx_inet.c" 3 4
                   ((void *)0)
# 396 "project/nginx/src/core/ngx_inet.c"
                       ) {
            cidr->u.in.mask = 0xffffffff;
            return 
# 398 "project/nginx/src/core/ngx_inet.c" 3 4
                  0
# 398 "project/nginx/src/core/ngx_inet.c"
                        ;
        }


    } else if (ngx_inet6_addr(addr, len, cidr->u.in6.addr.
# 402 "project/nginx/src/core/ngx_inet.c" 3 4
                                                         __u6_addr.__u6_addr8
# 402 "project/nginx/src/core/ngx_inet.c"
                                                                ) == 
# 402 "project/nginx/src/core/ngx_inet.c" 3 4
                                                                     0
# 402 "project/nginx/src/core/ngx_inet.c"
        ...
        cidr->family = 
# 403 "project/nginx/src/core/ngx_inet.c" 3 4
                      30
# 403 "project/nginx/src/core/ngx_inet.c"
                              ;

        if (mask == 
# 405 "project/nginx/src/core/ngx_inet.c" 3 4
                   ((void *)0)
# 405 "project/nginx/src/core/ngx_inet.c"
                       ) {
            
# 406 "project/nginx/src/core/ngx_inet.c" 3 4
           (void) __builtin___memset_chk (
# 406 "project/nginx/src/core/ngx_inet.c"
           cidr->u.in6.mask.
# 406 "project/nginx/src/core/ngx_inet.c" 3 4
           __u6_addr.__u6_addr8, 
# 406 "project/nginx/src/core/ngx_inet.c"
...
# 406 "project/nginx/src/core/ngx_inet.c"
                                                         ;
            return 
# 407 "project/nginx/src/core/ngx_inet.c" 3 4
                  0
# 407 "project/nginx/src/core/ngx_inet.c"
                        ;
        }
        ...
        return 
# 412 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 412 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    if (shift == 
# 418 "project/nginx/src/core/ngx_inet.c" 3 4
                -1
# 418 "project/nginx/src/core/ngx_inet.c"
                         ) {
        return 
# 419 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 419 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    case 
# 425 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 425 "project/nginx/src/core/ngx_inet.c"
                :
        if (shift > 128) {
            return 
# 427 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 427 "project/nginx/src/core/ngx_inet.c"
                           ;
        }

        addr = cidr->u.in6.addr.
# 430 "project/nginx/src/core/ngx_inet.c" 3 4
                               __u6_addr.__u6_addr8
# 430 "project/nginx/src/core/ngx_inet.c"
                                      ;
        mask = cidr->u.in6.mask.
# 431 "project/nginx/src/core/ngx_inet.c" 3 4
                               __u6_addr.__u6_addr8
# 431 "project/nginx/src/core/ngx_inet.c"
                                      ;
        rc = 
# 432 "project/nginx/src/core/ngx_inet.c" 3 4
            0
# 432 "project/nginx/src/core/ngx_inet.c"
                  ;
        ...
        for (i = 0; i < 16; i++) {
            ...
            if (addr[i] != (addr[i] & mask[i])) {
                rc = 
# 442 "project/nginx/src/core/ngx_inet.c" 3 4
                    -4
# 442 "project/nginx/src/core/ngx_inet.c"
                            ;
                addr[i] &= mask[i];
            }
        }
    ...
    default:
        if (shift > 32) {
            return 
# 452 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 452 "project/nginx/src/core/ngx_inet.c"
                           ;
        }

        if (shift) {
            cidr->u.in.mask = 
# 456 "project/nginx/src/core/ngx_inet.c" 3 4
                             (__builtin_constant_p(
# 456 "project/nginx/src/core/ngx_inet.c"
                             (uint32_t) (0xffffffffu << (32 - shift))
# 456 "project/nginx/src/core/ngx_inet.c" 3 4
                             ) ? ((__uint32_t)((((__uint32_t)(
# 456 "project/nginx/src/core/ngx_inet.c"
                             (uint32_t) (0xffffffffu << (32 - shift))
...
# 456 "project/nginx/src/core/ngx_inet.c"
        ...
        if (cidr->u.in.addr == (cidr->u.in.addr & cidr->u.in.mask)) {
            return 
# 464 "project/nginx/src/core/ngx_inet.c" 3 4
                  0
# 464 "project/nginx/src/core/ngx_inet.c"
                        ;
        }
        ...
        return 
# 469 "project/nginx/src/core/ngx_inet.c" 3 4
              -4
# 469 "project/nginx/src/core/ngx_inet.c"
                      ;
    }
}
...
ngx_cidr_match(struct sockaddr *sa, ngx_array_t *cidrs)
{
    ...
    inaddr6 = 
# 491 "project/nginx/src/core/ngx_inet.c" 3 4
             ((void *)0)
# 491 "project/nginx/src/core/ngx_inet.c"
                 ;
    ...
    if (family == 
# 497 "project/nginx/src/core/ngx_inet.c" 3 4
                 2
# 497 "project/nginx/src/core/ngx_inet.c"
                        ) {
...
# 502 "project/nginx/src/core/ngx_inet.c" 3 4
                      30
# 502 "project/nginx/src/core/ngx_inet.c"
                              ) {
        inaddr6 = &((struct sockaddr_in6 *) sa)->sin6_addr;

        if (
# 505 "project/nginx/src/core/ngx_inet.c" 3 4
           ((*(const __uint32_t *)(const void *)(&(
# 505 "project/nginx/src/core/ngx_inet.c"
           inaddr6
# 505 "project/nginx/src/core/ngx_inet.c" 3 4
...
# 505 "project/nginx/src/core/ngx_inet.c"
            ...
            family = 
# 506 "project/nginx/src/core/ngx_inet.c" 3 4
                    2
# 506 "project/nginx/src/core/ngx_inet.c"
                           ;

            p = inaddr6->
# 508 "project/nginx/src/core/ngx_inet.c" 3 4
                        __u6_addr.__u6_addr8
# 508 "project/nginx/src/core/ngx_inet.c"
                               ;
            ...
            inaddr = 
# 515 "project/nginx/src/core/ngx_inet.c" 3 4
                    (__builtin_constant_p(
# 515 "project/nginx/src/core/ngx_inet.c"
                    inaddr
# 515 "project/nginx/src/core/ngx_inet.c" 3 4
                    ) ? ((__uint32_t)((((__uint32_t)(
# 515 "project/nginx/src/core/ngx_inet.c"
...
# 515 "project/nginx/src/core/ngx_inet.c"
    ...
    for (cidr = cidrs->elts, i = 0; i < cidrs->nelts; i++) {
        ...
        case 
# 528 "project/nginx/src/core/ngx_inet.c" 3 4
            30
# 528 "project/nginx/src/core/ngx_inet.c"
                    :
            for (n = 0; n < 16; n++) {
                if ((inaddr6->
# 530 "project/nginx/src/core/ngx_inet.c" 3 4
                             __u6_addr.__u6_addr8
# 530 "project/nginx/src/core/ngx_inet.c"
                                    [n] & cidr[i].u.in6.mask.
# 530 "project/nginx/src/core/ngx_inet.c" 3 4
                                                             __u6_addr.__u6_addr8
# 530 "project/nginx/src/core/ngx_inet.c"
                                                                    [n])
                    != cidr[i].u.in6.addr.
# 531 "project/nginx/src/core/ngx_inet.c" 3 4
                                         __u6_addr.__u6_addr8
# 531 "project/nginx/src/core/ngx_inet.c"
                                                [n])
                {
                    goto next;
                }
        ...
        case 
# 540 "project/nginx/src/core/ngx_inet.c" 3 4
            1
# 540 "project/nginx/src/core/ngx_inet.c"
                   :
            break;
        ...
        return 
# 551 "project/nginx/src/core/ngx_inet.c" 3 4
              0
# 551 "project/nginx/src/core/ngx_inet.c"
                    ;
    ...
    return 
# 557 "project/nginx/src/core/ngx_inet.c" 3 4
          -5
# 557 "project/nginx/src/core/ngx_inet.c"
                      ;
}
...
# 575 "project/nginx/src/core/ngx_inet.c" 3 4
   (void) __builtin___memset_chk (
# 575 "project/nginx/src/core/ngx_inet.c"
   &inaddr6
# 575 "project/nginx/src/core/ngx_inet.c" 3 4
   , 0, 
# 575 "project/nginx/src/core/ngx_inet.c"
...
# 575 "project/nginx/src/core/ngx_inet.c"
    ...
    if (inaddr != 
# 580 "project/nginx/src/core/ngx_inet.c" 3 4
                 0xffffffff
# 580 "project/nginx/src/core/ngx_inet.c"
                            ) {
        family = 
# 581 "project/nginx/src/core/ngx_inet.c" 3 4
                2
# 581 "project/nginx/src/core/ngx_inet.c"
                       ;
        len = sizeof(struct sockaddr_in);


    } else if (ngx_inet6_addr(text, len, inaddr6.
# 585 "project/nginx/src/core/ngx_inet.c" 3 4
                                                __u6_addr.__u6_addr8
# 585 "project/nginx/src/core/ngx_inet.c"
                                                       ) == 
# 585 "project/nginx/src/core/ngx_inet.c" 3 4
                                                            0
# 585 "project/nginx/src/core/ngx_inet.c"
        ...
        family = 
# 586 "project/nginx/src/core/ngx_inet.c" 3 4
                30
# 586 "project/nginx/src/core/ngx_inet.c"
                        ;
        ...
        return 
# 591 "project/nginx/src/core/ngx_inet.c" 3 4
              -5
# 591 "project/nginx/src/core/ngx_inet.c"
                          ;
    }

    addr->sockaddr = ngx_pcalloc(pool, len);
    if (addr->sockaddr == 
# 595 "project/nginx/src/core/ngx_inet.c" 3 4
                         ((void *)0)
# 595 "project/nginx/src/core/ngx_inet.c"
                             ) {
        return 
# 596 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 596 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    case 
# 605 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 605 "project/nginx/src/core/ngx_inet.c"
                :
        sin6 = (struct sockaddr_in6 *) addr->sockaddr;
        
# 607 "project/nginx/src/core/ngx_inet.c" 3 4
       (void) __builtin___memcpy_chk (
# 607 "project/nginx/src/core/ngx_inet.c"
       sin6->sin6_addr.
# 607 "project/nginx/src/core/ngx_inet.c" 3 4
       __u6_addr.__u6_addr8, 
# 607 "project/nginx/src/core/ngx_inet.c"
...
# 607 "project/nginx/src/core/ngx_inet.c"
    ...
    return 
# 617 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 617 "project/nginx/src/core/ngx_inet.c"
                ;
}
    ...
    size_t len)
{
    ...
    if (rc != 
# 631 "project/nginx/src/core/ngx_inet.c" 3 4
             -5
# 631 "project/nginx/src/core/ngx_inet.c"
                         ) {
        return rc;
    }
    ...
    if (len && text[0] == '[') {
        ...
        if (p == 
# 642 "project/nginx/src/core/ngx_inet.c" 3 4
                ((void *)0) 
# 642 "project/nginx/src/core/ngx_inet.c"
                     || p == last - 1 || *++p != ':') {
            return 
# 643 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 643 "project/nginx/src/core/ngx_inet.c"
                              ;
        }
...

    {
        ...
        if (p == 
# 655 "project/nginx/src/core/ngx_inet.c" 3 4
                ((void *)0)
# 655 "project/nginx/src/core/ngx_inet.c"
                    ) {
            return 
# 656 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 656 "project/nginx/src/core/ngx_inet.c"
                              ;
        }
    }
    ...
    if (port < 1 || port > 65535) {
        return 
# 666 "project/nginx/src/core/ngx_inet.c" 3 4
              -5
# 666 "project/nginx/src/core/ngx_inet.c"
                          ;
    }
    ...
    if (rc != 
# 673 "project/nginx/src/core/ngx_inet.c" 3 4
             0
# 673 "project/nginx/src/core/ngx_inet.c"
                   ) {
        return rc;
    }
    ...
    return 
# 679 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 679 "project/nginx/src/core/ngx_inet.c"
                ;
}
...
ngx_parse_unix_domain_url(ngx_pool_t *pool, ngx_url_t *u)
{
    ...
    if (len == 0) {
        ...
        return 
# 733 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 733 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    if (len > sizeof(saun->sun_path)) {
        ...
        return 
# 741 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 741 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    saun->sun_family = 
# 746 "project/nginx/src/core/ngx_inet.c" 3 4
                      1
# 746 "project/nginx/src/core/ngx_inet.c"
                             ;
    (void) ngx_cpystrn((u_char *) saun->sun_path, path, len);

    u->addrs = ngx_pcalloc(pool, sizeof(ngx_addr_t));
    if (u->addrs == 
# 750 "project/nginx/src/core/ngx_inet.c" 3 4
                   ((void *)0)
# 750 "project/nginx/src/core/ngx_inet.c"
                       ) {
        return 
# 751 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 751 "project/nginx/src/core/ngx_inet.c"
                       ;
    }

    saun = ngx_pcalloc(pool, sizeof(struct sockaddr_un));
    if (saun == 
# 755 "project/nginx/src/core/ngx_inet.c" 3 4
               ((void *)0)
# 755 "project/nginx/src/core/ngx_inet.c"
                   ) {
        return 
# 756 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 756 "project/nginx/src/core/ngx_inet.c"
                       ;
    }

    u->family = 
# 759 "project/nginx/src/core/ngx_inet.c" 3 4
               1
# 759 "project/nginx/src/core/ngx_inet.c"
                      ;
    u->naddrs = 1;

    saun->sun_family = 
# 762 "project/nginx/src/core/ngx_inet.c" 3 4
                      1
# 762 "project/nginx/src/core/ngx_inet.c"
                             ;
    (void) ngx_cpystrn((u_char *) saun->sun_path, path, len);
    ...
    return 
# 770 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 770 "project/nginx/src/core/ngx_inet.c"
                ;
# 779 "project/nginx/src/core/ngx_inet.c"
}
...
ngx_parse_inet_url(ngx_pool_t *pool, ngx_url_t *u)
{
    ...
    sin->sin_family = 
# 792 "project/nginx/src/core/ngx_inet.c" 3 4
                     2
# 792 "project/nginx/src/core/ngx_inet.c"
                            ;

    u->family = 
# 794 "project/nginx/src/core/ngx_inet.c" 3 4
               2
# 794 "project/nginx/src/core/ngx_inet.c"
                      ;
    ...
    if (args) {
        if (uri == 
# 807 "project/nginx/src/core/ngx_inet.c" 3 4
                  ((void *)0) 
# 807 "project/nginx/src/core/ngx_inet.c"
                       || args < uri) {
            uri = args;
        }
    }
    ...
    if (uri) {
        if (u->listen || !u->uri_part) {
            u->err = "invalid host";
            return 
# 815 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 815 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
        ...
        if (uri < port) {
            port = 
# 824 "project/nginx/src/core/ngx_inet.c" 3 4
                  ((void *)0)
# 824 "project/nginx/src/core/ngx_inet.c"
                      ;
        }
    }
        ...
        if (u->listen) {
            ...
            if (dash) {
                ...
                if (n < 1 || n > 65535) {
                    u->err = "invalid port";
                    return 
# 843 "project/nginx/src/core/ngx_inet.c" 3 4
                          -1
# 843 "project/nginx/src/core/ngx_inet.c"
                                   ;
                }
        ...
        if (n < 1 || n > 65535) {
            u->err = "invalid port";
            return 
# 856 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 856 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
        ...
        if (u->last_port && n > u->last_port) {
            ...
            return 
# 861 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 861 "project/nginx/src/core/ngx_inet.c"
                           ;
        }

        u->port = (in_port_t) n;
        sin->sin_port = 
# 865 "project/nginx/src/core/ngx_inet.c" 3 4
                       ((__uint16_t)(__builtin_constant_p(
# 865 "project/nginx/src/core/ngx_inet.c"
                       (in_port_t) n
# 865 "project/nginx/src/core/ngx_inet.c" 3 4
                       ) ? ((__uint16_t)((((__uint16_t)(
# 865 "project/nginx/src/core/ngx_inet.c"
...
# 865 "project/nginx/src/core/ngx_inet.c"
        ...
        if (uri == 
# 873 "project/nginx/src/core/ngx_inet.c" 3 4
                  ((void *)0)
# 873 "project/nginx/src/core/ngx_inet.c"
                      ) {
            ...
            if (u->listen) {
                ...
                if (dash) {
                    ...
                    if (n == 
# 888 "project/nginx/src/core/ngx_inet.c" 3 4
                            -1
# 888 "project/nginx/src/core/ngx_inet.c"
                                     ) {
                        goto no_port;
                    }
                ...
                if (n != 
# 904 "project/nginx/src/core/ngx_inet.c" 3 4
                        -1
# 904 "project/nginx/src/core/ngx_inet.c"
                                 ) {

                    if (u->err) {
                        return 
# 907 "project/nginx/src/core/ngx_inet.c" 3 4
                              -1
# 907 "project/nginx/src/core/ngx_inet.c"
                                       ;
                    }
                    ...
                    if (n < 1 || n > 65535) {
                        u->err = "invalid port";
                        return 
# 912 "project/nginx/src/core/ngx_inet.c" 3 4
                              -1
# 912 "project/nginx/src/core/ngx_inet.c"
                                       ;
                    }
                    ...
                    if (u->last_port && n > u->last_port) {
                        u->err = "invalid port range";
                        return 
# 917 "project/nginx/src/core/ngx_inet.c" 3 4
                              -1
# 917 "project/nginx/src/core/ngx_inet.c"
                                       ;
                    }

                    u->port = (in_port_t) n;
                    sin->sin_port = 
# 921 "project/nginx/src/core/ngx_inet.c" 3 4
                                   ((__uint16_t)(__builtin_constant_p(
# 921 "project/nginx/src/core/ngx_inet.c"
                                   (in_port_t) n
# 921 "project/nginx/src/core/ngx_inet.c" 3 4
                                   ) ? ((__uint16_t)((((__uint16_t)(
# 921 "project/nginx/src/core/ngx_inet.c"
...
# 921 "project/nginx/src/core/ngx_inet.c"
                                                       ;
                    sin->sin_addr.s_addr = 
# 922 "project/nginx/src/core/ngx_inet.c" 3 4
                                          (u_int32_t)0x00000000
# 922 "project/nginx/src/core/ngx_inet.c"
                                                    ;
...
no_port:
        ...
        u->err = 
# 937 "project/nginx/src/core/ngx_inet.c" 3 4
                ((void *)0)
# 937 "project/nginx/src/core/ngx_inet.c"
                    ;
        u->no_port = 1;
        u->port = u->default_port;
        sin->sin_port = 
# 940 "project/nginx/src/core/ngx_inet.c" 3 4
                       ((__uint16_t)(__builtin_constant_p(
# 940 "project/nginx/src/core/ngx_inet.c"
                       u->default_port
# 940 "project/nginx/src/core/ngx_inet.c" 3 4
                       ) ? ((__uint16_t)((((__uint16_t)(
# 940 "project/nginx/src/core/ngx_inet.c"
...
# 940 "project/nginx/src/core/ngx_inet.c"
    ...
    if (len == 0) {
        u->err = "no host";
        return 
# 948 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 948 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    if (u->listen && len == 1 && *host == '*') {
        sin->sin_addr.s_addr = 
# 955 "project/nginx/src/core/ngx_inet.c" 3 4
                              (u_int32_t)0x00000000
# 955 "project/nginx/src/core/ngx_inet.c"
                                        ;
        u->wildcard = 1;
...
# 962 "project/nginx/src/core/ngx_inet.c" 3 4
                               0xffffffff
# 962 "project/nginx/src/core/ngx_inet.c"
                                          ) {

        if (sin->sin_addr.s_addr == 
# 964 "project/nginx/src/core/ngx_inet.c" 3 4
                                   (u_int32_t)0x00000000
# 964 "project/nginx/src/core/ngx_inet.c"
                                             ) {
            u->wildcard = 1;
        }
    ...
    if (u->no_resolve) {
        return 
# 972 "project/nginx/src/core/ngx_inet.c" 3 4
              0
# 972 "project/nginx/src/core/ngx_inet.c"
                    ;
    }

    if (ngx_inet_resolve_host(pool, u) != 
# 975 "project/nginx/src/core/ngx_inet.c" 3 4
                                         0
# 975 "project/nginx/src/core/ngx_inet.c"
                                               ) {
        return 
# 976 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 976 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
...
# 981 "project/nginx/src/core/ngx_inet.c" 3 4
   (void) __builtin___memcpy_chk (
# 981 "project/nginx/src/core/ngx_inet.c"
   &u->sockaddr
# 981 "project/nginx/src/core/ngx_inet.c" 3 4
   , 
# 981 "project/nginx/src/core/ngx_inet.c"
...
# 981 "project/nginx/src/core/ngx_inet.c"
    ...
    return 
# 984 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 984 "project/nginx/src/core/ngx_inet.c"
                ;
}
...
ngx_parse_inet6_url(ngx_pool_t *pool, ngx_url_t *u)
{
    ...
    sin6->sin6_family = 
# 999 "project/nginx/src/core/ngx_inet.c" 3 4
                       30
# 999 "project/nginx/src/core/ngx_inet.c"
                               ;
    ...
    if (p == 
# 1007 "project/nginx/src/core/ngx_inet.c" 3 4
            ((void *)0)
# 1007 "project/nginx/src/core/ngx_inet.c"
                ) {
        u->err = "invalid host";
        return 
# 1009 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 1009 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    if (uri) {
        if (u->listen || !u->uri_part) {
            u->err = "invalid host";
            return 
# 1019 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1019 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
    ...
    if (port < last) {
        if (*port != ':') {
            u->err = "invalid host";
            return 
# 1031 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1031 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
        ...
        if (u->listen) {
            ...
            if (dash) {
                ...
                if (n < 1 || n > 65535) {
                    u->err = "invalid port";
                    return 
# 1048 "project/nginx/src/core/ngx_inet.c" 3 4
                          -1
# 1048 "project/nginx/src/core/ngx_inet.c"
                                   ;
                }
        ...
        if (n < 1 || n > 65535) {
            u->err = "invalid port";
            return 
# 1061 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1061 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
        ...
        if (u->last_port && n > u->last_port) {
            u->err = "invalid port range";
            return 
# 1066 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1066 "project/nginx/src/core/ngx_inet.c"
                           ;
        }

        u->port = (in_port_t) n;
        sin6->sin6_port = 
# 1070 "project/nginx/src/core/ngx_inet.c" 3 4
                         ((__uint16_t)(__builtin_constant_p(
# 1070 "project/nginx/src/core/ngx_inet.c"
                         (in_port_t) n
# 1070 "project/nginx/src/core/ngx_inet.c" 3 4
                         ) ? ((__uint16_t)((((__uint16_t)(
# 1070 "project/nginx/src/core/ngx_inet.c"
...
# 1070 "project/nginx/src/core/ngx_inet.c"
        ...
        u->port = u->default_port;
        sin6->sin6_port = 
# 1078 "project/nginx/src/core/ngx_inet.c" 3 4
                         ((__uint16_t)(__builtin_constant_p(
# 1078 "project/nginx/src/core/ngx_inet.c"
                         u->default_port
# 1078 "project/nginx/src/core/ngx_inet.c" 3 4
                         ) ? ((__uint16_t)((((__uint16_t)(
# 1078 "project/nginx/src/core/ngx_inet.c"
...
# 1078 "project/nginx/src/core/ngx_inet.c"
    ...
    if (len == 0) {
        u->err = "no host";
        return 
# 1085 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 1085 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
    ...
    if (ngx_inet6_addr(host, len, sin6->sin6_addr.
# 1091 "project/nginx/src/core/ngx_inet.c" 3 4
                                                 __u6_addr.__u6_addr8
# 1091 "project/nginx/src/core/ngx_inet.c"
                                                        ) != 
# 1091 "project/nginx/src/core/ngx_inet.c" 3 4
                                                             0
# 1091 "project/nginx/src/core/ngx_inet.c"
        ...
        return 
# 1093 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 1093 "project/nginx/src/core/ngx_inet.c"
                       ;
    }

    if (
# 1096 "project/nginx/src/core/ngx_inet.c" 3 4
       ((*(const __uint32_t *)(const void *)(&(
# 1096 "project/nginx/src/core/ngx_inet.c"
       &sin6->sin6_addr
# 1096 "project/nginx/src/core/ngx_inet.c" 3 4
       )->__u6_addr.__u6_addr8[0]) == 0) && (*(const __uint32_t *)(const void *)(&(
# 1096 "project/nginx/src/core/ngx_inet.c"
...
# 1096 "project/nginx/src/core/ngx_inet.c"
       &sin6->sin6_addr
# 1096 "project/nginx/src/core/ngx_inet.c" 3 4
       )->__u6_addr.__u6_addr8[8]) == 0) && (*(const __uint32_t *)(const void *)(&(
# 1096 "project/nginx/src/core/ngx_inet.c"
       &sin6->sin6_addr
# 1096 "project/nginx/src/core/ngx_inet.c" 3 4
...
# 1096 "project/nginx/src/core/ngx_inet.c"
    ...
    u->family = 
# 1100 "project/nginx/src/core/ngx_inet.c" 3 4
               30
# 1100 "project/nginx/src/core/ngx_inet.c"
                       ;

    return ngx_inet_add_addr(pool, u, &u->sockaddr.sockaddr, u->socklen, 1);
# 1111 "project/nginx/src/core/ngx_inet.c"
}
...
ngx_inet_resolve_host(ngx_pool_t *pool, ngx_url_t *u)
{
    ...
    if (host == 
# 1124 "project/nginx/src/core/ngx_inet.c" 3 4
               ((void *)0)
# 1124 "project/nginx/src/core/ngx_inet.c"
                   ) {
        return 
# 1125 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 1125 "project/nginx/src/core/ngx_inet.c"
                       ;
    }
...
# 1130 "project/nginx/src/core/ngx_inet.c" 3 4
   (void) __builtin___memset_chk (
# 1130 "project/nginx/src/core/ngx_inet.c"
   &hints
# 1130 "project/nginx/src/core/ngx_inet.c" 3 4
   , 0, 
# 1130 "project/nginx/src/core/ngx_inet.c"
...
# 1130 "project/nginx/src/core/ngx_inet.c"
                                               ;
    hints.ai_family = 
# 1131 "project/nginx/src/core/ngx_inet.c" 3 4
                     0
# 1131 "project/nginx/src/core/ngx_inet.c"
                              ;
    hints.ai_socktype = 
# 1132 "project/nginx/src/core/ngx_inet.c" 3 4
                       1
# 1132 "project/nginx/src/core/ngx_inet.c"
                                  ;

    hints.ai_flags = 
# 1134 "project/nginx/src/core/ngx_inet.c" 3 4
                    0x00000400
# 1134 "project/nginx/src/core/ngx_inet.c"
                                 ;


    if (getaddrinfo((char *) host, 
# 1137 "project/nginx/src/core/ngx_inet.c" 3 4
                                  ((void *)0)
# 1137 "project/nginx/src/core/ngx_inet.c"
                                      , &hints, &res) != 0) {
        u->err = "host not found";
        
# 1139 "project/nginx/src/core/ngx_inet.c" 3 4
       free
# 1139 "project/nginx/src/core/ngx_inet.c"
               (host);
        return 
# 1140 "project/nginx/src/core/ngx_inet.c" 3 4
              -1
# 1140 "project/nginx/src/core/ngx_inet.c"
                       ;
    }

    
# 1143 "project/nginx/src/core/ngx_inet.c" 3 4
   free
# 1143 "project/nginx/src/core/ngx_inet.c"
           (host);

    for (n = 0, rp = res; rp != 
# 1145 "project/nginx/src/core/ngx_inet.c" 3 4
                               ((void *)0)
# 1145 "project/nginx/src/core/ngx_inet.c"
                                   ; rp = rp->ai_next) {

        switch (rp->ai_family) {

        case 
# 1149 "project/nginx/src/core/ngx_inet.c" 3 4
            2
# 1149 "project/nginx/src/core/ngx_inet.c"
                   :
        case 
# 1150 "project/nginx/src/core/ngx_inet.c" 3 4
            30
# 1150 "project/nginx/src/core/ngx_inet.c"
                    :
            break;
    ...
    for (rp = res; rp != 
# 1167 "project/nginx/src/core/ngx_inet.c" 3 4
                        ((void *)0)
# 1167 "project/nginx/src/core/ngx_inet.c"
                            ; rp = rp->ai_next) {

        switch (rp->ai_family) {

        case 
# 1171 "project/nginx/src/core/ngx_inet.c" 3 4
            2
# 1171 "project/nginx/src/core/ngx_inet.c"
                   :
        case 
# 1172 "project/nginx/src/core/ngx_inet.c" 3 4
            30
# 1172 "project/nginx/src/core/ngx_inet.c"
                    :
            break;
        ...
        if (ngx_inet_add_addr(pool, u, rp->ai_addr, rp->ai_addrlen, n)
            != 
# 1180 "project/nginx/src/core/ngx_inet.c" 3 4
              0
# 1180 "project/nginx/src/core/ngx_inet.c"
                    )
        {
            goto failed;
        }
    ...
    freeaddrinfo(res);
    return 
# 1187 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 1187 "project/nginx/src/core/ngx_inet.c"
                ;
...
failed:
    ...
    freeaddrinfo(res);
    return 
# 1192 "project/nginx/src/core/ngx_inet.c" 3 4
          -1
# 1192 "project/nginx/src/core/ngx_inet.c"
                   ;
}
# 1262 "project/nginx/src/core/ngx_inet.c"
static ngx_int_t
    ...
    socklen_t socklen, ngx_uint_t total)
{
    ...
    if (u->addrs == 
# 1274 "project/nginx/src/core/ngx_inet.c" 3 4
                   ((void *)0)
# 1274 "project/nginx/src/core/ngx_inet.c"
                       ) {
        u->addrs = ngx_palloc(pool, total * nports * sizeof(ngx_addr_t));
        if (u->addrs == 
# 1276 "project/nginx/src/core/ngx_inet.c" 3 4
                       ((void *)0)
# 1276 "project/nginx/src/core/ngx_inet.c"
                           ) {
            return 
# 1277 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1277 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
    }
    ...
    for (i = 0; i < nports; i++) {
        ...
        if (sa == 
# 1283 "project/nginx/src/core/ngx_inet.c" 3 4
                 ((void *)0)
# 1283 "project/nginx/src/core/ngx_inet.c"
                     ) {
            return 
# 1284 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1284 "project/nginx/src/core/ngx_inet.c"
                           ;
        }

        
# 1287 "project/nginx/src/core/ngx_inet.c" 3 4
       (void) __builtin___memcpy_chk (
# 1287 "project/nginx/src/core/ngx_inet.c"
       sa
# 1287 "project/nginx/src/core/ngx_inet.c" 3 4
       , 
# 1287 "project/nginx/src/core/ngx_inet.c"
...
# 1287 "project/nginx/src/core/ngx_inet.c"
        ...
        case 
# 1294 "project/nginx/src/core/ngx_inet.c" 3 4
            30
# 1294 "project/nginx/src/core/ngx_inet.c"
                    :
            len = 
# 1295 "project/nginx/src/core/ngx_inet.c" 3 4
                 (sizeof("ffff:ffff:ffff:ffff:ffff:ffff:255.255.255.255") - 1) 
# 1295 "project/nginx/src/core/ngx_inet.c"
                                      + sizeof("[]:65536") - 1;
            break;
        ...
        default:
            len = 
# 1300 "project/nginx/src/core/ngx_inet.c" 3 4
                 (sizeof("255.255.255.255") - 1) 
# 1300 "project/nginx/src/core/ngx_inet.c"
                                     + sizeof(":65535") - 1;
        }

        p = ngx_pnalloc(pool, len);
        if (p == 
# 1304 "project/nginx/src/core/ngx_inet.c" 3 4
                ((void *)0)
# 1304 "project/nginx/src/core/ngx_inet.c"
                    ) {
            return 
# 1305 "project/nginx/src/core/ngx_inet.c" 3 4
                  -1
# 1305 "project/nginx/src/core/ngx_inet.c"
                           ;
        }
    ...
    return 
# 1319 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 1319 "project/nginx/src/core/ngx_inet.c"
                ;
}
    ...
    struct sockaddr *sa2, socklen_t slen2, ngx_uint_t cmp_port)
{
    ...
    if (sa1->sa_family != sa2->sa_family) {
        return 
# 1337 "project/nginx/src/core/ngx_inet.c" 3 4
              -5
# 1337 "project/nginx/src/core/ngx_inet.c"
                          ;
    }
    ...
    case 
# 1343 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 1343 "project/nginx/src/core/ngx_inet.c"
                :
        ...
        if (cmp_port && sin61->sin6_port != sin62->sin6_port) {
            return 
# 1349 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 1349 "project/nginx/src/core/ngx_inet.c"
                              ;
        }

        if (
# 1352 "project/nginx/src/core/ngx_inet.c" 3 4
           memcmp((const char *) 
# 1352 "project/nginx/src/core/ngx_inet.c"
           &sin61->sin6_addr
# 1352 "project/nginx/src/core/ngx_inet.c" 3 4
           , (const char *) 
# 1352 "project/nginx/src/core/ngx_inet.c"
...
# 1352 "project/nginx/src/core/ngx_inet.c"
                                                                != 0) {
            return 
# 1353 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 1353 "project/nginx/src/core/ngx_inet.c"
                              ;
        }
    ...
    case 
# 1360 "project/nginx/src/core/ngx_inet.c" 3 4
        1
# 1360 "project/nginx/src/core/ngx_inet.c"
               :
        ...
        if (slen1 < slen2) {
            len = slen1 - 
# 1366 "project/nginx/src/core/ngx_inet.c" 3 4
                         __builtin_offsetof (
# 1366 "project/nginx/src/core/ngx_inet.c"
                         struct sockaddr_un
# 1366 "project/nginx/src/core/ngx_inet.c" 3 4
                         , 
# 1366 "project/nginx/src/core/ngx_inet.c"
...
# 1366 "project/nginx/src/core/ngx_inet.c"
            ...
            len = slen2 - 
# 1369 "project/nginx/src/core/ngx_inet.c" 3 4
                         __builtin_offsetof (
# 1369 "project/nginx/src/core/ngx_inet.c"
                         struct sockaddr_un
# 1369 "project/nginx/src/core/ngx_inet.c" 3 4
                         , 
# 1369 "project/nginx/src/core/ngx_inet.c"
...
# 1369 "project/nginx/src/core/ngx_inet.c"
        ...
        if (
# 1376 "project/nginx/src/core/ngx_inet.c" 3 4
           memcmp((const char *) 
# 1376 "project/nginx/src/core/ngx_inet.c"
           &saun1->sun_path
# 1376 "project/nginx/src/core/ngx_inet.c" 3 4
           , (const char *) 
# 1376 "project/nginx/src/core/ngx_inet.c"
...
# 1376 "project/nginx/src/core/ngx_inet.c"
                                                               != 0) {
            return 
# 1377 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 1377 "project/nginx/src/core/ngx_inet.c"
                              ;
        }
    ...
    default:
        ...
        if (cmp_port && sin1->sin_port != sin2->sin_port) {
            return 
# 1389 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 1389 "project/nginx/src/core/ngx_inet.c"
                              ;
        }

        if (sin1->sin_addr.s_addr != sin2->sin_addr.s_addr) {
            return 
# 1393 "project/nginx/src/core/ngx_inet.c" 3 4
                  -5
# 1393 "project/nginx/src/core/ngx_inet.c"
                              ;
        }
    ...
    return 
# 1399 "project/nginx/src/core/ngx_inet.c" 3 4
          0
# 1399 "project/nginx/src/core/ngx_inet.c"
                ;
}
...
ngx_inet_get_port(struct sockaddr *sa)
{
    ...
    case 
# 1414 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 1414 "project/nginx/src/core/ngx_inet.c"
                :
        sin6 = (struct sockaddr_in6 *) sa;
        return 
# 1416 "project/nginx/src/core/ngx_inet.c" 3 4
              ((__uint16_t)(__builtin_constant_p(
# 1416 "project/nginx/src/core/ngx_inet.c"
              sin6->sin6_port
# 1416 "project/nginx/src/core/ngx_inet.c" 3 4
              ) ? ((__uint16_t)((((__uint16_t)(
# 1416 "project/nginx/src/core/ngx_inet.c"
...
# 1416 "project/nginx/src/core/ngx_inet.c"
    ...
    case 
# 1420 "project/nginx/src/core/ngx_inet.c" 3 4
        1
# 1420 "project/nginx/src/core/ngx_inet.c"
               :
        return 0;
    ...
    default:
        sin = (struct sockaddr_in *) sa;
        return 
# 1426 "project/nginx/src/core/ngx_inet.c" 3 4
              ((__uint16_t)(__builtin_constant_p(
# 1426 "project/nginx/src/core/ngx_inet.c"
              sin->sin_port
# 1426 "project/nginx/src/core/ngx_inet.c" 3 4
              ) ? ((__uint16_t)((((__uint16_t)(
# 1426 "project/nginx/src/core/ngx_inet.c"
...
ngx_inet_set_port(struct sockaddr *sa, in_port_t port)
{
    ...
    case 
# 1442 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 1442 "project/nginx/src/core/ngx_inet.c"
                :
        sin6 = (struct sockaddr_in6 *) sa;
        sin6->sin6_port = 
# 1444 "project/nginx/src/core/ngx_inet.c" 3 4
                         ((__uint16_t)(__builtin_constant_p(
# 1444 "project/nginx/src/core/ngx_inet.c"
                         port
# 1444 "project/nginx/src/core/ngx_inet.c" 3 4
                         ) ? ((__uint16_t)((((__uint16_t)(
# 1444 "project/nginx/src/core/ngx_inet.c"
...
# 1444 "project/nginx/src/core/ngx_inet.c"
    ...
    case 
# 1449 "project/nginx/src/core/ngx_inet.c" 3 4
        1
# 1449 "project/nginx/src/core/ngx_inet.c"
               :
        break;
    ...
    default:
        sin = (struct sockaddr_in *) sa;
        sin->sin_port = 
# 1455 "project/nginx/src/core/ngx_inet.c" 3 4
                       ((__uint16_t)(__builtin_constant_p(
# 1455 "project/nginx/src/core/ngx_inet.c"
                       port
# 1455 "project/nginx/src/core/ngx_inet.c" 3 4
                       ) ? ((__uint16_t)((((__uint16_t)(
# 1455 "project/nginx/src/core/ngx_inet.c"
...
ngx_inet_wildcard(struct sockaddr *sa)
{
    ...
    case 
# 1471 "project/nginx/src/core/ngx_inet.c" 3 4
        2
# 1471 "project/nginx/src/core/ngx_inet.c"
               :
        sin = (struct sockaddr_in *) sa;

        if (sin->sin_addr.s_addr == 
# 1474 "project/nginx/src/core/ngx_inet.c" 3 4
                                   (u_int32_t)0x00000000
# 1474 "project/nginx/src/core/ngx_inet.c"
                                             ) {
            return 1;
        }
    ...
    case 
# 1482 "project/nginx/src/core/ngx_inet.c" 3 4
        30
# 1482 "project/nginx/src/core/ngx_inet.c"
                :
        sin6 = (struct sockaddr_in6 *) sa;

        if (
# 1485 "project/nginx/src/core/ngx_inet.c" 3 4
           ((*(const __uint32_t *)(const void *)(&(
# 1485 "project/nginx/src/core/ngx_inet.c"
           &sin6->sin6_addr
# 1485 "project/nginx/src/core/ngx_inet.c" 3 4
           )->__u6_addr.__u6_addr8[0]) == 0) && (*(const __uint32_t *)(const void *)(&(
# 1485 "project/nginx/src/core/ngx_inet.c"
