# 0 "project/nginx/src/core/ngx_resolver.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_resolver.c"
...
# 9 "project/nginx/src/core/ngx_resolver.c" 2
...
# 10 "project/nginx/src/core/ngx_resolver.c" 2
...
# 11 "project/nginx/src/core/ngx_resolver.c" 2
...
# 19 "project/nginx/src/core/ngx_resolver.c"
typedef struct {
    u_char ident_hi;
    u_char ident_lo;
    u_char flags_hi;
...
ngx_resolver_create(ngx_conf_t *cf, ngx_str_t *names, ngx_uint_t n)
{
    ...
    if (r == 
# 143 "project/nginx/src/core/ngx_resolver.c" 3 4
            ((void *)0)
# 143 "project/nginx/src/core/ngx_resolver.c"
                ) {
        return 
# 144 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 144 "project/nginx/src/core/ngx_resolver.c"
                  ;
    }

    r->event = ngx_pcalloc(cf->pool, sizeof(ngx_event_t));
    if (r->event == 
# 148 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 148 "project/nginx/src/core/ngx_resolver.c"
                       ) {
        return 
# 149 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 149 "project/nginx/src/core/ngx_resolver.c"
                  ;
    }

    cln = ngx_pool_cleanup_add(cf->pool, 0);
    if (cln == 
# 153 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 153 "project/nginx/src/core/ngx_resolver.c"
                  ) {
        return 
# 154 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 154 "project/nginx/src/core/ngx_resolver.c"
                  ;
    }
...
# 160 "project/nginx/src/core/ngx_resolver.c" 3 4
   ((
# 160 "project/nginx/src/core/ngx_resolver.c"
   &r->name_sentinel
# 160 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->color = 0); (
# 160 "project/nginx/src/core/ngx_resolver.c"
...
# 163 "project/nginx/src/core/ngx_resolver.c" 3 4
   ((
# 163 "project/nginx/src/core/ngx_resolver.c"
   &r->srv_sentinel
# 163 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->color = 0); (
# 163 "project/nginx/src/core/ngx_resolver.c"
...
# 166 "project/nginx/src/core/ngx_resolver.c" 3 4
   ((
# 166 "project/nginx/src/core/ngx_resolver.c"
   &r->addr_sentinel
# 166 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->color = 0); (
# 166 "project/nginx/src/core/ngx_resolver.c"
...
# 169 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 169 "project/nginx/src/core/ngx_resolver.c"
   &r->name_resend_queue
# 169 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 169 "project/nginx/src/core/ngx_resolver.c"
...
# 170 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 170 "project/nginx/src/core/ngx_resolver.c"
   &r->srv_resend_queue
# 170 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 170 "project/nginx/src/core/ngx_resolver.c"
...
# 171 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 171 "project/nginx/src/core/ngx_resolver.c"
   &r->addr_resend_queue
# 171 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 171 "project/nginx/src/core/ngx_resolver.c"
...
# 173 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 173 "project/nginx/src/core/ngx_resolver.c"
   &r->name_expire_queue
# 173 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 173 "project/nginx/src/core/ngx_resolver.c"
...
# 174 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 174 "project/nginx/src/core/ngx_resolver.c"
   &r->srv_expire_queue
# 174 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 174 "project/nginx/src/core/ngx_resolver.c"
...
# 175 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 175 "project/nginx/src/core/ngx_resolver.c"
   &r->addr_expire_queue
# 175 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 175 "project/nginx/src/core/ngx_resolver.c"
...
# 180 "project/nginx/src/core/ngx_resolver.c" 3 4
   ((
# 180 "project/nginx/src/core/ngx_resolver.c"
   &r->addr6_sentinel
# 180 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->color = 0); (
# 180 "project/nginx/src/core/ngx_resolver.c"
...
# 183 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 183 "project/nginx/src/core/ngx_resolver.c"
   &r->addr6_resend_queue
# 183 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 183 "project/nginx/src/core/ngx_resolver.c"
   &r->addr6_resend_queue
...
# 185 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 185 "project/nginx/src/core/ngx_resolver.c"
   &r->addr6_expire_queue
# 185 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->prev = 
# 185 "project/nginx/src/core/ngx_resolver.c"
   &r->addr6_expire_queue
...
# 185 "project/nginx/src/core/ngx_resolver.c"
   &r->addr6_expire_queue;
    ...
    r->log_level = 
# 200 "project/nginx/src/core/ngx_resolver.c" 3 4
                  4
# 200 "project/nginx/src/core/ngx_resolver.c"
                             ;
    ...
    if (n) {
        if (ngx_array_init(&r->connections, cf->pool, n,
            ...
            != 
# 205 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 205 "project/nginx/src/core/ngx_resolver.c"
                    )
        {
            return 
# 207 "project/nginx/src/core/ngx_resolver.c" 3 4
                  ((void *)0)
# 207 "project/nginx/src/core/ngx_resolver.c"
                      ;
        }
    }
    ...
    for (i = 0; i < n; i++) {
        if (
# 212 "project/nginx/src/core/ngx_resolver.c" 3 4
           strncmp((const char *) 
# 212 "project/nginx/src/core/ngx_resolver.c"
           names[i].data
# 212 "project/nginx/src/core/ngx_resolver.c" 3 4
           , (const char *) 
# 212 "project/nginx/src/core/ngx_resolver.c"
...
# 212 "project/nginx/src/core/ngx_resolver.c"
            ...
            if (r->valid == (time_t) 
# 218 "project/nginx/src/core/ngx_resolver.c" 3 4
                                    -1
# 218 "project/nginx/src/core/ngx_resolver.c"
                                             ) {
                ngx_conf_log_error(
# 219 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  1
# 219 "project/nginx/src/core/ngx_resolver.c"
                                               , cf, 0,
                                   "invalid parameter: %V", &names[i]);
                return 
# 221 "project/nginx/src/core/ngx_resolver.c" 3 4
                      ((void *)0)
# 221 "project/nginx/src/core/ngx_resolver.c"
                          ;
            }
        ...
        if (
# 228 "project/nginx/src/core/ngx_resolver.c" 3 4
           strncmp((const char *) 
# 228 "project/nginx/src/core/ngx_resolver.c"
           names[i].data
# 228 "project/nginx/src/core/ngx_resolver.c" 3 4
           , (const char *) 
# 228 "project/nginx/src/core/ngx_resolver.c"
...
# 228 "project/nginx/src/core/ngx_resolver.c"
            ...
            if (
# 230 "project/nginx/src/core/ngx_resolver.c" 3 4
               strcmp((const char *) 
# 230 "project/nginx/src/core/ngx_resolver.c"
               &names[i].data[5]
# 230 "project/nginx/src/core/ngx_resolver.c" 3 4
               , (const char *) 
# 230 "project/nginx/src/core/ngx_resolver.c"
...
# 233 "project/nginx/src/core/ngx_resolver.c" 3 4
                      strcmp((const char *) 
# 233 "project/nginx/src/core/ngx_resolver.c"
                      &names[i].data[5]
# 233 "project/nginx/src/core/ngx_resolver.c" 3 4
                      , (const char *) 
# 233 "project/nginx/src/core/ngx_resolver.c"
...
# 233 "project/nginx/src/core/ngx_resolver.c"
                ...
                ngx_conf_log_error(
# 237 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  1
# 237 "project/nginx/src/core/ngx_resolver.c"
                                               , cf, 0,
                                   "invalid parameter: %V", &names[i]);
                return 
# 239 "project/nginx/src/core/ngx_resolver.c" 3 4
                      ((void *)0)
# 239 "project/nginx/src/core/ngx_resolver.c"
                          ;
            }
...
# 246 "project/nginx/src/core/ngx_resolver.c" 3 4
       (void) __builtin___memset_chk (
# 246 "project/nginx/src/core/ngx_resolver.c"
       &u
# 246 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 0, 
# 246 "project/nginx/src/core/ngx_resolver.c"
...
# 251 "project/nginx/src/core/ngx_resolver.c" 3 4
                                          0
# 251 "project/nginx/src/core/ngx_resolver.c"
                                                ) {
            if (u.err) {
                ngx_conf_log_error(
# 253 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  1
# 253 "project/nginx/src/core/ngx_resolver.c"
                                               , cf, 0,
                                   "%s in resolver \"%V\"",
                                   u.err, &u.url);
            }
            ...
            return 
# 258 "project/nginx/src/core/ngx_resolver.c" 3 4
                  ((void *)0)
# 258 "project/nginx/src/core/ngx_resolver.c"
                      ;
        }

        rec = ngx_array_push_n(&r->connections, u.naddrs);
        if (rec == 
# 262 "project/nginx/src/core/ngx_resolver.c" 3 4
                  ((void *)0)
# 262 "project/nginx/src/core/ngx_resolver.c"
                      ) {
            return 
# 263 "project/nginx/src/core/ngx_resolver.c" 3 4
                  ((void *)0)
# 263 "project/nginx/src/core/ngx_resolver.c"
                      ;
        }

        
# 266 "project/nginx/src/core/ngx_resolver.c" 3 4
       (void) __builtin___memset_chk (
# 266 "project/nginx/src/core/ngx_resolver.c"
       rec
# 266 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 0, 
# 266 "project/nginx/src/core/ngx_resolver.c"
       u.naddrs * sizeof(ngx_resolver_connection_t)
# 266 "project/nginx/src/core/ngx_resolver.c" 3 4
       , __builtin_object_size (
# 266 "project/nginx/src/core/ngx_resolver.c"
       rec
...
# 266 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (n && r->connections.nelts == 0) {
        ngx_conf_log_error(
# 277 "project/nginx/src/core/ngx_resolver.c" 3 4
                          1
# 277 "project/nginx/src/core/ngx_resolver.c"
                                       , cf, 0, "no name servers defined");
        return 
# 278 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 278 "project/nginx/src/core/ngx_resolver.c"
                  ;
    }
...
# 306 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_del_timer
# 306 "project/nginx/src/core/ngx_resolver.c"
                    (r->event);
    }
...
ngx_resolver_cleanup_tree(ngx_resolver_t *r, ngx_rbtree_t *tree)
{
    ...
    while (tree->root != tree->sentinel) {
        ...
        rn = 
# 341 "project/nginx/src/core/ngx_resolver.c" 3 4
            (
# 341 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t 
# 341 "project/nginx/src/core/ngx_resolver.c" 3 4
            *) ((u_char *) (
# 341 "project/nginx/src/core/ngx_resolver.c"
            ngx_rbtree_min(tree->root, tree->sentinel)
# 341 "project/nginx/src/core/ngx_resolver.c" 3 4
            ) - __builtin_offsetof (
# 341 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t
...
# 343 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 343 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 343 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 343 "project/nginx/src/core/ngx_resolver.c"
...
# 350 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ngx_event_del_timer
# 350 "project/nginx/src/core/ngx_resolver.c"
                                (ctx->event);
                }
...
ngx_resolve_start(ngx_resolver_t *r, ngx_resolver_ctx_t *temp)
{
    ...
    if (temp) {
        ...
        if (addr != 
# 375 "project/nginx/src/core/ngx_resolver.c" 3 4
                   0xffffffff
# 375 "project/nginx/src/core/ngx_resolver.c"
                              ) {
            temp->resolver = r;
            temp->state = 
# 377 "project/nginx/src/core/ngx_resolver.c" 3 4
                         0
# 377 "project/nginx/src/core/ngx_resolver.c"
                               ;
            temp->naddrs = 1;
...
# 382 "project/nginx/src/core/ngx_resolver.c" 3 4
           (void) __builtin___memset_chk (
# 382 "project/nginx/src/core/ngx_resolver.c"
           &temp->sin
# 382 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 0, 
# 382 "project/nginx/src/core/ngx_resolver.c"
...
# 382 "project/nginx/src/core/ngx_resolver.c"
                                                              ;
            temp->sin.sin_family = 
# 383 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  2
# 383 "project/nginx/src/core/ngx_resolver.c"
                                         ;
    ...
    if (r->connections.nelts == 0) {
        return 
# 392 "project/nginx/src/core/ngx_resolver.c" 3 4
              (void *) -1
# 392 "project/nginx/src/core/ngx_resolver.c"
                             ;
    }
...
ngx_resolve_name(ngx_resolver_ctx_t *ctx)
{
    ...
    if (ctx->quick) {
        ctx->handler(ctx);
        return 
# 424 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 424 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }
    ...
    if (ctx->service.len) {
        ...
        if (ngx_strlchr(ctx->service.data,
            ...
            == 
# 432 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 432 "project/nginx/src/core/ngx_resolver.c"
                  )
        {
        ...
        if (name.data == 
# 440 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ((void *)0)
# 440 "project/nginx/src/core/ngx_resolver.c"
                            ) {
            goto failed;
        }
    ...
    if (rc == 
# 463 "project/nginx/src/core/ngx_resolver.c" 3 4
             0
# 463 "project/nginx/src/core/ngx_resolver.c"
                   ) {
        return 
# 464 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 464 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }
    ...
    if (rc == 
# 469 "project/nginx/src/core/ngx_resolver.c" 3 4
             -2
# 469 "project/nginx/src/core/ngx_resolver.c"
                      ) {
        return 
# 470 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 470 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }
...
failed:
    ...
    return 
# 483 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 483 "project/nginx/src/core/ngx_resolver.c"
                   ;
}
...
# 505 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_del_timer
# 505 "project/nginx/src/core/ngx_resolver.c"
                    (ctx->event);
    }
    ...
    if (ctx->state == 
# 527 "project/nginx/src/core/ngx_resolver.c" 3 4
                     -2 
# 527 "project/nginx/src/core/ngx_resolver.c"
                               || ctx->state == 
# 527 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                60
# 527 "project/nginx/src/core/ngx_resolver.c"
...
# 546 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 546 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 546 "project/nginx/src/core/ngx_resolver.c" 3 4
...
# 546 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 546 "project/nginx/src/core/ngx_resolver.c"
           0, "could not cancel %V resolving", &ctx->name
# 546 "project/nginx/src/core/ngx_resolver.c" 3 4
           )
                                                                      
# 547 "project/nginx/src/core/ngx_resolver.c"
                                                                     ;
        }
    }
...
# 573 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_del_timer
# 573 "project/nginx/src/core/ngx_resolver.c"
                    (r->event);
    }
}
    ...
    ngx_str_t *name)
{
    ...
    if (rn) {
        ...
        if (rn->valid >= 
# 616 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec
# 616 "project/nginx/src/core/ngx_resolver.c"
                                  ) {

            ;

            
# 620 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 620 "project/nginx/src/core/ngx_resolver.c"
           &rn->queue
# 620 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->next->prev = (
# 620 "project/nginx/src/core/ngx_resolver.c"
...
# 620 "project/nginx/src/core/ngx_resolver.c"
            ...
            rn->expire = 
# 622 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec 
# 622 "project/nginx/src/core/ngx_resolver.c"
                                   + r->expire;

            
# 624 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 624 "project/nginx/src/core/ngx_resolver.c"
           &rn->queue
# 624 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->next = (
# 624 "project/nginx/src/core/ngx_resolver.c"
           ...
           &rn->queue;
            ...
            if (naddrs) {
                ...
                if (naddrs == 1 && rn->naddrs == 1) {
                    addrs = 
# 634 "project/nginx/src/core/ngx_resolver.c" 3 4
                           ((void *)0)
# 634 "project/nginx/src/core/ngx_resolver.c"
                               ;

                } else {
                    addrs = ngx_resolver_export(r, rn, 1);
                    if (addrs == 
# 638 "project/nginx/src/core/ngx_resolver.c" 3 4
                                ((void *)0)
# 638 "project/nginx/src/core/ngx_resolver.c"
                                    ) {
                        return 
# 639 "project/nginx/src/core/ngx_resolver.c" 3 4
                              -1
# 639 "project/nginx/src/core/ngx_resolver.c"
                                       ;
                    }
                }
                ...
                rn->waiting = 
# 644 "project/nginx/src/core/ngx_resolver.c" 3 4
                             ((void *)0)
# 644 "project/nginx/src/core/ngx_resolver.c"
                                 ;
                ...
                do {
                    ctx->state = 
# 649 "project/nginx/src/core/ngx_resolver.c" 3 4
                                0
# 649 "project/nginx/src/core/ngx_resolver.c"
                                      ;
                    ctx->valid = rn->valid;
                    ctx->naddrs = naddrs;

                    if (addrs == 
# 653 "project/nginx/src/core/ngx_resolver.c" 3 4
                                ((void *)0)
# 653 "project/nginx/src/core/ngx_resolver.c"
                                    ) {
                        ctx->addrs = &ctx->addr;
                        ctx->addr.sockaddr = (struct sockaddr *) &ctx->sin;
                        ctx->addr.socklen = sizeof(struct sockaddr_in);
                        
# 657 "project/nginx/src/core/ngx_resolver.c" 3 4
                       (void) __builtin___memset_chk (
# 657 "project/nginx/src/core/ngx_resolver.c"
                       &ctx->sin
# 657 "project/nginx/src/core/ngx_resolver.c" 3 4
                       , 0, 
# 657 "project/nginx/src/core/ngx_resolver.c"
...
# 657 "project/nginx/src/core/ngx_resolver.c"
                                                                         ;
                        ctx->sin.sin_family = 
# 658 "project/nginx/src/core/ngx_resolver.c" 3 4
                                             2
# 658 "project/nginx/src/core/ngx_resolver.c"
                                                    ;
                ...
                if (addrs != 
# 672 "project/nginx/src/core/ngx_resolver.c" 3 4
                            ((void *)0)
# 672 "project/nginx/src/core/ngx_resolver.c"
                                ) {
                ...
                return 
# 677 "project/nginx/src/core/ngx_resolver.c" 3 4
                      0
# 677 "project/nginx/src/core/ngx_resolver.c"
                            ;
            }
            ...
            if (rn->nsrvs) {
                last->next = rn->waiting;
                rn->waiting = 
# 682 "project/nginx/src/core/ngx_resolver.c" 3 4
                             ((void *)0)
# 682 "project/nginx/src/core/ngx_resolver.c"
                                 ;
                ...
                return 
# 694 "project/nginx/src/core/ngx_resolver.c" 3 4
                      0
# 694 "project/nginx/src/core/ngx_resolver.c"
                            ;
            }
            ...
            if (ctx->recursion++ < 
# 699 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  50
# 699 "project/nginx/src/core/ngx_resolver.c"
                                                            ) {
            ...
            last->next = rn->waiting;
            rn->waiting = 
# 708 "project/nginx/src/core/ngx_resolver.c" 3 4
                         ((void *)0)
# 708 "project/nginx/src/core/ngx_resolver.c"
                             ;
            ...
            do {
                ctx->state = 
# 713 "project/nginx/src/core/ngx_resolver.c" 3 4
                            3
# 713 "project/nginx/src/core/ngx_resolver.c"
                                                ;
                ctx->valid = 
# 714 "project/nginx/src/core/ngx_resolver.c" 3 4
                            ngx_cached_time->sec 
# 714 "project/nginx/src/core/ngx_resolver.c"
                                       + (r->valid ? r->valid : 10);
                next = ctx->next;
            ...
            return 
# 722 "project/nginx/src/core/ngx_resolver.c" 3 4
                  0
# 722 "project/nginx/src/core/ngx_resolver.c"
                        ;
        }

        if (rn->waiting) {
            if (ngx_resolver_set_timeout(r, ctx) != 
# 726 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                   0
# 726 "project/nginx/src/core/ngx_resolver.c"
                                                         ) {
                return 
# 727 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 727 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }
            ...
            rn->waiting = ctx;
            ctx->state = 
# 732 "project/nginx/src/core/ngx_resolver.c" 3 4
                        -2
# 732 "project/nginx/src/core/ngx_resolver.c"
                                 ;
            ctx->async = 1;
            ...
            return 
# 740 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -2
# 740 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }

        
# 743 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 743 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 743 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 743 "project/nginx/src/core/ngx_resolver.c"
...
# 743 "project/nginx/src/core/ngx_resolver.c"
        ...
        if (rn->query) {
            ...
            rn->query = 
# 749 "project/nginx/src/core/ngx_resolver.c" 3 4
                       ((void *)0)
# 749 "project/nginx/src/core/ngx_resolver.c"
                           ;

            rn->query6 = 
# 751 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ((void *)0)
# 751 "project/nginx/src/core/ngx_resolver.c"
                            ;
        ...
        if (rn == 
# 784 "project/nginx/src/core/ngx_resolver.c" 3 4
                 ((void *)0)
# 784 "project/nginx/src/core/ngx_resolver.c"
                     ) {
            return 
# 785 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -1
# 785 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }

        rn->name = ngx_resolver_dup(r, name->data, name->len);
        if (rn->name == 
# 789 "project/nginx/src/core/ngx_resolver.c" 3 4
                       ((void *)0)
# 789 "project/nginx/src/core/ngx_resolver.c"
                           ) {
            ngx_resolver_free(r, rn);
            return 
# 791 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -1
# 791 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }
        ...
        rn->query = 
# 796 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 796 "project/nginx/src/core/ngx_resolver.c"
                       ;

        rn->query6 = 
# 798 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 798 "project/nginx/src/core/ngx_resolver.c"
                        ;
    ...
    if (rc == 
# 811 "project/nginx/src/core/ngx_resolver.c" 3 4
             -1
# 811 "project/nginx/src/core/ngx_resolver.c"
                      ) {
        goto failed;
    }

    if (rc == 
# 815 "project/nginx/src/core/ngx_resolver.c" 3 4
             -5
# 815 "project/nginx/src/core/ngx_resolver.c"
                         ) {
        ngx_rbtree_delete(tree, &rn->node);
        ...
        do {
            ctx->state = 
# 823 "project/nginx/src/core/ngx_resolver.c" 3 4
                        3
# 823 "project/nginx/src/core/ngx_resolver.c"
                                            ;
            next = ctx->next;
        ...
        return 
# 831 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 831 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }
    ...
    if (ngx_resolver_send_query(r, rn) != 
# 847 "project/nginx/src/core/ngx_resolver.c" 3 4
                                         0
# 847 "project/nginx/src/core/ngx_resolver.c"
                                               ) {
    ...
    if (ngx_resolver_set_timeout(r, ctx) != 
# 859 "project/nginx/src/core/ngx_resolver.c" 3 4
                                           0
# 859 "project/nginx/src/core/ngx_resolver.c"
                                                 ) {
        goto failed;
    }
...
# 864 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_add_timer
# 864 "project/nginx/src/core/ngx_resolver.c"
                    (r->event, (ngx_msec_t) (r->resend_timeout * 1000));
    }

    rn->expire = 
# 867 "project/nginx/src/core/ngx_resolver.c" 3 4
                ngx_cached_time->sec 
# 867 "project/nginx/src/core/ngx_resolver.c"
                           + r->resend_timeout;

    
# 869 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 869 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue
# 869 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->next = (
# 869 "project/nginx/src/core/ngx_resolver.c"
...
# 869 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue;
    ...
    rn->valid = 0;
    rn->ttl = 
# 874 "project/nginx/src/core/ngx_resolver.c" 3 4
             (uint32_t) 0xffffffff
# 874 "project/nginx/src/core/ngx_resolver.c"
                                 ;
    rn->waiting = ctx;

    ctx->state = 
# 877 "project/nginx/src/core/ngx_resolver.c" 3 4
                -2
# 877 "project/nginx/src/core/ngx_resolver.c"
                         ;
    ctx->async = 1;
    ...
    return 
# 885 "project/nginx/src/core/ngx_resolver.c" 3 4
          -2
# 885 "project/nginx/src/core/ngx_resolver.c"
                   ;
...
failed:
    ...
    return 
# 899 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 899 "project/nginx/src/core/ngx_resolver.c"
                   ;
}
...
ngx_resolve_addr(ngx_resolver_ctx_t *ctx)
{
    ...
    hash = 0;
    sin6 = 
# 922 "project/nginx/src/core/ngx_resolver.c" 3 4
          ((void *)0)
# 922 "project/nginx/src/core/ngx_resolver.c"
              ;
    ...
    case 
# 931 "project/nginx/src/core/ngx_resolver.c" 3 4
        30
# 931 "project/nginx/src/core/ngx_resolver.c"
                :
        sin6 = (struct sockaddr_in6 *) ctx->addr.sockaddr;
        hash = ngx_crc32_short(sin6->sin6_addr.
# 933 "project/nginx/src/core/ngx_resolver.c" 3 4
                                              __u6_addr.__u6_addr8
# 933 "project/nginx/src/core/ngx_resolver.c"
                                                     , 16);
    ...
    default:
        ...
        addr = 
# 948 "project/nginx/src/core/ngx_resolver.c" 3 4
              (__builtin_constant_p(
# 948 "project/nginx/src/core/ngx_resolver.c"
              sin->sin_addr.s_addr
# 948 "project/nginx/src/core/ngx_resolver.c" 3 4
...
# 948 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (rn) {
        ...
        if (rn->valid >= 
# 961 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec
# 961 "project/nginx/src/core/ngx_resolver.c"
                                  ) {

            ;

            
# 965 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 965 "project/nginx/src/core/ngx_resolver.c"
           &rn->queue
# 965 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->next->prev = (
# 965 "project/nginx/src/core/ngx_resolver.c"
...
# 965 "project/nginx/src/core/ngx_resolver.c"
            ...
            rn->expire = 
# 967 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec 
# 967 "project/nginx/src/core/ngx_resolver.c"
                                   + r->expire;

            
# 969 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 969 "project/nginx/src/core/ngx_resolver.c"
           &rn->queue
# 969 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->next = (
# 969 "project/nginx/src/core/ngx_resolver.c"
...
# 969 "project/nginx/src/core/ngx_resolver.c"
           &rn->queue;
            ...
            if (name == 
# 972 "project/nginx/src/core/ngx_resolver.c" 3 4
                       ((void *)0)
# 972 "project/nginx/src/core/ngx_resolver.c"
                           ) {
                ngx_resolver_free(r, ctx);
                return 
# 974 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 974 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }
            ...
            ctx->state = 
# 982 "project/nginx/src/core/ngx_resolver.c" 3 4
                        0
# 982 "project/nginx/src/core/ngx_resolver.c"
                              ;
            ctx->valid = rn->valid;
            ...
            return 
# 989 "project/nginx/src/core/ngx_resolver.c" 3 4
                  0
# 989 "project/nginx/src/core/ngx_resolver.c"
                        ;
        }

        if (rn->waiting) {
            if (ngx_resolver_set_timeout(r, ctx) != 
# 993 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                   0
# 993 "project/nginx/src/core/ngx_resolver.c"
                                                         ) {
                return 
# 994 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 994 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }
            ...
            rn->waiting = ctx;
            ctx->state = 
# 999 "project/nginx/src/core/ngx_resolver.c" 3 4
                        -2
# 999 "project/nginx/src/core/ngx_resolver.c"
                                 ;
            ctx->async = 1;
            ctx->node = rn;
            ...
            return 
# 1005 "project/nginx/src/core/ngx_resolver.c" 3 4
                  0
# 1005 "project/nginx/src/core/ngx_resolver.c"
                        ;
        }

        
# 1008 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 1008 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 1008 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 1008 "project/nginx/src/core/ngx_resolver.c"
...
# 1008 "project/nginx/src/core/ngx_resolver.c"
        ...
        ngx_resolver_free(r, rn->query);
        rn->query = 
# 1011 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 1011 "project/nginx/src/core/ngx_resolver.c"
                       ;

        rn->query6 = 
# 1013 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 1013 "project/nginx/src/core/ngx_resolver.c"
                        ;
        ...
        rn = ngx_resolver_alloc(r, sizeof(ngx_resolver_node_t));
        if (rn == 
# 1018 "project/nginx/src/core/ngx_resolver.c" 3 4
                 ((void *)0)
# 1018 "project/nginx/src/core/ngx_resolver.c"
                     ) {
            goto failed;
        }
        ...
        case 
# 1025 "project/nginx/src/core/ngx_resolver.c" 3 4
            30
# 1025 "project/nginx/src/core/ngx_resolver.c"
                    :
        ...
        rn->query = 
# 1035 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 1035 "project/nginx/src/core/ngx_resolver.c"
                       ;

        rn->query6 = 
# 1037 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 1037 "project/nginx/src/core/ngx_resolver.c"
                        ;
    ...
    if (ngx_resolver_create_addr_query(r, rn, &ctx->addr) != 
# 1043 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                            0
# 1043 "project/nginx/src/core/ngx_resolver.c"
                                                                  ) {
        goto failed;
    }
    ...
    if (ngx_resolver_send_query(r, rn) != 
# 1060 "project/nginx/src/core/ngx_resolver.c" 3 4
                                         0
# 1060 "project/nginx/src/core/ngx_resolver.c"
                                               ) {
    ...
    if (ngx_resolver_set_timeout(r, ctx) != 
# 1072 "project/nginx/src/core/ngx_resolver.c" 3 4
                                           0
# 1072 "project/nginx/src/core/ngx_resolver.c"
                                                 ) {
        goto failed;
    }
...
# 1077 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_add_timer
# 1077 "project/nginx/src/core/ngx_resolver.c"
                    (r->event, (ngx_msec_t) (r->resend_timeout * 1000));
    }

    rn->expire = 
# 1080 "project/nginx/src/core/ngx_resolver.c" 3 4
                ngx_cached_time->sec 
# 1080 "project/nginx/src/core/ngx_resolver.c"
                           + r->resend_timeout;

    
# 1082 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 1082 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue
# 1082 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->next = (
# 1082 "project/nginx/src/core/ngx_resolver.c"
...
# 1082 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue;
    ...
    rn->cnlen = 0;
    rn->name = 
# 1086 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 1086 "project/nginx/src/core/ngx_resolver.c"
                  ;
    rn->nlen = 0;
    rn->valid = 0;
    rn->ttl = 
# 1089 "project/nginx/src/core/ngx_resolver.c" 3 4
             (uint32_t) 0xffffffff
# 1089 "project/nginx/src/core/ngx_resolver.c"
                                 ;
    rn->waiting = ctx;
    ...
    ctx->state = 
# 1094 "project/nginx/src/core/ngx_resolver.c" 3 4
                -2
# 1094 "project/nginx/src/core/ngx_resolver.c"
                         ;
    ctx->async = 1;
    ctx->node = rn;

    return 
# 1098 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 1098 "project/nginx/src/core/ngx_resolver.c"
                ;
...
failed:
    ...
    return 
# 1120 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 1120 "project/nginx/src/core/ngx_resolver.c"
                   ;
}
...
ngx_resolve_addr_done(ngx_resolver_ctx_t *ctx)
{
    ...
    case 
# 1138 "project/nginx/src/core/ngx_resolver.c" 3 4
        30
# 1138 "project/nginx/src/core/ngx_resolver.c"
                :
        tree = &r->addr6_rbtree;
        expire_queue = &r->addr6_expire_queue;
        break;
...
# 1153 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_del_timer
# 1153 "project/nginx/src/core/ngx_resolver.c"
                    (ctx->event);
    }
    ...
    if (ctx->state == 
# 1158 "project/nginx/src/core/ngx_resolver.c" 3 4
                     -2 
# 1158 "project/nginx/src/core/ngx_resolver.c"
                               || ctx->state == 
# 1158 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                60
# 1158 "project/nginx/src/core/ngx_resolver.c"
        ...
        {
            u_char text[
# 1179 "project/nginx/src/core/ngx_resolver.c" 3 4
                           (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 1179 "project/nginx/src/core/ngx_resolver.c"
                                              ];
            ngx_str_t addrtext;
            ...
            addrtext.len = ngx_sock_ntop(ctx->addr.sockaddr, ctx->addr.socklen,
                                         text, 
# 1184 "project/nginx/src/core/ngx_resolver.c" 3 4
                                              (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 1184 "project/nginx/src/core/ngx_resolver.c"
                                                                 , 0);

            
# 1186 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 1186 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 1186 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 1186 "project/nginx/src/core/ngx_resolver.c"
...
# 1186 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 1186 "project/nginx/src/core/ngx_resolver.c"
           0, "could not cancel %V resolving", &addrtext
# 1186 "project/nginx/src/core/ngx_resolver.c" 3 4
           )
                                                                     
# 1187 "project/nginx/src/core/ngx_resolver.c"
                                                                    ;
        }
    }
...
# 1208 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_del_timer
# 1208 "project/nginx/src/core/ngx_resolver.c"
                    (r->event);
    }
}
...
ngx_resolver_expire(ngx_resolver_t *r, ngx_rbtree_t *tree, ngx_queue_t *queue)
{
    ...
    now = 
# 1223 "project/nginx/src/core/ngx_resolver.c" 3 4
         ngx_cached_time->sec
# 1223 "project/nginx/src/core/ngx_resolver.c"
                   ;

    for (i = 0; i < 2; i++) {
        if (
# 1226 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 1226 "project/nginx/src/core/ngx_resolver.c"
           queue 
# 1226 "project/nginx/src/core/ngx_resolver.c" 3 4
           == (
# 1226 "project/nginx/src/core/ngx_resolver.c"
...
# 1226 "project/nginx/src/core/ngx_resolver.c"
        ...
        q = 
# 1230 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 1230 "project/nginx/src/core/ngx_resolver.c"
           queue
# 1230 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->prev
# 1230 "project/nginx/src/core/ngx_resolver.c"
        ...
        rn = 
# 1232 "project/nginx/src/core/ngx_resolver.c" 3 4
            (
# 1232 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t 
# 1232 "project/nginx/src/core/ngx_resolver.c" 3 4
            *) ((u_char *) 
# 1232 "project/nginx/src/core/ngx_resolver.c"
...
# 1241 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 1241 "project/nginx/src/core/ngx_resolver.c"
       q
# 1241 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 1241 "project/nginx/src/core/ngx_resolver.c"
...
ngx_resolver_send_query(ngx_resolver_t *r, ngx_resolver_node_t *rn)
{
    ...
    if (rec->log.handler == 
# 1259 "project/nginx/src/core/ngx_resolver.c" 3 4
                           ((void *)0)
# 1259 "project/nginx/src/core/ngx_resolver.c"
                               ) {
        rec->log = *r->log;
    ...
    if (rn->naddrs == (u_short) -1) {
        ...
        if (rc != 
# 1270 "project/nginx/src/core/ngx_resolver.c" 3 4
                 0
# 1270 "project/nginx/src/core/ngx_resolver.c"
                       ) {
            return rc;
        }
    }
    ...
    if (rn->query6 && rn->naddrs6 == (u_short) -1) {
        ...
        if (rc != 
# 1282 "project/nginx/src/core/ngx_resolver.c" 3 4
                 0
# 1282 "project/nginx/src/core/ngx_resolver.c"
                       ) {
            return rc;
        }
    }
    ...
    return 
# 1289 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 1289 "project/nginx/src/core/ngx_resolver.c"
                ;
}
    ...
    u_char *query, u_short qlen)
{
    ...
    if (rec->udp == 
# 1299 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 1299 "project/nginx/src/core/ngx_resolver.c"
                       ) {
        if (ngx_udp_connect(rec) != 
# 1300 "project/nginx/src/core/ngx_resolver.c" 3 4
                                   0
# 1300 "project/nginx/src/core/ngx_resolver.c"
                                         ) {
            return 
# 1301 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -1
# 1301 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }
    ...
    n = 
# 1309 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_io.send
# 1309 "project/nginx/src/core/ngx_resolver.c"
               (rec->udp, query, qlen);

    if (n == 
# 1311 "project/nginx/src/core/ngx_resolver.c" 3 4
            -1
# 1311 "project/nginx/src/core/ngx_resolver.c"
                     ) {
        goto failed;
    }
...
# 1316 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1316 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 1316 "project/nginx/src/core/ngx_resolver.c" 3 4
...
# 1316 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 1320 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 1320 "project/nginx/src/core/ngx_resolver.c"
                ;
...
failed:
    ...
    rec->udp = 
# 1325 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 1325 "project/nginx/src/core/ngx_resolver.c"
                  ;

    return 
# 1327 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 1327 "project/nginx/src/core/ngx_resolver.c"
                   ;
}
    ...
    u_char *query, u_short qlen)
{
    ...
    rc = 
# 1338 "project/nginx/src/core/ngx_resolver.c" 3 4
        0
# 1338 "project/nginx/src/core/ngx_resolver.c"
              ;

    if (rec->tcp == 
# 1340 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 1340 "project/nginx/src/core/ngx_resolver.c"
                       ) {
        b = rec->read_buf;

        if (b == 
# 1343 "project/nginx/src/core/ngx_resolver.c" 3 4
                ((void *)0)
# 1343 "project/nginx/src/core/ngx_resolver.c"
                    ) {
            b = ngx_resolver_calloc(r, sizeof(ngx_buf_t));
            if (b == 
# 1345 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 1345 "project/nginx/src/core/ngx_resolver.c"
                        ) {
                return 
# 1346 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 1346 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }

            b->start = ngx_resolver_alloc(r, (2 + 65535));
            if (b->start == 
# 1350 "project/nginx/src/core/ngx_resolver.c" 3 4
                           ((void *)0)
# 1350 "project/nginx/src/core/ngx_resolver.c"
                               ) {
                ngx_resolver_free(r, b);
                return 
# 1352 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 1352 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }

            b->end = b->start + (2 + 65535);
        ...
        if (b == 
# 1365 "project/nginx/src/core/ngx_resolver.c" 3 4
                ((void *)0)
# 1365 "project/nginx/src/core/ngx_resolver.c"
                    ) {
            b = ngx_resolver_calloc(r, sizeof(ngx_buf_t));
            if (b == 
# 1367 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 1367 "project/nginx/src/core/ngx_resolver.c"
                        ) {
                return 
# 1368 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 1368 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }

            b->start = ngx_resolver_alloc(r, 8192);
            if (b->start == 
# 1372 "project/nginx/src/core/ngx_resolver.c" 3 4
                           ((void *)0)
# 1372 "project/nginx/src/core/ngx_resolver.c"
                               ) {
                ngx_resolver_free(r, b);
                return 
# 1374 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -1
# 1374 "project/nginx/src/core/ngx_resolver.c"
                               ;
            }
        ...
        if (rc == 
# 1386 "project/nginx/src/core/ngx_resolver.c" 3 4
                 -1
# 1386 "project/nginx/src/core/ngx_resolver.c"
                          ) {
            return 
# 1387 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -1
# 1387 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }
...
# 1395 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_add_timer
# 1395 "project/nginx/src/core/ngx_resolver.c"
                    (rec->tcp->write, (ngx_msec_t) (r->tcp_timeout * 1000));
    }
...
# 1401 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1401 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 1401 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 1401 "project/nginx/src/core/ngx_resolver.c"
...
# 1401 "project/nginx/src/core/ngx_resolver.c"
                                                                   ;
        return 
# 1402 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 1402 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    *b->last++ = (u_char) qlen;
    b->last = 
# 1407 "project/nginx/src/core/ngx_resolver.c" 3 4
             (((u_char *) __builtin___memcpy_chk (
# 1407 "project/nginx/src/core/ngx_resolver.c"
             b->last
# 1407 "project/nginx/src/core/ngx_resolver.c" 3 4
             , 
# 1407 "project/nginx/src/core/ngx_resolver.c"
...
# 1407 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (rc == 
# 1409 "project/nginx/src/core/ngx_resolver.c" 3 4
             0
# 1409 "project/nginx/src/core/ngx_resolver.c"
                   ) {
        ngx_resolver_tcp_write(rec->tcp->write);
    }

    return 
# 1413 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 1413 "project/nginx/src/core/ngx_resolver.c"
                ;
}
...
ngx_resolver_resend_handler(ngx_event_t *ev)
{
    ...
    if (timer == 0) {
        ...
        timer = 
# 1461 "project/nginx/src/core/ngx_resolver.c" 3 4
               ((
# 1461 "project/nginx/src/core/ngx_resolver.c"
               timer 
# 1461 "project/nginx/src/core/ngx_resolver.c" 3 4
               > 
# 1461 "project/nginx/src/core/ngx_resolver.c"
...
# 1461 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (timer == 0) {
        ...
        timer = 
# 1468 "project/nginx/src/core/ngx_resolver.c" 3 4
               ((
# 1468 "project/nginx/src/core/ngx_resolver.c"
               timer 
# 1468 "project/nginx/src/core/ngx_resolver.c" 3 4
               > 
# 1468 "project/nginx/src/core/ngx_resolver.c"
...
# 1468 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (timer == 0) {
        ...
        timer = 
# 1477 "project/nginx/src/core/ngx_resolver.c" 3 4
               ((
# 1477 "project/nginx/src/core/ngx_resolver.c"
               timer 
# 1477 "project/nginx/src/core/ngx_resolver.c" 3 4
               > 
# 1477 "project/nginx/src/core/ngx_resolver.c"
...
# 1483 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_add_timer
# 1483 "project/nginx/src/core/ngx_resolver.c"
                    (r->event, (ngx_msec_t) (timer * 1000));
    }
}
...
ngx_resolver_resend(ngx_resolver_t *r, ngx_rbtree_t *tree, ngx_queue_t *queue)
{
    ...
    now = 
# 1495 "project/nginx/src/core/ngx_resolver.c" 3 4
         ngx_cached_time->sec
# 1495 "project/nginx/src/core/ngx_resolver.c"
                   ;

    for ( ;; ) {
        if (
# 1498 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 1498 "project/nginx/src/core/ngx_resolver.c"
           queue 
# 1498 "project/nginx/src/core/ngx_resolver.c" 3 4
           == (
# 1498 "project/nginx/src/core/ngx_resolver.c"
...
# 1498 "project/nginx/src/core/ngx_resolver.c"
        ...
        q = 
# 1502 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 1502 "project/nginx/src/core/ngx_resolver.c"
           queue
# 1502 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->prev
# 1502 "project/nginx/src/core/ngx_resolver.c"
        ...
        rn = 
# 1504 "project/nginx/src/core/ngx_resolver.c" 3 4
            (
# 1504 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t 
# 1504 "project/nginx/src/core/ngx_resolver.c" 3 4
            *) ((u_char *) 
# 1504 "project/nginx/src/core/ngx_resolver.c"
...
# 1514 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 1514 "project/nginx/src/core/ngx_resolver.c"
       q
# 1514 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 1514 "project/nginx/src/core/ngx_resolver.c"
...
# 1526 "project/nginx/src/core/ngx_resolver.c" 3 4
           (
# 1526 "project/nginx/src/core/ngx_resolver.c"
           q
# 1526 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->next = (
# 1526 "project/nginx/src/core/ngx_resolver.c"
...
{
    return 
# 1541 "project/nginx/src/core/ngx_resolver.c" 3 4
          (
# 1541 "project/nginx/src/core/ngx_resolver.c"
          &r->name_resend_queue 
# 1541 "project/nginx/src/core/ngx_resolver.c" 3 4
          == (
# 1541 "project/nginx/src/core/ngx_resolver.c"
...
# 1542 "project/nginx/src/core/ngx_resolver.c"
          && 
# 1542 "project/nginx/src/core/ngx_resolver.c" 3 4
             (
# 1542 "project/nginx/src/core/ngx_resolver.c"
             &r->srv_resend_queue 
# 1542 "project/nginx/src/core/ngx_resolver.c" 3 4
...
# 1544 "project/nginx/src/core/ngx_resolver.c"
          && 
# 1544 "project/nginx/src/core/ngx_resolver.c" 3 4
             (
# 1544 "project/nginx/src/core/ngx_resolver.c"
             &r->addr6_resend_queue 
# 1544 "project/nginx/src/core/ngx_resolver.c" 3 4
...
# 1546 "project/nginx/src/core/ngx_resolver.c"
          && 
# 1546 "project/nginx/src/core/ngx_resolver.c" 3 4
             (
# 1546 "project/nginx/src/core/ngx_resolver.c"
             &r->addr_resend_queue 
# 1546 "project/nginx/src/core/ngx_resolver.c" 3 4
...
ngx_resolver_udp_read(ngx_event_t *rev)
{
    ...
    do {
        n = 
# 1562 "project/nginx/src/core/ngx_resolver.c" 3 4
           ngx_io.udp_recv
# 1562 "project/nginx/src/core/ngx_resolver.c"
                       (c, buf, 4096);

        if (n == 
# 1564 "project/nginx/src/core/ngx_resolver.c" 3 4
                -2
# 1564 "project/nginx/src/core/ngx_resolver.c"
                         ) {
            break;
        }

        if (n == 
# 1568 "project/nginx/src/core/ngx_resolver.c" 3 4
                -1
# 1568 "project/nginx/src/core/ngx_resolver.c"
                         ) {
            goto failed;
        }
...
# 1576 "project/nginx/src/core/ngx_resolver.c" 3 4
                                        0
# 1576 "project/nginx/src/core/ngx_resolver.c"
                                              ) {
        goto failed;
    }
...
failed:
    ...
    ngx_close_connection(rec->udp);
    rec->udp = 
# 1585 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 1585 "project/nginx/src/core/ngx_resolver.c"
                  ;
}
...
ngx_resolver_tcp_write(ngx_event_t *wev)
{
    ...
    while (wev->ready && b->pos < b->last) {
        n = 
# 1611 "project/nginx/src/core/ngx_resolver.c" 3 4
           ngx_io.send
# 1611 "project/nginx/src/core/ngx_resolver.c"
                   (c, b->pos, b->last - b->pos);

        if (n == 
# 1613 "project/nginx/src/core/ngx_resolver.c" 3 4
                -2
# 1613 "project/nginx/src/core/ngx_resolver.c"
                         ) {
            break;
        }

        if (n == 
# 1617 "project/nginx/src/core/ngx_resolver.c" 3 4
                -1
# 1617 "project/nginx/src/core/ngx_resolver.c"
                         ) {
            goto failed;
        }
    ...
    if (b->pos != b->start) {
        b->last = 
# 1625 "project/nginx/src/core/ngx_resolver.c" 3 4
                 (((u_char *) __builtin___memmove_chk (
# 1625 "project/nginx/src/core/ngx_resolver.c"
                 b->start
# 1625 "project/nginx/src/core/ngx_resolver.c" 3 4
                 , 
# 1625 "project/nginx/src/core/ngx_resolver.c"
...
# 1630 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_add_timer
# 1630 "project/nginx/src/core/ngx_resolver.c"
                    (wev, (ngx_msec_t) (r->tcp_timeout * 1000));
    }

    if (ngx_handle_write_event(wev, 0) != 
# 1633 "project/nginx/src/core/ngx_resolver.c" 3 4
                                         0
# 1633 "project/nginx/src/core/ngx_resolver.c"
                                               ) {
        goto failed;
    }
...
failed:
    ...
    rec->tcp = 
# 1642 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 1642 "project/nginx/src/core/ngx_resolver.c"
                  ;
}
...
ngx_resolver_tcp_read(ngx_event_t *rev)
{
    ...
    while (rev->ready) {
        n = 
# 1664 "project/nginx/src/core/ngx_resolver.c" 3 4
           ngx_io.recv
# 1664 "project/nginx/src/core/ngx_resolver.c"
                   (c, b->last, b->end - b->last);

        if (n == 
# 1666 "project/nginx/src/core/ngx_resolver.c" 3 4
                -2
# 1666 "project/nginx/src/core/ngx_resolver.c"
                         ) {
            break;
        }

        if (n == 
# 1670 "project/nginx/src/core/ngx_resolver.c" 3 4
                -1 
# 1670 "project/nginx/src/core/ngx_resolver.c"
                          || n == 0) {
            goto failed;
        }
        ...
        if (b->pos != b->start) {
            b->last = 
# 1697 "project/nginx/src/core/ngx_resolver.c" 3 4
                     (((u_char *) __builtin___memmove_chk (
# 1697 "project/nginx/src/core/ngx_resolver.c"
                     b->start
# 1697 "project/nginx/src/core/ngx_resolver.c" 3 4
                     , 
# 1697 "project/nginx/src/core/ngx_resolver.c"
...
# 1697 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (ngx_handle_read_event(rev, 0) != 
# 1702 "project/nginx/src/core/ngx_resolver.c" 3 4
                                        0
# 1702 "project/nginx/src/core/ngx_resolver.c"
                                              ) {
        goto failed;
    }
...
failed:
    ...
    ngx_close_connection(c);
    rec->tcp = 
# 1711 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 1711 "project/nginx/src/core/ngx_resolver.c"
                  ;
}
...
# 1750 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1750 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 1750 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 1750 "project/nginx/src/core/ngx_resolver.c"
...
# 1750 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 1750 "project/nginx/src/core/ngx_resolver.c"
       0, "invalid %s DNS response %ui fl:%04Xi", tcp ? "TCP" : "UDP", ident, flags
# 1750 "project/nginx/src/core/ngx_resolver.c" 3 4
       )

                                                        
# 1752 "project/nginx/src/core/ngx_resolver.c"
                                                       ;
        return;
    }
    ...
    if (code == 
# 1758 "project/nginx/src/core/ngx_resolver.c" 3 4
               1
# 1758 "project/nginx/src/core/ngx_resolver.c"
                                  ) {

        times = 0;

        for (q = 
# 1762 "project/nginx/src/core/ngx_resolver.c" 3 4
                (
# 1762 "project/nginx/src/core/ngx_resolver.c"
                &r->name_resend_queue
# 1762 "project/nginx/src/core/ngx_resolver.c" 3 4
                )->next
# 1762 "project/nginx/src/core/ngx_resolver.c"
                                                     ;
             q != 
# 1763 "project/nginx/src/core/ngx_resolver.c" 3 4
                 (
# 1763 "project/nginx/src/core/ngx_resolver.c"
                 &r->name_resend_queue
# 1763 "project/nginx/src/core/ngx_resolver.c" 3 4
                 ) 
# 1763 "project/nginx/src/core/ngx_resolver.c"
                                                           && times++ < 100;
             q = 
# 1764 "project/nginx/src/core/ngx_resolver.c" 3 4
                (
# 1764 "project/nginx/src/core/ngx_resolver.c"
                q
# 1764 "project/nginx/src/core/ngx_resolver.c" 3 4
                )->next
# 1764 "project/nginx/src/core/ngx_resolver.c"
        ...
        {
            rn = 
# 1766 "project/nginx/src/core/ngx_resolver.c" 3 4
                (
# 1766 "project/nginx/src/core/ngx_resolver.c"
                ngx_resolver_node_t 
# 1766 "project/nginx/src/core/ngx_resolver.c" 3 4
                *) ((u_char *) 
# 1766 "project/nginx/src/core/ngx_resolver.c"
...
# 1766 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (code > 
# 1787 "project/nginx/src/core/ngx_resolver.c" 3 4
              5
# 1787 "project/nginx/src/core/ngx_resolver.c"
                                 ) {
        goto dns_error;
    }
...
# 1836 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1836 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 1836 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 1836 "project/nginx/src/core/ngx_resolver.c"
...
# 1836 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 1836 "project/nginx/src/core/ngx_resolver.c"
       0, "unknown query class %ui in DNS response", qclass
# 1836 "project/nginx/src/core/ngx_resolver.c" 3 4
       )
                                                                        
# 1837 "project/nginx/src/core/ngx_resolver.c"
                                                                       ;
        return;
    }
    ...
    case 
# 1843 "project/nginx/src/core/ngx_resolver.c" 3 4
        1
# 1843 "project/nginx/src/core/ngx_resolver.c"
                     :

    case 
# 1845 "project/nginx/src/core/ngx_resolver.c" 3 4
        28
# 1845 "project/nginx/src/core/ngx_resolver.c"
                        :
    ...
    case 
# 1853 "project/nginx/src/core/ngx_resolver.c" 3 4
        33
# 1853 "project/nginx/src/core/ngx_resolver.c"
                       :
    ...
    case 
# 1860 "project/nginx/src/core/ngx_resolver.c" 3 4
        12
# 1860 "project/nginx/src/core/ngx_resolver.c"
                       :
...
# 1867 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1867 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 1867 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 1867 "project/nginx/src/core/ngx_resolver.c"
...
# 1867 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 1867 "project/nginx/src/core/ngx_resolver.c"
       0, "unknown query type %ui in DNS response", qtype
# 1867 "project/nginx/src/core/ngx_resolver.c" 3 4
       )
                                                                      
# 1868 "project/nginx/src/core/ngx_resolver.c"
                                                                     ;
        return;
    }
...
# 1880 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 1880 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 1880 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 1880 "project/nginx/src/core/ngx_resolver.c"
...
# 1886 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 1886 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 1886 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 1886 "project/nginx/src/core/ngx_resolver.c"
...
# 1886 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 1886 "project/nginx/src/core/ngx_resolver.c"
   0, "DNS error (%ui: %s), query id:%ui, name:\"%*s\"", code, ngx_resolver_strerror(code), ident, (size_t) rn->nlen, rn->name
# 1886 "project/nginx/src/core/ngx_resolver.c" 3 4
   )


                                              
# 1889 "project/nginx/src/core/ngx_resolver.c"
                                             ;
    return;
...
# 1894 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 1894 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 1894 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 1894 "project/nginx/src/core/ngx_resolver.c"
...
# 1894 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 1894 "project/nginx/src/core/ngx_resolver.c"
   0, "DNS error (%ui: %s), query id:%ui", code, ngx_resolver_strerror(code), ident
# 1894 "project/nginx/src/core/ngx_resolver.c" 3 4
   )

                                                           
# 1896 "project/nginx/src/core/ngx_resolver.c"
                                                          ;
    return;
}
    ...
    ngx_uint_t nan, ngx_uint_t trunc, ngx_uint_t ans)
{
    ...
    if (ngx_resolver_copy(r, &name, buf,
        ...
        != 
# 1925 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 1925 "project/nginx/src/core/ngx_resolver.c"
                )
    {
        return;
    }
    ...
    if (rn == 
# 1938 "project/nginx/src/core/ngx_resolver.c" 3 4
             ((void *)0)
# 1938 "project/nginx/src/core/ngx_resolver.c"
                 ) {
        
# 1939 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1939 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 1939 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 1939 "project/nginx/src/core/ngx_resolver.c"
...
# 1939 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 1939 "project/nginx/src/core/ngx_resolver.c"
       0, "unexpected DNS response for %V", &name
# 1939 "project/nginx/src/core/ngx_resolver.c" 3 4
       )
                                                              
# 1940 "project/nginx/src/core/ngx_resolver.c"
                                                             ;
        ngx_resolver_free(r, name.data);
        goto failed;
    }
    ...
    case 
# 1948 "project/nginx/src/core/ngx_resolver.c" 3 4
        28
# 1948 "project/nginx/src/core/ngx_resolver.c"
                        :

        if (rn->query6 == 
# 1950 "project/nginx/src/core/ngx_resolver.c" 3 4
                         ((void *)0) 
# 1950 "project/nginx/src/core/ngx_resolver.c"
                              || rn->naddrs6 != (u_short) -1) {
            
# 1951 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 1951 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 1951 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 1951 "project/nginx/src/core/ngx_resolver.c"
...
# 1952 "project/nginx/src/core/ngx_resolver.c"
                                                                 ;
            ngx_resolver_free(r, name.data);
            goto failed;
        }
    ...
    default:
        ...
        if (rn->query == 
# 1969 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ((void *)0) 
# 1969 "project/nginx/src/core/ngx_resolver.c"
                             || rn->naddrs != (u_short) -1) {
            
# 1970 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 1970 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 1970 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 1970 "project/nginx/src/core/ngx_resolver.c"
...
# 1971 "project/nginx/src/core/ngx_resolver.c"
                                                                 ;
            ngx_resolver_free(r, name.data);
            goto failed;
        }
...
# 1985 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 1985 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 1985 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 1985 "project/nginx/src/core/ngx_resolver.c"
...
# 1985 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 1985 "project/nginx/src/core/ngx_resolver.c"
       0, "wrong ident %ui in DNS response for %V, expect %ui", ident, &name, qident
# 1985 "project/nginx/src/core/ngx_resolver.c" 3 4
       )

                                           
# 1987 "project/nginx/src/core/ngx_resolver.c"
                                          ;
        ngx_resolver_free(r, name.data);
        goto failed;
    }
...
# 1996 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 1996 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 1996 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 1996 "project/nginx/src/core/ngx_resolver.c"
...
# 1996 "project/nginx/src/core/ngx_resolver.c"
        ...
        if (rn->waiting == 
# 1998 "project/nginx/src/core/ngx_resolver.c" 3 4
                          ((void *)0)
# 1998 "project/nginx/src/core/ngx_resolver.c"
                              ) {
        ...
        case 
# 2010 "project/nginx/src/core/ngx_resolver.c" 3 4
            28
# 2010 "project/nginx/src/core/ngx_resolver.c"
                            :
        ...
        rn->expire = 
# 2026 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 2026 "project/nginx/src/core/ngx_resolver.c"
                               + r->resend_timeout;

        
# 2028 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2028 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2028 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next = (
# 2028 "project/nginx/src/core/ngx_resolver.c"
...
# 2028 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (code == 0 && nan == 0) {
        ...
        case 
# 2042 "project/nginx/src/core/ngx_resolver.c" 3 4
            28
# 2042 "project/nginx/src/core/ngx_resolver.c"
                            :
        ...
        code = 
# 2070 "project/nginx/src/core/ngx_resolver.c" 3 4
              3
# 2070 "project/nginx/src/core/ngx_resolver.c"
                                  ;
    }
    ...
    if (code) {
        ...
        case 
# 2078 "project/nginx/src/core/ngx_resolver.c" 3 4
            28
# 2078 "project/nginx/src/core/ngx_resolver.c"
                            :
        ...
        next = rn->waiting;
        rn->waiting = 
# 2101 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 2101 "project/nginx/src/core/ngx_resolver.c"
                         ;

        
# 2103 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2103 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2103 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2103 "project/nginx/src/core/ngx_resolver.c"
...
# 2103 "project/nginx/src/core/ngx_resolver.c"
        ...
        while (next) {
            ...
            ctx->state = code;
            ctx->valid = 
# 2112 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec 
# 2112 "project/nginx/src/core/ngx_resolver.c"
                                   + (r->valid ? r->valid : 10);
            next = ctx->next;
    ...
    naddrs = 0;
    cname = 
# 2125 "project/nginx/src/core/ngx_resolver.c" 3 4
           ((void *)0)
# 2125 "project/nginx/src/core/ngx_resolver.c"
               ;
...
# 2170 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 2170 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 2170 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 2170 "project/nginx/src/core/ngx_resolver.c"
...
# 2170 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 2170 "project/nginx/src/core/ngx_resolver.c"
           0, "unexpected RR class %ui in DNS response", class
# 2170 "project/nginx/src/core/ngx_resolver.c" 3 4
           )
                                                                           
# 2171 "project/nginx/src/core/ngx_resolver.c"
                                                                          ;
            goto failed;
        }
        ...
        rn->ttl = 
# 2179 "project/nginx/src/core/ngx_resolver.c" 3 4
                 ((
# 2179 "project/nginx/src/core/ngx_resolver.c"
                 rn->ttl 
# 2179 "project/nginx/src/core/ngx_resolver.c" 3 4
                 > 
# 2179 "project/nginx/src/core/ngx_resolver.c"
...
# 2179 "project/nginx/src/core/ngx_resolver.c"
        ...
        case 
# 2185 "project/nginx/src/core/ngx_resolver.c" 3 4
            1
# 2185 "project/nginx/src/core/ngx_resolver.c"
                         :

            if (qtype != 
# 2187 "project/nginx/src/core/ngx_resolver.c" 3 4
                        1
# 2187 "project/nginx/src/core/ngx_resolver.c"
                                     ) {
        ...
        case 
# 2206 "project/nginx/src/core/ngx_resolver.c" 3 4
            28
# 2206 "project/nginx/src/core/ngx_resolver.c"
                            :

            if (qtype != 
# 2208 "project/nginx/src/core/ngx_resolver.c" 3 4
                        28
# 2208 "project/nginx/src/core/ngx_resolver.c"
                                        ) {
        ...
        case 
# 2227 "project/nginx/src/core/ngx_resolver.c" 3 4
            5
# 2227 "project/nginx/src/core/ngx_resolver.c"
                             :
        ...
        case 
# 2233 "project/nginx/src/core/ngx_resolver.c" 3 4
            39
# 2233 "project/nginx/src/core/ngx_resolver.c"
                             :
...
# 2239 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 2239 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 2239 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 2239 "project/nginx/src/core/ngx_resolver.c"
...
# 2239 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 2239 "project/nginx/src/core/ngx_resolver.c"
           0, "unexpected RR type %ui in DNS response", type
# 2239 "project/nginx/src/core/ngx_resolver.c" 3 4
           )
                                                                         
# 2240 "project/nginx/src/core/ngx_resolver.c"
                                                                        ;
        }
    ...
    if (naddrs) {
        ...
        case 
# 2255 "project/nginx/src/core/ngx_resolver.c" 3 4
            28
# 2255 "project/nginx/src/core/ngx_resolver.c"
                            :
            ...
            if (naddrs == 1) {
                ...
                if (addr6 == 
# 2263 "project/nginx/src/core/ngx_resolver.c" 3 4
                            ((void *)0)
# 2263 "project/nginx/src/core/ngx_resolver.c"
                                ) {
                    goto failed;
                }
            ...
            addr = 
# 2272 "project/nginx/src/core/ngx_resolver.c" 3 4
                  ((void *)0)
# 2272 "project/nginx/src/core/ngx_resolver.c"
                      ;
        ...
        default:
            ...
            if (naddrs == 1) {
                ...
                if (addr == 
# 2286 "project/nginx/src/core/ngx_resolver.c" 3 4
                           ((void *)0)
# 2286 "project/nginx/src/core/ngx_resolver.c"
                               ) {
                    goto failed;
                }
            ...
            addr6 = 
# 2295 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2295 "project/nginx/src/core/ngx_resolver.c"
                       ;
        ...
        for (a = 0; a < nan; a++) {
            ...
            if (type == 
# 2326 "project/nginx/src/core/ngx_resolver.c" 3 4
                       1
# 2326 "project/nginx/src/core/ngx_resolver.c"
                                    ) {

                addr[j] = 
# 2328 "project/nginx/src/core/ngx_resolver.c" 3 4
                         (__builtin_constant_p(
# 2328 "project/nginx/src/core/ngx_resolver.c"
...
# 2329 "project/nginx/src/core/ngx_resolver.c"
                                                                  ;
...
# 2344 "project/nginx/src/core/ngx_resolver.c" 3 4
                            28
# 2344 "project/nginx/src/core/ngx_resolver.c"
                                            ) {

                
# 2346 "project/nginx/src/core/ngx_resolver.c" 3 4
               (void) __builtin___memcpy_chk (
# 2346 "project/nginx/src/core/ngx_resolver.c"
               addr6[j].
# 2346 "project/nginx/src/core/ngx_resolver.c" 3 4
               __u6_addr.__u6_addr8, 
# 2346 "project/nginx/src/core/ngx_resolver.c"
...
# 2346 "project/nginx/src/core/ngx_resolver.c"
    ...
    case 
# 2366 "project/nginx/src/core/ngx_resolver.c" 3 4
        28
# 2366 "project/nginx/src/core/ngx_resolver.c"
                        :
    ...
    export:
        ...
        if (naddrs == 1 && rn->naddrs == 1) {
            addrs = 
# 2403 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2403 "project/nginx/src/core/ngx_resolver.c"
                       ;

        } else {
            addrs = ngx_resolver_export(r, rn, 0);
            if (addrs == 
# 2407 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ((void *)0)
# 2407 "project/nginx/src/core/ngx_resolver.c"
                            ) {
                goto failed;
            }
        }
...
# 2412 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2412 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2412 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2412 "project/nginx/src/core/ngx_resolver.c"
...
# 2412 "project/nginx/src/core/ngx_resolver.c"
        ...
        rn->valid = 
# 2414 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ngx_cached_time->sec 
# 2414 "project/nginx/src/core/ngx_resolver.c"
                              + (r->valid ? r->valid : (time_t) rn->ttl);
        rn->expire = 
# 2415 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 2415 "project/nginx/src/core/ngx_resolver.c"
                               + r->expire;

        
# 2417 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2417 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2417 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next = (
# 2417 "project/nginx/src/core/ngx_resolver.c"
...
# 2417 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue;
        ...
        next = rn->waiting;
        rn->waiting = 
# 2420 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 2420 "project/nginx/src/core/ngx_resolver.c"
                         ;
        ...
        while (next) {
            ctx = next;
            ctx->state = 
# 2426 "project/nginx/src/core/ngx_resolver.c" 3 4
                        0
# 2426 "project/nginx/src/core/ngx_resolver.c"
                              ;
            ctx->valid = rn->valid;
            ctx->naddrs = naddrs;

            if (addrs == 
# 2430 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ((void *)0)
# 2430 "project/nginx/src/core/ngx_resolver.c"
                            ) {
                ctx->addrs = &ctx->addr;
                ctx->addr.sockaddr = (struct sockaddr *) &ctx->sin;
                ctx->addr.socklen = sizeof(struct sockaddr_in);
                
# 2434 "project/nginx/src/core/ngx_resolver.c" 3 4
               (void) __builtin___memset_chk (
# 2434 "project/nginx/src/core/ngx_resolver.c"
               &ctx->sin
# 2434 "project/nginx/src/core/ngx_resolver.c" 3 4
               , 0, 
# 2434 "project/nginx/src/core/ngx_resolver.c"
...
# 2434 "project/nginx/src/core/ngx_resolver.c"
                                                                 ;
                ctx->sin.sin_family = 
# 2435 "project/nginx/src/core/ngx_resolver.c" 3 4
                                     2
# 2435 "project/nginx/src/core/ngx_resolver.c"
                                            ;
                ctx->sin.sin_addr.s_addr = rn->u.addr;
        ...
        if (addrs != 
# 2447 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 2447 "project/nginx/src/core/ngx_resolver.c"
                        ) {
            ngx_resolver_free(r, addrs->sockaddr);
            ngx_resolver_free(r, addrs);
        }
        ...
        ngx_resolver_free(r, rn->query);
        rn->query = 
# 2453 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2453 "project/nginx/src/core/ngx_resolver.c"
                       ;

        rn->query6 = 
# 2455 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 2455 "project/nginx/src/core/ngx_resolver.c"
                        ;
    ...
    if (cname) {
        ...
        if (ngx_resolver_copy(r, &name, buf, cname, buf + n) != 
# 2474 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                               0
# 2474 "project/nginx/src/core/ngx_resolver.c"
                                                                     ) {
            goto failed;
        }
...
# 2481 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2481 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2481 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2481 "project/nginx/src/core/ngx_resolver.c"
...
# 2481 "project/nginx/src/core/ngx_resolver.c"
        ...
        rn->valid = 
# 2486 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ngx_cached_time->sec 
# 2486 "project/nginx/src/core/ngx_resolver.c"
                              + (r->valid ? r->valid : (time_t) rn->ttl);
        rn->expire = 
# 2487 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 2487 "project/nginx/src/core/ngx_resolver.c"
                               + r->expire;

        
# 2489 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2489 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2489 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next = (
# 2489 "project/nginx/src/core/ngx_resolver.c"
...
# 2489 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue;
        ...
        ngx_resolver_free(r, rn->query);
        rn->query = 
# 2492 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2492 "project/nginx/src/core/ngx_resolver.c"
                       ;

        rn->query6 = 
# 2494 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 2494 "project/nginx/src/core/ngx_resolver.c"
                        ;


        ctx = rn->waiting;
        rn->waiting = 
# 2498 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 2498 "project/nginx/src/core/ngx_resolver.c"
                         ;

        if (ctx) {

            if (ctx->recursion++ >= 
# 2502 "project/nginx/src/core/ngx_resolver.c" 3 4
                                   50
# 2502 "project/nginx/src/core/ngx_resolver.c"
                                                             ) {
                ...
                do {
                    ctx->state = 
# 2507 "project/nginx/src/core/ngx_resolver.c" 3 4
                                3
# 2507 "project/nginx/src/core/ngx_resolver.c"
                                                    ;
                    next = ctx->next;
            ...
            for (next = ctx; next; next = next->next) {
                next->node = 
# 2519 "project/nginx/src/core/ngx_resolver.c" 3 4
                            ((void *)0)
# 2519 "project/nginx/src/core/ngx_resolver.c"
                                ;
            }
...
# 2530 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 2530 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 2530 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 2530 "project/nginx/src/core/ngx_resolver.c"
...
# 2530 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 2530 "project/nginx/src/core/ngx_resolver.c"
   0, "no A or CNAME types in DNS response"
# 2530 "project/nginx/src/core/ngx_resolver.c" 3 4
   )
                                                        
# 2531 "project/nginx/src/core/ngx_resolver.c"
                                                       ;
    return;
...
# 2542 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 2542 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 2542 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 2542 "project/nginx/src/core/ngx_resolver.c"
    ...
    ngx_uint_t trunc, ngx_uint_t ans)
{
    ...
    if (ngx_resolver_copy(r, &name, buf,
                          buf + sizeof(ngx_resolver_hdr_t), buf + n)
        != 
# 2576 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 2576 "project/nginx/src/core/ngx_resolver.c"
                )
    {
        return;
    }
    ...
    if (rn == 
# 2587 "project/nginx/src/core/ngx_resolver.c" 3 4
             ((void *)0) 
# 2587 "project/nginx/src/core/ngx_resolver.c"
                  || rn->query == 
# 2587 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  ((void *)0)
# 2587 "project/nginx/src/core/ngx_resolver.c"
...
# 2588 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 2588 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 2588 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 2588 "project/nginx/src/core/ngx_resolver.c"
...
# 2589 "project/nginx/src/core/ngx_resolver.c"
                                                             ;
        ngx_resolver_free(r, name.data);
        goto failed;
    }
...
# 2602 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 2602 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 2602 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 2602 "project/nginx/src/core/ngx_resolver.c"
...
# 2604 "project/nginx/src/core/ngx_resolver.c"
                                          ;
        ngx_resolver_free(r, name.data);
        goto failed;
    }
...
# 2613 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2613 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2613 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2613 "project/nginx/src/core/ngx_resolver.c"
...
# 2613 "project/nginx/src/core/ngx_resolver.c"
        ...
        if (rn->waiting == 
# 2615 "project/nginx/src/core/ngx_resolver.c" 3 4
                          ((void *)0)
# 2615 "project/nginx/src/core/ngx_resolver.c"
                              ) {
        ...
        rn->expire = 
# 2628 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 2628 "project/nginx/src/core/ngx_resolver.c"
                               + r->resend_timeout;

        
# 2630 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2630 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2630 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next = (
# 2630 "project/nginx/src/core/ngx_resolver.c"
...
# 2630 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (code == 0 && nan == 0) {
        code = 
# 2640 "project/nginx/src/core/ngx_resolver.c" 3 4
              3
# 2640 "project/nginx/src/core/ngx_resolver.c"
                                  ;
    }
    ...
    if (code) {
        next = rn->waiting;
        rn->waiting = 
# 2645 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 2645 "project/nginx/src/core/ngx_resolver.c"
                         ;

        
# 2647 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2647 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2647 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2647 "project/nginx/src/core/ngx_resolver.c"
...
# 2647 "project/nginx/src/core/ngx_resolver.c"
        ...
        while (next) {
            ...
            ctx->state = code;
            ctx->valid = 
# 2654 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec 
# 2654 "project/nginx/src/core/ngx_resolver.c"
                                   + (r->valid ? r->valid : 10);
            next = ctx->next;
    ...
    nsrvs = 0;
    cname = 
# 2667 "project/nginx/src/core/ngx_resolver.c" 3 4
           ((void *)0)
# 2667 "project/nginx/src/core/ngx_resolver.c"
               ;
...
# 2712 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 2712 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 2712 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 2712 "project/nginx/src/core/ngx_resolver.c"
...
# 2713 "project/nginx/src/core/ngx_resolver.c"
                                                                          ;
            goto failed;
        }
        ...
        rn->ttl = 
# 2721 "project/nginx/src/core/ngx_resolver.c" 3 4
                 ((
# 2721 "project/nginx/src/core/ngx_resolver.c"
                 rn->ttl 
# 2721 "project/nginx/src/core/ngx_resolver.c" 3 4
                 > 
# 2721 "project/nginx/src/core/ngx_resolver.c"
...
# 2721 "project/nginx/src/core/ngx_resolver.c"
        ...
        case 
# 2727 "project/nginx/src/core/ngx_resolver.c" 3 4
            33
# 2727 "project/nginx/src/core/ngx_resolver.c"
                           :
...
# 2733 "project/nginx/src/core/ngx_resolver.c" 3 4
                                    ((void *)0)
# 2733 "project/nginx/src/core/ngx_resolver.c"
                                        , buf, &buf[i + 6], buf + n)
                != 
# 2734 "project/nginx/src/core/ngx_resolver.c" 3 4
                  0
# 2734 "project/nginx/src/core/ngx_resolver.c"
                        )
            {
                goto failed;
            }
        ...
        case 
# 2743 "project/nginx/src/core/ngx_resolver.c" 3 4
            5
# 2743 "project/nginx/src/core/ngx_resolver.c"
                             :
        ...
        case 
# 2749 "project/nginx/src/core/ngx_resolver.c" 3 4
            39
# 2749 "project/nginx/src/core/ngx_resolver.c"
                             :
...
# 2755 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 2755 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 2755 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 2755 "project/nginx/src/core/ngx_resolver.c"
...
# 2756 "project/nginx/src/core/ngx_resolver.c"
                                                                        ;
        }
    ...
    if (nsrvs) {
        ...
        if (srvs == 
# 2769 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2769 "project/nginx/src/core/ngx_resolver.c"
                       ) {
            goto failed;
        }
        ...
        for (a = 0; a < nan; a++) {
            ...
            if (type == 
# 2803 "project/nginx/src/core/ngx_resolver.c" 3 4
                       33
# 2803 "project/nginx/src/core/ngx_resolver.c"
                                      ) {
                ...
                if (ngx_resolver_copy(r, &srvs[j].name, buf, &buf[i + 6],
                                      buf + n)
                    != 
# 2816 "project/nginx/src/core/ngx_resolver.c" 3 4
                      0
# 2816 "project/nginx/src/core/ngx_resolver.c"
                            )
                {
                    goto failed;
                }
        ...
        ngx_resolver_free(r, rn->query);
        rn->query = 
# 2831 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2831 "project/nginx/src/core/ngx_resolver.c"
                       ;

        
# 2833 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2833 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2833 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2833 "project/nginx/src/core/ngx_resolver.c"
...
# 2833 "project/nginx/src/core/ngx_resolver.c"
        ...
        rn->valid = 
# 2835 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ngx_cached_time->sec 
# 2835 "project/nginx/src/core/ngx_resolver.c"
                              + (r->valid ? r->valid : (time_t) rn->ttl);
        rn->expire = 
# 2836 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 2836 "project/nginx/src/core/ngx_resolver.c"
                               + r->expire;

        
# 2838 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2838 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2838 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next = (
# 2838 "project/nginx/src/core/ngx_resolver.c"
...
# 2838 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue;
        ...
        next = rn->waiting;
        rn->waiting = 
# 2841 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 2841 "project/nginx/src/core/ngx_resolver.c"
                         ;
    ...
    if (cname) {
        ...
        if (ngx_resolver_copy(r, &name, buf, cname, buf + n) != 
# 2859 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                               0
# 2859 "project/nginx/src/core/ngx_resolver.c"
                                                                     ) {
            goto failed;
        }
...
# 2866 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2866 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2866 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 2866 "project/nginx/src/core/ngx_resolver.c"
...
# 2866 "project/nginx/src/core/ngx_resolver.c"
        ...
        rn->valid = 
# 2871 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ngx_cached_time->sec 
# 2871 "project/nginx/src/core/ngx_resolver.c"
                              + (r->valid ? r->valid : (time_t) rn->ttl);
        rn->expire = 
# 2872 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 2872 "project/nginx/src/core/ngx_resolver.c"
                               + r->expire;

        
# 2874 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 2874 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 2874 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next = (
# 2874 "project/nginx/src/core/ngx_resolver.c"
...
# 2874 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue;
        ...
        ngx_resolver_free(r, rn->query);
        rn->query = 
# 2877 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2877 "project/nginx/src/core/ngx_resolver.c"
                       ;

        rn->query6 = 
# 2879 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 2879 "project/nginx/src/core/ngx_resolver.c"
                        ;


        ctx = rn->waiting;
        rn->waiting = 
# 2883 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 2883 "project/nginx/src/core/ngx_resolver.c"
                         ;

        if (ctx) {

            if (ctx->recursion++ >= 
# 2887 "project/nginx/src/core/ngx_resolver.c" 3 4
                                   50
# 2887 "project/nginx/src/core/ngx_resolver.c"
                                                             ) {
                ...
                do {
                    ctx->state = 
# 2892 "project/nginx/src/core/ngx_resolver.c" 3 4
                                3
# 2892 "project/nginx/src/core/ngx_resolver.c"
                                                    ;
                    next = ctx->next;
            ...
            for (next = ctx; next; next = next->next) {
                next->node = 
# 2904 "project/nginx/src/core/ngx_resolver.c" 3 4
                            ((void *)0)
# 2904 "project/nginx/src/core/ngx_resolver.c"
                                ;
            }
...
# 2915 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 2915 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 2915 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 2915 "project/nginx/src/core/ngx_resolver.c"
...
# 2927 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 2927 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 2927 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 2927 "project/nginx/src/core/ngx_resolver.c"
...
ngx_resolver_resolve_srv_names(ngx_resolver_ctx_t *ctx, ngx_resolver_node_t *rn)
{
    ...
    ctx->node = 
# 2949 "project/nginx/src/core/ngx_resolver.c" 3 4
               ((void *)0)
# 2949 "project/nginx/src/core/ngx_resolver.c"
                   ;
    ctx->state = 
# 2950 "project/nginx/src/core/ngx_resolver.c" 3 4
                0
# 2950 "project/nginx/src/core/ngx_resolver.c"
                      ;
    ctx->valid = rn->valid;
    ctx->count = rn->nsrvs;
    ...
    if (srvs == 
# 2955 "project/nginx/src/core/ngx_resolver.c" 3 4
               ((void *)0)
# 2955 "project/nginx/src/core/ngx_resolver.c"
                   ) {
        goto failed;
    }
...
# 2963 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_del_timer
# 2963 "project/nginx/src/core/ngx_resolver.c"
                    (ctx->event);
    }
    ...
    for (i = 0; i < (ngx_uint_t) rn->nsrvs; i++) {
        ...
        if (srvs[i].name.data == 
# 2968 "project/nginx/src/core/ngx_resolver.c" 3 4
                                ((void *)0)
# 2968 "project/nginx/src/core/ngx_resolver.c"
                                    ) {
            goto failed;
        }
...
# 2973 "project/nginx/src/core/ngx_resolver.c" 3 4
       (void) __builtin___memcpy_chk (
# 2973 "project/nginx/src/core/ngx_resolver.c"
       srvs[i].name.data
# 2973 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 2973 "project/nginx/src/core/ngx_resolver.c"
       rn->u.srvs[i].name.data
# 2973 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 2973 "project/nginx/src/core/ngx_resolver.c"
       srvs[i].name.len
...
# 2974 "project/nginx/src/core/ngx_resolver.c"
                                   ;

        cctx = ngx_resolve_start(r, 
# 2976 "project/nginx/src/core/ngx_resolver.c" 3 4
                                   ((void *)0)
# 2976 "project/nginx/src/core/ngx_resolver.c"
                                       );
        if (cctx == 
# 2977 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 2977 "project/nginx/src/core/ngx_resolver.c"
                       ) {
            goto failed;
        }
        ...
        if (ngx_resolve_name(cctx) == 
# 2992 "project/nginx/src/core/ngx_resolver.c" 3 4
                                     -1
# 2992 "project/nginx/src/core/ngx_resolver.c"
                                              ) {
            srvs[i].ctx = 
# 2993 "project/nginx/src/core/ngx_resolver.c" 3 4
                         ((void *)0)
# 2993 "project/nginx/src/core/ngx_resolver.c"
                             ;
            goto failed;
        }
    }
...
failed:
    ...
    ctx->state = 
# 3002 "project/nginx/src/core/ngx_resolver.c" 3 4
                -1
# 3002 "project/nginx/src/core/ngx_resolver.c"
                         ;
    ctx->valid = 
# 3003 "project/nginx/src/core/ngx_resolver.c" 3 4
                ngx_cached_time->sec 
# 3003 "project/nginx/src/core/ngx_resolver.c"
                           + (r->valid ? r->valid : 10);
...
ngx_resolver_srv_names_handler(ngx_resolver_ctx_t *cctx)
{
    ...
    srv->ctx = 
# 3026 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 3026 "project/nginx/src/core/ngx_resolver.c"
                  ;
    ...
    if (cctx->naddrs) {
        ...
        ctx->valid = 
# 3031 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((
# 3031 "project/nginx/src/core/ngx_resolver.c"
                    ctx->valid 
# 3031 "project/nginx/src/core/ngx_resolver.c" 3 4
                    > 
# 3031 "project/nginx/src/core/ngx_resolver.c"
...
# 3031 "project/nginx/src/core/ngx_resolver.c"
        ...
        if (addrs == 
# 3034 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ((void *)0)
# 3034 "project/nginx/src/core/ngx_resolver.c"
                        ) {
            srv->state = 
# 3035 "project/nginx/src/core/ngx_resolver.c" 3 4
                        -1
# 3035 "project/nginx/src/core/ngx_resolver.c"
                                 ;
            goto done;
        }
        ...
        if (sockaddr == 
# 3040 "project/nginx/src/core/ngx_resolver.c" 3 4
                       ((void *)0)
# 3040 "project/nginx/src/core/ngx_resolver.c"
                           ) {
            ngx_resolver_free(r, addrs);
            srv->state = 
# 3042 "project/nginx/src/core/ngx_resolver.c" 3 4
                        -1
# 3042 "project/nginx/src/core/ngx_resolver.c"
                                 ;
            goto done;
        }
...
# 3050 "project/nginx/src/core/ngx_resolver.c" 3 4
           (void) __builtin___memcpy_chk (
# 3050 "project/nginx/src/core/ngx_resolver.c"
           &sockaddr[i]
# 3050 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 3050 "project/nginx/src/core/ngx_resolver.c"
           cctx->addrs[i].sockaddr
# 3050 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 3050 "project/nginx/src/core/ngx_resolver.c"
           addrs[i].socklen
...
# 3051 "project/nginx/src/core/ngx_resolver.c"
                                       ;
    ...
    ngx_uint_t ident, ngx_uint_t code, ngx_uint_t nan)
{
    ...
    if (ngx_resolver_copy(r, &name, buf,
                          buf + sizeof(ngx_resolver_hdr_t), buf + n)
        != 
# 3094 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 3094 "project/nginx/src/core/ngx_resolver.c"
                )
    {
        return;
    }
    ...
    for (mask = 0; mask < 32; mask += 8) {
        ...
        if (octet == 
# 3110 "project/nginx/src/core/ngx_resolver.c" 3 4
                    -1 
# 3110 "project/nginx/src/core/ngx_resolver.c"
                              || octet > 255) {
...
invalid_in_addr_arpa:
    ...
    for (octet = 15; octet >= 0; octet--) {
        ...
        if (digit == 
# 3143 "project/nginx/src/core/ngx_resolver.c" 3 4
                    -1
# 3143 "project/nginx/src/core/ngx_resolver.c"
                             ) {
            goto invalid_ip6_arpa;
        }

        addr6.
# 3147 "project/nginx/src/core/ngx_resolver.c" 3 4
             __u6_addr.__u6_addr8
# 3147 "project/nginx/src/core/ngx_resolver.c"
                    [octet] = (u_char) digit;
        ...
        digit = ngx_hextoi(&buf[i++], 1);
        if (digit == 
# 3154 "project/nginx/src/core/ngx_resolver.c" 3 4
                    -1
# 3154 "project/nginx/src/core/ngx_resolver.c"
                             ) {
            goto invalid_ip6_arpa;
        }

        addr6.
# 3158 "project/nginx/src/core/ngx_resolver.c" 3 4
             __u6_addr.__u6_addr8
# 3158 "project/nginx/src/core/ngx_resolver.c"
                    [octet] += (u_char) (digit * 16);
    }
    ...
    if (ngx_strcasecmp(&buf[i], (u_char *) "\3ip6\4arpa") == 0) {
        ...
        hash = ngx_crc32_short(addr6.
# 3166 "project/nginx/src/core/ngx_resolver.c" 3 4
                                    __u6_addr.__u6_addr8
# 3166 "project/nginx/src/core/ngx_resolver.c"
                                           , 16);
...
# 3178 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 3178 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 3178 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 3178 "project/nginx/src/core/ngx_resolver.c"
...
# 3178 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 3178 "project/nginx/src/core/ngx_resolver.c"
   0, "invalid in-addr.arpa or ip6.arpa name in DNS response"
# 3178 "project/nginx/src/core/ngx_resolver.c" 3 4
   )
                                                                          
# 3179 "project/nginx/src/core/ngx_resolver.c"
                                                                         ;
    ngx_resolver_free(r, name.data);
    return;
...
valid:
    ...
    if (rn == 
# 3185 "project/nginx/src/core/ngx_resolver.c" 3 4
             ((void *)0) 
# 3185 "project/nginx/src/core/ngx_resolver.c"
                  || rn->query == 
# 3185 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  ((void *)0)
# 3185 "project/nginx/src/core/ngx_resolver.c"
...
# 3186 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 3186 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 3186 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 3186 "project/nginx/src/core/ngx_resolver.c"
...
# 3187 "project/nginx/src/core/ngx_resolver.c"
                                                             ;
        ngx_resolver_free(r, name.data);
        goto failed;
    }
...
# 3195 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 3195 "project/nginx/src/core/ngx_resolver.c"
       r->log
# 3195 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 
# 3195 "project/nginx/src/core/ngx_resolver.c"
...
# 3197 "project/nginx/src/core/ngx_resolver.c"
                                          ;
        ngx_resolver_free(r, name.data);
        goto failed;
    }
    ...
    if (code == 0 && nan == 0) {
        code = 
# 3205 "project/nginx/src/core/ngx_resolver.c" 3 4
              3
# 3205 "project/nginx/src/core/ngx_resolver.c"
                                  ;
    }
    ...
    if (code) {
        next = rn->waiting;
        rn->waiting = 
# 3210 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 3210 "project/nginx/src/core/ngx_resolver.c"
                         ;

        
# 3212 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 3212 "project/nginx/src/core/ngx_resolver.c"
       &rn->queue
# 3212 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->next->prev = (
# 3212 "project/nginx/src/core/ngx_resolver.c"
...
# 3212 "project/nginx/src/core/ngx_resolver.c"
        ...
        while (next) {
            ...
            ctx->state = code;
            ctx->valid = 
# 3221 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec 
# 3221 "project/nginx/src/core/ngx_resolver.c"
                                   + (r->valid ? r->valid : 10);
            next = ctx->next;
...
# 3277 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 3277 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 3277 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 3277 "project/nginx/src/core/ngx_resolver.c"
...
# 3278 "project/nginx/src/core/ngx_resolver.c"
                                                                          ;
            goto failed;
        }
        ...
        case 
# 3294 "project/nginx/src/core/ngx_resolver.c" 3 4
            12
# 3294 "project/nginx/src/core/ngx_resolver.c"
                           :

            goto ptr;

        case 
# 3298 "project/nginx/src/core/ngx_resolver.c" 3 4
            5
# 3298 "project/nginx/src/core/ngx_resolver.c"
                             :
...
# 3304 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 3304 "project/nginx/src/core/ngx_resolver.c"
           r->log
# 3304 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 3304 "project/nginx/src/core/ngx_resolver.c"
...
# 3305 "project/nginx/src/core/ngx_resolver.c"
                                                                        ;
        }
...
# 3313 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 3313 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 3313 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 3313 "project/nginx/src/core/ngx_resolver.c"
...
# 3313 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 3313 "project/nginx/src/core/ngx_resolver.c"
   0, "no PTR type in DNS response"
# 3313 "project/nginx/src/core/ngx_resolver.c" 3 4
   )
                                                
# 3314 "project/nginx/src/core/ngx_resolver.c"
                                               ;
    return;

ptr:

    if (ngx_resolver_copy(r, &name, buf, buf + i, buf + n) != 
# 3319 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                             0
# 3319 "project/nginx/src/core/ngx_resolver.c"
                                                                   ) {
        goto failed;
    }
    ...
    if (name.len != (size_t) rn->nlen
        || 
# 3326 "project/nginx/src/core/ngx_resolver.c" 3 4
          strncmp((const char *) 
# 3326 "project/nginx/src/core/ngx_resolver.c"
          name.data
# 3326 "project/nginx/src/core/ngx_resolver.c" 3 4
          , (const char *) 
# 3326 "project/nginx/src/core/ngx_resolver.c"
...
# 3326 "project/nginx/src/core/ngx_resolver.c"
                                                     != 0)
    {
        ...
        if (name.data == 
# 3336 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ((void *)0)
# 3336 "project/nginx/src/core/ngx_resolver.c"
                            ) {
            goto failed;
        }
    }
...
# 3341 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 3341 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue
# 3341 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->next->prev = (
# 3341 "project/nginx/src/core/ngx_resolver.c"
...
# 3341 "project/nginx/src/core/ngx_resolver.c"
    ...
    rn->valid = 
# 3343 "project/nginx/src/core/ngx_resolver.c" 3 4
               ngx_cached_time->sec 
# 3343 "project/nginx/src/core/ngx_resolver.c"
                          + (r->valid ? r->valid : ttl);
    rn->expire = 
# 3344 "project/nginx/src/core/ngx_resolver.c" 3 4
                ngx_cached_time->sec 
# 3344 "project/nginx/src/core/ngx_resolver.c"
                           + r->expire;

    
# 3346 "project/nginx/src/core/ngx_resolver.c" 3 4
   (
# 3346 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue
# 3346 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->next = (
# 3346 "project/nginx/src/core/ngx_resolver.c"
...
# 3346 "project/nginx/src/core/ngx_resolver.c"
   &rn->queue;
    ...
    next = rn->waiting;
    rn->waiting = 
# 3349 "project/nginx/src/core/ngx_resolver.c" 3 4
                 ((void *)0)
# 3349 "project/nginx/src/core/ngx_resolver.c"
                     ;
    ...
    while (next) {
        ctx = next;
        ctx->state = 
# 3355 "project/nginx/src/core/ngx_resolver.c" 3 4
                    0
# 3355 "project/nginx/src/core/ngx_resolver.c"
                          ;
        ctx->valid = rn->valid;
        ctx->name = name;
        next = ctx->next;
...
# 3375 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 3375 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 3375 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 3375 "project/nginx/src/core/ngx_resolver.c"
...
ngx_resolver_lookup_name(ngx_resolver_t *r, ngx_str_t *name, uint32_t hash)
{
    ...
    while (node != sentinel) {
        ...
        rn = 
# 3411 "project/nginx/src/core/ngx_resolver.c" 3 4
            (
# 3411 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t 
# 3411 "project/nginx/src/core/ngx_resolver.c" 3 4
            *) ((u_char *) (
# 3411 "project/nginx/src/core/ngx_resolver.c"
...
# 3411 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 3424 "project/nginx/src/core/ngx_resolver.c" 3 4
          ((void *)0)
# 3424 "project/nginx/src/core/ngx_resolver.c"
              ;
}
...
ngx_resolver_lookup_srv(ngx_resolver_t *r, ngx_str_t *name, uint32_t hash)
{
    ...
    while (node != sentinel) {
        ...
        rn = 
# 3452 "project/nginx/src/core/ngx_resolver.c" 3 4
            (
# 3452 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t 
# 3452 "project/nginx/src/core/ngx_resolver.c" 3 4
            *) ((u_char *) (
# 3452 "project/nginx/src/core/ngx_resolver.c"
...
# 3452 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 3465 "project/nginx/src/core/ngx_resolver.c" 3 4
          ((void *)0)
# 3465 "project/nginx/src/core/ngx_resolver.c"
              ;
}
...
ngx_resolver_lookup_addr(ngx_resolver_t *r, in_addr_t addr)
{
    ...
    while (node != sentinel) {
        ...
        return 
# 3491 "project/nginx/src/core/ngx_resolver.c" 3 4
              (
# 3491 "project/nginx/src/core/ngx_resolver.c"
              ngx_resolver_node_t 
# 3491 "project/nginx/src/core/ngx_resolver.c" 3 4
              *) ((u_char *) (
# 3491 "project/nginx/src/core/ngx_resolver.c"
...
# 3491 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 3496 "project/nginx/src/core/ngx_resolver.c" 3 4
          ((void *)0)
# 3496 "project/nginx/src/core/ngx_resolver.c"
              ;
}
    ...
    uint32_t hash)
{
    ...
    while (node != sentinel) {
        ...
        rn = 
# 3527 "project/nginx/src/core/ngx_resolver.c" 3 4
            (
# 3527 "project/nginx/src/core/ngx_resolver.c"
            ngx_resolver_node_t 
# 3527 "project/nginx/src/core/ngx_resolver.c" 3 4
            *) ((u_char *) (
# 3527 "project/nginx/src/core/ngx_resolver.c"
...
# 3527 "project/nginx/src/core/ngx_resolver.c"
        ...
        rc = 
# 3529 "project/nginx/src/core/ngx_resolver.c" 3 4
            memcmp((const char *) 
# 3529 "project/nginx/src/core/ngx_resolver.c"
            addr
# 3529 "project/nginx/src/core/ngx_resolver.c" 3 4
            , (const char *) 
# 3529 "project/nginx/src/core/ngx_resolver.c"
...
# 3529 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 3540 "project/nginx/src/core/ngx_resolver.c" 3 4
          ((void *)0)
# 3540 "project/nginx/src/core/ngx_resolver.c"
              ;
}
    ...
    ngx_rbtree_node_t *node, ngx_rbtree_node_t *sentinel)
{
    ...
    for ( ;; ) {
        ...
        if (node->key < temp->key) {
            ...
            rn = 
# 3565 "project/nginx/src/core/ngx_resolver.c" 3 4
                (
# 3565 "project/nginx/src/core/ngx_resolver.c"
                ngx_resolver_node_t 
# 3565 "project/nginx/src/core/ngx_resolver.c" 3 4
                *) ((u_char *) (
# 3565 "project/nginx/src/core/ngx_resolver.c"
...
# 3565 "project/nginx/src/core/ngx_resolver.c"
                                       ;
            rn_temp = 
# 3566 "project/nginx/src/core/ngx_resolver.c" 3 4
                     (
# 3566 "project/nginx/src/core/ngx_resolver.c"
                     ngx_resolver_node_t 
# 3566 "project/nginx/src/core/ngx_resolver.c" 3 4
                     *) ((u_char *) (
# 3566 "project/nginx/src/core/ngx_resolver.c"
...
# 3583 "project/nginx/src/core/ngx_resolver.c" 3 4
   ((
# 3583 "project/nginx/src/core/ngx_resolver.c"
   node
# 3583 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->color = 1)
# 3583 "project/nginx/src/core/ngx_resolver.c"
    ...
    ngx_rbtree_node_t *node, ngx_rbtree_node_t *sentinel)
{
    ...
    for ( ;; ) {
        ...
        if (node->key < temp->key) {
            ...
            rn = 
# 3608 "project/nginx/src/core/ngx_resolver.c" 3 4
                (
# 3608 "project/nginx/src/core/ngx_resolver.c"
                ngx_resolver_node_t 
# 3608 "project/nginx/src/core/ngx_resolver.c" 3 4
                *) ((u_char *) (
# 3608 "project/nginx/src/core/ngx_resolver.c"
...
# 3608 "project/nginx/src/core/ngx_resolver.c"
                                       ;
            rn_temp = 
# 3609 "project/nginx/src/core/ngx_resolver.c" 3 4
                     (
# 3609 "project/nginx/src/core/ngx_resolver.c"
                     ngx_resolver_node_t 
# 3609 "project/nginx/src/core/ngx_resolver.c" 3 4
                     *) ((u_char *) (
# 3609 "project/nginx/src/core/ngx_resolver.c"
...
# 3609 "project/nginx/src/core/ngx_resolver.c"
            ...
            p = (
# 3611 "project/nginx/src/core/ngx_resolver.c" 3 4
                memcmp((const char *) 
# 3611 "project/nginx/src/core/ngx_resolver.c"
                &rn->addr6
# 3611 "project/nginx/src/core/ngx_resolver.c" 3 4
                , (const char *) 
# 3611 "project/nginx/src/core/ngx_resolver.c"
...
# 3612 "project/nginx/src/core/ngx_resolver.c"
                < 0) ? &temp->left : &temp->right;
        }
...
# 3626 "project/nginx/src/core/ngx_resolver.c" 3 4
   ((
# 3626 "project/nginx/src/core/ngx_resolver.c"
   node
# 3626 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->color = 1)
# 3626 "project/nginx/src/core/ngx_resolver.c"
    ...
    ngx_str_t *name)
{
    ...
    if (p == 
# 3651 "project/nginx/src/core/ngx_resolver.c" 3 4
            ((void *)0)
# 3651 "project/nginx/src/core/ngx_resolver.c"
                ) {
        return 
# 3652 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 3652 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    ident = 
# 3666 "project/nginx/src/core/ngx_resolver.c" 3 4
           random
# 3666 "project/nginx/src/core/ngx_resolver.c"
                     ();
    ...
    qs->type_hi = 0; qs->type_lo = 
# 3688 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  1
# 3688 "project/nginx/src/core/ngx_resolver.c"
                                               ;
    ...
    *p-- = '\0';
    ...
    if (name->len == 0) {
        return 
# 3700 "project/nginx/src/core/ngx_resolver.c" 3 4
              -5
# 3700 "project/nginx/src/core/ngx_resolver.c"
                          ;
    }
    ...
    for (s = name->data + name->len - 1; s >= name->data; s--) {
        if (*s != '.') {
            *p = *s;
            ...
            if (len == 0 || len > 255) {
                return 
# 3710 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -5
# 3710 "project/nginx/src/core/ngx_resolver.c"
                                  ;
            }
    ...
    if (len == 0 || len > 255) {
        return 
# 3721 "project/nginx/src/core/ngx_resolver.c" 3 4
              -5
# 3721 "project/nginx/src/core/ngx_resolver.c"
                          ;
    }
    ...
    *p = (u_char) len;
    ...
    if (!r->ipv6) {
        return 
# 3728 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 3728 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }
...
# 3733 "project/nginx/src/core/ngx_resolver.c" 3 4
   (void) __builtin___memcpy_chk (
# 3733 "project/nginx/src/core/ngx_resolver.c"
   p
# 3733 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 3733 "project/nginx/src/core/ngx_resolver.c"
...
# 3733 "project/nginx/src/core/ngx_resolver.c"
    ...
    ident = 
# 3737 "project/nginx/src/core/ngx_resolver.c" 3 4
           random
# 3737 "project/nginx/src/core/ngx_resolver.c"
                     ();
    ...
    qs->type_lo = 
# 3749 "project/nginx/src/core/ngx_resolver.c" 3 4
                 28
# 3749 "project/nginx/src/core/ngx_resolver.c"
                                 ;


    return 
# 3752 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 3752 "project/nginx/src/core/ngx_resolver.c"
                ;
}
    ...
    ngx_str_t *name)
{
    ...
    if (p == 
# 3771 "project/nginx/src/core/ngx_resolver.c" 3 4
            ((void *)0)
# 3771 "project/nginx/src/core/ngx_resolver.c"
                ) {
        return 
# 3772 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 3772 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    ident = 
# 3780 "project/nginx/src/core/ngx_resolver.c" 3 4
           random
# 3780 "project/nginx/src/core/ngx_resolver.c"
                     ();
    ...
    qs->type_hi = 0; qs->type_lo = 
# 3802 "project/nginx/src/core/ngx_resolver.c" 3 4
                                  33
# 3802 "project/nginx/src/core/ngx_resolver.c"
                                                 ;
    ...
    *p-- = '\0';
    ...
    if (name->len == 0) {
        return 
# 3814 "project/nginx/src/core/ngx_resolver.c" 3 4
              -5
# 3814 "project/nginx/src/core/ngx_resolver.c"
                          ;
    }
    ...
    for (s = name->data + name->len - 1; s >= name->data; s--) {
        if (*s != '.') {
            *p = *s;
            ...
            if (len == 0 || len > 255) {
                return 
# 3824 "project/nginx/src/core/ngx_resolver.c" 3 4
                      -5
# 3824 "project/nginx/src/core/ngx_resolver.c"
                                  ;
            }
    ...
    if (len == 0 || len > 255) {
        return 
# 3835 "project/nginx/src/core/ngx_resolver.c" 3 4
              -5
# 3835 "project/nginx/src/core/ngx_resolver.c"
                          ;
    }
    ...
    *p = (u_char) len;
    ...
    return 
# 3840 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 3840 "project/nginx/src/core/ngx_resolver.c"
                ;
}
    ...
    ngx_resolver_addr_t *addr)
{
    ...
    case 
# 3862 "project/nginx/src/core/ngx_resolver.c" 3 4
        30
# 3862 "project/nginx/src/core/ngx_resolver.c"
                :
    ...
    p = ngx_resolver_alloc(r, len);
    if (p == 
# 3877 "project/nginx/src/core/ngx_resolver.c" 3 4
            ((void *)0)
# 3877 "project/nginx/src/core/ngx_resolver.c"
                ) {
        return 
# 3878 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 3878 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    ident = 
# 3884 "project/nginx/src/core/ngx_resolver.c" 3 4
           random
# 3884 "project/nginx/src/core/ngx_resolver.c"
                     ();
    ...
    case 
# 3903 "project/nginx/src/core/ngx_resolver.c" 3 4
        30
# 3903 "project/nginx/src/core/ngx_resolver.c"
                :
        ...
        for (n = 15; n >= 0; n--) {
            p = ngx_sprintf(p, "\1%xd\1%xd",
                            sin6->sin6_addr.
# 3908 "project/nginx/src/core/ngx_resolver.c" 3 4
                                           __u6_addr.__u6_addr8
# 3908 "project/nginx/src/core/ngx_resolver.c"
                                                  [n] & 0xf,
                            (sin6->sin6_addr.
# 3909 "project/nginx/src/core/ngx_resolver.c" 3 4
                                            __u6_addr.__u6_addr8
# 3909 "project/nginx/src/core/ngx_resolver.c"
                                                   [n] >> 4) & 0xf);
        }

        p = 
# 3912 "project/nginx/src/core/ngx_resolver.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 3912 "project/nginx/src/core/ngx_resolver.c"
           p
# 3912 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 3912 "project/nginx/src/core/ngx_resolver.c"
...
# 3912 "project/nginx/src/core/ngx_resolver.c"
    ...
    default:
        ...
        inaddr = 
# 3920 "project/nginx/src/core/ngx_resolver.c" 3 4
                (__builtin_constant_p(
# 3920 "project/nginx/src/core/ngx_resolver.c"
                sin->sin_addr.s_addr
# 3920 "project/nginx/src/core/ngx_resolver.c" 3 4
                ) ? ((__uint32_t)((((__uint32_t)(
# 3920 "project/nginx/src/core/ngx_resolver.c"
...
# 3920 "project/nginx/src/core/ngx_resolver.c"
        ...
        p = 
# 3928 "project/nginx/src/core/ngx_resolver.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 3928 "project/nginx/src/core/ngx_resolver.c"
           p
# 3928 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 3928 "project/nginx/src/core/ngx_resolver.c"
...
# 3928 "project/nginx/src/core/ngx_resolver.c"
    ...
    p = 
# 3932 "project/nginx/src/core/ngx_resolver.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 3932 "project/nginx/src/core/ngx_resolver.c"
       p
# 3932 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 
# 3932 "project/nginx/src/core/ngx_resolver.c"
...
# 3932 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 3936 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 3936 "project/nginx/src/core/ngx_resolver.c"
                ;
}
...
# 3993 "project/nginx/src/core/ngx_resolver.c" 3 4
   if ((
# 3993 "project/nginx/src/core/ngx_resolver.c"
   r->log
# 3993 "project/nginx/src/core/ngx_resolver.c" 3 4
   )->log_level >= 
# 3993 "project/nginx/src/core/ngx_resolver.c"
...
# 3993 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 3995 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 3995 "project/nginx/src/core/ngx_resolver.c"
                   ;

done:

    if (name == 
# 3999 "project/nginx/src/core/ngx_resolver.c" 3 4
               ((void *)0)
# 3999 "project/nginx/src/core/ngx_resolver.c"
                   ) {
        return 
# 4000 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 4000 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }

    if (len == 0) {
        
# 4004 "project/nginx/src/core/ngx_resolver.c" 3 4
       (
# 4004 "project/nginx/src/core/ngx_resolver.c"
       name
# 4004 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->len = 0; (
# 4004 "project/nginx/src/core/ngx_resolver.c"
...
# 4004 "project/nginx/src/core/ngx_resolver.c"
                         ;
        return 
# 4005 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 4005 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }

    dst = ngx_resolver_alloc(r, len);
    if (dst == 
# 4009 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4009 "project/nginx/src/core/ngx_resolver.c"
                  ) {
        return 
# 4010 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 4010 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    for ( ;; ) {
        ...
        if (n == 0) {
            ...
            return 
# 4020 "project/nginx/src/core/ngx_resolver.c" 3 4
                  0
# 4020 "project/nginx/src/core/ngx_resolver.c"
                        ;
        }
...
ngx_resolver_set_timeout(ngx_resolver_t *r, ngx_resolver_ctx_t *ctx)
{
    if (ctx->event || ctx->timeout == 0) {
        return 
# 4041 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 4041 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }

    ctx->event = ngx_resolver_calloc(r, sizeof(ngx_event_t));
    if (ctx->event == 
# 4045 "project/nginx/src/core/ngx_resolver.c" 3 4
                     ((void *)0)
# 4045 "project/nginx/src/core/ngx_resolver.c"
                         ) {
        return 
# 4046 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 4046 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
...
# 4055 "project/nginx/src/core/ngx_resolver.c" 3 4
   ngx_event_add_timer
# 4055 "project/nginx/src/core/ngx_resolver.c"
                (ctx->event, ctx->timeout);

    return 
# 4057 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 4057 "project/nginx/src/core/ngx_resolver.c"
                ;
}
...
ngx_resolver_timeout_handler(ngx_event_t *ev)
{
    ...
    ctx->state = 
# 4068 "project/nginx/src/core/ngx_resolver.c" 3 4
                60
# 4068 "project/nginx/src/core/ngx_resolver.c"
                                    ;
...
# 4142 "project/nginx/src/core/ngx_resolver.c" 3 4
       (void) __builtin___memset_chk (
# 4142 "project/nginx/src/core/ngx_resolver.c"
       p
# 4142 "project/nginx/src/core/ngx_resolver.c" 3 4
       , 0, 
# 4142 "project/nginx/src/core/ngx_resolver.c"
...
# 4154 "project/nginx/src/core/ngx_resolver.c" 3 4
   free
# 4154 "project/nginx/src/core/ngx_resolver.c"
           (p);
...
# 4163 "project/nginx/src/core/ngx_resolver.c" 3 4
   free
# 4163 "project/nginx/src/core/ngx_resolver.c"
           (p);
}
...
ngx_resolver_dup(ngx_resolver_t *r, void *src, size_t size)
{
    ...
    if (dst == 
# 4174 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4174 "project/nginx/src/core/ngx_resolver.c"
                  ) {
        return dst;
    }

    
# 4178 "project/nginx/src/core/ngx_resolver.c" 3 4
   (void) __builtin___memcpy_chk (
# 4178 "project/nginx/src/core/ngx_resolver.c"
   dst
# 4178 "project/nginx/src/core/ngx_resolver.c" 3 4
   , 
# 4178 "project/nginx/src/core/ngx_resolver.c"
    ...
    ngx_uint_t rotate)
{
    ...
    if (dst == 
# 4204 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4204 "project/nginx/src/core/ngx_resolver.c"
                  ) {
        return 
# 4205 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4205 "project/nginx/src/core/ngx_resolver.c"
                  ;
    }

    sockaddr = ngx_resolver_calloc(r, n * sizeof(ngx_sockaddr_t));
    if (sockaddr == 
# 4209 "project/nginx/src/core/ngx_resolver.c" 3 4
                   ((void *)0)
# 4209 "project/nginx/src/core/ngx_resolver.c"
                       ) {
        ngx_resolver_free(r, dst);
        return 
# 4211 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4211 "project/nginx/src/core/ngx_resolver.c"
                  ;
    }

    i = 0;
    d = rotate ? 
# 4215 "project/nginx/src/core/ngx_resolver.c" 3 4
                random
# 4215 "project/nginx/src/core/ngx_resolver.c"
                          () % n : 0;

    if (rn->naddrs) {
        j = rotate ? 
# 4218 "project/nginx/src/core/ngx_resolver.c" 3 4
                    random
# 4218 "project/nginx/src/core/ngx_resolver.c"
                              () % rn->naddrs : 0;
        ...
        do {
            ...
            sin->sin_family = 
# 4224 "project/nginx/src/core/ngx_resolver.c" 3 4
                             2
# 4224 "project/nginx/src/core/ngx_resolver.c"
                                    ;
    ...
    if (rn->naddrs6) {
        j = rotate ? 
# 4241 "project/nginx/src/core/ngx_resolver.c" 3 4
                    random
# 4241 "project/nginx/src/core/ngx_resolver.c"
                              () % rn->naddrs6 : 0;
        ...
        do {
            ...
            sin6->sin6_family = 
# 4247 "project/nginx/src/core/ngx_resolver.c" 3 4
                               30
# 4247 "project/nginx/src/core/ngx_resolver.c"
                                       ;
            
# 4248 "project/nginx/src/core/ngx_resolver.c" 3 4
           (void) __builtin___memcpy_chk (
# 4248 "project/nginx/src/core/ngx_resolver.c"
           sin6->sin6_addr.
# 4248 "project/nginx/src/core/ngx_resolver.c" 3 4
           __u6_addr.__u6_addr8, 
# 4248 "project/nginx/src/core/ngx_resolver.c"
...
ngx_resolver_report_srv(ngx_resolver_t *r, ngx_resolver_ctx_t *ctx)
{
    ...
    for (i = 0; i < nsrvs; i++) {
        if (srvs[i].state == 
# 4280 "project/nginx/src/core/ngx_resolver.c" 3 4
                            -1
# 4280 "project/nginx/src/core/ngx_resolver.c"
                                     ) {
            ctx->state = 
# 4281 "project/nginx/src/core/ngx_resolver.c" 3 4
                        -1
# 4281 "project/nginx/src/core/ngx_resolver.c"
                                 ;
            ctx->valid = 
# 4282 "project/nginx/src/core/ngx_resolver.c" 3 4
                        ngx_cached_time->sec 
# 4282 "project/nginx/src/core/ngx_resolver.c"
                                   + (r->valid ? r->valid : 10);
    ...
    if (naddrs == 0) {
        ...
        for (i = 0; i < nsrvs; i++) {
            if (srvs[i].state == 
# 4295 "project/nginx/src/core/ngx_resolver.c" 3 4
                                3
# 4295 "project/nginx/src/core/ngx_resolver.c"
                                                    ) {
                ctx->state = 
# 4296 "project/nginx/src/core/ngx_resolver.c" 3 4
                            3
# 4296 "project/nginx/src/core/ngx_resolver.c"
                                                ;
                break;
            }
        }
        ...
        ctx->valid = 
# 4301 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 4301 "project/nginx/src/core/ngx_resolver.c"
                               + (r->valid ? r->valid : 10);
    ...
    if (addrs == 
# 4308 "project/nginx/src/core/ngx_resolver.c" 3 4
                ((void *)0)
# 4308 "project/nginx/src/core/ngx_resolver.c"
                    ) {
        ctx->state = 
# 4309 "project/nginx/src/core/ngx_resolver.c" 3 4
                    -1
# 4309 "project/nginx/src/core/ngx_resolver.c"
                             ;
        ctx->valid = 
# 4310 "project/nginx/src/core/ngx_resolver.c" 3 4
                    ngx_cached_time->sec 
# 4310 "project/nginx/src/core/ngx_resolver.c"
                               + (r->valid ? r->valid : 10);
    ...
    do {
        ...
        w = 
# 4334 "project/nginx/src/core/ngx_resolver.c" 3 4
           random
# 4334 "project/nginx/src/core/ngx_resolver.c"
                     () % nw;
...
next_srv:
    ...
    ctx->state = 
# 4366 "project/nginx/src/core/ngx_resolver.c" 3 4
                0
# 4366 "project/nginx/src/core/ngx_resolver.c"
                      ;
    ctx->addrs = addrs;
    ctx->naddrs = naddrs;
...
ngx_resolver_strerror(ngx_int_t err)
{
    ...
    if (err == 
# 4391 "project/nginx/src/core/ngx_resolver.c" 3 4
              60
# 4391 "project/nginx/src/core/ngx_resolver.c"
                                  ) {
...
ngx_udp_connect(ngx_resolver_connection_t *rec)
{
    ...
    s = 
# 4431 "project/nginx/src/core/ngx_resolver.c" 3 4
       socket
# 4431 "project/nginx/src/core/ngx_resolver.c"
                 (rec->sockaddr->sa_family, 
# 4431 "project/nginx/src/core/ngx_resolver.c" 3 4
                                            2
# 4431 "project/nginx/src/core/ngx_resolver.c"
                                                      , 0);
...
# 4436 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 4436 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 4436 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 4436 "project/nginx/src/core/ngx_resolver.c"
...
# 4437 "project/nginx/src/core/ngx_resolver.c"
                                            ;
        return 
# 4438 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 4438 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    if (c == 
# 4443 "project/nginx/src/core/ngx_resolver.c" 3 4
            ((void *)0)
# 4443 "project/nginx/src/core/ngx_resolver.c"
                ) {
        if (
# 4444 "project/nginx/src/core/ngx_resolver.c" 3 4
           close
# 4444 "project/nginx/src/core/ngx_resolver.c"
                           (s) == -1) {
            
# 4445 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 4445 "project/nginx/src/core/ngx_resolver.c"
           &rec->log
# 4445 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 4445 "project/nginx/src/core/ngx_resolver.c"
...
# 4446 "project/nginx/src/core/ngx_resolver.c"
                                                      ;
        }

        return 
# 4449 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 4449 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }

    if (ngx_nonblocking(s) == -1) {
        
# 4453 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 4453 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 4453 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 4453 "project/nginx/src/core/ngx_resolver.c"
...
# 4454 "project/nginx/src/core/ngx_resolver.c"
                                                 ;
    ...
    c->number = 
# 4467 "project/nginx/src/core/ngx_resolver.c" 3 4
               __sync_fetch_and_add(
# 4467 "project/nginx/src/core/ngx_resolver.c"
...
# 4479 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 4479 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 4479 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 4479 "project/nginx/src/core/ngx_resolver.c"
...
# 4480 "project/nginx/src/core/ngx_resolver.c"
                                        ;
    ...
    event = (ngx_event_flags & 
# 4488 "project/nginx/src/core/ngx_resolver.c" 3 4
                              0x00000004
# 4488 "project/nginx/src/core/ngx_resolver.c"
                                                 ) ?
                                                    
# 4489 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                   0x0020
# 4489 "project/nginx/src/core/ngx_resolver.c"
                                                                  :
                                                    
# 4490 "project/nginx/src/core/ngx_resolver.c" 3 4
                                                   0
# 4490 "project/nginx/src/core/ngx_resolver.c"
                                                                  ;


    if (
# 4493 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_actions.add
# 4493 "project/nginx/src/core/ngx_resolver.c"
                    (rev, 
# 4493 "project/nginx/src/core/ngx_resolver.c" 3 4
                          (-1)
# 4493 "project/nginx/src/core/ngx_resolver.c"
...
# 4493 "project/nginx/src/core/ngx_resolver.c"
    ...
    return 
# 4497 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 4497 "project/nginx/src/core/ngx_resolver.c"
                ;
...
failed:
    ...
    ngx_close_connection(c);
    rec->udp = 
# 4502 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4502 "project/nginx/src/core/ngx_resolver.c"
                  ;

    return 
# 4504 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 4504 "project/nginx/src/core/ngx_resolver.c"
                   ;
}
...
ngx_tcp_connect(ngx_resolver_connection_t *rec)
{
    ...
    s = 
# 4519 "project/nginx/src/core/ngx_resolver.c" 3 4
       socket
# 4519 "project/nginx/src/core/ngx_resolver.c"
                 (rec->sockaddr->sa_family, 
# 4519 "project/nginx/src/core/ngx_resolver.c" 3 4
                                            1
# 4519 "project/nginx/src/core/ngx_resolver.c"
...
# 4524 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 4524 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 4524 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 4524 "project/nginx/src/core/ngx_resolver.c"
...
# 4525 "project/nginx/src/core/ngx_resolver.c"
                                            ;
        return 
# 4526 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 4526 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    if (c == 
# 4531 "project/nginx/src/core/ngx_resolver.c" 3 4
            ((void *)0)
# 4531 "project/nginx/src/core/ngx_resolver.c"
                ) {
        if (
# 4532 "project/nginx/src/core/ngx_resolver.c" 3 4
           close
# 4532 "project/nginx/src/core/ngx_resolver.c"
                           (s) == -1) {
            
# 4533 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 4533 "project/nginx/src/core/ngx_resolver.c"
           &rec->log
# 4533 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 4533 "project/nginx/src/core/ngx_resolver.c"
...
# 4534 "project/nginx/src/core/ngx_resolver.c"
                                                      ;
        }

        return 
# 4537 "project/nginx/src/core/ngx_resolver.c" 3 4
              -1
# 4537 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }

    if (ngx_nonblocking(s) == -1) {
        
# 4541 "project/nginx/src/core/ngx_resolver.c" 3 4
       if ((
# 4541 "project/nginx/src/core/ngx_resolver.c"
       &rec->log
# 4541 "project/nginx/src/core/ngx_resolver.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 4541 "project/nginx/src/core/ngx_resolver.c"
...
# 4542 "project/nginx/src/core/ngx_resolver.c"
                                                 ;
    ...
    c->number = 
# 4555 "project/nginx/src/core/ngx_resolver.c" 3 4
               __sync_fetch_and_add(
# 4555 "project/nginx/src/core/ngx_resolver.c"
               ngx_connection_counter
# 4555 "project/nginx/src/core/ngx_resolver.c" 3 4
               , 
# 4555 "project/nginx/src/core/ngx_resolver.c"
...
# 4555 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (
# 4559 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_actions.add_conn
# 4559 "project/nginx/src/core/ngx_resolver.c"
                   ) {
        if (
# 4560 "project/nginx/src/core/ngx_resolver.c" 3 4
           ngx_event_actions.add_conn
# 4560 "project/nginx/src/core/ngx_resolver.c"
                       (c) == 
# 4560 "project/nginx/src/core/ngx_resolver.c" 3 4
                              -1
# 4560 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (rc == -1) {
        err = 
# 4571 "project/nginx/src/core/ngx_resolver.c" 3 4
             (*__error())
# 4571 "project/nginx/src/core/ngx_resolver.c"
                             ;


        if (err != 
# 4574 "project/nginx/src/core/ngx_resolver.c" 3 4
                  36
...
# 4579 "project/nginx/src/core/ngx_resolver.c"
           )
        {
            if (err == 
# 4581 "project/nginx/src/core/ngx_resolver.c" 3 4
                      61
...
# 4589 "project/nginx/src/core/ngx_resolver.c"
               || err == 
# 4589 "project/nginx/src/core/ngx_resolver.c" 3 4
                         54
                
# 4590 "project/nginx/src/core/ngx_resolver.c"
               || err == 
# 4590 "project/nginx/src/core/ngx_resolver.c" 3 4
                         50
                
# 4591 "project/nginx/src/core/ngx_resolver.c"
               || err == 
# 4591 "project/nginx/src/core/ngx_resolver.c" 3 4
                         51
                
# 4592 "project/nginx/src/core/ngx_resolver.c"
               || err == 
# 4592 "project/nginx/src/core/ngx_resolver.c" 3 4
                         64
                
# 4593 "project/nginx/src/core/ngx_resolver.c"
               || err == 
# 4593 "project/nginx/src/core/ngx_resolver.c" 3 4
                         65
# 4593 "project/nginx/src/core/ngx_resolver.c"
                                         )
            {
                level = 
# 4595 "project/nginx/src/core/ngx_resolver.c" 3 4
                       4
# 4595 "project/nginx/src/core/ngx_resolver.c"
                                  ;

            } else {
                level = 
# 4598 "project/nginx/src/core/ngx_resolver.c" 3 4
                       3
# 4598 "project/nginx/src/core/ngx_resolver.c"
                                   ;
            }

            
# 4601 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 4601 "project/nginx/src/core/ngx_resolver.c"
           &rec->log
# 4601 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 
# 4601 "project/nginx/src/core/ngx_resolver.c"
...
# 4601 "project/nginx/src/core/ngx_resolver.c" 3 4
           , 
# 4601 "project/nginx/src/core/ngx_resolver.c"
           err, "connect() to %V failed", &rec->server
# 4601 "project/nginx/src/core/ngx_resolver.c" 3 4
           )
                                       
# 4602 "project/nginx/src/core/ngx_resolver.c"
                                      ;

            ngx_close_connection(c);
            rec->tcp = 
# 4605 "project/nginx/src/core/ngx_resolver.c" 3 4
                      ((void *)0)
# 4605 "project/nginx/src/core/ngx_resolver.c"
                          ;

            return 
# 4607 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -1
# 4607 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }
    }

    if (
# 4611 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_actions.add_conn
# 4611 "project/nginx/src/core/ngx_resolver.c"
                   ) {
        if (rc == -1) {
            ...
            return 
# 4616 "project/nginx/src/core/ngx_resolver.c" 3 4
                  -2
# 4616 "project/nginx/src/core/ngx_resolver.c"
                           ;
        }
        ...
        return 
# 4623 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 4623 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }

    if (ngx_event_flags & 
# 4626 "project/nginx/src/core/ngx_resolver.c" 3 4
                         0x00000200
# 4626 "project/nginx/src/core/ngx_resolver.c"
                                           ) {
...
# 4632 "project/nginx/src/core/ngx_resolver.c" 3 4
           if ((
# 4632 "project/nginx/src/core/ngx_resolver.c"
           &rec->log
# 4632 "project/nginx/src/core/ngx_resolver.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 4632 "project/nginx/src/core/ngx_resolver.c"
...
# 4633 "project/nginx/src/core/ngx_resolver.c"
                                                  ;
            goto failed;
        }
# 4644 "project/nginx/src/core/ngx_resolver.c"
        rev->ready = 1;
        wev->ready = 1;

        return 
# 4647 "project/nginx/src/core/ngx_resolver.c" 3 4
              0
# 4647 "project/nginx/src/core/ngx_resolver.c"
                    ;
    }

    if (ngx_event_flags & 
# 4650 "project/nginx/src/core/ngx_resolver.c" 3 4
                         0x00000004
# 4650 "project/nginx/src/core/ngx_resolver.c"
                                            ) {



        event = 
# 4654 "project/nginx/src/core/ngx_resolver.c" 3 4
               0x0020
# 4654 "project/nginx/src/core/ngx_resolver.c"
                              ;
        ...
        event = 
# 4660 "project/nginx/src/core/ngx_resolver.c" 3 4
               0
# 4660 "project/nginx/src/core/ngx_resolver.c"
                              ;
    }

    if (
# 4663 "project/nginx/src/core/ngx_resolver.c" 3 4
       ngx_event_actions.add
# 4663 "project/nginx/src/core/ngx_resolver.c"
                    (rev, 
# 4663 "project/nginx/src/core/ngx_resolver.c" 3 4
                          (-1)
# 4663 "project/nginx/src/core/ngx_resolver.c"
...
# 4663 "project/nginx/src/core/ngx_resolver.c"
    ...
    if (rc == -1) {
        ...
        if (
# 4671 "project/nginx/src/core/ngx_resolver.c" 3 4
           ngx_event_actions.add
# 4671 "project/nginx/src/core/ngx_resolver.c"
                        (wev, 
# 4671 "project/nginx/src/core/ngx_resolver.c" 3 4
                              (-2)
# 4671 "project/nginx/src/core/ngx_resolver.c"
...
# 4671 "project/nginx/src/core/ngx_resolver.c"
        ...
        return 
# 4675 "project/nginx/src/core/ngx_resolver.c" 3 4
              -2
# 4675 "project/nginx/src/core/ngx_resolver.c"
                       ;
    }
    ...
    return 
# 4682 "project/nginx/src/core/ngx_resolver.c" 3 4
          0
# 4682 "project/nginx/src/core/ngx_resolver.c"
                ;
...
failed:
    ...
    ngx_close_connection(c);
    rec->tcp = 
# 4687 "project/nginx/src/core/ngx_resolver.c" 3 4
              ((void *)0)
# 4687 "project/nginx/src/core/ngx_resolver.c"
                  ;

    return 
# 4689 "project/nginx/src/core/ngx_resolver.c" 3 4
          -1
# 4689 "project/nginx/src/core/ngx_resolver.c"
                   ;
}
