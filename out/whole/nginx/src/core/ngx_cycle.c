# 0 "project/nginx/src/core/ngx_cycle.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_cycle.c"
...
# 9 "project/nginx/src/core/ngx_cycle.c" 2
...
# 10 "project/nginx/src/core/ngx_cycle.c" 2
...
# 11 "project/nginx/src/core/ngx_cycle.c" 2



# 13 "project/nginx/src/core/ngx_cycle.c"
...
ngx_init_cycle(ngx_cycle_t *old_cycle)
{
    ...
    char hostname[
# 55 "project/nginx/src/core/ngx_cycle.c" 3 4
                                 256
# 55 "project/nginx/src/core/ngx_cycle.c"
                                                   ];
    ...
    tp = 
# 61 "project/nginx/src/core/ngx_cycle.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 61 "project/nginx/src/core/ngx_cycle.c"
                       ;
    tp->sec = 0;
...
# 69 "project/nginx/src/core/ngx_cycle.c" 3 4
                          (16 * 1024)
# 69 "project/nginx/src/core/ngx_cycle.c"
                                             , log);
    if (pool == 
# 70 "project/nginx/src/core/ngx_cycle.c" 3 4
               ((void *)0)
# 70 "project/nginx/src/core/ngx_cycle.c"
                   ) {
        return 
# 71 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 71 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    pool->log = log;
    ...
    if (cycle == 
# 76 "project/nginx/src/core/ngx_cycle.c" 3 4
                ((void *)0)
# 76 "project/nginx/src/core/ngx_cycle.c"
                    ) {
        ngx_destroy_pool(pool);
        return 
# 78 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 78 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
...
# 87 "project/nginx/src/core/ngx_cycle.c" 3 4
                                  ((void *)0)
# 87 "project/nginx/src/core/ngx_cycle.c"
                                      ) {
        ngx_destroy_pool(pool);
        return 
# 89 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 89 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
...
# 94 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 94 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
        ngx_destroy_pool(pool);
        return 
# 96 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 96 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
...
# 101 "project/nginx/src/core/ngx_cycle.c" 3 4
                                ((void *)0)
# 101 "project/nginx/src/core/ngx_cycle.c"
                                    ) {
        ngx_destroy_pool(pool);
        return 
# 103 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 103 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
...
# 110 "project/nginx/src/core/ngx_cycle.c" 3 4
                                ((void *)0)
# 110 "project/nginx/src/core/ngx_cycle.c"
                                    ) {
        ngx_destroy_pool(pool);
        return 
# 112 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 112 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
...
# 119 "project/nginx/src/core/ngx_cycle.c" 3 4
                                 ((void *)0)
# 119 "project/nginx/src/core/ngx_cycle.c"
                                     ) {
        ngx_destroy_pool(pool);
        return 
# 121 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 121 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    if (ngx_array_init(&cycle->paths, pool, n, sizeof(ngx_path_t *))
        != 
# 128 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 128 "project/nginx/src/core/ngx_cycle.c"
                )
    {
        ngx_destroy_pool(pool);
        return 
# 131 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 131 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }

    
# 134 "project/nginx/src/core/ngx_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 134 "project/nginx/src/core/ngx_cycle.c"
   cycle->paths.elts
# 134 "project/nginx/src/core/ngx_cycle.c" 3 4
   , 0, 
# 134 "project/nginx/src/core/ngx_cycle.c"
...
# 134 "project/nginx/src/core/ngx_cycle.c"
    ...
    if (ngx_array_init(&cycle->config_dump, pool, 1, sizeof(ngx_conf_dump_t))
        != 
# 138 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 138 "project/nginx/src/core/ngx_cycle.c"
                )
    {
        ngx_destroy_pool(pool);
        return 
# 141 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 141 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }

    
# 144 "project/nginx/src/core/ngx_cycle.c" 3 4
   ((
# 144 "project/nginx/src/core/ngx_cycle.c"
   &cycle->config_dump_sentinel
# 144 "project/nginx/src/core/ngx_cycle.c" 3 4
   )->color = 0); (
# 144 "project/nginx/src/core/ngx_cycle.c"
...
# 144 "project/nginx/src/core/ngx_cycle.c"
   ngx_str_rbtree_insert_value
    ...
    if (ngx_list_init(&cycle->open_files, pool, n, sizeof(ngx_open_file_t))
        != 
# 158 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 158 "project/nginx/src/core/ngx_cycle.c"
                )
    {
        ngx_destroy_pool(pool);
        return 
# 161 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 161 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    if (ngx_list_init(&cycle->shared_memory, pool, n, sizeof(ngx_shm_zone_t))
        != 
# 177 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 177 "project/nginx/src/core/ngx_cycle.c"
                )
    {
        ngx_destroy_pool(pool);
        return 
# 180 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 180 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    if (ngx_array_init(&cycle->listening, pool, n, sizeof(ngx_listening_t))
        != 
# 186 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 186 "project/nginx/src/core/ngx_cycle.c"
                )
    {
        ngx_destroy_pool(pool);
        return 
# 189 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 189 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }

    
# 192 "project/nginx/src/core/ngx_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 192 "project/nginx/src/core/ngx_cycle.c"
   cycle->listening.elts
# 192 "project/nginx/src/core/ngx_cycle.c" 3 4
   , 0, 
# 192 "project/nginx/src/core/ngx_cycle.c"
   n * sizeof(ngx_listening_t)
# 192 "project/nginx/src/core/ngx_cycle.c" 3 4
   , __builtin_object_size (
# 192 "project/nginx/src/core/ngx_cycle.c"
   cycle->listening.elts
...
# 195 "project/nginx/src/core/ngx_cycle.c" 3 4
   (
# 195 "project/nginx/src/core/ngx_cycle.c"
...
# 195 "project/nginx/src/core/ngx_cycle.c"
   &cycle->reusable_connections_queue;
    ...
    if (cycle->conf_ctx == 
# 199 "project/nginx/src/core/ngx_cycle.c" 3 4
                          ((void *)0)
# 199 "project/nginx/src/core/ngx_cycle.c"
                              ) {
        ngx_destroy_pool(pool);
        return 
# 201 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 201 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }


    if (gethostname(hostname, 
# 205 "project/nginx/src/core/ngx_cycle.c" 3 4
                             256
# 205 "project/nginx/src/core/ngx_cycle.c"
                                               ) == -1) {
        
# 206 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 206 "project/nginx/src/core/ngx_cycle.c"
       log
# 206 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 206 "project/nginx/src/core/ngx_cycle.c"
        ...
        ngx_destroy_pool(pool);
        return 
# 208 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 208 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    hostname[
# 213 "project/nginx/src/core/ngx_cycle.c" 3 4
            256 
# 213 "project/nginx/src/core/ngx_cycle.c"
                               - 1] = '\0';
    cycle->hostname.len = 
# 214 "project/nginx/src/core/ngx_cycle.c" 3 4
                         strlen((const char *) 
# 214 "project/nginx/src/core/ngx_cycle.c"
                         hostname
# 214 "project/nginx/src/core/ngx_cycle.c" 3 4
                         )
# 214 "project/nginx/src/core/ngx_cycle.c"
...
# 217 "project/nginx/src/core/ngx_cycle.c" 3 4
                               ((void *)0)
# 217 "project/nginx/src/core/ngx_cycle.c"
                                   ) {
        ngx_destroy_pool(pool);
        return 
# 219 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 219 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
...
# 225 "project/nginx/src/core/ngx_cycle.c" 3 4
                                   0
# 225 "project/nginx/src/core/ngx_cycle.c"
                                         ) {
        ngx_destroy_pool(pool);
        return 
# 227 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 227 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }


    for (i = 0; cycle->modules[i]; i++) {
        if (cycle->modules[i]->type != 
# 232 "project/nginx/src/core/ngx_cycle.c" 3 4
                                      0x45524F43
# 232 "project/nginx/src/core/ngx_cycle.c"
                                                     ) {
            continue;
        }
        ...
        if (module->create_conf) {
            ...
            if (rv == 
# 240 "project/nginx/src/core/ngx_cycle.c" 3 4
                     ((void *)0)
# 240 "project/nginx/src/core/ngx_cycle.c"
                         ) {
                ngx_destroy_pool(pool);
                return 
# 242 "project/nginx/src/core/ngx_cycle.c" 3 4
                      ((void *)0)
# 242 "project/nginx/src/core/ngx_cycle.c"
                          ;
            }
...
# 252 "project/nginx/src/core/ngx_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 252 "project/nginx/src/core/ngx_cycle.c"
   &conf
# 252 "project/nginx/src/core/ngx_cycle.c" 3 4
   , 0, 
# 252 "project/nginx/src/core/ngx_cycle.c"
...
# 252 "project/nginx/src/core/ngx_cycle.c"
    ...
    if (conf.args == 
# 255 "project/nginx/src/core/ngx_cycle.c" 3 4
                    ((void *)0)
# 255 "project/nginx/src/core/ngx_cycle.c"
                        ) {
        ngx_destroy_pool(pool);
        return 
# 257 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 257 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }

    conf.temp_pool = ngx_create_pool(
# 260 "project/nginx/src/core/ngx_cycle.c" 3 4
                                    (16 * 1024)
# 260 "project/nginx/src/core/ngx_cycle.c"
                                                       , log);
    if (conf.temp_pool == 
# 261 "project/nginx/src/core/ngx_cycle.c" 3 4
                         ((void *)0)
# 261 "project/nginx/src/core/ngx_cycle.c"
                             ) {
        ngx_destroy_pool(pool);
        return 
# 263 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 263 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    conf.log = log;
    conf.module_type = 
# 271 "project/nginx/src/core/ngx_cycle.c" 3 4
                      0x45524F43
# 271 "project/nginx/src/core/ngx_cycle.c"
                                     ;
    conf.cmd_type = 
# 272 "project/nginx/src/core/ngx_cycle.c" 3 4
                   0x01000000
# 272 "project/nginx/src/core/ngx_cycle.c"
                                ;
    ...
    if (ngx_conf_param(&conf) != 
# 278 "project/nginx/src/core/ngx_cycle.c" 3 4
                                ((void *)0)
# 278 "project/nginx/src/core/ngx_cycle.c"
                                           ) {
        environ = senv;
        ngx_destroy_cycle_pools(&conf);
        return 
# 281 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 281 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }

    if (ngx_conf_parse(&conf, &cycle->conf_file) != 
# 284 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                   ((void *)0)
# 284 "project/nginx/src/core/ngx_cycle.c"
                                                              ) {
        environ = senv;
        ngx_destroy_cycle_pools(&conf);
        return 
# 287 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 287 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    for (i = 0; cycle->modules[i]; i++) {
        if (cycle->modules[i]->type != 
# 296 "project/nginx/src/core/ngx_cycle.c" 3 4
                                      0x45524F43
# 296 "project/nginx/src/core/ngx_cycle.c"
                                                     ) {
            continue;
        }
        ...
        if (module->init_conf) {
            if (module->init_conf(cycle,
                ...
                == 
# 305 "project/nginx/src/core/ngx_cycle.c" 3 4
                  (void *) -1
# 305 "project/nginx/src/core/ngx_cycle.c"
                                )
            {
                environ = senv;
                ngx_destroy_cycle_pools(&conf);
                return 
# 309 "project/nginx/src/core/ngx_cycle.c" 3 4
                      ((void *)0)
# 309 "project/nginx/src/core/ngx_cycle.c"
                          ;
            }
        }
    }
    ...
    if (ngx_process == 
# 314 "project/nginx/src/core/ngx_cycle.c" 3 4
                      2
# 314 "project/nginx/src/core/ngx_cycle.c"
                                           ) {
        return cycle;
    }

    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 318 "project/nginx/src/core/ngx_cycle.c" 3 4
                             [
# 318 "project/nginx/src/core/ngx_cycle.c"
                             ngx_core_module
# 318 "project/nginx/src/core/ngx_cycle.c" 3 4
                             .index]
# 318 "project/nginx/src/core/ngx_cycle.c"
...
# 322 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                 0
# 322 "project/nginx/src/core/ngx_cycle.c"
                                                       ) {
            goto failed;
        }

    } else if (!
# 326 "project/nginx/src/core/ngx_cycle.c" 3 4
               (
# 326 "project/nginx/src/core/ngx_cycle.c"
               old_cycle
# 326 "project/nginx/src/core/ngx_cycle.c" 3 4
               ->conf_ctx == ((void *)0))
# 326 "project/nginx/src/core/ngx_cycle.c"
        ...
        old_ccf = (ngx_core_conf_t *) old_cycle->conf_ctx
# 333 "project/nginx/src/core/ngx_cycle.c" 3 4
                                     [
# 333 "project/nginx/src/core/ngx_cycle.c"
                                     ngx_core_module
# 333 "project/nginx/src/core/ngx_cycle.c" 3 4
                                     .index]
                                                                   
# 334 "project/nginx/src/core/ngx_cycle.c"
                                                                  ;
        if (ccf->pid.len != old_ccf->pid.len
            || 
# 336 "project/nginx/src/core/ngx_cycle.c" 3 4
              strcmp((const char *) 
# 336 "project/nginx/src/core/ngx_cycle.c"
              ccf->pid.data
# 336 "project/nginx/src/core/ngx_cycle.c" 3 4
              , (const char *) 
# 336 "project/nginx/src/core/ngx_cycle.c"
...
# 336 "project/nginx/src/core/ngx_cycle.c"
                                                           != 0)
        {
            ...
            if (ngx_create_pidfile(&ccf->pid, log) != 
# 340 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                     0
# 340 "project/nginx/src/core/ngx_cycle.c"
                                                           ) {
                goto failed;
            }
...
# 349 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                        0
# 349 "project/nginx/src/core/ngx_cycle.c"
                                                              ) {
        goto failed;
    }


    if (ngx_create_paths(cycle, ccf->user) != 
# 354 "project/nginx/src/core/ngx_cycle.c" 3 4
                                             0
# 354 "project/nginx/src/core/ngx_cycle.c"
                                                   ) {
        goto failed;
    }


    if (ngx_log_open_default(cycle) != 
# 359 "project/nginx/src/core/ngx_cycle.c" 3 4
                                      0
# 359 "project/nginx/src/core/ngx_cycle.c"
                                            ) {
        goto failed;
    }
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 371 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 371 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
        ...
        file[i].fd = 
# 383 "project/nginx/src/core/ngx_cycle.c" 3 4
                    open((const char *) 
# 383 "project/nginx/src/core/ngx_cycle.c"
                    file[i].name.data
# 383 "project/nginx/src/core/ngx_cycle.c" 3 4
                    , (0x0001|0x00000008)|0x00000200, 0644)


                                                           
# 386 "project/nginx/src/core/ngx_cycle.c"
                                                          ;
        ...
        if (file[i].fd == 
# 392 "project/nginx/src/core/ngx_cycle.c" 3 4
                         -1
# 392 "project/nginx/src/core/ngx_cycle.c"
                                         ) {
            
# 393 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 393 "project/nginx/src/core/ngx_cycle.c"
           log
# 393 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 393 "project/nginx/src/core/ngx_cycle.c"
...
# 395 "project/nginx/src/core/ngx_cycle.c"
                                           ;
            goto failed;
        }
        ...
        if (fcntl(file[i].fd, 
# 400 "project/nginx/src/core/ngx_cycle.c" 3 4
                             2
# 400 "project/nginx/src/core/ngx_cycle.c"
                                    , 
# 400 "project/nginx/src/core/ngx_cycle.c" 3 4
                                      1
# 400 "project/nginx/src/core/ngx_cycle.c"
...
# 401 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 401 "project/nginx/src/core/ngx_cycle.c"
           log
# 401 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 401 "project/nginx/src/core/ngx_cycle.c"
...
# 403 "project/nginx/src/core/ngx_cycle.c"
                                           ;
            goto failed;
        }
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 421 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 421 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
...
# 430 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 430 "project/nginx/src/core/ngx_cycle.c"
           log
# 430 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 430 "project/nginx/src/core/ngx_cycle.c"
...
# 430 "project/nginx/src/core/ngx_cycle.c" 3 4
           , 
# 430 "project/nginx/src/core/ngx_cycle.c"
           0, "zero size shared memory zone \"%V\"", &shm_zone[i].shm.name
# 430 "project/nginx/src/core/ngx_cycle.c" 3 4
           )

                                                
# 432 "project/nginx/src/core/ngx_cycle.c"
                                               ;
            goto failed;
        }
        ...
        for (n = 0; ; n++) {
            ...
            if (n >= opart->nelts) {
                if (opart->next == 
# 444 "project/nginx/src/core/ngx_cycle.c" 3 4
                                  ((void *)0)
# 444 "project/nginx/src/core/ngx_cycle.c"
                                      ) {
                    break;
                }
                opart = opart->next;
            ...
            if (
# 456 "project/nginx/src/core/ngx_cycle.c" 3 4
               strncmp((const char *) 
# 456 "project/nginx/src/core/ngx_cycle.c"
...
# 459 "project/nginx/src/core/ngx_cycle.c"
               != 0)
            {
                continue;
            }
                ...
                && !shm_zone[i].noreuse)
            {
                ...
                if (shm_zone[i].init(&shm_zone[i], oshm_zone[n].data)
                    != 
# 474 "project/nginx/src/core/ngx_cycle.c" 3 4
                      0
# 474 "project/nginx/src/core/ngx_cycle.c"
                            )
                {
                    goto failed;
                }
...
# 485 "project/nginx/src/core/ngx_cycle.c" 3 4
                                              0
# 485 "project/nginx/src/core/ngx_cycle.c"
                                                    ) {
            goto failed;
        }

        if (ngx_init_zone_pool(cycle, &shm_zone[i]) != 
# 489 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                      0
# 489 "project/nginx/src/core/ngx_cycle.c"
                                                            ) {
            goto failed;
        }

        if (shm_zone[i].init(&shm_zone[i], 
# 493 "project/nginx/src/core/ngx_cycle.c" 3 4
                                          ((void *)0)
# 493 "project/nginx/src/core/ngx_cycle.c"
                                              ) != 
# 493 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                   0
# 493 "project/nginx/src/core/ngx_cycle.c"
        ...
        for (n = 0; n < cycle->listening.nelts; n++) {
            ...
            for (i = 0; i < old_cycle->listening.nelts; i++) {
                ...
                if (ngx_cmp_sockaddr(nls[n].sockaddr, nls[n].socklen,
                    ...
                    == 
# 529 "project/nginx/src/core/ngx_cycle.c" 3 4
                      0
# 529 "project/nginx/src/core/ngx_cycle.c"
                            )
                {
                    nls[n].fd = ls[i].fd;
...
# 577 "project/nginx/src/core/ngx_cycle.c"
            ...
            if (nls[n].fd == (ngx_socket_t) -1) {
                nls[n].open = 1;
# 598 "project/nginx/src/core/ngx_cycle.c"
            }
        }
        ...
        for (i = 0; i < cycle->listening.nelts; i++) {
            ls[i].open = 1;
# 615 "project/nginx/src/core/ngx_cycle.c"
        }
    }

    if (ngx_open_listening_sockets(cycle) != 
# 618 "project/nginx/src/core/ngx_cycle.c" 3 4
                                            0
# 618 "project/nginx/src/core/ngx_cycle.c"
                                                  ) {
        goto failed;
    }
...
# 635 "project/nginx/src/core/ngx_cycle.c" 3 4
                                  0
# 635 "project/nginx/src/core/ngx_cycle.c"
                                        ) {
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= opart->nelts) {
            if (opart->next == 
# 651 "project/nginx/src/core/ngx_cycle.c" 3 4
                              ((void *)0)
# 651 "project/nginx/src/core/ngx_cycle.c"
                                  ) {
        ...
        for (n = 0; ; n++) {
            ...
            if (n >= part->nelts) {
                if (part->next == 
# 665 "project/nginx/src/core/ngx_cycle.c" 3 4
                                 ((void *)0)
# 665 "project/nginx/src/core/ngx_cycle.c"
                                     ) {
                    break;
                }
                part = part->next;
            ...
            if (
# 677 "project/nginx/src/core/ngx_cycle.c" 3 4
               strncmp((const char *) 
# 677 "project/nginx/src/core/ngx_cycle.c"
               oshm_zone[i].shm.name.data
# 677 "project/nginx/src/core/ngx_cycle.c" 3 4
               , (const char *) 
# 677 "project/nginx/src/core/ngx_cycle.c"
...
# 680 "project/nginx/src/core/ngx_cycle.c"
               != 0)
            {
                continue;
            }
...
old_shm_zone_done:
    ...
    for (i = 0; i < old_cycle->listening.nelts; i++) {
        ...
        if (
# 714 "project/nginx/src/core/ngx_cycle.c" 3 4
           close
# 714 "project/nginx/src/core/ngx_cycle.c"
                           (ls[i].fd) == -1) {
            
# 715 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 715 "project/nginx/src/core/ngx_cycle.c"
           log
# 715 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 715 "project/nginx/src/core/ngx_cycle.c"
...
# 717 "project/nginx/src/core/ngx_cycle.c"
                                          ;
        }



        if (ls[i].sockaddr->sa_family == 
# 722 "project/nginx/src/core/ngx_cycle.c" 3 4
                                        1
# 722 "project/nginx/src/core/ngx_cycle.c"
                                               ) {
            u_char *name;
...
# 727 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 727 "project/nginx/src/core/ngx_cycle.c"
           cycle->log
# 727 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 727 "project/nginx/src/core/ngx_cycle.c" 3 4
           , 
# 727 "project/nginx/src/core/ngx_cycle.c"
           0, "deleting socket %s", name
# 727 "project/nginx/src/core/ngx_cycle.c" 3 4
           )
                                                     
# 728 "project/nginx/src/core/ngx_cycle.c"
                                                    ;

            if (
# 730 "project/nginx/src/core/ngx_cycle.c" 3 4
               unlink((const char *) 
# 730 "project/nginx/src/core/ngx_cycle.c"
               name
# 730 "project/nginx/src/core/ngx_cycle.c" 3 4
               ) 
# 730 "project/nginx/src/core/ngx_cycle.c"
...
# 731 "project/nginx/src/core/ngx_cycle.c" 3 4
               if ((
# 731 "project/nginx/src/core/ngx_cycle.c"
               cycle->log
# 731 "project/nginx/src/core/ngx_cycle.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 731 "project/nginx/src/core/ngx_cycle.c"
...
# 732 "project/nginx/src/core/ngx_cycle.c"
                                                                  ;
            }
        }
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 748 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 748 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
        ...
        if (file[i].fd == 
# 756 "project/nginx/src/core/ngx_cycle.c" 3 4
                         -1 
# 756 "project/nginx/src/core/ngx_cycle.c"
                                          || file[i].fd == 
# 756 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                           2
# 756 "project/nginx/src/core/ngx_cycle.c"
        ...
        if (
# 760 "project/nginx/src/core/ngx_cycle.c" 3 4
           close
# 760 "project/nginx/src/core/ngx_cycle.c"
                         (file[i].fd) == 
# 760 "project/nginx/src/core/ngx_cycle.c" 3 4
                                         -1
# 760 "project/nginx/src/core/ngx_cycle.c"
...
# 761 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 761 "project/nginx/src/core/ngx_cycle.c"
           log
# 761 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 761 "project/nginx/src/core/ngx_cycle.c"
...
# 763 "project/nginx/src/core/ngx_cycle.c"
                                           ;
        }
    }
    ...
    if (ngx_process == 
# 769 "project/nginx/src/core/ngx_cycle.c" 3 4
                      1 
# 769 "project/nginx/src/core/ngx_cycle.c"
                                         || 
# 769 "project/nginx/src/core/ngx_cycle.c" 3 4
                                            (
# 769 "project/nginx/src/core/ngx_cycle.c"
...
# 769 "project/nginx/src/core/ngx_cycle.c"
        ...
        cycle->old_cycle = 
# 772 "project/nginx/src/core/ngx_cycle.c" 3 4
                          ((void *)0)
# 772 "project/nginx/src/core/ngx_cycle.c"
                              ;
    ...
    if (ngx_temp_pool == 
# 778 "project/nginx/src/core/ngx_cycle.c" 3 4
                        ((void *)0)
# 778 "project/nginx/src/core/ngx_cycle.c"
                            ) {
        ngx_temp_pool = ngx_create_pool(128, cycle->log);
        if (ngx_temp_pool == 
# 780 "project/nginx/src/core/ngx_cycle.c" 3 4
                            ((void *)0)
# 780 "project/nginx/src/core/ngx_cycle.c"
                                ) {
            
# 781 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 781 "project/nginx/src/core/ngx_cycle.c"
           cycle->log
# 781 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 781 "project/nginx/src/core/ngx_cycle.c"
...
# 781 "project/nginx/src/core/ngx_cycle.c" 3 4
           , 
# 781 "project/nginx/src/core/ngx_cycle.c"
           0, "could not create ngx_temp_pool"
# 781 "project/nginx/src/core/ngx_cycle.c" 3 4
           )
                                                           
# 782 "project/nginx/src/core/ngx_cycle.c"
                                                          ;
            exit(1);
        }
        ...
        if (ngx_array_init(&ngx_old_cycles, ngx_temp_pool, n,
                           sizeof(ngx_cycle_t *))
            != 
# 790 "project/nginx/src/core/ngx_cycle.c" 3 4
              0
# 790 "project/nginx/src/core/ngx_cycle.c"
                    )
        {
            exit(1);
        }
...
# 795 "project/nginx/src/core/ngx_cycle.c" 3 4
       (void) __builtin___memset_chk (
# 795 "project/nginx/src/core/ngx_cycle.c"
       ngx_old_cycles.elts
# 795 "project/nginx/src/core/ngx_cycle.c" 3 4
       , 0, 
# 795 "project/nginx/src/core/ngx_cycle.c"
...
# 795 "project/nginx/src/core/ngx_cycle.c"
    ...
    if (old == 
# 806 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 806 "project/nginx/src/core/ngx_cycle.c"
                  ) {
        exit(1);
    }
    *old = old_cycle;
...
# 812 "project/nginx/src/core/ngx_cycle.c" 3 4
       ngx_event_add_timer
# 812 "project/nginx/src/core/ngx_cycle.c"
                    (&ngx_cleaner_event, 30000);
...
failed:
    ...
    if (!
# 821 "project/nginx/src/core/ngx_cycle.c" 3 4
        (
# 821 "project/nginx/src/core/ngx_cycle.c"
        old_cycle
# 821 "project/nginx/src/core/ngx_cycle.c" 3 4
        ->conf_ctx == ((void *)0))
# 821 "project/nginx/src/core/ngx_cycle.c"
        ...
        old_ccf = (ngx_core_conf_t *) old_cycle->conf_ctx
# 822 "project/nginx/src/core/ngx_cycle.c" 3 4
                                     [
# 822 "project/nginx/src/core/ngx_cycle.c"
                                     ngx_core_module
# 822 "project/nginx/src/core/ngx_cycle.c" 3 4
                                     .index]
                                                                   
# 823 "project/nginx/src/core/ngx_cycle.c"
                                                                  ;
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 837 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 837 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
        ...
        if (file[i].fd == 
# 845 "project/nginx/src/core/ngx_cycle.c" 3 4
                         -1 
# 845 "project/nginx/src/core/ngx_cycle.c"
                                          || file[i].fd == 
# 845 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                           2
# 845 "project/nginx/src/core/ngx_cycle.c"
        ...
        if (
# 849 "project/nginx/src/core/ngx_cycle.c" 3 4
           close
# 849 "project/nginx/src/core/ngx_cycle.c"
                         (file[i].fd) == 
# 849 "project/nginx/src/core/ngx_cycle.c" 3 4
                                         -1
# 849 "project/nginx/src/core/ngx_cycle.c"
...
# 850 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 850 "project/nginx/src/core/ngx_cycle.c"
           log
# 850 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 850 "project/nginx/src/core/ngx_cycle.c"
...
# 852 "project/nginx/src/core/ngx_cycle.c"
                                           ;
        }
    }
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 864 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 864 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
...
# 872 "project/nginx/src/core/ngx_cycle.c" 3 4
                                   ((void *)0)
# 872 "project/nginx/src/core/ngx_cycle.c"
                                       ) {
            continue;
        }
        ...
        for (n = 0; ; n++) {
            ...
            if (n >= opart->nelts) {
                if (opart->next == 
# 882 "project/nginx/src/core/ngx_cycle.c" 3 4
                                  ((void *)0)
# 882 "project/nginx/src/core/ngx_cycle.c"
                                      ) {
                    break;
                }
                opart = opart->next;
            ...
            if (
# 894 "project/nginx/src/core/ngx_cycle.c" 3 4
               strncmp((const char *) 
# 894 "project/nginx/src/core/ngx_cycle.c"
               shm_zone[i].shm.name.data
# 894 "project/nginx/src/core/ngx_cycle.c" 3 4
               , (const char *) 
# 894 "project/nginx/src/core/ngx_cycle.c"
...
# 897 "project/nginx/src/core/ngx_cycle.c"
               != 0)
            {
                continue;
            }
    ...
    if (ngx_test_config) {
        ngx_destroy_cycle_pools(&conf);
        return 
# 921 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 921 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ...
        if (
# 930 "project/nginx/src/core/ngx_cycle.c" 3 4
           close
# 930 "project/nginx/src/core/ngx_cycle.c"
                           (ls[i].fd) == -1) {
            
# 931 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 931 "project/nginx/src/core/ngx_cycle.c"
           log
# 931 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 931 "project/nginx/src/core/ngx_cycle.c"
...
# 933 "project/nginx/src/core/ngx_cycle.c"
                                          ;
        }
    }
    ...
    return 
# 939 "project/nginx/src/core/ngx_cycle.c" 3 4
          ((void *)0)
# 939 "project/nginx/src/core/ngx_cycle.c"
              ;
}
...
ngx_init_zone_pool(ngx_cycle_t *cycle, ngx_shm_zone_t *zn)
{
    ...
    if (zn->shm.exists) {
        ...
        if (sp == sp->addr) {
            return 
# 962 "project/nginx/src/core/ngx_cycle.c" 3 4
                  0
# 962 "project/nginx/src/core/ngx_cycle.c"
                        ;
        }
# 981 "project/nginx/src/core/ngx_cycle.c"
        
# 981 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 981 "project/nginx/src/core/ngx_cycle.c"
       cycle->log
# 981 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 981 "project/nginx/src/core/ngx_cycle.c" 3 4
       , 
# 981 "project/nginx/src/core/ngx_cycle.c"
       0, "shared zone \"%V\" has no equal addresses: %p vs %p", &zn->shm.name, sp->addr, sp
# 981 "project/nginx/src/core/ngx_cycle.c" 3 4
       )

                                                  
# 983 "project/nginx/src/core/ngx_cycle.c"
                                                 ;
        return 
# 984 "project/nginx/src/core/ngx_cycle.c" 3 4
              -1
# 984 "project/nginx/src/core/ngx_cycle.c"
                       ;
    }
    ...
    file = 
# 993 "project/nginx/src/core/ngx_cycle.c" 3 4
          ((void *)0)
# 993 "project/nginx/src/core/ngx_cycle.c"
              ;
# 1007 "project/nginx/src/core/ngx_cycle.c"
    if (ngx_shmtx_create(&sp->mutex, &sp->lock, file) != 
# 1007 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                        0
# 1007 "project/nginx/src/core/ngx_cycle.c"
                                                              ) {
        return 
# 1008 "project/nginx/src/core/ngx_cycle.c" 3 4
              -1
# 1008 "project/nginx/src/core/ngx_cycle.c"
                       ;
    }
    ...
    return 
# 1013 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 1013 "project/nginx/src/core/ngx_cycle.c"
                ;
}
...
ngx_create_pidfile(ngx_str_t *name, ngx_log_t *log)
{
    ...
    ngx_file_t file;
    u_char pid[
# 1024 "project/nginx/src/core/ngx_cycle.c" 3 4
                   (sizeof("-9223372036854775808") - 1) 
# 1024 "project/nginx/src/core/ngx_cycle.c"
                                 + 2];

    if (ngx_process > 
# 1026 "project/nginx/src/core/ngx_cycle.c" 3 4
                     1
# 1026 "project/nginx/src/core/ngx_cycle.c"
                                       ) {
        return 
# 1027 "project/nginx/src/core/ngx_cycle.c" 3 4
              0
# 1027 "project/nginx/src/core/ngx_cycle.c"
                    ;
    }

    
# 1030 "project/nginx/src/core/ngx_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 1030 "project/nginx/src/core/ngx_cycle.c"
   &file
# 1030 "project/nginx/src/core/ngx_cycle.c" 3 4
   , 0, 
# 1030 "project/nginx/src/core/ngx_cycle.c"
...
# 1030 "project/nginx/src/core/ngx_cycle.c"
    ...
    create = ngx_test_config ? 
# 1035 "project/nginx/src/core/ngx_cycle.c" 3 4
                              0x00000200 
# 1035 "project/nginx/src/core/ngx_cycle.c"
                                                      : 
# 1035 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 1035 "project/nginx/src/core/ngx_cycle.c"
    ...
    file.fd = 
# 1037 "project/nginx/src/core/ngx_cycle.c" 3 4
             open((const char *) 
# 1037 "project/nginx/src/core/ngx_cycle.c"
             file.name.data
# 1037 "project/nginx/src/core/ngx_cycle.c" 3 4
             , 0x0002|
# 1037 "project/nginx/src/core/ngx_cycle.c"
...
# 1038 "project/nginx/src/core/ngx_cycle.c"
                                                           ;

    if (file.fd == 
# 1040 "project/nginx/src/core/ngx_cycle.c" 3 4
                  -1
# 1040 "project/nginx/src/core/ngx_cycle.c"
                                  ) {
        
# 1041 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 1041 "project/nginx/src/core/ngx_cycle.c"
       log
# 1041 "project/nginx/src/core/ngx_cycle.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 1041 "project/nginx/src/core/ngx_cycle.c"
...
# 1042 "project/nginx/src/core/ngx_cycle.c"
                                                                      ;
        return 
# 1043 "project/nginx/src/core/ngx_cycle.c" 3 4
              -1
# 1043 "project/nginx/src/core/ngx_cycle.c"
                       ;
    }

    rc = 
# 1046 "project/nginx/src/core/ngx_cycle.c" 3 4
        0
# 1046 "project/nginx/src/core/ngx_cycle.c"
              ;

    if (!ngx_test_config) {
        len = ngx_snprintf(pid, 
# 1049 "project/nginx/src/core/ngx_cycle.c" 3 4
                               (sizeof("-9223372036854775808") - 1) 
# 1049 "project/nginx/src/core/ngx_cycle.c"
                                             + 2, "%P%N", ngx_pid) - pid;

        if (ngx_write_file(&file, pid, len, 0) == 
# 1051 "project/nginx/src/core/ngx_cycle.c" 3 4
                                                 -1
# 1051 "project/nginx/src/core/ngx_cycle.c"
                                                          ) {
            rc = 
# 1052 "project/nginx/src/core/ngx_cycle.c" 3 4
                -1
# 1052 "project/nginx/src/core/ngx_cycle.c"
                         ;
        }
    }

    if (
# 1056 "project/nginx/src/core/ngx_cycle.c" 3 4
       close
# 1056 "project/nginx/src/core/ngx_cycle.c"
                     (file.fd) == 
# 1056 "project/nginx/src/core/ngx_cycle.c" 3 4
                                  -1
# 1056 "project/nginx/src/core/ngx_cycle.c"
...
# 1057 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 1057 "project/nginx/src/core/ngx_cycle.c"
       log
# 1057 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 1058 "project/nginx/src/core/ngx_cycle.c"
                                                                       ;
    }
...
ngx_delete_pidfile(ngx_cycle_t *cycle)
{
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 1071 "project/nginx/src/core/ngx_cycle.c" 3 4
                             [
# 1071 "project/nginx/src/core/ngx_cycle.c"
                             ngx_core_module
# 1071 "project/nginx/src/core/ngx_cycle.c" 3 4
                             .index]
# 1071 "project/nginx/src/core/ngx_cycle.c"
    ...
    if (
# 1075 "project/nginx/src/core/ngx_cycle.c" 3 4
       unlink((const char *) 
# 1075 "project/nginx/src/core/ngx_cycle.c"
       name
# 1075 "project/nginx/src/core/ngx_cycle.c" 3 4
       ) 
# 1075 "project/nginx/src/core/ngx_cycle.c"
...
# 1076 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 1076 "project/nginx/src/core/ngx_cycle.c"
       cycle->log
# 1076 "project/nginx/src/core/ngx_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1076 "project/nginx/src/core/ngx_cycle.c"
...
# 1077 "project/nginx/src/core/ngx_cycle.c"
                                                              ;
    }
}
...
ngx_signal_process(ngx_cycle_t *cycle, char *sig)
{
    ...
    ngx_core_conf_t *ccf;
    u_char buf[
# 1089 "project/nginx/src/core/ngx_cycle.c" 3 4
                         (sizeof("-9223372036854775808") - 1) 
# 1089 "project/nginx/src/core/ngx_cycle.c"
                                       + 2];

    
# 1091 "project/nginx/src/core/ngx_cycle.c" 3 4
   if ((
# 1091 "project/nginx/src/core/ngx_cycle.c"
   cycle->log
# 1091 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 1091 "project/nginx/src/core/ngx_cycle.c"
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 1093 "project/nginx/src/core/ngx_cycle.c" 3 4
                             [
# 1093 "project/nginx/src/core/ngx_cycle.c"
                             ngx_core_module
# 1093 "project/nginx/src/core/ngx_cycle.c" 3 4
                             .index]
# 1093 "project/nginx/src/core/ngx_cycle.c"
...
# 1095 "project/nginx/src/core/ngx_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 1095 "project/nginx/src/core/ngx_cycle.c"
   &file
# 1095 "project/nginx/src/core/ngx_cycle.c" 3 4
   , 0, 
# 1095 "project/nginx/src/core/ngx_cycle.c"
...
# 1095 "project/nginx/src/core/ngx_cycle.c"
    ...
    file.fd = 
# 1100 "project/nginx/src/core/ngx_cycle.c" 3 4
             open((const char *) 
# 1100 "project/nginx/src/core/ngx_cycle.c"
             file.name.data
# 1100 "project/nginx/src/core/ngx_cycle.c" 3 4
             , 0x0000|0, 0644)
                                                                   
# 1101 "project/nginx/src/core/ngx_cycle.c"
                                                                  ;

    if (file.fd == 
# 1103 "project/nginx/src/core/ngx_cycle.c" 3 4
                  -1
# 1103 "project/nginx/src/core/ngx_cycle.c"
                                  ) {
        
# 1104 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 1104 "project/nginx/src/core/ngx_cycle.c"
       cycle->log
# 1104 "project/nginx/src/core/ngx_cycle.c" 3 4
...
# 1105 "project/nginx/src/core/ngx_cycle.c"
                                                                      ;
        return 1;
    }

    n = ngx_read_file(&file, buf, 
# 1109 "project/nginx/src/core/ngx_cycle.c" 3 4
                                 (sizeof("-9223372036854775808") - 1) 
# 1109 "project/nginx/src/core/ngx_cycle.c"
                                               + 2, 0);

    if (
# 1111 "project/nginx/src/core/ngx_cycle.c" 3 4
       close
# 1111 "project/nginx/src/core/ngx_cycle.c"
                     (file.fd) == 
# 1111 "project/nginx/src/core/ngx_cycle.c" 3 4
                                  -1
# 1111 "project/nginx/src/core/ngx_cycle.c"
...
# 1112 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 1112 "project/nginx/src/core/ngx_cycle.c"
       cycle->log
# 1112 "project/nginx/src/core/ngx_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1112 "project/nginx/src/core/ngx_cycle.c"
...
# 1113 "project/nginx/src/core/ngx_cycle.c"
                                                                       ;
    }

    if (n == 
# 1116 "project/nginx/src/core/ngx_cycle.c" 3 4
            -1
# 1116 "project/nginx/src/core/ngx_cycle.c"
                     ) {
        return 1;
    }

    while (n-- && (buf[n] == 
# 1120 "project/nginx/src/core/ngx_cycle.c" 3 4
                            (u_char) '\r' 
# 1120 "project/nginx/src/core/ngx_cycle.c"
                               || buf[n] == 
# 1120 "project/nginx/src/core/ngx_cycle.c" 3 4
                                            (u_char) '\n'
# 1120 "project/nginx/src/core/ngx_cycle.c"
    ...
    if (pid == (ngx_pid_t) 
# 1124 "project/nginx/src/core/ngx_cycle.c" 3 4
                          -1
# 1124 "project/nginx/src/core/ngx_cycle.c"
                                   ) {
        
# 1125 "project/nginx/src/core/ngx_cycle.c" 3 4
       if ((
# 1125 "project/nginx/src/core/ngx_cycle.c"
       cycle->log
# 1125 "project/nginx/src/core/ngx_cycle.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 1125 "project/nginx/src/core/ngx_cycle.c"
...
# 1125 "project/nginx/src/core/ngx_cycle.c" 3 4
       , 
# 1125 "project/nginx/src/core/ngx_cycle.c"
       0, "invalid PID number \"%*s\" in \"%s\"", n, buf, file.name.data
# 1125 "project/nginx/src/core/ngx_cycle.c" 3 4
       )

                                             
# 1127 "project/nginx/src/core/ngx_cycle.c"
                                            ;
        return 1;
    }
...
{
# 1163 "project/nginx/src/core/ngx_cycle.c"
    return 
# 1163 "project/nginx/src/core/ngx_cycle.c" 3 4
          0
# 1163 "project/nginx/src/core/ngx_cycle.c"
                ;
}
...
ngx_reopen_files(ngx_cycle_t *cycle, ngx_uid_t user)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 1181 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 1181 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
        ...
        fd = 
# 1197 "project/nginx/src/core/ngx_cycle.c" 3 4
            open((const char *) 
# 1197 "project/nginx/src/core/ngx_cycle.c"
            file[i].name.data
# 1197 "project/nginx/src/core/ngx_cycle.c" 3 4
            , (0x0001|0x00000008)|0x00000200, 0644)
                                                                            
# 1198 "project/nginx/src/core/ngx_cycle.c"
                                                                           ;
        ...
        if (fd == 
# 1204 "project/nginx/src/core/ngx_cycle.c" 3 4
                 -1
# 1204 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
            
# 1205 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 1205 "project/nginx/src/core/ngx_cycle.c"
           cycle->log
# 1205 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1205 "project/nginx/src/core/ngx_cycle.c"
...
# 1206 "project/nginx/src/core/ngx_cycle.c"
                                                                             ;
            continue;
        }
        ...
        if (user != (ngx_uid_t) 
# 1211 "project/nginx/src/core/ngx_cycle.c" 3 4
                               (ngx_uint_t) -1
# 1211 "project/nginx/src/core/ngx_cycle.c"
                                                  ) {
            ngx_file_info_t fi;

            if (
# 1214 "project/nginx/src/core/ngx_cycle.c" 3 4
               stat((const char *) 
# 1214 "project/nginx/src/core/ngx_cycle.c"
               file[i].name.data
# 1214 "project/nginx/src/core/ngx_cycle.c" 3 4
               , 
# 1214 "project/nginx/src/core/ngx_cycle.c"
...
# 1215 "project/nginx/src/core/ngx_cycle.c" 3 4
               if ((
# 1215 "project/nginx/src/core/ngx_cycle.c"
               cycle->log
# 1215 "project/nginx/src/core/ngx_cycle.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 1215 "project/nginx/src/core/ngx_cycle.c"
...
# 1217 "project/nginx/src/core/ngx_cycle.c"
                                               ;

                if (
# 1219 "project/nginx/src/core/ngx_cycle.c" 3 4
                   close
# 1219 "project/nginx/src/core/ngx_cycle.c"
                                 (fd) == 
# 1219 "project/nginx/src/core/ngx_cycle.c" 3 4
                                         -1
# 1219 "project/nginx/src/core/ngx_cycle.c"
...
# 1220 "project/nginx/src/core/ngx_cycle.c" 3 4
                   if ((
# 1220 "project/nginx/src/core/ngx_cycle.c"
                   cycle->log
# 1220 "project/nginx/src/core/ngx_cycle.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 1220 "project/nginx/src/core/ngx_cycle.c"
...
# 1222 "project/nginx/src/core/ngx_cycle.c"
                                                   ;
                }
...
# 1230 "project/nginx/src/core/ngx_cycle.c" 3 4
                   if ((
# 1230 "project/nginx/src/core/ngx_cycle.c"
                   cycle->log
# 1230 "project/nginx/src/core/ngx_cycle.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 1230 "project/nginx/src/core/ngx_cycle.c"
...
# 1230 "project/nginx/src/core/ngx_cycle.c" 3 4
                   , (*__error())
# 1230 "project/nginx/src/core/ngx_cycle.c"
                   , "chown(\"%s\", %d) failed", file[i].name.data, user
# 1230 "project/nginx/src/core/ngx_cycle.c" 3 4
                   )

                                                          
# 1232 "project/nginx/src/core/ngx_cycle.c"
                                                         ;

                    if (
# 1234 "project/nginx/src/core/ngx_cycle.c" 3 4
                       close
# 1234 "project/nginx/src/core/ngx_cycle.c"
                                     (fd) == 
# 1234 "project/nginx/src/core/ngx_cycle.c" 3 4
                                             -1
# 1234 "project/nginx/src/core/ngx_cycle.c"
...
# 1235 "project/nginx/src/core/ngx_cycle.c" 3 4
                       if ((
# 1235 "project/nginx/src/core/ngx_cycle.c"
                       cycle->log
# 1235 "project/nginx/src/core/ngx_cycle.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 1235 "project/nginx/src/core/ngx_cycle.c"
...
# 1237 "project/nginx/src/core/ngx_cycle.c"
                                                       ;
                    }
            ...
            if ((fi.st_mode & (
# 1244 "project/nginx/src/core/ngx_cycle.c" 3 4
                              0000400
# 1244 "project/nginx/src/core/ngx_cycle.c"
                                     |
# 1244 "project/nginx/src/core/ngx_cycle.c" 3 4
                                      0000200
# 1244 "project/nginx/src/core/ngx_cycle.c"
...
# 1246 "project/nginx/src/core/ngx_cycle.c" 3 4
                              0000400
# 1246 "project/nginx/src/core/ngx_cycle.c"
                                     |
# 1246 "project/nginx/src/core/ngx_cycle.c" 3 4
                                      0000200
# 1246 "project/nginx/src/core/ngx_cycle.c"
...
# 1249 "project/nginx/src/core/ngx_cycle.c" 3 4
                   if ((
# 1249 "project/nginx/src/core/ngx_cycle.c"
                   cycle->log
# 1249 "project/nginx/src/core/ngx_cycle.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 1249 "project/nginx/src/core/ngx_cycle.c"
...
# 1250 "project/nginx/src/core/ngx_cycle.c"
                                                                            ;

                    if (
# 1252 "project/nginx/src/core/ngx_cycle.c" 3 4
                       close
# 1252 "project/nginx/src/core/ngx_cycle.c"
                                     (fd) == 
# 1252 "project/nginx/src/core/ngx_cycle.c" 3 4
                                             -1
# 1252 "project/nginx/src/core/ngx_cycle.c"
...
# 1253 "project/nginx/src/core/ngx_cycle.c" 3 4
                       if ((
# 1253 "project/nginx/src/core/ngx_cycle.c"
                       cycle->log
# 1253 "project/nginx/src/core/ngx_cycle.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 1253 "project/nginx/src/core/ngx_cycle.c"
...
# 1255 "project/nginx/src/core/ngx_cycle.c"
                                                       ;
                    }
        ...
        if (fcntl(fd, 
# 1263 "project/nginx/src/core/ngx_cycle.c" 3 4
                     2
# 1263 "project/nginx/src/core/ngx_cycle.c"
                            , 
# 1263 "project/nginx/src/core/ngx_cycle.c" 3 4
                              1
# 1263 "project/nginx/src/core/ngx_cycle.c"
...
# 1264 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 1264 "project/nginx/src/core/ngx_cycle.c"
           cycle->log
# 1264 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1264 "project/nginx/src/core/ngx_cycle.c"
...
# 1266 "project/nginx/src/core/ngx_cycle.c"
                                           ;

            if (
# 1268 "project/nginx/src/core/ngx_cycle.c" 3 4
               close
# 1268 "project/nginx/src/core/ngx_cycle.c"
                             (fd) == 
# 1268 "project/nginx/src/core/ngx_cycle.c" 3 4
                                     -1
# 1268 "project/nginx/src/core/ngx_cycle.c"
...
# 1269 "project/nginx/src/core/ngx_cycle.c" 3 4
               if ((
# 1269 "project/nginx/src/core/ngx_cycle.c"
               cycle->log
# 1269 "project/nginx/src/core/ngx_cycle.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 1269 "project/nginx/src/core/ngx_cycle.c"
...
# 1271 "project/nginx/src/core/ngx_cycle.c"
                                               ;
            }
        ...
        if (
# 1278 "project/nginx/src/core/ngx_cycle.c" 3 4
           close
# 1278 "project/nginx/src/core/ngx_cycle.c"
                         (file[i].fd) == 
# 1278 "project/nginx/src/core/ngx_cycle.c" 3 4
                                         -1
# 1278 "project/nginx/src/core/ngx_cycle.c"
...
# 1279 "project/nginx/src/core/ngx_cycle.c" 3 4
           if ((
# 1279 "project/nginx/src/core/ngx_cycle.c"
           cycle->log
# 1279 "project/nginx/src/core/ngx_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1279 "project/nginx/src/core/ngx_cycle.c"
...
# 1281 "project/nginx/src/core/ngx_cycle.c"
                                           ;
        }
...
ngx_shared_memory_add(ngx_conf_t *cf, ngx_str_t *name, size_t size, void *tag)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 1304 "project/nginx/src/core/ngx_cycle.c" 3 4
                             ((void *)0)
# 1304 "project/nginx/src/core/ngx_cycle.c"
                                 ) {
                break;
            }
            part = part->next;
        ...
        if (
# 1316 "project/nginx/src/core/ngx_cycle.c" 3 4
           strncmp((const char *) 
# 1316 "project/nginx/src/core/ngx_cycle.c"
           name->data
# 1316 "project/nginx/src/core/ngx_cycle.c" 3 4
           , (const char *) 
# 1316 "project/nginx/src/core/ngx_cycle.c"
...
# 1317 "project/nginx/src/core/ngx_cycle.c"
           != 0)
        {
            continue;
        }
        ...
        if (tag != shm_zone[i].tag) {
            ngx_conf_log_error(
# 1323 "project/nginx/src/core/ngx_cycle.c" 3 4
                              1
# 1323 "project/nginx/src/core/ngx_cycle.c"
                                           , cf, 0,
                            "the shared memory zone \"%V\" is "
                            "already declared for a different use",
                            &shm_zone[i].shm.name);
            return 
# 1327 "project/nginx/src/core/ngx_cycle.c" 3 4
                  ((void *)0)
# 1327 "project/nginx/src/core/ngx_cycle.c"
                      ;
        }
        ...
        if (size && size != shm_zone[i].shm.size) {
            ngx_conf_log_error(
# 1335 "project/nginx/src/core/ngx_cycle.c" 3 4
                              1
# 1335 "project/nginx/src/core/ngx_cycle.c"
                                           , cf, 0,
                            "the size %uz of shared memory zone \"%V\" "
                            "conflicts with already declared size %uz",
                            size, &shm_zone[i].shm.name, shm_zone[i].shm.size);
            return 
# 1339 "project/nginx/src/core/ngx_cycle.c" 3 4
                  ((void *)0)
# 1339 "project/nginx/src/core/ngx_cycle.c"
                      ;
        }
    ...
    if (shm_zone == 
# 1347 "project/nginx/src/core/ngx_cycle.c" 3 4
                   ((void *)0)
# 1347 "project/nginx/src/core/ngx_cycle.c"
                       ) {
        return 
# 1348 "project/nginx/src/core/ngx_cycle.c" 3 4
              ((void *)0)
# 1348 "project/nginx/src/core/ngx_cycle.c"
                  ;
    }

    shm_zone->data = 
# 1351 "project/nginx/src/core/ngx_cycle.c" 3 4
                    ((void *)0)
# 1351 "project/nginx/src/core/ngx_cycle.c"
                        ;
    shm_zone->shm.log = cf->cycle->log;
    shm_zone->shm.addr = 
# 1353 "project/nginx/src/core/ngx_cycle.c" 3 4
                        ((void *)0)
# 1353 "project/nginx/src/core/ngx_cycle.c"
                            ;
    shm_zone->shm.size = size;
    shm_zone->shm.name = *name;
    shm_zone->shm.exists = 0;
    shm_zone->init = 
# 1357 "project/nginx/src/core/ngx_cycle.c" 3 4
                    ((void *)0)
# 1357 "project/nginx/src/core/ngx_cycle.c"
                        ;
    shm_zone->tag = tag;
    shm_zone->noreuse = 0;
...
ngx_clean_old_cycles(ngx_event_t *ev)
{
    ...
    for (i = 0; i < ngx_old_cycles.nelts; i++) {
        ...
        if (cycle[i] == 
# 1382 "project/nginx/src/core/ngx_cycle.c" 3 4
                       ((void *)0)
# 1382 "project/nginx/src/core/ngx_cycle.c"
                           ) {
            continue;
        }
        ...
        cycle[i] = 
# 1406 "project/nginx/src/core/ngx_cycle.c" 3 4
                  ((void *)0)
# 1406 "project/nginx/src/core/ngx_cycle.c"
                      ;
    }
...
# 1412 "project/nginx/src/core/ngx_cycle.c" 3 4
       ngx_event_add_timer
# 1412 "project/nginx/src/core/ngx_cycle.c"
                    (ev, 30000);

    } else {
        ngx_destroy_pool(ngx_temp_pool);
        ngx_temp_pool = 
# 1416 "project/nginx/src/core/ngx_cycle.c" 3 4
                       ((void *)0)
# 1416 "project/nginx/src/core/ngx_cycle.c"
                           ;
...
ngx_set_shutdown_timer(ngx_cycle_t *cycle)
{
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 1427 "project/nginx/src/core/ngx_cycle.c" 3 4
                             [
# 1427 "project/nginx/src/core/ngx_cycle.c"
                             ngx_core_module
# 1427 "project/nginx/src/core/ngx_cycle.c" 3 4
                             .index]
# 1427 "project/nginx/src/core/ngx_cycle.c"
...
# 1435 "project/nginx/src/core/ngx_cycle.c" 3 4
       ngx_event_add_timer
# 1435 "project/nginx/src/core/ngx_cycle.c"
                    (&ngx_shutdown_event, ccf->shutdown_timeout);
    }
}
...
ngx_shutdown_timer_handler(ngx_event_t *ev)
{
    ...
    for (i = 0; i < cycle->connection_n; i++) {
        ...
        if (c[i].fd == (ngx_socket_t) -1
            || c[i].read == 
# 1454 "project/nginx/src/core/ngx_cycle.c" 3 4
                           ((void *)0)
            
# 1455 "project/nginx/src/core/ngx_cycle.c"
           || c[i].read->accept
            || c[i].read->channel
            || c[i].read->resolver)
        {
