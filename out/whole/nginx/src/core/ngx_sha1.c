# 0 "project/nginx/src/core/ngx_sha1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 11 "project/nginx/src/core/ngx_sha1.c" 2
...
# 12 "project/nginx/src/core/ngx_sha1.c" 2
...
# 13 "project/nginx/src/core/ngx_sha1.c" 2



# 15 "project/nginx/src/core/ngx_sha1.c"
...
# 44 "project/nginx/src/core/ngx_sha1.c" 3 4
           (void) __builtin___memcpy_chk (
# 44 "project/nginx/src/core/ngx_sha1.c"
           &ctx->buffer[used]
# 44 "project/nginx/src/core/ngx_sha1.c" 3 4
           , 
# 44 "project/nginx/src/core/ngx_sha1.c"
...
# 48 "project/nginx/src/core/ngx_sha1.c" 3 4
       (void) __builtin___memcpy_chk (
# 48 "project/nginx/src/core/ngx_sha1.c"
       &ctx->buffer[used]
# 48 "project/nginx/src/core/ngx_sha1.c" 3 4
       , 
# 48 "project/nginx/src/core/ngx_sha1.c"
...
# 59 "project/nginx/src/core/ngx_sha1.c" 3 4
   (void) __builtin___memcpy_chk (
# 59 "project/nginx/src/core/ngx_sha1.c"
   ctx->buffer
# 59 "project/nginx/src/core/ngx_sha1.c" 3 4
   , 
# 59 "project/nginx/src/core/ngx_sha1.c"
...
# 75 "project/nginx/src/core/ngx_sha1.c" 3 4
       (void) __builtin___memset_chk (
# 75 "project/nginx/src/core/ngx_sha1.c"
       &ctx->buffer[used]
# 75 "project/nginx/src/core/ngx_sha1.c" 3 4
       , 0, 
# 75 "project/nginx/src/core/ngx_sha1.c"
...
# 81 "project/nginx/src/core/ngx_sha1.c" 3 4
   (void) __builtin___memset_chk (
# 81 "project/nginx/src/core/ngx_sha1.c"
   &ctx->buffer[used]
# 81 "project/nginx/src/core/ngx_sha1.c" 3 4
   , 0, 
# 81 "project/nginx/src/core/ngx_sha1.c"
...
# 116 "project/nginx/src/core/ngx_sha1.c" 3 4
   (void) __builtin___memset_chk (
# 116 "project/nginx/src/core/ngx_sha1.c"
   ctx
# 116 "project/nginx/src/core/ngx_sha1.c" 3 4
   , 0, 
# 116 "project/nginx/src/core/ngx_sha1.c"
