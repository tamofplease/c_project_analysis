# 0 "project/nginx/src/core/ngx_queue.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_queue.c"
...
# 9 "project/nginx/src/core/ngx_queue.c" 2
...
# 10 "project/nginx/src/core/ngx_queue.c" 2
...
# 17 "project/nginx/src/core/ngx_queue.c"
ngx_queue_t *
ngx_queue_middle(ngx_queue_t *queue)
{
    ...
    middle = 
# 22 "project/nginx/src/core/ngx_queue.c" 3 4
            (
# 22 "project/nginx/src/core/ngx_queue.c"
            queue
# 22 "project/nginx/src/core/ngx_queue.c" 3 4
            )->next
# 22 "project/nginx/src/core/ngx_queue.c"
    ...
    if (middle == 
# 24 "project/nginx/src/core/ngx_queue.c" 3 4
                 (
# 24 "project/nginx/src/core/ngx_queue.c"
                 queue
# 24 "project/nginx/src/core/ngx_queue.c" 3 4
                 )->prev
# 24 "project/nginx/src/core/ngx_queue.c"
    ...
    next = 
# 28 "project/nginx/src/core/ngx_queue.c" 3 4
          (
# 28 "project/nginx/src/core/ngx_queue.c"
          queue
# 28 "project/nginx/src/core/ngx_queue.c" 3 4
          )->next
# 28 "project/nginx/src/core/ngx_queue.c"
    ...
    for ( ;; ) {
        middle = 
# 31 "project/nginx/src/core/ngx_queue.c" 3 4
                (
# 31 "project/nginx/src/core/ngx_queue.c"
                middle
# 31 "project/nginx/src/core/ngx_queue.c" 3 4
                )->next
# 31 "project/nginx/src/core/ngx_queue.c"
        ...
        next = 
# 33 "project/nginx/src/core/ngx_queue.c" 3 4
              (
# 33 "project/nginx/src/core/ngx_queue.c"
              next
# 33 "project/nginx/src/core/ngx_queue.c" 3 4
              )->next
# 33 "project/nginx/src/core/ngx_queue.c"
        ...
        if (next == 
# 35 "project/nginx/src/core/ngx_queue.c" 3 4
                   (
# 35 "project/nginx/src/core/ngx_queue.c"
                   queue
# 35 "project/nginx/src/core/ngx_queue.c" 3 4
                   )->prev
# 35 "project/nginx/src/core/ngx_queue.c"
        ...
        next = 
# 39 "project/nginx/src/core/ngx_queue.c" 3 4
              (
# 39 "project/nginx/src/core/ngx_queue.c"
              next
# 39 "project/nginx/src/core/ngx_queue.c" 3 4
              )->next
# 39 "project/nginx/src/core/ngx_queue.c"
        ...
        if (next == 
# 41 "project/nginx/src/core/ngx_queue.c" 3 4
                   (
# 41 "project/nginx/src/core/ngx_queue.c"
                   queue
# 41 "project/nginx/src/core/ngx_queue.c" 3 4
                   )->prev
# 41 "project/nginx/src/core/ngx_queue.c"
    ...
    ngx_int_t (*cmp)(const ngx_queue_t *, const ngx_queue_t *))
{
    ...
    q = 
# 56 "project/nginx/src/core/ngx_queue.c" 3 4
       (
# 56 "project/nginx/src/core/ngx_queue.c"
       queue
# 56 "project/nginx/src/core/ngx_queue.c" 3 4
       )->next
# 56 "project/nginx/src/core/ngx_queue.c"
    ...
    if (q == 
# 58 "project/nginx/src/core/ngx_queue.c" 3 4
            (
# 58 "project/nginx/src/core/ngx_queue.c"
            queue
# 58 "project/nginx/src/core/ngx_queue.c" 3 4
            )->prev
# 58 "project/nginx/src/core/ngx_queue.c"
    ...
    for (q = 
# 62 "project/nginx/src/core/ngx_queue.c" 3 4
            (
# 62 "project/nginx/src/core/ngx_queue.c"
            q
# 62 "project/nginx/src/core/ngx_queue.c" 3 4
            )->next
# 62 "project/nginx/src/core/ngx_queue.c"
...
# 62 "project/nginx/src/core/ngx_queue.c"
        ...
        prev = 
# 64 "project/nginx/src/core/ngx_queue.c" 3 4
              (
# 64 "project/nginx/src/core/ngx_queue.c"
              q
# 64 "project/nginx/src/core/ngx_queue.c" 3 4
              )->prev
# 64 "project/nginx/src/core/ngx_queue.c"
                               ;
        next = 
# 65 "project/nginx/src/core/ngx_queue.c" 3 4
              (
# 65 "project/nginx/src/core/ngx_queue.c"
              q
# 65 "project/nginx/src/core/ngx_queue.c" 3 4
              )->next
# 65 "project/nginx/src/core/ngx_queue.c"
...
# 67 "project/nginx/src/core/ngx_queue.c" 3 4
       (
# 67 "project/nginx/src/core/ngx_queue.c"
       q
# 67 "project/nginx/src/core/ngx_queue.c" 3 4
       )->next->prev = (
# 67 "project/nginx/src/core/ngx_queue.c"
...
# 67 "project/nginx/src/core/ngx_queue.c"
        ...
        do {
            ...
            prev = 
# 74 "project/nginx/src/core/ngx_queue.c" 3 4
                  (
# 74 "project/nginx/src/core/ngx_queue.c"
                  prev
# 74 "project/nginx/src/core/ngx_queue.c" 3 4
                  )->prev
# 74 "project/nginx/src/core/ngx_queue.c"
...
# 76 "project/nginx/src/core/ngx_queue.c" 3 4
                        (
# 76 "project/nginx/src/core/ngx_queue.c"
                        queue
# 76 "project/nginx/src/core/ngx_queue.c" 3 4
                        )
# 76 "project/nginx/src/core/ngx_queue.c"
...
# 78 "project/nginx/src/core/ngx_queue.c" 3 4
       (
# 78 "project/nginx/src/core/ngx_queue.c"
       q
# 78 "project/nginx/src/core/ngx_queue.c" 3 4
       )->next = (
# 78 "project/nginx/src/core/ngx_queue.c"
