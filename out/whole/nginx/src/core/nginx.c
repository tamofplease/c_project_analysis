# 0 "project/nginx/src/core/nginx.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/nginx.c"
...
# 9 "project/nginx/src/core/nginx.c" 2
...
# 10 "project/nginx/src/core/nginx.c" 2




# 13 "project/nginx/src/core/nginx.c"
...
static ngx_conf_enum_t ngx_debug_points[] = {
    { 
# 35 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 35 "project/nginx/src/core/nginx.c"
     "stop"
# 35 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 35 "project/nginx/src/core/nginx.c"
...
# 35 "project/nginx/src/core/nginx.c"
    ...
    { 
# 36 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 36 "project/nginx/src/core/nginx.c"
     "abort"
# 36 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 36 "project/nginx/src/core/nginx.c"
...
# 36 "project/nginx/src/core/nginx.c"
    ...
    { 
# 37 "project/nginx/src/core/nginx.c" 3 4
     { 0, ((void *)0) }
# 37 "project/nginx/src/core/nginx.c"
                    , 0 }
};
...
static ngx_command_t ngx_core_commands[] = {
    ...
    { 
# 43 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 43 "project/nginx/src/core/nginx.c"
     "daemon"
# 43 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 43 "project/nginx/src/core/nginx.c"
...
# 44 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 44 "project/nginx/src/core/nginx.c"
                  |
# 44 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 44 "project/nginx/src/core/nginx.c"
...
# 47 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 47 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 47 "project/nginx/src/core/nginx.c" 3 4
     , 
# 47 "project/nginx/src/core/nginx.c"
...
# 48 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 48 "project/nginx/src/core/nginx.c"
          },

    { 
# 50 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 50 "project/nginx/src/core/nginx.c"
     "master_process"
# 50 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 50 "project/nginx/src/core/nginx.c"
...
# 51 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 51 "project/nginx/src/core/nginx.c"
                  |
# 51 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 51 "project/nginx/src/core/nginx.c"
...
# 54 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 54 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 54 "project/nginx/src/core/nginx.c" 3 4
     , 
# 54 "project/nginx/src/core/nginx.c"
...
# 55 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 55 "project/nginx/src/core/nginx.c"
          },

    { 
# 57 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 57 "project/nginx/src/core/nginx.c"
     "timer_resolution"
# 57 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 57 "project/nginx/src/core/nginx.c"
...
# 58 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 58 "project/nginx/src/core/nginx.c"
                  |
# 58 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 58 "project/nginx/src/core/nginx.c"
...
# 61 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 61 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 61 "project/nginx/src/core/nginx.c" 3 4
     , 
# 61 "project/nginx/src/core/nginx.c"
...
# 62 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 62 "project/nginx/src/core/nginx.c"
          },

    { 
# 64 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 64 "project/nginx/src/core/nginx.c"
     "pid"
# 64 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 64 "project/nginx/src/core/nginx.c"
...
# 65 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 65 "project/nginx/src/core/nginx.c"
                  |
# 65 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 65 "project/nginx/src/core/nginx.c"
...
# 68 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 68 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 68 "project/nginx/src/core/nginx.c" 3 4
     , 
# 68 "project/nginx/src/core/nginx.c"
...
# 69 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 69 "project/nginx/src/core/nginx.c"
          },

    { 
# 71 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 71 "project/nginx/src/core/nginx.c"
     "lock_file"
# 71 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 71 "project/nginx/src/core/nginx.c"
...
# 72 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 72 "project/nginx/src/core/nginx.c"
                  |
# 72 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 72 "project/nginx/src/core/nginx.c"
...
# 75 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 75 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 75 "project/nginx/src/core/nginx.c" 3 4
     , 
# 75 "project/nginx/src/core/nginx.c"
...
# 76 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 76 "project/nginx/src/core/nginx.c"
          },

    { 
# 78 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 78 "project/nginx/src/core/nginx.c"
     "worker_processes"
# 78 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 78 "project/nginx/src/core/nginx.c"
...
# 79 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 79 "project/nginx/src/core/nginx.c"
                  |
# 79 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 79 "project/nginx/src/core/nginx.c"
...
# 83 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 83 "project/nginx/src/core/nginx.c"
          },

    { 
# 85 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 85 "project/nginx/src/core/nginx.c"
     "debug_points"
# 85 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 85 "project/nginx/src/core/nginx.c"
...
# 86 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 86 "project/nginx/src/core/nginx.c"
                  |
# 86 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 86 "project/nginx/src/core/nginx.c"
...
# 89 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 89 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 89 "project/nginx/src/core/nginx.c" 3 4
     , 
# 89 "project/nginx/src/core/nginx.c"
...
# 89 "project/nginx/src/core/nginx.c"
    ...
    { 
# 92 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 92 "project/nginx/src/core/nginx.c"
     "user"
# 92 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 92 "project/nginx/src/core/nginx.c"
...
# 93 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 93 "project/nginx/src/core/nginx.c"
                  |
# 93 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 93 "project/nginx/src/core/nginx.c"
...
# 97 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 97 "project/nginx/src/core/nginx.c"
          },

    { 
# 99 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 99 "project/nginx/src/core/nginx.c"
     "worker_priority"
# 99 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 99 "project/nginx/src/core/nginx.c"
...
# 100 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 100 "project/nginx/src/core/nginx.c"
                  |
# 100 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 100 "project/nginx/src/core/nginx.c"
...
# 104 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 104 "project/nginx/src/core/nginx.c"
          },

    { 
# 106 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 106 "project/nginx/src/core/nginx.c"
     "worker_cpu_affinity"
# 106 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 106 "project/nginx/src/core/nginx.c"
...
# 107 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 107 "project/nginx/src/core/nginx.c"
                  |
# 107 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 107 "project/nginx/src/core/nginx.c"
...
# 111 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 111 "project/nginx/src/core/nginx.c"
          },

    { 
# 113 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 113 "project/nginx/src/core/nginx.c"
...
# 114 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 114 "project/nginx/src/core/nginx.c"
                  |
# 114 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 114 "project/nginx/src/core/nginx.c"
...
# 117 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 117 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 117 "project/nginx/src/core/nginx.c" 3 4
     , 
# 117 "project/nginx/src/core/nginx.c"
...
# 118 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 118 "project/nginx/src/core/nginx.c"
          },

    { 
# 120 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 120 "project/nginx/src/core/nginx.c"
     "worker_rlimit_core"
# 120 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 120 "project/nginx/src/core/nginx.c"
...
# 121 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 121 "project/nginx/src/core/nginx.c"
                  |
# 121 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 121 "project/nginx/src/core/nginx.c"
...
# 124 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 124 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 124 "project/nginx/src/core/nginx.c" 3 4
     , 
# 124 "project/nginx/src/core/nginx.c"
...
# 125 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 125 "project/nginx/src/core/nginx.c"
          },

    { 
# 127 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 127 "project/nginx/src/core/nginx.c"
...
# 128 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 128 "project/nginx/src/core/nginx.c"
                  |
# 128 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 128 "project/nginx/src/core/nginx.c"
...
# 131 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 131 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 131 "project/nginx/src/core/nginx.c" 3 4
     , 
# 131 "project/nginx/src/core/nginx.c"
...
# 132 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 132 "project/nginx/src/core/nginx.c"
          },

    { 
# 134 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 134 "project/nginx/src/core/nginx.c"
     "working_directory"
# 134 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 134 "project/nginx/src/core/nginx.c"
...
# 135 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 135 "project/nginx/src/core/nginx.c"
                  |
# 135 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 135 "project/nginx/src/core/nginx.c"
...
# 138 "project/nginx/src/core/nginx.c" 3 4
     __builtin_offsetof (
# 138 "project/nginx/src/core/nginx.c"
     ngx_core_conf_t
# 138 "project/nginx/src/core/nginx.c" 3 4
     , 
# 138 "project/nginx/src/core/nginx.c"
...
# 139 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 139 "project/nginx/src/core/nginx.c"
          },

    { 
# 141 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 141 "project/nginx/src/core/nginx.c"
     "env"
# 141 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 141 "project/nginx/src/core/nginx.c"
...
# 142 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 142 "project/nginx/src/core/nginx.c"
                  |
# 142 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 142 "project/nginx/src/core/nginx.c"
...
# 146 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 146 "project/nginx/src/core/nginx.c"
          },

    { 
# 148 "project/nginx/src/core/nginx.c" 3 4
     { sizeof(
# 148 "project/nginx/src/core/nginx.c"
     "load_module"
# 148 "project/nginx/src/core/nginx.c" 3 4
     ) - 1, (u_char *) 
# 148 "project/nginx/src/core/nginx.c"
...
# 149 "project/nginx/src/core/nginx.c" 3 4
     0x01000000
# 149 "project/nginx/src/core/nginx.c"
                  |
# 149 "project/nginx/src/core/nginx.c" 3 4
                   0x00010000
# 149 "project/nginx/src/core/nginx.c"
...
# 153 "project/nginx/src/core/nginx.c" 3 4
     ((void *)0) 
# 153 "project/nginx/src/core/nginx.c"
          },

      
# 155 "project/nginx/src/core/nginx.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 156 "project/nginx/src/core/nginx.c"
};


static ngx_core_module_t ngx_core_module_ctx = {
    
# 160 "project/nginx/src/core/nginx.c" 3 4
   { sizeof(
# 160 "project/nginx/src/core/nginx.c"
   "core"
# 160 "project/nginx/src/core/nginx.c" 3 4
   ) - 1, (u_char *) 
# 160 "project/nginx/src/core/nginx.c"
...
# 167 "project/nginx/src/core/nginx.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 167 "project/nginx/src/core/nginx.c"
   "8" 
# 167 "project/nginx/src/core/nginx.c" 3 4
   "," 
# 167 "project/nginx/src/core/nginx.c"
...
# 170 "project/nginx/src/core/nginx.c" 3 4
   0x45524F43
# 170 "project/nginx/src/core/nginx.c"
                  ,
    
# 171 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 171 "project/nginx/src/core/nginx.c"
       ,
    
# 172 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 172 "project/nginx/src/core/nginx.c"
       ,
    
# 173 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 173 "project/nginx/src/core/nginx.c"
       ,
    
# 174 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 174 "project/nginx/src/core/nginx.c"
       ,
    
# 175 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 175 "project/nginx/src/core/nginx.c"
       ,
    
# 176 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 176 "project/nginx/src/core/nginx.c"
       ,
    
# 177 "project/nginx/src/core/nginx.c" 3 4
   ((void *)0)
# 177 "project/nginx/src/core/nginx.c"
       ,
    
# 178 "project/nginx/src/core/nginx.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 179 "project/nginx/src/core/nginx.c"
};
...
main(int argc, char *const *argv)
{
    ...
    if (ngx_strerror_init() != 
# 207 "project/nginx/src/core/nginx.c" 3 4
                              0
# 207 "project/nginx/src/core/nginx.c"
                                    ) {
        return 1;
    }

    if (ngx_get_options(argc, argv) != 
# 211 "project/nginx/src/core/nginx.c" 3 4
                                      0
# 211 "project/nginx/src/core/nginx.c"
                                            ) {
        return 1;
    }
    ...
    ngx_pid = 
# 231 "project/nginx/src/core/nginx.c" 3 4
             getpid
# 231 "project/nginx/src/core/nginx.c"
                       ();
    ngx_parent = 
# 232 "project/nginx/src/core/nginx.c" 3 4
                getppid
# 232 "project/nginx/src/core/nginx.c"
                           ();

    log = ngx_log_init(ngx_prefix, ngx_error_log);
    if (log == 
# 235 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 235 "project/nginx/src/core/nginx.c"
                  ) {
        return 1;
    }
# 249 "project/nginx/src/core/nginx.c"
    
# 249 "project/nginx/src/core/nginx.c" 3 4
...
# 249 "project/nginx/src/core/nginx.c"
    ...
    if (init_cycle.pool == 
# 254 "project/nginx/src/core/nginx.c" 3 4
                          ((void *)0)
# 254 "project/nginx/src/core/nginx.c"
                              ) {
        return 1;
    }

    if (ngx_save_argv(&init_cycle, argc, argv) != 
# 258 "project/nginx/src/core/nginx.c" 3 4
                                                 0
# 258 "project/nginx/src/core/nginx.c"
                                                       ) {
        return 1;
    }

    if (ngx_process_options(&init_cycle) != 
# 262 "project/nginx/src/core/nginx.c" 3 4
                                           0
# 262 "project/nginx/src/core/nginx.c"
                                                 ) {
        return 1;
    }

    if (ngx_os_init(log) != 
# 266 "project/nginx/src/core/nginx.c" 3 4
                           0
# 266 "project/nginx/src/core/nginx.c"
                                 ) {
        return 1;
    }
    ...
    if (ngx_crc32_table_init() != 
# 274 "project/nginx/src/core/nginx.c" 3 4
                                 0
# 274 "project/nginx/src/core/nginx.c"
                                       ) {
        return 1;
    }
    ...
    if (ngx_add_inherited_sockets(&init_cycle) != 
# 284 "project/nginx/src/core/nginx.c" 3 4
                                                 0
# 284 "project/nginx/src/core/nginx.c"
                                                       ) {
        return 1;
    }

    if (ngx_preinit_modules() != 
# 288 "project/nginx/src/core/nginx.c" 3 4
                                0
# 288 "project/nginx/src/core/nginx.c"
                                      ) {
        return 1;
    }
    ...
    if (cycle == 
# 293 "project/nginx/src/core/nginx.c" 3 4
                ((void *)0)
# 293 "project/nginx/src/core/nginx.c"
                    ) {
        if (ngx_test_config) {
    ...
    if (ngx_test_config) {
        ...
        if (ngx_dump_config) {
            ...
            for (i = 0; i < cycle->config_dump.nelts; i++) {
                ...
                (void) ngx_write_fd(
# 314 "project/nginx/src/core/nginx.c" 3 4
                                   1
# 314 "project/nginx/src/core/nginx.c"
                                             , cd[i].name.data,
                                    cd[i].name.len);
                ngx_write_stdout(":" 
# 316 "project/nginx/src/core/nginx.c" 3 4
                                    "\x0a"
# 316 "project/nginx/src/core/nginx.c"
                                                );

                b = cd[i].buffer;

                (void) ngx_write_fd(
# 320 "project/nginx/src/core/nginx.c" 3 4
                                   1
# 320 "project/nginx/src/core/nginx.c"
                                             , b->pos, b->last - b->pos);
                ngx_write_stdout(
# 321 "project/nginx/src/core/nginx.c" 3 4
                                "\x0a"
# 321 "project/nginx/src/core/nginx.c"
                                            );
            }
        }
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 336 "project/nginx/src/core/nginx.c" 3 4
                             [
# 336 "project/nginx/src/core/nginx.c"
                             ngx_core_module
# 336 "project/nginx/src/core/nginx.c" 3 4
                             .index]
# 336 "project/nginx/src/core/nginx.c"
    ...
    if (ccf->master && ngx_process == 
# 338 "project/nginx/src/core/nginx.c" 3 4
                                     0
# 338 "project/nginx/src/core/nginx.c"
                                                       ) {
        ngx_process = 
# 339 "project/nginx/src/core/nginx.c" 3 4
                     1
# 339 "project/nginx/src/core/nginx.c"
                                       ;
    }



    if (ngx_init_signals(cycle->log) != 
# 344 "project/nginx/src/core/nginx.c" 3 4
                                       0
# 344 "project/nginx/src/core/nginx.c"
                                             ) {
        return 1;
    }

    if (!ngx_inherited && ccf->daemon) {
        if (ngx_daemon(cycle->log) != 
# 349 "project/nginx/src/core/nginx.c" 3 4
                                     0
# 349 "project/nginx/src/core/nginx.c"
                                           ) {
            return 1;
        }
...
# 362 "project/nginx/src/core/nginx.c" 3 4
                                                    0
# 362 "project/nginx/src/core/nginx.c"
                                                          ) {
        return 1;
    }

    if (ngx_log_redirect_stderr(cycle) != 
# 366 "project/nginx/src/core/nginx.c" 3 4
                                         0
# 366 "project/nginx/src/core/nginx.c"
                                               ) {
        return 1;
    }

    if (log->file->fd != 
# 370 "project/nginx/src/core/nginx.c" 3 4
                        2
# 370 "project/nginx/src/core/nginx.c"
                                  ) {
        if (
# 371 "project/nginx/src/core/nginx.c" 3 4
           close
# 371 "project/nginx/src/core/nginx.c"
                         (log->file->fd) == 
# 371 "project/nginx/src/core/nginx.c" 3 4
                                            -1
# 371 "project/nginx/src/core/nginx.c"
...
# 372 "project/nginx/src/core/nginx.c" 3 4
           if ((
# 372 "project/nginx/src/core/nginx.c"
           cycle->log
# 372 "project/nginx/src/core/nginx.c" 3 4
...
# 373 "project/nginx/src/core/nginx.c"
                                                                 ;
        }
    }
    ...
    if (ngx_process == 
# 379 "project/nginx/src/core/nginx.c" 3 4
                      0
# 379 "project/nginx/src/core/nginx.c"
                                        ) {
...
# 393 "project/nginx/src/core/nginx.c" 3 4
                                      "nginx/" "1.21.5" "\x0a"
# 393 "project/nginx/src/core/nginx.c"
                                                                  );

    if (ngx_show_help) {
        ngx_write_stderr(
            "Usage: nginx [-?hvVtTq] [-s signal] [-p prefix]" 
# 397 "project/nginx/src/core/nginx.c" 3 4
                                                             "\x0a"
            
# 398 "project/nginx/src/core/nginx.c"
           "             [-e filename] [-c filename] [-g directives]"
                          
# 399 "project/nginx/src/core/nginx.c" 3 4
                         "\x0a" "\x0a"
            
# 400 "project/nginx/src/core/nginx.c"
           "Options:" 
# 400 "project/nginx/src/core/nginx.c" 3 4
                      "\x0a"
            
# 401 "project/nginx/src/core/nginx.c"
           "  -?,-h         : this help" 
# 401 "project/nginx/src/core/nginx.c" 3 4
                                         "\x0a"
            
# 402 "project/nginx/src/core/nginx.c"
           "  -v            : show version and exit" 
# 402 "project/nginx/src/core/nginx.c" 3 4
                                                     "\x0a"
            
# 403 "project/nginx/src/core/nginx.c"
           "  -V            : show version and configure options then exit"
                               
# 404 "project/nginx/src/core/nginx.c" 3 4
                              "\x0a"
            
# 405 "project/nginx/src/core/nginx.c"
           "  -t            : test configuration and exit" 
# 405 "project/nginx/src/core/nginx.c" 3 4
                                                           "\x0a"
            
# 406 "project/nginx/src/core/nginx.c"
           "  -T            : test configuration, dump it and exit"
                               
# 407 "project/nginx/src/core/nginx.c" 3 4
                              "\x0a"
            
# 408 "project/nginx/src/core/nginx.c"
           "  -q            : suppress non-error messages "
                               "during configuration testing" 
# 409 "project/nginx/src/core/nginx.c" 3 4
                                                             "\x0a"
            
# 410 "project/nginx/src/core/nginx.c"
           "  -s signal     : send signal to a master process: "
                               "stop, quit, reopen, reload" 
# 411 "project/nginx/src/core/nginx.c" 3 4
                                                           "\x0a"

            
# 413 "project/nginx/src/core/nginx.c"
           "  -p prefix     : set prefix path (default: " 
# 413 "project/nginx/src/core/nginx.c" 3 4
                                                          "/usr/local/nginx/" 
# 413 "project/nginx/src/core/nginx.c"
                                                                     ")"
                               
# 414 "project/nginx/src/core/nginx.c" 3 4
                              "\x0a"



            
# 418 "project/nginx/src/core/nginx.c"
           "  -e filename   : set error log file (default: "



                               
# 422 "project/nginx/src/core/nginx.c" 3 4
                              "logs/error.log" 
# 422 "project/nginx/src/core/nginx.c"
                                                 ")" 
# 422 "project/nginx/src/core/nginx.c" 3 4
                                                     "\x0a"

            
# 424 "project/nginx/src/core/nginx.c"
           "  -c filename   : set configuration file (default: " 
# 424 "project/nginx/src/core/nginx.c" 3 4
                                                                 "conf/nginx.conf"
                               
# 425 "project/nginx/src/core/nginx.c"
                              ")" 
# 425 "project/nginx/src/core/nginx.c" 3 4
                                  "\x0a"
            
# 426 "project/nginx/src/core/nginx.c"
           "  -g directives : set global directives out of configuration "
                               "file" 
# 427 "project/nginx/src/core/nginx.c" 3 4
                                     "\x0a" "\x0a"
        
# 428 "project/nginx/src/core/nginx.c"
       );
    }
    ...
    if (ngx_show_configure) {
        ...
        ngx_write_stderr("built by " 
# 434 "project/nginx/src/core/nginx.c" 3 4
                                    "clang 13.0.0 (clang-1300.0.29.30)" "\x0a"
# 434 "project/nginx/src/core/nginx.c"
                                                             );
# 453 "project/nginx/src/core/nginx.c"
        ngx_write_stderr("configure arguments:" 
# 453 "project/nginx/src/core/nginx.c" 3 4
                                               "" "\x0a"
# 453 "project/nginx/src/core/nginx.c"
                                                                         );
    }
...
ngx_add_inherited_sockets(ngx_cycle_t *cycle)
{
    ...
    inherited = (u_char *) getenv(
# 465 "project/nginx/src/core/nginx.c" 3 4
                                 "NGINX"
# 465 "project/nginx/src/core/nginx.c"
                                          );

    if (inherited == 
# 467 "project/nginx/src/core/nginx.c" 3 4
                    ((void *)0)
# 467 "project/nginx/src/core/nginx.c"
                        ) {
        return 
# 468 "project/nginx/src/core/nginx.c" 3 4
              0
# 468 "project/nginx/src/core/nginx.c"
                    ;
    }

    
# 471 "project/nginx/src/core/nginx.c" 3 4
   if ((
# 471 "project/nginx/src/core/nginx.c"
   cycle->log
# 471 "project/nginx/src/core/nginx.c" 3 4
...
# 471 "project/nginx/src/core/nginx.c" 3 4
   , 
# 471 "project/nginx/src/core/nginx.c"
   0, "using inherited sockets from \"%s\"", inherited
# 471 "project/nginx/src/core/nginx.c" 3 4
   )
                                                                   
# 472 "project/nginx/src/core/nginx.c"
                                                                  ;

    if (ngx_array_init(&cycle->listening, cycle->pool, 10,
                       sizeof(ngx_listening_t))
        != 
# 476 "project/nginx/src/core/nginx.c" 3 4
          0
# 476 "project/nginx/src/core/nginx.c"
                )
    {
        return 
# 478 "project/nginx/src/core/nginx.c" 3 4
              -1
# 478 "project/nginx/src/core/nginx.c"
                       ;
    }
    ...
    for (p = inherited, v = p; *p; p++) {
        if (*p == ':' || *p == ';') {
            s = ngx_atoi(v, p - v);
            if (s == 
# 484 "project/nginx/src/core/nginx.c" 3 4
                    -1
# 484 "project/nginx/src/core/nginx.c"
                             ) {
                
# 485 "project/nginx/src/core/nginx.c" 3 4
               if ((
# 485 "project/nginx/src/core/nginx.c"
               cycle->log
# 485 "project/nginx/src/core/nginx.c" 3 4
...
# 488 "project/nginx/src/core/nginx.c"
                                                   ;
                break;
            }
            ...
            if (ls == 
# 495 "project/nginx/src/core/nginx.c" 3 4
                     ((void *)0)
# 495 "project/nginx/src/core/nginx.c"
                         ) {
                return 
# 496 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 496 "project/nginx/src/core/nginx.c"
                               ;
            }

            
# 499 "project/nginx/src/core/nginx.c" 3 4
           (void) __builtin___memset_chk (
# 499 "project/nginx/src/core/nginx.c"
           ls
# 499 "project/nginx/src/core/nginx.c" 3 4
           , 0, 
# 499 "project/nginx/src/core/nginx.c"
...
# 507 "project/nginx/src/core/nginx.c" 3 4
       if ((
# 507 "project/nginx/src/core/nginx.c"
       cycle->log
# 507 "project/nginx/src/core/nginx.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 507 "project/nginx/src/core/nginx.c"
...
# 509 "project/nginx/src/core/nginx.c"
                                                          ;
    }
...
ngx_set_environment(ngx_cycle_t *cycle, ngx_uint_t *last)
{
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 527 "project/nginx/src/core/nginx.c" 3 4
                             [
# 527 "project/nginx/src/core/nginx.c"
                             ngx_core_module
# 527 "project/nginx/src/core/nginx.c" 3 4
                             .index]
# 527 "project/nginx/src/core/nginx.c"
    ...
    if (last == 
# 529 "project/nginx/src/core/nginx.c" 3 4
               ((void *)0) 
# 529 "project/nginx/src/core/nginx.c"
                    && ccf->environment) {
    ...
    for (i = 0; i < ccf->env.nelts; i++) {
        if (
# 536 "project/nginx/src/core/nginx.c" 3 4
           strcmp((const char *) 
# 536 "project/nginx/src/core/nginx.c"
           var[i].data
# 536 "project/nginx/src/core/nginx.c" 3 4
           , (const char *) 
# 536 "project/nginx/src/core/nginx.c"
...
# 536 "project/nginx/src/core/nginx.c"
                                         == 0
            || 
# 537 "project/nginx/src/core/nginx.c" 3 4
              strncmp((const char *) 
# 537 "project/nginx/src/core/nginx.c"
              var[i].data
# 537 "project/nginx/src/core/nginx.c" 3 4
              , (const char *) 
# 537 "project/nginx/src/core/nginx.c"
...
# 537 "project/nginx/src/core/nginx.c"
    ...
    if (var == 
# 544 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 544 "project/nginx/src/core/nginx.c"
                  ) {
        return 
# 545 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 545 "project/nginx/src/core/nginx.c"
                  ;
    }
...
tz_found:
    ...
    for (i = 0; i < ccf->env.nelts; i++) {
        ...
        for (p = ngx_os_environ; *p; p++) {
            ...
            if (
# 566 "project/nginx/src/core/nginx.c" 3 4
               strncmp((const char *) 
# 566 "project/nginx/src/core/nginx.c"
               *p
# 566 "project/nginx/src/core/nginx.c" 3 4
               , (const char *) 
# 566 "project/nginx/src/core/nginx.c"
...
# 566 "project/nginx/src/core/nginx.c"
    ...
    if (last) {
        ...
        if (env == 
# 577 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 577 "project/nginx/src/core/nginx.c"
                      ) {
            return 
# 578 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 578 "project/nginx/src/core/nginx.c"
                      ;
        }
        ...
        *last = n;
        ...
        if (cln == 
# 585 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 585 "project/nginx/src/core/nginx.c"
                      ) {
            return 
# 586 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 586 "project/nginx/src/core/nginx.c"
                      ;
        }

        env = ngx_alloc((n + 1) * sizeof(char *), cycle->log);
        if (env == 
# 590 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 590 "project/nginx/src/core/nginx.c"
                      ) {
            return 
# 591 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 591 "project/nginx/src/core/nginx.c"
                      ;
        }
    ...
    for (i = 0; i < ccf->env.nelts; i++) {
        ...
        for (p = ngx_os_environ; *p; p++) {
            ...
            if (
# 609 "project/nginx/src/core/nginx.c" 3 4
               strncmp((const char *) 
# 609 "project/nginx/src/core/nginx.c"
               *p
# 609 "project/nginx/src/core/nginx.c" 3 4
               , (const char *) 
# 609 "project/nginx/src/core/nginx.c"
...
# 609 "project/nginx/src/core/nginx.c"
    ...
    env[n] = 
# 618 "project/nginx/src/core/nginx.c" 3 4
            ((void *)0)
# 618 "project/nginx/src/core/nginx.c"
                ;

    if (last == 
# 620 "project/nginx/src/core/nginx.c" 3 4
               ((void *)0)
# 620 "project/nginx/src/core/nginx.c"
                   ) {
        ccf->environment = env;
        environ = env;
    }
...
# 644 "project/nginx/src/core/nginx.c" 3 4
   free
# 644 "project/nginx/src/core/nginx.c"
           (env);
}
...
# 659 "project/nginx/src/core/nginx.c" 3 4
   (void) __builtin___memset_chk (
# 659 "project/nginx/src/core/nginx.c"
   &ctx
# 659 "project/nginx/src/core/nginx.c" 3 4
   , 0, 
# 659 "project/nginx/src/core/nginx.c"
   sizeof(ngx_exec_ctx_t)
# 659 "project/nginx/src/core/nginx.c" 3 4
   , __builtin_object_size (
# 659 "project/nginx/src/core/nginx.c"
   &ctx
...
# 659 "project/nginx/src/core/nginx.c"
    ...
    if (env == 
# 667 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 667 "project/nginx/src/core/nginx.c"
                  ) {
        return 
# 668 "project/nginx/src/core/nginx.c" 3 4
              -1
# 668 "project/nginx/src/core/nginx.c"
                             ;
    }

    var = ngx_alloc(sizeof(
# 671 "project/nginx/src/core/nginx.c" 3 4
                          "NGINX"
# 671 "project/nginx/src/core/nginx.c"
                                   )
                    + cycle->listening.nelts * (
# 672 "project/nginx/src/core/nginx.c" 3 4
                                               (sizeof("-2147483648") - 1) 
# 672 "project/nginx/src/core/nginx.c"
                                                             + 1) + 2,
                    cycle->log);
    if (var == 
# 674 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 674 "project/nginx/src/core/nginx.c"
                  ) {
        
# 675 "project/nginx/src/core/nginx.c" 3 4
       free
# 675 "project/nginx/src/core/nginx.c"
               (env);
        return 
# 676 "project/nginx/src/core/nginx.c" 3 4
              -1
# 676 "project/nginx/src/core/nginx.c"
                             ;
    }

    p = 
# 679 "project/nginx/src/core/nginx.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 679 "project/nginx/src/core/nginx.c"
       var
# 679 "project/nginx/src/core/nginx.c" 3 4
       , "NGINX" 
# 679 "project/nginx/src/core/nginx.c"
...
# 679 "project/nginx/src/core/nginx.c"
    ...
    *p = '\0';
    ...
    env[n] = 
# 702 "project/nginx/src/core/nginx.c" 3 4
            ((void *)0)
# 702 "project/nginx/src/core/nginx.c"
                ;
# 713 "project/nginx/src/core/nginx.c"
    ctx.envp = (char *const *) env;

    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 715 "project/nginx/src/core/nginx.c" 3 4
                             [
# 715 "project/nginx/src/core/nginx.c"
                             ngx_core_module
# 715 "project/nginx/src/core/nginx.c" 3 4
                             .index]
# 715 "project/nginx/src/core/nginx.c"
    ...
    if (
# 717 "project/nginx/src/core/nginx.c" 3 4
       rename((const char *) 
# 717 "project/nginx/src/core/nginx.c"
       ccf->pid.data
# 717 "project/nginx/src/core/nginx.c" 3 4
       , (const char *) 
# 717 "project/nginx/src/core/nginx.c"
...
# 718 "project/nginx/src/core/nginx.c" 3 4
       if ((
# 718 "project/nginx/src/core/nginx.c"
       cycle->log
# 718 "project/nginx/src/core/nginx.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 718 "project/nginx/src/core/nginx.c"
...
# 718 "project/nginx/src/core/nginx.c" 3 4
       "rename()" 
# 718 "project/nginx/src/core/nginx.c"
       " %s to %s failed " "before executing new binary process \"%s\"", ccf->pid.data, ccf->oldpid.data, argv[0]
# 718 "project/nginx/src/core/nginx.c" 3 4
       )


                                                               
# 721 "project/nginx/src/core/nginx.c"
                                                              ;

        
# 723 "project/nginx/src/core/nginx.c" 3 4
       free
# 723 "project/nginx/src/core/nginx.c"
               (env);
        
# 724 "project/nginx/src/core/nginx.c" 3 4
       free
# 724 "project/nginx/src/core/nginx.c"
               (var);

        return 
# 726 "project/nginx/src/core/nginx.c" 3 4
              -1
# 726 "project/nginx/src/core/nginx.c"
                             ;
    }
    ...
    if (pid == 
# 731 "project/nginx/src/core/nginx.c" 3 4
              -1
# 731 "project/nginx/src/core/nginx.c"
                             ) {
        if (
# 732 "project/nginx/src/core/nginx.c" 3 4
           rename((const char *) 
# 732 "project/nginx/src/core/nginx.c"
           ccf->oldpid.data
# 732 "project/nginx/src/core/nginx.c" 3 4
           , (const char *) 
# 732 "project/nginx/src/core/nginx.c"
...
# 733 "project/nginx/src/core/nginx.c"
           == 
# 733 "project/nginx/src/core/nginx.c" 3 4
              -1
# 733 "project/nginx/src/core/nginx.c"
                            )
        {
            
# 735 "project/nginx/src/core/nginx.c" 3 4
           if ((
# 735 "project/nginx/src/core/nginx.c"
           cycle->log
# 735 "project/nginx/src/core/nginx.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 735 "project/nginx/src/core/nginx.c"
...
# 735 "project/nginx/src/core/nginx.c" 3 4
           "rename()" 
# 735 "project/nginx/src/core/nginx.c"
           " %s back to %s failed after " "an attempt to execute new binary process \"%s\"", ccf->oldpid.data, ccf->pid.data, argv[0]
# 735 "project/nginx/src/core/nginx.c" 3 4
           )


                                                                   
# 738 "project/nginx/src/core/nginx.c"
                                                                  ;
        }
    }

    
# 742 "project/nginx/src/core/nginx.c" 3 4
   free
# 742 "project/nginx/src/core/nginx.c"
           (env);
    
# 743 "project/nginx/src/core/nginx.c" 3 4
   free
# 743 "project/nginx/src/core/nginx.c"
           (var);
...
ngx_get_options(int argc, char *const *argv)
{
    ...
    for (i = 1; i < argc; i++) {
        ...
        if (*p++ != '-') {
            ...
            return 
# 761 "project/nginx/src/core/nginx.c" 3 4
                  -1
# 761 "project/nginx/src/core/nginx.c"
                           ;
        }
        ...
        while (*p) {
            ...
            case 'p':
                ...
                return 
# 808 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 808 "project/nginx/src/core/nginx.c"
                               ;
            ...
            case 'e':
                if (*p) {
                    ...
                    return 
# 819 "project/nginx/src/core/nginx.c" 3 4
                          -1
# 819 "project/nginx/src/core/nginx.c"
                                   ;
                }

                if (
# 822 "project/nginx/src/core/nginx.c" 3 4
                   strcmp((const char *) 
# 822 "project/nginx/src/core/nginx.c"
                   ngx_error_log
# 822 "project/nginx/src/core/nginx.c" 3 4
                   , (const char *) 
# 822 "project/nginx/src/core/nginx.c"
...
# 822 "project/nginx/src/core/nginx.c"
            ...
            case 'c':
                ...
                return 
# 840 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 840 "project/nginx/src/core/nginx.c"
                               ;
            ...
            case 'g':
                ...
                return 
# 854 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 854 "project/nginx/src/core/nginx.c"
                               ;
            ...
            case 's':
                if (*p) {
                    ...
                    return 
# 865 "project/nginx/src/core/nginx.c" 3 4
                          -1
# 865 "project/nginx/src/core/nginx.c"
                                   ;
                }

                if (
# 868 "project/nginx/src/core/nginx.c" 3 4
                   strcmp((const char *) 
# 868 "project/nginx/src/core/nginx.c"
                   ngx_signal
# 868 "project/nginx/src/core/nginx.c" 3 4
                   , (const char *) 
# 868 "project/nginx/src/core/nginx.c"
...
# 868 "project/nginx/src/core/nginx.c"
                                                  == 0
                    || 
# 869 "project/nginx/src/core/nginx.c" 3 4
                      strcmp((const char *) 
# 869 "project/nginx/src/core/nginx.c"
                      ngx_signal
# 869 "project/nginx/src/core/nginx.c" 3 4
                      , (const char *) 
# 869 "project/nginx/src/core/nginx.c"
...
# 869 "project/nginx/src/core/nginx.c"
                                                     == 0
                    || 
# 870 "project/nginx/src/core/nginx.c" 3 4
                      strcmp((const char *) 
# 870 "project/nginx/src/core/nginx.c"
                      ngx_signal
# 870 "project/nginx/src/core/nginx.c" 3 4
                      , (const char *) 
# 870 "project/nginx/src/core/nginx.c"
...
# 870 "project/nginx/src/core/nginx.c"
                                                       == 0
                    || 
# 871 "project/nginx/src/core/nginx.c" 3 4
                      strcmp((const char *) 
# 871 "project/nginx/src/core/nginx.c"
                      ngx_signal
# 871 "project/nginx/src/core/nginx.c" 3 4
                      , (const char *) 
# 871 "project/nginx/src/core/nginx.c"
...
# 871 "project/nginx/src/core/nginx.c"
                ...
                {
                    ngx_process = 
# 873 "project/nginx/src/core/nginx.c" 3 4
                                 2
# 873 "project/nginx/src/core/nginx.c"
                                                      ;
                    goto next;
                }
                ...
                return 
# 878 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 878 "project/nginx/src/core/nginx.c"
                               ;

            default:
                ngx_log_stderr(0, "invalid option: \"%c\"", *(p - 1));
                return 
# 882 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 882 "project/nginx/src/core/nginx.c"
                               ;
            }
        }
    ...
    return 
# 891 "project/nginx/src/core/nginx.c" 3 4
          0
# 891 "project/nginx/src/core/nginx.c"
                ;
}
...
ngx_save_argv(ngx_cycle_t *cycle, int argc, char *const *argv)
{
    ...
    if (ngx_argv == 
# 912 "project/nginx/src/core/nginx.c" 3 4
                   ((void *)0)
# 912 "project/nginx/src/core/nginx.c"
                       ) {
        return 
# 913 "project/nginx/src/core/nginx.c" 3 4
              -1
# 913 "project/nginx/src/core/nginx.c"
                       ;
    }

    for (i = 0; i < argc; i++) {
        len = 
# 917 "project/nginx/src/core/nginx.c" 3 4
             strlen((const char *) 
# 917 "project/nginx/src/core/nginx.c"
             argv[i]
# 917 "project/nginx/src/core/nginx.c" 3 4
             ) 
# 917 "project/nginx/src/core/nginx.c"
        ...
        if (ngx_argv[i] == 
# 920 "project/nginx/src/core/nginx.c" 3 4
                          ((void *)0)
# 920 "project/nginx/src/core/nginx.c"
                              ) {
            return 
# 921 "project/nginx/src/core/nginx.c" 3 4
                  -1
# 921 "project/nginx/src/core/nginx.c"
                           ;
        }
    ...
    ngx_argv[i] = 
# 927 "project/nginx/src/core/nginx.c" 3 4
                 ((void *)0)
# 927 "project/nginx/src/core/nginx.c"
                     ;
    ...
    return 
# 933 "project/nginx/src/core/nginx.c" 3 4
          0
# 933 "project/nginx/src/core/nginx.c"
                ;
}
...
ngx_process_options(ngx_cycle_t *cycle)
{
    ...
    if (ngx_prefix) {
        len = 
# 944 "project/nginx/src/core/nginx.c" 3 4
             strlen((const char *) 
# 944 "project/nginx/src/core/nginx.c"
             ngx_prefix
# 944 "project/nginx/src/core/nginx.c" 3 4
             )
# 944 "project/nginx/src/core/nginx.c"
        ...
        if (len && !
# 947 "project/nginx/src/core/nginx.c" 3 4
                   ((
# 947 "project/nginx/src/core/nginx.c"
                   p[len - 1]
# 947 "project/nginx/src/core/nginx.c" 3 4
                   ) == '/')
# 947 "project/nginx/src/core/nginx.c"
            ...
            if (p == 
# 949 "project/nginx/src/core/nginx.c" 3 4
                    ((void *)0)
# 949 "project/nginx/src/core/nginx.c"
                        ) {
                return 
# 950 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 950 "project/nginx/src/core/nginx.c"
                               ;
            }

            
# 953 "project/nginx/src/core/nginx.c" 3 4
           (void) __builtin___memcpy_chk (
# 953 "project/nginx/src/core/nginx.c"
           p
# 953 "project/nginx/src/core/nginx.c" 3 4
           , 
# 953 "project/nginx/src/core/nginx.c"
...
# 988 "project/nginx/src/core/nginx.c"
        
# 988 "project/nginx/src/core/nginx.c" 3 4
       (
# 988 "project/nginx/src/core/nginx.c"
       &cycle->conf_prefix
# 988 "project/nginx/src/core/nginx.c" 3 4
...
# 992 "project/nginx/src/core/nginx.c" 3 4
       (
# 992 "project/nginx/src/core/nginx.c"
       &cycle->prefix
# 992 "project/nginx/src/core/nginx.c" 3 4
       )->len = sizeof("/usr/local/nginx/") - 1; (
# 992 "project/nginx/src/core/nginx.c"
       &cycle->prefix
# 992 "project/nginx/src/core/nginx.c" 3 4
       )->data = (u_char *) "/usr/local/nginx/"
# 992 "project/nginx/src/core/nginx.c"
                                              ;
    ...
    if (ngx_conf_file) {
        cycle->conf_file.len = 
# 998 "project/nginx/src/core/nginx.c" 3 4
                              strlen((const char *) 
# 998 "project/nginx/src/core/nginx.c"
                              ngx_conf_file
# 998 "project/nginx/src/core/nginx.c" 3 4
                              )
# 998 "project/nginx/src/core/nginx.c"
...
# 1002 "project/nginx/src/core/nginx.c" 3 4
       (
# 1002 "project/nginx/src/core/nginx.c"
       &cycle->conf_file
# 1002 "project/nginx/src/core/nginx.c" 3 4
       )->len = sizeof("conf/nginx.conf") - 1; (
# 1002 "project/nginx/src/core/nginx.c"
       &cycle->conf_file
# 1002 "project/nginx/src/core/nginx.c" 3 4
       )->data = (u_char *) "conf/nginx.conf"
# 1002 "project/nginx/src/core/nginx.c"
                                                    ;
    }

    if (ngx_conf_full_name(cycle, &cycle->conf_file, 0) != 
# 1005 "project/nginx/src/core/nginx.c" 3 4
                                                          0
# 1005 "project/nginx/src/core/nginx.c"
                                                                ) {
        return 
# 1006 "project/nginx/src/core/nginx.c" 3 4
              -1
# 1006 "project/nginx/src/core/nginx.c"
                       ;
    }
    ...
    {
        if (
# 1013 "project/nginx/src/core/nginx.c" 3 4
           ((
# 1013 "project/nginx/src/core/nginx.c"
           *p
# 1013 "project/nginx/src/core/nginx.c" 3 4
           ) == '/')
# 1013 "project/nginx/src/core/nginx.c"
    ...
    if (ngx_error_log) {
        cycle->error_log.len = 
# 1021 "project/nginx/src/core/nginx.c" 3 4
                              strlen((const char *) 
# 1021 "project/nginx/src/core/nginx.c"
                              ngx_error_log
# 1021 "project/nginx/src/core/nginx.c" 3 4
                              )
# 1021 "project/nginx/src/core/nginx.c"
...
# 1025 "project/nginx/src/core/nginx.c" 3 4
       (
# 1025 "project/nginx/src/core/nginx.c"
       &cycle->error_log
# 1025 "project/nginx/src/core/nginx.c" 3 4
       )->len = sizeof("logs/error.log") - 1; (
# 1025 "project/nginx/src/core/nginx.c"
       &cycle->error_log
# 1025 "project/nginx/src/core/nginx.c" 3 4
       )->data = (u_char *) "logs/error.log"
# 1025 "project/nginx/src/core/nginx.c"
                                                         ;
    }
...
# 1029 "project/nginx/src/core/nginx.c" 3 4
                               strlen((const char *) 
# 1029 "project/nginx/src/core/nginx.c"
                               ngx_conf_params
# 1029 "project/nginx/src/core/nginx.c" 3 4
                               )
# 1029 "project/nginx/src/core/nginx.c"
    ...
    if (ngx_test_config) {
        cycle->log->log_level = 
# 1034 "project/nginx/src/core/nginx.c" 3 4
                               7
# 1034 "project/nginx/src/core/nginx.c"
                                           ;
    }

    return 
# 1037 "project/nginx/src/core/nginx.c" 3 4
          0
# 1037 "project/nginx/src/core/nginx.c"
                ;
}
...
ngx_core_module_create_conf(ngx_cycle_t *cycle)
{
    ...
    if (ccf == 
# 1047 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1047 "project/nginx/src/core/nginx.c"
                  ) {
        return 
# 1048 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1048 "project/nginx/src/core/nginx.c"
                  ;
    }
# 1062 "project/nginx/src/core/nginx.c"
    ccf->daemon = 
# 1062 "project/nginx/src/core/nginx.c" 3 4
                 -1
# 1062 "project/nginx/src/core/nginx.c"
                               ;
    ccf->master = 
# 1063 "project/nginx/src/core/nginx.c" 3 4
                 -1
# 1063 "project/nginx/src/core/nginx.c"
                               ;
    ccf->timer_resolution = 
# 1064 "project/nginx/src/core/nginx.c" 3 4
                           (ngx_msec_t) -1
# 1064 "project/nginx/src/core/nginx.c"
                                              ;
    ccf->shutdown_timeout = 
# 1065 "project/nginx/src/core/nginx.c" 3 4
                           (ngx_msec_t) -1
# 1065 "project/nginx/src/core/nginx.c"
                                              ;

    ccf->worker_processes = 
# 1067 "project/nginx/src/core/nginx.c" 3 4
                           -1
# 1067 "project/nginx/src/core/nginx.c"
                                         ;
    ccf->debug_points = 
# 1068 "project/nginx/src/core/nginx.c" 3 4
                       -1
# 1068 "project/nginx/src/core/nginx.c"
                                     ;

    ccf->rlimit_nofile = 
# 1070 "project/nginx/src/core/nginx.c" 3 4
                        -1
# 1070 "project/nginx/src/core/nginx.c"
                                      ;
    ccf->rlimit_core = 
# 1071 "project/nginx/src/core/nginx.c" 3 4
                      -1
# 1071 "project/nginx/src/core/nginx.c"
                                    ;

    ccf->user = (ngx_uid_t) 
# 1073 "project/nginx/src/core/nginx.c" 3 4
                           (ngx_uint_t) -1
# 1073 "project/nginx/src/core/nginx.c"
                                              ;
    ccf->group = (ngx_gid_t) 
# 1074 "project/nginx/src/core/nginx.c" 3 4
                            (ngx_uint_t) -1
# 1074 "project/nginx/src/core/nginx.c"
                                               ;

    if (ngx_array_init(&ccf->env, cycle->pool, 1, sizeof(ngx_str_t))
        != 
# 1077 "project/nginx/src/core/nginx.c" 3 4
          0
# 1077 "project/nginx/src/core/nginx.c"
                )
    {
        return 
# 1079 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1079 "project/nginx/src/core/nginx.c"
                  ;
    }
...
# 1091 "project/nginx/src/core/nginx.c" 3 4
   if (
# 1091 "project/nginx/src/core/nginx.c"
   ccf->daemon 
# 1091 "project/nginx/src/core/nginx.c" 3 4
   == -1) { 
# 1091 "project/nginx/src/core/nginx.c"
...
# 1092 "project/nginx/src/core/nginx.c" 3 4
   if (
# 1092 "project/nginx/src/core/nginx.c"
   ccf->master 
# 1092 "project/nginx/src/core/nginx.c" 3 4
   == -1) { 
# 1092 "project/nginx/src/core/nginx.c"
...
# 1093 "project/nginx/src/core/nginx.c" 3 4
   if (
# 1093 "project/nginx/src/core/nginx.c"
   ccf->timer_resolution 
# 1093 "project/nginx/src/core/nginx.c" 3 4
   == (ngx_msec_t) -1) { 
# 1093 "project/nginx/src/core/nginx.c"
...
# 1094 "project/nginx/src/core/nginx.c" 3 4
   if (
# 1094 "project/nginx/src/core/nginx.c"
   ccf->shutdown_timeout 
# 1094 "project/nginx/src/core/nginx.c" 3 4
   == (ngx_msec_t) -1) { 
# 1094 "project/nginx/src/core/nginx.c"
...
# 1096 "project/nginx/src/core/nginx.c" 3 4
   if (
# 1096 "project/nginx/src/core/nginx.c"
   ccf->worker_processes 
# 1096 "project/nginx/src/core/nginx.c" 3 4
   == -1) { 
# 1096 "project/nginx/src/core/nginx.c"
...
# 1097 "project/nginx/src/core/nginx.c" 3 4
   if (
# 1097 "project/nginx/src/core/nginx.c"
   ccf->debug_points 
# 1097 "project/nginx/src/core/nginx.c" 3 4
   == -1) { 
# 1097 "project/nginx/src/core/nginx.c"
...
# 1097 "project/nginx/src/core/nginx.c"
                                            ;
# 1115 "project/nginx/src/core/nginx.c"
    if (ccf->pid.len == 0) {
        
# 1116 "project/nginx/src/core/nginx.c" 3 4
       (
# 1116 "project/nginx/src/core/nginx.c"
       &ccf->pid
# 1116 "project/nginx/src/core/nginx.c" 3 4
       )->len = sizeof("logs/nginx.pid") - 1; (
# 1116 "project/nginx/src/core/nginx.c"
       &ccf->pid
# 1116 "project/nginx/src/core/nginx.c" 3 4
       )->data = (u_char *) "logs/nginx.pid"
# 1116 "project/nginx/src/core/nginx.c"
                                           ;
    }

    if (ngx_conf_full_name(cycle, &ccf->pid, 0) != 
# 1119 "project/nginx/src/core/nginx.c" 3 4
                                                  0
# 1119 "project/nginx/src/core/nginx.c"
                                                        ) {
        return 
# 1120 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1120 "project/nginx/src/core/nginx.c"
                            ;
    }

    ccf->oldpid.len = ccf->pid.len + sizeof(
# 1123 "project/nginx/src/core/nginx.c" 3 4
                                           ".oldbin"
# 1123 "project/nginx/src/core/nginx.c"
                                                         );

    ccf->oldpid.data = ngx_pnalloc(cycle->pool, ccf->oldpid.len);
    if (ccf->oldpid.data == 
# 1126 "project/nginx/src/core/nginx.c" 3 4
                           ((void *)0)
# 1126 "project/nginx/src/core/nginx.c"
                               ) {
        return 
# 1127 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1127 "project/nginx/src/core/nginx.c"
                            ;
    }

    
# 1130 "project/nginx/src/core/nginx.c" 3 4
   (void) __builtin___memcpy_chk ((((u_char *) __builtin___memcpy_chk (
# 1130 "project/nginx/src/core/nginx.c"
   ccf->oldpid.data
# 1130 "project/nginx/src/core/nginx.c" 3 4
   , 
# 1130 "project/nginx/src/core/nginx.c"
...
# 1130 "project/nginx/src/core/nginx.c" 3 4
   , __builtin_object_size ((((u_char *) __builtin___memcpy_chk (
# 1130 "project/nginx/src/core/nginx.c"
   ccf->oldpid.data
# 1130 "project/nginx/src/core/nginx.c" 3 4
   , 
...
# 1131 "project/nginx/src/core/nginx.c"
                                                     ;
    ...
    if (ccf->user == (uid_t) 
# 1136 "project/nginx/src/core/nginx.c" 3 4
                            (ngx_uint_t) -1 
# 1136 "project/nginx/src/core/nginx.c"
                                                && geteuid() == 0) {
        struct group *grp;
        struct passwd *pwd;

        
# 1140 "project/nginx/src/core/nginx.c" 3 4
       (*__error()) = 
# 1140 "project/nginx/src/core/nginx.c"
       0;
        pwd = getpwnam(
# 1141 "project/nginx/src/core/nginx.c" 3 4
                      "nobody"
# 1141 "project/nginx/src/core/nginx.c"
                              );
        if (pwd == 
# 1142 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 1142 "project/nginx/src/core/nginx.c"
                      ) {
            
# 1143 "project/nginx/src/core/nginx.c" 3 4
           if ((
# 1143 "project/nginx/src/core/nginx.c"
           cycle->log
# 1143 "project/nginx/src/core/nginx.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1143 "project/nginx/src/core/nginx.c"
...
# 1144 "project/nginx/src/core/nginx.c"
                                                             ;
            return 
# 1145 "project/nginx/src/core/nginx.c" 3 4
                  (void *) -1
# 1145 "project/nginx/src/core/nginx.c"
                                ;
        }

        ccf->username = 
# 1148 "project/nginx/src/core/nginx.c" 3 4
                       "nobody"
# 1148 "project/nginx/src/core/nginx.c"
                               ;
        ccf->user = pwd->pw_uid;

        
# 1151 "project/nginx/src/core/nginx.c" 3 4
       (*__error()) = 
# 1151 "project/nginx/src/core/nginx.c"
       0;
        grp = getgrnam(
# 1152 "project/nginx/src/core/nginx.c" 3 4
                      "nobody"
# 1152 "project/nginx/src/core/nginx.c"
                               );
        if (grp == 
# 1153 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 1153 "project/nginx/src/core/nginx.c"
                      ) {
            
# 1154 "project/nginx/src/core/nginx.c" 3 4
           if ((
# 1154 "project/nginx/src/core/nginx.c"
           cycle->log
# 1154 "project/nginx/src/core/nginx.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1154 "project/nginx/src/core/nginx.c"
...
# 1155 "project/nginx/src/core/nginx.c"
                                                              ;
            return 
# 1156 "project/nginx/src/core/nginx.c" 3 4
                  (void *) -1
# 1156 "project/nginx/src/core/nginx.c"
                                ;
        }
...
# 1164 "project/nginx/src/core/nginx.c" 3 4
       (
# 1164 "project/nginx/src/core/nginx.c"
       &ccf->lock_file
# 1164 "project/nginx/src/core/nginx.c" 3 4
       )->len = sizeof("logs/nginx.lock") - 1; (
# 1164 "project/nginx/src/core/nginx.c"
       &ccf->lock_file
# 1164 "project/nginx/src/core/nginx.c" 3 4
       )->data = (u_char *) "logs/nginx.lock"
# 1164 "project/nginx/src/core/nginx.c"
                                                  ;
    }

    if (ngx_conf_full_name(cycle, &ccf->lock_file, 0) != 
# 1167 "project/nginx/src/core/nginx.c" 3 4
                                                        0
# 1167 "project/nginx/src/core/nginx.c"
                                                              ) {
        return 
# 1168 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1168 "project/nginx/src/core/nginx.c"
                            ;
    }
    ...
    if (lock_file.len) {
        ...
        if (ccf->lock_file.len != lock_file.len
            || 
# 1180 "project/nginx/src/core/nginx.c" 3 4
              strncmp((const char *) 
# 1180 "project/nginx/src/core/nginx.c"
              ccf->lock_file.data
# 1180 "project/nginx/src/core/nginx.c" 3 4
              , (const char *) 
# 1180 "project/nginx/src/core/nginx.c"
...
# 1181 "project/nginx/src/core/nginx.c"
              != 0)
        {
            
# 1183 "project/nginx/src/core/nginx.c" 3 4
           if ((
# 1183 "project/nginx/src/core/nginx.c"
           cycle->log
# 1183 "project/nginx/src/core/nginx.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1183 "project/nginx/src/core/nginx.c"
...
# 1183 "project/nginx/src/core/nginx.c" 3 4
           , 
# 1183 "project/nginx/src/core/nginx.c"
           0, "\"lock_file\" could not be changed, ignored"
# 1183 "project/nginx/src/core/nginx.c" 3 4
           )
                                                                        
# 1184 "project/nginx/src/core/nginx.c"
                                                                       ;
        }
        ...
        if (cycle->lock_file.data == 
# 1191 "project/nginx/src/core/nginx.c" 3 4
                                    ((void *)0)
# 1191 "project/nginx/src/core/nginx.c"
                                        ) {
            return 
# 1192 "project/nginx/src/core/nginx.c" 3 4
                  (void *) -1
# 1192 "project/nginx/src/core/nginx.c"
                                ;
        }
        ...
        if (cycle->lock_file.data == 
# 1199 "project/nginx/src/core/nginx.c" 3 4
                                    ((void *)0)
# 1199 "project/nginx/src/core/nginx.c"
                                        ) {
            return 
# 1200 "project/nginx/src/core/nginx.c" 3 4
                  (void *) -1
# 1200 "project/nginx/src/core/nginx.c"
                                ;
        }

        
# 1203 "project/nginx/src/core/nginx.c" 3 4
       (void) __builtin___memcpy_chk ((((u_char *) __builtin___memcpy_chk (
# 1203 "project/nginx/src/core/nginx.c"
...
# 1205 "project/nginx/src/core/nginx.c"
                                               ;
    }
    }
    ...
    return 
# 1211 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1211 "project/nginx/src/core/nginx.c"
                     ;
}
...
{
# 1227 "project/nginx/src/core/nginx.c"
    ngx_core_conf_t *ccf = conf;
    ...
    if (ccf->user != (uid_t) 
# 1234 "project/nginx/src/core/nginx.c" 3 4
                            (ngx_uint_t) -1
# 1234 "project/nginx/src/core/nginx.c"
                                               ) {
        return "is duplicate";
    }
    ...
    if (geteuid() != 0) {
        ngx_conf_log_error(
# 1239 "project/nginx/src/core/nginx.c" 3 4
                          5
# 1239 "project/nginx/src/core/nginx.c"
                                      , cf, 0,
                           "the \"user\" directive makes sense only "
                           "if the master process runs "
                           "with super-user privileges, ignored");
        return 
# 1243 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1243 "project/nginx/src/core/nginx.c"
                         ;
    }
...
# 1250 "project/nginx/src/core/nginx.c" 3 4
   (*__error()) = 
# 1250 "project/nginx/src/core/nginx.c"
   0;
    pwd = getpwnam((const char *) value[1].data);
    if (pwd == 
# 1252 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1252 "project/nginx/src/core/nginx.c"
                  ) {
        ngx_conf_log_error(
# 1253 "project/nginx/src/core/nginx.c" 3 4
                          1
# 1253 "project/nginx/src/core/nginx.c"
                                       , cf, 
# 1253 "project/nginx/src/core/nginx.c" 3 4
                                             (*__error())
# 1253 "project/nginx/src/core/nginx.c"
        ...
        return 
# 1255 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1255 "project/nginx/src/core/nginx.c"
                            ;
    }
...
# 1262 "project/nginx/src/core/nginx.c" 3 4
   (*__error()) = 
# 1262 "project/nginx/src/core/nginx.c"
   0;
    grp = getgrnam(group);
    if (grp == 
# 1264 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1264 "project/nginx/src/core/nginx.c"
                  ) {
        ngx_conf_log_error(
# 1265 "project/nginx/src/core/nginx.c" 3 4
                          1
# 1265 "project/nginx/src/core/nginx.c"
                                       , cf, 
# 1265 "project/nginx/src/core/nginx.c" 3 4
                                             (*__error())
# 1265 "project/nginx/src/core/nginx.c"
        ...
        return 
# 1267 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1267 "project/nginx/src/core/nginx.c"
                            ;
    }
    ...
    return 
# 1272 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1272 "project/nginx/src/core/nginx.c"
                     ;
...
ngx_set_env(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    var = ngx_array_push(&ccf->env);
    if (var == 
# 1287 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1287 "project/nginx/src/core/nginx.c"
                  ) {
        return 
# 1288 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1288 "project/nginx/src/core/nginx.c"
                            ;
    }
    ...
    *var = value[1];
    ...
    for (i = 0; i < value[1].len; i++) {
        ...
        if (value[1].data[i] == '=') {
            ...
            return 
# 1300 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 1300 "project/nginx/src/core/nginx.c"
                             ;
        }
    }

    return 
# 1304 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1304 "project/nginx/src/core/nginx.c"
                     ;
}
...
ngx_set_priority(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ccf->priority == 
# 1336 "project/nginx/src/core/nginx.c" 3 4
                        -1
# 1336 "project/nginx/src/core/nginx.c"
                                 ) {
    ...
    return 
# 1344 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1344 "project/nginx/src/core/nginx.c"
                     ;
}
...
{
# 1437 "project/nginx/src/core/nginx.c"
    ngx_conf_log_error(
# 1437 "project/nginx/src/core/nginx.c" 3 4
                      5
# 1437 "project/nginx/src/core/nginx.c"
                                  , cf, 0,
    ...
    return 
# 1442 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1442 "project/nginx/src/core/nginx.c"
                     ;
}
...
{
# 1494 "project/nginx/src/core/nginx.c"
    return 
# 1494 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1494 "project/nginx/src/core/nginx.c"
              ;
...
# 1508 "project/nginx/src/core/nginx.c" 3 4
                                -1
# 1508 "project/nginx/src/core/nginx.c"
                                              ) {
        return "is duplicate";
    }
    ...
    if (
# 1514 "project/nginx/src/core/nginx.c" 3 4
       strcmp((const char *) 
# 1514 "project/nginx/src/core/nginx.c"
       value[1].data
# 1514 "project/nginx/src/core/nginx.c" 3 4
       , (const char *) 
# 1514 "project/nginx/src/core/nginx.c"
...
# 1514 "project/nginx/src/core/nginx.c"
        ...
        return 
# 1516 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1516 "project/nginx/src/core/nginx.c"
                         ;
    }
    ...
    if (ccf->worker_processes == 
# 1521 "project/nginx/src/core/nginx.c" 3 4
                                -1
# 1521 "project/nginx/src/core/nginx.c"
                                         ) {
        return "invalid value";
    }

    return 
# 1525 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1525 "project/nginx/src/core/nginx.c"
                     ;
}
...
ngx_load_module(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_conf_full_name(cf->cycle, &file, 0) != 
# 1548 "project/nginx/src/core/nginx.c" 3 4
                                                  0
# 1548 "project/nginx/src/core/nginx.c"
                                                        ) {
        return 
# 1549 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1549 "project/nginx/src/core/nginx.c"
                            ;
    }

    cln = ngx_pool_cleanup_add(cf->cycle->pool, 0);
    if (cln == 
# 1553 "project/nginx/src/core/nginx.c" 3 4
              ((void *)0)
# 1553 "project/nginx/src/core/nginx.c"
                  ) {
        return 
# 1554 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1554 "project/nginx/src/core/nginx.c"
                            ;
    }

    handle = 
# 1557 "project/nginx/src/core/nginx.c" 3 4
            dlopen((char *) 
# 1557 "project/nginx/src/core/nginx.c"
            file.data
# 1557 "project/nginx/src/core/nginx.c" 3 4
            , 0x2 | 0x8)
# 1557 "project/nginx/src/core/nginx.c"
                                 ;
    if (handle == 
# 1558 "project/nginx/src/core/nginx.c" 3 4
                 ((void *)0)
# 1558 "project/nginx/src/core/nginx.c"
                     ) {
        ngx_conf_log_error(
# 1559 "project/nginx/src/core/nginx.c" 3 4
                          1
# 1559 "project/nginx/src/core/nginx.c"
                                       , cf, 0,
                           
# 1560 "project/nginx/src/core/nginx.c" 3 4
                          "dlopen()" 
# 1560 "project/nginx/src/core/nginx.c"
                                       " \"%s\" failed (%s)",
                           file.data, ngx_dlerror());
        return 
# 1562 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1562 "project/nginx/src/core/nginx.c"
                            ;
    }
    ...
    modules = 
# 1568 "project/nginx/src/core/nginx.c" 3 4
             dlsym(
# 1568 "project/nginx/src/core/nginx.c"
             handle
# 1568 "project/nginx/src/core/nginx.c" 3 4
             , 
# 1568 "project/nginx/src/core/nginx.c"
...
# 1568 "project/nginx/src/core/nginx.c"
                                             ;
    if (modules == 
# 1569 "project/nginx/src/core/nginx.c" 3 4
                  ((void *)0)
# 1569 "project/nginx/src/core/nginx.c"
                      ) {
        ngx_conf_log_error(
# 1570 "project/nginx/src/core/nginx.c" 3 4
                          1
# 1570 "project/nginx/src/core/nginx.c"
                                       , cf, 0,
                           
# 1571 "project/nginx/src/core/nginx.c" 3 4
                          "dlsym()" 
# 1571 "project/nginx/src/core/nginx.c"
                                      " \"%V\", \"%s\" failed (%s)",
                           &value[1], "ngx_modules", ngx_dlerror());
        return 
# 1573 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1573 "project/nginx/src/core/nginx.c"
                            ;
    }

    names = 
# 1576 "project/nginx/src/core/nginx.c" 3 4
           dlsym(
# 1576 "project/nginx/src/core/nginx.c"
           handle
# 1576 "project/nginx/src/core/nginx.c" 3 4
           , 
# 1576 "project/nginx/src/core/nginx.c"
...
# 1576 "project/nginx/src/core/nginx.c"
                                                ;
    if (names == 
# 1577 "project/nginx/src/core/nginx.c" 3 4
                ((void *)0)
# 1577 "project/nginx/src/core/nginx.c"
                    ) {
        ngx_conf_log_error(
# 1578 "project/nginx/src/core/nginx.c" 3 4
                          1
# 1578 "project/nginx/src/core/nginx.c"
                                       , cf, 0,
                           
# 1579 "project/nginx/src/core/nginx.c" 3 4
                          "dlsym()" 
# 1579 "project/nginx/src/core/nginx.c"
                                      " \"%V\", \"%s\" failed (%s)",
                           &value[1], "ngx_module_names", ngx_dlerror());
        return 
# 1581 "project/nginx/src/core/nginx.c" 3 4
              (void *) -1
# 1581 "project/nginx/src/core/nginx.c"
                            ;
    }

    order = 
# 1584 "project/nginx/src/core/nginx.c" 3 4
           dlsym(
# 1584 "project/nginx/src/core/nginx.c"
           handle
# 1584 "project/nginx/src/core/nginx.c" 3 4
           , 
# 1584 "project/nginx/src/core/nginx.c"
...
# 1584 "project/nginx/src/core/nginx.c"
    ...
    for (i = 0; modules[i]; i++) {
        ...
        if (ngx_add_module(cf, &file, module, order) != 
# 1590 "project/nginx/src/core/nginx.c" 3 4
                                                       0
# 1590 "project/nginx/src/core/nginx.c"
                                                             ) {
            return 
# 1591 "project/nginx/src/core/nginx.c" 3 4
                  (void *) -1
# 1591 "project/nginx/src/core/nginx.c"
                                ;
        }
    ...
    return 
# 1598 "project/nginx/src/core/nginx.c" 3 4
          ((void *)0)
# 1598 "project/nginx/src/core/nginx.c"
                     ;
# 1608 "project/nginx/src/core/nginx.c"
}
...
ngx_unload_module(void *data)
{
    ...
    if (
# 1618 "project/nginx/src/core/nginx.c" 3 4
       dlclose(
# 1618 "project/nginx/src/core/nginx.c"
       handle
# 1618 "project/nginx/src/core/nginx.c" 3 4
       ) 
# 1618 "project/nginx/src/core/nginx.c"
...
# 1619 "project/nginx/src/core/nginx.c" 3 4
       if ((
# 1619 "project/nginx/src/core/nginx.c"
       ngx_cycle->log
# 1619 "project/nginx/src/core/nginx.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1619 "project/nginx/src/core/nginx.c"
...
# 1620 "project/nginx/src/core/nginx.c"
                                                                 ;
    }
}
