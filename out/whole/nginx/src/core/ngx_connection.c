# 0 "project/nginx/src/core/ngx_connection.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/core/ngx_connection.c" 2
...
# 10 "project/nginx/src/core/ngx_connection.c" 2
...
# 11 "project/nginx/src/core/ngx_connection.c" 2



# 13 "project/nginx/src/core/ngx_connection.c"
ngx_os_io_t ngx_io;
    ...
    socklen_t socklen)
{
    ...
    struct sockaddr *sa;
    u_char text[
# 26 "project/nginx/src/core/ngx_connection.c" 3 4
                          (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 26 "project/nginx/src/core/ngx_connection.c"
                                             ];

    ls = ngx_array_push(&cf->cycle->listening);
    if (ls == 
# 29 "project/nginx/src/core/ngx_connection.c" 3 4
             ((void *)0)
# 29 "project/nginx/src/core/ngx_connection.c"
                 ) {
        return 
# 30 "project/nginx/src/core/ngx_connection.c" 3 4
              ((void *)0)
# 30 "project/nginx/src/core/ngx_connection.c"
                  ;
    }

    
# 33 "project/nginx/src/core/ngx_connection.c" 3 4
   (void) __builtin___memset_chk (
# 33 "project/nginx/src/core/ngx_connection.c"
   ls
# 33 "project/nginx/src/core/ngx_connection.c" 3 4
   , 0, 
# 33 "project/nginx/src/core/ngx_connection.c"
...
# 33 "project/nginx/src/core/ngx_connection.c"
    ...
    if (sa == 
# 36 "project/nginx/src/core/ngx_connection.c" 3 4
             ((void *)0)
# 36 "project/nginx/src/core/ngx_connection.c"
                 ) {
        return 
# 37 "project/nginx/src/core/ngx_connection.c" 3 4
              ((void *)0)
# 37 "project/nginx/src/core/ngx_connection.c"
                  ;
    }

    
# 40 "project/nginx/src/core/ngx_connection.c" 3 4
   (void) __builtin___memcpy_chk (
# 40 "project/nginx/src/core/ngx_connection.c"
   sa
# 40 "project/nginx/src/core/ngx_connection.c" 3 4
   , 
# 40 "project/nginx/src/core/ngx_connection.c"
...
# 40 "project/nginx/src/core/ngx_connection.c"
    ...
    len = ngx_sock_ntop(sa, socklen, text, 
# 45 "project/nginx/src/core/ngx_connection.c" 3 4
                                          (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 45 "project/nginx/src/core/ngx_connection.c"
                                                             , 1);
    ...
    case 
# 50 "project/nginx/src/core/ngx_connection.c" 3 4
        30
# 50 "project/nginx/src/core/ngx_connection.c"
                :
        ls->addr_text_max_len = 
# 51 "project/nginx/src/core/ngx_connection.c" 3 4
                               (sizeof("ffff:ffff:ffff:ffff:ffff:ffff:255.255.255.255") - 1)
# 51 "project/nginx/src/core/ngx_connection.c"
                                                   ;
        break;


    case 
# 55 "project/nginx/src/core/ngx_connection.c" 3 4
        1
# 55 "project/nginx/src/core/ngx_connection.c"
               :
        ls->addr_text_max_len = 
# 56 "project/nginx/src/core/ngx_connection.c" 3 4
                               (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 56 "project/nginx/src/core/ngx_connection.c"
                                                  ;
        len++;
        break;

    case 
# 60 "project/nginx/src/core/ngx_connection.c" 3 4
        2
# 60 "project/nginx/src/core/ngx_connection.c"
               :
        ls->addr_text_max_len = 
# 61 "project/nginx/src/core/ngx_connection.c" 3 4
                               (sizeof("255.255.255.255") - 1)
# 61 "project/nginx/src/core/ngx_connection.c"
                                                  ;
        break;
    default:
        ls->addr_text_max_len = 
# 64 "project/nginx/src/core/ngx_connection.c" 3 4
                               (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 64 "project/nginx/src/core/ngx_connection.c"
                                                  ;
        break;
    }
...
# 69 "project/nginx/src/core/ngx_connection.c" 3 4
                             ((void *)0)
# 69 "project/nginx/src/core/ngx_connection.c"
                                 ) {
        return 
# 70 "project/nginx/src/core/ngx_connection.c" 3 4
              ((void *)0)
# 70 "project/nginx/src/core/ngx_connection.c"
                  ;
    }

    
# 73 "project/nginx/src/core/ngx_connection.c" 3 4
   (void) __builtin___memcpy_chk (
# 73 "project/nginx/src/core/ngx_connection.c"
   ls->addr_text.data
# 73 "project/nginx/src/core/ngx_connection.c" 3 4
   , 
# 73 "project/nginx/src/core/ngx_connection.c"
...
# 76 "project/nginx/src/core/ngx_connection.c" 3 4
   ((
# 76 "project/nginx/src/core/ngx_connection.c"
   &ls->sentinel
# 76 "project/nginx/src/core/ngx_connection.c" 3 4
   )->color = 0); (
# 76 "project/nginx/src/core/ngx_connection.c"
...
# 76 "project/nginx/src/core/ngx_connection.c"
   ngx_udp_rbtree_insert_value;
    ...
    ls->type = 
# 80 "project/nginx/src/core/ngx_connection.c" 3 4
              1
# 80 "project/nginx/src/core/ngx_connection.c"
                         ;

    ls->backlog = 
# 82 "project/nginx/src/core/ngx_connection.c" 3 4
                 -1
# 82 "project/nginx/src/core/ngx_connection.c"
                                   ;
    ls->rcvbuf = -1;
    ls->sndbuf = -1;
...
ngx_clone_listening(ngx_cycle_t *cycle, ngx_listening_t *ls)
{
    ...
    if (!ls->reuseport || ls->worker != 0) {
        return 
# 108 "project/nginx/src/core/ngx_connection.c" 3 4
              0
# 108 "project/nginx/src/core/ngx_connection.c"
                    ;
    }
...
# 113 "project/nginx/src/core/ngx_connection.c" 3 4
                             [
# 113 "project/nginx/src/core/ngx_connection.c"
                             ngx_core_module
# 113 "project/nginx/src/core/ngx_connection.c" 3 4
                             .index]
# 113 "project/nginx/src/core/ngx_connection.c"
    ...
    for (n = 1; n < ccf->worker_processes; n++) {
        ...
        if (ls == 
# 120 "project/nginx/src/core/ngx_connection.c" 3 4
                 ((void *)0)
# 120 "project/nginx/src/core/ngx_connection.c"
                     ) {
            return 
# 121 "project/nginx/src/core/ngx_connection.c" 3 4
                  -1
# 121 "project/nginx/src/core/ngx_connection.c"
                           ;
        }
    ...
    return 
# 130 "project/nginx/src/core/ngx_connection.c" 3 4
          0
# 130 "project/nginx/src/core/ngx_connection.c"
                ;
}
...
ngx_set_inherited_sockets(ngx_cycle_t *cycle)
{
    ...
    ngx_err_t err;
# 151 "project/nginx/src/core/ngx_connection.c"
    int reuseport;
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ...
        if (ls[i].sockaddr == 
# 158 "project/nginx/src/core/ngx_connection.c" 3 4
                             ((void *)0)
# 158 "project/nginx/src/core/ngx_connection.c"
                                 ) {
            return 
# 159 "project/nginx/src/core/ngx_connection.c" 3 4
                  -1
# 159 "project/nginx/src/core/ngx_connection.c"
                           ;
        }
...
# 164 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 164 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 164 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 164 "project/nginx/src/core/ngx_connection.c" 3 4
           , (*__error())
# 164 "project/nginx/src/core/ngx_connection.c"
           , "getsockname() of the inherited " "socket #%d failed", ls[i].fd
# 164 "project/nginx/src/core/ngx_connection.c" 3 4
           )

                                                        
# 166 "project/nginx/src/core/ngx_connection.c"
                                                       ;
            ls[i].ignore = 1;
            continue;
        }
        ...
        case 
# 178 "project/nginx/src/core/ngx_connection.c" 3 4
            30
# 178 "project/nginx/src/core/ngx_connection.c"
                    :
            ls[i].addr_text_max_len = 
# 179 "project/nginx/src/core/ngx_connection.c" 3 4
                                     (sizeof("ffff:ffff:ffff:ffff:ffff:ffff:255.255.255.255") - 1)
# 179 "project/nginx/src/core/ngx_connection.c"
                                                         ;
            len = 
# 180 "project/nginx/src/core/ngx_connection.c" 3 4
                 (sizeof("ffff:ffff:ffff:ffff:ffff:ffff:255.255.255.255") - 1) 
# 180 "project/nginx/src/core/ngx_connection.c"
                                      + sizeof("[]:65535") - 1;
            break;
        ...
        case 
# 185 "project/nginx/src/core/ngx_connection.c" 3 4
            1
# 185 "project/nginx/src/core/ngx_connection.c"
                   :
            ls[i].addr_text_max_len = 
# 186 "project/nginx/src/core/ngx_connection.c" 3 4
                                     (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 186 "project/nginx/src/core/ngx_connection.c"
                                                        ;
            len = 
# 187 "project/nginx/src/core/ngx_connection.c" 3 4
                 (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 187 "project/nginx/src/core/ngx_connection.c"
                                    ;
            break;


        case 
# 191 "project/nginx/src/core/ngx_connection.c" 3 4
            2
# 191 "project/nginx/src/core/ngx_connection.c"
                   :
            ls[i].addr_text_max_len = 
# 192 "project/nginx/src/core/ngx_connection.c" 3 4
                                     (sizeof("255.255.255.255") - 1)
# 192 "project/nginx/src/core/ngx_connection.c"
                                                        ;
            len = 
# 193 "project/nginx/src/core/ngx_connection.c" 3 4
                 (sizeof("255.255.255.255") - 1) 
# 193 "project/nginx/src/core/ngx_connection.c"
                                     + sizeof(":65535") - 1;
            break;

        default:
            
# 197 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 197 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 197 "project/nginx/src/core/ngx_connection.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 197 "project/nginx/src/core/ngx_connection.c"
...
# 199 "project/nginx/src/core/ngx_connection.c"
                                                                    ;
            ls[i].ignore = 1;
            continue;
        }
        ...
        if (ls[i].addr_text.data == 
# 205 "project/nginx/src/core/ngx_connection.c" 3 4
                                   ((void *)0)
# 205 "project/nginx/src/core/ngx_connection.c"
                                       ) {
            return 
# 206 "project/nginx/src/core/ngx_connection.c" 3 4
                  -1
# 206 "project/nginx/src/core/ngx_connection.c"
                           ;
        }
        ...
        if (len == 0) {
            return 
# 212 "project/nginx/src/core/ngx_connection.c" 3 4
                  -1
# 212 "project/nginx/src/core/ngx_connection.c"
                           ;
        }
        ...
        ls[i].backlog = 
# 217 "project/nginx/src/core/ngx_connection.c" 3 4
                       -1
# 217 "project/nginx/src/core/ngx_connection.c"
                                         ;

        olen = sizeof(int);

        if (getsockopt(ls[i].fd, 
# 221 "project/nginx/src/core/ngx_connection.c" 3 4
                                0xffff
# 221 "project/nginx/src/core/ngx_connection.c"
                                          , 
# 221 "project/nginx/src/core/ngx_connection.c" 3 4
                                            0x1008
# 221 "project/nginx/src/core/ngx_connection.c"
...
# 225 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 225 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 225 "project/nginx/src/core/ngx_connection.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 225 "project/nginx/src/core/ngx_connection.c"
...
# 226 "project/nginx/src/core/ngx_connection.c"
                                                                           ;
            ls[i].ignore = 1;
            continue;
        }
        ...
        if (getsockopt(ls[i].fd, 
# 233 "project/nginx/src/core/ngx_connection.c" 3 4
                                0xffff
# 233 "project/nginx/src/core/ngx_connection.c"
                                          , 
# 233 "project/nginx/src/core/ngx_connection.c" 3 4
                                            0x1002
# 233 "project/nginx/src/core/ngx_connection.c"
...
# 237 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 237 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 237 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 239 "project/nginx/src/core/ngx_connection.c"
                                          ;
        ...
        if (getsockopt(ls[i].fd, 
# 246 "project/nginx/src/core/ngx_connection.c" 3 4
                                0xffff
# 246 "project/nginx/src/core/ngx_connection.c"
                                          , 
# 246 "project/nginx/src/core/ngx_connection.c" 3 4
                                            0x1001
# 246 "project/nginx/src/core/ngx_connection.c"
...
# 250 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 250 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 250 "project/nginx/src/core/ngx_connection.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 250 "project/nginx/src/core/ngx_connection.c"
...
# 252 "project/nginx/src/core/ngx_connection.c"
                                          ;

            ls[i].sndbuf = -1;
        }
# 280 "project/nginx/src/core/ngx_connection.c"
        reuseport = 0;
        olen = sizeof(int);
# 299 "project/nginx/src/core/ngx_connection.c"
        if (getsockopt(ls[i].fd, 
# 299 "project/nginx/src/core/ngx_connection.c" 3 4
                                0xffff
# 299 "project/nginx/src/core/ngx_connection.c"
                                          , 
# 299 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 303 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 303 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 303 "project/nginx/src/core/ngx_connection.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 303 "project/nginx/src/core/ngx_connection.c"
...
# 305 "project/nginx/src/core/ngx_connection.c"
                                          ;
        ...
        if (ls[i].type != 
# 314 "project/nginx/src/core/ngx_connection.c" 3 4
                         1
# 314 "project/nginx/src/core/ngx_connection.c"
                                    ) {
            continue;
        }
        ...
        if (getsockopt(ls[i].fd, 
# 322 "project/nginx/src/core/ngx_connection.c" 3 4
                                6
# 322 "project/nginx/src/core/ngx_connection.c"
                                           , 
# 322 "project/nginx/src/core/ngx_connection.c" 3 4
                                             0x105
# 322 "project/nginx/src/core/ngx_connection.c"
        ...
        {
            err = 
# 326 "project/nginx/src/core/ngx_connection.c" 3 4
                 (*__error())
# 326 "project/nginx/src/core/ngx_connection.c"
                                 ;

            if (err != 
# 328 "project/nginx/src/core/ngx_connection.c" 3 4
                      102 
# 328 "project/nginx/src/core/ngx_connection.c"
                                     && err != 
# 328 "project/nginx/src/core/ngx_connection.c" 3 4
                                               42
                
# 329 "project/nginx/src/core/ngx_connection.c"
               && err != 
# 329 "project/nginx/src/core/ngx_connection.c" 3 4
                         22
# 329 "project/nginx/src/core/ngx_connection.c"
                                   )
            {
                
# 331 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 331 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 331 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 331 "project/nginx/src/core/ngx_connection.c" 3 4
               , 
# 331 "project/nginx/src/core/ngx_connection.c"
               err, "getsockopt(TCP_FASTOPEN) %V failed, ignored", &ls[i].addr_text
# 331 "project/nginx/src/core/ngx_connection.c" 3 4
               )

                                               
# 333 "project/nginx/src/core/ngx_connection.c"
                                              ;
            }

            ls[i].fastopen = -1;
        }
# 400 "project/nginx/src/core/ngx_connection.c"
    }

    return 
# 402 "project/nginx/src/core/ngx_connection.c" 3 4
          0
# 402 "project/nginx/src/core/ngx_connection.c"
                ;
}
    ...
    for (tries = 5; tries; tries--) {
        ...
        for (i = 0; i < cycle->listening.nelts; i++) {
            ...
            if (ls[i].add_reuseport) {
                ...
                int reuseport = 1;
# 463 "project/nginx/src/core/ngx_connection.c"
                if (setsockopt(ls[i].fd, 
# 463 "project/nginx/src/core/ngx_connection.c" 3 4
                                        0xffff
# 463 "project/nginx/src/core/ngx_connection.c"
                                                  , 
# 463 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 467 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 467 "project/nginx/src/core/ngx_connection.c"
                   cycle->log
# 467 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 467 "project/nginx/src/core/ngx_connection.c"
...
# 469 "project/nginx/src/core/ngx_connection.c"
                                                  ;
                }
            ...
            s = 
# 490 "project/nginx/src/core/ngx_connection.c" 3 4
               socket
# 490 "project/nginx/src/core/ngx_connection.c"
                         (ls[i].sockaddr->sa_family, ls[i].type, 0);

            if (s == (ngx_socket_t) -1) {
                
# 493 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 493 "project/nginx/src/core/ngx_connection.c"
               log
# 493 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 494 "project/nginx/src/core/ngx_connection.c"
                                                                         ;
                return 
# 495 "project/nginx/src/core/ngx_connection.c" 3 4
                      -1
# 495 "project/nginx/src/core/ngx_connection.c"
                               ;
            }

            if (ls[i].type != 
# 498 "project/nginx/src/core/ngx_connection.c" 3 4
                             2 
# 498 "project/nginx/src/core/ngx_connection.c"
                                        || !ngx_test_config) {

                if (setsockopt(s, 
# 500 "project/nginx/src/core/ngx_connection.c" 3 4
                                 0xffff
# 500 "project/nginx/src/core/ngx_connection.c"
                                           , 
# 500 "project/nginx/src/core/ngx_connection.c" 3 4
                                             0x0004
# 500 "project/nginx/src/core/ngx_connection.c"
...
# 504 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 504 "project/nginx/src/core/ngx_connection.c"
                   log
# 504 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 504 "project/nginx/src/core/ngx_connection.c"
...
# 506 "project/nginx/src/core/ngx_connection.c"
                                                  ;

                    if (
# 508 "project/nginx/src/core/ngx_connection.c" 3 4
                       close
# 508 "project/nginx/src/core/ngx_connection.c"
                                       (s) == -1) {
                        
# 509 "project/nginx/src/core/ngx_connection.c" 3 4
                       if ((
# 509 "project/nginx/src/core/ngx_connection.c"
                       log
# 509 "project/nginx/src/core/ngx_connection.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 509 "project/nginx/src/core/ngx_connection.c"
...
# 511 "project/nginx/src/core/ngx_connection.c"
                                                      ;
                    }

                    return 
# 514 "project/nginx/src/core/ngx_connection.c" 3 4
                          -1
# 514 "project/nginx/src/core/ngx_connection.c"
                                   ;
                }
            }
            ...
            if (ls[i].reuseport && !ngx_test_config) {
                ...
                reuseport = 1;
# 546 "project/nginx/src/core/ngx_connection.c"
                if (setsockopt(s, 
# 546 "project/nginx/src/core/ngx_connection.c" 3 4
                                 0xffff
# 546 "project/nginx/src/core/ngx_connection.c"
                                           , 
# 546 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 550 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 550 "project/nginx/src/core/ngx_connection.c"
                   log
# 550 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 550 "project/nginx/src/core/ngx_connection.c"
...
# 552 "project/nginx/src/core/ngx_connection.c"
                                                  ;

                    if (
# 554 "project/nginx/src/core/ngx_connection.c" 3 4
                       close
# 554 "project/nginx/src/core/ngx_connection.c"
                                       (s) == -1) {
                        
# 555 "project/nginx/src/core/ngx_connection.c" 3 4
                       if ((
# 555 "project/nginx/src/core/ngx_connection.c"
                       log
# 555 "project/nginx/src/core/ngx_connection.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 555 "project/nginx/src/core/ngx_connection.c"
...
# 557 "project/nginx/src/core/ngx_connection.c"
                                                      ;
                    }

                    return 
# 560 "project/nginx/src/core/ngx_connection.c" 3 4
                          -1
# 560 "project/nginx/src/core/ngx_connection.c"
                                   ;
                }
...
# 568 "project/nginx/src/core/ngx_connection.c" 3 4
                                            30
# 568 "project/nginx/src/core/ngx_connection.c"
                                                    ) {
                int ipv6only;
                ...
                if (setsockopt(s, 
# 573 "project/nginx/src/core/ngx_connection.c" 3 4
                                 41
# 573 "project/nginx/src/core/ngx_connection.c"
                                             , 
# 573 "project/nginx/src/core/ngx_connection.c" 3 4
                                               27
# 573 "project/nginx/src/core/ngx_connection.c"
...
# 577 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 577 "project/nginx/src/core/ngx_connection.c"
                   log
# 577 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 577 "project/nginx/src/core/ngx_connection.c"
...
# 577 "project/nginx/src/core/ngx_connection.c" 3 4
                   , (*__error())
# 577 "project/nginx/src/core/ngx_connection.c"
                   , "setsockopt(IPV6_V6ONLY) %V failed, ignored", &ls[i].addr_text
# 577 "project/nginx/src/core/ngx_connection.c" 3 4
                   )

                                                   
# 579 "project/nginx/src/core/ngx_connection.c"
                                                  ;
                }
            }
            ...
            if (!(ngx_event_flags & 
# 585 "project/nginx/src/core/ngx_connection.c" 3 4
                                   0x00000200
# 585 "project/nginx/src/core/ngx_connection.c"
                                                     )) {
                if (ngx_nonblocking(s) == -1) {
                    
# 587 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 587 "project/nginx/src/core/ngx_connection.c"
                   log
# 587 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 587 "project/nginx/src/core/ngx_connection.c"
...
# 589 "project/nginx/src/core/ngx_connection.c"
                                                  ;

                    if (
# 591 "project/nginx/src/core/ngx_connection.c" 3 4
                       close
# 591 "project/nginx/src/core/ngx_connection.c"
                                       (s) == -1) {
                        
# 592 "project/nginx/src/core/ngx_connection.c" 3 4
                       if ((
# 592 "project/nginx/src/core/ngx_connection.c"
                       log
# 592 "project/nginx/src/core/ngx_connection.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 592 "project/nginx/src/core/ngx_connection.c"
...
# 594 "project/nginx/src/core/ngx_connection.c"
                                                      ;
                    }

                    return 
# 597 "project/nginx/src/core/ngx_connection.c" 3 4
                          -1
# 597 "project/nginx/src/core/ngx_connection.c"
                                   ;
                }
            }
            ...
            if (bind(s, ls[i].sockaddr, ls[i].socklen) == -1) {
                err = 
# 605 "project/nginx/src/core/ngx_connection.c" 3 4
                     (*__error())
# 605 "project/nginx/src/core/ngx_connection.c"
                                     ;

                if (err != 
# 607 "project/nginx/src/core/ngx_connection.c" 3 4
                          48 
# 607 "project/nginx/src/core/ngx_connection.c"
                                         || !ngx_test_config) {
                    
# 608 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 608 "project/nginx/src/core/ngx_connection.c"
                   log
# 608 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 608 "project/nginx/src/core/ngx_connection.c"
...
# 608 "project/nginx/src/core/ngx_connection.c" 3 4
                   , 
# 608 "project/nginx/src/core/ngx_connection.c"
                   err, "bind() to %V failed", &ls[i].addr_text
# 608 "project/nginx/src/core/ngx_connection.c" 3 4
                   )
                                                                          
# 609 "project/nginx/src/core/ngx_connection.c"
                                                                         ;
                }

                if (
# 612 "project/nginx/src/core/ngx_connection.c" 3 4
                   close
# 612 "project/nginx/src/core/ngx_connection.c"
                                   (s) == -1) {
                    
# 613 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 613 "project/nginx/src/core/ngx_connection.c"
                   log
# 613 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 613 "project/nginx/src/core/ngx_connection.c"
...
# 615 "project/nginx/src/core/ngx_connection.c"
                                                  ;
                }

                if (err != 
# 618 "project/nginx/src/core/ngx_connection.c" 3 4
                          48
# 618 "project/nginx/src/core/ngx_connection.c"
                                        ) {
                    return 
# 619 "project/nginx/src/core/ngx_connection.c" 3 4
                          -1
# 619 "project/nginx/src/core/ngx_connection.c"
                                   ;
                }
            ...
            if (ls[i].sockaddr->sa_family == 
# 631 "project/nginx/src/core/ngx_connection.c" 3 4
                                            1
# 631 "project/nginx/src/core/ngx_connection.c"
                                                   ) {
                mode_t mode;
                u_char *name;
                ...
                mode = (
# 636 "project/nginx/src/core/ngx_connection.c" 3 4
                       0000400
# 636 "project/nginx/src/core/ngx_connection.c"
                              |
# 636 "project/nginx/src/core/ngx_connection.c" 3 4
                               0000200
# 636 "project/nginx/src/core/ngx_connection.c"
...
# 639 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 639 "project/nginx/src/core/ngx_connection.c"
                   cycle->log
# 639 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 639 "project/nginx/src/core/ngx_connection.c"
...
# 640 "project/nginx/src/core/ngx_connection.c"
                                                               ;
                }

                if (ngx_test_config) {
                    if (
# 644 "project/nginx/src/core/ngx_connection.c" 3 4
                       unlink((const char *) 
# 644 "project/nginx/src/core/ngx_connection.c"
                       name
# 644 "project/nginx/src/core/ngx_connection.c" 3 4
                       ) 
# 644 "project/nginx/src/core/ngx_connection.c"
...
# 645 "project/nginx/src/core/ngx_connection.c" 3 4
                       if ((
# 645 "project/nginx/src/core/ngx_connection.c"
                       cycle->log
# 645 "project/nginx/src/core/ngx_connection.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 645 "project/nginx/src/core/ngx_connection.c"
...
# 646 "project/nginx/src/core/ngx_connection.c"
                                                                          ;
                    }
                }
            }
            ...
            if (ls[i].type != 
# 652 "project/nginx/src/core/ngx_connection.c" 3 4
                             1
# 652 "project/nginx/src/core/ngx_connection.c"
                                        ) {
                ls[i].fd = s;
                continue;
            }
            ...
            if (listen(s, ls[i].backlog) == -1) {
                err = 
# 658 "project/nginx/src/core/ngx_connection.c" 3 4
                     (*__error())
# 658 "project/nginx/src/core/ngx_connection.c"
                                     ;
                ...
                if (err != 
# 666 "project/nginx/src/core/ngx_connection.c" 3 4
                          48 
# 666 "project/nginx/src/core/ngx_connection.c"
                                         || !ngx_test_config) {
                    
# 667 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 667 "project/nginx/src/core/ngx_connection.c"
                   log
# 667 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 667 "project/nginx/src/core/ngx_connection.c"
...
# 667 "project/nginx/src/core/ngx_connection.c" 3 4
                   , 
# 667 "project/nginx/src/core/ngx_connection.c"
                   err, "listen() to %V, backlog %d failed", &ls[i].addr_text, ls[i].backlog
# 667 "project/nginx/src/core/ngx_connection.c" 3 4
                   )

                                                                  
# 669 "project/nginx/src/core/ngx_connection.c"
                                                                 ;
                }

                if (
# 672 "project/nginx/src/core/ngx_connection.c" 3 4
                   close
# 672 "project/nginx/src/core/ngx_connection.c"
                                   (s) == -1) {
                    
# 673 "project/nginx/src/core/ngx_connection.c" 3 4
                   if ((
# 673 "project/nginx/src/core/ngx_connection.c"
                   log
# 673 "project/nginx/src/core/ngx_connection.c" 3 4
                   )->log_level >= 1) ngx_log_error_core(1, 
# 673 "project/nginx/src/core/ngx_connection.c"
...
# 675 "project/nginx/src/core/ngx_connection.c"
                                                  ;
                }

                if (err != 
# 678 "project/nginx/src/core/ngx_connection.c" 3 4
                          48
# 678 "project/nginx/src/core/ngx_connection.c"
                                        ) {
                    return 
# 679 "project/nginx/src/core/ngx_connection.c" 3 4
                          -1
# 679 "project/nginx/src/core/ngx_connection.c"
                                   ;
                }
...
# 700 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 700 "project/nginx/src/core/ngx_connection.c"
       log
# 700 "project/nginx/src/core/ngx_connection.c" 3 4
       )->log_level >= 6) ngx_log_error_core(6, 
# 700 "project/nginx/src/core/ngx_connection.c"
...
# 700 "project/nginx/src/core/ngx_connection.c" 3 4
       , 
# 700 "project/nginx/src/core/ngx_connection.c"
       0, "try again to bind() after 500ms"
# 700 "project/nginx/src/core/ngx_connection.c" 3 4
       )
                                                        
# 701 "project/nginx/src/core/ngx_connection.c"
                                                       ;

        
# 703 "project/nginx/src/core/ngx_connection.c" 3 4
       (void) usleep(
# 703 "project/nginx/src/core/ngx_connection.c"
       500 
# 703 "project/nginx/src/core/ngx_connection.c" 3 4
       * 1000)
# 703 "project/nginx/src/core/ngx_connection.c"
...
# 707 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 707 "project/nginx/src/core/ngx_connection.c"
       log
# 707 "project/nginx/src/core/ngx_connection.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 707 "project/nginx/src/core/ngx_connection.c"
...
# 707 "project/nginx/src/core/ngx_connection.c"
                                                                     ;
        return 
# 708 "project/nginx/src/core/ngx_connection.c" 3 4
              -1
# 708 "project/nginx/src/core/ngx_connection.c"
                       ;
    }

    return 
# 711 "project/nginx/src/core/ngx_connection.c" 3 4
          0
# 711 "project/nginx/src/core/ngx_connection.c"
                ;
}
...
ngx_configure_listening_sockets(ngx_cycle_t *cycle)
{
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ...
        if (ls[i].rcvbuf != -1) {
            if (setsockopt(ls[i].fd, 
# 732 "project/nginx/src/core/ngx_connection.c" 3 4
                                    0xffff
# 732 "project/nginx/src/core/ngx_connection.c"
                                              , 
# 732 "project/nginx/src/core/ngx_connection.c" 3 4
                                                0x1002
# 732 "project/nginx/src/core/ngx_connection.c"
...
# 736 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 736 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 736 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 736 "project/nginx/src/core/ngx_connection.c"
...
# 738 "project/nginx/src/core/ngx_connection.c"
                                                            ;
            }
        }
        ...
        if (ls[i].sndbuf != -1) {
            if (setsockopt(ls[i].fd, 
# 743 "project/nginx/src/core/ngx_connection.c" 3 4
                                    0xffff
# 743 "project/nginx/src/core/ngx_connection.c"
                                              , 
# 743 "project/nginx/src/core/ngx_connection.c" 3 4
                                                0x1001
# 743 "project/nginx/src/core/ngx_connection.c"
...
# 747 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 747 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 747 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 747 "project/nginx/src/core/ngx_connection.c"
...
# 749 "project/nginx/src/core/ngx_connection.c"
                                                            ;
            }
        }
        ...
        if (ls[i].keepalive) {
            ...
            if (setsockopt(ls[i].fd, 
# 756 "project/nginx/src/core/ngx_connection.c" 3 4
                                    0xffff
# 756 "project/nginx/src/core/ngx_connection.c"
                                              , 
# 756 "project/nginx/src/core/ngx_connection.c" 3 4
                                                0x0008
# 756 "project/nginx/src/core/ngx_connection.c"
...
# 760 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 760 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 760 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 760 "project/nginx/src/core/ngx_connection.c"
...
# 762 "project/nginx/src/core/ngx_connection.c"
                                                     ;
            }
        }
# 829 "project/nginx/src/core/ngx_connection.c"
        if (ls[i].fastopen != -1) {
            if (setsockopt(ls[i].fd, 
# 830 "project/nginx/src/core/ngx_connection.c" 3 4
                                    6
# 830 "project/nginx/src/core/ngx_connection.c"
                                               , 
# 830 "project/nginx/src/core/ngx_connection.c" 3 4
                                                 0x105
# 830 "project/nginx/src/core/ngx_connection.c"
...
# 834 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 834 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 834 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 834 "project/nginx/src/core/ngx_connection.c"
...
# 836 "project/nginx/src/core/ngx_connection.c"
                                                              ;
            }
        }
# 856 "project/nginx/src/core/ngx_connection.c"
        if (ls[i].listen) {
...
# 861 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 861 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 861 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 861 "project/nginx/src/core/ngx_connection.c"
...
# 863 "project/nginx/src/core/ngx_connection.c"
                                                             ;
            }
        }
# 959 "project/nginx/src/core/ngx_connection.c"
        if (ls[i].wildcard
            && ls[i].type == 
# 960 "project/nginx/src/core/ngx_connection.c" 3 4
                            2
            
# 961 "project/nginx/src/core/ngx_connection.c"
           && ls[i].sockaddr->sa_family == 
# 961 "project/nginx/src/core/ngx_connection.c" 3 4
                                           2
# 961 "project/nginx/src/core/ngx_connection.c"
                                                  )
        {
            ...
            if (setsockopt(ls[i].fd, 
# 965 "project/nginx/src/core/ngx_connection.c" 3 4
                                    0
# 965 "project/nginx/src/core/ngx_connection.c"
                                              , 
# 965 "project/nginx/src/core/ngx_connection.c" 3 4
                                                7
# 965 "project/nginx/src/core/ngx_connection.c"
...
# 969 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 969 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 969 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 969 "project/nginx/src/core/ngx_connection.c"
...
# 969 "project/nginx/src/core/ngx_connection.c" 3 4
               , (*__error())
# 969 "project/nginx/src/core/ngx_connection.c"
               , "setsockopt(IP_RECVDSTADDR) " "for %V failed, ignored", &ls[i].addr_text
# 969 "project/nginx/src/core/ngx_connection.c" 3 4
               )


                                               
# 972 "project/nginx/src/core/ngx_connection.c"
                                              ;
            }
        }
# 999 "project/nginx/src/core/ngx_connection.c"
        if (ls[i].wildcard
            && ls[i].type == 
# 1000 "project/nginx/src/core/ngx_connection.c" 3 4
                            2
            
# 1001 "project/nginx/src/core/ngx_connection.c"
           && ls[i].sockaddr->sa_family == 
# 1001 "project/nginx/src/core/ngx_connection.c" 3 4
                                           30
# 1001 "project/nginx/src/core/ngx_connection.c"
                                                   )
        {
            ...
            if (setsockopt(ls[i].fd, 
# 1005 "project/nginx/src/core/ngx_connection.c" 3 4
                                    41
# 1005 "project/nginx/src/core/ngx_connection.c"
                                                , 
# 1005 "project/nginx/src/core/ngx_connection.c" 3 4
                                                  61
# 1005 "project/nginx/src/core/ngx_connection.c"
...
# 1009 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 1009 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 1009 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 1009 "project/nginx/src/core/ngx_connection.c"
...
# 1009 "project/nginx/src/core/ngx_connection.c" 3 4
               , (*__error())
# 1009 "project/nginx/src/core/ngx_connection.c"
               , "setsockopt(IPV6_RECVPKTINFO) " "for %V failed, ignored", &ls[i].addr_text
# 1009 "project/nginx/src/core/ngx_connection.c" 3 4
               )


                                               
# 1012 "project/nginx/src/core/ngx_connection.c"
                                              ;
            }
        }
...
ngx_close_listening_sockets(ngx_cycle_t *cycle)
{
    ...
    if (ngx_event_flags & 
# 1030 "project/nginx/src/core/ngx_connection.c" 3 4
                         0x00000200
# 1030 "project/nginx/src/core/ngx_connection.c"
                                           ) {
        return;
    }
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ...
        if (c) {
            if (c->read->active) {
                if (ngx_event_flags & 
# 1044 "project/nginx/src/core/ngx_connection.c" 3 4
                                     0x00000040
# 1044 "project/nginx/src/core/ngx_connection.c"
                                                        ) {
...
# 1052 "project/nginx/src/core/ngx_connection.c" 3 4
                   ngx_event_actions.del
# 1052 "project/nginx/src/core/ngx_connection.c"
                                (c->read, 
# 1052 "project/nginx/src/core/ngx_connection.c" 3 4
                                          (-1)
# 1052 "project/nginx/src/core/ngx_connection.c"
...
# 1055 "project/nginx/src/core/ngx_connection.c" 3 4
                   ngx_event_actions.del
# 1055 "project/nginx/src/core/ngx_connection.c"
                                (c->read, 
# 1055 "project/nginx/src/core/ngx_connection.c" 3 4
                                          (-1)
# 1055 "project/nginx/src/core/ngx_connection.c"
...
# 1055 "project/nginx/src/core/ngx_connection.c"
        ...
        if (
# 1067 "project/nginx/src/core/ngx_connection.c" 3 4
           close
# 1067 "project/nginx/src/core/ngx_connection.c"
                           (ls[i].fd) == -1) {
            
# 1068 "project/nginx/src/core/ngx_connection.c" 3 4
           if ((
# 1068 "project/nginx/src/core/ngx_connection.c"
           cycle->log
# 1068 "project/nginx/src/core/ngx_connection.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 1068 "project/nginx/src/core/ngx_connection.c"
...
# 1069 "project/nginx/src/core/ngx_connection.c"
                                                                           ;
        }
        ...
        if (ls[i].sockaddr->sa_family == 
# 1074 "project/nginx/src/core/ngx_connection.c" 3 4
                                        1
            
# 1075 "project/nginx/src/core/ngx_connection.c"
           && ngx_process <= 
# 1075 "project/nginx/src/core/ngx_connection.c" 3 4
                             1
            
# 1076 "project/nginx/src/core/ngx_connection.c"
           && ngx_new_binary == 0
            && (!ls[i].inherited || 
# 1077 "project/nginx/src/core/ngx_connection.c" 3 4
                                   getppid
# 1077 "project/nginx/src/core/ngx_connection.c"
                                              () != ngx_parent))
        {
            u_char *name = ls[i].addr_text.data + sizeof("unix:") - 1;

            if (
# 1081 "project/nginx/src/core/ngx_connection.c" 3 4
               unlink((const char *) 
# 1081 "project/nginx/src/core/ngx_connection.c"
               name
# 1081 "project/nginx/src/core/ngx_connection.c" 3 4
               ) 
# 1081 "project/nginx/src/core/ngx_connection.c"
...
# 1082 "project/nginx/src/core/ngx_connection.c" 3 4
               if ((
# 1082 "project/nginx/src/core/ngx_connection.c"
               cycle->log
# 1082 "project/nginx/src/core/ngx_connection.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 1082 "project/nginx/src/core/ngx_connection.c"
...
# 1083 "project/nginx/src/core/ngx_connection.c"
                                                                  ;
            }
        }
...
# 1106 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 1106 "project/nginx/src/core/ngx_connection.c"
       log
# 1106 "project/nginx/src/core/ngx_connection.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1106 "project/nginx/src/core/ngx_connection.c"
...
# 1106 "project/nginx/src/core/ngx_connection.c" 3 4
       , 
# 1106 "project/nginx/src/core/ngx_connection.c"
       0, "the new socket has number %d, " "but only %ui files are available", s, ngx_cycle->files_n
# 1106 "project/nginx/src/core/ngx_connection.c" 3 4
       )


                                            
# 1109 "project/nginx/src/core/ngx_connection.c"
                                           ;
        return 
# 1110 "project/nginx/src/core/ngx_connection.c" 3 4
              ((void *)0)
# 1110 "project/nginx/src/core/ngx_connection.c"
                  ;
    }
    ...
    if (c == 
# 1117 "project/nginx/src/core/ngx_connection.c" 3 4
            ((void *)0)
# 1117 "project/nginx/src/core/ngx_connection.c"
                ) {
        
# 1118 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 1118 "project/nginx/src/core/ngx_connection.c"
       log
# 1118 "project/nginx/src/core/ngx_connection.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1118 "project/nginx/src/core/ngx_connection.c"
...
# 1118 "project/nginx/src/core/ngx_connection.c" 3 4
       , 
# 1118 "project/nginx/src/core/ngx_connection.c"
       0, "%ui worker_connections are not enough", ngx_cycle->connection_n
# 1118 "project/nginx/src/core/ngx_connection.c" 3 4
       )

                                              
# 1120 "project/nginx/src/core/ngx_connection.c"
                                             ;

        return 
# 1122 "project/nginx/src/core/ngx_connection.c" 3 4
              ((void *)0)
# 1122 "project/nginx/src/core/ngx_connection.c"
                  ;
    }
    ...
    if (ngx_cycle->files && ngx_cycle->files[s] == 
# 1128 "project/nginx/src/core/ngx_connection.c" 3 4
                                                  ((void *)0)
# 1128 "project/nginx/src/core/ngx_connection.c"
                                                      ) {
        ngx_cycle->files[s] = c;
    }
...
# 1135 "project/nginx/src/core/ngx_connection.c" 3 4
   (void) __builtin___memset_chk (
# 1135 "project/nginx/src/core/ngx_connection.c"
   c
# 1135 "project/nginx/src/core/ngx_connection.c" 3 4
   , 0, 
# 1135 "project/nginx/src/core/ngx_connection.c"
...
# 1144 "project/nginx/src/core/ngx_connection.c" 3 4
   (void) __builtin___memset_chk (
# 1144 "project/nginx/src/core/ngx_connection.c"
   rev
# 1144 "project/nginx/src/core/ngx_connection.c" 3 4
   , 0, 
# 1144 "project/nginx/src/core/ngx_connection.c"
...
# 1145 "project/nginx/src/core/ngx_connection.c" 3 4
   (void) __builtin___memset_chk (
# 1145 "project/nginx/src/core/ngx_connection.c"
   wev
# 1145 "project/nginx/src/core/ngx_connection.c" 3 4
   , 0, 
# 1145 "project/nginx/src/core/ngx_connection.c"
...
# 1145 "project/nginx/src/core/ngx_connection.c"
    ...
    rev->index = 
# 1150 "project/nginx/src/core/ngx_connection.c" 3 4
                0xd0d0d0d0
# 1150 "project/nginx/src/core/ngx_connection.c"
                                 ;
    wev->index = 
# 1151 "project/nginx/src/core/ngx_connection.c" 3 4
                0xd0d0d0d0
# 1151 "project/nginx/src/core/ngx_connection.c"
                                 ;
...
ngx_free_connection(ngx_connection_t *c)
{
    ...
    if (ngx_cycle->files && ngx_cycle->files[c->fd] == c) {
        ngx_cycle->files[c->fd] = 
# 1170 "project/nginx/src/core/ngx_connection.c" 3 4
                                 ((void *)0)
# 1170 "project/nginx/src/core/ngx_connection.c"
                                     ;
    }
}
...
# 1183 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 1183 "project/nginx/src/core/ngx_connection.c"
       c->log
# 1183 "project/nginx/src/core/ngx_connection.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1183 "project/nginx/src/core/ngx_connection.c"
...
# 1188 "project/nginx/src/core/ngx_connection.c" 3 4
       ngx_event_del_timer
# 1188 "project/nginx/src/core/ngx_connection.c"
                    (c->read);
    }

    if (c->write->timer_set) {
        
# 1192 "project/nginx/src/core/ngx_connection.c" 3 4
       ngx_event_del_timer
# 1192 "project/nginx/src/core/ngx_connection.c"
                    (c->write);
    }

    if (!c->shared) {
        if (
# 1196 "project/nginx/src/core/ngx_connection.c" 3 4
           ngx_event_actions.del_conn
# 1196 "project/nginx/src/core/ngx_connection.c"
                       ) {
            
# 1197 "project/nginx/src/core/ngx_connection.c" 3 4
           ngx_event_actions.del_conn
# 1197 "project/nginx/src/core/ngx_connection.c"
                       (c, 
# 1197 "project/nginx/src/core/ngx_connection.c" 3 4
                           0x8000
# 1197 "project/nginx/src/core/ngx_connection.c"
...
# 1201 "project/nginx/src/core/ngx_connection.c" 3 4
               ngx_event_actions.del
# 1201 "project/nginx/src/core/ngx_connection.c"
                            (c->read, 
# 1201 "project/nginx/src/core/ngx_connection.c" 3 4
                                      (-1)
# 1201 "project/nginx/src/core/ngx_connection.c"
...
# 1205 "project/nginx/src/core/ngx_connection.c" 3 4
               ngx_event_actions.del
# 1205 "project/nginx/src/core/ngx_connection.c"
                            (c->write, 
# 1205 "project/nginx/src/core/ngx_connection.c" 3 4
                                       (-2)
# 1205 "project/nginx/src/core/ngx_connection.c"
...
# 1211 "project/nginx/src/core/ngx_connection.c" 3 4
       (
# 1211 "project/nginx/src/core/ngx_connection.c"
       c->read
# 1211 "project/nginx/src/core/ngx_connection.c" 3 4
       )->posted = 0; (&(
# 1211 "project/nginx/src/core/ngx_connection.c"
...
# 1215 "project/nginx/src/core/ngx_connection.c" 3 4
       (
# 1215 "project/nginx/src/core/ngx_connection.c"
       c->write
# 1215 "project/nginx/src/core/ngx_connection.c" 3 4
       )->posted = 0; (&(
# 1215 "project/nginx/src/core/ngx_connection.c"
...
# 1215 "project/nginx/src/core/ngx_connection.c"
    ...
    if (
# 1234 "project/nginx/src/core/ngx_connection.c" 3 4
       close
# 1234 "project/nginx/src/core/ngx_connection.c"
                       (fd) == -1) {

        err = 
# 1236 "project/nginx/src/core/ngx_connection.c" 3 4
             (*__error())
# 1236 "project/nginx/src/core/ngx_connection.c"
                             ;

        if (err == 
# 1238 "project/nginx/src/core/ngx_connection.c" 3 4
                  54 
# 1238 "project/nginx/src/core/ngx_connection.c"
                                 || err == 
# 1238 "project/nginx/src/core/ngx_connection.c" 3 4
                                           57
# 1238 "project/nginx/src/core/ngx_connection.c"
            ...
            case NGX_ERROR_INFO:
                level = 
# 1243 "project/nginx/src/core/ngx_connection.c" 3 4
                       7
# 1243 "project/nginx/src/core/ngx_connection.c"
                                   ;
                break;

            case NGX_ERROR_ERR:
                level = 
# 1247 "project/nginx/src/core/ngx_connection.c" 3 4
                       4
# 1247 "project/nginx/src/core/ngx_connection.c"
                                  ;
                break;

            default:
                level = 
# 1251 "project/nginx/src/core/ngx_connection.c" 3 4
                       3
# 1251 "project/nginx/src/core/ngx_connection.c"
                                   ;
            }

        } else {
            level = 
# 1255 "project/nginx/src/core/ngx_connection.c" 3 4
                   3
# 1255 "project/nginx/src/core/ngx_connection.c"
                               ;
        }

        
# 1258 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 1258 "project/nginx/src/core/ngx_connection.c"
       c->log
# 1258 "project/nginx/src/core/ngx_connection.c" 3 4
       )->log_level >= 
# 1258 "project/nginx/src/core/ngx_connection.c"
...
# 1270 "project/nginx/src/core/ngx_connection.c" 3 4
       (
# 1270 "project/nginx/src/core/ngx_connection.c"
       &c->queue
# 1270 "project/nginx/src/core/ngx_connection.c" 3 4
       )->next->prev = (
# 1270 "project/nginx/src/core/ngx_connection.c"
...
# 1283 "project/nginx/src/core/ngx_connection.c" 3 4
       (
# 1283 "project/nginx/src/core/ngx_connection.c"
       &c->queue
# 1283 "project/nginx/src/core/ngx_connection.c" 3 4
       )->next = (
# 1283 "project/nginx/src/core/ngx_connection.c"
...
ngx_drain_connections(ngx_cycle_t *cycle)
{
    ...
    if (cycle->connections_reuse_time != 
# 1307 "project/nginx/src/core/ngx_connection.c" 3 4
                                        ngx_cached_time->sec
# 1307 "project/nginx/src/core/ngx_connection.c"
                                                  ) {
        cycle->connections_reuse_time = 
# 1308 "project/nginx/src/core/ngx_connection.c" 3 4
                                       ngx_cached_time->sec
# 1308 "project/nginx/src/core/ngx_connection.c"
                                                 ;

        
# 1310 "project/nginx/src/core/ngx_connection.c" 3 4
       if ((
# 1310 "project/nginx/src/core/ngx_connection.c"
       cycle->log
# 1310 "project/nginx/src/core/ngx_connection.c" 3 4
...
# 1310 "project/nginx/src/core/ngx_connection.c" 3 4
       , 
# 1310 "project/nginx/src/core/ngx_connection.c"
       0, "%ui worker_connections are not enough, " "reusing connections", cycle->connection_n
# 1310 "project/nginx/src/core/ngx_connection.c" 3 4
       )


                                          
# 1313 "project/nginx/src/core/ngx_connection.c"
                                         ;
    }

    c = 
# 1316 "project/nginx/src/core/ngx_connection.c" 3 4
       ((void *)0)
# 1316 "project/nginx/src/core/ngx_connection.c"
           ;
    n = 
# 1317 "project/nginx/src/core/ngx_connection.c" 3 4
       ((((
# 1317 "project/nginx/src/core/ngx_connection.c"
       32 
# 1317 "project/nginx/src/core/ngx_connection.c" 3 4
       > 
# 1317 "project/nginx/src/core/ngx_connection.c"
       cycle->reusable_connections_n / 8
# 1317 "project/nginx/src/core/ngx_connection.c" 3 4
       ) ? (
# 1317 "project/nginx/src/core/ngx_connection.c"
       cycle->reusable_connections_n / 8
...
# 1317 "project/nginx/src/core/ngx_connection.c"
    ...
    for (i = 0; i < n; i++) {
        if (
# 1320 "project/nginx/src/core/ngx_connection.c" 3 4
           (
# 1320 "project/nginx/src/core/ngx_connection.c"
...
# 1320 "project/nginx/src/core/ngx_connection.c"
        ...
        q = 
# 1324 "project/nginx/src/core/ngx_connection.c" 3 4
           (
# 1324 "project/nginx/src/core/ngx_connection.c"
           &cycle->reusable_connections_queue
# 1324 "project/nginx/src/core/ngx_connection.c" 3 4
           )->prev
# 1324 "project/nginx/src/core/ngx_connection.c"
                                                             ;
        c = 
# 1325 "project/nginx/src/core/ngx_connection.c" 3 4
           (
# 1325 "project/nginx/src/core/ngx_connection.c"
           ngx_connection_t 
# 1325 "project/nginx/src/core/ngx_connection.c" 3 4
           *) ((u_char *) 
# 1325 "project/nginx/src/core/ngx_connection.c"
    ...
    ngx_uint_t port)
{
    ...
    if (c->local_socklen) {
        ...
        case 
# 1390 "project/nginx/src/core/ngx_connection.c" 3 4
            30
# 1390 "project/nginx/src/core/ngx_connection.c"
                    :
            sin6 = (struct sockaddr_in6 *) c->local_sockaddr;

            for (i = 0; addr == 0 && i < 16; i++) {
                addr |= sin6->sin6_addr.
# 1394 "project/nginx/src/core/ngx_connection.c" 3 4
                                       __u6_addr.__u6_addr8
# 1394 "project/nginx/src/core/ngx_connection.c"
                                              [i];
            }
        ...
        case 
# 1401 "project/nginx/src/core/ngx_connection.c" 3 4
            1
# 1401 "project/nginx/src/core/ngx_connection.c"
                   :
            addr = 1;
            break;
...
# 1418 "project/nginx/src/core/ngx_connection.c" 3 4
                                   (*__error())
# 1418 "project/nginx/src/core/ngx_connection.c"
                                                   , "getsockname() failed");
            return 
# 1419 "project/nginx/src/core/ngx_connection.c" 3 4
                  -1
# 1419 "project/nginx/src/core/ngx_connection.c"
                           ;
        }

        c->local_sockaddr = ngx_palloc(c->pool, len);
        if (c->local_sockaddr == 
# 1423 "project/nginx/src/core/ngx_connection.c" 3 4
                                ((void *)0)
# 1423 "project/nginx/src/core/ngx_connection.c"
                                    ) {
            return 
# 1424 "project/nginx/src/core/ngx_connection.c" 3 4
                  -1
# 1424 "project/nginx/src/core/ngx_connection.c"
                           ;
        }

        
# 1427 "project/nginx/src/core/ngx_connection.c" 3 4
       (void) __builtin___memcpy_chk (
# 1427 "project/nginx/src/core/ngx_connection.c"
       c->local_sockaddr
# 1427 "project/nginx/src/core/ngx_connection.c" 3 4
       , 
# 1427 "project/nginx/src/core/ngx_connection.c"
...
# 1427 "project/nginx/src/core/ngx_connection.c"
    ...
    if (s == 
# 1432 "project/nginx/src/core/ngx_connection.c" 3 4
            ((void *)0)
# 1432 "project/nginx/src/core/ngx_connection.c"
                ) {
        return 
# 1433 "project/nginx/src/core/ngx_connection.c" 3 4
              0
# 1433 "project/nginx/src/core/ngx_connection.c"
                    ;
    }
    ...
    return 
# 1439 "project/nginx/src/core/ngx_connection.c" 3 4
          0
# 1439 "project/nginx/src/core/ngx_connection.c"
                ;
}
...
ngx_tcp_nodelay(ngx_connection_t *c)
{
    ...
    if (c->tcp_nodelay != NGX_TCP_NODELAY_UNSET) {
        return 
# 1449 "project/nginx/src/core/ngx_connection.c" 3 4
              0
# 1449 "project/nginx/src/core/ngx_connection.c"
                    ;
    }
    ...
    if (setsockopt(c->fd, 
# 1456 "project/nginx/src/core/ngx_connection.c" 3 4
                         6
# 1456 "project/nginx/src/core/ngx_connection.c"
                                    , 
# 1456 "project/nginx/src/core/ngx_connection.c" 3 4
                                      0x01
# 1456 "project/nginx/src/core/ngx_connection.c"
        ...
        == -1)
    {
# 1475 "project/nginx/src/core/ngx_connection.c"
        ngx_connection_error(c, 
# 1475 "project/nginx/src/core/ngx_connection.c" 3 4
                               (*__error())
# 1475 "project/nginx/src/core/ngx_connection.c"
                                               ,
                             "setsockopt(TCP_NODELAY) failed");
        return 
# 1477 "project/nginx/src/core/ngx_connection.c" 3 4
              -1
# 1477 "project/nginx/src/core/ngx_connection.c"
                       ;
    }
    ...
    return 
# 1482 "project/nginx/src/core/ngx_connection.c" 3 4
          0
# 1482 "project/nginx/src/core/ngx_connection.c"
                ;
}
...
ngx_connection_error(ngx_connection_t *c, ngx_err_t err, char *text)
{
    ...
    if ((err == 
# 1493 "project/nginx/src/core/ngx_connection.c" 3 4
               54



        
# 1497 "project/nginx/src/core/ngx_connection.c"
    ...
    if (err == 0
        || err == 
# 1509 "project/nginx/src/core/ngx_connection.c" 3 4
                 54



        
# 1513 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1513 "project/nginx/src/core/ngx_connection.c" 3 4
                 32

        
# 1515 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1515 "project/nginx/src/core/ngx_connection.c" 3 4
                 57
        
# 1516 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1516 "project/nginx/src/core/ngx_connection.c" 3 4
                 60
        
# 1517 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1517 "project/nginx/src/core/ngx_connection.c" 3 4
                 61
        
# 1518 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1518 "project/nginx/src/core/ngx_connection.c" 3 4
                 50
        
# 1519 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1519 "project/nginx/src/core/ngx_connection.c" 3 4
                 51
        
# 1520 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1520 "project/nginx/src/core/ngx_connection.c" 3 4
                 64
        
# 1521 "project/nginx/src/core/ngx_connection.c"
       || err == 
# 1521 "project/nginx/src/core/ngx_connection.c" 3 4
                 65
# 1521 "project/nginx/src/core/ngx_connection.c"
                                 )
    {
        ...
        case NGX_ERROR_INFO:
            level = 
# 1528 "project/nginx/src/core/ngx_connection.c" 3 4
                   7
# 1528 "project/nginx/src/core/ngx_connection.c"
                               ;
            break;

        default:
            level = 
# 1532 "project/nginx/src/core/ngx_connection.c" 3 4
                   4
# 1532 "project/nginx/src/core/ngx_connection.c"
                              ;
        }

    } else {
        level = 
# 1536 "project/nginx/src/core/ngx_connection.c" 3 4
               2
# 1536 "project/nginx/src/core/ngx_connection.c"
                            ;
    }

    
# 1539 "project/nginx/src/core/ngx_connection.c" 3 4
   if ((
# 1539 "project/nginx/src/core/ngx_connection.c"
   c->log
# 1539 "project/nginx/src/core/ngx_connection.c" 3 4
   )->log_level >= 
# 1539 "project/nginx/src/core/ngx_connection.c"
...
# 1539 "project/nginx/src/core/ngx_connection.c"
    ...
    return 
# 1541 "project/nginx/src/core/ngx_connection.c" 3 4
          -1
# 1541 "project/nginx/src/core/ngx_connection.c"
                   ;
}
