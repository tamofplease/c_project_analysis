# 0 "project/nginx/src/core/ngx_output_chain.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_output_chain.c"
...
# 9 "project/nginx/src/core/ngx_output_chain.c" 2
...
# 10 "project/nginx/src/core/ngx_output_chain.c" 2
...
# 11 "project/nginx/src/core/ngx_output_chain.c" 2
# 27 "project/nginx/src/core/ngx_output_chain.c"
#define NGX_NONE 1



# 30 "project/nginx/src/core/ngx_output_chain.c"
static 
# 30 "project/nginx/src/core/ngx_output_chain.c" 3 4
      inline 
# 30 "project/nginx/src/core/ngx_output_chain.c"
                 ngx_int_t
...
ngx_output_chain(ngx_output_chain_ctx_t *ctx, ngx_chain_t *in)
{
    ...
    if (ctx->in == 
# 48 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  ((void *)0) 
# 48 "project/nginx/src/core/ngx_output_chain.c"
                       && ctx->busy == 
# 48 "project/nginx/src/core/ngx_output_chain.c" 3 4
                                       ((void *)0)
...
# 52 "project/nginx/src/core/ngx_output_chain.c"
      )
    {
        ...
        if (in == 
# 60 "project/nginx/src/core/ngx_output_chain.c" 3 4
                 ((void *)0)
# 60 "project/nginx/src/core/ngx_output_chain.c"
                     ) {
            return ctx->output_filter(ctx->filter_ctx, in);
        }

        if (in->next == 
# 64 "project/nginx/src/core/ngx_output_chain.c" 3 4
                       ((void *)0)



            
# 68 "project/nginx/src/core/ngx_output_chain.c"
    ...
    if (in) {
        if (ngx_output_chain_add_copy(ctx->pool, &ctx->in, in) == 
# 77 "project/nginx/src/core/ngx_output_chain.c" 3 4
                                                                 -1
# 77 "project/nginx/src/core/ngx_output_chain.c"
                                                                          ) {
            return 
# 78 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 78 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }
    }

    out = 
# 82 "project/nginx/src/core/ngx_output_chain.c" 3 4
         ((void *)0)
# 82 "project/nginx/src/core/ngx_output_chain.c"
             ;
    last_out = &out;
    last = 1;
    ...
    for ( ;; ) {
        ...
        while (ctx->in) {
            ...
            bsize = 
# 101 "project/nginx/src/core/ngx_output_chain.c" 3 4
                   (((
# 101 "project/nginx/src/core/ngx_output_chain.c"
                   ctx->in->buf
# 101 "project/nginx/src/core/ngx_output_chain.c" 3 4
                   )->temporary || (
# 101 "project/nginx/src/core/ngx_output_chain.c"
...
# 101 "project/nginx/src/core/ngx_output_chain.c"
            ...
            if (bsize == 0 && !
# 103 "project/nginx/src/core/ngx_output_chain.c" 3 4
                              (((
# 103 "project/nginx/src/core/ngx_output_chain.c"
                              ctx->in->buf
# 103 "project/nginx/src/core/ngx_output_chain.c" 3 4
                              )->flush || (
# 103 "project/nginx/src/core/ngx_output_chain.c"
...
# 105 "project/nginx/src/core/ngx_output_chain.c" 3 4
               if ((
# 105 "project/nginx/src/core/ngx_output_chain.c"
               ctx->pool->log
# 105 "project/nginx/src/core/ngx_output_chain.c" 3 4
...
# 105 "project/nginx/src/core/ngx_output_chain.c" 3 4
               , 
# 105 "project/nginx/src/core/ngx_output_chain.c"
               0, "zero size buf in output " "t:%d r:%d f:%d %p %p-%p %p %O-%O", ctx->in->buf->temporary, ctx->in->buf->recycled, ctx->in->buf->in_file, ctx->in->buf->start, ctx->in->buf->pos, ctx->in->buf->last, ctx->in->buf->file, ctx->in->buf->file_pos, ctx->in->buf->file_last
# 105 "project/nginx/src/core/ngx_output_chain.c" 3 4
               )
# 116 "project/nginx/src/core/ngx_output_chain.c"
                                                      ;

                
# 118 "project/nginx/src/core/ngx_output_chain.c"
               ngx_debug_point();
...
# 127 "project/nginx/src/core/ngx_output_chain.c" 3 4
               if ((
# 127 "project/nginx/src/core/ngx_output_chain.c"
               ctx->pool->log
# 127 "project/nginx/src/core/ngx_output_chain.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 127 "project/nginx/src/core/ngx_output_chain.c"
...
# 127 "project/nginx/src/core/ngx_output_chain.c" 3 4
               , 
# 127 "project/nginx/src/core/ngx_output_chain.c"
               0, "negative size buf in output " "t:%d r:%d f:%d %p %p-%p %p %O-%O", ctx->in->buf->temporary, ctx->in->buf->recycled, ctx->in->buf->in_file, ctx->in->buf->start, ctx->in->buf->pos, ctx->in->buf->last, ctx->in->buf->file, ctx->in->buf->file_pos, ctx->in->buf->file_last
# 127 "project/nginx/src/core/ngx_output_chain.c" 3 4
               )
# 138 "project/nginx/src/core/ngx_output_chain.c"
                                                      ;

                
# 140 "project/nginx/src/core/ngx_output_chain.c"
               ngx_debug_point();

                return 
# 142 "project/nginx/src/core/ngx_output_chain.c" 3 4
                      -1
# 142 "project/nginx/src/core/ngx_output_chain.c"
                               ;
            }
            ...
            if (ngx_output_chain_as_is(ctx, ctx->in->buf)) {
                ...
                *last_out = cl;
                last_out = &cl->next;
                cl->next = 
# 154 "project/nginx/src/core/ngx_output_chain.c" 3 4
                          ((void *)0)
# 154 "project/nginx/src/core/ngx_output_chain.c"
                              ;
            ...
            if (ctx->buf == 
# 159 "project/nginx/src/core/ngx_output_chain.c" 3 4
                           ((void *)0)
# 159 "project/nginx/src/core/ngx_output_chain.c"
                               ) {

                rc = ngx_output_chain_align_file_buf(ctx, bsize);

                if (rc == 
# 163 "project/nginx/src/core/ngx_output_chain.c" 3 4
                         -1
# 163 "project/nginx/src/core/ngx_output_chain.c"
                                  ) {
                    return 
# 164 "project/nginx/src/core/ngx_output_chain.c" 3 4
                          -1
# 164 "project/nginx/src/core/ngx_output_chain.c"
                                   ;
                }

                if (rc != 
# 167 "project/nginx/src/core/ngx_output_chain.c" 3 4
                         0
# 167 "project/nginx/src/core/ngx_output_chain.c"
                               ) {
...
# 177 "project/nginx/src/core/ngx_output_chain.c" 3 4
                       (
# 177 "project/nginx/src/core/ngx_output_chain.c"
                       cl
# 177 "project/nginx/src/core/ngx_output_chain.c" 3 4
                       )->next = (
# 177 "project/nginx/src/core/ngx_output_chain.c"
...
# 183 "project/nginx/src/core/ngx_output_chain.c" 3 4
                                                                      0
# 183 "project/nginx/src/core/ngx_output_chain.c"
                                                                            ) {
                        return 
# 184 "project/nginx/src/core/ngx_output_chain.c" 3 4
                              -1
# 184 "project/nginx/src/core/ngx_output_chain.c"
                                       ;
                    }
                }
            }
            ...
            if (rc == 
# 191 "project/nginx/src/core/ngx_output_chain.c" 3 4
                     -1
# 191 "project/nginx/src/core/ngx_output_chain.c"
                              ) {
                return rc;
            }

            if (rc == 
# 195 "project/nginx/src/core/ngx_output_chain.c" 3 4
                     -2
# 195 "project/nginx/src/core/ngx_output_chain.c"
                              ) {
                if (out) {
                    break;
                }
            ...
            if (
# 205 "project/nginx/src/core/ngx_output_chain.c" 3 4
               (((
# 205 "project/nginx/src/core/ngx_output_chain.c"
               ctx->in->buf
# 205 "project/nginx/src/core/ngx_output_chain.c" 3 4
               )->temporary || (
# 205 "project/nginx/src/core/ngx_output_chain.c"
...
# 205 "project/nginx/src/core/ngx_output_chain.c"
            ...
            if (cl == 
# 210 "project/nginx/src/core/ngx_output_chain.c" 3 4
                     ((void *)0)
# 210 "project/nginx/src/core/ngx_output_chain.c"
                         ) {
                return 
# 211 "project/nginx/src/core/ngx_output_chain.c" 3 4
                      -1
# 211 "project/nginx/src/core/ngx_output_chain.c"
                               ;
            }

            cl->buf = ctx->buf;
            cl->next = 
# 215 "project/nginx/src/core/ngx_output_chain.c" 3 4
                      ((void *)0)
# 215 "project/nginx/src/core/ngx_output_chain.c"
                          ;
            *last_out = cl;
            last_out = &cl->next;
            ctx->buf = 
# 218 "project/nginx/src/core/ngx_output_chain.c" 3 4
                      ((void *)0)
# 218 "project/nginx/src/core/ngx_output_chain.c"
                          ;
        }

        if (out == 
# 221 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  ((void *)0) 
# 221 "project/nginx/src/core/ngx_output_chain.c"
                       && last != 1) {

            if (ctx->in) {
                return 
# 224 "project/nginx/src/core/ngx_output_chain.c" 3 4
                      -2
# 224 "project/nginx/src/core/ngx_output_chain.c"
                               ;
            }
        ...
        if (last == 
# 232 "project/nginx/src/core/ngx_output_chain.c" 3 4
                   -1 
# 232 "project/nginx/src/core/ngx_output_chain.c"
                             || last == 
# 232 "project/nginx/src/core/ngx_output_chain.c" 3 4
                                        -4
# 232 "project/nginx/src/core/ngx_output_chain.c"
...
static 
# 243 "project/nginx/src/core/ngx_output_chain.c" 3 4
      inline 
# 243 "project/nginx/src/core/ngx_output_chain.c"
                 ngx_int_t
ngx_output_chain_as_is(ngx_output_chain_ctx_t *ctx, ngx_buf_t *buf)
{
    ngx_uint_t sendfile;
    ...
    if (
# 248 "project/nginx/src/core/ngx_output_chain.c" 3 4
       (((
# 248 "project/nginx/src/core/ngx_output_chain.c"
       buf
# 248 "project/nginx/src/core/ngx_output_chain.c" 3 4
       )->flush || (
# 248 "project/nginx/src/core/ngx_output_chain.c"
...
# 259 "project/nginx/src/core/ngx_output_chain.c"
    sendfile = ctx->sendfile;
# 276 "project/nginx/src/core/ngx_output_chain.c"
    ...
    if (!sendfile) {
        ...
        if (!
# 284 "project/nginx/src/core/ngx_output_chain.c" 3 4
            ((
# 284 "project/nginx/src/core/ngx_output_chain.c"
            buf
# 284 "project/nginx/src/core/ngx_output_chain.c" 3 4
            )->temporary || (
# 284 "project/nginx/src/core/ngx_output_chain.c"
...
# 291 "project/nginx/src/core/ngx_output_chain.c" 3 4
                               ((
# 291 "project/nginx/src/core/ngx_output_chain.c"
                               buf
# 291 "project/nginx/src/core/ngx_output_chain.c" 3 4
                               )->temporary || (
# 291 "project/nginx/src/core/ngx_output_chain.c"
    ...
    ngx_chain_t *in)
{
    ...
    while (in) {
        ...
        if (cl == 
# 321 "project/nginx/src/core/ngx_output_chain.c" 3 4
                 ((void *)0)
# 321 "project/nginx/src/core/ngx_output_chain.c"
                     ) {
            return 
# 322 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 322 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }
# 358 "project/nginx/src/core/ngx_output_chain.c"
        cl->buf = in->buf;
        in = in->next;
        ...
        cl->next = 
# 363 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  ((void *)0)
# 363 "project/nginx/src/core/ngx_output_chain.c"
                      ;
        *ll = cl;
        ll = &cl->next;
    }
    ...
    return 
# 368 "project/nginx/src/core/ngx_output_chain.c" 3 4
          0
# 368 "project/nginx/src/core/ngx_output_chain.c"
                ;
}
...
ngx_output_chain_align_file_buf(ngx_output_chain_ctx_t *ctx, off_t bsize)
{
    ...
    if (in->file == 
# 380 "project/nginx/src/core/ngx_output_chain.c" 3 4
                   ((void *)0) 
# 380 "project/nginx/src/core/ngx_output_chain.c"
                        || !in->file->directio) {
        return 
# 381 "project/nginx/src/core/ngx_output_chain.c" 3 4
              -5
# 381 "project/nginx/src/core/ngx_output_chain.c"
                          ;
    }
    ...
    if (size == 0) {
        ...
        if (bsize >= (off_t) ctx->bufs.size) {
            return 
# 391 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -5
# 391 "project/nginx/src/core/ngx_output_chain.c"
                              ;
        }
    ...
    if (ctx->buf == 
# 405 "project/nginx/src/core/ngx_output_chain.c" 3 4
                   ((void *)0)
# 405 "project/nginx/src/core/ngx_output_chain.c"
                       ) {
        return 
# 406 "project/nginx/src/core/ngx_output_chain.c" 3 4
              -1
# 406 "project/nginx/src/core/ngx_output_chain.c"
                       ;
    }
# 418 "project/nginx/src/core/ngx_output_chain.c"
    return 
# 418 "project/nginx/src/core/ngx_output_chain.c" 3 4
          0
# 418 "project/nginx/src/core/ngx_output_chain.c"
                ;
}
...
ngx_output_chain_get_buf(ngx_output_chain_ctx_t *ctx, off_t bsize)
{
    ...
    b = 
# 460 "project/nginx/src/core/ngx_output_chain.c" 3 4
       ngx_pcalloc(
# 460 "project/nginx/src/core/ngx_output_chain.c"
       ctx->pool
# 460 "project/nginx/src/core/ngx_output_chain.c" 3 4
       , sizeof(ngx_buf_t))
# 460 "project/nginx/src/core/ngx_output_chain.c"
                                ;
    if (b == 
# 461 "project/nginx/src/core/ngx_output_chain.c" 3 4
            ((void *)0)
# 461 "project/nginx/src/core/ngx_output_chain.c"
                ) {
        return 
# 462 "project/nginx/src/core/ngx_output_chain.c" 3 4
              -1
# 462 "project/nginx/src/core/ngx_output_chain.c"
                       ;
    }
    ...
    if (ctx->directio) {
        ...
        if (b->start == 
# 473 "project/nginx/src/core/ngx_output_chain.c" 3 4
                       ((void *)0)
# 473 "project/nginx/src/core/ngx_output_chain.c"
                           ) {
            return 
# 474 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 474 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }
        ...
        if (b->start == 
# 479 "project/nginx/src/core/ngx_output_chain.c" 3 4
                       ((void *)0)
# 479 "project/nginx/src/core/ngx_output_chain.c"
                           ) {
            return 
# 480 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 480 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }
    }
    ...
    return 
# 494 "project/nginx/src/core/ngx_output_chain.c" 3 4
          0
# 494 "project/nginx/src/core/ngx_output_chain.c"
                ;
}
...
ngx_output_chain_copy_buf(ngx_output_chain_ctx_t *ctx)
{
    ...
    size = 
# 509 "project/nginx/src/core/ngx_output_chain.c" 3 4
          (((
# 509 "project/nginx/src/core/ngx_output_chain.c"
          src
# 509 "project/nginx/src/core/ngx_output_chain.c" 3 4
          )->temporary || (
# 509 "project/nginx/src/core/ngx_output_chain.c"
...
# 509 "project/nginx/src/core/ngx_output_chain.c"
                           ;
    size = 
# 510 "project/nginx/src/core/ngx_output_chain.c" 3 4
          ((
# 510 "project/nginx/src/core/ngx_output_chain.c"
          size 
# 510 "project/nginx/src/core/ngx_output_chain.c" 3 4
          > 
# 510 "project/nginx/src/core/ngx_output_chain.c"
...
# 522 "project/nginx/src/core/ngx_output_chain.c"
    if (
# 522 "project/nginx/src/core/ngx_output_chain.c" 3 4
       ((
# 522 "project/nginx/src/core/ngx_output_chain.c"
       src
# 522 "project/nginx/src/core/ngx_output_chain.c" 3 4
...
# 523 "project/nginx/src/core/ngx_output_chain.c" 3 4
       (void) __builtin___memcpy_chk (
# 523 "project/nginx/src/core/ngx_output_chain.c"
       dst->pos
# 523 "project/nginx/src/core/ngx_output_chain.c" 3 4
       , 
# 523 "project/nginx/src/core/ngx_output_chain.c"
...
# 591 "project/nginx/src/core/ngx_output_chain.c"
        {
            n = ngx_read_file(src->file, dst->pos, (size_t) size,
                              src->file_pos);
        }
# 616 "project/nginx/src/core/ngx_output_chain.c"
        if (n == 
# 616 "project/nginx/src/core/ngx_output_chain.c" 3 4
                -1
# 616 "project/nginx/src/core/ngx_output_chain.c"
                         ) {
            return (ngx_int_t) n;
...
# 621 "project/nginx/src/core/ngx_output_chain.c" 3 4
           if ((
# 621 "project/nginx/src/core/ngx_output_chain.c"
           ctx->pool->log
# 621 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 621 "project/nginx/src/core/ngx_output_chain.c"
...
# 623 "project/nginx/src/core/ngx_output_chain.c"
                                                       ;
            return 
# 624 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 624 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }
    ...
    return 
# 648 "project/nginx/src/core/ngx_output_chain.c" 3 4
          0
# 648 "project/nginx/src/core/ngx_output_chain.c"
                ;
}
...
ngx_chain_writer(void *data, ngx_chain_t *in)
{
    ...
    for (size = 0; in; in = in->next) {
        ...
        if (
# 665 "project/nginx/src/core/ngx_output_chain.c" 3 4
           (((
# 665 "project/nginx/src/core/ngx_output_chain.c"
           in->buf
# 665 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->temporary || (
# 665 "project/nginx/src/core/ngx_output_chain.c"
...
# 667 "project/nginx/src/core/ngx_output_chain.c" 3 4
           if ((
# 667 "project/nginx/src/core/ngx_output_chain.c"
           ctx->pool->log
# 667 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 667 "project/nginx/src/core/ngx_output_chain.c"
...
# 667 "project/nginx/src/core/ngx_output_chain.c" 3 4
           , 
# 667 "project/nginx/src/core/ngx_output_chain.c"
           0, "zero size buf in chain writer " "t:%d r:%d f:%d %p %p-%p %p %O-%O", in->buf->temporary, in->buf->recycled, in->buf->in_file, in->buf->start, in->buf->pos, in->buf->last, in->buf->file, in->buf->file_pos, in->buf->file_last
# 667 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )
# 678 "project/nginx/src/core/ngx_output_chain.c"
                                             ;

            
# 680 "project/nginx/src/core/ngx_output_chain.c"
           ngx_debug_point();
        ...
        if (
# 685 "project/nginx/src/core/ngx_output_chain.c" 3 4
           (((
# 685 "project/nginx/src/core/ngx_output_chain.c"
           in->buf
# 685 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->temporary || (
# 685 "project/nginx/src/core/ngx_output_chain.c"
...
# 687 "project/nginx/src/core/ngx_output_chain.c" 3 4
           if ((
# 687 "project/nginx/src/core/ngx_output_chain.c"
           ctx->pool->log
# 687 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 687 "project/nginx/src/core/ngx_output_chain.c"
...
# 687 "project/nginx/src/core/ngx_output_chain.c" 3 4
           , 
# 687 "project/nginx/src/core/ngx_output_chain.c"
           0, "negative size buf in chain writer " "t:%d r:%d f:%d %p %p-%p %p %O-%O", in->buf->temporary, in->buf->recycled, in->buf->in_file, in->buf->start, in->buf->pos, in->buf->last, in->buf->file, in->buf->file_pos, in->buf->file_last
# 687 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )
# 698 "project/nginx/src/core/ngx_output_chain.c"
                                             ;

            
# 700 "project/nginx/src/core/ngx_output_chain.c"
           ngx_debug_point();

            return 
# 702 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 702 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }

        size += 
# 705 "project/nginx/src/core/ngx_output_chain.c" 3 4
               (((
# 705 "project/nginx/src/core/ngx_output_chain.c"
               in->buf
# 705 "project/nginx/src/core/ngx_output_chain.c" 3 4
               )->temporary || (
# 705 "project/nginx/src/core/ngx_output_chain.c"
...
# 705 "project/nginx/src/core/ngx_output_chain.c"
        ...
        cl = ngx_alloc_chain_link(ctx->pool);
        if (cl == 
# 712 "project/nginx/src/core/ngx_output_chain.c" 3 4
                 ((void *)0)
# 712 "project/nginx/src/core/ngx_output_chain.c"
                     ) {
            return 
# 713 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 713 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }

        cl->buf = in->buf;
        cl->next = 
# 717 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  ((void *)0)
# 717 "project/nginx/src/core/ngx_output_chain.c"
                      ;
        *ctx->last = cl;
        ctx->last = &cl->next;
    }
    ...
    for (cl = ctx->out; cl; cl = cl->next) {
        ...
        if (
# 727 "project/nginx/src/core/ngx_output_chain.c" 3 4
           (((
# 727 "project/nginx/src/core/ngx_output_chain.c"
           cl->buf
# 727 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->temporary || (
# 727 "project/nginx/src/core/ngx_output_chain.c"
...
# 729 "project/nginx/src/core/ngx_output_chain.c" 3 4
           if ((
# 729 "project/nginx/src/core/ngx_output_chain.c"
           ctx->pool->log
# 729 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 729 "project/nginx/src/core/ngx_output_chain.c"
...
# 729 "project/nginx/src/core/ngx_output_chain.c" 3 4
           , 
# 729 "project/nginx/src/core/ngx_output_chain.c"
           0, "zero size buf in chain writer " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last
# 729 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )
# 740 "project/nginx/src/core/ngx_output_chain.c"
                                             ;

            
# 742 "project/nginx/src/core/ngx_output_chain.c"
           ngx_debug_point();
        ...
        if (
# 747 "project/nginx/src/core/ngx_output_chain.c" 3 4
           (((
# 747 "project/nginx/src/core/ngx_output_chain.c"
           cl->buf
# 747 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->temporary || (
# 747 "project/nginx/src/core/ngx_output_chain.c"
...
# 749 "project/nginx/src/core/ngx_output_chain.c" 3 4
           if ((
# 749 "project/nginx/src/core/ngx_output_chain.c"
           ctx->pool->log
# 749 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 749 "project/nginx/src/core/ngx_output_chain.c"
...
# 749 "project/nginx/src/core/ngx_output_chain.c" 3 4
           , 
# 749 "project/nginx/src/core/ngx_output_chain.c"
           0, "negative size buf in chain writer " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last
# 749 "project/nginx/src/core/ngx_output_chain.c" 3 4
           )
# 760 "project/nginx/src/core/ngx_output_chain.c"
                                             ;

            
# 762 "project/nginx/src/core/ngx_output_chain.c"
           ngx_debug_point();

            return 
# 764 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  -1
# 764 "project/nginx/src/core/ngx_output_chain.c"
                           ;
        }

        size += 
# 767 "project/nginx/src/core/ngx_output_chain.c" 3 4
               (((
# 767 "project/nginx/src/core/ngx_output_chain.c"
               cl->buf
# 767 "project/nginx/src/core/ngx_output_chain.c" 3 4
               )->temporary || (
# 767 "project/nginx/src/core/ngx_output_chain.c"
...
# 767 "project/nginx/src/core/ngx_output_chain.c"
    ...
    if (size == 0 && !c->buffered) {
        return 
# 771 "project/nginx/src/core/ngx_output_chain.c" 3 4
              0
# 771 "project/nginx/src/core/ngx_output_chain.c"
                    ;
    }
    ...
    if (chain == 
# 779 "project/nginx/src/core/ngx_output_chain.c" 3 4
                (ngx_chain_t *) -1
# 779 "project/nginx/src/core/ngx_output_chain.c"
                               ) {
        return 
# 780 "project/nginx/src/core/ngx_output_chain.c" 3 4
              -1
# 780 "project/nginx/src/core/ngx_output_chain.c"
                       ;
    }

    if (chain && c->write->ready) {
        
# 784 "project/nginx/src/core/ngx_output_chain.c" 3 4
       if (!(
# 784 "project/nginx/src/core/ngx_output_chain.c"
       c->write
# 784 "project/nginx/src/core/ngx_output_chain.c" 3 4
       )->posted) { (
# 784 "project/nginx/src/core/ngx_output_chain.c"
...
# 790 "project/nginx/src/core/ngx_output_chain.c" 3 4
       (
# 790 "project/nginx/src/core/ngx_output_chain.c"
       ln
# 790 "project/nginx/src/core/ngx_output_chain.c" 3 4
       )->next = (
# 790 "project/nginx/src/core/ngx_output_chain.c"
...
# 790 "project/nginx/src/core/ngx_output_chain.c"
    ...
    if (ctx->out == 
# 795 "project/nginx/src/core/ngx_output_chain.c" 3 4
                   ((void *)0)
# 795 "project/nginx/src/core/ngx_output_chain.c"
                       ) {
        ctx->last = &ctx->out;

        if (!c->buffered) {
            return 
# 799 "project/nginx/src/core/ngx_output_chain.c" 3 4
                  0
# 799 "project/nginx/src/core/ngx_output_chain.c"
                        ;
        }
    }

    return 
# 803 "project/nginx/src/core/ngx_output_chain.c" 3 4
          -2
# 803 "project/nginx/src/core/ngx_output_chain.c"
                   ;
}
