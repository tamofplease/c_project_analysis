# 0 "project/nginx/src/core/ngx_array.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_array.h"
# 9 "project/nginx/src/core/ngx_array.h"
...
# 13 "project/nginx/src/core/ngx_array.h" 2
...
# 14 "project/nginx/src/core/ngx_array.h" 2



# 16 "project/nginx/src/core/ngx_array.h"
typedef struct {
    void *elts;
    ngx_uint_t nelts;
    size_t size;
...
static 
# 31 "project/nginx/src/core/ngx_array.h" 3 4
      inline 
# 31 "project/nginx/src/core/ngx_array.h"
                 ngx_int_t
ngx_array_init(ngx_array_t *array, ngx_pool_t *pool, ngx_uint_t n, size_t size)
{
    ...
    if (array->elts == 
# 45 "project/nginx/src/core/ngx_array.h" 3 4
                      ((void *)0)
# 45 "project/nginx/src/core/ngx_array.h"
                          ) {
        return 
# 46 "project/nginx/src/core/ngx_array.h" 3 4
              -1
# 46 "project/nginx/src/core/ngx_array.h"
                       ;
    }

    return 
# 49 "project/nginx/src/core/ngx_array.h" 3 4
          0
# 49 "project/nginx/src/core/ngx_array.h"
                ;
}
