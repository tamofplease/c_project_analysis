# 0 "project/nginx/src/core/ngx_parse_time.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/core/ngx_parse_time.c" 2
...
# 10 "project/nginx/src/core/ngx_parse_time.c" 2



# 12 "project/nginx/src/core/ngx_parse_time.c"
...
ngx_parse_http_time(u_char *value, size_t len)
{
    ...
    if (end - p < 18) {
        return 
# 54 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 54 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if (fmt != isoc) {
        if (*p < '0' || *p > '9' || *(p + 1) < '0' || *(p + 1) > '9') {
            return 
# 59 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 59 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
        ...
        if (*p == ' ') {
            if (end - p < 18) {
                return 
# 67 "project/nginx/src/core/ngx_parse_time.c" 3 4
                      -1
# 67 "project/nginx/src/core/ngx_parse_time.c"
                               ;
            }
            fmt = rfc822;
            ...
            return 
# 75 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 75 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
    ...
    default:
        return 
# 116 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 116 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if ((fmt == rfc822 && *p != ' ') || (fmt == rfc850 && *p != '-')) {
        return 
# 122 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 122 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if (fmt == rfc822) {
        ...
        {
            return 
# 132 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 132 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
        ...
        if (*p < '0' || *p > '9' || *(p + 1) < '0' || *(p + 1) > '9') {
            return 
# 141 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 141 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
    ...
    if (fmt == isoc) {
        ...
        if (*p < '0' || *p > '9') {
            return 
# 155 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 155 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
        ...
        if (*p != ' ') {
            if (*p < '0' || *p > '9') {
                return 
# 162 "project/nginx/src/core/ngx_parse_time.c" 3 4
                      -1
# 162 "project/nginx/src/core/ngx_parse_time.c"
                               ;
            }
        ...
        if (end - p < 14) {
            return 
# 169 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 169 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
    }
    ...
    if (*p++ != ' ') {
        return 
# 174 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 174 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }

    if (*p < '0' || *p > '9' || *(p + 1) < '0' || *(p + 1) > '9') {
        return 
# 178 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 178 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if (*p++ != ':') {
        return 
# 185 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 185 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }

    if (*p < '0' || *p > '9' || *(p + 1) < '0' || *(p + 1) > '9') {
        return 
# 189 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 189 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if (*p++ != ':') {
        return 
# 196 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 196 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }

    if (*p < '0' || *p > '9' || *(p + 1) < '0' || *(p + 1) > '9') {
        return 
# 200 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 200 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if (fmt == isoc) {
        ...
        if (*p++ != ' ') {
            return 
# 209 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 209 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
        ...
        {
            return 
# 216 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 216 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }
    ...
    if (hour > 23 || min > 59 || sec > 59) {
        return 
# 224 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 224 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
    ...
    if (day == 29 && month == 1) {
        if ((year & 3) || ((year % 100 == 0) && (year % 400) != 0)) {
            return 
# 229 "project/nginx/src/core/ngx_parse_time.c" 3 4
                  -1
# 229 "project/nginx/src/core/ngx_parse_time.c"
                           ;
        }

    } else if (day > mday[month]) {
        return 
# 233 "project/nginx/src/core/ngx_parse_time.c" 3 4
              -1
# 233 "project/nginx/src/core/ngx_parse_time.c"
                       ;
    }
...
# 276 "project/nginx/src/core/ngx_parse_time.c"
    return (time_t) time;
}
