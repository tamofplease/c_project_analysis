# 0 "project/nginx/src/core/ngx_file.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_file.c"
...
# 9 "project/nginx/src/core/ngx_file.c" 2
...
# 10 "project/nginx/src/core/ngx_file.c" 2



# 12 "project/nginx/src/core/ngx_file.c"
...
ngx_get_full_name(ngx_pool_t *pool, ngx_str_t *prefix, ngx_str_t *name)
{
    ...
    if (rc == 
# 29 "project/nginx/src/core/ngx_file.c" 3 4
             0
# 29 "project/nginx/src/core/ngx_file.c"
                   ) {
        return rc;
    }

    len = prefix->len;
# 43 "project/nginx/src/core/ngx_file.c"
    n = ngx_pnalloc(pool, len + name->len + 1);
    if (n == 
# 44 "project/nginx/src/core/ngx_file.c" 3 4
            ((void *)0)
# 44 "project/nginx/src/core/ngx_file.c"
                ) {
        return 
# 45 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 45 "project/nginx/src/core/ngx_file.c"
                       ;
    }

    p = 
# 48 "project/nginx/src/core/ngx_file.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 48 "project/nginx/src/core/ngx_file.c"
       n
# 48 "project/nginx/src/core/ngx_file.c" 3 4
       , 
# 48 "project/nginx/src/core/ngx_file.c"
...
# 48 "project/nginx/src/core/ngx_file.c"
    ...
    return 
# 54 "project/nginx/src/core/ngx_file.c" 3 4
          0
# 54 "project/nginx/src/core/ngx_file.c"
                ;
}
...
{
# 98 "project/nginx/src/core/ngx_file.c"
    if (name->data[0] == '/') {
        return 
# 99 "project/nginx/src/core/ngx_file.c" 3 4
              0
# 99 "project/nginx/src/core/ngx_file.c"
                    ;
    }

    return 
# 102 "project/nginx/src/core/ngx_file.c" 3 4
          -5
# 102 "project/nginx/src/core/ngx_file.c"
                      ;
...
ngx_write_chain_to_temp_file(ngx_temp_file_t *tf, ngx_chain_t *chain)
{
    ...
    if (tf->file.fd == 
# 113 "project/nginx/src/core/ngx_file.c" 3 4
                      -1
# 113 "project/nginx/src/core/ngx_file.c"
                                      ) {
        rc = ngx_create_temp_file(&tf->file, tf->path, tf->pool,
                                  tf->persistent, tf->clean, tf->access);

        if (rc != 
# 117 "project/nginx/src/core/ngx_file.c" 3 4
                 0
# 117 "project/nginx/src/core/ngx_file.c"
                       ) {
            return rc;
        }
...
# 122 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 122 "project/nginx/src/core/ngx_file.c"
           tf->file.log
# 122 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 
# 122 "project/nginx/src/core/ngx_file.c"
...
# 122 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 122 "project/nginx/src/core/ngx_file.c"
           0, "%s %V", tf->warn, &tf->file.name
# 122 "project/nginx/src/core/ngx_file.c" 3 4
           )
                                                   
# 123 "project/nginx/src/core/ngx_file.c"
                                                  ;
        }
    }
# 136 "project/nginx/src/core/ngx_file.c"
    ...
    ngx_uint_t persistent, ngx_uint_t clean, ngx_uint_t access)
{
    ...
    if (file->name.data == 
# 167 "project/nginx/src/core/ngx_file.c" 3 4
                          ((void *)0)
# 167 "project/nginx/src/core/ngx_file.c"
                              ) {
        return 
# 168 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 168 "project/nginx/src/core/ngx_file.c"
                       ;
    }
    ...
    p = 
# 177 "project/nginx/src/core/ngx_file.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 177 "project/nginx/src/core/ngx_file.c"
       file->name.data
# 177 "project/nginx/src/core/ngx_file.c" 3 4
       , 
# 177 "project/nginx/src/core/ngx_file.c"
...
# 177 "project/nginx/src/core/ngx_file.c"
    ...
    if (cln == 
# 188 "project/nginx/src/core/ngx_file.c" 3 4
              ((void *)0)
# 188 "project/nginx/src/core/ngx_file.c"
                  ) {
        return 
# 189 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 189 "project/nginx/src/core/ngx_file.c"
                       ;
    }
    ...
    for ( ;; ) {
        ...
        if (file->fd != 
# 207 "project/nginx/src/core/ngx_file.c" 3 4
                       -1
# 207 "project/nginx/src/core/ngx_file.c"
                                       ) {
            ...
            return 
# 216 "project/nginx/src/core/ngx_file.c" 3 4
                  0
# 216 "project/nginx/src/core/ngx_file.c"
                        ;
        }

        err = 
# 219 "project/nginx/src/core/ngx_file.c" 3 4
             (*__error())
# 219 "project/nginx/src/core/ngx_file.c"
                      ;

        if (err == 
# 221 "project/nginx/src/core/ngx_file.c" 3 4
                  17
# 221 "project/nginx/src/core/ngx_file.c"
                                 ) {
            n = (uint32_t) ngx_next_temp_number(1);
            continue;
        }

        if ((path->level[0] == 0) || (err != 
# 226 "project/nginx/src/core/ngx_file.c" 3 4
                                            2
# 226 "project/nginx/src/core/ngx_file.c"
                                                       )) {
            
# 227 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 227 "project/nginx/src/core/ngx_file.c"
           file->log
# 227 "project/nginx/src/core/ngx_file.c" 3 4
...
# 229 "project/nginx/src/core/ngx_file.c"
                                         ;
            return 
# 230 "project/nginx/src/core/ngx_file.c" 3 4
                  -1
# 230 "project/nginx/src/core/ngx_file.c"
                           ;
        }

        if (ngx_create_path(file, path) == 
# 233 "project/nginx/src/core/ngx_file.c" 3 4
                                          -1
# 233 "project/nginx/src/core/ngx_file.c"
                                                   ) {
            return 
# 234 "project/nginx/src/core/ngx_file.c" 3 4
                  -1
# 234 "project/nginx/src/core/ngx_file.c"
                           ;
        }
    }
}
...
ngx_create_hashed_filename(ngx_path_t *path, u_char *file, size_t len)
{
    ...
    for (n = 0; n < 
# 250 "project/nginx/src/core/ngx_file.c" 3 4
                   3
# 250 "project/nginx/src/core/ngx_file.c"
                                     ; n++) {
        level = path->level[n];
...
# 259 "project/nginx/src/core/ngx_file.c" 3 4
       (void) __builtin___memcpy_chk (
# 259 "project/nginx/src/core/ngx_file.c"
       &file[i]
# 259 "project/nginx/src/core/ngx_file.c" 3 4
       , 
# 259 "project/nginx/src/core/ngx_file.c"
...
ngx_create_path(ngx_file_t *file, ngx_path_t *path)
{
    ...
    for (i = 0; i < 
# 274 "project/nginx/src/core/ngx_file.c" 3 4
                   3
# 274 "project/nginx/src/core/ngx_file.c"
                                     ; i++) {
        if (path->level[i] == 0) {
            break;
        }
        ...
        if (
# 286 "project/nginx/src/core/ngx_file.c" 3 4
           mkdir((const char *) 
# 286 "project/nginx/src/core/ngx_file.c"
           file->name.data
# 286 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 286 "project/nginx/src/core/ngx_file.c"
...
# 286 "project/nginx/src/core/ngx_file.c"
            ...
            err = 
# 287 "project/nginx/src/core/ngx_file.c" 3 4
                 (*__error())
# 287 "project/nginx/src/core/ngx_file.c"
                          ;
            if (err != 
# 288 "project/nginx/src/core/ngx_file.c" 3 4
                      17
# 288 "project/nginx/src/core/ngx_file.c"
                                ) {
                
# 289 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 289 "project/nginx/src/core/ngx_file.c"
               file->log
# 289 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 3) ngx_log_error_core(3, 
# 289 "project/nginx/src/core/ngx_file.c"
...
# 291 "project/nginx/src/core/ngx_file.c"
                                             ;
                return 
# 292 "project/nginx/src/core/ngx_file.c" 3 4
                      -1
# 292 "project/nginx/src/core/ngx_file.c"
                               ;
            }
        }
    ...
    return 
# 299 "project/nginx/src/core/ngx_file.c" 3 4
          0
# 299 "project/nginx/src/core/ngx_file.c"
                ;
}
...
ngx_create_full_path(u_char *dir, ngx_uint_t access)
{
    ...
    for ( ; *p; p++) {
        ...
        *p = '\0';
        ...
        if (
# 326 "project/nginx/src/core/ngx_file.c" 3 4
           mkdir((const char *) 
# 326 "project/nginx/src/core/ngx_file.c"
           dir
# 326 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 326 "project/nginx/src/core/ngx_file.c"
...
# 326 "project/nginx/src/core/ngx_file.c"
            ...
            err = 
# 327 "project/nginx/src/core/ngx_file.c" 3 4
                 (*__error())
# 327 "project/nginx/src/core/ngx_file.c"
                          ;

            switch (err) {
            case 
# 330 "project/nginx/src/core/ngx_file.c" 3 4
                17
# 330 "project/nginx/src/core/ngx_file.c"
                          :
                err = 0;
            case 
# 332 "project/nginx/src/core/ngx_file.c" 3 4
                13
# 332 "project/nginx/src/core/ngx_file.c"
                          :
                break;
...
ngx_next_temp_number(ngx_uint_t collision)
{
    ...
    n = 
# 354 "project/nginx/src/core/ngx_file.c" 3 4
       __sync_fetch_and_add(
# 354 "project/nginx/src/core/ngx_file.c"
       ngx_temp_number
# 354 "project/nginx/src/core/ngx_file.c" 3 4
       , 
# 354 "project/nginx/src/core/ngx_file.c"
...
ngx_conf_set_path_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (path == 
# 377 "project/nginx/src/core/ngx_file.c" 3 4
               ((void *)0)
# 377 "project/nginx/src/core/ngx_file.c"
                   ) {
        return 
# 378 "project/nginx/src/core/ngx_file.c" 3 4
              (void *) -1
# 378 "project/nginx/src/core/ngx_file.c"
                            ;
    }
    ...
    if (ngx_conf_full_name(cf->cycle, &path->name, 0) != 
# 389 "project/nginx/src/core/ngx_file.c" 3 4
                                                        0
# 389 "project/nginx/src/core/ngx_file.c"
                                                              ) {
        return 
# 390 "project/nginx/src/core/ngx_file.c" 3 4
              (void *) -1
# 390 "project/nginx/src/core/ngx_file.c"
                            ;
    }
    ...
    for (i = 0, n = 2; n < cf->args->nelts; i++, n++) {
        ...
        if (level == 
# 398 "project/nginx/src/core/ngx_file.c" 3 4
                    -1 
# 398 "project/nginx/src/core/ngx_file.c"
                              || level == 0) {
    ...
    *slot = path;
    ...
    if (ngx_add_path(cf, slot) == 
# 412 "project/nginx/src/core/ngx_file.c" 3 4
                                 -1
# 412 "project/nginx/src/core/ngx_file.c"
                                          ) {
        return 
# 413 "project/nginx/src/core/ngx_file.c" 3 4
              (void *) -1
# 413 "project/nginx/src/core/ngx_file.c"
                            ;
    }

    return 
# 416 "project/nginx/src/core/ngx_file.c" 3 4
          ((void *)0)
# 416 "project/nginx/src/core/ngx_file.c"
                     ;
}
    ...
    ngx_path_init_t *init)
{
    ...
    if (*path) {
        return 
# 427 "project/nginx/src/core/ngx_file.c" 3 4
              ((void *)0)
# 427 "project/nginx/src/core/ngx_file.c"
                         ;
    }
    ...
    if (prev) {
        *path = prev;
        return 
# 432 "project/nginx/src/core/ngx_file.c" 3 4
              ((void *)0)
# 432 "project/nginx/src/core/ngx_file.c"
                         ;
    }

    *path = ngx_pcalloc(cf->pool, sizeof(ngx_path_t));
    if (*path == 
# 436 "project/nginx/src/core/ngx_file.c" 3 4
                ((void *)0)
# 436 "project/nginx/src/core/ngx_file.c"
                    ) {
        return 
# 437 "project/nginx/src/core/ngx_file.c" 3 4
              (void *) -1
# 437 "project/nginx/src/core/ngx_file.c"
                            ;
    }
    ...
    if (ngx_conf_full_name(cf->cycle, &(*path)->name, 0) != 
# 442 "project/nginx/src/core/ngx_file.c" 3 4
                                                           0
# 442 "project/nginx/src/core/ngx_file.c"
                                                                 ) {
        return 
# 443 "project/nginx/src/core/ngx_file.c" 3 4
              (void *) -1
# 443 "project/nginx/src/core/ngx_file.c"
                            ;
    }

    for (i = 0; i < 
# 446 "project/nginx/src/core/ngx_file.c" 3 4
                   3
# 446 "project/nginx/src/core/ngx_file.c"
                                     ; i++) {
        (*path)->level[i] = init->level[i];
        (*path)->len += init->level[i] + (init->level[i] ? 1 : 0);
    }

    if (ngx_add_path(cf, path) != 
# 451 "project/nginx/src/core/ngx_file.c" 3 4
                                 0
# 451 "project/nginx/src/core/ngx_file.c"
                                       ) {
        return 
# 452 "project/nginx/src/core/ngx_file.c" 3 4
              (void *) -1
# 452 "project/nginx/src/core/ngx_file.c"
                            ;
    }

    return 
# 455 "project/nginx/src/core/ngx_file.c" 3 4
          ((void *)0)
# 455 "project/nginx/src/core/ngx_file.c"
                     ;
}
...
ngx_conf_set_access_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*access != 
# 470 "project/nginx/src/core/ngx_file.c" 3 4
                  (ngx_uint_t) -1
# 470 "project/nginx/src/core/ngx_file.c"
                                     ) {
        return "is duplicate";
    }
    ...
    *access = 0;
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (
# 483 "project/nginx/src/core/ngx_file.c" 3 4
           strncmp((const char *) 
# 483 "project/nginx/src/core/ngx_file.c"
           p
# 483 "project/nginx/src/core/ngx_file.c" 3 4
           , (const char *) 
# 483 "project/nginx/src/core/ngx_file.c"
...
# 488 "project/nginx/src/core/ngx_file.c" 3 4
                  strncmp((const char *) 
# 488 "project/nginx/src/core/ngx_file.c"
                  p
# 488 "project/nginx/src/core/ngx_file.c" 3 4
                  , (const char *) 
# 488 "project/nginx/src/core/ngx_file.c"
...
# 492 "project/nginx/src/core/ngx_file.c" 3 4
                  strncmp((const char *) 
# 492 "project/nginx/src/core/ngx_file.c"
                  p
# 492 "project/nginx/src/core/ngx_file.c" 3 4
                  , (const char *) 
# 492 "project/nginx/src/core/ngx_file.c"
...
# 492 "project/nginx/src/core/ngx_file.c"
        ...
        if (
# 500 "project/nginx/src/core/ngx_file.c" 3 4
           strcmp((const char *) 
# 500 "project/nginx/src/core/ngx_file.c"
           p
# 500 "project/nginx/src/core/ngx_file.c" 3 4
           , (const char *) 
# 500 "project/nginx/src/core/ngx_file.c"
...
# 503 "project/nginx/src/core/ngx_file.c" 3 4
                  strcmp((const char *) 
# 503 "project/nginx/src/core/ngx_file.c"
                  p
# 503 "project/nginx/src/core/ngx_file.c" 3 4
                  , (const char *) 
# 503 "project/nginx/src/core/ngx_file.c"
...
# 503 "project/nginx/src/core/ngx_file.c"
    ...
    *access |= user;
    ...
    return 
# 515 "project/nginx/src/core/ngx_file.c" 3 4
          ((void *)0)
# 515 "project/nginx/src/core/ngx_file.c"
                     ;

invalid:

    ngx_conf_log_error(
# 519 "project/nginx/src/core/ngx_file.c" 3 4
                      1
# 519 "project/nginx/src/core/ngx_file.c"
                                   , cf, 0, "invalid value \"%V\"", &value[i]);

    return 
# 521 "project/nginx/src/core/ngx_file.c" 3 4
          (void *) -1
# 521 "project/nginx/src/core/ngx_file.c"
                        ;
}
...
ngx_add_path(ngx_conf_t *cf, ngx_path_t **slot)
{
    ...
    for (i = 0; i < cf->cycle->paths.nelts; i++) {
        if (p[i]->name.len == path->name.len
            && 
# 536 "project/nginx/src/core/ngx_file.c" 3 4
              strcmp((const char *) 
# 536 "project/nginx/src/core/ngx_file.c"
              p[i]->name.data
# 536 "project/nginx/src/core/ngx_file.c" 3 4
              , (const char *) 
# 536 "project/nginx/src/core/ngx_file.c"
...
# 536 "project/nginx/src/core/ngx_file.c"
                                                           == 0)
        {
            if (p[i]->data != path->data) {
                ngx_conf_log_error(
# 539 "project/nginx/src/core/ngx_file.c" 3 4
                                  1
# 539 "project/nginx/src/core/ngx_file.c"
                                               , cf, 0,
                                   "the same path name \"%V\" "
                                   "used in %s:%ui and",
                                   &p[i]->name, p[i]->conf_file, p[i]->line);
                return 
# 543 "project/nginx/src/core/ngx_file.c" 3 4
                      -1
# 543 "project/nginx/src/core/ngx_file.c"
                               ;
            }

            for (n = 0; n < 
# 546 "project/nginx/src/core/ngx_file.c" 3 4
                           3
# 546 "project/nginx/src/core/ngx_file.c"
                                             ; n++) {
                if (p[i]->level[n] != path->level[n]) {
                    if (path->conf_file == 
# 548 "project/nginx/src/core/ngx_file.c" 3 4
                                          ((void *)0)
# 548 "project/nginx/src/core/ngx_file.c"
                                              ) {
                        if (p[i]->conf_file == 
# 549 "project/nginx/src/core/ngx_file.c" 3 4
                                              ((void *)0)
# 549 "project/nginx/src/core/ngx_file.c"
                                                  ) {
                            
# 550 "project/nginx/src/core/ngx_file.c" 3 4
                           if ((
# 550 "project/nginx/src/core/ngx_file.c"
                           cf->log
# 550 "project/nginx/src/core/ngx_file.c" 3 4
...
# 550 "project/nginx/src/core/ngx_file.c" 3 4
                           , 
# 550 "project/nginx/src/core/ngx_file.c"
                           0, "the default path name \"%V\" has " "the same name as another default path, " "but the different levels, you need to " "redefine one of them in http section", &p[i]->name
# 550 "project/nginx/src/core/ngx_file.c" 3 4
                           )
...
# 555 "project/nginx/src/core/ngx_file.c"
                                                 ;
                            return 
# 556 "project/nginx/src/core/ngx_file.c" 3 4
                                  -1
# 556 "project/nginx/src/core/ngx_file.c"
                                           ;
                        }

                        
# 559 "project/nginx/src/core/ngx_file.c" 3 4
                       if ((
# 559 "project/nginx/src/core/ngx_file.c"
                       cf->log
# 559 "project/nginx/src/core/ngx_file.c" 3 4
                       )->log_level >= 1) ngx_log_error_core(1, 
# 559 "project/nginx/src/core/ngx_file.c"
...
# 559 "project/nginx/src/core/ngx_file.c" 3 4
                       , 
# 559 "project/nginx/src/core/ngx_file.c"
                       0, "the path name \"%V\" in %s:%ui has " "the same name as default path, but " "the different levels, you need to " "define default path in http section", &p[i]->name, p[i]->conf_file, p[i]->line
# 559 "project/nginx/src/core/ngx_file.c" 3 4
                       )
...
# 564 "project/nginx/src/core/ngx_file.c"
                                                                              ;
                        return 
# 565 "project/nginx/src/core/ngx_file.c" 3 4
                              -1
# 565 "project/nginx/src/core/ngx_file.c"
                                       ;
                    }

                    ngx_conf_log_error(
# 568 "project/nginx/src/core/ngx_file.c" 3 4
                                      1
# 568 "project/nginx/src/core/ngx_file.c"
                                                   , cf, 0,
                                      "the same path name \"%V\" in %s:%ui "
                                      "has the different levels than",
                                      &p[i]->name, p[i]->conf_file, p[i]->line);
                    return 
# 572 "project/nginx/src/core/ngx_file.c" 3 4
                          -1
# 572 "project/nginx/src/core/ngx_file.c"
                                   ;
                }
            ...
            *slot = p[i];
            ...
            return 
# 582 "project/nginx/src/core/ngx_file.c" 3 4
                  0
# 582 "project/nginx/src/core/ngx_file.c"
                        ;
        }
    }
    ...
    if (p == 
# 587 "project/nginx/src/core/ngx_file.c" 3 4
            ((void *)0)
# 587 "project/nginx/src/core/ngx_file.c"
                ) {
        return 
# 588 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 588 "project/nginx/src/core/ngx_file.c"
                       ;
    }
    ...
    *p = path;
    ...
    return 
# 593 "project/nginx/src/core/ngx_file.c" 3 4
          0
# 593 "project/nginx/src/core/ngx_file.c"
                ;
}
...
ngx_create_paths(ngx_cycle_t *cycle, ngx_uid_t user)
{
    ...
    for (i = 0; i < cycle->paths.nelts; i++) {
        ...
        if (
# 607 "project/nginx/src/core/ngx_file.c" 3 4
           mkdir((const char *) 
# 607 "project/nginx/src/core/ngx_file.c"
           path[i]->name.data
# 607 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 607 "project/nginx/src/core/ngx_file.c"
...
# 607 "project/nginx/src/core/ngx_file.c"
            ...
            err = 
# 608 "project/nginx/src/core/ngx_file.c" 3 4
                 (*__error())
# 608 "project/nginx/src/core/ngx_file.c"
                          ;
            if (err != 
# 609 "project/nginx/src/core/ngx_file.c" 3 4
                      17
# 609 "project/nginx/src/core/ngx_file.c"
                                ) {
                
# 610 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 610 "project/nginx/src/core/ngx_file.c"
               cycle->log
# 610 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 610 "project/nginx/src/core/ngx_file.c"
...
# 612 "project/nginx/src/core/ngx_file.c"
                                                ;
                return 
# 613 "project/nginx/src/core/ngx_file.c" 3 4
                      -1
# 613 "project/nginx/src/core/ngx_file.c"
                               ;
            }
        }

        if (user == (ngx_uid_t) 
# 617 "project/nginx/src/core/ngx_file.c" 3 4
                               (ngx_uint_t) -1
# 617 "project/nginx/src/core/ngx_file.c"
                                                  ) {
            continue;
        }
        ...
        if (
# 625 "project/nginx/src/core/ngx_file.c" 3 4
           stat((const char *) 
# 625 "project/nginx/src/core/ngx_file.c"
           path[i]->name.data
# 625 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 625 "project/nginx/src/core/ngx_file.c"
...
# 626 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 626 "project/nginx/src/core/ngx_file.c"
           cycle->log
# 626 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 626 "project/nginx/src/core/ngx_file.c"
...
# 627 "project/nginx/src/core/ngx_file.c"
                                                                              ;
            return 
# 628 "project/nginx/src/core/ngx_file.c" 3 4
                  -1
# 628 "project/nginx/src/core/ngx_file.c"
                           ;
        }
...
# 633 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 633 "project/nginx/src/core/ngx_file.c"
               cycle->log
# 633 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 633 "project/nginx/src/core/ngx_file.c"
...
# 633 "project/nginx/src/core/ngx_file.c" 3 4
               , (*__error())
# 633 "project/nginx/src/core/ngx_file.c"
               , "chown(\"%s\", %d) failed", path[i]->name.data, user
# 633 "project/nginx/src/core/ngx_file.c" 3 4
               )

                                                       
# 635 "project/nginx/src/core/ngx_file.c"
                                                      ;
                return 
# 636 "project/nginx/src/core/ngx_file.c" 3 4
                      -1
# 636 "project/nginx/src/core/ngx_file.c"
                               ;
            }
        }

        if ((fi.st_mode & (
# 640 "project/nginx/src/core/ngx_file.c" 3 4
                          0000400
# 640 "project/nginx/src/core/ngx_file.c"
                                 |
# 640 "project/nginx/src/core/ngx_file.c" 3 4
                                  0000200
# 640 "project/nginx/src/core/ngx_file.c"
...
# 640 "project/nginx/src/core/ngx_file.c"
                                                  ...
                                                  != (
# 641 "project/nginx/src/core/ngx_file.c" 3 4
                                                     0000400
# 641 "project/nginx/src/core/ngx_file.c"
                                                            |
# 641 "project/nginx/src/core/ngx_file.c" 3 4
                                                             0000200
# 641 "project/nginx/src/core/ngx_file.c"
...
# 643 "project/nginx/src/core/ngx_file.c" 3 4
                          0000400
# 643 "project/nginx/src/core/ngx_file.c"
                                 |
# 643 "project/nginx/src/core/ngx_file.c" 3 4
                                  0000200
# 643 "project/nginx/src/core/ngx_file.c"
...
# 646 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 646 "project/nginx/src/core/ngx_file.c"
               cycle->log
# 646 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 646 "project/nginx/src/core/ngx_file.c"
...
# 647 "project/nginx/src/core/ngx_file.c"
                                                                         ;
                return 
# 648 "project/nginx/src/core/ngx_file.c" 3 4
                      -1
# 648 "project/nginx/src/core/ngx_file.c"
                               ;
            }
        }
        }
    ...
    return 
# 655 "project/nginx/src/core/ngx_file.c" 3 4
          0
# 655 "project/nginx/src/core/ngx_file.c"
                ;
}
...
ngx_ext_rename_file(ngx_str_t *src, ngx_str_t *to, ngx_ext_rename_file_t *ext)
{
    ...
    if (ext->access) {
        if (
# 669 "project/nginx/src/core/ngx_file.c" 3 4
           chmod((const char *) 
# 669 "project/nginx/src/core/ngx_file.c"
           src->data
# 669 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 669 "project/nginx/src/core/ngx_file.c"
...
# 670 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 670 "project/nginx/src/core/ngx_file.c"
           ext->log
# 670 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 670 "project/nginx/src/core/ngx_file.c"
...
# 671 "project/nginx/src/core/ngx_file.c"
                                                                              ;
            err = 0;
            goto failed;
        }
    ...
    if (ext->time != -1) {
        if (ngx_set_file_time(src->data, ext->fd, ext->time) != 
# 680 "project/nginx/src/core/ngx_file.c" 3 4
                                                               0
# 680 "project/nginx/src/core/ngx_file.c"
                                                                     ) {
            
# 681 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 681 "project/nginx/src/core/ngx_file.c"
           ext->log
# 681 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 681 "project/nginx/src/core/ngx_file.c"
...
# 682 "project/nginx/src/core/ngx_file.c"
                                                                         ;
            err = 0;
            goto failed;
        }
    ...
    if (
# 688 "project/nginx/src/core/ngx_file.c" 3 4
       rename((const char *) 
# 688 "project/nginx/src/core/ngx_file.c"
       src->data
# 688 "project/nginx/src/core/ngx_file.c" 3 4
       , (const char *) 
# 688 "project/nginx/src/core/ngx_file.c"
...
# 688 "project/nginx/src/core/ngx_file.c"
        ...
        return 
# 689 "project/nginx/src/core/ngx_file.c" 3 4
              0
# 689 "project/nginx/src/core/ngx_file.c"
                    ;
    }

    err = 
# 692 "project/nginx/src/core/ngx_file.c" 3 4
         (*__error())
# 692 "project/nginx/src/core/ngx_file.c"
                  ;

    if (err == 
# 694 "project/nginx/src/core/ngx_file.c" 3 4
              2
# 694 "project/nginx/src/core/ngx_file.c"
                         ) {
        ...
        err = ngx_create_full_path(to->data, 
# 700 "project/nginx/src/core/ngx_file.c" 3 4
                                            (
# 700 "project/nginx/src/core/ngx_file.c"
                                            ext->path_access 
# 700 "project/nginx/src/core/ngx_file.c" 3 4
                                            | (
# 700 "project/nginx/src/core/ngx_file.c"
...
# 703 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 703 "project/nginx/src/core/ngx_file.c"
           ext->log
# 703 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 703 "project/nginx/src/core/ngx_file.c"
...
# 704 "project/nginx/src/core/ngx_file.c"
                                                                     ;
            err = 0;
            goto failed;
        }
        ...
        if (
# 709 "project/nginx/src/core/ngx_file.c" 3 4
           rename((const char *) 
# 709 "project/nginx/src/core/ngx_file.c"
           src->data
# 709 "project/nginx/src/core/ngx_file.c" 3 4
           , (const char *) 
# 709 "project/nginx/src/core/ngx_file.c"
...
# 709 "project/nginx/src/core/ngx_file.c"
            ...
            return 
# 710 "project/nginx/src/core/ngx_file.c" 3 4
                  0
# 710 "project/nginx/src/core/ngx_file.c"
                        ;
        }

        err = 
# 713 "project/nginx/src/core/ngx_file.c" 3 4
             (*__error())
# 713 "project/nginx/src/core/ngx_file.c"
                      ;
    }
# 728 "project/nginx/src/core/ngx_file.c"
    if (err == 
# 728 "project/nginx/src/core/ngx_file.c" 3 4
              18
# 728 "project/nginx/src/core/ngx_file.c"
                       ) {
        ...
        if (name == 
# 737 "project/nginx/src/core/ngx_file.c" 3 4
                   ((void *)0)
# 737 "project/nginx/src/core/ngx_file.c"
                       ) {
            return 
# 738 "project/nginx/src/core/ngx_file.c" 3 4
                  -1
# 738 "project/nginx/src/core/ngx_file.c"
                           ;
        }
        ...
        if (ngx_copy_file(src->data, name, &cf) == 
# 744 "project/nginx/src/core/ngx_file.c" 3 4
                                                  0
# 744 "project/nginx/src/core/ngx_file.c"
                                                        ) {

            if (
# 746 "project/nginx/src/core/ngx_file.c" 3 4
               rename((const char *) 
# 746 "project/nginx/src/core/ngx_file.c"
               name
# 746 "project/nginx/src/core/ngx_file.c" 3 4
               , (const char *) 
# 746 "project/nginx/src/core/ngx_file.c"
...
# 747 "project/nginx/src/core/ngx_file.c" 3 4
               free
# 747 "project/nginx/src/core/ngx_file.c"
                       (name);

                if (
# 749 "project/nginx/src/core/ngx_file.c" 3 4
                   unlink((const char *) 
# 749 "project/nginx/src/core/ngx_file.c"
                   src->data
# 749 "project/nginx/src/core/ngx_file.c" 3 4
                   ) 
# 749 "project/nginx/src/core/ngx_file.c"
...
# 750 "project/nginx/src/core/ngx_file.c" 3 4
                   if ((
# 750 "project/nginx/src/core/ngx_file.c"
                   ext->log
# 750 "project/nginx/src/core/ngx_file.c" 3 4
                   )->log_level >= 3) ngx_log_error_core(3, 
# 750 "project/nginx/src/core/ngx_file.c"
...
# 752 "project/nginx/src/core/ngx_file.c"
                                           ;
                    return 
# 753 "project/nginx/src/core/ngx_file.c" 3 4
                          -1
# 753 "project/nginx/src/core/ngx_file.c"
                                   ;
                }

                return 
# 756 "project/nginx/src/core/ngx_file.c" 3 4
                      0
# 756 "project/nginx/src/core/ngx_file.c"
                            ;
            }

            
# 759 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 759 "project/nginx/src/core/ngx_file.c"
           ext->log
# 759 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 759 "project/nginx/src/core/ngx_file.c"
...
# 761 "project/nginx/src/core/ngx_file.c"
                                        ;

            if (
# 763 "project/nginx/src/core/ngx_file.c" 3 4
               unlink((const char *) 
# 763 "project/nginx/src/core/ngx_file.c"
               name
# 763 "project/nginx/src/core/ngx_file.c" 3 4
               ) 
# 763 "project/nginx/src/core/ngx_file.c"
...
# 764 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 764 "project/nginx/src/core/ngx_file.c"
               ext->log
# 764 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 3) ngx_log_error_core(3, 
# 764 "project/nginx/src/core/ngx_file.c"
...
# 765 "project/nginx/src/core/ngx_file.c"
                                                                      ;
...
# 770 "project/nginx/src/core/ngx_file.c" 3 4
       free
# 770 "project/nginx/src/core/ngx_file.c"
               (name);
...
failed:
    ...
    if (ext->delete_file) {
        if (
# 778 "project/nginx/src/core/ngx_file.c" 3 4
           unlink((const char *) 
# 778 "project/nginx/src/core/ngx_file.c"
           src->data
# 778 "project/nginx/src/core/ngx_file.c" 3 4
           ) 
# 778 "project/nginx/src/core/ngx_file.c"
...
# 779 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 779 "project/nginx/src/core/ngx_file.c"
           ext->log
# 779 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 779 "project/nginx/src/core/ngx_file.c"
...
# 780 "project/nginx/src/core/ngx_file.c"
                                                                       ;
        }
    }
...
# 785 "project/nginx/src/core/ngx_file.c" 3 4
       if ((
# 785 "project/nginx/src/core/ngx_file.c"
       ext->log
# 785 "project/nginx/src/core/ngx_file.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 785 "project/nginx/src/core/ngx_file.c"
...
# 787 "project/nginx/src/core/ngx_file.c"
                                         ;
    }

    return 
# 790 "project/nginx/src/core/ngx_file.c" 3 4
          -1
# 790 "project/nginx/src/core/ngx_file.c"
                   ;
}
...
ngx_copy_file(u_char *from, u_char *to, ngx_copy_file_t *cf)
{
    ...
    rc = 
# 807 "project/nginx/src/core/ngx_file.c" 3 4
        -1
# 807 "project/nginx/src/core/ngx_file.c"
                 ;
    buf = 
# 808 "project/nginx/src/core/ngx_file.c" 3 4
         ((void *)0)
# 808 "project/nginx/src/core/ngx_file.c"
             ;
    nfd = 
# 809 "project/nginx/src/core/ngx_file.c" 3 4
         -1
# 809 "project/nginx/src/core/ngx_file.c"
                         ;

    fd = 
# 811 "project/nginx/src/core/ngx_file.c" 3 4
        open((const char *) 
# 811 "project/nginx/src/core/ngx_file.c"
        from
# 811 "project/nginx/src/core/ngx_file.c" 3 4
        , 0x0000|0, 
# 811 "project/nginx/src/core/ngx_file.c"
...
# 811 "project/nginx/src/core/ngx_file.c"
    ...
    if (fd == 
# 813 "project/nginx/src/core/ngx_file.c" 3 4
             -1
# 813 "project/nginx/src/core/ngx_file.c"
                             ) {
        
# 814 "project/nginx/src/core/ngx_file.c" 3 4
       if ((
# 814 "project/nginx/src/core/ngx_file.c"
       cf->log
# 814 "project/nginx/src/core/ngx_file.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 814 "project/nginx/src/core/ngx_file.c"
...
# 815 "project/nginx/src/core/ngx_file.c"
                                                            ;
        goto failed;
    }
    ...
    if (cf->size != -1 && cf->access != 0 && cf->time != -1) {
        ...
        if (
# 825 "project/nginx/src/core/ngx_file.c" 3 4
           fstat(
# 825 "project/nginx/src/core/ngx_file.c"
           fd
# 825 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 825 "project/nginx/src/core/ngx_file.c"
...
# 826 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 826 "project/nginx/src/core/ngx_file.c"
           cf->log
# 826 "project/nginx/src/core/ngx_file.c" 3 4
...
# 827 "project/nginx/src/core/ngx_file.c"
                                                              ;

            goto failed;
        }

        size = (cf->size != -1) ? cf->size : 
# 832 "project/nginx/src/core/ngx_file.c" 3 4
                                            (
# 832 "project/nginx/src/core/ngx_file.c"
                                            &fi
# 832 "project/nginx/src/core/ngx_file.c" 3 4
                                            )->st_size
# 832 "project/nginx/src/core/ngx_file.c"
                                                              ;
        access = cf->access ? cf->access : 
# 833 "project/nginx/src/core/ngx_file.c" 3 4
                                          ((
# 833 "project/nginx/src/core/ngx_file.c"
                                          &fi
# 833 "project/nginx/src/core/ngx_file.c" 3 4
                                          )->st_mode & 0777)
# 833 "project/nginx/src/core/ngx_file.c"
                                                              ;
        time = (cf->time != -1) ? cf->time : 
# 834 "project/nginx/src/core/ngx_file.c" 3 4
                                            (
# 834 "project/nginx/src/core/ngx_file.c"
                                            &fi
# 834 "project/nginx/src/core/ngx_file.c" 3 4
                                            )->st_mtimespec.tv_sec
# 834 "project/nginx/src/core/ngx_file.c"
    ...
    if (buf == 
# 844 "project/nginx/src/core/ngx_file.c" 3 4
              ((void *)0)
# 844 "project/nginx/src/core/ngx_file.c"
                  ) {
        goto failed;
    }

    nfd = 
# 848 "project/nginx/src/core/ngx_file.c" 3 4
         open((const char *) 
# 848 "project/nginx/src/core/ngx_file.c"
         to
# 848 "project/nginx/src/core/ngx_file.c" 3 4
         , 0x0001|(0x00000200|0x00000400), 
# 848 "project/nginx/src/core/ngx_file.c"
         access
# 848 "project/nginx/src/core/ngx_file.c" 3 4
         )
# 848 "project/nginx/src/core/ngx_file.c"
    ...
    if (nfd == 
# 850 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 850 "project/nginx/src/core/ngx_file.c"
                              ) {
        
# 851 "project/nginx/src/core/ngx_file.c" 3 4
       if ((
# 851 "project/nginx/src/core/ngx_file.c"
       cf->log
# 851 "project/nginx/src/core/ngx_file.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 851 "project/nginx/src/core/ngx_file.c"
...
# 852 "project/nginx/src/core/ngx_file.c"
                                                          ;
        goto failed;
    }
    ...
    while (size > 0) {
        ...
        n = 
# 862 "project/nginx/src/core/ngx_file.c" 3 4
           read
# 862 "project/nginx/src/core/ngx_file.c"
                      (fd, buf, len);

        if (n == -1) {
            
# 865 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 865 "project/nginx/src/core/ngx_file.c"
           cf->log
# 865 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 865 "project/nginx/src/core/ngx_file.c"
...
# 866 "project/nginx/src/core/ngx_file.c"
                                                              ;
            goto failed;
        }
...
# 871 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 871 "project/nginx/src/core/ngx_file.c"
           cf->log
# 871 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 871 "project/nginx/src/core/ngx_file.c"
...
# 873 "project/nginx/src/core/ngx_file.c"
                                       ;
            goto failed;
        }
...
# 880 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 880 "project/nginx/src/core/ngx_file.c"
           cf->log
# 880 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 880 "project/nginx/src/core/ngx_file.c"
...
# 881 "project/nginx/src/core/ngx_file.c"
                                                             ;
            goto failed;
        }
...
# 886 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 886 "project/nginx/src/core/ngx_file.c"
           cf->log
# 886 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 886 "project/nginx/src/core/ngx_file.c"
...
# 888 "project/nginx/src/core/ngx_file.c"
                                     ;
            goto failed;
        }
    ...
    if (ngx_set_file_time(to, nfd, time) != 
# 895 "project/nginx/src/core/ngx_file.c" 3 4
                                           0
# 895 "project/nginx/src/core/ngx_file.c"
                                                 ) {
        
# 896 "project/nginx/src/core/ngx_file.c" 3 4
       if ((
# 896 "project/nginx/src/core/ngx_file.c"
       cf->log
# 896 "project/nginx/src/core/ngx_file.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 896 "project/nginx/src/core/ngx_file.c"
...
# 897 "project/nginx/src/core/ngx_file.c"
                                                              ;
        goto failed;
    }

    rc = 
# 901 "project/nginx/src/core/ngx_file.c" 3 4
        0
# 901 "project/nginx/src/core/ngx_file.c"
              ;

failed:

    if (nfd != 
# 905 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 905 "project/nginx/src/core/ngx_file.c"
                              ) {
        if (
# 906 "project/nginx/src/core/ngx_file.c" 3 4
           close
# 906 "project/nginx/src/core/ngx_file.c"
                         (nfd) == 
# 906 "project/nginx/src/core/ngx_file.c" 3 4
                                  -1
# 906 "project/nginx/src/core/ngx_file.c"
...
# 907 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 907 "project/nginx/src/core/ngx_file.c"
           cf->log
# 907 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 907 "project/nginx/src/core/ngx_file.c"
...
# 908 "project/nginx/src/core/ngx_file.c"
                                                               ;
        }
    }

    if (fd != 
# 912 "project/nginx/src/core/ngx_file.c" 3 4
             -1
# 912 "project/nginx/src/core/ngx_file.c"
                             ) {
        if (
# 913 "project/nginx/src/core/ngx_file.c" 3 4
           close
# 913 "project/nginx/src/core/ngx_file.c"
                         (fd) == 
# 913 "project/nginx/src/core/ngx_file.c" 3 4
                                 -1
# 913 "project/nginx/src/core/ngx_file.c"
...
# 914 "project/nginx/src/core/ngx_file.c" 3 4
           if ((
# 914 "project/nginx/src/core/ngx_file.c"
           cf->log
# 914 "project/nginx/src/core/ngx_file.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 914 "project/nginx/src/core/ngx_file.c"
...
# 915 "project/nginx/src/core/ngx_file.c"
                                                                 ;
        }
    }
...
# 920 "project/nginx/src/core/ngx_file.c" 3 4
       free
# 920 "project/nginx/src/core/ngx_file.c"
               (buf);
    }

    return rc;
}
# 945 "project/nginx/src/core/ngx_file.c"
ngx_int_t
...
# 956 "project/nginx/src/core/ngx_file.c" 3 4
   (
# 956 "project/nginx/src/core/ngx_file.c"
   &buf
# 956 "project/nginx/src/core/ngx_file.c" 3 4
   )->len = 0; (
# 956 "project/nginx/src/core/ngx_file.c"
...
# 956 "project/nginx/src/core/ngx_file.c"
    ...
    if (ngx_open_dir(tree, &dir) == 
# 961 "project/nginx/src/core/ngx_file.c" 3 4
                                   -1
# 961 "project/nginx/src/core/ngx_file.c"
                                            ) {
        
# 962 "project/nginx/src/core/ngx_file.c" 3 4
       if ((
# 962 "project/nginx/src/core/ngx_file.c"
       ctx->log
# 962 "project/nginx/src/core/ngx_file.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 962 "project/nginx/src/core/ngx_file.c"
...
# 963 "project/nginx/src/core/ngx_file.c"
                                                                 ;
        return 
# 964 "project/nginx/src/core/ngx_file.c" 3 4
              -1
# 964 "project/nginx/src/core/ngx_file.c"
                       ;
    }
    ...
    if (ctx->alloc) {
        ...
        if (data == 
# 971 "project/nginx/src/core/ngx_file.c" 3 4
                   ((void *)0)
# 971 "project/nginx/src/core/ngx_file.c"
                       ) {
            goto failed;
        }

        if (ctx->init_handler(data, prev) == 
# 975 "project/nginx/src/core/ngx_file.c" 3 4
                                            -6
# 975 "project/nginx/src/core/ngx_file.c"
                                                     ) {
            goto failed;
        }
        ...
        data = 
# 982 "project/nginx/src/core/ngx_file.c" 3 4
              ((void *)0)
# 982 "project/nginx/src/core/ngx_file.c"
                  ;
    }
...
# 987 "project/nginx/src/core/ngx_file.c" 3 4
       (*__error()) = 
# 987 "project/nginx/src/core/ngx_file.c"
       0;

        if (ngx_read_dir(&dir) == 
# 989 "project/nginx/src/core/ngx_file.c" 3 4
                                 -1
# 989 "project/nginx/src/core/ngx_file.c"
                                          ) {
            err = 
# 990 "project/nginx/src/core/ngx_file.c" 3 4
                 (*__error())
# 990 "project/nginx/src/core/ngx_file.c"
                          ;

            if (err == 
# 992 "project/nginx/src/core/ngx_file.c" 3 4
                      0
# 992 "project/nginx/src/core/ngx_file.c"
                                      ) {
                rc = 
# 993 "project/nginx/src/core/ngx_file.c" 3 4
                    0
# 993 "project/nginx/src/core/ngx_file.c"
                          ;

            } else {
                
# 996 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 996 "project/nginx/src/core/ngx_file.c"
               ctx->log
# 996 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 3) ngx_log_error_core(3, 
# 996 "project/nginx/src/core/ngx_file.c"
...
# 997 "project/nginx/src/core/ngx_file.c"
                                                                         ;
                rc = 
# 998 "project/nginx/src/core/ngx_file.c" 3 4
                    -1
# 998 "project/nginx/src/core/ngx_file.c"
                             ;
            }
        ...
        len = 
# 1004 "project/nginx/src/core/ngx_file.c" 3 4
             (
# 1004 "project/nginx/src/core/ngx_file.c"
             &dir
# 1004 "project/nginx/src/core/ngx_file.c" 3 4
             )->de->d_namlen
# 1004 "project/nginx/src/core/ngx_file.c"
                                 ;
        name = 
# 1005 "project/nginx/src/core/ngx_file.c" 3 4
              ((u_char *) (
# 1005 "project/nginx/src/core/ngx_file.c"
              &dir
# 1005 "project/nginx/src/core/ngx_file.c" 3 4
              )->de->d_name)
# 1005 "project/nginx/src/core/ngx_file.c"
...
# 1023 "project/nginx/src/core/ngx_file.c" 3 4
               free
# 1023 "project/nginx/src/core/ngx_file.c"
                       (buf.data);
            }
            ...
            if (buf.data == 
# 1029 "project/nginx/src/core/ngx_file.c" 3 4
                           ((void *)0)
# 1029 "project/nginx/src/core/ngx_file.c"
                               ) {
                goto failed;
            }
        }
        ...
        p = 
# 1034 "project/nginx/src/core/ngx_file.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 1034 "project/nginx/src/core/ngx_file.c"
           buf.data
# 1034 "project/nginx/src/core/ngx_file.c" 3 4
           , 
# 1034 "project/nginx/src/core/ngx_file.c"
...
# 1036 "project/nginx/src/core/ngx_file.c" 3 4
       (void) __builtin___memcpy_chk (
# 1036 "project/nginx/src/core/ngx_file.c"
       p
# 1036 "project/nginx/src/core/ngx_file.c" 3 4
       , 
# 1036 "project/nginx/src/core/ngx_file.c"
...
# 1036 "project/nginx/src/core/ngx_file.c"
        ...
        if (!dir.valid_info) {
            if (ngx_de_info(file.data, &dir) == 
# 1044 "project/nginx/src/core/ngx_file.c" 3 4
                                               -1
# 1044 "project/nginx/src/core/ngx_file.c"
                                                             ) {
                
# 1045 "project/nginx/src/core/ngx_file.c" 3 4
               if ((
# 1045 "project/nginx/src/core/ngx_file.c"
               ctx->log
# 1045 "project/nginx/src/core/ngx_file.c" 3 4
               )->log_level >= 3) ngx_log_error_core(3, 
# 1045 "project/nginx/src/core/ngx_file.c"
...
# 1046 "project/nginx/src/core/ngx_file.c"
                                                                       ;
                continue;
            }
        }
        ...
        if (
# 1051 "project/nginx/src/core/ngx_file.c" 3 4
           (((
# 1051 "project/nginx/src/core/ngx_file.c"
           &dir
# 1051 "project/nginx/src/core/ngx_file.c" 3 4
           )->type) ? ((
# 1051 "project/nginx/src/core/ngx_file.c"
...
# 1051 "project/nginx/src/core/ngx_file.c"
            ...
            ctx->size = 
# 1056 "project/nginx/src/core/ngx_file.c" 3 4
                       (
# 1056 "project/nginx/src/core/ngx_file.c"
                       &dir
# 1056 "project/nginx/src/core/ngx_file.c" 3 4
                       )->info.st_size
# 1056 "project/nginx/src/core/ngx_file.c"
                                        ;
            ctx->fs_size = 
# 1057 "project/nginx/src/core/ngx_file.c" 3 4
                          (((
# 1057 "project/nginx/src/core/ngx_file.c"
                          &dir
# 1057 "project/nginx/src/core/ngx_file.c" 3 4
                          )->info.st_size < (
# 1057 "project/nginx/src/core/ngx_file.c"
...
# 1057 "project/nginx/src/core/ngx_file.c"
                                              ;
            ctx->access = 
# 1058 "project/nginx/src/core/ngx_file.c" 3 4
                         (((
# 1058 "project/nginx/src/core/ngx_file.c"
                         &dir
# 1058 "project/nginx/src/core/ngx_file.c" 3 4
                         )->info.st_mode) & 0777)
# 1058 "project/nginx/src/core/ngx_file.c"
                                            ;
            ctx->mtime = 
# 1059 "project/nginx/src/core/ngx_file.c" 3 4
                        (
# 1059 "project/nginx/src/core/ngx_file.c"
                        &dir
# 1059 "project/nginx/src/core/ngx_file.c" 3 4
...
# 1059 "project/nginx/src/core/ngx_file.c"
            ...
            if (ctx->file_handler(ctx, &file) == 
# 1061 "project/nginx/src/core/ngx_file.c" 3 4
                                                -6
# 1061 "project/nginx/src/core/ngx_file.c"
                                                         ) {
                goto failed;
            }

        } else if (
# 1065 "project/nginx/src/core/ngx_file.c" 3 4
                  (((
# 1065 "project/nginx/src/core/ngx_file.c"
                  &dir
# 1065 "project/nginx/src/core/ngx_file.c" 3 4
                  )->type) ? ((
# 1065 "project/nginx/src/core/ngx_file.c"
...
# 1065 "project/nginx/src/core/ngx_file.c"
            ...
            ctx->access = 
# 1070 "project/nginx/src/core/ngx_file.c" 3 4
                         (((
# 1070 "project/nginx/src/core/ngx_file.c"
                         &dir
# 1070 "project/nginx/src/core/ngx_file.c" 3 4
                         )->info.st_mode) & 0777)
# 1070 "project/nginx/src/core/ngx_file.c"
                                            ;
            ctx->mtime = 
# 1071 "project/nginx/src/core/ngx_file.c" 3 4
                        (
# 1071 "project/nginx/src/core/ngx_file.c"
                        &dir
# 1071 "project/nginx/src/core/ngx_file.c" 3 4
                        )->info.st_mtimespec.tv_sec
# 1071 "project/nginx/src/core/ngx_file.c"
            ...
            if (rc == 
# 1075 "project/nginx/src/core/ngx_file.c" 3 4
                     -6
# 1075 "project/nginx/src/core/ngx_file.c"
                              ) {
                goto failed;
            }

            if (rc == 
# 1079 "project/nginx/src/core/ngx_file.c" 3 4
                     -5
# 1079 "project/nginx/src/core/ngx_file.c"
                                 ) {
            ...
            if (ngx_walk_tree(ctx, &file) == 
# 1085 "project/nginx/src/core/ngx_file.c" 3 4
                                            -6
# 1085 "project/nginx/src/core/ngx_file.c"
                                                     ) {
                goto failed;
            }

            ctx->access = 
# 1089 "project/nginx/src/core/ngx_file.c" 3 4
                         (((
# 1089 "project/nginx/src/core/ngx_file.c"
                         &dir
# 1089 "project/nginx/src/core/ngx_file.c" 3 4
                         )->info.st_mode) & 0777)
# 1089 "project/nginx/src/core/ngx_file.c"
                                            ;
            ctx->mtime = 
# 1090 "project/nginx/src/core/ngx_file.c" 3 4
                        (
# 1090 "project/nginx/src/core/ngx_file.c"
                        &dir
# 1090 "project/nginx/src/core/ngx_file.c" 3 4
                        )->info.st_mtimespec.tv_sec
# 1090 "project/nginx/src/core/ngx_file.c"
            ...
            if (ctx->post_tree_handler(ctx, &file) == 
# 1092 "project/nginx/src/core/ngx_file.c" 3 4
                                                     -6
# 1092 "project/nginx/src/core/ngx_file.c"
                                                              ) {
                goto failed;
            }
            ...
            if (ctx->spec_handler(ctx, &file) == 
# 1101 "project/nginx/src/core/ngx_file.c" 3 4
                                                -6
# 1101 "project/nginx/src/core/ngx_file.c"
                                                         ) {
                goto failed;
            }
        }
...
failed:
    ...
    rc = 
# 1109 "project/nginx/src/core/ngx_file.c" 3 4
        -6
# 1109 "project/nginx/src/core/ngx_file.c"
                 ;
...
# 1114 "project/nginx/src/core/ngx_file.c" 3 4
       free
# 1114 "project/nginx/src/core/ngx_file.c"
               (buf.data);
    }

    if (data) {
        
# 1118 "project/nginx/src/core/ngx_file.c" 3 4
       free
# 1118 "project/nginx/src/core/ngx_file.c"
               (data);
        ctx->data = prev;
    }

    if (
# 1122 "project/nginx/src/core/ngx_file.c" 3 4
       closedir((
# 1122 "project/nginx/src/core/ngx_file.c"
       &dir
# 1122 "project/nginx/src/core/ngx_file.c" 3 4
       )->dir) 
# 1122 "project/nginx/src/core/ngx_file.c"
...
# 1123 "project/nginx/src/core/ngx_file.c" 3 4
       if ((
# 1123 "project/nginx/src/core/ngx_file.c"
       ctx->log
# 1123 "project/nginx/src/core/ngx_file.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 1123 "project/nginx/src/core/ngx_file.c"
...
# 1124 "project/nginx/src/core/ngx_file.c"
                                                                  ;
    }
