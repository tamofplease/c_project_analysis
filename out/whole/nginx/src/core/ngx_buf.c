# 0 "project/nginx/src/core/ngx_buf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/core/ngx_buf.c" 2
...
# 10 "project/nginx/src/core/ngx_buf.c" 2



# 12 "project/nginx/src/core/ngx_buf.c"
ngx_buf_t *
ngx_create_temp_buf(ngx_pool_t *pool, size_t size)
{
    ...
    b = 
# 17 "project/nginx/src/core/ngx_buf.c" 3 4
       ngx_pcalloc(
# 17 "project/nginx/src/core/ngx_buf.c"
       pool
# 17 "project/nginx/src/core/ngx_buf.c" 3 4
       , sizeof(ngx_buf_t))
# 17 "project/nginx/src/core/ngx_buf.c"
                           ;
    if (b == 
# 18 "project/nginx/src/core/ngx_buf.c" 3 4
            ((void *)0)
# 18 "project/nginx/src/core/ngx_buf.c"
                ) {
        return 
# 19 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 19 "project/nginx/src/core/ngx_buf.c"
                  ;
    }

    b->start = ngx_palloc(pool, size);
    if (b->start == 
# 23 "project/nginx/src/core/ngx_buf.c" 3 4
                   ((void *)0)
# 23 "project/nginx/src/core/ngx_buf.c"
                       ) {
        return 
# 24 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 24 "project/nginx/src/core/ngx_buf.c"
                  ;
    }
...
ngx_alloc_chain_link(ngx_pool_t *pool)
{
    ...
    if (cl == 
# 60 "project/nginx/src/core/ngx_buf.c" 3 4
             ((void *)0)
# 60 "project/nginx/src/core/ngx_buf.c"
                 ) {
        return 
# 61 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 61 "project/nginx/src/core/ngx_buf.c"
                  ;
    }
...
ngx_create_chain_of_bufs(ngx_pool_t *pool, ngx_bufs_t *bufs)
{
    ...
    if (p == 
# 77 "project/nginx/src/core/ngx_buf.c" 3 4
            ((void *)0)
# 77 "project/nginx/src/core/ngx_buf.c"
                ) {
        return 
# 78 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 78 "project/nginx/src/core/ngx_buf.c"
                  ;
    }
    ...
    for (i = 0; i < bufs->num; i++) {
        ...
        b = 
# 85 "project/nginx/src/core/ngx_buf.c" 3 4
           ngx_pcalloc(
# 85 "project/nginx/src/core/ngx_buf.c"
           pool
# 85 "project/nginx/src/core/ngx_buf.c" 3 4
           , sizeof(ngx_buf_t))
# 85 "project/nginx/src/core/ngx_buf.c"
                               ;
        if (b == 
# 86 "project/nginx/src/core/ngx_buf.c" 3 4
                ((void *)0)
# 86 "project/nginx/src/core/ngx_buf.c"
                    ) {
            return 
# 87 "project/nginx/src/core/ngx_buf.c" 3 4
                  ((void *)0)
# 87 "project/nginx/src/core/ngx_buf.c"
                      ;
        }
# 102 "project/nginx/src/core/ngx_buf.c"
        ...
        if (cl == 
# 111 "project/nginx/src/core/ngx_buf.c" 3 4
                 ((void *)0)
# 111 "project/nginx/src/core/ngx_buf.c"
                     ) {
            return 
# 112 "project/nginx/src/core/ngx_buf.c" 3 4
                  ((void *)0)
# 112 "project/nginx/src/core/ngx_buf.c"
                      ;
        }
    ...
    *ll = 
# 120 "project/nginx/src/core/ngx_buf.c" 3 4
         ((void *)0)
# 120 "project/nginx/src/core/ngx_buf.c"
             ;
...
ngx_chain_add_copy(ngx_pool_t *pool, ngx_chain_t **chain, ngx_chain_t *in)
{
    ...
    while (in) {
        cl = ngx_alloc_chain_link(pool);
        if (cl == 
# 139 "project/nginx/src/core/ngx_buf.c" 3 4
                 ((void *)0)
# 139 "project/nginx/src/core/ngx_buf.c"
                     ) {
            *ll = 
# 140 "project/nginx/src/core/ngx_buf.c" 3 4
                 ((void *)0)
# 140 "project/nginx/src/core/ngx_buf.c"
                     ;
            return 
# 141 "project/nginx/src/core/ngx_buf.c" 3 4
                  -1
# 141 "project/nginx/src/core/ngx_buf.c"
                           ;
        }
    ...
    *ll = 
# 150 "project/nginx/src/core/ngx_buf.c" 3 4
         ((void *)0)
# 150 "project/nginx/src/core/ngx_buf.c"
             ;

    return 
# 152 "project/nginx/src/core/ngx_buf.c" 3 4
          0
# 152 "project/nginx/src/core/ngx_buf.c"
                ;
}
...
ngx_chain_get_free_buf(ngx_pool_t *p, ngx_chain_t **free)
{
    ...
    if (*free) {
        ...
        *free = cl->next;
        cl->next = 
# 164 "project/nginx/src/core/ngx_buf.c" 3 4
                  ((void *)0)
# 164 "project/nginx/src/core/ngx_buf.c"
                      ;
        return cl;
    }
    ...
    if (cl == 
# 169 "project/nginx/src/core/ngx_buf.c" 3 4
             ((void *)0)
# 169 "project/nginx/src/core/ngx_buf.c"
                 ) {
        return 
# 170 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 170 "project/nginx/src/core/ngx_buf.c"
                  ;
    }

    cl->buf = 
# 173 "project/nginx/src/core/ngx_buf.c" 3 4
             ngx_pcalloc(
# 173 "project/nginx/src/core/ngx_buf.c"
             p
# 173 "project/nginx/src/core/ngx_buf.c" 3 4
             , sizeof(ngx_buf_t))
# 173 "project/nginx/src/core/ngx_buf.c"
                              ;
    if (cl->buf == 
# 174 "project/nginx/src/core/ngx_buf.c" 3 4
                  ((void *)0)
# 174 "project/nginx/src/core/ngx_buf.c"
                      ) {
        return 
# 175 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 175 "project/nginx/src/core/ngx_buf.c"
                  ;
    }

    cl->next = 
# 178 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 178 "project/nginx/src/core/ngx_buf.c"
                  ;
    ...
    ngx_chain_t **out, ngx_buf_tag_t tag)
{
    ...
    if (*out) {
        if (*busy == 
# 191 "project/nginx/src/core/ngx_buf.c" 3 4
                    ((void *)0)
# 191 "project/nginx/src/core/ngx_buf.c"
                        ) {
            *busy = *out;
        ...
        *out = 
# 200 "project/nginx/src/core/ngx_buf.c" 3 4
              ((void *)0)
# 200 "project/nginx/src/core/ngx_buf.c"
                  ;
    }
...
# 208 "project/nginx/src/core/ngx_buf.c" 3 4
           (
# 208 "project/nginx/src/core/ngx_buf.c"
           cl
# 208 "project/nginx/src/core/ngx_buf.c" 3 4
           )->next = (
# 208 "project/nginx/src/core/ngx_buf.c"
...
# 208 "project/nginx/src/core/ngx_buf.c"
        ...
        if (
# 212 "project/nginx/src/core/ngx_buf.c" 3 4
           (((
# 212 "project/nginx/src/core/ngx_buf.c"
           cl->buf
# 212 "project/nginx/src/core/ngx_buf.c" 3 4
           )->temporary || (
# 212 "project/nginx/src/core/ngx_buf.c"
...
ngx_chain_update_sent(ngx_chain_t *in, off_t sent)
{
    ...
    for ( ; in; in = in->next) {
        ...
        if (
# 278 "project/nginx/src/core/ngx_buf.c" 3 4
           (((
# 278 "project/nginx/src/core/ngx_buf.c"
           in->buf
# 278 "project/nginx/src/core/ngx_buf.c" 3 4
           )->flush || (
# 278 "project/nginx/src/core/ngx_buf.c"
...
# 278 "project/nginx/src/core/ngx_buf.c"
        ...
        size = 
# 286 "project/nginx/src/core/ngx_buf.c" 3 4
              (((
# 286 "project/nginx/src/core/ngx_buf.c"
              in->buf
# 286 "project/nginx/src/core/ngx_buf.c" 3 4
              )->temporary || (
# 286 "project/nginx/src/core/ngx_buf.c"
...
# 286 "project/nginx/src/core/ngx_buf.c"
        ...
        if (sent >= size) {
            ...
            if (
# 291 "project/nginx/src/core/ngx_buf.c" 3 4
               ((
# 291 "project/nginx/src/core/ngx_buf.c"
               in->buf
# 291 "project/nginx/src/core/ngx_buf.c" 3 4
               )->temporary || (
# 291 "project/nginx/src/core/ngx_buf.c"
...
# 291 "project/nginx/src/core/ngx_buf.c"
        ...
        if (
# 302 "project/nginx/src/core/ngx_buf.c" 3 4
           ((
# 302 "project/nginx/src/core/ngx_buf.c"
           in->buf
# 302 "project/nginx/src/core/ngx_buf.c" 3 4
           )->temporary || (
# 302 "project/nginx/src/core/ngx_buf.c"
