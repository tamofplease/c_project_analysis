# 0 "project/nginx/src/core/ngx_string.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_string.h"
# 9 "project/nginx/src/core/ngx_string.h"
...
# 13 "project/nginx/src/core/ngx_string.h" 2
...
{
    (void) ngx_write_fd(2, text, ngx_strlen(text));
}
...
{
    (void) ngx_write_fd(1, text, ngx_strlen(text));
}
...
# 14 "project/nginx/src/core/ngx_string.h" 2



# 16 "project/nginx/src/core/ngx_string.h"
typedef struct {
    size_t len;
    u_char *data;
} ngx_str_t;
...
static 
# 67 "project/nginx/src/core/ngx_string.h" 3 4
      inline 
# 67 "project/nginx/src/core/ngx_string.h"
                 u_char *
ngx_strlchr(u_char *p, u_char *last, u_char c)
{
    ...
    return 
# 79 "project/nginx/src/core/ngx_string.h" 3 4
          ((void *)0)
# 79 "project/nginx/src/core/ngx_string.h"
              ;
}
...
# 106 "project/nginx/src/core/ngx_string.h"
#define ngx_memcpy(dst,src,n) (void) memcpy(dst, src, n)
#define ngx_cpymem(dst,src,n) (((u_char *) memcpy(dst, src, n)) + (n))
# 138 "project/nginx/src/core/ngx_string.h"
