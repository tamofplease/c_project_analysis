# 0 "project/nginx/src/core/ngx_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 10 "project/nginx/src/core/ngx_module.c" 2
...
# 11 "project/nginx/src/core/ngx_module.c" 2
...
# 16 "project/nginx/src/core/ngx_module.c"
...
ngx_preinit_modules(void)
{
    ...
    ngx_modules_n = i;
    ngx_max_module = ngx_modules_n + 128;

    return 
# 38 "project/nginx/src/core/ngx_module.c" 3 4
          0
# 38 "project/nginx/src/core/ngx_module.c"
                ;
}
...
ngx_cycle_modules(ngx_cycle_t *cycle)
{
    ...
    cycle->modules = ngx_pcalloc(cycle->pool, (ngx_max_module + 1)
                                              * sizeof(ngx_module_t *));
    if (cycle->modules == 
# 52 "project/nginx/src/core/ngx_module.c" 3 4
                         ((void *)0)
# 52 "project/nginx/src/core/ngx_module.c"
                             ) {
        return 
# 53 "project/nginx/src/core/ngx_module.c" 3 4
              -1
# 53 "project/nginx/src/core/ngx_module.c"
                       ;
    }

    
# 56 "project/nginx/src/core/ngx_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 56 "project/nginx/src/core/ngx_module.c"
   cycle->modules
# 56 "project/nginx/src/core/ngx_module.c" 3 4
   , 
# 56 "project/nginx/src/core/ngx_module.c"
...
# 57 "project/nginx/src/core/ngx_module.c"
                                                     ;

    cycle->modules_n = ngx_modules_n;

    return 
# 61 "project/nginx/src/core/ngx_module.c" 3 4
          0
# 61 "project/nginx/src/core/ngx_module.c"
                ;
}
...
# 72 "project/nginx/src/core/ngx_module.c" 3 4
                                                        0
# 72 "project/nginx/src/core/ngx_module.c"
                                                              ) {
                return 
# 73 "project/nginx/src/core/ngx_module.c" 3 4
                      -1
# 73 "project/nginx/src/core/ngx_module.c"
                               ;
            }
        }
    }
    ...
    return 
# 78 "project/nginx/src/core/ngx_module.c" 3 4
          0
# 78 "project/nginx/src/core/ngx_module.c"
                ;
}
...
ngx_count_modules(ngx_cycle_t *cycle, ngx_uint_t type)
{
    ...
    for (i = 0; cycle->modules[i]; i++) {
        ...
        if (module->ctx_index != 
# 100 "project/nginx/src/core/ngx_module.c" 3 4
                                (ngx_uint_t) -1
# 100 "project/nginx/src/core/ngx_module.c"
                                                      ) {
    ...
    char **order)
{
    ...
    if (cf->cycle->modules_n >= ngx_max_module) {
        ngx_conf_log_error(
# 165 "project/nginx/src/core/ngx_module.c" 3 4
                          1
# 165 "project/nginx/src/core/ngx_module.c"
                                       , cf, 0,
                           "too many modules loaded");
        return 
# 167 "project/nginx/src/core/ngx_module.c" 3 4
              -1
# 167 "project/nginx/src/core/ngx_module.c"
                       ;
    }

    if (module->version != 
# 170 "project/nginx/src/core/ngx_module.c" 3 4
                          1021005
# 170 "project/nginx/src/core/ngx_module.c"
                                       ) {
        ngx_conf_log_error(
# 171 "project/nginx/src/core/ngx_module.c" 3 4
                          1
# 171 "project/nginx/src/core/ngx_module.c"
                                       , cf, 0,
                           "module \"%V\" version %ui instead of %ui",
                           file, module->version, (ngx_uint_t) 
# 173 "project/nginx/src/core/ngx_module.c" 3 4
                                                              1021005
# 173 "project/nginx/src/core/ngx_module.c"
                                                                           );
        return 
# 174 "project/nginx/src/core/ngx_module.c" 3 4
              -1
# 174 "project/nginx/src/core/ngx_module.c"
                       ;
    }

    if (
# 177 "project/nginx/src/core/ngx_module.c" 3 4
       strcmp((const char *) 
# 177 "project/nginx/src/core/ngx_module.c"
       module->signature
# 177 "project/nginx/src/core/ngx_module.c" 3 4
       , (const char *) 
# 177 "project/nginx/src/core/ngx_module.c"
...
# 177 "project/nginx/src/core/ngx_module.c"
                                                           != 0) {
        ngx_conf_log_error(
# 178 "project/nginx/src/core/ngx_module.c" 3 4
                          1
# 178 "project/nginx/src/core/ngx_module.c"
                                       , cf, 0,
                           "module \"%V\" is not binary compatible",
                           file);
        return 
# 181 "project/nginx/src/core/ngx_module.c" 3 4
              -1
# 181 "project/nginx/src/core/ngx_module.c"
                       ;
    }

    for (m = 0; cf->cycle->modules[m]; m++) {
        if (
# 185 "project/nginx/src/core/ngx_module.c" 3 4
           strcmp((const char *) 
# 185 "project/nginx/src/core/ngx_module.c"
...
# 185 "project/nginx/src/core/ngx_module.c"
                                                                 == 0) {
            ngx_conf_log_error(
# 186 "project/nginx/src/core/ngx_module.c" 3 4
                              1
# 186 "project/nginx/src/core/ngx_module.c"
                                           , cf, 0,
                               "module \"%s\" is already loaded",
                               module->name);
            return 
# 189 "project/nginx/src/core/ngx_module.c" 3 4
                  -1
# 189 "project/nginx/src/core/ngx_module.c"
                           ;
        }
    }
    ...
    if (module->index == 
# 197 "project/nginx/src/core/ngx_module.c" 3 4
                        (ngx_uint_t) -1
# 197 "project/nginx/src/core/ngx_module.c"
                                              ) {
        module->index = ngx_module_index(cf->cycle);

        if (module->index >= ngx_max_module) {
            ngx_conf_log_error(
# 201 "project/nginx/src/core/ngx_module.c" 3 4
                              1
# 201 "project/nginx/src/core/ngx_module.c"
                                           , cf, 0,
                               "too many modules loaded");
            return 
# 203 "project/nginx/src/core/ngx_module.c" 3 4
                  -1
# 203 "project/nginx/src/core/ngx_module.c"
                           ;
        }
    }
    ...
    if (order) {
        for (i = 0; order[i]; i++) {
            if (
# 215 "project/nginx/src/core/ngx_module.c" 3 4
               strcmp((const char *) 
# 215 "project/nginx/src/core/ngx_module.c"
               order[i]
# 215 "project/nginx/src/core/ngx_module.c" 3 4
               , (const char *) 
# 215 "project/nginx/src/core/ngx_module.c"
...
# 215 "project/nginx/src/core/ngx_module.c"
        ...
        for ( ; order[i]; i++) {
            ...
            for (m = 0; m < before; m++) {
                if (
# 230 "project/nginx/src/core/ngx_module.c" 3 4
                   strcmp((const char *) 
# 230 "project/nginx/src/core/ngx_module.c"
                   cf->cycle->modules[m]->name
# 230 "project/nginx/src/core/ngx_module.c" 3 4
                   , (const char *) 
# 230 "project/nginx/src/core/ngx_module.c"
...
# 246 "project/nginx/src/core/ngx_module.c" 3 4
       (void) __builtin___memmove_chk (
# 246 "project/nginx/src/core/ngx_module.c"
...
# 248 "project/nginx/src/core/ngx_module.c"
                                                                            ;
    }
    ...
    if (module->type == 
# 254 "project/nginx/src/core/ngx_module.c" 3 4
                       0x45524F43
# 254 "project/nginx/src/core/ngx_module.c"
                                      ) {
# 263 "project/nginx/src/core/ngx_module.c"
        ...
        if (core_module->create_conf) {
            ...
            if (rv == 
# 267 "project/nginx/src/core/ngx_module.c" 3 4
                     ((void *)0)
# 267 "project/nginx/src/core/ngx_module.c"
                         ) {
                return 
# 268 "project/nginx/src/core/ngx_module.c" 3 4
                      -1
# 268 "project/nginx/src/core/ngx_module.c"
                               ;
            }
    ...
    return 
# 275 "project/nginx/src/core/ngx_module.c" 3 4
          0
# 275 "project/nginx/src/core/ngx_module.c"
                ;
}
