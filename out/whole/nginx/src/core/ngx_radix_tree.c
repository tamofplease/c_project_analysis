# 0 "project/nginx/src/core/ngx_radix_tree.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_radix_tree.c"
...
# 9 "project/nginx/src/core/ngx_radix_tree.c" 2
...
# 10 "project/nginx/src/core/ngx_radix_tree.c" 2



# 12 "project/nginx/src/core/ngx_radix_tree.c"
...
ngx_radix_tree_create(ngx_pool_t *pool, ngx_int_t preallocate)
{
    ...
    if (tree == 
# 22 "project/nginx/src/core/ngx_radix_tree.c" 3 4
               ((void *)0)
# 22 "project/nginx/src/core/ngx_radix_tree.c"
                   ) {
        return 
# 23 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              ((void *)0)
# 23 "project/nginx/src/core/ngx_radix_tree.c"
                  ;
    }

    tree->pool = pool;
    tree->free = 
# 27 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                ((void *)0)
# 27 "project/nginx/src/core/ngx_radix_tree.c"
                    ;
    tree->start = 
# 28 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                 ((void *)0)
# 28 "project/nginx/src/core/ngx_radix_tree.c"
                     ;
    tree->size = 0;

    tree->root = ngx_radix_alloc(tree);
    if (tree->root == 
# 32 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                     ((void *)0)
# 32 "project/nginx/src/core/ngx_radix_tree.c"
                         ) {
        return 
# 33 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              ((void *)0)
# 33 "project/nginx/src/core/ngx_radix_tree.c"
                  ;
    }

    tree->root->right = 
# 36 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                       ((void *)0)
# 36 "project/nginx/src/core/ngx_radix_tree.c"
                           ;
    tree->root->left = 
# 37 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                      ((void *)0)
# 37 "project/nginx/src/core/ngx_radix_tree.c"
                          ;
    tree->root->parent = 
# 38 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                        ((void *)0)
# 38 "project/nginx/src/core/ngx_radix_tree.c"
                            ;
    tree->root->value = 
# 39 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                       (uintptr_t) -1
# 39 "project/nginx/src/core/ngx_radix_tree.c"
                                         ;

    if (preallocate == 0) {
        return tree;
    }
# 62 "project/nginx/src/core/ngx_radix_tree.c"
    if (preallocate == -1) {
    ...
    while (preallocate--) {
        ...
        do {
            if (ngx_radix32tree_insert(tree, key, mask, 
# 91 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                                                       (uintptr_t) -1
# 91 "project/nginx/src/core/ngx_radix_tree.c"
                                                                         )
                != 
# 92 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  0
# 92 "project/nginx/src/core/ngx_radix_tree.c"
                        )
            {
                return 
# 94 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                      ((void *)0)
# 94 "project/nginx/src/core/ngx_radix_tree.c"
                          ;
            }
    ...
    uintptr_t value)
{
    ...
    while (bit & mask) {
        ...
        if (next == 
# 128 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                   ((void *)0)
# 128 "project/nginx/src/core/ngx_radix_tree.c"
                       ) {
            break;
        }
    ...
    if (next) {
        if (node->value != 
# 137 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 137 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            return 
# 138 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  -3
# 138 "project/nginx/src/core/ngx_radix_tree.c"
                          ;
        }

        node->value = value;
        return 
# 142 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              0
# 142 "project/nginx/src/core/ngx_radix_tree.c"
                    ;
    }
    ...
    while (bit & mask) {
        ...
        if (next == 
# 147 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                   ((void *)0)
# 147 "project/nginx/src/core/ngx_radix_tree.c"
                       ) {
            return 
# 148 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  -1
# 148 "project/nginx/src/core/ngx_radix_tree.c"
                           ;
        }

        next->right = 
# 151 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                     ((void *)0)
# 151 "project/nginx/src/core/ngx_radix_tree.c"
                         ;
        next->left = 
# 152 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                    ((void *)0)
# 152 "project/nginx/src/core/ngx_radix_tree.c"
                        ;
        next->parent = node;
        next->value = 
# 154 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                     (uintptr_t) -1
# 154 "project/nginx/src/core/ngx_radix_tree.c"
                                       ;
    ...
    return 
# 169 "project/nginx/src/core/ngx_radix_tree.c" 3 4
          0
# 169 "project/nginx/src/core/ngx_radix_tree.c"
                ;
}
...
ngx_radix32tree_delete(ngx_radix_tree_t *tree, uint32_t key, uint32_t mask)
{
    ...
    if (node == 
# 193 "project/nginx/src/core/ngx_radix_tree.c" 3 4
               ((void *)0)
# 193 "project/nginx/src/core/ngx_radix_tree.c"
                   ) {
        return 
# 194 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              -1
# 194 "project/nginx/src/core/ngx_radix_tree.c"
                       ;
    }

    if (node->right || node->left) {
        if (node->value != 
# 198 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 198 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            node->value = 
# 199 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                         (uintptr_t) -1
# 199 "project/nginx/src/core/ngx_radix_tree.c"
                                           ;
            return 
# 200 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  0
# 200 "project/nginx/src/core/ngx_radix_tree.c"
                        ;
        }

        return 
# 203 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              -1
# 203 "project/nginx/src/core/ngx_radix_tree.c"
                       ;
    }
    ...
    for ( ;; ) {
        if (node->parent->right == node) {
            node->parent->right = 
# 208 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                                 ((void *)0)
# 208 "project/nginx/src/core/ngx_radix_tree.c"
                                     ;

        } else {
            node->parent->left = 
# 211 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                                ((void *)0)
# 211 "project/nginx/src/core/ngx_radix_tree.c"
                                    ;
        }
        ...
        if (node->value != 
# 223 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 223 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            break;
        }

        if (node->parent == 
# 227 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                           ((void *)0)
# 227 "project/nginx/src/core/ngx_radix_tree.c"
                               ) {
            break;
        }
    }
    ...
    return 
# 232 "project/nginx/src/core/ngx_radix_tree.c" 3 4
          0
# 232 "project/nginx/src/core/ngx_radix_tree.c"
                ;
}
...
ngx_radix32tree_find(ngx_radix_tree_t *tree, uint32_t key)
{
    ...
    bit = 0x80000000;
    value = 
# 244 "project/nginx/src/core/ngx_radix_tree.c" 3 4
           (uintptr_t) -1
# 244 "project/nginx/src/core/ngx_radix_tree.c"
                             ;
    node = tree->root;

    while (node) {
        if (node->value != 
# 248 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 248 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            value = node->value;
        }
    ...
    uintptr_t value)
{
    ...
    while (bit & mask[i]) {
        ...
        if (next == 
# 290 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                   ((void *)0)
# 290 "project/nginx/src/core/ngx_radix_tree.c"
                       ) {
            break;
        }
    ...
    if (next) {
        if (node->value != 
# 307 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 307 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            return 
# 308 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  -3
# 308 "project/nginx/src/core/ngx_radix_tree.c"
                          ;
        }

        node->value = value;
        return 
# 312 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              0
# 312 "project/nginx/src/core/ngx_radix_tree.c"
                    ;
    }
    ...
    while (bit & mask[i]) {
        next = ngx_radix_alloc(tree);
        if (next == 
# 317 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                   ((void *)0)
# 317 "project/nginx/src/core/ngx_radix_tree.c"
                       ) {
            return 
# 318 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  -1
# 318 "project/nginx/src/core/ngx_radix_tree.c"
                           ;
        }

        next->right = 
# 321 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                     ((void *)0)
# 321 "project/nginx/src/core/ngx_radix_tree.c"
                         ;
        next->left = 
# 322 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                    ((void *)0)
# 322 "project/nginx/src/core/ngx_radix_tree.c"
                        ;
        next->parent = node;
        next->value = 
# 324 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                     (uintptr_t) -1
# 324 "project/nginx/src/core/ngx_radix_tree.c"
                                       ;
    ...
    return 
# 347 "project/nginx/src/core/ngx_radix_tree.c" 3 4
          0
# 347 "project/nginx/src/core/ngx_radix_tree.c"
                ;
}
...
ngx_radix128tree_delete(ngx_radix_tree_t *tree, u_char *key, u_char *mask)
{
    ...
    if (node == 
# 381 "project/nginx/src/core/ngx_radix_tree.c" 3 4
               ((void *)0)
# 381 "project/nginx/src/core/ngx_radix_tree.c"
                   ) {
        return 
# 382 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              -1
# 382 "project/nginx/src/core/ngx_radix_tree.c"
                       ;
    }

    if (node->right || node->left) {
        if (node->value != 
# 386 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 386 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            node->value = 
# 387 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                         (uintptr_t) -1
# 387 "project/nginx/src/core/ngx_radix_tree.c"
                                           ;
            return 
# 388 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  0
# 388 "project/nginx/src/core/ngx_radix_tree.c"
                        ;
        }

        return 
# 391 "project/nginx/src/core/ngx_radix_tree.c" 3 4
              -1
# 391 "project/nginx/src/core/ngx_radix_tree.c"
                       ;
    }
    ...
    for ( ;; ) {
        if (node->parent->right == node) {
            node->parent->right = 
# 396 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                                 ((void *)0)
# 396 "project/nginx/src/core/ngx_radix_tree.c"
                                     ;

        } else {
            node->parent->left = 
# 399 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                                ((void *)0)
# 399 "project/nginx/src/core/ngx_radix_tree.c"
                                    ;
        }
        ...
        if (node->value != 
# 411 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 411 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            break;
        }

        if (node->parent == 
# 415 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                           ((void *)0)
# 415 "project/nginx/src/core/ngx_radix_tree.c"
                               ) {
            break;
        }
    }
    ...
    return 
# 420 "project/nginx/src/core/ngx_radix_tree.c" 3 4
          0
# 420 "project/nginx/src/core/ngx_radix_tree.c"
                ;
}
...
ngx_radix128tree_find(ngx_radix_tree_t *tree, u_char *key)
{
    ...
    bit = 0x80;
    value = 
# 434 "project/nginx/src/core/ngx_radix_tree.c" 3 4
           (uintptr_t) -1
# 434 "project/nginx/src/core/ngx_radix_tree.c"
                             ;
    node = tree->root;

    while (node) {
        if (node->value != 
# 438 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          (uintptr_t) -1
# 438 "project/nginx/src/core/ngx_radix_tree.c"
                                            ) {
            value = node->value;
        }
...
ngx_radix_alloc(ngx_radix_tree_t *tree)
{
    ...
    if (tree->size < sizeof(ngx_radix_node_t)) {
        ...
        if (tree->start == 
# 476 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                          ((void *)0)
# 476 "project/nginx/src/core/ngx_radix_tree.c"
                              ) {
            return 
# 477 "project/nginx/src/core/ngx_radix_tree.c" 3 4
                  ((void *)0)
# 477 "project/nginx/src/core/ngx_radix_tree.c"
                      ;
        }
