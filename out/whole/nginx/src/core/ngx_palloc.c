# 0 "project/nginx/src/core/ngx_palloc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_palloc.c"
...
# 9 "project/nginx/src/core/ngx_palloc.c" 2
...
# 10 "project/nginx/src/core/ngx_palloc.c" 2



# 12 "project/nginx/src/core/ngx_palloc.c"
static 
# 12 "project/nginx/src/core/ngx_palloc.c" 3 4
      inline 
# 12 "project/nginx/src/core/ngx_palloc.c"
...
ngx_create_pool(size_t size, ngx_log_t *log)
{
    ...
    p = ngx_memalign(
# 23 "project/nginx/src/core/ngx_palloc.c" 3 4
                    16
# 23 "project/nginx/src/core/ngx_palloc.c"
                                      , size, log);
    if (p == 
# 24 "project/nginx/src/core/ngx_palloc.c" 3 4
            ((void *)0)
# 24 "project/nginx/src/core/ngx_palloc.c"
                ) {
        return 
# 25 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 25 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }
    ...
    p->d.next = 
# 30 "project/nginx/src/core/ngx_palloc.c" 3 4
               ((void *)0)
# 30 "project/nginx/src/core/ngx_palloc.c"
                   ;
    p->d.failed = 0;

    size = size - sizeof(ngx_pool_t);
    p->max = (size < 
# 34 "project/nginx/src/core/ngx_palloc.c" 3 4
                    (ngx_pagesize - 1)
# 34 "project/nginx/src/core/ngx_palloc.c"
                                           ) ? size : 
# 34 "project/nginx/src/core/ngx_palloc.c" 3 4
                                                      (ngx_pagesize - 1)
# 34 "project/nginx/src/core/ngx_palloc.c"
    ...
    p->current = p;
    p->chain = 
# 37 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 37 "project/nginx/src/core/ngx_palloc.c"
                  ;
    p->large = 
# 38 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 38 "project/nginx/src/core/ngx_palloc.c"
                  ;
    p->cleanup = 
# 39 "project/nginx/src/core/ngx_palloc.c" 3 4
                ((void *)0)
# 39 "project/nginx/src/core/ngx_palloc.c"
                    ;
    p->log = log;
...
# 83 "project/nginx/src/core/ngx_palloc.c"
    for (l = pool->large; l; l = l->next) {
        if (l->alloc) {
            
# 85 "project/nginx/src/core/ngx_palloc.c" 3 4
           free
# 85 "project/nginx/src/core/ngx_palloc.c"
                   (l->alloc);
        }
    }
...
# 90 "project/nginx/src/core/ngx_palloc.c" 3 4
       free
# 90 "project/nginx/src/core/ngx_palloc.c"
               (p);

        if (n == 
# 92 "project/nginx/src/core/ngx_palloc.c" 3 4
                ((void *)0)
# 92 "project/nginx/src/core/ngx_palloc.c"
                    ) {
            break;
        }
    }
...
# 107 "project/nginx/src/core/ngx_palloc.c" 3 4
           free
# 107 "project/nginx/src/core/ngx_palloc.c"
                   (l->alloc);
        }
    }
    ...
    pool->current = pool;
    pool->chain = 
# 117 "project/nginx/src/core/ngx_palloc.c" 3 4
                 ((void *)0)
# 117 "project/nginx/src/core/ngx_palloc.c"
                     ;
    pool->large = 
# 118 "project/nginx/src/core/ngx_palloc.c" 3 4
                 ((void *)0)
# 118 "project/nginx/src/core/ngx_palloc.c"
                     ;
}
...
static 
# 148 "project/nginx/src/core/ngx_palloc.c" 3 4
      inline 
# 148 "project/nginx/src/core/ngx_palloc.c"
                 void *
ngx_palloc_small(ngx_pool_t *pool, size_t size, ngx_uint_t align)
{
    ...
    do {
        ...
        if (align) {
            m = 
# 160 "project/nginx/src/core/ngx_palloc.c" 3 4
               (u_char *) (((uintptr_t) (
# 160 "project/nginx/src/core/ngx_palloc.c"
               m
# 160 "project/nginx/src/core/ngx_palloc.c" 3 4
               ) + ((uintptr_t) sizeof(unsigned long) - 1)) & ~((uintptr_t) sizeof(unsigned long) - 1))
# 160 "project/nginx/src/core/ngx_palloc.c"
                                              ;
        }
...
ngx_palloc_block(ngx_pool_t *pool, size_t size)
{
    ...
    m = ngx_memalign(
# 186 "project/nginx/src/core/ngx_palloc.c" 3 4
                    16
# 186 "project/nginx/src/core/ngx_palloc.c"
                                      , psize, pool->log);
    if (m == 
# 187 "project/nginx/src/core/ngx_palloc.c" 3 4
            ((void *)0)
# 187 "project/nginx/src/core/ngx_palloc.c"
                ) {
        return 
# 188 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 188 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }
    ...
    new->d.end = m + psize;
    new->d.next = 
# 194 "project/nginx/src/core/ngx_palloc.c" 3 4
                 ((void *)0)
# 194 "project/nginx/src/core/ngx_palloc.c"
                     ;
    new->d.failed = 0;

    m += sizeof(ngx_pool_data_t);
    m = 
# 198 "project/nginx/src/core/ngx_palloc.c" 3 4
       (u_char *) (((uintptr_t) (
# 198 "project/nginx/src/core/ngx_palloc.c"
       m
# 198 "project/nginx/src/core/ngx_palloc.c" 3 4
       ) + ((uintptr_t) sizeof(unsigned long) - 1)) & ~((uintptr_t) sizeof(unsigned long) - 1))
# 198 "project/nginx/src/core/ngx_palloc.c"
...
ngx_palloc_large(ngx_pool_t *pool, size_t size)
{
    ...
    if (p == 
# 221 "project/nginx/src/core/ngx_palloc.c" 3 4
            ((void *)0)
# 221 "project/nginx/src/core/ngx_palloc.c"
                ) {
        return 
# 222 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 222 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }
    ...
    for (large = pool->large; large; large = large->next) {
        if (large->alloc == 
# 228 "project/nginx/src/core/ngx_palloc.c" 3 4
                           ((void *)0)
# 228 "project/nginx/src/core/ngx_palloc.c"
                               ) {
            large->alloc = p;
            return p;
        }
    ...
    if (large == 
# 239 "project/nginx/src/core/ngx_palloc.c" 3 4
                ((void *)0)
# 239 "project/nginx/src/core/ngx_palloc.c"
                    ) {
        
# 240 "project/nginx/src/core/ngx_palloc.c" 3 4
       free
# 240 "project/nginx/src/core/ngx_palloc.c"
               (p);
        return 
# 241 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 241 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }
...
ngx_pmemalign(ngx_pool_t *pool, size_t size, size_t alignment)
{
    ...
    if (p == 
# 259 "project/nginx/src/core/ngx_palloc.c" 3 4
            ((void *)0)
# 259 "project/nginx/src/core/ngx_palloc.c"
                ) {
        return 
# 260 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 260 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }

    large = ngx_palloc_small(pool, sizeof(ngx_pool_large_t), 1);
    if (large == 
# 264 "project/nginx/src/core/ngx_palloc.c" 3 4
                ((void *)0)
# 264 "project/nginx/src/core/ngx_palloc.c"
                    ) {
        
# 265 "project/nginx/src/core/ngx_palloc.c" 3 4
       free
# 265 "project/nginx/src/core/ngx_palloc.c"
               (p);
        return 
# 266 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 266 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }
...
# 286 "project/nginx/src/core/ngx_palloc.c" 3 4
           free
# 286 "project/nginx/src/core/ngx_palloc.c"
                   (l->alloc);
            l->alloc = 
# 287 "project/nginx/src/core/ngx_palloc.c" 3 4
                      ((void *)0)
# 287 "project/nginx/src/core/ngx_palloc.c"
                          ;

            return 
# 289 "project/nginx/src/core/ngx_palloc.c" 3 4
                  0
# 289 "project/nginx/src/core/ngx_palloc.c"
                        ;
        }
    }

    return 
# 293 "project/nginx/src/core/ngx_palloc.c" 3 4
          -5
# 293 "project/nginx/src/core/ngx_palloc.c"
                      ;
}
...
# 304 "project/nginx/src/core/ngx_palloc.c" 3 4
       (void) __builtin___memset_chk (
# 304 "project/nginx/src/core/ngx_palloc.c"
       p
# 304 "project/nginx/src/core/ngx_palloc.c" 3 4
       , 0, 
# 304 "project/nginx/src/core/ngx_palloc.c"
...
ngx_pool_cleanup_add(ngx_pool_t *p, size_t size)
{
    ...
    if (c == 
# 317 "project/nginx/src/core/ngx_palloc.c" 3 4
            ((void *)0)
# 317 "project/nginx/src/core/ngx_palloc.c"
                ) {
        return 
# 318 "project/nginx/src/core/ngx_palloc.c" 3 4
              ((void *)0)
# 318 "project/nginx/src/core/ngx_palloc.c"
                  ;
    }
    ...
    if (size) {
        ...
        if (c->data == 
# 323 "project/nginx/src/core/ngx_palloc.c" 3 4
                      ((void *)0)
# 323 "project/nginx/src/core/ngx_palloc.c"
                          ) {
            return 
# 324 "project/nginx/src/core/ngx_palloc.c" 3 4
                  ((void *)0)
# 324 "project/nginx/src/core/ngx_palloc.c"
                      ;
        }

    } else {
        c->data = 
# 328 "project/nginx/src/core/ngx_palloc.c" 3 4
                 ((void *)0)
# 328 "project/nginx/src/core/ngx_palloc.c"
                     ;
    }

    c->handler = 
# 331 "project/nginx/src/core/ngx_palloc.c" 3 4
                ((void *)0)
# 331 "project/nginx/src/core/ngx_palloc.c"
                    ;
    c->next = p->cleanup;
    ...
    for (c = p->cleanup; c; c = c->next) {
        if (c->handler == ngx_pool_cleanup_file) {
            ...
            if (cf->fd == fd) {
                c->handler(cf);
                c->handler = 
# 355 "project/nginx/src/core/ngx_palloc.c" 3 4
                            ((void *)0)
# 355 "project/nginx/src/core/ngx_palloc.c"
                                ;
                return;
            }
        }
...
ngx_pool_cleanup_file(void *data)
{
    ...
    if (
# 371 "project/nginx/src/core/ngx_palloc.c" 3 4
       close
# 371 "project/nginx/src/core/ngx_palloc.c"
                     (c->fd) == 
# 371 "project/nginx/src/core/ngx_palloc.c" 3 4
                                -1
# 371 "project/nginx/src/core/ngx_palloc.c"
...
# 372 "project/nginx/src/core/ngx_palloc.c" 3 4
       if ((
# 372 "project/nginx/src/core/ngx_palloc.c"
       c->log
# 372 "project/nginx/src/core/ngx_palloc.c" 3 4
...
# 373 "project/nginx/src/core/ngx_palloc.c"
                                                                ;
    }
}
...
ngx_pool_delete_file(void *data)
{
    ...
    if (
# 388 "project/nginx/src/core/ngx_palloc.c" 3 4
       unlink((const char *) 
# 388 "project/nginx/src/core/ngx_palloc.c"
       c->name
# 388 "project/nginx/src/core/ngx_palloc.c" 3 4
       ) 
# 388 "project/nginx/src/core/ngx_palloc.c"
...
# 388 "project/nginx/src/core/ngx_palloc.c"
        ...
        err = 
# 389 "project/nginx/src/core/ngx_palloc.c" 3 4
             (*__error())
# 389 "project/nginx/src/core/ngx_palloc.c"
                      ;

        if (err != 
# 391 "project/nginx/src/core/ngx_palloc.c" 3 4
                  2
# 391 "project/nginx/src/core/ngx_palloc.c"
                            ) {
            
# 392 "project/nginx/src/core/ngx_palloc.c" 3 4
           if ((
# 392 "project/nginx/src/core/ngx_palloc.c"
           c->log
# 392 "project/nginx/src/core/ngx_palloc.c" 3 4
...
# 393 "project/nginx/src/core/ngx_palloc.c"
                                                                     ;
        }
    }

    if (
# 397 "project/nginx/src/core/ngx_palloc.c" 3 4
       close
# 397 "project/nginx/src/core/ngx_palloc.c"
                     (c->fd) == 
# 397 "project/nginx/src/core/ngx_palloc.c" 3 4
                                -1
# 397 "project/nginx/src/core/ngx_palloc.c"
...
# 398 "project/nginx/src/core/ngx_palloc.c" 3 4
       if ((
# 398 "project/nginx/src/core/ngx_palloc.c"
       c->log
# 398 "project/nginx/src/core/ngx_palloc.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 398 "project/nginx/src/core/ngx_palloc.c"
...
# 399 "project/nginx/src/core/ngx_palloc.c"
                                                                ;
    }
}
