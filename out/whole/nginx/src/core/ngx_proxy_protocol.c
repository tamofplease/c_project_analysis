# 0 "project/nginx/src/core/ngx_proxy_protocol.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 9 "project/nginx/src/core/ngx_proxy_protocol.c" 2
...
# 10 "project/nginx/src/core/ngx_proxy_protocol.c" 2
...
# 19 "project/nginx/src/core/ngx_proxy_protocol.c"
typedef struct {
    u_char signature[12];
...
ngx_proxy_protocol_read(ngx_connection_t *c, u_char *buf, u_char *last)
{
    ...
    if (len < 8 || 
# 69 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  strncmp((const char *) 
# 69 "project/nginx/src/core/ngx_proxy_protocol.c"
                  p
# 69 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  , (const char *) 
# 69 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 69 "project/nginx/src/core/ngx_proxy_protocol.c"
    ...
    if (len >= 7 && 
# 76 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                   strncmp((const char *) 
# 76 "project/nginx/src/core/ngx_proxy_protocol.c"
                   p
# 76 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                   , (const char *) 
# 76 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 76 "project/nginx/src/core/ngx_proxy_protocol.c"
    ...
    if (len < 5 || 
# 83 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  strncmp((const char *) 
# 83 "project/nginx/src/core/ngx_proxy_protocol.c"
                  p
# 83 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  , (const char *) 
# 83 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 83 "project/nginx/src/core/ngx_proxy_protocol.c"
    ...
    if (pp == 
# 92 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
             ((void *)0)
# 92 "project/nginx/src/core/ngx_proxy_protocol.c"
                 ) {
        return 
# 93 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 93 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }

    p = ngx_proxy_protocol_read_addr(c, p, last, &pp->src_addr);
    if (p == 
# 97 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
            ((void *)0)
# 97 "project/nginx/src/core/ngx_proxy_protocol.c"
                ) {
        goto invalid;
    }
    ...
    if (p == 
# 102 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
            ((void *)0)
# 102 "project/nginx/src/core/ngx_proxy_protocol.c"
                ) {
        goto invalid;
    }
    ...
    if (p == 
# 107 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
            ((void *)0)
# 107 "project/nginx/src/core/ngx_proxy_protocol.c"
                ) {
        goto invalid;
    }

    p = ngx_proxy_protocol_read_port(p, last, &pp->dst_port, 
# 111 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                                            (u_char) '\r'
# 111 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                              );
    if (p == 
# 112 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
            ((void *)0)
# 112 "project/nginx/src/core/ngx_proxy_protocol.c"
                ) {
        goto invalid;
    }
    ...
    if (*p++ != 
# 120 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
               (u_char) '\n'
# 120 "project/nginx/src/core/ngx_proxy_protocol.c"
                 ) {
        goto invalid;
    }
...
skip:
    ...
    for ( ; p < last - 1; p++) {
        if (p[0] == 
# 135 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                   (u_char) '\r' 
# 135 "project/nginx/src/core/ngx_proxy_protocol.c"
                      && p[1] == 
# 135 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                 (u_char) '\n'
# 135 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 142 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
   if ((
# 142 "project/nginx/src/core/ngx_proxy_protocol.c"
   c->log
# 142 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
...
# 142 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
   , 
# 142 "project/nginx/src/core/ngx_proxy_protocol.c"
   0, "broken header: \"%*s\"", (size_t) (last - buf), buf
# 142 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
   )
                                                                       
# 143 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                                      ;

    return 
# 145 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
          ((void *)0)
# 145 "project/nginx/src/core/ngx_proxy_protocol.c"
              ;
}
    ...
    ngx_str_t *addr)
{
    ...
    for ( ;; ) {
        if (p == last) {
            return 
# 160 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  ((void *)0)
# 160 "project/nginx/src/core/ngx_proxy_protocol.c"
                      ;
        }
        ...
        {
            return 
# 174 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  ((void *)0)
# 174 "project/nginx/src/core/ngx_proxy_protocol.c"
                      ;
        }
    }
    ...
    if (addr->data == 
# 181 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                     ((void *)0)
# 181 "project/nginx/src/core/ngx_proxy_protocol.c"
                         ) {
        return 
# 182 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 182 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }

    
# 185 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
   (void) __builtin___memcpy_chk (
# 185 "project/nginx/src/core/ngx_proxy_protocol.c"
   addr->data
# 185 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
   , 
# 185 "project/nginx/src/core/ngx_proxy_protocol.c"
    ...
    u_char sep)
{
    ...
    for ( ;; ) {
        if (p == last) {
            return 
# 204 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  ((void *)0)
# 204 "project/nginx/src/core/ngx_proxy_protocol.c"
                      ;
        }
    ...
    if (n < 0 || n > 65535) {
        return 
# 216 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 216 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }
...
ngx_proxy_protocol_write(ngx_connection_t *c, u_char *buf, u_char *last)
{
    ...
    if (last - buf < 
# 230 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                    107
# 230 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                 ) {
        return 
# 231 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 231 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }

    if (ngx_connection_local_sockaddr(c, 
# 234 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                        ((void *)0)
# 234 "project/nginx/src/core/ngx_proxy_protocol.c"
                                            , 0) != 
# 234 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                                    0
# 234 "project/nginx/src/core/ngx_proxy_protocol.c"
        ...
        return 
# 235 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 235 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }
    ...
    case 
# 240 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
        2
# 240 "project/nginx/src/core/ngx_proxy_protocol.c"
               :
        buf = 
# 241 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
             (((u_char *) __builtin___memcpy_chk (
# 241 "project/nginx/src/core/ngx_proxy_protocol.c"
             buf
# 241 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
             , 
# 241 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 241 "project/nginx/src/core/ngx_proxy_protocol.c"
    ...
    case 
# 245 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
        30
# 245 "project/nginx/src/core/ngx_proxy_protocol.c"
                :
        buf = 
# 246 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
             (((u_char *) __builtin___memcpy_chk (
# 246 "project/nginx/src/core/ngx_proxy_protocol.c"
             buf
# 246 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
             , 
# 246 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 246 "project/nginx/src/core/ngx_proxy_protocol.c"
    ...
    default:
        return 
# 251 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              (((u_char *) __builtin___memcpy_chk (
# 251 "project/nginx/src/core/ngx_proxy_protocol.c"
              buf
# 251 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              , 
# 251 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 252 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                          ;
    }
    ...
    *buf++ = ' ';
    ...
    return ngx_slprintf(buf, last, " %ui %ui" 
# 265 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                             "\r\n"
# 265 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                 , port, lport);
}
...
# 291 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       if ((
# 291 "project/nginx/src/core/ngx_proxy_protocol.c"
       c->log
# 291 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 291 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 291 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       , 
# 291 "project/nginx/src/core/ngx_proxy_protocol.c"
       0, "unknown PROXY protocol version: %ui", version
# 291 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       )
                                                                     
# 292 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                                    ;
        return 
# 293 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 293 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }

    len = ((header->len)[0] << 8 | (header->len)[1]);

    if ((size_t) (last - buf) < len) {
        
# 299 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       if ((
# 299 "project/nginx/src/core/ngx_proxy_protocol.c"
       c->log
# 299 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 299 "project/nginx/src/core/ngx_proxy_protocol.c"
...
# 299 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       , 
# 299 "project/nginx/src/core/ngx_proxy_protocol.c"
       0, "header is too large"
# 299 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       )
# 299 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                                   ;
        return 
# 300 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 300 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }
    ...
    pp = ngx_pcalloc(c->pool, sizeof(ngx_proxy_protocol_t));
    if (pp == 
# 325 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
             ((void *)0)
# 325 "project/nginx/src/core/ngx_proxy_protocol.c"
                 ) {
        return 
# 326 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 326 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }
    ...
    case 1:
        ...
        if ((size_t) (end - buf) < sizeof(ngx_proxy_protocol_inet_addrs_t)) {
            return 
# 336 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  ((void *)0)
# 336 "project/nginx/src/core/ngx_proxy_protocol.c"
                      ;
        }

        in = (ngx_proxy_protocol_inet_addrs_t *) buf;

        src_sockaddr.sockaddr_in.sin_family = 
# 341 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                             2
# 341 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                    ;
        src_sockaddr.sockaddr_in.sin_port = 0;
        
# 343 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       __builtin___memcpy_chk (
# 343 "project/nginx/src/core/ngx_proxy_protocol.c"
       &src_sockaddr.sockaddr_in.sin_addr
# 343 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       , 
# 343 "project/nginx/src/core/ngx_proxy_protocol.c"
       in->src_addr, 4
...
# 343 "project/nginx/src/core/ngx_proxy_protocol.c"
        ...
        dst_sockaddr.sockaddr_in.sin_family = 
# 345 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                             2
# 345 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                    ;
        dst_sockaddr.sockaddr_in.sin_port = 0;
        
# 347 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       __builtin___memcpy_chk (
# 347 "project/nginx/src/core/ngx_proxy_protocol.c"
       &dst_sockaddr.sockaddr_in.sin_addr
# 347 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       , 
# 347 "project/nginx/src/core/ngx_proxy_protocol.c"
       in->dst_addr, 4
...
# 347 "project/nginx/src/core/ngx_proxy_protocol.c"
        ...
        pp->src_port = ((in->src_port)[0] << 8 | (in->src_port)[1]);
        pp->dst_port = ((in->dst_port)[0] << 8 | (in->dst_port)[1]);
    ...
    case 2:
        ...
        if ((size_t) (end - buf) < sizeof(ngx_proxy_protocol_inet6_addrs_t)) {
            return 
# 363 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                  ((void *)0)
# 363 "project/nginx/src/core/ngx_proxy_protocol.c"
                      ;
        }

        in6 = (ngx_proxy_protocol_inet6_addrs_t *) buf;

        src_sockaddr.sockaddr_in6.sin6_family = 
# 368 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                               30
# 368 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                       ;
        src_sockaddr.sockaddr_in6.sin6_port = 0;
        
# 370 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       __builtin___memcpy_chk (
# 370 "project/nginx/src/core/ngx_proxy_protocol.c"
       &src_sockaddr.sockaddr_in6.sin6_addr
# 370 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       , 
# 370 "project/nginx/src/core/ngx_proxy_protocol.c"
       in6->src_addr, 16
...
# 370 "project/nginx/src/core/ngx_proxy_protocol.c"
        ...
        dst_sockaddr.sockaddr_in6.sin6_family = 
# 372 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                               30
# 372 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                       ;
        dst_sockaddr.sockaddr_in6.sin6_port = 0;
        
# 374 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       __builtin___memcpy_chk (
# 374 "project/nginx/src/core/ngx_proxy_protocol.c"
       &dst_sockaddr.sockaddr_in6.sin6_addr
# 374 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
       , 
# 374 "project/nginx/src/core/ngx_proxy_protocol.c"
       in6->dst_addr, 16
...
# 374 "project/nginx/src/core/ngx_proxy_protocol.c"
        ...
        pp->src_port = ((in6->src_port)[0] << 8 | (in6->src_port)[1]);
        pp->dst_port = ((in6->dst_port)[0] << 8 | (in6->dst_port)[1]);
    ...
    pp->src_addr.data = ngx_pnalloc(c->pool, 
# 394 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                            (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 394 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                               );
    if (pp->src_addr.data == 
# 395 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                            ((void *)0)
# 395 "project/nginx/src/core/ngx_proxy_protocol.c"
                                ) {
        return 
# 396 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 396 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }

    pp->src_addr.len = ngx_sock_ntop(&src_sockaddr.sockaddr, socklen,
                                     pp->src_addr.data, 
# 400 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                                       (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 400 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                                          , 0);

    pp->dst_addr.data = ngx_pnalloc(c->pool, 
# 402 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                            (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 402 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                               );
    if (pp->dst_addr.data == 
# 403 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                            ((void *)0)
# 403 "project/nginx/src/core/ngx_proxy_protocol.c"
                                ) {
        return 
# 404 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
              ((void *)0)
# 404 "project/nginx/src/core/ngx_proxy_protocol.c"
                  ;
    }

    pp->dst_addr.len = ngx_sock_ntop(&dst_sockaddr.sockaddr, socklen,
                                     pp->dst_addr.data, 
# 408 "project/nginx/src/core/ngx_proxy_protocol.c" 3 4
                                                       (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 408 "project/nginx/src/core/ngx_proxy_protocol.c"
                                                                          , 0);
