# 0 "project/nginx/src/core/ngx_hash.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/core/ngx_hash.h"
# 9 "project/nginx/src/core/ngx_hash.h"
...
# 13 "project/nginx/src/core/ngx_hash.h" 2
...
# 14 "project/nginx/src/core/ngx_hash.h" 2



# 16 "project/nginx/src/core/ngx_hash.h"
typedef struct {
    void *value;
    u_short len;
    u_char name[1];
