# 0 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 9 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 2
...
# 13 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 2



# 15 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
static u_char pop3_greeting[] = "+OK POP3 ready" 
# 24 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                 "\r\n"
# 24 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                     ;
static u_char pop3_ok[] = "+OK" 
# 25 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                "\r\n"
# 25 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                    ;
static u_char pop3_next[] = "+ " 
# 26 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                 "\r\n"
# 26 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                     ;
static u_char pop3_username[] = "+ VXNlcm5hbWU6" 
# 27 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                 "\r\n"
# 27 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                     ;
static u_char pop3_password[] = "+ UGFzc3dvcmQ6" 
# 28 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                 "\r\n"
# 28 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                     ;
static u_char pop3_invalid_command[] = "-ERR invalid command" 
# 29 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                              "\r\n"
# 29 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                                  ;
...
ngx_mail_pop3_init_session(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    pscf = 
# 39 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          (
# 39 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
          s
# 39 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          )->srv_conf[
# 39 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 39 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                               ;
    cscf = 
# 40 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          (
# 40 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
          s
# 40 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          )->srv_conf[
# 40 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 40 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    if (pscf->auth_methods
        & (
# 43 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          0x0008
# 43 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                    |
# 43 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                     0x0010
# 43 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 45 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                        0
# 45 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                              ) {
        ...
        if (s->out.data == 
# 51 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                          ((void *)0)
# 51 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                              ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
        ...
        p = 
# 56 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 56 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
           s->out.data
# 56 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
           , 
# 56 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 56 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
        ...
        *p++ = ' ';
        p = 
# 58 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 58 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
           p
# 58 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
           , 
# 58 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 63 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       (
# 63 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       &s->out
# 63 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->len = sizeof(
# 63 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 68 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   ngx_event_add_timer
# 68 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                (c->read, cscf->timeout);

    if (ngx_handle_read_event(c->read, 0) != 
# 70 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                            0
# 70 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                  ) {
...
# 89 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       if ((
# 89 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       c->log
# 89 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
...
# 89 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    if (s->buffer == 
# 97 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                    ((void *)0)
# 97 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                        ) {
        if (ngx_array_init(&s->args, c->pool, 2, sizeof(ngx_str_t))
            == 
# 99 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              -1
# 99 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                       )
        {
            ngx_mail_session_internal_server_error(s);
            return;
        ...
        if (s->buffer == 
# 106 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                        ((void *)0)
# 106 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                            ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
...
# 132 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       if ((
# 132 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       c->log
# 132 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 132 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 132 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    if (s->out.len) {
        ...
        if (ngx_handle_read_event(c->read, 0) != 
# 142 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                0
# 142 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                      ) {
            ngx_mail_close_connection(c);
            return;
        }
    ...
    if (rc == 
# 154 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
             -2
# 154 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                      ) {
        if (ngx_handle_read_event(c->read, 0) != 
# 155 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                0
# 155 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                      ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
    ...
    if (rc == 
# 163 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
             -1
# 163 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                      ) {
        return;
    }

    
# 167 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   (
# 167 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
   &s->out
# 167 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   )->len = sizeof(
# 167 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 167 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
   pop3_ok;
    ...
    if (rc == 
# 169 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
             0
# 169 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                   ) {
        switch (s->mail_state) {
        ...
        case ngx_pop3_start:
            ...
            case 
# 176 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                1
# 176 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                rc = ngx_mail_pop3_user(s, c);
                break;

            case 
# 180 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                3
# 180 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                rc = ngx_mail_pop3_capa(s, c, 1);
                break;

            case 
# 184 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                7
# 184 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                rc = ngx_mail_pop3_apop(s, c);
                break;

            case 
# 188 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                8
# 188 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                rc = ngx_mail_pop3_auth(s, c);
                break;

            case 
# 192 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                4
# 192 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                s->quit = 1;
                break;

            case 
# 196 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                5
# 196 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                break;

            case 
# 199 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                6
# 199 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
            ...
            default:
                rc = 
# 204 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                    20
# 204 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                  ;
                break;
            }
        ...
        case ngx_pop3_user:
            ...
            case 
# 214 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                2
# 214 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                rc = ngx_mail_pop3_pass(s, c);
                break;

            case 
# 218 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                3
# 218 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                rc = ngx_mail_pop3_capa(s, c, 0);
                break;

            case 
# 222 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                4
# 222 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                s->quit = 1;
                break;

            case 
# 226 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                5
# 226 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             :
                break;

            default:
                rc = 
# 230 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                    20
# 230 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                  ;
                break;
            }
...
# 243 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
           (
# 243 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
           &s->out
# 243 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
           )->len = sizeof(
# 243 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 243 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    case 
# 271 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        -4
# 271 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                :
        ngx_mail_auth(s, c);
        return;

    case 
# 275 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        -1
# 275 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                 :
        ngx_mail_session_internal_server_error(s);
        return;

    case 
# 279 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        20
# 279 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                      :
        s->mail_state = ngx_pop3_start;
        s->state = 0;

        
# 283 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       (
# 283 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       &s->out
# 283 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->len = sizeof(
# 283 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 283 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    case 
# 287 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        0
# 287 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
              :
        ...
        if (ngx_handle_read_event(c->read, 0) != 
# 300 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                0
# 300 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                      ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
...
ngx_mail_pop3_user(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (s->args.nelts != 1) {
        return 
# 321 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              20
# 321 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                            ;
    }
    ...
    if (s->login.data == 
# 327 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                        ((void *)0)
# 327 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                            ) {
        return 
# 328 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              -1
# 328 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                       ;
    }

    
# 331 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 331 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
   s->login.data
# 331 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   , 
# 331 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 331 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    return 
# 338 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          0
# 338 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                ;
}
...
ngx_mail_pop3_pass(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (s->args.nelts != 1) {
        return 
# 348 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              20
# 348 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                            ;
    }
    ...
    if (s->passwd.data == 
# 354 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                         ((void *)0)
# 354 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             ) {
        return 
# 355 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              -1
# 355 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                       ;
    }

    
# 358 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 358 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
   s->passwd.data
# 358 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   , 
# 358 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 358 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    return 
# 365 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          -4
# 365 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                  ;
}
...
ngx_mail_pop3_capa(ngx_mail_session_t *s, ngx_connection_t *c, ngx_int_t stls)
{
    ...
    pscf = 
# 374 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          (
# 374 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
          s
# 374 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          )->srv_conf[
# 374 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 374 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                               ;
# 396 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    s->out = pscf->capability;
    return 
# 397 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          0
# 397 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                ;
}
...
{
# 419 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    return 
# 419 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          20
# 419 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                        ;
}
...
ngx_mail_pop3_apop(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (s->args.nelts != 2) {
        return 
# 436 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              20
# 436 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                            ;
    }

    pscf = 
# 439 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          (
# 439 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
          s
# 439 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          )->srv_conf[
# 439 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 439 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    if (!(pscf->auth_methods & 
# 441 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                              0x0008
# 441 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                        )) {
        return 
# 442 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              20
# 442 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                            ;
    }
    ...
    s->login.data = ngx_pnalloc(c->pool, s->login.len);
    if (s->login.data == 
# 449 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                        ((void *)0)
# 449 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                            ) {
        return 
# 450 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              -1
# 450 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                       ;
    }

    
# 453 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 453 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
   s->login.data
# 453 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   , 
# 453 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 453 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    s->passwd.data = ngx_pnalloc(c->pool, s->passwd.len);
    if (s->passwd.data == 
# 457 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                         ((void *)0)
# 457 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                             ) {
        return 
# 458 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              -1
# 458 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                       ;
    }

    
# 461 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 461 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
   s->passwd.data
# 461 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
   , 
# 461 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 461 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    s->auth_method = 
# 466 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                    3
# 466 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                      ;

    return 
# 468 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          -4
# 468 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                  ;
}
...
ngx_mail_pop3_auth(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    pscf = 
# 484 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          (
# 484 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
          s
# 484 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
          )->srv_conf[
# 484 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 484 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    if (s->args.nelts == 0) {
        ...
        return 
# 490 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              0
# 490 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                    ;
    }
    ...
    case 
# 497 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        1
# 497 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                           :

        
# 499 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       (
# 499 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       &s->out
# 499 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->len = sizeof(
# 499 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 499 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       pop3_username;
        ...
        return 
# 502 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              0
# 502 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                    ;

    case 
# 504 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        2
# 504 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                    :

        
# 506 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       (
# 506 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       &s->out
# 506 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->len = sizeof(
# 506 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 506 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
    ...
    case 
# 511 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        0
# 511 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                           :

        
# 513 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       (
# 513 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       &s->out
# 513 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->len = sizeof(
# 513 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 513 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       pop3_next;
        ...
        return 
# 516 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              0
# 516 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                    ;

    case 
# 518 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        4
# 518 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                              :

        if (!(pscf->auth_methods & 
# 520 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                  0x0010
# 520 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                                )) {
            return 
# 521 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                  20
# 521 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                ;
        }

        if (ngx_mail_auth_cram_md5_salt(s, c, "+ ", 2) == 
# 524 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                                         0
# 524 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                               ) {
            s->mail_state = ngx_pop3_auth_cram_md5;
            return 
# 526 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                  0
# 526 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                        ;
        }

        return 
# 529 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              -1
# 529 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                       ;

    case 
# 531 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
        5
# 531 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                              :

        if (!(pscf->auth_methods & 
# 533 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                                  0x0020
# 533 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                                )) {
            return 
# 534 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
                  20
# 534 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                                                ;
        }

        
# 537 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       (
# 537 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       &s->out
# 537 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
       )->len = sizeof(
# 537 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
...
# 537 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
       pop3_username;
        ...
        return 
# 540 "project/nginx/src/mail/ngx_mail_pop3_handler.c" 3 4
              0
# 540 "project/nginx/src/mail/ngx_mail_pop3_handler.c"
                    ;
    }
