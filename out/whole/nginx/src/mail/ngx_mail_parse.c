# 0 "project/nginx/src/mail/ngx_mail_parse.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 9 "project/nginx/src/mail/ngx_mail_parse.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_parse.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_parse.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail_parse.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_pop3_module.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_pop3_module.h" 3 4
...
# 13 "project/nginx/src/mail/ngx_mail_parse.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_imap_module.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_imap_module.h" 3 4
...
# 14 "project/nginx/src/mail/ngx_mail_parse.c" 2
...
# 15 "project/nginx/src/mail/ngx_mail_parse.c" 2



# 17 "project/nginx/src/mail/ngx_mail_parse.c"
ngx_int_t
ngx_mail_pop3_parse_command(ngx_mail_session_t *s)
{
    ...
    for (p = s->buffer->pos; p < s->buffer->last; p++) {
        ...
        case sw_command:
            if (ch == ' ' || ch == 
# 46 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                  (u_char) '\r' 
# 46 "project/nginx/src/mail/ngx_mail_parse.c"
                                     || ch == 
# 46 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                              (u_char) '\n'
# 46 "project/nginx/src/mail/ngx_mail_parse.c"
                ...
                if (p - c == 4) {
                    ...
                    c0 = 
# 51 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 51 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[0] 
# 51 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 51 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 51 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
                    c1 = 
# 52 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 52 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[1] 
# 52 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 52 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 52 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
                    c2 = 
# 53 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 53 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[2] 
# 53 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 53 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 53 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
                    c3 = 
# 54 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 54 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[3] 
# 54 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 54 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 54 "project/nginx/src/mail/ngx_mail_parse.c"
                    ...
                    {
                        s->command = 
# 58 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    1
# 58 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'P' && c1 == 'A' && c2 == 'S' && c3 == 'S')
                    {
                        s->command = 
# 62 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    2
# 62 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'A' && c1 == 'P' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = 
# 66 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    7
# 66 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'Q' && c1 == 'U' && c2 == 'I' && c3 == 'T')
                    {
                        s->command = 
# 70 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    4
# 70 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'C' && c1 == 'A' && c2 == 'P' && c3 == 'A')
                    {
                        s->command = 
# 74 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    3
# 74 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'A' && c1 == 'U' && c2 == 'T' && c3 == 'H')
                    {
                        s->command = 
# 78 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    8
# 78 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'N' && c1 == 'O' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = 
# 82 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    5
# 82 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;
                ...
                case ' ':
                    ...
                    break;
                case 
# 103 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\r'
# 103 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    state = sw_almost_done;
                    break;
                case 
# 106 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\n'
# 106 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    goto done;
                }
                break;
        ...
        case sw_spaces_before_argument:
            ...
            case ' ':
                break;
            case 
# 125 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 125 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 128 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 128 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            default:
                if (s->args.nelts <= 2) {
        ...
        case sw_argument:
            ...
            case ' ':
                ...
                if (s->command == 
# 150 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                 1
                    
# 151 "project/nginx/src/mail/ngx_mail_parse.c"
                   || s->command == 
# 151 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    2
# 151 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 )
                {
            ...
            case 
# 158 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 158 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
            case 
# 159 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 159 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                arg = ngx_array_push(&s->args);
                if (arg == 
# 161 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          ((void *)0)
# 161 "project/nginx/src/mail/ngx_mail_parse.c"
                              ) {
                    return 
# 162 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          -1
# 162 "project/nginx/src/mail/ngx_mail_parse.c"
                                   ;
                }
                arg->len = p - s->arg_start;
                arg->data = s->arg_start;
                s->arg_start = 
# 166 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                              ((void *)0)
# 166 "project/nginx/src/mail/ngx_mail_parse.c"
                                  ;
                ...
                case ' ':
                    ...
                    break;
                case 
# 172 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\r'
# 172 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    state = sw_almost_done;
                    break;
                case 
# 175 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\n'
# 175 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    goto done;
                }
                break;
        ...
        case sw_almost_done:
            switch (ch) {
            case 
# 187 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 187 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            default:
                goto invalid;
    ...
    return 
# 198 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          -2
# 198 "project/nginx/src/mail/ngx_mail_parse.c"
                   ;
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != 
# 203 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                             8
# 203 "project/nginx/src/mail/ngx_mail_parse.c"
                                          ) ? sw_start : sw_argument;

    return 
# 205 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          0
# 205 "project/nginx/src/mail/ngx_mail_parse.c"
                ;
...
invalid:
    ...
    for ( ; p < s->buffer->last; p++) {
        if (*p == 
# 214 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                 (u_char) '\n'
# 214 "project/nginx/src/mail/ngx_mail_parse.c"
                   ) {
            s->state = sw_start;
            s->buffer->pos = p + 1;
            return 
# 217 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                  20
# 217 "project/nginx/src/mail/ngx_mail_parse.c"
                                                ;
        }
    }
    ...
    return 
# 223 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          -2
# 223 "project/nginx/src/mail/ngx_mail_parse.c"
                   ;
}
    ...
    for (p = s->buffer->pos; p < s->buffer->last; p++) {
        ...
        case sw_tag:
            ...
            case ' ':
                ...
                break;
            case 
# 270 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 270 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
            case 
# 271 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 271 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto invalid;
            default:
                if ((ch < 'A' || ch > 'Z') && (ch < 'a' || ch > 'z')
        ...
        case sw_spaces_before_command:
            ...
            case ' ':
                break;
            case 
# 294 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 294 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
            case 
# 295 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 295 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto invalid;
            default:
                s->cmd_start = p;
        ...
        case sw_command:
            if (ch == ' ' || ch == 
# 305 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                  (u_char) '\r' 
# 305 "project/nginx/src/mail/ngx_mail_parse.c"
                                     || ch == 
# 305 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                              (u_char) '\n'
# 305 "project/nginx/src/mail/ngx_mail_parse.c"
                ...
                case 4:
                    ...
                    {
                        s->command = 
# 317 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    4
# 317 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;
                ...
                case 5:
                    ...
                    {
                        s->command = 
# 331 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    1
# 331 "project/nginx/src/mail/ngx_mail_parse.c"
                                                  ;
                ...
                case 6:
                    ...
                    {
                        s->command = 
# 346 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    2
# 346 "project/nginx/src/mail/ngx_mail_parse.c"
                                                   ;
                    ...
                    break;
# 372 "project/nginx/src/mail/ngx_mail_parse.c"
                case 10:
                    if ((c[0] == 'C'|| c[0] == 'c')
                        && (c[1] == 'A'|| c[1] == 'a')
                        && (c[2] == 'P'|| c[2] == 'p')
                    ...
                    {
                        s->command = 
# 384 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    3
# 384 "project/nginx/src/mail/ngx_mail_parse.c"
                                                       ;
                ...
                case 12:
                    ...
                    {
                        s->command = 
# 405 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    7
# 405 "project/nginx/src/mail/ngx_mail_parse.c"
                                                         ;
                ...
                case ' ':
                    ...
                    break;
                case 
# 423 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\r'
# 423 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    state = sw_almost_done;
                    break;
                case 
# 426 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\n'
# 426 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    goto done;
                }
                break;
        ...
        case sw_spaces_before_argument:
            ...
            case ' ':
                break;
            case 
# 442 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 442 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 445 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 445 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            case '"':
                if (s->args.nelts <= 2) {
        ...
        case sw_argument:
            ...
            case ' ':
            case 
# 484 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 484 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
            case 
# 485 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 485 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                arg = ngx_array_push(&s->args);
                if (arg == 
# 487 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          ((void *)0)
# 487 "project/nginx/src/mail/ngx_mail_parse.c"
                              ) {
                    return 
# 488 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          -1
# 488 "project/nginx/src/mail/ngx_mail_parse.c"
                                   ;
                }
                arg->len = p - s->arg_start;
                arg->data = s->arg_start;
                ...
                s->arg_start = 
# 508 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                              ((void *)0)
# 508 "project/nginx/src/mail/ngx_mail_parse.c"
                                  ;
                ...
                case ' ':
                    ...
                    break;
                case 
# 515 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\r'
# 515 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    state = sw_almost_done;
                    break;
                case 
# 518 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\n'
# 518 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    goto done;
                }
                break;
        ...
        case sw_backslash:
            switch (ch) {
            case 
# 533 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 533 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
            case 
# 534 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 534 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto invalid;
            default:
                state = sw_argument;
        ...
        case sw_start_literal_argument:
            switch (ch) {
            case 
# 566 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 566 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                break;
            case 
# 568 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 568 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                s->buffer->pos = p + 1;
                s->arg_start = p + 1;
                if (s->no_sync_literal == 0) {
                    ...
                    return 
# 573 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          6
# 573 "project/nginx/src/mail/ngx_mail_parse.c"
                                       ;
                }
        ...
        case sw_literal_argument:
            ...
            arg = ngx_array_push(&s->args);
            if (arg == 
# 589 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      ((void *)0)
# 589 "project/nginx/src/mail/ngx_mail_parse.c"
                          ) {
                return 
# 590 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      -1
# 590 "project/nginx/src/mail/ngx_mail_parse.c"
                               ;
            }
            arg->len = p + 1 - s->arg_start;
            arg->data = s->arg_start;
            s->arg_start = 
# 594 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          ((void *)0)
# 594 "project/nginx/src/mail/ngx_mail_parse.c"
                              ;
        ...
        case sw_end_literal_argument:
            ...
            case '{':
                ...
                goto invalid;
            case 
# 607 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 607 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 610 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 610 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            default:
                state = sw_spaces_before_argument;
        ...
        case sw_almost_done:
            switch (ch) {
            case 
# 620 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 620 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            default:
                goto invalid;
    ...
    return 
# 631 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          -2
# 631 "project/nginx/src/mail/ngx_mail_parse.c"
                   ;
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != 
# 636 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                             7
# 636 "project/nginx/src/mail/ngx_mail_parse.c"
                                                  ) ? sw_start : sw_argument;

    return 
# 638 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          0
# 638 "project/nginx/src/mail/ngx_mail_parse.c"
                ;
...
invalid:
    ...
    for ( ; p < s->buffer->last; p++) {
        if (*p == 
# 651 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                 (u_char) '\n'
# 651 "project/nginx/src/mail/ngx_mail_parse.c"
                   ) {
            s->state = sw_start;
            s->buffer->pos = p + 1;
            ...
            if ((size_t) (p - s->buffer->start) > sizeof("{1+}") - 1) {
                ...
                if (*p == 
# 660 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                         (u_char) '\r'
# 660 "project/nginx/src/mail/ngx_mail_parse.c"
                           ) {
                    p--;
                }
            ...
            return 
# 669 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                  20
# 669 "project/nginx/src/mail/ngx_mail_parse.c"
                                                ;
        }
    }
    ...
    return 
# 675 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          -2
# 675 "project/nginx/src/mail/ngx_mail_parse.c"
                   ;
}
...
ngx_mail_smtp_parse_command(ngx_mail_session_t *s)
{
    ...
    for (p = s->buffer->pos; p < s->buffer->last; p++) {
        ...
        case sw_command:
            if (ch == ' ' || ch == 
# 708 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                  (u_char) '\r' 
# 708 "project/nginx/src/mail/ngx_mail_parse.c"
                                     || ch == 
# 708 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                              (u_char) '\n'
# 708 "project/nginx/src/mail/ngx_mail_parse.c"
                ...
                if (p - c == 4) {
                    ...
                    c0 = 
# 713 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 713 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[0] 
# 713 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 713 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 713 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
                    c1 = 
# 714 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 714 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[1] 
# 714 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 714 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 714 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
                    c2 = 
# 715 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 715 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[2] 
# 715 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 715 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 715 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
                    c3 = 
# 716 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        (u_char) ((
# 716 "project/nginx/src/mail/ngx_mail_parse.c"
                        c[3] 
# 716 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                        >= 'a' && 
# 716 "project/nginx/src/mail/ngx_mail_parse.c"
...
# 716 "project/nginx/src/mail/ngx_mail_parse.c"
                    ...
                    {
                        s->command = 
# 720 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    1
# 720 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'E' && c1 == 'H' && c2 == 'L' && c3 == 'O')
                    {
                        s->command = 
# 724 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    2
# 724 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'Q' && c1 == 'U' && c2 == 'I' && c3 == 'T')
                    {
                        s->command = 
# 728 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    4
# 728 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'A' && c1 == 'U' && c2 == 'T' && c3 == 'H')
                    {
                        s->command = 
# 732 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    3
# 732 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'N' && c1 == 'O' && c2 == 'O' && c3 == 'P')
                    {
                        s->command = 
# 736 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    5
# 736 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'M' && c1 == 'A' && c2 == 'I' && c3 == 'L')
                    {
                        s->command = 
# 740 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    6
# 740 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'R' && c1 == 'S' && c2 == 'E' && c3 == 'T')
                    {
                        s->command = 
# 744 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    7
# 744 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'R' && c1 == 'C' && c2 == 'P' && c3 == 'T')
                    {
                        s->command = 
# 748 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    8
# 748 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'V' && c1 == 'R' && c2 == 'F' && c3 == 'Y')
                    {
                        s->command = 
# 752 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    10
# 752 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'E' && c1 == 'X' && c2 == 'P' && c3 == 'N')
                    {
                        s->command = 
# 756 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    11
# 756 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else if (c0 == 'H' && c1 == 'E' && c2 == 'L' && c3 == 'P')
                    {
                        s->command = 
# 760 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                                    12
# 760 "project/nginx/src/mail/ngx_mail_parse.c"
                                                 ;

                    } else {
                        goto invalid;
                    }
# 783 "project/nginx/src/mail/ngx_mail_parse.c"
                } else {
                    goto invalid;
                }
                ...
                case ' ':
                    ...
                    break;
                case 
# 794 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\r'
# 794 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    state = sw_almost_done;
                    break;
                case 
# 797 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\n'
# 797 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    goto done;
                }
                break;
        ...
        case sw_spaces_before_argument:
            ...
            case ' ':
                break;
            case 
# 816 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 816 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                state = sw_almost_done;
                break;
            case 
# 819 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 819 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            default:
                if (s->args.nelts <= 10) {
        ...
        case sw_argument:
            ...
            case ' ':
            case 
# 834 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\r'
# 834 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
            case 
# 835 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 835 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                arg = ngx_array_push(&s->args);
                if (arg == 
# 837 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          ((void *)0)
# 837 "project/nginx/src/mail/ngx_mail_parse.c"
                              ) {
                    return 
# 838 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                          -1
# 838 "project/nginx/src/mail/ngx_mail_parse.c"
                                   ;
                }
                arg->len = p - s->arg_start;
                arg->data = s->arg_start;
                s->arg_start = 
# 842 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                              ((void *)0)
# 842 "project/nginx/src/mail/ngx_mail_parse.c"
                                  ;
                ...
                case ' ':
                    ...
                    break;
                case 
# 848 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\r'
# 848 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    state = sw_almost_done;
                    break;
                case 
# 851 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                    (u_char) '\n'
# 851 "project/nginx/src/mail/ngx_mail_parse.c"
                      :
                    goto done;
                }
                break;
        ...
        case sw_almost_done:
            switch (ch) {
            case 
# 863 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                (u_char) '\n'
# 863 "project/nginx/src/mail/ngx_mail_parse.c"
                  :
                goto done;
            default:
                goto invalid;
    ...
    return 
# 874 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          -2
# 874 "project/nginx/src/mail/ngx_mail_parse.c"
                   ;
    ...
    s->buffer->pos = p + 1;
    s->state = (s->command != 
# 879 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                             3
# 879 "project/nginx/src/mail/ngx_mail_parse.c"
                                          ) ? sw_start : sw_argument;

    return 
# 881 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          0
# 881 "project/nginx/src/mail/ngx_mail_parse.c"
                ;
...
invalid:
    ...
    for ( ; p < s->buffer->last; p++) {
        if (*p == 
# 890 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                 (u_char) '\n'
# 890 "project/nginx/src/mail/ngx_mail_parse.c"
                   ) {
            s->state = sw_start;
            s->buffer->pos = p + 1;
            return 
# 893 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                  20
# 893 "project/nginx/src/mail/ngx_mail_parse.c"
                                                ;
        }
    }
    ...
    return 
# 899 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          -2
# 899 "project/nginx/src/mail/ngx_mail_parse.c"
                   ;
}
...
ngx_mail_auth_parse(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (s->args.nelts == 0) {
        return 
# 915 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
              20
# 915 "project/nginx/src/mail/ngx_mail_parse.c"
                                            ;
    }
    ...
    if (arg[0].len == 5) {
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "LOGIN", 5) == 0) {
            ...
            if (s->args.nelts == 1) {
                return 
# 925 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      1
# 925 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
            }

            if (s->args.nelts == 2) {
                return 
# 929 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      2
# 929 "project/nginx/src/mail/ngx_mail_parse.c"
                                                  ;
            }

            return 
# 932 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                  20
# 932 "project/nginx/src/mail/ngx_mail_parse.c"
                                                ;
        }
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "PLAIN", 5) == 0) {
            ...
            if (s->args.nelts == 1) {
                return 
# 938 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      0
# 938 "project/nginx/src/mail/ngx_mail_parse.c"
                                         ;
            }
        ...
        return 
# 946 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
              20
# 946 "project/nginx/src/mail/ngx_mail_parse.c"
                                            ;
    }
    ...
    if (arg[0].len == 8) {
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "CRAM-MD5", 8) == 0) {
            ...
            if (s->args.nelts != 1) {
                return 
# 954 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      20
# 954 "project/nginx/src/mail/ngx_mail_parse.c"
                                                    ;
            }

            return 
# 957 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                  4
# 957 "project/nginx/src/mail/ngx_mail_parse.c"
                                        ;
        }
        ...
        if (ngx_strncasecmp(arg[0].data, (u_char *) "EXTERNAL", 8) == 0) {
            ...
            if (s->args.nelts == 1) {
                return 
# 963 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
                      5
# 963 "project/nginx/src/mail/ngx_mail_parse.c"
                                            ;
            }
        ...
        return 
# 971 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
              20
# 971 "project/nginx/src/mail/ngx_mail_parse.c"
                                            ;
    }

    return 
# 974 "project/nginx/src/mail/ngx_mail_parse.c" 3 4
          20
# 974 "project/nginx/src/mail/ngx_mail_parse.c"
                                        ;
}
