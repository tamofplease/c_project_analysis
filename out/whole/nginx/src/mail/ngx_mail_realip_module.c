# 0 "project/nginx/src/mail/ngx_mail_realip_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 9 "project/nginx/src/mail/ngx_mail_realip_module.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_realip_module.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_realip_module.c" 2



# 13 "project/nginx/src/mail/ngx_mail_realip_module.c"
typedef struct {
    ngx_array_t *from;
...
static ngx_command_t ngx_mail_realip_commands[] = {
    ...
    { 
# 29 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
     { sizeof(
# 29 "project/nginx/src/mail/ngx_mail_realip_module.c"
     "set_real_ip_from"
# 29 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 29 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 30 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
     0x02000000
# 30 "project/nginx/src/mail/ngx_mail_realip_module.c"
                       |
# 30 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                        0x04000000
# 30 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 32 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 32 "project/nginx/src/mail/ngx_mail_realip_module.c"
                             ,
      0,
      
# 34 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
     ((void *)0) 
# 34 "project/nginx/src/mail/ngx_mail_realip_module.c"
          },

      
# 36 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 37 "project/nginx/src/mail/ngx_mail_realip_module.c"
};


static ngx_mail_module_t ngx_mail_realip_module_ctx = {
    
# 41 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 41 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,

    
# 43 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 43 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 44 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 44 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,

    ngx_mail_realip_create_srv_conf,
    ngx_mail_realip_merge_srv_conf
};


ngx_module_t ngx_mail_realip_module = {
    
# 52 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 52 "project/nginx/src/mail/ngx_mail_realip_module.c"
   "8" 
# 52 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   "," 
# 52 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 52 "project/nginx/src/mail/ngx_mail_realip_module.c"
                ,
    &ngx_mail_realip_module_ctx,
    ngx_mail_realip_commands,
    
# 55 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   0x4C49414D
# 55 "project/nginx/src/mail/ngx_mail_realip_module.c"
                  ,
    
# 56 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 56 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 57 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 57 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 58 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 58 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 59 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 60 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 61 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 61 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 62 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   ((void *)0)
# 62 "project/nginx/src/mail/ngx_mail_realip_module.c"
       ,
    
# 63 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 64 "project/nginx/src/mail/ngx_mail_realip_module.c"
};
...
ngx_mail_realip_handler(ngx_mail_session_t *s)
{
    ...
    rscf = 
# 74 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
          (
# 74 "project/nginx/src/mail/ngx_mail_realip_module.c"
          s
# 74 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
          )->srv_conf[
# 74 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 74 "project/nginx/src/mail/ngx_mail_realip_module.c"
    ...
    if (rscf->from == 
# 76 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                     ((void *)0)
# 76 "project/nginx/src/mail/ngx_mail_realip_module.c"
                         ) {
        return 
# 77 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              0
# 77 "project/nginx/src/mail/ngx_mail_realip_module.c"
                    ;
    }
    ...
    if (c->proxy_protocol == 
# 82 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                            ((void *)0)
# 82 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                ) {
        return 
# 83 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              0
# 83 "project/nginx/src/mail/ngx_mail_realip_module.c"
                    ;
    }

    if (ngx_cidr_match(c->sockaddr, rscf->from) != 
# 86 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                                                  0
# 86 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                                        ) {
        return 
# 87 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              0
# 87 "project/nginx/src/mail/ngx_mail_realip_module.c"
                    ;
    }
    ...
    if (ngx_parse_addr(c->pool, &addr, c->proxy_protocol->src_addr.data,
        ...
        != 
# 92 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
          0
# 92 "project/nginx/src/mail/ngx_mail_realip_module.c"
                )
    {
        return 
# 94 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              0
# 94 "project/nginx/src/mail/ngx_mail_realip_module.c"
                    ;
    }
...
ngx_mail_realip_set_addr(ngx_mail_session_t *s, ngx_addr_t *addr)
{
    ...
    u_char *p;
    u_char text[
# 108 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                           (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 108 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                              ];
    ngx_connection_t *c;
...
# 114 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                       (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 114 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                          , 0);
    if (len == 0) {
        return 
# 116 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              -1
# 116 "project/nginx/src/mail/ngx_mail_realip_module.c"
                       ;
    }

    p = ngx_pnalloc(c->pool, len);
    if (p == 
# 120 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
            ((void *)0)
# 120 "project/nginx/src/mail/ngx_mail_realip_module.c"
                ) {
        return 
# 121 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              -1
# 121 "project/nginx/src/mail/ngx_mail_realip_module.c"
                       ;
    }

    
# 124 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 124 "project/nginx/src/mail/ngx_mail_realip_module.c"
   p
# 124 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   , 
# 124 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 124 "project/nginx/src/mail/ngx_mail_realip_module.c"
    ...
    return 
# 131 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
          0
# 131 "project/nginx/src/mail/ngx_mail_realip_module.c"
                ;
}
...
ngx_mail_realip_from(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (rscf->from == 
# 152 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                     ((void *)0)
# 152 "project/nginx/src/mail/ngx_mail_realip_module.c"
                         ) {
        rscf->from = ngx_array_create(cf->pool, 2,
                                      sizeof(ngx_cidr_t));
        if (rscf->from == 
# 155 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                         ((void *)0)
# 155 "project/nginx/src/mail/ngx_mail_realip_module.c"
                             ) {
            return 
# 156 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                  (void *) -1
# 156 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                ;
        }
    }
    ...
    if (
# 162 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
       strcmp((const char *) 
# 162 "project/nginx/src/mail/ngx_mail_realip_module.c"
       value[1].data
# 162 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
       , (const char *) 
# 162 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 162 "project/nginx/src/mail/ngx_mail_realip_module.c"
        ...
        if (cidr == 
# 164 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                   ((void *)0)
# 164 "project/nginx/src/mail/ngx_mail_realip_module.c"
                       ) {
            return 
# 165 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                  (void *) -1
# 165 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                ;
        }

        cidr->family = 
# 168 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                      1
# 168 "project/nginx/src/mail/ngx_mail_realip_module.c"
                             ;
        return 
# 169 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              ((void *)0)
# 169 "project/nginx/src/mail/ngx_mail_realip_module.c"
                         ;
    }
    ...
    if (rc != 
# 176 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
             -1
# 176 "project/nginx/src/mail/ngx_mail_realip_module.c"
                      ) {
        if (rc == 
# 177 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                 -4
# 177 "project/nginx/src/mail/ngx_mail_realip_module.c"
                         ) {
            ngx_conf_log_error(
# 178 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                              5
# 178 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                          , cf, 0,
        ...
        cidr = ngx_array_push(rscf->from);
        if (cidr == 
# 184 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                   ((void *)0)
# 184 "project/nginx/src/mail/ngx_mail_realip_module.c"
                       ) {
            return 
# 185 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                  (void *) -1
# 185 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                ;
        }
        ...
        *cidr = c;
        ...
        return 
# 190 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              ((void *)0)
# 190 "project/nginx/src/mail/ngx_mail_realip_module.c"
                         ;
    }

    
# 193 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   (void) __builtin___memset_chk (
# 193 "project/nginx/src/mail/ngx_mail_realip_module.c"
   &u
# 193 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   , 0, 
# 193 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 196 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                                              0
# 196 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                                    ) {
        if (u.err) {
            ngx_conf_log_error(
# 198 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                              1
# 198 "project/nginx/src/mail/ngx_mail_realip_module.c"
                                           , cf, 0,
        ...
        return 
# 203 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              (void *) -1
# 203 "project/nginx/src/mail/ngx_mail_realip_module.c"
                            ;
    }

    cidr = ngx_array_push_n(rscf->from, u.naddrs);
    if (cidr == 
# 207 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
               ((void *)0)
# 207 "project/nginx/src/mail/ngx_mail_realip_module.c"
                   ) {
        return 
# 208 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              (void *) -1
# 208 "project/nginx/src/mail/ngx_mail_realip_module.c"
                            ;
    }

    
# 211 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   (void) __builtin___memset_chk (
# 211 "project/nginx/src/mail/ngx_mail_realip_module.c"
   cidr
# 211 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
   , 0, 
# 211 "project/nginx/src/mail/ngx_mail_realip_module.c"
...
# 211 "project/nginx/src/mail/ngx_mail_realip_module.c"
    ...
    for (i = 0; i < u.naddrs; i++) {
        ...
        case 
# 219 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
            30
# 219 "project/nginx/src/mail/ngx_mail_realip_module.c"
                    :
            sin6 = (struct sockaddr_in6 *) u.addrs[i].sockaddr;
            cidr[i].u.in6.addr = sin6->sin6_addr;
            
# 222 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
           (void) __builtin___memset_chk (
# 222 "project/nginx/src/mail/ngx_mail_realip_module.c"
           cidr[i].u.in6.mask.
# 222 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
...
# 222 "project/nginx/src/mail/ngx_mail_realip_module.c"
    ...
    return 
# 234 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
          ((void *)0)
# 234 "project/nginx/src/mail/ngx_mail_realip_module.c"
                     ;
}
...
ngx_mail_realip_create_srv_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 244 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
               ((void *)0)
# 244 "project/nginx/src/mail/ngx_mail_realip_module.c"
                   ) {
        return 
# 245 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
              ((void *)0)
# 245 "project/nginx/src/mail/ngx_mail_realip_module.c"
                  ;
    }
...
ngx_mail_realip_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->from == 
# 264 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
                     ((void *)0)
# 264 "project/nginx/src/mail/ngx_mail_realip_module.c"
                         ) {
        conf->from = prev->from;
    }

    return 
# 268 "project/nginx/src/mail/ngx_mail_realip_module.c" 3 4
          ((void *)0)
# 268 "project/nginx/src/mail/ngx_mail_realip_module.c"
                     ;
}
