# 0 "project/nginx/src/mail/ngx_mail_smtp_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 9 "project/nginx/src/mail/ngx_mail_smtp_module.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_smtp_module.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_smtp_module.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail_smtp_module.c" 2
...
# 13 "project/nginx/src/mail/ngx_mail_smtp_module.c" 2



# 15 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
static ngx_conf_bitmask_t ngx_mail_smtp_auth_methods[] = {
    { 
# 21 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 21 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "plain"
# 21 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 21 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 21 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    { 
# 22 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 22 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "login"
# 22 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 22 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 22 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    { 
# 23 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 23 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "cram-md5"
# 23 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 23 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 23 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    { 
# 24 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 24 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "external"
# 24 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 24 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 24 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    { 
# 25 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 25 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "none"
# 25 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 25 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 25 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    { 
# 26 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { 0, ((void *)0) }
# 26 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                    , 0 }
};
...
# 31 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 31 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "PLAIN"
# 31 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ) - 1, (u_char *) 
# 31 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 32 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 32 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "LOGIN"
# 32 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ) - 1, (u_char *) 
# 32 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 33 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { 0, ((void *)0) }
# 33 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                  ,
    
# 34 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 34 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "CRAM-MD5"
# 34 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ) - 1, (u_char *) 
# 34 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 35 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 35 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "EXTERNAL"
# 35 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ) - 1, (u_char *) 
# 35 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 36 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { 0, ((void *)0) }

# 37 "project/nginx/src/mail/ngx_mail_smtp_module.c"
};


static ngx_mail_protocol_t ngx_mail_smtp_protocol = {
    
# 41 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 41 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "smtp"
# 41 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ) - 1, (u_char *) 
# 41 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 42 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 42 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "\x04smtp"
# 42 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ) - 1, (u_char *) 
# 42 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 44 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   2
# 44 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                         ,
...
# 51 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 51 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 52 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 52 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "421 4.7.1 SSL certificate error" 
# 52 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   "\r\n") - 1, (u_char *) 
# 52 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "421 4.7.1 SSL certificate error" 
...
# 53 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   { sizeof(
# 53 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "421 4.7.1 No required SSL certificate" 
# 53 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   "\r\n") - 1, (u_char *) 
# 53 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "421 4.7.1 No required SSL certificate" 
...
# 54 "project/nginx/src/mail/ngx_mail_smtp_module.c"
};
...
static ngx_command_t ngx_mail_smtp_commands[] = {
    ...
    { 
# 59 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 59 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "smtp_client_buffer"
# 59 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 59 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 60 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     0x02000000
# 60 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                       |
# 60 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                        0x04000000
# 60 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 62 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 62 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                             ,
      
# 63 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (
# 63 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     ngx_mail_smtp_srv_conf_t
# 63 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     , 
# 63 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 64 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ((void *)0) 
# 64 "project/nginx/src/mail/ngx_mail_smtp_module.c"
          },

    { 
# 66 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 66 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "smtp_greeting_delay"
# 66 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 66 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 67 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     0x02000000
# 67 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                       |
# 67 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                        0x04000000
# 67 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 69 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 69 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                             ,
      
# 70 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (
# 70 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     ngx_mail_smtp_srv_conf_t
# 70 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     , 
# 70 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 71 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ((void *)0) 
# 71 "project/nginx/src/mail/ngx_mail_smtp_module.c"
          },

    { 
# 73 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 73 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "smtp_capabilities"
# 73 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 73 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 74 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     0x02000000
# 74 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                       |
# 74 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                        0x04000000
# 74 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 76 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 76 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                             ,
      
# 77 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (
# 77 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     ngx_mail_smtp_srv_conf_t
# 77 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     , 
# 77 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 78 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ((void *)0) 
# 78 "project/nginx/src/mail/ngx_mail_smtp_module.c"
          },

    { 
# 80 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { sizeof(
# 80 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     "smtp_auth"
# 80 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     ) - 1, (u_char *) 
# 80 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 81 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     0x02000000
# 81 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                       |
# 81 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                        0x04000000
# 81 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 83 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 83 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                             ,
      
# 84 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     __builtin_offsetof (
# 84 "project/nginx/src/mail/ngx_mail_smtp_module.c"
     ngx_mail_smtp_srv_conf_t
# 84 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     , 
# 84 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 87 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 88 "project/nginx/src/mail/ngx_mail_smtp_module.c"
};
...
# 94 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 94 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 95 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 95 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,

    ngx_mail_smtp_create_srv_conf,
    ngx_mail_smtp_merge_srv_conf
};


ngx_module_t ngx_mail_smtp_module = {
    
# 103 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 103 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   "8" 
# 103 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   "," 
# 103 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 103 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ,
    &ngx_mail_smtp_module_ctx,
    ngx_mail_smtp_commands,
    
# 106 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   0x4C49414D
# 106 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                  ,
    
# 107 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 107 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 108 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 108 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 109 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 109 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 110 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 110 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 111 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 112 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 112 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 113 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   ((void *)0)
# 113 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       ,
    
# 114 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 115 "project/nginx/src/mail/ngx_mail_smtp_module.c"
};
...
ngx_mail_smtp_create_srv_conf(ngx_conf_t *cf)
{
    ...
    if (sscf == 
# 124 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
               ((void *)0)
# 124 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                   ) {
        return 
# 125 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              ((void *)0)
# 125 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                  ;
    }

    sscf->client_buffer_size = 
# 128 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                              (size_t) -1
# 128 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                 ;
    sscf->greeting_delay = 
# 129 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                          (ngx_msec_t) -1
# 129 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                             ;

    if (ngx_array_init(&sscf->capabilities, cf->pool, 4, sizeof(ngx_str_t))
        != 
# 132 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
          0
# 132 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                )
    {
        return 
# 134 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              ((void *)0)
# 134 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                  ;
    }
...
# 153 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   if (
# 153 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   conf->client_buffer_size 
# 153 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   == (size_t) -1) { 
# 153 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   conf->client_buffer_size 
...
# 155 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                   ;

    
# 157 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   if (
# 157 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   conf->greeting_delay 
# 157 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 157 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 158 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                     ;

    
# 160 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   if (
# 160 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   conf->auth_methods 
# 160 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   == 0) { 
# 160 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 164 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                            ;


    cscf = 
# 167 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
          ((ngx_mail_conf_ctx_t *) 
# 167 "project/nginx/src/mail/ngx_mail_smtp_module.c"
          cf
# 167 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
          ->ctx)->srv_conf[
# 167 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 167 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    size = sizeof("220  ESMTP ready" 
# 169 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                                    "\r\n"
# 169 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                        ) - 1 + cscf->server_name.len;

    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 172 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
            ((void *)0)
# 172 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ) {
        return 
# 173 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (void *) -1
# 173 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                            ;
    }
    ...
    *p++ = '2'; *p++ = '2'; *p++ = '0'; *p++ = ' ';
    p = 
# 180 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 180 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       p
# 180 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       , 
# 180 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 181 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 181 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   p
# 181 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   , 
# 181 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 181 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    size = sizeof("250 " 
# 184 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                        "\r\n"
# 184 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                            ) - 1 + cscf->server_name.len;

    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 187 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
            ((void *)0)
# 187 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ) {
        return 
# 188 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (void *) -1
# 188 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                            ;
    }
    ...
    *p++ = '2'; *p++ = '5'; *p++ = '0'; *p++ = ' ';
    p = 
# 195 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 195 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       p
# 195 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       , 
# 195 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 195 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                                   ;
    *p++ = 
# 196 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
          (u_char) '\r'
# 196 "project/nginx/src/mail/ngx_mail_smtp_module.c"
            ; *p = 
# 196 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                   (u_char) '\n'
# 196 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    size = sizeof("250-") - 1 + cscf->server_name.len + sizeof(
# 203 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                                                              "\r\n"
# 203 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                                  ) - 1;

    c = conf->capabilities.elts;
    for (i = 0; i < conf->capabilities.nelts; i++) {
        size += sizeof("250 ") - 1 + c[i].len + sizeof(
# 207 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                                                      "\r\n"
# 207 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                          ) - 1;
    }
    ...
    for (m = 
# 212 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
            0x0002
# 212 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                       , i = 0;
         m <= 
# 213 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
             0x0020
# 213 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                           ;
         m <<= 1, i++)
    {
    ...
    if (auth_enabled) {
        size += sizeof("250 AUTH") - 1 + sizeof(
# 223 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                                               "\r\n"
# 223 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                   ) - 1;
    }

    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 227 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
            ((void *)0)
# 227 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ) {
        return 
# 228 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (void *) -1
# 228 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                            ;
    }
    ...
    *p++ = '2'; *p++ = '5'; *p++ = '0'; *p++ = '-';
    p = 
# 237 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 237 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       p
# 237 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       , 
# 237 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 237 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                                   ;
    *p++ = 
# 238 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
          (u_char) '\r'
# 238 "project/nginx/src/mail/ngx_mail_smtp_module.c"
            ; *p++ = 
# 238 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                     (u_char) '\n'
# 238 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    for (i = 0; i < conf->capabilities.nelts; i++) {
        ...
        *p++ = '2'; *p++ = '5'; *p++ = '0'; *p++ = '-';
        p = 
# 243 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 243 "project/nginx/src/mail/ngx_mail_smtp_module.c"
           p
# 243 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
           , 
# 243 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 243 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                             ;
        *p++ = 
# 244 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (u_char) '\r'
# 244 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ; *p++ = 
# 244 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                         (u_char) '\n'
# 244 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    if (auth_enabled) {
        ...
        *p++ = 'A'; *p++ = 'U'; *p++ = 'T'; *p++ = 'H';
        ...
        for (m = 
# 255 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                0x0002
# 255 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                           , i = 0;
             m <= 
# 256 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                 0x0020
# 256 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                               ;
             m <<= 1, i++)
        {
            if (m & conf->auth_methods) {
                *p++ = ' ';
                p = 
# 261 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                   (((u_char *) __builtin___memcpy_chk (
# 261 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                   p
# 261 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                   , 
# 261 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                   ngx_mail_smtp_auth_methods_names[i].data
# 261 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                   , 
# 261 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 262 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                                                      ;
            }
        }

        *p++ = 
# 266 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (u_char) '\r'
# 266 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ; *p = 
# 266 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                       (u_char) '\n'
# 266 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    size += sizeof("250 STARTTLS" 
# 272 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                                 "\r\n"
# 272 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                     ) - 1;

    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 275 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
            ((void *)0)
# 275 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ) {
        return 
# 276 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (void *) -1
# 276 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                            ;
    }
    ...
    p = 
# 282 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 282 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       p
# 282 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       , 
# 282 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 284 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 284 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   p
# 284 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   , 
# 284 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 284 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    *p = '-';
    ...
    size = (auth - conf->capability.data)
            + sizeof("250 STARTTLS" 
# 291 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
                                   "\r\n"
# 291 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                                       ) - 1;

    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 294 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
            ((void *)0)
# 294 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                ) {
        return 
# 295 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
              (void *) -1
# 295 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                            ;
    }
    ...
    p = 
# 301 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 301 "project/nginx/src/mail/ngx_mail_smtp_module.c"
       p
# 301 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
       , 
# 301 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 303 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 303 "project/nginx/src/mail/ngx_mail_smtp_module.c"
   p
# 303 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
   , 
# 303 "project/nginx/src/mail/ngx_mail_smtp_module.c"
...
# 303 "project/nginx/src/mail/ngx_mail_smtp_module.c"
    ...
    return 
# 311 "project/nginx/src/mail/ngx_mail_smtp_module.c" 3 4
          ((void *)0)
# 311 "project/nginx/src/mail/ngx_mail_smtp_module.c"
                     ;
}
