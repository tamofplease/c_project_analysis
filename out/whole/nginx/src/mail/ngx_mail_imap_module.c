# 0 "project/nginx/src/mail/ngx_mail_imap_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 9 "project/nginx/src/mail/ngx_mail_imap_module.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_imap_module.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_imap_module.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail_imap_module.c" 2
...
# 13 "project/nginx/src/mail/ngx_mail_imap_module.c" 2



# 15 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 21 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 21 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "IMAP4"
# 21 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 21 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 22 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 22 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "IMAP4rev1"
# 22 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 22 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 23 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 23 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "UIDPLUS"
# 23 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 23 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 24 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { 0, ((void *)0) }

# 25 "project/nginx/src/mail/ngx_mail_imap_module.c"
};


static ngx_conf_bitmask_t ngx_mail_imap_auth_methods[] = {
    { 
# 29 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 29 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "plain"
# 29 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 29 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 29 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    { 
# 30 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 30 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "login"
# 30 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 30 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 30 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    { 
# 31 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 31 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "cram-md5"
# 31 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 31 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 31 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    { 
# 32 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 32 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "external"
# 32 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 32 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 32 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    { 
# 33 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { 0, ((void *)0) }
# 33 "project/nginx/src/mail/ngx_mail_imap_module.c"
                    , 0 }
};
...
# 38 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 38 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "AUTH=PLAIN"
# 38 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 38 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 39 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 39 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "AUTH=LOGIN"
# 39 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 39 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 40 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { 0, ((void *)0) }
# 40 "project/nginx/src/mail/ngx_mail_imap_module.c"
                  ,
    
# 41 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 41 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "AUTH=CRAM-MD5"
# 41 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 41 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 42 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 42 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "AUTH=EXTERNAL"
# 42 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 42 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 43 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { 0, ((void *)0) }

# 44 "project/nginx/src/mail/ngx_mail_imap_module.c"
};


static ngx_mail_protocol_t ngx_mail_imap_protocol = {
    
# 48 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 48 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "imap"
# 48 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 48 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 49 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 49 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "\x04imap"
# 49 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ) - 1, (u_char *) 
# 49 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 51 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   1
# 51 "project/nginx/src/mail/ngx_mail_imap_module.c"
                         ,
...
# 58 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 58 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 59 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 59 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "* BYE SSL certificate error" 
# 59 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   "\r\n") - 1, (u_char *) 
# 59 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "* BYE SSL certificate error" 
...
# 60 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   { sizeof(
# 60 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "* BYE No required SSL certificate" 
# 60 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   "\r\n") - 1, (u_char *) 
# 60 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "* BYE No required SSL certificate" 
...
# 61 "project/nginx/src/mail/ngx_mail_imap_module.c"
};
...
static ngx_command_t ngx_mail_imap_commands[] = {
    ...
    { 
# 66 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 66 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "imap_client_buffer"
# 66 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 66 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 67 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     0x02000000
# 67 "project/nginx/src/mail/ngx_mail_imap_module.c"
                       |
# 67 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                        0x04000000
# 67 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 69 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 69 "project/nginx/src/mail/ngx_mail_imap_module.c"
                             ,
      
# 70 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     __builtin_offsetof (
# 70 "project/nginx/src/mail/ngx_mail_imap_module.c"
     ngx_mail_imap_srv_conf_t
# 70 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     , 
# 70 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 71 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ((void *)0) 
# 71 "project/nginx/src/mail/ngx_mail_imap_module.c"
          },

    { 
# 73 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 73 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "imap_capabilities"
# 73 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 73 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 74 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     0x02000000
# 74 "project/nginx/src/mail/ngx_mail_imap_module.c"
                       |
# 74 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                        0x04000000
# 74 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 76 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 76 "project/nginx/src/mail/ngx_mail_imap_module.c"
                             ,
      
# 77 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     __builtin_offsetof (
# 77 "project/nginx/src/mail/ngx_mail_imap_module.c"
     ngx_mail_imap_srv_conf_t
# 77 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     , 
# 77 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 78 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ((void *)0) 
# 78 "project/nginx/src/mail/ngx_mail_imap_module.c"
          },

    { 
# 80 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { sizeof(
# 80 "project/nginx/src/mail/ngx_mail_imap_module.c"
     "imap_auth"
# 80 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     ) - 1, (u_char *) 
# 80 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 81 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     0x02000000
# 81 "project/nginx/src/mail/ngx_mail_imap_module.c"
                       |
# 81 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                        0x04000000
# 81 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 83 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     __builtin_offsetof (ngx_mail_conf_ctx_t, srv_conf)
# 83 "project/nginx/src/mail/ngx_mail_imap_module.c"
                             ,
      
# 84 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     __builtin_offsetof (
# 84 "project/nginx/src/mail/ngx_mail_imap_module.c"
     ngx_mail_imap_srv_conf_t
# 84 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     , 
# 84 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 87 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 88 "project/nginx/src/mail/ngx_mail_imap_module.c"
};
...
# 94 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 94 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 95 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 95 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,

    ngx_mail_imap_create_srv_conf,
    ngx_mail_imap_merge_srv_conf
};


ngx_module_t ngx_mail_imap_module = {
    
# 103 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 103 "project/nginx/src/mail/ngx_mail_imap_module.c"
   "8" 
# 103 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   "," 
# 103 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 103 "project/nginx/src/mail/ngx_mail_imap_module.c"
                ,
    &ngx_mail_imap_module_ctx,
    ngx_mail_imap_commands,
    
# 106 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   0x4C49414D
# 106 "project/nginx/src/mail/ngx_mail_imap_module.c"
                  ,
    
# 107 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 107 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 108 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 108 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 109 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 109 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 110 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 110 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 111 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 112 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 112 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 113 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   ((void *)0)
# 113 "project/nginx/src/mail/ngx_mail_imap_module.c"
       ,
    
# 114 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 115 "project/nginx/src/mail/ngx_mail_imap_module.c"
};
...
ngx_mail_imap_create_srv_conf(ngx_conf_t *cf)
{
    ...
    if (iscf == 
# 124 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
               ((void *)0)
# 124 "project/nginx/src/mail/ngx_mail_imap_module.c"
                   ) {
        return 
# 125 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
              ((void *)0)
# 125 "project/nginx/src/mail/ngx_mail_imap_module.c"
                  ;
    }

    iscf->client_buffer_size = 
# 128 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                              (size_t) -1
# 128 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                 ;

    if (ngx_array_init(&iscf->capabilities, cf->pool, 4, sizeof(ngx_str_t))
        != 
# 131 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
          0
# 131 "project/nginx/src/mail/ngx_mail_imap_module.c"
                )
    {
        return 
# 133 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
              ((void *)0)
# 133 "project/nginx/src/mail/ngx_mail_imap_module.c"
                  ;
    }
...
# 151 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   if (
# 151 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 153 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                   ;

    
# 155 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   if (
# 155 "project/nginx/src/mail/ngx_mail_imap_module.c"
   conf->auth_methods 
# 155 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
   == 0) { 
# 155 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 158 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                            ;
    ...
    if (conf->capabilities.nelts == 0) {
        ...
        for (d = ngx_mail_imap_default_capabilities; d->len; d++) {
            ...
            if (c == 
# 169 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                    ((void *)0)
# 169 "project/nginx/src/mail/ngx_mail_imap_module.c"
                        ) {
                return 
# 170 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                      (void *) -1
# 170 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                    ;
            }
...
# 177 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                                "\r\n"
# 177 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                    ) - 1;
    ...
    for (m = 
# 184 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
            0x0002
# 184 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                       , i = 0;
         m <= 
# 185 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
             0x0020
# 185 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                           ;
         m <<= 1, i++)
    {
    ...
    if (p == 
# 194 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
            ((void *)0)
# 194 "project/nginx/src/mail/ngx_mail_imap_module.c"
                ) {
        return 
# 195 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
              (void *) -1
# 195 "project/nginx/src/mail/ngx_mail_imap_module.c"
                            ;
    }
    ...
    p = 
# 201 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 201 "project/nginx/src/mail/ngx_mail_imap_module.c"
       p
# 201 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       , 
# 201 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 201 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    for (i = 0; i < conf->capabilities.nelts; i++) {
        *p++ = ' ';
        p = 
# 205 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 205 "project/nginx/src/mail/ngx_mail_imap_module.c"
           p
# 205 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
           , 
# 205 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 205 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    for (m = 
# 210 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
            0x0002
# 210 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                       , i = 0;
         m <= 
# 211 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
             0x0020
# 211 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                           ;
         m <<= 1, i++)
    {
        if (m & conf->auth_methods) {
            *p++ = ' ';
            p = 
# 216 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 216 "project/nginx/src/mail/ngx_mail_imap_module.c"
               p
# 216 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
               , 
# 216 "project/nginx/src/mail/ngx_mail_imap_module.c"
               ngx_mail_imap_auth_methods_names[i].data
# 216 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
               , 
# 216 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 217 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                                  ;
        }
    }

    *p++ = 
# 221 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
          (u_char) '\r'
# 221 "project/nginx/src/mail/ngx_mail_imap_module.c"
            ; *p = 
# 221 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                   (u_char) '\n'
# 221 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 227 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
            ((void *)0)
# 227 "project/nginx/src/mail/ngx_mail_imap_module.c"
                ) {
        return 
# 228 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
              (void *) -1
# 228 "project/nginx/src/mail/ngx_mail_imap_module.c"
                            ;
    }
    ...
    p = 
# 234 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 234 "project/nginx/src/mail/ngx_mail_imap_module.c"
       p
# 234 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       , 
# 234 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 235 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                            ;
    p = 
# 236 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 236 "project/nginx/src/mail/ngx_mail_imap_module.c"
       p
# 236 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       , 
# 236 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 236 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                          ;
    *p++ = 
# 237 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
          (u_char) '\r'
# 237 "project/nginx/src/mail/ngx_mail_imap_module.c"
            ; *p = 
# 237 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                   (u_char) '\n'
# 237 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    size = (auth - conf->capability.data) + sizeof(
# 240 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                                                  "\r\n"
# 240 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                      ) - 1
            + sizeof(" STARTTLS LOGINDISABLED") - 1;

    p = ngx_pnalloc(cf->pool, size);
    if (p == 
# 244 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
            ((void *)0)
# 244 "project/nginx/src/mail/ngx_mail_imap_module.c"
                ) {
        return 
# 245 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
              (void *) -1
# 245 "project/nginx/src/mail/ngx_mail_imap_module.c"
                            ;
    }
    ...
    p = 
# 251 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 251 "project/nginx/src/mail/ngx_mail_imap_module.c"
       p
# 251 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       , 
# 251 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 252 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                               ;
    p = 
# 253 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 253 "project/nginx/src/mail/ngx_mail_imap_module.c"
       p
# 253 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
       , 
# 253 "project/nginx/src/mail/ngx_mail_imap_module.c"
...
# 254 "project/nginx/src/mail/ngx_mail_imap_module.c"
                                                        ;
    *p++ = 
# 255 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
          (u_char) '\r'
# 255 "project/nginx/src/mail/ngx_mail_imap_module.c"
            ; *p = 
# 255 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
                   (u_char) '\n'
# 255 "project/nginx/src/mail/ngx_mail_imap_module.c"
    ...
    return 
# 257 "project/nginx/src/mail/ngx_mail_imap_module.c" 3 4
          ((void *)0)
# 257 "project/nginx/src/mail/ngx_mail_imap_module.c"
                     ;
}
