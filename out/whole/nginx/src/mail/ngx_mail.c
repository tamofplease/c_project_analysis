# 0 "project/nginx/src/mail/ngx_mail.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/mail/ngx_mail.c"
...
# 9 "project/nginx/src/mail/ngx_mail.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail.c" 2



# 14 "project/nginx/src/mail/ngx_mail.c"
...
static ngx_command_t ngx_mail_commands[] = {
    ...
    { 
# 32 "project/nginx/src/mail/ngx_mail.c" 3 4
     { sizeof(
# 32 "project/nginx/src/mail/ngx_mail.c"
     "mail"
# 32 "project/nginx/src/mail/ngx_mail.c" 3 4
     ) - 1, (u_char *) 
# 32 "project/nginx/src/mail/ngx_mail.c"
...
# 33 "project/nginx/src/mail/ngx_mail.c" 3 4
     0x01000000
# 33 "project/nginx/src/mail/ngx_mail.c"
                  |
# 33 "project/nginx/src/mail/ngx_mail.c" 3 4
                   0x00000100
# 33 "project/nginx/src/mail/ngx_mail.c"
...
# 37 "project/nginx/src/mail/ngx_mail.c" 3 4
     ((void *)0) 
# 37 "project/nginx/src/mail/ngx_mail.c"
          },

      
# 39 "project/nginx/src/mail/ngx_mail.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 40 "project/nginx/src/mail/ngx_mail.c"
};


static ngx_core_module_t ngx_mail_module_ctx = {
    
# 44 "project/nginx/src/mail/ngx_mail.c" 3 4
   { sizeof(
# 44 "project/nginx/src/mail/ngx_mail.c"
   "mail"
# 44 "project/nginx/src/mail/ngx_mail.c" 3 4
   ) - 1, (u_char *) 
# 44 "project/nginx/src/mail/ngx_mail.c"
...
# 45 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 45 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 46 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)

# 47 "project/nginx/src/mail/ngx_mail.c"
};


ngx_module_t ngx_mail_module = {
    
# 51 "project/nginx/src/mail/ngx_mail.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 51 "project/nginx/src/mail/ngx_mail.c"
   "8" 
# 51 "project/nginx/src/mail/ngx_mail.c" 3 4
   "," 
# 51 "project/nginx/src/mail/ngx_mail.c"
...
# 54 "project/nginx/src/mail/ngx_mail.c" 3 4
   0x45524F43
# 54 "project/nginx/src/mail/ngx_mail.c"
                  ,
    
# 55 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 55 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 56 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 56 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 57 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 57 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 58 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 58 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 59 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 60 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 61 "project/nginx/src/mail/ngx_mail.c" 3 4
   ((void *)0)
# 61 "project/nginx/src/mail/ngx_mail.c"
       ,
    
# 62 "project/nginx/src/mail/ngx_mail.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 63 "project/nginx/src/mail/ngx_mail.c"
};
...
ngx_mail_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ctx == 
# 86 "project/nginx/src/mail/ngx_mail.c" 3 4
              ((void *)0)
# 86 "project/nginx/src/mail/ngx_mail.c"
                  ) {
        return 
# 87 "project/nginx/src/mail/ngx_mail.c" 3 4
              (void *) -1
# 87 "project/nginx/src/mail/ngx_mail.c"
                            ;
    }
    ...
    *(ngx_mail_conf_ctx_t **) conf = ctx;
    ...
    ngx_mail_max_module = ngx_count_modules(cf->cycle, 
# 94 "project/nginx/src/mail/ngx_mail.c" 3 4
                                                      0x4C49414D
# 94 "project/nginx/src/mail/ngx_mail.c"
                                                                     );
    ...
    if (ctx->main_conf == 
# 101 "project/nginx/src/mail/ngx_mail.c" 3 4
                         ((void *)0)
# 101 "project/nginx/src/mail/ngx_mail.c"
                             ) {
        return 
# 102 "project/nginx/src/mail/ngx_mail.c" 3 4
              (void *) -1
# 102 "project/nginx/src/mail/ngx_mail.c"
                            ;
    }
    ...
    if (ctx->srv_conf == 
# 112 "project/nginx/src/mail/ngx_mail.c" 3 4
                        ((void *)0)
# 112 "project/nginx/src/mail/ngx_mail.c"
                            ) {
        return 
# 113 "project/nginx/src/mail/ngx_mail.c" 3 4
              (void *) -1
# 113 "project/nginx/src/mail/ngx_mail.c"
                            ;
    }
...
# 122 "project/nginx/src/mail/ngx_mail.c" 3 4
                                          0x4C49414D
# 122 "project/nginx/src/mail/ngx_mail.c"
                                                         ) {
            continue;
        }
        ...
        if (module->create_main_conf) {
            ...
            if (ctx->main_conf[mi] == 
# 131 "project/nginx/src/mail/ngx_mail.c" 3 4
                                     ((void *)0)
# 131 "project/nginx/src/mail/ngx_mail.c"
                                         ) {
                return 
# 132 "project/nginx/src/mail/ngx_mail.c" 3 4
                      (void *) -1
# 132 "project/nginx/src/mail/ngx_mail.c"
                                    ;
            }
        }
        ...
        if (module->create_srv_conf) {
            ...
            if (ctx->srv_conf[mi] == 
# 138 "project/nginx/src/mail/ngx_mail.c" 3 4
                                    ((void *)0)
# 138 "project/nginx/src/mail/ngx_mail.c"
                                        ) {
                return 
# 139 "project/nginx/src/mail/ngx_mail.c" 3 4
                      (void *) -1
# 139 "project/nginx/src/mail/ngx_mail.c"
                                    ;
            }
        }
    }
    ...
    cf->module_type = 
# 150 "project/nginx/src/mail/ngx_mail.c" 3 4
                     0x4C49414D
# 150 "project/nginx/src/mail/ngx_mail.c"
                                    ;
    cf->cmd_type = 
# 151 "project/nginx/src/mail/ngx_mail.c" 3 4
                  0x02000000
# 151 "project/nginx/src/mail/ngx_mail.c"
                                    ;
    rv = ngx_conf_parse(cf, 
# 152 "project/nginx/src/mail/ngx_mail.c" 3 4
                           ((void *)0)
# 152 "project/nginx/src/mail/ngx_mail.c"
                               );

    if (rv != 
# 154 "project/nginx/src/mail/ngx_mail.c" 3 4
             ((void *)0)
# 154 "project/nginx/src/mail/ngx_mail.c"
                        ) {
        *cf = pcf;
        return rv;
    }
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 166 "project/nginx/src/mail/ngx_mail.c" 3 4
                                          0x4C49414D
# 166 "project/nginx/src/mail/ngx_mail.c"
                                                         ) {
            continue;
        }
        ...
        if (module->init_main_conf) {
            ...
            if (rv != 
# 179 "project/nginx/src/mail/ngx_mail.c" 3 4
                     ((void *)0)
# 179 "project/nginx/src/mail/ngx_mail.c"
                                ) {
                *cf = pcf;
                return rv;
            }
        ...
        for (s = 0; s < cmcf->servers.nelts; s++) {
            ...
            if (module->merge_srv_conf) {
                ...
                if (rv != 
# 195 "project/nginx/src/mail/ngx_mail.c" 3 4
                         ((void *)0)
# 195 "project/nginx/src/mail/ngx_mail.c"
                                    ) {
                    *cf = pcf;
                    return rv;
                }
    ...
    *cf = pcf;
    ...
    if (ngx_array_init(&ports, cf->temp_pool, 4, sizeof(ngx_mail_conf_port_t))
        != 
# 207 "project/nginx/src/mail/ngx_mail.c" 3 4
          0
# 207 "project/nginx/src/mail/ngx_mail.c"
                )
    {
        return 
# 209 "project/nginx/src/mail/ngx_mail.c" 3 4
              (void *) -1
# 209 "project/nginx/src/mail/ngx_mail.c"
                            ;
    }
    ...
    for (i = 0; i < cmcf->listen.nelts; i++) {
        if (ngx_mail_add_ports(cf, &ports, &listen[i]) != 
# 215 "project/nginx/src/mail/ngx_mail.c" 3 4
                                                         0
# 215 "project/nginx/src/mail/ngx_mail.c"
                                                               ) {
            return 
# 216 "project/nginx/src/mail/ngx_mail.c" 3 4
                  (void *) -1
# 216 "project/nginx/src/mail/ngx_mail.c"
                                ;
        }
    }
    ...
    ngx_mail_listen_t *listen)
{
    ...
    if (port == 
# 251 "project/nginx/src/mail/ngx_mail.c" 3 4
               ((void *)0)
# 251 "project/nginx/src/mail/ngx_mail.c"
                   ) {
        return 
# 252 "project/nginx/src/mail/ngx_mail.c" 3 4
              -1
# 252 "project/nginx/src/mail/ngx_mail.c"
                       ;
    }
    ...
    if (ngx_array_init(&port->addrs, cf->temp_pool, 2,
        ...
        != 
# 260 "project/nginx/src/mail/ngx_mail.c" 3 4
          0
# 260 "project/nginx/src/mail/ngx_mail.c"
                )
    {
        return 
# 262 "project/nginx/src/mail/ngx_mail.c" 3 4
              -1
# 262 "project/nginx/src/mail/ngx_mail.c"
                       ;
    }
...
found:
    ...
    if (addr == 
# 268 "project/nginx/src/mail/ngx_mail.c" 3 4
               ((void *)0)
# 268 "project/nginx/src/mail/ngx_mail.c"
                   ) {
        return 
# 269 "project/nginx/src/mail/ngx_mail.c" 3 4
              -1
# 269 "project/nginx/src/mail/ngx_mail.c"
                       ;
    }
    ...
    return 
# 274 "project/nginx/src/mail/ngx_mail.c" 3 4
          0
# 274 "project/nginx/src/mail/ngx_mail.c"
                ;
}
    ...
    for (p = 0; p < ports->nelts; p++) {
        ...
        while (i < last) {
            ...
            ls = ngx_create_listening(cf, addr[i].opt.sockaddr,
                                      addr[i].opt.socklen);
            if (ls == 
# 321 "project/nginx/src/mail/ngx_mail.c" 3 4
                     ((void *)0)
# 321 "project/nginx/src/mail/ngx_mail.c"
                         ) {
                return 
# 322 "project/nginx/src/mail/ngx_mail.c" 3 4
                      (void *) -1
# 322 "project/nginx/src/mail/ngx_mail.c"
                                    ;
            }
            ...
            if (mport == 
# 351 "project/nginx/src/mail/ngx_mail.c" 3 4
                        ((void *)0)
# 351 "project/nginx/src/mail/ngx_mail.c"
                            ) {
                return 
# 352 "project/nginx/src/mail/ngx_mail.c" 3 4
                      (void *) -1
# 352 "project/nginx/src/mail/ngx_mail.c"
                                    ;
            }
            ...
            case 
# 361 "project/nginx/src/mail/ngx_mail.c" 3 4
                30
# 361 "project/nginx/src/mail/ngx_mail.c"
                        :
                if (ngx_mail_add_addrs6(cf, mport, addr) != 
# 362 "project/nginx/src/mail/ngx_mail.c" 3 4
                                                           0
# 362 "project/nginx/src/mail/ngx_mail.c"
                                                                 ) {
                    return 
# 363 "project/nginx/src/mail/ngx_mail.c" 3 4
                          (void *) -1
# 363 "project/nginx/src/mail/ngx_mail.c"
                                        ;
                }
                break;

            default:
                if (ngx_mail_add_addrs(cf, mport, addr) != 
# 368 "project/nginx/src/mail/ngx_mail.c" 3 4
                                                          0
# 368 "project/nginx/src/mail/ngx_mail.c"
                                                                ) {
                    return 
# 369 "project/nginx/src/mail/ngx_mail.c" 3 4
                          (void *) -1
# 369 "project/nginx/src/mail/ngx_mail.c"
                                        ;
                }
                break;
            }
    ...
    return 
# 379 "project/nginx/src/mail/ngx_mail.c" 3 4
          ((void *)0)
# 379 "project/nginx/src/mail/ngx_mail.c"
                     ;
}
    ...
    ngx_mail_conf_addr_t *addr)
{
    ...
    if (mport->addrs == 
# 393 "project/nginx/src/mail/ngx_mail.c" 3 4
                       ((void *)0)
# 393 "project/nginx/src/mail/ngx_mail.c"
                           ) {
        return 
# 394 "project/nginx/src/mail/ngx_mail.c" 3 4
              -1
# 394 "project/nginx/src/mail/ngx_mail.c"
                       ;
    }
    ...
    return 
# 412 "project/nginx/src/mail/ngx_mail.c" 3 4
          0
# 412 "project/nginx/src/mail/ngx_mail.c"
                ;
}
    ...
    ngx_mail_conf_addr_t *addr)
{
    ...
    if (mport->addrs == 
# 428 "project/nginx/src/mail/ngx_mail.c" 3 4
                       ((void *)0)
# 428 "project/nginx/src/mail/ngx_mail.c"
                           ) {
        return 
# 429 "project/nginx/src/mail/ngx_mail.c" 3 4
              -1
# 429 "project/nginx/src/mail/ngx_mail.c"
                       ;
    }
    ...
    return 
# 447 "project/nginx/src/mail/ngx_mail.c" 3 4
          0
# 447 "project/nginx/src/mail/ngx_mail.c"
                ;
}
