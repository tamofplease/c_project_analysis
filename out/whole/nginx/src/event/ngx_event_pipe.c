# 0 "project/nginx/src/event/ngx_event_pipe.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/ngx_event_pipe.c"
...
# 9 "project/nginx/src/event/ngx_event_pipe.c" 2
...
# 10 "project/nginx/src/event/ngx_event_pipe.c" 2
...
# 11 "project/nginx/src/event/ngx_event_pipe.c" 2
...
# 12 "project/nginx/src/event/ngx_event_pipe.c" 2



# 14 "project/nginx/src/event/ngx_event_pipe.c"
static ngx_int_t ngx_event_pipe_read_upstream(ngx_event_pipe_t *p);
static ngx_int_t ngx_event_pipe_write_to_downstream(ngx_event_pipe_t *p);

static ngx_int_t ngx_event_pipe_write_chain_to_temp_file(ngx_event_pipe_t *p);
static 
# 18 "project/nginx/src/event/ngx_event_pipe.c" 3 4
      inline 
# 18 "project/nginx/src/event/ngx_event_pipe.c"
                 void ngx_event_pipe_remove_shadow_links(ngx_buf_t *buf);
...
ngx_event_pipe(ngx_event_pipe_t *p, ngx_int_t do_write)
{
    ...
    for ( ;; ) {
        if (do_write) {
            ...
            if (rc == 
# 35 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                     -6
# 35 "project/nginx/src/event/ngx_event_pipe.c"
                              ) {
                return 
# 36 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      -6
# 36 "project/nginx/src/event/ngx_event_pipe.c"
                               ;
            }

            if (rc == 
# 39 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                     -3
# 39 "project/nginx/src/event/ngx_event_pipe.c"
                             ) {
                return 
# 40 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      0
# 40 "project/nginx/src/event/ngx_event_pipe.c"
                            ;
            }
        }
        ...
        if (ngx_event_pipe_read_upstream(p) == 
# 49 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                              -6
# 49 "project/nginx/src/event/ngx_event_pipe.c"
                                                       ) {
            return 
# 50 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -6
# 50 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
        }
    ...
    if (p->upstream->fd != (ngx_socket_t) -1) {
        ...
        flags = (rev->eof || rev->error) ? 
# 63 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                          0x8000 
# 63 "project/nginx/src/event/ngx_event_pipe.c"
                                                          : 0;

        if (ngx_handle_read_event(rev, flags) != 
# 65 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                0
# 65 "project/nginx/src/event/ngx_event_pipe.c"
                                                      ) {
            return 
# 66 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -6
# 66 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
        }
...
# 71 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ngx_event_add_timer
# 71 "project/nginx/src/event/ngx_event_pipe.c"
                            (rev, p->read_timeout);

            } else if (rev->timer_set) {
                
# 74 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ngx_event_del_timer
# 74 "project/nginx/src/event/ngx_event_pipe.c"
                            (rev);
            }
        }
    }
...
# 83 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                         0
# 83 "project/nginx/src/event/ngx_event_pipe.c"
                                                               ) {
            return 
# 84 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -6
# 84 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
        }
...
# 89 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ngx_event_add_timer
# 89 "project/nginx/src/event/ngx_event_pipe.c"
                            (wev, p->send_timeout);

            } else if (wev->timer_set) {
                
# 92 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ngx_event_del_timer
# 92 "project/nginx/src/event/ngx_event_pipe.c"
                            (wev);
            }
        }
    }
    ...
    return 
# 97 "project/nginx/src/event/ngx_event_pipe.c" 3 4
          0
# 97 "project/nginx/src/event/ngx_event_pipe.c"
                ;
}
...
ngx_event_pipe_read_upstream(ngx_event_pipe_t *p)
{
    ...
    if (p->upstream_eof || p->upstream_error || p->upstream_done) {
        return 
# 112 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 112 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
# 136 "project/nginx/src/event/ngx_event_pipe.c"
    ...
    for ( ;; ) {
        ...
        if (p->preread_bufs == 
# 145 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                              ((void *)0) 
# 145 "project/nginx/src/event/ngx_event_pipe.c"
        ...
        if (p->preread_bufs) {
            ...
            p->preread_bufs = 
# 154 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                             ((void *)0)
# 154 "project/nginx/src/event/ngx_event_pipe.c"
                                 ;
            n = p->preread_size;
...
# 174 "project/nginx/src/event/ngx_event_pipe.c"
...
# 191 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   if ((
# 191 "project/nginx/src/event/ngx_event_pipe.c"
                   p->log
# 191 "project/nginx/src/event/ngx_event_pipe.c" 3 4
...
# 191 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   , 
# 191 "project/nginx/src/event/ngx_event_pipe.c"
                   p->upstream->read->kq_errno, "kevent() reported that upstream " "closed connection"
# 191 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   )


                                                      
# 194 "project/nginx/src/event/ngx_event_pipe.c"
                                                     ;
                }
            ...
            if (p->limit_rate) {
                ...
                limit = (off_t) p->limit_rate * (
# 206 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                ngx_cached_time->sec 
# 206 "project/nginx/src/event/ngx_event_pipe.c"
                                                           - p->start_sec + 1)
                        - p->read_length;
...
# 212 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   ngx_event_add_timer
# 212 "project/nginx/src/event/ngx_event_pipe.c"
                                (p->upstream->read, delay);
                    break;
                }
            ...
            if (p->free_raw_bufs) {
                ...
                if (p->single_buf) {
                    ...
                    chain->next = 
# 227 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                 ((void *)0)
# 227 "project/nginx/src/event/ngx_event_pipe.c"
                                     ;
                } else {
                    p->free_raw_bufs = 
# 229 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                      ((void *)0)
# 229 "project/nginx/src/event/ngx_event_pipe.c"
                                          ;
                }
                ...
                if (b == 
# 237 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                        ((void *)0)
# 237 "project/nginx/src/event/ngx_event_pipe.c"
                            ) {
                    return 
# 238 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                          -6
# 238 "project/nginx/src/event/ngx_event_pipe.c"
                                   ;
                }
                ...
                if (chain == 
# 244 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                            ((void *)0)
# 244 "project/nginx/src/event/ngx_event_pipe.c"
                                ) {
                    return 
# 245 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                          -6
# 245 "project/nginx/src/event/ngx_event_pipe.c"
                                   ;
                }

                chain->buf = b;
                chain->next = 
# 249 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                             ((void *)0)
# 249 "project/nginx/src/event/ngx_event_pipe.c"
                                 ;
                       ...
                       || p->temp_file->offset < p->max_temp_file_size)
            {
                ...
                if (rc == 
# 282 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                         -3
# 282 "project/nginx/src/event/ngx_event_pipe.c"
                                 ) {
                    break;
                }

                if (rc != 
# 286 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                         0
# 286 "project/nginx/src/event/ngx_event_pipe.c"
                               ) {
                    return rc;
                }
                ...
                if (p->single_buf) {
                    p->free_raw_bufs = p->free_raw_bufs->next;
                    chain->next = 
# 293 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                 ((void *)0)
# 293 "project/nginx/src/event/ngx_event_pipe.c"
                                     ;
                } else {
                    p->free_raw_bufs = 
# 295 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                      ((void *)0)
# 295 "project/nginx/src/event/ngx_event_pipe.c"
                                          ;
                }
            ...
            if (n == 
# 318 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                    -1
# 318 "project/nginx/src/event/ngx_event_pipe.c"
                             ) {
                p->upstream_error = 1;
                break;
            }
            ...
            if (n == 
# 323 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                    -2
# 323 "project/nginx/src/event/ngx_event_pipe.c"
                             ) {
                if (p->single_buf) {
        ...
        cl = chain;
        p->free_raw_bufs = 
# 343 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                          ((void *)0)
# 343 "project/nginx/src/event/ngx_event_pipe.c"
                              ;
        ...
        while (cl && n > 0) {
            ...
            if (n >= size) {
                ...
                if (p->input_filter(p, cl->buf) == 
# 356 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                  -1
# 356 "project/nginx/src/event/ngx_event_pipe.c"
                                                           ) {
                    return 
# 357 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                          -6
# 357 "project/nginx/src/event/ngx_event_pipe.c"
                                   ;
                }
...
# 363 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               (
# 363 "project/nginx/src/event/ngx_event_pipe.c"
               ln
# 363 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               )->next = (
# 363 "project/nginx/src/event/ngx_event_pipe.c"
...
# 380 "project/nginx/src/event/ngx_event_pipe.c" 3 4
           ngx_event_add_timer
# 380 "project/nginx/src/event/ngx_event_pipe.c"
                        (p->upstream->read, delay);
            break;
        }
    }
# 444 "project/nginx/src/event/ngx_event_pipe.c"
    if (p->free_raw_bufs && p->length != -1) {
        ...
        if (cl->buf->last - cl->buf->pos >= p->length) {
            ...
            if (p->input_filter(p, cl->buf) == 
# 453 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                              -1
# 453 "project/nginx/src/event/ngx_event_pipe.c"
                                                       ) {
                return 
# 454 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      -6
# 454 "project/nginx/src/event/ngx_event_pipe.c"
                               ;
            }

            
# 457 "project/nginx/src/event/ngx_event_pipe.c" 3 4
           (
# 457 "project/nginx/src/event/ngx_event_pipe.c"
           cl
# 457 "project/nginx/src/event/ngx_event_pipe.c" 3 4
           )->next = (
# 457 "project/nginx/src/event/ngx_event_pipe.c"
...
# 457 "project/nginx/src/event/ngx_event_pipe.c"
    ...
    if ((p->upstream_eof || p->upstream_error) && p->free_raw_bufs) {
        ...
        if (p->input_filter(p, p->free_raw_bufs->buf) == 
# 470 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                        -1
# 470 "project/nginx/src/event/ngx_event_pipe.c"
                                                                 ) {
            return 
# 471 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -6
# 471 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
        }

        p->free_raw_bufs = p->free_raw_bufs->next;

        if (p->free_bufs && p->buf_to_file == 
# 476 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                             ((void *)0)
# 476 "project/nginx/src/event/ngx_event_pipe.c"
                                                 ) {
            for (cl = p->free_raw_bufs; cl; cl = cl->next) {
                if (cl->buf->shadow == 
# 478 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                      ((void *)0)
# 478 "project/nginx/src/event/ngx_event_pipe.c"
                                          ) {
    ...
    if (p->cacheable && (p->in || p->buf_to_file)) {
        ...
        if (rc != 
# 492 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                 0
# 492 "project/nginx/src/event/ngx_event_pipe.c"
                       ) {
            return rc;
        }
    }
    ...
    return 
# 497 "project/nginx/src/event/ngx_event_pipe.c" 3 4
          0
# 497 "project/nginx/src/event/ngx_event_pipe.c"
                ;
}
...
ngx_event_pipe_write_to_downstream(ngx_event_pipe_t *p)
{
    ...
    downstream = p->downstream;
                                                                         ...
                                                                         ;
# 528 "project/nginx/src/event/ngx_event_pipe.c"
    flushed = 0;
    ...
    for ( ;; ) {
        ...
        if (p->upstream_eof || p->upstream_error || p->upstream_done) {
            ...
            if (p->out) {
                ...
                if (rc == 
# 553 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                         -1
# 553 "project/nginx/src/event/ngx_event_pipe.c"
                                  ) {
                ...
                p->out = 
# 558 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                        ((void *)0)
# 558 "project/nginx/src/event/ngx_event_pipe.c"
                            ;
            }
            ...
            if (p->in) {
                ...
                if (rc == 
# 575 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                         -1
# 575 "project/nginx/src/event/ngx_event_pipe.c"
                                  ) {
                    p->downstream_error = 1;
                    return ngx_event_pipe_drain_chains(p);
                }
                ...
                p->in = 
# 580 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                       ((void *)0)
# 580 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
            }
        ...
        prev = 
# 601 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              ((void *)0)
# 601 "project/nginx/src/event/ngx_event_pipe.c"
                  ;
        bsize = 0;
        ...
        out = 
# 619 "project/nginx/src/event/ngx_event_pipe.c" 3 4
             ((void *)0)
# 619 "project/nginx/src/event/ngx_event_pipe.c"
                 ;
        ...
        flush = 0;
        ll = 
# 627 "project/nginx/src/event/ngx_event_pipe.c" 3 4
            ((void *)0)
# 627 "project/nginx/src/event/ngx_event_pipe.c"
                ;
        prev_last_shadow = 1;
...
# 635 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   if ((
# 635 "project/nginx/src/event/ngx_event_pipe.c"
                   p->log
# 635 "project/nginx/src/event/ngx_event_pipe.c" 3 4
...
# 635 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   , 
# 635 "project/nginx/src/event/ngx_event_pipe.c"
                   0, "recycled buffer in pipe out chain"
# 635 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   )
                                                                      
# 636 "project/nginx/src/event/ngx_event_pipe.c"
                                                                     ;
                }
            ...
            cl->next = 
# 667 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      ((void *)0)
# 667 "project/nginx/src/event/ngx_event_pipe.c"
                          ;
    ...
    flush:
        ...
        if (out == 
# 682 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  ((void *)0)
# 682 "project/nginx/src/event/ngx_event_pipe.c"
                      ) {
            ...
            if (flushed++ > 10) {
                return 
# 690 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      -3
# 690 "project/nginx/src/event/ngx_event_pipe.c"
                              ;
            }
        }
        ...
        if (rc == 
# 698 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                 -1
# 698 "project/nginx/src/event/ngx_event_pipe.c"
                          ) {
            p->downstream_error = 1;
            return ngx_event_pipe_drain_chains(p);
        }
        ...
        for (cl = p->free; cl; cl = cl->next) {
            ...
            if (cl->buf->last_shadow) {
                if (ngx_event_pipe_add_free_buf(p, cl->buf->shadow) != 
# 722 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                                      0
# 722 "project/nginx/src/event/ngx_event_pipe.c"
                                                                            ) {
                    return 
# 723 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                          -6
# 723 "project/nginx/src/event/ngx_event_pipe.c"
                                   ;
                }
            ...
            cl->buf->shadow = 
# 729 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                             ((void *)0)
# 729 "project/nginx/src/event/ngx_event_pipe.c"
                                 ;
        }
    }

    return 
# 733 "project/nginx/src/event/ngx_event_pipe.c" 3 4
          0
# 733 "project/nginx/src/event/ngx_event_pipe.c"
                ;
}
...
# 767 "project/nginx/src/event/ngx_event_pipe.c"
    if (p->buf_to_file) {
        out = ngx_alloc_chain_link(p->pool);
        if (out == 
# 769 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  ((void *)0)
# 769 "project/nginx/src/event/ngx_event_pipe.c"
                      ) {
            return 
# 770 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -6
# 770 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
        }
    ...
    if (!p->cacheable) {
        ...
        cl = out;
        ll = 
# 784 "project/nginx/src/event/ngx_event_pipe.c" 3 4
            ((void *)0)
# 784 "project/nginx/src/event/ngx_event_pipe.c"
                ;
        prev_last_shadow = 1;
        ...
        if (ll == 
# 816 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                 ((void *)0)
# 816 "project/nginx/src/event/ngx_event_pipe.c"
                     ) {
            return 
# 817 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -3
# 817 "project/nginx/src/event/ngx_event_pipe.c"
                          ;
        }
        ...
        if (cl) {
            p->in = cl;
            *ll = 
# 822 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                 ((void *)0)
# 822 "project/nginx/src/event/ngx_event_pipe.c"
                     ;

        } else {
            p->in = 
# 825 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   ((void *)0)
# 825 "project/nginx/src/event/ngx_event_pipe.c"
                       ;
            p->last_in = &p->in;
        }
        ...
        p->in = 
# 830 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ((void *)0)
# 830 "project/nginx/src/event/ngx_event_pipe.c"
                   ;
        p->last_in = &p->in;
    }
# 843 "project/nginx/src/event/ngx_event_pipe.c"
    n = ngx_write_chain_to_temp_file(p->temp_file, out);

    if (n == 
# 845 "project/nginx/src/event/ngx_event_pipe.c" 3 4
            -1
# 845 "project/nginx/src/event/ngx_event_pipe.c"
                     ) {
        return 
# 846 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              -6
# 846 "project/nginx/src/event/ngx_event_pipe.c"
                       ;
    }
# 861 "project/nginx/src/event/ngx_event_pipe.c"
    if (p->buf_to_file) {
        p->temp_file->offset = p->buf_to_file->last - p->buf_to_file->pos;
        n -= p->buf_to_file->last - p->buf_to_file->pos;
        p->buf_to_file = 
# 864 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                        ((void *)0)
# 864 "project/nginx/src/event/ngx_event_pipe.c"
                            ;
        out = out->next;
    }
    ...
    if (n > 0) {
        ...
        if (cl == 
# 889 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                 ((void *)0)
# 889 "project/nginx/src/event/ngx_event_pipe.c"
                     ) {
            return 
# 890 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  -6
# 890 "project/nginx/src/event/ngx_event_pipe.c"
                           ;
        }
...
# 895 "project/nginx/src/event/ngx_event_pipe.c" 3 4
       (void) __builtin___memset_chk (
# 895 "project/nginx/src/event/ngx_event_pipe.c"
       b
# 895 "project/nginx/src/event/ngx_event_pipe.c" 3 4
       , 0, 
# 895 "project/nginx/src/event/ngx_event_pipe.c"
...
free:
    ...
    for (last_free = &p->free_raw_bufs;
         *last_free != 
# 913 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      ((void *)0)
# 913 "project/nginx/src/event/ngx_event_pipe.c"
                          ;
    ...
    for (cl = out; cl; cl = next) {
        ...
        if (b->last_shadow) {
            ...
            if (tl == 
# 930 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                     ((void *)0)
# 930 "project/nginx/src/event/ngx_event_pipe.c"
                         ) {
                return 
# 931 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      -6
# 931 "project/nginx/src/event/ngx_event_pipe.c"
                               ;
            }

            tl->buf = b->shadow;
            tl->next = 
# 935 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                      ((void *)0)
# 935 "project/nginx/src/event/ngx_event_pipe.c"
                          ;
    ...
    return 
# 947 "project/nginx/src/event/ngx_event_pipe.c" 3 4
          0
# 947 "project/nginx/src/event/ngx_event_pipe.c"
                ;
}
...
ngx_event_pipe_copy_input_filter(ngx_event_pipe_t *p, ngx_buf_t *buf)
{
    ...
    if (buf->pos == buf->last) {
        return 
# 960 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 960 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
    ...
    if (p->upstream_done) {
                                                ...
                                                ;
        return 
# 966 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 966 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
...
# 972 "project/nginx/src/event/ngx_event_pipe.c" 3 4
       if ((
# 972 "project/nginx/src/event/ngx_event_pipe.c"
       p->log
# 972 "project/nginx/src/event/ngx_event_pipe.c" 3 4
...
# 974 "project/nginx/src/event/ngx_event_pipe.c"
                                                 ;

        return 
# 976 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 976 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }

    cl = ngx_chain_get_free_buf(p->pool, &p->free);
    if (cl == 
# 980 "project/nginx/src/event/ngx_event_pipe.c" 3 4
             ((void *)0)
# 980 "project/nginx/src/event/ngx_event_pipe.c"
                 ) {
        return 
# 981 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              -1
# 981 "project/nginx/src/event/ngx_event_pipe.c"
                       ;
    }
...
# 986 "project/nginx/src/event/ngx_event_pipe.c" 3 4
   (void) __builtin___memcpy_chk (
# 986 "project/nginx/src/event/ngx_event_pipe.c"
   b
# 986 "project/nginx/src/event/ngx_event_pipe.c" 3 4
   , 
# 986 "project/nginx/src/event/ngx_event_pipe.c"
...
# 986 "project/nginx/src/event/ngx_event_pipe.c"
    ...
    if (p->length == -1) {
        return 
# 1003 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 1003 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
...
# 1008 "project/nginx/src/event/ngx_event_pipe.c" 3 4
       if ((
# 1008 "project/nginx/src/event/ngx_event_pipe.c"
       p->log
# 1008 "project/nginx/src/event/ngx_event_pipe.c" 3 4
       )->log_level >= 5) ngx_log_error_core(5, 
# 1008 "project/nginx/src/event/ngx_event_pipe.c"
...
# 1010 "project/nginx/src/event/ngx_event_pipe.c"
                                                 ;
        ...
        return 
# 1015 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 1015 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
    ...
    return 
# 1020 "project/nginx/src/event/ngx_event_pipe.c" 3 4
          0
# 1020 "project/nginx/src/event/ngx_event_pipe.c"
                ;
}


static 
# 1024 "project/nginx/src/event/ngx_event_pipe.c" 3 4
      inline 
# 1024 "project/nginx/src/event/ngx_event_pipe.c"
                 void
ngx_event_pipe_remove_shadow_links(ngx_buf_t *buf)
{
    ...
    if (b == 
# 1031 "project/nginx/src/event/ngx_event_pipe.c" 3 4
            ((void *)0)
# 1031 "project/nginx/src/event/ngx_event_pipe.c"
                ) {
        return;
    }
    ...
    while (!b->last_shadow) {
        ...
        b->shadow = 
# 1041 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   ((void *)0)
# 1041 "project/nginx/src/event/ngx_event_pipe.c"
                       ;
        b = next;
    }
    ...
    b->shadow = 
# 1049 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ((void *)0)
# 1049 "project/nginx/src/event/ngx_event_pipe.c"
                   ;

    buf->shadow = 
# 1051 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                 ((void *)0)
# 1051 "project/nginx/src/event/ngx_event_pipe.c"
                     ;
}
...
ngx_event_pipe_add_free_buf(ngx_event_pipe_t *p, ngx_buf_t *b)
{
    ...
    if (cl == 
# 1061 "project/nginx/src/event/ngx_event_pipe.c" 3 4
             ((void *)0)
# 1061 "project/nginx/src/event/ngx_event_pipe.c"
                 ) {
        return 
# 1062 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              -1
# 1062 "project/nginx/src/event/ngx_event_pipe.c"
                       ;
    }
    ...
    b->shadow = 
# 1074 "project/nginx/src/event/ngx_event_pipe.c" 3 4
               ((void *)0)
# 1074 "project/nginx/src/event/ngx_event_pipe.c"
                   ;

    cl->buf = b;

    if (p->free_raw_bufs == 
# 1078 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                           ((void *)0)
# 1078 "project/nginx/src/event/ngx_event_pipe.c"
                               ) {
        p->free_raw_bufs = cl;
        cl->next = 
# 1080 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  ((void *)0)
# 1080 "project/nginx/src/event/ngx_event_pipe.c"
                      ;

        return 
# 1082 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 1082 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
    ...
    if (p->free_raw_bufs->buf->pos == p->free_raw_bufs->buf->last) {
        ...
        return 
# 1092 "project/nginx/src/event/ngx_event_pipe.c" 3 4
              0
# 1092 "project/nginx/src/event/ngx_event_pipe.c"
                    ;
    }
    ...
    return 
# 1100 "project/nginx/src/event/ngx_event_pipe.c" 3 4
          0
# 1100 "project/nginx/src/event/ngx_event_pipe.c"
                ;
}
...
ngx_event_pipe_drain_chains(ngx_event_pipe_t *p)
{
    ...
    for ( ;; ) {
        if (p->busy) {
            cl = p->busy;
            p->busy = 
# 1112 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                     ((void *)0)
# 1112 "project/nginx/src/event/ngx_event_pipe.c"
                         ;

        } else if (p->out) {
            cl = p->out;
            p->out = 
# 1116 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                    ((void *)0)
# 1116 "project/nginx/src/event/ngx_event_pipe.c"
                        ;

        } else if (p->in) {
            cl = p->in;
            p->in = 
# 1120 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                   ((void *)0)
# 1120 "project/nginx/src/event/ngx_event_pipe.c"
                       ;

        } else {
            return 
# 1123 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                  0
# 1123 "project/nginx/src/event/ngx_event_pipe.c"
                        ;
        }
        ...
        while (cl) {
            if (cl->buf->last_shadow) {
                if (ngx_event_pipe_add_free_buf(p, cl->buf->shadow) != 
# 1128 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                                                                      0
# 1128 "project/nginx/src/event/ngx_event_pipe.c"
                                                                            ) {
                    return 
# 1129 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                          -6
# 1129 "project/nginx/src/event/ngx_event_pipe.c"
                                   ;
                }
            ...
            cl->buf->shadow = 
# 1135 "project/nginx/src/event/ngx_event_pipe.c" 3 4
                             ((void *)0)
# 1135 "project/nginx/src/event/ngx_event_pipe.c"
                                 ;
            tl = cl->next;
            cl->next = p->free;
            p->free = cl;
