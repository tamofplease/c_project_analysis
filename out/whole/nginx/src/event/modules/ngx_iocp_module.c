# 0 "project/nginx/src/event/modules/ngx_iocp_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 9 "project/nginx/src/event/modules/ngx_iocp_module.c" 2
...
# 10 "project/nginx/src/event/modules/ngx_iocp_module.c" 2
...
# 11 "project/nginx/src/event/modules/ngx_iocp_module.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/event/modules/ngx_iocp_module.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/event/modules/ngx_iocp_module.h" 3 4
...
# 12 "project/nginx/src/event/modules/ngx_iocp_module.c" 2



# 14 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
static ngx_str_t iocp_name = 
# 26 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                                 { sizeof(
# 26 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                 "iocp"
# 26 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                                 ) - 1, (u_char *) 
# 26 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
static ngx_command_t ngx_iocp_commands[] = {
    ...
    { 
# 30 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     { sizeof(
# 30 "project/nginx/src/event/modules/ngx_iocp_module.c"
     "iocp_threads"
# 30 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     ) - 1, (u_char *) 
# 30 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 31 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     0x02000000
# 31 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   |
# 31 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                    0x00000002
# 31 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 34 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     __builtin_offsetof (
# 34 "project/nginx/src/event/modules/ngx_iocp_module.c"
     ngx_iocp_conf_t
# 34 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     , 
# 34 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 35 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     ((void *)0) 
# 35 "project/nginx/src/event/modules/ngx_iocp_module.c"
          },

    { 
# 37 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     { sizeof(
# 37 "project/nginx/src/event/modules/ngx_iocp_module.c"
     "post_acceptex"
# 37 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     ) - 1, (u_char *) 
# 37 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 38 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     0x02000000
# 38 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   |
# 38 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                    0x00000002
# 38 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 41 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     __builtin_offsetof (
# 41 "project/nginx/src/event/modules/ngx_iocp_module.c"
     ngx_iocp_conf_t
# 41 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     , 
# 41 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 42 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     ((void *)0) 
# 42 "project/nginx/src/event/modules/ngx_iocp_module.c"
          },

    { 
# 44 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     { sizeof(
# 44 "project/nginx/src/event/modules/ngx_iocp_module.c"
     "acceptex_read"
# 44 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     ) - 1, (u_char *) 
# 44 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 45 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     0x02000000
# 45 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   |
# 45 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                    0x00000200
# 45 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 48 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     __builtin_offsetof (
# 48 "project/nginx/src/event/modules/ngx_iocp_module.c"
     ngx_iocp_conf_t
# 48 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     , 
# 48 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 49 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     ((void *)0) 
# 49 "project/nginx/src/event/modules/ngx_iocp_module.c"
          },

      
# 51 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 52 "project/nginx/src/event/modules/ngx_iocp_module.c"
};
...
# 62 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       ((void *)0)
# 62 "project/nginx/src/event/modules/ngx_iocp_module.c"
           ,
        
# 63 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       ((void *)0)
# 63 "project/nginx/src/event/modules/ngx_iocp_module.c"
           ,
        
# 64 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       ((void *)0)
# 64 "project/nginx/src/event/modules/ngx_iocp_module.c"
           ,
        
# 65 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       ((void *)0)
# 65 "project/nginx/src/event/modules/ngx_iocp_module.c"
           ,
        ngx_iocp_del_connection,
        
# 67 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       ((void *)0)
# 67 "project/nginx/src/event/modules/ngx_iocp_module.c"
           ,
        ngx_iocp_process_events,
        ngx_iocp_init,
        ngx_iocp_done
    }
...
# 76 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 76 "project/nginx/src/event/modules/ngx_iocp_module.c"
   "8" 
# 76 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   "," 
# 76 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 79 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   0x544E5645
# 79 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   ,
    
# 80 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 80 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 81 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 81 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 82 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 82 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 83 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 83 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 84 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 84 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 85 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 85 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 86 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 86 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 87 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 88 "project/nginx/src/event/modules/ngx_iocp_module.c"
};
...
# 93 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 93 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    ngx_udp_overlapped_wsarecv,
    
# 95 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 95 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 96 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 96 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
    
# 97 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   ((void *)0)
# 97 "project/nginx/src/event/modules/ngx_iocp_module.c"
       ,
...
ngx_iocp_init(ngx_cycle_t *cycle, ngx_msec_t timer)
{
    ...
    cf = 
# 113 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
        (*(
# 113 "project/nginx/src/event/modules/ngx_iocp_module.c"
        cycle->conf_ctx
# 113 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
...
# 113 "project/nginx/src/event/modules/ngx_iocp_module.c"
    ...
    if (iocp == 
# 115 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               ((void *)0)
# 115 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   ) {
        iocp = CreateIoCompletionPort(INVALID_HANDLE_VALUE, 
# 116 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                                                           ((void *)0)
# 116 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                               , 0,
                                      cf->threads);
    }

    if (iocp == 
# 120 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               ((void *)0)
# 120 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   ) {
        
# 121 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       if ((
# 121 "project/nginx/src/event/modules/ngx_iocp_module.c"
       cycle->log
# 121 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
...
# 122 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                       ;
        return 
# 123 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
              -1
# 123 "project/nginx/src/event/modules/ngx_iocp_module.c"
                       ;
    }
    ...
    ngx_event_flags = 
# 130 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                     0x00000200
# 130 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                       ;

    if (timer == 0) {
        return 
# 133 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
              0
# 133 "project/nginx/src/event/modules/ngx_iocp_module.c"
                    ;
    }
    ...
    if (timer_thread == 
# 141 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                       ((void *)0)
# 141 "project/nginx/src/event/modules/ngx_iocp_module.c"
                           ) {
        ...
        {
            return 
# 148 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                  -1
# 148 "project/nginx/src/event/modules/ngx_iocp_module.c"
                           ;
        }
    }

    ngx_event_flags |= 
# 152 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                      0x00000800
# 152 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                         ;

    return 
# 154 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
          0
# 154 "project/nginx/src/event/modules/ngx_iocp_module.c"
                ;
}
...
# 185 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       if ((
# 185 "project/nginx/src/event/modules/ngx_iocp_module.c"
       cycle->log
# 185 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 185 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 186 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                 ;
    }

    iocp = 
# 189 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
          ((void *)0)
# 189 "project/nginx/src/event/modules/ngx_iocp_module.c"
              ;
}
...
ngx_iocp_add_event(ngx_event_t *ev, ngx_int_t event, ngx_uint_t key)
{
    ...
    if (CreateIoCompletionPort((HANDLE) c->fd, iocp, key, 0) == 
# 206 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                                                               ((void *)0)
# 206 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                                   ) {
        
# 207 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       if ((
# 207 "project/nginx/src/event/modules/ngx_iocp_module.c"
       c->log
# 207 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 207 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 208 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                       ;
        return 
# 209 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
              -1
# 209 "project/nginx/src/event/modules/ngx_iocp_module.c"
                       ;
    }

    return 
# 212 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
          0
# 212 "project/nginx/src/event/modules/ngx_iocp_module.c"
                ;
}
...
{
# 230 "project/nginx/src/event/modules/ngx_iocp_module.c"
    return 
# 230 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
          0
# 230 "project/nginx/src/event/modules/ngx_iocp_module.c"
                ;
}
    ...
    ngx_uint_t flags)
{
    ...
    if (timer == 
# 246 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                (ngx_msec_t) -1
# 246 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                  ) {
        timer = INFINITE;
    }
    ...
    if (rc == 0) {
        err = 
# 256 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
             (*__error())
# 256 "project/nginx/src/event/modules/ngx_iocp_module.c"
                      ;
    } else {
        err = 0;
    }
    ...
    if (flags & 
# 263 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               1
# 263 "project/nginx/src/event/modules/ngx_iocp_module.c"
                              ) {
        ngx_time_update();
    }
    ...
    if (err) {
        if (ovlp == 
# 278 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                   ((void *)0)
# 278 "project/nginx/src/event/modules/ngx_iocp_module.c"
                       ) {
            if (err != WAIT_TIMEOUT) {
                
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               if ((
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c"
               cycle->log
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               , 
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c"
               err, "GetQueuedCompletionStatus() failed"
# 280 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               )
                                                                   
# 281 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                                  ;

                return 
# 283 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                      -1
# 283 "project/nginx/src/event/modules/ngx_iocp_module.c"
                               ;
            }

            return 
# 286 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                  0
# 286 "project/nginx/src/event/modules/ngx_iocp_module.c"
                        ;
        }
    ...
    if (ovlp == 
# 292 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
               ((void *)0)
# 292 "project/nginx/src/event/modules/ngx_iocp_module.c"
                   ) {
        
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       if ((
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c"
       cycle->log
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       , 
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c"
       0, "GetQueuedCompletionStatus() returned no operation"
# 293 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       )
                                                                          
# 294 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                                         ;
        return 
# 295 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
              -1
# 295 "project/nginx/src/event/modules/ngx_iocp_module.c"
                       ;
    }
        ...
        || err == ERROR_OPERATION_ABORTED )
    {
        ...
        return 
# 316 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
              0
# 316 "project/nginx/src/event/modules/ngx_iocp_module.c"
                    ;
    }

    if (err) {
        
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       if ((
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c"
       cycle->log
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       , 
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c"
       err, "GetQueuedCompletionStatus() returned operation error"
# 320 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
       )
                                                                             
# 321 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                                                            ;
    }
    ...
    return 
# 348 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
          0
# 348 "project/nginx/src/event/modules/ngx_iocp_module.c"
                ;
}
...
ngx_iocp_create_conf(ngx_cycle_t *cycle)
{
    ...
    if (cf == 
# 358 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
             ((void *)0)
# 358 "project/nginx/src/event/modules/ngx_iocp_module.c"
                 ) {
        return 
# 359 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
              (void *) -1
# 359 "project/nginx/src/event/modules/ngx_iocp_module.c"
                            ;
    }

    cf->threads = 
# 362 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                 -1
# 362 "project/nginx/src/event/modules/ngx_iocp_module.c"
                               ;
    cf->post_acceptex = 
# 363 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                       -1
# 363 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                     ;
    cf->acceptex_read = 
# 364 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
                       -1
# 364 "project/nginx/src/event/modules/ngx_iocp_module.c"
                                     ;
...
# 375 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   if (
# 375 "project/nginx/src/event/modules/ngx_iocp_module.c"
   cf->threads 
# 375 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   == -1) { 
# 375 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 376 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   if (
# 376 "project/nginx/src/event/modules/ngx_iocp_module.c"
   cf->post_acceptex 
# 376 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   == -1) { 
# 376 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 377 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   if (
# 377 "project/nginx/src/event/modules/ngx_iocp_module.c"
   cf->acceptex_read 
# 377 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
   == -1) { 
# 377 "project/nginx/src/event/modules/ngx_iocp_module.c"
...
# 377 "project/nginx/src/event/modules/ngx_iocp_module.c"
    ...
    return 
# 379 "project/nginx/src/event/modules/ngx_iocp_module.c" 3 4
          ((void *)0)
# 379 "project/nginx/src/event/modules/ngx_iocp_module.c"
                     ;
}
