# 0 "project/nginx/src/event/ngx_event_posted.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/ngx_event_posted.c"
...
# 9 "project/nginx/src/event/ngx_event_posted.c" 2
...
# 10 "project/nginx/src/event/ngx_event_posted.c" 2
...
# 11 "project/nginx/src/event/ngx_event_posted.c" 2



# 13 "project/nginx/src/event/ngx_event_posted.c"
...
ngx_event_process_posted(ngx_cycle_t *cycle, ngx_queue_t *posted)
{
    ...
    while (!
# 24 "project/nginx/src/event/ngx_event_posted.c" 3 4
           (
# 24 "project/nginx/src/event/ngx_event_posted.c"
           posted 
# 24 "project/nginx/src/event/ngx_event_posted.c" 3 4
           == (
# 24 "project/nginx/src/event/ngx_event_posted.c"
...
# 24 "project/nginx/src/event/ngx_event_posted.c"
        ...
        q = 
# 26 "project/nginx/src/event/ngx_event_posted.c" 3 4
           (
# 26 "project/nginx/src/event/ngx_event_posted.c"
           posted
# 26 "project/nginx/src/event/ngx_event_posted.c" 3 4
           )->next
# 26 "project/nginx/src/event/ngx_event_posted.c"
                                 ;
        ev = 
# 27 "project/nginx/src/event/ngx_event_posted.c" 3 4
            (
# 27 "project/nginx/src/event/ngx_event_posted.c"
            ngx_event_t 
# 27 "project/nginx/src/event/ngx_event_posted.c" 3 4
            *) ((u_char *) 
# 27 "project/nginx/src/event/ngx_event_posted.c"
...
# 32 "project/nginx/src/event/ngx_event_posted.c" 3 4
       (
# 32 "project/nginx/src/event/ngx_event_posted.c"
       ev
# 32 "project/nginx/src/event/ngx_event_posted.c" 3 4
       )->posted = 0; (&(
# 32 "project/nginx/src/event/ngx_event_posted.c"
...
ngx_event_move_posted_next(ngx_cycle_t *cycle)
{
    ...
    for (q = 
# 45 "project/nginx/src/event/ngx_event_posted.c" 3 4
            (
# 45 "project/nginx/src/event/ngx_event_posted.c"
...
# 45 "project/nginx/src/event/ngx_event_posted.c"
                                                   ;
         q != 
# 46 "project/nginx/src/event/ngx_event_posted.c" 3 4
             (
# 46 "project/nginx/src/event/ngx_event_posted.c"
             &ngx_posted_next_events
# 46 "project/nginx/src/event/ngx_event_posted.c" 3 4
             )
# 46 "project/nginx/src/event/ngx_event_posted.c"
                                                        ;
         q = 
# 47 "project/nginx/src/event/ngx_event_posted.c" 3 4
            (
# 47 "project/nginx/src/event/ngx_event_posted.c"
            q
# 47 "project/nginx/src/event/ngx_event_posted.c" 3 4
            )->next
# 47 "project/nginx/src/event/ngx_event_posted.c"
    ...
    {
        ev = 
# 49 "project/nginx/src/event/ngx_event_posted.c" 3 4
            (
# 49 "project/nginx/src/event/ngx_event_posted.c"
            ngx_event_t 
# 49 "project/nginx/src/event/ngx_event_posted.c" 3 4
            *) ((u_char *) 
# 49 "project/nginx/src/event/ngx_event_posted.c"
...
# 58 "project/nginx/src/event/ngx_event_posted.c" 3 4
   (
# 58 "project/nginx/src/event/ngx_event_posted.c"
   &ngx_posted_events
# 58 "project/nginx/src/event/ngx_event_posted.c" 3 4
   )->prev->next = (
# 58 "project/nginx/src/event/ngx_event_posted.c"
...
# 59 "project/nginx/src/event/ngx_event_posted.c" 3 4
   (
# 59 "project/nginx/src/event/ngx_event_posted.c"
   &ngx_posted_next_events
# 59 "project/nginx/src/event/ngx_event_posted.c" 3 4
   )->prev = 
# 59 "project/nginx/src/event/ngx_event_posted.c"
