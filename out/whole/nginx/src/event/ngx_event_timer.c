# 0 "project/nginx/src/event/ngx_event_timer.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/ngx_event_timer.c"
...
# 9 "project/nginx/src/event/ngx_event_timer.c" 2
...
# 10 "project/nginx/src/event/ngx_event_timer.c" 2
...
# 11 "project/nginx/src/event/ngx_event_timer.c" 2



# 13 "project/nginx/src/event/ngx_event_timer.c"
...
# 25 "project/nginx/src/event/ngx_event_timer.c" 3 4
   ((
# 25 "project/nginx/src/event/ngx_event_timer.c"
...
# 25 "project/nginx/src/event/ngx_event_timer.c"
   ngx_rbtree_insert_timer_value
    ...
    return 
# 28 "project/nginx/src/event/ngx_event_timer.c" 3 4
          0
# 28 "project/nginx/src/event/ngx_event_timer.c"
                ;
}
...
ngx_event_find_timer(void)
{
    ...
    if (ngx_event_timer_rbtree.root == &ngx_event_timer_sentinel) {
        return 
# 39 "project/nginx/src/event/ngx_event_timer.c" 3 4
              (ngx_msec_t) -1
# 39 "project/nginx/src/event/ngx_event_timer.c"
                                ;
    }
...
ngx_event_expire_timers(void)
{
    ...
    for ( ;; ) {
        ...
        ev = 
# 76 "project/nginx/src/event/ngx_event_timer.c" 3 4
            (
# 76 "project/nginx/src/event/ngx_event_timer.c"
            ngx_event_t 
# 76 "project/nginx/src/event/ngx_event_timer.c" 3 4
            *) ((u_char *) (
# 76 "project/nginx/src/event/ngx_event_timer.c"
...
ngx_event_no_timers_left(void)
{
    ...
    if (root == sentinel) {
        return 
# 109 "project/nginx/src/event/ngx_event_timer.c" 3 4
              0
# 109 "project/nginx/src/event/ngx_event_timer.c"
                    ;
    }
    ...
    {
        ev = 
# 116 "project/nginx/src/event/ngx_event_timer.c" 3 4
            (
# 116 "project/nginx/src/event/ngx_event_timer.c"
            ngx_event_t 
# 116 "project/nginx/src/event/ngx_event_timer.c" 3 4
            *) ((u_char *) (
# 116 "project/nginx/src/event/ngx_event_timer.c"
...
# 116 "project/nginx/src/event/ngx_event_timer.c"
        ...
        if (!ev->cancelable) {
            return 
# 119 "project/nginx/src/event/ngx_event_timer.c" 3 4
                  -2
# 119 "project/nginx/src/event/ngx_event_timer.c"
                           ;
        }
    }
    ...
    return 
# 125 "project/nginx/src/event/ngx_event_timer.c" 3 4
          0
# 125 "project/nginx/src/event/ngx_event_timer.c"
                ;
}
