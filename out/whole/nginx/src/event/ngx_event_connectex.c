# 0 "project/nginx/src/event/ngx_event_connectex.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/event/ngx_event_connectex.c" 2
...
# 10 "project/nginx/src/event/ngx_event_connectex.c" 2
...
# 11 "project/nginx/src/event/ngx_event_connectex.c" 2
...
# 16 "project/nginx/src/event/ngx_event_connectex.c"
static CRITICAL_SECTION connect_lock;
static int nconnects;
static ngx_connection_t pending_connects[10];
...
# 38 "project/nginx/src/event/ngx_event_connectex.c" 3 4
               if ((
# 38 "project/nginx/src/event/ngx_event_connectex.c"
               c->log
# 38 "project/nginx/src/event/ngx_event_connectex.c" 3 4
...
# 39 "project/nginx/src/event/ngx_event_connectex.c"
                                                 ;
                return 
# 40 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                      -1
# 40 "project/nginx/src/event/ngx_event_connectex.c"
                               ;
...
# 46 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       if ((
# 46 "project/nginx/src/event/ngx_event_connectex.c"
       c->log
# 46 "project/nginx/src/event/ngx_event_connectex.c" 3 4
...
# 46 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       , 
# 46 "project/nginx/src/event/ngx_event_connectex.c"
       0, "max number of pending connect()s is %d", 10
# 46 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )

                                           
# 48 "project/nginx/src/event/ngx_event_connectex.c"
                                          ;
        msleep(100);
    }

    if (!started) {
        if (ngx_iocp_new_thread(1) == 
# 53 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                                     -1
# 53 "project/nginx/src/event/ngx_event_connectex.c"
                                              ) {
            return 
# 54 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                  -1
# 54 "project/nginx/src/event/ngx_event_connectex.c"
                           ;
        }
        started = 1;
    }
    ...
    return 
# 59 "project/nginx/src/event/ngx_event_connectex.c" 3 4
          0
# 59 "project/nginx/src/event/ngx_event_connectex.c"
                ;
}
...
int ngx_iocp_new_thread(int main)
{
    ...
    if (main) {
        pending_connect_event = CreateEvent(
# 68 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                                           ((void *)0)
# 68 "project/nginx/src/event/ngx_event_connectex.c"
                                               , 0, 1, 
# 68 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                                                       ((void *)0)
# 68 "project/nginx/src/event/ngx_event_connectex.c"
...
# 70 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           if ((
# 70 "project/nginx/src/event/ngx_event_connectex.c"
           c->log
# 70 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 70 "project/nginx/src/event/ngx_event_connectex.c"
...
# 71 "project/nginx/src/event/ngx_event_connectex.c"
                                                 ;
            return 
# 72 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                  -1
# 72 "project/nginx/src/event/ngx_event_connectex.c"
                           ;
        }
    }

    if (CreateThread(
# 76 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                    ((void *)0)
# 76 "project/nginx/src/event/ngx_event_connectex.c"
                        , 0, ngx_iocp_wait_events, main, 0, &id)
                                                       == INVALID_HANDLE_VALUE)
    {
        
# 79 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       if ((
# 79 "project/nginx/src/event/ngx_event_connectex.c"
       c->log
# 79 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 79 "project/nginx/src/event/ngx_event_connectex.c"
...
# 80 "project/nginx/src/event/ngx_event_connectex.c"
                                             ;
        return 
# 81 "project/nginx/src/event/ngx_event_connectex.c" 3 4
              -1
# 81 "project/nginx/src/event/ngx_event_connectex.c"
                       ;
    }

    SetEvent(event) {
        
# 85 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       if ((
# 85 "project/nginx/src/event/ngx_event_connectex.c"
       c->log
# 85 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 85 "project/nginx/src/event/ngx_event_connectex.c"
...
# 86 "project/nginx/src/event/ngx_event_connectex.c"
                                         ;
        return 
# 87 "project/nginx/src/event/ngx_event_connectex.c" 3 4
              -1
# 87 "project/nginx/src/event/ngx_event_connectex.c"
                       ;
    }

    return 
# 90 "project/nginx/src/event/ngx_event_connectex.c" 3 4
          0
# 90 "project/nginx/src/event/ngx_event_connectex.c"
                ;
}
...
# 104 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       if ((
# 104 "project/nginx/src/event/ngx_event_connectex.c"
       c->log
# 104 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 104 "project/nginx/src/event/ngx_event_connectex.c"
...
# 105 "project/nginx/src/event/ngx_event_connectex.c"
                                               ;
        return 
# 106 "project/nginx/src/event/ngx_event_connectex.c" 3 4
              -1
# 106 "project/nginx/src/event/ngx_event_connectex.c"
                       ;
    }

    if (WSAEventSelect(c->fd, events[nevents], FD_CONNECT) == -1)
        
# 110 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       if ((
# 110 "project/nginx/src/event/ngx_event_connectex.c"
       c->log
# 110 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 110 "project/nginx/src/event/ngx_event_connectex.c"
...
# 111 "project/nginx/src/event/ngx_event_connectex.c"
                                               ;
        return 
# 112 "project/nginx/src/event/ngx_event_connectex.c" 3 4
              -1
# 112 "project/nginx/src/event/ngx_event_connectex.c"
                       ;
    }
    ...
    return 
# 117 "project/nginx/src/event/ngx_event_connectex.c" 3 4
          0
# 117 "project/nginx/src/event/ngx_event_connectex.c"
                ;
}
...
void ngx_iocp_wait_events(int main)
{
    ...
    conn[0] = 
# 127 "project/nginx/src/event/ngx_event_connectex.c" 3 4
             ((void *)0)
# 127 "project/nginx/src/event/ngx_event_connectex.c"
                 ;
...
# 136 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           if ((
# 136 "project/nginx/src/event/ngx_event_connectex.c"
           log
# 136 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 136 "project/nginx/src/event/ngx_event_connectex.c"
...
# 137 "project/nginx/src/event/ngx_event_connectex.c"
                                                             ;
            continue;
        }
...
# 146 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           if ((
# 146 "project/nginx/src/event/ngx_event_connectex.c"
           log
# 146 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 146 "project/nginx/src/event/ngx_event_connectex.c"
...
# 146 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           , 
# 146 "project/nginx/src/event/ngx_event_connectex.c"
           0, "WSAWaitForMultipleEvents() " "returned unexpected WAIT_TIMEOUT"
# 146 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           )

                                                             
# 148 "project/nginx/src/event/ngx_event_connectex.c"
                                                            ;
            continue;
        }
        ...
        if (events[n] == 
# 154 "project/nginx/src/event/ngx_event_connectex.c" 3 4
                        ((void *)0)
# 154 "project/nginx/src/event/ngx_event_connectex.c"
                            ) {
...
# 168 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           if ((
# 168 "project/nginx/src/event/ngx_event_connectex.c"
           log
# 168 "project/nginx/src/event/ngx_event_connectex.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 168 "project/nginx/src/event/ngx_event_connectex.c"
...
# 169 "project/nginx/src/event/ngx_event_connectex.c"
                                                         ;
            continue;
        }
...
# 179 "project/nginx/src/event/ngx_event_connectex.c" 3 4
               if ((
# 179 "project/nginx/src/event/ngx_event_connectex.c"
               log
# 179 "project/nginx/src/event/ngx_event_connectex.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 179 "project/nginx/src/event/ngx_event_connectex.c"
...
# 180 "project/nginx/src/event/ngx_event_connectex.c"
                                                                   ;
                continue;
            }
...
# 201 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       if ((
# 201 "project/nginx/src/event/ngx_event_connectex.c"
       c[n].log
# 201 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 201 "project/nginx/src/event/ngx_event_connectex.c"
...
# 201 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       , 
# 201 "project/nginx/src/event/ngx_event_connectex.c"
       0, "WSAWaitForMultipleEvents() " "returned unexpected network event %ul", ne.lNetworkEvents
# 201 "project/nginx/src/event/ngx_event_connectex.c" 3 4
       )


                                        
# 204 "project/nginx/src/event/ngx_event_connectex.c"
                                       ;
    }
}
