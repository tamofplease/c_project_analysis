# 0 "project/nginx/src/event/ngx_event_acceptex.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/ngx_event_acceptex.c"
...
# 9 "project/nginx/src/event/ngx_event_acceptex.c" 2
...
# 10 "project/nginx/src/event/ngx_event_acceptex.c" 2
...
# 11 "project/nginx/src/event/ngx_event_acceptex.c" 2



# 13 "project/nginx/src/event/ngx_event_acceptex.c"
...
# 30 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       if ((
# 30 "project/nginx/src/event/ngx_event_acceptex.c"
       c->log
# 30 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
...
# 30 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       , 
# 30 "project/nginx/src/event/ngx_event_acceptex.c"
       rev->ovlp.error, "AcceptEx() %V failed", &ls->addr_text
# 30 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       )
                                                             
# 31 "project/nginx/src/event/ngx_event_acceptex.c"
                                                            ;
        return;
    }
    ...
    if (setsockopt(c->fd, 
# 37 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                         0xffff
# 37 "project/nginx/src/event/ngx_event_acceptex.c"
                                   , SO_UPDATE_ACCEPT_CONTEXT,
                   (char *) &ls->fd, sizeof(ngx_socket_t))
        == -1)
    {
        
# 41 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       if ((
# 41 "project/nginx/src/event/ngx_event_acceptex.c"
       c->log
# 41 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 41 "project/nginx/src/event/ngx_event_acceptex.c"
...
# 43 "project/nginx/src/event/ngx_event_acceptex.c"
                                   ;
    ...
    if (ls->post_accept_buffer_size) {
        ...
        c->buffer = 
# 60 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                   ((void *)0)
# 60 "project/nginx/src/event/ngx_event_acceptex.c"
                       ;
    }
    ...
    if (ls->addr_ntop) {
        ...
        if (c->addr_text.data == 
# 65 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                                ((void *)0)
# 65 "project/nginx/src/event/ngx_event_acceptex.c"
                                    ) {
    ...
    c->number = 
# 81 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
               __sync_fetch_and_add(
# 81 "project/nginx/src/event/ngx_event_acceptex.c"
...
ngx_event_post_acceptex(ngx_listening_t *ls, ngx_uint_t n)
{
    ...
    for (i = 0; i < n; i++) {
        ...
        s = 
# 107 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
           socket
# 107 "project/nginx/src/event/ngx_event_acceptex.c"
                     (ls->sockaddr->sa_family, ls->type, 0);
...
# 113 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
           if ((
# 113 "project/nginx/src/event/ngx_event_acceptex.c"
           &ls->log
# 113 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
...
# 114 "project/nginx/src/event/ngx_event_acceptex.c"
                                                ;

            return 
# 116 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 116 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }
        ...
        if (c == 
# 121 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                ((void *)0)
# 121 "project/nginx/src/event/ngx_event_acceptex.c"
                    ) {
            return 
# 122 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 122 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }

        c->pool = ngx_create_pool(ls->pool_size, &ls->log);
        if (c->pool == 
# 126 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                      ((void *)0)
# 126 "project/nginx/src/event/ngx_event_acceptex.c"
                          ) {
            ngx_close_posted_connection(c);
            return 
# 128 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 128 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }

        log = ngx_palloc(c->pool, sizeof(ngx_log_t));
        if (log == 
# 132 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  ((void *)0)
# 132 "project/nginx/src/event/ngx_event_acceptex.c"
                      ) {
            ngx_close_posted_connection(c);
            return 
# 134 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 134 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }
        ...
        c->buffer = ngx_create_temp_buf(c->pool, ls->post_accept_buffer_size
                                                 + 2 * (ls->socklen + 16));
        if (c->buffer == 
# 139 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                        ((void *)0)
# 139 "project/nginx/src/event/ngx_event_acceptex.c"
                            ) {
            ngx_close_posted_connection(c);
            return 
# 141 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 141 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }

        c->local_sockaddr = ngx_palloc(c->pool, ls->socklen);
        if (c->local_sockaddr == 
# 145 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                                ((void *)0)
# 145 "project/nginx/src/event/ngx_event_acceptex.c"
                                    ) {
            ngx_close_posted_connection(c);
            return 
# 147 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 147 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }

        c->sockaddr = ngx_palloc(c->pool, ls->socklen);
        if (c->sockaddr == 
# 151 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                          ((void *)0)
# 151 "project/nginx/src/event/ngx_event_acceptex.c"
                              ) {
            ngx_close_posted_connection(c);
            return 
# 153 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 153 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }
        ...
        *log = ls->log;
        ...
        c->recv = 
# 159 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                 ngx_io.recv
# 159 "project/nginx/src/event/ngx_event_acceptex.c"
                         ;
        c->send = 
# 160 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                 ngx_io.send
# 160 "project/nginx/src/event/ngx_event_acceptex.c"
                         ;
        c->recv_chain = 
# 161 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                       ngx_io.recv_chain
# 161 "project/nginx/src/event/ngx_event_acceptex.c"
                                     ;
        c->send_chain = 
# 162 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                       ngx_io.send_chain
# 162 "project/nginx/src/event/ngx_event_acceptex.c"
                                     ;
        ...
        if (
# 179 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
           ngx_event_actions.add
# 179 "project/nginx/src/event/ngx_event_acceptex.c"
                        (rev, 0, NGX_IOCP_IO) == 
# 179 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                                                 -1
# 179 "project/nginx/src/event/ngx_event_acceptex.c"
            ...
            ngx_close_posted_connection(c);
            return 
# 181 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                  -1
# 181 "project/nginx/src/event/ngx_event_acceptex.c"
                           ;
        }
        ...
        {
            err = 
# 189 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                 (*__error())
# 189 "project/nginx/src/event/ngx_event_acceptex.c"
                                 ;
            if (err != WSA_IO_PENDING) {
                
# 191 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
               if ((
# 191 "project/nginx/src/event/ngx_event_acceptex.c"
               &ls->log
# 191 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 191 "project/nginx/src/event/ngx_event_acceptex.c"
...
# 191 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
               , 
# 191 "project/nginx/src/event/ngx_event_acceptex.c"
               err, "AcceptEx() %V failed", &ls->addr_text
# 191 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
               )
                                                                     
# 192 "project/nginx/src/event/ngx_event_acceptex.c"
                                                                    ;

                ngx_close_posted_connection(c);
                return 
# 195 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
                      -1
# 195 "project/nginx/src/event/ngx_event_acceptex.c"
                               ;
            }
        }
    }
    ...
    return 
# 200 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
          0
# 200 "project/nginx/src/event/ngx_event_acceptex.c"
                ;
}
...
ngx_close_posted_connection(ngx_connection_t *c)
{
    ...
    if (
# 214 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       close
# 214 "project/nginx/src/event/ngx_event_acceptex.c"
                       (fd) == -1) {
        
# 215 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       if ((
# 215 "project/nginx/src/event/ngx_event_acceptex.c"
       c->log
# 215 "project/nginx/src/event/ngx_event_acceptex.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 215 "project/nginx/src/event/ngx_event_acceptex.c"
...
# 216 "project/nginx/src/event/ngx_event_acceptex.c"
                                                  ;
    }
