# 0 "project/nginx/src/event/ngx_event_openssl_stapling.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/ngx_event_openssl_stapling.c"
...
# 9 "project/nginx/src/event/ngx_event_openssl_stapling.c" 2
...
# 10 "project/nginx/src/event/ngx_event_openssl_stapling.c" 2
...
# 11 "project/nginx/src/event/ngx_event_openssl_stapling.c" 2
...
# 12 "project/nginx/src/event/ngx_event_openssl_stapling.c" 2
# 2713 "project/nginx/src/event/ngx_event_openssl_stapling.c"
...
# 2717 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
   if ((
# 2717 "project/nginx/src/event/ngx_event_openssl_stapling.c"
   ssl->log
# 2717 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
...
# 2717 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
   , 
# 2717 "project/nginx/src/event/ngx_event_openssl_stapling.c"
   0, "\"ssl_stapling\" ignored, not supported"
# 2717 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
   )
                                                            
# 2718 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                                                           ;

    return 
# 2720 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          0
# 2720 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                ;
}
...
{
    return 
# 2728 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          0
# 2728 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                ;
}
...
# 2736 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
   if ((
# 2736 "project/nginx/src/event/ngx_event_openssl_stapling.c"
   ssl->log
# 2736 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
...
# 2736 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
   , 
# 2736 "project/nginx/src/event/ngx_event_openssl_stapling.c"
   0, "\"ssl_ocsp\" is not supported on this platform"
# 2736 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
   )
                                                                   
# 2737 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                                                                  ;

    return 
# 2739 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          -1
# 2739 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                   ;
}
...
{
    return 
# 2747 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          0
# 2747 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                ;
}
...
{
    return 
# 2754 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          0
# 2754 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                ;
}
...
{
    return 
# 2761 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          0
# 2761 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                ;
}
...
{
    return 
# 2774 "project/nginx/src/event/ngx_event_openssl_stapling.c" 3 4
          0
# 2774 "project/nginx/src/event/ngx_event_openssl_stapling.c"
                ;
}
