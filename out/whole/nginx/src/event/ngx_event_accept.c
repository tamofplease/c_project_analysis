# 0 "project/nginx/src/event/ngx_event_accept.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/event/ngx_event_accept.c"
...
# 9 "project/nginx/src/event/ngx_event_accept.c" 2
...
# 10 "project/nginx/src/event/ngx_event_accept.c" 2
...
# 11 "project/nginx/src/event/ngx_event_accept.c" 2



# 13 "project/nginx/src/event/ngx_event_accept.c"
...
# 35 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                                                  0
# 35 "project/nginx/src/event/ngx_event_accept.c"
                                                                        ) {
            return;
        }
    ...
    ecf = 
# 42 "project/nginx/src/event/ngx_event_accept.c" 3 4
         (*(
# 42 "project/nginx/src/event/ngx_event_accept.c"
         ngx_cycle->conf_ctx
# 42 "project/nginx/src/event/ngx_event_accept.c" 3 4
...
# 42 "project/nginx/src/event/ngx_event_accept.c"
    ...
    if (!(ngx_event_flags & 
# 44 "project/nginx/src/event/ngx_event_accept.c" 3 4
                           0x00000008
# 44 "project/nginx/src/event/ngx_event_accept.c"
                                               )) {
...
# 65 "project/nginx/src/event/ngx_event_accept.c"
        s = accept(lc->fd, &sa.sockaddr, &socklen);


        if (s == (ngx_socket_t) -1) {
            err = 
# 69 "project/nginx/src/event/ngx_event_accept.c" 3 4
                 (*__error())
# 69 "project/nginx/src/event/ngx_event_accept.c"
                                 ;

            if (err == 
# 71 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      35
# 71 "project/nginx/src/event/ngx_event_accept.c"
                                ) {
            ...
            level = 
# 77 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   2
# 77 "project/nginx/src/event/ngx_event_accept.c"
                                ;

            if (err == 
# 79 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      53
# 79 "project/nginx/src/event/ngx_event_accept.c"
                                      ) {
                level = 
# 80 "project/nginx/src/event/ngx_event_accept.c" 3 4
                       4
# 80 "project/nginx/src/event/ngx_event_accept.c"
                                  ;

            } else if (err == 
# 82 "project/nginx/src/event/ngx_event_accept.c" 3 4
                             24 
# 82 "project/nginx/src/event/ngx_event_accept.c"
                                        || err == 
# 82 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                                  23
# 82 "project/nginx/src/event/ngx_event_accept.c"
                ...
                level = 
# 83 "project/nginx/src/event/ngx_event_accept.c" 3 4
                       3
# 83 "project/nginx/src/event/ngx_event_accept.c"
                                   ;
            }
# 96 "project/nginx/src/event/ngx_event_accept.c"
            
# 96 "project/nginx/src/event/ngx_event_accept.c" 3 4
           if ((
# 96 "project/nginx/src/event/ngx_event_accept.c"
           ev->log
# 96 "project/nginx/src/event/ngx_event_accept.c" 3 4
...
# 96 "project/nginx/src/event/ngx_event_accept.c"
            ...
            if (err == 
# 99 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      53
# 99 "project/nginx/src/event/ngx_event_accept.c"
                                      ) {
                if (ngx_event_flags & 
# 100 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                     0x00000008
# 100 "project/nginx/src/event/ngx_event_accept.c"
                                                         ) {
                    ev->available--;
                }
            ...
            if (err == 
# 109 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      24 
# 109 "project/nginx/src/event/ngx_event_accept.c"
                                 || err == 
# 109 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                           23
# 109 "project/nginx/src/event/ngx_event_accept.c"
                ...
                if (ngx_disable_accept_events((ngx_cycle_t *) ngx_cycle, 1)
                    != 
# 111 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      0
# 111 "project/nginx/src/event/ngx_event_accept.c"
                            )
                {
                    return;
                }
...
# 125 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   ngx_event_add_timer
# 125 "project/nginx/src/event/ngx_event_accept.c"
                                (ev, ecf->accept_mutex_delay);
                }
            }
        ...
        if (c == 
# 141 "project/nginx/src/event/ngx_event_accept.c" 3 4
                ((void *)0)
# 141 "project/nginx/src/event/ngx_event_accept.c"
                    ) {
            if (
# 142 "project/nginx/src/event/ngx_event_accept.c" 3 4
               close
# 142 "project/nginx/src/event/ngx_event_accept.c"
                               (s) == -1) {
                
# 143 "project/nginx/src/event/ngx_event_accept.c" 3 4
               if ((
# 143 "project/nginx/src/event/ngx_event_accept.c"
               ev->log
# 143 "project/nginx/src/event/ngx_event_accept.c" 3 4
...
# 144 "project/nginx/src/event/ngx_event_accept.c"
                                                          ;
            }
        ...
        c->type = 
# 150 "project/nginx/src/event/ngx_event_accept.c" 3 4
                 1
# 150 "project/nginx/src/event/ngx_event_accept.c"
                            ;
        ...
        if (c->pool == 
# 157 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      ((void *)0)
# 157 "project/nginx/src/event/ngx_event_accept.c"
                          ) {
        ...
        if (c->sockaddr == 
# 167 "project/nginx/src/event/ngx_event_accept.c" 3 4
                          ((void *)0)
# 167 "project/nginx/src/event/ngx_event_accept.c"
                              ) {
            ngx_close_accepted_connection(c);
            return;
        }
...
# 172 "project/nginx/src/event/ngx_event_accept.c" 3 4
       (void) __builtin___memcpy_chk (
# 172 "project/nginx/src/event/ngx_event_accept.c"
       c->sockaddr
# 172 "project/nginx/src/event/ngx_event_accept.c" 3 4
       , 
# 172 "project/nginx/src/event/ngx_event_accept.c"
...
# 172 "project/nginx/src/event/ngx_event_accept.c"
        ...
        if (log == 
# 175 "project/nginx/src/event/ngx_event_accept.c" 3 4
                  ((void *)0)
# 175 "project/nginx/src/event/ngx_event_accept.c"
                      ) {
            ngx_close_accepted_connection(c);
            return;
        }
        ...
        if (ngx_inherited_nonblocking) {
            if (ngx_event_flags & 
# 183 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                 0x00000200
# 183 "project/nginx/src/event/ngx_event_accept.c"
                                                   ) {
                if (ngx_blocking(s) == -1) {
                    
# 185 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   if ((
# 185 "project/nginx/src/event/ngx_event_accept.c"
                   ev->log
# 185 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 185 "project/nginx/src/event/ngx_event_accept.c"
...
# 186 "project/nginx/src/event/ngx_event_accept.c"
                                                          ;
                    ngx_close_accepted_connection(c);
                    return;
                }
            ...
            if (!(ngx_event_flags & 
# 193 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                   0x00000200
# 193 "project/nginx/src/event/ngx_event_accept.c"
                                                     )) {
                if (ngx_nonblocking(s) == -1) {
                    
# 195 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   if ((
# 195 "project/nginx/src/event/ngx_event_accept.c"
                   ev->log
# 195 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 195 "project/nginx/src/event/ngx_event_accept.c"
...
# 196 "project/nginx/src/event/ngx_event_accept.c"
                                                             ;
                    ngx_close_accepted_connection(c);
                    return;
                }
        ...
        *log = ls->log;
        ...
        c->recv = 
# 205 "project/nginx/src/event/ngx_event_accept.c" 3 4
                 ngx_io.recv
# 205 "project/nginx/src/event/ngx_event_accept.c"
                         ;
        c->send = 
# 206 "project/nginx/src/event/ngx_event_accept.c" 3 4
                 ngx_io.send
# 206 "project/nginx/src/event/ngx_event_accept.c"
                         ;
        c->recv_chain = 
# 207 "project/nginx/src/event/ngx_event_accept.c" 3 4
                       ngx_io.recv_chain
# 207 "project/nginx/src/event/ngx_event_accept.c"
                                     ;
        c->send_chain = 
# 208 "project/nginx/src/event/ngx_event_accept.c" 3 4
                       ngx_io.send_chain
# 208 "project/nginx/src/event/ngx_event_accept.c"
                                     ;
...
# 219 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                     1
# 219 "project/nginx/src/event/ngx_event_accept.c"
                                            ) {
        ...
        if (ngx_event_flags & 
# 234 "project/nginx/src/event/ngx_event_accept.c" 3 4
                             0x00000200
# 234 "project/nginx/src/event/ngx_event_accept.c"
                                               ) {
            rev->ready = 1;
        }
        ...
        rev->log = log;
        wev->log = log;
# 257 "project/nginx/src/event/ngx_event_accept.c"
        c->number = 
# 257 "project/nginx/src/event/ngx_event_accept.c" 3 4
...
# 257 "project/nginx/src/event/ngx_event_accept.c"
        ...
        if (ls->addr_ntop) {
            ...
            if (c->addr_text.data == 
# 267 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                    ((void *)0)
# 267 "project/nginx/src/event/ngx_event_accept.c"
                                        ) {
                ngx_close_accepted_connection(c);
                return;
            }
...
# 300 "project/nginx/src/event/ngx_event_accept.c"
        if (
# 300 "project/nginx/src/event/ngx_event_accept.c" 3 4
...
# 300 "project/nginx/src/event/ngx_event_accept.c"
            ...
            if (
# 301 "project/nginx/src/event/ngx_event_accept.c" 3 4
               ngx_event_actions.add_conn
# 301 "project/nginx/src/event/ngx_event_accept.c"
                           (c) == 
# 301 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                  -1
# 301 "project/nginx/src/event/ngx_event_accept.c"
        ...
        log->data = 
# 307 "project/nginx/src/event/ngx_event_accept.c" 3 4
                   ((void *)0)
# 307 "project/nginx/src/event/ngx_event_accept.c"
                       ;
        log->handler = 
# 308 "project/nginx/src/event/ngx_event_accept.c" 3 4
                      ((void *)0)
# 308 "project/nginx/src/event/ngx_event_accept.c"
                          ;

        ls->handler(c);

        if (ngx_event_flags & 
# 312 "project/nginx/src/event/ngx_event_accept.c" 3 4
                             0x00000008
# 312 "project/nginx/src/event/ngx_event_accept.c"
                                                 ) {
            ev->available--;
        }
...
ngx_trylock_accept_mutex(ngx_cycle_t *cycle)
{
    if (ngx_shmtx_trylock(&ngx_accept_mutex)) {
        ...
        if (ngx_accept_mutex_held && ngx_accept_events == 0) {
            return 
# 329 "project/nginx/src/event/ngx_event_accept.c" 3 4
                  0
# 329 "project/nginx/src/event/ngx_event_accept.c"
                        ;
        }

        if (ngx_enable_accept_events(cycle) == 
# 332 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                              -1
# 332 "project/nginx/src/event/ngx_event_accept.c"
                                                       ) {
            ngx_shmtx_unlock(&ngx_accept_mutex);
            return 
# 334 "project/nginx/src/event/ngx_event_accept.c" 3 4
                  -1
# 334 "project/nginx/src/event/ngx_event_accept.c"
                           ;
        }
        ...
        return 
# 340 "project/nginx/src/event/ngx_event_accept.c" 3 4
              0
# 340 "project/nginx/src/event/ngx_event_accept.c"
                    ;
    }
    ...
    if (ngx_accept_mutex_held) {
        if (ngx_disable_accept_events(cycle, 0) == 
# 347 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                                  -1
# 347 "project/nginx/src/event/ngx_event_accept.c"
                                                           ) {
            return 
# 348 "project/nginx/src/event/ngx_event_accept.c" 3 4
                  -1
# 348 "project/nginx/src/event/ngx_event_accept.c"
                           ;
        }
    ...
    return 
# 354 "project/nginx/src/event/ngx_event_accept.c" 3 4
          0
# 354 "project/nginx/src/event/ngx_event_accept.c"
                ;
}
...
ngx_enable_accept_events(ngx_cycle_t *cycle)
{
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ...
        if (c == 
# 370 "project/nginx/src/event/ngx_event_accept.c" 3 4
                ((void *)0) 
# 370 "project/nginx/src/event/ngx_event_accept.c"
                     || c->read->active) {
            continue;
        }

        if (
# 374 "project/nginx/src/event/ngx_event_accept.c" 3 4
           ngx_event_actions.add
# 374 "project/nginx/src/event/ngx_event_accept.c"
                        (c->read, 
# 374 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                  (-1)
# 374 "project/nginx/src/event/ngx_event_accept.c"
...
# 374 "project/nginx/src/event/ngx_event_accept.c"
            ...
            return 
# 375 "project/nginx/src/event/ngx_event_accept.c" 3 4
                  -1
# 375 "project/nginx/src/event/ngx_event_accept.c"
                           ;
        }
    }

    return 
# 379 "project/nginx/src/event/ngx_event_accept.c" 3 4
          0
# 379 "project/nginx/src/event/ngx_event_accept.c"
                ;
}
...
ngx_disable_accept_events(ngx_cycle_t *cycle, ngx_uint_t all)
{
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ...
        if (c == 
# 395 "project/nginx/src/event/ngx_event_accept.c" 3 4
                ((void *)0) 
# 395 "project/nginx/src/event/ngx_event_accept.c"
                     || !c->read->active) {
            continue;
        }
# 406 "project/nginx/src/event/ngx_event_accept.c"
        ...
        if (
# 412 "project/nginx/src/event/ngx_event_accept.c" 3 4
           ngx_event_actions.del
# 412 "project/nginx/src/event/ngx_event_accept.c"
                        (c->read, 
# 412 "project/nginx/src/event/ngx_event_accept.c" 3 4
                                  (-1)
# 412 "project/nginx/src/event/ngx_event_accept.c"
...
# 412 "project/nginx/src/event/ngx_event_accept.c"
            ...
            == 
# 413 "project/nginx/src/event/ngx_event_accept.c" 3 4
              -1
# 413 "project/nginx/src/event/ngx_event_accept.c"
                       )
        {
            return 
# 415 "project/nginx/src/event/ngx_event_accept.c" 3 4
                  -1
# 415 "project/nginx/src/event/ngx_event_accept.c"
                           ;
        }
    }

    return 
# 419 "project/nginx/src/event/ngx_event_accept.c" 3 4
          0
# 419 "project/nginx/src/event/ngx_event_accept.c"
                ;
}
...
ngx_close_accepted_connection(ngx_connection_t *c)
{
    ...
    if (
# 433 "project/nginx/src/event/ngx_event_accept.c" 3 4
       close
# 433 "project/nginx/src/event/ngx_event_accept.c"
                       (fd) == -1) {
        
# 434 "project/nginx/src/event/ngx_event_accept.c" 3 4
       if ((
# 434 "project/nginx/src/event/ngx_event_accept.c"
       c->log
# 434 "project/nginx/src/event/ngx_event_accept.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 434 "project/nginx/src/event/ngx_event_accept.c"
...
# 435 "project/nginx/src/event/ngx_event_accept.c"
                                                  ;
    }
