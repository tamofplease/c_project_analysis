# 0 "project/nginx/src/stream/ngx_stream_realip_module.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 9 "project/nginx/src/stream/ngx_stream_realip_module.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_realip_module.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_realip_module.c" 2



# 13 "project/nginx/src/stream/ngx_stream_realip_module.c"
typedef struct {
    ngx_array_t *from;
...
static ngx_command_t ngx_stream_realip_commands[] = {
    ...
    { 
# 45 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     { sizeof(
# 45 "project/nginx/src/stream/ngx_stream_realip_module.c"
     "set_real_ip_from"
# 45 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 45 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 46 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     0x02000000
# 46 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         |
# 46 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                          0x04000000
# 46 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 48 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     __builtin_offsetof (ngx_stream_conf_ctx_t, srv_conf)
# 48 "project/nginx/src/stream/ngx_stream_realip_module.c"
                               ,
      0,
      
# 50 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     ((void *)0) 
# 50 "project/nginx/src/stream/ngx_stream_realip_module.c"
          },

      
# 52 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 53 "project/nginx/src/stream/ngx_stream_realip_module.c"
};
...
# 60 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 61 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 61 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,

    ngx_stream_realip_create_srv_conf,
...
# 69 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 69 "project/nginx/src/stream/ngx_stream_realip_module.c"
   "8" 
# 69 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   "," 
# 69 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 69 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ,
    &ngx_stream_realip_module_ctx,
    ngx_stream_realip_commands,
    
# 72 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   0x4d525453
# 72 "project/nginx/src/stream/ngx_stream_realip_module.c"
                    ,
    
# 73 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 73 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 74 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 74 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 75 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 75 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 76 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 76 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 77 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 77 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 78 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 78 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 79 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ((void *)0)
# 79 "project/nginx/src/stream/ngx_stream_realip_module.c"
       ,
    
# 80 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 81 "project/nginx/src/stream/ngx_stream_realip_module.c"
};
...
static ngx_stream_variable_t ngx_stream_realip_vars[] = {
    ...
    { 
# 86 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     { sizeof(
# 86 "project/nginx/src/stream/ngx_stream_realip_module.c"
     "realip_remote_addr"
# 86 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 86 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 86 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    { 
# 89 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     { sizeof(
# 89 "project/nginx/src/stream/ngx_stream_realip_module.c"
     "realip_remote_port"
# 89 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     ) - 1, (u_char *) 
# 89 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 92 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 93 "project/nginx/src/stream/ngx_stream_realip_module.c"
};
...
ngx_stream_realip_handler(ngx_stream_session_t *s)
{
    ...
    rscf = 
# 103 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          (
# 103 "project/nginx/src/stream/ngx_stream_realip_module.c"
          s
# 103 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          )->srv_conf[
# 103 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 103 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    if (rscf->from == 
# 105 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                     ((void *)0)
# 105 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         ) {
        return 
# 106 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -5
# 106 "project/nginx/src/stream/ngx_stream_realip_module.c"
                          ;
    }
    ...
    if (c->proxy_protocol == 
# 111 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                            ((void *)0)
# 111 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                ) {
        return 
# 112 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -5
# 112 "project/nginx/src/stream/ngx_stream_realip_module.c"
                          ;
    }

    if (ngx_cidr_match(c->sockaddr, rscf->from) != 
# 115 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                                                  0
# 115 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                                        ) {
        return 
# 116 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -5
# 116 "project/nginx/src/stream/ngx_stream_realip_module.c"
                          ;
    }
    ...
    if (ngx_parse_addr(c->pool, &addr, c->proxy_protocol->src_addr.data,
        ...
        != 
# 121 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          0
# 121 "project/nginx/src/stream/ngx_stream_realip_module.c"
                )
    {
        return 
# 123 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -5
# 123 "project/nginx/src/stream/ngx_stream_realip_module.c"
                          ;
    }
...
ngx_stream_realip_set_addr(ngx_stream_session_t *s, ngx_addr_t *addr)
{
    ...
    u_char *p;
    u_char text[
# 137 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                                  (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 137 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                                     ];
    ngx_connection_t *c;
    ...
    if (ctx == 
# 144 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              ((void *)0)
# 144 "project/nginx/src/stream/ngx_stream_realip_module.c"
                  ) {
        return 
# 145 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -1
# 145 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ;
    }

    len = ngx_sock_ntop(addr->sockaddr, addr->socklen, text,
                        
# 149 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                       (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 149 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                          , 0);
    if (len == 0) {
        return 
# 151 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -1
# 151 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ;
    }

    p = ngx_pnalloc(c->pool, len);
    if (p == 
# 155 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
            ((void *)0)
# 155 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ) {
        return 
# 156 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -1
# 156 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ;
    }

    
# 159 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 159 "project/nginx/src/stream/ngx_stream_realip_module.c"
   p
# 159 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   , 
# 159 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 159 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    s
# 161 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   ->ctx[
# 161 "project/nginx/src/stream/ngx_stream_realip_module.c"
   ngx_stream_realip_module
# 161 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   .ctx_index] = 
# 161 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 161 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    return 
# 172 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          -5
# 172 "project/nginx/src/stream/ngx_stream_realip_module.c"
                      ;
}
...
ngx_stream_realip_from(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (rscf->from == 
# 193 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                     ((void *)0)
# 193 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         ) {
        rscf->from = ngx_array_create(cf->pool, 2,
                                      sizeof(ngx_cidr_t));
        if (rscf->from == 
# 196 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                         ((void *)0)
# 196 "project/nginx/src/stream/ngx_stream_realip_module.c"
                             ) {
            return 
# 197 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                  (void *) -1
# 197 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                ;
        }
    }
    ...
    if (
# 203 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
       strcmp((const char *) 
# 203 "project/nginx/src/stream/ngx_stream_realip_module.c"
       value[1].data
# 203 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
       , (const char *) 
# 203 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 203 "project/nginx/src/stream/ngx_stream_realip_module.c"
        ...
        if (cidr == 
# 205 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                   ((void *)0)
# 205 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ) {
            return 
# 206 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                  (void *) -1
# 206 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                ;
        }

        cidr->family = 
# 209 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                      1
# 209 "project/nginx/src/stream/ngx_stream_realip_module.c"
                             ;
        return 
# 210 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              ((void *)0)
# 210 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         ;
    }
    ...
    if (rc != 
# 217 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
             -1
# 217 "project/nginx/src/stream/ngx_stream_realip_module.c"
                      ) {
        if (rc == 
# 218 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                 -4
# 218 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         ) {
            ngx_conf_log_error(
# 219 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                              5
# 219 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                          , cf, 0,
        ...
        cidr = ngx_array_push(rscf->from);
        if (cidr == 
# 225 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                   ((void *)0)
# 225 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ) {
            return 
# 226 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                  (void *) -1
# 226 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                ;
        }
        ...
        *cidr = c;
        ...
        return 
# 231 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              ((void *)0)
# 231 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         ;
    }

    
# 234 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   (void) __builtin___memset_chk (
# 234 "project/nginx/src/stream/ngx_stream_realip_module.c"
   &u
# 234 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   , 0, 
# 234 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 234 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    if (ngx_inet_resolve_host(cf->pool, &u) != 
# 237 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                                              0
# 237 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                                    ) {
        if (u.err) {
            ngx_conf_log_error(
# 239 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                              1
# 239 "project/nginx/src/stream/ngx_stream_realip_module.c"
                                           , cf, 0,
        ...
        return 
# 244 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              (void *) -1
# 244 "project/nginx/src/stream/ngx_stream_realip_module.c"
                            ;
    }

    cidr = ngx_array_push_n(rscf->from, u.naddrs);
    if (cidr == 
# 248 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
               ((void *)0)
# 248 "project/nginx/src/stream/ngx_stream_realip_module.c"
                   ) {
        return 
# 249 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              (void *) -1
# 249 "project/nginx/src/stream/ngx_stream_realip_module.c"
                            ;
    }

    
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   (void) __builtin___memset_chk (
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c"
   cidr
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   , 0, 
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c"
   u.naddrs * sizeof(ngx_cidr_t)
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
   , __builtin_object_size (
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c"
   cidr
...
# 252 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    for (i = 0; i < u.naddrs; i++) {
        ...
        case 
# 260 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
            30
# 260 "project/nginx/src/stream/ngx_stream_realip_module.c"
                    :
            sin6 = (struct sockaddr_in6 *) u.addrs[i].sockaddr;
            cidr[i].u.in6.addr = sin6->sin6_addr;
            
# 263 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
           (void) __builtin___memset_chk (
# 263 "project/nginx/src/stream/ngx_stream_realip_module.c"
           cidr[i].u.in6.mask.
# 263 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
...
# 263 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    return 
# 275 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          ((void *)0)
# 275 "project/nginx/src/stream/ngx_stream_realip_module.c"
                     ;
}
...
ngx_stream_realip_create_srv_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 285 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
               ((void *)0)
# 285 "project/nginx/src/stream/ngx_stream_realip_module.c"
                   ) {
        return 
# 286 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              ((void *)0)
# 286 "project/nginx/src/stream/ngx_stream_realip_module.c"
                  ;
    }
...
ngx_stream_realip_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->from == 
# 305 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                     ((void *)0)
# 305 "project/nginx/src/stream/ngx_stream_realip_module.c"
                         ) {
        conf->from = prev->from;
    }

    return 
# 309 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          ((void *)0)
# 309 "project/nginx/src/stream/ngx_stream_realip_module.c"
                     ;
}
...
ngx_stream_realip_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_stream_realip_vars; v->name.len; v++) {
        ...
        if (var == 
# 320 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                  ((void *)0)
# 320 "project/nginx/src/stream/ngx_stream_realip_module.c"
                      ) {
            return 
# 321 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                  -1
# 321 "project/nginx/src/stream/ngx_stream_realip_module.c"
                           ;
        }
    ...
    return 
# 328 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          0
# 328 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ;
}
...
ngx_stream_realip_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 338 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 338 "project/nginx/src/stream/ngx_stream_realip_module.c"
          cf
# 338 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          ->ctx)->main_conf[
# 338 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 338 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    if (h == 
# 341 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
            ((void *)0)
# 341 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ) {
        return 
# 342 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -1
# 342 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ;
    }
    ...
    *h = ngx_stream_realip_handler;
    ...
    return 
# 347 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          0
# 347 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    ctx = 
# 358 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
         (
# 358 "project/nginx/src/stream/ngx_stream_realip_module.c"
         s
# 358 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
         )->ctx[
# 358 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 358 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    return 
# 368 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          0
# 368 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    ctx = 
# 380 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
         (
# 380 "project/nginx/src/stream/ngx_stream_realip_module.c"
         s
# 380 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
         )->ctx[
# 380 "project/nginx/src/stream/ngx_stream_realip_module.c"
...
# 380 "project/nginx/src/stream/ngx_stream_realip_module.c"
    ...
    if (v->data == 
# 390 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
                  ((void *)0)
# 390 "project/nginx/src/stream/ngx_stream_realip_module.c"
                      ) {
        return 
# 391 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
              -1
# 391 "project/nginx/src/stream/ngx_stream_realip_module.c"
                       ;
    }
    ...
    return 
# 400 "project/nginx/src/stream/ngx_stream_realip_module.c" 3 4
          0
# 400 "project/nginx/src/stream/ngx_stream_realip_module.c"
                ;
}
