# 0 "project/nginx/src/stream/ngx_stream_variables.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 9 "project/nginx/src/stream/ngx_stream_variables.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_variables.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_variables.c" 2



# 13 "project/nginx/src/stream/ngx_stream_variables.c"
...
static ngx_stream_variable_t ngx_stream_core_variables[] = {
    ...
    { 
# 57 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 57 "project/nginx/src/stream/ngx_stream_variables.c"
     "binary_remote_addr"
# 57 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 57 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 57 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 60 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 60 "project/nginx/src/stream/ngx_stream_variables.c"
     "remote_addr"
# 60 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 60 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 60 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 63 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 63 "project/nginx/src/stream/ngx_stream_variables.c"
     "remote_port"
# 63 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 63 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 63 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 66 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 66 "project/nginx/src/stream/ngx_stream_variables.c"
     "proxy_protocol_addr"
# 66 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 66 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 68 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     __builtin_offsetof (
# 68 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 68 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 70 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 70 "project/nginx/src/stream/ngx_stream_variables.c"
     "proxy_protocol_port"
# 70 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 70 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 72 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     __builtin_offsetof (
# 72 "project/nginx/src/stream/ngx_stream_variables.c"
     ngx_proxy_protocol_t
# 72 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     , 
# 72 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 72 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 74 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 74 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 76 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     __builtin_offsetof (
# 76 "project/nginx/src/stream/ngx_stream_variables.c"
     ngx_proxy_protocol_t
# 76 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     , 
# 76 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 76 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 78 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 78 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 80 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     __builtin_offsetof (
# 80 "project/nginx/src/stream/ngx_stream_variables.c"
     ngx_proxy_protocol_t
# 80 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     , 
# 80 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 80 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 82 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 82 "project/nginx/src/stream/ngx_stream_variables.c"
     "server_addr"
# 82 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 82 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 82 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 85 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 85 "project/nginx/src/stream/ngx_stream_variables.c"
     "server_port"
# 85 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 85 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 85 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 88 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 88 "project/nginx/src/stream/ngx_stream_variables.c"
     "bytes_sent"
# 88 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 88 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 88 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                               ((void *)0)
# 88 "project/nginx/src/stream/ngx_stream_variables.c"
                                   , ngx_stream_variable_bytes,
      0, 0, 0 },

    { 
# 91 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 91 "project/nginx/src/stream/ngx_stream_variables.c"
     "bytes_received"
# 91 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 91 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 91 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 94 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 94 "project/nginx/src/stream/ngx_stream_variables.c"
     "session_time"
# 94 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 94 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 94 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                 ((void *)0)
# 94 "project/nginx/src/stream/ngx_stream_variables.c"
                                     , ngx_stream_variable_session_time,
      0, 
# 95 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        2
# 95 "project/nginx/src/stream/ngx_stream_variables.c"
                                  , 0 },

    { 
# 97 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 97 "project/nginx/src/stream/ngx_stream_variables.c"
     "status"
# 97 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 97 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 97 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                           ((void *)0)
# 97 "project/nginx/src/stream/ngx_stream_variables.c"
                               , ngx_stream_variable_status,
      0, 
# 98 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        2
# 98 "project/nginx/src/stream/ngx_stream_variables.c"
                                  , 0 },

    { 
# 100 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 100 "project/nginx/src/stream/ngx_stream_variables.c"
     "connection"
# 100 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 100 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 100 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 103 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 103 "project/nginx/src/stream/ngx_stream_variables.c"
     "nginx_version"
# 103 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 103 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 103 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    { 
# 106 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 106 "project/nginx/src/stream/ngx_stream_variables.c"
     "hostname"
# 106 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 106 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 106 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                             ((void *)0)
# 106 "project/nginx/src/stream/ngx_stream_variables.c"
                                 , ngx_stream_variable_hostname,
      0, 0, 0 },

    { 
# 109 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 109 "project/nginx/src/stream/ngx_stream_variables.c"
     "pid"
# 109 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 109 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 109 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                        ((void *)0)
# 109 "project/nginx/src/stream/ngx_stream_variables.c"
                            , ngx_stream_variable_pid,
      0, 0, 0 },

    { 
# 112 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 112 "project/nginx/src/stream/ngx_stream_variables.c"
     "msec"
# 112 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 112 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 112 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                         ((void *)0)
# 112 "project/nginx/src/stream/ngx_stream_variables.c"
                             , ngx_stream_variable_msec,
      0, 
# 113 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        2
# 113 "project/nginx/src/stream/ngx_stream_variables.c"
                                  , 0 },

    { 
# 115 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 115 "project/nginx/src/stream/ngx_stream_variables.c"
     "time_iso8601"
# 115 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 115 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 115 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                 ((void *)0)
# 115 "project/nginx/src/stream/ngx_stream_variables.c"
                                     , ngx_stream_variable_time_iso8601,
      0, 
# 116 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        2
# 116 "project/nginx/src/stream/ngx_stream_variables.c"
                                  , 0 },

    { 
# 118 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 118 "project/nginx/src/stream/ngx_stream_variables.c"
     "time_local"
# 118 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 118 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 118 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                               ((void *)0)
# 118 "project/nginx/src/stream/ngx_stream_variables.c"
                                   , ngx_stream_variable_time_local,
      0, 
# 119 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        2
# 119 "project/nginx/src/stream/ngx_stream_variables.c"
                                  , 0 },

    { 
# 121 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { sizeof(
# 121 "project/nginx/src/stream/ngx_stream_variables.c"
     "protocol"
# 121 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     ) - 1, (u_char *) 
# 121 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 124 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 125 "project/nginx/src/stream/ngx_stream_variables.c"
};


ngx_stream_variable_value_t ngx_stream_variable_null_value =
    
# 129 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   { sizeof(
# 129 "project/nginx/src/stream/ngx_stream_variables.c"
   ""
# 129 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   ) - 1, 1, 0, 0, 0, (u_char *) 
# 129 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 131 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   { sizeof(
# 131 "project/nginx/src/stream/ngx_stream_variables.c"
   "1"
# 131 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   ) - 1, 1, 0, 0, 0, (u_char *) 
# 131 "project/nginx/src/stream/ngx_stream_variables.c"
...
ngx_stream_add_variable(ngx_conf_t *cf, ngx_str_t *name, ngx_uint_t flags)
{
    ...
    if (name->len == 0) {
        ngx_conf_log_error(
# 147 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          1
# 147 "project/nginx/src/stream/ngx_stream_variables.c"
                                       , cf, 0,
                           "invalid variable name \"$\"");
        return 
# 149 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 149 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }

    if (flags & 
# 152 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
               32
# 152 "project/nginx/src/stream/ngx_stream_variables.c"
                                    ) {
        return ngx_stream_add_prefix_variable(cf, name, flags);
    }

    cmcf = 
# 156 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 156 "project/nginx/src/stream/ngx_stream_variables.c"
          cf
# 156 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ->ctx)->main_conf[
# 156 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 156 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    for (i = 0; i < cmcf->variables_keys->keys.nelts; i++) {
        ...
        if (!(v->flags & 
# 168 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                        1
# 168 "project/nginx/src/stream/ngx_stream_variables.c"
                                                 )) {
            ngx_conf_log_error(
# 169 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                              1
# 169 "project/nginx/src/stream/ngx_stream_variables.c"
                                           , cf, 0,
                               "the duplicate \"%V\" variable", name);
            return 
# 171 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 171 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }

        if (!(flags & 
# 174 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                     16
# 174 "project/nginx/src/stream/ngx_stream_variables.c"
                                        )) {
            v->flags &= ~
# 175 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                        16
# 175 "project/nginx/src/stream/ngx_stream_variables.c"
                                           ;
        }
    ...
    if (v == 
# 182 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 182 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 183 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 183 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    if (v->name.data == 
# 188 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                       ((void *)0)
# 188 "project/nginx/src/stream/ngx_stream_variables.c"
                           ) {
        return 
# 189 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 189 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    v->set_handler = 
# 194 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 194 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;
    v->get_handler = 
# 195 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 195 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;
    v->data = 0;
    v->flags = flags;
    v->index = 0;
    ...
    if (rc == 
# 202 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             -1
# 202 "project/nginx/src/stream/ngx_stream_variables.c"
                      ) {
        return 
# 203 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 203 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }

    if (rc == 
# 206 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             -3
# 206 "project/nginx/src/stream/ngx_stream_variables.c"
                     ) {
        ngx_conf_log_error(
# 207 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          1
# 207 "project/nginx/src/stream/ngx_stream_variables.c"
                                       , cf, 0,
                           "conflicting variable name \"%V\"", name);
        return 
# 209 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 209 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    ngx_uint_t flags)
{
    ...
    cmcf = 
# 224 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 224 "project/nginx/src/stream/ngx_stream_variables.c"
          cf
# 224 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ->ctx)->main_conf[
# 224 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 224 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    for (i = 0; i < cmcf->prefix_variables.nelts; i++) {
        ...
        if (!(v->flags & 
# 236 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                        1
# 236 "project/nginx/src/stream/ngx_stream_variables.c"
                                                 )) {
            ngx_conf_log_error(
# 237 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                              1
# 237 "project/nginx/src/stream/ngx_stream_variables.c"
                                           , cf, 0,
                               "the duplicate \"%V\" variable", name);
            return 
# 239 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 239 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }

        if (!(flags & 
# 242 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                     16
# 242 "project/nginx/src/stream/ngx_stream_variables.c"
                                        )) {
            v->flags &= ~
# 243 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                        16
# 243 "project/nginx/src/stream/ngx_stream_variables.c"
                                           ;
        }
    ...
    if (v == 
# 250 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 250 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 251 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 251 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    v->name.data = ngx_pnalloc(cf->pool, name->len);
    if (v->name.data == 
# 256 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                       ((void *)0)
# 256 "project/nginx/src/stream/ngx_stream_variables.c"
                           ) {
        return 
# 257 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 257 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    v->set_handler = 
# 262 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 262 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;
    v->get_handler = 
# 263 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 263 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;
    v->data = 0;
    v->flags = flags;
    v->index = 0;
...
ngx_stream_get_variable_index(ngx_conf_t *cf, ngx_str_t *name)
{
    ...
    if (name->len == 0) {
        ngx_conf_log_error(
# 280 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          1
# 280 "project/nginx/src/stream/ngx_stream_variables.c"
                                       , cf, 0,
                           "invalid variable name \"$\"");
        return 
# 282 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 282 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    cmcf = 
# 285 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 285 "project/nginx/src/stream/ngx_stream_variables.c"
          cf
# 285 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ->ctx)->main_conf[
# 285 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 285 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    if (v == 
# 289 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 289 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        if (ngx_array_init(&cmcf->variables, cf->pool, 4,
                           sizeof(ngx_stream_variable_t))
            != 
# 292 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              0
# 292 "project/nginx/src/stream/ngx_stream_variables.c"
                    )
        {
            return 
# 294 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  -1
# 294 "project/nginx/src/stream/ngx_stream_variables.c"
                           ;
        }
    ...
    if (v == 
# 310 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 310 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 311 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 311 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    v->name.data = ngx_pnalloc(cf->pool, name->len);
    if (v->name.data == 
# 316 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                       ((void *)0)
# 316 "project/nginx/src/stream/ngx_stream_variables.c"
                           ) {
        return 
# 317 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 317 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    v->set_handler = 
# 322 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 322 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;
    v->get_handler = 
# 323 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 323 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;
    v->data = 0;
    v->flags = 0;
...
ngx_stream_get_indexed_variable(ngx_stream_session_t *s, ngx_uint_t index)
{
    ...
    cmcf = 
# 338 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          (
# 338 "project/nginx/src/stream/ngx_stream_variables.c"
          s
# 338 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          )->main_conf[
# 338 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 341 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
       if ((
# 341 "project/nginx/src/stream/ngx_stream_variables.c"
       s->connection->log
# 341 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
...
# 342 "project/nginx/src/stream/ngx_stream_variables.c"
                                                          ;
        return 
# 343 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 343 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
...
# 353 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
       if ((
# 353 "project/nginx/src/stream/ngx_stream_variables.c"
       s->connection->log
# 353 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
...
# 355 "project/nginx/src/stream/ngx_stream_variables.c"
                                    ;
        return 
# 356 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 356 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    if (v[index].get_handler(s, &s->variables[index], v[index].data)
        == 
# 362 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 362 "project/nginx/src/stream/ngx_stream_variables.c"
                )
    {
        ngx_stream_variable_depth++;

        if (v[index].flags & 
# 366 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                            2
# 366 "project/nginx/src/stream/ngx_stream_variables.c"
                                                      ) {
    ...
    return 
# 378 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((void *)0)
# 378 "project/nginx/src/stream/ngx_stream_variables.c"
              ;
}
    ...
    ngx_uint_t key)
{
    ...
    cmcf = 
# 412 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          (
# 412 "project/nginx/src/stream/ngx_stream_variables.c"
          s
# 412 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          )->main_conf[
# 412 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 412 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    if (v) {
        if (v->flags & 
# 417 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                      4
# 417 "project/nginx/src/stream/ngx_stream_variables.c"
                                            ) {
...
# 422 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
           if ((
# 422 "project/nginx/src/stream/ngx_stream_variables.c"
           s->connection->log
# 422 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 422 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 423 "project/nginx/src/stream/ngx_stream_variables.c"
                                                                        ;
            return 
# 424 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 424 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }
        ...
        if (vv && v->get_handler(s, vv, v->data) == 
# 432 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                   0
# 432 "project/nginx/src/stream/ngx_stream_variables.c"
                                                         ) {
            ngx_stream_variable_depth++;
            return vv;
        }
        ...
        ngx_stream_variable_depth++;
        return 
# 438 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 438 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }

    vv = ngx_palloc(s->connection->pool, sizeof(ngx_stream_variable_value_t));
    if (vv == 
# 442 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             ((void *)0)
# 442 "project/nginx/src/stream/ngx_stream_variables.c"
                 ) {
        return 
# 443 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 443 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    for (i = 0; i < cmcf->prefix_variables.nelts; i++) {
        if (name->len >= v[i].name.len && name->len > len
            && 
# 453 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              strncmp((const char *) 
# 453 "project/nginx/src/stream/ngx_stream_variables.c"
              name->data
# 453 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              , (const char *) 
# 453 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 453 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    if (n != cmcf->prefix_variables.nelts) {
        if (v[n].get_handler(s, vv, (uintptr_t) name) == 
# 461 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                        0
# 461 "project/nginx/src/stream/ngx_stream_variables.c"
                                                              ) {
            return vv;
        }

        return 
# 465 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 465 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
     ...
     ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    case 
# 486 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        30
# 486 "project/nginx/src/stream/ngx_stream_variables.c"
                :
...
# 493 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                 __u6_addr.__u6_addr8
# 493 "project/nginx/src/stream/ngx_stream_variables.c"
                                        ;
    ...
    case 
# 499 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        1
# 499 "project/nginx/src/stream/ngx_stream_variables.c"
               :
    ...
    return 
# 522 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 522 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    return 
# 536 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 536 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (v->data == 
# 552 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 552 "project/nginx/src/stream/ngx_stream_variables.c"
                      ) {
        return 
# 553 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 553 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 562 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 562 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (pp == 
# 574 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             ((void *)0)
# 574 "project/nginx/src/stream/ngx_stream_variables.c"
                 ) {
        v->not_found = 1;
        return 
# 576 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              0
# 576 "project/nginx/src/stream/ngx_stream_variables.c"
                    ;
    }
    ...
    return 
# 587 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 587 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    pp = s->connection->proxy_protocol;
    if (pp == 
# 599 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             ((void *)0)
# 599 "project/nginx/src/stream/ngx_stream_variables.c"
                 ) {
        v->not_found = 1;
        return 
# 601 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              0
# 601 "project/nginx/src/stream/ngx_stream_variables.c"
                    ;
    }
    ...
    v->data = ngx_pnalloc(s->connection->pool, sizeof("65535") - 1);
    if (v->data == 
# 610 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 610 "project/nginx/src/stream/ngx_stream_variables.c"
                      ) {
        return 
# 611 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 611 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 620 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 620 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ngx_str_t str;
    u_char addr[
# 629 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                   (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 629 "project/nginx/src/stream/ngx_stream_variables.c"
                                      ];

    str.len = 
# 631 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 631 "project/nginx/src/stream/ngx_stream_variables.c"
                                ;
    str.data = addr;

    if (ngx_connection_local_sockaddr(s->connection, &str, 0) != 
# 634 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                                0
# 634 "project/nginx/src/stream/ngx_stream_variables.c"
                                                                      ) {
        return 
# 635 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 635 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    str.data = ngx_pnalloc(s->connection->pool, str.len);
    if (str.data == 
# 639 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                   ((void *)0)
# 639 "project/nginx/src/stream/ngx_stream_variables.c"
                       ) {
        return 
# 640 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 640 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    
# 643 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   (void) __builtin___memcpy_chk (
# 643 "project/nginx/src/stream/ngx_stream_variables.c"
   str.data
# 643 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   , 
# 643 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 643 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    return 
# 651 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 651 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (ngx_connection_local_sockaddr(s->connection, 
# 666 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                    ((void *)0)
# 666 "project/nginx/src/stream/ngx_stream_variables.c"
                                                        , 0) != 
# 666 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                                0
# 666 "project/nginx/src/stream/ngx_stream_variables.c"
        ...
        return 
# 667 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 667 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    v->data = ngx_pnalloc(s->connection->pool, sizeof("65535") - 1);
    if (v->data == 
# 671 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 671 "project/nginx/src/stream/ngx_stream_variables.c"
                      ) {
        return 
# 672 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 672 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 681 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 681 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
...
# 691 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                        (sizeof("-9223372036854775808") - 1)
# 691 "project/nginx/src/stream/ngx_stream_variables.c"
                                                     );
    if (p == 
# 692 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 692 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 693 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 693 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 708 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 708 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    p = ngx_pnalloc(s->connection->pool, 
# 720 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                        (sizeof("-9223372036854775808") - 1) 
# 720 "project/nginx/src/stream/ngx_stream_variables.c"
                                                       + 4);
    if (p == 
# 721 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 721 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 722 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 722 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    tp = 
# 725 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 725 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;

    ms = (ngx_msec_int_t)
             ((tp->sec - s->start_sec) * 1000 + (tp->msec - s->start_msec));
    ms = 
# 729 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        ((
# 729 "project/nginx/src/stream/ngx_stream_variables.c"
        ms 
# 729 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        < 
# 729 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 729 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    return 
# 737 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 737 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
...
ngx_stream_variable_status(ngx_stream_session_t *s,
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    v->data = ngx_pnalloc(s->connection->pool, 
# 745 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                              (sizeof("-9223372036854775808") - 1)
# 745 "project/nginx/src/stream/ngx_stream_variables.c"
                                                           );
    if (v->data == 
# 746 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 746 "project/nginx/src/stream/ngx_stream_variables.c"
                      ) {
        return 
# 747 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 747 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 755 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 755 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    p = ngx_pnalloc(s->connection->pool, 
# 765 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                        (sizeof("-9223372036854775808") - 1)
# 765 "project/nginx/src/stream/ngx_stream_variables.c"
                                                        );
    if (p == 
# 766 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 766 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 767 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 767 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 776 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 776 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
...
{
    v->len = sizeof(
# 784 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                   "1.21.5"
# 784 "project/nginx/src/stream/ngx_stream_variables.c"
                                ) - 1;
    v->valid = 1;
    v->no_cacheable = 0;
    v->not_found = 0;
    v->data = (u_char *) 
# 788 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                        "1.21.5"
# 788 "project/nginx/src/stream/ngx_stream_variables.c"
                                     ;

    return 
# 790 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 790 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    return 
# 804 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 804 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    p = ngx_pnalloc(s->connection->pool, 
# 814 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                        (sizeof("-9223372036854775808") - 1)
# 814 "project/nginx/src/stream/ngx_stream_variables.c"
                                                     );
    if (p == 
# 815 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 815 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 816 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 816 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    return 
# 825 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 825 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    p = ngx_pnalloc(s->connection->pool, 
# 836 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                        (sizeof("-9223372036854775808") - 1) 
# 836 "project/nginx/src/stream/ngx_stream_variables.c"
                                                       + 4);
    if (p == 
# 837 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 837 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 838 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 838 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    tp = 
# 841 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 841 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    ...
    return 
# 849 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 849 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (p == 
# 860 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 860 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 861 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 861 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    
# 864 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   (void) __builtin___memcpy_chk (
# 864 "project/nginx/src/stream/ngx_stream_variables.c"
   p
# 864 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   , 
# 864 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 865 "project/nginx/src/stream/ngx_stream_variables.c"
                                              ;
    ...
    return 
# 873 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 873 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (p == 
# 884 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 884 "project/nginx/src/stream/ngx_stream_variables.c"
                ) {
        return 
# 885 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 885 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    
# 888 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   (void) __builtin___memcpy_chk (
# 888 "project/nginx/src/stream/ngx_stream_variables.c"
   p
# 888 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
   , 
# 888 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 888 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    return 
# 896 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 896 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    v->no_cacheable = 0;
    v->not_found = 0;
    v->data = (u_char *) (s->connection->type == 
# 908 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                2 
# 908 "project/nginx/src/stream/ngx_stream_variables.c"
                                                           ? "UDP" : "TCP");

    return 
# 910 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 910 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
    ...
    ngx_str_t *match)
{
    ...
    if (len) {
        ...
        if (low == 
# 927 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 927 "project/nginx/src/stream/ngx_stream_variables.c"
                      ) {
            return 
# 928 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 928 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }

    } else {
        low = 
# 932 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             ((void *)0)
# 932 "project/nginx/src/stream/ngx_stream_variables.c"
                 ;
    }
    ...
    if (len && map->nregex) {
        ...
        for (i = 0; i < map->nregex; i++) {
            ...
            if (n == 
# 955 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    0
# 955 "project/nginx/src/stream/ngx_stream_variables.c"
                          ) {
                return reg[i].value;
            }

            if (n == 
# 959 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    -5
# 959 "project/nginx/src/stream/ngx_stream_variables.c"
                                ) {
                continue;
            }
            ...
            return 
# 965 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 965 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }
    }
    ...
    return 
# 971 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((void *)0)
# 971 "project/nginx/src/stream/ngx_stream_variables.c"
              ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    v->not_found = 1;
    return 
# 982 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 982 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
...
# 1000 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                0
# 1000 "project/nginx/src/stream/ngx_stream_variables.c"
                                      ) {
        ngx_conf_log_error(
# 1001 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          1
# 1001 "project/nginx/src/stream/ngx_stream_variables.c"
                                       , cf, 0, "%V", &rc->err);
        return 
# 1002 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 1002 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }

    re = ngx_pcalloc(cf->pool, sizeof(ngx_stream_regex_t));
    if (re == 
# 1006 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             ((void *)0)
# 1006 "project/nginx/src/stream/ngx_stream_variables.c"
                 ) {
        return 
# 1007 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 1007 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    cmcf = 
# 1014 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 1014 "project/nginx/src/stream/ngx_stream_variables.c"
          cf
# 1014 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ->ctx)->main_conf[
# 1014 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1014 "project/nginx/src/stream/ngx_stream_variables.c"
                                                                          ;
    cmcf->ncaptures = 
# 1015 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                     ((
# 1015 "project/nginx/src/stream/ngx_stream_variables.c"
                     cmcf->ncaptures 
# 1015 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                     < 
# 1015 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1015 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    if (rv == 
# 1024 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             ((void *)0)
# 1024 "project/nginx/src/stream/ngx_stream_variables.c"
                 ) {
        return 
# 1025 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              ((void *)0)
# 1025 "project/nginx/src/stream/ngx_stream_variables.c"
                  ;
    }
    ...
    for (i = 0; i < n; i++) {
        ...
        name.data = &p[2];
        name.len = 
# 1038 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  strlen((const char *) 
# 1038 "project/nginx/src/stream/ngx_stream_variables.c"
                  name.data
# 1038 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  )
# 1038 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1040 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                              1
# 1040 "project/nginx/src/stream/ngx_stream_variables.c"
                                                                       );
        if (v == 
# 1041 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                ((void *)0)
# 1041 "project/nginx/src/stream/ngx_stream_variables.c"
                    ) {
            return 
# 1042 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 1042 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }

        rv[i].index = ngx_stream_get_variable_index(cf, &name);
        if (rv[i].index == 
# 1046 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          -1
# 1046 "project/nginx/src/stream/ngx_stream_variables.c"
                                   ) {
            return 
# 1047 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  ((void *)0)
# 1047 "project/nginx/src/stream/ngx_stream_variables.c"
                      ;
        }
    ...
    ngx_str_t *str)
{
    ...
    cmcf = 
# 1068 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          (
# 1068 "project/nginx/src/stream/ngx_stream_variables.c"
          s
# 1068 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          )->main_conf[
# 1068 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1068 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    if (re->ncaptures) {
        ...
        if (s->captures == 
# 1073 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          ((void *)0)
# 1073 "project/nginx/src/stream/ngx_stream_variables.c"
                              ) {
            s->captures = ngx_palloc(s->connection->pool, len * sizeof(int));
            if (s->captures == 
# 1075 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                              ((void *)0)
# 1075 "project/nginx/src/stream/ngx_stream_variables.c"
                                  ) {
                return 
# 1076 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                      -1
# 1076 "project/nginx/src/stream/ngx_stream_variables.c"
                               ;
            }
        }
    ...
    if (rc == 
# 1086 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
             (-1)
# 1086 "project/nginx/src/stream/ngx_stream_variables.c"
                                 ) {
        return 
# 1087 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -5
# 1087 "project/nginx/src/stream/ngx_stream_variables.c"
                          ;
    }

    if (rc < 0) {
        
# 1091 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
       if ((
# 1091 "project/nginx/src/stream/ngx_stream_variables.c"
       s->connection->log
# 1091 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1091 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1093 "project/nginx/src/stream/ngx_stream_variables.c"
                                        ;
        return 
# 1094 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 1094 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
...
# 1119 "project/nginx/src/stream/ngx_stream_variables.c"
    }
    ...
    return 
# 1124 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 1124 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
...
ngx_stream_variables_add_core_vars(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 1136 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 1136 "project/nginx/src/stream/ngx_stream_variables.c"
          cf
# 1136 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ->ctx)->main_conf[
# 1136 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1140 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                               ((void *)0)
# 1140 "project/nginx/src/stream/ngx_stream_variables.c"
                                   ) {
        return 
# 1141 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 1141 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
...
# 1147 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                                      1
# 1147 "project/nginx/src/stream/ngx_stream_variables.c"
                                                                    )
        != 
# 1148 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 1148 "project/nginx/src/stream/ngx_stream_variables.c"
                )
    {
        return 
# 1150 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 1150 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->prefix_variables, cf->pool, 8,
                       sizeof(ngx_stream_variable_t))
        != 
# 1155 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 1155 "project/nginx/src/stream/ngx_stream_variables.c"
                )
    {
        return 
# 1157 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 1157 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }
    ...
    for (cv = ngx_stream_core_variables; cv->name.len; cv++) {
        ...
        if (v == 
# 1162 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                ((void *)0)
# 1162 "project/nginx/src/stream/ngx_stream_variables.c"
                    ) {
            return 
# 1163 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  -1
# 1163 "project/nginx/src/stream/ngx_stream_variables.c"
                           ;
        }
    ...
    return 
# 1169 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 1169 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
...
ngx_stream_variables_init_vars(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 1185 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 1185 "project/nginx/src/stream/ngx_stream_variables.c"
          cf
# 1185 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          ->ctx)->main_conf[
# 1185 "project/nginx/src/stream/ngx_stream_variables.c"
    ...
    for (i = 0; i < cmcf->variables.nelts; i++) {
        ...
        for (n = 0; n < cmcf->variables_keys->keys.nelts; n++) {
            ...
            if (v[i].name.len == key[n].key.len
                && 
# 1198 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  strncmp((const char *) 
# 1198 "project/nginx/src/stream/ngx_stream_variables.c"
                  v[i].name.data
# 1198 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  , (const char *) 
# 1198 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1199 "project/nginx/src/stream/ngx_stream_variables.c"
                  == 0)
            {
                ...
                av->flags |= 
# 1204 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                            4
# 1204 "project/nginx/src/stream/ngx_stream_variables.c"
                                                  ;
                v[i].flags = av->flags;
                ...
                if (av->get_handler == 
# 1209 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                      ((void *)0)
                    
# 1210 "project/nginx/src/stream/ngx_stream_variables.c"
                   || (av->flags & 
# 1210 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                                   16
# 1210 "project/nginx/src/stream/ngx_stream_variables.c"
                                                      ))
                {
        ...
        len = 0;
        av = 
# 1220 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
            ((void *)0)
# 1220 "project/nginx/src/stream/ngx_stream_variables.c"
                ;

        for (n = 0; n < cmcf->prefix_variables.nelts; n++) {
            if (v[i].name.len >= pv[n].name.len && v[i].name.len > len
                && 
# 1224 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  strncmp((const char *) 
# 1224 "project/nginx/src/stream/ngx_stream_variables.c"
                  v[i].name.data
# 1224 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  , (const char *) 
# 1224 "project/nginx/src/stream/ngx_stream_variables.c"
...
# 1225 "project/nginx/src/stream/ngx_stream_variables.c"
                  == 0)
            {
                av = &pv[n];
                len = pv[n].name.len;
        ...
        if (v[i].get_handler == 
# 1240 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                               ((void *)0)
# 1240 "project/nginx/src/stream/ngx_stream_variables.c"
                                   ) {
            
# 1241 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
           if ((
# 1241 "project/nginx/src/stream/ngx_stream_variables.c"
           cf->log
# 1241 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
...
# 1242 "project/nginx/src/stream/ngx_stream_variables.c"
                                                               ;
            return 
# 1243 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                  -1
# 1243 "project/nginx/src/stream/ngx_stream_variables.c"
                           ;
        }
    ...
    for (n = 0; n < cmcf->variables_keys->keys.nelts; n++) {
        ...
        if (av->flags & 
# 1254 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                       8
# 1254 "project/nginx/src/stream/ngx_stream_variables.c"
                                            ) {
            key[n].key.data = 
# 1255 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                             ((void *)0)
# 1255 "project/nginx/src/stream/ngx_stream_variables.c"
                                 ;
        }
    }
    ...
    hash.pool = cf->pool;
    hash.temp_pool = 
# 1266 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                    ((void *)0)
# 1266 "project/nginx/src/stream/ngx_stream_variables.c"
                        ;

    if (ngx_hash_init(&hash, cmcf->variables_keys->keys.elts,
                      cmcf->variables_keys->keys.nelts)
        != 
# 1270 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 1270 "project/nginx/src/stream/ngx_stream_variables.c"
                )
    {
        return 
# 1272 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
              -1
# 1272 "project/nginx/src/stream/ngx_stream_variables.c"
                       ;
    }

    cmcf->variables_keys = 
# 1275 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
                          ((void *)0)
# 1275 "project/nginx/src/stream/ngx_stream_variables.c"
                              ;

    return 
# 1277 "project/nginx/src/stream/ngx_stream_variables.c" 3 4
          0
# 1277 "project/nginx/src/stream/ngx_stream_variables.c"
                ;
}
