# 0 "project/nginx/src/stream/ngx_stream_upstream.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/stream/ngx_stream_upstream.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_upstream.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_upstream.c" 2



# 13 "project/nginx/src/stream/ngx_stream_upstream.c"
...
static ngx_command_t ngx_stream_upstream_commands[] = {
    ...
    { 
# 31 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 31 "project/nginx/src/stream/ngx_stream_upstream.c"
     "upstream"
# 31 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     ) - 1, (u_char *) 
# 31 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 32 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     0x02000000
# 32 "project/nginx/src/stream/ngx_stream_upstream.c"
                         |
# 32 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                          0x00000100
# 32 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 36 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     ((void *)0) 
# 36 "project/nginx/src/stream/ngx_stream_upstream.c"
          },

    { 
# 38 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 38 "project/nginx/src/stream/ngx_stream_upstream.c"
     "server"
# 38 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     ) - 1, (u_char *) 
# 38 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 39 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     0x08000000
# 39 "project/nginx/src/stream/ngx_stream_upstream.c"
                        |
# 39 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                         0x00000800
# 39 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 41 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     __builtin_offsetof (ngx_stream_conf_ctx_t, srv_conf)
# 41 "project/nginx/src/stream/ngx_stream_upstream.c"
                               ,
      0,
      
# 43 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     ((void *)0) 
# 43 "project/nginx/src/stream/ngx_stream_upstream.c"
          },

      
# 45 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 46 "project/nginx/src/stream/ngx_stream_upstream.c"
};
...
# 51 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 51 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
...
# 56 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 56 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 57 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)

# 58 "project/nginx/src/stream/ngx_stream_upstream.c"
};


ngx_module_t ngx_stream_upstream_module = {
    
# 62 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 62 "project/nginx/src/stream/ngx_stream_upstream.c"
   "8" 
# 62 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   "," 
# 62 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 65 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   0x4d525453
# 65 "project/nginx/src/stream/ngx_stream_upstream.c"
                    ,
    
# 66 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 66 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 67 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 67 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 68 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 68 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 69 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 69 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 70 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 70 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 71 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 71 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 72 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   ((void *)0)
# 72 "project/nginx/src/stream/ngx_stream_upstream.c"
       ,
    
# 73 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 74 "project/nginx/src/stream/ngx_stream_upstream.c"
};
...
static ngx_stream_variable_t ngx_stream_upstream_vars[] = {
    ...
    { 
# 79 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 79 "project/nginx/src/stream/ngx_stream_upstream.c"
     "upstream_addr"
# 79 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     ) - 1, (u_char *) 
# 79 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 81 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     2
# 81 "project/nginx/src/stream/ngx_stream_upstream.c"
                               , 0 },

    { 
# 83 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 83 "project/nginx/src/stream/ngx_stream_upstream.c"
     "upstream_bytes_sent"
# 83 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     ) - 1, (u_char *) 
# 83 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 85 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     2
# 85 "project/nginx/src/stream/ngx_stream_upstream.c"
                               , 0 },

    { 
# 87 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 87 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 89 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     2
# 89 "project/nginx/src/stream/ngx_stream_upstream.c"
                               , 0 },

    { 
# 91 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 91 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 93 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     2
# 93 "project/nginx/src/stream/ngx_stream_upstream.c"
                               , 0 },

    { 
# 95 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 95 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 97 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     2
# 97 "project/nginx/src/stream/ngx_stream_upstream.c"
                               , 0 },

    { 
# 99 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { sizeof(
# 99 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 101 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     2
# 101 "project/nginx/src/stream/ngx_stream_upstream.c"
                               , 0 },

      
# 103 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 104 "project/nginx/src/stream/ngx_stream_upstream.c"
};
...
ngx_stream_upstream_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_stream_upstream_vars; v->name.len; v++) {
        ...
        if (var == 
# 114 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 114 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ) {
            return 
# 115 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  -1
# 115 "project/nginx/src/stream/ngx_stream_upstream.c"
                           ;
        }
    ...
    return 
# 122 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          0
# 122 "project/nginx/src/stream/ngx_stream_upstream.c"
                ;
}
...
# 139 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                             ((void *)0) 
# 139 "project/nginx/src/stream/ngx_stream_upstream.c"
                                  || s->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 141 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              0
# 141 "project/nginx/src/stream/ngx_stream_upstream.c"
                    ;
    }
    ...
    if (p == 
# 156 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
            ((void *)0)
# 156 "project/nginx/src/stream/ngx_stream_upstream.c"
                ) {
        return 
# 157 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              -1
# 157 "project/nginx/src/stream/ngx_stream_upstream.c"
                       ;
    }
    ...
    for ( ;; ) {
        if (state[i].peer) {
            p = 
# 166 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 166 "project/nginx/src/stream/ngx_stream_upstream.c"
               p
# 166 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
               , 
# 166 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 166 "project/nginx/src/stream/ngx_stream_upstream.c"
    ...
    return 
# 179 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          0
# 179 "project/nginx/src/stream/ngx_stream_upstream.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (s->upstream_states == 
# 196 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                             ((void *)0) 
# 196 "project/nginx/src/stream/ngx_stream_upstream.c"
                                  || s->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 198 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              0
# 198 "project/nginx/src/stream/ngx_stream_upstream.c"
                    ;
    }

    len = s->upstream_states->nelts * (
# 201 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                      (sizeof("-9223372036854775808") - 1) 
# 201 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                    + 2);

    p = ngx_pnalloc(s->connection->pool, len);
    if (p == 
# 204 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
            ((void *)0)
# 204 "project/nginx/src/stream/ngx_stream_upstream.c"
                ) {
        return 
# 205 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              -1
# 205 "project/nginx/src/stream/ngx_stream_upstream.c"
                       ;
    }
    ...
    return 
# 232 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          0
# 232 "project/nginx/src/stream/ngx_stream_upstream.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (s->upstream_states == 
# 250 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                             ((void *)0) 
# 250 "project/nginx/src/stream/ngx_stream_upstream.c"
                                  || s->upstream_states->nelts == 0) {
        v->not_found = 1;
        return 
# 252 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              0
# 252 "project/nginx/src/stream/ngx_stream_upstream.c"
                    ;
    }

    len = s->upstream_states->nelts * (
# 255 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                      (sizeof("-9223372036854775808") - 1) 
# 255 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                     + 4 + 2);

    p = ngx_pnalloc(s->connection->pool, len);
    if (p == 
# 258 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
            ((void *)0)
# 258 "project/nginx/src/stream/ngx_stream_upstream.c"
                ) {
        return 
# 259 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              -1
# 259 "project/nginx/src/stream/ngx_stream_upstream.c"
                       ;
    }
    ...
    for ( ;; ) {
        ...
        if (ms != -1) {
            ms = 
# 280 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                ((
# 280 "project/nginx/src/stream/ngx_stream_upstream.c"
                ms 
# 280 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                < 
# 280 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 280 "project/nginx/src/stream/ngx_stream_upstream.c"
    ...
    return 
# 297 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          0
# 297 "project/nginx/src/stream/ngx_stream_upstream.c"
                ;
}
...
# 314 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 314 "project/nginx/src/stream/ngx_stream_upstream.c"
   &u
# 314 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   , 0, 
# 314 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 314 "project/nginx/src/stream/ngx_stream_upstream.c"
    ...
    uscf = ngx_stream_upstream_add(cf, &u, 
# 321 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                          0x0001
                                           
# 322 "project/nginx/src/stream/ngx_stream_upstream.c"
                                          |
# 322 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                           0x0002
                                           
# 323 "project/nginx/src/stream/ngx_stream_upstream.c"
                                          |
# 323 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                           0x0100
                                           
# 324 "project/nginx/src/stream/ngx_stream_upstream.c"
                                          |
# 324 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                           0x0004
                                           
# 325 "project/nginx/src/stream/ngx_stream_upstream.c"
                                          |
# 325 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                           0x0008
                                           
# 326 "project/nginx/src/stream/ngx_stream_upstream.c"
                                          |
# 326 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                           0x0010
                                           
# 327 "project/nginx/src/stream/ngx_stream_upstream.c"
                                          |
# 327 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                           0x0020
# 327 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                                     );
    if (uscf == 
# 328 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
               ((void *)0)
# 328 "project/nginx/src/stream/ngx_stream_upstream.c"
                   ) {
        return 
# 329 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 329 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }
    ...
    if (ctx == 
# 334 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              ((void *)0)
# 334 "project/nginx/src/stream/ngx_stream_upstream.c"
                  ) {
        return 
# 335 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 335 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }
    ...
    if (ctx->srv_conf == 
# 345 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                        ((void *)0)
# 345 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ) {
        return 
# 346 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 346 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }
...
# 354 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                          0x4d525453
# 354 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                           ) {
            continue;
        }
        ...
        if (module->create_srv_conf) {
            ...
            if (mconf == 
# 362 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                        ((void *)0)
# 362 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ) {
                return 
# 363 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                      (void *) -1
# 363 "project/nginx/src/stream/ngx_stream_upstream.c"
                                    ;
            }
    ...
    if (uscf->servers == 
# 372 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                        ((void *)0)
# 372 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ) {
        return 
# 373 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 373 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }
    ...
    cf->ctx = ctx;
    cf->cmd_type = 
# 381 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  0x08000000
# 381 "project/nginx/src/stream/ngx_stream_upstream.c"
                                     ;

    rv = ngx_conf_parse(cf, 
# 383 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                           ((void *)0)
# 383 "project/nginx/src/stream/ngx_stream_upstream.c"
                               );

    *cf = pcf;

    if (rv != 
# 387 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
             ((void *)0)
# 387 "project/nginx/src/stream/ngx_stream_upstream.c"
                        ) {
        return rv;
    }
    ...
    if (uscf->servers->nelts == 0) {
        ngx_conf_log_error(
# 392 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                          1
# 392 "project/nginx/src/stream/ngx_stream_upstream.c"
                                       , cf, 0,
                           "no servers are inside upstream");
        return 
# 394 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 394 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }
...
ngx_stream_upstream_server(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (us == 
# 414 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
             ((void *)0)
# 414 "project/nginx/src/stream/ngx_stream_upstream.c"
                 ) {
        return 
# 415 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 415 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }

    
# 418 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 418 "project/nginx/src/stream/ngx_stream_upstream.c"
   us
# 418 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   , 0, 
# 418 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 418 "project/nginx/src/stream/ngx_stream_upstream.c"
    ...
    for (i = 2; i < cf->args->nelts; i++) {
        ...
        if (
# 429 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           strncmp((const char *) 
# 429 "project/nginx/src/stream/ngx_stream_upstream.c"
           value[i].data
# 429 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           , (const char *) 
# 429 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 429 "project/nginx/src/stream/ngx_stream_upstream.c"
            ...
            if (!(uscf->flags & 
# 431 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                               0x0002
# 431 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                         )) {
                goto not_supported;
            }
            ...
            if (weight == 
# 437 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                         -1 
# 437 "project/nginx/src/stream/ngx_stream_upstream.c"
                                   || weight == 0) {
                goto invalid;
            }
        ...
        if (
# 444 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           strncmp((const char *) 
# 444 "project/nginx/src/stream/ngx_stream_upstream.c"
           value[i].data
# 444 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           , (const char *) 
# 444 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 444 "project/nginx/src/stream/ngx_stream_upstream.c"
            ...
            if (!(uscf->flags & 
# 446 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                               0x0100
# 446 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                            )) {
                goto not_supported;
            }
            ...
            if (max_conns == 
# 452 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                            -1
# 452 "project/nginx/src/stream/ngx_stream_upstream.c"
                                     ) {
                goto invalid;
            }
        ...
        if (
# 459 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           strncmp((const char *) 
# 459 "project/nginx/src/stream/ngx_stream_upstream.c"
           value[i].data
# 459 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           , (const char *) 
# 459 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 459 "project/nginx/src/stream/ngx_stream_upstream.c"
            ...
            if (!(uscf->flags & 
# 461 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                               0x0004
# 461 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                            )) {
                goto not_supported;
            }
            ...
            if (max_fails == 
# 467 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                            -1
# 467 "project/nginx/src/stream/ngx_stream_upstream.c"
                                     ) {
                goto invalid;
            }
        ...
        if (
# 474 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           strncmp((const char *) 
# 474 "project/nginx/src/stream/ngx_stream_upstream.c"
           value[i].data
# 474 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           , (const char *) 
# 474 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 474 "project/nginx/src/stream/ngx_stream_upstream.c"
            ...
            if (!(uscf->flags & 
# 476 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                               0x0008
# 476 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                               )) {
                goto not_supported;
            }
...
# 485 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                        -1
# 485 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                 ) {
                goto invalid;
            }
        ...
        if (
# 492 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           strcmp((const char *) 
# 492 "project/nginx/src/stream/ngx_stream_upstream.c"
           value[i].data
# 492 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           , (const char *) 
# 492 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 492 "project/nginx/src/stream/ngx_stream_upstream.c"
            ...
            if (!(uscf->flags & 
# 494 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                               0x0020
# 494 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                         )) {
                goto not_supported;
            }
        ...
        if (
# 503 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           strcmp((const char *) 
# 503 "project/nginx/src/stream/ngx_stream_upstream.c"
           value[i].data
# 503 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           , (const char *) 
# 503 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 503 "project/nginx/src/stream/ngx_stream_upstream.c"
            ...
            if (!(uscf->flags & 
# 505 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                               0x0010
# 505 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                       )) {
                goto not_supported;
            }
...
# 517 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   (void) __builtin___memset_chk (
# 517 "project/nginx/src/stream/ngx_stream_upstream.c"
   &u
# 517 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
   , 0, 
# 517 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 521 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                      0
# 521 "project/nginx/src/stream/ngx_stream_upstream.c"
                                            ) {
        if (u.err) {
            ngx_conf_log_error(
# 523 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                              1
# 523 "project/nginx/src/stream/ngx_stream_upstream.c"
                                           , cf, 0,
                               "%s in upstream \"%V\"", u.err, &u.url);
        }

        return 
# 527 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 527 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }

    if (u.no_port) {
        ngx_conf_log_error(
# 531 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                          1
# 531 "project/nginx/src/stream/ngx_stream_upstream.c"
                                       , cf, 0,
                           "no port in upstream \"%V\"", &u.url);
        return 
# 533 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              (void *) -1
# 533 "project/nginx/src/stream/ngx_stream_upstream.c"
                            ;
    }
    ...
    return 
# 544 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          ((void *)0)
# 544 "project/nginx/src/stream/ngx_stream_upstream.c"
                     ;

invalid:

    ngx_conf_log_error(
# 548 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                      1
# 548 "project/nginx/src/stream/ngx_stream_upstream.c"
                                   , cf, 0,
                       "invalid parameter \"%V\"", &value[i]);

    return 
# 551 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          (void *) -1
# 551 "project/nginx/src/stream/ngx_stream_upstream.c"
                        ;

not_supported:

    ngx_conf_log_error(
# 555 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                      1
# 555 "project/nginx/src/stream/ngx_stream_upstream.c"
                                   , cf, 0,
                       "balancing method does not support parameter \"%V\"",
                       &value[i]);

    return 
# 559 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          (void *) -1
# 559 "project/nginx/src/stream/ngx_stream_upstream.c"
                        ;
}
...
ngx_stream_upstream_add(ngx_conf_t *cf, ngx_url_t *u, ngx_uint_t flags)
{
    ...
    if (!(flags & 
# 571 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                 0x0001
# 571 "project/nginx/src/stream/ngx_stream_upstream.c"
                                           )) {

        if (ngx_parse_url(cf->pool, u) != 
# 573 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                         0
# 573 "project/nginx/src/stream/ngx_stream_upstream.c"
                                               ) {
            if (u->err) {
                ngx_conf_log_error(
# 575 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                  1
# 575 "project/nginx/src/stream/ngx_stream_upstream.c"
                                               , cf, 0,
                                   "%s in upstream \"%V\"", u->err, &u->url);
            }

            return 
# 579 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 579 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ;
        }
    }

    umcf = 
# 583 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          ((ngx_stream_conf_ctx_t *) 
# 583 "project/nginx/src/stream/ngx_stream_upstream.c"
          cf
# 583 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          ->ctx)->main_conf[
# 583 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 583 "project/nginx/src/stream/ngx_stream_upstream.c"
    ...
    for (i = 0; i < umcf->upstreams.nelts; i++) {
        ...
        if ((flags & 
# 596 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                    0x0001
# 596 "project/nginx/src/stream/ngx_stream_upstream.c"
                                              )
             && (uscfp[i]->flags & 
# 597 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                  0x0001
# 597 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                            ))
        {
            ngx_conf_log_error(
# 599 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                              1
# 599 "project/nginx/src/stream/ngx_stream_upstream.c"
                                           , cf, 0,
                               "duplicate upstream \"%V\"", &u->host);
            return 
# 601 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 601 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ;
        }

        if ((uscfp[i]->flags & 
# 604 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                              0x0001
# 604 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                        ) && !u->no_port) {
            ngx_conf_log_error(
# 605 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                              1
# 605 "project/nginx/src/stream/ngx_stream_upstream.c"
                                           , cf, 0,
                               "upstream \"%V\" may not have port %d",
                               &u->host, u->port);
            return 
# 608 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 608 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ;
        }

        if ((flags & 
# 611 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                    0x0001
# 611 "project/nginx/src/stream/ngx_stream_upstream.c"
                                              ) && !uscfp[i]->no_port) {
            
# 612 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
           if ((
# 612 "project/nginx/src/stream/ngx_stream_upstream.c"
           cf->log
# 612 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
...
# 615 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                             ;
            return 
# 616 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 616 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ;
        }
        ...
        if (flags & 
# 623 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                   0x0001
# 623 "project/nginx/src/stream/ngx_stream_upstream.c"
                                             ) {
            uscfp[i]->flags = flags;
        }
    ...
    if (uscf == 
# 631 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
               ((void *)0)
# 631 "project/nginx/src/stream/ngx_stream_upstream.c"
                   ) {
        return 
# 632 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              ((void *)0)
# 632 "project/nginx/src/stream/ngx_stream_upstream.c"
                  ;
    }
...
# 642 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                                  1
# 642 "project/nginx/src/stream/ngx_stream_upstream.c"
                                                         )) {
        uscf->servers = ngx_array_create(cf->pool, 1,
                                         sizeof(ngx_stream_upstream_server_t));
        if (uscf->servers == 
# 645 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                            ((void *)0)
# 645 "project/nginx/src/stream/ngx_stream_upstream.c"
                                ) {
            return 
# 646 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 646 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ;
        }

        us = ngx_array_push(uscf->servers);
        if (us == 
# 650 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                 ((void *)0)
# 650 "project/nginx/src/stream/ngx_stream_upstream.c"
                     ) {
            return 
# 651 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  ((void *)0)
# 651 "project/nginx/src/stream/ngx_stream_upstream.c"
                      ;
        }

        
# 654 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
       (void) __builtin___memset_chk (
# 654 "project/nginx/src/stream/ngx_stream_upstream.c"
       us
# 654 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
       , 0, 
# 654 "project/nginx/src/stream/ngx_stream_upstream.c"
...
# 654 "project/nginx/src/stream/ngx_stream_upstream.c"
    ...
    if (uscfp == 
# 661 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                ((void *)0)
# 661 "project/nginx/src/stream/ngx_stream_upstream.c"
                    ) {
        return 
# 662 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              ((void *)0)
# 662 "project/nginx/src/stream/ngx_stream_upstream.c"
                  ;
    }
...
ngx_stream_upstream_create_main_conf(ngx_conf_t *cf)
{
    ...
    if (umcf == 
# 677 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
               ((void *)0)
# 677 "project/nginx/src/stream/ngx_stream_upstream.c"
                   ) {
        return 
# 678 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              ((void *)0)
# 678 "project/nginx/src/stream/ngx_stream_upstream.c"
                  ;
    }
    ...
    if (ngx_array_init(&umcf->upstreams, cf->pool, 4,
        ...
        != 
# 683 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          0
# 683 "project/nginx/src/stream/ngx_stream_upstream.c"
                )
    {
        return 
# 685 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
              ((void *)0)
# 685 "project/nginx/src/stream/ngx_stream_upstream.c"
                  ;
    }
...
ngx_stream_upstream_init_main_conf(ngx_conf_t *cf, void *conf)
{
    ...
    for (i = 0; i < umcf->upstreams.nelts; i++) {
        ...
        if (init(cf, uscfp[i]) != 
# 709 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                                 0
# 709 "project/nginx/src/stream/ngx_stream_upstream.c"
                                       ) {
            return 
# 710 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
                  (void *) -1
# 710 "project/nginx/src/stream/ngx_stream_upstream.c"
                                ;
        }
    }

    return 
# 714 "project/nginx/src/stream/ngx_stream_upstream.c" 3 4
          ((void *)0)
# 714 "project/nginx/src/stream/ngx_stream_upstream.c"
                     ;
}
