# 0 "project/nginx/src/stream/ngx_stream_handler.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/nginx/src/stream/ngx_stream_handler.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_handler.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_handler.c" 2
...
# 12 "project/nginx/src/stream/ngx_stream_handler.c" 2



# 14 "project/nginx/src/stream/ngx_stream_handler.c"
...
{
    u_char text[
# 23 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                      (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 23 "project/nginx/src/stream/ngx_stream_handler.c"
                                                         ];
    size_t len;
    ngx_uint_t i;
    ngx_time_t *tp;
...
# 55 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                            ((void *)0)
# 55 "project/nginx/src/stream/ngx_stream_handler.c"
                                                , 0) != 
# 55 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
...
# 55 "project/nginx/src/stream/ngx_stream_handler.c"
        ...
        case 
# 65 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
            30
# 65 "project/nginx/src/stream/ngx_stream_handler.c"
                    :
            ...
            for (i = 0; i < port->naddrs - 1; i++) {
                if (
# 73 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                   memcmp((const char *) 
# 73 "project/nginx/src/stream/ngx_stream_handler.c"
                   &addr6[i].addr6
# 73 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                   , (const char *) 
# 73 "project/nginx/src/stream/ngx_stream_handler.c"
...
# 73 "project/nginx/src/stream/ngx_stream_handler.c"
        ...
        case 
# 105 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
            30
# 105 "project/nginx/src/stream/ngx_stream_handler.c"
                    :
            addr6 = port->addrs;
    ...
    if (s == 
# 119 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
            ((void *)0)
# 119 "project/nginx/src/stream/ngx_stream_handler.c"
                ) {
        ngx_stream_close_connection(c);
        return;
    }
    ...
    s->signature = 
# 124 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                  0x4d525453
# 124 "project/nginx/src/stream/ngx_stream_handler.c"
                                   ;
    ...
    cscf = 
# 139 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
          (
# 139 "project/nginx/src/stream/ngx_stream_handler.c"
          s
# 139 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
          )->srv_conf[
# 139 "project/nginx/src/stream/ngx_stream_handler.c"
...
# 139 "project/nginx/src/stream/ngx_stream_handler.c"
    ...
    c
# 141 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
   ->log->file = 
# 141 "project/nginx/src/stream/ngx_stream_handler.c"
   cscf->error_log
# 141 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
   ->file; 
# 141 "project/nginx/src/stream/ngx_stream_handler.c"
...
# 143 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                                      (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 143 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                         , 1);

    
# 145 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
   if ((
# 145 "project/nginx/src/stream/ngx_stream_handler.c"
   c->log
# 145 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
...
# 145 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
   , 
# 145 "project/nginx/src/stream/ngx_stream_handler.c"
   0, "*%uA %sclient %*s connected to %V", c->number, c->type == 
# 145 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
   2 
# 145 "project/nginx/src/stream/ngx_stream_handler.c"
   ? "udp " : "", len, text, &addr_conf->addr_text
# 145 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
   )

                                                   
# 147 "project/nginx/src/stream/ngx_stream_handler.c"
                                                  ;
    ...
    if (s->ctx == 
# 156 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                 ((void *)0)
# 156 "project/nginx/src/stream/ngx_stream_handler.c"
                     ) {
        ngx_stream_close_connection(c);
        return;
    }
    ...
    cmcf = 
# 161 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
          (
# 161 "project/nginx/src/stream/ngx_stream_handler.c"
          s
# 161 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
          )->main_conf[
# 161 "project/nginx/src/stream/ngx_stream_handler.c"
...
# 161 "project/nginx/src/stream/ngx_stream_handler.c"
    ...
    if (s->variables == 
# 167 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                       ((void *)0)
# 167 "project/nginx/src/stream/ngx_stream_handler.c"
                           ) {
        ngx_stream_close_connection(c);
        return;
    }
    ...
    tp = 
# 172 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 172 "project/nginx/src/stream/ngx_stream_handler.c"
                       ;
    s->start_sec = tp->sec;
...
# 185 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
           ngx_event_add_timer
# 185 "project/nginx/src/stream/ngx_stream_handler.c"
                        (rev, cscf->proxy_protocol_timeout);

            if (ngx_handle_read_event(rev, 0) != 
# 187 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                                0
# 187 "project/nginx/src/stream/ngx_stream_handler.c"
                                                      ) {
                ngx_stream_finalize_session(s,
                                            
# 189 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                           500
# 189 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                           );
            }
...
# 197 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
       if (!(
# 197 "project/nginx/src/stream/ngx_stream_handler.c"
       rev
# 197 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
       )->posted) { (
# 197 "project/nginx/src/stream/ngx_stream_handler.c"
...
{
    u_char *p, buf[
# 208 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                       107
# 208 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                    ];
    size_t size;
    ssize_t n;
    ngx_err_t err;
...
# 223 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
       if ((
# 223 "project/nginx/src/stream/ngx_stream_handler.c"
       c->log
# 223 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 223 "project/nginx/src/stream/ngx_stream_handler.c"
...
# 223 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                             ;
        ngx_stream_finalize_session(s, 
# 224 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                      200
# 224 "project/nginx/src/stream/ngx_stream_handler.c"
                                                   );
        return;
    }

    n = recv(c->fd, (char *) buf, sizeof(buf), 
# 228 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                              0x2
# 228 "project/nginx/src/stream/ngx_stream_handler.c"
                                                      );

    err = 
# 230 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
         (*__error())
# 230 "project/nginx/src/stream/ngx_stream_handler.c"
                         ;
    ...
    if (n == -1) {
        if (err == 
# 235 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                  35
# 235 "project/nginx/src/stream/ngx_stream_handler.c"
                            ) {
            rev->ready = 0;

            if (!rev->timer_set) {
                cscf = 
# 239 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                      (
# 239 "project/nginx/src/stream/ngx_stream_handler.c"
                      s
# 239 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                      )->srv_conf[
# 239 "project/nginx/src/stream/ngx_stream_handler.c"
...
# 240 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                            ;

                
# 242 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
               ngx_event_add_timer
# 242 "project/nginx/src/stream/ngx_stream_handler.c"
                            (rev, cscf->proxy_protocol_timeout);
            }

            if (ngx_handle_read_event(rev, 0) != 
# 245 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                                0
# 245 "project/nginx/src/stream/ngx_stream_handler.c"
                                                      ) {
                ngx_stream_finalize_session(s,
                                            
# 247 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                           500
# 247 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                           );
            }
        ...
        ngx_stream_finalize_session(s, 
# 255 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                      200
# 255 "project/nginx/src/stream/ngx_stream_handler.c"
                                                   );
        return;
    }
...
# 260 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
       ngx_event_del_timer
# 260 "project/nginx/src/stream/ngx_stream_handler.c"
                    (rev);
    }
    ...
    if (p == 
# 265 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
            ((void *)0)
# 265 "project/nginx/src/stream/ngx_stream_handler.c"
                ) {
        ngx_stream_finalize_session(s, 
# 266 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                      400
# 266 "project/nginx/src/stream/ngx_stream_handler.c"
                                                            );
        return;
    }
    ...
    if (c->recv(c, buf, size) != (ssize_t) size) {
        ngx_stream_finalize_session(s, 
# 273 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                      500
# 273 "project/nginx/src/stream/ngx_stream_handler.c"
                                                                      );
        return;
    }
...
ngx_stream_log_session(ngx_stream_session_t *s)
{
    ...
    cmcf = 
# 317 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
          (
# 317 "project/nginx/src/stream/ngx_stream_handler.c"
          s
# 317 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
          )->main_conf[
# 317 "project/nginx/src/stream/ngx_stream_handler.c"
...
ngx_stream_close_connection(ngx_connection_t *c)
{
    ngx_pool_t *pool;
                                                        ...
                                                        ;
# 351 "project/nginx/src/stream/ngx_stream_handler.c"
    pool = c->pool;
...
ngx_stream_log_error(ngx_log_t *log, u_char *buf, size_t len)
{
    ...
    p = ngx_snprintf(buf, len, ", %sclient: %V, server: %V",
                     s->connection->type == 
# 374 "project/nginx/src/stream/ngx_stream_handler.c" 3 4
                                           2 
# 374 "project/nginx/src/stream/ngx_stream_handler.c"
                                                      ? "udp " : "",
