# 0 "project/nginx/objs/ngx_modules.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 3 "project/nginx/objs/ngx_modules.c" 2
...
# 4 "project/nginx/objs/ngx_modules.c" 2




# 7 "project/nginx/objs/ngx_modules.c"
extern ngx_module_t ngx_core_module;
extern ngx_module_t ngx_errlog_module;
...
# 111 "project/nginx/objs/ngx_modules.c" 3 4
   ((void *)0)

# 112 "project/nginx/objs/ngx_modules.c"
};
...
# 166 "project/nginx/objs/ngx_modules.c" 3 4
   ((void *)0)

# 167 "project/nginx/objs/ngx_modules.c"
};
