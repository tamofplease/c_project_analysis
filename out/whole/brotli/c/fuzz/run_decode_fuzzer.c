# 0 "project/brotli/c/fuzz/run_decode_fuzzer.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 10 "project/brotli/c/fuzz/run_decode_fuzzer.c" 2
...
# 11 "project/brotli/c/fuzz/run_decode_fuzzer.c" 2
...
# 12 "project/brotli/c/fuzz/run_decode_fuzzer.c" 2



# 14 "project/brotli/c/fuzz/run_decode_fuzzer.c"
void LLVMFuzzerTestOneInput(const uint8_t* data, size_t size);

int main(int argc, char* *argv) {
  if (argc != 2) {
    fprintf(
# 18 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
           __stderrp
# 18 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                 , "Exactly one argument is expected.\n");
    exit(
# 19 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
        1
# 19 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                    );
  }
  ...
  if (!f) {
    fprintf(
# 24 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
           __stderrp
# 24 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                 , "Failed to open input file.");
    exit(
# 25 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
        1
# 25 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                    );
  }
  ...
  if (ferror(f)) {
    fclose(f);
    fprintf(
# 33 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
           __stderrp
# 33 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                 , "Failed read input file.");
    exit(
# 34 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
        1
# 34 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                    );
  }

  unsigned char* data = (unsigned char*)malloc(len);
  
# 38 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
 __builtin___memcpy_chk (
# 38 "project/brotli/c/fuzz/run_decode_fuzzer.c"
 data
# 38 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
 , 
# 38 "project/brotli/c/fuzz/run_decode_fuzzer.c"
...
# 38 "project/brotli/c/fuzz/run_decode_fuzzer.c"
  ...
  free(data);
  exit(
# 43 "project/brotli/c/fuzz/run_decode_fuzzer.c" 3 4
      0
# 43 "project/brotli/c/fuzz/run_decode_fuzzer.c"
                  );
}
