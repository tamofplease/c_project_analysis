# 0 "project/brotli/c/enc/metablock_inc.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
static void FN(InitBlockSplitter)(
    ...
    BlockSplit* split, FN(Histogram)** histograms, size_t* histograms_size) {
  ...
  *histograms = BROTLI_ALLOC(m, FN(Histogram), *histograms_size);
...
static void FN(BlockSplitterFinishBlock)(
  ...
  FN(Histogram)* histograms = self->histograms_;
  self->block_size_ =
