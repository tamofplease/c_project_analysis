# 0 "project/brotli/c/enc/cluster.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 10 "project/brotli/c/enc/./cluster.h"
...
# 13 "project/brotli/c/enc/./cluster.h" 2

# 1 "project/brotli/c/enc/././histogram.h" 1
# 10 "project/brotli/c/enc/././histogram.h"
...
# 1 "project/brotli/c/enc/././../common/platform.h" 1
# 17 "project/brotli/c/enc/././histogram.h" 2

# 1 "project/brotli/c/enc/./././block_splitter.h" 1
# 10 "project/brotli/c/enc/./././block_splitter.h"
...
# 15 "project/brotli/c/enc/./cluster.h" 2
# 1 "project/brotli/c/enc/././memory.h" 1
# 16 "project/brotli/c/enc/./cluster.h" 2
...
# 320 "project/brotli/c/enc/././cluster_inc.h"
#undef HistogramType
...
#undef CODE
# 10 "project/brotli/c/enc/cluster.c" 2

# 1 "project/brotli/c/enc/../common/platform.h" 1
# 12 "project/brotli/c/enc/cluster.c" 2

# 1 "project/brotli/c/enc/./bit_cost.h" 1
# 10 "project/brotli/c/enc/./bit_cost.h"
...
# 14 "project/brotli/c/enc/cluster.c" 2
# 1 "project/brotli/c/enc/./fast_log.h" 1
# 15 "project/brotli/c/enc/cluster.c" 2
# 1 "project/brotli/c/enc/./histogram.h" 1
# 16 "project/brotli/c/enc/cluster.c" 2
# 1 "project/brotli/c/enc/./memory.h" 1
# 17 "project/brotli/c/enc/cluster.c" 2
...
# 22 "project/brotli/c/enc/cluster.c" 3 4
                    int 
# 22 "project/brotli/c/enc/cluster.c"
                                HistogramPairIsLess(
    const HistogramPair* p1, const HistogramPair* p2) {
  if (p1->cost_diff != p2->cost_diff) {
    return 
# 25 "project/brotli/c/enc/cluster.c" 3 4
          (!!(
# 25 "project/brotli/c/enc/cluster.c"
...
# 25 "project/brotli/c/enc/cluster.c"
  ...
  return 
# 27 "project/brotli/c/enc/cluster.c" 3 4
        (!!(
# 27 "project/brotli/c/enc/cluster.c"
...
static inline __attribute__((__always_inline__)) double ClusterCostDiff(size_t size_a, size_t size_b) {
...
__attribute__ ((visibility ("hidden"))) void BrotliCompareAndPushToQueueLiteral(
    ...
    uint32_t idx2, size_t max_num_pairs, HistogramPair* pairs,
    size_t* num_pairs) { 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      int 
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      is_good_pair = 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      0
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; HistogramPair p; p.idx1 = p.idx2 = 0; p.cost_diff = p.cost_combo = 0; if (idx1 == idx2) { return; } if (idx2 < idx1) { uint32_t t = idx2; idx2 = idx1; idx1 = t; } p.idx1 = idx1; p.idx2 = idx2; p.cost_diff = 0.5 * ClusterCostDiff(cluster_size[idx1], cluster_size[idx2]); p.cost_diff -= out[idx1].bit_cost_; p.cost_diff -= out[idx2].bit_cost_; if (out[idx1].total_count_ == 0) { p.cost_combo = out[idx2].bit_cost_; is_good_pair = 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } else if (out[idx2].total_count_ == 0) { p.cost_combo = out[idx1].bit_cost_; is_good_pair = 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } else { double threshold = *num_pairs == 0 ? 1e99 : (brotli_max_double((0.0), (pairs[0].cost_diff))); HistogramLiteral combo = out[idx1]; double cost_combo; HistogramAddHistogramLiteral(&combo, &out[idx2]); cost_combo = BrotliPopulationCostLiteral(&combo); if (cost_combo < threshold - p.cost_diff) { p.cost_combo = cost_combo; is_good_pair = 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } } if (is_good_pair) { p.cost_diff += p.cost_combo; if (*num_pairs > 0 && HistogramPairIsLess(&pairs[0], &p)) { if (*num_pairs < max_num_pairs) { pairs[*num_pairs] = pairs[0]; ++(*num_pairs); } pairs[0] = p; } else if (*num_pairs < max_num_pairs) { pairs[*num_pairs] = p; ++(*num_pairs); } } }
# 70 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramCombineLiteral(HistogramLiteral* out,
                                                  uint32_t* cluster_size,
                                                  uint32_t* symbols,
...
# 78 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                                       , 0))
# 78 "project/brotli/c/enc/./cluster_inc.h"
                                                                       ; break; } } --num_clusters; { size_t copy_to_idx = 0; for (i = 0; i < num_pairs; ++i) { HistogramPair* p = &pairs[i]; if (p->idx1 == best_idx1 || p->idx2 == best_idx1 || p->idx1 == best_idx2 || p->idx2 == best_idx2) { continue; } if (HistogramPairIsLess(&pairs[0], p)) { HistogramPair front = pairs[0]; pairs[0] = *p; pairs[copy_to_idx] = front; } else { pairs[copy_to_idx] = *p; } ++copy_to_idx; } num_pairs = copy_to_idx; } for (i = 0; i < num_clusters; ++i) { BrotliCompareAndPushToQueueLiteral(out, cluster_size, best_idx1, clusters[i], max_num_pairs, &pairs[0], &num_pairs); } } return num_clusters; }
# 157 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) double BrotliHistogramBitCostDistanceLiteral(
    const HistogramLiteral* histogram, const HistogramLiteral* candidate) { if (histogram->total_count_ == 0) { return 0.0; } else { HistogramLiteral tmp = *histogram; HistogramAddHistogramLiteral(&tmp, candidate); return BrotliPopulationCostLiteral(&tmp) - candidate->bit_cost_; } }
# 172 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliHistogramRemapLiteral(const HistogramLiteral* in,
    size_t in_size, const uint32_t* clusters, size_t num_clusters,
    HistogramLiteral* out, uint32_t* symbols) { size_t i; for (i = 0; i < in_size; ++i) { uint32_t best_out = i == 0 ? symbols[0] : symbols[i - 1]; double best_bits = BrotliHistogramBitCostDistanceLiteral(&in[i], &out[best_out]); size_t j; for (j = 0; j < num_clusters; ++j) { const double cur_bits = BrotliHistogramBitCostDistanceLiteral(&in[i], &out[clusters[j]]); if (cur_bits < best_bits) { best_bits = cur_bits; best_out = clusters[j]; } } symbols[i] = best_out; } for (i = 0; i < num_clusters; ++i) { HistogramClearLiteral(&out[clusters[i]]); } for (i = 0; i < in_size; ++i) { HistogramAddHistogramLiteral(&out[symbols[i]], &in[i]); } }
# 211 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramReindexLiteral(MemoryManager* m,
    HistogramLiteral* out, uint32_t* symbols, size_t length) { static const uint32_t kInvalidIndex = 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         (~((uint32_t)0))
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ; uint32_t* new_index = ((length) > 0 ? ((uint32_t*)BrotliAllocate((m), (length) * sizeof(uint32_t))) : 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         ((void *)0)
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ); uint32_t next_index; HistogramLiteral* tmp; size_t i; if ((!!0) || (!!0)) return 0; for (i = 0; i < length; ++i) { new_index[i] = kInvalidIndex; } next_index = 0; for (i = 0; i < length; ++i) { if (new_index[symbols[i]] == kInvalidIndex) { new_index[symbols[i]] = next_index; ++next_index; } } tmp = ((next_index) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (next_index) * sizeof(HistogramLiteral))) : 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         ((void *)0)
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ); if ((!!0) || (!!0)) return 0; next_index = 0; for (i = 0; i < length; ++i) { if (new_index[symbols[i]] == next_index) { tmp[next_index] = out[symbols[i]]; ++next_index; } symbols[i] = new_index[symbols[i]]; } { BrotliFree((m), (new_index)); new_index = 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         ((void *)0)
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ; }; for (i = 0; i < next_index; ++i) { out[i] = tmp[i]; } { BrotliFree((m), (tmp)); tmp = 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         ((void *)0)
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ; }; return next_index; }
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                , 
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                pairs, pairs_capacity * sizeof(HistogramPair)
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                , __builtin_object_size (
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                new_array
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; pairs = new_array; pairs_capacity = _new_size; } }; if ((!!0)) return; num_clusters = BrotliHistogramCombineLiteral(out, cluster_size, histogram_symbols, clusters, pairs, num_clusters, in_size, max_histograms, max_num_pairs); } { BrotliFree((m), (pairs)); pairs = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; BrotliHistogramRemapLiteral(in, in_size, clusters, num_clusters, out, histogram_symbols); { BrotliFree((m), (clusters)); clusters = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; *out_size = BrotliHistogramReindexLiteral(m, out, histogram_symbols, in_size); if ((!!0)) return; }
# 320 "project/brotli/c/enc/./cluster_inc.h"
#undef HistogramType
# 42 "project/brotli/c/enc/cluster.c" 2
#undef FN
...
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } else { double threshold = *num_pairs == 0 ? 1e99 : (brotli_max_double((0.0), (pairs[0].cost_diff))); HistogramCommand combo = out[idx1]; double cost_combo; HistogramAddHistogramCommand(&combo, &out[idx2]); cost_combo = BrotliPopulationCostCommand(&combo); if (cost_combo < threshold - p.cost_diff) { p.cost_combo = cost_combo; is_good_pair = 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } } if (is_good_pair) { p.cost_diff += p.cost_combo; if (*num_pairs > 0 && HistogramPairIsLess(&pairs[0], &p)) { if (*num_pairs < max_num_pairs) { pairs[*num_pairs] = pairs[0]; ++(*num_pairs); } pairs[0] = p; } else if (*num_pairs < max_num_pairs) { pairs[*num_pairs] = p; ++(*num_pairs); } } }
...
# 157 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) double BrotliHistogramBitCostDistanceCommand(
    const HistogramCommand* histogram, const HistogramCommand* candidate) { if (histogram->total_count_ == 0) { return 0.0; } else { HistogramCommand tmp = *histogram; HistogramAddHistogramCommand(&tmp, candidate); return BrotliPopulationCostCommand(&tmp) - candidate->bit_cost_; } }
# 172 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliHistogramRemapCommand(const HistogramCommand* in,
    size_t in_size, const uint32_t* clusters, size_t num_clusters,
    HistogramCommand* out, uint32_t* symbols) { size_t i; for (i = 0; i < in_size; ++i) { uint32_t best_out = i == 0 ? symbols[0] : symbols[i - 1]; double best_bits = BrotliHistogramBitCostDistanceCommand(&in[i], &out[best_out]); size_t j; for (j = 0; j < num_clusters; ++j) { const double cur_bits = BrotliHistogramBitCostDistanceCommand(&in[i], &out[clusters[j]]); if (cur_bits < best_bits) { best_bits = cur_bits; best_out = clusters[j]; } } symbols[i] = best_out; } for (i = 0; i < num_clusters; ++i) { HistogramClearCommand(&out[clusters[i]]); } for (i = 0; i < in_size; ++i) { HistogramAddHistogramCommand(&out[symbols[i]], &in[i]); } }
# 211 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramReindexCommand(MemoryManager* m,
    HistogramCommand* out, uint32_t* symbols, size_t length) { static const uint32_t kInvalidIndex = 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         (~((uint32_t)0))
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ; uint32_t* new_index = ((length) > 0 ? ((uint32_t*)BrotliAllocate((m), (length) * sizeof(uint32_t))) : 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         ((void *)0)
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ); uint32_t next_index; HistogramCommand* tmp; size_t i; if ((!!0) || (!!0)) return 0; for (i = 0; i < length; ++i) { new_index[i] = kInvalidIndex; } next_index = 0; for (i = 0; i < length; ++i) { if (new_index[symbols[i]] == kInvalidIndex) { new_index[symbols[i]] = next_index; ++next_index; } } tmp = ((next_index) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (next_index) * sizeof(HistogramCommand))) : 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         ((void *)0)
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ); if ((!!0) || (!!0)) return 0; next_index = 0; for (i = 0; i < length; ++i) { if (new_index[symbols[i]] == next_index) { tmp[next_index] = out[symbols[i]]; ++next_index; } symbols[i] = new_index[symbols[i]]; } { BrotliFree((m), (new_index)); new_index = 
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ); size_t i; if ((!!0) || (!!0) || (!!0) || (!!0)) { return; } for (i = 0; i < in_size; ++i) { cluster_size[i] = 1; } for (i = 0; i < in_size; ++i) { out[i] = in[i]; out[i].bit_cost_ = BrotliPopulationCostCommand(&in[i]); histogram_symbols[i] = (uint32_t)i; } for (i = 0; i < in_size; i += max_input_histograms) { size_t num_to_combine = (brotli_min_size_t((in_size - i), (max_input_histograms))); size_t num_new_clusters; size_t j; for (j = 0; j < num_to_combine; ++j) { clusters[num_clusters + j] = (uint32_t)(i + j); } num_new_clusters = BrotliHistogramCombineCommand(out, cluster_size, &histogram_symbols[i], &clusters[num_clusters], pairs, num_to_combine, num_to_combine, max_histograms, pairs_capacity); num_clusters += num_new_clusters; } { size_t max_num_pairs = (brotli_min_size_t((64 * num_clusters), ((num_clusters / 2) * num_clusters))); { if (pairs_capacity < (max_num_pairs + 1)) { size_t _new_size = (pairs_capacity == 0) ? (max_num_pairs + 1) : pairs_capacity; HistogramPair* new_array; while (_new_size < (max_num_pairs + 1)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramPair*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramPair))) : 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ); if (!(!!0) && !(!!0) && pairs_capacity != 0) 
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; pairs = new_array; pairs_capacity = _new_size; } }; if ((!!0)) return; num_clusters = BrotliHistogramCombineCommand(out, cluster_size, histogram_symbols, clusters, pairs, num_clusters, in_size, max_histograms, max_num_pairs); } { BrotliFree((m), (pairs)); pairs = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; { BrotliFree((m), (cluster_size)); cluster_size = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; BrotliHistogramRemapCommand(in, in_size, clusters, num_clusters, out, histogram_symbols); { BrotliFree((m), (clusters)); clusters = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; *out_size = BrotliHistogramReindexCommand(m, out, histogram_symbols, in_size); if ((!!0)) return; }
# 320 "project/brotli/c/enc/./cluster_inc.h"
#undef HistogramType
# 46 "project/brotli/c/enc/cluster.c" 2
#undef FN
...
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } else { double threshold = *num_pairs == 0 ? 1e99 : (brotli_max_double((0.0), (pairs[0].cost_diff))); HistogramDistance combo = out[idx1]; double cost_combo; HistogramAddHistogramDistance(&combo, &out[idx2]); cost_combo = BrotliPopulationCostDistance(&combo); if (cost_combo < threshold - p.cost_diff) { p.cost_combo = cost_combo; is_good_pair = 
# 17 "project/brotli/c/enc/./cluster_inc.h" 3 4
                      1
# 17 "project/brotli/c/enc/./cluster_inc.h"
                      ; } } if (is_good_pair) { p.cost_diff += p.cost_combo; if (*num_pairs > 0 && HistogramPairIsLess(&pairs[0], &p)) { if (*num_pairs < max_num_pairs) { pairs[*num_pairs] = pairs[0]; ++(*num_pairs); } pairs[0] = p; } else if (*num_pairs < max_num_pairs) { pairs[*num_pairs] = p; ++(*num_pairs); } } }
...
# 78 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                                       , 0))
# 78 "project/brotli/c/enc/./cluster_inc.h"
                                                                       ; break; } } --num_clusters; { size_t copy_to_idx = 0; for (i = 0; i < num_pairs; ++i) { HistogramPair* p = &pairs[i]; if (p->idx1 == best_idx1 || p->idx2 == best_idx1 || p->idx1 == best_idx2 || p->idx2 == best_idx2) { continue; } if (HistogramPairIsLess(&pairs[0], p)) { HistogramPair front = pairs[0]; pairs[0] = *p; pairs[copy_to_idx] = front; } else { pairs[copy_to_idx] = *p; } ++copy_to_idx; } num_pairs = copy_to_idx; } for (i = 0; i < num_clusters; ++i) { BrotliCompareAndPushToQueueDistance(out, cluster_size, best_idx1, clusters[i], max_num_pairs, &pairs[0], &num_pairs); } } return num_clusters; }
# 157 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) double BrotliHistogramBitCostDistanceDistance(
    const HistogramDistance* histogram, const HistogramDistance* candidate) { if (histogram->total_count_ == 0) { return 0.0; } else { HistogramDistance tmp = *histogram; HistogramAddHistogramDistance(&tmp, candidate); return BrotliPopulationCostDistance(&tmp) - candidate->bit_cost_; } }
# 172 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliHistogramRemapDistance(const HistogramDistance* in,
    size_t in_size, const uint32_t* clusters, size_t num_clusters,
    HistogramDistance* out, uint32_t* symbols) { size_t i; for (i = 0; i < in_size; ++i) { uint32_t best_out = i == 0 ? symbols[0] : symbols[i - 1]; double best_bits = BrotliHistogramBitCostDistanceDistance(&in[i], &out[best_out]); size_t j; for (j = 0; j < num_clusters; ++j) { const double cur_bits = BrotliHistogramBitCostDistanceDistance(&in[i], &out[clusters[j]]); if (cur_bits < best_bits) { best_bits = cur_bits; best_out = clusters[j]; } } symbols[i] = best_out; } for (i = 0; i < num_clusters; ++i) { HistogramClearDistance(&out[clusters[i]]); } for (i = 0; i < in_size; ++i) { HistogramAddHistogramDistance(&out[symbols[i]], &in[i]); } }
# 211 "project/brotli/c/enc/./cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramReindexDistance(MemoryManager* m,
    HistogramDistance* out, uint32_t* symbols, size_t length) { static const uint32_t kInvalidIndex = 
# 212 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                                         (~((uint32_t)0))
# 212 "project/brotli/c/enc/./cluster_inc.h"
                                                         ; uint32_t* new_index = ((length) > 0 ? ((uint32_t*)BrotliAllocate((m), (length) * sizeof(uint32_t))) : 
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ); size_t i; if ((!!0) || (!!0) || (!!0) || (!!0)) { return; } for (i = 0; i < in_size; ++i) { cluster_size[i] = 1; } for (i = 0; i < in_size; ++i) { out[i] = in[i]; out[i].bit_cost_ = BrotliPopulationCostDistance(&in[i]); histogram_symbols[i] = (uint32_t)i; } for (i = 0; i < in_size; i += max_input_histograms) { size_t num_to_combine = (brotli_min_size_t((in_size - i), (max_input_histograms))); size_t num_new_clusters; size_t j; for (j = 0; j < num_to_combine; ++j) { clusters[num_clusters + j] = (uint32_t)(i + j); } num_new_clusters = BrotliHistogramCombineDistance(out, cluster_size, &histogram_symbols[i], &clusters[num_clusters], pairs, num_to_combine, num_to_combine, max_histograms, pairs_capacity); num_clusters += num_new_clusters; } { size_t max_num_pairs = (brotli_min_size_t((64 * num_clusters), ((num_clusters / 2) * num_clusters))); { if (pairs_capacity < (max_num_pairs + 1)) { size_t _new_size = (pairs_capacity == 0) ? (max_num_pairs + 1) : pairs_capacity; HistogramPair* new_array; while (_new_size < (max_num_pairs + 1)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramPair*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramPair))) : 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ); if (!(!!0) && !(!!0) && pairs_capacity != 0) 
...
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; pairs = new_array; pairs_capacity = _new_size; } }; if ((!!0)) return; num_clusters = BrotliHistogramCombineDistance(out, cluster_size, histogram_symbols, clusters, pairs, num_clusters, in_size, max_histograms, max_num_pairs); } { BrotliFree((m), (pairs)); pairs = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; { BrotliFree((m), (cluster_size)); cluster_size = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; BrotliHistogramRemapDistance(in, in_size, clusters, num_clusters, out, histogram_symbols); { BrotliFree((m), (clusters)); clusters = 
# 252 "project/brotli/c/enc/./cluster_inc.h" 3 4
                                ((void *)0)
# 252 "project/brotli/c/enc/./cluster_inc.h"
                                ; }; *out_size = BrotliHistogramReindexDistance(m, out, histogram_symbols, in_size); if ((!!0)) return; }
# 320 "project/brotli/c/enc/./cluster_inc.h"
#undef HistogramType
# 50 "project/brotli/c/enc/cluster.c" 2
#undef FN
