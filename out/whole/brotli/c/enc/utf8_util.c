# 0 "project/brotli/c/enc/utf8_util.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/brotli/c/enc/utf8_util.c"
# 9 "project/brotli/c/enc/utf8_util.c"
...
# 10 "project/brotli/c/enc/utf8_util.c" 2
...
# 68 "project/brotli/c/enc/utf8_util.c" 3 4
int 
# 68 "project/brotli/c/enc/utf8_util.c"
           BrotliIsMostlyUTF8(
    const uint8_t* data, const size_t pos, const size_t mask,
    const size_t length, const double min_fraction) {
  size_t size_utf8 = 0;
  ...
  return 
# 80 "project/brotli/c/enc/utf8_util.c" 3 4
        (!!(
# 80 "project/brotli/c/enc/utf8_util.c"
        (double)size_utf8 > min_fraction * (double)length
# 80 "project/brotli/c/enc/utf8_util.c" 3 4
        ) ? 1 : 0)
# 80 "project/brotli/c/enc/utf8_util.c"
                                                                         ;
