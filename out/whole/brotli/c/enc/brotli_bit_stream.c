# 0 "project/brotli/c/enc/brotli_bit_stream.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/brotli/c/enc/brotli_bit_stream.c"
# 11 "project/brotli/c/enc/brotli_bit_stream.c"
...
# 21 "project/brotli/c/enc/./brotli_bit_stream.h" 2
...
# 25 "project/brotli/c/enc/./brotli_bit_stream.h" 2
...
# 12 "project/brotli/c/enc/brotli_bit_stream.c" 2



# 1 "project/brotli/c/enc/../common/constants.h" 1
# 16 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/../common/context.h" 1
# 17 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/../common/platform.h" 1
# 18 "project/brotli/c/enc/brotli_bit_stream.c" 2

# 1 "project/brotli/c/enc/./entropy_encode.h" 1
# 20 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/./entropy_encode_static.h" 1
# 10 "project/brotli/c/enc/./entropy_encode_static.h"
#define BROTLI_ENC_ENTROPY_ENCODE_STATIC_H_ 

# 1 "project/brotli/c/enc/./../common/constants.h" 1
# 13 "project/brotli/c/enc/./entropy_encode_static.h" 2
...
# 16 "project/brotli/c/enc/./entropy_encode_static.h" 2
...
static const uint8_t kStaticCommandCodeDepth[704] = {
...
static inline __attribute__((__always_inline__)) void StoreStaticCodeLengthCode(
    size_t* storage_ix, uint8_t* storage) {
  BrotliWriteBits(
      40, 
# 86 "project/brotli/c/enc/./entropy_encode_static.h" 3 4
         ((((uint64_t)(
# 86 "project/brotli/c/enc/./entropy_encode_static.h"
         0x0000FFu
# 86 "project/brotli/c/enc/./entropy_encode_static.h" 3 4
         )) << 32) | 
# 86 "project/brotli/c/enc/./entropy_encode_static.h"
...
static const uint16_t kStaticCommandCodeBits[704] = {
...
static inline __attribute__((__always_inline__)) void StoreStaticCommandHuffmanTree(
    size_t* storage_ix, uint8_t* storage) {
  BrotliWriteBits(
      56, 
# 519 "project/brotli/c/enc/./entropy_encode_static.h" 3 4
         ((((uint64_t)(
# 519 "project/brotli/c/enc/./entropy_encode_static.h"
         0x926244U
# 519 "project/brotli/c/enc/./entropy_encode_static.h" 3 4
         )) << 32) | 
# 519 "project/brotli/c/enc/./entropy_encode_static.h"
...
static inline __attribute__((__always_inline__)) void StoreStaticDistanceHuffmanTree(
    size_t* storage_ix, uint8_t* storage) {
  BrotliWriteBits(28, 0x0369DC03u, storage_ix, storage);
}
# 21 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/./fast_log.h" 1
# 22 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/./histogram.h" 1
# 23 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/./memory.h" 1
# 24 "project/brotli/c/enc/brotli_bit_stream.c" 2
# 1 "project/brotli/c/enc/./write_bits.h" 1
# 25 "project/brotli/c/enc/brotli_bit_stream.c" 2
...
static inline __attribute__((__always_inline__)) uint32_t BlockLengthPrefixCode(uint32_t len) {
...
static inline __attribute__((__always_inline__)) void GetBlockLengthPrefixCode(uint32_t len, size_t* code,
...
static inline __attribute__((__always_inline__)) size_t NextBlockTypeCode(
...
static inline __attribute__((__always_inline__)) void StoreCommandExtra(
...
static void StoreCompressedMetaBlockHeader(
# 123 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                                          int 
# 123 "project/brotli/c/enc/brotli_bit_stream.c"
                                                      is_final_block,
                                           size_t length,
                                           size_t* storage_ix,
                                           uint8_t* storage) {
...
static void BrotliStoreHuffmanTreeOfHuffmanTreeToBitMask(
    ...
    size_t* storage_ix, uint8_t* storage) {
  static const uint8_t kStorageOrder[(17 + 1)] = {
    1, 2, 3, 4, 0, 5, 17, 6, 16, 7, 8, 9, 10, 11, 12, 13, 14, 15
  };
# 184 "project/brotli/c/enc/brotli_bit_stream.c"
    ...
    for (i = 0; i < num_symbols; i++) {
      ...
      for (j = i + 1; j < num_symbols; j++) {
        if (depths[symbols[j]] < depths[symbols[i]]) {
          { size_t __brotli_swap_tmp = (symbols)[(j)]; (symbols)[(j)] = (symbols)[(i)]; (symbols)[(i)] = __brotli_swap_tmp; };
        }
      }
    }
  }
...
void BrotliStoreHuffmanTree(const uint8_t* depths, size_t num,
  ...
  BrotliCreateHuffmanTree(huffman_tree_histogram, (17 + 1),
...
# 387 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 __builtin___memset_chk (
# 387 "project/brotli/c/enc/brotli_bit_stream.c"
 depth
# 387 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , 
# 387 "project/brotli/c/enc/brotli_bit_stream.c"
 0, histogram_length * sizeof(depth[0])
# 387 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , __builtin_object_size (
# 387 "project/brotli/c/enc/brotli_bit_stream.c"
 depth
...
# 398 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                    int 
# 398 "project/brotli/c/enc/brotli_bit_stream.c"
                                SortHuffmanTree(
    const HuffmanTree* v0, const HuffmanTree* v1) {
  return 
# 400 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
        (!!(
# 400 "project/brotli/c/enc/brotli_bit_stream.c"
...
# 433 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 __builtin___memset_chk (
# 433 "project/brotli/c/enc/brotli_bit_stream.c"
 depth
# 433 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , 
# 433 "project/brotli/c/enc/brotli_bit_stream.c"
 0, length * sizeof(depth[0])
# 433 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , __builtin_object_size (
# 433 "project/brotli/c/enc/brotli_bit_stream.c"
 depth
...
# 433 "project/brotli/c/enc/brotli_bit_stream.c"
                                            ;
  {
    ...
    HuffmanTree* tree = ((max_tree_size) > 0 ? ((HuffmanTree*)BrotliAllocate((m), (max_tree_size) * sizeof(HuffmanTree))) : 
# 436 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                       ((void *)0)
# 436 "project/brotli/c/enc/brotli_bit_stream.c"
                       );
...
# 468 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                                  (~((uint32_t)0))
# 468 "project/brotli/c/enc/brotli_bit_stream.c"
                                                   , -1, -1);
        *node++ = sentinel;
        *node++ = sentinel;
    ...
    { BrotliFree((m), (tree)); tree = 
# 503 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   ((void *)0)
# 503 "project/brotli/c/enc/brotli_bit_stream.c"
   ; };
  }
...
static void MoveToFrontTransform(const uint32_t* restrict v_in,
                                 const size_t v_size,
                                 uint32_t* v_out) {
  size_t i;
  uint8_t mtf[256];
...
static void RunLengthCodeZeros(const size_t in_size,
    uint32_t* restrict v, size_t* restrict out_size,
    uint32_t* restrict max_run_length_prefix) {
  uint32_t max_reps = 0;
  size_t i;
  uint32_t max_prefix;
  for (i = 0; i < in_size;) {
...
static void EncodeContextMap(MemoryManager* m,
  ...
  rle_symbols = ((context_map_size) > 0 ? ((uint32_t*)BrotliAllocate((m), (context_map_size) * sizeof(uint32_t))) : 
# 701 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
               ((void *)0)
# 701 "project/brotli/c/enc/brotli_bit_stream.c"
               );
  if ((!!0) || (!!0)) return;
...
# 706 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 __builtin___memset_chk (
# 706 "project/brotli/c/enc/brotli_bit_stream.c"
 histogram
# 706 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , 
# 706 "project/brotli/c/enc/brotli_bit_stream.c"
...
# 711 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   int 
# 711 "project/brotli/c/enc/brotli_bit_stream.c"
               use_rle = 
# 711 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                         (!!(
# 711 "project/brotli/c/enc/brotli_bit_stream.c"
...
# 711 "project/brotli/c/enc/brotli_bit_stream.c"
  ...
  for (i = 0; i < num_rle_symbols; ++i) {
    ...
    const uint32_t extra_bits_val = rle_symbols[i] >> 9;
  ...
  BrotliWriteBits(1, 1, storage_ix, storage);
  { BrotliFree((m), (rle_symbols)); rle_symbols = 
# 729 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 ((void *)0)
# 729 "project/brotli/c/enc/brotli_bit_stream.c"
 ; };
}


static inline __attribute__((__always_inline__)) void StoreBlockSwitch(BlockSplitCode* code,
                                           const uint32_t block_len,
                                           const uint8_t block_type,
                                           
# 736 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                                          int 
# 736 "project/brotli/c/enc/brotli_bit_stream.c"
                                                      is_first_block,
                                           size_t* storage_ix,
                                           uint8_t* storage) {
...
# 768 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 __builtin___memset_chk (
# 768 "project/brotli/c/enc/brotli_bit_stream.c"
 type_histo
# 768 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , 
# 768 "project/brotli/c/enc/brotli_bit_stream.c"
 0, (num_types + 2) * sizeof(type_histo[0])
# 768 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , __builtin_object_size (
# 768 "project/brotli/c/enc/brotli_bit_stream.c"
 type_histo
...
# 769 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 __builtin___memset_chk (
# 769 "project/brotli/c/enc/brotli_bit_stream.c"
 length_histo
# 769 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , 
# 769 "project/brotli/c/enc/brotli_bit_stream.c"
...
# 804 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   __builtin___memset_chk (
# 804 "project/brotli/c/enc/brotli_bit_stream.c"
   histogram
# 804 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   , 
# 804 "project/brotli/c/enc/brotli_bit_stream.c"
   0, alphabet_size * sizeof(histogram[0])
# 804 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   , __builtin_object_size (
# 804 "project/brotli/c/enc/brotli_bit_stream.c"
   histogram
...
static void CleanupBlockEncoder(MemoryManager* m, BlockEncoder* self) {
  { BrotliFree((m), (self->depths_)); self->depths_ = 
# 859 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 ((void *)0)
# 859 "project/brotli/c/enc/brotli_bit_stream.c"
 ; };
  { BrotliFree((m), (self->bits_)); self->bits_ = 
# 860 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 ((void *)0)
# 860 "project/brotli/c/enc/brotli_bit_stream.c"
 ; };
}
...
# 1 "project/brotli/c/enc/./block_encoder_inc.h" 1
# 10 "project/brotli/c/enc/./block_encoder_inc.h"
#define HistogramType FN(Histogram)



static void BuildAndStoreEntropyCodesLiteral(MemoryManager* m, BlockEncoder* self,
    const HistogramLiteral* histograms, const size_t histograms_size,
    const size_t alphabet_size, HuffmanTree* tree,
    size_t* storage_ix, uint8_t* storage) {
  const size_t table_size = histograms_size * self->histogram_length_;
  self->depths_ = ((table_size) > 0 ? ((uint8_t*)BrotliAllocate((m), (table_size) * sizeof(uint8_t))) : 
# 19 "project/brotli/c/enc/./block_encoder_inc.h" 3 4
                 ((void *)0)
# 19 "project/brotli/c/enc/./block_encoder_inc.h"
                 );
  self->bits_ = ((table_size) > 0 ? ((uint16_t*)BrotliAllocate((m), (table_size) * sizeof(uint16_t))) : 
# 20 "project/brotli/c/enc/./block_encoder_inc.h" 3 4
               ((void *)0)
# 20 "project/brotli/c/enc/./block_encoder_inc.h"
               );
  if ((!!0)) return;
...
#undef HistogramType
# 918 "project/brotli/c/enc/brotli_bit_stream.c" 2
#undef FN
...
static void BuildAndStoreEntropyCodesCommand(MemoryManager* m, BlockEncoder* self,
    const HistogramCommand* histograms, const size_t histograms_size,
    const size_t alphabet_size, HuffmanTree* tree,
    size_t* storage_ix, uint8_t* storage) {
  const size_t table_size = histograms_size * self->histogram_length_;
  self->depths_ = ((table_size) > 0 ? ((uint8_t*)BrotliAllocate((m), (table_size) * sizeof(uint8_t))) : 
...
#undef HistogramType
# 923 "project/brotli/c/enc/brotli_bit_stream.c" 2
#undef FN
...
static void BuildAndStoreEntropyCodesDistance(MemoryManager* m, BlockEncoder* self,
    const HistogramDistance* histograms, const size_t histograms_size,
    const size_t alphabet_size, HuffmanTree* tree,
    size_t* storage_ix, uint8_t* storage) {
  const size_t table_size = histograms_size * self->histogram_length_;
  self->depths_ = ((table_size) > 0 ? ((uint8_t*)BrotliAllocate((m), (table_size) * sizeof(uint8_t))) : 
...
#undef HistogramType
# 928 "project/brotli/c/enc/brotli_bit_stream.c" 2
#undef FN
...
void BrotliStoreMetaBlock(MemoryManager* m,
    const uint8_t* input, size_t start_pos, size_t length, size_t mask,
    uint8_t prev_byte, uint8_t prev_byte2, 
# 937 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                                          int 
# 937 "project/brotli/c/enc/brotli_bit_stream.c"
                                                      is_last,
    const BrotliEncoderParams* params, ContextType literal_context_mode,
    const Command* commands, size_t n_commands, const MetaBlockSplit* mb,
    size_t* storage_ix, uint8_t* storage) {
  ...
  tree = (((2 * 704 + 1)) > 0 ? ((HuffmanTree*)BrotliAllocate((m), ((2 * 704 + 1)) * sizeof(HuffmanTree))) : 
# 957 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
        ((void *)0)
# 957 "project/brotli/c/enc/brotli_bit_stream.c"
        );
  if ((!!0) || (!!0)) return;
  InitBlockEncoder(&literal_enc, 256,
      mb->literal_split.num_types, mb->literal_split.types,
      mb->literal_split.lengths, mb->literal_split.num_blocks);
  InitBlockEncoder(&command_enc, 704,
  ...
  BuildAndStoreEntropyCodesLiteral(m, &literal_enc, mb->literal_histograms,
      mb->literal_histograms_size, 256, tree,
      storage_ix, storage);
  if ((!!0)) return;
  BuildAndStoreEntropyCodesCommand(m, &command_enc, mb->command_histograms,
      mb->command_histograms_size, 704, tree,
      storage_ix, storage);
  if ((!!0)) return;
  ...
  if ((!!0)) return;
  { BrotliFree((m), (tree)); tree = 
# 1014 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 ((void *)0)
# 1014 "project/brotli/c/enc/brotli_bit_stream.c"
 ; };
...
# 1136 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   int 
# 1136 "project/brotli/c/enc/brotli_bit_stream.c"
               is_last, const BrotliEncoderParams* params,
    const Command* commands, size_t n_commands,
    size_t* storage_ix, uint8_t* storage) {
  HistogramLiteral lit_histo;
  ...
  tree = (((2 * 704 + 1)) > 0 ? ((HuffmanTree*)BrotliAllocate((m), ((2 * 704 + 1)) * sizeof(HuffmanTree))) : 
# 1162 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
        ((void *)0)
# 1162 "project/brotli/c/enc/brotli_bit_stream.c"
        );
  if ((!!0) || (!!0)) return;
  BuildAndStoreHuffmanTree(lit_histo.data_, 256,
                           ...
                           lit_depth, lit_bits,
                           storage_ix, storage);
  BuildAndStoreHuffmanTree(cmd_histo.data_, 704,
                           704, tree,
                           cmd_depth, cmd_bits,
                           storage_ix, storage);
  BuildAndStoreHuffmanTree(dist_histo.data_, ( 16 + (0) + ((62U) << ((0) + 1))),
                           num_distance_symbols, tree,
                           dist_depth, dist_bits,
                           storage_ix, storage);
  { BrotliFree((m), (tree)); tree = 
# 1176 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 ((void *)0)
# 1176 "project/brotli/c/enc/brotli_bit_stream.c"
 ; };
...
# 1189 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   int 
# 1189 "project/brotli/c/enc/brotli_bit_stream.c"
               is_last, const BrotliEncoderParams* params,
    const Command* commands, size_t n_commands,
    size_t* storage_ix, uint8_t* storage) {
  uint32_t num_distance_symbols = params->dist.alphabet_size_max;
...
# 1279 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
                                     int 
# 1279 "project/brotli/c/enc/brotli_bit_stream.c"
                                                 is_final_block,
                                      const uint8_t* restrict input,
                                      size_t position, size_t mask,
                                      size_t len,
                                      size_t* restrict storage_ix,
                                      uint8_t* restrict storage) {
...
# 1291 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   __builtin___memcpy_chk (
# 1291 "project/brotli/c/enc/brotli_bit_stream.c"
   &storage[*storage_ix >> 3]
# 1291 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   , 
# 1291 "project/brotli/c/enc/brotli_bit_stream.c"
   &input[masked_pos], len1
# 1291 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
   , __builtin_object_size (
# 1291 "project/brotli/c/enc/brotli_bit_stream.c"
   &storage[*storage_ix >> 3]
...
# 1296 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 __builtin___memcpy_chk (
# 1296 "project/brotli/c/enc/brotli_bit_stream.c"
 &storage[*storage_ix >> 3]
# 1296 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , 
# 1296 "project/brotli/c/enc/brotli_bit_stream.c"
 &input[masked_pos], len
# 1296 "project/brotli/c/enc/brotli_bit_stream.c" 3 4
 , __builtin_object_size (
# 1296 "project/brotli/c/enc/brotli_bit_stream.c"
 &storage[*storage_ix >> 3]
