# 0 "project/brotli/c/enc/static_dict.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/brotli/c/enc/static_dict.c"
...
# 14 "project/brotli/c/enc/./static_dict.h" 2
...
# 31 "project/brotli/c/enc/./static_dict.h"
    ...
    uint32_t* matches);
# 8 "project/brotli/c/enc/static_dict.c" 2

# 1 "project/brotli/c/enc/../common/dictionary.h" 1
# 10 "project/brotli/c/enc/static_dict.c" 2
# 1 "project/brotli/c/enc/../common/platform.h" 1
# 11 "project/brotli/c/enc/static_dict.c" 2
...
# 12 "project/brotli/c/enc/static_dict.c" 2
# 1 "project/brotli/c/enc/./encoder_dict.h" 1
# 13 "project/brotli/c/enc/static_dict.c" 2
...
# 14 "project/brotli/c/enc/static_dict.c" 2





static inline __attribute__((__always_inline__)) uint32_t Hash(const uint8_t* data) {
  uint32_t h = BrotliUnalignedRead32(data) * kDictHashMul32;


  return h >> (32 - kDictNumBits);
}

static inline __attribute__((__always_inline__)) void AddMatch(size_t distance, size_t len, size_t len_code,
                                   uint32_t* matches) {
  uint32_t match = (uint32_t)((distance << 5) + len_code);
  matches[len] = (brotli_min_uint32_t((matches[len]), (match)));
}

static inline __attribute__((__always_inline__)) size_t DictMatchLength(const BrotliDictionary* dictionary,
                                            const uint8_t* data,
                                            size_t id,
                                            size_t len,
                                            size_t maxlen) {
...
# 42 "project/brotli/c/enc/static_dict.c" 3 4
                    int 
# 42 "project/brotli/c/enc/static_dict.c"
                                IsMatch(const BrotliDictionary* dictionary,
    DictWord w, const uint8_t* data, size_t max_length) {
  if (w.len > max_length) {
    return 
# 45 "project/brotli/c/enc/static_dict.c" 3 4
          0
# 45 "project/brotli/c/enc/static_dict.c"
                      ;
  } else {
...
# 53 "project/brotli/c/enc/static_dict.c" 3 4
         (!!(
# 53 "project/brotli/c/enc/static_dict.c"
...
# 53 "project/brotli/c/enc/static_dict.c"
      ...
      return 
# 57 "project/brotli/c/enc/static_dict.c" 3 4
            (!!(
# 57 "project/brotli/c/enc/static_dict.c"
            dict[0] >= 'a' && dict[0] <= 'z' && (dict[0] ^ 32) == data[0] && FindMatchLengthWithLimit(&dict[1], &data[1], w.len - 1u) == w.len - 1u
# 57 "project/brotli/c/enc/static_dict.c" 3 4
            ) ? 1 : 0)


                         
# 60 "project/brotli/c/enc/static_dict.c"
                        ;
    } else {
      ...
      for (i = 0; i < w.len; ++i) {
        if (dict[i] >= 'a' && dict[i] <= 'z') {
          if ((dict[i] ^ 32) != data[i]) return 
# 67 "project/brotli/c/enc/static_dict.c" 3 4
                                               0
# 67 "project/brotli/c/enc/static_dict.c"
                                                           ;
        } else {
          if (dict[i] != data[i]) return 
# 69 "project/brotli/c/enc/static_dict.c" 3 4
                                        0
# 69 "project/brotli/c/enc/static_dict.c"
                                                    ;
        }
      }
      return 
# 72 "project/brotli/c/enc/static_dict.c" 3 4
            1
# 72 "project/brotli/c/enc/static_dict.c"
                       ;
    }
  }
}
...
# 77 "project/brotli/c/enc/static_dict.c" 3 4
int 
# 77 "project/brotli/c/enc/static_dict.c"
           BrotliFindAllStaticDictionaryMatches(
    const BrotliEncoderDictionary* dictionary, const uint8_t* data,
    size_t min_length, size_t max_length, uint32_t* matches) {
  
# 80 "project/brotli/c/enc/static_dict.c" 3 4
 int 
# 80 "project/brotli/c/enc/static_dict.c"
             has_found_match = 
# 80 "project/brotli/c/enc/static_dict.c" 3 4
                               0
# 80 "project/brotli/c/enc/static_dict.c"
...
# 83 "project/brotli/c/enc/static_dict.c" 3 4
   int 
# 83 "project/brotli/c/enc/static_dict.c"
               end = !offset;
    while (!end) {
      ...
      if (w.transform == 0) {
        ...
        if (matchlen == l) {
          ...
          has_found_match = 
# 101 "project/brotli/c/enc/static_dict.c" 3 4
                           1
# 101 "project/brotli/c/enc/static_dict.c"
                                      ;
        }
        ...
        if (matchlen >= l - 1) {
          ...
          has_found_match = 
# 112 "project/brotli/c/enc/static_dict.c" 3 4
                           1
# 112 "project/brotli/c/enc/static_dict.c"
                                      ;
        }

        minlen = min_length;
        if (l > 9) minlen = (brotli_max_size_t((minlen), (l - 9)));
        ...
        for (len = minlen; len <= maxlen; ++len) {
          ...
          has_found_match = 
# 123 "project/brotli/c/enc/static_dict.c" 3 4
                           1
# 123 "project/brotli/c/enc/static_dict.c"
                                      ;
        }
        ...
        const 
# 279 "project/brotli/c/enc/static_dict.c" 3 4
             int 
# 279 "project/brotli/c/enc/static_dict.c"
                         is_all_caps =
            
# 280 "project/brotli/c/enc/static_dict.c" 3 4
           (!!(
# 280 "project/brotli/c/enc/static_dict.c"
           w.transform != BROTLI_TRANSFORM_UPPERCASE_FIRST
# 280 "project/brotli/c/enc/static_dict.c" 3 4
           ) ? 1 : 0)
# 280 "project/brotli/c/enc/static_dict.c"
                                                                          ;
        ...
        has_found_match = 
# 287 "project/brotli/c/enc/static_dict.c" 3 4
                         1
# 287 "project/brotli/c/enc/static_dict.c"
                                    ;
        if (l + 1 >= max_length) {
          continue;
        }
...
# 326 "project/brotli/c/enc/static_dict.c" 3 4
   int 
# 326 "project/brotli/c/enc/static_dict.c"
               is_space = 
# 326 "project/brotli/c/enc/static_dict.c" 3 4
                          (!!(
# 326 "project/brotli/c/enc/static_dict.c"
...
# 328 "project/brotli/c/enc/static_dict.c" 3 4
   int 
# 328 "project/brotli/c/enc/static_dict.c"
               end = !offset;
    while (!end) {
      DictWord w = dictionary->dict_words[offset++];
      const size_t l = w.len & 0x1F;
      ...
      if (w.transform == 0) {
        ...
        has_found_match = 
# 344 "project/brotli/c/enc/static_dict.c" 3 4
                         1
# 344 "project/brotli/c/enc/static_dict.c"
                                    ;
        if (l + 2 >= max_length) {
          continue;
        }
        ...
        const 
# 379 "project/brotli/c/enc/static_dict.c" 3 4
             int 
# 379 "project/brotli/c/enc/static_dict.c"
                         is_all_caps =
            
# 380 "project/brotli/c/enc/static_dict.c" 3 4
           (!!(
# 380 "project/brotli/c/enc/static_dict.c"
           w.transform != BROTLI_TRANSFORM_UPPERCASE_FIRST
# 380 "project/brotli/c/enc/static_dict.c" 3 4
           ) ? 1 : 0)
# 380 "project/brotli/c/enc/static_dict.c"
        ...
        has_found_match = 
# 387 "project/brotli/c/enc/static_dict.c" 3 4
                         1
# 387 "project/brotli/c/enc/static_dict.c"
                                    ;
        if (l + 2 >= max_length) {
          continue;
        }
...
# 423 "project/brotli/c/enc/static_dict.c" 3 4
     int 
# 423 "project/brotli/c/enc/static_dict.c"
                 end = !offset;
      while (!end) {
        DictWord w = dictionary->dict_words[offset++];
        const size_t l = w.len & 0x1F;
        ...
        if (w.transform == 0 &&
          ...
          if (data[0] == 0xC2) {
            ...
            has_found_match = 
# 435 "project/brotli/c/enc/static_dict.c" 3 4
                             1
# 435 "project/brotli/c/enc/static_dict.c"
                                        ;
          } else if (l + 2 < max_length && data[l + 2] == ' ') {
            size_t t = data[0] == 'e' ? 18 : (data[0] == 's' ? 7 : 13);
            AddMatch(id + t * n, l + 3, l, matches);
            has_found_match = 
# 439 "project/brotli/c/enc/static_dict.c" 3 4
                             1
# 439 "project/brotli/c/enc/static_dict.c"
                                        ;
          }
        }
      }
...
# 452 "project/brotli/c/enc/static_dict.c" 3 4
     int 
# 452 "project/brotli/c/enc/static_dict.c"
                 end = !offset;
      while (!end) {
        DictWord w = dictionary->dict_words[offset++];
        const size_t l = w.len & 0x1F;
        ...
        if (w.transform == 0 &&
          ...
          has_found_match = 
# 463 "project/brotli/c/enc/static_dict.c" 3 4
                           1
# 463 "project/brotli/c/enc/static_dict.c"
                                      ;
          if (l + 5 < max_length) {
