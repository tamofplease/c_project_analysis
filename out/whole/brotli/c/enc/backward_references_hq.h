# 0 "project/brotli/c/enc/backward_references_hq.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 10 "project/brotli/c/enc/backward_references_hq.h"
...
# 13 "project/brotli/c/enc/backward_references_hq.h" 2
...
# 14 "project/brotli/c/enc/backward_references_hq.h" 2
...
# 15 "project/brotli/c/enc/backward_references_hq.h" 2
# 1 "project/brotli/c/enc/../common/platform.h" 1
# 16 "project/brotli/c/enc/backward_references_hq.h" 2
...
# 18 "project/brotli/c/enc/backward_references_hq.h" 2
...
# 19 "project/brotli/c/enc/backward_references_hq.h" 2
# 1 "project/brotli/c/enc/./memory.h" 1
# 20 "project/brotli/c/enc/backward_references_hq.h" 2
# 1 "project/brotli/c/enc/./quality.h" 1
# 21 "project/brotli/c/enc/backward_references_hq.h" 2





__attribute__ ((visibility ("hidden"))) void BrotliCreateZopfliBackwardReferences(MemoryManager* m,
    size_t num_bytes,
...
__attribute__ ((visibility ("hidden"))) void BrotliCreateHqZopfliBackwardReferences(MemoryManager* m,
    size_t num_bytes,
    size_t position, const uint8_t* ringbuffer, size_t ringbuffer_mask,
    ContextLut literal_context_lut, const BrotliEncoderParams* params,
    Hasher* hasher, int* dist_cache, size_t* last_insert_len,
...
__attribute__ ((visibility ("hidden"))) void BrotliInitZopfliNodes(ZopfliNode* array, size_t length);
# 80 "project/brotli/c/enc/backward_references_hq.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliZopfliComputeShortestPath(
    MemoryManager* m, size_t num_bytes,
    size_t position, const uint8_t* ringbuffer, size_t ringbuffer_mask,
    ContextLut literal_context_lut, const BrotliEncoderParams* params,
    const int* dist_cache, Hasher* hasher, ZopfliNode* nodes);

__attribute__ ((visibility ("hidden"))) void BrotliZopfliCreateCommands(
